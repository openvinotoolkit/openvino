...
OutputVector fused_conv(const Node& node) {
    ...
    if (activation_type == "Relu") {
        ...
        const auto activation_alpha_node = v0::Constant::create(element::f32, ov::Shape{}, activation_params);
        ...
        const auto alpha = v0::Constant::create<float>(element::f32, ov::Shape{}, {activation_params[0]});
        const auto beta = v0::Constant::create<float>(element::f32, ov::Shape{}, {activation_params[1]});
