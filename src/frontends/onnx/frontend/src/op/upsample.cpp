...
static bool registered = register_translator("Upsample", {1, 6}, ai_onnx::opset_1::upsample);
}  // namespace opset_1
...
static bool registered = register_translator("Upsample", {7, 8}, ai_onnx::opset_7::upsample);
}  // namespace opset_7
