...
inline OutputVector nms_rotated(const Node& node) {
    ...
    auto max_output_boxes_per_class =
        ov::op::v0::Constant::create(element::i64, ov::Shape{1}, {std::numeric_limits<int64_t>::max()});
    auto iou_threshold_const = ov::op::v0::Constant::create(element::f32, ov::Shape{}, {iou_threshold});
    auto score_threshold_const = ov::op::v0::Constant::create(element::f32, ov::Shape{}, {score_threshold});
