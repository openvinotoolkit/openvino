...
OperatorsBridge::OperatorsBridge() {
    ...
    // custom ops
    REGISTER_OPERATOR_WITH_DOMAIN(OPENVINO_ONNX_DOMAIN, "Relu", 6, set_6::relu);
    REGISTER_OPERATOR_WITH_DOMAIN(OPENVINO_ONNX_DOMAIN, "Relu", 13, set_13::relu);
    REGISTER_OPERATOR_WITH_DOMAIN(OPENVINO_ONNX_DOMAIN, "Relu", 14, set_14::relu);
