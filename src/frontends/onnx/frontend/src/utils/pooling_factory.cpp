...
OutputVector PoolingFactory::make_avg_pool_7() const {
    const bool count_include_pad = m_onnx_node.get_attribute_value<std::int64_t>("count_include_pad", 0);
    return {std::make_shared<v7::AvgPool>(m_inputs.at(0),
                                                     m_strides,
                                                     m_padding_below,
                                                     m_padding_above,
                                                     m_kernel_shape,
...
OutputVector PoolingFactory::make_avg_pool_10() const {
    const bool count_include_pad = m_onnx_node.get_attribute_value<std::int64_t>("count_include_pad", 0);
    return {std::make_shared<v10::AvgPool>(m_inputs.at(0),
                                                     m_strides,
                                                     m_padding_below,
                                                     m_padding_above,
                                                     m_kernel_shape,
...
OutputVector PoolingFactory::make_avg_pool_11() const {
    const bool count_include_pad = m_onnx_node.get_attribute_value<std::int64_t>("count_include_pad", 0);
    return {std::make_shared<v11::AvgPool>(m_inputs.at(0),
                                                     m_strides,
                                                     m_padding_below,
                                                     m_padding_above,
                                                     m_kernel_shape,
...
OutputVector PoolingFactory::make_avg_pool_19() const {
    const bool count_include_pad = m_onnx_node.get_attribute_value<std::int64_t>("count_include_pad", 0);
    return {std::make_shared<v19::AvgPool>(m_inputs.at(0),
                                                     m_strides,
                                                     m_dilations,
                                                     m_padding_below,
                                                     m_padding_above,
