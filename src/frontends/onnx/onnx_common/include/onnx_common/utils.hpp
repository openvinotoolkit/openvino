...
///
ov::element::Type_t onnx_to_ov_data_type(const ONNX_NAMESPACE::TensorProto_DataType& onnx_type);
...
/// type.
///
ONNX_NAMESPACE::TensorProto_DataType ov_to_onnx_data_type(const ov::element::Type_t& ov_type);
...
///
PartialShape onnx_to_ov_shape(const ONNX_NAMESPACE::TensorShapeProto& onnx_shape);
