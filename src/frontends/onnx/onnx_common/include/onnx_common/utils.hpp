...
/// \brief Returns size of an ONNX data type in bytes.
///
...
/// \brief Returns a OpenVINO data type corresponding to an ONNX type.
///
...
/// \brief Returns an ONNX data type corresponding to a OpenVINO data type.
///
...
/// \brief Returns true if a OpenVINO data type is mapped to an ONNX data type.
///
/// \param ov_type An element of  ov::element::Type_t enum class which determines a OpenVINO data
/// type.
///
...
/// \brief Returns OpenVINO PartialShape based on onnx_shape.
///
