...
tests_expected_to_fail = [
    ...
    (
        # The translator handles every LinearAttention config; the "_expanded" variants instead run
        # the ONNX function-body decomposition, which OV does not fully support yet.
        xfail_issue_onnx122_linearattention,
