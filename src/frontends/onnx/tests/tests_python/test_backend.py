...
tests_expected_to_fail = [
    ...
    (
        ...
        "OnnxBackendNodeModelTest.test_attention_4d_diff_heads_mask4d_padded_kv_cpu",
        "OnnxBackendNodeModelTest.test_attention_4d_diff_heads_mask4d_padded_kv_expanded_cpu",
    ),
    (
        xfail_issue_99961,
