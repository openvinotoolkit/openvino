...
OPENVINO_TEST(${BACKEND_NAME}, onnx_model_dequantize_linear_opset21_3d) {
    auto model = convert_model("dequantize_linear_21_3d.onnx");
    ...
    test_case.add_expected_output<float>({2, 4, 1},
