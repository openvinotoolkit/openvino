...
OPENVINO_TEST(${BACKEND_NAME}, onnx_model_lstm_missing_num_directions) {
    ...
    // Y shape: [3, 1, 2, 2]
    std::vector<float> expected_Y = {0.022259334102272987f,
                                     0.0033883226569741964f,
                                     0.052766889333724976f,
                                     0.11502055823802948f,
                                     0.006480472162365913f,
                                     -0.2669661045074463f,
                                     0.35137200355529785f,
                                     -0.5121785998344421f,
                                     0.13379308581352234f,
                                     -0.42883145809173584f,
                                     0.3751090168952942f,
                                     -0.09079679846763611f};
    ...
    // Y_c shape: [1, 2, 2]
    std::vector<float> expected_Y_c = {0.35507580637931824f,
                                       -0.7553168535232544f,
                                       0.6096105575561523f,
                                       -0.12818993628025055f};
