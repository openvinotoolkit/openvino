...
const std::map<std::string, Fingerprint>& fingerprints() {
    static const std::map<std::string, Fingerprint> fp{
        {"mamba2-dense.gguf.hdr", {245, 6}},     {"nemotron_h-dense.gguf.hdr", {256, 8}},
        {"bailingmoe2-moe.gguf.hdr", {495, 10}}, {"ernie4_5-moe-moe.gguf.hdr", {476, 10}},
        {"exaone4-dense.gguf.hdr", {419, 11}},   {"gemma-dense.gguf.hdr", {367, 10}},
        {"gemma2-dense.gguf.hdr", {417, 11}},    {"glm4moe-moe.gguf.hdr", {507, 10}},
        {"gpt-oss-moe.gguf.hdr", {614, 11}},     {"hunyuan-dense-dense.gguf.hdr", {418, 10}},
        {"hunyuan-moe-moe.gguf.hdr", {596, 10}}, {"llama-dense.gguf.hdr", {400, 10}},
        {"llama-moe.gguf.hdr", {546, 10}},       {"maincoder-dense.gguf.hdr", {434, 10}},
        ...
        {"phi3-dense.gguf.hdr", {370, 10}},      {"qwen2-dense.gguf.hdr", {370, 10}},
        {"qwen3-dense.gguf.hdr", {418, 10}},     {"qwen3moe-moe.gguf.hdr", {586, 10}},
        {"qwen35-dense.gguf.hdr", {356, 10}},    {"qwen35moe-moe.gguf.hdr", {532, 10}},
        {"smollm3-dense.gguf.hdr", {386, 10}},
    };
    return fp;
}
