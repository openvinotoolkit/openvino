...
// class DummyDecoder : public JaxDecoder {
// public:
...
//     }
//     virtual void visit_subgraph(std::function<void(std::shared_ptr<JaxDecoder>)> node_visitor) const override {
//         FRONT_END_NOT_IMPLEMENTED(visit_subgraph);
//     }
//     virtual std::shared_ptr<JaxDecoder> get_subgraph_decoder(size_t index) const override {
