...
namespace op {
    ...
    shared_ptr<tuple<shared_ptr<Node>, shared_ptr<Node>, shared_ptr<Node>>> convert_rgb_to_hsv(shared_ptr<Node> images) {
...
OutputVector translate_adjust_saturation_op(const NodeContext& node) {
    ...
    auto hsv_components = convert_rgb_to_hsv(images.get_node_shared_ptr());
