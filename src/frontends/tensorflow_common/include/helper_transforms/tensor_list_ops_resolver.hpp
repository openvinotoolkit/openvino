...
public:
    OPENVINO_RTTI("ov::frontend::tensorflow::pass::TensorListReplacer", "0", ov::pass::MatcherPass);
    TensorListReplacer();
};
...
public:
    OPENVINO_RTTI("ov::frontend::tensorflow::pass::TensorListSetItemReplacer", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("ov::frontend::tensorflow::pass::TensorListPushBackReplacer", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("ov::frontend::tensorflow::pass::TensorListGetItemReplacer", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("ov::frontend::tensorflow::pass::TensorListInLoopOptimization", "0", ov::pass::MatcherPass);
