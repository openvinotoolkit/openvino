...
OP_CONVERTER(translate_fifo_queue_op);
...
OP_CONVERTER(translate_hash_table_op);
...
OP_CONVERTER(translate_iterator_get_next_op);
OP_CONVERTER(translate_iterator_op);
...
OP_CONVERTER(translate_lookup_table_insert_op);
...
OP_CONVERTER(translate_queue_dequeue_op);
