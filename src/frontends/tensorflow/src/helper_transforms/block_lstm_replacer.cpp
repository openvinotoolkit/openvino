...
pass::BlockLSTMToLSTMSequenceOneOutput::BlockLSTMToLSTMSequenceOneOutput() {
    ...
    matcher_pass_callback callback = [=](pattern::Matcher& m) {
        ...
        auto hidden_size_const =
            make_shared<Constant>(element::i64, Shape{1}, std::vector<int64_t>{hidden_size.get_length()});
        ...
        auto shift_const = make_shared<Constant>(element::f32, Shape{}, block_lstm_node->get_forget_bias());
        ...
        NodeVector node_vector = {x_shape,
                                  ss_start,
                                  ss_stop,
                                  ss_step,
                                  ss_start2,
                                  ...
                                  x_order,
                                  x_adjusted,
                                  squeeze_output_hidden_states,
                                  output_hidden_states_order,
                                  output_hidden_states};
        copy_runtime_info(block_lstm_node, node_vector);
