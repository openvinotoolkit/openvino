...
requires working with `PtFrameworkNode` directly. [General rules](https://docs.openvino.ai/2026/documentation/openvino-extensibility/transformation-api.html)
...
OpenVINO operation can accept can be found in [documentation](https://docs.openvino.ai/2026/documentation/openvino-ir-format/operation-sets/operation-specs.html)).
