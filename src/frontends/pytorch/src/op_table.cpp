...
const std::unordered_map<std::string, CreatorFunction> get_supported_ops_fx() {
    // ATen operations reuse the TorchScript table by name. Keep only FX-specific names and schemas here.
    return {
        ...
        {"aten._embedding_bag.default", op::translate_embedding_bag},
        {"aten._embedding_bag_forward_only.default", op::translate_embedding_bag},
