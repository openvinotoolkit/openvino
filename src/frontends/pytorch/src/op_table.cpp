...
const std::unordered_map<std::string, CreatorFunction> get_supported_ops_fx() {
    return {
        ...
        {"torchvision.deform_conv2d", op::translate_deform_conv},
        {"torchvision.roi_align", op::translate_roi_align},
        {"quantized_decomposed.quantize_per_tensor", op::translate_quantize_per_tensor_fx},
        {"quantized_decomposed.quantize_per_channel", op::translate_quantize_per_channel_fx},
        {"quantized_decomposed.dequantize_per_tensor", op::skip_node},
        {"quantized_decomposed.dequantize_per_channel", op::skip_node},
        {"inlined.constant", op::translate_constant},  // this is a custom ov type
    };
};
