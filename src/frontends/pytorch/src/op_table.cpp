...
const std::unordered_map<std::string, CreatorFunction> get_supported_ops_ts() {
    return {
        ...
        {"aten::_fake_quantize_learnable_per_channel_affine", op::translate_fake_quantize_learnable_per_channel_affine},
...
const std::unordered_map<std::string, CreatorFunction> get_supported_ops_fx() {
    return {
        ...
        {"aten._fake_quantize_learnable_per_channel_affine.default", op::translate_fake_quantize_learnable_per_channel_affine},
