...
U4BlockRepack::U4BlockRepack() {
    ...
    register_matcher(
        std::make_shared<ov::pass::pattern::Matcher>(m_reshape2,
                                                     "ov::frontend::pytorch::pass::U4BlockRepack"),
        [=](ov::pass::pattern::Matcher& m) {
            auto& pattern_to_output = m.get_pattern_value_map();
            auto constant = std::dynamic_pointer_cast<ov::op::v0::Constant>(pattern_to_output[m_constant].get_node_shared_ptr());
