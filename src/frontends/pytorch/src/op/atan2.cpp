...
OutputVector translate_atan2(const NodeContext& context) {
    ...
    // Same input type
    auto x = context.mark_node(std::make_shared<v1::ConvertLike>(x, const_pi));
    auto is_x_negative = context.mark_node(std::make_shared<v1::Less>(x, const_zero));
    auto y = context.mark_node(std::make_shared<v1::ConvertLike>(y, const_zero));
    ...
    auto atan = context.mark_node(std::make_shared<v1::ConvertLike>(atan, const_pi));
    ...
    auto y = context.mark_node(std::make_shared<v1::ConvertLike>(atan, const_pi));
    ...
    auto x = context.mark_node(std::make_shared<v1::ConvertLike>(x, const_zero));
    ...
    auto const_pi = context.mark_node(std::make_shared<v1::ConvertLike>(const_pi, const_two));
    ...
    auto const_minus_two = context.mark_node(std::make_shared<v1::ConvertLike>(const_minus_two, const_pi));
