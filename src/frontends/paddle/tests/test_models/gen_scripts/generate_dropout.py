...
def paddle_dropout(name: str, x, p, paddle_attrs):
    ...
    with paddle.static.program_guard(paddle.static.Program(), paddle.static.Program()):
        ...
        out = paddle.nn.functional.dropout(
            x=node_x, p=p, training=paddle_attrs["training"], mode=paddle_attrs["mode"]
        )
...
def main():
    ...
    paddle_attrs = {"training": False, "mode": "downscale_in_infer"}
    paddle_attrs2 = {"training": False, "mode": "upscale_in_train"}
