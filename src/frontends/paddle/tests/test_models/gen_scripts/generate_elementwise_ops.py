...
def elementwise_add(name: str, x, y, in_dtype, axis=-1):
    ...
    with paddle.static.program_guard(paddle.static.Program(), paddle.static.Program()):
        ...
        if paddle.__version__ >= "2.0.0":
            ...
            out = paddle.fluid.layers.elementwise_add(node_x, node_y, axis=axis)
...
def elementwise_sub(name: str, x, y, in_dtype, axis=-1):
    ...
    with paddle.static.program_guard(paddle.static.Program(), paddle.static.Program()):
        ...
        if paddle.__version__ >= "2.0.0":
            ...
            out = paddle.fluid.layers.elementwise_sub(node_x, node_y, axis=axis)
...
def elementwise_div(name: str, x, y, in_dtype, axis=-1):
    ...
    with paddle.static.program_guard(paddle.static.Program(), paddle.static.Program()):
        ...
        if paddle.__version__ >= "2.0.0":
            ...
            out = paddle.fluid.layers.elementwise_div(node_x, node_y, axis=axis)
...
def elementwise_mul(name: str, x, y, in_dtype, axis=-1):
    ...
    with paddle.static.program_guard(paddle.static.Program(), paddle.static.Program()):
        ...
        if paddle.__version__ >= "2.0.0":
            ...
            out = paddle.fluid.layers.elementwise_mul(node_x, node_y, axis=axis)
...
def elementwise_min(name: str, x, y, in_dtype, axis=-1):
    ...
    with paddle.static.program_guard(paddle.static.Program(), paddle.static.Program()):
        ...
        if paddle.__version__ >= "2.0.0":
            ...
            out = paddle.fluid.layers.elementwise_min(node_x, node_y, axis=axis)
...
def elementwise_max(name: str, x, y, in_dtype, axis=-1):
    ...
    with paddle.static.program_guard(paddle.static.Program(), paddle.static.Program()):
        ...
        if paddle.__version__ >= "2.0.0":
            ...
            out = paddle.fluid.layers.elementwise_max(node_x, node_y, axis=axis)
...
def elementwise_pow(name: str, x, y, in_dtype, axis=-1):
    ...
    with paddle.static.program_guard(paddle.static.Program(), paddle.static.Program()):
        ...
        if paddle.__version__ >= "2.0.0":
            ...
            out = paddle.fluid.layers.elementwise_pow(node_x, node_y, axis=axis)
...
def main():
    ...
    for dtype in floordiv_support_dtype:
        elementwise_floordiv(
            "elementwise_floordiv_" + dtype + "_1",
            data_x.astype(dtype),
            data_y.astype(dtype),
            dtype,
        )
    ...
    for dtype in floordiv_support_dtype:
        elementwise_floordiv(
            "elementwise_floordiv_" + dtype + "_2",
            data_x.astype(dtype),
            data_y.astype(dtype),
            dtype,
        )
    ...
    for dtype in floordiv_support_dtype:
        elementwise_floordiv(
            "elementwise_floordiv_" + dtype + "_3",
            data_x.astype(dtype),
            data_y.astype(dtype),
            dtype,
        )
