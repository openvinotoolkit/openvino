#
# less_equal paddle model generator
#
import numpy as np
...
def less_equal(name: str, x, y, data_type, cast_to_fp32=False):
...
def main():
    ...
    for test in test_cases:
        ...
        if ((test == "float64") or (test == "int64")):
            less_equal("less_equal_" + test, x, y, test, True)
        else:
            less_equal("less_equal_" + test, x, y, test, False)
