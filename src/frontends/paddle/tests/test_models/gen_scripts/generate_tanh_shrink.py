...
def main():
    ...
    data = np.random.randn(2, 3, 4).astype(np.float16)
    tanh_shrink("tanh_shrink_3", data)

    data = np.random.randn(2, 3, 4).astype(np.int32)
    tanh_shrink("tanh_shrink_4", data)

    data = np.random.randn(2, 3, 4).astype(np.int64)
    tanh_shrink("tanh_shrink_5", data)
