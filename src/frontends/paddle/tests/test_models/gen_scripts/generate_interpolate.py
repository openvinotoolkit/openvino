...
def resize_upsample_bilinear():
    ...
    test_case = [
        {"name": "bilinear_upsample_false_1", "align_corners": False, "align_mode": 1},
    ...
    for test in test_case:
        paddle_result = paddle_interpolate(
            data,
            [64, 64],
            None,
            mode="bilinear",
            align_corners=test["align_corners"],
            align_mode=test["align_mode"],
            data_format="NCHW",
            name=test["name"],
        )
...
def resize_downsample_bilinear():
    ...
    test_case = [
        {
            "name": "bilinear_downsample_false_1",
            "align_corners": False,
            "align_mode": 1,
        },
        {
            "name": "bilinear_downsample_false_0",
            "align_corners": False,
            "align_mode": 0,
        },
...
def resize_upsample_nearest():
    ...
    test_case = [
        {
            "name": "nearest_upsample_false_0",
            "size": [64, 64],
            "align_corners": False,
            "align_mode": 0,
        },
        {
            "name": "nearest_upsample_false_1",
            "size": [16, 64],
            "align_corners": False,
            "align_mode": 0,
        },
...
def resize_downsample_nearest():
    ...
    test_case = [
        {
            "name": "nearest_downsample_false_0",
            "size": [8, 8],
            "align_corners": False,
            "align_mode": 1,
        },
        {
            "name": "nearest_downsample_false_1",
            "size": [4, 8],
            "align_corners": False,
            "align_mode": 1,
        },
...
def nearest_upsample_tensor_size():
    ...
    test_case = [
        {
            "name": "nearest_upsample_tensor_size",
            "align_corners": False,
            "align_mode": 0,
        }
    ]
    for test in test_case:
        ...
        with paddle.static.program_guard(main_program, startup_program):
            ...
            node_sizes = paddle.static.data(
                name="sizes", shape=sizes.shape, dtype="int32"
            )
            interp = interpolate(
                node_x,
                size=node_sizes,
            ...
            outs = exe.run(
                feed={"x": data, "sizes": sizes}, fetch_list=out, program=main_program
            )
            saveModel(
                test["name"],
                exe,
...
def bilinear_upsample_tensor_size():
    ...
    test_case = [
        {
            "name": "bilinear_upsample_tensor_size",
            "align_corners": False,
            "align_mode": 1,
        }
    ]
...
def bilinear_upsample_scales():
    ...
    test_case = [
        {
            "name": "bilinear_upsample_scales",
            "align_corners": False,
            "align_mode": 1,
            "scales": 2,
        },
        {
            "name": "bilinear_upsample_scales2",
            "align_corners": False,
            "align_mode": 1,
            "scales": [2, 2],
        },
...
def resize_upsample_trilinear():
    ...
    test_case = [
        {"name": "trilinear_upsample_false_1", "align_corners": False, "align_mode": 1},
...
def resize_downsample_trilinear():
    ...
    test_case = [
        {
            "name": "trilinear_downsample_false_1",
            "align_corners": False,
            "align_mode": 1,
        },
        {
            "name": "trilinear_downsample_false_0",
            "align_corners": False,
            "align_mode": 0,
        },
...
def trilinear_upsample_tensor_size():
    ...
    test_case = [
        {
            "name": "trilinear_upsample_tensor_size",
            "align_corners": False,
            "align_mode": 1,
        }
    ]
...
def trilinear_upsample_scales():
    ...
    test_case = [
        {
            "name": "trilinear_upsample_scales",
            "align_corners": False,
            "align_mode": 1,
            "scales": 2,
        },
        {
            "name": "trilinear_upsample_scales2",
            "align_corners": False,
            "align_mode": 1,
            "scales": [1, 2, 2],
        },
...
def resize_upsample_bicubic():
    ...
    test_case = [
        {"name": "bicubic_upsample_false_1", "align_corners": False, "align_mode": 1},
...
def resize_downsample_bicubic():
    ...
    data_28 = data.reshape([1, 1, 2, 8])
    test_case = [
        {"name": "bicubic_downsample_false_1", "align_corners": False, "align_mode": 1},
...
def bicubic_upsample_tensor_size():
    ...
    test_case = [
        {
            "name": "bicubic_upsample_tensor_size",
            "align_corners": False,
            "align_mode": 1,
        }
    ]
...
def bicubic_upsample_scales():
    ...
    test_case = [
        {
            "name": "bicubic_upsample_scales",
            "align_corners": False,
            "align_mode": 1,
            "scales": 2,
        },
        {
            "name": "bicubic_upsample_scales2",
            "align_corners": False,
            "align_mode": 1,
            "scales": [2, 2],
        },
...
def resize_upsample_linear():
    ...
    test_case = [
        {"name": "linear_upsample_false_1", "align_corners": False, "align_mode": 1},
...
def resize_downsample_linear():
    ...
    test_case = [
        {"name": "linear_downsample_false_1", "align_corners": False, "align_mode": 1},
...
def linear_upsample_tensor_size():
    ...
    test_case = [
        {"name": "linear_upsample_tensor_size", "align_corners": False, "align_mode": 1}
    ]
...
def linear_upsample_scales():
    ...
    test_case = [
        {
            "name": "linear_upsample_scales",
            "align_corners": False,
            "align_mode": 1,
            "scales": 2,
        },
        {
            "name": "linear_upsample_scales2",
            "align_corners": False,
            "align_mode": 1,
            "scales": [2, 2],
        },
