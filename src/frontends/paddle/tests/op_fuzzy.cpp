...
static const std::vector<std::string> models{
    ...
    std::string("dequantize_linear_static/dequantize_linear_static.pdmodel"),
    std::string("dequantize_linear_per_channel/dequantize_linear_per_channel.pdmodel"),
    std::string("dequantize_linear_zero_point/dequantize_linear_zero_point.pdmodel"),
    std::string("dequantize_linear_dynamic/dequantize_linear_dynamic.pdmodel"),
    std::string("dequantize_linear_extreme_values/dequantize_linear_extreme_values.pdmodel"),
    ...
    std::string("quantize_linear_per_channel/quantize_linear_per_channel.pdmodel"),
    std::string("quantize_linear_different_bit_lengths/quantize_linear_different_bit_lengths.pdmodel"),
    std::string("quantize_linear_zero_point_handling/quantize_linear_zero_point_handling.pdmodel"),
    std::string("quantize_linear_dynamic/quantize_linear_dynamic.pdmodel"),
