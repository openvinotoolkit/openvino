...
static const std::vector<std::string> models{
    ...
    std::string("mean_negative_axis"),
    std::string("mean_negative_axis_keepdim"),
    std::string("mean_none_axis"),
    std::string("mean_none_axis_keepdim"),
    std::string("mean_positive_axis"),
    std::string("mean_list_axis"),
    std::string("mean_list_axis_keepdim"),
