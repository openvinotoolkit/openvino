...
TEST(Paddle_Places, DISABLED_check_tensor_names) {
...
TEST(Paddle_Places, DISABLED_check_out_port_of_all_ops) {
    auto fem = FrontEndManager();
    FrontEnd::Ptr frontend;
    ASSERT_NO_THROW(frontend = fem.load_by_framework(PADDLE_FE));
    InputModel::Ptr input_model;
...
TEST(Paddle_Places, DISABLED_check_data_flow) {
    auto fem = FrontEndManager();
    FrontEnd::Ptr frontend;
    ASSERT_NO_THROW(frontend = fem.load_by_framework(PADDLE_FE));
    InputModel::Ptr input_model;
...
TEST(Paddle_Places, DISABLED_check_tensor_to_multiple_ports) {
    auto fem = FrontEndManager();
    FrontEnd::Ptr frontend;
    ASSERT_NO_THROW(frontend = fem.load_by_framework(PADDLE_FE));
    InputModel::Ptr input_model;
...
TEST(Paddle_Places, DISABLED_check_consuming_ops) {
    auto fem = FrontEndManager();
    FrontEnd::Ptr frontend;
    ASSERT_NO_THROW(frontend = fem.load_by_framework(PADDLE_FE));
    InputModel::Ptr input_model;
...
TEST(Paddle_Places, DISABLED_check_producing_ops) {
    auto fem = FrontEndManager();
    FrontEnd::Ptr frontend;
    ASSERT_NO_THROW(frontend = fem.load_by_framework(PADDLE_FE));
    InputModel::Ptr input_model;
...
TEST(Paddle_Places, DISABLED_check_input_output_ports_dy_idx) {
    auto fem = FrontEndManager();
    FrontEnd::Ptr frontend;
    ASSERT_NO_THROW(frontend = fem.load_by_framework(PADDLE_FE));
    InputModel::Ptr input_model;
