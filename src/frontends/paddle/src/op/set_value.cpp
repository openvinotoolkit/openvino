...
NamedOutputs set_value(const NodeContext& node) {
    ...
    if (node.has_input("StartsTensorList")) {
        ...
        PADDLE_OP_CHECK(node, start_vec.size() >= axes.size(), "set_value 'starts' size must be >= 'axes' size");
    ...
    if (node.has_input("EndsTensorList")) {
        ...
        PADDLE_OP_CHECK(node, ends_vec.size() >= axes.size(), "set_value 'ends' size must be >= 'axes' size");
    ...
    if (node.has_input("StepsTensorList")) {
        ...
        PADDLE_OP_CHECK(node, step_vec.size() >= axes.size(), "set_value 'steps' size must be >= 'axes' size");
