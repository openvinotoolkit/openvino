...
# Model:
# (int8)tensor_0[12] -> DEQUANTIZE -> (float16)tensor_1[12]
# QUANTIZE:
#   scale: 0.25
#   zero point: 16
sm_path = os.path.join(sys.argv[1], "dequantize_fp16")
tflite_model = b'\x08\x00\x00\x00TFL3\x96\xff\xff\xff\x03\x00\x00\x004\x00\x00\x00T\x00\x00\x00\x08\x00\x00\x00\x14\x00\x00\x00\n\x00\x00\x00test_modell\x00\x00\x00,\x00\x00\x00 \x00\x00\x00,\x00\x00\x00\x04\x00\x00\x00\r\x00\x00\x00test_subgraph\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x10\x00\x00\x00\x00\x00\n\x00\x10\x00\x06\x00\x08\x00\x0c\x00\n\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x04\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x08\x00\x00\x00h\x00\x00\x00\xaa\xff\xff\xff<\x00\x00\x00\x00\x00\x00\t<\x00\x00\x00\x10\x00\x00\x00\x0c\x00\x0c\x00\x00\x00\x00\x00\x04\x00\x08\x00\x0c\x00\x00\x00\x14\x00\x00\x00\x04\x00\x00\x00\x01\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x80>\x01\x00\x00\x00\x0c\x00\x00\x00\x08\x00\x00\x00tensor_0\x00\x00\x0e\x00\x14\x00\x04\x00\x0b\x00\x00\x00\x0c\x00\x10\x00\x0e\x00\x00\x00\x18\x00\x00\x00\x00\x00\x00\x01\x18\x00\x00\x00\x08\x00\x00\x00\x04\x00\x04\x00\x04\x00\x00\x00\x01\x00\x00\x00\x0c\x00\x00\x00\x08\x00\x00\x00tensor_1\x00\x00\x00\x00'
with open(os.path.join(sys.argv[1], sm_path + ".tflite"), 'wb') as f:
  f.write(tflite_model)
