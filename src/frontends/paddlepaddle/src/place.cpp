...
std::shared_ptr<OutPortPlace> OpPlace::get_output_port_pdpd(const std::string& outputName, int outputPortIndex) const {
...
std::shared_ptr<InPortPlace> OpPlace::get_input_port_pdpd(const std::string& inputName, int inputPortIndex) const {
...
std::shared_ptr<TensorPlace> InPortPlace::get_source_tensor_pdpd() const {
...
std::shared_ptr<TensorPlace> OutPortPlace::get_target_tensor_pdpd() const {
