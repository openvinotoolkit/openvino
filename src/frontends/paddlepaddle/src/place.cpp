...
std::shared_ptr<OutPortPlace> OpPlace::get_output_port_pdpd(const std::string &outputName,
...
std::shared_ptr<InPortPlace> OpPlace::get_input_port_pdpd(const std::string &inputName,
