...
typedef struct ie_core ie_core_t;
             ...
             * @ingroup Core
             * @param xml_config_file A path to .xml file with devices to load from. If XML configuration file is not
             * specified, then default Inference Engine devices are loaded from the default plugin.xml file.
             * @param core A pointer to the newly created ie_core_t.
             * @return Status code of the operation: OK(0) for success.
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_core_create(const char* xml_config_file, ie_core_t** core);
            ...
            /**
             * @brief Gets version information of the device specified. Use the ie_core_versions_free() method to free
             * memory.
             * @ingroup Core
            ...
            /**
             * @brief Reads the model from the .xml and .bin files of the IR. Use the ie_network_free() method to free
             * memory.
             * @ingroup Core
             * @param core A pointer to the ie_core_t instance.
             * @param xml .xml file's path of the IR.
             * @param weights_file .bin file's path of the IR, if path is empty, will try to read bin file with the same
             * name as xml and if bin file with the same name was not found, will load IR without weights.
            ...
            /**
             * @brief Reads the model from an xml string and a blob of the bin part of the IR. Use the ie_network_free()
            ...
            /**
             * @brief Creates an executable network from a network previously exported to a file. Users can create as
             * many networks as they need and use them simultaneously (up to the limitation of the hardware resources).
             * Use the ie_exec_network_free() method to free memory.
             * @ingroup Core
             * @param core A pointer to the ie_core_t instance.
            ...
            /**
             * @brief Creates an executable network from a network previously exported to memory. Users can create as
             * many networks as they need and use them simultaneously (up to the limitation of the hardware resources).
             * Use the ie_exec_network_free() method to free memory.
             * @ingroup Core
             * @param core A pointer to the ie_core_t instance.
            ...
            /**
             * @brief Creates an executable network from a given network object. Users can create as many networks as
             * they need and use them simultaneously (up to the limitation of the hardware resources). Use the
            ...
            /**
             * @brief Reads model and creates an executable network from IR or ONNX file. Users can create as many
             * networks as they need and use them simultaneously (up to the limitation of the hardware resources). Use
             * the ie_exec_network_free() method to free memory.
             * @ingroup Core
             * @param core A pointer to the ie_core_t instance.
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_core_unregister_plugin(ie_core_t* core, const char* device_name);
            ...
            /**
             * @brief Gets general runtime metric for dedicated hardware. The method is needed to request common device
             * properties which are executable network agnostic. It can be device name, temperature, other
             * devices-specific values.
             * @ingroup Core
             * @param core A pointer to ie_core_t instance.
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_core_get_metric(const ie_core_t* core,
                               const char* device_name,
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_core_get_config(const ie_core_t* core,
                               const char* device_name,
            ...
            /**
             * @brief Creates an inference request instance used to infer the network. The created request has allocated
             * input and output blobs (that can be changed later). Use the ie_infer_request_free() method to free
             * memory.
             * @ingroup ExecutableNetwork
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_exec_network_create_infer_request(ie_executable_network_t* ie_exec_network,
             ...
             * when the network run on the Multi device and the configuration parameter is only can be
             ...
             * @param blob A pointer to input or output blob. The type of Blob must match the network input precision
             * and size.
             * @return Status code of the operation: OK(0) for success.
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
             ...
             * @param infer_request A pointer to ie_infer_request_t instance.
             * @param name Name of input or output blob.
             * @param blob Reference to input or output blob. The type of a blob must match the network input precision
             * and size.
             * @return Status code of the operation: OK(0) for success.
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_infer_request_infer_async(ie_infer_request_t* infer_request);
            ...
            /**
             * @brief Waits for the result to become available. Blocks until specified timeout elapses or the result
            ...
            /**
             * @brief When network is loaded into the Infernece Engine, it is not required anymore and should be
             * released
             * @ingroup Network
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_network_get_name(const ie_network_t* network, char** name);
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_network_get_input_precision(const ie_network_t* network,
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_network_set_input_resize_algorithm(ie_network_t* network,
                                                  const char* input_name,
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_network_get_color_format(const ie_network_t* network,
                                        const char* input_name,
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_network_set_color_format(ie_network_t* network,
                                        const char* input_name,
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_network_get_output_precision(const ie_network_t* network,
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_blob_make_memory_from_preallocated(const tensor_desc_t* tensorDesc,
                                                  void* ptr,
                                                  size_t size,
                                                  ie_blob_t** blob);
             ...
             * @ingroup Blob
             * @param blob A pointer to the blob.
             * @param blob_cbuffer A pointer to the coped data from the given pointer to the blob and the data is
             * read-only.
             * @return Status code of the operation: OK(0) for success
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_blob_get_dims(const ie_blob_t* blob, dimensions_t* dims_result);
             ...
             */
            INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode)
            ie_blob_get_layout(const ie_blob_t* blob, layout_e* layout_result);
            ...
            /**
             * @brief Shut down the OpenVINO by deleting all static-duration objects allocated by the library and
             * releasing dependent resources
             *
             * @note This function should be used by advanced user to control unload the resources.
             *
             * You might want to use this function if you are developing a dynamically-loaded library which should clean
             * up all resources after itself when the library is unloaded.
             */
