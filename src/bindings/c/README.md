 ...
 * [include](./include) contains all provided C API headers. [Learn more](https://docs.openvino.ai/2026/api/api_reference.html).
...
* [How to integrate OpenVINO C API with Your Application](https://docs.openvino.ai/2026/openvino-workflow/running-inference.html)
 ...
 * [OpenVINO Runtime C API User Guide](https://docs.openvino.ai/2026/openvino-workflow/running-inference.html)
