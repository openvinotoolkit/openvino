...
class PipInstallCommand(BaseCommand):
    ...
    name = "pip-install"  # TODO: consider changing to "install" to override original one
    ...
    def handle(self, project, options):
        ...
        # TODO: think about enable_write_lockfile to sync with pip-lock
        # project.enable_write_lockfile = True  # set --no-lock if False
        options.no_self = True  # set --no-self if True
...
def register(core: Core) -> None:
    core.register_command(PipInstallCommand)
