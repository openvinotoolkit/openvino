...
function( cython_add_module _name )
  ...
  if(PYTHON_MODULE_EXTENSION)
    ...
    if (Python3_SOABI AND NOT PYTHON_MODULE_EXTENSION STREQUAL ".${Python3_SOABI}${CMAKE_SHARED_MODULE_SUFFIX}")
      message(FATAL_ERROR "Python3_SOABI (${Python3_SOABI}) and PYTHON_MODULE_EXTENSION (${PYTHON_MODULE_EXTENSION}) are not equal")
    endif()
