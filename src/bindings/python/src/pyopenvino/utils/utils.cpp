...
py::object from_ov_any(const ov::Any& any) {
    ...
    } else if (any.is<ov::hint::AttnKernelMode>()) {
        return py::cast(any.as<ov::hint::AttnKernelMode>());
...
ov::Any py_object_to_any(const py::object& py_obj) {
    ...
    } else if (py::isinstance<ov::hint::AttnKernelMode>(py_obj)) {
        return py::cast<ov::hint::AttnKernelMode>(py_obj);
