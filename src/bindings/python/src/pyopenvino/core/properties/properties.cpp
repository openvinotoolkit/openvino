...
void regmodule_properties(py::module m) {
    ...
    // Submodule intel_cpu
    py::module m_intel_cpu = m_properties.def_submodule(
        "intel_cpu", "openvino.runtime.properties.intel_cpu submodule that "
                     "simulates ov::intel_cpu");

    // Submodule intel_cpu property
    wrap_property_RW(m_intel_cpu, ov::intel_cpu::denormals_optimization,
