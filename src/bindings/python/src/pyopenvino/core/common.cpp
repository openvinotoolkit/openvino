    ...
    for (py::handle dim : shape) {
        if (py::isinstance<py::int_>(dim)) {
            ...
            if (!(py::isinstance<py::int_>(bounded_dim[0]) && py::isinstance<py::int_>(bounded_dim[1]))) {
                throw py::type_error("Incorrect pair of types (" + std::string(py::str(bounded_dim[0])) + ", " +
                                     std::string(py::str(bounded_dim[1])) +
            ...
            throw py::type_error("Incorrect type " + std::string(py::str(dim)) +
