...
void regclass_graph_op_Loop(py::module m) {
    ...
    cls.def(
        py::init([](ov::Node& trip_count, ov::Node& execution_condition) {
            auto checkNode = [](ov::Node& node) -> bool {
                if (std::string(node.get_type_name()) == "Constant" || std::string(node.get_type_name()) == "Parameter")
                    return true;
                else
                    return false;
            };

            if (checkNode(trip_count) && checkNode(execution_condition)) {
    ...
    cls.def(
        ...
        [](ov::op::v5::Loop& self, py::list& special_body_ports) {
    ...
    cls.def("get_special_body_ports", [](ov::op::v5::Loop& self) -> py::list {
        py::list result;
    ...
    cls.def("get_function", [](ov::op::v5::Loop& self) {
        return self.get_function();
    });

    cls.def(
        "set_function",
        [](ov::op::v5::Loop& self, const std::shared_ptr<ov::Model>& func) {
            self.set_function(func);
        },
        py::arg("func"));

    cls.def("get_output_descriptions", [](ov::op::v5::Loop& self) -> py::list {
        py::list result;
    ...
    cls.def("get_input_descriptions", [](ov::op::v5::Loop& self) -> py::list {
        py::list result;
    ...
    cls.def(
        ...
        [](ov::op::v5::Loop& self, py::list& inputs) {
    ...
    cls.def(
        ...
        [](ov::op::v5::Loop& self, py::list outputs) {
