...
public:
    ...
    std::shared_ptr<InputDescription> copy() const override {
        PYBIND11_OVERRIDE_PURE(std::shared_ptr<ov::op::util::MultiSubGraphOp::InputDescription>, ov::op::util::MultiSubGraphOp::InputDescription, copy, );
    }
...
public:
    ...
    std::shared_ptr<OutputDescription> copy() const override {
        PYBIND11_OVERRIDE_PURE(std::shared_ptr<ov::op::util::MultiSubGraphOp::OutputDescription>, ov::op::util::MultiSubGraphOp::OutputDescription, copy, );
    }
...
void regclass_graph_op_util_MultiSubgraphOp(py::module m) {
    ...
    py::class_<ov::op::util::MultiSubGraphOp::InputDescription, std::shared_ptr<ov::op::util::MultiSubGraphOp::InputDescription>, PyInputDescription> input(m, "InputDescription");
    input.doc() = "ov::op::util::MultiSubGraphOp::InputDescription wraps ov::op::util::MultiSubGraphOp::InputDescription";
    input.def(py::init<>());
    input.def("copy", &ov::op::util::MultiSubGraphOp::InputDescription::copy);

    py::class_<ov::op::util::MultiSubGraphOp::SliceInputDescription, std::shared_ptr<ov::op::util::MultiSubGraphOp::SliceInputDescription>, ov::op::util::MultiSubGraphOp::InputDescription>(m, "SliceInputDescription")
            .def(py::init<>())
            ...
            .def_readonly("body_parameter_index", &ov::op::util::MultiSubGraphOp::SliceInputDescription::m_body_parameter_index)
    ...
    py::class_<ov::op::util::MultiSubGraphOp::MergedInputDescription, std::shared_ptr<ov::op::util::MultiSubGraphOp::MergedInputDescription>, ov::op::util::MultiSubGraphOp::InputDescription> merged(m, "MergedInputDescription");
            ...
            merged.def_readonly("body_parameter_index", &ov::op::util::MultiSubGraphOp::MergedInputDescription::m_body_parameter_index);
            merged.def_readonly("body_value_index", &ov::op::util::MultiSubGraphOp::MergedInputDescription::m_body_value_index);

    py::class_<ov::op::util::MultiSubGraphOp::InvariantInputDescription, std::shared_ptr<ov::op::util::MultiSubGraphOp::InvariantInputDescription>, ov::op::util::MultiSubGraphOp::InputDescription>(m, "InvariantInputDescription")
            .def(py::init<>())
            ...
            .def_readonly("body_parameter_index", &ov::op::util::MultiSubGraphOp::InvariantInputDescription::m_body_parameter_index);
    

    py::class_<ov::op::util::MultiSubGraphOp::OutputDescription, std::shared_ptr<ov::op::util::MultiSubGraphOp::OutputDescription>, PyOutputDescription> output(m, "OutputDescription");
    output.doc() = "ov::op::util::MultiSubGraphOp::OutputDescription wraps ov::op::util::MultiSubGraphOp::OutputDescription";
    output.def(py::init<>());
    output.def("copy", &ov::op::util::MultiSubGraphOp::OutputDescription::copy);

    py::class_<ov::op::util::MultiSubGraphOp::ConcatOutputDescription, std::shared_ptr<ov::op::util::MultiSubGraphOp::ConcatOutputDescription>, ov::op::util::MultiSubGraphOp::OutputDescription>(m, "ConcatOutputDescription")
            .def(py::init<>())
            .def(py::init<uint64_t&, uint64_t&, int64_t&, int64_t&, int64_t&, int64_t&, int64_t&>(),
                 py::arg("body_value_index"),
                 py::arg("output_index"),
    ...
    py::class_<ov::op::util::MultiSubGraphOp::BodyOutputDescription, std::shared_ptr<ov::op::util::MultiSubGraphOp::BodyOutputDescription>, ov::op::util::MultiSubGraphOp::OutputDescription>(m, "BodyOutputDescription")
            .def(py::init<>())
            ...
            .def_readonly("input_index", &ov::op::util::MultiSubGraphOp::BodyOutputDescription::m_output_index)
