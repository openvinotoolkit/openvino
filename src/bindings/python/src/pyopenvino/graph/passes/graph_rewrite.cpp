...
void regclass_passes_GraphRewrite(py::module m) {
    ...
    graph_rewrite.doc() =
        "openvino.runtime.passes.GraphRewrite execute sequence of MatcherPass transformations in topological order";
    ...
    back_graph_rewrite.doc() = "openvino.runtime.passes.BackwardGraphRewrite execute sequence of MatcherPass "
