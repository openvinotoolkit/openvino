...
void regclass_GraphRewrite(py::module m) {
    ...
    graph_rewrite.def("add_matcher", static_cast<std::shared_ptr<ov::pass::MatcherPass> (ov::pass::GraphRewrite::*)(const std::shared_ptr<ov::pass::MatcherPass>&)>(&ov::pass::GraphRewrite::add_matcher));

    py::class_<ov::pass::BackwardGraphRewrite,
            std::shared_ptr<ov::pass::BackwardGraphRewrite>,
            ov::pass::GraphRewrite,
            ov::pass::ModelPass,
            ov::pass::PassBase> back_graph_rewrite(m, "BackwardGraphRewrite");
    back_graph_rewrite.doc() = "openvino.runtime.passes.BackwardGraphRewrite execute sequence of MatcherPass transformations in reversed topological order";
    ...
    back_graph_rewrite.def("add_matcher", static_cast<std::shared_ptr<ov::pass::MatcherPass> (ov::pass::BackwardGraphRewrite::*)(const std::shared_ptr<ov::pass::MatcherPass>&)>(&ov::pass::BackwardGraphRewrite::add_matcher));
}
