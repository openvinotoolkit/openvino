...
void regclass_transformations(py::module m) {
    py::class_<ov::pass::Serialize, std::shared_ptr<ov::pass::Serialize>,
               ov::pass::ModelPass, ov::pass::PassBase> serialize(m, "Serialize");
    ...
    py::class_<ov::pass::ConstantFolding, std::shared_ptr<ov::pass::ConstantFolding>,
               ov::pass::ModelPass, ov::pass::PassBase> cf(m, "ConstantFolding");
    cf.doc() = "openvino.runtime.passes.ConstantFolding transformation";
    cf.def(py::init<>());

    py::class_<ov::pass::VisualizeTree, std::shared_ptr<ov::pass::VisualizeTree>,
            ov::pass::ModelPass, ov::pass::PassBase> visualize(m, "VisualizeTree");
    ...
    py::class_<ov::pass::MakeStateful, std::shared_ptr<ov::pass::MakeStateful>,
            ov::pass::ModelPass, ov::pass::PassBase> make_stateful(m, "MakeStateful");
    ...
    py::class_<ov::pass::LowLatency2, std::shared_ptr<ov::pass::LowLatency2>,
            ov::pass::ModelPass, ov::pass::PassBase> low_latency(m, "LowLatency2");
    ...
    py::class_<ov::pass::ConvertFP32ToFP16, std::shared_ptr<ov::pass::ConvertFP32ToFP16>,
            ov::pass::ModelPass, ov::pass::PassBase> convert(m, "ConvertFP32ToFP16");
