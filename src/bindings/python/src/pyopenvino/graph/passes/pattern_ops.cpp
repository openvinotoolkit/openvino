...
using NewPredicate = const ov::pass::pattern::op::Predicate;
...
static void reg_pattern_wrap_type(py::module m) {
    py::class_<ov::pass::pattern::op::WrapType, std::shared_ptr<ov::pass::pattern::op::WrapType>, ov::Node> wrap_type(
        m,
        "WrapType");
    wrap_type.doc() = "openvino.passes.WrapType wraps ov::pass::pattern::op::WrapType";
    ...
    wrap_type.def(py::init([](const std::string& type_name, const ov::Output<ov::Node>& input, const NewPredicate& pred) {
                      return std::make_shared<ov::pass::pattern::op::WrapType>(get_type(type_name),
                                                                               pred,
                                                                               ov::OutputVector{input});
                  }),
    ...
    wrap_type.def(
        py::init([](const std::string& type_name, const std::shared_ptr<ov::Node>& input, const NewPredicate& pred) {
            return std::make_shared<ov::pass::pattern::op::WrapType>(get_type(type_name),
                                                                     pred,
                                                                     ov::OutputVector{input});
        }),
    ...
    wrap_type.def(
        py::init(
            [](const std::vector<std::string>& type_names, const ov::Output<ov::Node>& input, const NewPredicate& pred) {
                return std::make_shared<ov::pass::pattern::op::WrapType>(get_types(type_names),
                                                                         pred,
                                                                         ov::OutputVector{input});
            }),
    ...
    wrap_type.def(
        py::init([](const std::vector<std::string>& type_names, const ov::OutputVector& inputs, const NewPredicate& pred) {
            return std::make_shared<ov::pass::pattern::op::WrapType>(get_types(type_names), pred, inputs);
        }),
        py::arg("type_names"),
        py::arg("inputs"),
    ...
    wrap_type.def(
        py::init([](const std::vector<std::string>& type_names, const ov::NodeVector& inputs, const NewPredicate& pred) {
            return std::make_shared<ov::pass::pattern::op::WrapType>(get_types(type_names),
                                                                     pred,
                                                                     ov::as_output_vector(inputs));
        }),
...
static void reg_pattern_or(py::module m) {
    ...
    or_type.doc() = "openvino.passes.Or wraps ov::pass::pattern::op::Or";
...
static void reg_pattern_any_input(py::module m) {
    py::class_<ov::pass::pattern::op::Label, std::shared_ptr<ov::pass::pattern::op::Label>, ov::Node> any_input(
        m,
        "AnyInput");
    any_input.doc() = "openvino.passes.AnyInput wraps ov::pass::pattern::op::Label";
...
static void reg_pattern_optional(py::module m) {
    ...
    optional_type.doc() = "openvino.passes.Optional wraps ov::pass::pattern::op::Optional";
    ...
    optional_type.def(
        py::init(
            [](const std::vector<std::string>& type_names, const ov::OutputVector& inputs, const NewPredicate& pred) {
...
inline void reg_predicates(py::module m) {
    ...
    m.def("rank_more_than", &ov::pass::pattern::rank_more_than);
