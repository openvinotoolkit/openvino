...
PartialFunction: typing._CallableGenericAlias  # value = typing.Callable[..., openvino.utils.node_factory.NodeFactory]
ScalarData: typing._UnionGenericAlias  # value = typing.Union[int, float]
TensorShape: typing._GenericAlias  # value = typing.List[int]
_get_node_factory_opset1: functools.partial  # value = functools.partial(<function _get_node_factory at 0x7f34ebd8b640>, 'opset1')
