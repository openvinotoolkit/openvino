...
def moc_emit_ir(ngraph_function: Model, argv: argparse.Namespace):
    ...
    from openvino.runtime.utils.moc_frontend.offline_transformations import apply_user_transformations, apply_moc_transformations, \
    ...
    if argv.compress_to_fp16:
        from openvino.runtime.utils.moc_frontend.offline_transformations import compress_model
