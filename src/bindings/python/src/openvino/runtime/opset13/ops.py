...
def multinomial(
    ...
    :param probs: Tensor with probabilities of shape [class_size] or [batch_size, class_size].
    :param num_samples: Tensor (scalar or 1D) with the lower bound on the range of random values to generate.
