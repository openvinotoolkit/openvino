...
from openvino.tools.mo_lite.utils.clean_utils import create_params_with_custom_types
from openvino.tools.mo_lite.utils.cli_parser import parse_transform
...
def apply_offline_transformations(func: Model, argv: argparse.Namespace):
    from openvino.tools.mo_lite.utils.preprocessing import apply_preprocessing  # pylint: disable=no-name-in-module,import-error
