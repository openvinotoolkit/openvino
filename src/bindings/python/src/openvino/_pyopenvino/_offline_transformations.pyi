...
def convert_sequence_to_tensor_iterator_transformation(model: typing.Any) -> None:
    ...
def paged_attention_transformation(model: typing.Any, use_block_indices_inputs: bool = False, use_score_outputs: bool = False, allow_score_aggregation: bool = False, allow_cache_rotation: bool = False, allow_xattention: bool = False, allow_adaptive_rkv: bool = False) -> None:
    ...
