...
def auto_batch_timeout() -> str:
    ...
@typing.overload
def auto_batch_timeout(arg0: typing.SupportsInt | typing.SupportsIndex) -> tuple[str, openvino._pyopenvino.OVAny]:
    ...
...
def compilation_num_threads() -> str:
    ...
@typing.overload
def compilation_num_threads(arg0: typing.SupportsInt | typing.SupportsIndex) -> tuple[str, openvino._pyopenvino.OVAny]:
    ...
@typing.overload
def enable_mmap() -> str:
    ...
...
def inference_num_threads() -> str:
    ...
@typing.overload
def inference_num_threads(arg0: typing.SupportsInt | typing.SupportsIndex) -> tuple[str, openvino._pyopenvino.OVAny]:
    ...
@typing.overload
def key_cache_group_size() -> str:
    ...
@typing.overload
def key_cache_group_size(arg0: typing.SupportsInt | typing.SupportsIndex) -> tuple[str, openvino._pyopenvino.OVAny]:
    ...
@typing.overload
...
def value_cache_group_size() -> str:
    ...
@typing.overload
def value_cache_group_size(arg0: typing.SupportsInt | typing.SupportsIndex) -> tuple[str, openvino._pyopenvino.OVAny]:
    ...
@typing.overload
