...
import openvino.pyopenvino.offline_transformations as _base

# TODO: add "serialize transformation" as deprecated

@deprecated(version="2023.1", message="The module is private and following namespace `offline_transformations` will be removed in the future, use `openvino.pass.Manager` instead!")
