...
def test_serialize_complex_rt_info(request):
    def check_rt_info(m, serialized):
        if serialized:
            threshold = '13.23'
            min_val = '-3.24543'
            max_val = '3.23422'
        ...
        assert m.has_rt_info(["config", "type_of_model"]) is True
        assert m.has_rt_info(["config", "converter_type"]) is True
        assert m.has_rt_info(["config", "model_parameters", "threshold"]) is True
        assert m.has_rt_info(["config", "model_parameters", "min"]) is True
        assert m.has_rt_info(["config", "model_parameters", "max"]) is True
        assert m.has_rt_info(["config", "model_parameters", "labels", "label_tree", "type"]) is True
        assert m.has_rt_info(["config", "model_parameters", "labels", "label_tree", "directed"]) is True
        assert m.has_rt_info(["config", "model_parameters", "labels", "label_tree", "float_empty"]) is True
        assert m.has_rt_info(["config", "model_parameters", "labels", "label_tree", "nodes"]) is True
        assert m.has_rt_info(["config", "model_parameters", "labels", "label_groups", "ids"]) is True
        assert m.has_rt_info(["config", "model_parameters", "mean_values"]) is True

        assert m.get_rt_info(["config", "type_of_model"]) == "classification"
        assert m.get_rt_info(["config", "converter_type"]) == "classification"
        assert m.get_rt_info(["config", "model_parameters", "threshold"]) == threshold
        assert m.get_rt_info(["config", "model_parameters", "min"]) == min_val
        assert m.get_rt_info(["config", "model_parameters", "max"]) == max_val
        assert m.get_rt_info(["config", "model_parameters", "labels", "label_tree", "type"]) == "tree"
        assert m.get_rt_info(["config", "model_parameters", "labels", "label_tree", "directed"]) == directed
        assert m.get_rt_info(["config", "model_parameters", "labels", "label_tree", "float_empty"]) == empty
        assert m.get_rt_info(["config", "model_parameters", "labels", "label_tree", "nodes"]) == empty
