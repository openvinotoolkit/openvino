...
tests_expected_to_fail = [
    ...
    (
        ...
        "OnnxBackendNodeModelTest.test_layer_normalization_2d_axis_negative_2_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_3d_axis0_epsilon_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_3d_axis1_epsilon_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_3d_axis2_epsilon_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_3d_axis_negative_1_epsilon_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_3d_axis_negative_2_epsilon_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_3d_axis_negative_3_epsilon_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_4d_axis0_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_4d_axis1_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_4d_axis2_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_4d_axis3_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_4d_axis_negative_1_cpu",
        "OnnxBackendNodeModelTest.test_layer_normalization_4d_axis_negative_2_cpu",
