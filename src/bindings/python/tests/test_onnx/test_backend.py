...
tests_expected_to_fail = [
    ...
    (
        xfail_issue_XXX11,
        "OnnxBackendNodeModelTest.test_reduce_l1",
        "OnnxBackendNodeModelTest.test_reduce_l2",
        "OnnxBackendNodeModelTest.test_reduce_log_sum",
        "OnnxBackendNodeModelTest.test_reduce_log_sum_exp",
        "OnnxBackendNodeModelTest.test_reduce_sum_square",
    ),
    (
        xfail_issue_XXX12,
