...
# openvino                         - namespace - no version methods
# openvino.utils                   - not a package - no version provided
# openvino.tools                   - namespace - no version methods
# openvino.pyopenvino              - pybind, provides only get_version method
# openvino.inference_engine        - \/ \/
# openvino.offline_transformations - Remaining entries are proper packages
# openvino.frontend                - with__version__ attribute and
# openvino.preprocess              - get_version method provided
# openvino.runtime                 - /\ /\
# ====================================
