...
xfail_issue_33488 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
                                      "MaxUnpool")
skip_issue_38084 = pytest.mark.skip(reason="Aborted (core dumped) Assertion "
                                           "`(layer->get_output_partial_shape(i).is_static())' failed.")
xfail_issue_33589 = xfail_test(reason="graph does not support the following ONNX operations: "
                                      "IsNaN and isInf")
xfail_issue_33595 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
                                      "Unique")
xfail_issue_33596 = xfail_test(reason="RuntimeError: graph does not support different sequence operations: "
                                      "ConcatFromSequence, SequenceConstruct, SequenceAt, SplitToSequence, "
                                      "SequenceEmpty, SequenceInsert, SequenceErase, SequenceLength ")
xfail_issue_33606 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
                                      "Det")
xfail_issue_33651 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
                                      "TfIdfVectorizer")
xfail_issue_33581 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
                                      "GatherElements")
...
xfail_issue_38699 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
...
xfail_issue_38713 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
...
xfail_issue_38734 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
                                      "ai.onnx.preview.training.Adam")
xfail_issue_38735 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
...
# Model MSFT issues:
xfail_issue_37957 = xfail_test(reason="RuntimeError: graph does not support the following ONNX operations: "
