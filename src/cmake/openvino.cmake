...
set_source_files_properties(${legacy_src} PROPERTIES
    INCLUDE_DIRECTORIES $<TARGET_PROPERTY:inference_engine_legacy,INTERFACE_INCLUDE_DIRECTORIES>)
...
target_include_directories(${TARGET_NAME}_s PUBLIC
    ...
    $<BUILD_INTERFACE:${OpenVINO_SOURCE_DIR}/src/common/transformations/include>
    $<BUILD_INTERFACE:${OpenVINO_SOURCE_DIR}/src/common/low_precision_transformations/include>
    $<BUILD_INTERFACE:$<TARGET_PROPERTY:inference_engine_legacy,SOURCE_DIR>/src>)

if(WIN32)
    set_target_properties(${TARGET_NAME}_s PROPERTIES COMPILE_PDB_NAME ${TARGET_NAME}_s)
endif()

target_link_libraries(${TARGET_NAME}_s PRIVATE openvino::itt pugixml::static)
...
add_library(inference_engine_s ALIAS ${TARGET_NAME}_s)
