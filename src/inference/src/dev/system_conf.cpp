...
bool check_openmp_env_vars(bool include_omp_num_threads) {
...
// for Linux and Windows the get_number_of_cpu_cores (that accounts only for physical cores) implementation is
// OS-specific (see cpp files in corresponding folders), for __APPLE__ it is default :
