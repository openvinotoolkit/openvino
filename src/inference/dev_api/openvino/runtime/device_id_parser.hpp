...
public:
    ...
    static std::vector<std::string> get_hetero_devices(std::string fallbackDevice);
    static std::vector<std::string> get_multi_devices(std::string devicesList);
    static std::string get_batch_device(std::string devicesList);
};
