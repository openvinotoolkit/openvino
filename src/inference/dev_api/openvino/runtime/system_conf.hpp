...
/**
 * @brief      Sets the flag indicating whether HBM memory exist in the system.
 * @ingroup    ov_dev_api_system_conf
 * @param[in]  input_flag input value of flag.
 */
OPENVINO_RUNTIME_API void set_hbm_flag(const bool input_flag);
