...
LinuxCpuMapTestCase cache_HBM_cache_0 = {
    160,
    2,
    2,
    80,
    {{160, 80, 0, 80, -1, -1}, {80, 40, 0, 40, 0, 0}, {80, 40, 0, 40, 1, 1}},
    {
        {0, 0, 0, 0, HYPER_THREADING_PROC, 0, -1},    {1, 0, 0, 1, HYPER_THREADING_PROC, 1, -1},
        {2, 0, 0, 2, HYPER_THREADING_PROC, 2, -1},    {3, 0, 0, 3, HYPER_THREADING_PROC, 3, -1},
        {4, 0, 0, 4, HYPER_THREADING_PROC, 4, -1},    {5, 0, 0, 5, HYPER_THREADING_PROC, 5, -1},
        ...
        {76, 1, 1, 76, HYPER_THREADING_PROC, 76, -1}, {77, 1, 1, 77, HYPER_THREADING_PROC, 77, -1},
        {78, 1, 1, 78, HYPER_THREADING_PROC, 78, -1}, {79, 1, 1, 79, HYPER_THREADING_PROC, 79, -1},
        {80, 0, 0, 0, MAIN_CORE_PROC, 0, -1},         {81, 0, 0, 1, MAIN_CORE_PROC, 1, -1},
        {82, 0, 0, 2, MAIN_CORE_PROC, 2, -1},         {83, 0, 0, 3, MAIN_CORE_PROC, 3, -1},
        {84, 0, 0, 4, MAIN_CORE_PROC, 4, -1},         {85, 0, 0, 5, MAIN_CORE_PROC, 5, -1},
        {86, 0, 0, 6, MAIN_CORE_PROC, 6, -1},         {87, 0, 0, 7, MAIN_CORE_PROC, 7, -1},
        {88, 0, 0, 8, MAIN_CORE_PROC, 8, -1},         {89, 0, 0, 9, MAIN_CORE_PROC, 9, -1},
        {90, 0, 0, 10, MAIN_CORE_PROC, 10, -1},       {91, 0, 0, 11, MAIN_CORE_PROC, 11, -1},
        {92, 0, 0, 12, MAIN_CORE_PROC, 12, -1},       {93, 0, 0, 13, MAIN_CORE_PROC, 13, -1},
        {94, 0, 0, 14, MAIN_CORE_PROC, 14, -1},       {95, 0, 0, 15, MAIN_CORE_PROC, 15, -1},
        {96, 0, 0, 16, MAIN_CORE_PROC, 16, -1},       {97, 0, 0, 17, MAIN_CORE_PROC, 17, -1},
        {98, 0, 0, 18, MAIN_CORE_PROC, 18, -1},       {99, 0, 0, 19, MAIN_CORE_PROC, 19, -1},
        {100, 0, 0, 20, MAIN_CORE_PROC, 20, -1},      {101, 0, 0, 21, MAIN_CORE_PROC, 21, -1},
        {102, 0, 0, 22, MAIN_CORE_PROC, 22, -1},      {103, 0, 0, 23, MAIN_CORE_PROC, 23, -1},
        {104, 0, 0, 24, MAIN_CORE_PROC, 24, -1},      {105, 0, 0, 25, MAIN_CORE_PROC, 25, -1},
        {106, 0, 0, 26, MAIN_CORE_PROC, 26, -1},      {107, 0, 0, 27, MAIN_CORE_PROC, 27, -1},
        {108, 0, 0, 28, MAIN_CORE_PROC, 28, -1},      {109, 0, 0, 29, MAIN_CORE_PROC, 29, -1},
        {110, 0, 0, 30, MAIN_CORE_PROC, 30, -1},      {111, 0, 0, 31, MAIN_CORE_PROC, 31, -1},
        {112, 0, 0, 32, MAIN_CORE_PROC, 32, -1},      {113, 0, 0, 33, MAIN_CORE_PROC, 33, -1},
        {114, 0, 0, 34, MAIN_CORE_PROC, 34, -1},      {115, 0, 0, 35, MAIN_CORE_PROC, 35, -1},
        {116, 0, 0, 36, MAIN_CORE_PROC, 36, -1},      {117, 0, 0, 37, MAIN_CORE_PROC, 37, -1},
        {118, 0, 0, 38, MAIN_CORE_PROC, 38, -1},      {119, 0, 0, 39, MAIN_CORE_PROC, 39, -1},
        {120, 1, 1, 40, MAIN_CORE_PROC, 40, -1},      {121, 1, 1, 41, MAIN_CORE_PROC, 41, -1},
        {122, 1, 1, 42, MAIN_CORE_PROC, 42, -1},      {123, 1, 1, 43, MAIN_CORE_PROC, 43, -1},
        {124, 1, 1, 44, MAIN_CORE_PROC, 44, -1},      {125, 1, 1, 45, MAIN_CORE_PROC, 45, -1},
        {126, 1, 1, 46, MAIN_CORE_PROC, 46, -1},      {127, 1, 1, 47, MAIN_CORE_PROC, 47, -1},
        {128, 1, 1, 48, MAIN_CORE_PROC, 48, -1},      {129, 1, 1, 49, MAIN_CORE_PROC, 49, -1},
        {130, 1, 1, 50, MAIN_CORE_PROC, 50, -1},      {131, 1, 1, 51, MAIN_CORE_PROC, 51, -1},
        {132, 1, 1, 52, MAIN_CORE_PROC, 52, -1},      {133, 1, 1, 53, MAIN_CORE_PROC, 53, -1},
        {134, 1, 1, 54, MAIN_CORE_PROC, 54, -1},      {135, 1, 1, 55, MAIN_CORE_PROC, 55, -1},
        {136, 1, 1, 56, MAIN_CORE_PROC, 56, -1},      {137, 1, 1, 57, MAIN_CORE_PROC, 57, -1},
        {138, 1, 1, 58, MAIN_CORE_PROC, 58, -1},      {139, 1, 1, 59, MAIN_CORE_PROC, 59, -1},
        {140, 1, 1, 60, MAIN_CORE_PROC, 60, -1},      {141, 1, 1, 61, MAIN_CORE_PROC, 61, -1},
        {142, 1, 1, 62, MAIN_CORE_PROC, 62, -1},      {143, 1, 1, 63, MAIN_CORE_PROC, 63, -1},
        {144, 1, 1, 64, MAIN_CORE_PROC, 64, -1},      {145, 1, 1, 65, MAIN_CORE_PROC, 65, -1},
        {146, 1, 1, 66, MAIN_CORE_PROC, 66, -1},      {147, 1, 1, 67, MAIN_CORE_PROC, 67, -1},
        {148, 1, 1, 68, MAIN_CORE_PROC, 68, -1},      {149, 1, 1, 69, MAIN_CORE_PROC, 69, -1},
        {150, 1, 1, 70, MAIN_CORE_PROC, 70, -1},      {151, 1, 1, 71, MAIN_CORE_PROC, 71, -1},
        {152, 1, 1, 72, MAIN_CORE_PROC, 72, -1},      {153, 1, 1, 73, MAIN_CORE_PROC, 73, -1},
        {154, 1, 1, 74, MAIN_CORE_PROC, 74, -1},      {155, 1, 1, 75, MAIN_CORE_PROC, 75, -1},
        {156, 1, 1, 76, MAIN_CORE_PROC, 76, -1},      {157, 1, 1, 77, MAIN_CORE_PROC, 77, -1},
        {158, 1, 1, 78, MAIN_CORE_PROC, 78, -1},      {159, 1, 1, 79, MAIN_CORE_PROC, 79, -1},
    },
    {
        {"0,80", "0,80", "0-39,80-119"},       {"1,81", "1,81", "0-39,80-119"},
        {"2,82", "2,82", "0-39,80-119"},       {"3,83", "3,83", "0-39,80-119"},
        {"4,84", "4,84", "0-39,80-119"},       {"5,85", "5,85", "0-39,80-119"},
        {"6,86", "6,86", "0-39,80-119"},       {"7,87", "7,87", "0-39,80-119"},
        {"8,88", "8,88", "0-39,80-119"},       {"9,89", "9,89", "0-39,80-119"},
        {"10,90", "10,90", "0-39,80-119"},     {"11,91", "11,91", "0-39,80-119"},
        {"12,92", "12,92", "0-39,80-119"},     {"13,93", "13,93", "0-39,80-119"},
