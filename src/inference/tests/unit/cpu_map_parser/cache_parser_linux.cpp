...
LinuxCpuMapTestCase cache_1sockets_16cores = {
    ...
    {{16, 4, 8, 4, 0, 0, 0}},
    {
        {0, 0, 0, 0, MAIN_CORE_PROC, 0, -1},  {1, 0, 0, 1, MAIN_CORE_PROC, 1, -1},
        {2, 0, 0, 2, MAIN_CORE_PROC, 2, -1},        {3, 0, 0, 3, MAIN_CORE_PROC, 3, -1},
        {4, 0, 0, 4, EFFICIENT_CORE_PROC, 4, -1},        {5, 0, 0, 5, EFFICIENT_CORE_PROC, 4, -1},
        {6, 0, 0, 6, EFFICIENT_CORE_PROC, 4, -1},  {7, 0, 0, 7, EFFICIENT_CORE_PROC, 4, -1},
        {8, 0, 0, 8, EFFICIENT_CORE_PROC, 5, -1},  {9, 0, 0, 9, EFFICIENT_CORE_PROC, 5, -1},
        {10, 0, 0, 10, EFFICIENT_CORE_PROC, 5, -1}, {11, 0, 0, 11, EFFICIENT_CORE_PROC, 5, -1},
        {12, 0, 0, 12, LP_EFFICIENT_CORE_PROC, 6, -1},  {13, 0, 0, 13, LP_EFFICIENT_CORE_PROC, 6, -1},
        {14, 0, 0, 14, LP_EFFICIENT_CORE_PROC, 6, -1},  {15, 0, 0, 15, LP_EFFICIENT_CORE_PROC, 6, -1},
    },
    {
        {"0", "0", "0-11"},  {"1", "1", "0-11"},  {"2", "2", "0-11"},     {"3", "3", "0-11"},
        {"4", "4-7", "0-11"},  {"5", "4-7", "0-11"},  {"6", "4-7", "0-11"},     {"7", "4-7", "0-11"},
        {"8", "8-11", "0-11"},  {"9", "8-11", "0-11"},  {"10", "8-11", "0-11"}, {"11", "8-11", "0-11"},
        {"12", "12-15", ""}, {"13", "12-15", ""}, {"14", "12-15", ""},    {"15", "12-15", ""},
    },
    {
        {"0-15"},
    },
