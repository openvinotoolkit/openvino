...
TEST_F(NetworkContext_CalcFileInfoTests, NoFile) {
    ASSERT_NE(ov::util::ModelCache::calculate_file_info("notexisting.abc"),
              ov::util::ModelCache::calculate_file_info("notexisting2.abc"));

    std::string fileName(100, 'a');
    std::string fileName2(fileName);
    ASSERT_EQ(ov::util::ModelCache::calculate_file_info(fileName),
              ov::util::ModelCache::calculate_file_info(fileName2));
}

TEST_F(NetworkContext_CalcFileInfoTests, ExistingFile) {
    ASSERT_EQ(ov::util::ModelCache::calculate_file_info(m_fileName),
              ov::util::ModelCache::calculate_file_info(m_fileName));
}

TEST_F(NetworkContext_CalcFileInfoTests, ExistingDiffFiles) {
    auto hash1 = ov::util::ModelCache::calculate_file_info(m_fileName);
    std::string newName = m_fileName + "2";
    std::rename(m_fileName.c_str(), newName.c_str());
    m_fileName = std::move(newName);
    auto hash2 = ov::util::ModelCache::calculate_file_info(m_fileName);
...
TEST_F(NetworkContext_CalcFileInfoTests, ExistingFile_sameAbsPath) {
    ...
    ASSERT_EQ(ov::util::ModelCache::calculate_file_info(file1), ov::util::ModelCache::calculate_file_info(file2))
        << "Hash of [" << file1 << "] is not equal to hash of [" << file2 << "]";
}

TEST_F(NetworkContext_CalcFileInfoTests, DateModified) {
    auto info1 = ov::util::ModelCache::calculate_file_info(m_fileName);
    std::this_thread::sleep_for(std::chrono::seconds(2));
    createFile(m_fileName);
    auto info2 = ov::util::ModelCache::calculate_file_info(m_fileName);
...
static void checkCustomRt(const std::function<void(Node::RTMap&)>& emptyCb,
    ...
    emptyCb(op2);
    ASSERT_NE(ov::util::ModelCache::compute_hash(model1, {}), ov::util::ModelCache::compute_hash(model2, {}));

    emptyCb(op1);
    ASSERT_EQ(ov::util::ModelCache::compute_hash(model1, {}), ov::util::ModelCache::compute_hash(model2, {}));
...
TEST(NetworkContext, HashWithConfig) {
    ...
    ASSERT_NE(ov::util::ModelCache::compute_hash(net1, {{"key", "value"}}),
              ov::util::ModelCache::compute_hash(net2, {}));
    ASSERT_EQ(ov::util::ModelCache::compute_hash(net1, {{"key", "value"}}),
              ov::util::ModelCache::compute_hash(net2, {{"key", "value"}}));
}
...
TEST(NetworkContext, HashWithPrimitivesPriority) {
    ...
    ASSERT_NE(ov::util::ModelCache::compute_hash(net1, {}), ov::util::ModelCache::compute_hash(net2, {}));
    ASSERT_NE(ov::util::ModelCache::compute_hash(net2, {}), ov::util::ModelCache::compute_hash(net3, {}));
}
...
TEST(NetworkContext, HashWithAffinity) {
    ...
    ASSERT_EQ(ov::util::ModelCache::compute_hash(net2, {}), ov::util::ModelCache::compute_hash(net3, {}));
}
...
TEST(NetworkContext, HashWithFutureRt_string) {
    ...
    ASSERT_EQ(ov::util::ModelCache::compute_hash(net1, {}), ov::util::ModelCache::compute_hash(net2, {}));
...
TEST(NetworkContext, HashWithTensorNames) {
    ...
    ASSERT_EQ(ov::util::ModelCache::compute_hash(fun1, {}), ov::util::ModelCache::compute_hash(fun2, {}));

    ASSERT_NE(ov::util::ModelCache::compute_hash(fun2, {}), ov::util::ModelCache::compute_hash(fun3, {}));
}
...
TEST(NetworkContext, HashOfSameMultiThreading) {
    ...
    auto threadFun = [&](int& count) {
        do {
            count++;
            auto hash1 = ov::util::ModelCache::compute_hash(net1, {});
            auto hash2 = ov::util::ModelCache::compute_hash(net2, {});
            if (hash1 != hash2) {
                fail = true;
                break;
            }
...
TEST(NetworkContext_ModelName, HashOfSame) {
    ASSERT_EQ(ov::util::ModelCache::compute_hash("model1", {}), ov::util::ModelCache::compute_hash("model1", {}));

    ASSERT_NE(ov::util::ModelCache::compute_hash("model1", {}), ov::util::ModelCache::compute_hash("model2", {}));

    ASSERT_NE(ov::util::ModelCache::compute_hash("model1", {{"key", "value"}}),
              ov::util::ModelCache::compute_hash("model1", {}));

    ASSERT_EQ(ov::util::ModelCache::compute_hash("model1", {{"key", "value"}}),
              ov::util::ModelCache::compute_hash("model1", {{"key", "value"}}));
}
...
TEST(NetworkContext_ModelName, HashOfExistingFile) {
    ...
    ASSERT_EQ(ov::util::ModelCache::compute_hash(file1, {}), ov::util::ModelCache::compute_hash(file1, {}));

    ASSERT_EQ(ov::util::ModelCache::compute_hash(file1, {}), ov::util::ModelCache::compute_hash(file2, {}));

    ASSERT_NE(ov::util::ModelCache::compute_hash(file1, {{"key", "value"}}),
              ov::util::ModelCache::compute_hash(file2, {}));

    ASSERT_EQ(ov::util::ModelCache::compute_hash(file1, {{"key", "value"}}),
              ov::util::ModelCache::compute_hash(file2, {{"key", "value"}}));
}
...
TEST(NetworkContext, HashOfSameModelWithClone) {
    ...
    ASSERT_EQ(ov::util::ModelCache::compute_hash(model1, {}), ov::util::ModelCache::compute_hash(model1_clone, {}));
    ...
    ASSERT_EQ(ov::util::ModelCache::compute_hash(model2, {}), ov::util::ModelCache::compute_hash(model2_clone, {}));
}