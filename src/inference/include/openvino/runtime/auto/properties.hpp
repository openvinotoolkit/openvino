...
/**
 * @brief auto device saves the hash id of the blob file for each device and its existence status
 */
static constexpr Property<std::map<std::string, std::pair<std::string, bool>>> devices_blob_hash_id{"DEVICES_BLOB_HASH_ID"};
