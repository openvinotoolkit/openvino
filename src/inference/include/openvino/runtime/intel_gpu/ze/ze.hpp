...
using gpu_handle_param = ov::intel_gpu::ocl::gpu_handle_param;
...
public:
     ...
     */
    ov::intel_gpu::ocl::ClBufferTensor create_tensor(const element::Type type,
                                                     const Shape& shape,
                                                     VirtualAddressMemory buffer) {
        ...
        return create_tensor(type, shape, params).as<ov::intel_gpu::ocl::ClBufferTensor>();
    }
};
