...
BWDCMP_RTTI_DEFINITION(ov::op::v0::AUGRUCell);

ov::op::v0::AUGRUCell::AUGRUCell() : m_linear_before_reset(false) {
    m_activations = {"sigmoid", "tanh"};
    m_activation_f = get_activation_function(0);
    m_activation_g = get_activation_function(1);
}

ov::op::v0::AUGRUCell::AUGRUCell(const Output<Node>& X,
...
shared_ptr<Node> ov::op::v0::AUGRUCell::clone_with_new_inputs(const OutputVector& new_args) const {
