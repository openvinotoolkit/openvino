...
BWDCMP_RTTI_DEFINITION(ov::op::v0::AUGRUSequence);

ov::op::v0::AUGRUSequence::AUGRUSequence()
    : m_direction(op::RecurrentSequenceDirection::FORWARD),
    m_linear_before_reset(false) {}

ov::op::v0::AUGRUSequence::AUGRUSequence(const Output<Node>& X,
...
void ov::op::v0::AUGRUSequence::validate_and_infer_types() {
...
bool ov::op::v0::AUGRUSequence::visit_attributes(AttributeVisitor& visitor) {
...
shared_ptr<Node> ov::op::v0::AUGRUSequence::clone_with_new_inputs(const OutputVector& new_args) const {
