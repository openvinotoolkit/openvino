...
bool op::v8::RandomUniform::evaluate(const HostTensorVector& outputs, const HostTensorVector& inputs) const {
    ...
    if (inputs[0]->get_element_type() == element::Type_t::u64) {
        ...
        OPENVINO_THROW_NORETURN("Unsupported type of out shape in RandomUniform operation: " +
    ...
    case element::Type_t::f64:
        ...
        break;
    default:
        OPENVINO_THROW_NORETURN("Unsupported type of RandomUniform: " + get_out_type().get_type_name());
    }
