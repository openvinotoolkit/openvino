...
BWDCMP_RTTI_DEFINITION(ov::op::v2::ReorgYolo);
...
void op::ReorgYolo::validate_and_infer_types() {
    NGRAPH_OP_SCOPE(v2_ReorgYolo_validate_and_infer_types);
