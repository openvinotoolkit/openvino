...
BWDCMP_RTTI_DEFINITION(ov::op::v2::ROIPooling);
...
void op::ROIPooling::validate_and_infer_types() {
    NGRAPH_OP_SCOPE(v2_ROIPooling_validate_and_infer_types);
...
shared_ptr<Node> op::ROIPooling::clone_with_new_inputs(const OutputVector& new_args) const {
    NGRAPH_OP_SCOPE(v2_ROIPooling_clone_with_new_inputs);
...
bool op::ROIPooling::visit_attributes(AttributeVisitor& visitor) {
    NGRAPH_OP_SCOPE(v2_ROIPooling_visit_attributes);
