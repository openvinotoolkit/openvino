...
BWDCMP_RTTI_DEFINITION(ov::op::v1::FakeQuantize);
...
void op::FakeQuantize::validate_and_infer_types() {
    NGRAPH_OP_SCOPE(v1_FakeQuantize_validate_and_infer_types);
...
bool ov::op::v1::FakeQuantize::visit_attributes(AttributeVisitor& visitor) {
    NGRAPH_OP_SCOPE(v1_FakeQuantize_visit_attributes);
...
shared_ptr<Node> op::FakeQuantize::clone_with_new_inputs(const OutputVector& new_args) const {
    NGRAPH_OP_SCOPE(v1_FakeQuantize_clone_with_new_inputs);
...
bool evaluate(const HostTensorPtr& arg0,
    ...
    NGRAPH_OP_SCOPE(v1_FakeQuantize_evaluate);
...
bool ngraph::op::FakeQuantize::has_evaluate() const {
    NGRAPH_OP_SCOPE(v1_FakeQuantize_has_evaluate);
