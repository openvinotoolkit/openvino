...
void SelectiveSSM::validate_and_infer_types() {
    ...
    for (size_t i = 1; i < get_input_size(); ++i) {
        NODE_VALIDATION_CHECK(this,
                              ov::element::Type::merge(common_float_type, common_float_type, get_input_element_type(i)),
                              "SelectiveSSM expects all real-valued inputs to have the same element type.");
    }
