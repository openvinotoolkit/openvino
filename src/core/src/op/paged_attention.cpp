...
void PagedAttentionExtension::validate_and_infer_types() {
    ...
    NODE_VALIDATION_CHECK(this,
                          get_input_size() == 25 || get_input_size() == 26,
                          "PagedAttensionExtension expects 25 or 26 inputs, but it has ",
                          get_input_size());
    ...
    if (get_input_size() == 26) {
        input_check(this, 25, "token_type_ids", {1}, {element::i32});
    }
