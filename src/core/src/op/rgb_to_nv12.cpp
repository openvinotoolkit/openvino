...
ov::op::v16::RGBtoNV12::RGBtoNV12(const Output<Node>& arg)
    : util::ConvertColorToNV12Base(arg, util::ConvertColorToNV12Base::ColorConversion::RGB_TO_NV12) {
    constructor_validate_and_infer_types();
}

ov::op::v16::RGBtoNV12::RGBtoNV12(const Output<Node>& arg, bool single_plane)
    : util::ConvertColorToNV12Base(arg, util::ConvertColorToNV12Base::ColorConversion::RGB_TO_NV12, single_plane) {
    constructor_validate_and_infer_types();
}

std::shared_ptr<ov::Node> ov::op::v16::RGBtoNV12::clone_with_new_inputs(const OutputVector& new_args) const {
    OV_OP_SCOPE(v16_RGBtoNV12_clone_with_new_inputs);
