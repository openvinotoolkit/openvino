...
bool evaluate_clamp(const HostTensorPtr& arg, const HostTensorPtr& out, double min, double max) {
    ...
    switch (arg->get_element_type()) {
        ...
        (arg,
         out,
         ngraph::double_to_int<int8_t>(min, ceil_func),
         ngraph::double_to_int<int8_t>(max, floor_func),
         count);
        break;
        TYPE_CASE(i16)
        (arg,
         out,
         ngraph::double_to_int<int16_t>(min, ceil_func),
         ngraph::double_to_int<int16_t>(max, floor_func),
         count);
        break;
        TYPE_CASE(i32)
        (arg,
         out,
         ngraph::double_to_int<int32_t>(min, ceil_func),
         ngraph::double_to_int<int32_t>(max, floor_func),
         count);
        break;
        TYPE_CASE(i64)
        (arg,
         out,
         ngraph::double_to_int<int64_t>(min, ceil_func),
         ngraph::double_to_int<int64_t>(max, floor_func),
         count);
        break;
        TYPE_CASE(u8)
        (arg,
         out,
         ngraph::double_to_int<uint8_t>(min, ceil_func),
         ngraph::double_to_int<uint8_t>(max, floor_func),
         count);
        break;
        TYPE_CASE(u16)
        (arg,
         out,
         ngraph::double_to_int<uint16_t>(min, ceil_func),
         ngraph::double_to_int<uint16_t>(max, floor_func),
         count);
        break;
        TYPE_CASE(u32)
        (arg,
         out,
         ngraph::double_to_int<uint32_t>(min, ceil_func),
         ngraph::double_to_int<uint32_t>(max, floor_func),
         count);
        break;
        TYPE_CASE(u64)
        (arg,
         out,
         ngraph::double_to_int<uint64_t>(min, ceil_func),
