...
bool RotRPEAttentionWeightWithIndexComputation::has_evaluate() const {
    return true;
}
...
bool RotRPEProjectValueWithIndexComputation::has_evaluate() const {
    return true;
}

// template class ov::Evaluator<ov::op::v5::RotRPEAttentionWeightWithIndexComputation>;
