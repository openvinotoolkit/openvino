...
Mamba2::Mamba2(const Output<Node>& A,
...
void Mamba2::validate_and_infer_types() {
    ...
    NODE_VALIDATION_CHECK(this, get_input_size() == 6, "Mamba2 expects 6 inputs, but it has ", get_input_size());
    ...
    mamba2_input_check(this, 0, "A", {1}, float_types);
    mamba2_input_check(this, 1, "dt", {3}, float_types);
    mamba2_input_check(this, 2, "B", {4}, float_types);
    mamba2_input_check(this, 3, "x", {4}, float_types);
    mamba2_input_check(this, 4, "C", {4}, float_types);
    mamba2_input_check(this, 5, "recurrent_state", {4}, float_types);

    const auto output_shapes = shape_infer(this, ov::util::get_node_input_partial_shapes(*this));
    // output has the per-token data type derived from `x`; output state keeps the recurrent_state type
