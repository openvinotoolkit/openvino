...
void PagedSelectiveSSM::validate_and_infer_types() {
    ...
    for (size_t i = 1; i < 6; ++i) {
        float_types_merge &= ov::element::Type::merge(common_float_type, common_float_type, get_input_element_type(i));
    }
    NODE_VALIDATION_CHECK(this,
                          float_types_merge,
                          "PagedSelectiveSSM expects all real-valued inputs to have the same element type.");
    NODE_VALIDATION_CHECK(this,
    ...
    for (size_t i = 6; i < 11; ++i) {
        ...
        NODE_VALIDATION_CHECK(this,
                              ov::element::Type::merge(common_index_type, common_index_type, et),
                              "PagedSelectiveSSM expects all index inputs to have the same element type.");
    }
