...
#define CONSTANT_FILL_DATA(ET, SRC_TYPE)                                             \
    template <>                                                                      \
    void Constant::fill_data<element::Type_t::ET, SRC_TYPE>(const SRC_TYPE& value) { \
...
#define CONSTANT_CAST_VECTOR(ET, DST_TYPE)                                                           \
    template <>                                                                                      \
    void Constant::cast_vector<element::Type_t::ET, DST_TYPE>(std::vector<DST_TYPE> & output_vector, \
...
#define CONSTANT_WRITE_BUFFER(ET, SRC_TYPE)                                                           \
    template <>                                                                                       \
    void Constant::write_buffer<element::Type_t::ET, SRC_TYPE>(const std::vector<SRC_TYPE>& source) { \
