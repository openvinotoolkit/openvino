...
#define _OPENVINO_OP_REG(NAME, NAMESPACE) opset.get_factory()->registerImplIfRequired(opset_factory, NAME, NAMESPACE::NAME::get_type_info_static(), []() {return new NAMESPACE::NAME();}); \
