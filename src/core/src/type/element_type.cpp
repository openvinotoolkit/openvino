...
inline TypeInfo get_type_info(ov::element::Type_t type) {
    switch(type) {
        case ov::element::Type_t::undefined : return {std::numeric_limits<size_t>::max(), false, false, false, "undefined", "undefined"};
        case ov::element::Type_t::dynamic : return {0, false, false, false, "dynamic", "dynamic"};
        case ov::element::Type_t::boolean : return {8, false, true, false, "char", "boolean"};
        case ov::element::Type_t::bf16 : return {16, true, true, false, "bfloat16", "bf16"};
        case ov::element::Type_t::f16 : return {16, true, true, false, "float16", "f16"};
        case ov::element::Type_t::f32 : return {32, true, true, false, "float", "f32"};
        case ov::element::Type_t::f64 : return {64, true, true, false, "double", "f64"};
        case ov::element::Type_t::i4 : return {4, false, true, true, "int4_t", "i4"};
        case ov::element::Type_t::i8 : return {8, false, true, true, "int8_t", "i8"};
        case ov::element::Type_t::i16 : return {16, false, true, false, "int16_t", "i16"};
        case ov::element::Type_t::i32 : return {32, false, true, true, "int32_t", "i32"};
        case ov::element::Type_t::i64 : return {64, false, true, false, "int64_t", "i64"};
        case ov::element::Type_t::u1 : return {1, false, false, false, "uint1_t", "u1"};
        case ov::element::Type_t::u4 : return {4, false, false, false, "uint4_t", "u4"};
        case ov::element::Type_t::u8 : return {8, false, false, true, "uint8_t", "u8"};
        case ov::element::Type_t::u16 : return {16, false, false, false, "uint16_t", "u16"};
        case ov::element::Type_t::u32 : return {32, false, false, false, "uint32_t", "u32"};
        case ov::element::Type_t::u64 : return {64, false, false, false, "uint64_t", "u64"};
        default : OPENVINO_UNREACHABLE("ov::element::Type_t not supported: ", type);
    }
};
}  // namespace
