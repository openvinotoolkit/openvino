...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        IsSizePreservingSliceParams{inf, {0, 0}, {i64_max, i64_max}, 1, true},
        ...
        // a start/stop bound one away from the INT64_MIN/INT64_MAX sentinel still clips for every length up to
        // max_length (max_length - 1 away from the sentinel in the opposite direction of the check)
