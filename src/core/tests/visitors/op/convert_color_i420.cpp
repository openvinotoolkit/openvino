...
TEST(attributes, convert_color_i420_rgb) {
    ...
    auto data = make_shared<op::v1::Parameter>(element::u8, Shape{3, 720, 640, 1});
...
TEST(attributes, convert_color_i420_rgb_3planes) {
    NodeBuilder::get_ops().register_factory<op::v8::I420toRGB>();
    auto data1 = make_shared<op::v1::Parameter>(element::u8, Shape{3, 480, 640, 1});
    auto data2 = make_shared<op::v1::Parameter>(element::u8, Shape{3, 240, 320, 1});
    auto data3 = make_shared<op::v1::Parameter>(element::u8, Shape{3, 240, 320, 1});
