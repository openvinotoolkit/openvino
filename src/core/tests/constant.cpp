...
TEST(constant, boolean_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({1}));
}
...
TEST(constant, float_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_lower_value().get_strides(), Strides({4}));
}
...
TEST(constant, double_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::f64.size()}));
}
...
TEST(constant, int4_string) {
    ...
    EXPECT_THROW(c.get_output_tensor(0).get_lower_value().get_strides(), Exception);
}
...
TEST(constant, int8_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::i8.size()}));
}
...
TEST(constant, int16_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::i16.size()}));
}
...
TEST(constant, uint8_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::u8.size()}));
}
...
TEST(constant, uint16_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::u16.size()}));
}
...
TEST(constant, uint32_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::u32.size()}));
}
...
TEST(constant, uint64_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::u64.size()}));
}
...
TEST(constant, bfloat16_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::bf16.size()}));
}
...
TEST(constant, float16_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::f16.size()}));
}
...
TEST(constant, ov_string) {
    ...
    EXPECT_EQ(c.get_output_tensor(0).get_upper_value().get_strides(), Strides({element::string.size()}));
}
...
TEST(constant, hold_tensor) {
    ...
    EXPECT_EQ(constOp->get_output_tensor(0).get_lower_value().get_strides(), Strides({72, 36, 12, 4}));
}
...
TEST(constant, hold_tensor_custom_strides) {
    ...
    EXPECT_EQ(const_op->get_output_tensor(0).get_lower_value().get_strides(), strides);
}
