...
TEST(type_prop, scaled_dot_product_attention_static_5_inputs) {
    const auto query = std::make_shared<op::v0::Parameter>(element::f32, Shape{2, 3, 4});
    const auto key = std::make_shared<op::v0::Parameter>(element::f32, Shape{2, 5, 4});
    const auto value = std::make_shared<op::v0::Parameter>(element::f32, Shape{2, 5, 6});
...
TEST(type_prop, scaled_dot_product_attention_static_5_inputs_extra_batch) {
    const auto query = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 7, 3, 4});
...
TEST(type_prop, scaled_dot_product_attention_static_4_inputs_extra_batch) {
    const auto query = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 7, 3, 4});
    const auto key = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{7, 5, 4});
...
TEST(type_prop, scaled_dot_product_attention_static_3_inputs_extra_batch) {
    const auto query = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{7, 3, 4});
    const auto key = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 7, 5, 4});
    const auto value = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 7, 5, 6});
    auto causal = false;
...
TEST(type_prop, scaled_dot_product_attention_static_ignored_attention_mask_extra_batch) {
    const auto query = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 7, 3, 4});
    const auto key = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 1, 5, 4});
    const auto value = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 7, 5, 6});
    const auto attention_mask = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{7, 8, 9, 10, 11});
    const auto scale = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{});
    auto causal = true;
...
TEST(type_prop, scaled_dot_product_attention_mixed_shape_infer_5_inputs) {
    ...
    const auto query = std::make_shared<op::v0::Parameter>(element::dynamic, query_shape);
    const auto key = std::make_shared<op::v0::Parameter>(element::f64, key_shape);
    const auto value = std::make_shared<op::v0::Parameter>(element::dynamic, value_shape);
...
TEST(type_prop, scaled_dot_product_attention_mixed_shape_infer_5_inputs_ignore_attention) {
    const auto query = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape{{1, 4}, 3, {1, 5}, 4});
    const auto key = std::make_shared<op::v0::Parameter>(element::f64, PartialShape{{4, 8}, {1, 4}, 5, 4});
    const auto value = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape{{2, 4}, 3, 5, {3, 7}});
...
TEST(type_prop, scaled_dot_product_attention_type_infer_5_inputs) {
    ...
    const auto key = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape{2, 5, 4});
...
TEST(type_prop, scaled_dot_product_attention_type_infer_4_inputs) {
    const auto query = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape{2, 3, 4});
    const auto key = std::make_shared<op::v0::Parameter>(element::f64, PartialShape{2, 5, 4});
    const auto value = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape{2, 5, 6});
...
TEST(type_prop, scaled_dot_product_attention_static_broadcast_attention_L) {
    const auto query = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 8, 16, 32});
    const auto key = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 8, 48, 32});
    const auto value = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 8, 48, 64});
...
TEST(type_prop, scaled_dot_product_attention_dyn_broadcast_attention_L) {
    const auto query = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 8, {8, -1}, 32});
    const auto key = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 8, -1, 32});
    const auto value = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 8, -1, 64});
...
TEST(type_prop, scaled_dot_product_unsupported_key_shape) {
    const auto query = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 3, 4});
    const auto key = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{3, 5, 4});
    const auto value = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 5, 6});
...
TEST(type_prop, scaled_dot_product_unsupported_dtype) {
    const auto query = std::make_shared<op::v0::Parameter>(element::i32, PartialShape{2, 3, 4});
    const auto key = std::make_shared<op::v0::Parameter>(element::i32, PartialShape{2, 5, 4});
    const auto value = std::make_shared<op::v0::Parameter>(element::i32, PartialShape{2, 5, 6});
