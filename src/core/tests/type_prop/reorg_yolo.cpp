...
TEST_F(TypePropReorgYoloTest, default_ctor) {
    const auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 4, {13, 16}, 4});
...
TEST_F(TypePropReorgYoloTest, stride_2) {
    ...
    size_t stride = 2;
    auto data_param = std::make_shared<op::v0::Parameter>(element::f32, in_shape);
...
TEST_F(TypePropReorgYoloTest, data_shape_not_compatible_rank_4) {
    const auto data_param = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 1, {13, 14}, 4});
...
TEST_F(TypePropReorgYoloTest, h_dim_not_div_by_stride) {
    const auto data_param = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 9, 13, 3});
...
TEST_F(TypePropReorgYoloTest, w_dim_not_div_by_stride) {
    const auto data_param = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 9, 6, 4});
...
TEST_F(TypePropReorgYoloTest, channels_lower_than_sq_stride) {
    const auto data_param = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 8, 6, 6});
