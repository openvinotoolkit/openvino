...
TEST(type_prop, matmul_propagate_labels) {
    const auto a_labels = std::vector<ov::label_t>{1, 0, 2, 5, 6};
    const auto b_labels = std::vector<ov::label_t>{0, 1, 3, 7, 9};
...
TEST(type_prop, matmul_propagate_labels_on_interval_dims) {
    const auto a_labels = std::vector<ov::label_t>{1, 0, 3, 4, 5};
    const auto b_labels = std::vector<ov::label_t>{0, 1, 3, 4, 7};
