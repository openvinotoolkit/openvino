...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        RDFTConstantAxesAndConstantSignalSizeTestParams{{Dimension(0, 2), Dimension(7, 500), Dimension(7, 500)},
                                                        ...
                                                        {1, 2},
                                                        {}},
        RDFTConstantAxesAndConstantSignalSizeTestParams{{2, 180, 180}, {2}, {2}, {2, 91, 39, 2}, {1, 2}, {-1, 77}},
        RDFTConstantAxesAndConstantSignalSizeTestParams{{2, 180, 180}, {2}, {2}, {44, 180, 196, 2}, {2, 0}, {390, 87}},
