...
TEST(type_prop, grid_sample_default_attributes) {
    ...
    const auto grid = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 10, 10, 2});
...
TEST(type_prop, grid_sample_dynamic_batch) {
    const auto data = make_shared<op::v0::Parameter>(element::i32, PartialShape{Dimension::dynamic(), 3, 224, 224});
    const auto grid = make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic(), 10, 10, 2});
    const auto grid_sample = make_shared<op::v9::GridSample>(data, grid, op::v9::GridSample::Attributes{});
...
TEST(type_prop, grid_sample_interval_dims_and_labels) {
    ...
    const auto data = make_shared<op::v0::Parameter>(element::i32, data_pshape);
...
TEST(type_prop, grid_sample_dynamic_output_spatials) {
    const auto data = make_shared<op::v0::Parameter>(element::i32, PartialShape{2, 3, 224, 224});
    const auto grid =
        make_shared<op::v0::Parameter>(element::f64, PartialShape{2, Dimension::dynamic(), Dimension::dynamic(), 2});
    const auto grid_sample = make_shared<op::v9::GridSample>(data, grid, op::v9::GridSample::Attributes{});
...
TEST(type_prop, grid_sample_unsupported_grid_element_type) {
    const auto data = make_shared<op::v0::Parameter>(element::i32, PartialShape{1, 3, 224, 224});
    const auto grid = make_shared<op::v0::Parameter>(element::i64, PartialShape{1, 5, 5, 2});
    EXPECT_THROW(op::v9::GridSample(data, grid, op::v9::GridSample::Attributes{}), ov::NodeValidationFailure);
}

TEST(type_prop, grid_sample_incorrect_last_dim_in_grid) {
    const auto data = make_shared<op::v0::Parameter>(element::i32, PartialShape{1, 3, 224, 224});
    const auto grid = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 5, 5, 5});
    EXPECT_THROW(op::v9::GridSample(data, grid, op::v9::GridSample::Attributes{}), ov::NodeValidationFailure);
}

TEST(type_prop, grid_sample_all_dimensions_dynamic_in_grid) {
    const auto data = make_shared<op::v0::Parameter>(element::i32, PartialShape{1, 3, 224, 224});
    const auto grid = make_shared<op::v0::Parameter>(
        element::f32,
...
TEST(type_prop, grid_sample_all_dimensions_dynamic_in_data) {
    const auto data = make_shared<op::v0::Parameter>(
        element::f16,
        PartialShape{Dimension::dynamic(), Dimension::dynamic(), Dimension::dynamic(), Dimension::dynamic()});
    const auto grid = make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic(), 3, 5, 2});
    const auto grid_sample = make_shared<op::v9::GridSample>(data, grid, op::v9::GridSample::Attributes{});
    EXPECT_TRUE(grid_sample->get_output_partial_shape(0).same_scheme(
...
TEST(type_prop, grid_sample_dynamic_input_rank) {
    ...
    const auto grid = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 5, 5, 2});
    const auto grid_sample = make_shared<op::v9::GridSample>(data, grid, op::v9::GridSample::Attributes{});
