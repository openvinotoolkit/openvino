...
TEST(type_prop, augru_cell) {
    ...
    const auto augru_cell = make_shared<op::v3::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
...
TEST(type_prop, augru_cell_invalid_input) {
    ...
    try {
        const auto gru_cell = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
...
TEST(type_prop, augru_cell_dynamic_batch_size) {
    ...
    const auto augru_cell = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
    EXPECT_EQ(augru_cell->get_output_element_type(0), element::f32);
...
TEST(type_prop, augru_cell_invalid_input_rank) {
    ...
    ASSERT_THROW(const auto unused = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size),
...
TEST(type_prop, augru_cell_invalid_input_dynamic_rank) {
    ...
    auto check_dynamic_gru = [](const shared_ptr<opset9::AUGRUCell>& augru) -> bool {
    ...
    auto augru_w = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
    ...
    auto augru_x = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
    ...
    auto augru_h = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
    ...
    auto augru_r = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
    ...
    auto augru_b = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
    ...
    auto augru_a = make_shared<opset9::AUGRUCell>(X, H_t, W, R, B, A, hidden_size);
