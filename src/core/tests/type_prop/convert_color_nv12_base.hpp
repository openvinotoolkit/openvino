...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_single_tensor)
{
    ...
    auto param = std::make_shared<op::v1::Parameter>(element::f32, param_shape);
...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_single_tensor_dynamic_dims)
{
    ...
    auto param = std::make_shared<op::v1::Parameter>(element::u8, param_shape);
    auto op = std::make_shared<TypeParam>(param);
    ASSERT_EQ(op->output(0).get_partial_shape(), out_shape);
...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_single_tensor_dynamic_type)
{
    ...
    auto param = std::make_shared<op::v1::Parameter>(element::dynamic, param_shape);
    auto op = std::make_shared<TypeParam>(param);
    ASSERT_EQ(op->output(0).get_partial_shape(), out_shape);
...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_single_tensor_error_i8)
{
    ...
    auto param = std::make_shared<op::v1::Parameter>(element::i8, param_shape);
    EXPECT_THROW(std::make_shared<TypeParam>(param), ov::AssertFailure);
}
...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_2_plane_simple)
{
    ...
    auto param_y = std::make_shared<op::v1::Parameter>(element::u8, param_shape_y);
    auto param_uv = std::make_shared<op::v1::Parameter>(element::u8, param_shape_uv);
...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_2_plane_dynamic)
{
    ...
    auto out_shape = PartialShape{Dimension::dynamic(), Dimension::dynamic(), Dimension::dynamic(), 3};
    auto param_y = std::make_shared<op::v1::Parameter>(element::f32, param_shape_y);
    auto param_uv = std::make_shared<op::v1::Parameter>(element::f32, param_shape_uv);
    auto op = std::make_shared<TypeParam>(param_y, param_uv);
    ASSERT_EQ(op->output(0).get_partial_shape(), out_shape);
    ASSERT_EQ(op->output(0).get_element_type(), element::f32);
}
...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_2_plane_y_dynamic)
{
    ...
    auto param_y = std::make_shared<op::v1::Parameter>(element::bf16, param_shape_y);
    auto param_uv = std::make_shared<op::v1::Parameter>(element::bf16, param_shape_uv);
    auto op = std::make_shared<TypeParam>(param_y, param_uv);
    ASSERT_EQ(op->output(0).get_partial_shape(), out_shape);
...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_2_plane_uv_dynamic)
{
    ...
    auto param_y = std::make_shared<op::v1::Parameter>(element::f16, param_shape_y);
    auto param_uv = std::make_shared<op::v1::Parameter>(element::f16, param_shape_uv);
    auto op = std::make_shared<TypeParam>(param_y, param_uv);
    ASSERT_EQ(op->output(0).get_partial_shape(), out_shape);
...
TYPED_TEST_P(ConvertNV12BaseTest, shape_inference_2_plane_dynamic_types)
{
    ...
    auto param_y = std::make_shared<op::v1::Parameter>(y_type, param_shape_y);
    auto param_uv = std::make_shared<op::v1::Parameter>(uv_type, param_shape_uv);
    auto op = std::make_shared<TypeParam>(param_y, param_uv);
    ASSERT_EQ(op->output(0).get_partial_shape(), out_shape);
...
{
    auto param_y = std::make_shared<op::v1::Parameter>(element::u8, PartialShape::dynamic());
    auto param_uv = std::make_shared<op::v1::Parameter>(element::f32, PartialShape::dynamic());
...
{
    auto param_y = std::make_shared<op::v1::Parameter>(element::dynamic, PartialShape::dynamic());
    auto param_uv = std::make_shared<op::v1::Parameter>(element::i8, PartialShape::dynamic());
    EXPECT_THROW(std::make_shared<TypeParam>(param_y, param_uv), ov::AssertFailure);
}
...
{
    auto param_y = std::make_shared<op::v1::Parameter>(element::dynamic, PartialShape::dynamic());
    auto param_u = std::make_shared<op::v1::Parameter>(element::dynamic, PartialShape::dynamic());
    auto param_v = std::make_shared<op::v1::Parameter>(element::dynamic, PartialShape::dynamic());
