...
TEST_F(AdaptiveMaxPoolV8Test, default_ctor) {
    const auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 6, 3, 2});
    const auto out_shape = op::v0::Constant::create<int64_t>(element::i64, Shape{2}, {5, 7});
...
TEST_F(AdaptiveMaxPoolV8Test, shape_infer) {
    const auto data = make_shared<op::v0::Parameter>(element::f64, Shape{2, 6, 3, 2, 10});
    const auto out_shape = op::v0::Constant::create<int64_t>(element::i64, Shape{3}, {5, 7, 1});
...
TEST_F(AdaptiveMaxPoolV8Test, i32_indices) {
    ...
    const auto out_shape = op::v0::Constant::create<int32_t>(element::i32, Shape{2}, {7, 1});
...
TEST_F(AdaptiveMaxPoolV8Test, dynamic_batch) {
    ...
    const auto out_shape = op::v0::Constant::create<int64_t>(element::i64, Shape{2}, {9, 9});
    const auto op = make_op(data, out_shape);
...
TEST_F(AdaptiveMaxPoolV8Test, dynamic_output_shape) {
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 6, 8, 9, 2});
    auto out_shape = make_shared<op::v0::Parameter>(element::i64, PartialShape::dynamic());
    const auto op = make_op(data, out_shape);
...
TEST_F(AdaptiveMaxPoolV8Test, output_shape_as_parameter) {
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 6, 8, 9, 2});
    auto out_shape = make_shared<op::v0::Parameter>(element::i64, PartialShape{3});
    const auto op = make_op(data, out_shape);
...
TEST_F(AdaptiveMaxPoolV8Test, data_dynamic_rank) {
    ...
    auto out_shape = make_shared<op::v0::Parameter>(element::i32, Shape{3});
    const auto op = make_op(data, out_shape);
...
TEST_F(AdaptiveMaxPoolV8Test, out_spatial_shape_size_not_match_data_spatial_dimensions) {
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 3, 5, 6});
    auto out_shape = make_shared<op::v0::Parameter>(element::i32, Shape{3});
...
TEST_F(AdaptiveMaxPoolV8Test, preserve_partial_values_and_symbols_on_output_shape_input) {
    ...
    const auto data = make_shared<op::v0::Parameter>(element::f32, data_shape);
    const auto spatial_dim_shape = make_shared<op::v3::ShapeOf>(make_shared<op::v0::Parameter>(element::i64, out_shape));
...
TEST_F(AdaptiveMaxPoolV8Test, unsupported_input_shape) {
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 6});
    auto out_shape = op::v0::Constant::create<int64_t>(element::i64, Shape{}, {1});
...
TEST_F(AdaptiveMaxPoolV8Test, wrong_out_shape) {
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 6, 8, 9});
    auto out_shape = op::v0::Constant::create<int64_t>(element::i64, Shape{3}, {5, 7, 8});
...
TEST_F(AdaptiveMaxPoolV8Test, wrong_index_element_type) {
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 6, 8, 9});
    auto out_shape = op::v0::Constant::create<int64_t>(element::i16, Shape{2}, {5, 7});
