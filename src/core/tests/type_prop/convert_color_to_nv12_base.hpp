...
TYPED_TEST_P(ConvertToNV12BaseTest, shape_inference_single_plane_default_ctor) {
    auto param_shape = ov::PartialShape{5, 4, 6, 3};
...
TYPED_TEST_P(ConvertToNV12BaseTest, shape_inference_two_plane) {
    auto param_shape = ov::PartialShape{1, 480, 640, 3};
    ...
    EXPECT_EQ(op->output(1).get_element_type(), ov::element::u8);
...
TYPED_TEST_P(ConvertToNV12BaseTest, shape_inference_two_plane_small) {
    auto param_shape = ov::PartialShape{2, 4, 6, 3};
...
TYPED_TEST_P(ConvertToNV12BaseTest, shape_inference_single_plane_interval_dims) {
    auto param_shape = ov::PartialShape{{2, 10}, {4, 20}, 8, 3};
    auto symbols = set_shape_symbols(param_shape);
...
TYPED_TEST_P(ConvertToNV12BaseTest, shape_inference_two_plane_dynamic_dims) {
    auto param_shape = ov::PartialShape{ov::Dimension::dynamic(), ov::Dimension::dynamic(), 8, 3};
    auto expected_y_shape = ov::PartialShape{ov::Dimension::dynamic(), ov::Dimension::dynamic(), 8, 1};
...
TYPED_TEST_P(ConvertToNV12BaseTest, shape_inference_two_plane_interval_dims_and_symbols) {
    auto param_shape = ov::PartialShape{{2, 10}, {4, 20}, {6, 12}, 3};
    auto symbols = set_shape_symbols(param_shape);

    auto expected_y_shape = ov::PartialShape{{2, 10}, {4, 20}, {6, 12}, 1};
...
TYPED_TEST_P(ConvertToNV12BaseTest, shape_inference_two_plane_dynamic_type) {
    auto param_shape = ov::PartialShape{1, 480, 640, 3};
    auto out_y_shape = ov::PartialShape{1, 480, 640, 1};
    ...
    EXPECT_EQ(op->output(0).get_element_type(), ov::element::dynamic);
    EXPECT_EQ(op->output(1).get_element_type(), ov::element::dynamic);
