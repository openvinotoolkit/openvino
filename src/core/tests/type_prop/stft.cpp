...
INSTANTIATE_TEST_SUITE_P(
    ...
    TypePropSTFTTestP,
    testing::Values(
        std::make_tuple(PartialShape{16}, PartialShape{16}, 16, 16, true, PartialShape{1, 9, 1, 2}),
        std::make_tuple(PartialShape{48}, PartialShape{16}, 16, 16, false, PartialShape{1, 3, 9, 2}),
        std::make_tuple(PartialShape{56}, PartialShape{7}, 11, 3, false, PartialShape{1, 16, 6, 2}),
        std::make_tuple(PartialShape{56}, PartialShape{7}, 11, 3, true, PartialShape{1, 6, 16, 2}),
