...
TEST(type_prop, generate_proposals_dynamic) {
    ...
    std::vector<ShapesAndAttrs> shapes = {
        ...
        {{1, 3}, {dyn_dim, dyn_dim, dyn_dim, 4}, {1, 12, 200, 336}, {1, 3, 200, 336}, 540, {{0, 540}, 4}, {{0, 540}}, {{1}}},
        {{1, 3}, {dyn_dim, dyn_dim, dyn_dim, 4}, {1, 12, 200, 336}, {dyn_dim, dyn_dim, 200, 336}, 600, {{0, 600}, 4}, {{0, 600}}, {{1}}},
        {{2, 3}, {dyn_dim, dyn_dim, dyn_dim, 4}, {dyn_dim, dyn_dim, 200, 336}, {2, 3, 200, 336}, 75, {{0, 150}, 4}, {{0, 150}}, {{2}}},
        {{1, 3}, {dyn_dim, dyn_dim, dyn_dim, 4}, {dyn_dim, dyn_dim, 200, 336}, {dyn_dim, dyn_dim, 200, 336}, 80, {{0, 80}, 4}, {{0, 80}}, {{1}}},
        ...
        {{1, 3}, {200, 336, 3, 4}, {1, 12, dyn_dim, dyn_dim}, {1, 3, dyn_dim, dyn_dim}, 170, {{0, 170}, 4}, {{0, 170}}, {{1}}},
        {{1, 3}, {dyn_dim, dyn_dim, dyn_dim, 4}, {1, 12, 200, dyn_dim}, {1, 3, 200, dyn_dim}, 200, {{0, 200}, 4}, {{0, 200}}, {{1}}},
        {{2, 3}, {dyn_dim, dyn_dim, dyn_dim, 4}, {2, 12, dyn_dim, 336}, {2, 3, dyn_dim, 336}, 800, {{0, 1600}, 4}, {{0, 1600}}, {{2}}},
        {{1, 3}, {dyn_dim, dyn_dim, dyn_dim, 4}, {1, 12, dyn_dim, dyn_dim}, {1, 3, dyn_dim, dyn_dim}, 560, {{0, 560}, 4}, {{0, 560}}, {{1}}},
    };
