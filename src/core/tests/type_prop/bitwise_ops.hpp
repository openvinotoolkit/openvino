...
template <class T>
class BitwiseOperator : public testing::Test {};

TYPED_TEST_SUITE_P(BitwiseOperator);

TYPED_TEST_P(BitwiseOperator, default_constructor_integer) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32,
                                                     PartialShape{-1, 4, 1, 6, Dimension(1, 6), Dimension(2, 6)});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32,
...
TYPED_TEST_P(BitwiseOperator, default_constructor_boolean) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::boolean,
                                                     PartialShape{-1, 4, 1, 6, Dimension(1, 6), Dimension(2, 6)});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::boolean,
                                                     PartialShape{-1, 1, 5, 6, Dimension(5, 8), Dimension(5, 8)});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_2D) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 2});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 2});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_4D) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 2, 3, 3});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_4D_x_scalar_numpy_broadcast) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{1});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_4D_x_1D_numpy_broadcast) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{5});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_2D_x_4D_numpy_broadcast) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{4, 5});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_3D_x_4D_numpy_broadcast) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{1, 4, 5});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 1, 1});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_4D_x_3D_numpy_broadcast) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{8, 1, 6, 1});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{7, 1, 5});
...
TYPED_TEST_P(BitwiseOperator, static_shape_pdpd_doc_examples) {
    {
        auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
        auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{3, 4});
    ...
    {
        auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
        auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{3, 1});
    ...
    {
        auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
        auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{});
    ...
    {
        auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
        auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{1, 3});
    ...
    {
        auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
        auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{3, 1, 5});
...
TYPED_TEST_P(BitwiseOperator, static_shape_inference_4D_x_4D_pdpd_broadcast) {
    {
        auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{8, 1, 6, 5});
        auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{8, 1, 6, 5});
    ...
    {
        auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{8, 7, 6, 5});
        auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{8, 1, 6, 5});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_1D_x_1D_incompatible) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{3});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{4});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_3D_x_3D_incompatible) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{3, 5, 6});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{4, 10, 12});

    ASSERT_THROW(const auto unused = std::make_shared<TypeParam>(A, B), ov::NodeValidationFailure);
}

TYPED_TEST_P(BitwiseOperator, shape_inference_5D_x_5D_incompatible) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{389, 112, 12});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{389, 112, 19});
...
TYPED_TEST_P(BitwiseOperator, shape_inference_dst_smaller_than_src_pdpd_broadcast) {
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 1});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, Shape{2, 3, 4, 5});
...
TYPED_TEST_P(BitwiseOperator, fully_dynamic_shape_broadcast_numpy) {
    auto param = std::make_shared<ov::op::v0::Parameter>(element::i32, PartialShape::dynamic());
...
TYPED_TEST_P(BitwiseOperator, dynamic_shape_3D) {
    ...
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, PartialShape{dynamic, dynamic, 6});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, PartialShape{dynamic, dynamic, 6});
...
TYPED_TEST_P(BitwiseOperator, dynamic_shape_5D) {
    Dimension dynamic = Dimension::dynamic();
    auto A = std::make_shared<ov::op::v0::Parameter>(element::i32, PartialShape{dynamic, 4, dynamic, dynamic, 6});
    auto B = std::make_shared<ov::op::v0::Parameter>(element::i32, PartialShape{dynamic, 4, dynamic, dynamic, 6});
...
TYPED_TEST_P(BitwiseOperator, dynamic_shape_intervals_broadcast_pdpd) {
    {  // Equal rank
        ...
        auto B =
            std::make_shared<ov::op::v0::Parameter>(element::i32,
...
TYPED_TEST_P(BitwiseOperator, labels_a_dynamic_mixed_dims_broadcast_numpy) {
    ...
    auto param_A = std::make_shared<ov::op::v0::Parameter>(element::i32, pshape_A);
    auto param_B = std::make_shared<ov::op::v0::Parameter>(element::i32, pshape_B);
...
TYPED_TEST_P(BitwiseOperator, labels_dyn_batch_a_broadcast_numpy) {
    ...
    auto param_A = std::make_shared<ov::op::v0::Parameter>(element::i64, A);
    auto param_B = std::make_shared<ov::op::v0::Parameter>(element::i64, B);
...
TYPED_TEST_P(BitwiseOperator, labels_dyn_batch_and_higher_rank_a_broadcast_numpy) {
    ...
    auto param_A = std::make_shared<ov::op::v0::Parameter>(element::i64, pshape_A);
    auto param_B = std::make_shared<ov::op::v0::Parameter>(element::i64, pshape_B);
