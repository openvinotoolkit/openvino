...
TEST_F(GatherMatmulTest, shape_3arg_gate_broadcast) {
    auto a = ov::test::utils::make_param(element::f32, {1, 64, 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {64, 2});
...
TEST_F(GatherMatmulTest, shape_3arg_down_projection) {
    auto a = ov::test::utils::make_param(element::f32, {2, 64, 4096});
...
TEST_F(GatherMatmulTest, output_type_matches_A) {
    auto a = ov::test::utils::make_param(element::f16, {1, 64, 2048});
...
TEST_F(GatherMatmulTest, shape_dynamic_seq_len) {
    auto a = ov::test::utils::make_param(element::f32, {1, Dimension::dynamic(), 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {Dimension::dynamic(), 2});
...
TEST_F(GatherMatmulTest, shape_dynamic_topk) {
    auto a = ov::test::utils::make_param(element::f32, {Dimension::dynamic(), 64, 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {64, Dimension::dynamic()});
...
TEST_F(GatherMatmulTest, shape_single_expert) {
    auto a = ov::test::utils::make_param(element::f32, {1, 32, 1024});
    auto b = make_const(element::f32, {1, 512, 1024});
    auto idx = ov::test::utils::make_param(element::i32, {32, 1});
...
TEST_F(GatherMatmulTest, fail_A_rank_2d) {
    auto a = ov::test::utils::make_param(element::f32, {64, 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {64, 2});
...
TEST_F(GatherMatmulTest, fail_A_rank_4d) {
    auto a = ov::test::utils::make_param(element::f32, {1, 1, 64, 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {64, 2});
...
TEST_F(GatherMatmulTest, fail_indices_rank_1d) {
    auto a = ov::test::utils::make_param(element::f32, {1, 64, 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {64});
...
TEST_F(GatherMatmulTest, fail_indices_rank_3d) {
    auto a = ov::test::utils::make_param(element::f32, {1, 64, 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {1, 64, 2});
...
TEST_F(GatherMatmulTest, fail_A0_not_broadcastable_to_topk) {
    auto a = ov::test::utils::make_param(element::f32, {3, 64, 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {64, 2});
...
TEST_F(GatherMatmulTest, fail_topk_exceeds_experts) {
    ...
    auto idx = ov::test::utils::make_param(element::i32, {64, 8});
...
TEST_F(GatherMatmulTest, fail_seq_length_mismatch) {
    auto a = ov::test::utils::make_param(element::f32, {1, 64, 2048});
    auto b = make_const(element::f32, {8, 4096, 2048});
    auto idx = ov::test::utils::make_param(element::i32, {32, 2});
