...
TEST_P(SliceV8IntervalTest, start_stop_as_interval) {
    ...
    const auto start =
        std::make_shared<op::v1::Subtract>(shape_of_start, op::v0::Constant::create(element::i64, Shape{1}, {start_offset}));
    ...
    const auto stop =
        std::make_shared<op::v1::Subtract>(shape_of_stop, op::v0::Constant::create(element::i64, Shape{1}, {stop_offset}));
