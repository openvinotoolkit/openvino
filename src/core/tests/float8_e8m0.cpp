...
constexpr float _2_power_127 = 1.7014118346046923e+38f;
constexpr float _2_power_negative_127 = 5.877471754111437e-39f;

// clang-format off
const auto exp_floats = std::vector<float>{
    _2_power_negative_127,     1.1754943508222875e-38f,    2.350988701644575e-38f,     4.70197740328915e-38f,
    ...
    4.253529586511731e+37f,     8.507059173023462e+37f,     _2_power_127,               f32_nan,
};
// clang-format on
...
// clang-format off
std::vector<std::tuple<float, float>> f32_f8_f32{
        {-std::numeric_limits<float>::infinity(),                               _2_power_negative_127},
        {-15466.5486f,                                                          _2_power_negative_127},
        {-1.f,                                                                  _2_power_negative_127},
        {0.f,                                                                   _2_power_negative_127},
        {std::nextafter(_2_power_127, std::numeric_limits<float>::infinity()),  _2_power_127},
        {std::numeric_limits<float>::max(),                                     _2_power_127},
        {std::numeric_limits<float>::infinity(),                                _2_power_127},
        {std::numeric_limits<float>::signaling_NaN(),                           f32_nan},
        {1.f, 1.f},     {1.49f, 1.f},   {1.5f, 2.f},    {1.51f, 2.f},
        {2.f, 2.f},     {2.5f, 2.f},    {3.f, 2.f},     {3.5f, 4.f},
        {4.f, 4.f},     {5.f, 4.f},     {5.5f, 4.f},    {5.99f, 4.f},
        {6.f, 8.f},     {7.f, 8.f},     {8.f, 8.f},     {9.f, 8.f},
        {10.f, 8.f},    {11.f, 8.f},    {12.f, 8.f},    {13.f, 16.f},
        {14.f, 16.f},   {15.f, 16.f},   {16.f, 16.f},   {24.f, 32.f},
        {32.f, 32.f},   {32.1f, 32.f},  {63.9f, 64.f},  {64.f, 64.f},
};
// clang-format on
