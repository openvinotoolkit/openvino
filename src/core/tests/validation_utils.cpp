...
TEST(get_constant_from_source, invalidation_check) {
    ...
    auto div = std::make_shared<ov::op::v1::Divide>(a, b);
    auto s = std::make_shared<ov::op::v3::ShapeOf>(a);
    auto r = std::make_shared<ov::op::v1::Reshape>(div, s, true);
    auto tmp_consumer = std::make_shared<ov::op::v3::ShapeOf>(s);
...
TEST(get_constant_from_source, extract_static_dim_from_dynamic_shape_check) {
    auto data = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::PartialShape{-1, 1, 128});
    auto shape = std::make_shared<ov::op::v3::ShapeOf>(data);
    auto one = ov::op::v0::Constant::create(ov::element::i64, {1}, {1});
    auto zero = ov::op::v0::Constant::create(ov::element::i64, {1}, {0});
    const auto extract_static_dimension = std::make_shared<ov::op::v8::Gather>(shape, one, zero);
...
TEST(constantfold_subgraph, split) {
    ...
    auto mul = std::make_shared<ov::op::v1::Multiply>(constant,
                                                      ov::op::v0::Constant::create(ov::element::f32, ov::Shape{}, {1}));
    auto shape = std::make_shared<ov::op::v3::ShapeOf>(mul);
    auto len_0 =
        std::make_shared<ov::op::v1::Divide>(shape, ov::op::v0::Constant::create(ov::element::i64, ov::Shape{}, {2}));
    auto len_1 = std::make_shared<ov::op::v1::Subtract>(shape, len_0);
    auto lenghts = std::make_shared<ov::op::v0::Concat>(ov::OutputVector{len_0, len_1}, 0);
    auto axis = ov::op::v0::Constant::create(ov::element::i64, ov::Shape{}, {0});
    auto split = std::make_shared<ov::op::v1::VariadicSplit>(mul, axis, lenghts);
