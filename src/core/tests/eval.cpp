...
TEST(eval, evaluate_fake_convert_f32_to_f8e4m3_scale_small) {
    ...
    auto op = make_shared<op::v13::FakeConvert>(data, scale, shift, "f8e4m3", true);
...
TEST(eval, evaluate_fake_convert_f32_to_f8e4m3_big_scale_false) {
    using namespace testing;
    constexpr auto et = element::f32;
...
TEST(eval, evaluate_fake_convert_f32_seq_to_f8e4m3_scale_false) {
    using namespace testing;
    constexpr auto et = element::f32;
...
TEST(eval, evaluate_fake_convert_f16_matching_f8_to_f8e4m3_scale_false) {
    using namespace testing;
...
TEST(eval, evaluate_fake_convert_f32_to_f8e5m2_scale_false) {
    using namespace testing;
    constexpr auto et = element::f32;
...
TEST(eval, evaluate_fake_convert_f32_to_f8e5m2_scale_1) {
    ...
    auto op = make_shared<op::v13::FakeConvert>(data, scale, shift, "f8e5m2", true);
...
TEST(eval, evaluate_fake_convert_f32_to_f8e5m2_big_scale_false) {
    using namespace testing;
    constexpr auto et = element::f32;
    ...
    EXPECT_THAT(read_vector<float>(result),
                Pointwise(FloatEq(), std::vector<float>{fp8::MAX_F8E5M2 / 2.f, fp8::MAX_F8E5M2, inf, inf}));
}
...
TEST(eval, evaluate_fake_convert_f32_matching_f8_to_f8e5m2_scale_false) {
    using namespace testing;
    constexpr auto et = element::f32;
...
TEST(eval, evaluate_fake_convert_f32_matching_f8e4m3_to_f8e5m2_scale_false) {
    using namespace testing;
    constexpr auto et = element::f32;
