...
<net name="Model0" version=")V0G0N";
    ...
    std::ifstream initial_xml(xmlFileName, std::ios::in | std::ios::binary);
    std::ifstream xml_1(m_out_xml_path_1, std::ios::in | std::ios::binary);
    EXPECT_TRUE(files_equal(xml_1, initial_xml));

    std::ifstream xml_2(m_out_xml_path_2, std::ios::in | std::ios::binary);
    initial_xml = std::ifstream(xmlFileName, std::ios::in | std::ios::binary);
    EXPECT_TRUE(files_equal(xml_2, initial_xml));
}
