...
NGRAPH_TEST(TEMPLATE, onnx_prior_box) {
...
NGRAPH_TEST(TEMPLATE, onnx_priorbox_clustered) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_priorbox_clustered_most_attrs_default) {
...
NGRAPH_TEST(TEMPLATE, onnx_priorbox_clustered_first_input_bad_shape) {
    try {
        auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_priorbox_clustered_second_input_bad_shape) {
    try {
        auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_detection_output) {
    const auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_group_norm) {
...
NGRAPH_TEST(TEMPLATE, onnx_group_norm_5d) {
    const auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_normalize) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_swish_with_beta) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_swish_without_beta) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_experimental_detectron_detection_output) {
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_model_experimental_detectron_detection_output_most_attrs_default) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_experimental_detectron_generate_proposals_single_image) {
    auto function =
        onnx_import::import_onnx_model(file_util::path_join(SERIALIZED_ZOO,
                                                            "onnx/org.openvinotoolkit/experimental_detectron/"
...
NGRAPH_TEST(TEMPLATE, onnx_model_experimental_detectron_group_norm) {
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_model_experimental_detectron_prior_grid_generator) {
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_model_experimental_detectron_roi_feature_extractor) {
    auto function = onnx_import::import_onnx_model(
        file_util::path_join(SERIALIZED_ZOO,
...
NGRAPH_TEST(TEMPLATE, onnx_model_experimental_detectron_topk_rios) {
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_model_deformable_conv_2d) {
    auto function = onnx_import::import_onnx_model(
