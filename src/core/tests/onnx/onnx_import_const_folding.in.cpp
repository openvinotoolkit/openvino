...
NGRAPH_TEST(TEMPLATE, onnx_const_folding_model_scatter_elements) {
    const auto fn =
...
NGRAPH_TEST(TEMPLATE, onnx_const_folding_model_non_zero_scalar) {
...
NGRAPH_TEST(TEMPLATE, onnx_const_folding_model_non_zero_1d) {
...
NGRAPH_TEST(TEMPLATE, onnx_const_folding_model_non_zero_1d_float) {
...
NGRAPH_TEST(TEMPLATE, onnx_const_folding_model_non_zero_3d) {
...
NGRAPH_TEST(TEMPLATE, onnx_const_folding_model_non_zero_2d_bool) {
