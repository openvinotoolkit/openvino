...
NGRAPH_TEST(TEMPLATE, onnx_external_data) {
    const auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_external_data_from_stream) {
...
NGRAPH_TEST(TEMPLATE, onnx_external_data_optional_fields) {
...
NGRAPH_TEST(TEMPLATE, onnx_external_data_in_different_paths) {
...
NGRAPH_TEST(TEMPLATE, onnx_external_two_tensors_data_in_the_same_file) {
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_external_invalid_external_data_exception) {
    try {
        auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_external_invalid_up_dir_path) {
    try {
        auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_external_data_sanitize_path) {
    const auto function = onnx_import::import_onnx_model(
