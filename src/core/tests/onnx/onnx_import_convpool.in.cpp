...
NGRAPH_TEST(TEMPLATE, onnx_model_conv2d_strides_padding) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_conv2d_strides_no_padding) {
    // Convolution with strides=2 and padding=1
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_conv2d_strides_assymetric_padding) {
    // Convolution with strides=2 and padding=1
...
NGRAPH_TEST(TEMPLATE, onnx_model_conv2d_dilation_assymetric_pads_strides) {
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_model_conv3d_bias) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_conv_transpose_w_groups) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_average_pool_2d) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_average_pool_2d_pads) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_max_pool_2d_pads) {
    // Pooling with strides=2 and padding=1
...
NGRAPH_TEST(TEMPLATE, onnx_model_global_lp_pool_p0) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_global_lp_pool_p1) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_global_lp_pool_p2) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_global_lp_pool_p3) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_convtranspose_output_shape) {
    auto function =
    ...
    test_case.add_expected_output_from_file<float>({1, 2, 10, 8}, TEST_FILES, "onnx/convtranspose_output_shape/y.bin");

    test_case.run();
}

NGRAPH_TEST(TEMPLATE, onnx_model_convtranspose_output_shape_auto_pads_same_upper) {
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_model_convtranspose_output_shape_auto_pads_same_lower) {
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_model_convtranspose_groups_w_pads) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_convtranspose_groups_pads_bias) {
    auto function = onnx_import::import_onnx_model(
