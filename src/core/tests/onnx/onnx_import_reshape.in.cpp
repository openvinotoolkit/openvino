...
NGRAPH_TEST(TEMPLATE, onnx_model_reshape_reduced_dims) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_reshape_reordered_dims) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_reshape_extended_dims) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_reshape_single_dim) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_reshape_negative_dim) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_reshape_negative_with_zero_dim) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_reshape_output_shape_as_input) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_depth_to_space) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_depth_to_space_v1) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_depth_to_space_crd) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_depth_to_space_bad_blocksize) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_depth_to_space_no_blocksize) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_depth_to_space_bad_mode) {
    try {
...
NGRAPH_TEST(TEMPLATE, onnx_model_depth_to_space_bad_input_shape) {
    try {
...
NGRAPH_TEST(TEMPLATE, onnx_model_space_to_depth) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_space_to_depth_invalid_input_shape) {
    try {
        onnx_import::import_onnx_model(
...
NGRAPH_TEST(TEMPLATE, onnx_model_space_to_depth_bad_blocksize) {
    // This model fails to import since the depth channel length must be a multiple of the
    // `blocksize` attribute value.
    EXPECT_THROW(
...
NGRAPH_TEST(TEMPLATE, onnx_model_space_to_depth_no_blocksize) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_squeeze) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_squeeze_opset13_no_axes) {
    const auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_unsqueeze) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_unsqueeze_negative_axes) {
    auto function =
...
NGRAPH_TEST(TEMPLATE, onnx_model_concat) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_concat_negative_axis) {
    auto function =
...
// NGRAPH_TEST(TEMPLATE, onnx_model_split_equal_parts_default) {
//     auto function =
...
//
//     Outputs outputs{execute(function, inputs, "TEMPLATE")};
...
NGRAPH_TEST(TEMPLATE, onnx_model_split_equal_parts_2d) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_split_variable_parts_2d) {
...
NGRAPH_TEST(TEMPLATE, onnx_model_expand_static_shape) {
    auto function =
