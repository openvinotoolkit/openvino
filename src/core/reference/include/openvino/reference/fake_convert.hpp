...
void fake_convert(const T* data,
    ...
    reference::func::apply_scale_shift<float16>(out, data, scale, shift, data_shape, scale_shape, shift_shape, false);
    apply_conversion(out, out, element_count, destination_type);
    reference::func::apply_scale_shift<float16>(out, out, scale, shift, data_shape, scale_shape, shift_shape, true);
}
...
void fake_convert(const T* data,
                  ...
                  const std::string& destination_type) {
    const size_t element_count = shape_size(data_shape);
    reference::func::apply_scale_shift<T>(out, data, scale, shift, data_shape, scale_shape, shift_shape, false);
    ...
    reference::func::apply_scale_shift<T>(out, out, scale, shift, data_shape, scale_shape, shift_shape, true);
}
