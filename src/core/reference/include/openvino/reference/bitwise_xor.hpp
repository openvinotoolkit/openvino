...
T bitwise_xor(const T arg0, const T arg1) {
    return static_cast<T>(std::bit_xor<bool>()(arg0, arg1));
}

template <class T, typename std::enable_if<!std::is_same<typename std::decay<T>::type, char>::value>::type* = nullptr>
T bitwise_xor(const T arg0, const T arg1) {
    return static_cast<T>(std::bit_xor<T>()(arg0, arg1));
}
}  // namespace func
/**
...
void bitwise_xor(const T* arg0,
    ...
    autobroadcast_binop(arg0, arg1, out, arg0_shape, arg1_shape, broadcast_spec, func::bitwise_xor<T>);
}
}  // namespace reference
}  // namespace ov
