...
enum class Type_t {
    ...
    undefined OPENVINO_DEPRECATED(
        "This type is deprecated and will be removed in 2026.0. Use dynamic instead"),  //!< Undefined element
                                                                                        //!< type
...
/// \ingroup ov_element_cpp_api
constexpr Type undefined(Type_t::dynamic);
