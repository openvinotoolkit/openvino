...
class OPENVINO_API NoImpl : public AssertFailure {
public:
    NoImpl(const CheckLocInfo& check_loc_info, const std::string& context_info, const std::string& explanation)
...
#define OPENVINO_NOT_IMPLEMENTED                    OPENVINO_ASSERT_HELPER(::ov::NoImpl, "", false, "Not Implemented", "")
