...
_OPENVINO_OP_REG(Abs, ov::op::v1)
_OPENVINO_OP_REG(Acos, ov::op::v1)
_OPENVINO_OP_REG(Add, ov::op::v1)
_OPENVINO_OP_REG(Asin, ov::op::v1)
_OPENVINO_OP_REG(Atan, ov::op::v1)
_OPENVINO_OP_REG(AvgPool, ov::op::v1)
_OPENVINO_OP_REG(BatchNormInference, ov::op::v1)
_OPENVINO_OP_REG(BinaryConvolution, ov::op::v1)
_OPENVINO_OP_REG(CTCGreedyDecoder, ov::op::v1)
_OPENVINO_OP_REG(Ceiling, ov::op::v1)
_OPENVINO_OP_REG(Clamp, ov::op::v1)
_OPENVINO_OP_REG(Concat, ov::op::v1)
_OPENVINO_OP_REG(Constant, ov::op::v1)
_OPENVINO_OP_REG(Convert, ov::op::v1)
...
_OPENVINO_OP_REG(Cos, ov::op::v1)
_OPENVINO_OP_REG(Cosh, ov::op::v1)
_OPENVINO_OP_REG(DeformableConvolution, ov::op::v1)
_OPENVINO_OP_REG(DeformablePSROIPooling, ov::op::v1)
_OPENVINO_OP_REG(DepthToSpace, ov::op::v1)
_OPENVINO_OP_REG(DetectionOutput, ov::op::v1)
_OPENVINO_OP_REG(Divide, ov::op::v1)
_OPENVINO_OP_REG(Elu, ov::op::v1)
_OPENVINO_OP_REG(Erf, ov::op::v1)
_OPENVINO_OP_REG(Equal, ov::op::v1)
_OPENVINO_OP_REG(Exp, ov::op::v1)
_OPENVINO_OP_REG(FakeQuantize, ov::op::v1)
_OPENVINO_OP_REG(Floor, ov::op::v1)
...
_OPENVINO_OP_REG(GRN, ov::op::v1)
_OPENVINO_OP_REG(HardSigmoid, ov::op::v1)
_OPENVINO_OP_REG(Interpolate, ov::op::v1)
_OPENVINO_OP_REG(Less, ov::op::v1)
_OPENVINO_OP_REG(LessEqual, ov::op::v1)
_OPENVINO_OP_REG(Log, ov::op::v1)
...
_OPENVINO_OP_REG(LRN, ov::op::v1)
_OPENVINO_OP_REG(LSTMCell, ov::op::v1)
_OPENVINO_OP_REG(LSTMSequence, ov::op::v1)
_OPENVINO_OP_REG(MatMul, ov::op::v1)
...
_OPENVINO_OP_REG(Negative, ov::op::v1)
_OPENVINO_OP_REG(NormalizeL2, ov::op::v1)
_OPENVINO_OP_REG(NotEqual, ov::op::v1)
_OPENVINO_OP_REG(OneHot, ov::op::v1)
_OPENVINO_OP_REG(PRelu, ov::op::v1)
_OPENVINO_OP_REG(PSROIPooling, ov::op::v1)
_OPENVINO_OP_REG(Pad, ov::op::v1)
_OPENVINO_OP_REG(Parameter, ov::op::v1)
_OPENVINO_OP_REG(Power, ov::op::v1)
_OPENVINO_OP_REG(PriorBox, ov::op::v1)
_OPENVINO_OP_REG(PriorBoxClustered, ov::op::v1)
_OPENVINO_OP_REG(Proposal, ov::op::v1)
_OPENVINO_OP_REG(Range, ov::op::v1)
_OPENVINO_OP_REG(Relu, ov::op::v1)
...
_OPENVINO_OP_REG(RegionYolo, ov::op::v1)
_OPENVINO_OP_REG(Reshape, ov::op::v1)
_OPENVINO_OP_REG(Result, ov::op::v1)
_OPENVINO_OP_REG(ReverseSequence, ov::op::v1)
_OPENVINO_OP_REG(Select, ov::op::v1)
_OPENVINO_OP_REG(Selu, ov::op::v1)
_OPENVINO_OP_REG(Sign, ov::op::v1)
_OPENVINO_OP_REG(Sigmoid, ov::op::v1)
_OPENVINO_OP_REG(Sin, ov::op::v1)
_OPENVINO_OP_REG(Sinh, ov::op::v1)
_OPENVINO_OP_REG(Softmax, ov::op::v1)
_OPENVINO_OP_REG(Sqrt, ov::op::v1)
_OPENVINO_OP_REG(SpaceToDepth, ov::op::v1)
_OPENVINO_OP_REG(Split, ov::op::v1)
_OPENVINO_OP_REG(SquaredDifference, ov::op::v1)
_OPENVINO_OP_REG(Squeeze, ov::op::v1)
_OPENVINO_OP_REG(StridedSlice, ov::op::v1)
_OPENVINO_OP_REG(Subtract, ov::op::v1)
_OPENVINO_OP_REG(Tan, ov::op::v1)
_OPENVINO_OP_REG(Tanh, ov::op::v1)
_OPENVINO_OP_REG(TensorIterator, ov::op::v1)
_OPENVINO_OP_REG(Tile, ov::op::v1)
_OPENVINO_OP_REG(Transpose, ov::op::v1)
_OPENVINO_OP_REG(Unsqueeze, ov::op::v1)
_OPENVINO_OP_REG(VariadicSplit, ov::op::v1)

// New operations added in opset2
_OPENVINO_OP_REG(Gelu, ov::op::v2)
_OPENVINO_OP_REG(BatchToSpace, ov::op::v2)
_OPENVINO_OP_REG(SpaceToBatch, ov::op::v2)
_OPENVINO_OP_REG(ReorgYolo, ov::op::v2)
_OPENVINO_OP_REG(MVN, ov::op::v2)
_OPENVINO_OP_REG(ROIPooling, ov::op::v2)
