...
public:
    ...
    ///
    /// \param begins ND tensor containing the beginning indices of strings in the symbols array.
    /// \param ends ND tensor containing the ending indices of strings in the symbols array.
