...
public:
    ...
    OPENVINO_DEPRECATED("The function get_concatenation_axis() is deprecated. Will be removed in 2025.0 release. Use get_axis() instead.")
    int64_t get_concatenation_axis() const {
        return m_concat_axis;
    }
    OPENVINO_DEPRECATED("The function set_concatenation_axis() is deprecated. Will be removed in 2025.0 release. Use set_axis() instead.")
