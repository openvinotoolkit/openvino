...
public:
    ...
    SearchSorted(const Output<Node>& sorted_sequence,
                 ...
                 const element::Type& output_element_type = element::i64);
    ...
    void set_output_element_type(const element::Type& output_element_type) {
        m_output_element_type = output_element_type;
    }

    element::Type get_output_element_type() const {
        return m_output_element_type;
    }

private:
    bool m_right_mode{};
    element::Type m_output_element_type = element::i64;
};
}  // namespace v15
}  // namespace op
}  // namespace ov
