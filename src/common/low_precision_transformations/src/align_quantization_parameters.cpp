...
ov::pass::low_precision::AlignQuantizationParameters::AlignQuantizationParameters(
...
bool ov::pass::low_precision::AlignQuantizationParameters::run_on_model(const std::shared_ptr<ov::Model>& f) {
    ...
    propagation->add_matcher<low_precision::UpdateSharedPrecisionPreserved<QuantizationAlignmentAttribute,
