...
NormalizeL2Transformation::NormalizeL2Transformation(const Params& params) : LayerTransformation(params) {
    ...
    auto matcher = pattern::wrap_type<ov::opset1::NormalizeL2>(
...
bool NormalizeL2Transformation::canBeTransformed(const TransformationContext& context,
...
bool NormalizeL2Transformation::transform(TransformationContext& context, ov::pass::pattern::Matcher& m) {
    ...
    auto normalize = ov::as_type_ptr<ov::opset1::NormalizeL2>(
        NetworkHelper::separateInStandaloneBranch(operation, defaultPrecisions));
    ...
    case ov::element::Type_t::f16: {
        newScalesConst =
            normalize_l2::createNewScalesConst<ov::element_type_traits<ov::element::Type_t::f16>::value_type>(
                *scalesConst);
        break;
    }
    case ov::element::Type_t::f32: {
        newScalesConst =
            normalize_l2::createNewScalesConst<ov::element_type_traits<ov::element::Type_t::f32>::value_type>(
                *scalesConst);
        break;
    }
    default: {
