...
static bool isTargetType(const std::shared_ptr<Node> node) {
    return node != nullptr && (ov::is_type<ov::op::v1::Convolution>(node) ||
...
static std::shared_ptr<Node> getDataParent(const std::shared_ptr<Node> branchData) {
    ...
    while (ov::is_type<ov::op::v0::FakeQuantize>(parent)) {
...
static bool isBranchHaveMultipleConsumers(const std::shared_ptr<Node> branchData, const std::shared_ptr<Node> branchDataParent) {
    ...
    while (parent != branchDataParent) {
        ...
        parent = !ov::is_type<ov::op::v0::Constant>(new_parent) ? new_parent : parent->get_input_node_shared_ptr(1);
    }
...
int EltwiseBaseTransformation::getNotEmpty(const std::shared_ptr<Node>& eltwise) const {
    ...
    if (ov::as_type<ov::op::v0::Constant>(dequantization1.data.get_node())) {
        return -1;
    }
    ...
    if (ov::as_type<ov::op::v0::Constant>(dequantization2.data.get_node())) {
        return -1;
    }
    ...
    const std::shared_ptr<ov::op::v0::FakeQuantize> fakeQuantize1 =
        ov::as_type_ptr<ov::op::v0::FakeQuantize>(dequantization1.data.get_node_shared_ptr());
    const std::shared_ptr<ov::op::v0::FakeQuantize> fakeQuantize2 =
        ov::as_type_ptr<ov::op::v0::FakeQuantize>(dequantization2.data.get_node_shared_ptr());
    ...
    if (ov::is_type<ov::op::v0::Constant>(dequantization1.data.get_node())) {
        return 0;
    }

    if (ov::is_type<ov::op::v0::Constant>(dequantization2.data.get_node())) {
        return 1;
    }
...
std::pair<int, int> EltwiseBaseTransformation::getMultiplyConstBranch(const std::shared_ptr<Node>& eltwise) const {
    ...
    std::shared_ptr<ov::op::v0::Constant> constParent = dequantization1.empty() ?
        ov::as_type_ptr<ov::op::v0::Constant>(parent1) :
        ov::as_type_ptr<ov::op::v0::Constant>(dequantization1.data.get_node_shared_ptr());
    std::shared_ptr<ov::op::v1::Multiply> multiplyParent = ov::as_type_ptr<ov::op::v1::Multiply>(parent2);
    int multiplyBranch = 1;


    if (constParent == nullptr || multiplyParent == nullptr) {
        constParent = dequantization2.empty() ?
            ov::as_type_ptr<ov::op::v0::Constant>(parent2) :
            ov::as_type_ptr<ov::op::v0::Constant>(dequantization2.data.get_node_shared_ptr());
        multiplyParent = ov::as_type_ptr<ov::op::v1::Multiply>(parent1);
        multiplyBranch = 0;
    }
    ...
    auto multiplyParentParent = ov::as_type_ptr<ov::op::v1::Multiply>(multiplyParentParent1);
    auto multiplyParentConst = ov::as_type_ptr<ov::op::v0::Constant>(multiplyParentParent2);
    int multiplyActBranch = 0;


    if (multiplyParentConst == nullptr) {
        multiplyParentParent = ov::as_type_ptr<ov::op::v1::Multiply>(multiplyParentParent2);
        multiplyParentConst = ov::as_type_ptr<ov::op::v0::Constant>(multiplyParentParent1);
        multiplyActBranch = 1;
    }
