...
std::shared_ptr<Node> moveThroughElementwise(const std::shared_ptr<Node>& reshape,
    ...
    const auto newElementwiseValues = [&]() -> std::shared_ptr<Node> {
        ...
        const auto newReshapeValuesVector =
        ...
        const auto newReshapeValues = std::make_shared<opset1::Constant>(reshapeValues->get_output_element_type(0),
