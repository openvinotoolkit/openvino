...
public:
    void SetUp() override {
        ...
        actualFunction =
            ov::builder::subgraph::ConcatFunction::getOriginalWithStridedSlice(precision,
                                                                               shape,
        ...
        referenceFunction =
            ov::builder::subgraph::ConcatFunction::getReferenceWithStridedSlice(precision,
                                                                                shape,
...
const std::vector<ov::PartialShape> shapes = {{1, 4, 9, 9},
                                              {4, 4, 9, 9},
...
const std::vector<ConcatTransformationTestValues> testValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     true,
     true,
     {{256ul, ov::Shape({}), {0.f}, {2.55f}, {0.f}, {2.55f}}, {256ul, ov::Shape({}), {0.f}, {2.55f}, {0.f}, {2.55f}}},
