...
typedef std::tuple<ngraph::PartialShape, DepthToSpaceTransformationTestValues> DepthToSpaceTransformationParams;
...
const std::vector<ngraph::PartialShape> inputShapesForBlockSize2 = {{1, 4, 3, 3}, {-1, -1, -1, -1}};
...
const std::vector<DepthToSpaceTransformationTestValues> testValues = {
    ...
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     ...
     {ngraph::element::u8, {{}, {}, {}}, ngraph::element::u8, {{ngraph::element::f32}, {0.32f}, {0.45f}}}},
    // blockSize = 2
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     2,
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8,
      {{ngraph::element::f32}, {{0.32f}, ngraph::element::f32, {}, false, 1, ngraph::element::u8, true}, {0.45f}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
      {{ngraph::element::f32}, {{0.32f}, ngraph::element::f32, {}, false, 1, ngraph::element::u8, true}, {0.45f}}}},
    ...
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     2,
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {{0.32f, 0.5f, 0.6f, 0.77f}}, {{0.1f, 0.55f, 0.3f, 0.8f}}}},
     {ngraph::element::u8,
      {{ngraph::element::f32}, {{0.32f, 0.5f, 0.6f, 0.77f}}, {{0.1f, 0.55f, 0.3f, 0.8f}}},
      ngraph::element::f32,
      {{}, {}, {}}}},
    ...
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     2,
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {{0.32f, 0.32f, 0.32f, 0.32f}}, {{0.1f, 0.1f, 0.1f, 0.1f}}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
      {{ngraph::element::f32}, {{0.32f, 0.32f, 0.32f, 0.32f}}, {{0.1f, 0.1f, 0.1f, 0.1f}}}}},
...
const std::vector<ngraph::PartialShape> inputShapesForBlockSize3 = {{1, 9, 3, 3}, {-1, -1, -1, -1}};
