...
typedef std::tuple<ov::PartialShape, DepthToSpaceTransformationTestValues> DepthToSpaceTransformationParams;

class DepthToSpaceTransformation : public LayerTransformation,
...
public:
    void SetUp() override {
        ...
        actualFunction = DepthToSpaceFunction::getOriginal(inputShape,
                                                           testValues.mode,
        ...
        referenceFunction = DepthToSpaceFunction::getReference(inputShape,
                                                               testValues.mode,
                                                               testValues.blockSize,
    ...
    static std::string getTestCaseName(testing::TestParamInfo<DepthToSpaceTransformationParams> obj) {
        ...
        result << inputShape << "_" << names[testValues.mode] << "_" << testValues.blockSize << "_"
               << testValues.actual.precisionBeforeDequantization << "_" << testValues.actual.dequantization;
        return result.str();
    }
};
...
const std::vector<ov::PartialShape> inputShapesForBlockSize2 = {{1, 4, 3, 3}, {-1, -1, -1, -1}};
...
const std::vector<DepthToSpaceTransformationTestValues> testValues = {
    ...
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     ...
     {ov::element::u8, {{ov::element::f32}, {0.32f}, {0.45f}}},
     {ov::element::u8, {{}, {}, {}}, ov::element::u8, {{ov::element::f32}, {0.32f}, {0.45f}}}},
    // blockSize = 2
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     2,
     LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {{0.32f}, ov::element::f32, {}, false, 1, ov::element::u8, true}, {0.45f}}},
     {ov::element::u8,
      {{}, {}, {}},
      ov::element::u8,
      {{ov::element::f32}, {{0.32f}, ov::element::f32, {}, false, 1, ov::element::u8, true}, {0.45f}}}},
    // not scalar-like dequantizations with different values
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     2,
     LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {{0.32f, 0.5f, 0.6f, 0.77f}}, {{0.1f, 0.55f, 0.3f, 0.8f}}}},
     {ov::element::u8,
      {{ov::element::f32}, {{0.32f, 0.5f, 0.6f, 0.77f}}, {{0.1f, 0.55f, 0.3f, 0.8f}}},
      ov::element::f32,
      {{}, {}, {}}}},
    ...
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     2,
     LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {{0.32f, 0.32f, 0.32f, 0.32f}}, {{0.1f, 0.1f, 0.1f, 0.1f}}}},
     {ov::element::u8,
      {{}, {}, {}},
      ov::element::u8,
      {{ov::element::f32}, {{0.32f, 0.32f, 0.32f, 0.32f}}, {{0.1f, 0.1f, 0.1f, 0.1f}}}}},
...
INSTANTIATE_TEST_SUITE_P(smoke_LPT,
                         ...
                         ::testing::Combine(::testing::ValuesIn(inputShapesForBlockSize2),
                                            ::testing::ValuesIn(testValues)),
                         DepthToSpaceTransformation::getTestCaseName);
}  // namespace testValues1

namespace testValues2 {
const std::vector<ov::PartialShape> inputShapesForBlockSize3 = {{1, 9, 3, 3}, {-1, -1, -1, -1}};
...
INSTANTIATE_TEST_SUITE_P(smoke_LPT,
                         DepthToSpaceTransformation,
                         ::testing::Combine(::testing::ValuesIn(inputShapesForBlockSize3),
                                            ::testing::ValuesIn(testValues)),
                         DepthToSpaceTransformation::getTestCaseName);
}  // namespace testValues2
...
const std::vector<DepthToSpaceTransformationTestValues> testValues = {
    {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
     ...
     LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {0.32f}, {0.45f}}},
     {ov::element::u8, {{ov::element::f32}, {0.32f}, {0.45f}}, ov::element::f32, {}}},
};
