...
typedef std::tuple<ov::element::Type, ov::PartialShape, MVNTransformationTestValues, int> MVNTransformationParams;
...
public:
    void SetUp() override {
        ...
        actualFunction =
            ov::builder::subgraph::MVNFunction::getOriginal(precision,
                                                            inputShape,
        ...
        referenceFunction =
            ov::builder::subgraph::MVNFunction::getReference(precision,
                                                             inputShape,
                                                             testValues.reductionAxes,
                                                             testValues.normalizeVariance,
...
const std::vector<MVNTransformationTestValues> testValues = {
    {{1, 2, 3},
     ...
     {ov::element::f16, {{ov::element::f16}, {}, {{0.45f}, ov::element::f16, {}, false, 1ul, ov::element::f16}}},
     {
         ov::element::f16,
         {},
         ov::element::f32,
    ...
    {{1, 2, 3},
     ...
     {ov::element::u8, {{ov::element::f32}, {127.f}, {0.45f}}},
     {ov::element::u8, {{ov::element::f32}, {127.f}, {0.45f}}, ov::element::f32, {{}, {}, {}}}},
    {{1, 2, 3},
     true,
     LayerTransformation::createParamsU8I8().setSupportAsymmetricQuantization(true),
     {ov::element::u8, {{ov::element::f32}, {12.5f}, {0.45f}}},
     {ov::element::u8, {{ov::element::f32}, {12.5f}, {0.45f}}, ov::element::f32, {{}, {}, {}}}},
    {{1, 2, 3},
     true,
     LayerTransformation::createParamsU8I8().setSupportAsymmetricQuantization(false),
     {ov::element::u8, {{ov::element::f32}, {127.f}, {0.45f}}},
    ...
    {{1, 2, 3},
     ...
     {ov::element::u8, {{ov::element::f32}, {}, {-0.5f}}},
     {ov::element::u8, {{}, {}, {}}, ov::element::f32, {{}, {}, {-1.f}}}},
    {{1, 2, 3},
     false,
     LayerTransformation::createParamsU8I8(),
    ...
    {{1, 2, 3},
     ...
     {ov::element::f32, {{}, {}, {}}, ov::element::f32, {{}, {}, {0.45f}}}},
};
...
const std::vector<ov::PartialShape> inputShapes = {{1, 2, 2, 2}, {-1, -1, -1, -1}};

const std::vector<MVNTransformationTestValues> testValues = {
    {{1, 2, 3},
     false,
     LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {{0.45f, 0.45f}, ov::element::f32, ov::Shape{1, 2, 1, 1}}}},
     {ov::element::u8,
      {{}, {}, {}},
      ov::element::f32,
...
const std::vector<MVNTransformationTestValues> testValues = {
    {{1, 2, 3},
     ...
     LayerTransformation::createParamsU8I8().setSupportAsymmetricQuantization(false),
     {ov::element::u8, {{ov::element::f32}, {}, {0.45f}}},
     {ov::element::u8, {{ov::element::f32}, {}, {0.45f}}, ov::element::f32, {}}},
};
