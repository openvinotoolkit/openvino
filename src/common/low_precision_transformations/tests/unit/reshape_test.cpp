...
TEST(LPT_ReshapeTransformation, canBeTransformed_4D_to_2D_perTensor) {
    ASSERT_TRUE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({}),
                                                                                     ngraph::Shape({}),
...
TEST(LPT_ReshapeTransformation, canBeTransformed_4D_to_2D_perTensor2) {
    ASSERT_TRUE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1}),
                                                                                     ngraph::Shape({1}),
                                                                                     ngraph::Shape({1, 3, 4, 5}),
                                                                                     ngraph::Shape({1, 60})));
}
...
TEST(LPT_ReshapeTransformation, canBeTransformed_4D_to_2D_perChannels) {
    ASSERT_TRUE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1, 3}),
                                                                                     ngraph::Shape({1, 3}),
                                                                                     ngraph::Shape({1, 3, 4, 5}),
                                                                                     ngraph::Shape({1, 60})));
}
...
TEST(LPT_ReshapeTransformation, canBeTransformed_4D_to_2D_perChannels2) {
    ASSERT_TRUE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1, 3, 1, 1}),
...
TEST(LPT_ReshapeTransformation, canBeTransformed_4D_to_2D_perChannels3) {
    ASSERT_FALSE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1, 3, 1, 1}),
                                                                                      ngraph::Shape({1, 3, 1, 1}),
                                                                                      ngraph::Shape({1, 3, 4, 5}),
                                                                                      ngraph::Shape({12, 5})));
}
...
TEST(LPT_ReshapeTransformation, canBeTransformed_4D_to_2D_spatial) {
    ASSERT_FALSE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1, 3, 4, 1}),
...
TEST(LPT_ReshapeTransformation, canBeTransformed_4D_to_3D_perSpacial2) {
    ASSERT_FALSE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1, 3, 1, 4}),
...
TEST(LPT_ReshapeTransformation, canBeTransformed_3D_to_4D_perSpacial) {
    ASSERT_FALSE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1, 3, 20}),
                                                                                      ngraph::Shape({1, 3, 20}),
                                                                                      ngraph::Shape({1, 3, 20}),
                                                                                      ngraph::Shape({1, 3, 4, 5})));
}
...
TEST(LPT_ReshapeTransformation, canBeTransformed_4D_to_2D_perSpacial_TRUE) {
    ASSERT_TRUE(ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1, 256, 1, 1}),
...
TEST(LPT_ReshapeTransformation, canBeTransformed_5D_to_5D_perBatch) {
    ASSERT_FALSE(
        ngraph::pass::low_precision::ReshapeTransformation::canBeTransformed(ngraph::Shape({1, 16, 1, 1, 1}),
