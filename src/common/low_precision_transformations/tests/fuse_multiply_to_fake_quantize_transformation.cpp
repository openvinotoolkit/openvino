...
typedef std::tuple<size_t, ov::PartialShape, FuseMultiplyToFakeQuantizeTransformationTestValues>
...
public:
    void SetUp() override {
        ...
        actualFunction =
            ov::builder::subgraph::FuseMultiplyToFakeQuantizeFunction::get(inputShape,
                                                                           testValues.actual.fakeQuantizeOnData,
                                                                           testValues.actual.dequantization);

        SimpleLowPrecisionTransformer transformer;
        transformer.add<ov::pass::low_precision::FuseMultiplyToFakeQuantizeTransformation, ov::op::v1::Multiply>(
            testValues.params);
