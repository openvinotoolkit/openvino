...
typedef std::tuple<size_t, ngraph::PartialShape, FuseMultiplyToFakeQuantizeTransformationTestValues>
...
public:
    void SetUp() override {
        ...
        actualFunction =
            ngraph::builder::subgraph::FuseMultiplyToFakeQuantizeFunction::get(inputShape,
                                                                               testValues.actual.fakeQuantizeOnData,
                                                                               testValues.actual.dequantization);

        SimpleLowPrecisionTransformer transformer;
        transformer
            .add<ngraph::pass::low_precision::FuseMultiplyToFakeQuantizeTransformation, ngraph::opset1::Multiply>(
                testValues.params);
    ...
    static std::string getTestCaseName(testing::TestParamInfo<FuseMultiplyToFakeQuantizeTransformationTestParams> obj) {
        ...
        result << inputShape << "_" << testValues.params.updatePrecisions << "_" << testValues.actual.dequantization
               << "_" << testValues.actual.fakeQuantizeOnData << "_" << testValues.expected.dequantization;
        return result.str();
    }
};
...
const std::vector<FuseMultiplyToFakeQuantizeTransformationTestValues> testValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {
         {256ul, {{}, {}, {1, 3, 1, 1}, {1, 3, 1, 1}}, {0.f}, {2.55f}, {0.f}, {127.5f, 102.f, 76.5f}},
         {{}, {}, {}},
     }},
};
