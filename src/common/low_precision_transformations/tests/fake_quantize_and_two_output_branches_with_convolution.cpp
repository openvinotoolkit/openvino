...
typedef std::tuple<ov::element::Type, ov::Shape, FakeQuantizeAndTwoOutputBranchesWithConvolutionTestValues>
...
public:
    void SetUp() override {
        ...
        referenceFunction =
            ov::builder::subgraph::FakeQuantizeAndTwoOutputBranchesWithConvolutionFunction::getReference(
                precision,
                shape,
