...
typedef std::tuple<size_t, ngraph::PartialShape, FuseSubtractToFakeQuantizeTransformationTestValues>
...
public:
    void SetUp() override {
        ...
        transformer
            .add<ngraph::pass::low_precision::FuseSubtractToFakeQuantizeTransformation, ngraph::opset1::Subtract>(
                testValues.params);
