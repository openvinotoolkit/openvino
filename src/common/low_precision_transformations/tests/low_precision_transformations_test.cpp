...
TEST_F(smoke_LPT_LowPrecisionTransformationsTests, DISABLED_removeAll) {
    ...
    // LowPrecisionTransformer::getAllTransformations(LayerTransformation::Params()); auto transformation =
    // transformations.find("Convolution"); ASSERT_NE(0, transformation.size());
...
//    LowPrecisionTransformations transformations =
//    LowPrecisionTransformer::getAllTransformations(LayerTransformation::Params()); auto transformation =
//    transformations.find("Concat"); ASSERT_NE(0, transformation.size());
//
//    transformations.removeBranchSpecific<ngraph::pass::low_precision::ConcatMultiChannelsTransformation,
//    ngraph::opset1::Concat>(); transformation = transformations.find("Concat"); ASSERT_EQ(0, transformation.size());
//}
//
// TEST_F(LowPrecisionTransformationsTests, remove) {
//    LowPrecisionTransformations transformations =
//    LowPrecisionTransformer::getAllTransformations(LayerTransformation::Params()); auto transformation =
//    transformations.find("MatMul"); ASSERT_NE(0, transformation.size());
//
...
//    LowPrecisionTransformations transformations =
//    LowPrecisionTransformer::getAllTransformations(LayerTransformation::Params()); auto transformation =
//    transformations.find("Multiply"); ASSERT_NE(0, transformation.size()); const size_t originalSize =
//    transformation.size();
//
...
//    transformation.size();
//
//    transformations.removeStandaloneCleanup<ngraph::pass::low_precision::SubtractMultiplyToMultiplyAddTransformation,
//    ngraph::opset1::Multiply>(); transformation = transformations.find("Multiply"); ASSERT_EQ(originalSize - 1,
//    transformation.size());
//}
