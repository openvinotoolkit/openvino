...
public:
    void SetUp() override {
        ...
        if (useParameterAsDataSource) {
            ...
            parameter = std::make_shared<ngraph::opset1::Parameter>(testValues.actual.constPrecision, testValues.constShape);
        ...
        std::shared_ptr<Node> fq = ngraph::builder::subgraph::makeFakeQuantizeTypeRelaxed(dataSource, element::f32, testValues.actual.fakeQuantize);
