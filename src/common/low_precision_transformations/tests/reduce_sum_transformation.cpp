...
const std::vector<ngraph::PartialShape> inputShapes = {{1, 3, 16, 16}, {4, 3, 16, 16}, {-1, -1, 16, 16}};
...
const std::vector<ReduceTransformationTestValues> reduceSumTransformationTestValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {ngraph::element::u8, {}, ngraph::element::f32, {{}, {128.f * 16.f}, {0.1f}}}},
    ...
    {LayerTransformation::createParamsI8I8(),
     ...
     {ngraph::element::i8, {}, ngraph::element::f32, {{}, {64.f * 16.f}, {0.1f}}}},
