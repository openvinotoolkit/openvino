...
const std::vector<ov::PartialShape> inputShapes = {{1, 3, 16, 16}, {4, 3, 16, 16}, {-1, -1, 16, 16}};
...
const std::vector<ReduceTransformationTestValues> reduceSumTransformationTestValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {ov::element::u8, {}, ov::element::f32, {{}, {128.f * 16.f}, {0.1f}}}},
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     false,
     {ov::element::u8, {{ov::element::f32}, {}, {{0.1f, 1.f, 10.f}, ov::element::f32, {1, 3, 1, 1}}}},
     {ov::element::u8, {}, ov::element::f32, {{}, {}, {{0.1f, 1.f, 10.f}, ov::element::f32, {1, 3}}}}},
    ...
    {LayerTransformation::createParamsI8I8(),
     ...
     {ov::element::i8, {}, ov::element::f32, {{}, {64.f * 16.f}, {0.1f}}}},
