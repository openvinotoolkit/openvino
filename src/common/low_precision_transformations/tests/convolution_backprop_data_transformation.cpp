...
public:
    ...
    public:
        ...
        Actual() = default;
        Actual(const ov::element::Type& precisionBeforeDequantization,
...
typedef std::tuple<element::Type, ov::PartialShape, ConvolutionBackpropDataTransformationTestValues>
...
public:
    void SetUp() override {
        ...
        if (!testValues.actual.fakeQuantizeOnWeights.empty() && !testValues.actual.dequantizationOnWeights.empty()) {
            actualWeights =
                ConvolutionBackpropDataFunction::getWeights(outputShape,
                                                            netPrecision,
        ...
        transform.add<ov::pass::low_precision::ConvolutionBackpropDataTransformation, opset1::ConvolutionBackpropData>(
            testValues.params);
        transform.get_pass_config()->set_callback<ov::pass::low_precision::ConvolutionBackpropDataTransformation>(
            testValues.actual.callback);
    ...
    static std::string getTestCaseName(testing::TestParamInfo<ConvolutionBackpropDataTransformationParams> obj) {
        ...
        result << toString(testValues.params) << "_" << netPrecision << "_" << inputShape << "_"
               ...
               << testValues.actual.dequantizationOnActivations << "_" << testValues.actual.dequantizationOnWeights
               << "_" << testValues.actual.fakeQuantizeOnWeights << "_" << "_weights_"
...
const std::vector<ov::PartialShape> shapes = {{1, 8, 16, 16}, {-1, -1, -1, -1}};
...
const std::vector<ConvolutionBackpropDataTransformationTestValues> testValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {ov::element::u8,
      ...
      op::v0::Constant::create(ov::element::i8, ov::Shape{}, std::vector<float>{2.f}),
      [](const_node_ptr& node) {
          return ov::pass::low_precision::LayerTransformation::isAsymmetricQuantization(
              node,
