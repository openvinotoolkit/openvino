...
public:
    ...
    public:
        ...
        Actual() = default;
        Actual(const ngraph::element::Type& precisionBeforeDequantization,
...
typedef std::tuple<element::Type, ngraph::PartialShape, ConvolutionBackpropDataTransformationTestValues>
...
public:
    void SetUp() override {
        ...
        transform.add<low_precision::ConvolutionBackpropDataTransformation, opset1::ConvolutionBackpropData>(
            testValues.params);
        transform.get_pass_config()->set_callback<low_precision::ConvolutionBackpropDataTransformation>(
    ...
    static std::string getTestCaseName(testing::TestParamInfo<ConvolutionBackpropDataTransformationParams> obj) {
        ...
        result << toString(testValues.params) << "_" << netPrecision << "_" << inputShape << "_"
               ...
               << "_" << testValues.actual.fakeQuantizeOnWeights << "_"
...
const std::vector<ngraph::PartialShape> shapes = {{1, 8, 16, 16}, {-1, -1, -1, -1}};
...
const std::vector<ConvolutionBackpropDataTransformationTestValues> testValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {ngraph::element::u8,
      ...
      op::Constant::create(ngraph::element::i8, ngraph::Shape{}, std::vector<float>{2.f}),
      [](const_node_ptr& node) {
          return low_precision::LayerTransformation::isAsymmetricQuantization(
              node,
