...
typedef std::tuple<element::Type, ov::PartialShape, ConvolutionTransformationTestValues>
    ConvolutionTransformationParams;

class ConvolutionTransformation : public LayerTransformation,
...
public:
    void SetUp() override {
        ...
        referenceFunction =
            ov::builder::subgraph::ConvolutionFunction::getReference(netPrecision,
...
const std::vector<element::Type> netPrecisions = {element::f32, element::f16};
...
const std::vector<ConvolutionTransformationTestValues> testValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     // ActualValues
     {ov::element::f32,
      {{ov::element::f32}, {{128.f}, ov::element::f32, {1, 1, 1, 1}}, {{0.02f}, ov::element::f32, {1, 1, 1, 1}}},
      op::v0::Constant::create(ov::element::f32, ov::Shape{}, std::vector<float>{2.f}),
      {255ul, Shape({1, 1, 1, 1}), {0.f}, {254.f}, {-1.27f}, {1.27f}}},
     // ExpectedValues
     {ov::element::f32,
...
const std::vector<ov::PartialShape> unsuitablePartialShapes = {ov::PartialShape::dynamic()};
