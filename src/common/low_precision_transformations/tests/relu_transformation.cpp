...
typedef std::tuple<ngraph::PartialShape, ReluTransformationTestValues> ReluTransformationParams;
...
public:
    void SetUp() override {
        ...
        actualFunction =
            ngraph::builder::subgraph::ReluFunction::getOriginal(inputShape,
        ...
        referenceFunction =
            ngraph::builder::subgraph::ReluFunction::getReference(inputShape,
...
const std::vector<ReluTransformationTestValues> testValues = {
    ...
    // U8: no subtract
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.2f, 0.3f}}}},
     {ngraph::element::u8, {{}, {}, {}}, ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.2f, 0.3f}}}}},
    // U8: no subtract
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, -0.2f, 0.3f}}}},
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, -0.2f, 0.3f}}}, ngraph::element::f32, {{}, {}, {}}}},
    // I8: no subtract
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {0.1f}}},
     {ngraph::element::i8, {{}, {}, {}}, ngraph::element::i8, {{ngraph::element::f32}, {}, {0.1f}}}},
