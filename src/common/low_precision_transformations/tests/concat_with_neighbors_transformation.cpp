...
public:
    void SetUp() override {
        ...
        actualFunction =
            ov::builder::subgraph::ConcatFunction::getOriginalWithNeighbors(precision,
                                                                            shape,
        ...
        referenceFunction =
            ov::builder::subgraph::ConcatFunction::getReferenceWithNeighbors(precision,
                                                                             shape,
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {{256ul, ov::Shape({}), {0.f}, {2.55f}, {128.f}, {154.f}},
      ...
      {{},
       ...
       {{0.1f}, ov::element::f32, {}}},
      {{}, {{128.f, 128.f, 128.f}, ov::element::f32, {1, 3, 1, 1}, false}, {{0.1f}, ov::element::f32, {}}}},
     "convolution",
     "convolution"},
    //// I8: concat multi channels
    //{
