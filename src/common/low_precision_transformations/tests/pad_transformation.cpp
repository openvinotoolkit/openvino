...
public:
    void SetUp() override {
        ...
        actualFunction = ov::builder::subgraph::PadFunction::get(inputShape,
                                                                 testValues.actual.precisionBeforeDequantization,
        ...
        referenceFunction = ov::builder::subgraph::PadFunction::get(inputShape,
    ...
    static std::string getTestCaseName(testing::TestParamInfo<PadTransformationParams> obj) {
        ...
        result << "_" << toString(testValues.params) << "_" << inputShape << "_" << pads.first << "_" << pads.second
               ...
               << "_expected_dequantizationBefore_" << testValues.expected.dequantizationBefore
               << "_expected_dequantizationAfter_" << testValues.expected.dequantizationAfter;
...
const std::vector<ov::PartialShape> inputShapes = {{1, 3, 6, 6}, {4, 3, 6, 6}, {-1, 3, 6, -1}};

const std::vector<std::pair<std::vector<int64_t>, std::vector<int64_t>>> padsBySpatialDimensions = {
    {{0, 0, 2, 1}, {0, 0, 1, 2}},
    {{0, 0, -1, -1}, {0, 0, 2, 2}}};

const std::pair<std::vector<int64_t>, std::vector<int64_t>> padsPositiveBySpatialDimensions = {{0, 0, 2, 1},
                                                                                               {0, 0, 1, 2}};

const std::pair<std::vector<int64_t>, std::vector<int64_t>> padsNegativeBySpatialDimensions = {{0, 0, -2, -1},
                                                                                               {0, 0, -1, -2}};

const std::pair<std::vector<int64_t>, std::vector<int64_t>> padsMixedBySpatialDimensions = {{0, 0, 2, -1},
                                                                                            {0, 0, -1, 2}};
...
const std::vector<ov::PartialShape> commonInputShapes = {{4, 3, 6, 6}, {-1, -1, -1, -1}};
...
const std::vector<PadTransformationTestValues> deqWithoutSub = {
    {LayerTransformation::createParamsU8I8(),
     ...
     {ov::element::u8, {{}, {}, {}}, ov::element::u8, {{ov::element::f32}, {}, {3.f}}}},
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {}, {3.f}}},
     {ov::element::i8, {{}, {}, {}}, ov::element::i8, {{ov::element::f32}, {}, {3.f}}}},
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {}, {{3.f, 1.f, 2.f}}}},
     {ov::element::i8, {{}, {}, {}}, ov::element::i8, {{ov::element::f32}, {}, {{3.f, 1.f, 2.f}}}}},
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {{3.f, 1.f, 2.f}}}},
     {ov::element::u8, {{}, {}, {}}, ov::element::u8, {{ov::element::f32}, {}, {{3.f, 1.f, 2.f}}}}},
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{}, {}, {}}},
     {ov::element::u8, {{}, {}, {}}, ov::element::u8, {{}, {}, {}}}},
    {LayerTransformation::createParamsU8I8(),
     {ov::element::f32, {{}, {}, {{3.f, 1.f, 2.f}}}},
     {ov::element::f32, {{}, {}, {}}, ov::element::f32, {{}, {}, {{3.f, 1.f, 2.f}}}}},
...
const std::vector<PadTransformationTestValues> testValuesForConstantMode = {
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {64.f}, {3.f}}},
     {ov::element::i8, {{ov::element::f32}, {64.f}, {3.f}}, ov::element::f32, {{}, {}, {}}}},
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {{64.f, 32.f, 16.f}}, {{3.f, 1.f, 2.f}}}},
     {ov::element::i8, {{ov::element::f32}, {{64.f, 32.f, 16.f}}, {{3.f, 1.f, 2.f}}}, ov::element::f32, {{}, {}, {}}}},
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {{128.f, 64.f, 32.f}}, {{3.f, 1.f, 2.f}}}},
     {ov::element::u8,
...
const std::vector<PadTransformationTestValues> testValuesForConstantMode = {
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {{1.f, 2.f, 3.f, 4.f, 5.f, 6.f}, ov::element::f32, {1, 1, 6, 1}}}},
     {ov::element::u8,
      {{}, {}, {}},
      ov::element::u8,
...
const std::vector<PadTransformationTestValues> testValuesForConstantMode2 = {
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {}, {3.f}}},
     {ov::element::i8, {{ov::element::f32}, {}, {3.f}}, ov::element::f32, {{}, {}, {}}}},
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {}, {{3.f, 1.f, 2.f}}}},
     {ov::element::i8, {{ov::element::f32}, {}, {{3.f, 1.f, 2.f}}}, ov::element::f32, {{}, {}, {}}}},
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {{3.f, 1.f, 2.f}}}},
     {ov::element::u8, {{ov::element::f32}, {}, {{3.f, 1.f, 2.f}}}, ov::element::f32, {{}, {}, {}}}}};
...
namespace positive {
const std::pair<std::vector<int64_t>, std::vector<int64_t>> padsPositiveByUniqueDimension = {{0, 0, 2, 0},
                                                                                             {0, 0, 1, 0}};
...
namespace negative {
const std::pair<std::vector<int64_t>, std::vector<int64_t>> padsNegativeByUniqueDimension = {{0, 0, -2, 0},
                                                                                             {0, 0, -1, 0}};
...
namespace mixed {
const std::pair<std::vector<int64_t>, std::vector<int64_t>> padsMixedByUniqueDimension = {{0, 0, 2, 0}, {0, 0, -1, 0}};
...
const std::pair<std::vector<int64_t>, std::vector<int64_t>> padsByUniqueDimension = {{0, 0, 2, 0}, {0, 0, 1, 0}};

const std::vector<PadTransformationTestValues> testValuesForConstantMode = {
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {}, {{3.f, 3.f, 3.f, 2.f, 2.f, 2.f}, ov::element::f32, {1, 1, 6, 1}}}},
     {ov::element::i8,
      {},
      ov::element::i8,
      {{ov::element::f32}, {}, {{1.f, 1.f, 3.f, 3.f, 3.f, 2.f, 2.f, 2.f, 1.f}, ov::element::f32, {1, 1, 9, 1}}}}},
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {64.f}, {3.f}}},
     {ov::element::i8,
      {},
