...
typedef std::tuple<ngraph::PartialShape, StridedSliceTransformationTestValues> StridedSliceTransformationParams;

class StridedSliceTransformation : public LayerTransformation,
...
public:
    void SetUp() override {
        ...
        actualFunction =
            ngraph::builder::subgraph::StridedSliceFunction::getOriginal(testValues.actual.inputPrecision,
                                                                         inputShape,
        ...
        transformer.add<ngraph::pass::low_precision::StridedSliceTransformation, ngraph::opset1::StridedSlice>(
            testValues.params);
        transformer.transform(actualFunction);

        referenceFunction =
            ngraph::builder::subgraph::StridedSliceFunction::getReference(testValues.expected.inputPrecision,
                                                                          inputShape,
                                                                          testValues.layerParams.begin,
                                                                          testValues.layerParams.end,
                                                                          testValues.layerParams.strides,
    ...
    static std::string getTestCaseName(testing::TestParamInfo<StridedSliceTransformationParams> obj) {
        ...
        result << inputShape << testValues.actual.inputPrecision << "_" << toString(testValues.params)
               << testValues.actual.dequantization << "_strided_slice_params_" << testValues.layerParams.begin
               << testValues.layerParams.end << testValues.layerParams.beginMask << testValues.layerParams.endMask
               << testValues.layerParams.strides << testValues.layerParams.shrinkAxisMask
               << testValues.layerParams.newAxisMask;
        return result.str();
    }
};
...
StridedSliceTransformationTestValues::LayerParams spatialDimensionSlice =
    {{0, 0, 0, 0}, {1, 3, 20, 24}, {1, 1, 1, 1}, {1, 1, 0, 1}, {1, 1, 0, 1}, {}, {}, {}};

StridedSliceTransformationTestValues::LayerParams spatialDimensionEndSlice =
    {{0, 0, 20, 0}, {1, 3, 24, 24}, {1, 1, 1, 1}, {1, 1, 0, 1}, {1, 1, 0, 1}, {}, {}, {}};
...
const std::vector<ngraph::PartialShape> inputShapes = {{1, 3, 24, 24}, {-1, -1, -1, -1}};
...
const std::vector<StridedSliceTransformationTestValues> stridedSliceTransformationTestValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     channelSlice,
     {ngraph::element::u8, {{ngraph::element::f32}, {{128.f, 128.f, 128.f}}, {{0.1f, 0.1f, 0.1f}}}},
     {ngraph::element::u8, {}, ngraph::element::u8, {{ngraph::element::f32}, {128.f}, {0.1f}}}},
    ...
    {LayerTransformation::createParamsU8I8(),
     channelSlice,
     {ngraph::element::u8, {{ngraph::element::f32}, {{128.f, 64.f, 128.f}}, {{0.1f, 0.01f, 1.f}}}},
     {ngraph::element::u8, {}, ngraph::element::u8, {{ngraph::element::f32}, {{128.f, 64.f}}, {{0.1f, 0.01f}}}}},
    // U8: channel slice, per-channel quantization with different values
    {LayerTransformation::createParamsU8I8(),
     channelSlice2D,
     {ngraph::element::u8, {{ngraph::element::f32}, {{128.f, 64.f, 128.f}}, {{0.1f, 0.01f, 1.f}}}},
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {ngraph::element::u8, {}, ngraph::element::u8, {{ngraph::element::f32}, {}, {0.1f}}}},
    // I8: channel slice, per-tensor quantization
    {LayerTransformation::createParamsI8I8(),
     channelSlice,
     {ngraph::element::i8, {{ngraph::element::f32}, {32.f}, {0.1f}}},
     {ngraph::element::i8, {}, ngraph::element::i8, {{ngraph::element::f32}, {32.f}, {0.1f}}}},
    // I8: channel slice, per-channel quantization with the same values
    {LayerTransformation::createParamsI8I8(),
     channelSlice,
     {ngraph::element::i8, {{ngraph::element::f32}, {{32.f, 32.f, 32.f}}, {{0.1f, 0.1f, 0.1f}}}},
     {ngraph::element::i8, {}, ngraph::element::i8, {{ngraph::element::f32}, {32.f}, {0.1f}}}},
    // I8: channel slice, per-channel quantization with different values
    {LayerTransformation::createParamsI8I8(),
     channelSlice,
     {ngraph::element::i8, {{ngraph::element::f32}, {{32.f, 64.f, 32.f}}, {{0.1f, 0.01f, 1.f}}}},
     {ngraph::element::i8, {}, ngraph::element::i8, {{ngraph::element::f32}, {{32.f, 64.f}}, {{0.1f, 0.01f}}}}},
    // channel slice, not update precisions
    {LayerTransformation::createParamsU8I8().setUpdatePrecisions(false),
     channelSlice,
     {ngraph::element::f32, {{}, {128.f}, {0.1f}}},
     {ngraph::element::f32, {}, ngraph::element::f32, {{}, {128.f}, {0.1f}}}},
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.01f, 1.f}, ngraph::element::f32, {3, 1, 1}}}},
     {ngraph::element::u8,
      {},
      ngraph::element::u8,
    ...
    {LayerTransformation::createParamsU8I8(),
     sliceWithRemovedAxis,
     {ngraph::element::u8, {{ngraph::element::f32}, {{128.f, 64.f, 32.f}}, {{0.1f, 0.2f, 0.3f}}}},
     {
         ngraph::element::u8,
         {},
         ngraph::element::u8,
...
const std::vector<ngraph::PartialShape> inputShapes = {{-1, -1, -1, -1}, {1, 3, 4, 4}};
...
const std::vector<ngraph::PartialShape> inputShapesWithDynamicChannels = {PartialShape::dynamic()};
...
INSTANTIATE_TEST_SUITE_P(smoke_LPT,
                         StridedSliceTransformation,
                         ::testing::Combine(::testing::ValuesIn(inputShapesWithDynamicChannels),
