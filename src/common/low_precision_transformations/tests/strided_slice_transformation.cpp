...
typedef std::tuple<ov::PartialShape, StridedSliceTransformationTestValues> StridedSliceTransformationParams;
...
public:
    void SetUp() override {
        ...
        actualFunction = ov::builder::subgraph::StridedSliceFunction::getOriginal(testValues.actual.inputPrecision,
                                                                                  inputShape,
        ...
        transformer.add<ov::pass::low_precision::StridedSliceTransformation, ov::op::v1::StridedSlice>(
            testValues.params);
        transformer.transform(actualFunction);

        referenceFunction =
            ov::builder::subgraph::StridedSliceFunction::getReference(testValues.expected.inputPrecision,
                                                                      inputShape,
                                                                      testValues.layerParams.begin,
                                                                      testValues.layerParams.end,
                                                                      testValues.layerParams.strides,
...
const std::vector<ov::PartialShape> inputShapes = {{1, 3, 24, 24}, {-1, -1, -1, -1}};
...
const std::vector<StridedSliceTransformationTestValues> stridedSliceTransformationTestValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     channelSlice,
     {ov::element::u8,
      {{ov::element::f32}, {{128.f}, element::undefined, {1, 3, 1, 1}, false, 1ul, element::u8, true}, {3.f}}},
     {ov::element::u8,
      {},
      ov::element::u8,
...
const std::vector<ov::PartialShape> inputShapes = {{-1, -1, -1, -1}, {1, 3, 4, 4}};
...
const std::vector<ov::PartialShape> inputShapesWithDynamicChannels = {PartialShape::dynamic()};
...
const std::vector<StridedSliceTransformationTestValues> testValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     channelSlice,
     {ov::element::u8, {{ov::element::f32}, {{128.f, 64.f, 128.f}}, {{0.1f, 0.01f, 1.f}}}},
     {ov::element::u8, {{ov::element::f32}, {{128.f, 64.f, 128.f}}, {{0.1f, 0.01f, 1.f}}}, ov::element::f32, {}}},
};
...
namespace inputs_3d {
const std::vector<ov::PartialShape> inputShapes = {{1, 3, 4}, {1, -1, 4}};
...
const std::vector<StridedSliceTransformationTestValues> testValuesWithDQBySpatialDimension = {
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {ov::element::u8,
      {},
      ov::element::u8,
      {{ov::element::f32}, {{2.f}, ov::element::f32, {}}, {{2.f}, ov::element::f32, {}}}}}};
