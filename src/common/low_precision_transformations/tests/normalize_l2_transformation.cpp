...
public:
    void SetUp() override {
        ...
        actualFunction = ov::builder::subgraph::NormalizeL2Function::getOriginal(precision,
        ...
        transform.add<ov::pass::low_precision::NormalizeL2Transformation, ov::op::v0::NormalizeL2>(
            params.transformationParams);
        transform.transform(actualFunction);

        referenceFunction =
            ov::builder::subgraph::NormalizeL2Function::getReference(precision,
...
std::vector<ov::op::EpsMode> epsMode = {ov::op::EpsMode::ADD, ov::op::EpsMode::MAX};

std::vector<std::vector<size_t>> axes = {{1}, {1, 2, 3}};

namespace testValues1 {
const std::vector<ov::PartialShape> shapes = {{1, 3, 16, 16}, {-1, -1, -1, -1}};
...
const std::vector<NormalizeL2TransformationTestValues> normalizeL2TransformationTestValues = {
    {LayerTransformation::createParamsU8I8().setSupportAsymmetricQuantization(false),
     {ov::element::f16, {{ov::element::f16}, {}, {{-12.3f}, ov::element::f16, {}, false, 1ul, ov::element::f16}}},
     {
         ov::element::f16,
         {},
         ov::element::f32,
    ...
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {2.f}, {-12.3f}}},
     {ov::element::u8, {{ov::element::f32}, {2.f}, {-12.3f}}, ov::element::f32, {}}},
    // U8 per tensor quantization without subtract
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {-12.3f}}},
     {ov::element::u8, {}, ov::element::f32, {{}, {}, {-1.f}}}},
    // U8 per channel quantization with the same values
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {{12.3f, 12.3f, 12.3f}}}},
     {ov::element::u8, {}, ov::element::f32, {{}, {}, {{1.f, 1.f, 1.f}}}}},
    // U8 per channel quantization with different values
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {{12.3f, -12.3f, 12.3f}}}},
     {ov::element::u8, {{ov::element::f32}, {}, {{12.3f, -12.3f, 12.3f}}}, ov::element::f32, {}}},
    // U8 not update precisions
    {LayerTransformation::createParamsU8I8().setUpdatePrecisions(false),
     {ov::element::f32, {{}, {}, {12.3f}}},
     {ov::element::f32, {}, ov::element::f32, {{}, {}, {1.f}}}},
    // I8 per tensor quantization
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {2.f}, {-12.3f}}},
     {ov::element::i8, {{ov::element::f32}, {2.f}, {-12.3f}}, ov::element::f32, {}}},
    // I8 per tensor quantization without subtract
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {}, {-12.3f}}},
     {ov::element::i8, {}, ov::element::f32, {{}, {}, {-1.f}}}},
    // I8 per channel quantization with the same values
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {}, {{12.3f, 12.3f, 12.3f}}}},
     {ov::element::i8, {}, ov::element::f32, {{}, {}, {{1.f, 1.f, 1.f}}}}},
    // I8 per channel quantization with different values
    {LayerTransformation::createParamsI8I8(),
     {ov::element::i8, {{ov::element::f32}, {}, {{12.3f, -12.3f, 12.3f}}}},
     {ov::element::i8, {{ov::element::f32}, {}, {{12.3f, -12.3f, 12.3f}}}, ov::element::f32, {}}},
};
...
const std::vector<NormalizeL2TransformationTestValues> normalizeL2TransformationTestValues = {
    {LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {-12.3f}}},
     {ov::element::u8, {{ov::element::f32}, {}, {-12.3f}}, ov::element::f32, {}}}};
