...
typedef std::tuple<ngraph::element::Type,
                   ...
                   ngraph::op::EpsMode,
                   std::vector<size_t>,
                   NormalizeL2TransformationTestValues>
    NormalizeL2TransformationParams;

class NormalizeL2Transformation : public LayerTransformation,
...
public:
    void SetUp() override {
        ...
        actualFunction = ngraph::builder::subgraph::NormalizeL2Function::getOriginal(precision,
        ...
        referenceFunction =
            ngraph::builder::subgraph::NormalizeL2Function::getReference(precision,
    ...
    static std::string getTestCaseName(testing::TestParamInfo<NormalizeL2TransformationParams> obj) {
        ...
        result << precision << "_" << toString(params.transformationParams) << shape << "_" << axes << "_" << epsMode
               << "_" << params.actual.inputPrecision << "_" << params.actual.dequantization;
        return result.str();
    }
};
...
std::vector<ngraph::op::EpsMode> epsMode = {ngraph::op::EpsMode::ADD, ngraph::op::EpsMode::MAX};

std::vector<std::vector<size_t>> axes = {{1}, {1, 2, 3}};

namespace testValues1 {
const std::vector<ngraph::PartialShape> shapes = {{1, 3, 16, 16}, {-1, -1, -1, -1}};

const std::vector<NormalizeL2TransformationTestValues> normalizeL2TransformationTestValues = {
    // U8 per tensor quantization
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {2.f}, {-12.3f}}},
     {ngraph::element::u8, {{ngraph::element::f32}, {2.f}, {-12.3f}}, ngraph::element::f32, {}}},
    // U8 per tensor quantization without subtract
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {-12.3f}}},
     {ngraph::element::u8, {}, ngraph::element::f32, {{}, {}, {-1.f}}}},
    // U8 per channel quantization with the same values
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{12.3f, 12.3f, 12.3f}}}},
     {ngraph::element::u8, {}, ngraph::element::f32, {{}, {}, {{1.f, 1.f, 1.f}}}}},
    // U8 per channel quantization with different values
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{12.3f, -12.3f, 12.3f}}}},
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{12.3f, -12.3f, 12.3f}}}, ngraph::element::f32, {}}},
    // U8 not update precisions
    {LayerTransformation::createParamsU8I8().setUpdatePrecisions(false),
     {ngraph::element::f32, {{}, {}, {12.3f}}},
     {ngraph::element::f32, {}, ngraph::element::f32, {{}, {}, {1.f}}}},
    // I8 per tensor quantization
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {2.f}, {-12.3f}}},
     {ngraph::element::i8, {{ngraph::element::f32}, {2.f}, {-12.3f}}, ngraph::element::f32, {}}},
    // I8 per tensor quantization without subtract
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {-12.3f}}},
     {ngraph::element::i8, {}, ngraph::element::f32, {{}, {}, {-1.f}}}},
    // I8 per channel quantization with the same values
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {{12.3f, 12.3f, 12.3f}}}},
     {ngraph::element::i8, {}, ngraph::element::f32, {{}, {}, {{1.f, 1.f, 1.f}}}}},
    // I8 per channel quantization with different values
    {LayerTransformation::createParamsI8I8(),
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {{12.3f, -12.3f, 12.3f}}}},
     {ngraph::element::i8, {{ngraph::element::f32}, {}, {{12.3f, -12.3f, 12.3f}}}, ngraph::element::f32, {}}},
};
...
const std::vector<NormalizeL2TransformationTestValues> normalizeL2TransformationTestValues = {
    {LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {-12.3f}}},
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {-12.3f}}, ngraph::element::f32, {}}}};
