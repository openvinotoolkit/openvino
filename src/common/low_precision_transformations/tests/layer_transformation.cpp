...
ov::pass::low_precision::LayerTransformation::Params TestTransformationParams::toParams(
    const TestTransformationParams& params) {
    return ov::pass::low_precision::LayerTransformation::Params(params.updatePrecisions,
                                                                params.deqPrecision,
...
std::string LayerTransformation::getTestCaseNameByParams(const ov::element::Type& type,
...
ov::builder::subgraph::DequantizationOperations LayerTransformation::toDequantizationOperations(
    ...
    const auto convert = dequantization.convert != nullptr ? ov::builder::subgraph::DequantizationOperations::Convert(
    ...
    ov::builder::subgraph::DequantizationOperations::Multiply multiply;
    {
        const size_t constantIndex =
            dequantization.multiplyConstant && dequantization.multiply
                ? ov::pass::low_precision::NetworkHelper::getChildInputIndex(dequantization.multiplyConstant,
