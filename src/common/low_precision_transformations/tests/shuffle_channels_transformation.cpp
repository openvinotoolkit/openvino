...
typedef std::tuple<ov::PartialShape, ShuffleChannelsTransformationTestValues> ShuffleChannelsTransformationParams;
...
public:
    void SetUp() override {
        ...
        actualFunction = ov::builder::subgraph::ShuffleChannelsFunction::getOriginal(testValues.actual.inputPrecision,
                                                                                     inputShape,
        ...
        transform.add<ov::pass::low_precision::ShuffleChannelsTransformation, ov::op::v0::ShuffleChannels>(
            testValues.params);
        transform.transform(actualFunction);

        referenceFunction =
            ov::builder::subgraph::ShuffleChannelsFunction::getReference(testValues.expected.inputPrecision,
                                                                         inputShape,
...
const std::vector<ov::PartialShape> inputShapes = {{1, 3, 8, 10}, {4, 3, 8, 10}, {-1, -1, -1, -1}};
...
const std::vector<ov::PartialShape> inputShapesWithDynamicRank = {ov::PartialShape::dynamic()};
