...
typedef std::tuple<ov::element::Type, ov::Shape, ConcatWithNeighborsWithConvolutionTestValues>
...
TEST_P(ConcatWithNeighborsWithConvolutionTransformation, CompareFunctions) {
    ...
    ASSERT_FALSE(
        ov::pass::low_precision::getAttribute<ov::QuantizationAlignmentAttribute>(actualConcatOperations[0]).empty());
    ASSERT_FALSE(
        ov::pass::low_precision::getAttribute<ov::QuantizationAlignmentAttribute>(actualConcatOperations[1]).empty());
