...
class ConcatWithIntermediateTransformation : public LayerTransformation,
...
public:
    void SetUp() override {
        ...
        actualFunction =
            ov::builder::subgraph::ConcatFunction::getOriginalWithIntermediate(precision,
                                                                               shape,
...
const std::vector<ov::PartialShape> shapes = {{1, 3, 9, 9},
                                              {4, 3, 9, 9},
