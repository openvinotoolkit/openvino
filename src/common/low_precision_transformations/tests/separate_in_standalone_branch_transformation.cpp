...
typedef std::tuple<ov::Shape, SeparateInStandaloneBranchTransformationTestValues>
...
public:
    void SetUp() override {
        ...
        const auto createActualFunction =
            ...
            const std::shared_ptr<ov::op::v0::Parameter> input =
                std::make_shared<ov::op::v0::Parameter>(precision, inputShape);
            ...
            return std::make_shared<ov::Model>(ov::ResultVector{std::make_shared<ov::op::v0::Result>(reshape1),
...
std::vector<SeparateInStandaloneBranchTransformationTestValues> testValues = {
    ...
    {LayerTransformation::createParamsU8U8(), ov::element::u8, {ov::element::f32, {127.f}, {}}},
    {LayerTransformation::createParamsU8U8().setSupportAsymmetricQuantization(true),
     ov::element::u8,
     {ov::element::f32, {{127.f}, ov::element::f32, {}, true, 1ul, ov::element::u8, true}, {0.02f}}}};
