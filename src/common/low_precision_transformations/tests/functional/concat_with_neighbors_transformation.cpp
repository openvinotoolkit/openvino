...
class ConcatWithNeighborsTransformation : public LayerTransformation,
...
public:
    void SetUp() override {
        ...
        actualFunction =
            ngraph::builder::subgraph::ConcatFunction::getOriginalWithNeighbors(precision,
                                                                                shape,
        ...
        auto supportedPrecisionsOnActivation = std::vector<ngraph::pass::low_precision::PrecisionsRestriction>(
            {ngraph::pass::low_precision::PrecisionsRestriction::create<ngraph::opset1::Convolution>(
                {{{0}, testValues.params.precisionsOnActivations}, {{1}, testValues.params.precisionsOnWeights}})});
        ...
        referenceFunction =
            ngraph::builder::subgraph::ConcatFunction::getReferenceWithNeighbors(precision,
                                                                                 shape,
...
const std::vector<ConcatTransformationTestValues> testValues = {
    ...
    {LayerTransformation::createParamsU8I8(),
     ...
     {{256ul, ngraph::Shape({}), {0.f}, {2.55f}, {128.f}, {154.f}},
      ...
      {{}, {{128.f, 128.f, 128.f}, ngraph::element::f32, {1, 3, 1, 1}, false}, {{0.1f}, ngraph::element::f32, {}}}},
     "convolution",
     "convolution"},
    //// I8: concat multi channels
    //{
