...
const std::vector<ReshapeTransformationTestValues> testValues = {
    ...
    {PartialShape::dynamic(),
     {0, 3, 16, 64},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.2f, 0.3f}, element::f32, {1, 3, 1, 1}}}},
     {ngraph::element::u8,
    ...
    {{1, 3, 20},
     {1, 3, 4, 5},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.2f, 0.3f}, ngraph::element::f32, {1, 3, 1}}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
    ...
    {{1, 4, 10, 10},
     ...
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8,
      {{ngraph::element::f32}, {{128.f}, element::undefined, {1, 4, 1, 1}, false, 1ul, element::u8, true}, {3.f}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
    ...
    {{1, 3, 4, 5},
     {1, 3, 20, 1, 1, 1},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.2f, 0.3f}, ngraph::element::f32, {1, 3, 1, 1}}}},
     {
         ngraph::element::u8,
         {},
         ngraph::element::u8,
    ...
    {{1, 3, 4, 8},
     {12, -1},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {{0.f, 128.f, 255.f}}, {{0.1f, 0.2f, 0.3f}}}},
     {ngraph::element::u8,
    ...
    {{1, 3, 2, 2},
     ...
     {ngraph::element::u8,
      {{ngraph::element::f32},
       {{0.f, 128.f, 255.f}, ngraph::element::f32, {1, 3, 1, 1}},
       {{0.1f, 0.2f, 0.3f}, ngraph::element::f32, {1, 3, 1, 1}}}},
     {ngraph::element::u8,
      {},
      ngraph::element::u8,
    ...
    {{1, 3, 2, 2},
     ...
     {ngraph::element::u8,
      {{ngraph::element::f32},
       {{0.f, 128.f, 255.f}, ngraph::element::f32, {3, 1, 1}},
       {{0.1f, 0.2f, 0.3f}, ngraph::element::f32, {3, 1, 1}}}},
     {ngraph::element::u8,
      {},
      ngraph::element::u8,
      {{ngraph::element::f32},
    ...
    {{1, 3, 1, 1},
       ...
       {{0.1f, 0.2f, 0.3f}, ngraph::element::f32, {3, 1, 1}}}},
     {
         ...
         ngraph::element::u8,
         {{ngraph::element::f32},
          {{0.f, 128.f, 255.f}, ngraph::element::f32, {1, 3}},
          {{0.1f, 0.2f, 0.3f}, ngraph::element::f32, {1, 3}}},
     }},
    ...
    {{1, 3, 4, 5},
       ...
       {{0.1f, 0.2f, 0.3f}, ngraph::element::f32, {3, 1, 1}}}},
     {
         ...
         ngraph::element::u8,
         {{ngraph::element::f32},
          {{0.f, 128.f, 255.f}, ngraph::element::f32, {1, 3, 1}},
          {{0.1f, 0.2f, 0.3f}, ngraph::element::f32, {1, 3, 1}}},
     }},
    ...
    {{2, 2048, 1, 1},
     {2, -1},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f}, ngraph::element::f32, {1ul}}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
      {{ngraph::element::f32}, {}, {{0.1f}, ngraph::element::f32, {}}}}},
    ...
    {{1, 2048, 1, 1},
     {1, -1},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f}, ngraph::element::f32, {1, 1, 1, 1}}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
      {{ngraph::element::f32}, {}, {{0.1f}, ngraph::element::f32, {}}}}},
    ...
    {{1, 3, 12, 12},
     {0, 3, -1},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.01f, 0.1f}, ngraph::element::f32, {3, 1, 1}}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
      {{ngraph::element::f32}, {}, {{0.1f, 0.01f, 0.1f}, ngraph::element::f32, {1, 3, 1}}}}},
    ...
    {{1, 3},
     {1, -1},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.01f, 0.1f}, ngraph::element::f32, {1, 3}}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
      {{ngraph::element::f32}, {}, {{0.1f, 0.01f, 0.1f}, ngraph::element::f32, {1, 3}}}}},
    // U8: without subtract 2D -> 2D
    {{-1, 2},
     {-1, 6},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {}, {{0.1f, 0.02f}, ngraph::element::f32, {1, 2}}}},
     {ngraph::element::u8,
      {{}, {}, {}},
      ngraph::element::u8,
      {{ngraph::element::f32}, {}, {{0.1f, 0.02f, 0.1f, 0.02f, 0.1f, 0.02f}, ngraph::element::f32, {1, 6}}}}},
    // Nondequantization multiply (I32 precision)
    {{1, 384, 1024},
     {1, 384, 16, 64},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::i32, {{}, {}, {2}}},
     {ngraph::element::i32, {{}, {}, {2}}, ngraph::element::i32, {}}},
    ...
    {{-1, 3, -1, -1},
     {},
     LayerTransformation::createParamsU8I8(),
     {ngraph::element::u8, {{ngraph::element::f32}, {{128.f, 124.f, 120.f}}, {{0.1f, 1.f, 10.f}}}},
     {ngraph::element::u8,
