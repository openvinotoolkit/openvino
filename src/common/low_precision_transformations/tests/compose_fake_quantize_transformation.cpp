...
typedef std::tuple<ov::Shape, ComposeFakeQuantizeTransformationParams> ComposeFakeQuantizeTransformationValues;
...
public:
    void SetUp() override {
        ...
        actualFunction = ov::builder::subgraph::ComposeFakeQuantizeFunction::get(testValues.originalPrecision,
                                                                                 inputShape,
        ...
        referenceFunction =
            ov::builder::subgraph::ComposeFakeQuantizeFunction::get(testValues.originalPrecision,
                                                                    inputShape,
...
const std::vector<ComposeFakeQuantizeTransformationParams> testValues = {
    {
        ov::element::f32,
        {{256ul, {}, {0.f}, {2.55f}, {0.f}, {255.f}}, {{ov::element::f32}, {}, {0.01f}}, {}},
        {{256ul, {}, {0.f}, {2.55f}, {0.f}, {2.55f}}, {}, {}},
    },
    {
        ov::element::f32,
        {{256ul, {}, {0.f}, {2.55f}, {-128.f}, {127.f}}, {{ov::element::f32}, {-128}, {0.01f}}, {}},
        {{256ul, {}, {0.f}, {2.55f}, {0.f}, {2.55f}}, {}, {}},
    },
    {
        ov::element::f32,
