...
typedef std::tuple<ov::PartialShape, SpaceToBatchTransformationTestValues> SpaceToBatchTransformationParams;

class SpaceToBatchTransformation : public LayerTransformation,
...
public:
    void SetUp() override {
        ...
        actualFunction = ov::builder::subgraph::SpaceToBatchFunction::get(input_shape,
        ...
        referenceFunction = ov::builder::subgraph::SpaceToBatchFunction::get(input_shape,
