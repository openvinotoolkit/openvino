...
typedef std::tuple<ov::PartialShape, FuseConvertTransformationTestValues> FuseConvertTransformationParams;

class FuseConvertTransformation : public LayerTransformation,
...
public:
    void SetUp() override {
        ...
        actualFunction = ov::builder::subgraph::FuseConvertFunction::get(inputShape,
        ...
        referenceFunction = ov::builder::subgraph::FuseConvertFunction::get(inputShape,
    ...
    static std::string getTestCaseName(testing::TestParamInfo<FuseConvertTransformationParams> obj) {
        ...
        result << "IS_" << inputShape << "_" << "AIP_" << testValues.actual.inputPrecision << "_" << "ADEQ_"
               << testValues.actual.dequantization << "_" << "AFQ_" << testValues.actual.fakeQuantize << "_" << "EIP_"
               << testValues.expected.inputPrecision << "_" << "EDEQ_" << testValues.expected.dequantization << "_"
               << "EFQ_" << testValues.expected.fakeQuantize << "_" << testValues.constInput;
        return result.str();
    }
};
...
const std::vector<FuseConvertTransformationTestValues> testValues = {
    ...
    {false,
     ...
     {ov::element::u8, {{ov::element::f32}, {1.f}, {0.45f}}, {}},
     {ov::element::u8,
      {{}, DequantizationOperations::Subtract({1.f}, ov::element::f32).setConstantPrecision(ov::element::f32), {0.45f}},
      {}}},
    // fuse to multiply
    {false,
     LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {0.45f}}, {}},
     {ov::element::u8,
    ...
    {false,
     LayerTransformation::createParamsU8I8(),
     {ov::element::f32, {{ov::element::i32}, {}, {3.f}}, {}},
     {ov::element::f32, {{ov::element::i32}, {}, {3.f}}, {}}},
};
...
const std::vector<FuseConvertTransformationTestValues> testValuesWithConstant = {
    ...
    {true,
     LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {}, {}}, {256, {}, {0.f}, {0.1f}, {0.f}, {0.1f}, ov::element::f32}},
     {ov::element::f32, {}, {256, {}, {0.f}, {0.1f}, {0.f}, {0.1f}, ov::element::f32}}},
    // fuse to const
    {true,
     LayerTransformation::createParamsU8I8(),
     {ov::element::u8, {{ov::element::f32}, {1.f}, {0.45f}}, {}},
