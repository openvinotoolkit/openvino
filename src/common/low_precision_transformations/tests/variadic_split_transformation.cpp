...
const std::vector<VariadicSplitTransformationTestValues> testValues = {
    ...
    {{2, 3, 16, 16},
     ...
     {ngraph::element::u8,
      {},
      ngraph::element::u8,
      {{{ngraph::element::f32}, {2.f}, {22.f}}, {{ngraph::element::f32}, {3.f}, {33.f}}}}},
    ...
    {{1, 3, 16, 16},
     ...
     {ngraph::element::u8,
      {},
      ngraph::element::u8,
      {{{ngraph::element::f32}, {1.f}, {11.f}}, {{ngraph::element::f32}, {1.f}, {11.f}}}}},
    ...
    {{1, 3, 16, 16},
     ...
     {ngraph::element::u8,
      ...
      ngraph::element::u8,
      {
          {{ngraph::element::f32}, {}, {{11.f, 22.f, 33.f}, ngraph::element::f32, {1, 3, 1, 1}}},
          {{ngraph::element::f32}, {}, {{11.f, 22.f, 33.f}, ngraph::element::f32, {1, 3, 1, 1}}},
          {{ngraph::element::f32}, {}, {{11.f, 22.f, 33.f}, ngraph::element::f32, {1, 3, 1, 1}}},
      }}},
    // I8 without subtract
