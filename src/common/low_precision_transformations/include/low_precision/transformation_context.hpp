...
public:
    ...
    // ConcatTransformation and FakeQuantizeTransformation handle FakeQuantize operations. ConcatTransformation handles
    // FakeQuantize operation first. If updatePrecision transformation option is set to False then there are no
    // FakeQuantize operation attributes to identify that the operation have been handled by ConcatTransformation
    // already:
    ...
    // To avoid FakeQuantize operation double handling by FakeQuantizeTransformation after ConcatTransformation,
    // FakeQuantizeTransformation has to use this member.
