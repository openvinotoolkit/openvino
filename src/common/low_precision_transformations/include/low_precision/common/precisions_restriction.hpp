...
public:
    ...
    PrecisionsRestriction(const ov::Node::type_info_t& operationType,
    ...
    template <typename T>
    static PrecisionsRestriction create(const PrecisionsByPorts& precisionsByPorts, const bool specifyVersion = false) {
        return PrecisionsRestriction(T::get_type_info_static(), specifyVersion, precisionsByPorts);
    }

    template <typename T>
    static PrecisionsRestriction create(const PrecisionsByPortsFunction& precisionsByPortsFunction,
