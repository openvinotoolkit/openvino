...
/* The main purpose is to test that FuseTransposeBrgemm properly fuses 0213 Transposes on both inputs, as well as on
 * output
 */
...
typedef std::tuple<std::vector<PartialShape>,  // Input shapes
