...
TEST_F(SplitLoopsTest, BrgemmAdd) {
    ...
    const ov::snippets::VectorDims brgemm_c_subtensor{m_block, n_block};
    {
        ...
        auto result = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{add.second});
...

    {
        ...
        auto result = linear_ir_ref->push_node<ov::snippets::op::Result>(OutputVector{add.second});
...
TEST_F(SplitLoopsTest, AddBrgemm) {
    ...
    const ov::snippets::VectorDims brgemm_c_subtensor{m_block, n_block};
    {
        ...
        init_expr_descriptors(*brgemm.first, {brgemm_a_subtensor, brgemm_b_subtensor, brgemm_c_subtensor});
        auto result = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{brgemm.second});
...

    {
        ...
        init_expr_descriptors(*brgemm.first, {brgemm_a_subtensor, brgemm_b_subtensor, brgemm_c_subtensor});
        auto result = linear_ir_ref->push_node<ov::snippets::op::Result>(OutputVector{brgemm.second});
...
TEST_F(SplitLoopsTest, BrgemmAddBrgemm) {
    ...
    const ov::snippets::VectorDims brgemm_c_subtensor{m_block, n_block};
    {
        ...
        auto result = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{brgemm2.second});
...

    {
        ...
        init_expr_descriptors(*brgemm2.first, {brgemm_a_subtensor, brgemm_b_subtensor, brgemm_c_subtensor});
        auto result = linear_ir_ref->push_node<ov::snippets::op::Result>(OutputVector{brgemm2.second});
        ...
        const std::map<ExpressionPtr, std::vector<size_t>> expr_to_loop_ids = {
            {*brgemm1.first, {blocking_m_loop_id, blocking_n_loop_id}},
            {*add.first, {blocking_m_loop_id, blocking_n_loop_id, add_m_split_loop_id, add_n_split_loop_id}},
            {*brgemm2.first, {blocking_m_loop_id, brgemm2_blocking_n2_loop_id}}};
        const std::map<size_t, size_t> loop_ids_mapper = {{blocking_n_loop_id, 2},
                                                          {blocking_m_loop_id, 3},
                                                          {brgemm2_blocking_n2_loop_id, 4},
                                                          {add_n_split_loop_id, 7},
                                                          {add_m_split_loop_id, 9}};
        assign_loop_ids(expr_to_loop_ids, loop_ids_mapper);
    }
}
