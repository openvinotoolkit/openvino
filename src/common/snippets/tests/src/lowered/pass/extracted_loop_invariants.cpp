    ...
    */
    {
        ...
        auto result = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{sub.second});
    ...
    }
    {
        ...
        init_expr_descriptors(*sub.first, sub_subtensor, layout_1d);
        auto result = linear_ir_ref->push_node<ov::snippets::op::Result>(OutputVector{sub.second});
    ...
    */
    {
        ...
        auto result0 = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{add.second});
        auto result1 = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{sub.second});
        auto begin = multiply.first;
    ...
    }
    {
        ...
        auto result0 = linear_ir_ref->push_node<ov::snippets::op::Result>(OutputVector{add.second});
        auto result1 = linear_ir_ref->push_node<ov::snippets::op::Result>(OutputVector{sub.second});
    ...
    */
    {
        ...
        auto result = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{store.second});
    ...
    */
    {
        ...
        init_expr_descriptors(*add.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
        const auto result = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{add.second});
    ...
    */
    {
        ...
        auto result = linear_ir->push_node<ov::snippets::op::Result>(OutputVector{multiply.second});
        // 3 inner loop
    ...
    }
    {
        ...
        init_expr_descriptors(*multiply.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
        auto result = linear_ir_ref->push_node<ov::snippets::op::Result>(OutputVector{multiply.second});
        // outer loop
        const auto loop_begin = std::make_shared<ov::snippets::op::LoopBegin>(false);
