...
TEST_F(PrecisionPropagationGetPrecisionsTest, selected) {
    ASSERT_EQ(std::vector<element::Type>({element::f32, element::f32}),
              ov::snippets::pass::PropagatePrecision::get_precisions({element::f32, element::f32},
                                                                     {
...
TEST_F(PrecisionPropagationGetPrecisionsTest, first) {
    ASSERT_EQ(std::vector<element::Type>({element::bf16, element::bf16}),
              ov::snippets::pass::PropagatePrecision::get_precisions({element::i32, element::i32},
                                                                     {
                                                                         {element::bf16, element::bf16},
                                                                         {element::f32, element::f32},
                                                                         {element::i8, element::i8},
