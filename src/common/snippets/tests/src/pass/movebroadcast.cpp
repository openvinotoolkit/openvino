...
TEST_F(TransformationTestsF, InsertBroadcastMove) {
    {
        ...
        function = std::make_shared<Model>(NodeVector{add}, ParameterVector{data0, data1});
    ...
    }
    {
        ...
        function_ref = std::make_shared<Model>(NodeVector{add}, ParameterVector{data0, data1});
    }
}
