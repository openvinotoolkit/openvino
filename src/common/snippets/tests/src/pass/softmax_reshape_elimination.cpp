...
TEST_F(TransformationTestsF, SoftmaxV1ReshapeElimination) {
    {
        ...
        auto shape0 =
            std::make_shared<ov::op::v0::Constant>(ov::element::i32, ov::Shape{2}, std::vector<int32_t>{6, 240});
        ...
        auto shape1 =
            std::make_shared<ov::op::v0::Constant>(ov::element::i32, ov::Shape{3}, std::vector<int32_t>{2, 3, 240});
...
TEST_F(TransformationTestsF, SoftmaxReshapeElimination_IncorrectReshape) {
    {
        auto data = std::make_shared<ov::op::v0::Parameter>(element::f32, Shape{1, 2, 340, 240});
        auto shape0 =
            std::make_shared<ov::op::v0::Constant>(ov::element::i32, ov::Shape{2}, std::vector<int32_t>{2, 81600});
        auto reshape0 = std::make_shared<ov::op::v1::Reshape>(data, shape0, false);
        auto softmax_v1 = std::make_shared<ov::op::v8::Softmax>(reshape0, -1);
        auto shape1 = std::make_shared<ov::op::v0::Constant>(ov::element::i32,
                                                             ov::Shape{4},
