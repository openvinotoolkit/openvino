 ...
 * otherwise. Note: should be called before ResetBuffer() pass to have correct offsets
 * @ingroup snippets
 */
...
private:
     ...
     */
    static std::vector<bool> create_adjacency_matrix(lowered::LinearIR::constExprIt begin,
     ...
     * @param lhs Pair where first value is Expression with first Buffer and second value is data pointer shift params
     * for it
     * @param rhs Pair where first value is Expression with second Buffer and second value is data pointer shift params
     * for it
