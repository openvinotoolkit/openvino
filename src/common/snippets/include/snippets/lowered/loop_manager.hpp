...
public:
    ...
    size_t mark_loop(LinearIR::constExprIt loop_begin_pos,
        ...
        const auto loop_info =
            std::make_shared<UnifiedLoopInfo>(work_amount, normalized_increment, entries, exits, false);
     ...
     * @return the pair of loop_begin_pos and loop_end_pos iterators
     */
    static LoopBounds get_loop_bounds(const LinearIR& linear_ir,
                                      size_t loop_id,
...
private:
     ...
     */
    static void fuse_loop_ports(std::vector<LoopPort>& output_ports,
