...
SNIPPETS_API auto getRegisters(std::shared_ptr<ngraph::Node>& n) -> ngraph::snippets::RegInfo;
 ...
 * @ingroup snippets
 */
class SNIPPETS_API TargetMachine {
public:
    /**
