...
ov::snippets::pass::BroadcastToMoveBroadcast::BroadcastToMoveBroadcast() {
    ...
    auto callback = [](ov::pass::pattern::Matcher& m) {
        ...
        bool shapes_static = target_shape.is_static() && value_shape.rank().is_static();
        OPENVINO_ASSERT(shapes_static, "Broadcast with dynamic target shape is not supported in Snippets");
