...
std::vector<bool> BufferIdentification::create_adjacency_matrix(const LoweredExprIR& linear_ir, const BufferSet& buffers) const {
...
bool BufferIdentification::run(LoweredExprIR& linear_ir) {
