...
std::pair<ov::PartialShape, std::vector<ov::PartialShape>> get_numpy_broadcast_partial_shapes(
...
ov::snippets::pass::InsertMoveBroadcast::InsertMoveBroadcast() {
    ...
    auto any = std::make_shared<ov::pass::pattern::op::Label>(
        ov::pass::pattern::any_input(),
        [](const std::shared_ptr<Node>& n) {
            // should add supports_auto_broadcast to SquaredDifference
            return ((ov::op::util::supports_auto_broadcast(n) || is_type<ov::op::v0::SquaredDifference>(n) ||
                     is_type<ov::op::v1::Mod>(n)) &&
