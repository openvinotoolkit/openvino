...
bool SplitLoops::TransformInnerSplitLoop::run(LinearIR& linear_ir, LinearIR::constExprIt begin, LinearIR::constExprIt end) {
    ...
    for (auto it = begin; it != end; ++it) {
        ...
        const auto new_expanded_inner_loop_info =
            std::make_shared<ExpandedLoopInfo>(inner_splitted_unified_loop_info->get_work_amount(), inner_splitted_unified_loop_info->get_increment(),
                                               inner_splitted_unified_loop_info->get_input_ports(), inner_splitted_unified_loop_info->get_output_ports(),
                                               inner_splitted_unified_loop_info->get_ptr_increments(),
                                               inner_splitted_unified_loop_info->get_finalization_offsets(),
                                               inner_splitted_unified_loop_info->get_data_sizes(), inner_expanded_loop_info->get_type(),
                                               inner_splitted_unified_loop_info, inner_expanded_loop_info->is_evaluate_once());
