...
public:
    OPENVINO_RTTI("InitMasks", "0", ov::pass::GraphRewrite);
    InitMasks();
};
...
public:
    OPENVINO_RTTI("PropagateMasks", "0", ov::pass::GraphRewrite);
    PropagateMasks();
};
...
public:
    OPENVINO_RTTI("ShrinkWeights", "0", ov::pass::ModelPass);
...
public:
    OPENVINO_RTTI("Pruning", "0", ov::pass::ModelPass);
