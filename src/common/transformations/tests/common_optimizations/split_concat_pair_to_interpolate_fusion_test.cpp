...
TEST_F(TransformationTestsF, SplitConcatPairToInterpolateFusionSpatial2D1) {
    ...
    }
    {
        ...
        auto scales_node = ngraph::opset8::Constant::create(ngraph::element::f32,
                                                            {1},
                                                            std::vector<float>{static_cast<float>(scale_factor)});
        ...
        auto strided_slice_node =
            std::make_shared<ngraph::opset8::StridedSlice>(shape_node, sslice_begin, sslice_end, begin_mask, end_mask);
        ...
        auto interpolate =
            std::make_shared<ngraph::opset8::Interpolate>(input, cast_mul_result_to_int, scales_node, axis_node, attrs);
        function_ref =
...
TEST_F(TransformationTestsF, SplitConcatPairToInterpolateFusionTwoSplitsOneConcat) {
    ...
    int64_t axis = 4;
    {
        ...
        ngraph::OutputVector concat_inputs_vec{split1->output(0),
                                               split1->output(1),
                                               split2->output(0),
                                               split2->output(1)};
...
TEST_F(TransformationTestsF, SplitConcatPairToInterpolateFusionSpatial2D1WithConstantFolding) {
    ...
    }
    {
        ...
        auto axis_node = ngraph::opset8::Constant::create(ngraph::element::i64, {1}, std::vector<int64_t>{axis});
        auto sizes_node =
            ngraph::opset8::Constant::create(ngraph::element::i64, {1}, std::vector<int64_t>{target_size});
...
TEST_F(TransformationTestsF, SplitConcatPairToInterpolateFusionSpatial2D1Dynamic) {
    ngraph::PartialShape input_shape{ngraph::Dimension::dynamic(),
