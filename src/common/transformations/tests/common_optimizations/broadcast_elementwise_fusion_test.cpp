...
public:
    ...
    std::shared_ptr<Function> get_initial_function(const InputShape& input_shape,
        ...
        auto input_shape_node = ngraph::opset5::Constant::create(ngraph::element::i64,
        ...
        return std::make_shared<ngraph::Function>(ngraph::NodeVector{elementwise},
                                                  ngraph::ParameterVector{input1, input2});
    }

    std::shared_ptr<Function> get_reference(const InputShape& input_shape, const InputShape& broadcast_output_shape) {
        ...
        return std::make_shared<ngraph::Function>(ngraph::NodeVector{ref_elementwise},
                                                  ngraph::ParameterVector{ref_input1, ref_input2});
    }
};
...
public:
    ...
    std::shared_ptr<Function> get_reference(const InputShape& input_shape,
        ...
        auto ref_input_shape_node = ngraph::opset5::Constant::create(ngraph::element::i64,
                                                                     ngraph::Shape{broadcast_shape.size()},
                                                                     broadcast_shape);
...
public:
    ...
    std::shared_ptr<Function> get_initial_function(const InputShape& input_shape,
        ...
        auto input_shape_node =
            std::make_shared<ngraph::opset5::Parameter>(ngraph::element::i64,
                                                        ngraph::Shape{(size_t)(broadcast_shape.rank().get_length())});
        auto broadcast = std::make_shared<ngraph::opset5::Broadcast>(input2, input_shape_node);
        auto elementwise = std::make_shared<ngraph::opset5::Multiply>(input1, broadcast);
        return std::make_shared<ngraph::Function>(ngraph::NodeVector{elementwise},
                                                  ngraph::ParameterVector{input1, input2, input_shape_node});
    }
...
public:
    ...
    std::shared_ptr<Function> get_reference(const InputShape& input_shape,
        ...
        return std::make_shared<ngraph::Function>(
            ngraph::NodeVector{ref_elementwise},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        std::make_tuple(InputShape{1, 2, 1}, InputShape{3}, TargetShape{3}),
...
TEST_F(TransformationTestsF, BroadcastElementwiseFusionWithShapeOf) {
...

    {
        ...
        function_ref =
            std::make_shared<ngraph::Function>(ngraph::NodeVector{elementwise}, ngraph::ParameterVector{input});
    }
}
...
TEST_F(TransformationTestsF, BroadcastElementwiseFusionDynShapesDifferentRanks) {
    {
        auto input = std::make_shared<ngraph::opset5::Parameter>(ngraph::element::f32, ov::PartialShape{-1, -1, -1, -1});
        auto target_shape = std::make_shared<ngraph::opset5::Parameter>(ngraph::element::i32, ov::PartialShape{2});
        ...
        function = std::make_shared<ngraph::Function>(ngraph::NodeVector{elementwise}, ngraph::ParameterVector{input, target_shape});
