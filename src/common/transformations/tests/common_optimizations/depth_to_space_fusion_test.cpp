...
TEST_F(TransformationTestsF, DepthToSpaceFusionDepthFirst) {
    {
        ...
        function =
            std::make_shared<ngraph::Function>(ngraph::NodeVector{reshape_after}, ngraph::ParameterVector{input0});
...

    {
        ...
        auto depth_to_space =
            std::make_shared<ngraph::opset3::DepthToSpace>(input0,
                                                           ...
                                                           2);
        function_ref =
            std::make_shared<ngraph::Function>(ngraph::NodeVector{depth_to_space}, ngraph::ParameterVector{input0});
    }
}
...
TEST_F(TransformationTestsF, DepthToSpaceFusionDepthFirstDynamicBatch) {
    {
        ...
        function =
            std::make_shared<ngraph::Function>(ngraph::NodeVector{reshape_after}, ngraph::ParameterVector{input});
...

    {
        ...
        auto input = std::make_shared<ngraph::opset3::Parameter>(ngraph::element::f32, input_pshape);
        auto depth_to_space =
            std::make_shared<ngraph::opset3::DepthToSpace>(input,
                                                           ngraph::opset3::DepthToSpace::DepthToSpaceMode::DEPTH_FIRST,
                                                           2);
        function_ref =
            std::make_shared<ngraph::Function>(ngraph::NodeVector{depth_to_space}, ngraph::ParameterVector{input});
    }
}
...
TEST_F(TransformationTestsF, DepthToSpaceFusionSeveralConsumers) {
    {
        ...
        function = std::make_shared<ngraph::Function>(ngraph::NodeVector{result, additional_consumer},
...

    {
        ...
        function_ref = std::make_shared<ngraph::Function>(ngraph::NodeVector{result, additional_consumer},
                                                          ngraph::ParameterVector{input0});
    }
}
