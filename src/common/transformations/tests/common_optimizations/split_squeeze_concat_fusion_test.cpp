...
TEST_F(TransformationTestsF, SplitSqueezeConcatFusion) {
    ...
    {
        auto input = std::make_shared<ngraph::opset7::Parameter>(ngraph::element::f32,
                                                                 ngraph::Shape{1, 2, num_splits, 640, 20, 2});
...

    {
        ...
        auto transpose_order =
            ngraph::opset7::Constant::create(ngraph::element::i64, ngraph::Shape{6}, {0, 1, 3, 4, 2, 5});
        auto transpose = std::make_shared<ngraph::opset7::Transpose>(input, transpose_order);
        auto reshape_shape = ngraph::opset7::Constant::create<int64_t>(ngraph::element::i64,
                                                                       ngraph::Shape{5},
