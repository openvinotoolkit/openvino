...
TEST(TransformationTests, keep_precission_sensitive_fp32_1) {
...

    {
        ...
        disable_compression(exp_1, element::f16);
        disable_compression(reduce_sum_1, element::f16);
        disable_compression(mul_1, element::f16);
        disable_compression(factor_const, element::f16);
        disable_compression(factor_const_decompressed, element::f16);
...
TEST(TransformationTests, keep_precission_sensitive_fp32_with_reducemean) {
...

    {
        ...
        // marking nodes to be kept in fp32 for mixed precision
        disable_compression(exp_1, element::f16);
        disable_compression(reduce_mean_1, element::f16);
        disable_compression(mul_1, element::f16);
        disable_compression(factor_const, element::f16);
        disable_compression(factor_const_decompressed, element::f16);
...
TEST(TransformationTests, keep_precission_sensitive_fp32_2) {
...

    {
        ...
        // marking nodes to be kept in fp32 for mixed precision
        disable_compression(exp_1, ov::element::f16);
        disable_compression(reduce_sum_1, ov::element::f16);
        disable_compression(mul_1, ov::element::f16);
        disable_compression(unsqueeze_1, ov::element::f16);
        disable_compression(factor_const, ov::element::f16);
        disable_compression(factor_const_decompressed, ov::element::f16);
...
TEST(TransformationTests, keep_precission_sensitive_fp32_3) {
...

    {
        ...
        disable_compression(reduce_sum_1, ov::element::f16);
        disable_compression(mul_1, ov::element::f16);
        disable_compression(add_1, ov::element::f16);
        disable_compression(addition_const, ov::element::f16);
        disable_compression(factor_const, ov::element::f16);
        disable_compression(factor_const_decompressed, ov::element::f16);
...
TEST(TransformationTests, keep_precission_sensitive_fp32_7) {
...

    {
        ...
        // marking nodes to be kept in fp32 for mixed precision
        disable_compression(mul_1, ov::element::f16);
        disable_compression(mul_2, ov::element::f16);
        disable_compression(mul_3, ov::element::f16);
        disable_compression(mul_4, ov::element::f16);
        disable_compression(mul_5, ov::element::f16);
        disable_compression(unsqueeze_1, ov::element::f16);
        disable_compression(unsqueeze_2, ov::element::f16);
        disable_compression(unsqueeze_3, ov::element::f16);
        disable_compression(reduce_sum_1, ov::element::f16);
        disable_compression(reduce_sum_2, ov::element::f16);
        disable_compression(reduce_sum_3, ov::element::f16);
        disable_compression(reduce_sum_4, ov::element::f16);
        disable_compression(exp_1, ov::element::f16);
        disable_compression(exp_2, ov::element::f16);
        disable_compression(tile, ov::element::f16);
        disable_compression(eps_const, ov::element::f16);
        disable_compression(add_1, ov::element::f16);
        disable_compression(broadcast, ov::element::f16);
        disable_compression(div_1, ov::element::f16);

        disable_compression(factor_1, ov::element::f16);
        disable_compression(factor_2, ov::element::f16);

        disable_compression(broadcast_to_shape, ov::element::f16);
        disable_compression(tile_shape, ov::element::f16);
        disable_compression(const_unsqueeze_1, ov::element::f16);
        disable_compression(const_unsqueeze_2, ov::element::f16);
        disable_compression(const_unsqueeze_3, ov::element::f16);
...
TEST(TransformationTests, DivisionByZeroMinimalPattern) {
...

    {
        ...
        auto add = std::make_shared<Add>(input_2, eps_const);
        auto divide = std::make_shared<Divide>(input_1, add);
        disable_compression(divide, ov::element::f16);
        disable_compression(eps_const, ov::element::f16);
...
TEST(TransformationTests, DivisionByZeroEpsWithConvert) {
...

    {
        ...
        disable_compression(divide, ov::element::f16);
        disable_compression(eps_const, ov::element::f16);
        disable_compression(convert_eps, ov::element::f16);
        disable_compression(add, ov::element::f16);
...
TEST(TransformationTests, PowWithNegativeExponent) {
...

    {
        ...
        disable_compression(eps_const, ov::element::f16);
        disable_compression(add, ov::element::f16);
        disable_compression(pow_exp_const, ov::element::f16);
        disable_compression(pow, ov::element::f16);
        disable_compression(mul, ov::element::f16);
...
TEST(TransformationTests, DivisionByZeroInL2NormWithSqrtAndWithMax) {
...

    {
        ...
        // marking nodes to be kept in fp32 for mixed precision
        disable_compression(exp, ov::element::f16);
        disable_compression(pow, ov::element::f16);
        disable_compression(reduce_sum, ov::element::f16);
        disable_compression(max, ov::element::f16);
        disable_compression(eps_const, ov::element::f16);
        disable_compression(sqrt, ov::element::f16);
        disable_compression(divide, ov::element::f16);
...
TEST(TransformationTests, MarkReduceOpExpToKeepInMixedPrecision_with_reducemean) {
...

    {
        ...
        disable_compression(exp_1, ov::element::f16);
        disable_compression(mul_1, ov::element::f16);
        disable_compression(reduce_mean_1, ov::element::f16);
        disable_compression(factor_const_decompressed, ov::element::f16);
        disable_compression(factor_const, ov::element::f16);
    }
...
TEST(TransformationTests, MarkFloatingPointRange) {
...

    {
        ...
        // marking nodes to be kept in fp32 for mixed precision
        disable_compression(begin, ov::element::f16);
        disable_compression(end, ov::element::f16);
        disable_compression(step, ov::element::f16);
        disable_compression(range_1, ov::element::f16);
        disable_compression(range_2, ov::element::f16);
        disable_compression(convert_1, ov::element::f16);
        disable_compression(convert_2, ov::element::f16);
        disable_compression(unsqueeze, ov::element::f16);
        disable_compression(greater, ov::element::f16);
        disable_compression(convert, ov::element::f16);
