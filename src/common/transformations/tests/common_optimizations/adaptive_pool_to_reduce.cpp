...
TEST_F(TransformationTestsF, AdaptiveAvgPool2dToReduceMean) {
    {
        ...
        auto out_spatial_shape = op::v0::Constant::create(element::i32, Shape{2}, {1, 1});
        auto adaptive_pool = std::make_shared<op::v8::AdaptiveAvgPool>(data, out_spatial_shape);
        auto result = std::make_shared<op::v0::Result>(adaptive_pool);
    ...
    }
    {
        ...
        auto reduce_mean = std::make_shared<op::v1::ReduceMean>(data, axes, true);
        auto result = std::make_shared<op::v0::Result>(reduce_mean);
...
TEST_F(TransformationTestsF, AdaptiveMaxPool2dToReduceMax) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 3, 14, 14});
        auto out_spatial_shape = op::v0::Constant::create(element::i32, Shape{2}, {1, 1});
        auto adaptive_pool = std::make_shared<op::v8::AdaptiveMaxPool>(data, out_spatial_shape);
        auto result = std::make_shared<op::v0::Result>(adaptive_pool);
        model = std::make_shared<Model>(ResultVector{result}, ParameterVector{data});
        manager.register_pass<pass::AdaptivePoolToReduce>();
    }
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 3, 14, 14});
        auto axes = op::v0::Constant::create(element::i64, Shape{2}, {2, 3});
        auto reduce_mean = std::make_shared<op::v1::ReduceMax>(data, axes, true);
        auto result = std::make_shared<op::v0::Result>(reduce_mean);
        model_ref = std::make_shared<Model>(ResultVector{result}, ParameterVector{data});
    }
}
...
TEST_F(TransformationTestsF, AdaptiveMaxPool2dToReduceMaxUsedIndexes) {
    {
        ...
        auto out_spatial_shape = op::v0::Constant::create(element::i32, Shape{2}, {1, 1});
        auto adaptive_pool = std::make_shared<op::v8::AdaptiveMaxPool>(data, out_spatial_shape);
        auto result1 = std::make_shared<op::v0::Result>(adaptive_pool->output(0));
        auto result2 = std::make_shared<op::v0::Result>(adaptive_pool->output(1));
...
TEST_F(TransformationTestsF, AdaptiveAvgPool3dToReduceMean) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 3, 14, 14, 14});
        auto out_spatial_shape = op::v0::Constant::create(element::i32, Shape{3}, {1, 1, 1});
        auto adaptive_pool = std::make_shared<op::v8::AdaptiveAvgPool>(data, out_spatial_shape);
        auto result = std::make_shared<op::v0::Result>(adaptive_pool);
        model = std::make_shared<Model>(ResultVector{result}, ParameterVector{data});
        manager.register_pass<pass::AdaptivePoolToReduce>();
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 3, 14, 14, 14});
        auto axes = op::v0::Constant::create(element::i64, Shape{3}, {2, 3, 4});
        auto reduce_mean = std::make_shared<op::v1::ReduceMean>(data, axes, true);
        auto result = std::make_shared<op::v0::Result>(reduce_mean);
        model_ref = std::make_shared<Model>(ResultVector{result}, ParameterVector{data});
    }
