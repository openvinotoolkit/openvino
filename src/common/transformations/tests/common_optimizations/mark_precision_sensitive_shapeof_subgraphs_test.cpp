...
TEST_F(TransformationTestsF, MarkEntireShapeSubgraphs_whole_shape_subgraph_is_marked_1) {
    ...
    }
    {
        ...
        auto reshape = std::make_shared<opset10::Reshape>(input_1, new_shape, false);
        disable_compression(convert_to_float, element::f16);
        disable_compression(const_denominator, element::f16);
        disable_compression(div, element::f16);
        disable_compression(new_shape, element::f16);
        model_ref = std::make_shared<Model>(OutputVector{reshape}, ParameterVector{input_1, input_2});
    }
}
...
TEST_F(TransformationTestsF, MarkEntireShapeSubgraphs_whole_shape_subgraph_is_marked_2) {
    ...
    }
    {
        ...
        disable_compression(gather_1, element::f16);
        disable_compression(convert_to_float, element::f16);
        disable_compression(const_denominator, element::f16);
        disable_compression(div, element::f16);
        disable_compression(new_dim_size, element::f16);
        disable_compression(const_ends, element::f16);
        disable_compression(concat_with_ends, element::f16);
...
TEST_F(TransformationTestsF, MarkEntireShapeSubgraphs_whole_shape_subgraph_is_marked_3) {
...

    {
        ...
        disable_compression(gather_1, element::f16);
        disable_compression(convert_1, element::f16);
        disable_compression(convert_2, element::f16);
        disable_compression(const_2, element::f16);
        disable_compression(div_1, element::f16);
        disable_compression(const_3, element::f16);
        disable_compression(concat, element::f16);
        disable_compression(mul_1, element::f16);
        disable_compression(convert_3, element::f16);
