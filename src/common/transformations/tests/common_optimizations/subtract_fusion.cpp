...
TEST(TransformationTests, SubtractFusionMultiply) {
    std::shared_ptr<ov::Model> f, f_ref;
    {
        ...
        auto mul_constant = op::v0::Constant::create(element::f32, Shape{1}, {-1});
        auto mul = std::make_shared<op::v1::Multiply>(data2, mul_constant);
        auto add = std::make_shared<op::v1::Add>(data1, mul);
...

    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto divide = std::make_shared<op::v1::Subtract>(data1, data2);
...
TEST(TransformationTests, SubtractFusionMultiplyNegative) {
    std::shared_ptr<ov::Model> f, f_ref;
    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto mul_constant = op::v0::Constant::create(element::f32, Shape{1}, {-1.01});
        auto mul = std::make_shared<op::v1::Multiply>(data2, mul_constant);
        auto add = std::make_shared<op::v1::Add>(data1, mul);
...
TEST(TransformationTests, SubtractFusionNeg) {
    std::shared_ptr<ov::Model> f, f_ref;
    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto neg = std::make_shared<op::v0::Negative>(data2);
        auto add = std::make_shared<op::v1::Add>(neg, data1);
