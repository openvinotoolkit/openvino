...
TEST_F(TransformationTestsF, WrapInterpolateIntoTransposes4DScales) {
    ...
    }
    {
        ...
        auto interpolate =
            std::make_shared<ngraph::opset8::Interpolate>(first_transpose, sizes_node, scales_node, axis_node, attrs);
        auto last_transpose = std::make_shared<ngraph::opset8::Transpose>(interpolate, last_transpose_perm);

        function_ref =
            std::make_shared<ngraph::Function>(ngraph::NodeVector{last_transpose}, ngraph::ParameterVector{input});
    }
}
...
TEST_F(TransformationTestsF, WrapInterpolateIntoTransposes5DScales) {
    ...
    }
    {
        ...
        auto first_transpose_perm =
            ngraph::opset8::Constant::create(ngraph::element::i64, ngraph::Shape{5}, {0, 4, 1, 2, 3});
        auto last_transpose_perm =
            ngraph::opset8::Constant::create(ngraph::element::i64, ngraph::Shape{5}, {0, 2, 3, 4, 1});
