...
public:
    ...
    static Output<Node> make_slice(const Output<Node>& out,
        ...
        return std::make_shared<ov::op::v8::Slice>(out,
                                           ov::op::v0::Constant::create(element::i64, Shape{1}, {start}),
                                           ov::op::v0::Constant::create(element::i64, Shape{1}, {stop}),
    ...
    static Output<Node> make_tile(const Output<Node>& out, const std::vector<int64_t>& repeats) {
        return std::make_shared<ov::op::v0::Tile>(out, ov::op::v0::Constant::create(element::i64, Shape{repeats.size()}, repeats));
    }

    static Output<Node> make_reshape(const Output<Node>& out, const std::vector<int64_t>& order) {
        return std::make_shared<ov::op::v1::Reshape>(out, ov::op::v0::Constant::create(element::i64, Shape{order.size()}, order), true);
    }
};
...
TEST_F(SharedTransformationTestsF, SharedSlice) {
    {
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{slice_0, slice_1, slice_2, slice_3, slice_4}, 0);
    ...
    }
    {
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{slice_0, slice_0, slice_2, slice_0, slice_0}, 0);
...
TEST_F(SharedTransformationTestsF, SharedConcat) {
    {
        auto pre_constant_0 = ov::op::v0::Constant::create(element::f32, Shape{4}, std::vector<float>{3.14f, 42.f, 0.f, 14.f});
        auto pre_constant_1 = ov::op::v0::Constant::create(element::f32, Shape{4}, std::vector<float>{3.14f, 42.f, 0.f, 14.f});
        auto data = std::make_shared<ov::op::v0::Parameter>(element::f32, PartialShape{-1});
        auto post_constant = ov::op::v0::Constant::create(element::f32, Shape{1}, std::vector<float>{3.14f});

        auto concat_0 = std::make_shared<ov::op::v0::Concat>(OutputVector{pre_constant_0, data, post_constant}, 0);
        auto concat_1 = std::make_shared<ov::op::v0::Concat>(OutputVector{pre_constant_1, data, post_constant}, 0);

        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{concat_0, concat_1}, 0);
        model = std::make_shared<ov::Model>(OutputVector{concat}, ParameterVector{data});
        manager.register_pass<ov::pass::SharedOpOptimization>();
    }
    {
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{concat_0, concat_0}, 0);
        model_ref = std::make_shared<ov::Model>(OutputVector{concat}, ParameterVector{data});
    }
}
...
TEST_F(SharedTransformationTestsF, SharedSliceInThreeGroups) {
    {
        auto data = std::make_shared<ov::op::v0::Parameter>(element::f32, PartialShape::dynamic(10));
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{slice_0_0,
                                                                slice_1_0,
                                                                slice_2_0,
                                                                slice_0_1,
                                                                slice_1_1,
...
TEST_F(SharedTransformationTestsF, SharedShapeOfTest) {
    Shape input_shape{120, 4};
    {
        ...
        auto shapeof1_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof2_i64 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i64);
        auto shapeof3_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof4_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof5_i64 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i64);
        auto shapeof6_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof7_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);

        auto shapeof1_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof1_i32, element::i64);
        auto shapeof3_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof3_i32, element::i64);
        auto shapeof4_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof4_i32, element::i64);
        auto shapeof6_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof6_i32, element::i64);
        auto shapeof7_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof7_i32, element::i64);
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(inputs_of_concat, 0);
...
TEST_F(SharedTransformationTestsF, SharedShapeOfTestI64Only) {
    Shape input_shape{120, 4};
    {
        ...
        auto shapeof1_i64 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i64);
        auto shapeof2_i64 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i64);
        auto shapeof3_i64 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i64);
...
TEST_F(SharedTransformationTestsF, Sharedv1Broadcasts) {
    {
        auto input = std::make_shared<ov::op::v0::Parameter>(element::f32, PartialShape::dynamic());
        auto target_shape = std::make_shared<ov::op::v0::Parameter>(element::i64, PartialShape::dynamic());
        auto broadcast_v1_0 = std::make_shared<ov::op::v1::Broadcast>(input, target_shape);
        auto broadcast_v1_1 = std::make_shared<ov::op::v1::Broadcast>(input, target_shape, ov::op::AutoBroadcastType::PDPD);
        auto broadcast_v1_2 = std::make_shared<ov::op::v1::Broadcast>(input, target_shape);
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{broadcast_v1_0, broadcast_v1_1, broadcast_v1_2}, 0);
    ...
    }
    {
        ...
        auto broadcast_v1_0 = std::make_shared<ov::op::v1::Broadcast>(input, target_shape);
        auto broadcast_v1_1 = std::make_shared<ov::op::v1::Broadcast>(input, target_shape, ov::op::AutoBroadcastType::PDPD);
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{broadcast_v1_0, broadcast_v1_1, broadcast_v1_0}, 0);
...
TEST_F(SharedTransformationTestsF, Sharedv3Broadcasts) {
    {
        auto input = std::make_shared<ov::op::v0::Parameter>(element::f32, PartialShape::dynamic());
        auto target_shape = std::make_shared<ov::op::v0::Parameter>(element::i64, PartialShape::dynamic());
        auto broadcast_v1_0 = std::make_shared<ov::op::v3::Broadcast>(input, target_shape);
        auto broadcast_v1_1 = std::make_shared<ov::op::v3::Broadcast>(input, target_shape, ov::op::BroadcastType::BIDIRECTIONAL);
        auto broadcast_v1_2 = std::make_shared<ov::op::v3::Broadcast>(input, target_shape);
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{broadcast_v1_0, broadcast_v1_1, broadcast_v1_2}, 0);
        model = std::make_shared<Model>(OutputVector{concat}, ParameterVector{input, target_shape});
        manager.register_pass<pass::SharedOpOptimization>();
    }
...
TEST_F(SharedTransformationTestsF, SharedShapeOfTestI32Only) {
    Shape input_shape{120, 4};
    {
        ...
        auto shapeof1_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof2_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof3_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof4_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof5_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);

        auto shapeof1_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof1_i32, element::i64);
        auto shapeof2_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof2_i32, element::i64);
        auto shapeof3_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof3_i32, element::i64);
        auto shapeof4_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof4_i32, element::i64);
        auto shapeof5_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof5_i32, element::i64);
...
TEST_F(SharedTransformationTestsF, SharedShapeOfTestMixed) {
    Shape input_shape{120, 4};
    {
        ...
        auto shapeof1 = std::make_shared<ov::op::v0::ShapeOf>(input);
        auto shapeof2_i64 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i64);
        auto shapeof3_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof4 = std::make_shared<ov::op::v0::ShapeOf>(input);
        auto shapeof5_i64 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i64);
        auto shapeof6_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
        auto shapeof7_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);
    ...
    }
    {
        ...
        auto shapeof1 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i64);
        auto shapeof2_i32 = std::make_shared<ov::op::v3::ShapeOf>(input, element::i32);

        auto shapeof3_i32_convert = std::make_shared<ov::op::v0::Convert>(shapeof2_i32, element::i64);
...
OutputVector createShapeNodesInMemory(const std::vector<size_t>& node_order_in_memory,
    ...
    memory.reset(::malloc(node_order_in_memory.size() * sizeof(ov::op::v3::ShapeOf)), ::free);
    for (size_t i = 0; i < node_order_in_memory.size(); ++i) {
        ov::op::v3::ShapeOf* node_addr = static_cast<ov::op::v3::ShapeOf*>(memory.get()) + node_order_in_memory[i];
        auto node_ptr =
            std::shared_ptr<ov::op::v3::ShapeOf>(new (node_addr) ov::op::v3::ShapeOf(input, output_type), [](ov::op::v3::ShapeOf* node) {
                node->ov::op::v3::ShapeOf::~ShapeOf();
            });
        std::stringstream ss;
...
std::shared_ptr<Model> createModelWithShapes(const Shape& input_shape,
    ...
    for (const auto& shape_node : shape_nodes) {
        auto node = std::make_shared<ov::op::v0::Convert>(shape_node, element::i64);
...
TEST_F(SharedTransformationTestsF, SharedCeiling) {
    {
        ...
        auto ceiling_1 = std::make_shared<ov::op::v0::Ceiling>(data);
        auto ceiling_2 = std::make_shared<ov::op::v0::Ceiling>(data);

        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{ceiling_1, ceiling_2}, 0);
        model = std::make_shared<ov::Model>(OutputVector{concat}, ParameterVector{data});
        manager.register_pass<ov::pass::SharedOpOptimization>();
    }
    {
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{ceiling_1, ceiling_1}, 0);
        model_ref = std::make_shared<ov::Model>(OutputVector{concat}, ParameterVector{data});
    }
}
...
TEST_F(SharedTransformationTestsF, SharedFloor) {
    {
        ...
        auto op_1 = std::make_shared<ov::op::v0::Floor>(data);
        auto op_2 = std::make_shared<ov::op::v0::Floor>(data);

        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{op_1, op_2}, 0);
        model = std::make_shared<ov::Model>(OutputVector{concat}, ParameterVector{data});
        manager.register_pass<ov::pass::SharedOpOptimization>();
    }
    {
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{op_1, op_1}, 0);
        model_ref = std::make_shared<ov::Model>(OutputVector{concat}, ParameterVector{data});
    }
}
...
TEST_F(SharedTransformationTestsF, SharedRelu) {
    {
        ...
        auto op_1 = std::make_shared<ov::op::v0::Relu>(data);
        auto op_2 = std::make_shared<ov::op::v0::Relu>(data);
...
TEST_F(SharedTransformationTestsF, SharedMultiply) {
    {
        auto data_0 = std::make_shared<ov::op::v0::Parameter>(element::f32, PartialShape{-1, -1, -1, -1});
        auto data_1 = std::make_shared<ov::op::v0::Parameter>(element::f32, PartialShape{-1, -1, -1, -1});

        auto op_0 = std::make_shared<ov::op::v1::Multiply>(data_0, data_1);
        auto op_1 = std::make_shared<ov::op::v1::Multiply>(data_0, data_1);

        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{op_0, op_1}, 0);
    ...
    }
    {
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{op_0, op_0}, 0);
...
TEST_F(SharedTransformationTestsF, SharedDivide) {
    {
        ...
        auto op_0 = std::make_shared<ov::op::v1::Divide>(data_0, data_1);
        auto op_1 = std::make_shared<ov::op::v1::Divide>(data_0, data_1);
...
TEST_F(SharedTransformationTestsF, SharedPad) {
    {
        auto data_0 = std::make_shared<ov::op::v0::Parameter>(element::f32, PartialShape{-1, -1, -1, -1});
        auto data_1 = std::make_shared<ov::op::v0::Parameter>(element::i32, PartialShape{4});
        auto data_2 = std::make_shared<ov::op::v0::Parameter>(element::i32, PartialShape{4});

        auto op_1 = std::make_shared<ov::op::v12::Pad>(data_0, data_1, data_2, ov::op::PadMode::REFLECT);
        auto op_2 = std::make_shared<ov::op::v12::Pad>(data_0, data_1, data_2, ov::op::PadMode::REFLECT);
...
TEST_F(SharedTransformationTestsF, SharedMaxPool) {
    {
        ...
        auto op_1 =
            std::make_shared<ov::op::v8::MaxPool>(data, Strides{1, 1}, Strides{1, 1}, Shape{1, 1}, Shape{1, 1}, Shape{3, 3});
        auto op_2 =
            std::make_shared<ov::op::v8::MaxPool>(data, Strides{1, 1}, Strides{1, 1}, Shape{1, 1}, Shape{1, 1}, Shape{3, 3});
...
TEST_F(SharedTransformationTestsF, TopologicalOrder) {
    {
        ...
        auto gather_1 = std::make_shared<ov::op::v8::Gather>(shape_of,
                                                     ov::op::v0::Constant::create(element::i32, {1}, {0}),
                                                     ov::op::v0::Constant::create(element::i32, {}, {0}));

        auto gather_2 = std::make_shared<ov::op::v8::Gather>(shape_of,
                                                     ov::op::v0::Constant::create(element::i32, {1}, {0}),
                                                     ov::op::v0::Constant::create(element::i32, {}, {0}));

        auto add_0 = std::make_shared<ov::op::v1::Add>(gather_0, gather_0);
        auto add_1 = std::make_shared<ov::op::v1::Add>(gather_1, gather_1);
        auto add_2 = std::make_shared<ov::op::v1::Add>(gather_2, gather_2);

        auto concat_0 =
            std::make_shared<ov::op::v0::Concat>(OutputVector{gather_0, add_0, ov::op::v0::Constant::create(element::i64, {1}, {0})},
                                         0);
        auto concat_1 =
            std::make_shared<ov::op::v0::Concat>(OutputVector{gather_1, add_1, ov::op::v0::Constant::create(element::i64, {1}, {0})},
                                         0);
        auto concat_2 =
            std::make_shared<ov::op::v0::Concat>(OutputVector{gather_2, add_2, ov::op::v0::Constant::create(element::i64, {1}, {0})},
                                         0);

        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{concat_0, concat_1}, 0);
        auto output = std::make_shared<ov::op::v0::Concat>(OutputVector{concat, concat_2}, 0);
    ...
    }
    {
        ...
        auto concat_0 =
            std::make_shared<ov::op::v0::Concat>(OutputVector{gather_0, add_0, ov::op::v0::Constant::create(element::i64, {1}, {0})},
                                         0);
        auto concat = std::make_shared<ov::op::v0::Concat>(OutputVector{concat_0, concat_0}, 0);
        auto output = std::make_shared<ov::op::v0::Concat>(OutputVector{concat, concat_0}, 0);
