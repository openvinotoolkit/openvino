...
TEST_F(TransformationTestsF, ConvolutionReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto weights =
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, 3, DYN, DYN});
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
        auto conv = std::make_shared<op::v1::Convolution>(data,
                                                           weights,
...
TEST_F(TransformationTestsF, ConvolutionReverseInferUpdateShape) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic(4));
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
        auto conv = std::make_shared<op::v1::Convolution>(data,
                                                           weights,
...
TEST_F(TransformationTestsF, ConvolutionBackpropDataReverseInfer) {
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, 20, DYN, DYN});
        auto weights =
            op::v0::Constant::create(element::f32, Shape{20, 10, 3, 3}, std::vector<float>(20 * 10 * 3 * 3, 0.1f));
        auto conv = std::make_shared<op::v1::ConvolutionBackpropData>(data,
                                                                       weights,
...
TEST_F(TransformationTestsF, GroupConvolutionReverseInfer) {
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, 9, DYN, DYN});
        auto weights =
            op::v0::Constant::create(element::f32, Shape{3, 2, 3, 7, 7}, std::vector<float>(3 * 2 * 3 * 7 * 7, 0.1f));
        auto conv = std::make_shared<op::v1::GroupConvolution>(data,
                                                                weights,
...
TEST_F(TransformationTestsF, DeformableConvolutionReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto offsets = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto weights =
    ...
    }
    {
        ...
        auto offsets = std::make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic(4));
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 4, 5, 5}, std::vector<float>(64 * 4 * 5 * 5, 0.1f));
...
TEST_F(TransformationTestsF, PadReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto pads_begin = op::v0::Constant::create(element::i64, Shape{4}, {0, 0, 0, 0});
        auto pads_end = op::v0::Constant::create(element::i64, Shape{4}, {0, 0, 0, 0});
        auto value = op::v0::Constant::create(element::f32, Shape{}, {0});
        auto pad = std::make_shared<op::v1::Pad>(data, pads_begin, pads_end, value, op::PadMode::CONSTANT);
        auto result = std::make_shared<op::v0::Result>(pad);
        model = std::make_shared<Model>(ResultVector{result}, ParameterVector{data});
        manager.register_pass<pass::ReverseShapeAndTypeInfer>();
    }
    {
...
TEST_F(TransformationTestsF, NegativePad12ReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto pads_begin = op::v0::Constant::create(element::i64, Shape{4}, {0, 0, 0, -1});
        auto pads_end = op::v0::Constant::create(element::i64, Shape{4}, {0, 0, 0, -1});
        auto value = op::v0::Constant::create(element::f32, Shape{}, {0});
...
TEST_F(TransformationTestsF, EltwiseScalarRightReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto add_const = op::v0::Constant::create(element::f32, Shape{}, {1});
...
TEST_F(TransformationTestsF, EltwiseScalarLeftReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto add_const = op::v0::Constant::create(element::f32, Shape{}, {1});
        auto add = std::make_shared<op::v1::Add>(add_const, data);
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
        auto conv = std::make_shared<op::v1::Convolution>(add,
                                                           weights,
...
TEST_F(TransformationTestsF, ConcatReverseInfer) {
    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        // Specify rank and type in one of Concat input to inherit in another
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 3, 224, 224});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{data1, data2}, 0);
    ...
    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, 3, 224, 224});
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 3, 224, 224});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{data1, data2}, 0);
        auto result = std::make_shared<op::v0::Result>(concat);
...
TEST_F(TransformationTestsF, ConcatReverseInferUpdateShape) {
    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape{DYN, DYN, 224, DYN});
        // Specify rank and type in one of Concat input to inherit in another
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, 3, DYN, 224});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{data1, data2}, 0);
        auto result = std::make_shared<op::v0::Result>(concat);
        model = std::make_shared<Model>(ResultVector{result}, ParameterVector{data1, data2});
        manager.register_pass<pass::ReverseShapeAndTypeInfer>();
    ...
    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, 3, 224, 224});
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, 3, 224, 224});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{data1, data2}, 0);
        auto result = std::make_shared<op::v0::Result>(concat);
        model_ref = std::make_shared<Model>(ResultVector{result}, ParameterVector{data1, data2});
    }
...
TEST_F(TransformationTestsF, SliceReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto start = op::v0::Constant::create(element::i32, Shape{1}, {0});
        auto stop = op::v0::Constant::create(element::i32, Shape{1}, {1});
...
TEST_F(TransformationTestsF, SqueezeReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto axes = op::v0::Constant::create(element::i32, Shape{2}, {0, 1});
        auto squeeze = std::make_shared<op::v0::Squeeze>(data, axes);
        // Convolution is needed to produce static rank
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic(6));
        auto axes = op::v0::Constant::create(element::i32, Shape{2}, {0, 1});
        auto squeeze = std::make_shared<op::v0::Squeeze>(data, axes);
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
...
TEST_F(TransformationTestsF, SqueezeAxesReverseInfer) {
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape{1, dyn, 1, dyn, dyn, dyn});
        auto squeeze = std::make_shared<op::v0::Squeeze>(data);
        // Convolution is needed to produce static rank
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
        auto conv = std::make_shared<op::v1::Convolution>(squeeze,
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{1, dyn, 1, dyn, dyn, dyn});
...
TEST_F(TransformationTestsF, UnsqueezeReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto axes = op::v0::Constant::create(element::i32, Shape{1}, {0});
        auto unsqueeze = std::make_shared<op::v0::Unsqueeze>(data, axes);
        // Convolution is needed to produce static rank
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
...
TEST_F(TransformationTestsF, ConvertLikeReverseInfer) {
    {
        ...
        auto data1 = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto data2 = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto convert_like = std::make_shared<op::v1::ConvertLike>(data1, data2);
        // Convolution is needed to produce static rank
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
    ...
    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape{DYN, 3, DYN, DYN});
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
        auto convert_like = std::make_shared<op::v1::ConvertLike>(data1, data2);
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
        auto conv = std::make_shared<op::v1::Convolution>(convert_like,
...
TEST_F(TransformationTestsF, IfReverseInfer) {
    {
        auto X = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto cond = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());

        // Body parameters
        auto Xt = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto Xe = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        // Body
        auto one = op::v0::Constant::create(element::f32, Shape{}, {1});
        auto then_op = std::make_shared<op::v1::Add>(Xt, one);
        ...
        auto neg_one = op::v0::Constant::create(element::f32, Shape{}, {-1});
        auto else_op = std::make_shared<op::v1::Add>(Xe, neg_one);
    ...
    }
    {
        ...
        // Body parameters
        auto Xt = std::make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic(4));
        auto Xe = std::make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic(4));
        // Body
        auto one = op::v0::Constant::create(element::f32, Shape{}, {1});
        auto then_op = std::make_shared<op::v1::Add>(Xt, one);
        auto then_op_res = std::make_shared<op::v0::Result>(then_op);
...
TEST_F(TransformationTestsF, TransposeWithDynamicOrderReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto order = std::make_shared<op::v0::Parameter>(element::i32, PartialShape::dynamic());
...
TEST_F(TransformationTestsF, TransposeWithConstantOrderReverseInfer) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto order = std::make_shared<op::v0::Constant>(element::i32, Shape{3}, std::vector<int64_t>{1, 0, 2});
        auto transpose = std::make_shared<op::v1::Transpose>(data, order);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic(3));
        auto order = std::make_shared<op::v0::Constant>(element::i32, Shape{3}, std::vector<int64_t>{1, 0, 2});
        auto transpose = std::make_shared<op::v1::Transpose>(data, order);
        auto result = std::make_shared<op::v0::Result>(transpose);
        model_ref = std::make_shared<Model>(ResultVector{result}, ParameterVector{data});
...
TEST_F(TransformationTestsF, TransposeWithConstantOrderReverseInfer2) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::dynamic, PartialShape::dynamic());
        auto order = std::make_shared<op::v0::Constant>(element::i32, Shape{4}, std::vector<int64_t>{0, 3, 1, 2});
        auto transpose = std::make_shared<op::v1::Transpose>(data, order);
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
        auto conv = std::make_shared<op::v1::Convolution>(transpose,
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, DYN, DYN, 3});
        auto order = std::make_shared<op::v0::Constant>(element::i32, Shape{4}, std::vector<int64_t>{0, 3, 1, 2});
        auto transpose = std::make_shared<op::v1::Transpose>(data, order);
        auto weights =
            op::v0::Constant::create(element::f32, Shape{64, 3, 7, 7}, std::vector<float>(64 * 3 * 7 * 7, 0.1f));
