...
TEST_P(LSTMStatesBroadcastTest, BareLSTM) {
    ...
    shared_ptr<ov::Model> model(nullptr);
    {
        ...
        auto initial_hidden_state =
            v0::Constant::create(p.data_et, ov::PartialShape{1, p.hidden_size}.to_shape(), {0});
        auto initial_cell_state =
            v0::Constant::create(p.data_et, ov::PartialShape{1, p.hidden_size}.to_shape(), {0});
        auto W =
            v0::Constant::create(p.data_et, ov::PartialShape{p.hidden_size * 4, p.input_size}.to_shape(), {0});
        auto R =
            v0::Constant::create(p.data_et, ov::PartialShape{p.hidden_size * 4, p.hidden_size}.to_shape(), {0});
...
TEST_P(LSTMStatesBroadcastTestWithTI, TI_With_LSTM) {
    ...
    shared_ptr<ov::Model> model(nullptr);
    {
        ...
        auto H_init =
            v0::Constant::create(ov::element::i64, ov::PartialShape{1, p.hidden_size}.to_shape(), {0});
        auto C_init =
            v0::Constant::create(ov::element::i64, ov::PartialShape{1, p.hidden_size}.to_shape(), {0});
