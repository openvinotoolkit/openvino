...
TEST(TransformationTests, ConstFoldingPriorBox8) {
...

    {
        ...
        auto const_prior_box = ngraph::opset8::Constant::create<float>(
            ngraph::element::f32,
            ngraph::Shape{2, 48},
            {0.15f, 0.15f, 0.35f, 0.35f, 0.127526f, 0.16835f, 0.372474f, 0.33165f, 0.0918861f, 0.0918861f, 0.408114f, 0.408114f,
             0.65f, 0.15f, 0.85f, 0.35f, 0.627526f, 0.16835f, 0.872474f, 0.33165f, 0.591886f,  0.0918861f, 0.908114f, 0.408114f,
             0.15f, 0.65f, 0.35f, 0.85f, 0.127526f, 0.66835f, 0.372474f, 0.83165f, 0.0918861f, 0.591886f,  0.408114f, 0.908114f,
             0.65f, 0.65f, 0.85f, 0.85f, 0.627526f, 0.66835f, 0.872474f, 0.83165f, 0.591886f,  0.591886f,  0.908114f, 0.908114f,
