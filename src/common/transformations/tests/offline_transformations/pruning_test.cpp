...
Output<Node> create_constant_with_zeros(const Shape& shape, const Mask& mask) {
    ...
    return std::make_shared<op::v0::Constant>(element::f32, shape, values);
}
...
TEST(TransformationTests, InitMasksOutputChannel) {
    ...
    auto weights = std::make_shared<op::v0::Constant>(element::f32, weights_shape, values);
...
TEST(TransformationTests, InitMasksNegative) {
    Shape weights_shape{6, 3, 3, 3};
    auto weights = op::v0::Constant::create(element::f32, weights_shape, {0.5});
...
TEST_F(TransformationTestsF, PropagateMasksBasic) {
    ...
    auto sub = std::make_shared<op::v1::Subtract>(add, sub_const);
...

    {
        ...
        auto sub_const = op::v0::Constant::create(element::f32, Shape{3, 1, 1}, {1});
        auto sub = std::make_shared<op::v1::Subtract>(add, sub_const);

        auto mul_const = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {1});
        auto mul = std::make_shared<ov::op::v1::Multiply>(sub, mul_const);
...
TEST_F(TransformationTestsF, PropagateMasksDynamicConvolution) {
    ...
    auto sub = std::make_shared<op::v1::Subtract>(relu, sub_const);

    auto mul_const = create_constant_with_zeros(Shape{6, 1, 1}, {{2}, {}, {}});
    auto mul = std::make_shared<op::v1::Subtract>(sub, mul_const);
...
TEST(TransformationTests, PropagateMasksEmpty) {
    ...
    auto add = std::make_shared<op::v1::Subtract>(sub, add_const);
...
TEST_F(TransformationTestsF, PropagateMaskPassThrough) {
    ...
    auto clamp = std::make_shared<op::v0::Clamp>(relu, 0, 6);
...
TEST_F(TransformationTestsF, PropagateMasksHardDependencies) {
    ...
    auto input2 = std::make_shared<op::v0::Parameter>(element::f32, input_shape);
    ...
    auto reshape =
        std::make_shared<op::v1::Reshape>(add1, op::v0::Constant::create(element::i64, Shape{2}, {1, 6}), true);
    reshape->set_friendly_name("reshape");

    auto matmul_const = op::v0::Constant::create(element::f32, Shape{6, 100}, {1.});
    auto matmul = std::make_shared<op::v0::MatMul>(reshape, matmul_const);
    matmul->set_friendly_name("matmul");

    auto add2 = std::make_shared<op::v1::Add>(conv2, create_constant_with_zeros({6, 1, 1}, {{2}, {}, {}}));
    add2->set_friendly_name("add2");

    Shape weights_shape3{6, 6, 1, 1};
    auto weights3 = op::v0::Constant::create(element::f32, weights_shape3, {0});
    ...
    model = std::make_shared<Model>(NodeVector{matmul, conv3}, ParameterVector{input1, input2});
    {
        ...
        auto reshape =
            std::make_shared<op::v1::Reshape>(add1, op::v0::Constant::create(element::i64, Shape{2}, {1, 5}), true);
        reshape->set_friendly_name("reshape");

        auto matmul =
            std::make_shared<op::v0::MatMul>(reshape, op::v0::Constant::create(element::f32, Shape{5, 100}, {1.}));
        matmul->set_friendly_name("matmul");

        auto add2 = std::make_shared<op::v1::Add>(conv2, create_constant_with_zeros({5, 1, 1}, {{}, {}, {}}));
        add2->set_friendly_name("add2");
...
TEST_F(TransformationTestsF, PropagateMasksQuantizedGroupConvolution) {
    ...
    auto convert = std::make_shared<op::v0::Convert>(weights_group, element::f32);
    convert->set_friendly_name("convert");

    auto sub_const = create_constant_with_zeros(Shape{8, 1, 1, 1}, {{0, 1, 2, 3, 4}, {}, {}, {}});

    auto sub = std::make_shared<op::v1::Subtract>(convert, sub_const);
    ...
    ;
    auto add = std::make_shared<op::v1::Add>(conv_group, add_const);
    ...
    model = std::make_shared<Model>(NodeVector{conv2}, ParameterVector{input});
    {
        ...
        auto reshape_const = op::v0::Constant::create(element::i64, Shape{5}, {8, 1, 1, 3, 3});
        ...
        const auto dims_to_keep =
            op::v0::Constant::create(reshape_const->get_element_type(), {dims_to_keep_vec.size()}, dims_to_keep_vec);
        const auto reshape_gather = std::make_shared<op::v8::Gather>(reshape_const, dims_to_keep, axis);
        const auto reshape_concat = std::make_shared<op::v0::Concat>(
            NodeVector{op::v0::Constant::create(reshape_const->get_element_type(), {2}, {-1, 1}), reshape_gather},
            0);
...
TEST_F(TransformationTestsF, PropagateMasksQuantizedGroupConvolutionWithShapeOf) {
    ...
    auto shape_of = std::make_shared<op::v3::ShapeOf>(mul);
    auto axis = op::v0::Constant::create(ov::element::i8, {}, {0});
    auto split_lenghts = op::v0::Constant::create(ov::element::i8, {2}, {1, -1});
    auto variadic_split = std::make_shared<op::v1::VariadicSplit>(shape_of, axis, split_lenghts);
    auto div_const = op::v0::Constant::create(ov::element::i64, {1}, {8});
    auto div = std::make_shared<op::v1::Divide>(variadic_split->output(0), div_const);
    auto reshape_concat = std::make_shared<op::v0::Concat>(
        OutputVector{op::v0::Constant::create(shape_of->get_element_type(), {1}, {8})->output(0),
                     div->output(0),
    ...
    model = std::make_shared<Model>(NodeVector{conv2}, ParameterVector{input});
    {
        ...
        auto reshape_concat = std::make_shared<op::v0::Concat>(
            OutputVector{op::v0::Constant::create(shape_of->get_element_type(), {1}, {1})->output(0),
                         div->output(0),
                         variadic_split->output(1)},
            0);

        const auto axis_1 = op::v0::Constant::create(ov::element::i8, {}, {0});
        auto dims_to_keep_vec = std::vector<size_t>{2, 3, 4};
        const auto dims_to_keep =
            op::v0::Constant::create(reshape_concat->get_element_type(), {dims_to_keep_vec.size()}, dims_to_keep_vec);
        const auto new_reshape_gather = std::make_shared<op::v8::Gather>(reshape_concat, dims_to_keep, axis_1);
        const auto new_reshape_concat = std::make_shared<op::v0::Concat>(
            NodeVector{op::v0::Constant::create(reshape_concat->get_element_type(), {2}, {-1, 1}), new_reshape_gather},
            0);
...
TEST_F(TransformationTestsF, PropagateMasksFakeQuantizePerTensor) {
    ...
    auto input = std::make_shared<op::v0::Parameter>(element::f32, input_shape);
    input->set_friendly_name("input");
    auto weights_1 = op::v0::Constant::create(element::i8, weights_shape, {0});
    ...
    auto add_const = create_constant_with_zeros(Shape{1, 8, 1, 1}, {{}, {0, 1, 2, 3, 4}, {}, {}});
    ;
    auto add = std::make_shared<op::v1::Add>(conv1, add_const);
    add->set_friendly_name("add");

    auto input_low = op::v0::Constant::create(element::f32, Shape{1}, {0});
    auto input_high = op::v0::Constant::create(element::f32, Shape{1, 1, 1, 1}, {20});
    auto output_low = op::v0::Constant::create(element::f32, Shape{}, {1});
    auto output_high = op::v0::Constant::create(element::f32, Shape{}, {10});
...
TEST_F(TransformationTestsF, PropagateMasksFakeQuantizePerChannel) {
    ...
    auto input_low = op::v0::Constant::create(element::f32, Shape{1, 8, 1, 1}, {0});
    auto input_high = op::v0::Constant::create(element::f32, Shape{1, 8, 1, 1}, {20});
    auto output_low = op::v0::Constant::create(element::f32, Shape{8, 1, 1}, {1});
    auto output_high = op::v0::Constant::create(element::f32, Shape{8, 1, 1}, {10});
    auto fq = std::make_shared<op::v0::FakeQuantize>(add, input_low, input_high, output_low, output_high, 8);
    ...
    model = std::make_shared<Model>(NodeVector{conv2}, ParameterVector{input});
    {
        ...
        auto input_low = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {0});
        auto input_high = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {20});
        auto output_low = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {1});
        auto output_high = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {10});
        auto fq = std::make_shared<op::v0::FakeQuantize>(add, input_low, input_high, output_low, output_high, 8);
...
TEST_F(TransformationTestsF, TestConcatMaskPropagationUp) {
    ...
    auto add = std::make_shared<op::v1::Add>(concat, add_const);
...
TEST(TransformationTests, PruneBranchingStopOp) {
    ...
    auto mul = std::make_shared<op::v1::Multiply>(conv_1, conv);
...
TEST(TransformationTests, PruneStopOpUp) {
    ...
    auto mul = std::make_shared<op::v1::Multiply>(group_conv, mul_const);
...
TEST_P(TransformationTestsBoolParamF, MaskPropagationReshapeUpWithShapeOf) {
    ...
    if (use_shape_of) {
        reshape_shape_input = std::make_shared<op::v3::ShapeOf>(conv);
    } else {
        auto shape_of = std::make_shared<op::v3::ShapeOf>(conv);
        const auto axis = op::v0::Constant::create(ov::element::i8, {}, {0});
        const auto dims_to_keep = op::v0::Constant::create(element::i64, {2}, std::vector<int64_t>{2, 3});
        const auto gather = std::make_shared<op::v8::Gather>(shape_of, dims_to_keep, axis);
        const auto one_const = op::v0::Constant::create(element::i64, {1}, {1});
        const auto minus_one_const = op::v0::Constant::create(element::i64, {1}, {-1});
        const auto concat = std::make_shared<op::v0::Concat>(NodeVector{one_const, minus_one_const, gather}, 0);
        reshape_shape_input = concat;
    }
    auto reshape = std::make_shared<op::v1::Reshape>(conv, reshape_shape_input, true);
...
TEST_F(TransformationTestsF, MaskPropagationReshapeUpShapeSubGraph) {
    ...
    model = std::make_shared<ov::Model>(OutputVector{conv_1}, ParameterVector{input});
    {
        ...
        const auto sub_const = op::v0::Constant::create(concat->get_element_type(), {4}, {0, 3, 0, 0});
        const auto sub = std::make_shared<op::v1::Subtract>(concat, sub_const);

        auto reshape = std::make_shared<op::v1::Reshape>(conv, sub, true);
...
TEST_F(TransformationTestsF, MaskPropagationReshapeExtend) {
    ...
    auto mul = std::make_shared<op::v1::Multiply>(reshape_to, mul_const);

    auto shape_of = std::make_shared<op::v3::ShapeOf>(conv);
    auto reshape_from = std::make_shared<op::v1::Reshape>(mul, shape_of, true);

    auto add_const = create_constant_with_zeros(inputShapes, {{}, {2, 3}, {}, {}});
    auto add = std::make_shared<op::v1::Add>(reshape_from, add_const);
...
TEST_F(DISABLED_TransformationTestsF, MaskPropagationReshapeDownMul) {
    ...
    auto mul = std::make_shared<op::v1::Multiply>(first_conv, reshape_1);
...
TEST_F(TransformationTestsF, MaskPropagationReshapeDownAdd) {
    ...
    auto add = std::make_shared<op::v1::Add>(first_conv, reshape_1);
...
TEST_F(TransformationTestsF, MaskPropagationReshapeUnsqueezeUp) {
    ...
    auto mul_right = std::make_shared<op::v0::MatMul>(input, right_weights);

    auto reshape_const = op::v0::Constant::create(element::i64, {3}, {0, 6, 2});
    auto reshape = std::make_shared<op::v1::Reshape>(mul_right, reshape_const, true);

    auto left_up_weights = create_constant_with_zeros(weightsLeftUpShape, {{}, {1, 2}});
    auto mul_left_up = std::make_shared<op::v0::MatMul>(input, left_up_weights);

    auto mul_left = std::make_shared<op::v0::MatMul>(mul_left_up, reshape);
    ...
    model = std::make_shared<ov::Model>(OutputVector{mul_left}, ParameterVector{input});
    {
        ...
        auto reshape_const = op::v0::Constant::create(element::i64, {3}, {0, 4, 2});
        auto reshape = std::make_shared<op::v1::Reshape>(mul_right, reshape_const, true);
...
TEST_F(TransformationTestsF, MaskPropagationReshapeUnsqueezeDown) {
    ...
    auto transpose_const = op::v0::Constant::create(element::i64, {3}, {0, 2, 1});
    auto transpose = std::make_shared<op::v1::Transpose>(reshape, transpose_const);

    auto left_weights = create_constant_with_zeros(weightsLeftShape, {{}, {1, 2}});

    auto mul_left = std::make_shared<op::v0::MatMul>(transpose, left_weights);
...
TEST(TransformationTests, MaskPropagationWrongDimsElementwise) {
    ...
    auto mul = std::make_shared<op::v1::Multiply>(branch_conv, reshape);
...
TEST_F(TransformationTestsF, PruneSEBlock) {
    ...
    auto reshape_const = op::v0::Constant::create(element::i64, Shape{4}, {1, 6, 1, 1});
    auto reshape = std::make_shared<op::v1::Reshape>(reduce_mean, reshape_const, true);
    ...
    model = std::make_shared<ov::Model>(OutputVector{end_conv}, ParameterVector{input});
    {
        ...
        auto reshape_const = op::v0::Constant::create(element::i64, Shape{4}, {1, 3, 1, 1});
        auto reshape = std::make_shared<op::v1::Reshape>(reduce_mean, reshape_const, true);
...
TEST_F(TransformationTestsF, PropagateMasksLinear) {
    ...
    auto reshape = std::make_shared<op::v1::Reshape>(relu, reshape_const, true);

    auto weights_linear = create_constant_with_zeros(weights_linear_shape, {{}, {0, 1, 2}});
    auto linear = std::make_shared<op::v0::MatMul>(reshape, weights_linear);
    ...
    auto last_linear = std::make_shared<op::v0::MatMul>(linear, weights_last_linear);
...
TEST(TransformationTests, MaskPropagationMatMulStopEmptyABranch) {
    ...
    auto mul_left = std::make_shared<op::v0::MatMul>(left_weights, reshape);
...
TEST(TransformationTests, PruneLinearUp) {
    ...
    auto linear = std::make_shared<op::v0::MatMul>(reshape, linear_const);

    auto add_mask = Mask();
    add_mask.push_back({});
    add_mask.push_back(outer_dim_zeros);
    auto add_const = create_constant_with_zeros({1, linear_input_features}, add_mask);
    auto add = std::make_shared<op::v1::Add>(linear, add_const);
    auto add_const_1 = create_constant_with_zeros({1, linear_input_features}, add_mask);
    auto add_1 = std::make_shared<op::v1::Add>(add, add_const_1);
    auto add_2 = std::make_shared<op::v1::Add>(add_1, reshape);

    auto bad_add_const = create_constant_with_zeros({1, linear_input_features}, {{}, {}});
    auto bad_add = std::make_shared<op::v1::Add>(add_2, bad_add_const);

    auto weights_end_linear = create_constant_with_zeros(lastLinearShape, {{1, 2, 3}, {3, 4, 6}});
    auto last_linear = std::make_shared<op::v0::MatMul>(bad_add, weights_end_linear, false, true);
...
TEST(TransformationTests, PruneConvUpShort) {
    ...
    auto add_1 = std::make_shared<op::v1::Add>(add, add_const_1);
    auto add_2 = std::make_shared<op::v1::Add>(add_1, conv);
...
TEST_F(TransformationTestsF, MaskPropagationLinearOuterDims) {
    ...
    auto eltwise_mul = std::make_shared<op::v1::Multiply>(mul_right, eltwise_mul_const);

    auto reshape_const = op::v0::Constant::create(element::i64, {4}, {0, 0, 6, 2});
    auto reshape = std::make_shared<op::v1::Reshape>(eltwise_mul, reshape_const, true);
    ...
    auto flatten_const = op::v0::Constant::create(element::i64, {2}, {1, 36});
    auto flatten = std::make_shared<op::v1::Reshape>(mul_left, flatten_const, true);

    auto last_mul_const = create_constant_with_zeros({36, 2}, {{}, {0}});
    auto last_mul = std::make_shared<op::v0::MatMul>(flatten, last_mul_const);
    ...
    model = std::make_shared<ov::Model>(OutputVector{last_mul}, ParameterVector{input});
    {
        ...
        auto reshape_const = op::v0::Constant::create(element::i64, {4}, {0, 0, 4, 2});
        auto reshape = std::make_shared<op::v1::Reshape>(eltwise_mul, reshape_const, true);
        ...
        auto flatten_const = op::v0::Constant::create(element::i64, {2}, {1, 8});
        auto flatten = std::make_shared<op::v1::Reshape>(mul_left, flatten_const, true);
...
TEST_F(TransformationTestsF, PruneMasksMatMulRowsStopColsUp) {
    ...
    auto last_linear = std::make_shared<op::v0::MatMul>(linear, weights_last_linear, true, true);
    model = std::make_shared<Model>(NodeVector{last_linear}, ParameterVector{input});
...
TEST_F(TransformationTestsF, PropagateFlattenUp) {
    ...
    auto add = std::make_shared<op::v1::Add>(reshape, weights_add);

    auto weights_linear = create_constant_with_zeros(weights_linear_shape, {{}, {0, 1, 2}});
    auto linear = std::make_shared<op::v0::MatMul>(add, weights_linear);
...
TEST_F(TransformationTestsF, PropagateMasksTranspose) {
    ...
    auto weights = create_constant_with_zeros(weights_shape, {{1, 2, 3}, {}});
    auto transpose_const = op::v0::Constant::create(element::i64, {2}, {1, 0});
    auto transpose = std::make_shared<op::v1::Transpose>(weights, transpose_const);
    auto mul = std::make_shared<op::v0::MatMul>(input, transpose);
    auto relu = std::make_shared<op::v0::Relu>(mul);

    auto last_mul_weights = create_constant_with_zeros(weights_shape, {{}, {1, 2, 3}});
    auto last_mul = std::make_shared<op::v0::MatMul>(relu, last_mul_weights);
...
TEST_F(TransformationTestsF, PropagateMasksTransposeComplex) {
    ...
    for (auto& transpose_const_vec : transpose_consts) {
        auto transpose_const =
            op::v0::Constant::create(element::i64, {transpose_const_vec.size()}, transpose_const_vec);
        last_output = std::make_shared<op::v1::Transpose>(last_output, transpose_const);
    }

    auto mul = std::make_shared<op::v0::MatMul>(input, last_output);
    auto relu = std::make_shared<op::v0::Relu>(mul);
...
TEST(TransformationTests, PropagateMasksTransposeStop) {
    ...
    auto weights = create_constant_with_zeros(weights_shape, {{1, 2, 3}, {}, {}, {}});
    auto transpose_const = op::v0::Constant::create(element::i64, {4}, {2, 3, 1, 0});
    auto transpose = std::make_shared<op::v1::Transpose>(weights, transpose_const);

    auto shape_of = std::make_shared<op::v3::ShapeOf>(transpose);
    auto reshape = std::make_shared<op::v1::Reshape>(transpose, shape_of, true);

    auto mul = std::make_shared<op::v0::MatMul>(input, reshape);
    auto relu = std::make_shared<op::v0::Relu>(mul);
...
TEST_F(DISABLED_TransformationTestsF, PropagateMasksBroadcastedEltwiseWithInputs) {
    ...
    auto broadcasted_eltwise = std::make_shared<op::v1::Add>(transpose, broadcasted_eltwise_weights);
    broadcasted_eltwise->set_friendly_name("Eltwise broadcasted same rank");

    auto transpose_to_const = op::v0::Constant::create(element::i64, {4}, {1, 0, 2, 3});
    auto transpose_to = std::make_shared<op::v1::Transpose>(broadcasted_eltwise, transpose_to_const);
    ...
    auto dummy_eltwise_weights = std::make_shared<op::v0::Parameter>(element::f32, broadcastedEltwiseShape);
    auto dummy_eltwise_inputs = std::make_shared<op::v0::Parameter>(element::f32, broadcastedEltwiseShape);
    auto dummy_eltwise = std::make_shared<op::v1::Add>(dummy_eltwise_inputs, dummy_eltwise_weights);

    auto broadcasted_eltwise_without_weights_mask = std::make_shared<op::v1::Add>(transpose_from, dummy_eltwise);
    broadcasted_eltwise_without_weights_mask->set_friendly_name("Eltwise broadcasted same rank without weights mask");

    auto left_weights = create_constant_with_zeros(weightsLeftShape, {{}, {1, 2}});

    auto mul_left = std::make_shared<op::v0::MatMul>(broadcasted_eltwise_without_weights_mask, left_weights);

    auto flatten_const = op::v0::Constant::create(element::i64, {2}, {2, 36});
    auto flatten = std::make_shared<op::v1::Reshape>(mul_left, flatten_const, true);
                                        ...
                                        ParameterVector{input, dummy_eltwise_inputs, dummy_eltwise_weights});
    {
        ...
        auto flatten_const = op::v0::Constant::create(element::i64, {2}, {2, 8});
        auto flatten = std::make_shared<op::v1::Reshape>(mul_left, flatten_const, true);
...
TEST_F(TransformationTestsF, PropagateMasksBroadcastedEltwise) {
    ...
    auto broadcasted_eltwise2 = std::make_shared<op::v1::Add>(broadcasted_eltwise_weights, broadcasted_eltwise);
    broadcasted_eltwise2->set_friendly_name("Eltwise broadcasted same rank swapped");

    auto transpose_to_const = op::v0::Constant::create(element::i64, {4}, {1, 0, 2, 3});
    auto transpose_to = std::make_shared<op::v1::Transpose>(broadcasted_eltwise2, transpose_to_const);
    ...
    auto transpose_from = std::make_shared<op::v1::Transpose>(broadcasted_eltwise_short2, transpose_to_const);

    // Constants should be zero as broadcasted values!
    auto dummy_eltwise_weights = std::make_shared<op::v0::Constant>(element::f32, broadcastedEltwiseShape, 0);
    auto dummy_eltwise_inputs = std::make_shared<op::v0::Constant>(element::f32, broadcastedEltwiseShape, 0);
    auto dummy_eltwise = std::make_shared<op::v1::Add>(dummy_eltwise_inputs, dummy_eltwise_weights);
    ...
    auto broadcasted_eltwise_without_weights_mask2 =
        std::make_shared<op::v1::Add>(dummy_eltwise, broadcasted_eltwise_without_weights_mask);
    broadcasted_eltwise_without_weights_mask2->set_friendly_name(
        "Eltwise broadcasted same rank without weights mask swapped");

    auto left_weights = create_constant_with_zeros(weightsLeftShape, {{}, {1, 2}});

    auto mul_left = std::make_shared<op::v0::MatMul>(broadcasted_eltwise_without_weights_mask2, left_weights);
...
TEST_F(TransformationTestsF, MaskPropagationComplexReshape) {
    ...
    auto mul = std::make_shared<op::v0::MatMul>(input, mul_weights);

    auto reshape_to_constant = op::v0::Constant::create(element::i64, {6}, unsquizedShape);
    auto reshape_to = std::make_shared<op::v1::Reshape>(mul, reshape_to_constant, true);
    ...
    auto unsquized_eltwise_const = op::v0::Constant::create(element::f32, unsquizedShape, unsquized_eltwise_const_vec);
    auto unsquized_eltwise = std::make_shared<op::v1::Add>(reshape_to, unsquized_eltwise_const);

    auto shape_of = std::make_shared<op::v3::ShapeOf>(mul);
    auto reshape_from = std::make_shared<op::v1::Reshape>(unsquized_eltwise, shape_of, true);
    ...
    auto mul_2 = std::make_shared<op::v0::MatMul>(reshape_from, mul_2_weights);

    auto reshape_to_constant_2 = op::v0::Constant::create(element::i64, {6}, unsquizedShape);
    auto reshape_to_2 = std::make_shared<op::v1::Reshape>(mul_2, reshape_to_constant_2, true);

    auto shape_of_2 = std::make_shared<op::v3::ShapeOf>(mul_2);
    auto reshape_from_2 = std::make_shared<op::v1::Reshape>(reshape_to_2, shape_of_2, true);
    ...
    auto squized_eltwise = std::make_shared<op::v1::Add>(reshape_from_2, squized_eltwise_const);

    auto mul_last_weights = create_constant_with_zeros({weightsShape[1], 1}, {{}, {}});
    auto mul_last = std::make_shared<op::v0::MatMul>(squized_eltwise, mul_last_weights);
    ...
    const auto remained_dims = std::vector<uint64_t>{6, 7, 26, 27, 36, 37, 56, 57};
    {
        ...
        auto reshape_to_constant = op::v0::Constant::create(element::i64, {6}, squized_shape);
        auto reshape_to = std::make_shared<op::v1::Reshape>(mul, reshape_to_constant, true);

        auto unsquized_eltwise_const = op::v0::Constant::create(element::f32, squized_shape, unsquized_const);
        auto unsquized_eltwise = std::make_shared<op::v1::Add>(reshape_to, unsquized_eltwise_const);
        ...
        auto reshape_to_constant_2 = op::v0::Constant::create(element::i64, {6}, squized_shape);
        auto reshape_to_2 = std::make_shared<op::v1::Reshape>(mul_2, reshape_to_constant_2, true);
...
TEST_P(TransformationTestsBoolParamF, MaskPropagationReshapedPassThroughP) {
    ...
    auto mul_left = std::make_shared<op::v0::MatMul>(input, left_weights);

    auto eltwise_mul_const = create_constant_with_zeros(EltwiseShape, {{}, {1}, {}});
    auto eltwise_mul = std::make_shared<op::v1::Multiply>(mul_left, eltwise_mul_const);
    ...
    auto rev_flat_const = op::v0::Constant::create(element::i64, {2}, {12, 6});
    auto rev_flat = std::make_shared<op::v1::Reshape>(transpose, rev_flat_const, true);

    auto unary_op = std::make_shared<op::v8::Softmax>(rev_flat);

    auto add_shape_of = GetParam();
    std::shared_ptr<Node> reshape_recover_shape;
    if (add_shape_of)
        reshape_recover_shape = std::make_shared<op::v3::ShapeOf>(transpose);
    else
        reshape_recover_shape = op::v0::Constant::create(element::i64, {4}, {1, 6, 2, 6});

    auto reshape_recover = std::make_shared<op::v1::Reshape>(unary_op, reshape_recover_shape, true);

    auto right_weights = create_constant_with_zeros(weightsShape, {{}, {1, 2, 3, 4, 5}});
    auto mul_right = std::make_shared<op::v0::MatMul>(input, right_weights);

    auto eltwise_mul_right_const = create_constant_with_zeros(EltwiseShape, {{}, {1}, {}});
    auto eltwise_mul_right = std::make_shared<op::v1::Multiply>(mul_right, eltwise_mul_right_const);

    auto reshape_const_right = op::v0::Constant::create(element::i64, {4}, {0, 0, 6, 2});
    auto reshape_right = std::make_shared<op::v1::Reshape>(eltwise_mul_right, reshape_const_right, true);

    auto transpose_const_right = op::v0::Constant::create(element::i64, {4}, {0, 2, 1, 3});
    auto transpose_right = std::make_shared<op::v1::Transpose>(reshape_right, transpose_const_right);

    auto mul_v = std::make_shared<op::v0::MatMul>(reshape_recover, transpose_right);

    auto flatten_const = op::v0::Constant::create(element::i64, {2}, {1, 24});
    auto flatten = std::make_shared<op::v1::Reshape>(mul_v, flatten_const, true);
    ...
    model = std::make_shared<ov::Model>(OutputVector{last_mul}, ParameterVector{input});
    {
        ...
        auto rev_flat_const = op::v0::Constant::create(element::i64, {2}, {8, 6});
        auto rev_flat = std::make_shared<op::v1::Reshape>(transpose, rev_flat_const, true);
        ...
        if (add_shape_of)
            ...
            reshape_recover_shape = op::v0::Constant::create(element::i64, {4}, {1, 4, 2, 6});
        ...
        auto reshape_const_right = op::v0::Constant::create(element::i64, {4}, {0, 0, 4, 2});
        auto reshape_right = std::make_shared<op::v1::Reshape>(eltwise_mul_right, reshape_const_right, true);
        ...
        auto flatten_const = op::v0::Constant::create(element::i64, {2}, {1, 16});
        auto flatten = std::make_shared<op::v1::Reshape>(mul_v, flatten_const, true);
...
TEST_P(TransformationTestsBoolParamF, MaskPropagationBroadcastedSameRankEltwiseSwappedLayoutP) {
    ...
    auto mul = std::make_shared<op::v0::MatMul>(input, mul_const);

    auto mul_last_const = create_constant_with_zeros(weightsShape2, {{}, {}});
    auto mult_const = op::v0::Constant::create(element::f32, {1, 1}, {5});

    std::shared_ptr<Node> mult;
    const auto reverse_mul = GetParam();
    if (reverse_mul)
        mult = std::make_shared<op::v1::Multiply>(mult_const, mul_last_const);
    else
        mult = std::make_shared<op::v1::Multiply>(mul_last_const, mult_const);

    auto mul_last = std::make_shared<op::v0::MatMul>(mul, mult);
...
TEST(TransformationTests, MaskPropagationBroadcastedEltwiseInputAndWeightsBroadcasted) {
    ...
    auto reshape_const = op::v0::Constant::create(element::i64, Shape{4}, std::vector<int64_t>{1, a, c, 1});
    auto reshape = std::make_shared<op::v1::Reshape>(mul, reshape_const, true);

    auto mult_const = create_constant_with_zeros({1, a, 1, d}, {{}, {}, {}, {2}});
    auto mult = std::make_shared<op::v1::Multiply>(reshape, mult_const);

    auto reshape_from_const = op::v0::Constant::create(element::i64, Shape{3}, std::vector<int64_t>{1, a, c * d});
    auto reshape_from = std::make_shared<op::v1::Reshape>(mult, reshape_from_const, true);

    auto mul_last_const = create_constant_with_zeros(weightsShape2, {{}, {}});
    auto mul_last = std::make_shared<op::v0::MatMul>(reshape_from, mul_last_const);
...
TEST(TransformationTests, MaskPropagationBroadcastedEltwiseWrongBroadcastingMode) {
    ...
    auto mult = std::make_shared<op::v1::Multiply>(mul, mult_const, autob);

    auto mul_last_const = create_constant_with_zeros(weightsShape2, {{}, {}});
    auto mul_last = std::make_shared<op::v0::MatMul>(mult, mul_last_const);
...
TEST_F(TransformationTestsF, MaskPropagationMatMulWithSeveralOutputs) {
    ...
    auto first_matmul = std::make_shared<op::v0::MatMul>(input, first_matmul_weights);

    auto left_matmul_weights = create_constant_with_zeros(secondMatmulShape, {{}, {}});
    auto left_matmul = std::make_shared<op::v0::MatMul>(first_matmul, left_matmul_weights);

    auto right_matmul_weights = create_constant_with_zeros(secondMatmulShape, {{}, {}});
    auto right_matmul = std::make_shared<op::v0::MatMul>(first_matmul, right_matmul_weights);
...
TEST(TransformationTests, CheckReshapeWithNoConstInShape) {
    ...
    auto input = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 3, 1});
    auto input_shape = std::make_shared<op::v0::Parameter>(element::i64, Shape{3});
    auto reshape = std::make_shared<op::v1::Reshape>(input, input_shape, true);
...
TEST_F(TransformationTestsF, PruningReshapeNegativeOne) {
    {
        ...
        auto matmul3 = std::make_shared<op::v0::MatMul>(matmul2, reshape);
