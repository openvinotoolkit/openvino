...
TEST_F(TransformationTestsF, ConvertMVN1ToMVN6) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 2, 3, 4});
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 2, 3, 4});
        auto axes_const = op::v0::Constant::create(element::i64, Shape{2}, {2, 3});
...
TEST_F(TransformationTestsF, ConvertMVN1ToMVN6_across_channels) {
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 2, 3, 4});
        auto axes_const = op::v0::Constant::create(element::i64, Shape{3}, {1, 2, 3});
        auto mvn = std::make_shared<op::v6::MVN>(data, axes_const, true, 1e-5f, op::MVNEpsMode::INSIDE_SQRT);
...
TEST_F(TransformationTestsF, ConvertMVN1ToMVN6_5D) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 2, 3, 4, 5});
        auto mvn = std::make_shared<op::v0::MVN>(data, false, true, 1e-5);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 2, 3, 4, 5});
        auto axes_const = op::v0::Constant::create(element::i64, Shape{3}, {2, 3, 4});
        auto mvn = std::make_shared<op::v6::MVN>(data, axes_const, true, 1e-5f, op::MVNEpsMode::INSIDE_SQRT);
