...
TEST_F(TransformationTestsF, HSigmoidDecompositionTest) {
    {
        auto input =
            std::make_shared<ngraph::opset5::Parameter>(ngraph::element::f32, ngraph::PartialShape::dynamic(1));
...

    {
        ...
        auto mul_constant =
            ngraph::opset5::Constant::create(ngraph::element::f32, ngraph::Shape{}, {(1.0 / 6.0)});  // const(1/6)
