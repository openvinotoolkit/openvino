...
TEST_F(SDPAToPATest, SDPAToPA_jais_13b_General) {
    {
        ...
        auto Broadcast0 = makeOP<v3::Broadcast>({0.000000f, Concat0}, {{"mode", "numpy"}});
        auto ReadValue0 = makeOP<v6::ReadValue>({Broadcast0}, {{"variable_id", "var1"}, {"variable_type", "f32"}, {"variable_shape", PartialShape{DYN, 40, DYN, 128}}});
        auto Gather1 = makeOP<v8::Gather>({ReadValue0, beam_idx, 0}, {{"batch_dims", 0}});
        auto Constant0 = makeConst(element::f32, ov::Shape({1,15360,}), MOCK_VALUE);
        auto Constant1 = makeConst(element::u8, ov::Shape({84992,5120,}), MOCK_VALUE);
        auto Convert0 = makeOP<v0::Convert>({Constant1}, {{"destination_type", "f16"}});
        auto Constant2 = makeConst(element::u8, ov::Shape({84992,1,}), MOCK_VALUE);
        auto Convert1 = makeOP<v0::Convert>({Constant2}, {{"destination_type", "f16"}});
        auto Subtract0 = makeOP<v1::Subtract>({Convert0, Convert1}, {{"auto_broadcast", "numpy"}});
        auto Constant3 = makeConst(element::f16, ov::Shape({84992,1,}), MOCK_VALUE);
        auto Multiply0 = makeOP<v1::Multiply>({Subtract0, Constant3}, {{"auto_broadcast", "numpy"}});
        auto Convert2 = makeOP<v0::Convert>({Multiply0}, {{"destination_type", "f32"}});
        ...
        auto Gather2 = makeOP<v8::Gather>({Convert2, Convert3, 0}, {{"batch_dims", 0}});
        auto Constant4 = makeConst(element::f32, ov::Shape({1,1,1,}), {14.600000f});
        auto Multiply1 = makeOP<v1::Multiply>({Gather2, Constant4}, {{"auto_broadcast", "numpy"}});
        auto MVN0 = makeOP<v6::MVN>({Multiply1, {-1}}, {{"eps", 0.000010}, {"normalize_variance", true}, {"eps_mode", "INSIDE_SQRT"}});
        auto Constant5 = makeConst(element::f32, ov::Shape({1,1,5120,}), MOCK_VALUE);
        auto Multiply2 = makeOP<v1::Multiply>({MVN0, Constant5}, {{"auto_broadcast", "numpy"}});
        auto Constant6 = makeConst(element::f32, ov::Shape({1,1,5120,}), MOCK_VALUE);
        ...
        auto Constant7 = makeConst(element::u8, ov::Shape({15360,5120,}), MOCK_VALUE);
        auto Convert4 = makeOP<v0::Convert>({Constant7}, {{"destination_type", "f16"}});
        auto Constant8 = makeConst(element::u8, ov::Shape({15360,1,}), MOCK_VALUE);
        auto Convert5 = makeOP<v0::Convert>({Constant8}, {{"destination_type", "f16"}});
        auto Subtract1 = makeOP<v1::Subtract>({Convert4, Convert5}, {{"auto_broadcast", "numpy"}});
        auto Constant9 = makeConst(element::f16, ov::Shape({15360,1,}), MOCK_VALUE);
        auto Multiply3 = makeOP<v1::Multiply>({Subtract1, Constant9}, {{"auto_broadcast", "numpy"}});
        auto Convert6 = makeOP<v0::Convert>({Multiply3}, {{"destination_type", "f32"}});
        ...
        auto ReadValue1 = makeOP<v6::ReadValue>({Broadcast1}, {{"variable_id", "var2"}, {"variable_type", "f32"}, {"variable_shape", PartialShape{DYN, 40, DYN, 128}}});
        ...
        auto ReadValue2 = makeOP<v6::ReadValue>({Broadcast2}, {{"variable_id", "var3"}, {"variable_type", "f32"}, {"variable_shape", PartialShape{DYN, 40, DYN, 128}}});
        ...
        auto Constant10 = makeConst(element::boolean, ov::Shape({1,1,2048,2048,}), MOCK_VALUE);
        ...
        auto Constant11 = makeConst(element::f32, ov::Shape({1,1,1,1,}), {1.000000f});
        ...
        auto Constant12 = makeConst(element::f32, ov::Shape({1,1,1,1,}), {1.000000f});
        ...
        auto Constant14 = makeConst(element::f32, ov::Shape({40,1,1,}), {-1});
        ...
        auto ScaledDotProductAttention = makeOP<v13::ScaledDotProductAttention>({Transpose0, Concat3, Concat5, Add6, 0.007812f}, {{"causal", false}});
        auto res = make_shared<v0::Result>(ScaledDotProductAttention);
    ...
    }
    {
        ...
        auto Constant10 = makeConst(element::f32, ov::Shape({40,1,1,}), MOCK_VALUE);
        ...
        auto Constant11 = makeConst(element::f32, ov::Shape({0,0,0,0,}), MOCK_VALUE);
        ...
        auto PagedAttentionExtension0 = make_shared<ov::op::PagedAttentionExtension>(
            OutputVector{Reshape4, Reshape6, Reshape8, key_cache_0, value_cache_0, past_lens, subsequence_begins, block_indices, block_indices_begins, Constant12, Constant13, Multiply4, max_context_len, score_aggregation_window, Constant14, Constant15, Constant16, Constant17, Constant18, Constant19, Constant11, Constant20, Constant21, Constant22, Constant23});
