...
TEST_F(TransformationTestsF, ConvertMaxPool1ToMaxPool8) {
    {
        ...
        auto maxpool_1 = std::make_shared<op::v1::MaxPool>(data, strides, pads_begin, pads_end, kernel);
...

    {
        ...
        Shape pads_begin{0}, pads_end{0}, kernel{1};
        auto maxpool_8 = std::make_shared<op::v8::MaxPool>(data, strides, dilations, pads_begin, pads_end, kernel);
