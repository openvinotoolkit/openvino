...
TEST_F(TransformationTestsF, ReduceL2DecompositionTest) {
    {
        ...
        function =
            std::make_shared<ngraph::Function>(ngraph::NodeVector{reduce_l2}, ngraph::ParameterVector{data, axes});
...

    {
        auto data = std::make_shared<ngraph::opset4::Parameter>(ngraph::element::f32, ngraph::PartialShape::dynamic(1));
        auto axes = std::make_shared<ngraph::opset4::Parameter>(ngraph::element::i32, ngraph::Shape{1});
        auto pow = std::make_shared<ngraph::opset4::Power>(
            data,
            ngraph::opset4::Constant::create(ngraph::element::f32, ngraph::Shape{}, {2.0}));
        ...
        function_ref =
            std::make_shared<ngraph::Function>(ngraph::NodeVector{sqrt}, ngraph::ParameterVector{data, axes});
    }
}
