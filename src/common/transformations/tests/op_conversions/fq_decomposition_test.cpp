...
protected:
    void SetUp() override {
        ...
        std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
        {
            ...
            const auto il =
                std::make_shared<ngraph::opset1::Constant>(ranges_prec, il_shape, input_ranges_values.first);
            const auto ih =
                std::make_shared<ngraph::opset1::Constant>(ranges_prec, ih_shape, input_ranges_values.second);
...

        {
            ...
            if (should_be_decompos) {
                ...
                const auto levels_minus_one =
                    std::make_shared<ngraph::opset1::Constant>(ranges_prec, ngraph::Shape{}, levels - 1);
                ...
                const auto round =
                    std::make_shared<ngraph::opset5::Round>(after_ish_apply,
