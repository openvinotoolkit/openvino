...
#ifdef __clang__
extern template class OPENVINO_API op::internal::NmsStaticShapeIE<ov::op::v8::MulticlassNms>;
extern template class OPENVINO_API op::internal::NmsStaticShapeIE<ov::op::v8::MatrixNms>;
#endif  // __clang__
