...
public:
    OPENVINO_RTTI("PReluFusionNegativeAdd", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("PReluFusionNegativeSub", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("PReluFusionMultiplyAdd", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("PReluFusionMultiplySub", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("PReluFusionAbsSubMulMulAdd", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("PReluFusionNegReluMulAdd", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("PReluFusion", "0", ov::pass::GraphRewrite);
    PReluFusion() {
