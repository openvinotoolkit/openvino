...
public:
    OPENVINO_RTTI("ConvStridesPropagation", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("SupportedNodesStridesPropagation", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("UnsupportedNodesStridesPropagation", "0", ov::pass::MatcherPass);
