...
public:
    OPENVINO_RTTI("PullUnsqueezeThroughReduce", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("PullReshapeThroughReduce", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("PullThroughReduce", "0", ov::pass::GraphRewrite);
    PullThroughReduce() {
