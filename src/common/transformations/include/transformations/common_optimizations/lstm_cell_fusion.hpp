...
public:
    OPENVINO_RTTI("LSTMCellFusionWithJointWeights", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("LSTMCellFusionWithSplitWeights", "0", ov::pass::MatcherPass);
...
public:
    OPENVINO_RTTI("LSTMCellFusion", "0", ov::pass::GraphRewrite);
    LSTMCellFusion() {
