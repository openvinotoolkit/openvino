 ...
 * can overflow f16 range and turn into NaN downstream. Intended for platforms where the Clamp
 * fuses into the preceding MatMul, so that it costs almost nothing at runtime.
 */
