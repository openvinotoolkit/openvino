...
public:
    OPENVINO_RTTI("TSGeneralForward", "0", ov::pass::GraphRewrite);
    TSGeneralForward();
};
...
public:
    OPENVINO_RTTI("TSGeneralBackward", "0", ov::pass::GraphRewrite);
    TSGeneralBackward();
};
...
public:
    OPENVINO_RTTI("TSGeneral", "0", ov::pass::ModelPass);
