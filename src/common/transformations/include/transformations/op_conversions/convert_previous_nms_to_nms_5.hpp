...
public:
    OPENVINO_RTTI("ConvertNMS1ToNMS5", "0", ov::pass::MatcherPass);
    ConvertNMS1ToNMS5();
};

class ov::pass::ConvertNMS3ToNMS5 : public ov::pass::MatcherPass {
public:
    OPENVINO_RTTI("ConvertNMS3ToNMS5", "0", ov::pass::MatcherPass);
    ConvertNMS3ToNMS5();
};

class ov::pass::ConvertNMS4ToNMS5 : public ov::pass::MatcherPass {
public:
    OPENVINO_RTTI("ConvertNMS4ToNMS5", "0", ov::pass::MatcherPass);
    ConvertNMS4ToNMS5();
};
