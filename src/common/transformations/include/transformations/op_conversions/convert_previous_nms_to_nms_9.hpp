...
public:
    OPENVINO_RTTI("ConvertNMS1ToNMS9", "0", ov::pass::MatcherPass);
    ConvertNMS1ToNMS9();
};

class ov::pass::ConvertNMS3ToNMS9 : public ov::pass::MatcherPass {
public:
    OPENVINO_RTTI("ConvertNMS3ToNMS9", "0", ov::pass::MatcherPass);
    ConvertNMS3ToNMS9();
};

class ov::pass::ConvertNMS4ToNMS9 : public ov::pass::MatcherPass {
public:
    OPENVINO_RTTI("ConvertNMS4ToNMS9", "0", ov::pass::MatcherPass);
    ConvertNMS4ToNMS9();
};

class ov::pass::ConvertNMS5ToNMS9 : public ov::pass::MatcherPass {
public:
    OPENVINO_RTTI("ConvertNMS5ToNMS9", "0", ov::pass::MatcherPass);
    ConvertNMS5ToNMS9();
};
