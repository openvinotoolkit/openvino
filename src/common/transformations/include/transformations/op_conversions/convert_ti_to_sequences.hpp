...
namespace ngraph {
namespace pass {
using ov::pass::ConvertTensorIteratorToLSTMSequence; using ov::pass::ConvertTensorIteratorToRNNSequence; using ov::pass::ConvertTensorIteratorToGRUSequence; using ov::pass::ConvertTensorIteratorToSequence;
}  // namespace pass
}  // namespace ngraph
