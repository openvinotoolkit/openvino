...
void MOECompressed::validate_and_infer_types() {
    ...
    // Cross-check config.group_size/has_zp against scale/zp tensor shapes — bad config
    // otherwise surfaces only as silently-wrong dequantization.
