...
pass::EnableDecompressionConvertConstantFolding::EnableDecompressionConvertConstantFolding() {
    ...
    auto convert = wrap_type<v0::Convert>();
    ...
    auto m = std::make_shared<Matcher>(convert, matcher_name);
...
pass::KeepConstAndDecompression::KeepConstAndDecompression() {
    ...
    auto node_pattern = wrap_type<v0::Convert>();
    ...
    auto m = std::make_shared<Matcher>(node_pattern, matcher_name);
