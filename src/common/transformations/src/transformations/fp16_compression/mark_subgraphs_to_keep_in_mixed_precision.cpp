 ...
 * ops like ov::op::v8::Slice, ov::op::v1::ReduceSum, ov::op::v1::Reshape, Elementwise, et al. to be kept in f32 as
 * well. Propagation stops when ops not listed in propagate_through_ops are faced: e.g. if we face Conv or MatMul.
 */
