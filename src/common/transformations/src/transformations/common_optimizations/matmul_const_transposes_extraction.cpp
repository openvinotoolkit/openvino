...
ov::pass::MatMulConstTransposesExtraction::MatMulConstTransposesExtraction() {
    ...
    auto weights_pattern =
        ov::pass::pattern::wrap_type<ov::op::v0::Constant, ov::op::v0::FakeQuantize>([](Output<Node> node) -> bool {
    ...
    auto matmul_pattern = ov::pass::pattern::wrap_type<ov::op::v0::MatMul>({data_pattern, weights_pattern});
    ...
    auto m = std::make_shared<ov::pass::pattern::Matcher>(matmul_pattern, "MatMulConstTransposesExtraction");
