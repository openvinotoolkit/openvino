...
bool ov::pass::ConvertPrecisionCompressedOnly::run_on_function(std::shared_ptr<ov::Model> f) {
...
bool ov::pass::ConvertCompressedOnlyToLegacy::run_on_function(std::shared_ptr<ov::Model> f) {
