...
ov::pass::GRUCellFusion::GRUCellFusion() {
    ...
    auto split_out_0_or_1 = make_shared<pattern::op::Or>(split->outputs());
    auto split_out_0_or_1_2 = make_shared<pattern::op::Or>(split->outputs());
    auto split_out_0_or_1_3 = make_shared<pattern::op::Or>(split->outputs());
