...
RoPEFusionFlux::RoPEFusionFlux(bool num_heads_transposed) {
    ...
    matcher_pass_callback callback = [OV_CAPTURE_CPY_AND_THIS](pattern::Matcher& m) {
        ...
        new_args.push_back(pattern_map.at(std::move(x)));
        new_args.push_back(pattern_map.at(std::move(t_cos)));
        ...
        ov::copy_runtime_info({pattern_map.at(std::move(x1)).get_node_shared_ptr(),
                               pattern_map.at(std::move(split)).get_node_shared_ptr(),
                               pattern_map.at(std::move(x2)).get_node_shared_ptr(),
                               pattern_map.at(std::move(x3)).get_node_shared_ptr(),
                               pattern_map.at(std::move(y1)).get_node_shared_ptr(),
                               pattern_map.at(std::move(y2)).get_node_shared_ptr(),
...
RoPEFusionGPTOSS::RoPEFusionGPTOSS() {
    ...
    matcher_pass_callback callback = [OV_CAPTURE_CPY_AND_THIS](pattern::Matcher& m) {
        const auto& pattern_map = m.get_pattern_value_map();
        auto root = m.get_match_root();
        const auto& x_val = pattern_map.at(std::move(x));
        const auto& v_cos = pattern_map.at(std::move(t_cos));
