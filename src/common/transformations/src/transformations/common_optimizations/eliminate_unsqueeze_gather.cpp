...
ov::pass::EliminateUnsqueezeGather::EliminateUnsqueezeGather() {
    ...
    const auto unsqueeze = ov::pass::pattern::wrap_type<ov::op::v0::Unsqueeze>({unsqueezeInput, unsqueezeAxis}, ov::pass::pattern::consumers_count(1));
...
ov::pass::EliminateGatherUnsqueeze::EliminateGatherUnsqueeze() {
    ...
    const auto be_label = ov::pass::pattern::wrap_type<BinaryElementwiseArithmetic, BinaryElementwiseComparison, BinaryElementwiseLogical>(
    ...
    const auto unsqueeze_label = ov::pass::pattern::wrap_type<ov::op::v0::Unsqueeze, ov::op::v1::Reshape>({or_label, ov::pass::pattern::any_input()}, ov::pass::pattern::rank_equals(1));
    ...
    ov::matcher_pass_callback callback = [OV_CAPTURE_CPY_AND_THIS](ov::pass::pattern::Matcher& m) {
        ...
        const auto& indices = ov::op::util::make_try_fold<ov::op::v1::Reshape>(gather->input_value(1),
