...
ov::pass::ConvertU4WeightsZeroPointToScalar::ConvertU4WeightsZeroPointToScalar() {
    ...
    auto weights_m =
        ov::pass::pattern::wrap_type<ov::op::v0::Constant>(ov::pass::pattern::type_matches(ov::element::u4));
    auto convert_m =
        ov::pass::pattern::wrap_type<ov::op::v0::Convert>({weights_m}, ov::pass::pattern::consumers_count(1));
    ...
    auto u4_zp_predicate = [](ov::Output<ov::Node> output) -> bool {
        return ov::pass::pattern::type_matches(ov::element::u4)(output) &&
               ov::pass::pattern::consumers_count(1)(output);
    };
    auto u4_zero_point_m = ov::pass::pattern::wrap_type<ov::op::v0::Constant>(u4_zp_predicate);
    auto zero_point_convert_m =
        ov::pass::pattern::wrap_type<ov::op::v0::Convert>({u4_zero_point_m}, float_zp_predicate);
