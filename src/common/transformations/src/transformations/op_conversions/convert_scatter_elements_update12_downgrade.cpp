...
ov::pass::ConvertScatterElementsUpdate12ToScatterElementsUpdate3::
    ...
    const auto seu_v12_pattern = ov::pass::pattern::wrap_type<ov::op::v12::ScatterElementsUpdate>();
    ...
    auto m = std::make_shared<ov::pass::pattern::Matcher>(seu_v12_pattern, matcher_name);
