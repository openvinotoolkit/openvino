...
ov::pass::ConvertROIAlign3To9::ConvertROIAlign3To9() {
    ...
    auto roi_align_v3 = ov::pass::pattern::wrap_type<v3::ROIAlign>();

    matcher_pass_callback callback = [=](Matcher& m) {
        auto roi_align_v3_node = ov::as_type_ptr<v3::ROIAlign>(m.get_match_root());
        ...
        v3::ROIAlign::PoolingMode m_mode_v3 = roi_align_v3_node->get_mode();
        v9::ROIAlign::PoolingMode m_mode_v9;
        switch (m_mode_v3) {
        case v3::ROIAlign::PoolingMode::AVG: {
            m_mode_v9 = v9::ROIAlign::PoolingMode::AVG;
            break;
        }
        case v3::ROIAlign::PoolingMode::MAX: {
            m_mode_v9 = v9::ROIAlign::PoolingMode::MAX;
            break;
        }
        default: {
    ...
    auto m = std::make_shared<Matcher>(roi_align_v3, matcher_name);
