...
std::shared_ptr<ov::Node> ov::pass::ScaledDotProductAttentionDecomposition::decompose(
    ...
    auto minus_one = register_new_node_(v0::Constant::create(element::i32, Shape{}, {-1}));
    auto minus_two = register_new_node_(v0::Constant::create(element::i32, Shape{}, {-2}));
    auto zero_i = register_new_node_(v0::Constant::create(element::i32, Shape{}, {0}));
    auto one_i = register_new_node_(v0::Constant::create(element::i32, Shape{}, {1}));
    ...
    auto minus_inf = register_new_node_(v0::Constant::create(element::f32, Shape{}, {-std::numeric_limits<float>::infinity()}))->output(0);
