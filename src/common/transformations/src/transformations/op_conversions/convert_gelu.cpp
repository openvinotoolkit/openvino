...
ov::pass::ConvertGELU::ConvertGELU() {
    ...
    matcher_pass_callback callback = [this](pattern::Matcher& m) {
        ...
        auto mul =
            std::make_shared<ov::opset1::Multiply>(input,
                                                       ov::opset1::Constant::create(input_type, Shape{}, {0.5}));
        ...
        auto add =
            std::make_shared<ov::opset1::Add>(erf, ov::opset1::Constant::create(input_type, Shape{}, {1.0}));
