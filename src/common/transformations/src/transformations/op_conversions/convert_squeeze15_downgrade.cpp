...
ov::pass::ConvertSqueeze15ToSqueeze0::ConvertSqueeze15ToSqueeze0() {
    ...
    const auto& squeeze_v15_pattern = ov::pass::pattern::wrap_type<ov::op::v15::Squeeze>();
    ...
    auto m = std::make_shared<ov::pass::pattern::Matcher>(squeeze_v15_pattern, matcher_name);
