...
ov::pass::FuseBias::FuseBias() {
    ...
    auto m_conv = ov::pass::pattern::wrap_type<ov::op::v1::Convolution>({data_batch, filters},
    ...
    ov::matcher_pass_callback callback = [OV_CAPTURE_CPY_AND_THIS](ov::pass::pattern::Matcher& m) {
        ...
        auto conv = ov::as_type_ptr<ov::op::v1::Convolution>(pattern_to_output[m_conv].get_node_shared_ptr());
        ...
        ov::Shape add_shape(add->get_shape());
