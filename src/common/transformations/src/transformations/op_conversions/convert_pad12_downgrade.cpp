...
ov::pass::ConvertPad12ToPad1::ConvertPad12ToPad1() {
    ...
    const auto pad_v12_pattern = ov::pass::pattern::wrap_type<v12::Pad>();

    const matcher_pass_callback callback = [OV_CAPTURE_CPY_AND_THIS](Matcher& m) {
        const auto pad_v12 = ov::as_type_ptr<v12::Pad>(m.get_match_root());
    ...
    auto m = std::make_shared<Matcher>(pad_v12_pattern, matcher_name);
