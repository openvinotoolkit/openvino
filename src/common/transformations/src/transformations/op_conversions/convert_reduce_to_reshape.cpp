...
ov::pass::ConvertReduceMeanToReshape::ConvertReduceMeanToReshape() {
    ...
    auto m = std::make_shared<Matcher>(
        wrap_type<v1::ReduceMean>({any_input(has_static_shape()), wrap_type<v0::Constant>()}, has_static_shape()),
        matcher_name);
...
ov::pass::ConvertReduceSumToReshape::ConvertReduceSumToReshape() {
    ...
    auto m = std::make_shared<Matcher>(
        wrap_type<v1::ReduceSum>({any_input(has_static_shape()), wrap_type<v0::Constant>()}, has_static_shape()),
        matcher_name);
...
ov::pass::ConvertReduceProdToReshape::ConvertReduceProdToReshape() {
    ...
    auto m = std::make_shared<Matcher>(
        wrap_type<v1::ReduceProd>({any_input(has_static_shape()), wrap_type<v0::Constant>()}, has_static_shape()),
        matcher_name);
...
ov::pass::ConvertReduceMaxToReshape::ConvertReduceMaxToReshape() {
    ...
    auto m = std::make_shared<Matcher>(
        wrap_type<v1::ReduceMax>({any_input(has_static_shape()), wrap_type<v0::Constant>()}, has_static_shape()),
        matcher_name);
...
ov::pass::ConvertReduceMinToReshape::ConvertReduceMinToReshape() {
    ...
    auto m = std::make_shared<Matcher>(
        wrap_type<v1::ReduceMin>({any_input(has_static_shape()), wrap_type<v0::Constant>()}, has_static_shape()),
        matcher_name);
...
ov::pass::ConvertReduceLogicalAndToReshape::ConvertReduceLogicalAndToReshape() {
    ...
    auto m = std::make_shared<Matcher>(
        wrap_type<v1::ReduceLogicalAnd>({any_input(has_static_shape()), wrap_type<v0::Constant>()}, has_static_shape()),
        matcher_name);
...
ov::pass::ConvertReduceLogicalOrToReshape::ConvertReduceLogicalOrToReshape() {
    ...
    auto m = std::make_shared<Matcher>(
        wrap_type<v1::ReduceLogicalOr>({any_input(has_static_shape()), wrap_type<v0::Constant>()}, has_static_shape()),
        matcher_name);
