...
ov::pass::ConvertNMS9ToNMSIEInternal::ConvertNMS9ToNMSIEInternal() {
    ...
    matcher_pass_callback callback = [=](pattern::Matcher& m) {
        ...
        if (nms_9->output(0).get_element_type() != output_0.get_element_type()) {
            ...
            output_0.get_node_shared_ptr()->set_friendly_name(nms_9->output(0).get_node_shared_ptr()->get_friendly_name());
        ...
        if (nms_9->output(2).get_element_type() != output_2.get_element_type()) {
            ...
            output_2.get_node_shared_ptr()->set_friendly_name(nms_9->output(2).get_node_shared_ptr()->get_friendly_name());
