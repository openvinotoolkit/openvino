...
#    define ADD_MATCHER_SCOPE_FOR_THIS(nspace, region, ...)        add_matcher<nspace::region>(__VA_ARGS__);
#    define ADD_MATCHER_SCOPE_FOR_THIS_WITHOUT_NSPACE(region, ...) add_matcher<region>(__VA_ARGS__);
