...
namespace subgraph {
    std::shared_ptr<ov::Model> TransposeAfterMatMulFunction::getOriginal(
        ...
        const float k = 50.f;
        const auto fakeQuantize1 = ov::builder::makeFakeQuantize(input1, precision, 256ul, { 1ul }, { 0.f }, { 255.f / k }, { 0.f }, { 255.f / k });
        input2->set_friendly_name("fakeQuantize1");
        const auto fakeQuantize2 = ov::builder::makeFakeQuantize(input2, precision, 256ul, { 1ul }, { 0.f }, { 255.f / k }, { 0.f }, { 255.f / k });
