...
#include "lpt_ov_models/markup_avg_pool_precisions_function.hpp"
...
std::shared_ptr<ov::Model> MarkupAvgPoolPrecisionsFunction::getOriginal(
    ...
    std::shared_ptr<ov::Node> parent;
    {
        auto createBranch = [](
            ...
            auto newParent = ov::builder::makeFakeQuantize(parent, precision, 256, {}, { -1.28 }, { 1.27 }, { -1.28 }, { 1.27 });
    ...
    //    parent2 = ov::builder::makeFakeQuantize(parent2, precision, 256, {}, { 0 }, { 255 }, { 0 }, { 255 });
    ...
    if (fakeQuantizeBranch != -1) {
        if (fakeQuantizeBranch != 1) {
            parent1 = ov::builder::makeFakeQuantize(parent1, precision, 256, {}, { -1.28 }, { 1.27 }, { -1.28 }, { 1.27 });
            parent1->set_friendly_name("fakeQuantize1");
        }
        if (fakeQuantizeBranch != 0) {
            parent2 = ov::builder::makeFakeQuantize(parent2, precision, 256, {}, { -1.28 }, { 1.27 }, { -1.28 }, { 1.27 });
...
std::shared_ptr<ov::Model> MarkupAvgPoolPrecisionsFunction::getReference(
    ...
    if (addFQ) {
        lastLayer = ov::builder::makeFakeQuantize(
