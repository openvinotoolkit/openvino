...
#include "lpt_ov_models/align_concat_quantization_parameters_function.hpp"
...
std::shared_ptr<ov::Model> AlignConcatQuantizationParametersFunction::getOriginal(
    ...
    {
        parent1 = ov::builder::makeFakeQuantize(input1, precision, 256, {}, { -1.28 }, { 1.27 }, { -1.28 }, { 1.27 });
        ...
        if (addFQ) {
            parent1 = ov::builder::makeFakeQuantize(parent1, precision, 256, {}, { 0 }, { 255 }, { 0 }, { 255 });
    ...
    {
        parent2 = ov::builder::makeFakeQuantize(input1, precision, 256, {}, { -1.28f / 2.f }, { 1.27f / 2.f }, { -1.28f / 2.f }, { 1.27f / 2.f });
        ...
        if (addFQ) {
            parent2 = ov::builder::makeFakeQuantize(parent1, precision, 256, {}, { 0 }, { 255 }, { 0 }, { 255 });
            parent2->set_friendly_name("lastFakeQuantize2");
        }
    }
    auto parent = std::dynamic_pointer_cast<ov::Node>(std::make_shared<opset1::Concat>(ov::OutputVector{ parent1, parent2 }, 1));
...

    {
        ...
        const auto fakeQuantizeOnWeights = ov::builder::makeFakeQuantize(
            std::make_shared<opset1::Constant>(element::f32, shape, std::vector<float>(1.f, ov::shape_size(shape))),
            precision,
            255,
