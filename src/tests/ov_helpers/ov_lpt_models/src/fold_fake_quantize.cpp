...
std::shared_ptr<ov::Model> FoldFakeQuantizeFunction::getOriginal(const ov::element::Type precision,
    ...
    const auto fakeQuantize = ov::test::utils::make_fake_quantize(constant,
                                                                  precision,
...
std::shared_ptr<ov::Model> FoldFakeQuantizeFunction::getReference(const ov::element::Type precision,
                                                                  const ov::Shape& constShape,
                                                                  const std::vector<float>& constValues) {
