...
std::shared_ptr<ov::Model> AlignConcatQuantizationParametersFunction::getOriginal(
    ...
    std::shared_ptr<ov::Node> parent1 = input1;
    {
        ...
        parent1 = std::make_shared<ov::opset1::AvgPool>(parent1,
                                                        Strides{1, 1},
                                                        Shape{1, 1},
                                                        Shape{0, 0},
                                                        Shape{2, 2},
        ...
        if (additionalLayer == "maxpool") {
            parent1 = std::make_shared<ov::opset1::MaxPool>(parent1,
                                                            Strides{1, 1},
                                                            Shape{1, 1},
                                                            Shape{0, 0},
                                                            Shape{2, 2},
    ...
    {
        parent2 = ov::test::utils::make_fake_quantize(input1,
                                                      precision,
                                                      256,
                                                      {},
                                                      {-1.28f / 2.f},
        ...
        parent2 = std::make_shared<ov::opset1::AvgPool>(parent2,
                                                        Strides{1, 1},
                                                        Shape{1, 1},
                                                        Shape{0, 0},
                                                        Shape{2, 2},
        ...
        if (additionalLayer == "maxpool") {
            parent2 = std::make_shared<ov::opset1::MaxPool>(parent2,
                                                            Strides{1, 1},
                                                            Shape{1, 1},
                                                            Shape{0, 0},
                                                            Shape{2, 2},
    ...
    auto parent = std::dynamic_pointer_cast<ov::Node>(
        std::make_shared<ov::opset1::Concat>(ov::OutputVector{parent1, parent2}, 1));
    ...
    return std::make_shared<ov::Model>(results,
                                       ...
                                       "AlignConcatQuantizationParameters");
}
