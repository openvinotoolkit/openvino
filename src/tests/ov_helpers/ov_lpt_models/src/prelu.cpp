...
std::shared_ptr<ov::Model> PReluFunction::getOriginal(
    ...
    const auto slope =
        std::make_shared<ov::opset1::Constant>(precisionBeforeDequantization, Shape{}, std::vector<float>{0.1f});
...
std::shared_ptr<ov::Model> PReluFunction::getOriginal(const ov::PartialShape& inputShape,
...
std::shared_ptr<ov::Model> PReluFunction::getReference(
    ...
    const auto slope =
        std::make_shared<ov::opset1::Constant>(precisionBeforeDequantization, Shape{}, std::vector<float>{0.1f});
    const auto prelu =
        std::make_shared<ov::op::TypeRelaxed<ov::opset1::PRelu>>(ov::opset1::PRelu(quantizationOpBefore, slope),
