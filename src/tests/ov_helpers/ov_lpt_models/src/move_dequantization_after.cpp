...
std::shared_ptr<ov::Model> MoveDequantizationAfterFunction::getOriginal(
    ...
    return std::make_shared<ov::Model>(ov::ResultVector{std::make_shared<ov::opset1::Result>(targetOp)},
...
std::shared_ptr<ov::Model> MoveDequantizationAfterFunction::getReference(
    ...
    return std::make_shared<ov::Model>(ov::ResultVector{std::make_shared<ov::opset1::Result>(deqAfter)},
                                       ov::ParameterVector{input},
                                       "MoveDequantizationAfterFunction");
}
