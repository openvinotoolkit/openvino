...
public:
    ...
    static std::shared_ptr<ov::Model> getOriginal(bool isConvert,
                                                  bool isSubtract,
                                                  size_t subDataInput,
                                                  size_t mulDataInput);

    static std::shared_ptr<ov::Model> getReference(ov::pass::low_precision::FakeQuantizeDequantization dequantization);
};
}  // namespace subgraph
}  // namespace builder
}  // namespace ov
