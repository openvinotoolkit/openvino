...
public:
    static std::shared_ptr<ov::Model> getOriginal(const ov::element::Type inputPrecision,
    ...
    static std::shared_ptr<ov::Model> getReference(const ov::element::Type inputPrecision,
                                                   const ov::PartialShape& inputShape,
                                                   const ov::builder::subgraph::DequantizationOperations& deqBefore,
                                                   const std::int64_t axis,
                                                   const std::int64_t group,
