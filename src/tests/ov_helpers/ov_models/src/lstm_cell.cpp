...
std::shared_ptr<ov::Node> makeLSTM(const std::vector<ov::Output<Node>>& in,
    ...
    if (WRB_range > 0) {
        W = ov::test::utils::make_constant(in[0].get_element_type(), constants[0], empty, true, -WRB_range, WRB_range);
        R = ov::test::utils::make_constant(in[0].get_element_type(), constants[1], empty, true, -WRB_range, WRB_range);
        B = ov::test::utils::make_constant(in[0].get_element_type(), constants[2], empty, true, -WRB_range, WRB_range);
    }
    if (!make_sequence) {
