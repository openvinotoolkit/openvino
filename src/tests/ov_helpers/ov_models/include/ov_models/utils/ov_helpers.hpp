...
template<>
struct nGraphTypesTrait<ov::element::Type_t::boolean> {
    using value_type = bool;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::f64> {
    using value_type = double;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::f32> {
    using value_type = float;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::f16> {
    using value_type = ov::float16;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::bf16> {
    using value_type = ov::bfloat16;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::i8> {
    using value_type = int8_t;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::i16> {
    using value_type = int16_t;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::i32> {
    using value_type = int32_t;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::i64> {
    using value_type = int64_t;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::u8> {
    using value_type = uint8_t;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::u16> {
    using value_type = uint16_t;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::u32> {
    using value_type = uint32_t;
};
template<>
struct nGraphTypesTrait<ov::element::Type_t::u64> {
...
interpretFunction(const std::shared_ptr<Model> &function,
...
std::shared_ptr<ov::Node> getNodeSharedPtr(const ov::NodeTypeInfo &type_info,
                                               const ov::OutputVector &outputVector);
...
std::ostream& operator<<(std::ostream & os, ov::helpers::EltwiseTypes type);
