...
std::vector<typename ov::helpers::nGraphTypesTrait<dType>::value_type> inline
generateVector(size_t vec_len,
               typename ov::helpers::nGraphTypesTrait<dType>::value_type upTo = 10,
               typename ov::helpers::nGraphTypesTrait<dType>::value_type startFrom = 1,
               int32_t seed = 1) {
    using dataType = typename ov::helpers::nGraphTypesTrait<dType>::value_type;
...
template<>
std::vector<ov::float16> inline
generateVector<ov::element::Type_t::f16>(size_t vec_len,
                                             ov::float16 upTo,
...
template<>
std::vector<ov::bfloat16> inline
generateVector<ov::element::Type_t::bf16>(size_t vec_len,
                                              ov::bfloat16 upTo,
