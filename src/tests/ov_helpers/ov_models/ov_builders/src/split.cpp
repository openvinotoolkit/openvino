...
namespace op {
namespace util {
ov::OutputVector split(const Output<Node>& value, const std::vector<int64_t>& split_lengths, int64_t axis) {
...
ov::OutputVector split(const Output<Node>& value, int64_t num_splits, int64_t axis) {
    const auto axis_node = ov::op::v0::Constant::create(element::i64, Shape{}, {axis});
