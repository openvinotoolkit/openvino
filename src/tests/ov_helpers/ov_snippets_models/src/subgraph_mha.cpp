...
std::shared_ptr<ov::Model> MHAFunction::initOriginal() const {
    ...
    const auto transpose0Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, ov::Shape{rank}, fusion_order);
    const auto transpose1Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, ov::Shape{rank}, decomposed_order);
    ...
    const auto reshape0Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                          ov::Shape{reshape0ConstData.size()},
                                                                          reshape0ConstData);
    const auto reshape1Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
...
std::shared_ptr<ov::Model> MHASplitMFunction::initReference() const {
    ...
    const auto transpose0Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                            ov::Shape{rank},
                                                                            get_fusion_order_after_split_m(rank, true));
    const auto transpose1Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                            ov::Shape{rank},
                                                                            get_decomposed_order_after_split_m(rank));
    const auto transpose2Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                            ov::Shape{rank},
                                                                            get_fusion_order_after_split_m(rank, true));
    const auto transpose3Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                   ov::Shape{rank},
                                                   get_fusion_order_after_split_m(rank, false));
    ...
    const auto subgraph = std::make_shared<ov::snippets::op::Subgraph>(
        subgraph_inputs,
        std::make_shared<ov::Model>(ov::OutputVector{transpose3}, subgraph_params));
...
std::shared_ptr<ov::Model> MHAMatMul0TransposeFunction::initOriginal() const {
    ...
    std::vector<int64_t> reshape0ConstData = {
        ...
        -1};
    auto reshape0Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, constantShapes[3], reshape0ConstData);
    ...
    std::vector<int64_t> reshape1ConstData = {static_cast<int64_t>(input_shapes[0].get_shape()[0]),
                                              ...
                                              static_cast<int64_t>(input_shapes[0].get_shape()[1])};
    auto reshape1Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, constantShapes[4], reshape1ConstData);
...
std::shared_ptr<ov::Model> MHAMatMul0TransposeFunction::initReference() const {
    ...
    auto transpose0Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                      constantShapes[0],
                                                                      std::vector<int64_t>{0, 2, 1, 3});
    auto transpose1Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                      constantShapes[1],
                                                                      std::vector<int64_t>{0, 2, 3, 1});
    auto transpose2Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                      constantShapes[5],
                                                                      std::vector<int64_t>{0, 2, 1, 3});
    auto transpose3Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                      constantShapes[6],
                                                                      std::vector<int64_t>{0, 2, 1, 3});
...
std::shared_ptr<ov::Model> MHASelectFunction::initOriginal() const {
    ...
    if (add->get_output_partial_shape(0) != input_shapes[3]) {
        const auto broadcast_shape =
            ov::test::utils::deprecated::make_constant(ov::element::i64, constantShapes[5], add->get_output_shape(0));
...
std::shared_ptr<ov::Model> MHASelectSplitMFunction::initOriginal() const {
    ...
    auto reshape0Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                    ov::Shape{reshape0ConstData.size()},
                                                                    reshape0ConstData);
    ...
    auto reshape1Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                    ov::Shape{reshape1ConstData.size()},
                                                                    reshape1ConstData);
...
std::shared_ptr<ov::Model> MHAWOTransposeOnInputsFunction::initOriginal() const {
    ...
    auto transpose3Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, ov::Shape({4}), std::vector<int64_t>{0, 2, 1, 3});

    float transA = false;
    float transB = false;
    const auto mulConst =
        ov::test::utils::deprecated::make_constant(precision, ov::Shape({1}), std::vector<float>{1}, true);
...
std::shared_ptr<ov::Model> MHAWOTransposeSplitMFunction::initReference() const {
    ...
    const auto subgraph = std::make_shared<ov::snippets::op::Subgraph>(
        ov::NodeVector{reshape0, reshape1, reshape2},
        std::make_shared<ov::Model>(ov::OutputVector{matMul1}, ov::ParameterVector{data0, data1, data2}));
...
std::shared_ptr<ov::Model> MHAFQAfterMatMulFunction::initOriginal() const {
    ...
    auto transpose0Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, {shape_rank}, std::vector<int64_t>{0, 2, 1, 3});
    auto transpose1Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, {shape_rank}, std::vector<int64_t>{0, 2, 3, 1});
    ...
    std::vector<int64_t> reshape0ConstData = {
        ...
        -1};
    auto reshape0Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, {reshape0ConstData.size()}, reshape0ConstData);
    ...
    std::vector<int64_t> reshape1ConstData = {static_cast<int64_t>(input_shapes[0].get_shape()[0]),
                                              ...
                                              static_cast<int64_t>(input_shapes[0].get_shape()[1])};
    auto reshape1Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, {reshape1ConstData.size()}, reshape1ConstData);
...
std::shared_ptr<ov::Model> MHAINT8MatMulFunction::initOriginal() const {
    ...
    const auto reshape1 = std::make_shared<ov::opset1::Reshape>(softMax, reshape1Const, true);
    auto fq4 =
        ov::test::utils::make_fake_quantize(reshape1, ov::element::f32, 256, {1}, {0}, {0.820726}, {0}, {0.820726});
...
std::shared_ptr<ov::Model> MHAQuantMatMul0Function::initOriginal() const {
    ...
    auto reshape3Const = ov::test::utils::deprecated::make_constant(ov::element::i64,
                                                                    {input_shapes[0].size()},
                                                                    std::vector<int64_t>{0, 0, -1});

    auto transpose0Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, {4}, std::vector<int64_t>{0, 2, 1, 3});
    auto transpose1Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, {4}, std::vector<int64_t>{0, 2, 3, 1});
    auto transpose2Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, {4}, std::vector<int64_t>{0, 2, 1, 3});
    auto transpose3Const =
        ov::test::utils::deprecated::make_constant(ov::element::i64, {4}, std::vector<int64_t>{0, 2, 1, 3});
...
std::shared_ptr<ov::Model> MHAFQFunction::initOriginal() const {
    ...
    const auto transpose1 = std::make_shared<ov::op::v1::Transpose>(fq1, transpose1Const);
    const auto transpose2 = std::make_shared<ov::op::v1::Transpose>(transpose2Param, transpose2Const);
    const auto mul_const =
        ov::test::utils::deprecated::make_constant(ov::element::i8, ov::Shape{1}, std::vector<int8_t>{127});
    const auto convert = std::make_shared<ov::opset1::Convert>(mul_const, ov::element::f32);
    const auto mul_deq_const =
        ov::test::utils::deprecated::make_constant(ov::element::f32, ov::Shape{1}, std::vector<float>{0.00098425});
    ...
    auto fq1_1 = ov::test::utils::make_fake_quantize(mul,
                                                     ov::element::f32,
                                                     256,
                                                     {1},
                                                     {-0.8003067},
    ...
    auto fq2 = ov::test::utils::make_fake_quantize(matMul0,
                                                   ov::element::f32,
                                                   256,
                                                   {1},
                                                   {-14.50351},
...
std::shared_ptr<ov::Model> MHAINT8MatMulTypeRelaxedFunction::initOriginal() const {
    ...
    const auto fq_signed_params = ov::builder::subgraph::FakeQuantizeOnData(256,
                                                                            ...
                                                                            ov::element::i8);
    const auto fq0 =
        ov::builder::subgraph::makeFakeQuantizeTypeRelaxed(transpose0Param, ov::element::i8, fq_signed_params);
    const auto fq1 =
        ov::builder::subgraph::makeFakeQuantizeTypeRelaxed(transpose1Param, ov::element::i8, fq_signed_params);
    const auto fq2 =
        ov::builder::subgraph::makeFakeQuantizeTypeRelaxed(transpose2Param, ov::element::i8, fq_signed_params);
    ...
    const auto fq_unsigned_params =
        ov::builder::subgraph::FakeQuantizeOnData(256, {1}, {0}, {0.245}, {0}, {255}, ov::element::u8);
...
std::shared_ptr<ov::Model> MHAMulAddFunction::initOriginal() const {
    ...
    const auto matMul0 = std::make_shared<ov::op::v0::MatMul>(transpose0, transpose1, transA, transB);
    auto mulConst =
        ov::test::utils::deprecated::make_constant(ov::element::f32, matMul0->get_shape(), std::vector<float>{}, true);
    auto addConst =
        ov::test::utils::deprecated::make_constant(ov::element::f32, matMul0->get_shape(), std::vector<float>{}, true);
...
std::shared_ptr<ov::Model> MHATransposedInputFunction::initReference() const {
    ...
    if (m_transposed_b) {
        if (m_order != std::vector<int64_t>{0, 2, 1, 3}) {
            ...
            const auto transposeConst = ov::test::utils::deprecated::make_constant(ov::element::i32,
    ...
    if (!m_order.empty() && is_supported) {
        const auto transposeConst =
            ov::test::utils::deprecated::make_constant(ov::element::i32, ov::Shape{m_order.size()}, m_order);
        matmul0_in1 = std::make_shared<ov::op::v1::Transpose>(param1, transposeConst);
    }
...
std::shared_ptr<ov::Model> MHAWithExtractedReshapeFunction::initReference() const {
    ...
    auto subgraph_model =
        std::make_shared<ov::Model>(NodeVector{matmul_1}, ov::ParameterVector{param_0, param_1, param_2, param_3});
    auto subgraph =
        std::make_shared<ov::snippets::op::Subgraph>(ov::NodeVector{data_0, data_1, reshape, data_4}, subgraph_model);
