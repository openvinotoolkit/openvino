...
std::shared_ptr<ov::Model> ThreeFQFunction::initOriginal() const {
    ...
    auto fq0_data = ov::builder::subgraph::FakeQuantizeOnDataWithConstant(
        256,
    ...
    auto fq1_data = ov::builder::subgraph::FakeQuantizeOnDataWithConstant(
        256,
        std::vector<ov::Shape>{{1, 3, 1, 1}, {1, 3, 1, 1}, {1}, {1}},
    ...
    auto fq2_data = ov::builder::subgraph::FakeQuantizeOnDataWithConstant(
        256,
        std::vector<ov::Shape>{{1, 3, 1, 1}, {1, 3, 1, 1}, {1}, {1}},
