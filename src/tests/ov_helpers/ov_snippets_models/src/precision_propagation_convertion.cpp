...
namespace {
std::shared_ptr<ov::op::v0::FakeQuantize> make_fake_quantize(const Output<Node>& parent,
...
std::shared_ptr<ov::Model> PrecisionPropagationConvertionFunction::get(
    ...
    std::shared_ptr<Node> parent = make_fake_quantize(parameter1, input_shapes[0], input_type, fake_quantize_intervals);
