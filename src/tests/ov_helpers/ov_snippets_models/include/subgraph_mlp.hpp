...
/* The file contains graphs with different MLP from LLM patterns:
...
public:
    ...
    explicit MLPFunction(const std::vector<PartialShape>& input_shapes,
...
std::ostream& operator<<(std::ostream& os, MLPFunction::WeightFormat type);
