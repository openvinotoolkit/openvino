...
public:
    ...
    void SetUp() override {
       ...
       metaDevices = {{CommonTestUtils::DEVICE_CPU, {}, 2, "", "CPU_01"},
           ...
           {CommonTestUtils::DEVICE_GPU, {}, 2, "01", "Intel(R) Iris(R) Xe MAX Graphic_01"},
...
// example
// ConfigParams {"FP32", {PriorityParams {0, "Intel(R) Iris(R) Xe MAX Graphic_01"},
...
const std::vector<ConfigParams> testConfigs = {
                                               ConfigParams {"FP32", {PriorityParams {0, "Intel(R) Iris(R) Xe MAX Graphic_01"},
                                                                      ...
                                                                      PriorityParams {2, "CPU_01"}}},
                                               ConfigParams {"FP32", {PriorityParams {2, "Intel(R) Iris(R) Xe MAX Graphic_01"},
                                                                      PriorityParams {3, "iGPU_01"},
                                                                      PriorityParams {4, "CPU_01"},
                                                                      PriorityParams {5, "MYRIAD_01"}}},
                                               ConfigParams {"FP32", {PriorityParams {2, "Intel(R) Iris(R) Xe MAX Graphic_01"},
                                                                      PriorityParams {0, "Intel(R) Iris(R) Xe MAX Graphic_01"},
                                               ...
                                               ConfigParams {"INT8", {PriorityParams {0, "VPUX_01"},
                                                                      ...
                                                                      PriorityParams {2, "CPU_01"},
                                                                      PriorityParams {3, "CPU_01"}}},
                                               ConfigParams {"BIN", {PriorityParams {0, "Intel(R) Iris(R) Xe MAX Graphic_01"},
                                                                      PriorityParams {1, "iGPU_01"},
                                                                      PriorityParams {2, "CPU_01"},
                                                                      PriorityParams {2, "CPU_01"}}},
                                               ConfigParams {"BIN", {PriorityParams {2, "Intel(R) Iris(R) Xe MAX Graphic_01"},
                                                                      PriorityParams {3, "iGPU_01"},
                                                                      PriorityParams {4, "CPU_01"},
                                                                      PriorityParams {5, "CPU_01"}}},
                                               ConfigParams {"BIN", {PriorityParams {2, "Intel(R) Iris(R) Xe MAX Graphic_01"},
