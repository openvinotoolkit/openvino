...
TEST(TransformationTests, ConvertToInteractionTest1) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        {
            auto dense_feature = std::make_shared<ngraph::opset1::Parameter>(element::f32, ov::PartialShape{3, 4});
            ...
            for (size_t i = 0; i < sparse_feature_num; i++) {
                auto sparse_feat = std::make_shared<ngraph::opset1::Parameter>(element::f32, ov::PartialShape{3, 4});
            ...
            auto concat2 = std::make_shared<opset1::Concat>(ov::NodeVector{dense_feature, reshape4}, 1);
            f = std::make_shared<ov::Model>(concat2, inputs_params, "interaction");
        ...
        //construct ref interaction
        {
            ...
            f_ref = std::make_shared<ov::Model>(interaction, inputs_params, "interaction");
        }
