...
TEST(StaticShapeInferenceTest, Einsum1) {
    auto I1 = std::make_shared<op::v1::Parameter>(element::f32, ov::PartialShape::dynamic());
    auto I2 = std::make_shared<op::v1::Parameter>(element::f32, ov::PartialShape::dynamic());
...
TEST(StaticShapeInferenceTest, Einsum5) {
    auto I1 = std::make_shared<op::v1::Parameter>(element::i32, ov::PartialShape::dynamic());
    auto I2 = std::make_shared<op::v1::Parameter>(element::i32, ov::PartialShape::dynamic());
    auto I3 = std::make_shared<op::v1::Parameter>(element::i32, ov::PartialShape::dynamic());
