...
std::shared_ptr<Node> create_detection_output(const PartialShape& box_logits_shape,
    ...
    auto box_logits = std::make_shared<op::v1::Parameter>(input_type, box_logits_shape);
    auto class_preds = std::make_shared<op::v1::Parameter>(input_type, class_preds_shape);
    auto proposals = std::make_shared<op::v1::Parameter>(proposals_type, proposals_shape);
    auto aux_class_preds = std::make_shared<op::v1::Parameter>(input_type, aux_class_preds_shape);
    auto aux_box_preds = std::make_shared<op::v1::Parameter>(input_type, aux_box_preds_shape);
...
TEST(StaticShapeInferenceTest, detection_output_top_k) {
    op::v1::DetectionOutput::Attributes attrs;
    attrs.keep_top_k = {-1};
    attrs.top_k = 7;
    attrs.normalized = true;
    attrs.num_classes = 2;
    auto op = create_detection_output<op::v1::DetectionOutput>(PartialShape{4, 20},
                                                               PartialShape{4, 10},
                                                               PartialShape{4, 2, 20},
                                                               PartialShape{4, 10},
                                                               PartialShape{4, 20},
...
TEST(StaticShapeInferenceTest, detection_output_no_share_location) {
    ...
    auto op = create_detection_output<op::v1::DetectionOutput>(PartialShape{4, 40},
                                                               PartialShape{4, 10},
                                                               PartialShape{4, 2, 20},
                                                               PartialShape{4, 10},
                                                               PartialShape{4, 40},
