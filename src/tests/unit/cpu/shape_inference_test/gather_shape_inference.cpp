...
TEST(StaticShapeInferenceTest, GatherV1Test) {
    auto P = std::make_shared<op::v1::Parameter>(element::f32, PartialShape{-1, -1});
    auto I = std::make_shared<op::v1::Parameter>(element::i32, PartialShape{-1, -1});
    auto A = op::v1::Constant::create(element::i64, Shape{}, {0});
...
TEST(StaticShapeInferenceTest, GatherV1TestNonConstantA) {
    auto P = std::make_shared<op::v1::Parameter>(element::f32, PartialShape{-1, -1});
    auto I = std::make_shared<op::v1::Parameter>(element::i32, PartialShape{-1, -1});
    auto A = std::make_shared<op::v1::Parameter>(element::i32, PartialShape{});
    auto G = std::make_shared<op::v1::Gather>(P, I, A);
