...
public:
    ...
    MOCK_METHOD(std::shared_ptr<ov::ICompiledModel>,
                ...
                (const));
    MOCK_METHOD(std::shared_ptr<ov::ICompiledModel>, import_model, (const ov::Any&, const ov::AnyMap&), (const));
    MOCK_METHOD(std::shared_ptr<ov::ICompiledModel>,
                import_model,
                (const ov::Any&, const ov::SoPtr<ov::IRemoteContext>&, const ov::AnyMap&),
                (const));
