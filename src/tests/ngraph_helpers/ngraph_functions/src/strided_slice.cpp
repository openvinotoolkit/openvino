...
std::shared_ptr<ov::Node> makeStridedSlice(const ov::Output<Node> &in,
    ...
    auto beginNode = std::make_shared<ov::op::v1::Constant>(ov::element::i64, constShape, begin.data());
    auto endNode = std::make_shared<ov::op::v1::Constant>(ov::element::i64, constShape, end.data());
    auto strideNode = std::make_shared<ov::op::v1::Constant>(ov::element::i64, constShape, stride.data());
...
std::shared_ptr<ov::Node> makeSlice(const ov::Output<Node> &in,
    ...
    auto strideNode = std::make_shared<ov::op::v1::Constant>(ov::element::i64, constShape, stride.data());
    if (!axes.empty()) {
        auto axesNode = std::make_shared<ov::op::v1::Constant>(ov::element::i64, constShape, axes.data());
