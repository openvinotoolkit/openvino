...
std::vector<typename ngraph::helpers::nGraphTypesTrait<dType>::value_type> inline generateVector(
    size_t vec_len,
...
std::vector<ngraph::float16> inline generateF16Vector(size_t vec_len,
                                                      ngraph::float16 upTo = 10,
                                                      ngraph::float16 startFrom = 1,
                                                      int32_t seed = 1) {
...
std::vector<ngraph::bfloat16> inline generateBF16Vector(size_t vec_len,
                                                        ngraph::bfloat16 upTo = 10,
                                                        ngraph::bfloat16 startFrom = 1,
                                                        int32_t seed = 1) {
