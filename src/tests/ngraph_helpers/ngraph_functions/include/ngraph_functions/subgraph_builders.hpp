...
inline std::shared_ptr<ov::Model> makeTIwithLSTMcell(ov::element::Type_t ngPRC = ov::element::Type_t::f32,
...
inline std::shared_ptr<ov::Model> makeSplitConvConcatNestedInBranch(
...
inline std::shared_ptr<ov::Model> makeMultipleInputOutputDoubleConcat(
