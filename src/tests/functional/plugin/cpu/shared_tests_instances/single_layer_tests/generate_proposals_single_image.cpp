...
const std::vector<std::pair<std::string, std::vector<ov::Tensor>>> inputTensors = {
    {
        ...
        {
            // 3
            ov::test::utils::create_tensor<float>(ov::element::f32, ov::Shape{2, 3}, {1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f}),
            // 2 x 6 x 3 x 4 = 144
    ...
    },
    {
        "filled",
        {
            ov::test::utils::create_tensor<float>(ov::element::f32, ov::Shape{2, 3}, {150.0, 150.0, 1.0, 150.0, 150.0, 1.0}),
            ov::test::utils::create_tensor<float>(ov::element::f32, ov::Shape{2, 6, 3, 4}, {
