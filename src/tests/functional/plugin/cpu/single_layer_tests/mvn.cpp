...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefsStatic_Mvn3D, MvnLayerCPUTest, Mvn3DStatic, MvnLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefsStatic_Mvn4D, MvnLayerCPUTest, Mvn4DStatic, MvnLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefsStatic_Mvn5D, MvnLayerCPUTest, Mvn5DStatic, MvnLayerCPUTest::getTestCaseName);
