...
protected:
    bool isBias = false;
    std::vector<double> relThresholds;
    ...
    void SetUp() override {
        ...
        // WA to compare results with different thresholds for different implementations
        relThresholds.resize(cpuParamsVec.size());
        for (int i = 0; i < cpuParamsVec.size(); i++) {
            std::tie(inFmts, outFmts, priority, selectedType) = cpuParamsVec[i];
            if (selectedType == "jit_gemm" && execElemType == ov::element::bf16) {
                relThresholds[i] = 0.05f;
            } else {
                relThresholds[i] = rel_threshold;
            }
        }
    ...
    void infer() override {
        ...
        std::shared_ptr<ov::Node> convOpPtr;

        auto ops = function->get_ops();
        for (const auto &op : ops) {
            if (std::string {op->get_type_name()} == "Convolution") {
                convOpPtr = op;
                break;
            }
        }
        ASSERT_FALSE(convOpPtr == nullptr) << "No operation with type Convolution in test function";

        ASSERT_EQ(relThresholds.size(), cpuParamsVec.size());
        ...
        for (size_t i = 0; i < cpuParamsVec.size(); i++) {
            ...
            if (!inFmts.empty() && (inFmts.front() == nwc || inFmts.front() == nhwc || inFmts.front() == ndhwc) && selectedType.find("jit_sse")
                                                                                                                   != std::string::npos) {
                ...
                if ((inpChannels % 8) || (outChannels % 8)) {
                    std::cout << "Skipped test with inFmts = " << fmts2str(inFmts, {}) << " and implType = " << selectedType << std::endl;
                    continue;
                }
            }

            convOpPtr->get_rt_info() = getCPUInfo();
            ...
            ASSERT_FALSE(expectedOutputs.empty()) << "expectedOutputs is empty for Convolution CPU test";
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_GEMM_BF16_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_GEMM_2D,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_GEMM_BF16_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_GEMM_2D,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(Conv_2D_GEMM_BF16_dilated_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_GEMM_2D_dilated,
                                         ::testing::Values(ElementType::f32),
...
// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(Conv_2D_GEMM_BF16_dilated_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_GEMM_2D_dilated,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_GEMM_BF16_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_GEMM_3D,
                                         ::testing::Values(ElementType::f32),
...
// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_GEMM_BF16_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_GEMM_3D,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(Conv_3D_GEMM_BF16_dilated_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_GEMM_3D_dilated,
                                         ::testing::Values(ElementType::f32),
...
// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(Conv_3D_GEMM_BF16_dilated_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_GEMM_3D_dilated,
                                         ::testing::Values(ElementType::f32),
...
const std::vector<CPUSpecificParams> CPUParams_1D_sse42_avx512 = {
        conv_sse42_1D,
        conv_avx512_1D,
        conv_sse42_1D_nspc,
        conv_avx512_1D_nspc
...
const std::vector<CPUSpecificParams> CPUParams_1D_avx2 = {
        conv_avx2_1D,
        conv_avx2_1D_nspc
};

INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_FP32_sse42_avx512, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1D_sse42_avx512)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_FP32_avx2, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_1D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes1d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1D_avx2)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_PlainToBlocked_FP32, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1D_plain_to_blocked)),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_PlainToBlocked_BF16, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapesPlain2Blocked1d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx512_plain_to_blocked_1D})),
                                 ::testing::Values(emptyFusingSpec),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
const std::vector<CPUSpecificParams> CPUParams_2D_sse42_avx512 = {
        conv_sse42_2D,
        conv_avx512_2D,
        conv_sse42_2D_nspc,
        conv_avx512_2D_nspc
...
const std::vector<CPUSpecificParams> CPUParams_2D_avx2 = {
        conv_avx2_2D,
        conv_avx2_2D_nspc
};
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_FP32_sse42_avx512, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_2D_sse42_avx512)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_FP32_avx2, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_2D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes2d_cache),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_2D_avx2)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_BF16_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_2D,
                                         ::testing::Values(ElementType::f32),
...
// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_BF16_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_2D,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(Conv_2D_BF16_dilated_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_2D_dilated,
                                         ::testing::Values(ElementType::f32),
...
// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(Conv_2D_BF16_dilated_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_2D_dilated,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_PlainToBlocked_FP32, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_2D_plain_to_blocked)),
                                 ::testing::Values(emptyFusingSpec),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_PlainToBlocked_BF16, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapesPlain2Blocked2d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx512_plain_to_blocked_2D})),
                                 ::testing::Values(emptyFusingSpec),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_reorder_Conv_2D, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx512_2D_1x1})),
...
const std::vector<CPUSpecificParams> CPUParams_3D_avx512 = {
        conv_avx512_3D,
        conv_avx512_3D_nspc
};

const std::vector<CPUSpecificParams> CPUParams_3D_avx2 = {
        conv_avx2_3D,
        conv_avx2_3D_nspc
};


INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_FP32_avx512, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_3D_avx512)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_FP32_avx2, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_3D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes3d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_3D_avx2)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_BF16_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_3D,
                                         ::testing::Values(ElementType::f32),
...
// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_BF16_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_3D,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(Conv_3D_BF16_dilated_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_3D_dilated,
                                         ::testing::Values(ElementType::f32),
...
// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(Conv_3D_BF16_dilated_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_3D_dilated,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_PlainToBlocked_FP32, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_3D_plain_to_blocked)),
                                 ::testing::Values(emptyFusingSpec),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_PlainToBlocked_BF16, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapesPlain2Blocked3d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx512_plain_to_blocked_3D})),
                                 ::testing::Values(emptyFusingSpec),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
const std::vector<CPUSpecificParams> CPUParams_1x1_1D_sse42_avx512 = {
        conv_sse42_1D_1x1,
        conv_avx512_1D_1x1,
        conv_sse42_1D_1x1_nspc,
        conv_avx512_1D_1x1_nspc
...
const std::vector<CPUSpecificParams> CPUParams_1x1_1D_avx2 = {
        conv_avx2_1D_1x1,
        conv_avx2_1D_1x1_nspc
};

INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_1x1_FP32_sse42_avx512, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapes1d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1x1_1D_sse42_avx512)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_1x1_FP32_avx2, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_1x1_1D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes1d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1x1_1D_avx2)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_1x1_BF16_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_1x1_1D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes1d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx512_1D_1x1})),
                                 ::testing::ValuesIn(fusingParamsSetBF16),
                                 ::testing::Values(cpuBF16PluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_1x1_BF16_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_1x1_1D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes1d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx512_2D_1x1_nspc})),
                                 ::testing::ValuesIn(fusingParamsSetBF16),
                                 ::testing::Values(cpuBF16PluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D_1x1_I8, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapes1d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1x1_1D)),
                                 ::testing::Values(fusingSum),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
const std::vector<CPUSpecificParams> CPUParams_1x1_2D_sse42_avx512 = {
        conv_sse42_2D_1x1,
        conv_avx512_2D_1x1,
        conv_sse42_2D_1x1_nspc,
        conv_avx512_2D_1x1_nspc
...
const std::vector<CPUSpecificParams> CPUParams_1x1_2D_avx2 = {
        conv_avx2_2D_1x1,
        conv_avx2_2D_1x1_nspc
};

INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_1x1_FP32_sse42_avx512, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapes2d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1x1_2D_sse42_avx512)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_1x1_FP32_avx2, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_1x1_2D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes2d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1x1_2D_avx2)),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_1x1_BF16_ncsp, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_1x1_2D,
                                         ::testing::Values(ElementType::f32),
...
// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_1x1_BF16_nspc, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_ExplicitPadding_1x1_2D,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_1x1_I8, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapes2d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_1x1_2D)),
                                 ::testing::Values(fusingSum),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_Jit_Planar_FP32_avx512, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapes2d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx512_planar_2D})),
                                 ::testing::Values(emptyFusingSpec, fusingRelu),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_Jit_Planar_FP32_avx2, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_Planar_ExplicitPadding_2D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes2d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx2_planar_2D})),
                                 ::testing::Values(emptyFusingSpec, fusingRelu),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(Conv_2D_Jit_Planar_FP32_dilated, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapes2d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_Jit_Planar_2D)),
                                 ::testing::Values(emptyFusingSpec, fusingRelu),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_Jit_Planar_FP32_avx512, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapes3d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx512_planar_3D})),
                                 ::testing::Values(emptyFusingSpec, fusingRelu),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);

// disabled in skip_tests_config.cpp for now
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_Jit_Planar_FP32_avx2, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_Planar_ExplicitPadding_3D,
                                         ::testing::Values(ElementType::f32),
                                         ...
                                         ::testing::ValuesIn(inputShapes3d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice({conv_avx2_planar_3D})),
                                 ::testing::Values(emptyFusingSpec, fusingRelu),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(Conv_3D_Jit_Planar_FP32_dilated, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::ValuesIn(inputShapes3d),
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(CPUParams_Jit_Planar_3D)),
                                 ::testing::Values(emptyFusingSpec, fusingRelu),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_AutoPad_FP32_sse42_avx512, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_AutoPad_FP32_avx2, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         convParams_AutoPadding_2D,
                                         ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_winograd, ConvolutionLayerCPUTest,
                         ::testing::Combine(
                                 ::testing::Combine(
                                         ...
                                         ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                 ::testing::Values(filterCPUInfoForDevice(std::vector<CPUSpecificParams>{conv_winograd})),
                                 ::testing::ValuesIn(fusingParamsSet),
                                 ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
