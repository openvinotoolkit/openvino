...
const std::vector<ov::AnyMap> Multiconfigs = {
        ...
        {ov::device::priorities(CommonTestUtils::DEVICE_CPU, CommonTestUtils::DEVICE_GPU), ov::intel_auto::device_bind_buffer(false)},
        {ov::device::priorities(CommonTestUtils::DEVICE_CPU, CommonTestUtils::DEVICE_GPU), ov::intel_auto::device_bind_buffer(true)}
};
