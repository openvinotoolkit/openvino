...
TEST_P(IEClassGetMetricTest_GPU_MEMORY_STATISTICS_DEFAULT, GetMetricAndPrintNoThrow) {
    ...
    std::map<std::string, uint64_t> t = p.as<std::map<std::string, uint64_t>>();
...
TEST_P(IEClassGetMetricTest_GPU_MEMORY_STATISTICS_MULTIPLE_NETWORKS, GetMetricAndPrintNoThrow) {
    ...
    ASSERT_NO_THROW(p = ie.GetMetric(target_device, GPU_METRIC_KEY(MEMORY_STATISTICS)));
    std::map<std::string, uint64_t> t1 = p.as<std::map<std::string, uint64_t>>();
    ...
    ASSERT_NO_THROW(p = ie.GetMetric(target_device, GPU_METRIC_KEY(MEMORY_STATISTICS)));
    std::map<std::string, uint64_t> t2 = p.as<std::map<std::string, uint64_t>>();
...
TEST_P(IEClassGetMetricTest_GPU_MEMORY_STATISTICS_CHECK_VALUES, GetMetricAndPrintNoThrow) {
...

    {
        ...
        }
        {
            ...
            ASSERT_NO_THROW(p = ie.GetMetric(target_device, GPU_METRIC_KEY(MEMORY_STATISTICS)));
            std::map<std::string, uint64_t> t3 = p.as<std::map<std::string, uint64_t>>();
        ...
        ASSERT_NO_THROW(p = ie.GetMetric(target_device, GPU_METRIC_KEY(MEMORY_STATISTICS)));
        std::map<std::string, uint64_t> t4 = p.as<std::map<std::string, uint64_t>>();
    ...
    ASSERT_NO_THROW(p = ie.GetMetric(target_device, GPU_METRIC_KEY(MEMORY_STATISTICS)));
    std::map<std::string, uint64_t> t5 = p.as<std::map<std::string, uint64_t>>();
