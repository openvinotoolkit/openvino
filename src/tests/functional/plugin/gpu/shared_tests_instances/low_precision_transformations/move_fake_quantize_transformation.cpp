...
const std::vector<LayerTestsDefinitions::MoveFakeQuantizeTransformationParam> params = {
    ...
    // with ReLU operation
    {3, "relu", {256ul, {}, {-12.7f}, {12.7f}, {-12.7f}, {12.7f}}, {}, {}, "Concat", "U8", 1},
    // negative axis
    {3, "", {256ul, {}, {-1.28f}, {1.27f}, {-1.28f}, {1.27f}}, {}, {}, "Concat", "FP32", 0},
    // Q/DQ
    {3,
     "",
    ...
    {3,
     ...
     {256ul,
      ...
      {255.f, 255.f, 255.f}},
     {ngraph::element::u8},
     {{ngraph::element::f32}, {}, {{0.01f, 0.01f, 0.01f}, ngraph::element::f32, {1, 3, 1, 1}}},
     "Concat",
     "U8",
     1},
    ...
    {3,
     ...
     {256ul,
      ...
      {255.f, 255.f, 255.f}},
     {ngraph::element::u8},
     {{ngraph::element::f32}, {{0.01f, 0.01f, 0.01f}, ngraph::element::f32, {1, 3, 1, 1}}, {0.01f}},
     "Concat",
     "U8",
     1},
};

const std::vector<std::vector<ngraph::PartialShape>> shapes = {{{1, 1, 16, 16}, {1, 1, 16, 16}, {1, 1, 16, 16}},
