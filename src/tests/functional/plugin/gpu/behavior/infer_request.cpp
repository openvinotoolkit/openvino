...
TEST(TensorTest, smoke_canSetScalarTensor) {
    ...
    auto params = ngraph::builder::makeParams(ngraph::element::Type_t::f64, scalar_shape);
    ...
    const1->fill_data(ov::element::Type_t::i64, 0);
    ...
    ov::Tensor input_data(ngraph::element::Type_t::f64, {}, &real_data);
