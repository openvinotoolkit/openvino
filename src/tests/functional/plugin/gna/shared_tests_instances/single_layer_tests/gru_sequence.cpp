...
protected:
    void SetUp() override {
        ...
        std::shared_ptr<ngraph::Node> seq_length = ngraph::builder::makeConstant(ngraph::element::i64, WRB[3], lengths, false);

        auto gru_sequence = std::make_shared<ngraph::opset8::GRUSequence>(in[0], in[1], seq_length, weightsNode, reccurrenceWeightsNode, biasNode,
                    hidden_size, direction, activations, activations_alpha, activations_beta, clip, linear_before_reset);
...
namespace {
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_GRUSequenceCommonZeroClip, GRUSequenceGNATest,
                            ::testing::Combine(
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_GRUSequenceCommonClip, GRUSequenceGNATest,
                            ::testing::Combine(
                                    ::testing::ValuesIn(mode),
