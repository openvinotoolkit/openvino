...
const std::vector<std::string> device_name{ov::test::utils::DEVICE_CPU, ov::test::utils::DEVICE_GPU};
...
namespace {
INSTANTIATE_TEST_SUITE_P(ov_plugin, AutoBatching_Test,
        ::testing::Combine(
                ::testing::ValuesIn(device_name),
...
INSTANTIATE_TEST_SUITE_P(ov_plugin, AutoBatching_Test_DetectionOutput,
                         ::testing::Combine(
