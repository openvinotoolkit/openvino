...
INSTANTIATE_TEST_SUITE_P(ov_plugin, OVClassModelOptionalTestP, ::testing::Values(ov::test::utils::target_device));

// OV Class Query network

INSTANTIATE_TEST_SUITE_P(ov_plugin_mandatory, OVClassQueryModelTest, ::testing::Values(ov::test::utils::target_device));
}  // namespace
