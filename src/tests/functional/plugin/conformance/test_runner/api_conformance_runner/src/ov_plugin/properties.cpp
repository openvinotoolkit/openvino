...
INSTANTIATE_TEST_SUITE_P(
    ov_plugin_mandatory,
    OVCheckSetIncorrectRWMetricsPropsTests,
    ::testing::Combine(::testing::Values(ov::test::utils::target_device),
...
INSTANTIATE_TEST_SUITE_P(ov_plugin_mandatory, OVGetMetricPropsTest, ::testing::Values(ov::test::utils::target_device));

INSTANTIATE_TEST_SUITE_P(ov_plugin, OVGetMetricPropsOptionalTest, ::testing::Values(ov::test::utils::target_device));
