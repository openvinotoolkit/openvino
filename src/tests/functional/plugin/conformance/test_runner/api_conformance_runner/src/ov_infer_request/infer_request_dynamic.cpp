...
std::shared_ptr<ov::Model> ovGetFunction1() {
    ...
    auto in2add = ov::test::utils::make_constant(ngPrc, {1, 4, 1, 1}, std::vector<float>{}, true);
...
std::shared_ptr<ov::Model> ovGetFunction2() {
    ...
    auto in2add = ov::test::utils::make_constant(ngPrc, {1, 2, 1, 1}, std::vector<float>{}, true);
    ...
    auto in2mult = ov::test::utils::make_constant(ngPrc, {1, 2, 1, 1}, std::vector<float>{}, true);
