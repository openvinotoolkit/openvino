...
static const std::vector<std::size_t> ovBatchSizesTemplate = {1, 2};
...
INSTANTIATE_TEST_SUITE_P(ov_plugin,
                         ...
                         ::testing::Combine(::testing::ValuesIn(CompileModelCacheTestBase::getAnyTypeOnlyFunctions()),
...
INSTANTIATE_TEST_SUITE_P(
    ov_plugin_numeric,
    CompileModelCacheTestBase,
    ::testing::Combine(::testing::ValuesIn(CompileModelCacheTestBase::getNumericTypeOnlyFunctions()),
