...
public:
    Model_1() {
        ...
        std::shared_ptr<ov::op::v0::Abs> test_abs_0 = std::make_shared<ov::op::v0::Abs>(test_parameter_0);
        test_abs_0->set_friendly_name("Op_" + std::to_string(op_idx++));
        std::shared_ptr<ov::op::v0::Relu> test_relu_0 = std::make_shared<ov::op::v0::Relu>(test_abs_0);
        ...
        std::shared_ptr<ov::op::v0::Abs> test_abs_1 = std::make_shared<ov::op::v0::Abs>(test_parameter_1);
        test_abs_1->set_friendly_name("Op_" + std::to_string(op_idx++));
        std::shared_ptr<ov::op::v0::Clamp> test_clamp_1 = std::make_shared<ov::op::v0::Clamp>(test_abs_1, 0, 10);
        test_clamp_1->set_friendly_name("Op_" + std::to_string(op_idx++));

        std::shared_ptr<ov::op::v1::Add> test_add_0 = std::make_shared<ov::op::v1::Add>(test_relu_0, test_clamp_1);
        ...
        std::shared_ptr<ov::op::v0::Abs> test_abs_0_0 = std::make_shared<ov::op::v0::Abs>(test_parameter_0_0);
        test_abs_0_0->set_friendly_name("Op_" + std::to_string(op_idx++));
        std::shared_ptr<ov::op::v0::Relu> test_relu_0_0 = std::make_shared<ov::op::v0::Relu>(test_abs_0_0);
        ...
        std::shared_ptr<ov::op::v0::Abs> test_abs_0_1 = std::make_shared<ov::op::v0::Abs>(test_parameter_0_1);
        test_abs_0_1->set_friendly_name("Op_" + std::to_string(op_idx++));
        std::shared_ptr<ov::op::v0::Clamp> test_clamp_0_1 = std::make_shared<ov::op::v0::Clamp>(test_abs_0_1, 0, 10);
        ...
        std::shared_ptr<ov::op::v0::Relu> test_relu_0_1 = std::make_shared<ov::op::v0::Relu>(test_multiply_0_1);
        ...
        std::shared_ptr<ov::op::v0::Relu> test_relu_1_1 = std::make_shared<ov::op::v0::Relu>(test_multiply_1_1);
        ...
        std::shared_ptr<ov::op::v0::Result> test_res = std::make_shared<ov::op::v0::Result>(test_add);
        ...
        out_nodes = {test_abs_0, test_relu_0, test_add_0, test_multiply_0_1, test_relu_0_1, test_add};
    ...
    std::vector<std::shared_ptr<ov::Model>> get_repeat_pattern_ref() {
        std::vector<std::shared_ptr<ov::Model>> ref;
        {
            ...
            std::shared_ptr<ov::op::v0::Abs> test_abs_0 = std::make_shared<ov::op::v0::Abs>(test_parameter_0);
            std::shared_ptr<ov::op::v0::Relu> test_relu_0 = std::make_shared<ov::op::v0::Relu>(test_abs_0);
            std::shared_ptr<ov::op::v0::Result> res = std::make_shared<ov::op::v0::Result>(test_relu_0);
            auto ref_model = std::make_shared<ov::Model>(ov::ResultVector{res}, ov::ParameterVector{test_parameter_0});
            ref.push_back(ref_model);
        }
        {
            std::shared_ptr<ov::op::v0::Parameter> test_parameter_0 =
                std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::Shape{1, 2});
            std::shared_ptr<ov::op::v0::Abs> test_abs_1 = std::make_shared<ov::op::v0::Abs>(test_parameter_0);
            std::shared_ptr<ov::op::v0::Clamp> test_clamp_1 = std::make_shared<ov::op::v0::Clamp>(test_abs_1, 0, 10);
            std::shared_ptr<ov::op::v0::Result> res = std::make_shared<ov::op::v0::Result>(test_clamp_1);
            auto ref_model = std::make_shared<ov::Model>(ov::ResultVector{res}, ov::ParameterVector{test_parameter_0});
            ref.push_back(ref_model);
        }
        {
            ...
            std::shared_ptr<ov::op::v1::Multiply> test_multiply_1 =
                std::make_shared<ov::op::v1::Multiply>(test_parameter_1_0, test_parameter_1_1);
            std::shared_ptr<ov::op::v0::Relu> test_relu_1 = std::make_shared<ov::op::v0::Relu>(test_multiply_1);
            std::shared_ptr<ov::op::v0::Result> res = std::make_shared<ov::op::v0::Result>(test_relu_1);
    ...
    std::vector<std::vector<ov::NodeVector>> get_ref_node_vector() {
        return ref_nodes;
    }

    std::vector<std::vector<PatternBorders>> get_ref_node_borders() {
        return ref_borders;
    }
    ...
    std::unordered_set<std::shared_ptr<ov::Node>> get_out_nodes_after_abs_0() {
        return out_nodes;
    }

    std::shared_ptr<ov::Node> get_test_abs_0() {
        return start_node;
    }
