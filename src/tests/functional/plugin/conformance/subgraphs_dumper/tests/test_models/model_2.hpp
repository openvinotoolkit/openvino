...
public:
    Model_2() {
        ...
        std::shared_ptr<ov::op::v0::Clamp> test_clamp = std::make_shared<ov::op::v0::Clamp>(test_abs, 0, 10);
        std::shared_ptr<ov::op::v0::Relu> test_relu = std::make_shared<ov::op::v0::Relu>(test_clamp);
        std::shared_ptr<ov::op::v0::Abs> test_abs_1 = std::make_shared<ov::op::v0::Abs>(test_relu);
        std::shared_ptr<ov::op::v1::Add> test_add = std::make_shared<ov::op::v1::Add>(test_abs_1, test_parameter_0);
