...
TEST_F(ConvolutionMatcherTest, ConvsSameKernelSize) {
    ...
    const auto op1 = std::make_shared<ov::op::v1::Convolution>(param,
                                                               weights,
                                                               ov::Strides(0, 0),
    ...
    const auto op2 = std::make_shared<ov::op::v1::Convolution>(param2,
                                                               weights2,
                                                               ov::Strides(0, 0),
                                                               ov::CoordinateDiff(0, 0),
                                                               ov::CoordinateDiff(0, 0),
...
TEST_F(ConvolutionMatcherTest, GroupConvsSameKernelSize) {
    ...
    const auto weights =
        std::make_shared<ov::op::v0::Constant>(ov::element::Type_t::f32, ov::Shape({2, 10, 2, 3, 3}), 1);
    const auto op1 = std::make_shared<ov::op::v1::GroupConvolution>(param,
                                                                    weights,
                                                                    ov::Strides(0, 0),
                                                                    ov::CoordinateDiff(0, 0),
                                                                    ov::CoordinateDiff(0, 0),
    ...
    const auto weights2 =
        std::make_shared<ov::op::v0::Constant>(ov::element::Type_t::f32, ov::Shape({2, 10, 3, 3, 3}), 1);
    const auto op2 = std::make_shared<ov::op::v1::GroupConvolution>(param2,
                                                                    weights2,
                                                                    ov::Strides(0, 0),
                                                                    ov::CoordinateDiff(0, 0),
                                                                    ov::CoordinateDiff(0, 0),
...
TEST_F(ConvolutionMatcherTest, GroupConvsDifferentKernelSize) {
    const auto param = std::make_shared<ov::op::v0::Parameter>(ov::element::Type_t::f32, ov::Shape({1, 4, 10, 10}));
    const auto weights =
        std::make_shared<ov::op::v0::Constant>(ov::element::Type_t::f32, ov::Shape({2, 10, 2, 3, 5}), 1);
    const auto op1 = std::make_shared<ov::op::v1::GroupConvolution>(param,
                                                                    weights,
                                                                    ov::Strides(0, 0),
                                                                    ov::CoordinateDiff(0, 0),
