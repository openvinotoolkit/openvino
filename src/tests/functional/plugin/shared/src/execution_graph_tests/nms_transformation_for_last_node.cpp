...
std::string ExecGraphNmsTransformLastNode::getTestCaseName(testing::TestParamInfo<std::string> obj) {
...
TEST_P(ExecGraphNmsTransformLastNode, CheckIfCanBeInfered) {
    ...
    auto nms = std::make_shared<ov::op::v5::NonMaxSuppression>(boxes,
                                                               scores,
    ...
    auto compareOutputNames = [](const ov::Output<ov::Node>& lhs, const ov::Output<const ov::Node>& rhs) {
