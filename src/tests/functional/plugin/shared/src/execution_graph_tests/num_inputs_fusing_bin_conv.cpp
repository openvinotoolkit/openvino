...
void ExecGraphInputsFusingBinConv::SetUp() {
    const ov::inplace_vector<size_t> inputShapes = {1, 16, 30, 30}, binConvKernelSize = {2, 2}, convKernelSize = {3, 3};
    const size_t numOutChannels = 16, numGroups = 16;
    const ov::inplace_vector<size_t> strides = {1, 1}, dilations = {1, 1};
    ...
    auto biasNode = std::make_shared<ov::op::v0::Constant>(ov::element::f32, ov::inplace_vector<size_t>{16, 1, 1});
