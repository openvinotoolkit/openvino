...
std::string ExecGraphRemoveParameterNode::getTestCaseName(testing::TestParamInfo<std::string> obj) {
...
TEST_P(ExecGraphRemoveParameterNode, RemoveParameterNode) {
    ...
    auto function = std::make_shared<ov::Model>(ov::NodeVector{sum}, ov::ParameterVector{input2, input}, "SimpleNet");
    ...
    auto const_in = std::make_shared<ov::op::v0::Constant>(type, shape, std::vector<float>(6, 1.0));
