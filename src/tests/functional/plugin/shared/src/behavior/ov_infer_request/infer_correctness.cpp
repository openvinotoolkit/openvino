...
std::shared_ptr<ngraph::Function> GetDefaultGraph() {
    ...
    auto weights = ov::test::utils::builder::makeConstant<float>(ov::element::f32, {64, 3, 7, 7}, {},
            true);
    auto conv1 = std::make_shared<ov::op::v1::Convolution>(input, weights, strides,
            padBegin, padEnd, strides);
    auto gamma = ov::test::utils::builder::makeConstant<float>(ov::element::f32, {64}, {},
            true);
    auto beta = ov::test::utils::builder::makeConstant<float>(ov::element::f32, {64}, {},
            true);
    auto mean = ov::test::utils::builder::makeConstant<float>(ov::element::f32, {64}, {},
            true);
    auto variance = ov::test::utils::builder::makeConstant<float>(ov::element::f32, {64}, {},
            true);
