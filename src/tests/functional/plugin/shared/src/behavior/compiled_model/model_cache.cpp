...
std::string WeightlessCacheAccuracy::get_test_case_name(
...
void WeightlessCacheAccuracy::TearDown() {
    ...
    ov::test::utils::removeFilesWithExt<true>(m_cache_dir, "blob");
    ov::test::utils::removeFilesWithExt<true>(m_cache_dir, "cl_cache");
