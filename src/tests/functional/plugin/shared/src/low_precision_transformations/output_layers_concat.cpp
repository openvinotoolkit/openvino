...
std::string OutputLayersConcat::getTestCaseName(
...
void OutputLayersConcat::SetUp() {
    ...
    init_input_shapes({ov::PartialShape(inputShape1),
    ...
    const auto fakeQuantize1 = ov::test::utils::make_fake_quantize(input1->output(0),
                                                                   ngPrecision,
                                                                   256ul,
                                                                   {1ul},
                                                                   {0.f},
    ...
    const auto fakeQuantize2 = ov::test::utils::make_fake_quantize(input2->output(0),
                                                                   ngPrecision,
                                                                   256ul,
                                                                   {1ul},
                                                                   {0.f},
    ...
    const std::shared_ptr<ov::op::v0::Concat> concat =
        std::make_shared<ov::op::v0::Concat>(ov::OutputVector{fakeQuantize1->output(0), fakeQuantize2->output(0)}, 1);
    ...
    const std::shared_ptr<ov::op::v1::Convolution> convolution =
        std::make_shared<ov::op::v1::Convolution>(concat->output(0),
