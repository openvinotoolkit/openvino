...
std::string FakeQuantizeAndMaxPoolTransformation::getTestCaseName(
    const testing::TestParamInfo<FakeQuantizeAndMaxPoolTransformationParams>& obj) {
...
void FakeQuantizeAndMaxPoolTransformation::SetUp() {
    ...
    function = ov::builder::subgraph::MaxPoolFunction::getOriginal(precision, inputShape, fakeQuantize);
