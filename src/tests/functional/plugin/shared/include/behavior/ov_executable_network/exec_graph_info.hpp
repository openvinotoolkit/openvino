...
class OVExecGraphUniqueNodeNamesTest : public testing::WithParamInterface<OVExecGraphUniqueNodeNamesTestParams>,
                                       public OVCompiledNetworkTestBase {
public:
    static std::string getTestCaseName(testing::TestParamInfo<OVExecGraphUniqueNodeNamesTestParams> obj) {
