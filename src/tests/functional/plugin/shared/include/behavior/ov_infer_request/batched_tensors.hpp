...
class OVInferRequestBatchedTests : public testing::WithParamInterface<std::string>, public OVInferRequestTestBase {
public:
...
protected:
    ...
    static std::shared_ptr<Model> create_n_inputs(size_t num,
                                                  element::Type type,
