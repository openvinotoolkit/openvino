...
typedef std::tuple<ov::element::Type, std::string, GatherTransformationTestValues, int> GatherTransformationParams;

class GatherTransformation : public testing::WithParamInterface<GatherTransformationParams>,
