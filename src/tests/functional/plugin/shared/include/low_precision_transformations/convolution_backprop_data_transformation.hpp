...
public:
    ...
    ConvolutionBackpropDataTransformationParam(
        ...
        : fakeQuantizeOnData(fakeQuantizeOnData),
          ...
          expectedKernelType(std::move(expectedKernelType)) {}
    ConvolutionBackpropDataTransformationParam(const ov::builder::subgraph::FakeQuantizeOnData& fakeQuantizeOnData,
                                               ov::builder::subgraph::DequantizationOperations dequantizationOnWeights,
                                               std::string layerName,
                                               std::string expectedKernelType)
        : fakeQuantizeOnData(fakeQuantizeOnData),
          dequantizationOnWeights(std::move(dequantizationOnWeights)),
          layerName(std::move(layerName)),
          expectedKernelType(std::move(expectedKernelType)) {}
};
