...
using GRUCellParams = typename std::tuple<
        ...
        ov::helpers::InputLayerType,   // W input type (Constant or Parameter)
        ov::helpers::InputLayerType,   // R input type (Constant or Parameter)
        ov::helpers::InputLayerType,   // B input type (Constant or Parameter)
