...
namespace ov {
namespace test {
using groupConvBackpropSpecificParams = std::tuple<std::vector<size_t>,      // kernels
...
using groupConvBackpropLayerTestParamsSet = std::tuple<groupConvBackpropSpecificParams,
