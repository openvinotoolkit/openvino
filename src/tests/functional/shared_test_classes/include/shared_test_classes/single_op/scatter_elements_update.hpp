...
namespace ov {
namespace test {
using axisShapeInShape = std::tuple<std::vector<InputShape>,  // Input, update/indices shapes
                                    int                       // Axis
                                    >;
using scatterElementsUpdateParamsTuple = typename std::tuple<axisShapeInShape,       // Shape description
...
using scatterElementsUpdate12ParamsTuple =
    typename std::tuple<axisShapeInShape,                               // Shape description
