...
namespace ov {
namespace test {
using GRUCellParams = typename std::tuple<bool,                             // using decompose to sub-ops transformation
                                          size_t,                           // batch
                                          size_t,                           // hidden size
                                          size_t,                           // input size
...
class GRUCellTest : public testing::WithParamInterface<GRUCellParams>, virtual public ov::test::SubgraphBaseTest {
public:
