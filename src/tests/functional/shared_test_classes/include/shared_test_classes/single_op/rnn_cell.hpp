...
using RNNCellParams = typename std::tuple<bool,                             // Use decompose to sub-ops transformation
                                          size_t,                           // Batch
                                          size_t,                           // Hidden size
                                          size_t,                           // Input size
...
class RNNCellTest : public testing::WithParamInterface<RNNCellParams>, virtual public ov::test::SubgraphBaseStaticTest {
public:
