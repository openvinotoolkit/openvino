...
class Mvn1LayerTest : public testing::WithParamInterface<mvn1Params>, virtual public ov::test::SubgraphBaseTest {
public:
...
class Mvn6LayerTest : public testing::WithParamInterface<mvn6Params>, virtual public ov::test::SubgraphBaseTest {
public:
