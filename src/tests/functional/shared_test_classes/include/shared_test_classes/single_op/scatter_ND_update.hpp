...
namespace ov {
namespace test {
using scatterNDUpdateSpecParams = std::tuple<std::vector<InputShape>,  // input, update shapes
                                             ov::Shape,                // indices shape
                                             std::vector<size_t>       // indices value
                                             >;

using scatterNDUpdateParamsTuple = typename std::tuple<scatterNDUpdateSpecParams,
