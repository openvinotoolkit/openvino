...
using LoopParams = typename std::tuple<bool,                       // ExecuteFirstIteration
                                       bool,                       // BodyCondition is a constant?
                                       bool,                       // BodyCondition value, if it is a Const
                                       int64_t,                    // TripCount, -1 means infinity
                                       std::vector<InputShape>,    // input shapes
                                       std::vector<LOOP_IN_TYPE>,  // input types. Vector size have to be equal to input
                                                                   // shapes vector size
                                       ov::element::Type,          // Model type
                                       std::string>;               // Device name

class LoopLayerTest : public testing::WithParamInterface<LoopParams>, virtual public ov::test::SubgraphBaseTest {
public:
...
using StaticShapeLoopParams = typename std::
    tuple<bool, bool, std::tuple<bool, int64_t, int64_t, int64_t>, int64_t, ov::Shape, ov::element::Type, std::string>;
