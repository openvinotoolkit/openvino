...
void MemoryEltwiseReshapeConcatTest::initTestModel() {
    ...
    auto reshape_1_pattern = std::make_shared<ov::op::v0::Constant>(ngraph::element::i64, ngraph::Shape{2}, std::vector<size_t>({inputSize, concatSize}));
    ...
    auto final_reshape_pattern = std::make_shared<ov::op::v0::Constant>(ngraph::element::i64, ngraph::Shape{4},
...
void MemoryEltwiseReshapeConcatTest::initNgraphFriendlyModel() {
    ...
    auto reshape = std::make_shared<ov::op::v1::Reshape>(mul, reshape_pattern, false);
    reshape->set_friendly_name("reshape");

    auto squeeze_const = std::make_shared<ov::op::v0::Constant>(ngraph::element::i64, ngraph::Shape{1}, 0);
