...
namespace SubgraphTestsDefinitions {
    ...
    void MultioutputEltwiseReshapeEltwise::SetUp() {
        ...
        auto eltwise_const = ov::test::utils::make_constant(ngPrc,
        ...
        auto eltwise_const2 = ov::test::utils::make_constant(ngPrc, ngraph::Shape{1}, std::vector<float>{1.01f});
        auto eltwise_const3 = ov::test::utils::make_constant(ngPrc, ngraph::Shape{1}, std::vector<float>{1.01f});
