...
namespace SubgraphTestsDefinitions {
    ...
    void DelayedCopyAfterReshapeWithMultipleConnTest::SetUp() {
        ...
        auto mem_c = ov::test::utils::make_constant(ngPrc, ngraph::Shape{8, memory_size / 8}, memory_init);
        auto mem_r = std::make_shared<ov::op::v3::ReadValue>(mem_c, "id");
        auto reshape_pattern1 = ov::test::utils::make_constant(ngraph::element::i64, ngraph::Shape{2}, ngraph::Shape{1, memory_size});
        ...
        auto reshape_pattern2 = ov::test::utils::make_constant(ngraph::element::i64, ngraph::Shape{2}, ngraph::Shape{8, memory_size / 8});
        ...
        auto reshape_pattern3 = ov::test::utils::make_constant(ngraph::element::i64, ngraph::Shape{2}, ngraph::Shape{1, memory_size});
    ...
    void DelayedCopyAfterReshapeWithMultipleConnTest::switchToNgraphFriendlyModel() {
        ...
        auto mem_c = ov::test::utils::make_constant(ngPrc, ngraph::Shape{1, memory_size}, memory_init);
        auto reshape_pattern1 = ov::test::utils::make_constant(ngraph::element::i64, ngraph::Shape{2}, ngraph::Shape{1, memory_size});
