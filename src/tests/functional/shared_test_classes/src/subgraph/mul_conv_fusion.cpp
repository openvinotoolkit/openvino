...
void MulConvFusion::SetUp() {
    ...
    auto mul_const = ov::test::utils::make_constant<float>(precision, const_shape, {}, true);
    ...
    auto weights = ov::test::utils::make_constant<float>(precision, weights_shape, {}, true);
