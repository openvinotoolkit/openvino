...
namespace SubgraphTestsDefinitions {
    ...
    void SplitTrivialPermuteConcatTest::SetUp() {
        ...
        auto permute_in_params = std::make_shared<ov::op::v0::Constant>(ngraph::element::i64,
                                                                            ngraph::Shape{ 4 },
                                                                            ngraph::Shape{ {0, 3, 2, 1} });
        auto permute_0 = std::make_shared<ov::op::v1::Transpose>(split->output(0), permute_in_params);
