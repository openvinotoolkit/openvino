...
void MultipleLSTMCellTest::SetUp() {
    ...
    auto cell_memory_2_constant =
        ov::test::utils::make_constant<float>(element_type, cell_memory_dims, cell_memory_init);
    ...
    auto weightsNode_2 =
        ov::test::utils::make_constant<float>(element_type, {4 * hiddenSize, hiddenSize}, weights_2_vals);
    auto reccurrenceWeightsNode_2 =
        ov::test::utils::make_constant<float>(element_type, {4 * hiddenSize, hiddenSize}, reccurrenceWeights_vals);
    auto biasNode_2 = ov::test::utils::make_constant<float>(element_type, {4 * hiddenSize}, bias_vals);
