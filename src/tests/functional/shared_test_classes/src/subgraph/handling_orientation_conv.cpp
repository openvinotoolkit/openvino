...
namespace SubgraphTestsDefinitions {
    ...
    void HandlingOrientationClass::SetUp() {
        ...
        auto pattern1 = std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 4 }, outFormShapes1);
        auto reshape1 = std::make_shared<ov::op::v1::Reshape>(params[0], pattern1, false);

        auto pattern2 = std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 4 }, outFormShapes2);
        auto reshape2 = std::make_shared<ov::op::v1::Reshape>(params[1], pattern2, false);
        ...
        auto pattern4 = std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 2 }, outFormShapes4);
        auto reshape3 = std::make_shared<ov::op::v1::Reshape>(permute2, pattern3, false);
        auto reshape4 = std::make_shared<ov::op::v1::Reshape>(conv2, pattern4, false);
        ngraph::ResultVector results{ std::make_shared<ov::op::v0::Result>(reshape3),
                                      std::make_shared<ov::op::v0::Result>(reshape4)};
