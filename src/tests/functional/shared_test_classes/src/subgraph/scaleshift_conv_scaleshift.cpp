...
void ScaleShiftAfterConvTest::SetUp() {
    ...
    auto reshapePattern2 = std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 4 }, outFormShapes);
    ...
    auto reshapePattern3 = std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 2 }, outFormShapes);
    auto reshape3 = std::make_shared<ov::op::v1::Reshape>(add, reshapePattern3, false);
...
void ScaleShiftBeforeConvTest::SetUp() {
    ...
    auto mul_const = std::make_shared<ov::op::v0::Constant>(ngPrc, convInputShape, scale);
    auto mul = std::make_shared<ov::op::v1::Multiply>(reshape1, mul_const);
    auto add_const = std::make_shared<ov::op::v0::Constant>(ngPrc, convInputShape, shift);
    auto add = std::make_shared<ov::op::v1::Add>(mul, add_const);

    convInputShape = {1, inputChannels, 1, inputShape[1] / inputChannels};
    auto reshapePattern2 = std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 4 }, convInputShape);
    auto reshape2 = std::make_shared<ov::op::v1::Reshape>(mul, reshapePattern2, false);
    ...
    auto reshapePattern3 = std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 2 }, outFormShapes);
    auto reshape3 = std::make_shared<ov::op::v1::Reshape>(conv, reshapePattern3, false);
