...
void ConvStridesOpt::SetUp() {
    ...
    auto weights1 = ov::test::utils::builder::makeConstant<float>(element::f32, {C, C, 3, 3}, {}, true);
    ...
    auto conv1 = std::make_shared<opset4::Convolution>(param, weights1, strides1, pad_begin1, pad_end1,
            dilations, pad_type);
    auto weights2 = ov::test::utils::builder::makeConstant<float>(element::f32, {C, C, 1, 1}, {}, true);
