...
void MatmulSqueezeAddTest::SetUp() {
    ...
    auto constant_0 = ov::builder::makeConstant<float>(ngPrc, { outputSize, inputShape[1] },
    ...
    auto constant_2 = ov::builder::makeConstant<float>(ngPrc, { 1, inputShape[0], outputSize },
