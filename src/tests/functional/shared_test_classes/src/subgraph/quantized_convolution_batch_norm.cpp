...
void QuantizedConvolutionBatchNorm::SetUp() {
    ...
    std::shared_ptr<Node> weights = ov::test::utils::make_constant(element::f32, weights_shape, {}, true, 0.5f, -0.5f);
    ...
    auto gamma = ov::test::utils::make_constant(element::f32, Shape{output_channels}, {}, true, 1.0f, 0.1f);
    auto beta = ov::test::utils::make_constant(element::f32, Shape{output_channels}, {}, true, 1.0f, 0.1f);
    auto mean = ov::test::utils::make_constant(element::f32, Shape{output_channels}, {}, true, 1.0f, 0.1f);
    auto var = ov::test::utils::make_constant(element::f32, Shape{output_channels}, {}, true, 1.0f, 0.1f);
