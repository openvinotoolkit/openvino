...
void ConvolutionBackpropLayerTest::SetUp() {
    ...
    auto convBackpropData = std::dynamic_pointer_cast<ngraph::opset1::ConvolutionBackpropData>(
            ov::builder::makeConvolutionBackpropData(paramOuts[0], ngPrc, kernel, stride, padBegin,
    ...
    if (!outputShape.empty()) {
        ...
        ov::builder::makeConvolutionBackpropData(paramOuts[0], outShape, ngPrc, kernel, stride, padBegin,
