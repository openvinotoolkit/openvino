...
void LowPrecisionTest::SetUp() {
    ...
    auto weights1 = ov::test::utils::make_constant<float>(ngPrc, weights1Shape, weights1Data);
    ...
    auto bias1 = ov::test::utils::make_constant<float>(ngPrc, inputShape, bias1Data);
    ...
    auto weights2 = ov::test::utils::make_constant<float>(ngPrc, weights2Shape, weights2Data);
    ...
    auto bias2 = ov::test::utils::make_constant<float>(ngPrc, weights2Shape, bias2Data);
    ...
    function = std::make_shared<ngraph::Function>(ngraph::ResultVector{std::make_shared<ov::op::v0::Result>(add1)},
