...
void LowPrecisionTest::SetUp() {
    ...
    auto weights1 = ov::builder::makeConstant<float>(ngPrc, weights1Shape, weights1Data);
    ...
    auto bias1 = ov::builder::makeConstant<float>(ngPrc, inputShape, bias1Data);
    ...
    auto weights2 = ov::builder::makeConstant<float>(ngPrc, weights2Shape, weights2Data);
    ...
    auto bias2 = ov::builder::makeConstant<float>(ngPrc, weights2Shape, bias2Data);
