...
void GroupConvBackpropDataLayerTest::SetUp() {
    ...
    auto groupConvBackpropData = std::dynamic_pointer_cast<ngraph::opset1::GroupConvolutionBackpropData>(
            ov::builder::makeGroupConvolutionBackpropData(paramOuts[0], ngPrc, kernel, stride, padBegin,
...
void GroupConvBackpropLayerTest::SetUp() {
    ...
    if (!outputShape.empty()) {
        ...
        ov::builder::makeGroupConvolutionBackpropData(paramOuts[0], outShape, ngPrc, kernel, stride, padBegin,
