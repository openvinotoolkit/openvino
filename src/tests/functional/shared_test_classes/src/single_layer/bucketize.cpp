...
namespace LayerTestsDefinitions {
    ...
    void BucketizeLayerTest::SetUp() {
        ...
        auto buckets = std::make_shared<ov::op::v0::Parameter>(ngInBucketsPrc, ov::Shape(bucketsShape));
        ...
        function = std::make_shared<ov::Model>(std::make_shared<ov::op::v0::Result>(bucketize), ov::ParameterVector{data, buckets}, "Bucketize");
    }
} // namespace LayerTestsDefinitions
