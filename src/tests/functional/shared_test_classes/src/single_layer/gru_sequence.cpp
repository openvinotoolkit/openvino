...
namespace LayerTestsDefinitions {
    ...
    void GRUSequenceTest::SetUp() {
        ...
        if (m_mode == SequenceTestsMode::CONVERT_TO_TI_MAX_SEQ_LEN_PARAM ||
            ...
            auto param = ov::test::utils::builder::makeParams(ov::element::i64, {inputShapes[2]}).at(0);
            ...
            seq_lengths_node = ov::test::utils::builder::makeConstant<int64_t>(ov::element::i64, inputShapes[2], {}, true,
