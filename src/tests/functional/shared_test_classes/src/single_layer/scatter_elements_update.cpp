...
void ScatterElementsUpdateLayerTest::SetUp() {
    ...
    auto paramVectorOuts = ov::helpers::convert2OutputVector(ov::helpers::castOps2Nodes<ngraph::op::Parameter>(paramVector));
    auto s2d = ov::builder::makeScatterElementsUpdate(paramVectorOuts[0], idxPrc, indicesShape, indicesValue, paramVectorOuts[1], axis);
