...
Refer to [OpenVINO Plugin Developer Guide](https://docs.openvino.ai/2026/documentation/openvino-extensibility/openvino-plugin-library.html) for detailed information on how to implement a new plugin.
