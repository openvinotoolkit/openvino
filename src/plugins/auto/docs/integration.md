...
Refer to [OpenVINO Plugin Developer Guide](https://docs.openvino.ai/2023.3/openvino_docs_ie_plugin_dg_overview.html) for detailed information on how to implement a new plugin.
