...
//               DeviceParams {ov::test::utils::DEVICE_KEEMBAY, true},
...
//
const std::vector<ConfigParams> testConfigs = {ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, true},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, true},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 1, 2, 2},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, true},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 2, 3, 2},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, true},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 1, 2, 2},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, true},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, true},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, false}}, 1, 2, 1},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, true},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, false}}, 1, 2, 1},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, true},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, false}}, 2, 3, 1},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 3, 4, 2},
                                               ConfigParams {false, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, false}}, 3, 4, 0},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, true},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 1, 2, 2},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 2, 3, 2},
                                               ConfigParams {true, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, true},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, false}}, 1, 2, 1},
                                               ConfigParams {false, false, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, false}}, 2, 3, 0},
                                               ...
                                               ConfigParams {true, true, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, true},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 2, 2, 1},
                                               ConfigParams {false, true, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, true},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, false}}, 2, 2, 0},
                                               ConfigParams {true, true, GENERAL, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 2, 2, 1},
                                               ConfigParams {true, false, LATENCY, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 3, 3, 1},
                                               ConfigParams {true, false, LATENCY, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 2, 2, 1},
                                               ConfigParams {true, false, THROUGHPUT, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_KEEMBAY, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 3, 4, 2},
                                               ConfigParams {true, false, THROUGHPUT, {DeviceParams {ov::test::utils::DEVICE_GPU, false},
                                                        DeviceParams {ov::test::utils::DEVICE_CPU, true}}, 2, 3, 2}
