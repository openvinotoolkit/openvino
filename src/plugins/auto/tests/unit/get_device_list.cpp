...
const std::vector<Params> testConfigsWithId = {Params{"", "CPU,GPU.0,GPU.1"},
                                         Params{"CPU, ", "CPU"},
                                         Params{" ,CPU", "CPU"},
                                         Params{"CPU,", "CPU"},
                                         ...
                                         Params{"CPU,GPU,VPUX,INVALID_DEVICE", "CPU,GPU.0,GPU.1,VPUX"},
                                         Params{"-CPU,GPU,INVALID_DEVICE", "GPU.0,GPU.1"},
                                         Params{"-GPU,CPU,INVALID_DEVICE", "CPU"},
                                         ...
                                         Params{"-GPU.0,-GPU.1,INVALID_DEVICE", ""},
                                         Params{"GPU.0,-GPU.1,INVALID_DEVICE", "GPU.0"},
                                         Params{"-GPU.0,GPU.1,INVALID_DEVICE", "GPU.1"},
...
const std::vector<Params> testConfigs = { Params{"", "CPU,GPU"},
                                         Params{"GPU", "GPU"},
                                         Params{"GPU.0", "GPU.0"},
