...
const std::vector<modelPrioPerfHintTestParams> modelPrioPerfHintConfig = {
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", ov::hint::Priority::LOW},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "LATENCY", ov::hint::Priority::LOW},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", ov::hint::Priority::MEDIUM},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "LATENCY", ov::hint::Priority::MEDIUM},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", ov::hint::Priority::HIGH},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "LATENCY", ov::hint::Priority::HIGH},
    modelPrioPerfHintTestParams{true, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", ov::hint::Priority::LOW},
    modelPrioPerfHintTestParams{true, true, ov::test::utils::DEVICE_GPU, "LATENCY", ov::hint::Priority::LOW},
    modelPrioPerfHintTestParams{true, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", ov::hint::Priority::MEDIUM},
    modelPrioPerfHintTestParams{true, true, ov::test::utils::DEVICE_GPU, "LATENCY", ov::hint::Priority::MEDIUM},
    modelPrioPerfHintTestParams{true, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", ov::hint::Priority::HIGH},
