...
const std::vector<modelPrioPerfHintTestParams> modelPrioPerfHintConfig = {
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", "LOW"},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "LATENCY", "LOW"},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", "MEDIUM"},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "LATENCY", "MEDIUM"},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "THROUGHPUT", "HIGH"},
    modelPrioPerfHintTestParams{false, true, ov::test::utils::DEVICE_GPU, "LATENCY", "HIGH"},
