    ...
    std::shared_ptr<ov::Model> create_function(const TensorIteratorStaticParams& params) override {
        ...
        switch (params.body_type) {
            case TensorIteratorBodyType::LSTM: {
                ...
                auto outer_params = ov::test::utils::builder::make_params(params.iType, {inputShapes[0], inputShapes[1], inputShapes[2]});

                // 1. Create TensorIterator body.
                inputShapes[0][params.sequenceAxis] = 1; // sliced dimension
                auto body_params = ov::test::utils::builder::make_params(params.iType, {inputShapes[0], inputShapes[1], inputShapes[2]});
            ...
            case TensorIteratorBodyType::GRU: {
                ...
                auto outer_params = ov::test::utils::builder::make_params(params.iType, {inputShapes[0], inputShapes[1]});

                // 1. Create TensorIterator body.
                inputShapes[0][params.sequenceAxis] = 1; // sliced dimension
                auto body_params = ov::test::utils::builder::make_params(params.iType, {inputShapes[0], inputShapes[1]});
                auto squeeze = std::make_shared<ov::opset8::Squeeze>(body_params[0], axis);
