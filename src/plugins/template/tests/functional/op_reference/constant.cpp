...
std::vector<ConstantParams> generateConstantDefinedTypeParams() {
    std::vector<ConstantParams> constantParams{
        ...
        ConstantParams(
            ...
            element::Type_t::f8e4m3,
            std::vector<ov::f8e4m3>{4.75f, 4.5f,  -5.25f, 0.0f,  0.1f,  0.2f,  0.3f,  0.4f,         0.5f,
                                    0.6f,  0.7f,  0.8f,   0.9f,  1.f,   -0.0f, -0.1f, -0.2f,        -0.3f,
                                    -0.4f, -0.5f, -0.6f,  -0.7f, -0.8f, -0.9f, -1.f,  0.001953125f, 448.f},
            std::vector<ov::f8e4m3>{4.75f,    4.5f,        -5.25f,     0.0f,     0.1015625f,   0.203125f, 0.3125f,
        ...
        ConstantParams({3, 9},
                       ...
                       element::Type_t::f8e5m2,
                       std::vector<ov::f8e5m2>{4.75f,  4.5f,
                                               -5.25f, 0.0f,
                                               0.1f,   0.2f,
                                               0.3f,   0.4f,
                                               0.5f,   0.6f,
