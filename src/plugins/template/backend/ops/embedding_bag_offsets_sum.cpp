...
bool evaluate(const std::shared_ptr<ov::op::v3::EmbeddingBagOffsetsSum>& op,
    ...
    case ov::element::Type_t::i32:
        embedding_bag_offsets_sum_v3::evaluate<ET, ov::element::Type_t::i32>(op, outputs, inputs);
        break;
    case ov::element::Type_t::i64:
        embedding_bag_offsets_sum_v3::evaluate<ET, ov::element::Type_t::i64>(op, outputs, inputs);
        break;
    default:
        return false;
    }
