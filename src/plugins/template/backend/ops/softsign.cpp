...
bool evaluate(const std::shared_ptr<ngraph::op::v9::SoftSign>& op,
    ...
    case ngraph::element::Type_t::f64:
        ngraph::reference::softsign<double>(inputs[0]->get_data_ptr<double>(),
                                            outputs[0]->get_data_ptr<double>(),
                                            ngraph::shape_size(inputs[0]->get_shape()));
        break;
    case ngraph::element::Type_t::f32:
        ngraph::reference::softsign<float>(inputs[0]->get_data_ptr<float>(),
                                           outputs[0]->get_data_ptr<float>(),
                                           ngraph::shape_size(inputs[0]->get_shape()));
        break;
    case ngraph::element::Type_t::f16:
        ngraph::reference::softsign<ngraph::float16>(inputs[0]->get_data_ptr<ngraph::float16>(),
                                                     outputs[0]->get_data_ptr<ngraph::float16>(),
                                                     ngraph::shape_size(inputs[0]->get_shape()));
        break;
    case ngraph::element::Type_t::bf16:
        ngraph::reference::softsign<ngraph::bfloat16>(inputs[0]->get_data_ptr<ngraph::bfloat16>(),
