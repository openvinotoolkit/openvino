...
template <>
bool evaluate<ov::element::i2>(const std::shared_ptr<ov::op::v1::Subtract>& op,
                               ov::TensorVector& outputs,
                               const ov::TensorVector& inputs) {
    ...
    ov::reference::convert(ov::element::iterator<ov::element::i2>(inputs[0].data()),
    ...
    ov::reference::convert(ov::element::iterator<ov::element::i2>(inputs[1].data()),
    ...
    ov::reference::convert(ov::element::iterator<conversion_type>(converted_out.data()),
                           ov::element::iterator<ov::element::i2>(outputs[0].data()),
...
bool evaluate_node<ov::op::v1::Subtract>(std::shared_ptr<ov::Node> node,
    ...
    case ov::element::i2:
        return evaluate<ov::element::i2>(ov::as_type_ptr<ov::op::v1::Subtract>(node), outputs, inputs);
    case ov::element::u2:
