...
bool evaluate(const std::shared_ptr<ngraph::op::v6::ExperimentalDetectronDetectionOutput>& op,
    ...
    ngraph::reference::experimental_detectron_detection_output(boxes_data.data(),
    ...
    ngraph::reference::experimental_detectron_detection_output_postprocessing(outputs[0]->get_data_ptr(),
