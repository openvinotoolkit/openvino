...
bool evaluate(const std::shared_ptr<ov::op::v1::AvgPool>& op,
    ...
    ov::reference::avg_pool<T>(inputs[0].data<const T>(),
                               ...
                               op->get_kernel(),
                               op->get_strides(),
                               ov::Strides(op->get_kernel().size(), 1),
                               op->get_pads_begin(),
                               op->get_pads_end(),
                               !op->get_exclude_pad());
    return true;
...
template <ov::element::Type_t ET>
bool evaluate(const std::shared_ptr<ov::op::v16::AvgPool>& op,
              ov::TensorVector& outputs,
              const ov::TensorVector& inputs) {
    using T = typename ov::element_type_traits<ET>::value_type;
    ov::reference::avg_pool<T>(inputs[0].data<const T>(),
...
bool evaluate_node<ov::op::v16::AvgPool>(std::shared_ptr<ov::Node> node,
    ...
    switch (element_type) {
    case ov::element::bf16:
        return evaluate<ov::element::bf16>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::f16:
        return evaluate<ov::element::f16>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::f64:
        return evaluate<ov::element::f64>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::f32:
        return evaluate<ov::element::f32>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::i8:
        return evaluate<ov::element::i8>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::i16:
        return evaluate<ov::element::i16>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::i32:
        return evaluate<ov::element::i32>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::i64:
        return evaluate<ov::element::i64>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::u8:
        return evaluate<ov::element::u8>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::u16:
        return evaluate<ov::element::u16>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::u32:
        return evaluate<ov::element::u32>(ov::as_type_ptr<ov::op::v16::AvgPool>(node), outputs, inputs);
    case ov::element::u64:
