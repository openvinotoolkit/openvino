...
bool evaluate_node<ov::op::v14::AvgPool>(std::shared_ptr<ov::Node> node,
    ...
    switch (element_type) {
    case ov::element::boolean:
        return evaluate<ov::element::boolean>(ov::as_type_ptr<ov::op::v14::AvgPool>(node), outputs, inputs);
    case ov::element::bf16:
    ...
    case ov::element::i4:
        return evaluate<ov::element::i4>(ov::as_type_ptr<ov::op::v14::AvgPool>(node), outputs, inputs);
    case ov::element::i8:
    ...
    case ov::element::u1:
        return evaluate<ov::element::u1>(ov::as_type_ptr<ov::op::v14::AvgPool>(node), outputs, inputs);
    case ov::element::u4:
        return evaluate<ov::element::u4>(ov::as_type_ptr<ov::op::v14::AvgPool>(node), outputs, inputs);
    case ov::element::u8:
