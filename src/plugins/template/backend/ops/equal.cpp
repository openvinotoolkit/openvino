...
bool evaluate(const std::shared_ptr<ov::op::v1::Equal>& op,
    ...
    ngraph::runtime::reference::equal<typename ov::element_type_traits<ET>::value_type,
                                      typename ov::element_type_traits<ov::element::Type_t::boolean>::value_type>(
        in0_data_ptr,
        in1_data_ptr,
        out_data_ptr,
        in0_shape,
