...
bool evaluate(const std::shared_ptr<ngraph::op::v6::ExperimentalDetectronGenerateProposalsSingleImage>& op,
    ...
    ngraph::reference::experimental_detectron_proposals_single_image(im_info_data.data(),
                                                                     anchors_data.data(),
                                                                     deltas_data.data(),
                                                                     scores_data.data(),
                                                                     attrs,
                                                                     ...
                                                                     output_rois.data(),
                                                                     output_scores.data());
    ngraph::reference::experimental_detectron_proposals_single_image_postprocessing(outputs[0]->get_data_ptr(),
