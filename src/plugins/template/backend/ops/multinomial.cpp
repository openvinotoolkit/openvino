...
inline void evaluate_samples_t(const std::shared_ptr<ov::op::v13::Multinomial>& op,
    ...
    default:
        OPENVINO_THROW(std::string("Unhandled convert data type ") +
                       ov::element::Type(op->get_convert_type()).get_type_name() + std::string("in evaluate_node(). Use either i32 or i64 and apply conversion manually."));
    }
}
...
bool evaluate_node<ov::op::v13::Multinomial>(std::shared_ptr<ov::Node> node,
    ...
    case ov::element::Type_t::f16:
        return evaluate_input_t<ov::element::Type_t::f16>(ov::as_type_ptr<ov::op::v13::Multinomial>(node), outputs, inputs);
    case ov::element::Type_t::f32:
        return evaluate_input_t<ov::element::Type_t::f32>(ov::as_type_ptr<ov::op::v13::Multinomial>(node), outputs, inputs);
    case ov::element::Type_t::f64:
        return evaluate_input_t<ov::element::Type_t::f64>(ov::as_type_ptr<ov::op::v13::Multinomial>(node), outputs, inputs);
