...
bool evaluate(const std::shared_ptr<ov::op::v8::Gather>& op, const ov::HostTensorVector& outputs, const ov::HostTensorVector& inputs) {
...
bool evaluate(const std::shared_ptr<ov::op::v10::Unique>& op, const ov::HostTensorVector& outputs, const ov::HostTensorVector& inputs) {
