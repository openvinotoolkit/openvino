...
bool evaluate(const std::shared_ptr<ngraph::op::v10::IsInf>& op,
    ...
    case ngraph::element::Type_t::f64:
        ngraph::reference::is_inf(inputs[0]->get_data_ptr<double>(),
                                  outputs[0]->get_data_ptr<ngraph::element::Type_t::boolean>(),
                                  ngraph::shape_size(inputs[0]->get_shape()),
                                  op->get_attributes());
        break;
    case ngraph::element::Type_t::f32:
        ngraph::reference::is_inf(inputs[0]->get_data_ptr<float>(),
                                  outputs[0]->get_data_ptr<ngraph::element::Type_t::boolean>(),
                                  ngraph::shape_size(inputs[0]->get_shape()),
                                  op->get_attributes());
        break;
    case ngraph::element::Type_t::f16:
        ngraph::reference::is_inf(inputs[0]->get_data_ptr<ngraph::float16>(),
                                  outputs[0]->get_data_ptr<ngraph::element::Type_t::boolean>(),
                                  ngraph::shape_size(inputs[0]->get_shape()),
                                  op->get_attributes());
        break;
    case ngraph::element::Type_t::bf16:
        ngraph::reference::is_inf(inputs[0]->get_data_ptr<ngraph::bfloat16>(),
                                  outputs[0]->get_data_ptr<ngraph::element::Type_t::boolean>(),
                                  ngraph::shape_size(inputs[0]->get_shape()),
                                  op->get_attributes());
        break;
