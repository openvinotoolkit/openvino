...
inline void evaluate(const std::shared_ptr<ov::op::v3::EmbeddingSegmentsSum>& op,
...
bool evaluate(const std::shared_ptr<ov::op::v3::EmbeddingSegmentsSum>& op,
              const ov::HostTensorVector& outputs,
              const ov::HostTensorVector& inputs) {
    switch (inputs[1]->get_element_type()) {
    case ov::element::Type_t::i32:
        embedding_offsets_sum_v3::evaluate<ET, ov::element::Type_t::i32>(op, outputs, inputs);
        break;
    case ov::element::Type_t::i64:
        embedding_offsets_sum_v3::evaluate<ET, ov::element::Type_t::i64>(op, outputs, inputs);
        break;
    default:
        return false;
    }
