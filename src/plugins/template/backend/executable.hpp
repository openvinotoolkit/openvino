...
public:
    ...
    /// \returns A Tensor
    virtual ov::Tensor create_input_tensor(size_t input_index, void* memory_pointer);
    ...
    ///     responsibility of the caller and must outlive the created Tensor.
    /// \returns A Tensor
    virtual ov::Tensor create_output_tensor(size_t output_index, void* memory_pointer);
    ...
    ///     responsibility of the caller and must outlive the created Tensor.
    /// \returns A vector of Tensors, one for each stage of the pipeline
    virtual std::vector<ov::Tensor> create_input_tensor(size_t input_index,
    ...
    ///     responsibility of the caller and must outlive the created Tensor.
    /// \returns A vector of Tensors, one for each stage of the pipeline
    virtual std::vector<ov::Tensor> create_output_tensor(size_t output_index,
                                                         size_t pipeline_depth,
                                                         std::vector<void*> memory_pointers);
