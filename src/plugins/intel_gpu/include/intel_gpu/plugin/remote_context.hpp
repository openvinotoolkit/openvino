...
private:
    ...
    std::shared_ptr<ov::IRemoteTensor> reuse_memory_from_cpu_va(const ov::element::Type type, const ov::Shape& shape, VirtualAdressMemory cpu_va, TensorType tensor_type);
