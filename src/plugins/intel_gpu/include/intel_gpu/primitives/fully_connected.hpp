...
struct fully_connected : public primitive_base<fully_connected> {
    ...
    /// @param activation_partial_sum Primitive id containing partial sum for activation.
    fully_connected(const primitive_id& id,
                    const input_info& input,
                    const primitive_id& weights,
                    const primitive_id& bias,
                    ...
                    const input_info& activation_partial_sum,
                    const data_types data_type,
                    const size_t input_size = 2,
                    const size_t weights_rank = 2)
        : primitive_base(id, { input }, 1, {optional_data_type{data_type}}),
          ...
          activation_partial_sum(activation_partial_sum),
          input_size(input_size),
          weights_rank(weights_rank) {
        ...
        if (activation_partial_sum.is_valid())
            dynamic_quantized_partial_sum = true;
    ...
    bool dynamic_quantized_partial_sum = false;
    input_info activation_scale = {"", 0};
    input_info activation_zero_point = {"", 0};
    input_info activation_partial_sum = {"", 0};
    ...
    size_t hash() const override {
        ...
        seed = hash_combine(seed, activation_partial_sum.is_valid());
    ...
    bool operator==(const primitive& rhs) const override {
        ...
        return input_size == rhs_casted.input_size &&
               ...
               activation_partial_sum.is_valid() == rhs_casted.activation_partial_sum.is_valid() &&
...
protected:
    std::map<size_t, const input_info*> get_dependencies_map() const override {
        ...
        if (activation_partial_sum.is_valid())
            ret[idx++] = &activation_partial_sum;
