...
/// @brief Gathered GEMM for MoE expert execution: per-token weight gather + matmul.
/// A=[n_activated_experts, batch*seq, K], B=[n_all_experts, N, K], out=[n_activated_experts, batch*seq, N].
