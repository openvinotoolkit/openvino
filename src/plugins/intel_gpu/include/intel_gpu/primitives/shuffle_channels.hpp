...
struct shuffle_channels : public primitive_base<shuffle_channels> {
    ...
    /// @brief The number of groups to split the channel dimension. This number must evenly divide the channel dimension
    /// size.
    int32_t group;
    ...
    bool operator==(const primitive& rhs) const override {
        ...
        return group == rhs_casted.group && axis == rhs_casted.axis;
    }
