...
public:
    ...
    void helperAllgathervf16(const void* sendBuf, size_t count, void* recvBuf, const std::vector<long unsigned int> &recvCounts) {
        ccl::allgatherv(sendBuf, count, recvBuf, recvCounts, ccl::datatype::float16, *pcomm).wait();
    }
