...
public:
    ...
    virtual bool check_allocatable(const layout& layout, allocation_type type) final;
    ...
    virtual stream& get_service_stream() const final;
    ...
    virtual dnnl::engine& get_onednn_engine() const final;
#endif
