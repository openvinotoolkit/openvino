...
public:
    ...
    std::vector<std::string> fc_dynamic_quantize_layers;        // Specify Fully-connected layers which enable Dynamic quantization
    ...
    bool is_matched_layer(const std::string& layer_name, const std::string& pattern) const;
