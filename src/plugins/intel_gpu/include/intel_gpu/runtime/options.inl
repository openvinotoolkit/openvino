...
OV_CONFIG_RELEASE_OPTION(ov::hint, dynamic_quantization_group_size_unsupported, 0, "Unsupported dynamic quantization group size. When group_size is set as a higher value than this number, dynamic quantization will be turned off")
