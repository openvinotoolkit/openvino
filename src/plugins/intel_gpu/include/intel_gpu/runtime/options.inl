...
OV_CONFIG_RELEASE_INTERNAL_OPTION(ov::intel_gpu, enable_dynamic_batch_mode, false, "Enable/Disable onednn dynamic batch mode for scalable performance in CNN models batch size")
