...
OV_CONFIG_RELEASE_OPTION(ov::intel_gpu, moe_offload_ratio, 0, "Percentage (0-100) of MoE experts to offload to disk (0=all resident, 100=invalid)", [](size_t v) { return v <= 100; })
