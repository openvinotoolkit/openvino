...
OV_CONFIG_RELEASE_INTERNAL_OPTION(ov::intel_gpu, dynamic_quantization_threshold, 64, "Apply dynamic quantization only when batch size is larger than this value, when an equivalent FC fast path is available. 0 disables runtime threshold-based skipping")
