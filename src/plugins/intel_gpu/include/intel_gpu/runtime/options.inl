...
OV_CONFIG_RELEASE_OPTION(ov::intel_gpu, offload_ratio, 0, "Percentage (0-100) of model weights to offload to disk, or AUTO/OFFLOAD_RATIO_AUTO (-1) for automatic selection. Currently supported for MoE experts only.", [](int64_t v) { return (v >= 0 && v <= 100) || v == -1; })
