...
OV_CONFIG_DEBUG_OPTION(ov::intel_gpu, print_list_layers, false, "Print list layers")
OV_CONFIG_DEBUG_OPTION(ov::intel_gpu, print_input_data_shapes, false, "print input data shape")
