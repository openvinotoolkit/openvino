...
OV_CONFIG_RELEASE_OPTION(ov::hint, attn_kernel_mode, ov::hint::AttnMode::AUTO, "High-level hint that defines target attention kernel backend. Supported values: AUTO, PA_CM")
