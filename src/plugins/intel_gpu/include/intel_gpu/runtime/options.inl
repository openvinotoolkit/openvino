...
OV_CONFIG_RELEASE_OPTION(ov::intel_gpu, offload_ratio, 0, "Percentage (0-100) of model weights to offload to disk, or OFFLOAD_RATIO_AUTO (size_t(-1)) for automatic selection. Currently supported for MoE experts only.", [](size_t v) { return v <= 100 || v == static_cast<size_t>(-1); })
