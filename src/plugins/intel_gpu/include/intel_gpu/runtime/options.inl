...
OV_CONFIG_RELEASE_OPTION(ov::hint, dynamic_quantization_data_type, ov::hint::DynamicQuantizationDataType::INT8, "Determines output dtypes of dynamic quantization")
