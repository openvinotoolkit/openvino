...
std::vector<layout> lstm_elt_inst::calc_output_layouts(lstm_elt_node const& node,
    ...
    return {cldnn::layout{ov::PartialShape{lstm_batch_size, 2, 1, lstm_hidden_size},
                          input_layout.data_type,
                          input_layout.format}};
}

template std::vector<layout> lstm_elt_inst::calc_output_layouts<ov::PartialShape>(lstm_elt_node const& node,
