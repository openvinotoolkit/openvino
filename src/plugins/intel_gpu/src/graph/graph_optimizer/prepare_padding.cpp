...
void prepare_padding::run(program& p) {
    ...
    for (auto& pair : p.nodes_map) {
        ...
        auto padding_end_x = std::max<tensor::value_type>(static_cast<tensor::value_type>(input_limit_x) - prev_prim_output_layout.spatial(0), 0);
        auto padding_end_y = std::max<tensor::value_type>(static_cast<tensor::value_type>(input_limit_y) - prev_prim_output_layout.spatial(1), 0);
        auto padding_end_z = std::max<tensor::value_type>(static_cast<tensor::value_type>(input_limit_z) - prev_prim_output_layout.spatial(2), 0);
