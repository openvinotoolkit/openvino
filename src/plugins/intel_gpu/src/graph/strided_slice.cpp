...
std::string strided_slice_inst::to_string(strided_slice_node const& node) {
    ...
    strided_slice_info.add("begin_param shape", node.get_dependency(1).first->get_output_layout().size.to_string());
    strided_slice_info.add("end_param shape", node.get_dependency(2).first->get_output_layout().size.to_string());
    strided_slice_info.add("stride_param shape", node.get_dependency(3).first->get_output_layout().size.to_string());
