...
public:
    ...
    program_node& cell() const {
        return get_dependency(1);
    }
    bool cell_term() const {
        return !get_primitive()->cell.empty();
    }
    lstm_weights_order offset_order() const {
        return get_primitive()->offset_order;
    }
    float clip() const {
    ...
    bool input_forget() const {
        return get_primitive()->input_forget;
    }
    int32_t direction() const {
        return get_primitive()->direction;
    }
};
...
public:
    ...
    memory::ptr cell_memory() const {
        return dep_memory_ptr(1);
    }
    bool cell_term() const {
        return !get_typed_desc<lstm_elt>()->cell.empty();
    }
    lstm_weights_order offset_order() const {
        return get_typed_desc<lstm_elt>()->offset_order;
    }
    float clip() const {
    ...
    bool input_forget() const {
        return get_typed_desc<lstm_elt>()->input_forget;
    }
    uint32_t direction() const {
        return get_typed_desc<lstm_elt>()->direction;
    }
};
