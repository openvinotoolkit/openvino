...
public:
    static layout calc_output_layout(deformable_conv_node const& node, int32_t idx);
...
public:
    static layout calc_output_layout(deformable_interp_node const& node, int32_t idx);
