...
struct onednn_add_fusing_helpers {
    ...
    static void for_eltwise(const program_node& conv_node,
                            eltwise_mode mode,
...
static inline std::ostream& operator<<(std::ostream& os, add_fusing_type& t) {
    switch (t) {
    case add_fusing_type::sum:
        os << "sum";
        break;
    case add_fusing_type::binary_per_tensor:
        os << "binary_per_tensor";
        break;
    case add_fusing_type::binary_per_oc:
        os << "binary_per_oc";
        break;
    default:
        os << "not_supported";
...
struct pattern_match_optimization {
    pattern_match_optimization(program& prog) : prog(prog) {}
