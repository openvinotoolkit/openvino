...
struct typed_program_node<prior_box> : typed_program_node_base<prior_box> {
    ...
    bool is_clustered() const {
        return get_primitive()->is_clustered();
    }
    void calc_result();
    memory::ptr get_result_buffer() const {
        return result;
    }
...
public:
    ...
    static std::vector<layout> calc_output_layouts(prior_box_node const& /*node*/,
