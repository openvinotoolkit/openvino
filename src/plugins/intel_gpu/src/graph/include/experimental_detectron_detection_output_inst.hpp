...
public:
    ...
    program_node& deltas() const { return get_dependency(1); }
    program_node& scores() const { return get_dependency(2); }
    program_node& image_size_info() const { return get_dependency(3); }

    program_node& output_classes_node() const { return get_dependency(4); }
    program_node& output_scores_node() const { return get_dependency(5); }
};
...
public:
    ...
    memory::ptr output_classes_memory() const { return dep_memory_ptr(4); }
    memory::ptr output_scores_memory() const { return dep_memory_ptr(5); }
};
