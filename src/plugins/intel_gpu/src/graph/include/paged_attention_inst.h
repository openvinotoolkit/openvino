...
public:
    ...
    memory::ptr adaptive_rkv_diversity_block_set_begins_memory_ptr() const { return input_memory_ptr(PagedAttentionInputIdx::ADAPTIVE_RKV_DIVERSITY_BLOCK_SET_BEGINS); }
};
