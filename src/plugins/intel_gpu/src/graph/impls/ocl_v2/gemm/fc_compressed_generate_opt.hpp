...
struct FCCompressedGenerateOpt : public ImplementationManager {
    ...
    explicit FCCompressedGenerateOpt(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, std::move(vf)) {}
    ...
    bool raw_sub_byte_weight_compatible() const noexcept override {
        return true;
    }
