...
// mlp_up: 1
// mlp_down: 2
enum class MOEInputIndex : uint8_t { HIDDEN_STATES = 0, ROUTING_WEIGHTS = 1, ROUTER_TOPK_OUTPUT_INDICES = 2, 
                                    WEIGHT_0 = 3, SCALE_0 = 4, ZP_0 = 5, WEIGHT_1 = 6, SCALE_1 = 7, ZP_1 = 8, WEIGHT_2 = 9, 
                                    SCALE_2 = 10, ZP_2 = 11};
...
struct MOEOpt : public ImplementationManager {
    ...
    [[nodiscard]] bool validate_impl(const program_node& node) const override {
        ...
        const auto& in0_layout = node.get_input_layout(MOEInputIndex::HIDDEN_STATES);
