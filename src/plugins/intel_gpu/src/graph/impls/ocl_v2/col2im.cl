...
)
{
    ...
    for (int idx = 0; idx < KERNEL_PRODUCT; ++idx) {
        ...
        for (int image_height_idx = 0; image_height_idx < max_height; image_height_idx+=STRIDE_0) {
            for (int image_width_idx = 0; image_width_idx < max_width; image_width_idx+=STRIDE_1) {
