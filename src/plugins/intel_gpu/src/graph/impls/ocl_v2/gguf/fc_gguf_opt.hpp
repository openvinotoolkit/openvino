...
// rejected by validate_impl with a clear "not yet implemented" signal; the
...
struct FCGGUFOpt : public ImplementationManager {
    ...
    explicit FCGGUFOpt(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, std::move(vf)) {}

    // GGUF formats with a working native kernel in this release.
    static constexpr std::array<element::Type_t, 11> kSupportedBaseline = {
        element::Type_t::gguf_q4_0,
        element::Type_t::gguf_q4_1,
        element::Type_t::gguf_q4_k,
        element::Type_t::gguf_q5_k,
        element::Type_t::gguf_q6_k,
        element::Type_t::gguf_q8_0,
        element::Type_t::gguf_q3_k,
        element::Type_t::gguf_iq2_xs,
        element::Type_t::gguf_iq2_s,
        element::Type_t::gguf_iq3_xxs,
        element::Type_t::gguf_iq3_s,
    };
