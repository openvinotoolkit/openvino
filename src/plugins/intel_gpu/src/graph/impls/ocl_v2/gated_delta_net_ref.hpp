...
struct GatedDeltaNetRef : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("ocl::gated_delta_net::ref")
    explicit GatedDeltaNetRef(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, std::move(vf)) {}
