...
JitConstants make_activation_jit_constants(const std::string& suffix,
    ...
    case activation_func::erfinv: {
        ...
        const std::string ts = (out_dt == ov::element::f32) ? "f" : "h";
        const std::string elem_inf = (out_dt == ov::element::f32) ? "INFINITY" : "((half)INFINITY)";
        ...
        jit.add(make_jit_constant(macro_def, JitTerm{body}));
        break;
    }
