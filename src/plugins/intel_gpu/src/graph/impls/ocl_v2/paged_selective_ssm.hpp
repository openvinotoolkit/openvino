...
struct PagedSelectiveSSMRef : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("ocl::paged_selective_ssm::ref")
    explicit PagedSelectiveSSMRef(shape_types shape_type, ValidateFunc vf = nullptr)
    ...
    [[nodiscard]] bool validate_impl(const program_node& node) const override {
        ...
        static constexpr std::array supported_real_types = {ov::element::f16, ov::element::f32};
