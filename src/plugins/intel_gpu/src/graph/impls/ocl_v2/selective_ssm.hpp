...
struct SelectiveSSMRef : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("ocl::selective_ssm::ref")
    explicit SelectiveSSMRef(shape_types shape_type, ValidateFunc vf = nullptr)
