...
size_t get_vec_size(const kernel_impl_params& params) {
...
class RopeGenerator : public SingleKernelGenerator {
public:
    RopeGenerator() : SingleKernelGenerator("rope_opt") {}
...
std::unique_ptr<primitive_impl> RopeOpt::create_impl(const program_node& node, const kernel_impl_params& params) const {
