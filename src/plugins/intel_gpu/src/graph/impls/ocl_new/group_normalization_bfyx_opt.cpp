...
//     GetInternalBuffersFunc get_interanl_buffers_func(const program_node& node, const kernel_impl_params& params) const override {
//         static auto f = INTERNAL_BUFFERS_FUNC(params) {
