...
class OpenCL2CHeaders(object):
    ...
    def convert(self):
        res = '// This file is autogenerated by kernels_db_gen.py, all changes to this file will be undone\n\n'
        ...
        batch_headers = '// This file is autogenerated by kernels_db_gen.py, all changes to this file will be undone\n\n'
    ...
    def add_kernel_template(self, template_name, template_code, required_headers):
        return '{{ "{0}", {{ {{ "{1}" }}, {{ "{2}" }} }} }}\n'.format(template_name, template_code, required_headers)
    ...
    def append_file_content(self, filename, origin_file):
        ...
        content = []
        with open(filename) as f:
            content = ['{}\n'.format("this is the kernels code")]
            # content += f.readlines()

        print(self.add_kernel_template("something.cl", "this is some code", "some_header.cl"))
