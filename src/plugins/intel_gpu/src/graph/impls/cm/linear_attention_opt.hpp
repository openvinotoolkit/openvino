...
struct LinearAttentionOptImplementationManager : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("cm::linear_attention::opt")
    explicit LinearAttentionOptImplementationManager(shape_types shape_type, ValidateFunc vf = nullptr)
