...
struct GatedDeltaNetOptImplementationManager : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("cm::gated_delta_net::opt")
    explicit GatedDeltaNetOptImplementationManager(shape_types shape_type, ValidateFunc vf = nullptr)
