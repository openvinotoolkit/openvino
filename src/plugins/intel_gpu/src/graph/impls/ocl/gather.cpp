...
attach_gather_impl::attach_gather_impl() {
    implementation_map<gather>::add(impl_types::ocl, gather_impl::create, {
        MAKE_TUPLE5(fyxb,                   f32, f16, u8, i8, i32),
        ...
        MAKE_TUPLE5(b_fs_yx_fsv4,           f32, f16, u8, i8, i32),
        ...
        MAKE_TUPLE5(b_fs_zyx_fsv32,         f32, f16, u8, i8, i32),
        ...
        MAKE_TUPLE5(fs_b_yx_fsv32,          f32, f16, u8, i8, i32),
    });
}
