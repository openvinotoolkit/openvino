...
struct experimental_detectron_prior_grid_generator_impl
    ...
    static kernel_params_t get_kernel_params(const kernel_impl_params& impl_param) {
        ...
        auto params =
            get_default_params<kernel_selector::experimental_detectron_prior_grid_generator_params>(impl_param);
        ...
        params.step_x =
            primitive->stride_x ? primitive->stride_x : static_cast<float>(primitive->image_width) / params.layer_width;
        params.step_y = primitive->stride_y ? primitive->stride_y
                                            : static_cast<float>(primitive->image_height) / params.layer_height;
...
attach_experimental_detectron_prior_grid_generator_impl::attach_experimental_detectron_prior_grid_generator_impl() {
    implementation_map<experimental_detectron_prior_grid_generator>::add(
        impl_types::ocl,
        typed_primitive_impl_ocl<experimental_detectron_prior_grid_generator>::create<
