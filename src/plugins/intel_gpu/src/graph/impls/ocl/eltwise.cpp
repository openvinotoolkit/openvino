...
attach_eltwise_impl::attach_eltwise_impl() {
    implementation_map<eltwise>::add(impl_types::ocl, eltwise_impl::create, {
        ...
        MAKE_TUPLE5(byxf,                   f32, f16,     i8, i32, i64),
        MAKE_TUPLE5(yxfb,                   f32, f16,     i8, i32, i64),
        ...
        MAKE_TUPLE6(bs_fs_yx_bsv4_fsv2,     f32, f16, u8, i8, i32, i64),
        ...
        MAKE_TUPLE5(bs_fs_zyx_bsv16_fsv16,  f32, f16,     i8, i32, i64),
        MAKE_TUPLE6(bs_fs_zyx_bsv16_fsv32,  f32, f16, u8, i8, i32, i64),
        MAKE_TUPLE6(bs_fs_zyx_bsv32_fsv16,  f32, f16, u8, i8, i32, i64),
        MAKE_TUPLE6(bs_fs_zyx_bsv32_fsv32,  f32, f16, u8, i8, i32, i64),
    });
}
