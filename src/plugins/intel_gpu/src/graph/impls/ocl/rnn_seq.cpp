...
struct rnn_seq_impl : typed_primitive_impl_ocl<rnn> {
    using parent = typed_primitive_impl_ocl<rnn>;
    using parent::parent;
...
protected:
    kernel_arguments_data get_arguments(const typed_primitive_inst<rnn>& instance) const override {
...
public:
    static kernel_params_t get_kernel_params(const kernel_impl_params& impl_param) {
        const auto& primitive = impl_param.typed_desc<rnn>();
...
attach_lstm_seq_impl::attach_lstm_seq_impl() {
    implementation_map<rnn>::add(impl_types::ocl, typed_primitive_impl_ocl<rnn>::create<rnn_seq_impl>, {
...
BIND_BINARY_BUFFER_WITH_TYPE(cldnn::rnn)
