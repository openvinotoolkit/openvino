...
public:
    static kernel_params_t get_kernel_params(const kernel_impl_params& impl_param, bool is_shape_agnostic = false) {
        ...
        if (impl_param.is_dynamic() || is_shape_agnostic) {
            ...
            // W/O enforcing this option we may generate kernel for "broadcast" scneario due to umatched tensor
            // dimensions but in runtime dispatch data will be generated for non-broadcast case as shapes are actually
            // same.
    ...
    void update_dispatch_data(const kernel_impl_params& impl_param) override {
        ...
        auto runtime_offset =
            convert_data_tensor(impl_param.get_input_layout(), impl_param.input_offsets[0]).GetFirstElementOffset();
...
attach_crop_impl::attach_crop_impl() {
    auto dyn_types =
        {data_types::f32, data_types::f16, data_types::i8, data_types::u8, data_types::i32, data_types::i64};
