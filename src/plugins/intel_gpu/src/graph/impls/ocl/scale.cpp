...
attach_scale_impl::attach_scale_impl() {
    implementation_map<scale>::add(impl_types::ocl, scale_impl::create, {
        ...
        MAKE_TUPLE3(byxf,                   f32, f16,         i32),
        MAKE_TUPLE3(yxfb,                   f32, f16,         i32),
        ...
        MAKE_TUPLE3(b_fs_yx_fsv32,          f32, f16,         i32),
        MAKE_TUPLE3(b_fs_zyx_fsv32,         f32, f16,         i32),
        MAKE_TUPLE2(fs_b_yx_fsv32,          f32, f16),
        MAKE_TUPLE3(bs_fs_zyx_bsv16_fsv16,  f32, f16,         i32),
        MAKE_TUPLE3(bs_fs_yx_bsv16_fsv16,   f32, f16,         i32),
    });
}
