...
const implementations& get_compiled_implementations(std::type_index primitive_type) {
    ...
    static const std::unordered_map<std::type_index, implementations> compiled_implementations = {
        {typeid(cldnn::eltwise),
         {std::make_shared<cldnn::vulkan::EltwiseImplementationManager>(cldnn::shape_types::static_shape,
                                                                        cldnn::not_in_shape_flow()),
          std::make_shared<cldnn::vulkan::EltwiseImplementationManager>(cldnn::shape_types::dynamic_shape,
                                                                        cldnn::not_in_shape_flow())}},
        {typeid(cldnn::reorder),
         {std::make_shared<cldnn::vulkan::ReorderImplementationManager>(cldnn::shape_types::static_shape,
                                                                        cldnn::not_in_shape_flow()),
          std::make_shared<cldnn::vulkan::ReorderImplementationManager>(cldnn::shape_types::dynamic_shape,
                                                                        cldnn::not_in_shape_flow())}},
        {typeid(cldnn::reshape),
         {std::make_shared<cldnn::vulkan::ReshapeImplementationManager>(cldnn::shape_types::static_shape)}},
    };
