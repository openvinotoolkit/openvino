...
protected:
    ...
    static std::shared_ptr<dnnl::lbr_gru_forward::primitive_desc> get_gru_primitive_descriptor(const kernel_impl_params& impl_params, cldnn::engine& engine,
        ...
        auto W_shape_mod = ov::Shape{1, num_dir, src_shape[2], 3, initial_hidden_shape_mod[3]};
        ...
        auto R_shape_mod = ov::Shape{1, num_dir, initial_hidden_shape_mod[3], 3, initial_hidden_shape_mod[3]};
