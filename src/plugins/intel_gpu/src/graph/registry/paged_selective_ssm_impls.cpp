...
#if OV_GPU_WITH_OCL
        OV_GPU_CREATE_INSTANCE_OCL(ocl::PagedSelectiveSSMJitIntegrated, shape_types::static_shape)
            OV_GPU_CREATE_INSTANCE_OCL(ocl::PagedSelectiveSSMJitDiscrete, shape_types::static_shape)
