...
#if OV_GPU_WITH_ONEDNN && __has_include(<oneapi/dnnl/dnnl_graph.hpp>)
#    define OV_GPU_WITH_ONEDNN_GRAPH_FUSED_MLP 1
#    include "impls/onednn/fused_mlp_onednn_graph.hpp"
#else
#    define OV_GPU_WITH_ONEDNN_GRAPH_FUSED_MLP 0
#endif
...
#if OV_GPU_WITH_ONEDNN_GRAPH_FUSED_MLP
