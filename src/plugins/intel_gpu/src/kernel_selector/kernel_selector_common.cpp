...
std::string toString(ActivationFunction activation) {
    ...
    case ActivationFunction::ROUND_HALF_TO_EVEN:
        method = "ROUND_HALF_TO_EVEN";
        break;
    case ActivationFunction::ROUND_HALF_AWAY_FROM_ZERO:
        method = "ROUND_HALF_AWAY_FROM_ZERO";
        break;
    default:
        break;
    }
...
std::string toString(DataLayout l) {
    switch (l) {
    case kernel_selector::DataLayout::bf:
        return "BF";
    case kernel_selector::DataLayout::fb:
        return "FB";
    case kernel_selector::DataLayout::bfyx:
        return "BFYX";
    case kernel_selector::DataLayout::yxfb:
        return "YXFB";
    case kernel_selector::DataLayout::byxf:
        return "BYXF";
    case kernel_selector::DataLayout::byfx:
        return "BYFX";
    case kernel_selector::DataLayout::bxfy:
        return "BXFY";
    case kernel_selector::DataLayout::fbyx:
        return "FBYX";
    case kernel_selector::DataLayout::fyxb:
        return "FYXB";
    case kernel_selector::DataLayout::b_fs_yx_fsv2:
        return "B_FS_YX_FSV2";
    case kernel_selector::DataLayout::b_fs_yx_fsv4:
        return "B_FS_YX_FSV4";
    case kernel_selector::DataLayout::b_fs_yx_fsv8:
        return "B_FS_YX_FSV8";
    case kernel_selector::DataLayout::b_fs_yx_fsv16:
        return "B_FS_YX_FSV16";
    case kernel_selector::DataLayout::b_fs_yx_fsv32:
        return "B_FS_YX_FSV32";
    case kernel_selector::DataLayout::b_fs_zyx_fsv32:
        return "B_FS_ZYX_FSV32";
    case kernel_selector::DataLayout::bs_f_bsv8__af8:
        return "BS_F_BSV8__AF8";
    case kernel_selector::DataLayout::bs_f_bsv16__af8:
        return "BS_F_BSV16__AF8";
    case kernel_selector::DataLayout::winograd_2x3_s1_data:
        return "WINOGRAD_2x3_S1_DATA";
    case kernel_selector::DataLayout::bfzyx:
        return "BFZYX";
    case kernel_selector::DataLayout::bzyxf:
        return "BZYXF";
    case kernel_selector::DataLayout::fs_b_yx_fsv32:
        return "FS_B_YX_FSV32";
    case kernel_selector::DataLayout::bfwzyx:
        return "BFWZYX";
    case kernel_selector::DataLayout::bfuwzyx:
        return "BFUWZYX";
    case kernel_selector::DataLayout::bfvuwzyx:
        return "BFVUWZYX";
    case kernel_selector::DataLayout::b_fs_zyx_fsv8:
        return "B_FS_ZYX_FSV8";
    case kernel_selector::DataLayout::b_fs_zyx_fsv16:
        return "B_FS_ZYX_FSV16";
    case kernel_selector::DataLayout::bs_fs_yx_bsv16_fsv16:
        return "BS_FS_YX_BSV16_FSV16";
    case kernel_selector::DataLayout::bs_fs_yx_bsv16_fsv32:
        return "BS_FS_YX_BSV16_FSV32";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv16_fsv32:
        return "BS_FS_ZYX_BSV16_FSV32";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv16_fsv16:
        return "BS_FS_ZYX_BSV16_FSV16";
    case kernel_selector::DataLayout::bs_fs_yx_bsv4_fsv4:
        return "BS_FS_YX_BSV4_FSV4";
    case kernel_selector::DataLayout::bs_fs_yx_bsv8_fsv4:
        return "BS_FS_YX_BSV8_FSV4";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv8_fsv4:
        return "BS_FS_ZYX_BSV8_FSV4";
    case kernel_selector::DataLayout::bs_fs_yx_bsv16_fsv8:
        return "BS_FS_YX_BSV16_FSV8";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv16_fsv8:
        return "BS_FS_ZYX_BSV16_FSV8";
    case kernel_selector::DataLayout::bs_fs_yx_bsv16_fsv4:
        return "BS_FS_YX_BSV16_FSV4";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv16_fsv4:
        return "BS_FS_ZYX_BSV16_FSV4";
    case kernel_selector::DataLayout::bs_fs_yx_bsv16_fsv2:
        return "BS_FS_YX_BSV16_FSV2";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv16_fsv2:
        return "BS_FS_ZYX_BSV16_FSV2";
    case kernel_selector::DataLayout::bs_fs_yx_bsv8_fsv2:
        return "BS_FS_YX_BSV8_FSV2";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv8_fsv2:
        return "BS_FS_ZYX_BSV8_FSV2";
    case kernel_selector::DataLayout::bs_fs_yx_bsv4_fsv2:
        return "BS_FS_YX_BSV4_FSV2";
    case kernel_selector::DataLayout::bs_fs_yx_bsv32_fsv32:
        return "BS_FS_YX_BSV32_FSV32";
    case kernel_selector::DataLayout::bs_fs_yx_bsv32_fsv16:
        return "BS_FS_YX_BSV32_FSV16";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv32_fsv32:
        return "BS_FS_ZYX_BSV32_FSV32";
    case kernel_selector::DataLayout::bs_fs_zyx_bsv32_fsv16:
        return "BS_FS_ZYX_BSV32_FSV16";
    case kernel_selector::DataLayout::nv12:
        return "NV12";
    case kernel_selector::DataLayout::image_2d_rgba:
...
std::string toString(KernelType kt) {
    ...
    case KernelType::SOFT_MAX:
        return "SOFT_MAX";
    case KernelType::REGION_YOLO:
        return "REGION_YOLO";
    case KernelType::REORG_YOLO:
        return "REORG_YOLO";
    case KernelType::ELTWISE:
        return "ELTWISE";
    case KernelType::REORDER:
        return "REORDER";
    case KernelType::SELECT:
        return "SELECT";
    case KernelType::NON_MAX_SUPPRESSION:
        return "NON_MAX_SUPPRESSION";
    case KernelType::MATRIX_NMS:
        return "MATRIX_NMS";
    default:
        return "";
    }
...
std::string toString(MeanSubtractMode mode) {
    switch (mode) {
    case MeanSubtractMode::NONE:
        return "NONE";
    case MeanSubtractMode::INSIDE_PARAMS:
        return "INSIDE_PARAMS";
    case MeanSubtractMode::IN_BUFFER:
        return "IN_BUFFER";
    default:
        return "";
    }
...
std::string toString(KernelDividerMode mode) {
    switch (mode) {
    case KernelDividerMode::DONT_CARE:
        return "DONT_CARE";
...
std::string toString(MVNEpsMode mode) {
    switch (mode) {
    case MVNEpsMode::INSIDE_SQRT:
        return "INSIDE_SQRT";
    case MVNEpsMode::OUTSIDE_SQRT:
        return "OUTSIDE_SQRT";
    default:
        return "";
    }
...
std::string toString(WeightsLayout layout) {
    ...
    case WeightsLayout::os_is_zyx_osv16_isv16:
        return "OS_IS_ZYX_OSV16_ISV16";
    case WeightsLayout::os_is_zyx_osv32_isv16:
        return "OS_IS_ZYX_OSV32_ISV16";
    case WeightsLayout::os_is_zyx_osv64_isv16:
        return "OS_IS_ZYX_OSV64_ISV16";
    case WeightsLayout::o_is_yx_isv4:
        return "O_IS_YX_ISV4";
    ...
    case WeightsLayout::os_iyx_osv32:
        return "OS_IYX_OSV32";
    case WeightsLayout::os_iyx_osv8:
        return "OS_IYX_OSV8";
    case WeightsLayout::os_iyx_osv32__ai32:
    ...
    case WeightsLayout::g_os_iyx_osv16_rotate_180:
        return "G_OS_IYX_OSV16_ROTATE_180";
    ...
    case WeightsLayout::winograd_2x3_s1_weights:
        return "WINOGRAD_2x3_S1_WEIGHTS";
    case WeightsLayout::winograd_2x3_s1_fused_weights:
        return "WINOGRAD_2x3_S1_FUSED_WEIGHTS";
    case WeightsLayout::winograd_6x3_s1_fused_weights:
    ...
    case WeightsLayout::os_is_yx_isa8_osv8_isv4:
        return "OS_IS_YX_ISA8_OSV8_ISV4";
    case WeightsLayout::os_is_yx_isa8_osv16_isv4:
        return "OS_IS_YX_ISA8_OSV16_ISV4";
    case WeightsLayout::os_is_zyx_isa8_osv8_isv4:
        return "OS_IS_ZYX_ISA8_OSV8_ISV4";
    case WeightsLayout::os_is_zyx_isa8_osv16_isv4:
        return "OS_IS_ZYX_ISA8_OSV16_ISV4";
    case WeightsLayout::os_is_yx_osa4_isa8_osv8_isv4_swizzled_by_4:
        return "OS_IS_YX_OSA4_ISA8_OSV8_ISV4_SWIZZLED_BY_4";
    case WeightsLayout::os_is_zyx_osa4_isa8_osv8_isv4_swizzled_by_4:
        return "OS_IS_ZYX_OSA4_ISA8_OSV8_ISV4_SWIZZLED_BY_4";
    case WeightsLayout::os_is_yx_osv16_isv4:
        return "OS_IS_YX_OSV16_ISV4";
    case WeightsLayout::os_is_yx_osv32_isv4_swizzled_by_2:
        return "OS_IS_YX_OSV32_ISV4_SWIZZLED_BY_2";
    case WeightsLayout::os_is_yx_osv32_isv4:
        return "OS_IS_YX_OSV32_ISV4";
    case WeightsLayout::os_is_yx_osv32_isv2:
        return "OS_IS_YX_OSV32_ISV2";
    case WeightsLayout::os_is_zyx_osv32_isv4:
    ...
    case WeightsLayout::gs_oi_yxs_gsv16_yxsv4:
        return "GS_OI_YXS_GSV16_YXSV4";
    case WeightsLayout::gs_oi_yxs_gsv32_yxsv4:
        return "GS_OI_YXS_GSV32_YXSV4";
    case WeightsLayout::os_is_yx_osa4_isa8_osv8_isv4:
        return "OS_IS_YX_OSA4_ISA8_OSV8_ISV4";
    case WeightsLayout::os_is_zyx_osa4_isa8_osv8_isv4:
    ...
    case WeightsLayout::g_os_is_zyx_osv16_isv16:
        return "G_OS_IS_ZYX_OSV16_ISV16";
    case WeightsLayout::g_os_zyx_is_osv16_isv4:
        return "G_OS_ZYX_IS_OSV16_ISV4";
    case WeightsLayout::g_os_zyx_is_osv16_isv16:
        return "G_OS_ZYX_IS_OSV16_ISV16";
    case WeightsLayout::g_os_zyx_is_osv16_isv32:
        return "G_OS_ZYX_IS_OSV16_ISV32";
    case WeightsLayout::g_os_zyx_is_osv32_isv4:
        return "G_OS_ZYX_IS_OSV32_ISV4";
    case WeightsLayout::g_os_zyx_is_osv32_isv16:
        return "G_OS_ZYX_IS_OSV32_ISV16";
    case WeightsLayout::g_os_zyx_is_osv32_isv32:
        return "G_OS_ZYX_IS_OSV32_ISV32";

    default:
        throw std::invalid_argument("Failed to convert WeightsLayout " + std::to_string(layout) + " to string");
    }
}
...
std::string toString(ResampleType type) {
    ...
    case ResampleType::NEAREST_NEIGHBOR:
        return "SAMPLE_TYPE_NEAREST";
    case ResampleType::BILINEAR_INTERP:
        return "SAMPLE_TYPE_INTERP";
    case ResampleType::CAFFE_BILINEAR_INTERP:
        return "SAMPLE_TYPE_CAFFE_INTERP";
    case ResampleType::CUBIC:
        return "SAMPLE_TYPE_CUBIC";
    case ResampleType::LINEAR_ONNX:
        return "SAMPLE_TYPE_LINEAR_ONNX";
    default:
        return "";
    }
}
...
std::string toString(CoordinateTransformationMode mode) {
    switch (mode) {
    case CoordinateTransformationMode::HALF_PIXEL:
        return "COORD_TRANS_MODE_HALF_PIXEL";
    case CoordinateTransformationMode::PYTORCH_HALF_PIXEL:
        return "COORD_TRANS_MODE_PYTORCH_HALF_PIXEL";
    case CoordinateTransformationMode::ASYMMETRIC:
        return "COORD_TRANS_MODE_ASYMMETRIC";
    case CoordinateTransformationMode::TF_HALF_PIXEL_FOR_NN:
        return "COORD_TRANS_MODE_TF_HALF_PIXEL_FOR_NN";
    case CoordinateTransformationMode::ALIGN_CORNERS:
        return "COORD_TRANS_MODE_ALIGN_CORNERS";
    default:
        return "";
    }
}
...
std::string toString(const BorderType type) {
    ...
    case BorderType::CONSTANT:
        return "BORDER_TYPE_CONSTANT";
    case BorderType::EDGE:
        return "BORDER_TYPE_EDGE";
    case BorderType::MIRROR:
        return "BORDER_TYPE_MIRROR";
    case BorderType::MIRROR_101:
        return "BORDER_TYPE_MIRROR_101";
    default:
        return "";
    }
}
...
std::string toString(const IndexSelectAxis& axis) {
    ...
    case IndexSelectAxis::BATCH:
        return "INDEX_SELECT_AXIS_BATCH";
    case IndexSelectAxis::FEATURE:
        return "INDEX_SELECT_AXIS_FEATURE";
    case IndexSelectAxis::X:
        return "INDEX_SELECT_AXIS_X";
    case IndexSelectAxis::Y:
        return "INDEX_SELECT_AXIS_Y";
    default:
        return "";
    }
}
...
std::string toString(const DataTensor& tensor) {
    ...
    if (tensor.GetLayout() != DataLayout::b_fs_yx_fsv16 && tensor.GetLayout() != DataLayout::b_fs_zyx_fsv16) {
        return toStringTensor(tensor);
    } else {
        std::stringstream s;
        s << toString(tensor.GetDType()) << "_";
