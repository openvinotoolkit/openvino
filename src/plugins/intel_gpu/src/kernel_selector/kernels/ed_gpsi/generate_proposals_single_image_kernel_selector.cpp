...
experimental_detectron_generate_proposals_single_image_kernel_selector&
experimental_detectron_generate_proposals_single_image_kernel_selector::Instance() {
    static experimental_detectron_generate_proposals_single_image_kernel_selector instance_;
    return instance_;
}

KernelsData experimental_detectron_generate_proposals_single_image_kernel_selector::GetBestKernels(
