...
DeviceFeaturesKey Convolution_kernel_imad_bs_fs_yx_bsv16_fsv16_1x1::get_required_device_features_key(
    const Params&) const {
    DeviceFeaturesKey k;
...
KernelsData Convolution_kernel_imad_bs_fs_yx_bsv16_fsv16_1x1::GetKernelsData(const Params& params) const {
...
ConvolutionKernelBase::DispatchData Convolution_kernel_imad_bs_fs_yx_bsv16_fsv16_1x1::SetDefault(
...
KernelsPriority Convolution_kernel_imad_bs_fs_yx_bsv16_fsv16_1x1::GetKernelsPriority(const Params& /*params*/) const {
