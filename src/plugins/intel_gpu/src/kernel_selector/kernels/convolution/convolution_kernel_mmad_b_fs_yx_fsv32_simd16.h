...
class ConvolutionKernel_mmad_b_fs_yx_fsv32_simd16 : public ConvolutionKernelBase {
public:
    using Parent = ConvolutionKernelBase;
    ConvolutionKernel_mmad_b_fs_yx_fsv32_simd16() : ConvolutionKernelBase("convolution_gpu_mmad_b_fs_yx_fsv32_simd16") {}
    virtual ~ConvolutionKernel_mmad_b_fs_yx_fsv32_simd16() {}
