...
struct eltwise_fuse_params : fuse_params {
    ...
    eltwise_fuse_params(EltwiseMode mode, bool m_pythondiv)
        : fuse_params(KernelType::ELTWISE),
          mode(mode),
...
protected:
    ...
    virtual JitConstants GetOperationsJitConstants(const eltwise_params& params,
                                                   bool useVload8,
                                                   size_t blockSize = 1) const;
