...
namespace {
ExperimentalDetectronROIFeatureExtractorRef::DispatchData SetDefault(
    const experimental_detectron_roi_feature_extractor_params& params) {
    ...
    dispatch_data.gws = {params.outputs[0].X().v * params.outputs[0].Y().v,
...
JitConstants ExperimentalDetectronROIFeatureExtractorRef::GetJitConstants(
    const experimental_detectron_roi_feature_extractor_params& params) const {
...
KernelsData ExperimentalDetectronROIFeatureExtractorRef::GetKernelsData(const Params& params) const {
    ...
    const experimental_detectron_roi_feature_extractor_params& org_params =
        static_cast<const experimental_detectron_roi_feature_extractor_params&>(params);
    ...
    FillCLKernelData(kernel,
                     ...
                     false,
                     false,
                     static_cast<int>(org_params.number_of_inputs));
    return {kd};
}
