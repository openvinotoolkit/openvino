...
static inline std::pair<size_t, size_t> GetSliceSizes(WeightsLayout l) {
    if (l == WeightsLayout::os_is_yx_isv16_osv16 || l == WeightsLayout::os_is_zyx_isv16_osv16 || l == WeightsLayout::g_os_is_yx_isv16_osv16 ||
        l == WeightsLayout::g_os_is_zyx_isv16_osv16 || l == WeightsLayout::is_os_zyx_isv16_osv16 || l == WeightsLayout::is_os_yx_isv16_osv16 ||
        l == WeightsLayout::os_is_yx_osv16_isv16 || l == WeightsLayout::g_os_zyx_is_osv16_isv16 || l == WeightsLayout::g_is_os_yx_isv16_osv16 ||
...
static inline bool IsOsvFirst(WeightsLayout l) {
    return l == WeightsLayout::os_is_yx_isv16_osv16 || l == WeightsLayout::os_is_zyx_isv16_osv16 || l == WeightsLayout::g_os_is_yx_isv16_osv16 ||
           l == WeightsLayout::g_os_is_zyx_isv16_osv16 || l == WeightsLayout::os_iyx_osv16 || l == WeightsLayout::g_os_iyx_osv16 ||
           l == WeightsLayout::os_iyx_osv32 || l == WeightsLayout::g_os_iyx_osv32 || l == WeightsLayout::os_iyx_osv32__ai32 ||
           l == WeightsLayout::is_os_yx_isv16_osv16 || l == WeightsLayout::is_os_zyx_isv16_osv16 || l == WeightsLayout::g_is_os_yx_isv16_osv16 ||
           l == WeightsLayout::g_is_os_zyx_isv16_osv16;
}
...
ReorderWeightsOpt::DispatchData ReorderWeightsOpt::SetDefault(const reorder_weights_params& params) const {
    DispatchData dispatchData;

    const auto& output = params.output;
    const auto output_layout = output.GetLayout();
    const auto subgroup_size = 16;
    const auto ifm_block_supported =
        (output_layout != WeightsLayout::os_iyx_osv16 && output_layout != WeightsLayout::os_iyx_osv32 && output_layout != WeightsLayout::g_os_iyx_osv16 &&
         output_layout != WeightsLayout::g_os_iyx_osv32 && output_layout != WeightsLayout::os_iyx_osv32__ai32);
    ...
    const auto ifm_block = (osv_first) ? ifm_block_supported ? GetOptimalSize(output.IFM().v, preferred_sizes) : 1 : subgroup_size;
    ...
    if (osv_first) {
        ...
        size_t ifm_padded = (isv_size > 1 && (output.IFM().v % isv_size) != 0) ? Align(output.IFM().v, isv_size) : output.IFM().v;
        dispatchData.gws = {output.G().v * (ifm_padded / ifm_block), output.Z().v * output.Y().v * output.X().v, Align(output.OFM().v, ofm_block)};
    } else {
        dispatchData.gws = {output.G().v * (output.OFM().v / ofm_block), output.Z().v * output.Y().v * output.X().v, Align(output.IFM().v, ifm_block)};
    }
...
JitConstants ReorderWeightsOpt::GetJitConstants(const reorder_weights_params& params) const {
    ...
    const auto& output = params.output;
    const auto subgroup_size = 16;
    const auto ifm_block_supported = (output.GetLayout() != WeightsLayout::os_iyx_osv16 && output.GetLayout() != WeightsLayout::os_iyx_osv32 &&
                                      output.GetLayout() != WeightsLayout::g_os_iyx_osv16 && output.GetLayout() != WeightsLayout::g_os_iyx_osv32 &&
