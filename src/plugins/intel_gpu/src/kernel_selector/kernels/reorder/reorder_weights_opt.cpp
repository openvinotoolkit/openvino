...
static inline std::pair<size_t, size_t> GetSliceSizes(WeightsLayout l) {
    if (l == WeightsLayout::os_is_yx_isv16_osv16 || l == WeightsLayout::os_is_zyx_isv16_osv16 ||
        ...
        return {1, 16};
    else if (l == WeightsLayout::os_iyx_osv32 || l == WeightsLayout::g_os_iyx_osv32 ||
             l == WeightsLayout::os_iyx_osv32__ai32)
        return {1, 32};
...
static inline bool IsOsvFirst(WeightsLayout l) {
    if (l == WeightsLayout::os_is_yx_isv16_osv16 || l == WeightsLayout::os_is_zyx_isv16_osv16 ||
        l == WeightsLayout::g_os_is_yx_isv16_osv16 || l == WeightsLayout::g_os_is_zyx_isv16_osv16 ||
        l == WeightsLayout::os_iyx_osv16 || l == WeightsLayout::g_os_iyx_osv16 || l == WeightsLayout::os_iyx_osv32 ||
        l == WeightsLayout::g_os_iyx_osv32 || l == WeightsLayout::os_iyx_osv32__ai32 ||
        l == WeightsLayout::is_os_yx_isv16_osv16 || l == WeightsLayout::is_os_zyx_isv16_osv16 ||
        l == WeightsLayout::g_is_os_yx_isv16_osv16 || l == WeightsLayout::g_is_os_zyx_isv16_osv16)
        return true;
    else
        return false;
...
ReorderWeightsOpt::DispatchData ReorderWeightsOpt::SetDefault(const reorder_weights_params& params) const {
    ...
    const auto ifm_block_supported =
        (output_layout != WeightsLayout::os_iyx_osv16 && output_layout != WeightsLayout::os_iyx_osv32 &&
         output_layout != WeightsLayout::g_os_iyx_osv16 && output_layout != WeightsLayout::g_os_iyx_osv32 &&
    ...
    const auto ifm_block =
        (osv_first) ? ifm_block_supported ? GetOptimalSize(output.IFM().v, preferred_sizes) : 1 : subgroup_size;
...
JitConstants ReorderWeightsOpt::GetJitConstants(const reorder_weights_params& params) const {
    ...
    const auto subgroup_size = 16;
    const auto ifm_block_supported =
        (output.GetLayout() != WeightsLayout::os_iyx_osv16 && output.GetLayout() != WeightsLayout::os_iyx_osv32 &&
