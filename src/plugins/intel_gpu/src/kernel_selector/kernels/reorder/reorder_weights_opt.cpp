...
bool ReorderWeightsOpt::Validate(const Params& params) const {
    ...
    // On Xe2+ discrete GPUs the subgroup block-write operations used by this
    // optimised kernel can trigger CL_OUT_OF_RESOURCES for certain weight
    // layouts (e.g. os_iyx_osv32). Fall back to the scalar base kernel.
