...
class SoftmaxKernelBlockedAllAxis : public SoftmaxKernelBase {
public:
    using Parent = SoftmaxKernelBase;
    SoftmaxKernelBlockedAllAxis() : Parent("softmax_gpu_blocked_all_axis") {}
    virtual ~SoftmaxKernelBlockedAllAxis() = default;
