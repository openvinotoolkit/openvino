...
//    printf("PADDED_Z(%d), PADDED_Y(%d), PADDED_X(%d) xS[2](%f) S[3](%f) S[4](%f) os[2](%d) os[3](%d) os[4](%d) \n",
//        PADDED_Z, PADDED_Y, PADDED_X, SCALES[2], SCALES[3], SCALES[4], out_size[2], out_size[3], out_size[4]);
...
//    printf("oz(%d) oy(%d) ox(%d) dx1(%f) dx2(%f) dy1(%f) dy2(%f) dz1(%f) dz2(%f)\n", oz, oy, ox, dx1, dx2, dy1, dy2, dz1, dz2);
//    printf("b(%d) f(%d) oz(%d) oy(%d) ox(%d) in_z(%f) in_y(%f) in_x(%f) in_z1(%d) in_y1(%d) in_x1(%d) in_z2(%d) in_y2(%d) in_x2(%d)\n",
//        batch, feature, oz, oy, ox, in_z, in_y, in_x, in_z1, in_y1, in_x1, in_z2, in_y2, in_x2);
//    printf("oz(%d) oy(%d) ox(%d) in_z(%f) in_y(%f) in_x(%f) in_z1(%d) in_y1(%d) in_x1(%d) in_z2(%d) in_y2(%d) in_x2(%d) x111(%f) x211(%f) x121(%f) x221(%f) x112(%f) x212(%f) x122(%f) x222(%f)\n",
//        oz, oy, ox, in_z, in_y, in_x, in_z1, in_y1, in_x1, in_z2, in_y2, in_x2 ,(float)x111, (float)x211, (float)x121, (float)x221, (float)x112, (float)x212, (float)x122, (float)x222);
...
//    printf("batch(%d) feature(%d) oz(%d) oy(%d) ox(%d) idx(%d) val(%f) interp_val(%f) %u\n", batch, feature, oz, oy, ox,
//          OUTPUT_GET_INDEX(batch, feature, oz, oy, ox), (float)res, interp_val, convert_uchar(interp_val));
