...
#else
    OUTPUT_TYPE_BLOCK out = TO_OUTPUT_VECTOR_TYPE(ACTIVATION_TYPED(TO_TYPE(MAKE_VECTOR_TYPE(OUTPUT_COMPUTE_TYPE, VEC_SIZE), res), ACTIVATION_PARAMS_TYPED), VEC_SIZE);
#endif
