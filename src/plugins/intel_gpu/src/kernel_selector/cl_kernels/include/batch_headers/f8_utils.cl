...
typedef struct fp8e5m2_t3 { uchar data[3]; } fp8e5m2_t3;
typedef struct fp8e5m2_t4 { uchar data[4]; } fp8e5m2_t4;
typedef struct fp8e5m2_t8 { uchar data[8]; } fp8e5m2_t8;
typedef struct fp8e5m2_t16 { uchar data[16]; } fp8e5m2_t16;

typedef struct fp8e4m3_t {  char data; } fp8e4m3_t;  // hf8
typedef struct fp8e4m3_t1 { char data[1]; } fp8e4m3_t1;
typedef struct fp8e4m3_t2 { char data[2]; } fp8e4m3_t2;
typedef struct fp8e4m3_t3 { char data[3]; } fp8e4m3_t3;
...
half __attribute__((overloadable)) _convert_half(fp8e5m2_t1 val) {
    return _intel_convert_bf8_to_f16(val.data[0]);
}
half2 __attribute__((overloadable)) _convert_half2(fp8e5m2_t2 val) {
    return (half2)(_intel_convert_bf8_to_f16(val.data[0]), _intel_convert_bf8_to_f16(val.data[1]));
}
half3 __attribute__((overloadable)) _convert_half3(fp8e5m2_t3 val) {
    return (half3)(_intel_convert_bf8_to_f16(val.data[0]), _intel_convert_bf8_to_f16(val.data[1]), _intel_convert_bf8_to_f16(val.data[2]));
}
half4 __attribute__((overloadable)) _convert_half4(fp8e5m2_t4 val) {
    return (half4)(_intel_convert_bf8_to_f16(val.data[0]), _intel_convert_bf8_to_f16(val.data[1]), 
                  _intel_convert_bf8_to_f16(val.data[2]), _intel_convert_bf8_to_f16(val.data[3]));
}
half8 __attribute__((overloadable)) _convert_half8(fp8e5m2_t8 val) {
    return (half8)(_intel_convert_bf8_to_f16(val.data[0]), _intel_convert_bf8_to_f16(val.data[1]),
                   _intel_convert_bf8_to_f16(val.data[2]), _intel_convert_bf8_to_f16(val.data[3]),
                   _intel_convert_bf8_to_f16(val.data[4]), _intel_convert_bf8_to_f16(val.data[5]),
                   _intel_convert_bf8_to_f16(val.data[6]), _intel_convert_bf8_to_f16(val.data[7]));
}
half16 __attribute__((overloadable)) _convert_half16(fp8e5m2_t16 val) {
    return (half16)(
        _intel_convert_bf8_to_f16(val.data[0]),  _intel_convert_bf8_to_f16(val.data[1]),
        _intel_convert_bf8_to_f16(val.data[2]),  _intel_convert_bf8_to_f16(val.data[3]),
        _intel_convert_bf8_to_f16(val.data[4]),  _intel_convert_bf8_to_f16(val.data[5]),
        _intel_convert_bf8_to_f16(val.data[6]),  _intel_convert_bf8_to_f16(val.data[7]),
        _intel_convert_bf8_to_f16(val.data[8]),  _intel_convert_bf8_to_f16(val.data[9]),
        _intel_convert_bf8_to_f16(val.data[10]), _intel_convert_bf8_to_f16(val.data[11]),
        _intel_convert_bf8_to_f16(val.data[12]), _intel_convert_bf8_to_f16(val.data[13]),
        _intel_convert_bf8_to_f16(val.data[14]), _intel_convert_bf8_to_f16(val.data[15])
    );
}
...
float __attribute__((overloadable)) _convert_float(fp8e5m2_t1 val) {
    return (float)_intel_convert_bf8_to_f16(val.data[0]);
}
float2 __attribute__((overloadable)) _convert_float2(fp8e5m2_t2 val) {
    return (float2)(_intel_convert_bf8_to_f16(val.data[0]), _intel_convert_bf8_to_f16(val.data[1]));
}
float3 __attribute__((overloadable)) _convert_float3(fp8e5m2_t3 val) {
    return (float3)(_intel_convert_bf8_to_f16(val.data[0]), _intel_convert_bf8_to_f16(val.data[1]), _intel_convert_bf8_to_f16(val.data[2]));
}
float4 __attribute__((overloadable)) _convert_float4(fp8e5m2_t4 val) {
    return (float4)(_intel_convert_bf8_to_f16(val.data[0]), _intel_convert_bf8_to_f16(val.data[1]), 
                   _intel_convert_bf8_to_f16(val.data[2]), _intel_convert_bf8_to_f16(val.data[3]));
}
float8 __attribute__((overloadable)) _convert_float8(fp8e5m2_t8 val) {
    return (float8)(_intel_convert_bf8_to_f16(val.data[0]), _intel_convert_bf8_to_f16(val.data[1]),
                    _intel_convert_bf8_to_f16(val.data[2]), _intel_convert_bf8_to_f16(val.data[3]),
                    _intel_convert_bf8_to_f16(val.data[4]), _intel_convert_bf8_to_f16(val.data[5]),
                    _intel_convert_bf8_to_f16(val.data[6]), _intel_convert_bf8_to_f16(val.data[7]));
}
...
half __attribute__((overloadable)) _convert_half(fp8e4m3_t1 val) {
    return _intel_convert_hf8_to_f16(val.data[0]);
}
half2 __attribute__((overloadable)) _convert_half2(fp8e4m3_t2 val) {
    return (half2)(_intel_convert_hf8_to_f16(val.data[0]), _intel_convert_hf8_to_f16(val.data[1]));
}
half3 __attribute__((overloadable)) _convert_half3(fp8e4m3_t3 val) {
    return (half3)(_intel_convert_hf8_to_f16(val.data[0]), _intel_convert_hf8_to_f16(val.data[1]), _intel_convert_hf8_to_f16(val.data[2]));
}
half4 __attribute__((overloadable)) _convert_half4(fp8e4m3_t4 val) {
    return (half4)(_intel_convert_hf8_to_f16(val.data[0]), _intel_convert_hf8_to_f16(val.data[1]), 
                  _intel_convert_hf8_to_f16(val.data[2]), _intel_convert_hf8_to_f16(val.data[3]));
}
half8 __attribute__((overloadable)) _convert_half8(fp8e4m3_t8 val) {
    return (half8)(_intel_convert_hf8_to_f16(val.data[0]), _intel_convert_hf8_to_f16(val.data[1]),
                   _intel_convert_hf8_to_f16(val.data[2]), _intel_convert_hf8_to_f16(val.data[3]),
                   _intel_convert_hf8_to_f16(val.data[4]), _intel_convert_hf8_to_f16(val.data[5]),
                   _intel_convert_hf8_to_f16(val.data[6]), _intel_convert_hf8_to_f16(val.data[7]));
}
half16 __attribute__((overloadable)) _convert_half16(fp8e4m3_t16 val) {
    return (half16)(
        _intel_convert_hf8_to_f16(val.data[0]),  _intel_convert_hf8_to_f16(val.data[1]),
        _intel_convert_hf8_to_f16(val.data[2]),  _intel_convert_hf8_to_f16(val.data[3]),
        _intel_convert_hf8_to_f16(val.data[4]),  _intel_convert_hf8_to_f16(val.data[5]),
        _intel_convert_hf8_to_f16(val.data[6]),  _intel_convert_hf8_to_f16(val.data[7]),
        _intel_convert_hf8_to_f16(val.data[8]),  _intel_convert_hf8_to_f16(val.data[9]),
...
float __attribute__((overloadable)) _convert_float(fp8e4m3_t1 val) {
    return (float)_intel_convert_hf8_to_f16(val.data[0]);
}
float2 __attribute__((overloadable)) _convert_float2(fp8e4m3_t2 val) {
    return (float2)(_intel_convert_hf8_to_f16(val.data[0]), _intel_convert_hf8_to_f16(val.data[1]));
}
float3 __attribute__((overloadable)) _convert_float3(fp8e4m3_t3 val) {
    return (float3)(_intel_convert_hf8_to_f16(val.data[0]), _intel_convert_hf8_to_f16(val.data[1]), _intel_convert_hf8_to_f16(val.data[2]));
}
float4 __attribute__((overloadable)) _convert_float4(fp8e4m3_t4 val) {
    return (float4)(_intel_convert_hf8_to_f16(val.data[0]), _intel_convert_hf8_to_f16(val.data[1]), 
                   _intel_convert_hf8_to_f16(val.data[2]), _intel_convert_hf8_to_f16(val.data[3]));
}
float8 __attribute__((overloadable)) _convert_float8(fp8e4m3_t8 val) {
    return (float8)(_intel_convert_hf8_to_f16(val.data[0]), _intel_convert_hf8_to_f16(val.data[1]),
                    _intel_convert_hf8_to_f16(val.data[2]), _intel_convert_hf8_to_f16(val.data[3]),
                    _intel_convert_hf8_to_f16(val.data[4]), _intel_convert_hf8_to_f16(val.data[5]),
                    _intel_convert_hf8_to_f16(val.data[6]), _intel_convert_hf8_to_f16(val.data[7]));
}
...
fp8e5m2_t1 __attribute__((overloadable)) _convert_fp8e5m2_t1(float val[1]) {
    fp8e5m2_t1 res;
    res.data[0] = _intel_convert_f16_to_bf8((half)val[0]);
    return res;
}
fp8e5m2_t2 __attribute__((overloadable)) _convert_fp8e5m2_t2(float2 val) {
    fp8e5m2_t2 res;
    res.data[0] = _intel_convert_f16_to_bf8((half)val.x);
    res.data[1] = _intel_convert_f16_to_bf8((half)val.y);
    return res;
}
fp8e5m2_t3 __attribute__((overloadable)) _convert_fp8e5m2_t3(float3 val) {
    ...
    res.data[0] = _intel_convert_f16_to_bf8((half)val.x);
    res.data[1] = _intel_convert_f16_to_bf8((half)val.y);
    res.data[2] = _intel_convert_f16_to_bf8((half)val.z);
    return res;
}
fp8e5m2_t4 __attribute__((overloadable)) _convert_fp8e5m2_t4(float4 val) {
    ...
    res.data[1] = _intel_convert_f16_to_bf8((half)val.y);
    res.data[2] = _intel_convert_f16_to_bf8((half)val.z);
    res.data[3] = _intel_convert_f16_to_bf8((half)val.w);
    return res;
}
fp8e5m2_t8 __attribute__((overloadable)) _convert_fp8e5m2_t8(float8 val) {
    fp8e5m2_t8 res;
    res.data[0] = _intel_convert_f16_to_bf8((half)val.s0);
    res.data[1] = _intel_convert_f16_to_bf8((half)val.s1);
    res.data[2] = _intel_convert_f16_to_bf8((half)val.s2);
    res.data[3] = _intel_convert_f16_to_bf8((half)val.s3);
    res.data[4] = _intel_convert_f16_to_bf8((half)val.s4);
    res.data[5] = _intel_convert_f16_to_bf8((half)val.s5);
    res.data[6] = _intel_convert_f16_to_bf8((half)val.s6);
    res.data[7] = _intel_convert_f16_to_bf8((half)val.s7);
    return res;
}
fp8e5m2_t16 __attribute__((overloadable)) _convert_fp8e5m2_t16(float16 val) {
    ...
    res.data[6]  = _intel_convert_f16_to_bf8((half)val.s6);
    res.data[7]  = _intel_convert_f16_to_bf8((half)val.s7);
    res.data[8]  = _intel_convert_f16_to_bf8((half)val.s8);
    res.data[9]  = _intel_convert_f16_to_bf8((half)val.s9);
    res.data[10] = _intel_convert_f16_to_bf8((half)val.sA);
    res.data[11] = _intel_convert_f16_to_bf8((half)val.sB);
    res.data[12] = _intel_convert_f16_to_bf8((half)val.sC);
    res.data[13] = _intel_convert_f16_to_bf8((half)val.sD);
    res.data[14] = _intel_convert_f16_to_bf8((half)val.sE);
    res.data[15] = _intel_convert_f16_to_bf8((half)val.sF);
    return res;
}
...
fp8e5m2_t1 __attribute__((overloadable)) _convert_fp8e5m2_t1(half val[1]) {
    fp8e5m2_t1 res;
    res.data[0] = _intel_convert_f16_to_bf8(val[0]);
    return res;
}
fp8e5m2_t2 __attribute__((overloadable)) _convert_fp8e5m2_t2(half2 val) {
    fp8e5m2_t2 res;
    res.data[0] = _intel_convert_f16_to_bf8(val.x);
    res.data[1] = _intel_convert_f16_to_bf8(val.y);
    return res;
}
fp8e5m2_t3 __attribute__((overloadable)) _convert_fp8e5m2_t3(half3 val) {
    ...
    res.data[0] = _intel_convert_f16_to_bf8(val.x);
    res.data[1] = _intel_convert_f16_to_bf8(val.y);
    res.data[2] = _intel_convert_f16_to_bf8(val.z);
    return res;
}
fp8e5m2_t4 __attribute__((overloadable)) _convert_fp8e5m2_t4(half4 val) {
    ...
    res.data[1] = _intel_convert_f16_to_bf8(val.y);
    res.data[2] = _intel_convert_f16_to_bf8(val.z);
    res.data[3] = _intel_convert_f16_to_bf8(val.w);
    return res;
}
fp8e5m2_t8 __attribute__((overloadable)) _convert_fp8e5m2_t8(half8 val) {
    fp8e5m2_t8 res;
    res.data[0] = _intel_convert_f16_to_bf8(val.s0);
    res.data[1] = _intel_convert_f16_to_bf8(val.s1);
    res.data[2] = _intel_convert_f16_to_bf8(val.s2);
    res.data[3] = _intel_convert_f16_to_bf8(val.s3);
    res.data[4] = _intel_convert_f16_to_bf8(val.s4);
    res.data[5] = _intel_convert_f16_to_bf8(val.s5);
    res.data[6] = _intel_convert_f16_to_bf8(val.s6);
    res.data[7] = _intel_convert_f16_to_bf8(val.s7);
    return res;
}
fp8e5m2_t16 __attribute__((overloadable)) _convert_fp8e5m2_t16(half16 val) {
    ...
    res.data[6]  = _intel_convert_f16_to_bf8(val.s6);
    res.data[7]  = _intel_convert_f16_to_bf8(val.s7);
    res.data[8]  = _intel_convert_f16_to_bf8(val.s8);
    res.data[9]  = _intel_convert_f16_to_bf8(val.s9);
    res.data[10] = _intel_convert_f16_to_bf8(val.sA);
    res.data[11] = _intel_convert_f16_to_bf8(val.sB);
    res.data[12] = _intel_convert_f16_to_bf8(val.sC);
    res.data[13] = _intel_convert_f16_to_bf8(val.sD);
    res.data[14] = _intel_convert_f16_to_bf8(val.sE);
    res.data[15] = _intel_convert_f16_to_bf8(val.sF);
    return res;
}
...
fp8e5m2_t1 __attribute__((overloadable)) _convert_fp8e5m2_t1_sat(float val[1]) {
    fp8e5m2_t1 res;
    res.data[0] = _intel_convert_f16_to_bf8_sat((half)val[0]);
    return res;
}
fp8e5m2_t2 __attribute__((overloadable)) _convert_fp8e5m2_t2_sat(float2 val) {
    fp8e5m2_t2 res;
    res.data[0] = _intel_convert_f16_to_bf8_sat((half)val.x);
    res.data[1] = _intel_convert_f16_to_bf8_sat((half)val.y);
    return res;
}
fp8e5m2_t3 __attribute__((overloadable)) _convert_fp8e5m2_t3_sat(float3 val) {
    ...
    res.data[0] = _intel_convert_f16_to_bf8_sat((half)val.x);
    res.data[1] = _intel_convert_f16_to_bf8_sat((half)val.y);
    res.data[2] = _intel_convert_f16_to_bf8_sat((half)val.z);
    return res;
}
fp8e5m2_t4 __attribute__((overloadable)) _convert_fp8e5m2_t4_sat(float4 val) {
    ...
    res.data[1] = _intel_convert_f16_to_bf8_sat((half)val.y);
    res.data[2] = _intel_convert_f16_to_bf8_sat((half)val.z);
    res.data[3] = _intel_convert_f16_to_bf8_sat((half)val.w);
    return res;
}
fp8e5m2_t8 __attribute__((overloadable)) _convert_fp8e5m2_t8_sat(float8 val) {
    fp8e5m2_t8 res;
    res.data[0] = _intel_convert_f16_to_bf8_sat((half)val.s0);
    res.data[1] = _intel_convert_f16_to_bf8_sat((half)val.s1);
    res.data[2] = _intel_convert_f16_to_bf8_sat((half)val.s2);
    res.data[3] = _intel_convert_f16_to_bf8_sat((half)val.s3);
    res.data[4] = _intel_convert_f16_to_bf8_sat((half)val.s4);
    res.data[5] = _intel_convert_f16_to_bf8_sat((half)val.s5);
    res.data[6] = _intel_convert_f16_to_bf8_sat((half)val.s6);
    res.data[7] = _intel_convert_f16_to_bf8_sat((half)val.s7);
    return res;
}
fp8e5m2_t16 __attribute__((overloadable)) _convert_fp8e5m2_t16_sat(float16 val) {
    ...
    res.data[6]  = _intel_convert_f16_to_bf8_sat((half)val.s6);
    res.data[7]  = _intel_convert_f16_to_bf8_sat((half)val.s7);
    res.data[8]  = _intel_convert_f16_to_bf8_sat((half)val.s8);
    res.data[9]  = _intel_convert_f16_to_bf8_sat((half)val.s9);
    res.data[10] = _intel_convert_f16_to_bf8_sat((half)val.sA);
    res.data[11] = _intel_convert_f16_to_bf8_sat((half)val.sB);
    res.data[12] = _intel_convert_f16_to_bf8_sat((half)val.sC);
    res.data[13] = _intel_convert_f16_to_bf8_sat((half)val.sD);
    res.data[14] = _intel_convert_f16_to_bf8_sat((half)val.sE);
    res.data[15] = _intel_convert_f16_to_bf8_sat((half)val.sF);
    return res;
}
...
fp8e5m2_t1 __attribute__((overloadable)) _convert_fp8e5m2_t1_sat(half val[1]) {
    fp8e5m2_t1 res;
    res.data[0] = _intel_convert_f16_to_bf8_sat(val[0]);
    return res;
}
fp8e5m2_t2 __attribute__((overloadable)) _convert_fp8e5m2_t2_sat(half2 val) {
    fp8e5m2_t2 res;
    res.data[0] = _intel_convert_f16_to_bf8_sat(val.x);
    res.data[1] = _intel_convert_f16_to_bf8_sat(val.y);
    return res;
}
fp8e5m2_t3 __attribute__((overloadable)) _convert_fp8e5m2_t3_sat(half3 val) {
    ...
    res.data[0] = _intel_convert_f16_to_bf8_sat(val.x);
    res.data[1] = _intel_convert_f16_to_bf8_sat(val.y);
    res.data[2] = _intel_convert_f16_to_bf8_sat(val.z);
    return res;
}
fp8e5m2_t4 __attribute__((overloadable)) _convert_fp8e5m2_t4_sat(half4 val) {
    ...
    res.data[1] = _intel_convert_f16_to_bf8_sat(val.y);
    res.data[2] = _intel_convert_f16_to_bf8_sat(val.z);
    res.data[3] = _intel_convert_f16_to_bf8_sat(val.w);
    return res;
}
fp8e5m2_t8 __attribute__((overloadable)) _convert_fp8e5m2_t8_sat(half8 val) {
    fp8e5m2_t8 res;
    res.data[0] = _intel_convert_f16_to_bf8_sat(val.s0);
    res.data[1] = _intel_convert_f16_to_bf8_sat(val.s1);
    res.data[2] = _intel_convert_f16_to_bf8_sat(val.s2);
    res.data[3] = _intel_convert_f16_to_bf8_sat(val.s3);
    res.data[4] = _intel_convert_f16_to_bf8_sat(val.s4);
    res.data[5] = _intel_convert_f16_to_bf8_sat(val.s5);
    res.data[6] = _intel_convert_f16_to_bf8_sat(val.s6);
    res.data[7] = _intel_convert_f16_to_bf8_sat(val.s7);
    return res;
}
fp8e5m2_t16 __attribute__((overloadable)) _convert_fp8e5m2_t16_sat(half16 val) {
    ...
    res.data[6]  = _intel_convert_f16_to_bf8_sat(val.s6);
    res.data[7]  = _intel_convert_f16_to_bf8_sat(val.s7);
    res.data[8]  = _intel_convert_f16_to_bf8_sat(val.s8);
    res.data[9]  = _intel_convert_f16_to_bf8_sat(val.s9);
    res.data[10] = _intel_convert_f16_to_bf8_sat(val.sA);
    res.data[11] = _intel_convert_f16_to_bf8_sat(val.sB);
    res.data[12] = _intel_convert_f16_to_bf8_sat(val.sC);
    res.data[13] = _intel_convert_f16_to_bf8_sat(val.sD);
    res.data[14] = _intel_convert_f16_to_bf8_sat(val.sE);
    res.data[15] = _intel_convert_f16_to_bf8_sat(val.sF);
    return res;
}
...
fp8e4m3_t1 __attribute__((overloadable)) _convert_fp8e4m3_t1(float val[1]) {
    fp8e4m3_t1 res;
    res.data[0] = _intel_convert_f16_to_hf8((half)val[0]);
    return res;
}
fp8e4m3_t2 __attribute__((overloadable)) _convert_fp8e4m3_t2(float2 val) {
    fp8e4m3_t2 res;
    res.data[0] = _intel_convert_f16_to_hf8((half)val.x);
    res.data[1] = _intel_convert_f16_to_hf8((half)val.y);
    return res;
}
fp8e4m3_t3 __attribute__((overloadable)) _convert_fp8e4m3_t3(float3 val) {
    ...
    res.data[0] = _intel_convert_f16_to_hf8((half)val.x);
    res.data[1] = _intel_convert_f16_to_hf8((half)val.y);
    res.data[2] = _intel_convert_f16_to_hf8((half)val.z);
    return res;
}
fp8e4m3_t4 __attribute__((overloadable)) _convert_fp8e4m3_t4(float4 val) {
    ...
    res.data[1] = _intel_convert_f16_to_hf8((half)val.y);
    res.data[2] = _intel_convert_f16_to_hf8((half)val.z);
    res.data[3] = _intel_convert_f16_to_hf8((half)val.w);
    return res;
}
fp8e4m3_t8 __attribute__((overloadable)) _convert_fp8e4m3_t8(float8 val) {
    fp8e4m3_t8 res;
    res.data[0] = _intel_convert_f16_to_hf8((half)val.s0);
    res.data[1] = _intel_convert_f16_to_hf8((half)val.s1);
    res.data[2] = _intel_convert_f16_to_hf8((half)val.s2);
    res.data[3] = _intel_convert_f16_to_hf8((half)val.s3);
    res.data[4] = _intel_convert_f16_to_hf8((half)val.s4);
    res.data[5] = _intel_convert_f16_to_hf8((half)val.s5);
    res.data[6] = _intel_convert_f16_to_hf8((half)val.s6);
    res.data[7] = _intel_convert_f16_to_hf8((half)val.s7);
    return res;
}
fp8e4m3_t16 __attribute__((overloadable)) _convert_fp8e4m3_t16(float16 val) {
    ...
    res.data[6]  = _intel_convert_f16_to_hf8((half)val.s6);
    res.data[7]  = _intel_convert_f16_to_hf8((half)val.s7);
    res.data[8]  = _intel_convert_f16_to_hf8((half)val.s8);
    res.data[9]  = _intel_convert_f16_to_hf8((half)val.s9);
    res.data[10] = _intel_convert_f16_to_hf8((half)val.sA);
    res.data[11] = _intel_convert_f16_to_hf8((half)val.sB);
    res.data[12] = _intel_convert_f16_to_hf8((half)val.sC);
    res.data[13] = _intel_convert_f16_to_hf8((half)val.sD);
    res.data[14] = _intel_convert_f16_to_hf8((half)val.sE);
    res.data[15] = _intel_convert_f16_to_hf8((half)val.sF);
    return res;
}
...
fp8e4m3_t1 __attribute__((overloadable)) _convert_fp8e4m3_t1(half val[1]) {
    fp8e4m3_t1 res;
    res.data[0] = _intel_convert_f16_to_hf8(val[0]);
    return res;
}
fp8e4m3_t2 __attribute__((overloadable)) _convert_fp8e4m3_t2(half2 val) {
    fp8e4m3_t2 res;
    res.data[0] = _intel_convert_f16_to_hf8(val.x);
    res.data[1] = _intel_convert_f16_to_hf8(val.y);
    return res;
}
fp8e4m3_t3 __attribute__((overloadable)) _convert_fp8e4m3_t3(half3 val) {
    ...
    res.data[0] = _intel_convert_f16_to_hf8(val.x);
    res.data[1] = _intel_convert_f16_to_hf8(val.y);
    res.data[2] = _intel_convert_f16_to_hf8(val.z);
    return res;
}
fp8e4m3_t4 __attribute__((overloadable)) _convert_fp8e4m3_t4(half4 val) {
    ...
    res.data[1] = _intel_convert_f16_to_hf8(val.y);
    res.data[2] = _intel_convert_f16_to_hf8(val.z);
    res.data[3] = _intel_convert_f16_to_hf8(val.w);
    return res;
}
fp8e4m3_t8 __attribute__((overloadable)) _convert_fp8e4m3_t8(half8 val) {
    fp8e4m3_t8 res;
    res.data[0] = _intel_convert_f16_to_hf8(val.s0);
    res.data[1] = _intel_convert_f16_to_hf8(val.s1);
    res.data[2] = _intel_convert_f16_to_hf8(val.s2);
    res.data[3] = _intel_convert_f16_to_hf8(val.s3);
    res.data[4] = _intel_convert_f16_to_hf8(val.s4);
    res.data[5] = _intel_convert_f16_to_hf8(val.s5);
    res.data[6] = _intel_convert_f16_to_hf8(val.s6);
    res.data[7] = _intel_convert_f16_to_hf8(val.s7);
    return res;
}
fp8e4m3_t16 __attribute__((overloadable)) _convert_fp8e4m3_t16(half16 val) {
    ...
    res.data[6]  = _intel_convert_f16_to_hf8(val.s6);
    res.data[7]  = _intel_convert_f16_to_hf8(val.s7);
    res.data[8]  = _intel_convert_f16_to_hf8(val.s8);
    res.data[9]  = _intel_convert_f16_to_hf8(val.s9);
    res.data[10] = _intel_convert_f16_to_hf8(val.sA);
    res.data[11] = _intel_convert_f16_to_hf8(val.sB);
    res.data[12] = _intel_convert_f16_to_hf8(val.sC);
    res.data[13] = _intel_convert_f16_to_hf8(val.sD);
    res.data[14] = _intel_convert_f16_to_hf8(val.sE);
    res.data[15] = _intel_convert_f16_to_hf8(val.sF);
    return res;
}
...
fp8e4m3_t1 __attribute__((overloadable)) _convert_fp8e4m3_t1_sat(float val[1]) {
    fp8e4m3_t1 res;
    res.data[0] = _intel_convert_f16_to_hf8_sat((half)val[0]);
    return res;
}
fp8e4m3_t2 __attribute__((overloadable)) _convert_fp8e4m3_t2_sat(float2 val) {
    fp8e4m3_t2 res;
    res.data[0] = _intel_convert_f16_to_hf8_sat((half)val.x);
    res.data[1] = _intel_convert_f16_to_hf8_sat((half)val.y);
    return res;
}
fp8e4m3_t3 __attribute__((overloadable)) _convert_fp8e4m3_t3_sat(float3 val) {
    ...
    res.data[0] = _intel_convert_f16_to_hf8_sat((half)val.x);
    res.data[1] = _intel_convert_f16_to_hf8_sat((half)val.y);
    res.data[2] = _intel_convert_f16_to_hf8_sat((half)val.z);
    return res;
}
fp8e4m3_t4 __attribute__((overloadable)) _convert_fp8e4m3_t4_sat(float4 val) {
    ...
    res.data[1] = _intel_convert_f16_to_hf8_sat((half)val.y);
    res.data[2] = _intel_convert_f16_to_hf8_sat((half)val.z);
    res.data[3] = _intel_convert_f16_to_hf8_sat((half)val.w);
    return res;
}
fp8e4m3_t8 __attribute__((overloadable)) _convert_fp8e4m3_t8_sat(float8 val) {
    fp8e4m3_t8 res;
    res.data[0] = _intel_convert_f16_to_hf8_sat((half)val.s0);
    res.data[1] = _intel_convert_f16_to_hf8_sat((half)val.s1);
    res.data[2] = _intel_convert_f16_to_hf8_sat((half)val.s2);
    res.data[3] = _intel_convert_f16_to_hf8_sat((half)val.s3);
    res.data[4] = _intel_convert_f16_to_hf8_sat((half)val.s4);
    res.data[5] = _intel_convert_f16_to_hf8_sat((half)val.s5);
    res.data[6] = _intel_convert_f16_to_hf8_sat((half)val.s6);
    res.data[7] = _intel_convert_f16_to_hf8_sat((half)val.s7);
    return res;
}
fp8e4m3_t16 __attribute__((overloadable)) _convert_fp8e4m3_t16_sat(float16 val) {
    ...
    res.data[6]  = _intel_convert_f16_to_hf8_sat((half)val.s6);
    res.data[7]  = _intel_convert_f16_to_hf8_sat((half)val.s7);
    res.data[8]  = _intel_convert_f16_to_hf8_sat((half)val.s8);
    res.data[9]  = _intel_convert_f16_to_hf8_sat((half)val.s9);
    res.data[10] = _intel_convert_f16_to_hf8_sat((half)val.sA);
    res.data[11] = _intel_convert_f16_to_hf8_sat((half)val.sB);
    res.data[12] = _intel_convert_f16_to_hf8_sat((half)val.sC);
    res.data[13] = _intel_convert_f16_to_hf8_sat((half)val.sD);
    res.data[14] = _intel_convert_f16_to_hf8_sat((half)val.sE);
    res.data[15] = _intel_convert_f16_to_hf8_sat((half)val.sF);
    return res;
}
...
fp8e4m3_t1 __attribute__((overloadable)) _convert_fp8e4m3_t1_sat(half val[1]) {
    fp8e4m3_t1 res;
    res.data[0] = _intel_convert_f16_to_hf8_sat(val[0]);
    return res;
}
fp8e4m3_t2 __attribute__((overloadable)) _convert_fp8e4m3_t2_sat(half2 val) {
    fp8e4m3_t2 res;
    res.data[0] = _intel_convert_f16_to_hf8_sat(val.x);
    res.data[1] = _intel_convert_f16_to_hf8_sat(val.y);
    return res;
}
fp8e4m3_t3 __attribute__((overloadable)) _convert_fp8e4m3_t3_sat(half3 val) {
    ...
    res.data[0] = _intel_convert_f16_to_hf8_sat(val.x);
    res.data[1] = _intel_convert_f16_to_hf8_sat(val.y);
    res.data[2] = _intel_convert_f16_to_hf8_sat(val.z);
    return res;
}
fp8e4m3_t4 __attribute__((overloadable)) _convert_fp8e4m3_t4_sat(half4 val) {
    ...
    res.data[1] = _intel_convert_f16_to_hf8_sat(val.y);
    res.data[2] = _intel_convert_f16_to_hf8_sat(val.z);
    res.data[3] = _intel_convert_f16_to_hf8_sat(val.w);
    return res;
}
fp8e4m3_t8 __attribute__((overloadable)) _convert_fp8e4m3_t8_sat(half8 val) {
    fp8e4m3_t8 res;
    res.data[0] = _intel_convert_f16_to_hf8_sat(val.s0);
    res.data[1] = _intel_convert_f16_to_hf8_sat(val.s1);
    res.data[2] = _intel_convert_f16_to_hf8_sat(val.s2);
    res.data[3] = _intel_convert_f16_to_hf8_sat(val.s3);
    res.data[4] = _intel_convert_f16_to_hf8_sat(val.s4);
    res.data[5] = _intel_convert_f16_to_hf8_sat(val.s5);
    res.data[6] = _intel_convert_f16_to_hf8_sat(val.s6);
    res.data[7] = _intel_convert_f16_to_hf8_sat(val.s7);
    return res;
}
fp8e4m3_t16 __attribute__((overloadable)) _convert_fp8e4m3_t16_sat(half16 val) {
    ...
    res.data[6]  = _intel_convert_f16_to_hf8_sat(val.s6);
    res.data[7]  = _intel_convert_f16_to_hf8_sat(val.s7);
    res.data[8]  = _intel_convert_f16_to_hf8_sat(val.s8);
    res.data[9]  = _intel_convert_f16_to_hf8_sat(val.s9);
    res.data[10] = _intel_convert_f16_to_hf8_sat(val.sA);
    res.data[11] = _intel_convert_f16_to_hf8_sat(val.sB);
    res.data[12] = _intel_convert_f16_to_hf8_sat(val.sC);
    res.data[13] = _intel_convert_f16_to_hf8_sat(val.sD);
    res.data[14] = _intel_convert_f16_to_hf8_sat(val.sE);
    res.data[15] = _intel_convert_f16_to_hf8_sat(val.sF);
    return res;
}
...
fp8e4m3_t1 __attribute__((overloadable)) as_fp8e4m3_t1(uchar val[1]) {
    fp8e4m3_t1 res;
    res.data[0] = as_char(val[0]);
    return res;
}
fp8e4m3_t2 __attribute__((overloadable)) as_fp8e4m3_t2(uchar2 val) {
    fp8e4m3_t2 res;
    res.data[0] = as_char(val.x);
    res.data[1] = as_char(val.y);
    return res;
}
...
fp8e4m3_t4 __attribute__((overloadable)) as_fp8e4m3_t4(uchar4 val) {
    ...
    res.data[1] = as_char(val.y);
    res.data[2] = as_char(val.z);
    res.data[3] = as_char(val.w);
    return res;
}
fp8e4m3_t8 __attribute__((overloadable)) as_fp8e4m3_t8(uchar8 val) {
    fp8e4m3_t8 res;
    res.data[0] = as_char(val.s0);
    res.data[1] = as_char(val.s1);
    res.data[2] = as_char(val.s2);
    res.data[3] = as_char(val.s3);
    res.data[4] = as_char(val.s4);
    res.data[5] = as_char(val.s5);
    res.data[6] = as_char(val.s6);
    res.data[7] = as_char(val.s7);
    return res;
}
fp8e4m3_t16 __attribute__((overloadable)) as_fp8e4m3_t16(uchar16 val) {
    ...
    res.data[6]  = as_char(val.s6);
    res.data[7]  = as_char(val.s7);
    res.data[8]  = as_char(val.s8);
    res.data[9]  = as_char(val.s9);
    res.data[10] = as_char(val.sA);
    res.data[11] = as_char(val.sB);
    res.data[12] = as_char(val.sC);
    res.data[13] = as_char(val.sD);
    res.data[14] = as_char(val.sE);
    res.data[15] = as_char(val.sF);
    return res;
}
...
uchar __attribute__((overloadable)) _as_uchar(fp8e4m3_t1 val) {
    return as_uchar((char)val.data[0]);
}
uchar2 __attribute__((overloadable)) _as_uchar2(fp8e4m3_t2 val) {
    return (uchar2)(as_uchar((char)val.data[0]), as_uchar((char)val.data[1]));
}
uchar3 __attribute__((overloadable)) _as_uchar3(fp8e4m3_t3 val) {
    return (uchar3)(as_uchar((char)val.data[0]), as_uchar((char)val.data[1]), as_uchar((char)val.data[2]));
}
uchar4 __attribute__((overloadable)) _as_uchar4(fp8e4m3_t4 val) {
    return (uchar4)(as_uchar((char)val.data[0]), as_uchar((char)val.data[1]),
                    as_uchar((char)val.data[2]), as_uchar((char)val.data[3]));
}
uchar8 __attribute__((overloadable)) _as_uchar8(fp8e4m3_t8 val) {
    return (uchar8)(as_uchar((char)val.data[0]), as_uchar((char)val.data[1]),
                    as_uchar((char)val.data[2]), as_uchar((char)val.data[3]),
                    as_uchar((char)val.data[4]), as_uchar((char)val.data[5]),
                    as_uchar((char)val.data[6]), as_uchar((char)val.data[7]));
}
uchar16 __attribute__((overloadable)) _as_uchar16(fp8e4m3_t16 val) {
    return (uchar16)(as_uchar((char)val.data[0]),  as_uchar((char)val.data[1]),
                     as_uchar((char)val.data[2]),  as_uchar((char)val.data[3]),
                     as_uchar((char)val.data[4]),  as_uchar((char)val.data[5]),
                     as_uchar((char)val.data[6]),  as_uchar((char)val.data[7]),
                     as_uchar((char)val.data[8]),  as_uchar((char)val.data[9]),
