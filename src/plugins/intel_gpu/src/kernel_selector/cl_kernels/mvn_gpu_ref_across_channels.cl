...
#   endif
                    ...
                    MVN_FINAL_TYPE result = TO_MVN_FINAL_TYPE(DECODE_INPUT0_COMPUTE_TYPE(input[input_idx])) - TO_MVN_FINAL_TYPE(mean);
#   if HAS_FUSED_OPS
                    FUSED_OPS;
...
#   endif
                    ...
                    MVN_FINAL_TYPE result = (TO_MVN_FINAL_TYPE(DECODE_INPUT0_COMPUTE_TYPE(input[input_idx])) - TO_MVN_FINAL_TYPE(mean)) * TO_MVN_FINAL_TYPE(variance);
#   if HAS_FUSED_OPS
                    FUSED_OPS;
                    output[output_idx] = FUSED_OPS_RESULT;
#   else
