...
#if HAS_PRE_SHIFT
    INPUT1_COMPUTE_VEC_TYPE val = TO_VECTOR_TYPE(INPUT1_COMPUTE_TYPE, 8)(DECODE_INPUT0_COMPUTE_VECTOR_TYPE(in0, 8)) * TO_INPUT1_COMPUTE_TYPE(IN_SCALE_VAL) + TO_INPUT1_COMPUTE_TYPE(IN_SHIFT_VAL);
#else
...
#if HAS_CLAMP
    INPUT1_COMPUTE_VEC_TYPE val = clamp(TO_VECTOR_TYPE(INPUT1_COMPUTE_TYPE, 8)(DECODE_INPUT0_COMPUTE_VECTOR_TYPE(in0, 8)), input_low_val, input_high_val);
#else
    INPUT1_COMPUTE_VEC_TYPE val = TO_VECTOR_TYPE(INPUT1_COMPUTE_TYPE, 8)(DECODE_INPUT0_COMPUTE_VECTOR_TYPE(in0, 8));
#endif
