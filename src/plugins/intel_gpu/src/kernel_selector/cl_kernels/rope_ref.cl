...
#define UNPACK_HALF16_VEC_1(outputv, input1, input2) \
    outputv = (half16)(input1[0], input1[2], input1[4], input1[6], input1[8], input1[10], input1[12], input1[14], \
                       input2[0], input2[2], input2[4], input2[6], input2[8], input2[10], input2[12], input2[14]);

#define UNPACK_HALF16_VEC_2(outputv, input1, input2) \
    outputv = (half16)(input1[1], input1[3], input1[5], input1[7], input1[9], input1[11], input1[13], input1[15], \
                       input2[1], input2[3], input2[5], input2[7], input2[9], input2[11], input2[13], input2[15]);

#define PACK_HALF16_VEC_1(outputv, input1, input2) \
    outputv = (half16)(input1[0], input2[0], input1[1], input2[1], input1[2], input2[2], input1[3], input2[3], \
                       input1[4], input2[4], input1[5], input2[5], input1[6], input2[6], input1[7], input2[7]);

#define PACK_HALF16_VEC_2(outputv, input1, input2) \
    outputv = (half16)(input1[8], input2[8], input1[9], input2[9], input1[10], input2[10], input1[11], input2[11], \
...
#   error "rope_ref.cl - VEC_SIZE must be one of {1, 8, 16}"
#endif
    ...
    *(float8 *)(output + output_idx + r) = (float8)(out1.s0, out2.s0, out1.s1, out2.s1, out1.s2, out2.s2, out1.s3, out2.s3);
    *(float8 *)(output + output_idx + r + VEC_SIZE) = (float8)(out1.s4, out2.s4, out1.s5, out2.s5, out1.s6, out2.s6, out1.s7, out2.s7);

    #ifdef ENABLE_IO_COPY
        *(float8 *)(output + output_idx + ROTARY_NDIMS + f) = *(float8 *)(input + input_idx + ROTARY_NDIMS + f);
        *(float8 *)(output + output_idx + ROTARY_NDIMS + f + VEC_SIZE) = *(float8 *)(input + input_idx + ROTARY_NDIMS + f + VEC_SIZE);
    #endif
#elif VEC_SIZE==16
