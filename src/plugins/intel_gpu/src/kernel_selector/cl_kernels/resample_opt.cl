...
<<<<<<< HEAD:src/plugins/intel_gpu/src/kernel_selector/cl_kernels/resample_opt.cl
...
>>>>>>> 3-axis interpolation for linear-onnx mode:src/plugins/intel_gpu/src/kernel_selector/core/cl_kernels/resample_opt.cl
#if PADDING_USED == 1
        if (tlOutOfBounds)
