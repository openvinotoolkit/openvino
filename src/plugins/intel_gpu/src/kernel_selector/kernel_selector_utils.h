...
struct DimensionAccessHelper {
    ...
    std::pair<std::string, std::string> x_pad() {
        return {pad_before_after_sizes[14], pad_before_after_sizes[15]};
    }
    std::pair<std::string, std::string> y_pad() {
        return {pad_before_after_sizes[12], pad_before_after_sizes[13]};
    }
    std::pair<std::string, std::string> z_pad() {
        return {pad_before_after_sizes[10], pad_before_after_sizes[11]};
    }
    std::pair<std::string, std::string> w_pad() {
        return {pad_before_after_sizes[8], pad_before_after_sizes[9]};
    }
    std::pair<std::string, std::string> v_pad() {
        return {pad_before_after_sizes[6], pad_before_after_sizes[7]};
    }
    std::pair<std::string, std::string> u_pad() {
        return {pad_before_after_sizes[4], pad_before_after_sizes[5]};
    }
    std::pair<std::string, std::string> f_pad() {
        return {pad_before_after_sizes[2], pad_before_after_sizes[3]};
    }
    std::pair<std::string, std::string> b_pad() {
        return {pad_before_after_sizes[0], pad_before_after_sizes[1]};
    }
...
std::vector<size_t> GetOptimalLocalWorkGroupSizes(std::vector<size_t> gws,
                                                  ...
                                                  DataLayout input_layout = DataLayout::bfyx,
                                                  DataLayout output_layout = DataLayout::bfyx,
