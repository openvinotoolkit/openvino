...
memory_ptr ocl_engine::create_hostbuffer_host_ro(void* cpu_address,
                                         size_t data_size,
                                         allocation_type _allocation_type,
                                         const layout output_layout) {
    return create_hostbuffer_impl(cpu_address, data_size, _allocation_type, output_layout, CL_MEM_READ_ONLY | CL_MEM_HOST_READ_ONLY);
}
