...
public:
    ...
    */
    ...
    //! \brief Copy constructor - forwards to the superclass copy constructor.
    ImageVA(const ImageVA& img) = default;

    //! \brief Copy assignment - forwards to the superclass copy assignment.
...
public:
    ...
    */
    ...
    //! \brief Copy constructor - forwards to the superclass copy constructor.
    BufferDX(const BufferDX& buf) = default;

    //! \brief Copy assignment - forwards to the superclass copy assignment.
    BufferDX& operator = (const BufferDX &buf) = default;
