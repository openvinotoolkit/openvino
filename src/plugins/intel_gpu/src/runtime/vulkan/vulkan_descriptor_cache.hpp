...
public:
    ...
    bool requires_mutable_set(VkDescriptorSetLayout layout, const vulkan_prepared_arguments& prepared) const;
...
private:
    ...
    static descriptor_key make_key(VkDescriptorSetLayout layout, const vulkan_prepared_arguments& prepared);
