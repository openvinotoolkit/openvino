...
uint32_t Plugin::get_optimal_batch_size(const ov::AnyMap& options) const {
    ...
    GPU_DEBUG_INFO << "DEVICE_INFO:" << "gfx_version.major, " << device_info.gfx_ver.major << "gfx_version.minor "
    ...
    if (gen_kbytes_per_bank.end() != val) {
        ...
        GPU_DEBUG_INFO << "DEVICE_INFO:" << "num_slices " << device_info.num_slices << ", num_sub_slices_per_slice "
