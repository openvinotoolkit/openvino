...
#include "plugin/transformations/scatterupdate_reshape_concat_reshape_sdpa_fusion.hpp"
...
void TransformationsPipeline::apply(std::shared_ptr<ov::Model> func) {
...

    {
        ...
        manager.register_pass<ov::intel_gpu::ScatterUpdateReshapeConcatReshapeSDPAFusion>();
