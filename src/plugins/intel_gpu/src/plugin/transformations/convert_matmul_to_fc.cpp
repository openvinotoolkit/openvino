...
ConvertMatMulToFullyConnected::ConvertMatMulToFullyConnected() {
    ...
    ov::matcher_pass_callback callback = [OV_CAPTURE_CPY_AND_THIS](ov::pass::pattern::Matcher& m) {
        ...
        // If fc_input_b is shared with another matmul, transposing fc_input_b is limited.
        // If it is connected to input_a of another matmul, do not transpose
        // If it is connected to input_b of another matmul and the transpose option is different between those two matmuls, do not transpose.
