...
KeepMOE3GemmConstPrecision::KeepMOE3GemmConstPrecision() {
    ...
    auto moe_3gemm_fused_compressed_m_shared = wrap_type<ov::intel_gpu::op::MOE3GemmFusedCompressed>(
    ...
    auto moe_3gemm_fused_compressed_m_no_shared = wrap_type<ov::intel_gpu::op::MOE3GemmFusedCompressed>(
        {any_input(), any_input(),   wei_0_m, any_input(), zp_0_m, wei_1_m, any_input(), zp_1_m, wei_2_m, any_input(),
         zp_2_m});
