 ...
 * constants in order to constant fold the Reshape node. Example: Weights(3D) Weights(2D) | | Convert Subtract_const(3D)
 * Convert    Subtract_const(2D) |      /                                               |      / Subtract(optional)
 * Subtract(optional) |      Multiply_const(3D)        ====>                 |      Multiply_const(2D) |     / |     /
 *                    Multiply                                               Multiply
 *                       |                                                      |
 *                    Reshape(2D)                                               |
 *                       |                                                      |
