...
void copyResultToOutputBlob(cldnn::memory::ptr src, Blob::Ptr dst, ov::intel_gpu::buf_into* bi, cldnn::stream& stream) {
...
void InferRequestLegacy::copy_output_data(cldnn::memory::ptr src, Blob::Ptr dst, buf_into* bi) {
...
void InferRequestLegacy::copy_input_data(std::shared_ptr<cldnn::network> network,
                                        ...
                                        const Blob &inputBlob, buf_into* bi) {
