...
static void CreateExperimentalDetectronPriorGridGeneratorOp(Program &p, const std::shared_ptr<ngraph::op::v6::ExperimentalDetectronPriorGridGenerator> &op) {
    ...
    auto &priors_shape = op->get_input_shape(0);
    ...
    cldnn::experimental_detectron_prior_grid_generator prim {
