...
static void CreateNonMaxSuppressionIEInternalOp(
    ProgramBuilder& p,
    const std::shared_ptr<ov::op::internal::NonMaxSuppressionIEInternal>& op) {
    ...
    if (p.use_new_shape_infer()) {
        ...
        auto prim = cldnn::non_max_suppression(nonMaxSuppressionLayerName,
                                               reordered_inputs[0],
                                               reordered_inputs[1],
                                               0,
        ...
        case 6:
            prim.soft_nms_sigma = reordered_inputs[5].pid;
        case 5:
            prim.score_threshold = reordered_inputs[4].pid;
        case 4:
            prim.iou_threshold = reordered_inputs[3].pid;
        case 3:
            prim.num_select_per_class = reordered_inputs[2].pid;
        case 2:
            break;
        default:
        ...
        case 3: {
            ...
            cldnn::layout mutableLayoutSecond =
                cldnn::layout(cldnn::element_type_to_data_type(mutable_precision_second),
            ...
            auto nms_mutable_prim_second =
                cldnn::mutable_data(non_max_suppression_mutable_id_w_second, shared_memory.back());
        ...
        case 2: {
            ...
            cldnn::layout mutableLayoutFirst =
                cldnn::layout(cldnn::element_type_to_data_type(mutable_precision_first),
                              cldnn::format::bfyx,
            ...
            auto nms_mutable_prim_first =
                cldnn::mutable_data(non_max_suppression_mutable_id_w_first, shared_memory.back());
        ...
        case 1:
            break;
        default:
            OPENVINO_THROW("Incorrect number of output for layer: ", op->get_friendly_name());
        }
        ...
        switch (num_outputs) {
        case 3:
            prim.third_output = inputs[inputs.size() - 2].pid;
        case 2:
            prim.second_output = inputs[inputs.size() - 1].pid;
        default:
            break;
        }
