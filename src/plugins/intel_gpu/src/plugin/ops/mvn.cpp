...
static void CreateCommonMVNOp(ProgramBuilder& p,
    ...
    auto mvnPrim = cldnn::mvn(layerName, inputs[0], normalize_variance, eps, eps_inside_sqrt, axes);
...
static void CreateMVNOp(ProgramBuilder& p, const std::shared_ptr<ov::op::v6::MVN>& op) {
    ...
    OPENVINO_ASSERT(inConst != nullptr,
