...
using ReadValueAssignParams = std::tuple<InputShape,        // input shapes
...
const std::vector<InputShape> input_shapes_dyn = {{{-1, -1, -1, -1}, {{7, 4, 20, 20}, {19, 4, 20, 20}}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_ReadValueAssign_Static,
    ReadValueAssignGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_ReadValueAssign_Dynamic,
                         ReadValueAssignGPUTest,
                         ::testing::Combine(::testing::ValuesIn(input_shapes_dyn), ::testing::Values(ov::element::i32)),
                         ReadValueAssignGPUTest::getTestCaseName);
}  // namespace
