...
protected:
    ...
    void SetUp() override {
        ...
        auto concatEmptyInputEmptyOutputOp = std::make_shared<ov::op::v0::Concat>(
            ov::NodeVector{convertEmptyInputOp, convertEmptyInputOp, convertEmptyInputOp},
...
INSTANTIATE_TEST_SUITE_P(smoke_empty_tensor,
                         EmptyTensorDynamicGPUTest,
                         testParams_smoke,
                         EmptyTensorDynamicGPUTest::getTestCaseName);
}  // namespace
