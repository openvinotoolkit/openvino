...
class MatmulWeightsDecompression : public testing::WithParamInterface<MatmulWeightsDecompressionParams>, virtual public ov::test::SubgraphBaseTest {
public:
...
protected:
    ...
    void generate_inputs(const std::vector<ov::Shape>& target_input_static_shapes) override {
        ...
        for (size_t i = 0; i < model_inputs.size(); ++i) {
            ...
            ov::Tensor tensor =
                ov::test::utils::create_and_fill_tensor(model_input.get_element_type(),
...
const std::vector<ShapeParams> input_shapes_basic = {{{{-1, -1, -1}, {{1, 4, 16}, {10, 16, 16}}}, {16, 32}},
                                                     {{{}, {{1, 4, 16}}}, {16, 32}, 2ul},
                                                     {{{}, {{1, 4, 16}}}, {1, 16, 32}},
                                                     {{{}, {{1, 4, 48}}}, {48, 256}},
                                                     {{{}, {{11, 339, 377}}}, {377, 335}}};
...
INSTANTIATE_TEST_SUITE_P(
    smoke_MatMulCompressedWeights_dyn_quan,
    MatmulWeightsDecompression,
    ::testing::Combine(::testing::Values(ShapeParams{{{-1, -1, 1024}, {{1024, 1, 1024}, {1, 1, 1024}, {1024, 1, 1024}}}, {1024, 1024}, 128}),  // shape
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_dyn_quan_precomputed_reduction,
                         MatmulWeightsDecompression,
                         ::testing::Combine(::testing::Values(ShapeParams{{{-1, -1, 1024}, {{1024, 1, 1024}}}, {1024, 1024}, 128}),  // shape
                                            ::testing::Values(ov::element::u4),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(false),
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_dyn_quan_unaligned,  // dyn_quan is turned off because of innermost-shape
                         MatmulWeightsDecompression,
                         ::testing::Combine(::testing::ValuesIn({ShapeParams{{{-1, -1, 1008}, {{1, 1, 1008}}}, {1008, 1024}, 1008}}),  // shape
                                            ::testing::Values(ov::element::u4),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(false),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_MatMulCompressedWeights_dyn_quan_no_slm,
    MatmulWeightsDecompression,
    ::testing::Combine(::testing::Values(ShapeParams{{{-1, -1, 1024}, {{2, 1, 1024}, {1, 1, 1024}, {2, 1, 1024}}}, {1024, 1}, 128}),  // shape
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_3D_weight,
                         MatmulWeightsDecompression,
                         ::testing::Combine(::testing::Values(ShapeParams{{{-1, -1, 32}, {{32, 128, 32}}}, {32, 32, 1024}, 32}),
                                            ::testing::Values(ov::element::u4),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(false),
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_dyn_quan_mxfp8,
                         MatmulWeightsDecompression,
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_dyn_quan_fp8,
                         MatmulWeightsDecompression,
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_dyn_quan_mxfp4,
                         MatmulWeightsDecompression,
                         ::testing::Combine(::testing::Values(ShapeParams{{{-1, -1, 4096}, {{1, 1, 4096}, {8, 1, 4096}}}, {4096, 1024}, 32}),  // shape
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_dyn_quan_fp4,
                         MatmulWeightsDecompression,
                         ::testing::Combine(::testing::Values(ShapeParams{{{-1, -1, 128}, {{2, 1, 128}, {1, 1, 128}, {2, 1, 128}}}, {128, 16}, 128}),  // shape
                                            ::testing::ValuesIn({ov::element::f4e2m1}),
                                            ::testing::Values(ov::element::f16),
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_dyn_quan_precomputed_reduction_with_gs16,
                         MatmulWeightsDecompression,
                         ::testing::Combine(::testing::Values(ShapeParams{{{-1, -1, 128}, {{128, 1, 128}}}, {128, 128}, 16}),  // shape
                                            ::testing::Values(ov::element::u8),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(false),
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulCompressedWeights_input_4d,
                         MatmulWeightsDecompression,
                         ::testing::Combine(::testing::Values(ShapeParams{{{1, 1, -1, 2048}, {{1, 1, 2, 2048}}}, {2048, 512}, 32}),  // shape
                                            ::testing::Values(ov::element::u4),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(ov::element::f16),
                                            ::testing::Values(false),
 ...
 */
class MatmulSharedDynQuantMultipleFC : public testing::WithParamInterface<uint64_t>, virtual public ov::test::SubgraphBaseTest {
public:
...
protected:
    std::shared_ptr<ov::Node> make_compressed_weights(size_t input_channels, size_t output_channels, const ov::element::Type& data_precision) {
    ...
    void SetUp() override {
        ...
        InputShape data_shape = {{-1, -1, static_cast<ov::Dimension::value_type>(hidden)}, {{1, 64, hidden}, {1, 256, hidden}}};
