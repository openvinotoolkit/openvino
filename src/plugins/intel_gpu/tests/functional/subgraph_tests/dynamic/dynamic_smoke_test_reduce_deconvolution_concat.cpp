...
protected:
    ...
    void SetUp() override {
        ...
        auto deconvOp = ov::test::utils::make_convolution_backprop_data(params[0],
                                                                        model_type,
                                                                        {2, 2, 2},
                                                                        {2, 2, 2},
                                                                        {0, 0, 0},
        ...
        auto reduceOp =
            ov::test::utils::make_reduce(params[1], reduceAxesNode, false, ov::test::utils::ReductionType::Max);
        ...
        auto transposeOrderNode =
            std::make_shared<ov::op::v0::Constant>(ov::element::i64, ov::Shape({5}), transpose_order);
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamic_reduce_deconv_concat,
                         ReduceDeconvConcatDynamicGPUTest,
                         testParams_smoke,
                         ReduceDeconvConcatDynamicGPUTest::getTestCaseName);
}  // namespace
