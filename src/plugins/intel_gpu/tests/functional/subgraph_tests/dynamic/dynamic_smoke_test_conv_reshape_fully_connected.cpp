...
class ConvReshapeFullyConnectedDynamicGPUTestDynamic
    : public testing::WithParamInterface<convReshapeFullyConnectedDynamicGPUTestDynamicParamsSet>,
      virtual public ov::test::SubgraphBaseTest {
public:
    static std::string getTestCaseName(
        const testing::TestParamInfo<convReshapeFullyConnectedDynamicGPUTestDynamicParamsSet>& obj) {
...
protected:
    void SetUp() override {
        ...
        auto convolutionOp = ov::test::utils::make_convolution(inputParams.front(),
                                                               model_type,
                                                               {3, 3, 3},
                                                               {1, 1, 1},
                                                               {1, 1, 1},
        ...
        auto transposeOrderNode =
            std::make_shared<ov::op::v0::Constant>(ov::element::i64, ov::Shape({4}), transpose_order);
        ...
        std::shared_ptr<ov::Node> fakequantizeOp1 = ov::test::utils::make_fake_quantize(convertOp1,
                                                                                        ov::element::f32,
                                                                                        256,
                                                                                        {},
                                                                                        {0.0f},
        ...
        std::shared_ptr<ov::Node> fakequantizeOp2 = ov::test::utils::make_fake_quantize(convertOp2,
                                                                                        ov::element::f32,
                                                                                        256,
                                                                                        {},
                                                                                        {-1.28f},
...
const std::vector<ov::test::InputShape> dynInputShapes3D = {
    {{ov::Dimension::dynamic(), 64, 1, ov::Dimension::dynamic(), ov::Dimension::dynamic()}, {{1, 64, 1, 1, 1}}},
};
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamic_conv_reshape_fullyconnected,
                         ConvReshapeFullyConnectedDynamicGPUTestDynamic,
                         testParams_smoke,
                         ConvReshapeFullyConnectedDynamicGPUTestDynamic::getTestCaseName);
}  // namespace
