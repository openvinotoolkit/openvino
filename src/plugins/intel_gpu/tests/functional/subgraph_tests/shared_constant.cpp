...
namespace {
// Validate scenario where a single Constant has multiple users (like one constant is used for Convolution,
// ConvolutionBackpropData, Multiply, etc.)
...
protected:
    void SetUp() override {
        ...
        auto conv = std::make_shared<ov::op::v1::Convolution>(input1,
                                                              constant,
                                                              ov::Strides{1, 1},
        ...
        auto convBprop = std::make_shared<ov::op::v1::ConvolutionBackpropData>(input2,
                                                                               constant,
                                                                               ov::Strides{1, 1},
                                                                               ov::CoordinateDiff{0, 0},
                                                                               ov::CoordinateDiff{0, 0},
        ...
        auto groupConvBprop = std::make_shared<ov::op::v1::GroupConvolutionBackpropData>(input3,
                                                                                         constantGroupConv,
                                                                                         ov::Strides{1, 1},
                                                                                         ov::CoordinateDiff{0, 0},
                                                                                         ov::CoordinateDiff{0, 0},
