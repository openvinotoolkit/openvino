    ...
    void SetUp() override {
        ...
        switch (ti_body) {
            case ngraph::helpers::TensorIteratorBody::LSTM: {
                ...
                auto outer_params = ov::test::utils::builder::make_params(ngPrc, {inputShapes[0], inputShapes[1], inputShapes[2]});

                // 1. Create TensorIterator body.
                inputShapes[0][sequence_axis] = 1; // sliced dimension
                auto body_params = ov::test::utils::builder::make_params(ngPrc, {inputShapes[0], inputShapes[1], inputShapes[2]});
            ...
            case ngraph::helpers::TensorIteratorBody::GRU: {
                ...
                auto outer_params = ov::test::utils::builder::make_params(ngPrc, {inputShapes[0], inputShapes[1]});

                // 1. Create TensorIterator body.
                inputShapes[0][sequence_axis] = 1; // sliced dimension
                auto body_params = ov::test::utils::builder::make_params(ngPrc, {inputShapes[0], inputShapes[1]});
