...
using poolLayerGpuTestParamsSet = std::tuple<ov::test::poolSpecificParams, InputShape, ov::element::Type>;
...
protected:
    void SetUp() override {
        ...
        if (ov::test::utils::PoolingTypes::MAX == poolType) {
            pooling = std::make_shared<ov::op::v1::MaxPool>(poolInput,
                                                            stride,
                                                            padBegin,
                                                            padEnd,
                                                            kernel,
            ...
            pooling = std::make_shared<ov::op::v1::AvgPool>(poolInput,
                                                            stride,
                                                            padBegin,
                                                            padEnd,
                                                            kernel,
...
const std::vector<InputShape> inputShapes3D = {{{}, {{3, 4, 64}}},
                                               {{}, {{2, 8, 12}}},
                                               {{}, {{1, 16, 12}}},
                                               {{}, {{1, 21, 4}}},
                                               {{}, {{1, 32, 8}}},
                                               {// dynamic
                                                {-1, -1, -1},
                                                // target
                                                {{1, 32, 8}, {1, 21, 4}, {2, 8, 12}}},
                                               {// dynamic
                                                {{1, 5}, {4, 32}, {1, 64}},
                                                // target
                                                {{3, 4, 64}, {1, 16, 12}, {1, 32, 8}}}};

const std::vector<InputShape> inputShapes4D = {{{}, {{3, 4, 64, 64}}},
                                               {{}, {{2, 8, 8, 12}}},
                                               {{}, {{1, 16, 16, 12}}},
                                               {{}, {{1, 21, 8, 4}}},
                                               {{}, {{1, 32, 8, 8}}},
                                               {// dynamic
                                                {-1, -1, -1, -1},
                                                // target
                                                {{1, 32, 8, 8}, {1, 21, 8, 4}, {2, 8, 8, 12}}},
                                               {// dynamic
                                                {{1, 5}, {4, 32}, {1, 64}, {1, 64}},
                                                // target
                                                {{3, 4, 64, 64}, {1, 16, 16, 12}, {1, 32, 8, 8}}},
                                               {// dynamic
                                                {{1, 10}, 16, 8, 8},
                                                // target
                                                {
...
const std::vector<InputShape> inputShapes4D_Large = {
    {// dynamic
     {-1, -1, -1, -1},
     // target
     {{1, 16, 65, 65}, {1, 8, 130, 130}, {1, 16, 65, 65}}},
};

const std::vector<InputShape> inputShapes5D = {{{}, {{1, 4, 16, 16, 16}}},
                                               {{}, {{2, 8, 8, 8, 8}}},
                                               {{}, {{2, 16, 12, 16, 20}}},
                                               {{}, {{1, 19, 16, 20, 8}}},
                                               {{}, {{1, 32, 16, 8, 12}}},
                                               {// dynamic
                                                {-1, -1, -1, -1, -1},
                                                // target
                                                {{2, 8, 8, 8, 8}, {1, 19, 16, 20, 8}, {1, 4, 16, 16, 16}}},
                                               {// dynamic
                                                {{1, 5}, {4, 32}, {1, 64}, {1, 64}, {1, 25}},
                                                // target
                                                {{1, 4, 16, 16, 16}, {1, 32, 16, 8, 12}, {3, 16, 4, 8, 3}}}};

/* ============= Pooling (1D) ============= */
const std::vector<ov::test::poolSpecificParams> paramsMax3D = {
    ov::test::poolSpecificParams{ov::test::utils::PoolingTypes::MAX,
                                 {2},
                                 {2},
                                 {0},
                                 {0},
...
const std::vector<ov::test::poolSpecificParams> paramsAvg3D = {
    ov::test::poolSpecificParams{ov::test::utils::PoolingTypes::AVG,
                                 {3},
                                 {1},
                                 {1},
                                 {0},
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_GPU_3D,
                         PoolingLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_GPU_3D,
                         PoolingLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_GPU_4D,
                         PoolingLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_GPU_4D,
                         PoolingLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_GPU_Large,
                         PoolingLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_GPU_5D,
                         PoolingLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_GPU_5D,
                         PoolingLayerGPUTest,
