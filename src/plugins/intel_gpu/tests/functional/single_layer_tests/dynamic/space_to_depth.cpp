...
const std::vector<ov::Shape> inputShapesBS2_4D = {{1, 16, 8, 8},
                                                  {1, 5, 8, 16},
                                                  {2, 1, 8, 4},
                                                  {1, 32, 4, 4},
                                                  {2, 16, 64, 8}};

const std::vector<ov::Shape> inputShapesBS3_4D = {{1, 1, 27, 27}, {1, 4, 9, 18}, {3, 18, 9, 9}, {2, 18, 3, 3}};

INSTANTIATE_TEST_SUITE_P(
    smoke_GPUSpaceToDepthStaticBS2_4D,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GPUSpaceToDepthStaticBS3_4D,
    SpaceToDepthLayerGPUTest,
...
const std::vector<ov::Shape> inputShapesBS2_5D = {{1, 1, 4, 8, 8},
                                                  {2, 5, 4, 8, 4},
                                                  {4, 1, 4, 4, 4},
                                                  {2, 1, 4, 20, 4},
                                                  {2, 16, 4, 32, 4}};

const std::vector<ov::Shape> inputShapesBS3_5D = {{1, 3, 3, 6, 6},
                                                  {1, 1, 9, 27, 27},
                                                  {2, 1, 3, 3, 3},
                                                  {1, 3, 27, 27, 27}};

INSTANTIATE_TEST_SUITE_P(
    smoke_GPUSpaceToDepthStaticBS2_5D,
    SpaceToDepthLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GPUSpaceToDepthStaticBS3_5D,
    SpaceToDepthLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_GPUSpaceToDepthDynamic4D,
                         SpaceToDepthLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_GPUSpaceToDepthDynamic5D,
                         SpaceToDepthLayerGPUTest,
