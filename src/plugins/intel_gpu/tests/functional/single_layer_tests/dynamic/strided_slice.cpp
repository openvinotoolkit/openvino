...
protected:
    ...
    void SetUp() override {
        ...
        auto ss = std::make_shared<ov::op::v1::StridedSlice>(input_1d,
                                                             beginInput,
                                                             endInput,
                                                             strideInput,
                                                             ssParams.beginMask,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_CompareWithRefs_Plain_Static_2D,
    StridedSliceLayerGPUTest,
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation({{32, 20}})),
...
const std::vector<InputShape> inputShapesDynamic4D = {
    {{-1, -1, -1, -1}, {{1, 5, 32, 32}, {2, 5, 32, 32}, {1, 5, 64, 64}}},

    {{1, 64, -1, -1}, {{1, 64, 16, 32}, {1, 64, 32, 64}, {1, 64, 64, 64}}},

    {{1, -1, 16, 32}, {{1, 16, 16, 32}, {1, 32, 16, 32}, {1, 64, 16, 32}}},
};
...
const std::vector<InputShape> inputShapesDynamic5D = {
    {{-1, -1, -1, -1, -1}, {{1, 5, 32, 32, 32}, {2, 5, 32, 32, 32}, {1, 5, 64, 64, 64}}},

    {{1, 64, -1, -1, -1}, {{1, 64, 1, 16, 32}, {1, 64, 1, 32, 64}, {1, 64, 1, 64, 64}}},

    {{1, -1, 16, 32, -1}, {{1, 16, 16, 32, 1}, {1, 32, 16, 32, 1}, {1, 64, 16, 32, 1}}},
};
...
const std::vector<InputShape> inputShapesDynamic6D = {
    {{-1, -1, -1, -1, -1, -1}, {{1, 5, 5, 32, 32, 32}, {2, 5, 7, 32, 32, 64}, {1, 3, 5, 64, 64, 64}}},

    {{1, -1, 16, 32, -1, -1}, {{1, 16, 16, 32, 1, 32}, {1, 32, 16, 32, 32, 64}, {1, 64, 16, 32, 32, 64}}},
};

INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_Common_Dynamic_6D,
                         StridedSliceLayerGPUTest,
                         ::testing::Combine(::testing::ValuesIn(inputShapesDynamic6D),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_new_axis_3D,
                         StridedSliceLayerReshapeGPUTest,
