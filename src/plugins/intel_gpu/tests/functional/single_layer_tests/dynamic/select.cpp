...
const std::vector<std::vector<InputShape>> inShapesDynamicNumpy = {
    ...
    {{{-1, -1}, {{8, 1}, {8, 3}}},
     ...
     {{-1, -1, -1}, {{9, 1, 1}, {9, 1, 3}}}},
    {{{-1}, {{6}, {3}}}, {{-1, -1, -1, -1}, {{2, 1, 8, 1}, {2, 9, 8, 1}}}, {{-1, -1, -1}, {{9, 1, 1}, {9, 1, 3}}}},
    {{{-1, -1, -1, -1}, {{4, 1, 1, 1}, {5, 5, 5, 1}, {3, 4, 5, 6}}},
     {{-1, -1, -1, -1}, {{1, 8, 1, 1}, {1, 1, 1, 8}, {3, 4, 5, 6}}},
     {{-1, -1, -1}, {{1, 5, 1}, {5, 5, 8}, {4, 5, 6}}}},
    {{{-1, -1, -1, -1}, {{3, 4, 5, 6}}}, {{-1, -1, -1}, {{4, 5, 6}}}, {{-1, -1}, {{5, 6}}}},
    {{{-1}, {{130048}}}, {{-1, -1}, {{2, 130048}}}, {{-1, -1}, {{2, 130048}}}},
};
...
INSTANTIATE_TEST_SUITE_P(smoke_select_CompareWithRefsNumpy_dynamic,
                         SelectLayerGPUTest,
                         numpyCases,
...
const auto rangeNumpyCases = ::testing::Combine(::testing::ValuesIn(inShapesDynamicRangeNumpy),
                                                ::testing::ValuesIn(model_types),
                                                ::testing::Values(ov::op::AutoBroadcastType::NUMPY),
                                                ::testing::Values(ov::test::utils::DEVICE_GPU));

INSTANTIATE_TEST_SUITE_P(smoke_select_CompareWithRefsNumpy_dynamic_range,
                         SelectLayerGPUTest,
                         rangeNumpyCases,
                         SelectLayerGPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_select_CompareWithRefsNone_dynamic,
                         SelectLayerGPUTest,
                         noneCases,
                         SelectLayerGPUTest::getTestCaseName);
}  // namespace
