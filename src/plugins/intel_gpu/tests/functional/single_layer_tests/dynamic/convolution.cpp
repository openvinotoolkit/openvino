...
protected:
    void SetUp() override {
        ...
        if (activationFusing) {
            auto activationNode =
                ov::test::utils::make_activation(convolutionNode, model_type, ov::test::utils::ActivationTypes::Relu);
...
const std::vector<ov::test::InputShape> dynInputShapes1D = {
    {{1, 10, ov::Dimension::dynamic()}, {{1, 10, 20}, {1, 10, 30}, {1, 10, 50}}},
};
...
const std::vector<InputShape> inputShapes1D = {{{}, {{2, 64, 7}}},
                                               {{}, {{1, 67, 7}}},
                                               {// dynamic shape
                                                {-1, 64, {1, 200}},
...
INSTANTIATE_TEST_SUITE_P(smoke_ConvolutionLayerGPUTest_ExplicitPad1D,
                         ConvolutionLayerGPUTestDynamic,
...
const std::vector<ov::test::InputShape> dynInputShapes2D = {
    {{1, 10, ov::Dimension::dynamic(), ov::Dimension::dynamic()}, {{1, 10, 20, 20}, {1, 10, 30, 30}, {1, 10, 40, 20}}},
};

// Specific range causes output static shapeS
const std::vector<ov::test::InputShape> dynInputShapes2D_static_output = {
    {{1, 128, {1, 2}, {1, 2}}, {{1, 128, 1, 1}, {1, 128, 2, 2}}},
};
// ==== Symmetric pad
...
INSTANTIATE_TEST_SUITE_P(smoke_ConvolutionLayerGPUTest_dynamic3DSymPad,
                         ConvolutionLayerGPUTestDynamic,
                         ::testing::Combine(::testing::Combine(::testing::Values(std::vector<size_t>{3, 3, 3}),
