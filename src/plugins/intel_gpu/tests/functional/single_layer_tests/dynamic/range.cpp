...
const std::vector<std::vector<ov::test::InputShape>> dynInputShapes = {{// Inputs for Range
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamic_range_01,
                         RangeDynamicGPUTest,
                         testParams_smoke,
                         RangeDynamicGPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamic_range_02,
                         RangeDynamicGPUTest,
                         testFloatParams_smoke,
                         RangeDynamicGPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamic_diff_types,
                         RangeDynamicGPUTest,
                         testMixedParams_smoke,
                         RangeDynamicGPUTest::getTestCaseName);
}  // namespace
