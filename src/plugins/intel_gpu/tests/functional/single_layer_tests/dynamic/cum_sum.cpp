...
typedef std::tuple<ov::element::Type,  // data type
...
protected:
    void SetUp() override {
        ...
        auto axisNode =
            std::make_shared<ov::op::v0::Constant>(ov::element::i32, ov::Shape{}, std::vector<int64_t>{axis});
...
const auto testCasesAxis_0 = ::testing::Combine(::testing::ValuesIn(model_type),
...
const auto testCasesAxis_1 =
    ::testing::Combine(::testing::ValuesIn(model_type),
...
INSTANTIATE_TEST_SUITE_P(smoke_cum_sum_axis_0_CompareWithRefs_dynamic,
                         CumSumLayerGPUTest,
                         testCasesAxis_0,
                         CumSumLayerGPUTest::getTestCaseName);
INSTANTIATE_TEST_SUITE_P(smoke_cum_sum_axis_1_CompareWithRefs_dynamic,
                         CumSumLayerGPUTest,
                         testCasesAxis_1,
                         CumSumLayerGPUTest::getTestCaseName);
INSTANTIATE_TEST_SUITE_P(smoke_cum_sum_axis_2_CompareWithRefs_dynamic,
                         CumSumLayerGPUTest,
                         testCasesAxis_2,
                         CumSumLayerGPUTest::getTestCaseName);
INSTANTIATE_TEST_SUITE_P(smoke_cum_sum_axis_3_CompareWithRefs_dynamic,
                         CumSumLayerGPUTest,
                         testCasesAxis_3,
                         CumSumLayerGPUTest::getTestCaseName);
INSTANTIATE_TEST_SUITE_P(smoke_cum_sum_axis_4_CompareWithRefs_dynamic,
                         CumSumLayerGPUTest,
                         testCasesAxis_4,
                         CumSumLayerGPUTest::getTestCaseName);
INSTANTIATE_TEST_SUITE_P(smoke_cum_sum_axis_5_CompareWithRefs_dynamic,
                         CumSumLayerGPUTest,
                         testCasesAxis_5,
                         CumSumLayerGPUTest::getTestCaseName);
INSTANTIATE_TEST_SUITE_P(smoke_cum_sum_neg_axes_CompareWithRefs_dynamic,
                         CumSumLayerGPUTest,
