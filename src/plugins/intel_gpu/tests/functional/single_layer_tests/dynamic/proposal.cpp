...
> ProposalLayerGPUTestParams;

class ProposalLayerGPUTest : public testing::WithParamInterface<ProposalLayerGPUTestParams>,
                             virtual public ov::test::SubgraphBaseTest {
public:
    static std::string getTestCaseName(testing::TestParamInfo<ProposalLayerGPUTestParams> obj) {
...
TEST_P(ProposalLayerGPUTest, CompareWithRefs) {
...
INSTANTIATE_TEST_SUITE_P(smoke_Proposal_Static_Test_Case1, ProposalLayerGPUTest,
                         ...
                         ProposalLayerGPUTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_Proposal_Dynamic_Test_Case1, ProposalLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Proposal_Static_Test_Case2, ProposalLayerGPUTest,
                         ::testing::Combine(::testing::ValuesIn(static_shapes_to_test_representation(staticInputShapesCase2)),
                                            proposalParamsCase2,
                                            ::testing::ValuesIn(netPrecision)),
                         ProposalLayerGPUTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_Proposal_Dynamic_Test_Case2, ProposalLayerGPUTest,
