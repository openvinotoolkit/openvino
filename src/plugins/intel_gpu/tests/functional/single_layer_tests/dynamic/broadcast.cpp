...
typedef std::tuple<std::vector<InputShape>,  // Shapes
...
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_1d_explicit_compareWithRefs_dynamic,
                         ...
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes1D_explicit),
                                            ::testing::ValuesIn(std::vector<std::vector<int64_t>>{{4, 7, 3},
                                                                                                  {2, 7, 4, 3, 6}}),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_broadcast_1d_numpy_compareWithRefs_dynamic,
    BroadcastLayerGPUTest,
...
// ==============================================================================
// 2D
const std::vector<std::vector<InputShape>> dynamicInputShapes2D_explicit = {{{{-1, -1}, {{3, 5}}}}};
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_2d_explicit_compareWithRefs_dynamic,
                         BroadcastLayerGPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes2D_explicit),
                                            ::testing::ValuesIn(std::vector<std::vector<int64_t>>{{3, 4, 5},
                                                                                                  {3, 6, 5, 7}}),
...
const std::vector<std::vector<InputShape>> dynamicInputShapes2D = {{{{-1, -1}, {{3, 1}, {3, 5}}}}};
...
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_3d_explicit_compareWithRefs_dynamic,
                         BroadcastLayerGPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes3D_explicit),
                                            ::testing::ValuesIn(std::vector<std::vector<int64_t>>{{4, 5, 6},
                                                                                                  {4, 5, 6, 2, 3}}),
...
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_3d_numpy_compareWithRefs_dynamic,
                         BroadcastLayerGPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes3D),
                                            ::testing::ValuesIn(std::vector<std::vector<int64_t>>{{4, 5, 6},
                                                                                                  {2, 4, 5, 1}}),
                                            ::testing::Values(std::vector<int64_t>{}),
                                            ::testing::Values(ov::op::BroadcastType::NUMPY),
...
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_4d_explicit_compareWithRefs_dynamic,
                         BroadcastLayerGPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes4D_explicit),
                                            ::testing::ValuesIn(std::vector<std::vector<int64_t>>{{1, 16, 2, 1, 7},
                                                                                                  {1, 16, 2, 1, 7, 3}}),
...
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_4d_numpy_compareWithRefs_dynamic,
                         ...
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes4D),
                                            ::testing::ValuesIn(std::vector<std::vector<int64_t>>{{2, 4, 1, 3},
                                                                                                  {3, 2, 2, 4, 1, 3}}),
                                            ::testing::Values(std::vector<int64_t>{}),
                                            ::testing::Values(ov::op::BroadcastType::NUMPY),
                                            ::testing::ValuesIn(inputPrecisionsFloat),
...
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_5d_explicit_compareWithRefs_dynamic,
                         BroadcastLayerGPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes5D_explicit),
...
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_5d_numpy_compareWithRefs_dynamic,
                         ...
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes5D),
                                            ::testing::ValuesIn(std::vector<std::vector<int64_t>>{{8, 4, 1, 7, 3},
                                                                                                  {8, 4, 5, 7, 3}}),
                                            ::testing::Values(std::vector<int64_t>{}),
                                            ::testing::Values(ov::op::BroadcastType::NUMPY),
                                            ::testing::ValuesIn(inputPrecisionsFloat),
...
INSTANTIATE_TEST_SUITE_P(smoke_broadcast_6d_numpy_compareWithRefs_dynamic,
                         BroadcastLayerGPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes6D),
                                            ::testing::ValuesIn(std::vector<std::vector<int64_t>>{{8, 4, 1, 7, 16, 3},
                                                                                                  {8, 4, 5, 7, 16, 3}}),
                                            ::testing::Values(std::vector<int64_t>{}),
                                            ::testing::Values(ov::op::BroadcastType::NUMPY),
                                            ::testing::ValuesIn(inputPrecisionsInt),
