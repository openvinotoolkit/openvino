...
typedef std::tuple<bool,                  // varianceEncodedInTarget
                   bool,                  // shareLocation
                   bool,                  // normalized
                   size_t,                // inputHeight
                   size_t,                // inputWidth
...
typedef std::tuple<int,               // numClasses
...
typedef std::tuple<DetectionOutputAttributes,
                   ParamsWhichSizeDependsDynamic,
    ...
    void SetUp() override {
        ...
        if (attrs.num_classes == -1) {
            ...
            if (params.size() == 3)
                ...
                detOut = std::make_shared<ov::op::v8::DetectionOutput>(params[0],
                                                                       params[1],
                                                                       params[2],
                                                                       params[3],
                                                                       params[4],
...
const auto commonAttributes1 = ::testing::Combine(::testing::Values(numClasses[0]),
...
const auto commonAttributes2 = ::testing::Combine(::testing::Values(numClasses[0]),
                                                  ::testing::Values(backgroundLabelId),
...
const auto commonAttributes_v8 = ::testing::Combine(::testing::Values(numClasses[1]),
                                                    ::testing::Values(backgroundLabelId),
                                                    ::testing::Values(topK[0]),
                                                    ::testing::Values(keepTopK[0]),
                                                    ::testing::ValuesIn(codeType),
...
const auto params3InputsDynamic1 = ::testing::Combine(commonAttributes1,
...
const auto params3InputsDynamic2 = ::testing::Combine(commonAttributes2,
...
const auto params3InputsDynamic_v8 = ::testing::Combine(commonAttributes_v8,
                                                        ::testing::Values(specificParams3InDynamic[0]),
                                                        ::testing::ValuesIn(numberBatch),
                                                        ::testing::Values(objectnessScore),
                                                        ::testing::Values(true),
...
INSTANTIATE_TEST_SUITE_P(smoke_GPUDetectionOutputDynamic3In1,
                         DetectionOutputLayerGPUTest,
                         params3InputsDynamic1,
                         DetectionOutputLayerGPUTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_GPUDetectionOutputDynamic3In2,
                         DetectionOutputLayerGPUTest,
                         params3InputsDynamic2,
                         DetectionOutputLayerGPUTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_GPUDetectionOutputV8Dynamic3In,
                         DetectionOutputLayerGPUTest,
