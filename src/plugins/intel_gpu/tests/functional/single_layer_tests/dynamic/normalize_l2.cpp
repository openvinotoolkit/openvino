...
using NormalizeL2LayerGPUTestParams = std::tuple<InputShape,            // Input shapes
...
const std::vector<ov::op::EpsMode> epsMode = {ov::op::EpsMode::ADD, ov::op::EpsMode::MAX};

const std::vector<float> epsilon = {0.000000001};
...
const auto NormalizeL2_3D = ::testing::Combine(::testing::ValuesIn(inputShapes_3D),
                                               ::testing::ValuesIn(nrtPrecision),
                                               ::testing::ValuesIn({reduction_axes_12, reduction_axes_2}),
                                               ::testing::ValuesIn(epsMode),
                                               ::testing::ValuesIn(epsilon));

INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_NormalizeL2_3D,
                         NormalizeL2LayerGPUTest,
                         NormalizeL2_3D,
                         NormalizeL2LayerGPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_NormalizeL2_4D,
                         NormalizeL2LayerGPUTest,
                         NormalizeL2_4D,
                         NormalizeL2LayerGPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_NormalizeL2_5D,
                         NormalizeL2LayerGPUTest,
                         NormalizeL2_5D,
                         NormalizeL2LayerGPUTest::getTestCaseName);
