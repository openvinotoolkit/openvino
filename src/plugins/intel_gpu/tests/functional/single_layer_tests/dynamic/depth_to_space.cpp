...
const std::vector<ov::element::Type> input_types = {ov::element::f32, ov::element::f16, ov::element::i8};
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GPUDepthToSpaceStaticBS2_4D,
    DepthToSpaceLayerGPUTest,
    testing::Combine(testing::ValuesIn(ov::test::static_shapes_to_test_representation(inputShapesBS2_4D)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GPUDepthToSpaceStaticBS3_4D,
    DepthToSpaceLayerGPUTest,
    testing::Combine(testing::ValuesIn(ov::test::static_shapes_to_test_representation(inputShapesBS3_4D)),
                     testing::ValuesIn(input_types),
                     testing::ValuesIn(depthToSpaceModes),
                     testing::Values(1, 3)),
    DepthToSpaceLayerGPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GPUDepthToSpaceStaticBS2_5D,
    DepthToSpaceLayerGPUTest,
    testing::Combine(testing::ValuesIn(ov::test::static_shapes_to_test_representation(inputShapesBS2_5D)),
                     testing::ValuesIn(input_types),
                     testing::ValuesIn(depthToSpaceModes),
                     testing::Values(1, 2)),
    DepthToSpaceLayerGPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GPUDepthToSpaceStaticBS3_5D,
    DepthToSpaceLayerGPUTest,
    testing::Combine(testing::ValuesIn(ov::test::static_shapes_to_test_representation(inputShapesBS3_5D)),
                     testing::ValuesIn(input_types),
                     testing::ValuesIn(depthToSpaceModes),
                     testing::Values(1, 3)),
    DepthToSpaceLayerGPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_GPUDepthToSpaceDynamic4D,
                         DepthToSpaceLayerGPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_GPUDepthToSpaceDynamic5D,
                         DepthToSpaceLayerGPUTest,
