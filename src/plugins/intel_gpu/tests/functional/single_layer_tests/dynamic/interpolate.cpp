...
using InterpolateSpecificParams =
    std::tuple<ov::op::v4::Interpolate::InterpolateMode,          // InterpolateMode
...
protected:
    ...
    void SetUp() override {
        ...
        if (shapeCalcMode == ov::op::v4::Interpolate::ShapeCalcMode::SCALES) {
            if (scalesInputType == ov::test::utils::InputLayerType::PARAMETER) {
                auto paramNode =
                    std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::Shape{scales.front().size()});
                params.push_back(paramNode);
                scalesInput = paramNode;
            } else {
                scalesInput = std::make_shared<ov::op::v0::Constant>(ov::element::f32,
                                                                     ov::Shape{scales.front().size()},
                                                                     scales.front());
            }
            if (sizesInputType == ov::test::utils::InputLayerType::PARAMETER) {
                auto paramNode =
                    std::make_shared<ov::op::v0::Parameter>(ov::element::i32, ov::Shape{sizes.front().size()});
                params.push_back(paramNode);
                sizesInput = paramNode;
            } else {
                sizesInput = std::make_shared<ov::op::v0::Constant>(ov::element::i32,
        ...
        if (useInterpolateV11) {
            ...
            interpolate =
                std::make_shared<ov::op::v4::Interpolate>(params[0], sizesInput, scalesInput, axesInput, interpAttr);
        }
...
const std::vector<std::vector<int64_t>> reducedAxes4D = {{2, 3}, {3}};

const std::vector<ShapeParams> shapeParams4D_Smoke = {
    ShapeParams{ov::op::v4::Interpolate::ShapeCalcMode::SCALES,
    ...
    ShapeParams{ov::op::v4::Interpolate::ShapeCalcMode::SCALES,
                ...
                {{0.5f, 2.0f}},
                reducedAxes4D.front()},
    ShapeParams{ov::op::v4::Interpolate::ShapeCalcMode::SIZES,
                InputShape{{-1, {2, 20}, -1, -1}, {{1, 11, 4, 4}, {2, 7, 6, 5}, {1, 11, 4, 4}}},
                ov::test::utils::InputLayerType::PARAMETER,
                ov::test::utils::InputLayerType::CONSTANT,
...
const auto interpolateCasesNN_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v4::Interpolate::InterpolateMode::NEAREST),
...
const auto interpolateCasesLinearOnnx_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v4::Interpolate::InterpolateMode::LINEAR_ONNX),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
...
const auto interpolateCasesLinear_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v4::Interpolate::InterpolateMode::LINEAR),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
                       ::testing::ValuesIn(pads4D),
...
const auto interpolateCasesCubic_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v4::Interpolate::InterpolateMode::CUBIC),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
                       ::testing::ValuesIn(pads4D),
...
const std::vector<std::vector<int64_t>> reducedAxes5D = {{2, 3, 4}};
