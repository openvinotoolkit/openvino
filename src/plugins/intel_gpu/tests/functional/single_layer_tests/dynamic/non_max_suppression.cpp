...
protected:
    void SetUp() override {
        ...
        auto maxOutBoxesPerClassNode =
            std::make_shared<ov::op::v0::Constant>(maxBoxPrec, ov::Shape{}, std::vector<int32_t>{maxOutBoxesPerClass});
        ...
        auto softNmsSigmaNode =
            std::make_shared<ov::op::v0::Constant>(thrPrec, ov::Shape{}, std::vector<float>{softNmsSigma});
...
INSTANTIATE_TEST_SUITE_P(smoke_Nms_dynamic,
                         NmsLayerGPUTest,
