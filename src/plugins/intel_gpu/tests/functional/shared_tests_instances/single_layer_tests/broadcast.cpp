...
const std::vector<ov::element::Type> inputTPrecisions = {ov::element::f16, ov::element::i16, ov::element::boolean};
...
std::vector<std::vector<ov::Shape>> input_shapes_1d_static = {{{1}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_TestNumpyBroadcast1D,
    BroadcastLayerTest,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_PrecTransformation,
    BroadcastLayerTest,
    ::testing::Combine(::testing::Values(targetShapesNumpy1D[0]),
                       ::testing::Values(ov::AxisSet{}),  // not used in numpy mode
                       ::testing::Values(ov::op::BroadcastType::NUMPY),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_1d_static)),
...
std::vector<std::vector<ov::Shape>> input_shapes_2d_static = {{{3, 1}}};
...
std::vector<std::vector<ov::Shape>> input_shapes_3d_static = {{{1, 4, 1}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_TestNumpyBroadcast3D,
    BroadcastLayerTest,
...
std::vector<std::vector<ov::Shape>> input_shapes_6d_static = {{{1, 2, 1, 4, 1, 6}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_TestNumpyBroadcast6D,
    BroadcastLayerTest,
...
std::vector<std::vector<ov::Shape>> input_shapes_5d_static = {{{1, 2, 1, 4, 1}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_TestNumpyBroadcast5D,
    BroadcastLayerTest,
...
std::vector<std::vector<size_t>> targetShapesBidi = {{4, 1, 4}, {1, 4, 4}, {1, 1, 4, 4}};
