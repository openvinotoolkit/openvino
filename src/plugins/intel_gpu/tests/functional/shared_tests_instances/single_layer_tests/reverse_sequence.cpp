...
const std::vector<ov::element::Type> netPrecisions =
    {ov::element::f32, ov::element::f16, ov::element::u8, ov::element::i8, ov::element::u16, ov::element::i32};
...
INSTANTIATE_TEST_SUITE_P(Basic_smoke,
                         ReverseSequenceLayerTest,
                         ::testing::Combine(::testing::ValuesIn(batchAxisIndices),
