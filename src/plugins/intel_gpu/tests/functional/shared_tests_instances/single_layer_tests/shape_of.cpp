...
const std::vector<ov::element::Type> model_precisions = {ov::element::f32, ov::element::i32};

const std::vector<std::vector<ov::Shape>> input_shapes = {{{1, 2, 3, 4, 5}}, {{1, 2, 3, 4}}, {{1, 2}}};
