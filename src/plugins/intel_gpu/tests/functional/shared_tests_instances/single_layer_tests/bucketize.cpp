...
const std::vector<ov::element::Type> out_precision = {ov::element::i32, ov::element::i64};

const std::vector<ov::element::Type> in_buckets_precision =
    {ov::element::f16, ov::element::f32, ov::element::i32, ov::element::i64, ov::element::i8, ov::element::u8};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(
        ...
        testing::Values(ov::element::f16, ov::element::i32, ov::element::i64, ov::element::i8, ov::element::u8),
        testing::ValuesIn(out_precision),
        testing::Values(ov::test::utils::DEVICE_GPU)),
    BucketizeLayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(
    smoke_Bucketize_input_fp32,
    BucketizeLayerTest,
    testing::Combine(
        testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_static)),
        testing::ValuesIn(with_right_bound),
        testing::Values(ov::element::f32),
        testing::Values(ov::element::f32, ov::element::i32, ov::element::i64, ov::element::i8, ov::element::u8),
        testing::ValuesIn(out_precision),
        testing::Values(ov::test::utils::DEVICE_GPU)),
    BucketizeLayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(
    smoke_Bucketize_input_i32,
    BucketizeLayerTest,
