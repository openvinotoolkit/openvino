...
const auto groupConv1DParams_ExplicitPadding = ::testing::Combine(::testing::ValuesIn(kernels1D),
...
INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolution1D_ExplicitPadding_Disabled,
                         GroupConvolutionLayerTest,
                         ::testing::Combine(groupConv1DParams_ExplicitPadding,
...
const auto dwConv1DParams_ExplicitPadding = ::testing::Combine(::testing::ValuesIn(kernels1D),
                                                               ::testing::ValuesIn(strides1D),
                                                               ::testing::ValuesIn(padBegins1D),
                                                               ::testing::ValuesIn(padEnds1D),
                                                               ::testing::ValuesIn(dilations1D),
...
INSTANTIATE_TEST_SUITE_P(smoke_DwGroupConvolution1D_ExplicitPadding,
                         GroupConvolutionLayerTest,
                         ::testing::Combine(dwConv1DParams_ExplicitPadding,
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(
                                                std::vector<std::vector<ov::Shape>>({{{1, 16, 30}}}))),
                                            ::testing::Values(ov::test::utils::DEVICE_GPU)),
...
const auto groupConv2DParams_ExplicitPadding = ::testing::Combine(::testing::ValuesIn(kernels),
                                                                  ...
                                                                  ::testing::Values(ov::op::PadType::EXPLICIT));
const auto groupConv2DParams_AutoPadValid = ::testing::Combine(::testing::ValuesIn(kernels),
                                                               ::testing::ValuesIn(strides),
...
const auto groupConv2DParams_AutoPadSameUpper = ::testing::Combine(::testing::Values(std::vector<size_t>({1, 5})),
                                                                   ::testing::ValuesIn(strides),
                                                                   ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                                                   ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                                                   ::testing::ValuesIn(dilations),
...
INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolution2D_ExplicitPadding,
                         GroupConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolution2D_AutoPadValid,
                         GroupConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolution2D_AutoPadSameUpper,
                         GroupConvolutionLayerTest,
                         ::testing::Combine(groupConv2DParams_AutoPadSameUpper,
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(
...
const auto groupConv3DParams_ExplicitPadding = ::testing::Combine(::testing::ValuesIn(kernels3d),
                                                                  ...
                                                                  ::testing::Values(2),
                                                                  ::testing::Values(ov::op::PadType::EXPLICIT));
const auto groupConv3DParams_AutoPadValid = ::testing::Combine(::testing::ValuesIn(kernels3d),
                                                               ::testing::ValuesIn(strides3d),
...
INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolution3D_ExplicitPadding,
                         GroupConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolution3D_AutoPadValid,
                         GroupConvolutionLayerTest,
