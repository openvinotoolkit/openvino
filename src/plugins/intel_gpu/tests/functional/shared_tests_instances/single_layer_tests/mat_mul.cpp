...
protected:
    void SetUp() override {
        ...
        std::tie(shapes, transpose_type, model_type, input_layer_type, targetDevice, additional_config) =
            this->GetParam();
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMul_NoTranspose,
                         MatMulLayerTest,
                         ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(
                                                no_transpose_shapeRelatedParams)),
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMul_FirstTranspose,
                         MatMulLayerTest,
                         ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(
                                                first_transpose_shapeRelatedParams)),
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMul_SecondTranspose,
                         MatMulLayerTest,
                         ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(
                                                second_transpose_shapeRelatedParams)),
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMul_BothTranspose,
                         MatMulLayerTest,
                         ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(
                                                both_transpose_shapeRelatedParams)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_MatMul_fc_fb_io_block_f16,
    GPUMatMulLayerTest,
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(fc_f16_shapeRelatedParams)),
                       ::testing::Values(std::make_pair(false, false)),
