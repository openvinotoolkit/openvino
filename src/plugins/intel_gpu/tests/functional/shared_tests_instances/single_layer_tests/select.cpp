...
const std::vector<ov::element::Type> inputPrecision = {ov::element::u8,
                                                       ov::element::f16,
                                                       ov::element::f32,
                                                       ov::element::i16,
                                                       ov::element::i32};

const std::vector<std::vector<ov::Shape>> noneShapes = {{{1}, {1}, {1}},
                                                        {{8}, {8}, {8}},
                                                        {{4, 5}, {4, 5}, {4, 5}},
                                                        {{3, 4, 5}, {3, 4, 5}, {3, 4, 5}},
                                                        {{2, 3, 4, 5}, {2, 3, 4, 5}, {2, 3, 4, 5}}};

const std::vector<std::vector<ov::Shape>> numpyShapes = {{{1}, {16}, {1}},
                                                         {{1}, {1}, {16}},
                                                         {{1}, {8}, {8}},
                                                         {{8}, {1}, {8}},
                                                         {{8}, {8}, {8}},
