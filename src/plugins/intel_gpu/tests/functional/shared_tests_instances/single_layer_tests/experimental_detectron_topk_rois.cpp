...
std::vector<int64_t> maxRois{1000, 1500, 2000};

std::vector<ov::element::Type_t> elementTypes{ov::element::f16, ov::element::f32};
...
INSTANTIATE_TEST_SUITE_P(smoke_ExperimentalDetectronTopKROIs_static,
                         ExperimentalDetectronTopKROIsLayerTest,
