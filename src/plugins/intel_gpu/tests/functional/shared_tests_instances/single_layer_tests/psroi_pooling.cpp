...
const auto params_average = testing::Combine(testing::Values(std::vector<size_t>{3, 8, 16, 16}),  // input shape
...
const auto params_bilinear = testing::Combine(testing::Values(std::vector<size_t>{3, 32, 20, 20}),  // input shape
                                              testing::Values(std::vector<size_t>{10, 5}),          // coords shape
