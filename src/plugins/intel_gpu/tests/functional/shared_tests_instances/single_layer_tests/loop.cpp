...
std::vector<ov::Shape> inputs_0 = {{1, 4, 2}};

INSTANTIATE_TEST_SUITE_P(smoke_StaticShapeLoop_axis_0,
                         StaticShapeLoopLayerTest,
                         testing::Combine(
...
std::vector<ov::Shape> inputs_1 = {{2, 1, 4, 6}};

INSTANTIATE_TEST_SUITE_P(smoke_StaticShapeLoop_axis_1,
                         StaticShapeLoopLayerTest,
                         testing::Combine(
                             /* unrolling */ testing::ValuesIn(std::vector<bool>{false}),
                             /* static_continue_cond */ testing::Values(true),
...
std::vector<ov::Shape> inputs_2 = {{2, 4, 1, 6}};

INSTANTIATE_TEST_SUITE_P(smoke_StaticShapeLoop_axis_2,
                         StaticShapeLoopLayerTest,
                         testing::Combine(
                             /* unrolling */ testing::ValuesIn(std::vector<bool>{false}),
                             /* static_continue_cond */ testing::Values(true),
...
std::vector<ov::Shape> inputs_no_auto_concat = {{4, 20, 12}};

INSTANTIATE_TEST_SUITE_P(smoke_StaticShapeLoop_no_auto_concat,
                         StaticShapeLoopLayerTest,
                         testing::Combine(
                             /* unrolling */ testing::ValuesIn(std::vector<bool>{false}),
                             /* static_continue_cond */ testing::Values(true),
...
std::vector<ov::Shape> inputs_dynamic_exit = {{4, 1, 2}};

INSTANTIATE_TEST_SUITE_P(smoke_StaticShapeLoop_dynamic_exit,
                         StaticShapeLoopLayerTest,
                         testing::Combine(
                             /* unrolling */ testing::ValuesIn(std::vector<bool>{false}),
                             /* static_continue_cond */ testing::Values(true),
