...
const auto GatherIndiceScalar = []() {
    return testing::Combine(
        testing::Values(ov::test::static_shapes_to_test_representation(std::vector<ov::Shape>({{1, 3, 4, 5}}))),
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather7Axes4i4b1,
                         Gather7LayerTest,
                         GatherAxes4i4b1(),
                         Gather7LayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_Gather7Axes4i4b2,
                         Gather7LayerTest,
                         GatherAxes4i4b1(),
                         Gather7LayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_Gather7Axes4i8b1,
                         Gather7LayerTest,
                         GatherAxes4i8b1(),
                         Gather7LayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_Gather7Axes4i8b2,
                         Gather7LayerTest,
                         GatherAxes4i8b2(),
                         Gather7LayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_GatherIndiceScalar,
...
const std::vector<ov::Shape> indicesShapes12 = {{4}, {2, 2}};
...
INSTANTIATE_TEST_SUITE_P(smoke_GatherAxes4, GatherLayerTest, GatherAxes4(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather6dAxes4, GatherLayerTest, Gather6dAxes4(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_GatherAxes3, GatherLayerTest, GatherAxes3(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather6dAxes3, GatherLayerTest, Gather6dAxes3(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_GatherAxes2, GatherLayerTest, GatherAxes2(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather6dAxes2, GatherLayerTest, Gather6dAxes2(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_GatherAxes1, GatherLayerTest, GatherAxes1(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather6dAxes1, GatherLayerTest, Gather6dAxes1(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_GatherAxes0, GatherLayerTest, GatherAxes0(), GatherLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather6dAxes0, GatherLayerTest, Gather6dAxes0(), GatherLayerTest::getTestCaseName);

const auto GatherAxes0Optimized = []() {
    return testing::Combine(testing::ValuesIn(ov::test::static_shapes_to_test_representation(
                                std::vector<std::vector<ov::Shape>>({{{4, 8, 2, 2}}}))),
                            testing::Values(ov::Shape({})),
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather7Axes0Optimized,
                         Gather8IndiceScalarLayerTest,
...
const auto gatherWithIndicesParams = testing::Combine(testing::Values(dummyParams), testing::ValuesIn(indicesData));
...
std::vector<std::vector<int64_t>> nagativeSingleindicesData = {{-1}, {-2}, {-3}};
...
const auto gatherWithNagativeIndicesParams1 =
    testing::Combine(testing::Values(dummyParams2), testing::ValuesIn(nagativeSingleindicesData));
...
const auto gatherWithNagativeIndicesParams2 =
    testing::Combine(testing::Values(dummyParams3), testing::ValuesIn(nagativeSingleindicesData));
