...
const std::vector<ov::Shape> output_shapes = {{1, 3, 3, 3}, {1, 1, 5, 5}, {2, 1, 10, 10}};

INSTANTIATE_TEST_SUITE_P(smoke_BasicRandomUniform,
                         RandomUniformLayerTest,
                         ::testing::Combine(::testing::ValuesIn(output_shapes),
