...
protected:
    void SetUp() override {
        ...
        std::tie(interpolate_params, model_type, shapes, target_shape, targetDevice, additional_config) =
            this->GetParam();
        ...
        if (targetDevice == "GPU" && (model_type == ov::element::u8 || model_type == ov::element::i8)) {
            rel_threshold = 1.f;
        }
    }
};
...
const std::vector<std::vector<int64_t>> default5dAxes = {{0, 1, 2, 3, 4}};

const std::vector<std::vector<float>> default5dScales = {{1.f, 1.f, 2.f, 2.f, 2.f}};

std::map<std::string, std::string> additional_config = {};

const auto interpolateCasesWithoutNearest = ::testing::Combine(::testing::ValuesIn(modesWithoutNearest),
...
const auto interpolateCasesWithoutNearestEmptyAxes = ::testing::Combine(::testing::ValuesIn(modesWithoutNearest),
                                                                        ::testing::ValuesIn(shapeCalculationMode),
                                                                        ::testing::ValuesIn(coordinateTransformModes),
                                                                        ::testing::ValuesIn(defaultNearestMode),
                                                                        ::testing::ValuesIn(antialias),
...
const auto interpolateCasesNearesMode = ::testing::Combine(::testing::ValuesIn(nearestMode),
                                                           ::testing::ValuesIn(shapeCalculationMode),
                                                           ::testing::ValuesIn(coordinateTransformModes),
...
const auto interpolate5dCasesLinearOnnxMode = ::testing::Combine(::testing::ValuesIn(linearOnnxMode),
                                                                 ::testing::ValuesIn(shapeCalculationMode),
                                                                 ::testing::ValuesIn(coordinateTransformModes),
                                                                 ::testing::ValuesIn(nearestModes),
                                                                 ::testing::ValuesIn(antialias),
...
const auto interpolate5dCasesNearestMode = ::testing::Combine(::testing::ValuesIn(nearestMode),
                                                              ::testing::ValuesIn(shapeCalculationMode),
                                                              ::testing::ValuesIn(coordinateTransformModes),
                                                              ::testing::ValuesIn(nearestModes),
                                                              ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_Interpolate_Basic,
                         InterpolateLayerTest,
                         ::testing::Combine(interpolateCasesWithoutNearest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Interpolate_BasicEmptyAxes,
                         InterpolateLayerTest,
                         ::testing::Combine(interpolateCasesWithoutNearestEmptyAxes,
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(ov::test::static_shapes_to_test_representation(inShapes)),
                                            ::testing::ValuesIn(targetShapes),
                                            ::testing::Values(ov::test::utils::DEVICE_GPU),
...
INSTANTIATE_TEST_SUITE_P(smoke_Interpolate_Nearest,
                         InterpolateLayerTest,
                         ::testing::Combine(interpolateCasesNearesMode,
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(ov::test::static_shapes_to_test_representation(inShapes)),
                                            ::testing::ValuesIn(targetShapes),
                                            ::testing::Values(ov::test::utils::DEVICE_GPU),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Interpolate_5dLinearOnnx,
    GPUInterpolateLayerTest,
    ::testing::Combine(interpolate5dCasesLinearOnnxMode,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    GPUInterpolateLayerTest,
    ::testing::Combine(interpolate5dCasesNearestMode,
                       ::testing::ValuesIn(netOnnx5dPrecisions),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(in5dShapes)),
                       ::testing::ValuesIn(target5dShapes),
                       ::testing::Values(ov::test::utils::DEVICE_GPU),
...
INSTANTIATE_TEST_SUITE_P(smoke_Interpolate_11_Basic,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Interpolate_11_Pillow_Horizontal,
    Interpolate11LayerTest,
    ::testing::Combine(
        ::testing::Combine(
            ::testing::ValuesIn(modesPillow),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Interpolate_11_Pillow_Vertical,
    Interpolate11LayerTest,
    ::testing::Combine(
        ::testing::Combine(
            ::testing::ValuesIn(modesPillow),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Interpolate_11_Pillow_Vertical_BF,
    Interpolate11LayerTest,
    ::testing::Combine(
        ::testing::Combine(
            ::testing::ValuesIn(modesPillow),
