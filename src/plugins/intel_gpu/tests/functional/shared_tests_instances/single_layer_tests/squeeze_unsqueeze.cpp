...
const std::vector<SqueezeOpType> opTypes = {SqueezeOpType::SQUEEZE, SqueezeOpType::UNSQUEEZE};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::ValuesIn(prepare_cases(ov::test::utils::combineParams(axesVectors))),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Basic_emptyAxes,
    SqueezeUnsqueezeLayerTest,
    ::testing::Combine(::testing::ValuesIn(prepare_cases(ov::test::utils::combineParams(emptyAxesVectors))),
