...
const std::vector<std::vector<ov::Shape>> inputShapes = {{{1, 32, 17}},
                                                         {{1, 37, 9}},
                                                         {{1, 16, 5, 8}},
                                                         {{2, 19, 5, 10}},
                                                         {{7, 32, 2, 8}},
...
std::vector<ov::element::Type> dataPrecisions = {ov::element::f32, ov::element::f16};

std::vector<ov::element::Type> idxPrecisions = {ov::element::i32, ov::element::i64};

const std::vector<std::string> epsMode = {"inside_sqrt", "outside_sqrt"};

const std::vector<float> epsilonF = {0.0001f};
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(
        ...
        ::testing::ValuesIn(
            std::vector<std::vector<int>>{{1, 2, 3, 4}, {2, 3, 4}, {-3, -2, -1}, {-1, -4, -2, -3}, {-1}}),
        ::testing::ValuesIn(normalizeVariance),
