...
void MultinomialLayerTestGPU::SetUp() {
    ...
    auto num_samples_const = std::make_shared<ov::op::v0::Constant>(num_samples.get_element_type(),
                                                                    m_num_samples.get_shape(),
                                                                    m_num_samples.data());
...
const std::vector<ov::Tensor> inputTensors = {ov::test::utils::create_and_fill_tensor(ov::element::f32, {1, 32}),
...
const std::vector<ov::Tensor> numSamples = {ov::Tensor(ov::element::i64, {1}, num_samples_2_i64.data()),
                                            ov::Tensor(ov::element::i64, {1}, num_samples_4_i64.data())};

const std::vector<bool> withReplacement = {false, true};

const std::vector<bool> logProbes = {false, true};

const std::vector<std::string> static_dynamic = {"static"};

INSTANTIATE_TEST_SUITE_P(smoke_Multinomial,
