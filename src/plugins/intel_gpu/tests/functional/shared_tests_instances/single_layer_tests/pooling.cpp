...
const std::vector<std::vector<size_t>> dilations = {{1, 1}, {1, 2}};
...
const auto avgPoolExplicitPadCeilRoundingParams =
    ::testing::Combine(::testing::Values(ov::test::utils::PoolingTypes::AVG),
                       ::testing::ValuesIn(kernels),
                       // TODO: Non 1 strides fails in ngraph reference implementation with error "The end corner is out
                       // of bounds at axis 3" thrown in the test body.
                       ::testing::Values(std::vector<size_t>({1, 1})),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_MaxPool8_ExplicitPad_FloorRounding,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_MaxPool8_ExplicitPad_CeilRounding,
    MaxPoolingV8LayerTest,
