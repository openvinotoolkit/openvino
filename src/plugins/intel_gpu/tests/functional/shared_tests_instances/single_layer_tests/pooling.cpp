...
const std::vector<ov::element::Type> netPrecisions_fp_i32 = {ov::element::f32, ov::element::f16, ov::element::i32};

const std::vector<std::vector<size_t>> kernels = {{3, 3}, {3, 5}};
const std::vector<ov::Strides> strides = {{1, 1}, {1, 2}};
const std::vector<ov::Strides> dilations = {{1, 1}, {1, 2}};
...
const auto maxPool_ExplicitPad_FloorRounding_Params =
    ::testing::Combine(::testing::Values(ov::test::utils::PoolingTypes::MAX),
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_ExplicitPad_CeilRounding,
                         PoolingLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_ExplicitPad_CeilRounding,
                         PoolingLayerTest,
...
/* +========== Explicit Pad Floor Rounding ========== */
const auto avgPoolExplicitPadFloorRoundingParams = ::testing::Combine(::testing::Values(ov::test::utils::PoolingTypes::AVG),
                                                                      ::testing::ValuesIn(kernels),
                                                                      ::testing::ValuesIn(strides),
                                                                      ::testing::ValuesIn(padBegins),
                                                                      ::testing::ValuesIn(padEnds),
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_ExplicitPad_FloorRounding,
                         PoolingLayerTest,
...
/* +========== Explicit Pad Floor Rounding ========== */
const auto avgPoolV16ExplicitPadFloorRoundingParams = ::testing::Combine(::testing::ValuesIn(kernels),
                                                                         ::testing::ValuesIn(strides),
                                                                         ::testing::ValuesIn(dilations),
                                                                         ::testing::ValuesIn(padBegins),
                                                                         ::testing::ValuesIn(padEnds),
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool16_ExplicitPad_FloorRounding,
                         AvgPoolingV16LayerTest,
...
const auto allPools_ValidPad_Params =
    ::testing::Combine(::testing::Values(ov::test::utils::PoolingTypes::MAX, ov::test::utils::PoolingTypes::AVG),
                       ::testing::ValuesIn(kernels),
                       ::testing::ValuesIn(strides),
...
////* ========== MaxPool v8 ========== */
///* +========== Explicit Pad Floor Rounding ========== */
const auto maxPool8_ExplicitPad_FloorRounding_Params = ::testing::Combine(::testing::ValuesIn(kernels),
                                                                          ::testing::ValuesIn(strides),
                                                                          ::testing::ValuesIn(dilations),
                                                                          ::testing::ValuesIn(padBegins),
                                                                          ::testing::ValuesIn(padEnds),
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool8_ExplicitPad_FloorRounding,
                         MaxPoolingV8LayerTest,
                         ::testing::Combine(maxPool8_ExplicitPad_FloorRounding_Params,
                                            ::testing::ValuesIn(netPrecisions_fp_i32),
                                            ::testing::Values(ov::test::static_shapes_to_test_representation(inputShapeSmall)),
                                            ::testing::Values(ov::test::utils::DEVICE_GPU)),
...
/* ========== Explicit Pad Ceil Rounding ========== */
const auto maxPool8_ExplicitPad_CeilRounding_Params = ::testing::Combine(::testing::ValuesIn(kernels),
                                                                         ::testing::Values(std::vector<size_t>({1, 1})),
                                                                         ::testing::ValuesIn(dilations),
                                                                         ::testing::ValuesIn(padBegins),
                                                                         ::testing::ValuesIn(padEnds),
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool8_ExplicitPad_CeilRounding,
                         MaxPoolingV8LayerTest,
                         ::testing::Combine(maxPool8_ExplicitPad_CeilRounding_Params,
                                            ::testing::ValuesIn(netPrecisions_fp_i32),
                                            ::testing::Values(ov::test::static_shapes_to_test_representation(inputShapeSmall)),
                                            ::testing::Values(ov::test::utils::DEVICE_GPU)),
                         MaxPoolingV8LayerTest::getTestCaseName);
