...
const std::vector<ov::inplace_vector<size_t>> strides = {{1, 1}, {1, 2}};
const std::vector<ov::inplace_vector<size_t>> dilations = {{1, 1}, {1, 2}};
const std::vector<ov::inplace_vector<size_t>> padBegins = {{0, 0}, {0, 2}};
const std::vector<ov::inplace_vector<size_t>> padEnds = {{0, 0}, {0, 2}};
...
/* ========== Explicit Pad Ceil Rounding ========== */
const auto maxPool8_ExplicitPad_CeilRounding_Params =
