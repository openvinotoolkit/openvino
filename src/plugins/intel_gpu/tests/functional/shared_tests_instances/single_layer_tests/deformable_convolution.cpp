...
const std::vector<ov::element::Type> netPrecisions = {ov::element::f32, ov::element::f16, ov::element::i16};
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_ExplicitPadding,
    ...
    ::testing::Combine(deformableConv2DParams_ExplicitPadding,
                       ...
                       ::testing::Values(ov::test::static_shapes_to_test_representation(
                           std::vector<ov::Shape>({{1, 2, 3, 3}, {1, 16, 2, 2}, {2, 2, 2, 2}, {1, 8, 2, 2}}))),
                       ::testing::Values(ov::test::utils::DEVICE_GPU)),
    DeformableConvolutionLayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_AutoPadValid,
    DeformableConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(deformableConv2DParams_DeformableGroups_AutoPadExplicit,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(std::vector<ov::Shape>(
                           {{1, 16, 66, 66}, {1, 72, 64, 64}, {16, 16, 3, 3}, {1, 36, 64, 64}}))),
                       ::testing::Values(ov::test::utils::DEVICE_GPU)),
    DeformableConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_SingleTestCase,
    DeformableConvolutionLayerTest,
    ::testing::Combine(deformableConv2DParams_SingleTestCase,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(
                           std::vector<ov::Shape>({{1, 3, 30, 30}, {1, 54, 28, 28}, {1, 3, 3, 3}, {1, 27, 28, 28}}))),
                       ::testing::Values(ov::test::utils::DEVICE_GPU)),
    DeformableConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups22,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_Batch2,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups22,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_Batch3,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups22,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_Batch4,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups22,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_2,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups_41,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_2_Batch2,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups_41,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_2_Batch3,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups_41,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_2_Batch4,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups_41,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_3,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups_42,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_3_Batch2,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups_42,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_3_Batch3,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups_42,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_MultipleGroups_3_Batch4,
    DeformableConvolutionLayerTest,
    ::testing::Combine(DeformableConvolution2D_MultipleGroups_42,
                       ::testing::ValuesIn(with_modulated_scalar),
                       ::testing::ValuesIn(netPrecisions),
