...
INSTANTIATE_TEST_SUITE_P(
    smoke_CumSum1D,
    CumSumLayerTest,
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(shape1d)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_CumSumBigDims,
    CumSumLayerTest,
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(inShapesWithBigDims)),
