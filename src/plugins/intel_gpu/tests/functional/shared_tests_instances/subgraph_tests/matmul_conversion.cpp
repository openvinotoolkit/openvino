 ...
 *                   MatMul_0       MatMul_1
 */
class MatmulConversionsSameParent : public testing::WithParamInterface<MatmulConversionParams>,
...
protected:
    std::shared_ptr<ov::Model> init_subgraph(std::vector<ov::PartialShape>& input_shapes,
        ...
        return std::make_shared<ov::Model>(ov::NodeVector{matmul_1}, ov::ParameterVector{input0, input1}, "MatmulConversionsSameParent");
    }
...
const std::vector<std::vector<InputShape>> test_input_shapes = {
    {{{1, 16, 128}, {{1, 16, 128}}}, {{1, 128, 64}, {{1, 128, 64}}}},
};

const std::vector<std::vector<InputShape>> test_input_shapes_transposed = {
    {{{1, 16, 128}, {{1, 16, 128}}}, {{1, 64, 128}, {{1, 64, 128}}}},
};
...
const std::vector<ov::element::Type> test_input_precisions_basic = {ov::element::f32,
                                                                    ov::element::i8};

INSTANTIATE_TEST_SUITE_P(MatmulConversions_basic_1,
                         MatmulConversions,
                         ::testing::Combine(::testing::ValuesIn(test_input_shapes_basic_1),
                                            ::testing::ValuesIn(test_input_precisions_basic),
                                            ::testing::Values(false),
                                            ::testing::Values(false),
                                            ::testing::Values(false),
                                            ::testing::Values(false)),
