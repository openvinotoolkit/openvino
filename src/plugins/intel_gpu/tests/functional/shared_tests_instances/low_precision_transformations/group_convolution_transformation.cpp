...
const std::vector<std::pair<ov::PartialShape, ov::Shape>> inputShapes = {{{1, 6, 24, 24}, {1, 24, 18, 18}}};
...
const std::vector<LayerTestsDefinitions::GroupConvolutionTransformationParam> params = {
    ...
    {3ul,
     ...
     {255ul,
      ov::Shape{3, 8, 1, 1, 1},
      {-127.f, -12.7f, -1.27f, -127.f, -12.7f, -1.27f, -127.f, -12.7f, -127.f, -12.7f, -1.27f, -127.f,
       -12.7f, -1.27f, -127.f, -12.7f, -127.f, -12.7f, -1.27f, -127.f, -12.7f, -1.27f, -127.f, -12.7f},
      {127.f, 12.7f, 1.27f, 127.f, 12.7f, 1.27f, 127.f, 12.7f, 127.f, 12.7f, 1.27f, 127.f,
       12.7f, 1.27f, 127.f, 12.7f, 127.f, 12.7f, 1.27f, 127.f, 12.7f, 1.27f, 127.f, 12.7f},
      {-127.f, -12.7f, -1.27f, -127.f, -12.7f, -1.27f, -127.f, -12.7f, -127.f, -12.7f, -1.27f, -127.f,
       -12.7f, -1.27f, -127.f, -12.7f, -127.f, -12.7f, -1.27f, -127.f, -12.7f, -1.27f, -127.f, -12.7f},
...
namespace depthwise {
const std::vector<std::pair<ov::PartialShape, ov::Shape>> inputShapes = {{{1, 6, 24, 24}, {1, 6, 18, 18}}};
