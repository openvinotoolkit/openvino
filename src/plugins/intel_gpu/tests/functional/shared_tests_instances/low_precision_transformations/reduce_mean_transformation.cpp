...
const std::vector<LayerTestsDefinitions::ReduceMeanTransformationParam> params = {
    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {127.f}}, {}, {}, {{2, 3}, true}, {}},
    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {127.f}}, {}, {}, {{2, 3}, false}, {}},
    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {127.f}}, {}, {}, {{1}, true}, {}},
    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {127.f}}, {}, {}, {{1}, false}, {}},
    {{256ul,
      ov::Shape{1, 3, 1, 1},
      {-127.f, -127.f, -127.f},
      {128.f, 128.f, 128.f},
