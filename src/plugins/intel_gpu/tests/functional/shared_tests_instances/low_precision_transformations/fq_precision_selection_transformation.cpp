...
const std::vector<FakeQuantizePrecisionSelectionTransformationTestValues> testValues = {
    {
        ...
        {ov::element::u8},
        true,
        {{256ul, {}, {0.f}, {25.5f}, {0.f}, {25.5f}}, {255ul, {1, 1, 1, 1}, {0.f}, {254.f}, {-12.7f}, {12.7f}}},
        {ov::element::u8, {256ul, {}, {0.f}, {2.55f}, {0.f}, {255.f}}, {}},
    },
    {
        {ov::element::u8, ov::element::i8},
        {ov::element::i8},
        ...
        {// original precision is used
         ov::element::u8,
         // FakeQuantize has to select the first available: U8, not limited operation required I8 but this fact doesn't
         // affect
...
// GPU issue
INSTANTIATE_TEST_SUITE_P(DISABLED_LPT,
