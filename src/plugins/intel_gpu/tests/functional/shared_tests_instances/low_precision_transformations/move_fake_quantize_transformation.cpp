...
const std::vector<LayerTestsDefinitions::MoveFakeQuantizeTransformationParam> params = {
    ...
    {3,
     ...
     {256ul,
      ...
      {255.f, 255.f, 255.f}},
     {ov::element::u8},
     {{ov::element::f32}, {}, {{0.01f, 0.01f, 0.01f}, ov::element::f32, {1, 3, 1, 1}}},
     "Concat",
     "U8",
     1},
    ...
    {3,
     ...
     {256ul,
      ...
      {255.f, 255.f, 255.f}},
     {ov::element::u8},
     {{ov::element::f32}, {{0.01f, 0.01f, 0.01f}, ov::element::f32, {1, 3, 1, 1}}, {0.01f}},
     "Concat",
     "U8",
     1},
};

const std::vector<std::vector<ov::PartialShape>> shapes = {{{1, 1, 16, 16}, {1, 1, 16, 16}, {1, 1, 16, 16}},
