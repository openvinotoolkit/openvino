...
const std::vector<LayerTestsDefinitions::SqueezeTransformationParam> params = {
    {{256ul, ov::Shape{1, 1, 1, 1}, {-12.8f}, {12.7f}, {-12.8f}, {12.7f}}, {3}, {1, 3, 5, 1}},
    {{256ul, ov::Shape{1, 1, 1, 1}, {-12.8f}, {12.7f}, {-12.8f}, {12.7f}}, {2, 3}, {1, 1, 1, 1}},
    {{256ul, ov::Shape{1, 1, 1, 1}, {-12.8f}, {12.7f}, {-12.8f}, {12.7f}}, {3}, {1, 64, 32, 1}},
    {{256ul, ov::Shape{1, 1, 1, 1}, {-12.8f}, {12.7f}, {-12.8f}, {12.7f}}, {2.0, 3.0}, {1, 32, 1, 1}}};
