...
const std::vector<std::pair<ov::PartialShape, bool>> inputShapes_4D = {{{1, 8, 16, 16}, false},
                                                                       {{1, 32, 16, 16}, true}};

const std::vector<ov::Shape> outputShapes_4D = {{16, 16}};

INSTANTIATE_TEST_SUITE_P(smoke_LPT_4D,
...
const std::vector<std::pair<ov::PartialShape, bool>> inputShapes_3D = {{{1, 32, 16, 16}, true}};

const std::vector<ov::Shape> outputShapes_3D = {{16}};
...
INSTANTIATE_TEST_SUITE_P(smoke_LPT_3D,
                         ConvolutionBackpropDataTransformation,
                         ::testing::Combine(::testing::ValuesIn(netPrecisions),
