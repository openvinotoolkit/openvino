...
const std::vector<LayerTestsDefinitions::ConvolutionTransformationParam> params = {
    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, false, {}, false, "Convolution", "FP32"},
    {{}, false, {255ul, ov::Shape{1, 1, 1, 1}, {0.f}, {254.f}, {-12.7f}, {12.7f}}, false, "Convolution", "FP32"},
    ...
    {{256ul, ov::Shape{1}, {0.f}, {255.f}, {-18.7f}, {18.8f}},
     ...
     {255ul,
      ...
      {-0.6f},
      {0.6f},
      {-1.52806e-39f, -0.2, -0.3, -0.3, -0.2, -0.1},
      {1.52806e-39f, 0.2, 0.3, 0.3, 0.2, 0.1}},
     false,
     "Convolution",
     "U8"},
