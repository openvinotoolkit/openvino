...
const std::vector<std::regex>& disabled_test_patterns() {
    auto get_patterns = []() {
        std::vector<std::regex> patterns{
            ...
            std::regex(R"(.*smoke_MVN_5D/Mvn6LayerTest.Inference/.*ModelType=(f16|bf16).*_Ax=\(2.3.4\).*)"),
            std::regex(R"(.*smoke_MVN_5D/Mvn6LayerTest.Inference/.*ModelType=f32.*_Ax=\(2.3.4\).*NormVariance=FALSE.*)"),
            std::regex(R"(.*smoke_MVN_4D/Mvn6LayerTest.Inference/.*TS=\{\(1.10.5.17\)\}.*_ModelType=(f16|bf16).*Ax=\(2.3\).*)"),
            std::regex(R"(.*smoke_MVN_4D/Mvn6LayerTest.Inference/.*TS=\{\(1.3.8.9\)\}.*_ModelType=(f16|bf16).*Ax=\((2.3|1.2.3)\).*)"),
            std::regex(R"(.*smoke_MVN_3D/Mvn6LayerTest.Inference/IS=\(\[\]\)_TS=\{\(1.32.17\)\}_ModelType=(f16|bf16).*AxType=(i64|i32)_Ax=\((1.2|2)\).*)"),
            std::regex(R"(.*smoke_MVN_2D/Mvn6LayerTest.Inference.*TS=\{\(2.55\)\}_ModelType=f32_.*)"),
            std::regex(R"(.*smoke_Decomposition_6D/Mvn6LayerTest.Inference.*ModelType=(f16|f32|bf16).*Ax=\(0.1.2\).*)"),
            std::regex(R"(.*smoke_Decomposition_6D/Mvn6LayerTest.Inference.*ModelType=(f16|f32|bf16).*Ax=\(0.1.5\).*)"),
            std::regex(R"(.*smoke_Decomposition_4D/Mvn6LayerTest.Inference.*ModelType=(f16|bf16).*Ax=\(1\).*)"),
            ...
            std::regex(R"(.*smoke_Decomposition_3D/Mvn6LayerTest.Inference/.*TS=\{\(1.32.17\)\}_ModelType=(f16|bf16).*AxType=.*_Ax=\(0.1.2\).*)"),
            std::regex(R"(.*moke_Decomposition_3D/Mvn6LayerTest.Inference.*TS=\{\(1.37.9\)\}_ModelType=(f16|bf16).*AxType=.*_Ax=\(1\).*)"),
            ...
            std::regex(R"(.*smoke_Decomposition_4D/Mvn6LayerTest.Inference/.*TS=\{\(2.19.5.10\)\}_ModelType=(f16|bf16).*AxType=(i32|i64)_Ax=\(0.3\)_NormVariance=TRUE.*)"),
