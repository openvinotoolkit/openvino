...
TEST(arg_max_gpu_min_axis_batch, i32) {
    ...
    topology topology;
    topology.add(input_layout("input", input->get_layout()));
    topology.add(arg_max_min("arg_max", { input_info("input") }, ov::op::TopKMode::MIN, top_k, 0, ov::op::TopKSortType::SORT_VALUES, false, padding(), data_types::i32));
...
TEST(arg_max_gpu_min_axis_y_yxfb, f32) {
    ...
    topology topology;
    topology.add(input_layout("input", input->get_layout()));
    topology.add(arg_max_min("arg_max", { input_info("input") }, ov::op::TopKMode::MAX, top_k, 2, ov::op::TopKSortType::SORT_VALUES, false, padding(), data_types::f32));
...
TEST(arg_max_gpu_min_axis_batch_yxfb, f32) {
    ...
    topology topology;
    topology.add(input_layout("input", input->get_layout()));
    topology.add(arg_max_min("arg_max", { input_info("input") }, ov::op::TopKMode::MAX, top_k, 0, ov::op::TopKSortType::SORT_VALUES, false, padding(), data_types::f32));
...
TEST(top_k_layer_tests, second_output2) {
    ...
    topology.add(cldnn::data("const", top_k_input));
    topology.add(mutable_data("second_output", second_output));
    topology.add(arg_max_min("arg_max", { input_info("input"), input_info("const"), input_info("second_output") }, ov::op::TopKMode::MAX, top_k, 0, ov::op::TopKSortType::SORT_VALUES, false, padding(), data_types::f32));
...
TEST(arg_max_gpu_min_axis_y_yxfb_topk_2, sort_by_indices) {
    ...
    topology topology;
    topology.add(input_layout("input", input->get_layout()));
    topology.add(arg_max_min("arg_max", { input_info("input") }, ov::op::TopKMode::MAX, top_k, 2, ov::op::TopKSortType::SORT_INDICES, false, padding(), data_types::f32));
...
TEST(top_k_layer_tests, sort_probabilities_by_indices) {
    ...
    topology topology;
    topology.add(input_layout("input", input->get_layout()));
    topology.add(arg_max_min("arg_max", { input_info("input")}, ov::op::TopKMode::MAX, top_k, 3,
...
TEST(top_k_layer_tests, md_sync) {
    ...
    topology.add(arg_max_min("arg_max.0", { input_info("input1"), input_info("const"), input_info("arg_max_md_write") },
