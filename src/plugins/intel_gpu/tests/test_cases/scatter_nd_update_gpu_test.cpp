...
TEST(scatter_nd_update_gpu_fp16_fsv16_test13, data4_indice2_update2) {
    auto& engine = get_test_engine();
    ...
    topology topology(
        ...
        input_layout("InputIndices", input2->get_layout()),
        input_layout("InputUpdates", input3->get_layout()),
        reorder("reorder1", "InputData", format::b_fs_yx_fsv16, data_types::f16),
        reorder("reorder2", "InputIndices", format::b_fs_yx_fsv16, data_types::f16),
        reorder("reorder3", "InputUpdates", format::b_fs_yx_fsv16, data_types::f16),
        scatter_nd_update("scatter_nd_update", "reorder1", "reorder2", "reorder3", 2),
        reorder("out", "scatter_nd_update", format::bfyx, data_types::f16)
    );
...
TEST(scatter_nd_update_gpu_fp16_fsv16_test12, data3_indice3_update1) {
    auto& engine = get_test_engine();
...
TEST(scatter_nd_update_gpu_fp16_fsv16_test9, data4_indice1_update4) {
    auto& engine = get_test_engine();
...
TEST(scatter_nd_update_gpu_fp16_fsv16_test5, data3_indice2_update2) {
    auto& engine = get_test_engine();
...
TEST(scatter_nd_update_gpu_fp16_fsv16_test4, data2_indice2_update1) {
    auto& engine = get_test_engine();
...
TEST(scatter_nd_update_gpu_fp16_fsv16_test3, data3_indice1_update3) {
    auto& engine = get_test_engine();
...
TEST(scatter_nd_update_gpu_fp16_fsv16_test2, data2_indice1_update2) {
    auto& engine = get_test_engine();
...
TEST(scatter_nd_update_gpu_fp16_fsv16_test1, data1_indice1_update1) {
    auto& engine = get_test_engine();
