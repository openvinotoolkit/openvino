...
TEST(convert_color, nv12_to_rgb_two_planes_buffer_fp32) {
    ...
    auto input_y = engine.allocate_memory({ data_types::f32, format::byxf, tensor{ 1, 1, width, height } });
    auto input_uv = engine.allocate_memory({ data_types::f32, format::byxf, tensor{ 1, 2, width / 2 , height / 2 } });
    ...
    layout output_layout(data_types::f32, format::byxf, tensor{ 1, 3, width, height });
...
TEST(convert_color, nv12_to_rgb_two_planes_buffer_u8) {
    ...
    auto input_y = engine.allocate_memory({ data_types::u8, format::byxf, tensor{ 1, 1, width, height } });
    auto input_uv = engine.allocate_memory({ data_types::u8, format::byxf, tensor{ 1, 2, width / 2 , height / 2 } });
    ...
    layout output_layout(data_types::u8, cldnn::format::byxf, tensor{ 1, 3, width, height });
...
TEST(convert_color, nv12_to_rgb_two_planes_buffer_fp16) {
    ...
    auto input_y = engine.allocate_memory({ data_types::f16, format::byxf, tensor{ 1, 1, width, height } });
    auto input_uv = engine.allocate_memory({ data_types::f16, format::byxf, tensor{ 1, 2, width / 2 , height / 2 } });
    ...
    layout output_layout(data_types::f16, cldnn::format::byxf, tensor{ 1, 3, width, height });
...
TEST(convert_color, nv12_to_rgb_single_plane_buffer_fp32) {
    ...
    auto input = engine.allocate_memory({ data_types::f32, format::byxf, tensor{ 1, 1, width, input_height } });
...
TEST(convert_color, nv12_to_rgb_single_plane_buffer_u8) {
    ...
    auto input = engine.allocate_memory({ data_types::u8, format::byxf, tensor{ 1, 1, width, input_height } });

    int data_size = width * (height + height / 2);
    std::vector<uint8_t> input_data = generate_random_1d<uint8_t>(data_size, 0, 255);
    set_values(input, input_data);

    layout output_layout(data_types::u8, format::byxf, tensor{ 1, 3, width, height });
...
TEST(convert_color, nv12_to_rgb_two_planes_surface_u8) {
    ...
    auto input = input_layout("input", { data_types::u8, format::nv12, tensor{ 1, 1, width, height } });
    auto input2 = input_layout("input2", { data_types::u8, format::nv12, tensor{ 1, 2, width / 2, height / 2} });
    auto output_format = cldnn::format::byxf;
    layout output_layout(data_types::f32, output_format, tensor{ 1, 3, width, height });
...
TEST(convert_color, nv12_to_rgb_single_plane_surface_u8) {
    ...
    auto input = input_layout("input", { data_types::u8, format::nv12, tensor{ 1, 1, width, input_height } });
    auto output_format = cldnn::format::byxf;
    layout output_layout(data_types::f32, output_format, tensor{ 1, 3, width, height });
...
TEST(convert_color, i420_to_rgb_three_planes_buffer_fp32) {
    ...
    auto input_y = engine.allocate_memory({ data_types::f32, format::byxf, tensor{ 1, 1, width, height } });
    auto input_u = engine.allocate_memory({ data_types::f32, format::byxf, tensor{ 1, 1, width / 2 , height / 2 } });
    auto input_v = engine.allocate_memory({ data_types::f32, format::byxf, tensor{ 1, 1, width / 2 , height / 2 } });
...
TEST(convert_color, i420_to_rgb_three_planes_surface_u8) {
    ...
    auto input = input_layout("input", { data_types::u8, format::nv12, tensor{ 1, 1, width, height } });
    auto input2 = input_layout("input2", { data_types::u8, format::nv12, tensor{ 1, 1, width / 2, height / 2 } });
    auto input3 = input_layout("input3", { data_types::u8, format::nv12, tensor{ 1, 1, width / 2, height / 2 } });
    auto output_format = cldnn::format::byxf;
    layout output_layout(data_types::f32, output_format, tensor{ 1, 3, width, height });
