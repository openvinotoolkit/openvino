...
TEST(gather_nd_gpu_fp16, d23322_i231312_ir6_batch2) {
    ...
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfzyx, tensor{ 2, 3, 2, 2, 3 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfwzyx, tensor{ 2, 3, 2, 1, 3, 1 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfzyx, tensor{6, 1, 2, 1, 3});
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfwzyx, tensor{ 2, 3, 2, 1, 3, 1 });
}
...
TEST(gather_nd_gpu_fp16, d231322_i231321_ir6_batch5) {
    ...
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfwzyx, tensor{ 2, 3, 2, 2, 3, 1 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfwzyx, tensor{ 2, 3, 1, 2, 3, 1 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{36, 1, 1, 1});
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfzyx, tensor{2, 3, 2, 3, 1});
}
...
TEST(gather_nd_gpu_fp16, d23322_i23321_ir5_batch4) {
    ...
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfzyx, tensor{ 2, 3, 2, 2, 3 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfzyx, tensor{ 2, 3, 1, 2, 3 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 36, 1, 1, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 3, 2, 3 });
}
...
TEST(gather_nd_gpu_fp16, d23223_i2321_ir4_batch3) {
    ...
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfzyx, tensor{ 2, 3, 3, 2, 2 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 3, 1, 2 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 12, 3, 1, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 3, 3, 2 });
}
...
TEST(gather_nd_gpu_fp16, d2342_i2312_ir4_batch2) {
    ...
    const int indices_rank = 4;
    const int batch_dims = 2;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 3, 2, 4 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 3, 2, 1 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 6, 1, 1, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 3, 1, 1 });
}
...
TEST(gather_nd_gpu_fp16, d234_i2311_ir4_batch2) {
    ...
    const int indices_rank = 4;
    const int batch_dims = 2;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 3, 1, 4 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 3, 1, 1 } }); // indices
...
TEST(gather_nd_gpu_fp16, d234_i21_ir2_batch1) {
    ...
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 3, 1, 4 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 1, 1, 1 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 4, 1, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 4, 1, 1 });
}
...
TEST(gather_nd_gpu_fp16, d22_i21_ir2_batch1) {
    ...
    const int indices_rank = 2;
    const int batch_dims = 1;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 2, 1, 1 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 1, 1, 1 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 1, 1, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 1, 1, 1, 1 });
}
...
TEST(gather_nd_gpu_fp16, d3223_i321113_ir6_batch0) {
    ...
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 3, 2, 3, 2 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfwzyx, tensor{ 3, 2, 3, 1, 1, 1 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfwzyx, tensor{ 3, 2, 3, 1, 1, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfwzyx, tensor{ 3, 2, 3, 1, 1, 1 });
}
...
TEST(gather_nd_gpu_fp16, d3221_i32312_ir3_batch0) {
    ...
    const int batch_dims = 0;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfzyx, tensor{ 3, 2, 2, 1, 3 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 3, 2, 1, 2 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfzyx, tensor{ 3, 2, 2, 1, 3 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfzyx, tensor{ 3, 2, 2, 1, 3 });
}
...
TEST(gather_nd_gpu_fp16, d3231_i32312_ir3_batch0) {
    ...
    const int batch_dims = 0;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfzyx, tensor{ 3, 2, 2, 1, 3 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 3, 2, 1, 3 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 3, 2, 2, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 3, 2, 2, 1 });
}
...
TEST(gather_nd_gpu_fp16, d3112_i3221_ir4_batch0) {
    ...
    const int indices_rank = 4;
    const int batch_dims = 0;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 3, 1, 2, 1 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 3, 2, 1, 2 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfwzyx, tensor{ 3, 2, 2, 1, 1, 2 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfwzyx, tensor{ 3, 2, 2, 1, 1, 2 });
}
...
TEST(gather_nd_gpu_fp16, d3332_i3223_ir4_batch0) {
    ...
    const int indices_rank = 4;
    const int batch_dims = 0;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 3, 3, 3, 2 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 3, 2, 3, 2 } }); // indices
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 3, 2, 3, 2 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 3, 2, 3, 2 });
}
...
TEST(gather_nd_gpu_fp16, d22_i21_ir2_batch0) {
    ...
    DoTestV5(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 2, 1, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 2, 2, 1, 1 });
}
...
TEST(gather_nd_gpu_fp16, d22_i32_ir2_batch0) {
    ...
    const int batch_dims = 0;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 2, 1, 1 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, tensor{ 3, 2, 1, 1 } }); // indices
    ...
    DoTestV5(engine,input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 3, 1, 1, 1 });
    DoTestV8(engine, input0, input1, expected_results, indices_rank, batch_dims, format::bfyx, tensor{ 3, 1, 1, 1 });
}
