...
TEST(test_device_mem_usage_estimation, basic) {
    ...
    auto input1 = engine1->allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 2, 256, 256} });
    auto input2 = engine1->allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 2, 256, 256} });
    topology topology(
    ...
    auto input3 = engine2->allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 2, 256, 256} });
    auto input4 = engine2->allocate_memory({ data_types::f16, format::bfyx, tensor{ 2, 2, 256, 256} });
