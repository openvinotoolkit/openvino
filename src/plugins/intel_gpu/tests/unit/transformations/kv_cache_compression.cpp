...
TEST_F(TransformationTestsF, KVCacheCompression) {
    ...
    {
        bool combine_scales_and_zp = true;
        std::vector<uint64_t> scales_zp_output_order = { 0, 1, 2, 3 };
        ov::intel_gpu::op::KVCache::QuantizationConfig dq_config;
        dq_config.type = ov::intel_gpu::op::KVCache::QuantizationConfig::QuantizationType::Asymmetric;
        ...
        auto key_cache = std::make_shared<ov::intel_gpu::op::KVCache>(key_cache_inputs,
                                                                      key_variable,
                                                                      concat_axis,
                                                                      gather_axis,
        ...
        auto value_cache = std::make_shared<ov::intel_gpu::op::KVCache>(value_cache_inputs,
                                                                        value_variable,
                                                                        concat_axis,
                                                                        gather_axis,
                                                                        combine_scales_and_zp,
