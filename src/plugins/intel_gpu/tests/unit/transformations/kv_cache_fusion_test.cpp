...
TEST_F(TransformationTestsF, KVCacheFusionTest1) {
    {
        auto variable = std::make_shared<ov::op::util::Variable>(
            ov::op::util::VariableInfo{{1, 32, -1, 80}, ov::element::f16, "v0"});
...
TEST_F(TransformationTestsF, KVCacheFusionTest2) {
    {
        auto variable = std::make_shared<ov::op::util::Variable>(
            ov::op::util::VariableInfo{{1, 32, -1, 80}, ov::element::f32, "v0"});
        auto past = std::make_shared<ov::op::v6::ReadValue>(variable);
        ...
        model = std::make_shared<ov::Model>(ov::ResultVector{result},
                                            ov::SinkVector{present},
                                            ov::ParameterVector{parameter, beam_idx});
        manager.register_pass<KVCacheFusion>();
    }
    {
        auto variable = std::make_shared<ov::op::util::Variable>(
        ...
        auto gather_past = std::make_shared<ov::op::v8::Gather>(past, beam_idx, axis);
        auto kv_cache =
            std::make_shared<ov::intel_gpu::op::KVCache>(gather_past, parameter, variable, 2, ov::element::f32);
        auto result = std::make_shared<ov::op::v0::Result>(kv_cache);
