...
// Test asymmetric u8 weight compression with shared expert
TEST_F(TransformationTestsF, ConvertMOEToMOE3GemmSharedExpertAsymU8CompressedTest) {
    disable_rt_info_check();
    {
        ...
        // Shared expert projections (asymmetric u8, 3D without num_experts dim)
        ...
        auto hidden_states_f32 = std::make_shared<ov::op::v0::Convert>(hidden_states, element::f32);
        auto moe =
            std::make_shared<ov::op::internal::MOE>(ov::OutputVector{hidden_states_f32, routing_weights, routing_idx, convert_gate, convert_up, convert_down},
                                                    config);
    ...
    }
    {
        ...
        auto hidden_states_f32 = std::make_shared<ov::op::v0::Convert>(hidden_states, element::f32);
        auto shared_gate_gate_wei_m = std::make_shared<ov::op::v0::Constant>(element::f32, Shape{2048, 1}, std::vector<float>(2048, 1.0f));
        std::shared_ptr<ov::Node> moe_compressed = std::make_shared<ov::intel_gpu::op::MOECompressed>(ov::OutputVector{hidden_states_f32,
                                                                                                                       routing_weights,
                                                                                                                       routing_idx,
                                                                                                                       wei_gate,
                                                                                                                       scale_transpose_gate,
                                                                                                                       ...
                                                                                                                       zp_transpose_down,
                                                                                                                       sh_wei_gate,
                                                                                                                       sh_scale_transpose_gate,
                                                                                                                       sh_zp_transpose_gate,
                                                                                                                       sh_wei_up,
                                                                                                                       sh_scale_transpose_up,
                                                                                                                       sh_zp_transpose_up,
                                                                                                                       sh_wei_down,
                                                                                                                       sh_scale_transpose_down,
                                                                                                                       sh_zp_transpose_down,
