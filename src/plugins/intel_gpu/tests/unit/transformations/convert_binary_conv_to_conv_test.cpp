...
TEST_F(TransformationTestsF, ConvertBinaryConvolutionToConvolutionTest1) {
    {
        ...
        auto out_lo =
            std::make_shared<ov::op::v0::Constant>(ov::element::f32, ov::Shape{1, 1, 1, 1}, std::vector<float>{0.0f});
        auto out_hi =
            std::make_shared<ov::op::v0::Constant>(ov::element::f32, ov::Shape{1, 1, 1, 1}, std::vector<float>{1.0f});
        ...
        auto binary_conv = std::make_shared<ov::op::v1::BinaryConvolution>(
            fq,
            weights,
            ov::Strides{1, 1},
    ...
    }
    {
        ...
        auto pb =
            std::make_shared<ov::op::v0::Constant>(ov::element::i32, ov::Shape{4}, std::vector<int32_t>{0, 0, 1, 1});
        auto pe =
            std::make_shared<ov::op::v0::Constant>(ov::element::i32, ov::Shape{4}, std::vector<int32_t>{0, 0, 1, 1});
