...
TEST_F(TransformationTestsF, TranposeSDPAFusion1) {
    ...
    const bool is_gqa = false;
    {
        ...
        auto sdpa = std::make_shared<ov::op::v13::ScaledDotProductAttention>(input_a, input_b, input_c, is_gqa, is_causal);
...
TEST_F(TransformationTestsF, TransformationTestsF) {
    ...
    const bool is_gqa = false;
    {
        ...
        auto input_b = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::PartialShape::dynamic(4));
        auto input_c = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::PartialShape::dynamic(4));
        auto sdpa = std::make_shared<ov::op::v13::ScaledDotProductAttention>(tranpose_a, input_b, input_c, is_gqa, is_causal);
...
TEST_F(TransformationTestsF, TranposeSDPAFusion3) {
    ...
    const bool is_gqa = false;
    {
        ...
        auto sdpa = std::make_shared<ov::op::v13::ScaledDotProductAttention>(tranpose_a, tranpose_b, input_c, is_gqa, is_causal);
...
TEST_F(TransformationTestsF, TranposeSDPAFusion4) {
    ...
    const bool is_gqa = false;
    {
        ...
        auto sdpa = std::make_shared<ov::op::v13::ScaledDotProductAttention>(tranpose_a, tranpose_b, tranpose_c, is_gqa, is_causal);
