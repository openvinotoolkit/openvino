...
void tile_ref(const memory::ptr input, memory::ptr output, int64_t axis, int num_tiles) {
    auto get_sizes = [](const layout& l, int64_t axis, size_t rank) -> std::pair<int, int> {
        switch (axis) {
        case 0:
            return std::make_pair(1, l.batch() * l.feature() * l.spatial(2) * l.spatial(1) * l.spatial(0));
        case 1:
        ...
        case 4:
            return std::make_pair(l.batch() * l.feature() * l.spatial(2) * l.spatial(1), l.spatial(0));
        default:
            throw std::invalid_argument("Invalid axis(" + std::to_string(static_cast<int>(axis)) +
                                        ") in tile ref version");
        }
    };
...
public:
    void test_basic_in1x2x2x2_axis_b(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        std::vector<float> input_vec = {1.f, 0.f, 5.f, 1.5f, 2.f, 0.f, 6.f, 5.2f};
        ...
        if (impl_type != impl_types::any)
            config.set_property(ov::intel_gpu::force_implementations(
                ov::intel_gpu::ImplForcingMap{{"tile", {format::bfyx, "", impl_types::cpu}}}));
    ...
    void test_basic_in1x2x2x2_axis_f(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        std::vector<float> input_vec = {1.f,
                                        0.f,
                                        5.f,
                                        1.5f,
    ...
    void test_basic_in1x2x2x2_axis_y(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        std::vector<float> input_vec = {0.f,  1.f,  2.f,  3.f,  4.f,  5.f,  6.f,  7.f,  8.f,  9.f,  10.f, 11.f,
    ...
    void test_basic_in1x2x2x2_axis_x(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        std::vector<float> input_vec = {0.f,
                                        1.f,
                                        2.f,
                                        3.f,
    ...
    void test_basic_in1x2x2x2_axis_z(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        std::vector<float> input_vec =
            {1.f, 0.f, 5.f, 1.5f, 2.f, 0.f, 6.f, 5.2f, 1.f, 0.f, 5.f, 1.5f, 2.f, 0.f, 6.f, 5.2f};
        set_values(input, input_vec);
        tile_ref<float>(input, output_ref, 2, 2);
    ...
    void test_dynamic_1x2x2x2_axis_f(impl_types impl_type = impl_types::any) {
        ...
        set_values(input, {1.f, 0.f, 5.f, 1.5f, 2.f, 0.f, 6.f, 5.2f});
...
template <typename T>
using ParamsWithLayout = std::tuple<Params<T>,
                                    format::type,  // source (plain) layout - bfyx or bfzyx
                                    format::type   // target (blocked) layout
                                    >;

const std::vector<format::type> layouts_2d = {format::bfyx,
...
const std::vector<format::type> layouts_3d = {format::bfzyx,
...
std::vector<Params<T>> generateTileParams3D() {
    static const std::vector<Params<T>> result = {{
        ...
        },
        {
            ...
            tensor(1, 2, 4, 2, 2),
            getValues<T>({
                1.f, 0.f, 1.f, 0.f, 5.f, 1.5f, 5.f, 1.5f, 2.f, 0.f, 2.f, 0.f, 6.f, 5.2f, 6.f, 5.2f,
        ...
        },
        {
            ...
            tensor(1, 2, 2, 4, 2),
            getValues<T>({
                1.f, 0.f, 5.f, 1.5f, 1.f, 0.f, 5.f, 1.5f, 2.f, 0.f, 6.f, 5.2f, 2.f, 0.f, 6.f, 5.2f,
...
struct PrintToStringParamName {
    ...
    std::string operator()(const testing::TestParamInfo<ParamsWithLayout<T>>& param) {
        ...
        buf << " input tensor " << p.input_tensor.to_string() << " output tensor " << p.output_tensor.to_string()
            << " plain layout " << plain_layout << " target layout " << target_layout;
        return buf.str();
    }
};
};  // namespace
...
template <typename T>
struct tile_test : public ::testing::TestWithParam<ParamsWithLayout<T>> {
public:
...
INSTANTIATE_TEST_SUITE_P(tile_gpu_2D,
                         tile_test_f32,
                         ::testing::Combine(::testing::ValuesIn(generateTileParams2D<float>()),
...
INSTANTIATE_TEST_SUITE_P(tile_gpu_2D,
                         tile_test_f16,
                         ::testing::Combine(::testing::ValuesIn(generateTileParams2D<ov::float16>()),
                                            ::testing::Values(format::bfyx),
                                            ::testing::ValuesIn(layouts_2d)),
                         PrintToStringParamName());
...
INSTANTIATE_TEST_SUITE_P(tile_gpu_3D,
                         tile_test_f32,
                         ::testing::Combine(::testing::ValuesIn(generateTileParams3D<float>()),
...
INSTANTIATE_TEST_SUITE_P(tile_gpu_3D,
                         tile_test_f16,
                         ::testing::Combine(::testing::ValuesIn(generateTileParams3D<ov::float16>()),
                                            ::testing::Values(format::bfzyx),
                                            ::testing::ValuesIn(layouts_3d)),
                         PrintToStringParamName());
