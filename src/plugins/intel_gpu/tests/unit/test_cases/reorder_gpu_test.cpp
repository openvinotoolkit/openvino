...
TEST(reorder_gpu_u2, fp16_to_u2_clamp) {
    // The in-range f16 -> u2 conversions are covered by reorder_gpu_u2.fp16_to_u2; this one is here
    // for the saturating arm only: -2 and -1 clamp up to 0, 4 and 5 clamp down to 3.
