...
public:
    void test_i1222_bs1222_pb0000_pe0000(bool is_caching_test) {
        ...
        topology.add(space_to_batch("space_to_batch",
                                    input_info("Input"),
    ...
    void test_i1242_bs1221_pb0020_pe0000(bool is_caching_test) {
        ...
        std::vector<float> expected_results = {0.f, 0.f, 0.f, 1.f, 4.f,  5.f,  0.f, 0.f, 2.f,  3.f,  6.f,  7.f,
                                               0.f, 0.f, 8.f, 9.f, 12.f, 13.f, 0.f, 0.f, 10.f, 11.f, 14.f, 15.f};
    ...
    void test_i2132_bs1222_pb0010_pe0100(bool is_caching_test) {
        ...
        std::vector<float> expected_results = {0.f,  2.f, 0.f, 8.f, 0.f,  3.f, 0.f, 9.f, 0.f, 4.f, 6.f,
                                               10.f, 1.f, 5.f, 7.f, 11.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
    ...
    void test_i12132_bs12122_pb00010_pe00000(bool is_caching_test) {
        ...
        topology.add(space_to_batch("space_to_batch",
                                    input_info("Input"),
                                    tensor(format::bfzyx, {1, 2, 1, 2, 2}, 1),
        ...
        std::vector<float> expected_results =
            {0.f, 2.f, 0.f, 3.f, 0.f, 4.f, 1.f, 5.f, 0.f, 8.f, 0.f, 9.f, 6.f, 10.f, 7.f, 11.f};
    ...
    void test_i134121_bs142121_pb010100_pe000000(bool is_caching_test) {
        ...
        topology.add(space_to_batch("space_to_batch",
                                    input_info("Input"),
                                    tensor(format::bfwzyx, {1, 4, 2, 1, 2, 1}, 1),
        ...
        std::vector<float> expected_results = {
            ...
            0.f, 0.f,  0.f, 4.f,  0.f, 1.f,  0.f, 5.f,  0.f, 2.f,  0.f, 6.f,  0.f, 3.f,  0.f, 7.f,
            0.f, 8.f,  0.f, 12.f, 0.f, 9.f,  0.f, 13.f, 0.f, 10.f, 0.f, 14.f, 0.f, 11.f, 0.f, 15.f,
            0.f, 16.f, 0.f, 20.f, 0.f, 17.f, 0.f, 21.f, 0.f, 18.f, 0.f, 22.f, 0.f, 19.f, 0.f, 23.f};
    ...
    void test_i11611_bs1222_pb0010_pe0001_b_fs_yx_fsv16(bool is_caching_test) {
        ...
        std::vector<float> expected_results = {0.f, 0.f,  0.f,  0.f,  0.f, 0.f, 0.f, 0.f, 0.f,  0.f,  0.f,  0.f, 0.f,
                                               0.f, 0.f,  0.f,  0.f,  2.f, 4.f, 6.f, 8.f, 10.f, 12.f, 14.f, 0.f, 0.f,
                                               0.f, 0.f,  0.f,  0.f,  0.f, 0.f, 0.f, 0.f, 0.f,  0.f,  0.f,  0.f, 0.f,
                                               0.f, 0.f,  0.f,  0.f,  0.f, 0.f, 0.f, 0.f, 0.f,  1.f,  3.f,  5.f, 7.f,
                                               9.f, 11.f, 13.f, 15.f, 0.f, 0.f, 0.f, 0.f, 0.f,  0.f,  0.f,  0.f};
    ...
    void test_i1812_bs1221_pb0010_pe0200_b_fs_yx_fsv16(bool is_caching_test) {
        ...
        std::vector<float> expected_results = {
            0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f, 4.f, 5.f, 8.f,  9.f,  12.f, 13.f, 0.f, 0.f,
            0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 2.f, 3.f, 6.f, 7.f, 10.f, 11.f, 14.f, 15.f, 0.f, 0.f};
...
public:
    ...
    void test_i11622_bs1421_pb0000_pe0000_b_fs_yx_fsv16(bool is_caching_test) {
        ...
        std::vector<float> expected_results = {
            0.f,  1.f,  16.f, 17.f, 32.f, 33.f, 48.f, 49.f, 2.f,  3.f,  18.f, 19.f, 34.f, 35.f, 50.f, 51.f,
            4.f,  5.f,  20.f, 21.f, 36.f, 37.f, 52.f, 53.f, 6.f,  7.f,  22.f, 23.f, 38.f, 39.f, 54.f, 55.f,
            8.f,  9.f,  24.f, 25.f, 40.f, 41.f, 56.f, 57.f, 10.f, 11.f, 26.f, 27.f, 42.f, 43.f, 58.f, 59.f,
            12.f, 13.f, 28.f, 29.f, 44.f, 45.f, 60.f, 61.f, 14.f, 15.f, 30.f, 31.f, 46.f, 47.f, 62.f, 63.f};
    ...
    void test_i1623_bs1312_pb0001_pe0000_b_fs_yx_fsv16(bool is_caching_test) {
        ...
        std::vector<float> expected_results = {0.f,  1.f,  0.f,  4.f,  0.f,  19.f, 0.f,  22.f, 0.f,  2.f,  3.f,  5.f,
                                               18.f, 20.f, 21.f, 23.f, 0.f,  7.f,  0.f,  10.f, 0.f,  25.f, 0.f,  28.f,
                                               6.f,  8.f,  9.f,  11.f, 24.f, 26.f, 27.f, 29.f, 0.f,  13.f, 0.f,  16.f,
                                               0.f,  31.f, 0.f,  34.f, 12.f, 14.f, 15.f, 17.f, 30.f, 32.f, 33.f, 35.f};
