...
inline void DoTest(engine& engine,
    ...
    bool reorder_indices = true,
    format expected_impl_output_format = format::any) {
    topology topology;
    ...
    if (blocked_format != format::any) {
        topology.add(reorder("gather_elements_to_original_format",
                             input_info("gather_elements"),
                             input0->get_layout().format,
                             input0->get_layout().data_type));
        output_id = "gather_elements_to_original_format";
    }
...
// must index each with its own pitches rather than reusing one index for both. The kernel fix
// itself landed upstream in #37654 for the b_fs_yx_fsv16 case; this is the padding case, which
// reaches the same indexing and had no coverage.
...
TEST(gather_elements_gpu_fp16, d1x32x1x2_i1x32x1x2_a1_b_fs_yx_fsv16) {
    auto& engine = get_test_engine();
    ...
    set_values(input0, {
        ...
        ov::float16(16), ov::float16(17), ov::float16(18), ov::float16(19), ov::float16(20), ov::float16(21), ov::float16(22), ov::float16(23),
        ov::float16(24), ov::float16(25), ov::float16(26), ov::float16(27), ov::float16(28), ov::float16(29), ov::float16(30), ov::float16(31),
        ov::float16(32), ov::float16(33), ov::float16(34), ov::float16(35), ov::float16(36), ov::float16(37), ov::float16(38), ov::float16(39),
        ...
        ov::float16(56), ov::float16(57), ov::float16(58), ov::float16(59), ov::float16(60), ov::float16(61), ov::float16(62), ov::float16(63),
    });
    ...
    std::vector<float> expected_results = {
        ov::float16(20), ov::float16(7), ov::float16(8), ov::float16(63), ov::float16(20), ov::float16(9), ov::float16(26), ov::float16(19),
        ov::float16(2), ov::float16(45), ov::float16(14), ov::float16(19), ov::float16(38), ov::float16(59), ov::float16(4), ov::float16(53),
        ov::float16(34), ov::float16(5), ov::float16(22), ov::float16(35), ov::float16(18), ov::float16(39), ov::float16(18), ov::float16(59),
        ov::float16(4), ov::float16(49), ov::float16(44), ov::float16(63), ov::float16(42), ov::float16(59), ov::float16(60), ov::float16(5),
        ov::float16(60), ov::float16(21), ov::float16(56), ov::float16(57), ov::float16(36), ov::float16(35), ov::float16(14), ov::float16(23),
        ov::float16(52), ov::float16(55), ov::float16(14), ov::float16(13), ov::float16(62), ov::float16(49), ov::float16(32), ov::float16(25),
        ov::float16(44), ov::float16(13), ov::float16(20), ov::float16(35), ov::float16(18), ov::float16(41), ov::float16(56), ov::float16(9),
        ov::float16(10), ov::float16(51), ov::float16(26), ov::float16(7), ov::float16(36), ov::float16(5), ov::float16(28), ov::float16(11),
    };

        DoTest(engine, input0, input1, expected_results, tensor(1, 32, 1, 2), axis, false, format::b_fs_yx_fsv16,
            true, format::b_fs_yx_fsv16);
}

TEST(gather_elements_gpu_fp16, data_1x32x1x2_b_fs_yx_fsv16_indices_bfyx_axis1_mismatched_layout) {
    auto& engine = get_test_engine();
    ...
    std::vector<float> expected_results = {
        ...
        DoTest(engine, input0, input1, expected_results, tensor(1, 32, 1, 2), axis, false, format::b_fs_yx_fsv16,
            /*reorder_indices=*/false, format::b_fs_yx_fsv16);
}

TEST(gather_elements_gpu_fp16, data_1x17x1x2_b_fs_yx_fsv16_axis1_partial_feature_block) {
    auto& engine = get_test_engine();

    auto axis = 1;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfyx, { 1, 17, 1, 2 } }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfyx, { 1, 17, 1, 2 } }); // indices
    ...
    set_values(input0, {
        ...
        ov::float16(16), ov::float16(17), ov::float16(18), ov::float16(19), ov::float16(20), ov::float16(21), ov::float16(22), ov::float16(23),
        ov::float16(24), ov::float16(25), ov::float16(26), ov::float16(27), ov::float16(28), ov::float16(29), ov::float16(30), ov::float16(31),
        ov::float16(32), ov::float16(33),
    });

    set_values(input1, {
        ov::float16(16), ov::float16(16), ov::float16(15), ov::float16(15), ov::float16(14), ov::float16(14), ov::float16(13), ov::float16(13),
        ov::float16(12), ov::float16(12), ov::float16(11), ov::float16(11), ov::float16(10), ov::float16(10), ov::float16(9), ov::float16(9),
        ov::float16(8), ov::float16(8), ov::float16(7), ov::float16(7), ov::float16(6), ov::float16(6), ov::float16(5), ov::float16(5),
        ov::float16(4), ov::float16(4), ov::float16(3), ov::float16(3), ov::float16(2), ov::float16(2), ov::float16(1), ov::float16(1),
        ov::float16(0), ov::float16(0),
    });

    std::vector<float> expected_results = {
        ov::float16(32), ov::float16(33), ov::float16(30), ov::float16(31), ov::float16(28), ov::float16(29), ov::float16(26), ov::float16(27),
        ov::float16(24), ov::float16(25), ov::float16(22), ov::float16(23), ov::float16(20), ov::float16(21), ov::float16(18), ov::float16(19),
        ov::float16(16), ov::float16(17), ov::float16(14), ov::float16(15), ov::float16(12), ov::float16(13), ov::float16(10), ov::float16(11),
        ov::float16(8), ov::float16(9), ov::float16(6), ov::float16(7), ov::float16(4), ov::float16(5), ov::float16(2), ov::float16(3),
        ov::float16(0), ov::float16(1),
    };

        DoTest(engine, input0, input1, expected_results, tensor(1, 17, 1, 2), axis, false, format::b_fs_yx_fsv16,
            true, format::b_fs_yx_fsv16);
}
...
// General coverage for the b_fs_zyx_fsv16 blocked layout (both data/indices and output reordered).
TEST(gather_elements_gpu_fp16, data_1x2x2x2x3_indices_1x2x2x2x3_b_fs_zyx_fsv16_axis1) {
    auto& engine = get_test_engine();

    auto axis = 1;
    auto input0 = engine.allocate_memory({ data_types::f16, format::bfzyx, tensor(1, 2, 2, 2, 3) }); // data
    auto input1 = engine.allocate_memory({ data_types::f16, format::bfzyx, tensor(1, 2, 2, 2, 3) }); // indices

    set_values(input0, {
        ov::float16(0), ov::float16(1), ov::float16(2), ov::float16(3),
        ov::float16(4), ov::float16(5), ov::float16(6), ov::float16(7),
        ov::float16(8), ov::float16(9), ov::float16(10), ov::float16(11),
        ov::float16(12), ov::float16(13), ov::float16(14), ov::float16(15),
        ov::float16(16), ov::float16(17), ov::float16(18), ov::float16(19),
        ov::float16(20), ov::float16(21), ov::float16(22), ov::float16(23),
    });

    set_values(input1, {
        ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1),
        ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1),
        ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1),
        ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1),
        ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1),
    ...
    std::vector<float> expected_results = {
        ov::float16(0), ov::float16(13), ov::float16(2), ov::float16(15),
        ov::float16(4), ov::float16(17), ov::float16(6), ov::float16(19),
        ov::float16(8), ov::float16(21), ov::float16(10), ov::float16(23),
        ov::float16(0), ov::float16(13), ov::float16(2), ov::float16(15),
        ov::float16(4), ov::float16(17), ov::float16(6), ov::float16(19),
        ov::float16(8), ov::float16(21), ov::float16(10), ov::float16(23),
    };
