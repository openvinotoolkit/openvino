...
TEST(gather_elements_gpu_fp16, d3283_i2283_a0) {
    ...
    set_values(input0,
               {
                   ov::float16(0),  ov::float16(1),  ov::float16(8),  ov::float16(5),  ov::float16(5),  ov::float16(2),
                   ov::float16(0),  ov::float16(7),  ov::float16(7),  ov::float16(10), ov::float16(4),  ov::float16(5),
                   ov::float16(9),  ov::float16(0),  ov::float16(0),  ov::float16(5),  ov::float16(7),  ov::float16(0),
                   ov::float16(4),  ov::float16(0),  ov::float16(4),  ov::float16(7),  ov::float16(6),  ov::float16(10),
                   ov::float16(9),  ov::float16(5),  ov::float16(1),  ov::float16(7),  ov::float16(4),  ov::float16(7),
                   ov::float16(10), ov::float16(8),  ov::float16(2),  ov::float16(0),  ov::float16(8),  ov::float16(3),
                   ov::float16(6),  ov::float16(8),  ov::float16(10), ov::float16(4),  ov::float16(2),  ov::float16(10),
                   ov::float16(7),  ov::float16(8),  ov::float16(7),  ov::float16(0),  ov::float16(6),  ov::float16(9),
                   ov::float16(2),  ov::float16(4),  ov::float16(8),  ov::float16(5),  ov::float16(2),  ov::float16(3),
                   ov::float16(3),  ov::float16(1),  ov::float16(5),  ov::float16(9),  ov::float16(10), ov::float16(0),
                   ov::float16(9),  ov::float16(5),  ov::float16(5),  ov::float16(3),  ov::float16(10), ov::float16(5),
                   ov::float16(2),  ov::float16(0),  ov::float16(10), ov::float16(0),  ov::float16(5),  ov::float16(4),
                   ov::float16(3),  ov::float16(10), ov::float16(5),  ov::float16(5),  ov::float16(10), ov::float16(0),
                   ov::float16(8),  ov::float16(8),  ov::float16(9),  ov::float16(1),  ov::float16(0),  ov::float16(7),
                   ov::float16(9),  ov::float16(6),  ov::float16(8),  ov::float16(7),  ov::float16(10), ov::float16(9),
                   ov::float16(2),  ov::float16(3),  ov::float16(3),  ov::float16(5),  ov::float16(6),  ov::float16(9),
                   ov::float16(4),  ov::float16(9),  ov::float16(2),  ov::float16(4),  ov::float16(5),  ov::float16(5),
                   ov::float16(3),  ov::float16(1),  ov::float16(1),  ov::float16(6),  ov::float16(8),  ov::float16(0),
                   ov::float16(5),  ov::float16(5),  ov::float16(10), ov::float16(8),  ov::float16(6),  ov::float16(9),
                   ov::float16(6),  ov::float16(9),  ov::float16(1),  ov::float16(2),  ov::float16(7),  ov::float16(1),
                   ov::float16(1),  ov::float16(3),  ov::float16(0),  ov::float16(4),  ov::float16(0),  ov::float16(7),
                   ov::float16(10), ov::float16(2),  ov::float16(1),  ov::float16(3),  ov::float16(9),  ov::float16(7),
                   ov::float16(1),  ov::float16(7),  ov::float16(4),  ov::float16(4),  ov::float16(5),  ov::float16(1),
                   ov::float16(6),  ov::float16(9),  ov::float16(6),  ov::float16(10), ov::float16(6),  ov::float16(1),
               });
    ...
    set_values(input1,
               {
                   ...
                   ov::float16(0), ov::float16(1), ov::float16(1), ov::float16(2), ov::float16(0), ov::float16(2),
               });

    std::vector<float> expected_results = {
        ov::float16(0),  ov::float16(4), ov::float16(2), ov::float16(4),  ov::float16(5),  ov::float16(2),
        ov::float16(0),  ov::float16(7), ov::float16(1), ov::float16(10), ov::float16(4),  ov::float16(5),
        ov::float16(9),  ov::float16(0), ov::float16(5), ov::float16(3),  ov::float16(6),  ov::float16(5),
        ov::float16(6),  ov::float16(0), ov::float16(1), ov::float16(0),  ov::float16(6),  ov::float16(1),
        ov::float16(3),  ov::float16(5), ov::float16(5), ov::float16(4),  ov::float16(4),  ov::float16(7),
        ov::float16(8),  ov::float16(2), ov::float16(1), ov::float16(1),  ov::float16(0),  ov::float16(7),
        ov::float16(9),  ov::float16(8), ov::float16(4), ov::float16(4),  ov::float16(5),  ov::float16(1),
        ov::float16(6),  ov::float16(9), ov::float16(6), ov::float16(0),  ov::float16(6),  ov::float16(1),
        ov::float16(2),  ov::float16(9), ov::float16(2), ov::float16(4),  ov::float16(5),  ov::float16(2),
        ov::float16(3),  ov::float16(7), ov::float16(7), ov::float16(10), ov::float16(4),  ov::float16(0),
        ov::float16(5),  ov::float16(0), ov::float16(5), ov::float16(3),  ov::float16(6),  ov::float16(9),
        ov::float16(2),  ov::float16(0), ov::float16(4), ov::float16(2),  ov::float16(6),  ov::float16(10),
        ov::float16(9),  ov::float16(3), ov::float16(0), ov::float16(4),  ov::float16(10), ov::float16(7),
        ov::float16(10), ov::float16(2), ov::float16(9), ov::float16(3),  ov::float16(0),  ov::float16(7),
        ov::float16(6),  ov::float16(8), ov::float16(8), ov::float16(4),  ov::float16(2),  ov::float16(10),
        ov::float16(7),  ov::float16(3), ov::float16(3), ov::float16(10), ov::float16(6),  ov::float16(1),
    };
...
TEST(gather_elements_gpu_fp16, d2235_i2235_a3) {
    ...
    std::vector<float> expected_results = {
        ov::float16(0), ov::float16(1), ov::float16(8),  ov::float16(2),  ov::float16(2),  ov::float16(5),
        ov::float16(0), ov::float16(0), ov::float16(7),  ov::float16(10), ov::float16(10), ov::float16(10),
        ov::float16(0), ov::float16(9), ov::float16(0),  ov::float16(7),  ov::float16(0),  ov::float16(7),
        ov::float16(4), ov::float16(0), ov::float16(4),  ov::float16(6),  ov::float16(7),  ov::float16(10),
        ov::float16(5), ov::float16(9), ov::float16(5),  ov::float16(7),  ov::float16(7),  ov::float16(7),
        ov::float16(8), ov::float16(2), ov::float16(2),  ov::float16(8),  ov::float16(8),  ov::float16(8),
        ov::float16(8), ov::float16(6), ov::float16(10), ov::float16(4),  ov::float16(10), ov::float16(10),
        ov::float16(7), ov::float16(7), ov::float16(7),  ov::float16(0),  ov::float16(0),  ov::float16(9),
        ov::float16(4), ov::float16(8), ov::float16(8),  ov::float16(3),  ov::float16(3),  ov::float16(5),
        ov::float16(5), ov::float16(3), ov::float16(3),  ov::float16(9),  ov::float16(9),  ov::float16(0),
    };
...
TEST(gather_elements_gpu_fp16, d1329_i1359_an1) {
    ...
    set_values(input1,
               {
                   ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(0),
                   ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(0), ov::float16(0),
                   ov::float16(0), ov::float16(0), ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0),
                   ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(0), ov::float16(0), ov::float16(1),
                   ov::float16(1), ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(0),
                   ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(0), ov::float16(0), ov::float16(1),
                   ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(1),
                   ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(0), ov::float16(0), ov::float16(1),
                   ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(0),
                   ov::float16(1), ov::float16(0), ov::float16(0), ov::float16(0), ov::float16(0), ov::float16(1),
                   ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(1),
                   ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(0),
                   ov::float16(0), ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(0), ov::float16(0),
                   ov::float16(0), ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(1), ov::float16(1),
                   ov::float16(0), ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(0),
                   ov::float16(0), ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(0),
                   ov::float16(1), ov::float16(0), ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0),
                   ov::float16(0), ov::float16(1), ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(0),
                   ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(1),
                   ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(1), ov::float16(0), ov::float16(1),
                   ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(1),
                   ov::float16(0), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(1),
                   ov::float16(0), ov::float16(1), ov::float16(1),
               });

    std::vector<float> expected_results = {
        ov::float16(0),  ov::float16(0),  ov::float16(1),  ov::float16(1),  ov::float16(1),  ov::float16(8),
        ov::float16(8),  ov::float16(8),  ov::float16(5),  ov::float16(8),  ov::float16(5),  ov::float16(5),
        ov::float16(5),  ov::float16(5),  ov::float16(5),  ov::float16(0),  ov::float16(7),  ov::float16(0),
        ov::float16(7),  ov::float16(7),  ov::float16(10), ov::float16(7),  ov::float16(7),  ov::float16(10),
        ov::float16(10), ov::float16(4),  ov::float16(4),  ov::float16(5),  ov::float16(4),  ov::float16(4),
        ov::float16(0),  ov::float16(0),  ov::float16(0),  ov::float16(9),  ov::float16(9),  ov::float16(5),
        ov::float16(0),  ov::float16(0),  ov::float16(5),  ov::float16(0),  ov::float16(0),  ov::float16(0),
        ov::float16(0),  ov::float16(0),  ov::float16(0),  ov::float16(4),  ov::float16(4),  ov::float16(0),
        ov::float16(0),  ov::float16(0),  ov::float16(7),  ov::float16(7),  ov::float16(7),  ov::float16(4),
        ov::float16(7),  ov::float16(6),  ov::float16(6),  ov::float16(6),  ov::float16(6),  ov::float16(10),
        ov::float16(5),  ov::float16(9),  ov::float16(5),  ov::float16(9),  ov::float16(5),  ov::float16(7),
        ov::float16(1),  ov::float16(7),  ov::float16(1),  ov::float16(7),  ov::float16(4),  ov::float16(4),
        ov::float16(4),  ov::float16(7),  ov::float16(7),  ov::float16(8),  ov::float16(10), ov::float16(10),
        ov::float16(10), ov::float16(8),  ov::float16(0),  ov::float16(0),  ov::float16(0),  ov::float16(0),
        ov::float16(2),  ov::float16(8),  ov::float16(8),  ov::float16(3),  ov::float16(8),  ov::float16(8),
        ov::float16(6),  ov::float16(6),  ov::float16(6),  ov::float16(8),  ov::float16(6),  ov::float16(10),
        ov::float16(4),  ov::float16(10), ov::float16(10), ov::float16(10), ov::float16(10), ov::float16(2),
        ov::float16(2),  ov::float16(10), ov::float16(10), ov::float16(7),  ov::float16(8),  ov::float16(7),
        ov::float16(7),  ov::float16(7),  ov::float16(0),  ov::float16(7),  ov::float16(0),  ov::float16(0),
        ov::float16(0),  ov::float16(6),  ov::float16(9),  ov::float16(9),  ov::float16(6),  ov::float16(9),
        ov::float16(2),  ov::float16(2),  ov::float16(4),  ov::float16(2),  ov::float16(4),  ov::float16(5),
        ov::float16(8),  ov::float16(8),  ov::float16(5),  ov::float16(8),  ov::float16(3),  ov::float16(3),
    ...
    set_values(input0,
               {
                   ...
                   ov::float16(1),  ov::float16(7),  ov::float16(4),  ov::float16(4),  ov::float16(5),  ov::float16(1),
                   ov::float16(6),  ov::float16(9),  ov::float16(6),  ov::float16(10), ov::float16(6),  ov::float16(1),
                   ov::float16(10), ov::float16(4),  ov::float16(1),  ov::float16(6),  ov::float16(2),  ov::float16(5),
                   ov::float16(5),  ov::float16(10), ov::float16(1),  ov::float16(2),  ov::float16(3),  ov::float16(6),
                   ov::float16(1),  ov::float16(7),  ov::float16(6),  ov::float16(8),  ov::float16(2),  ov::float16(5),
                   ov::float16(4),  ov::float16(2),  ov::float16(0),  ov::float16(9),  ov::float16(4),  ov::float16(1),
                   ov::float16(10), ov::float16(4),  ov::float16(1),  ov::float16(9),  ov::float16(1),  ov::float16(1),
                   ov::float16(0),  ov::float16(4),  ov::float16(2),  ov::float16(1),  ov::float16(8),  ov::float16(5),
                   ov::float16(3),  ov::float16(4),  ov::float16(8),  ov::float16(10), ov::float16(7),  ov::float16(2),
                   ov::float16(7),  ov::float16(9),  ov::float16(2),  ov::float16(9),  ov::float16(5),  ov::float16(5),
                   ov::float16(6),  ov::float16(8),  ov::float16(8),  ov::float16(5),  ov::float16(10), ov::float16(6),
                   ov::float16(4),  ov::float16(9),  ov::float16(7),  ov::float16(7),  ov::float16(10), ov::float16(10),
                   ov::float16(9),  ov::float16(3),  ov::float16(5),  ov::float16(5),  ov::float16(1),  ov::float16(4),
                   ov::float16(6),  ov::float16(9),  ov::float16(4),  ov::float16(8),  ov::float16(9),  ov::float16(7),
                   ov::float16(8),  ov::float16(7),  ov::float16(8),  ov::float16(0),  ov::float16(9),  ov::float16(5),
                   ov::float16(5),  ov::float16(0),  ov::float16(7),  ov::float16(5),  ov::float16(7),  ov::float16(7),
                   ov::float16(2),  ov::float16(10), ov::float16(9),  ov::float16(9),  ov::float16(5),  ov::float16(1),
                   ov::float16(4),  ov::float16(10), ov::float16(2),  ov::float16(4),  ov::float16(3),  ov::float16(5),
               });

    set_values(input1,
               {
                   ov::float16(0), ov::float16(2), ov::float16(4), ov::float16(3), ov::float16(4), ov::float16(0),
                   ov::float16(0), ov::float16(1), ov::float16(4), ov::float16(0), ov::float16(1), ov::float16(0),
                   ov::float16(1), ov::float16(0), ov::float16(1), ov::float16(1), ov::float16(3), ov::float16(1),
                   ov::float16(4), ov::float16(2), ov::float16(4), ov::float16(2), ov::float16(1), ov::float16(3),
                   ov::float16(2), ov::float16(1), ov::float16(2), ov::float16(4), ov::float16(1), ov::float16(0),
                   ov::float16(2), ov::float16(3), ov::float16(4), ov::float16(2), ov::float16(2), ov::float16(2),
                   ov::float16(2), ov::float16(0), ov::float16(4), ov::float16(0), ov::float16(3), ov::float16(4),
                   ov::float16(3), ov::float16(4), ov::float16(4), ov::float16(1), ov::float16(0), ov::float16(3),
                   ov::float16(2), ov::float16(4), ov::float16(4), ov::float16(4), ov::float16(4), ov::float16(0),
                   ov::float16(4), ov::float16(0), ov::float16(1), ov::float16(0), ov::float16(0), ov::float16(4),
                   ov::float16(3), ov::float16(0), ov::float16(2), ov::float16(2), ov::float16(3), ov::float16(4),
                   ov::float16(2), ov::float16(2), ov::float16(0), ov::float16(3), ov::float16(1), ov::float16(1),
                   ov::float16(0), ov::float16(3), ov::float16(3), ov::float16(4), ov::float16(2), ov::float16(0),
                   ov::float16(0), ov::float16(3), ov::float16(3), ov::float16(4), ov::float16(3), ov::float16(3),
                   ov::float16(1), ov::float16(1), ov::float16(2), ov::float16(3), ov::float16(1), ov::float16(0),
                   ov::float16(0), ov::float16(2), ov::float16(2), ov::float16(4), ov::float16(0), ov::float16(4),
               });

    std::vector<float> expected_results = {
        ov::float16(0),  ov::float16(0), ov::float16(8),  ov::float16(7), ov::float16(6),  ov::float16(2),
        ov::float16(0),  ov::float16(5), ov::float16(2),  ov::float16(1), ov::float16(4),  ov::float16(5),
        ov::float16(9),  ov::float16(2), ov::float16(0),  ov::float16(5), ov::float16(10), ov::float16(4),
        ov::float16(5),  ov::float16(0), ov::float16(10), ov::float16(5), ov::float16(3),  ov::float16(4),
        ov::float16(5),  ov::float16(4), ov::float16(10), ov::float16(5), ov::float16(2),  ov::float16(0),
        ov::float16(5),  ov::float16(4), ov::float16(6),  ov::float16(9), ov::float16(2),  ov::float16(4),
        ov::float16(5),  ov::float16(6), ov::float16(7),  ov::float16(7), ov::float16(1),  ov::float16(9),
        ov::float16(8),  ov::float16(9), ov::float16(1),  ov::float16(5), ov::float16(8),  ov::float16(8),
        ov::float16(5),  ov::float16(2), ov::float16(3),  ov::float16(6), ov::float16(1),  ov::float16(7),
        ov::float16(6),  ov::float16(2), ov::float16(1),  ov::float16(3), ov::float16(0),  ov::float16(6),
        ov::float16(2),  ov::float16(7), ov::float16(6),  ov::float16(1), ov::float16(7),  ov::float16(8),
        ov::float16(8),  ov::float16(5), ov::float16(0),  ov::float16(9), ov::float16(0),  ov::float16(4),
        ov::float16(2),  ov::float16(2), ov::float16(7),  ov::float16(5), ov::float16(3),  ov::float16(9),
        ov::float16(4),  ov::float16(5), ov::float16(7),  ov::float16(1), ov::float16(7),  ov::float16(7),
        ov::float16(4),  ov::float16(8), ov::float16(5),  ov::float16(9), ov::float16(1),  ov::float16(7),
        ov::float16(10), ov::float16(0), ov::float16(9),  ov::float16(4), ov::float16(5),  ov::float16(5),
    };
...
TEST(gather_elements_gpu_fp16, d25441_i22441_an4) {
    ...
    std::vector<float> expected_results = {
        ov::float16(0), ov::float16(0),  ov::float16(2),  ov::float16(5),  ov::float16(10), ov::float16(2),
        ov::float16(0), ov::float16(10), ov::float16(3),  ov::float16(10), ov::float16(1),  ov::float16(5),
        ov::float16(4), ov::float16(0),  ov::float16(10), ov::float16(8),  ov::float16(2),  ov::float16(0),
        ov::float16(2), ov::float16(3),  ov::float16(10), ov::float16(8),  ov::float16(6),  ov::float16(1),
        ov::float16(2), ov::float16(5),  ov::float16(7),  ov::float16(5),  ov::float16(4),  ov::float16(0),
        ov::float16(6), ov::float16(3),  ov::float16(10), ov::float16(9),  ov::float16(6),  ov::float16(9),
        ov::float16(1), ov::float16(6),  ov::float16(5),  ov::float16(7),  ov::float16(5),  ov::float16(2),
        ov::float16(6), ov::float16(6),  ov::float16(1),  ov::float16(5),  ov::float16(6),  ov::float16(1),
        ov::float16(6), ov::float16(4),  ov::float16(1),  ov::float16(6),  ov::float16(2),  ov::float16(6),
        ov::float16(5), ov::float16(7),  ov::float16(1),  ov::float16(9),  ov::float16(2),  ov::float16(6),
    ...
    set_values(input0,
               {
                   ...
                   ov::float16(2),  ov::float16(10), ov::float16(9),  ov::float16(9),  ov::float16(5),  ov::float16(1),
                   ov::float16(4),  ov::float16(10), ov::float16(2),  ov::float16(4),  ov::float16(3),  ov::float16(5),
                   ov::float16(9),  ov::float16(4),  ov::float16(5),  ov::float16(8),  ov::float16(4),  ov::float16(2),
                   ov::float16(10), ov::float16(1),  ov::float16(6),  ov::float16(6),  ov::float16(0),  ov::float16(0),
                   ov::float16(8),  ov::float16(8),  ov::float16(3),  ov::float16(4),  ov::float16(7),  ov::float16(7),
                   ov::float16(2),  ov::float16(9),  ov::float16(7),  ov::float16(9),  ov::float16(1),  ov::float16(0),
                   ov::float16(8),  ov::float16(6),  ov::float16(2),  ov::float16(2),  ov::float16(0),  ov::float16(4),
                   ov::float16(10), ov::float16(10), ov::float16(4),  ov::float16(2),  ov::float16(7),  ov::float16(3),
                   ov::float16(8),  ov::float16(8),  ov::float16(4),  ov::float16(3),  ov::float16(2),  ov::float16(0),
                   ov::float16(2),  ov::float16(10), ov::float16(2),  ov::float16(9),  ov::float16(1),  ov::float16(4),
                   ov::float16(6),  ov::float16(1),  ov::float16(9),  ov::float16(1),  ov::float16(10), ov::float16(2),
                   ov::float16(2),  ov::float16(1),  ov::float16(2),  ov::float16(6),  ov::float16(7),  ov::float16(8),
                   ov::float16(7),  ov::float16(8),  ov::float16(7),  ov::float16(6),  ov::float16(0),  ov::float16(6),
                   ov::float16(2),  ov::float16(3),  ov::float16(7),  ov::float16(1),  ov::float16(8),  ov::float16(5),
                   ov::float16(6),  ov::float16(6),  ov::float16(3),  ov::float16(7),  ov::float16(1),  ov::float16(1),
                   ov::float16(5),  ov::float16(9),  ov::float16(8),  ov::float16(6),  ov::float16(8),  ov::float16(3),
                   ov::float16(1),  ov::float16(5),  ov::float16(3),  ov::float16(6),  ov::float16(5),  ov::float16(4),
                   ov::float16(2),  ov::float16(4),  ov::float16(4),  ov::float16(4),  ov::float16(5),  ov::float16(4),
                   ov::float16(3),  ov::float16(0),  ov::float16(4),  ov::float16(2),  ov::float16(7),  ov::float16(7),
                   ov::float16(5),  ov::float16(8),  ov::float16(7),  ov::float16(10), ov::float16(5),  ov::float16(10),
                   ov::float16(3),  ov::float16(5),  ov::float16(5),  ov::float16(7),  ov::float16(4),  ov::float16(6),
                   ov::float16(10), ov::float16(1),  ov::float16(7),  ov::float16(3),  ov::float16(5),  ov::float16(5),
                   ov::float16(9),  ov::float16(0),  ov::float16(3),  ov::float16(7),  ov::float16(6),  ov::float16(10),
                   ov::float16(2),  ov::float16(10), ov::float16(2),  ov::float16(9),  ov::float16(7),  ov::float16(5),
                   ov::float16(8),  ov::float16(0),  ov::float16(1),  ov::float16(7),  ov::float16(7),  ov::float16(4),
                   ov::float16(6),  ov::float16(8),  ov::float16(10), ov::float16(7),  ov::float16(3),  ov::float16(8),
                   ov::float16(1),  ov::float16(0),  ov::float16(5),  ov::float16(0),  ov::float16(1),  ov::float16(9),
                   ov::float16(8),  ov::float16(8),  ov::float16(4),  ov::float16(0),  ov::float16(6),  ov::float16(5),
                   ov::float16(0),  ov::float16(5),  ov::float16(4),  ov::float16(2),  ov::float16(4),  ov::float16(6),
                   ov::float16(7),  ov::float16(7),  ov::float16(5),  ov::float16(3),  ov::float16(8),  ov::float16(4),
                   ov::float16(7),  ov::float16(3),  ov::float16(0),  ov::float16(1),  ov::float16(5),  ov::float16(8),
                   ov::float16(2),  ov::float16(0),  ov::float16(0),  ov::float16(1),  ov::float16(7),  ov::float16(3),
                   ov::float16(0),  ov::float16(5),  ov::float16(5),  ov::float16(5),  ov::float16(4),  ov::float16(1),
                   ov::float16(3),  ov::float16(9),  ov::float16(7),  ov::float16(6),  ov::float16(7),  ov::float16(3),
                   ov::float16(0),  ov::float16(10), ov::float16(5),  ov::float16(0),  ov::float16(9),  ov::float16(0),
                   ov::float16(4),  ov::float16(5),  ov::float16(6),  ov::float16(8),  ov::float16(7),  ov::float16(5),
                   ov::float16(0),  ov::float16(1),  ov::float16(10), ov::float16(2),  ov::float16(3),  ov::float16(6),
                   ov::float16(6),  ov::float16(1),  ov::float16(6),  ov::float16(10), ov::float16(3),  ov::float16(9),
                   ov::float16(10), ov::float16(2),  ov::float16(2),  ov::float16(4),  ov::float16(8),  ov::float16(9),
                   ov::float16(2),  ov::float16(8),  ov::float16(7),  ov::float16(4),  ov::float16(2),  ov::float16(7),
                   ov::float16(1),  ov::float16(2),  ov::float16(1),  ov::float16(6),  ov::float16(0),  ov::float16(1),
                   ov::float16(6),  ov::float16(4),  ov::float16(0),  ov::float16(7),  ov::float16(4),  ov::float16(9),
                   ov::float16(1),  ov::float16(10), ov::float16(0),  ov::float16(0),  ov::float16(5),  ov::float16(8),
                   ov::float16(10), ov::float16(2),  ov::float16(3),  ov::float16(8),  ov::float16(5),  ov::float16(8),
                   ov::float16(7),  ov::float16(7),  ov::float16(8),  ov::float16(0),  ov::float16(2),  ov::float16(2),
                   ov::float16(6),  ov::float16(7),  ov::float16(6),  ov::float16(4),  ov::float16(2),  ov::float16(2),
                   ov::float16(7),  ov::float16(1),  ov::float16(8),  ov::float16(1),  ov::float16(0),  ov::float16(7),
                   ov::float16(1),  ov::float16(10), ov::float16(5),  ov::float16(6),  ov::float16(10), ov::float16(0),
                   ov::float16(6),  ov::float16(7),  ov::float16(5),  ov::float16(0),  ov::float16(4),  ov::float16(5),
                   ov::float16(8),  ov::float16(0),  ov::float16(4),  ov::float16(10), ov::float16(5),  ov::float16(3),
                   ov::float16(4),  ov::float16(8),  ov::float16(2),  ov::float16(1),  ov::float16(4),  ov::float16(10),
                   ov::float16(10), ov::float16(2),  ov::float16(0),  ov::float16(1),  ov::float16(5),  ov::float16(1),
                   ov::float16(5),  ov::float16(1),  ov::float16(9),  ov::float16(4),  ov::float16(4),  ov::float16(3),
                   ov::float16(7),  ov::float16(6),  ov::float16(9),  ov::float16(8),  ov::float16(9),  ov::float16(7),
                   ov::float16(4),  ov::float16(10), ov::float16(6),  ov::float16(3),  ov::float16(5),  ov::float16(5),
                   ov::float16(4),  ov::float16(2),  ov::float16(0),  ov::float16(4),  ov::float16(5),  ov::float16(3),
                   ov::float16(1),  ov::float16(2),  ov::float16(8),  ov::float16(5),  ov::float16(7),  ov::float16(9),
                   ov::float16(2),  ov::float16(7),  ov::float16(2),  ov::float16(4),  ov::float16(0),  ov::float16(5),
    ...
    set_values(input1,
               {
                   ...
                   ov::float16(1), ov::float16(1), ov::float16(2), ov::float16(1), ov::float16(1), ov::float16(2),
               });

    std::vector<float> expected_results = {
        ov::float16(0), ov::float16(8),  ov::float16(5),  ov::float16(0),  ov::float16(1),  ov::float16(2),
        ov::float16(0), ov::float16(7),  ov::float16(4),  ov::float16(10), ov::float16(4),  ov::float16(5),
        ov::float16(9), ov::float16(0),  ov::float16(5),  ov::float16(5),  ov::float16(4),  ov::float16(4),
        ov::float16(7), ov::float16(9),  ov::float16(5),  ov::float16(8),  ov::float16(6),  ov::float16(4),
        ov::float16(8), ov::float16(5),  ov::float16(8),  ov::float16(1),  ov::float16(4),  ov::float16(7),
        ov::float16(5), ov::float16(0),  ov::float16(0),  ov::float16(5),  ov::float16(7),  ov::float16(7),
        ov::float16(2), ov::float16(8),  ov::float16(5),  ov::float16(4),  ov::float16(4),  ov::float16(1),
        ov::float16(3), ov::float16(9),  ov::float16(7),  ov::float16(0),  ov::float16(6),  ov::float16(3),
        ov::float16(9), ov::float16(10), ov::float16(5),  ov::float16(0),  ov::float16(9),  ov::float16(3),
        ov::float16(4), ov::float16(1),  ov::float16(5),  ov::float16(9),  ov::float16(10), ov::float16(5),
        ov::float16(0), ov::float16(5),  ov::float16(3),  ov::float16(4),  ov::float16(3),  ov::float16(6),
        ov::float16(2), ov::float16(9),  ov::float16(10), ov::float16(10), ov::float16(5),  ov::float16(4),
        ov::float16(3), ov::float16(2),  ov::float16(2),  ov::float16(4),  ov::float16(0),  ov::float16(0),
        ov::float16(8), ov::float16(8),  ov::float16(4),  ov::float16(4),  ov::float16(7),  ov::float16(7),
        ov::float16(9), ov::float16(6),  ov::float16(4),  ov::float16(6),  ov::float16(10), ov::float16(9),
        ov::float16(2), ov::float16(10), ov::float16(2),  ov::float16(7),  ov::float16(6),  ov::float16(9),
        ov::float16(1), ov::float16(9),  ov::float16(2),  ov::float16(4),  ov::float16(10), ov::float16(5),
        ov::float16(3), ov::float16(2),  ov::float16(3),  ov::float16(6),  ov::float16(5),  ov::float16(0),
        ov::float16(5), ov::float16(8),  ov::float16(7),  ov::float16(8),  ov::float16(0),  ov::float16(6),
        ov::float16(2), ov::float16(9),  ov::float16(6),  ov::float16(1),  ov::float16(7),  ov::float16(2),
        ov::float16(1), ov::float16(3),  ov::float16(3),  ov::float16(7),  ov::float16(0),  ov::float16(7),
        ov::float16(5), ov::float16(9),  ov::float16(8),  ov::float16(3),  ov::float16(10), ov::float16(3),
        ov::float16(1), ov::float16(5),  ov::float16(4),  ov::float16(6),  ov::float16(4),  ov::float16(5),
        ov::float16(6), ov::float16(4),  ov::float16(4),  ov::float16(10), ov::float16(5),  ov::float16(1),
        ov::float16(3), ov::float16(4),  ov::float16(2),  ov::float16(1),  ov::float16(7),  ov::float16(7),
        ov::float16(5), ov::float16(10), ov::float16(7),  ov::float16(1),  ov::float16(5),  ov::float16(10),
        ov::float16(3), ov::float16(1),  ov::float16(5),  ov::float16(4),  ov::float16(2),  ov::float16(3),
        ov::float16(7), ov::float16(1),  ov::float16(7),  ov::float16(8),  ov::float16(5),  ov::float16(5),
        ov::float16(4), ov::float16(4),  ov::float16(3),  ov::float16(3),  ov::float16(5),  ov::float16(10),
        ov::float16(4), ov::float16(2),  ov::float16(2),  ov::float16(9),  ov::float16(7),  ov::float16(5),
        ov::float16(3), ov::float16(4),  ov::float16(8),  ov::float16(5),  ov::float16(7),  ov::float16(4),
        ov::float16(6), ov::float16(8),  ov::float16(2),  ov::float16(7),  ov::float16(3),  ov::float16(5),
    };
...
TEST(gather_elements_gpu_fp16, d233113_i233115_a2) {
    ...
    std::vector<float> expected_results = {
        ov::float16(0),  ov::float16(5), ov::float16(7),  ov::float16(0), ov::float16(7), ov::float16(8),
        ov::float16(0),  ov::float16(1), ov::float16(7),  ov::float16(0), ov::float16(1), ov::float16(8),
        ov::float16(5),  ov::float16(1), ov::float16(2),  ov::float16(9), ov::float16(7), ov::float16(0),
        ov::float16(5),  ov::float16(0), ov::float16(0),  ov::float16(9), ov::float16(4), ov::float16(0),
        ov::float16(9),  ov::float16(4), ov::float16(0),  ov::float16(5), ov::float16(4), ov::float16(5),
        ov::float16(7),  ov::float16(5), ov::float16(1),  ov::float16(7), ov::float16(6), ov::float16(10),
        ov::float16(7),  ov::float16(0), ov::float16(1),  ov::float16(4), ov::float16(5), ov::float16(1),
        ov::float16(9),  ov::float16(5), ov::float16(1),  ov::float16(7), ov::float16(4), ov::float16(3),
        ov::float16(10), ov::float16(8), ov::float16(3),  ov::float16(0), ov::float16(8), ov::float16(7),
        ov::float16(0),  ov::float16(4), ov::float16(7),  ov::float16(7), ov::float16(4), ov::float16(3),
        ov::float16(7),  ov::float16(8), ov::float16(10), ov::float16(4), ov::float16(8), ov::float16(7),
        ov::float16(4),  ov::float16(2), ov::float16(10), ov::float16(7), ov::float16(8), ov::float16(10),
        ov::float16(6),  ov::float16(8), ov::float16(7),  ov::float16(5), ov::float16(4), ov::float16(9),
        ov::float16(0),  ov::float16(2), ov::float16(8),  ov::float16(5), ov::float16(4), ov::float16(3),
        ov::float16(0),  ov::float16(6), ov::float16(8),  ov::float16(5), ov::float16(6), ov::float16(3),
    };
...
TEST(gather_elements_gpu, dynamic) {
    ...
    set_values<uint8_t>(input0,
                        {0, 1, 8, 5,  5,  2, 0, 7, 7, 10, 4,  5,  9, 0, 0,  5, 7, 0, 4, 0,  4, 7, 6,  10, 9, 5, 1,
                         7, 4, 7, 10, 8,  2, 0, 8, 3, 6,  8,  10, 4, 2, 10, 7, 8, 7, 0, 6,  9, 2, 4,  8,  5, 2, 3,
                         3, 1, 5, 9,  10, 0, 9, 5, 5, 3,  10, 5,  2, 0, 10, 0, 5, 4, 3, 10, 5, 5, 10, 0,  8, 8});

    set_values<uint8_t>(input1, {0, 2, 4, 3, 4, 0, 0, 1, 4, 0, 1, 0, 1, 0, 1, 1,
                                 3, 1, 4, 2, 4, 2, 1, 3, 2, 1, 2, 4, 1, 0, 2, 4});

    std::vector<uint8_t> expected_results = {0,  0, 8, 7, 6,  2, 0, 5, 2, 1, 4,  5, 9, 2, 0, 5,
                                             10, 4, 5, 0, 10, 5, 3, 4, 5, 4, 10, 5, 2, 0, 5, 8};
