...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        // Representative shape eligible for a device-specific JIT kernel on supported devices.
        paged_selective_ssm_test_params{{8}, {0}, {8}, 64, 1, 64, 128, ov::element::f32, ov::element::i32, false},
        with_state_precision(paged_selective_ssm_test_params{{8}, {0}, {8}, 64, 1, 64, 128, ov::element::f32, ov::element::i32, false}, ov::element::f16),
        ...
        // Exceeds the maximum JIT state size and therefore covers the universal fallback behavior.
        ...
        paged_selective_ssm_test_params{{3}, {0}, {2}, 2, 1, 4, 64, ov::element::f32, ov::element::i32, false, {}, false, false, false, 1, 1},
        paged_selective_ssm_test_params{{3}, {0}, {2}, 2, 1, 4, 64, ov::element::f16, ov::element::i64, false, {}, false, false, false, 1, 2},
        with_state_precision(paged_selective_ssm_test_params{{3}, {0}, {2}, 2, 1, 4, 64, ov::element::f16, ov::element::i64, false, {}, false, false, false, 2},
                             ov::element::bf16),
