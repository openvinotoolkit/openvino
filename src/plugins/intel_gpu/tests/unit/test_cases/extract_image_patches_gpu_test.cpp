...
TEST(extract_image_patches_gpu, basic) {
    ...
    topology.add(extract_image_patches("extract_image_patches",
                                       input_info("Input0"),
                                       sizes,
                                       strides,
                                       rates,
    ...
    std::vector<float> answers = {1,  6,  51, 56,
...
TEST(extract_image_patches_gpu, basic2) {
    ...
    std::vector<float> answers = {1, 2, 3, 4, 11, 12, 13, 14, 21, 22, 23, 24, 31, 32, 33, 34};
...
void test_extract_image_patches_gpu_basic5(bool is_caching_test) {
    ...
    std::vector<T> answers = {1,  4,  16, 19,
