        ...
        for (uint32_t f = 0; f < feature_size; ++f) {
            ...
            for (uint32_t y = 0; y < y_size; ++y) {
                for (uint32_t x = 0; x < x_size; ++x) {
                    ...
                    float result =
                        rms * static_cast<float>(src[src_offset]) * static_cast<float>(weight[weight_offset]);
...
TEST(rms_gpu_test, rms_test_bfyx_ref) {
    ...
    set_values(input,
               {0.001839f,
                ...
                0.000072f,
                0.001404f});
    set_values(gamma, {0.029785f, 0.014038f, 0.003098f, 0.013123f, 0.015137f, 0.009399f});
...
TEST(rms_gpu_test, rms_test_bfyx_opt) {
    ...
    set_values(input, {0.001839f, -0.003815f, 0.000961f,  0.002930f,  -0.003998f, -0.008057f, -0.005402f, -0.002945f,
...
TEST(rms_gpu_test, rms_test_bfyx_opt_leftovers) {
    ...
    set_values(input, {0.001839f, -0.003815f, 0.000961f,  0.002930f,  -0.003998f, -0.008057f, -0.005402f, -0.002945f,
                       ...
                       0.003098f, -0.006989f, -0.000244f, 0.010193f,  0.002899f,  -0.005798f, -0.026978f, 0.008789f,
                       0.002258f, 0.006500f,  0.003159f,  -0.012329f, 0.026245f,  -0.001839f, 0.000259f,  0.002670f,
                       0.001419f, 0.001617f,  -0.006622f, 0.010864f});
    set_values(gamma,
               {0.029785f,
                0.014038f,
                0.003098f,
