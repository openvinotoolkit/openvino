...
public:
    void test_2x2x2x2_full_legacy_activation(bool is_caching_test) {
        ...
        set_values(
            input,
            {-0.2f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.8f});
    ...
    void test_2x2x2x2x2x2_full(bool is_caching_test) {
        ...
        config.set_property(ov::intel_gpu::force_implementations(
            ov::intel_gpu::ImplForcingMap{{"strided_slice", {format::bfwzyx, "", impl_types::ocl}}}));
    ...
    void test_2x2x2x2_single(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        if (impl_type != impl_types::any)
            config.set_property(ov::intel_gpu::force_implementations(
                ov::intel_gpu::ImplForcingMap{{"strided_slice", {format::bfyx, "", impl_types::cpu}}}));
    ...
    void test_2x2x4x3_stride(bool is_caching_test) {
        ...
        std::vector<float> answers = {0.f,  1.f,  2.f,  6.f,  7.f,  8.f,  12.f, 13.f, 14.f, 18.f, 19.f, 20.f,
    ...
    void test_2x2x4x4_part_stride(bool is_caching_test) {
        ...
        std::vector<float> answers = {33.0f,
                                      35.0f,
                                      37.0f,
                                      39.0f,
                                      41.0f,
    ...
    void test_2x2x1x1_new_axis_mask_2(bool is_caching_test) {
        ...
        set_values(input, {0.0f, 1.0f, 2.0f, 3.0f});
        std::vector<int64_t> begin_data = {1, 0, 1, 0};
        std::vector<int64_t> end_data = {2, 2, 4, 4};
        std::vector<int64_t> strides_data = {1, 1, 1, 2};
        ...
        std::vector<float> answers = {0.0f, 1.0f, 2.0f, 3.0f};
    ...
    void test_2x2x2x1x1_2(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        std::vector<float> answers = {0.0f, 4.0f};
    ...
    void test_2x2x2x2x1x1_2(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        if (impl_type != impl_types::any)
            config.set_property(ov::intel_gpu::force_implementations(
                ov::intel_gpu::ImplForcingMap{{"strided_slice", {format::bfwzyx, "", impl_types::cpu}}}));
    ...
    void test_2x2x2_all_dynamic_bcast(impl_types impl_type = impl_types::any) {
        ...
        std::vector<float> answers = {4.0f, 5.0f, 6.0f, 7.0f};
    ...
    void test_3d_all_dynamic_with_new_axis() {
        ...
        topology topology(input_layout("input", l_input),
...
public:
    ...
    void test_2x2x2x2_ignore(bool is_caching_test) {
        ...
        set_values(
            input,
            {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f});
        set_values<int64_t>(begin, {1, 1, 1, 1});
        set_values<int64_t>(end, {2, 2, 2, 2});
        set_values<int64_t>(strides, {1, 1, 1, 1});
    ...
    void test_2x2x4x3_stride(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        set_values(input,
                   {0.f,  1.f,  2.f,  3.f,  4.f,  5.f,  6.f,  7.f,  8.f,  9.f,  10.f, 11.f, 12.f, 13.f, 14.f, 15.f,
                    ...
                    32.f, 33.f, 34.f, 35.f, 36.f, 37.f, 38.f, 39.f, 40.f, 41.f, 42.f, 43.f, 44.f, 45.f, 46.f, 47.f});
        set_values<int64_t>(begin, {0, 0, 0, 0});
        set_values<int64_t>(end, {2, 2, 4, 3});
        set_values<int64_t>(strides, {1, 1, 2, 1});
    ...
    void test_2x2x4x4_part_stride(bool is_caching_test) {
        ...
        set_values(input, {0.0f,  1.0f,  2.0f,  3.0f,  4.0f,  5.0f,  6.0f,  7.0f,
                           ...
                           48.0f, 49.0f, 50.0f, 51.0f, 52.0f, 53.0f, 54.0f, 55.0f,
                           56.0f, 57.0f, 58.0f, 59.0f, 60.0f, 61.0f, 62.0f, 63.0f});
        set_values<int64_t>(begin, {1, 0, 0, 1});
        set_values<int64_t>(end, {2, 2, 4, 4});
    ...
    void test_2x2x4x1_new_axis_mask(bool is_caching_test, impl_types impl_type = impl_types::any) {
        ...
        set_values(
            input,
            {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f});
        set_values<int64_t>(begin, {1, 0, 1, 0});
        set_values<int64_t>(end, {2, 2, 4, 4});
        set_values<int64_t>(strides, {1, 1, 1, 2});
    ...
    void test_2x2x1x1(bool is_caching_test) {
        ...
        set_values<int64_t>(begin, {0, 0});
        set_values<int64_t>(end, {2, 2});
        set_values<int64_t>(strides, {1, 1});
    ...
    void test_2x2x2x2_full_negative_stride_f_axis(bool is_caching_test) {
        ...
        set_values(input, {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f});
        std::vector<int64_t> begin = {0, 0, 0, 0};
        std::vector<int64_t> end = {1, 2, 2, 2};
        std::vector<int64_t> strides = {1, -1, 1, 1};

        topology topology;
        topology.add(input_layout("input", input->get_layout()));
        topology.add(
            strided_slice("strided_slice", input_info("input"), begin, end, strides, {}, {}, {}, {}, {}, {1, 2, 2, 2}));
        ...
        std::vector<float> answers = {4.f, 5.f, 6.f, 7.f, 0.f, 1.f, 2.f, 3.f};
    ...
    void test_2x2x2x2_full_negative_stride_negative_begin_f_axis(bool is_caching_test) {
        ...
        std::vector<int64_t> end = {100, -100};
    ...
    void test_2x2x2x2_full_negative_stride_f_axis_clamp(bool is_caching_test) {
        ...
        set_values(input, {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f});
        std::vector<int64_t> begin = {0, 100};
        std::vector<int64_t> end = {100, -100};
        std::vector<int64_t> strides = {1, -1};
    ...
    void test_1x3x1x3_negative(bool is_caching_test) {
        ...
        set_values<int64_t>(begin, {0, -1, 0});
        set_values<int64_t>(end, {1, -2, 3});
        set_values<int64_t>(strides, {1, -1, 1});
    ...
    void test_1x1x1x3_negative(bool is_caching_test) {
        ...
        set_values<int64_t>(begin, {0, -1, 0, 0});
        set_values<int64_t>(end, {1, -2, 1, 3});
        set_values<int64_t>(strides, {1, -1, 1, 1});
    ...
    void test_2x2x2x2_negative_begin_end_positive_stride(bool is_caching_test) {
        ...
        set_values(
            input,
            {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f});
        set_values<int64_t>(begin, {-1, -1, 0, 0});
        set_values<int64_t>(end, {-3, -3, 2, 2});
        set_values<int64_t>(strides, {1, 1, 1, 1});
    ...
    void test_1x1x1x10_pos_begin_end_neg_stride2(bool is_caching_test) {
        ...
        set_values(input, {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f});
        set_values<int64_t>(begin, {0, 0, 0, 3});
        set_values<int64_t>(end, {1, 1, 1, 6});
        set_values<int64_t>(strides, {1, 1, 1, -2});
    ...
    void test_1x1x1x10_neg_begin_end_neg_stride2(bool is_caching_test) {
        ...
        set_values(input, {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f});
        set_values<int64_t>(begin, {0, 0, 0, -5});
        set_values<int64_t>(end, {1, 1, 1, -8});
        set_values<int64_t>(strides, {1, 1, 1, -2});
...
public:
    void test_2x2x2x1x1(bool is_caching_test) {
        ...
        set_values<int8_t>(input, {0, 1, 2, 3, 4, 5, 6, 7});
        std::vector<int64_t> begin_data = {0, 0, 0};
        std::vector<int64_t> end_data = {1, 2, 2};
        std::vector<int64_t> strides_data = {1, 1, 1};
        ...
        std::vector<int8_t> answers = {0, 1, 2, 3};
...
public:
    void test_1x1x1x8x1_new_axis_5d(bool is_caching_test) {
        ...
        set_values(input, {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f});
        set_values(begin, {0, 0, 0, 0, 0});
        set_values(end, {0, 0, 0, 0, 0});
        set_values(strides, {1, 1, 1, 1, 1});
        ...
        std::vector<float> answers = {0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f};
