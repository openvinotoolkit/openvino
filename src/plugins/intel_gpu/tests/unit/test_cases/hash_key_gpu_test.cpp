...
public:
    ...
    void test_fc_basic(bool is_caching_test) {
        ...
        topology topology(input_layout("input", input_prim->get_layout()),
    ...
    void test_gather_basic(bool is_caching_test) {
        ...
        topology.add(gather(key_prim_id,
    ...
    void test_reshape_basic(bool is_caching_test) {
        ...
        topology.add(reshape(key_prim_id,
                             input_info("reorder"),
                             tensor(1, 1, 4, 1),
