...
void test_basic_in2x3x2x2_nearest(bool is_caching_test) {
    ...
    topology.add(resample("upsampling",
                          input_info("input"),
                          output_size,
                          num_filter,
    ...
    set_values(input,
               {
                   1.f, 2.f, -10.f, 3.f,  4.f,   -14.f, 5.f,  6.f,  -12.f, 7.f,  8.f, -16.f,
                   0.f, 0.f, -11.f, 0.5f, -0.5f, -15.f, 1.5f, 5.2f, -13.f, 12.f, 9.f, -17.f,
               });
    ...
    T answers[96] = {
        1.f,   1.f,   2.f,   2.f,   -10.f, -10.f, 1.f,   1.f,   2.f,   2.f,   -10.f, -10.f, 3.f,   3.f,   4.f,   4.f,
        -14.f, -14.f, 3.f,   3.f,   4.f,   4.f,   -14.f, -14.f, 5.f,   5.f,   6.f,   6.f,   -12.f, -12.f, 5.f,   5.f,
        6.f,   6.f,   -12.f, -12.f, 7.f,   7.f,   8.f,   8.f,   -16.f, -16.f, 7.f,   7.f,   8.f,   8.f,   -16.f, -16.f,
        0.f,   0.f,   0.f,   0.f,   -11.f, -11.f, 0.f,   0.f,   0.f,   0.f,   -11.f, -11.f, 0.5f,  0.5f,  -0.5f, -0.5f,
        -15.f, -15.f, 0.5f,  0.5f,  -0.5f, -0.5f, -15.f, -15.f, 1.5f,  1.5f,  5.2f,  5.2f,  -13.f, -13.f, 1.5f,  1.5f,
        5.2f,  5.2f,  -13.f, -13.f, 12.f,  12.f,  9.f,   9.f,   -17.f, -17.f, 12.f,  12.f,  9.f,   9.f,   -17.f, -17.f,
    };
...
TEST(resample_gpu, nearest_asymmetric) {
    ...
    float answers[20] = {
        1.f, 1.f, 1.f, 2.f, 2.f, 1.f, 1.f, 1.f, 2.f, 2.f, 3.f, 3.f, 3.f, 4.f, 4.f, 3.f, 3.f, 3.f, 4.f, 4.f,
    };
...
TEST(resample_gpu, nearest_asymmetric_i8) {
    ...
    int8_t answers[20] = {
        1, 1, 1, 2, 2, 1, 1, 1, 2, 2, 3, 3, 3, 4, 4, 3, 3, 3, 4, 4,
    };
...
TEST(resample_gpu, bilinear_asymmetric) {
    ...
    float answers[24] = {
        1.f,  1.f,  1.33333f, 1.66667f, 2.f,  2.f,  1.5f, 1.5f, 1.83333f, 2.16667f, 2.5f, 2.5f,
        2.5f, 2.5f, 2.83333f, 3.16667f, 3.5f, 3.5f, 3.f,  3.f,  3.33333f, 3.66667f, 4.f,  4.f,
    };
...
struct resample_random_test : testing::TestWithParam<resample_random_test_params> {
    ...
    void compare_nearest_typed(const memory::ptr input, const memory::ptr output, uint32_t align_corners) {
        ...
        float x_ratio =
            x > align_corners ? static_cast<float>(in_x - align_corners) / static_cast<float>(x - align_corners) : 0.f;
        float y_ratio =
            y > align_corners ? static_cast<float>(in_y - align_corners) / static_cast<float>(y - align_corners) : 0.f;
            ...
            for (size_t fi = 0; fi < f; ++fi) {
                for (size_t yi = 0; yi < y; ++yi) {
                    for (size_t xi = 0; xi < x; ++xi) {
                        ...
                        auto bottom_right_coords =
                            tensor(batch(bi), feature(fi), spatial(high_in_xi, high_in_yi, 0, 0));
                        ...
                        auto bottom_val =
                            static_cast<float>(bottom_left_val) +
    ...
    void compare(const memory::ptr input,
                 const memory::ptr output,
                 resample::InterpolateOp::InterpolateMode operation,
                 uint32_t align_corners) {
    ...
    void execute(const resample_random_test_params& params, bool is_caching_test) {
        ...
        auto prim =
            resample("resample", input_info("in"), params.output_size, params.num_filter, params.operation_type);
        topo.add(prim);

        ExecutionConfig config = get_test_default_config(engine);
        config.set_property(
            ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"resample", {params.out_format, ""}}}));
...
struct resample_random_test_param_generator : std::vector<resample_random_test_params> {
    ...
    resample_random_test_param_generator& smoke_params(data_types type,
                                                       format::type input_format,
                                                       format::type output_format) {
        push_back(resample_random_test_params{type,
                                              {1, 17, 5, 9},
                                              {1, 17, 15, 18},
                                              1,
                                              resample::InterpolateOp::InterpolateMode::NEAREST,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(resample_random_test_param_generator()
...
struct caffe_resample_random_test : testing::TestWithParam<caffe_resample_random_test_params> {
    ...
    void execute_compare(const caffe_resample_random_test_params& params, bool check_result, bool is_caching_test) {
        ...
        config.set_property(ov::intel_gpu::force_implementations(
            ov::intel_gpu::ImplForcingMap{{"resample", {params.in_format, "resample_ref"}}}));
        ...
        auto prim_opt =
            resample("resample_opt", input_info("in"), params.output_size, params.num_filter, params.operation_type);
        ...
        config_opt.set_property(ov::intel_gpu::force_implementations(
            ov::intel_gpu::ImplForcingMap{{"resample_opt", {params.in_format, "resample_opt"}}}));
...
struct caffe_resample_random_test_param_generator : std::vector<caffe_resample_random_test_params> {
    ...
    caffe_resample_random_test_param_generator& smoke_params(data_types type,
                                                             format::type input_format,
                                                             format::type output_format) {
        push_back(caffe_resample_random_test_params{type,
                                                    {1, 512, 16, 16},
                                                    {1, 512, 32, 32},
                                                    1,
                                                    resample::InterpolateOp::InterpolateMode::LINEAR,
...
INSTANTIATE_TEST_SUITE_P(
    caffe_smoke_caffe_fsv16,
    caffe_resample_random_test,
    testing::ValuesIn(caffe_resample_random_test_param_generator()
                          .smoke_params(data_types::f32, format::b_fs_yx_fsv16, format::b_fs_yx_fsv16)
                          .smoke_params(data_types::f16, format::b_fs_yx_fsv16, format::b_fs_yx_fsv16)));

INSTANTIATE_TEST_SUITE_P(
    caffe_smoke_caffe_fsv32,
    caffe_resample_random_test,
    testing::ValuesIn(caffe_resample_random_test_param_generator().smoke_params(data_types::f16,
...
TEST(resample_gpu, interpolate_in2x2x3x2_nearest1) {
    ...
    topology.add(resample("interpolate",
                          input_info("input"),
                          output_pattern,
                          std::vector<float>{},
                          {},
    ...
    float answers[96] = {
        0.f,  1.f,  1.f,  1.f,  2.f,  3.f,  3.f,  3.f,  2.f,  3.f,  3.f,  3.f,
        4.f,  5.f,  5.f,  5.f,  4.f,  5.f,  5.f,  5.f,  4.f,  5.f,  5.f,  5.f,

        6.f,  7.f,  7.f,  7.f,  8.f,  9.f,  9.f,  9.f,  8.f,  9.f,  9.f,  9.f,
        10.f, 11.f, 11.f, 11.f, 10.f, 11.f, 11.f, 11.f, 10.f, 11.f, 11.f, 11.f,

        12.f, 13.f, 13.f, 13.f, 14.f, 15.f, 15.f, 15.f, 14.f, 15.f, 15.f, 15.f,
        16.f, 17.f, 17.f, 17.f, 16.f, 17.f, 17.f, 17.f, 16.f, 17.f, 17.f, 17.f,

        18.f, 19.f, 19.f, 19.f, 20.f, 21.f, 21.f, 21.f, 20.f, 21.f, 21.f, 21.f,
        22.f, 23.f, 23.f, 23.f, 22.f, 23.f, 23.f, 23.f, 22.f, 23.f, 23.f, 23.f,
    };
...
TEST(resample_gpu, interpolate_in2x2x3x2_nearest2) {
    ...
    float answers[96] = {
        0.f,  0.f,  1.f,  1.f,  0.f,  0.f,  1.f,  1.f,  2.f,  2.f,  3.f,  3.f,
        2.f,  2.f,  3.f,  3.f,  4.f,  4.f,  5.f,  5.f,  4.f,  4.f,  5.f,  5.f,

        6.f,  6.f,  7.f,  7.f,  6.f,  6.f,  7.f,  7.f,  8.f,  8.f,  9.f,  9.f,
        8.f,  8.f,  9.f,  9.f,  10.f, 10.f, 11.f, 11.f, 10.f, 10.f, 11.f, 11.f,

        12.f, 12.f, 13.f, 13.f, 12.f, 12.f, 13.f, 13.f, 14.f, 14.f, 15.f, 15.f,
        14.f, 14.f, 15.f, 15.f, 16.f, 16.f, 17.f, 17.f, 16.f, 16.f, 17.f, 17.f,

        18.f, 18.f, 19.f, 19.f, 18.f, 18.f, 19.f, 19.f, 20.f, 20.f, 21.f, 21.f,
        20.f, 20.f, 21.f, 21.f, 22.f, 22.f, 23.f, 23.f, 22.f, 22.f, 23.f, 23.f,
    };
...
TEST(resample_gpu, interpolate_in2x2x3x2_nearest4) {
    ...
    float answers[96] = {
        ...
        2.f,  2.f,  2.f,  3.f,  2.f,  2.f,  2.f,  3.f,  4.f,  4.f,  4.f,  5.f,

        6.f,  6.f,  6.f,  7.f,  6.f,  6.f,  6.f,  7.f,  6.f,  6.f,  6.f,  7.f,
        8.f,  8.f,  8.f,  9.f,  8.f,  8.f,  8.f,  9.f,  10.f, 10.f, 10.f, 11.f,

        12.f, 12.f, 12.f, 13.f, 12.f, 12.f, 12.f, 13.f, 12.f, 12.f, 12.f, 13.f,
        14.f, 14.f, 14.f, 15.f, 14.f, 14.f, 14.f, 15.f, 16.f, 16.f, 16.f, 17.f,

        18.f, 18.f, 18.f, 19.f, 18.f, 18.f, 18.f, 19.f, 18.f, 18.f, 18.f, 19.f,
        20.f, 20.f, 20.f, 21.f, 20.f, 20.f, 20.f, 21.f, 22.f, 22.f, 22.f, 23.f,
    };
...
TEST(resample_gpu, interpolate_in2x2x3x2_coord_transform_mode1) {
    ...
    std::vector<float> answers = {
        0.f,  0.f,  1.f,  4.f,  4.f,  5.f,

        6.f,  6.f,  7.f,  10.f, 10.f, 11.f,

        12.f, 12.f, 13.f, 16.f, 16.f, 17.f,

        18.f, 18.f, 19.f, 22.f, 22.f, 23.f,
    };
...
TEST(resample_gpu, interpolate_in2x2x3x2_coord_transform_mode3) {
    ...
    std::vector<float> answers = {
        0.f,  1.f,  1.f,  2.f,  3.f,  3.f,

        6.f,  7.f,  7.f,  8.f,  9.f,  9.f,

        12.f, 13.f, 13.f, 14.f, 15.f, 15.f,

        18.f, 19.f, 19.f, 20.f, 21.f, 21.f,
    };
...
TEST(resample_gpu, interpolate_in2x2x3x2_coord_transform_mode4) {
    ...
    std::vector<float> answers = {
        2.f,  3.f,  3.f,  4.f,  5.f,  5.f,

        8.f,  9.f,  9.f,  10.f, 11.f, 11.f,

        14.f, 15.f, 15.f, 16.f, 17.f, 17.f,

        20.f, 21.f, 21.f, 22.f, 23.f, 23.f,
    };
...
TEST(resample_gpu, interpolate_in2x2x3x2_cubic) {
    ...
    std::vector<float> answers = {
        0.29600694f,  0.8828125f,  1.46961806f,  3.53038194f,  4.1171875f,  4.70399306f,

        6.29600694f,  6.8828125f,  7.46961806f,  9.53038194f,  10.1171875f, 10.70399306f,

        12.29600694f, 12.8828125f, 13.46961806f, 15.53038194f, 16.1171875f, 16.70399306f,

        18.29600694f, 18.8828125f, 19.46961806f, 21.53038194f, 22.1171875f, 22.70399306f,
    };
...
TEST(resample_gpu, interpolate_in2x2x3x2_linear) {
    ...
    std::vector<float> answers = {
        0.5f,  1.f,  1.5f,  3.5f,  4.f,  4.5f,

        6.5f,  7.f,  7.5f,  9.5f,  10.f, 10.5f,

        12.5f, 13.f, 13.5f, 15.5f, 16.f, 16.5f,

        18.5f, 19.f, 19.5f, 21.5f, 22.f, 22.5f,
    };
...
TEST(resample_gpu, interpolate_in1x1x2x4_linear_scale) {
    ...
    std::vector<float> answers = {2.6666665f, 4.3333331f};
...
TEST(resample_gpu, downsampling_u8) {
    ...
    set_values<uint8_t>(
        input,
        {124, 126, 128, 130, 131, 131, 129, 128, 119, 119, 119, 119, 119, 119, 119, 119, 125, 124, 120, 118, 115,
         111, 109, 106, 103, 109, 95,  120, 155, 150, 142, 139, 129, 128, 122, 110, 98,  85,  81,  78,  79,  78,
         76,  75,  74,  75,  76,  77,  78,  77,  77,  76,  76,  77,  77,  78,  80,  77,  75,  75,  78,  81,  83,
         83,  79,  79,  78,  78,  78,  77,  75,  75,  70,  71,  73,  74,  76,  76,  75,  74,  74,  72,  71,  70,
         71,  72,  75,  76,  74,  73,  74,  72,  73,  73,  72,  72,  71,  71,  71,  72,  72,  72,  73,  73,  73,
         71,  69,  71,  75,  78,  78,  75,  72,  72,  75,  77,  79,  79,  79,  78,  76,  75,  74,  72,  72,  73,
         74,  75,  74,  74,  75,  75,  75,  75,  75,  75,  77,  74,  70,  67,  67,  69,  73,  76});
...
struct resample_opt_random_test : testing::TestWithParam<resample_opt_random_test_params> {
    ...
    void execute_compare(const resample_opt_random_test_params& params,
                         bool check_result,
                         bool is_caching_test,
                         const std::string& kernel = "resample_opt") {
        auto& engine = get_test_engine();
        ...
        auto prim_opt = resample("resample_opt",
                                 input_info("in_to_input_type"),
                                 params.output_size,
                                 params.num_filter,
        ...
        if (!format::is_simple_data_format(params.in_format)) {
            ASSERT_FALSE(
                format::is_simple_data_format(result_opt.at("resample_opt").get_memory()->get_layout().format));
        }
        if (check_result == true) {
            // Check data_types
            if (params.input_type == data_types::f32) {
...
struct resample_opt_random_test_ext : resample_opt_random_test {
    void execute_perf_test(const resample_opt_random_test_params& params,
                           const std::string& kernel,
                           const bool do_planar = false) {
        auto& engine = get_test_engine();
        ...
        cfg.set_property(ov::intel_gpu::force_implementations(
            ov::intel_gpu::ImplForcingMap{{"resample_opt", {working_format, kernel}}}));
        ...
        std::cout << "Exectued time " << "" << mode << " " << is_opt << " " << kernel << " " << " input("
                  << params.input_size.to_string() << ") output(" << params.output_size.to_string() << ") " << frm_str
...
INSTANTIATE_TEST_SUITE_P(resample_opt_smoke_nearest,
                         ...
                         testing::ValuesIn(std::vector<resample_opt_random_test_params>{
                             {data_types::i8,
                              {1, 128, 13, 13},
                              {1, 128, 26, 26},
                              1,
