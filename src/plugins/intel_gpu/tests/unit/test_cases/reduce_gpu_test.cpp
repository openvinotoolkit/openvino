...
INSTANTIATE_TEST_SUITE_P(reduce_scalar_output_f16_f16,
                        ...
                        ::testing::Values(
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 1013, 2, format::bfyx, reduce_mode::sum, {3, 2, 1, 0}, "reduce_ref", false, data_types::f16, false, data_types::f16),
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 1013, 2, format::bfyx, reduce_mode::min, {3, 2, 1, 0}, "reduce_ref", false, data_types::f16, false, data_types::f16),
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 1013, 2, format::bfyx, reduce_mode::mean, {3, 2, 1, 0}, "reduce_ref", false, data_types::f16, false, data_types::f16),
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 1013, 2, format::bfyx, reduce_mode::max, {3, 2, 1, 0}, "reduce_ref", false, data_types::f16, false, data_types::f16),
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 512, 1,  format::bfyx, reduce_mode::min, {3, 2, 1, 0}, "reduce_ref", false, data_types::f16, false, data_types::f16),
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 513, 1,  format::bfyx, reduce_mode::min, {3, 2, 1, 0}, "reduce_ref", false, data_types::f16, false, data_types::f16),
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 1024, 1, format::bfyx, reduce_mode::min, {3, 2, 1, 0}, "reduce_ref", false, data_types::f16, false, data_types::f16),
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 1025, 1, format::bfyx, reduce_mode::min, {3, 2, 1, 0}, "reduce_ref", false, data_types::f16, false, data_types::f16)
                        ), general_reduce_gpu::PrintToStringParamName);
