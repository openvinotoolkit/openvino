...
INSTANTIATE_TEST_SUITE_P(reduce_scalar_output_f16_f16,
                        ...
                        ::testing::Values(
                            ...
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 512, 1,  format::bfyx, reduce_mode::min, {3, 2, 1, 0},  "reduce_simple_to_scalar", false, data_types::f16, false, data_types::f16),
                            TestParamType_general_reduce_gpu(1, 1, 1, 1, 513, 1,  format::bfyx, reduce_mode::min, {3, 2, 1, 0},  "reduce_simple_to_scalar", false, data_types::f16, false, data_types::f16),
