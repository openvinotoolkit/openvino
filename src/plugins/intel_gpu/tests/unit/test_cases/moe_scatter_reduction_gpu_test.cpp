...
void test_moe_scatter_reduction(bool is_caching_test, size_t k) {
    ...
    auto expert_weights_per_token_shape = ov::PartialShape{ov::Dimension::dynamic(), ov::Dimension(num_active_experts_per_token)};
    ...
    auto tokens_per_expert_data_shape    = ov::PartialShape{ov::Dimension(num_tokens * num_active_experts_per_token)};
    ...
    auto experts_ids_data_shape    = ov::PartialShape{ov::Dimension(experts_ids_data.size())};
    auto experts_ids_data_layout   = layout{experts_ids_data_shape, data_types::i32, format::bfyx};
    auto experts_ids_data_mem      = engine.allocate_memory(experts_ids_data_layout);
    set_values(experts_ids_data_mem, experts_ids_data);
    ...
    network.set_input_data("experts_ids", experts_ids_data_mem);
