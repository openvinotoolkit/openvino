...
INSTANTIATE_TEST_SUITE_P(
    GroupNormalizationGPUTest_blocked_layouts_support_5d_16_256_256_128, GroupNormalizationGPUTest,
    ::testing::Combine(
        ::testing::Values(std::vector<int32_t>{1, 16, 256, 256, 128}),  // pass with loop 1, fail with loop 3
        //::testing::Values(std::vector<int32_t>{1, 16, 256, 256, 256}), // fail with loop 1, fail with wait()
        //::testing::Values(std::vector<int32_t>{1, 16, 1024, 256, 128}), // fail with loop 1, fail with wait() or finish()
        ::testing::Values(8),
        ::testing::Values(0.0025),
...
INSTANTIATE_TEST_SUITE_P(
    gtest_GroupNormalizationGPUTest_blocked_layouts_support_5d_4_2_3_4, GroupNormalizationGPUTest,
    ::testing::Combine(
        ::testing::Values(std::vector<int32_t>{1, 4, 2, 3, 4}),  // pass with loop 3
        ::testing::Values(2),
        ::testing::Values(0.0025),
        ::testing::ValuesIn(f_blocked_5d_formats)));
