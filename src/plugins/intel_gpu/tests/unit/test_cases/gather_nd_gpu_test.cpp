...
inline void DoTestBase(engine& engine,
    ...
    auto gather_nd_inst = gather_nd("gather_nd",
...
TEST(gather_nd_gpu_fp16, d231322_i231321_ir6_batch5) {
    ...
    set_values(input0,
               {
                   ov::float16(11), ov::float16(12), ov::float16(13), ov::float16(14), ov::float16(15), ov::float16(16),
                   ov::float16(17), ov::float16(18), ov::float16(19), ov::float16(10), ov::float16(21), ov::float16(18),
                   ov::float16(21), ov::float16(22), ov::float16(23), ov::float16(24), ov::float16(25), ov::float16(26),
                   ov::float16(27), ov::float16(28), ov::float16(29), ov::float16(20), ov::float16(27), ov::float16(28),
                   ov::float16(31), ov::float16(32), ov::float16(33), ov::float16(34), ov::float16(35), ov::float16(36),
                   ov::float16(37), ov::float16(38), ov::float16(39), ov::float16(30), ov::float16(31), ov::float16(30),

                   ov::float16(11), ov::float16(12), ov::float16(13), ov::float16(14), ov::float16(15), ov::float16(16),
                   ov::float16(17), ov::float16(18), ov::float16(19), ov::float16(10), ov::float16(17), ov::float16(18),
                   ov::float16(21), ov::float16(22), ov::float16(23), ov::float16(24), ov::float16(25), ov::float16(26),
                   ov::float16(27), ov::float16(28), ov::float16(29), ov::float16(20), ov::float16(27), ov::float16(28),
                   ov::float16(31), ov::float16(32), ov::float16(33), ov::float16(34), ov::float16(35), ov::float16(36),
                   ov::float16(37), ov::float16(38), ov::float16(39), ov::float16(30), ov::float16(29), ov::float16(30),
               });
...
TEST(gather_nd_gpu_fp16, d23223_i2321_ir4_batch3) {
    ...
    set_values(input0,
               {
                   ov::float16(11), ov::float16(12), ov::float16(13), ov::float16(14), ov::float16(15), ov::float16(16),
                   ov::float16(17), ov::float16(18), ov::float16(15), ov::float16(16), ov::float16(17), ov::float16(18),
                   ov::float16(21), ov::float16(22), ov::float16(23), ov::float16(24), ov::float16(25), ov::float16(26),
                   ov::float16(27), ov::float16(28), ov::float16(25), ov::float16(26), ov::float16(27), ov::float16(28),
                   ov::float16(29), ov::float16(30), ov::float16(31), ov::float16(32), ov::float16(33), ov::float16(34),
                   ov::float16(35), ov::float16(36), ov::float16(33), ov::float16(34), ov::float16(35), ov::float16(36),
...
TEST(gather_nd_gpu_fp16, d2342_i2312_ir4_batch2) {
    ...
    set_values(input0,
               {
                   ov::float16(11), ov::float16(12), ov::float16(13), ov::float16(14), ov::float16(15), ov::float16(16),
                   ov::float16(17), ov::float16(18), ov::float16(21), ov::float16(22), ov::float16(23), ov::float16(24),
...
TEST(gather_nd_gpu_fp16, d22_i21_ir2_batch0) {
    ...
    set_values(input0, {ov::float16(1), ov::float16(2), ov::float16(3), ov::float16(4)});
...
TEST(gather_nd_gpu_fp16, dynamic_r4) {
    ...
    auto input2 =
        engine.allocate_memory(layout{ov::PartialShape(in2_shape), data_types::f16, format::bfyx});  // Indexes
    ...
    topology.add(gather_nd("gather_nd",
                           input_info("input1"),
                           input_info("input2"),
                           static_cast<uint8_t>(in1_shape.size()),
                           static_cast<uint8_t>(in2_shape.size()),
                           batch_dims,
                           true));
...
TEST(gather_nd_gpu_fp16, dynamic_r5) {
    ...
    auto input2 =
        engine.allocate_memory(layout{ov::PartialShape(in2_shape), data_types::f16, format::bfzyx});  // Indexes
