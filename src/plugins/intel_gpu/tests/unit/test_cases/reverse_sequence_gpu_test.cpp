...
void test_fp32_d2_2_ba1_sa0(bool is_caching_test) {
    ...
    set_values(seq_lengths, {1.0f, 2.0f});
    ...
    std::vector<T> expected_results = {0.0f, 3.0f, 2.0f, 1.0f};
...
void test_fp32_d3_3_3_ba0_sa1(bool is_caching_test) {
    ...
    set_values(seq_lengths, {2.0f, 2.0f, 2.0f});
    ...
    std::vector<T> expected_results = {3.0f,  4.0f,  5.0f,  0.0f,  1.0f,  2.0f,  6.0f,  7.0f,  8.0f,
...
TEST(reverese_sequence_gpu_test, fp32_d3_3_3_ba2_sa0) {
    ...
    std::vector<float> expected_results = {9.0f,  10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f, 16.0f, 17.0f,
...
TEST(reverese_sequence_gpu_test, fp32_d2_2_3_2ba0_sa3) {
    ...
    std::vector<float> expected_results = {0.0f,  1.0f,  2.0f,  3.0f,  4.0f,  5.0f,  6.0f,  7.0f,
                                           8.0f,  9.0f,  10.0f, 11.0f, 13.0f, 12.0f, 15.0f, 14.0f,
                                           17.0f, 16.0f, 19.0f, 18.0f, 21.0f, 20.0f, 23.0f, 22.0f};
...
TEST(reverese_sequence_gpu_test, fp32_d2_2_3_2ba0_sa2) {
    ...
    set_values(seq_lengths, {2.0f, 2.0f});
    ...
    std::vector<float> expected_results = {2.0f,  3.0f,  0.0f,  1.0f,  4.0f,  5.0f,  8.0f,  9.0f,
                                           6.0f,  7.0f,  10.0f, 11.0f, 14.0f, 15.0f, 12.0f, 13.0f,
                                           16.0f, 17.0f, 20.0f, 21.0f, 18.0f, 19.0f, 22.0f, 23.0f};
...
TEST(reverese_sequence_gpu_test, fp32_d2_2_3_2ba2_sa0) {
    ...
    set_values(seq_lengths, {1.0f, 1.0f, 2.0f});
    ...
    std::vector<float> expected_results = {0.0f, 1.0f, 2.0f,  3.0f,  16.0f, 17.0f, 6.0f,  7.0f,
                                           8.0f, 9.0f, 22.0f, 23.0f, 12.0f, 13.0f, 14.0f, 15.0f,
                                           4.0f, 5.0f, 18.0f, 19.0f, 20.0f, 21.0f, 10.0f, 11.0f};
...
TEST(reverese_sequence_gpu_test, fp16_d2_2_ba1_sa0) {
    ...
    set_values(input, {ov::float16(0.0f), ov::float16(1.0f), ov::float16(2.0f), ov::float16(3.0f)});
    ...
    std::vector<float> expected_results = {0.0f, 3.0f, 2.0f, 1.0f};
...
TEST(reverese_sequence_gpu_test, fp16x2_d2_2_ba1_sa0) {
    ...
    set_values(seq_lengths, {ov::float16(1.0f), ov::float16(2.0f)});
...
TEST(reverese_sequence_gpu_test, fp16_d3_3_3_ba0_sa1) {
    ...
    set_values(input,
               {ov::float16(0.0f),  ov::float16(1.0f),  ov::float16(2.0f),  ov::float16(3.0f),  ov::float16(4.0f),
                ...
                ov::float16(25.0f), ov::float16(26.0f)});
    ...
    std::vector<float> expected_results = {3.0f,  4.0f,  5.0f,  0.0f,  1.0f,  2.0f,  6.0f,  7.0f,  8.0f,
                                           12.0f, 13.0f, 14.0f, 9.0f,  10.0f, 11.0f, 15.0f, 16.0f, 17.0f,
                                           21.0f, 22.0f, 23.0f, 18.0f, 19.0f, 20.0f, 24.0f, 25.0f, 26.0f};
