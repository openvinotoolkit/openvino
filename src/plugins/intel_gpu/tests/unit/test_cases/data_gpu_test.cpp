...
TEST(data_gpu, attach_host_buffer) {
    ...
    std::vector<float> weights_data = {1.5f, 1.0f, -1.0f, 0.0f, 0.5f, -0.5f, -0.5f, 1.0f};
    ...
    set_values(input_memory, {-0.5f, 2.0f, 0.5f, 1.f, -1.5f, 2.0f, 0.5f, 1.f, -0.5f, 2.5f, 0.5f, 1.f,
                              -0.5f, 3.0f, 0.5f, 1.f, -0.5f, 2.0f, 0.5f, 1.f, -0.5f, 2.0f, 2.5f, 1.f});
    ...
    cldnn::topology topology{
        ...
        fully_connected("fc",
                        ...
                        "",
                        cldnn::padding(),
                        in_layout.get_partial_shape().size()),
    };
