...
// ScatterUpdate: the plugin's legacy (static) constant layout selection must
// give a 1-D constant consumed by ScatterUpdate batch interpretation
// ([N,1,1,1], like Gather/GatherND), otherwise the scatter runs on the wrong
// axis. Constant data [64] + Constant indices [8] + Parameter updates [8],
// axis = 0.
// ---------------------------------------------------------------------------
...
TEST(scatter_update_gpu, static_model_1d_constant_data_v3) {
