...
public:
    /*
    In this test we check if the convolution conv2 will be eliminated from the network. This is expected to be done in
    trim_to_outputs optimization pass
    ...
    */
    void test_one_node_to_eliminate_case1(bool is_caching_test) {
        ...
        topology.add(cldnn::convolution("conv1",
                                        input_info("input"),
                                        "weights",
                                        "bias",
                                        1,
    ...
    */
    void test_two_nodes_to_eliminate_case1(bool is_caching_test) {
        ...
        topology.add(cldnn::convolution("conv2",
                                        ...
                                        {0, 0},
                                        false));
        topology.add(cldnn::convolution("conv3",
                                        input_info("conv2"),
                                        "weights23",
                                        "bias",
                                        1,
        ...
        topology.add(cldnn::convolution("conv4",
                                        input_info("conv1"),
                                        "weights4",
                                        "bias",
                                        1,
    ...
    void test_const_removal() {
        ...
        topology.add(
            convolution("conv2", input_info("pool"), "weights", "bias", 1, {1, 1}, {1, 1}, {0, 0}, {0, 0}, false));
