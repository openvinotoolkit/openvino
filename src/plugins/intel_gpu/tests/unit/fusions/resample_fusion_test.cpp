...
#define CASE_RESAMPLE_FP32_1                                                                                        \
    {1, 15, 4, 5}, {1, 15, 2, 3}, data_types::f32, format::bfyx, resample::InterpolateOp::InterpolateMode::NEAREST, \
        data_types::f32, format::bfyx
#define CASE_RESAMPLE_FP32_3                                                                                       \
    {1, 15, 4, 5}, {1, 15, 2, 3}, data_types::f32, format::bfyx, resample::InterpolateOp::InterpolateMode::LINEAR, \
        data_types::f32, format::bfyx
#define CASE_RESAMPLE_FP32_4                                                                                        \
    {1, 16, 4, 5}, {1, 16, 7, 8}, data_types::f32, format::bfyx, resample::InterpolateOp::InterpolateMode::NEAREST, \
        data_types::f32, format::bfyx
#define CASE_RESAMPLE_FP32_6                                                                                       \
    {1, 16, 4, 5}, {1, 16, 7, 8}, data_types::f32, format::bfyx, resample::InterpolateOp::InterpolateMode::LINEAR, \
        data_types::f32, format::bfyx
#define CASE_RESAMPLE_FP32_7                                            \
    {1, 16, 4, 5, 4}, {1, 16, 2, 3, 2}, data_types::f32, format::bfzyx, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f32, format::bfzyx
#define CASE_RESAMPLE_FP32_8                                            \
    {1, 16, 4, 5, 4}, {1, 16, 2, 3, 2}, data_types::f32, format::bfzyx, \
        resample::InterpolateOp::InterpolateMode::LINEAR, data_types::f32, format::bfzyx
#define CASE_RESAMPLE_FP32_10                                             \
    {1, 16, 4, 5}, {1, 16, 7, 8}, data_types::f32, format::b_fs_yx_fsv16, \
        resample::InterpolateOp::InterpolateMode::LINEAR, data_types::f32, format::bfyx

#define CASE_RESAMPLE_FP16_1                                                                                        \
    {1, 15, 4, 5}, {1, 15, 2, 3}, data_types::f16, format::bfyx, resample::InterpolateOp::InterpolateMode::NEAREST, \
        data_types::f16, format::bfyx
#define CASE_RESAMPLE_FP16_3                                                                                       \
    {1, 15, 4, 5}, {1, 15, 2, 3}, data_types::f16, format::bfyx, resample::InterpolateOp::InterpolateMode::LINEAR, \
        data_types::f16, format::bfyx
#define CASE_RESAMPLE_FP16_4                                                                                        \
    {1, 16, 4, 5}, {1, 16, 7, 8}, data_types::f16, format::bfyx, resample::InterpolateOp::InterpolateMode::NEAREST, \
        data_types::f16, format::bfyx
#define CASE_RESAMPLE_FP16_6                                                                                       \
    {1, 16, 4, 5}, {1, 16, 7, 8}, data_types::f16, format::bfyx, resample::InterpolateOp::InterpolateMode::LINEAR, \
        data_types::f16, format::bfyx
#define CASE_RESAMPLE_FP16_7                                            \
    {1, 16, 4, 5, 4}, {1, 16, 2, 3, 2}, data_types::f16, format::bfzyx, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f16, format::bfzyx
#define CASE_RESAMPLE_FP16_8                                            \
    {1, 16, 4, 5, 4}, {1, 16, 2, 3, 2}, data_types::f16, format::bfzyx, \
        resample::InterpolateOp::InterpolateMode::LINEAR, data_types::f16, format::bfzyx
#define CASE_RESAMPLE_FP16_11                                             \
    {1, 16, 4, 5}, {1, 16, 7, 8}, data_types::f16, format::b_fs_yx_fsv16, \
        resample::InterpolateOp::InterpolateMode::LINEAR, data_types::f16, format::bfyx
#define CASE_RESAMPLE_FP16_12                                             \
    {2, 32, 4, 5}, {2, 32, 7, 8}, data_types::f16, format::fs_b_yx_fsv32, \
        resample::InterpolateOp::InterpolateMode::LINEAR, data_types::f16, format::bfyx
#define CASE_RESAMPLE_FP16_13                                             \
    {1, 16, 4, 5}, {1, 16, 7, 8}, data_types::f16, format::b_fs_yx_fsv16, \
        resample::InterpolateOp::InterpolateMode::LINEAR, data_types::f16, format::bfyx
#define CASE_RESAMPLE_FP16_14                                             \
    {1, 32, 4, 5}, {1, 32, 2, 3}, data_types::f16, format::fs_b_yx_fsv32, \
        resample::InterpolateOp::InterpolateMode::LINEAR, data_types::f16, format::bfyx

#define CASE_RESAMPLE_I8_1                                               \
    {1, 16, 4, 5}, {1, 16, 2, 3}, data_types::i8, format::b_fs_yx_fsv16, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f32, format::bfyx
#define CASE_RESAMPLE_I8_2                                               \
    {2, 32, 4, 5}, {2, 32, 2, 3}, data_types::i8, format::b_fs_yx_fsv16, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f32, format::bfyx

#define CASE_RESAMPLE_U8_1                                               \
    {1, 16, 4, 5}, {1, 16, 2, 3}, data_types::u8, format::b_fs_yx_fsv16, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f32, format::bfyx
#define CASE_RESAMPLE_U8_2                                               \
    {2, 32, 4, 5}, {2, 32, 2, 3}, data_types::u8, format::b_fs_yx_fsv16, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f32, format::bfyx
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         resample_scale_activation_eltwise,
                         ::testing::ValuesIn(std::vector<resample_test_params>{
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         resample_eltwise_fusing_through,
                         ::testing::ValuesIn(std::vector<resample_test_params>{
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         resample_eltwise_fusing_through_not_allowed,
                         ::testing::ValuesIn(std::vector<resample_test_params>{
