...
public:
    ...
    layout get_bias_layout(fully_connected_test_params& p) {
        auto bias_shape =
            p.out_shape.size() == 3 ? ov::PartialShape{1, 1, p.out_shape[2]} : ov::PartialShape{1, p.out_shape[1]};
    ...
    layout get_scale_layout(fully_connected_test_params& p, size_t group_size = 1) {
        if (p.weights_type == data_types::u8 || p.weights_type == data_types::i8) {
            auto scale_shape =
                p.out_shape.size() == 3 ? ov::PartialShape{p.out_shape[2]} : ov::PartialShape{p.out_shape[1]};
            ...
            auto scale_shape = p.out_shape.size() == 3 ? ov::PartialShape{p.out_shape[2], groups_num}
                                                       : ov::PartialShape{p.out_shape[1], groups_num};
            return layout{scale_shape, p.default_type, p.default_format};
        }
    }
};
...
#define CASE_FC_FP32_1 \
    {1, 3}, {1, 4}, {4, 3}, data_types::f32, format::bfyx, data_types::f32, format::oiyx, data_types::f32, format::bfyx
#define CASE_FC_FP32_2 \
    {2, 3}, {2, 4}, {4, 3}, data_types::f32, format::yxfb, data_types::f32, format::oiyx, data_types::f32, format::bfyx
#define CASE_FC_FP32_3                                                                                        \
    {2, 32}, {2, 16}, {16, 32}, data_types::f32, format::bfyx, data_types::i8, format::oiyx, data_types::f32, \
        format::bfyx
#define CASE_FC_FP32_3D_1                                                                                  \
    {5, 3, 3}, {5, 3, 5}, {5, 3, 1}, data_types::f32, format::bfyx, data_types::f32, format::os_iyx_osv16, \
        data_types::f32, format::bfyx
#define CASE_FC_FP32_3D_2                                                                                    \
    {2, 1, 1}, {2, 1, 32}, {32, 1, 1}, data_types::f32, format::bfyx, data_types::f32, format::os_iyx_osv16, \
        data_types::f32, format::bfyx
#define CASE_FC_FP32_3D_3                                                                                        \
    {2, 32, 32}, {2, 32, 16}, {16, 32, 1}, data_types::f32, format::bfyx, data_types::f32, format::os_iyx_osv16, \
        data_types::f32, format::bfyx

#define DYN_CASE_FC_FP32_3D_1                                                                           \
    {5, 3, 3}, {5, 3, 5}, {5, 3}, data_types::f32, format::bfyx, data_types::f32, format::os_iyx_osv16, \
        data_types::f32, format::bfyx
#define DYN_CASE_FC_FP32_3D_2                                                                             \
    {2, 1, 1}, {2, 1, 32}, {32, 1}, data_types::f32, format::bfyx, data_types::f32, format::os_iyx_osv16, \
        data_types::f32, format::bfyx
#define DYN_CASE_FC_FP32_3D_3                                                                                 \
    {2, 32, 32}, {2, 32, 16}, {16, 32}, data_types::f32, format::bfyx, data_types::f32, format::os_iyx_osv16, \
        data_types::f32, format::bfyx

#define CASE_FC_U8S8_1 \
    {1, 3}, {1, 4}, {4, 3}, data_types::u8, format::bfyx, data_types::i8, format::oiyx, data_types::f32, format::bfyx
#define CASE_FC_U8S8_2                                                                                           \
    {2, 3}, {2, 4}, {4, 3}, data_types::u8, format::b_fs_yx_fsv4, data_types::i8, format::oiyx, data_types::f32, \
        format::bfyx
#define CASE_FC_U8S8_3                                                                                               \
    {2, 32}, {2, 16}, {16, 32}, data_types::u8, format::b_fs_yx_fsv4, data_types::i8, format::oiyx, data_types::f32, \
        format::bfyx
#define CASE_FC_U8S8_4 \
    {1, 3}, {1, 3}, {3, 3}, data_types::u8, format::bfyx, data_types::i8, format::oiyx, data_types::f32, format::bfyx
#define CASE_FC_U8S8_3D_1                                                                                             \
    {2, 32, 3}, {2, 32, 16}, {16, 3, 1}, data_types::u8, format::bfyx, data_types::i8, format::oiyx, data_types::f32, \
        format::bfyx
#define CASE_FC_U8S8_3D_2                                                                                           \
    {1, 1, 3}, {1, 1, 32}, {32, 3, 1}, data_types::u8, format::bfyx, data_types::i8, format::oiyx, data_types::f32, \
        format::bfyx
#define CASE_FC_U8S8_3D_3                                                                                           \
    {2, 3, 1}, {2, 3, 15}, {15, 1, 1}, data_types::u8, format::bfyx, data_types::i8, format::oiyx, data_types::f32, \
        format::bfyx
#define CASE_FC_U8S8_3D_4                                                                                        \
    {1, 512, 1024}, {1, 384, 1024}, {1024, 1024, 1}, data_types::u8, format::bfyx, data_types::i8, format::oiyx, \
        data_types::f32, format::bfyx

#define CASE_FC_FP16_1 \
    {1, 3}, {1, 4}, {4, 3}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, data_types::f32, format::bfyx
#define CASE_FC_FP16_2 \
    {2, 3}, {2, 4}, {4, 3}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, data_types::f32, format::bfyx
#define CASE_FC_FP16_3                                                                                         \
    {2, 32}, {2, 16}, {16, 32}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, data_types::f32, \
        format::bfyx
#define CASE_FC_FP16_4                                                                                               \
    {128, 76}, {128, 768}, {768, 76}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, data_types::f32, \
        format::bfyx
#define CASE_FC_FP16_5                                                                                       \
    {1, 128, 76}, {1, 128, 768}, {1, 768, 76}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, \
        data_types::f32, format::bfyx
#define CASE_FC_FP16_6                                                                                   \
    {2, 1, 76}, {2, 1, 768}, {768, 76, 1}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, \
        data_types::f32, format::bfyx
#define CASE_FC_FP16_7                                                                                       \
    {2, 128, 76}, {2, 128, 768}, {768, 76, 1}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, \
        data_types::f32, format::bfyx
#define CASE_FC_FP16_3D_1                                                                              \
    {2, 32, 3}, {2, 32, 16}, {16, 3, 1}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, \
        data_types::f32, format::bfyx
#define CASE_FC_FP16_3D_2                                                                                             \
    {1, 1, 3}, {1, 1, 32}, {32, 3, 1}, data_types::f16, format::bfyx, data_types::f16, format::oiyx, data_types::f32, \
        format::bfyx

#define CASE_FC_FP16_INT4_COMP_1                                                                                  \
    {1, 128}, {1, 128}, {128, 128}, data_types::f16, format::bfyx, data_types::u4, format::oiyx, data_types::f16, \
        format::bfyx
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         fc_fp32_activation,
                         ::testing::ValuesIn(std::vector<fully_connected_test_params>{
...
TEST_P(fc_fp32_bias_dynamic, basic) {
    auto p = GetParam();
    auto test_input_layout = get_input_layout(p);
    auto dynamic_input_layout = layout{ov::PartialShape::dynamic(test_input_layout.get_partial_shape().rank()),
                                       test_input_layout.data_type,
                                       test_input_layout.format};
    create_topologies(input_layout("input", dynamic_input_layout),
                      data("weights", get_mem(get_weights_layout(p))),
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         fc_compressed_int8_bias_dynamic,
                         ::testing::ValuesIn(std::vector<fully_connected_test_params>{
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         fc_int8_eltwise_dynamic_residual,
                         ::testing::ValuesIn(std::vector<fully_connected_test_params>{
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         fc_int8_eltwise_activation_quantize_i8,
                         ::testing::ValuesIn(std::vector<fully_connected_test_params>{
    ...
    void run_test(bool is_caching_test = false) {
        ...
        create_topologies(input_layout("input", get_input_layout(p)),
                          ...
                          fully_connected("fc_prim",
                                          ...
                                          get_input_weights_rank(p)),
                          eltwise("shift",
                                  {input_info("fc_prim"), input_info("shift_data")},
                                  eltwise_mode::sum,
                                  cldnn::data_types::f32),
