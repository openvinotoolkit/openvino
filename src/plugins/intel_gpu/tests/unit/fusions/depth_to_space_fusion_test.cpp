...
#define CASE_DEPTH_TO_SPACE_F32_1                                                                        \
    {1, 16, 8, 10}, {1, 4, 16, 20}, depth_to_space_mode::blocks_first, data_types::f32, format::bfyx, 2, \
        data_types::f32, format::bfyx
#define CASE_DEPTH_TO_SPACE_F32_2                                                                                \
    {1, 32, 8, 8}, {1, 2, 32, 32}, depth_to_space_mode::blocks_first, data_types::f32, format::b_fs_yx_fsv16, 4, \
        data_types::f32, format::bfyx
#define CASE_DEPTH_TO_SPACE_F16_1                                                                       \
    {1, 12, 8, 8}, {1, 3, 16, 16}, depth_to_space_mode::blocks_first, data_types::f16, format::bfyx, 2, \
        data_types::f32, format::bfyx
#define CASE_DEPTH_TO_SPACE_F16_2                                                                                \
    {1, 16, 9, 8}, {1, 1, 36, 32}, depth_to_space_mode::blocks_first, data_types::f16, format::b_fs_yx_fsv16, 4, \
        data_types::f32, format::bfyx
#define CASE_DEPTH_TO_SPACE_U8_1                                                                        \
    {1, 128, 8, 8}, {1, 2, 64, 64}, depth_to_space_mode::blocks_first, data_types::u8, format::bfyx, 8, \
        data_types::f32, format::bfyx
#define CASE_DEPTH_TO_SPACE_U8_2                                                                                 \
    {1, 128, 4, 8}, {1, 8, 16, 32}, depth_to_space_mode::blocks_first, data_types::u8, format::b_fs_yx_fsv16, 4, \
        data_types::f32, format::bfyx
#define CASE_DEPTH_TO_SPACE_I8_1                                                                       \
    {1, 16, 8, 8}, {1, 4, 16, 16}, depth_to_space_mode::blocks_first, data_types::i8, format::bfyx, 2, \
        data_types::f32, format::bfyx
#define CASE_DEPTH_TO_SPACE_I8_2                                                                                 \
    {1, 256, 8, 8}, {1, 4, 64, 64}, depth_to_space_mode::blocks_first, data_types::i8, format::b_fs_yx_fsv16, 8, \
        data_types::f32, format::bfyx
