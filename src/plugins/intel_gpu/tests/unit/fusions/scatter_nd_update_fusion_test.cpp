...
#define CASE_SCATTER_ND_UPDATE_FP16_4D_1 \
    {6, 1, 1, 1}, {3, 1, 1, 1}, {3, 1, 1, 1}, 1, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_4D_2 \
    {6, 6, 1, 1}, {3, 2, 1, 1}, {3, 1, 1, 1}, 2, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_4D_3 \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_4D_4 \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_4D_5 \
    {6, 7, 8, 9}, {6, 2, 1, 1}, {6, 9, 1, 8}, 2, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_4D_6 \
    {6, 7, 8, 9}, {6, 3, 1, 1}, {6, 8, 1, 1}, 2, data_types::f16, format::bfyx, data_types::f16, format::bfyx

#define CASE_SCATTER_ND_UPDATE_FP16_5D_1 \
    {6, 7, 8, 9, 10}, {5, 1, 1, 1}, {5, 7, 8, 9, 10}, 1, data_types::f16, format::bfzyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_5D_2 \
    {6, 7, 8, 9, 10}, {5, 2, 1, 1}, {5, 10, 1, 8, 9}, 2, data_types::f16, format::bfzyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_5D_3 \
    {6, 7, 8, 9, 10}, {5, 3, 1, 1}, {5, 9, 1, 1, 8}, 2, data_types::f16, format::bfzyx, data_types::f16, format::bfyx
...
#define CASE_SCATTER_ND_UPDATE_FP16_5D_5 \
    {6, 7, 8, 9, 10}, {5, 5, 1, 1}, {5, 1, 1, 1, 1}, 2, data_types::f16, format::bfzyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_5D_6 \
    {6, 7, 8, 9, 10}, {5, 2, 1, 2}, {5, 2, 8, 9, 10}, 3, data_types::f16, format::bfzyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_5D_7 \
    {6, 7, 8, 9, 10}, {5, 2, 1, 3}, {5, 2, 1, 8, 9}, 3, data_types::f16, format::bfzyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_5D_8 \
    {6, 7, 8, 9, 10}, {5, 2, 4, 3}, {5, 2, 1, 8, 3}, 4, data_types::f16, format::bfzyx, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_5D_9 \
    {6, 7, 8, 9, 10}, {5, 2, 3, 3}, {5, 2, 8, 9, 3}, 4, data_types::f16, format::bfzyx, data_types::f16, format::bfyx

#define CASE_SCATTER_ND_UPDATE_FP16_6D_1                                                                           \
    {6, 7, 8, 9, 10, 11}, {5, 1, 1, 1}, {5, 7, 8, 9, 10, 11}, 1, data_types::f16, format::bfwzyx, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_6D_2                                                                           \
    {6, 7, 8, 9, 10, 11}, {5, 2, 1, 1}, {5, 11, 1, 8, 9, 10}, 2, data_types::f16, format::bfwzyx, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_6D_3                                                                          \
    {6, 7, 8, 9, 10, 11}, {5, 3, 1, 1}, {5, 10, 1, 1, 8, 9}, 2, data_types::f16, format::bfwzyx, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_6D_4                                                                         \
    {6, 7, 8, 9, 10, 11}, {5, 4, 1, 1}, {5, 9, 1, 1, 1, 8}, 2, data_types::f16, format::bfwzyx, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_6D_5                                                                       \
    {6, 7, 8, 9, 2, 2}, {5, 5, 1, 1}, {5, 8, 1, 1, 1, 1}, 2, data_types::f16, format::bfwzyx, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_6D_6                                                                       \
    {6, 7, 8, 9, 2, 2}, {5, 6, 1, 1}, {5, 1, 1, 1, 1, 1}, 2, data_types::f16, format::bfwzyx, data_types::f16, \
        format::bfyx

#define CASE_SCATTER_ND_UPDATE_FP32_4D_1 \
    {6, 1, 1, 1}, {3, 1, 1, 1}, {3, 1, 1, 1}, 1, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_4D_2 \
    {6, 6, 1, 1}, {3, 2, 1, 1}, {3, 1, 1, 1}, 2, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_4D_3 \
    {6, 7, 8, 1}, {5, 1, 1, 1}, {5, 7, 8, 1}, 2, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_4D_4 \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_4D_5 \
    {6, 7, 8, 9}, {6, 2, 1, 1}, {6, 9, 1, 8}, 2, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_4D_6 \
    {6, 7, 8, 9}, {6, 3, 1, 1}, {6, 8, 1, 1}, 2, data_types::f32, format::bfyx, data_types::f32, format::bfyx

#define CASE_SCATTER_ND_UPDATE_FP32_5D_1 \
    {6, 7, 8, 9, 10}, {5, 1, 1, 1}, {5, 7, 8, 9, 10}, 1, data_types::f32, format::bfzyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_5D_2 \
    {6, 7, 8, 9, 10}, {5, 2, 1, 1}, {5, 10, 1, 8, 9}, 2, data_types::f32, format::bfzyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_5D_3 \
    {6, 7, 8, 9, 10}, {5, 3, 1, 1}, {5, 9, 1, 1, 8}, 2, data_types::f32, format::bfzyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_5D_4 \
    {6, 7, 8, 9, 10}, {5, 4, 1, 1}, {5, 8, 1, 1, 1}, 2, data_types::f32, format::bfzyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_5D_5 \
    {6, 7, 8, 9, 10}, {5, 5, 1, 1}, {5, 1, 1, 1, 1}, 2, data_types::f32, format::bfzyx, data_types::f32, format::bfyx

#define CASE_SCATTER_ND_UPDATE_FP32_6D_1                                                                           \
    {6, 7, 8, 9, 10, 11}, {5, 1, 1, 1}, {5, 7, 8, 9, 10, 11}, 1, data_types::f32, format::bfwzyx, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_6D_2                                                                           \
    {6, 7, 8, 9, 10, 11}, {5, 2, 1, 1}, {5, 11, 1, 8, 9, 10}, 2, data_types::f32, format::bfwzyx, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_6D_3                                                                          \
    {6, 7, 8, 9, 10, 11}, {5, 3, 1, 1}, {5, 10, 1, 1, 8, 9}, 2, data_types::f32, format::bfwzyx, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_6D_4                                                                         \
    {6, 7, 8, 9, 10, 11}, {5, 4, 1, 1}, {5, 9, 1, 1, 1, 8}, 2, data_types::f32, format::bfwzyx, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_6D_5                                                                       \
    {6, 7, 8, 9, 2, 2}, {5, 5, 1, 1}, {5, 8, 1, 1, 1, 1}, 2, data_types::f32, format::bfwzyx, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_6D_6                                                                       \
    {6, 7, 8, 9, 2, 2}, {5, 6, 1, 1}, {5, 1, 1, 1, 1, 1}, 2, data_types::f32, format::bfwzyx, data_types::f32, \
        format::bfyx
...
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_4D_2 \
    {6, 6, 1, 1}, {3, 2, 1, 1}, {3, 1, 1, 1}, 2, data_types::f16, format::b_fs_yx_fsv16, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_4D_3 \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f16, format::b_fs_yx_fsv16, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_4D_4 \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f16, format::b_fs_yx_fsv16, data_types::f16, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_4D_5 \
    {6, 7, 8, 9}, {6, 2, 1, 1}, {6, 9, 1, 8}, 2, data_types::f16, format::b_fs_yx_fsv16, data_types::f16, format::bfyx
...
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_1                                                                     \
    {6, 7, 8, 9, 10}, {5, 1, 1, 1}, {5, 7, 8, 9, 10}, 1, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_2                                                                     \
    {6, 7, 8, 9, 10}, {5, 2, 1, 1}, {5, 10, 1, 8, 9}, 2, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_3                                                                    \
    {6, 7, 8, 9, 10}, {5, 3, 1, 1}, {5, 9, 1, 1, 8}, 2, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_4                                                                    \
    {6, 7, 8, 9, 10}, {5, 4, 1, 1}, {5, 8, 1, 1, 1}, 2, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_5                                                                    \
    {6, 7, 8, 9, 10}, {5, 5, 1, 1}, {5, 1, 1, 1, 1}, 2, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_6                                                                     \
    {6, 7, 8, 9, 10}, {5, 2, 1, 2}, {5, 2, 8, 9, 10}, 3, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_7                                                                    \
    {6, 7, 8, 9, 10}, {5, 2, 1, 3}, {5, 2, 1, 8, 9}, 3, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_8                                                                    \
    {6, 7, 8, 9, 10}, {5, 2, 4, 3}, {5, 2, 1, 8, 3}, 4, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_FSV16_5D_9                                                                    \
    {6, 7, 8, 9, 10}, {5, 2, 3, 3}, {5, 2, 8, 9, 3}, 4, data_types::f16, format::b_fs_zyx_fsv16, data_types::f16, \
        format::bfyx
...
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_4D_2 \
    {6, 6, 1, 1}, {3, 2, 1, 1}, {3, 1, 1, 1}, 2, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
...
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_4D_4 \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_4D_5 \
    {6, 7, 8, 9}, {6, 2, 1, 1}, {6, 9, 1, 8}, 2, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_4D_6 \
    {6, 7, 8, 9}, {6, 3, 1, 1}, {6, 8, 1, 1}, 2, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, format::bfyx

#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_1                                                                     \
    {6, 7, 8, 9, 10}, {5, 1, 1, 1}, {5, 7, 8, 9, 10}, 1, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_2                                                                     \
    {6, 7, 8, 9, 10}, {5, 2, 1, 1}, {5, 10, 1, 8, 9}, 2, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_3                                                                    \
    {6, 7, 8, 9, 10}, {5, 3, 1, 1}, {5, 9, 1, 1, 8}, 2, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_4                                                                    \
    {6, 7, 8, 9, 10}, {5, 4, 1, 1}, {5, 8, 1, 1, 1}, 2, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_5                                                                    \
    {6, 7, 8, 9, 10}, {5, 5, 1, 1}, {5, 1, 1, 1, 1}, 2, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_6                                                                     \
    {6, 7, 8, 9, 10}, {5, 2, 1, 2}, {5, 2, 8, 9, 10}, 3, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_7                                                                    \
    {6, 7, 8, 9, 10}, {5, 2, 1, 3}, {5, 2, 1, 8, 9}, 3, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_8                                                                    \
    {6, 7, 8, 9, 10}, {5, 2, 4, 3}, {5, 2, 1, 8, 3}, 4, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_FSV16_5D_9                                                                    \
    {6, 7, 8, 9, 10}, {5, 2, 3, 3}, {5, 2, 8, 9, 3}, 4, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, \
        format::bfyx

#define CASE_SCATTER_ND_UPDATE_FP16_BSV32_FSV16_4D_1                                                             \
    {6, 1, 1, 1}, {3, 1, 1, 1}, {3, 1, 1, 1}, 1, data_types::f16, format::bs_fs_yx_bsv32_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_BSV32_FSV16_4D_2                                                             \
    {6, 6, 1, 1}, {3, 2, 1, 1}, {3, 1, 1, 1}, 2, data_types::f16, format::bs_fs_yx_bsv32_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_BSV32_FSV16_4D_3                                                             \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f16, format::bs_fs_yx_bsv32_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_BSV32_FSV16_4D_4                                                             \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f16, format::bs_fs_yx_bsv32_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_BSV32_FSV16_4D_5                                                             \
    {6, 7, 8, 9}, {6, 2, 1, 1}, {6, 9, 1, 8}, 2, data_types::f16, format::bs_fs_yx_bsv32_fsv16, data_types::f16, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP16_BSV32_FSV16_4D_6                                                             \
    {6, 7, 8, 9}, {6, 3, 1, 1}, {6, 8, 1, 1}, 2, data_types::f16, format::bs_fs_yx_bsv32_fsv16, data_types::f16, \
        format::bfyx

#define CASE_SCATTER_ND_UPDATE_FP32_BSV32_FSV16_4D_1                                                             \
    {6, 1, 1, 1}, {3, 1, 1, 1}, {3, 1, 1, 1}, 1, data_types::f32, format::bs_fs_yx_bsv32_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_BSV32_FSV16_4D_2                                                             \
    {6, 6, 1, 1}, {3, 2, 1, 1}, {3, 1, 1, 1}, 2, data_types::f32, format::bs_fs_yx_bsv32_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_BSV32_FSV16_4D_3                                                             \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f32, format::bs_fs_yx_bsv32_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_BSV32_FSV16_4D_4                                                             \
    {6, 7, 8, 9}, {5, 1, 1, 1}, {5, 7, 8, 9}, 2, data_types::f32, format::bs_fs_yx_bsv32_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_BSV32_FSV16_4D_5                                                             \
    {6, 7, 8, 9}, {6, 2, 1, 1}, {6, 9, 1, 8}, 2, data_types::f32, format::bs_fs_yx_bsv32_fsv16, data_types::f32, \
        format::bfyx
#define CASE_SCATTER_ND_UPDATE_FP32_BSV32_FSV16_4D_6                                                             \
    {6, 7, 8, 9}, {6, 3, 1, 1}, {6, 8, 1, 1}, 2, data_types::f32, format::bs_fs_yx_bsv32_fsv16, data_types::f32, \
        format::bfyx
...
TEST_P(scatter_nd_update_quantize, basic) {
    ...
    create_topologies(input_layout("input", get_input_layout(p)),
                      ...
                      scatter_nd_update("scatter_nd_update_prim",
                                        input_info("input"),
                                        input_info("scatter_nd_update_indices"),
                                        input_info("scatter_nd_update_updates"),
                                        p.indices_rank),
                      quantize("quantize",
                               input_info("scatter_nd_update_prim"),
                               input_info("in_lo"),
                               input_info("in_hi"),
                               input_info("out_lo"),
                               input_info("out_hi"),
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         scatter_nd_update_scale_activation_eltwise,
                         ::testing::ValuesIn(std::vector<scatter_nd_update_test_params>{
