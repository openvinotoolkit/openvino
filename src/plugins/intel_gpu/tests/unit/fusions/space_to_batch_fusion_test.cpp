...
/* ---------------------------------------- SpaceToBatch cases ----------------------------------------- */
/* ----------------------------------------------------------------------------------------------------- */
#define CASE_SPACE_TO_BATCH_F32_1                                                                         \
    {1, 4, 8, 8}, {16, 2, 3, 8}, data_types::f32, format::bfyx, {1, 2, 4, 1}, {0, 0, 4, 0}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_BATCH_F32_2                                                                                   \
    {2, 16, 4, 6}, {24, 4, 4, 3}, data_types::f32, format::b_fs_yx_fsv16, {1, 4, 1, 3}, {0, 0, 0, 0}, {0, 0, 0, 3}, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_BATCH_F16_1                                                                         \
    {1, 1, 6, 8}, {48, 1, 1, 1}, data_types::f16, format::bfyx, {1, 1, 6, 8}, {0, 0, 0, 0}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_BATCH_F16_2                                                                                    \
    {1, 32, 1, 5}, {20, 4, 1, 4}, data_types::f16, format::b_fs_yx_fsv16, {1, 10, 1, 2}, {0, 8, 0, 0}, {0, 0, 0, 3}, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_BATCH_U8_1                                                                          \
    {3, 12, 4, 8}, {48, 6, 2, 3}, data_types::u8, format::bfyx, {1, 2, 2, 4}, {0, 0, 0, 4}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_BATCH_U8_2                                                                                   \
    {2, 16, 3, 6}, {30, 4, 1, 6}, data_types::u8, format::b_fs_yx_fsv16, {1, 5, 3, 1}, {0, 4, 0, 0}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_BATCH_I8_1                                                                        \
    {1, 2, 8, 1}, {4, 2, 2, 1}, data_types::i8, format::bfyx, {1, 1, 4, 1}, {0, 0, 0, 0}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_BATCH_I8_2                                                                                    \
    {1, 32, 4, 8}, {48, 2, 6, 3}, data_types::i8, format::b_fs_yx_fsv16, {1, 16, 1, 3}, {0, 0, 2, 0}, {0, 0, 0, 1}, \
        data_types::f32, format::bfyx
...
TEST_P(space_to_batch_scale_act_eltwise_quantize_u8, basic) {
    ...
    create_topologies(
        ...
        eltwise("scale1",
                {input_info("space_to_batch"), input_info("scale1_data")},
                eltwise_mode::prod,
                p.default_type),
