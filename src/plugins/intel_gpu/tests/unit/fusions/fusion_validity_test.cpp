...
#define CASE_RESAMPLE_FSV16_1_5D                                                                    \
    {1, 16, 4, 32, 32}, {1, 16, 4, 64, 64}, data_types::f16, format::b_fs_zyx_fsv16, format::bfzyx, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f16, format::bfzyx
#define CASE_RESAMPLE_FSV16_1                                                                 \
    {1, 16, 64, 64}, {1, 16, 128, 128}, data_types::f16, format::b_fs_yx_fsv16, format::bfyx, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f16, format::bfyx
#define CASE_RESAMPLE_FSV16_2                                                             \
    {1, 2, 32, 32}, {1, 2, 64, 64}, data_types::f16, format::b_fs_yx_fsv16, format::bfyx, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::f16, format::bfyx
#define CASE_RESAMPLE_FSV32_1                                                              \
    {1, 16, 32, 32}, {1, 16, 64, 64}, data_types::i8, format::b_fs_yx_fsv32, format::bfyx, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::i8, format::bfyx
#define CASE_RESAMPLE_FSV32_2                                                            \
    {1, 2, 32, 32}, {1, 2, 64, 64}, data_types::i8, format::b_fs_yx_fsv32, format::bfyx, \
        resample::InterpolateOp::InterpolateMode::NEAREST, data_types::i8, format::bfyx
...
// This test is to validate fused operation when a fused post-ops has a planar format input while its data input is a
// blocked format. It is expected to replace LT_ALIGNED_READ with LT_UNALIGNED if fused input is planar while generating
// FUSED_OPS_LOAD in jitter.
class format_mismatch_fusing : public PrimitiveFusingTest {};

TEST_P(format_mismatch_fusing, single_fused_node) {
    auto p = GetParam();
    create_topologies(
        // Fused eltwise contains format mismatch between data input of resample(input_format) and fused eltwise
    ...
    cfg_fused.set_property(
        ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"resample_opt", resample_impl}}));
    ov::intel_gpu::ImplementationDesc ref_resample_impl = {p.input_format, "resample_ref"};
    cfg_not_fused.set_property(
        ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"resample_opt", ref_resample_impl}}));
    ov::intel_gpu::ImplementationDesc ref_eltwise = {p.input_format, ""};
    cfg_not_fused.set_property(
        ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"eltwise_data", ref_eltwise}}));

    tolerance = 1e-5f;
    execute(p);
}

INSTANTIATE_TEST_SUITE_P(validate_fusings_gpu,
                         format_mismatch_fusing,
                         ::testing::ValuesIn(std::vector<fusing_test_params>{
...
TEST_P(format_mismatch_multiple_fusing, multiple_fused_node) {
    ...
    ov::intel_gpu::ImplementationDesc resample_impl = {p.input_format, "resample_opt"};
    cfg_fused.set_property(
        ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"resample_prim", resample_impl}}));
    ov::intel_gpu::ImplementationDesc ref_resample_impl = {p.input_format, "resample_ref"};
    cfg_not_fused.set_property(
        ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"resample_prim", ref_resample_impl}}));
    ov::intel_gpu::ImplementationDesc ref_eltwise = {p.input_format, ""};
    cfg_not_fused.set_property(
        ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"eltwise_data", ref_eltwise}}));
...
INSTANTIATE_TEST_SUITE_P(validate_fusings_gpu,
                         format_mismatch_multiple_fusing,
                         ::testing::ValuesIn(std::vector<fusing_test_params>{
                             fusing_test_params{CASE_RESAMPLE_FSV16_1, 3, 4},
                             fusing_test_params{CASE_RESAMPLE_FSV16_2, 3, 4}}));

#define CASE_RESAMPLE_ONNX_4D_FSV16_1                                                         \
    {1, 16, 64, 64}, {1, 16, 128, 128}, data_types::f16, format::b_fs_yx_fsv16, format::bfyx, \
        resample::InterpolateOp::InterpolateMode::LINEAR_ONNX, data_types::f16, format::bfyx
#define CASE_RESAMPLE_ONNX_5D_FSV16_1                                                                 \
    {1, 16, 16, 16, 16}, {1, 16, 32, 32, 32}, data_types::f16, format::b_fs_zyx_fsv16, format::bfzyx, \
        resample::InterpolateOp::InterpolateMode::LINEAR_ONNX, data_types::f16, format::bfzyx
...
INSTANTIATE_TEST_SUITE_P(validate_fusings_onnx_gpu,
                         format_mismatch_onnx_fusing,
                         ::testing::ValuesIn(std::vector<fusing_test_params>{
