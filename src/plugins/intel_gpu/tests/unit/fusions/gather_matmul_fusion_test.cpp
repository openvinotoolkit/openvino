...
// DISABLED: kernel selection misses K=128/u4 shapes (same root cause as DISABLED_smoke_MoEGatherMatmul).
INSTANTIATE_TEST_SUITE_P(DISABLED_fusings_gpu, GatherMatmulSwiGLUFusingTest, ::testing::ValuesIn(std::vector<gather_matmul_fusion_test_params>{
