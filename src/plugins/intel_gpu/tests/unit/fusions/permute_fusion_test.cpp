...
/* ---------------------------------------- PERMUTE FUSE cases ------------------------------------------------ */
/* ------------------------------------------------------------------------------------------------------------ */
#define CASE_PERMUTE_F32_0 \
    {1, 16, 2, 2}, {1, 16, 2, 2}, {0, 1, 2, 3}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_F32_1                                                                                     \
    {1, 15, 16, 16}, {1, 15, 16, 16}, {0, 1, 2, 3}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_F32_2                                                                                   \
    {1, 8, 16, 16}, {16, 16, 8, 1}, {2, 3, 0, 1}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_F32_3 \
    {1, 1, 3, 4}, {1, 3, 4, 1}, {1, 3, 0, 2}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_F32_4                                                                             \
    {2, 16, 16, 16}, {2, 16, 16, 16}, {0, 1, 2, 3}, tensor{0}, data_types::f32, format::b_fs_yx_fsv16, \
        data_types::f32, format::bfyx
#define CASE_PERMUTE_F32_5                                                                                          \
    {1, 32, 4, 5}, {32, 4, 5, 1}, {1, 3, 0, 2}, tensor{0}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_F32_6                                                                                          \
    {1, 16, 4, 5}, {5, 16, 4, 1}, {2, 1, 0, 3}, tensor{0}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_F32_7                                                                                          \
    {1, 16, 1, 1}, {1, 1, 1, 16}, {3, 2, 1, 0}, tensor{0}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx

#define CASE_PERMUTE_F16_0                                                                                          \
    {1, 16, 4, 5}, {1, 16, 4, 5}, {0, 1, 2, 3}, tensor{0}, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_F16_1                                                                                          \
    {2, 16, 4, 5}, {16, 4, 5, 2}, {1, 3, 0, 2}, tensor{0}, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_F16_2                                                                                          \
    {1, 32, 2, 3}, {2, 3, 32, 1}, {3, 2, 0, 1}, tensor{0}, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_F16_3                                                                                          \
    {3, 16, 1, 1}, {1, 1, 16, 3}, {2, 3, 0, 1}, tensor{0}, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_F16_4 \
    {2, 15, 4, 5}, {4, 2, 5, 15}, {3, 0, 1, 2}, tensor{0}, data_types::f16, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_F16_5 \
    {1, 15, 1, 2}, {15, 2, 1, 1}, {1, 2, 0, 3}, tensor{0}, data_types::f16, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_F16_6 \
    {1, 15, 4, 4}, {4, 4, 1, 15}, {3, 2, 1, 0}, tensor{0}, data_types::f16, format::bfyx, data_types::f32, format::bfyx

#define CASE_PERMUTE_S8_0 \
    {1, 15, 4, 5}, {1, 15, 4, 5}, {0, 1, 2, 3}, tensor{0}, data_types::i8, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_S8_1 \
    {1, 15, 4, 5}, {5, 4, 15, 1}, {2, 3, 0, 1}, tensor{0}, data_types::i8, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_S8_2                                                                                          \
    {1, 16, 1, 2}, {1, 1, 16, 2}, {3, 0, 2, 1}, tensor{0}, data_types::i8, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_S8_3                                                                                          \
    {1, 16, 2, 2}, {2, 2, 16, 1}, {3, 2, 0, 1}, tensor{0}, data_types::i8, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_U8_0 \
    {1, 15, 4, 5}, {15, 5, 1, 4}, {1, 2, 3, 0}, tensor{0}, data_types::u8, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_U8_1                                                                                     \
    {1, 15, 16, 16}, {15, 16, 1, 16}, {1, 3, 2, 0}, tensor{0}, data_types::u8, format::bfyx, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_U8_2                                                                                          \
    {1, 32, 5, 4}, {1, 32, 5, 4}, {0, 1, 2, 3}, tensor{0}, data_types::u8, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx
#define CASE_PERMUTE_U8_3                                                                                          \
    {1, 16, 4, 5}, {5, 4, 16, 1}, {2, 3, 0, 1}, tensor{0}, data_types::u8, format::b_fs_yx_fsv16, data_types::f32, \
        format::bfyx

// 3d
#define CASE_PERMUTE_F32_3D_0                                                                                        \
    {1, 15, 4, 4, 5}, {1, 15, 4, 4, 5}, {0, 1, 2, 3, 4}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_F32_3D_1                                                                                        \
    {2, 15, 2, 3, 4}, {15, 2, 3, 4, 2}, {1, 4, 0, 2, 3}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_F32_3D_2                                                                                        \
    {2, 16, 4, 4, 5}, {4, 2, 4, 5, 16}, {3, 0, 1, 2, 4}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_F32_3D_3                                                                                        \
    {1, 32, 4, 2, 2}, {2, 2, 32, 1, 4}, {2, 3, 4, 0, 1}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_F32_3D_4                                                                                        \
    {1, 16, 1, 1, 1}, {1, 1, 1, 16, 1}, {4, 2, 3, 1, 0}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx

#define CASE_PERMUTE_F16_3D_0                                                                                        \
    {1, 15, 4, 4, 5}, {1, 15, 4, 4, 5}, {0, 1, 2, 3, 4}, tensor{0}, data_types::f16, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_F16_3D_1                                                                                        \
    {2, 15, 4, 3, 4}, {4, 4, 2, 15, 3}, {4, 2, 3, 1, 0}, tensor{0}, data_types::f16, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_F16_3D_2                                                                                        \
    {2, 16, 4, 4, 3}, {2, 4, 3, 16, 4}, {0, 3, 4, 1, 2}, tensor{0}, data_types::f16, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_F16_3D_3                                                                                        \
    {1, 32, 4, 2, 1}, {2, 32, 4, 1, 1}, {3, 1, 0, 2, 4}, tensor{0}, data_types::f16, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_F16_3D_4                                                                                          \
    {16, 16, 1, 1, 1}, {1, 16, 1, 1, 16}, {2, 0, 1, 4, 3}, tensor{0}, data_types::f16, format::bfzyx, data_types::f32, \
        format::bfzyx

#define CASE_PERMUTE_S8_3D_0                                                                                        \
    {1, 15, 4, 4, 5}, {1, 15, 4, 4, 5}, {0, 1, 2, 3, 4}, tensor{0}, data_types::i8, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_S8_3D_1                                                                                        \
    {2, 15, 4, 3, 4}, {4, 4, 15, 2, 3}, {2, 4, 3, 0, 1}, tensor{0}, data_types::i8, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_S8_3D_2                                                                                        \
    {2, 16, 4, 4, 3}, {2, 4, 3, 16, 4}, {0, 3, 4, 1, 2}, tensor{0}, data_types::i8, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_S8_3D_3                                                                                        \
    {1, 32, 4, 2, 1}, {2, 32, 4, 1, 1}, {3, 1, 0, 2, 4}, tensor{0}, data_types::i8, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_U8_3D_0                                                                                          \
    {16, 16, 1, 1, 1}, {1, 1, 16, 16, 1}, {4, 2, 3, 1, 0}, tensor{0}, data_types::u8, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_U8_3D_1                                                                                          \
    {16, 16, 1, 1, 1}, {1, 1, 1, 16, 16}, {2, 3, 0, 1, 4}, tensor{0}, data_types::u8, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_U8_3D_2                                                                                        \
    {2, 16, 4, 4, 3}, {4, 2, 4, 3, 16}, {3, 0, 1, 2, 4}, tensor{0}, data_types::u8, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_U8_3D_3                                                                                        \
    {1, 32, 4, 2, 1}, {1, 2, 32, 1, 4}, {2, 3, 4, 0, 1}, tensor{0}, data_types::u8, format::bfzyx, data_types::f32, \
        format::bfzyx

// permute_tile_8x8_4x4
#define CASE_PERMUTE_TILE_8x8_4x4_4D_0 \
    {1, 8, 8, 2}, {1, 2, 8, 8}, {0, 2, 3, 1}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_TILE_8x8_4x4_4D_1 \
    {1, 5, 8, 2}, {1, 2, 5, 8}, {0, 2, 3, 1}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_TILE_8x8_4x4_4D_2 \
    {1, 8, 5, 2}, {1, 2, 8, 5}, {0, 2, 3, 1}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_TILE_8x8_4x4_4D_3 \
    {1, 5, 5, 2}, {1, 2, 5, 5}, {0, 2, 3, 1}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_TILE_8x8_4x4_5D_0                                                                             \
    {1, 8, 8, 2, 2}, {1, 2, 8, 8, 2}, {0, 2, 3, 4, 1}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_TILE_8x8_4x4_5D_1                                                                             \
    {1, 5, 8, 2, 2}, {1, 2, 5, 8, 2}, {0, 2, 3, 4, 1}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_TILE_8x8_4x4_5D_2                                                                             \
    {1, 8, 5, 2, 2}, {1, 2, 8, 5, 2}, {0, 2, 3, 4, 1}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_TILE_8x8_4x4_5D_3                                                                             \
    {1, 5, 5, 2, 2}, {1, 2, 5, 5, 2}, {0, 2, 3, 4, 1}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx
#define CASE_PERMUTE_TILE_8x8_4x4_6D_0                                                                      \
    {1, 8, 8, 2, 2, 2}, {1, 2, 8, 8, 2, 2}, {0, 2, 3, 4, 5, 1}, tensor{0}, data_types::f32, format::bfwzyx, \
        data_types::f32, format::bfwzyx
#define CASE_PERMUTE_TILE_8x8_4x4_6D_1                                                                      \
    {1, 5, 8, 2, 2, 2}, {1, 2, 5, 8, 2, 2}, {0, 2, 3, 4, 5, 1}, tensor{0}, data_types::f32, format::bfwzyx, \
        data_types::f32, format::bfwzyx
#define CASE_PERMUTE_TILE_8x8_4x4_6D_2                                                                      \
    {1, 8, 5, 2, 2, 2}, {1, 2, 8, 5, 2, 2}, {0, 2, 3, 4, 5, 1}, tensor{0}, data_types::f32, format::bfwzyx, \
        data_types::f32, format::bfwzyx
#define CASE_PERMUTE_TILE_8x8_4x4_6D_3                                                                      \
    {1, 5, 5, 2, 2, 2}, {1, 2, 5, 5, 2, 2}, {0, 2, 3, 4, 5, 1}, tensor{0}, data_types::f32, format::bfwzyx, \
        data_types::f32, format::bfwzyx

// permute_tile_8x8_4x4_fsv16
#define CASE_PERMUTE_TILE_8x8_4x4_FSV16_4D_0                                                                          \
    {1, 16, 16, 2}, {1, 2, 16, 16}, {0, 2, 3, 1}, tensor{0}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, \
        format::b_fs_yx_fsv16
#define CASE_PERMUTE_TILE_8x8_4x4_FSV16_4D_1                                                                          \
    {1, 15, 16, 2}, {1, 2, 15, 16}, {0, 2, 3, 1}, tensor{0}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, \
        format::b_fs_yx_fsv16
#define CASE_PERMUTE_TILE_8x8_4x4_FSV16_4D_2                                                                        \
    {1, 16, 3, 2}, {1, 2, 16, 3}, {0, 2, 3, 1}, tensor{0}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, \
        format::b_fs_yx_fsv16
#define CASE_PERMUTE_TILE_8x8_4x4_FSV16_4D_3                                                                      \
    {1, 5, 7, 2}, {1, 2, 5, 7}, {0, 2, 3, 1}, tensor{0}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, \
        format::b_fs_yx_fsv16
#define CASE_PERMUTE_TILE_8x8_4x4_FSV16_5D_0                                                                   \
    {1, 16, 16, 2, 2}, {1, 2, 16, 16, 2}, {0, 2, 3, 4, 1}, tensor{0}, data_types::f32, format::b_fs_zyx_fsv16, \
        data_types::f32, format::b_fs_zyx_fsv16
#define CASE_PERMUTE_TILE_8x8_4x4_FSV16_5D_1                                                                   \
    {1, 15, 16, 2, 2}, {1, 2, 15, 16, 2}, {0, 2, 3, 4, 1}, tensor{0}, data_types::f32, format::b_fs_zyx_fsv16, \
        data_types::f32, format::b_fs_zyx_fsv16
#define CASE_PERMUTE_TILE_8x8_4x4_FSV16_5D_2                                                                 \
    {1, 16, 3, 2, 2}, {1, 2, 16, 3, 2}, {0, 2, 3, 4, 1}, tensor{0}, data_types::f32, format::b_fs_zyx_fsv16, \
        data_types::f32, format::b_fs_zyx_fsv16
#define CASE_PERMUTE_TILE_8x8_4x4_FSV16_5D_3                                                               \
    {1, 5, 7, 2, 2}, {1, 2, 5, 7, 2}, {0, 2, 3, 4, 1}, tensor{0}, data_types::f32, format::b_fs_zyx_fsv16, \
        data_types::f32, format::b_fs_zyx_fsv16

// permute_bfzyx_to_bfyxz
#define CASE_PERMUTE_TILE_BFZYX_TO_BFYXZ_0                                                                         \
    {1, 8, 8, 2, 2}, {1, 8, 2, 8, 2}, {0, 1, 3, 4, 2}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, \
        format::bfzyx

// permute_f_y_axes
#define CASE_PERMUTE_TILE_BFYX_TO_BYFX_0 \
    {1, 8, 4, 2}, {1, 2, 4, 8}, {0, 2, 1, 3}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         permute_activation_scale_eltwise,
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         ...
                         ::testing::ValuesIn(std::vector<permute_params>{
                             permute_params{CASE_PERMUTE_F32_0, 2, 8},    permute_params{CASE_PERMUTE_F32_1, 2, 8},
                             permute_params{CASE_PERMUTE_F32_2, 2, 8},    permute_params{CASE_PERMUTE_F32_3, 2, 8},
                             permute_params{CASE_PERMUTE_F32_4, 2, 8},    permute_params{CASE_PERMUTE_F32_5, 2, 8},
                             permute_params{CASE_PERMUTE_F32_6, 2, 8},    permute_params{CASE_PERMUTE_F32_7, 2, 8},

                             permute_params{CASE_PERMUTE_F16_0, 2, 8},    permute_params{CASE_PERMUTE_F16_1, 2, 8},
                             permute_params{CASE_PERMUTE_F16_2, 2, 8},    permute_params{CASE_PERMUTE_F16_3, 2, 8},
                             permute_params{CASE_PERMUTE_F16_4, 2, 8},    permute_params{CASE_PERMUTE_F16_5, 2, 8},
                             permute_params{CASE_PERMUTE_F16_6, 2, 8},

                             permute_params{CASE_PERMUTE_S8_0, 2, 8},     permute_params{CASE_PERMUTE_S8_1, 2, 8},
                             permute_params{CASE_PERMUTE_S8_2, 2, 8},     permute_params{CASE_PERMUTE_S8_3, 2, 8},

                             permute_params{CASE_PERMUTE_U8_0, 2, 8},     permute_params{CASE_PERMUTE_U8_1, 2, 8},
                             permute_params{CASE_PERMUTE_U8_2, 2, 8},     permute_params{CASE_PERMUTE_U8_3, 2, 8},

                             permute_params{CASE_PERMUTE_F32_3D_0, 2, 8}, permute_params{CASE_PERMUTE_F32_3D_1, 2, 8},
                             permute_params{CASE_PERMUTE_F32_3D_2, 2, 8}, permute_params{CASE_PERMUTE_F32_3D_3, 2, 8},
                             permute_params{CASE_PERMUTE_F32_3D_4, 2, 8},

                             permute_params{CASE_PERMUTE_F16_3D_0, 2, 8}, permute_params{CASE_PERMUTE_F16_3D_1, 2, 8},
                             permute_params{CASE_PERMUTE_F16_3D_2, 2, 8}, permute_params{CASE_PERMUTE_F16_3D_3, 2, 8},
                             permute_params{CASE_PERMUTE_F16_3D_4, 2, 8},

                             permute_params{CASE_PERMUTE_S8_3D_0, 2, 8},  permute_params{CASE_PERMUTE_S8_3D_1, 2, 8},
                             permute_params{CASE_PERMUTE_S8_3D_2, 2, 8},  permute_params{CASE_PERMUTE_S8_3D_3, 2, 8},

                             permute_params{CASE_PERMUTE_U8_3D_0, 2, 8},  permute_params{CASE_PERMUTE_U8_3D_1, 2, 8},
                             permute_params{CASE_PERMUTE_U8_3D_2, 2, 8},  permute_params{CASE_PERMUTE_U8_3D_3, 2, 8},
                         }));
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         permute_scale_eltwise_actv_scale_actv,
                         ::testing::ValuesIn(std::vector<permute_params>{
...
#define CASE_PERMUTE_REORDER_F32_0 \
    {1, 16, 32, 2}, {0, 2, 1, 3}, {0, 2, 1, 3}, data_types::f32, data_types::f32, format::b_fs_yx_fsv16, format::bfyx
#define CASE_PERMUTE_REORDER_F32_1 \
    {2, 7, 9, 27}, {0, 2, 1, 3}, {0, 2, 1, 3}, data_types::f32, data_types::f32, format::b_fs_yx_fsv4, format::bfyx
#define CASE_PERMUTE_REORDER_F32_2                                                                                 \
    {1, 16, 4, 5, 16}, {0, 2, 3, 4, 1}, {0, 2, 3, 4, 1}, data_types::f32, data_types::f32, format::b_fs_zyx_fsv16, \
        format::bfzyx
#define CASE_PERMUTE_REORDER_F16_0 \
    {1, 16, 2, 4}, {0, 2, 1, 3}, {0, 2, 1, 3}, data_types::f16, data_types::f16, format::b_fs_yx_fsv16, format::bfyx
#define CASE_PERMUTE_REORDER_F16_1                                                                                 \
    {1, 16, 4, 5, 16}, {0, 2, 1, 3, 4}, {0, 1, 2, 3, 4}, data_types::f16, data_types::f16, format::b_fs_zyx_fsv16, \
        format::bfzyx
#define CASE_PERMUTE_REORDER_F16_2                                                                                \
    {1, 5, 1, 2, 14}, {0, 3, 2, 1, 4}, {0, 3, 2, 1, 4}, data_types::f16, data_types::f16, format::b_fs_zyx_fsv16, \
        format::bfzyx

// type change
#define CASE_PERMUTE_REORDER_S8_TO_F32_0 \
    {1, 15, 4, 5}, {0, 2, 1, 3}, {0, 2, 1, 3}, data_types::i8, data_types::f32, format::b_fs_yx_fsv4, format::bfyx
#define CASE_PERMUTE_REORDER_S8_TO_F32_1                                                                         \
    {1, 2, 15, 4, 5}, {0, 3, 2, 1, 4}, {0, 3, 2, 1, 4}, data_types::i8, data_types::f32, format::b_fs_zyx_fsv16, \
        format::bfzyx
#define CASE_PERMUTE_REORDER_F32_TO_F16_0                                                                         \
    {1, 5, 1, 2, 14}, {0, 2, 1, 3, 4}, {0, 1, 2, 3, 4}, data_types::f32, data_types::f16, format::b_fs_zyx_fsv16, \
        format::bfzyx
#define CASE_PERMUTE_REORDER_U8_TO_F16_0                                                                         \
    {1, 17, 1, 2, 7}, {0, 2, 1, 3, 4}, {0, 1, 2, 3, 4}, data_types::u8, data_types::f16, format::b_fs_zyx_fsv16, \
        format::bfzyx

// dim change
#define CASE_PERMUTE_REORDER_4D_TO_5D_F32_0 \
    {1, 16, 8, 16}, {1, 3, 2, 0}, {0, 3, 4, 2, 1}, data_types::f32, data_types::f32, format::bfyx, format::bfzyx
#define CASE_PERMUTE_REORDER_4D_TO_6D_F32_1 \
    {1, 16, 8, 16}, {0, 3, 1, 2}, {0, 4, 5, 1, 3, 2}, data_types::f32, data_types::f32, format::bfyx, format::bfwzyx
#define CASE_PERMUTE_REORDER_5D_TO_4D_F32_0                                                                     \
    {1, 16, 4, 5, 18}, {0, 2, 1, 3, 4}, {0, 2, 3, 1}, data_types::f32, data_types::f32, format::b_fs_zyx_fsv16, \
        format::bfyx
#define CASE_PERMUTE_REORDER_5D_TO_4D_F32_1 \
    {1, 16, 4, 5, 16}, {0, 4, 1, 2, 3}, {0, 2, 3, 1}, data_types::f32, data_types::f32, format::bfzyx, format::bfyx
#define CASE_PERMUTE_REORDER_5D_TO_6D_F32_2                                                                           \
    {1, 16, 8, 4, 16}, {0, 2, 1, 3, 4}, {0, 4, 5, 1, 3, 2}, data_types::f32, data_types::f32, format::b_fs_zyx_fsv16, \
        format::bfwzyx
#define CASE_PERMUTE_REORDER_6D_TO_4D_F32_0                                                                   \
    {1, 16, 4, 5, 4, 16}, {0, 5, 1, 4, 3, 2}, {0, 2, 3, 1}, data_types::f32, data_types::f32, format::bfwzyx, \
        format::bfyx
#define CASE_PERMUTE_REORDER_6D_TO_5D_F32_1                                                                      \
    {1, 16, 4, 5, 4, 16}, {0, 5, 1, 4, 3, 2}, {0, 3, 4, 1, 2}, data_types::f32, data_types::f32, format::bfwzyx, \
        format::bfzyx

// permute_opt for blocked format
#define CASE_PERMUTE_REORDER_TILED_F32_0 \
    {1, 256, 2, 64}, {0, 2, 3, 1}, {0, 3, 1, 2}, data_types::f32, data_types::f32, format::b_fs_yx_fsv16, format::bfyx
#define CASE_PERMUTE_REORDER_TILED_F32_1 \
    {1, 78, 2, 259}, {0, 2, 3, 1}, {0, 3, 1, 2}, data_types::f32, data_types::f32, format::b_fs_yx_fsv16, format::bfyx
#define CASE_PERMUTE_REORDER_TILED_F32_2                                                                            \
    {1, 48, 1, 3, 259}, {0, 2, 3, 4, 1}, {0, 4, 1, 2, 3}, data_types::f32, data_types::f32, format::b_fs_zyx_fsv16, \
        format::bfzyx

// permute_opt for blocked format => reorder to differnt dim
#define CASE_PERMUTE_REORDER_TILED_F32_3                                                                         \
    {1, 45, 1, 3, 259}, {0, 2, 3, 4, 1}, {0, 3, 1, 2}, data_types::f32, data_types::f32, format::b_fs_zyx_fsv16, \
        format::bfyx
#define CASE_PERMUTE_REORDER_TILED_F32_4 \
    {2, 273, 19, 19}, {0, 2, 3, 1}, {0, 3, 1, 2}, data_types::f32, data_types::f32, format::b_fs_yx_fsv16, format::bfyx
#define CASE_PERMUTE_REORDER_TILED_F32_5 \
    {2, 546, 2, 2}, {0, 2, 3, 1}, {0, 3, 1, 2}, data_types::f32, data_types::f32, format::b_fs_yx_fsv16, format::bfyx

// permute opt for blocked format => reorder to different dim/type
#define CASE_PERMUTE_REORDER_TILED_I8_4                                                                         \
    {1, 45, 1, 3, 259}, {0, 2, 3, 4, 1}, {0, 3, 1, 2}, data_types::i8, data_types::f32, format::b_fs_zyx_fsv16, \
        format::bfyx
#define CASE_PERMUTE_REORDER_TILED_F16_5                                                                     \
    {1, 48, 3, 256}, {0, 2, 3, 1}, {0, 4, 1, 3, 2}, data_types::f16, data_types::f32, format::b_fs_yx_fsv16, \
        format::bfzyx
#define CASE_PERMUTE_REORDER_TILED_F16_6                                                                               \
    {1, 48, 2, 3, 256}, {0, 2, 3, 4, 1}, {0, 5, 1, 4, 3, 2}, data_types::f16, data_types::f32, format::b_fs_zyx_fsv16, \
        format::bfwzyx

// permute opt for non_blocked format => reorder to differnt dim/type
#define CASE_PERMUTE_REORDER_TILED_F16_7 \
    {1, 48, 2, 3, 256}, {0, 2, 3, 4, 1}, {0, 3, 1, 2}, data_types::f16, data_types::f32, format::bfzyx, format::bfyx
#define CASE_PERMUTE_REORDER_TILED_F16_8                                                                       \
    {1, 28, 2, 2, 3, 256}, {0, 2, 3, 4, 5, 1}, {0, 3, 1, 2}, data_types::f16, data_types::f32, format::bfwzyx, \
        format::bfyx
#define CASE_PERMUTE_REORDER_TILED_F16_9 \
    {1, 24, 2, 3, 256}, {0, 2, 3, 4, 1}, {0, 3, 1, 2}, data_types::f16, data_types::f32, format::bfzyx, format::bfyx
#define CASE_PERMUTE_REORDER_TILED_F16_10 \
    {1, 35, 3, 253}, {0, 2, 3, 1}, {0, 4, 1, 3, 2}, data_types::f16, data_types::f32, format::bfyx, format::bfzyx
#define CASE_PERMUTE_REORDER_TILED_F16_11 \
    {1, 32, 3, 253}, {0, 2, 3, 1}, {0, 5, 1, 4, 2, 3}, data_types::f16, data_types::f32, format::bfyx, format::bfwzyx
#define CASE_PERMUTE_REORDER_TILED_F16_12 \
    {1, 768, 32, 32}, {0, 2, 3, 1}, {0, 4, 1, 3, 2}, data_types::f16, data_types::f32, format::bfyx, format::bfzyx
...
// Tiled opt kernel should not be fused with eltwise + reorder. Currently permute_ref will be selected and fused with
// eltwise + reorder
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         permute_eltwise_reorder,
                         ::testing::ValuesIn(std::vector<permute_reorder_params>{
                             permute_reorder_params{CASE_PERMUTE_REORDER_TILED_F16_7, 3, 5},
                             permute_reorder_params{CASE_PERMUTE_REORDER_TILED_F16_8, 3, 5},
                             permute_reorder_params{CASE_PERMUTE_REORDER_TILED_F16_9, 3, 5},
