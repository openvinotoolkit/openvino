...
#define CASE_SCATTER_ELEMENTS_UPDATE_FP32_1 \
    {8, 4, 1, 1}, {2, 4, 1, 1}, 0, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ELEMENTS_UPDATE_FP32_2 \
    {2, 8, 1, 2}, {2, 2, 1, 2}, 1, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_ELEMENTS_UPDATE_FP32_3 \
    {2, 3, 10, 10}, {2, 2, 1, 2}, 2, data_types::f32, format::bfyx, data_types::f32, format::bfyx

#define CASE_SCATTER_ELEMENTS_UPDATE_FP16_1 \
    {2, 2, 14, 12}, {2, 2, 3, 1}, 3, data_types::f16, format::bfyx, data_types::f16, format::bfyx

#define CASE_SCATTER_ELEMENTS_UPDATE_5D_FP32_1 \
    {24, 3, 1, 4, 1}, {4, 3, 1, 2, 1}, 0, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_SCATTER_ELEMENTS_UPDATE_5D_FP32_2 \
    {2, 17, 2, 2, 2}, {1, 2, 2, 2, 2}, 1, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_SCATTER_ELEMENTS_UPDATE_5D_FP32_3 \
    {5, 3, 2, 20, 22}, {5, 1, 1, 2, 2}, 3, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx

#define CASE_SCATTER_ELEMENTS_UPDATE_5D_FP16_1 \
    {13, 2, 1, 2, 1}, {2, 2, 1, 2, 1}, 0, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx
#define CASE_SCATTER_ELEMENTS_UPDATE_5D_FP16_2 \
    {1, 13, 1, 2, 1}, {1, 2, 1, 2, 1}, 1, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx
#define CASE_SCATTER_ELEMENTS_UPDATE_5D_FP16_3 \
    {2, 3, 1, 13, 13}, {2, 3, 1, 2, 1}, 3, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx
...
TEST_P(scatter_elements_update_quantize, basic) {
    auto p = GetParam();
    const auto& seu = scatter_elements_update("scatter_elements_update_prim",
                                              input_info("input"),
                                              input_info("scatter_elements_update_indices"),
                                              input_info("scatter_elements_update_updates"),
                                              p.axis);
    const auto& q = quantize("quantize",
                             input_info("scatter_elements_update_prim"),
                             input_info("in_lo"),
                             input_info("in_hi"),
                             input_info("out_lo"),
                             input_info("out_hi"),
    ...
    create_topologies(input_layout("input", get_input_layout(p)),
                      data("scatter_elements_update_indices",
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         scatter_elements_update_quantize,
...
TEST_P(scatter_elements_update_scale_activation_eltwise, basic) {
    ...
    create_topologies(
        ...
        scatter_elements_update("scatter_elements_update_prim",
                                input_info("input"),
                                input_info("scatter_elements_update_indices"),
                                input_info("scatter_elements_update_updates"),
                                p.axis),
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         scatter_elements_update_scale_activation_eltwise,
                         ::testing::ValuesIn(std::vector<scatter_elements_update_test_params>{
