...
#define CASE_SPACE_TO_DEPTH_F32_1                                                                                \
    {2, 2, 8, 10}, {2, 8, 4, 5}, SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST, data_types::f32, format::bfyx, 2, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_DEPTH_F32_2                                                                                      \
    {1, 2, 6, 6, 6}, {1, 54, 2, 2, 2}, SpaceToDepth::SpaceToDepthMode::DEPTH_FIRST, data_types::f32, format::bfzyx, 3, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_DEPTH_F16_1                                                                                \
    {1, 3, 6, 6}, {1, 12, 3, 3}, SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST, data_types::f16, format::bfyx, 2, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_DEPTH_F16_2                                                                                     \
    {2, 1, 3, 3}, {2, 9, 1, 1}, SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST, data_types::f16, format::b_fs_yx_fsv16, \
        3, data_types::f32, format::bfyx
#define CASE_SPACE_TO_DEPTH_U8_1                                                                                \
    {2, 2, 8, 10}, {2, 8, 4, 5}, SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST, data_types::u8, format::bfyx, 2, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_DEPTH_U8_2                                                                                      \
    {1, 2, 6, 6, 6}, {1, 54, 2, 2, 2}, SpaceToDepth::SpaceToDepthMode::DEPTH_FIRST, data_types::u8, format::bfzyx, 3, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_DEPTH_I8_1                                                                                \
    {1, 3, 6, 6}, {1, 12, 3, 3}, SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST, data_types::i8, format::bfyx, 2, \
        data_types::f32, format::bfyx
#define CASE_SPACE_TO_DEPTH_I8_2                                                                                     \
    {2, 1, 3, 3}, {2, 9, 1, 1}, SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST, data_types::i8, format::b_fs_yx_fsv16, \
        3, data_types::f32, format::bfyx
...
TEST_P(space_to_depth_scale_act_eltwise_quantize_u8, basic) {
    ...
    create_topologies(
        ...
        eltwise("scale1",
                {input_info("space_to_depth"), input_info("scale1_data")},
                eltwise_mode::prod,
                p.default_type),
