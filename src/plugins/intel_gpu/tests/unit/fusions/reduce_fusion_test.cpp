...
public:
    ...
    // To avoid this issue made by a generator, it could use a proper planar format given by 'default_format' and add a
    // reorder.
...
/* ---------------------------------------- Reduce cases ----------------------------------------------- */
/* ----------------------------------------------------------------------------------------------------- */
#define CASE_REDUCE_F32_0 \
    {3, 7, 7, 5}, {3, 7, 7, 5}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
#define CASE_REDUCE_F32_1 {3, 7, 7, 5}, {3, 7, 7, 5}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_REDUCE_F32_2 \
    {2, 4, 4, 4, 8}, {2, 4, 4, 4, 8}, data_types::f32, format::bfzyx, data_types::f32, format::bfyx
#define CASE_REDUCE_F32_3 \
    {16, 16, 8, 8, 8, 16}, {16, 16, 8, 8, 8, 16}, data_types::f32, format::bfwzyx, data_types::f32, format::bfyx
#define CASE_REDUCE_F32_4 \
    {2, 8, 4, 4}, {2, 8, 4, 4}, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, format::bfyx

#define CASE_REDUCE_F16_0 \
    {3, 7, 7, 5}, {3, 7, 7, 5}, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
#define CASE_REDUCE_F16_1 {2, 8, 4, 4}, {2, 8, 4, 4}, data_types::f16, format::bfyx, data_types::f32, format::bfyx
#define CASE_REDUCE_F16_2 \
    {2, 4, 4, 4, 8}, {2, 4, 4, 4, 8}, data_types::f16, format::bfzyx, data_types::f32, format::bfyx
#define CASE_REDUCE_F16_3 \
    {3, 5, 7, 7, 5, 3}, {3, 5, 7, 7, 5, 3}, data_types::f16, format::bfwzyx, data_types::f32, format::bfyx
#define CASE_REDUCE_F16_4 \
    {2, 8, 4, 4}, {2, 8, 4, 4}, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, format::bfyx

#define CASE_REDUCE_I32_0 \
    {3, 7, 7, 5}, {3, 7, 7, 5}, data_types::i32, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
#define CASE_REDUCE_I32_1 {2, 8, 4, 4}, {2, 8, 4, 4}, data_types::i32, format::bfyx, data_types::f32, format::bfyx
#define CASE_REDUCE_I32_2 \
    {2, 4, 4, 4, 8}, {2, 4, 4, 4, 8}, data_types::i32, format::bfzyx, data_types::f32, format::bfyx
#define CASE_REDUCE_I32_3 \
    {3, 5, 7, 7, 5, 3}, {3, 5, 7, 7, 5, 3}, data_types::i32, format::bfwzyx, data_types::f32, format::bfyx
#define CASE_REDUCE_I32_4 \
    {3, 5, 7, 7, 5, 3}, {3, 5, 7, 7, 5, 3}, data_types::i32, format::bfwzyx, data_types::f32, format::bfyx

#define CASE_REDUCE_I8_0 \
    {3, 7, 7, 5}, {3, 7, 7, 5}, data_types::i8, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
...
#define CASE_REDUCE_I8_3 \
    {3, 5, 7, 7, 5, 3}, {3, 5, 7, 7, 5, 3}, data_types::i8, format::bfwzyx, data_types::f32, format::bfyx
#define CASE_REDUCE_I8_4 \
    {2, 8, 4, 4}, {2, 8, 4, 4}, data_types::i8, format::b_fs_yx_fsv16, data_types::f32, format::bfyx

#define CASE_REDUCE_U8_0 \
    {3, 7, 7, 5}, {3, 7, 7, 5}, data_types::u8, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
...
#define CASE_REDUCE_U8_3 \
    {3, 5, 7, 7, 5, 3}, {3, 5, 7, 7, 5, 3}, data_types::u8, format::bfwzyx, data_types::f32, format::bfyx
#define CASE_REDUCE_U8_4 \
    {2, 8, 4, 4}, {2, 8, 4, 4}, data_types::u8, format::b_fs_yx_fsv16, data_types::f32, format::bfyx
...
TEST_P(reduce_scale_activation, dynamic) {
    auto p = GetParam();
    create_topologies(input_layout("input", get_dynamic_input_layout(p)),
                      data("scale_data", get_mem(get_per_channel_layout(p), -0.125f)),
                      reduce("reduce", input_info("input"), p.reduce_mode, p.reduce_axes, p.keep_dims),
                      eltwise("scale", {input_info("reduce"), input_info("scale_data")}, eltwise_mode::prod),
                      activation("activation", input_info("scale"), activation_func::cos),
