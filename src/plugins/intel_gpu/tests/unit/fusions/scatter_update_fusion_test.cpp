...
#define CASE_SCATTER_UPDATE_FP32_1 \
    {2, 4, 1, 1}, {2, 1, 1, 1}, {2, 4, 1, 1}, 0, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_UPDATE_FP32_2 \
    {8, 1, 1, 1}, {4, 1, 1, 1}, {4, 1, 1, 1}, 0, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_UPDATE_FP32_3 \
    {4, 3, 1, 1}, {2, 2, 1, 1}, {2, 2, 1, 3}, 0, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_UPDATE_FP32_4 \
    {2, 5, 1, 2}, {2, 2, 1, 1}, {2, 2, 2, 2}, 1, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_SCATTER_UPDATE_FP32_5 \
    {2, 2, 1, 4}, {2, 2, 1, 1}, {2, 2, 2, 2}, 2, data_types::f32, format::bfyx, data_types::f32, format::bfyx

#define CASE_SCATTER_UPDATE_FP16_1 \
    {2, 4, 1, 1}, {1, 1, 1, 2}, {2, 1, 2, 1}, 1, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_UPDATE_FP16_2 \
    {8, 2, 1, 20}, {2, 3, 1, 1}, {2, 3, 20, 2}, 0, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_UPDATE_FP16_3 \
    {2, 2, 4, 1}, {3, 1, 1, 1}, {2, 2, 3, 1}, 3, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_UPDATE_FP16_4 \
    {6, 2, 1, 1}, {1, 2, 1, 2}, {1, 2, 2, 2}, 0, data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_SCATTER_UPDATE_FP16_5 \
    {3, 1, 1, 5}, {2, 2, 1, 1}, {3, 1, 2, 2}, 2, data_types::f16, format::bfyx, data_types::f16, format::bfyx

#define CASE_SCATTER_UPDATE_5D_FP32_1 \
    {4, 3, 1, 4, 1}, {4, 1, 1, 1}, {4, 3, 1, 4, 1}, 0, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_SCATTER_UPDATE_5D_FP32_2 \
    {2, 3, 2, 2, 2}, {2, 1, 1, 1}, {2, 2, 2, 2, 2}, 1, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_SCATTER_UPDATE_5D_FP32_3 \
    {5, 3, 2, 4, 2}, {3, 1, 1, 1}, {5, 3, 2, 3, 2}, 3, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_SCATTER_UPDATE_5D_FP32_4 \
    {2, 3, 1, 4, 4}, {2, 1, 1, 1}, {2, 3, 1, 4, 2}, 2, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_SCATTER_UPDATE_5D_FP32_5 \
    {3, 1, 5, 2, 1}, {2, 1, 1, 1}, {3, 1, 2, 2, 1}, 4, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx

#define CASE_SCATTER_UPDATE_5D_FP16_1 \
    {3, 2, 1, 2, 1}, {2, 1, 1, 1}, {2, 2, 2, 2, 1}, 0, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx
#define CASE_SCATTER_UPDATE_5D_FP16_2 \
    {1, 3, 1, 2, 1}, {2, 1, 1, 1}, {1, 2, 1, 2, 1}, 1, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx
#define CASE_SCATTER_UPDATE_5D_FP16_3 \
    {2, 3, 1, 3, 3}, {1, 2, 1, 1}, {2, 3, 1, 2, 3}, 3, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx
#define CASE_SCATTER_UPDATE_5D_FP16_4 \
    {3, 2, 2, 2, 2}, {2, 1, 1, 1}, {3, 2, 2, 2, 2}, 2, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx
#define CASE_SCATTER_UPDATE_5D_FP16_5 \
    {1, 1, 4, 1, 1}, {3, 1, 1, 1}, {1, 1, 3, 1, 1}, 4, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx

class scatter_update_quantize : public ScatterUpdatePrimitiveFusingTest {};
TEST_P(scatter_update_quantize, basic) {
    auto p = GetParam();
    create_topologies(input_layout("input", get_input_layout(p)),
                      data("scatter_update_indices",
                           get_repeatless_mem(get_indices_layout(p), 0, static_cast<int>(get_axis_dim(p)) - 1)),
                      data("scatter_update_updates", get_mem(get_updates_layout(p), 0, 1000)),
                      data("in_lo", get_mem(get_per_channel_layout(p), min_random, 0)),
                      data("in_hi", get_mem(get_per_channel_layout(p), 1, max_random)),
                      data("out_lo", get_mem(get_single_element_layout(p), -127)),
                      data("out_hi", get_mem(get_single_element_layout(p), 127)),
                      scatter_update("scatter_update_prim",
                                     input_info("input"),
                                     input_info("scatter_update_indices"),
                                     input_info("scatter_update_updates"),
                                     p.axis),
                      quantize("quantize",
                               input_info("scatter_update_prim"),
                               input_info("in_lo"),
                               input_info("in_hi"),
                               input_info("out_lo"),
                               input_info("out_hi"),
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         scatter_update_scale_activation,
                         ::testing::ValuesIn(std::vector<scatter_update_test_params>{
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         scatter_update_scale_activation_eltwise,
                         ::testing::ValuesIn(std::vector<scatter_update_test_params>{
