...
/* ---------------------------------------- Eltwise cases ---------------------------------------------- */
/* ----------------------------------------------------------------------------------------------------- */
#define CASE_ELTWISE_FP32_1 \
    {2, 16, 4, 4}, data_types::f32, data_types::f32, format::bfyx, data_types::f32, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_FP32_2 \
    {2, 16, 4, 4}, data_types::f32, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_FP32_3                                                                                         \
    {2, 32, 4, 8}, data_types::f32, data_types::f32, format::b_fs_yx_fsv16, data_types::f32, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP32_4 \
    {2, 16, 4, 4}, data_types::f32, data_types::f32, format::bfwzyx, data_types::f32, format::bfwzyx, eltwise_mode::sum
#define CASE_ELTWISE_FP16_1 \
    {2, 16, 4, 4}, data_types::f16, data_types::f16, format::bfyx, data_types::f16, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_FP16_2 \
    {2, 16, 4, 4}, data_types::f16, data_types::f16, format::bfzyx, data_types::f16, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_FP16_3                                                                                         \
    {2, 32, 4, 8}, data_types::f16, data_types::f16, format::b_fs_yx_fsv16, data_types::f16, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP16_4                                                                                         \
    {3, 32, 4, 4}, data_types::f16, data_types::f16, format::fs_b_yx_fsv32, data_types::f16, format::fs_b_yx_fsv32, \
        eltwise_mode::sum
#define CASE_ELTWISE_I8_1 \
    {2, 16, 4, 4}, data_types::i8, data_types::i8, format::bfyx, data_types::f32, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_I8_2 \
    {2, 16, 4, 4}, data_types::i8, data_types::i8, format::bfzyx, data_types::f32, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_I8_3                                                                                         \
    {2, 16, 4, 4}, data_types::i8, data_types::i8, format::b_fs_yx_fsv16, data_types::f32, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_U8_1 \
    {2, 16, 4, 4}, data_types::u8, data_types::u8, format::bfyx, data_types::f32, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_U8_2 \
    {2, 16, 4, 4}, data_types::u8, data_types::u8, format::bfzyx, data_types::f32, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_U8_3                                                                                         \
    {2, 16, 4, 4}, data_types::u8, data_types::u8, format::b_fs_yx_fsv16, data_types::f32, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP32_FP16_1 \
    {2, 16, 4, 4}, data_types::f32, data_types::f16, format::bfyx, data_types::f32, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_FP32_FP16_2 \
    {2, 16, 4, 4}, data_types::f32, data_types::f16, format::bfzyx, data_types::f32, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_FP32_FP16_3                                                                                    \
    {2, 32, 4, 4}, data_types::f32, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP16_FP32_1 \
    {2, 16, 4, 4}, data_types::f16, data_types::f32, format::bfyx, data_types::f16, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_FP16_FP32_2 \
    {2, 16, 4, 4}, data_types::f16, data_types::f32, format::bfzyx, data_types::f16, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_FP16_FP32_3                                                                                    \
    {2, 32, 4, 4}, data_types::f16, data_types::f32, format::b_fs_yx_fsv16, data_types::f16, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_I8_FP16_1 \
    {2, 16, 4, 4}, data_types::i8, data_types::f16, format::bfyx, data_types::f32, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_I8_FP16_2 \
    {2, 16, 4, 4}, data_types::i8, data_types::f16, format::bfzyx, data_types::f32, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_I8_FP16_3                                                                                     \
    {2, 32, 4, 4}, data_types::i8, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_I8_FP32_1 \
    {2, 16, 4, 4}, data_types::i8, data_types::f32, format::bfyx, data_types::f16, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_I8_FP32_2 \
    {2, 16, 4, 4}, data_types::i8, data_types::f32, format::bfzyx, data_types::f16, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_I8_FP32_3                                                                                     \
    {2, 32, 4, 4}, data_types::i8, data_types::f32, format::b_fs_yx_fsv16, data_types::f16, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_U8_FP16_1 \
    {2, 16, 4, 4}, data_types::u8, data_types::f16, format::bfyx, data_types::f32, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_U8_FP16_2 \
    {2, 16, 4, 4}, data_types::u8, data_types::f16, format::bfzyx, data_types::f32, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_U8_FP16_3                                                                                     \
    {2, 32, 4, 4}, data_types::u8, data_types::f16, format::b_fs_yx_fsv16, data_types::f32, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_U8_FP32_1 \
    {2, 16, 4, 4}, data_types::u8, data_types::f32, format::bfyx, data_types::f16, format::bfyx, eltwise_mode::sum
#define CASE_ELTWISE_U8_FP32_2 \
    {2, 16, 4, 4}, data_types::u8, data_types::f32, format::bfzyx, data_types::f16, format::bfzyx, eltwise_mode::sum
#define CASE_ELTWISE_U8_FP32_3                                                                                     \
    {2, 32, 4, 4}, data_types::u8, data_types::f32, format::b_fs_yx_fsv16, data_types::f16, format::b_fs_yx_fsv16, \
        eltwise_mode::sum

#define CASE_ELTWISE_FP32_5                                                                                      \
    {1, 5, 4, 4}, data_types::f32, data_types::f32, format::b_fs_yx_fsv4, data_types::f32, format::b_fs_yx_fsv4, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP32_6                                                                                       \
    {2, 32, 4, 8}, data_types::f32, data_types::f32, format::b_fs_yx_fsv4, data_types::f32, format::b_fs_yx_fsv4, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP32_7 \
    {1, 8, 16, 1}, data_types::f32, data_types::f32, format::bfyx, data_types::f32, format::bfwzyx, eltwise_mode::sum
#define CASE_ELTWISE_FP16_5                                                                                       \
    {2, 32, 4, 8}, data_types::f16, data_types::f16, format::b_fs_yx_fsv4, data_types::f16, format::b_fs_yx_fsv4, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP16_6 \
    {1, 32, 4, 8}, data_types::f16, data_types::f16, format::byxf, data_types::f16, format::byxf, eltwise_mode::sum
#define CASE_ELTWISE_I8_4                                                                                       \
    {2, 16, 4, 4}, data_types::i8, data_types::i8, format::b_fs_yx_fsv4, data_types::f32, format::b_fs_yx_fsv4, \
        eltwise_mode::sum
#define CASE_ELTWISE_U8_4                                                                                       \
    {2, 16, 4, 4}, data_types::u8, data_types::u8, format::b_fs_yx_fsv4, data_types::f32, format::b_fs_yx_fsv4, \
        eltwise_mode::sum

#define CASE_ELTWISE_FP16_7                                                                                           \
    {3, 32, 2, 3, 3, 2, 1, 2}, data_types::f16, data_types::f16, format::bfvuwzyx, data_types::f16, format::bfvuwzyx, \
        eltwise_mode::sum
...
TEST_P(eltwise_reorder_eltwise_fp32_fused_prims, eltwise_activation) {
    ...
    create_topologies(
        ...
        reorder("reorder6d",
                input_info("eltwise1"),
                layout{{p.input_size[0], p.input_size[1], 1, 1, p.input_size[2], p.input_size[3]},
                       p.input_type,
                       p.default_format}),
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         eltwise_reorder_eltwise_fp32_fused_prims,
                         ::testing::ValuesIn(std::vector<eltwise_test_params>{
...
#define CASE_ELTWISE_FP16_FS_B_YX                                                                                   \
    {1, 32, 4, 4}, data_types::f16, data_types::f16, format::fs_b_yx_fsv32, data_types::f16, format::fs_b_yx_fsv32, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP16_BATCH_FS_B                                                                                \
    {8, 32, 4, 4}, data_types::f16, data_types::f16, format::fs_b_yx_fsv32, data_types::f16, format::fs_b_yx_fsv32, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP16_B_FS_YX                                                                                   \
    {1, 32, 4, 4}, data_types::f16, data_types::f16, format::b_fs_yx_fsv16, data_types::f16, format::b_fs_yx_fsv16, \
        eltwise_mode::sum
#define CASE_ELTWISE_FP16_BATCH_B_FS                                                                                \
    {8, 32, 4, 4}, data_types::f16, data_types::f16, format::b_fs_yx_fsv16, data_types::f16, format::b_fs_yx_fsv16, \
        eltwise_mode::sum

INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         eltwise_quantize_fs_b_yx_fsv32,
                         ::testing::ValuesIn(std::vector<eltwise_test_params>{
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         eltwise_quantize_fs_b_yx_fsv32_exception,
                         ::testing::ValuesIn(std::vector<eltwise_test_params>{
