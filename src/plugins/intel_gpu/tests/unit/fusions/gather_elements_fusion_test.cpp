...
/* ----------------------------------------------------------------------------------------------------- */
#define CASE_GATHER_ELEMENTS_FP16_4D_1                                                                      \
    data_types::f16, format::bfyx, {3, 7, 9, 8}, format::bfyx, {3, 7, 9, 8}, format::bfyx, {3, 7, 9, 8}, 2, \
        data_types::f16, format::bfyx
#define CASE_GATHER_ELEMENTS_FP16_4D_2                                                                      \
    data_types::f16, format::bfyx, {3, 2, 8, 3}, format::bfyx, {2, 2, 8, 3}, format::bfyx, {2, 2, 8, 3}, 0, \
        data_types::f16, format::bfyx
#define CASE_GATHER_ELEMENTS_FP16_4D_3                                                                      \
    data_types::f16, format::bfyx, {1, 3, 2, 9}, format::bfyx, {1, 3, 5, 9}, format::bfyx, {1, 3, 5, 9}, 3, \
        data_types::f16, format::bfyx

#define CASE_GATHER_ELEMENTS_FP16_5D_1                                                                               \
    data_types::f16, format::bfzyx, {3, 2, 5, 2, 3}, format::bfzyx, {3, 2, 2, 2, 3}, format::bfzyx, {3, 2, 2, 2, 3}, \
        4, data_types::f16, format::bfzyx
#define CASE_GATHER_ELEMENTS_FP16_5D_2                                                                               \
    data_types::f16, format::bfzyx, {5, 4, 7, 4, 4}, format::bfzyx, {5, 4, 7, 4, 3}, format::bfzyx, {5, 4, 7, 4, 3}, \
        2, data_types::f16, format::bfzyx

#define CASE_GATHER_ELEMENTS_FP16_6D_1                                                                       \
    data_types::f16, format::bfwzyx, {5, 4, 6, 7, 8, 2}, format::bfwzyx, {5, 2, 6, 7, 8, 2}, format::bfwzyx, \
        {5, 2, 6, 7, 8, 2}, 1, data_types::f16, format::bfwzyx
#define CASE_GATHER_ELEMENTS_FP16_6D_2                                                                       \
    data_types::f16, format::bfwzyx, {2, 1, 2, 3, 2, 1}, format::bfwzyx, {2, 1, 2, 3, 2, 3}, format::bfwzyx, \
        {2, 1, 2, 3, 2, 3}, 2, data_types::f16, format::bfwzyx
#define CASE_GATHER_ELEMENTS_FP16_6D_3                                                                       \
    data_types::f16, format::bfwzyx, {2, 2, 3, 4, 4, 2}, format::bfwzyx, {2, 2, 6, 4, 4, 2}, format::bfwzyx, \
        {2, 2, 6, 4, 4, 2}, 5, data_types::f16, format::bfwzyx

#define CASE_GATHER_ELEMENTS_FP32_4D_1                                                                      \
    data_types::f32, format::bfyx, {3, 7, 9, 8}, format::bfyx, {3, 7, 9, 8}, format::bfyx, {3, 7, 9, 8}, 2, \
        data_types::f32, format::bfyx
#define CASE_GATHER_ELEMENTS_FP32_4D_2                                                                      \
    data_types::f32, format::bfyx, {3, 2, 8, 3}, format::bfyx, {2, 2, 8, 3}, format::bfyx, {2, 2, 8, 3}, 0, \
        data_types::f32, format::bfyx
#define CASE_GATHER_ELEMENTS_FP32_4D_3                                                                      \
    data_types::f32, format::bfyx, {1, 3, 2, 9}, format::bfyx, {1, 3, 5, 9}, format::bfyx, {1, 3, 5, 9}, 3, \
        data_types::f32, format::bfyx

#define CASE_GATHER_ELEMENTS_FP32_5D_1                                                                               \
    data_types::f32, format::bfzyx, {3, 2, 5, 2, 3}, format::bfzyx, {3, 2, 2, 2, 3}, format::bfzyx, {3, 2, 2, 2, 3}, \
        4, data_types::f32, format::bfzyx
#define CASE_GATHER_ELEMENTS_FP32_5D_2                                                                               \
    data_types::f32, format::bfzyx, {5, 4, 7, 4, 4}, format::bfzyx, {5, 4, 7, 4, 3}, format::bfzyx, {5, 4, 7, 4, 3}, \
        2, data_types::f32, format::bfzyx

#define CASE_GATHER_ELEMENTS_FP32_6D_1                                                                       \
    data_types::f32, format::bfwzyx, {5, 4, 6, 7, 8, 2}, format::bfwzyx, {5, 2, 6, 7, 8, 2}, format::bfwzyx, \
        {5, 2, 6, 7, 8, 2}, 1, data_types::f32, format::bfwzyx
#define CASE_GATHER_ELEMENTS_FP32_6D_2                                                                       \
    data_types::f32, format::bfwzyx, {2, 1, 2, 3, 2, 1}, format::bfwzyx, {2, 1, 2, 3, 2, 3}, format::bfwzyx, \
        {2, 1, 2, 3, 2, 3}, 2, data_types::f32, format::bfwzyx
#define CASE_GATHER_ELEMENTS_FP32_6D_3                                                                       \
    data_types::f32, format::bfwzyx, {2, 2, 3, 4, 4, 2}, format::bfwzyx, {2, 2, 6, 4, 4, 2}, format::bfwzyx, \
        {2, 2, 6, 4, 4, 2}, 5, data_types::f32, format::bfwzyx
...
TEST_P(gather_elements_quantize, basic) {
    ...
    create_topologies(
        ...
        gather_elements("gather_elements_prim",
                        input_info("input"),
                        input_info("gather_elements_indices"),
                        p.output_format,
                        p.output_shape,
                        p.axis),
        quantize("quantize",
                 input_info("gather_elements_prim"),
                 input_info("in_lo"),
                 input_info("in_hi"),
                 input_info("out_lo"),
                 input_info("out_hi"),
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         gather_elements_scale_activation,
                         ::testing::ValuesIn(std::vector<gather_elements_test_params>{
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         gather_elements_activation_scale_eltwise,
                         ::testing::ValuesIn(std::vector<gather_elements_test_params>{
