...
public:
    void execute(lrn_test_params& p) {
        ...
        config.set_property(
            ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"lrn_norm", lrn_impl}}));
...
INSTANTIATE_TEST_SUITE_P(
    fusings_gpu,
    lrn_fp32_quantize_u8_eltwise_activation,
    ::testing::ValuesIn(std::vector<lrn_test_params>{
        ...
        lrn_test_params{CASE_LRN_FP32_1,
                        2,
                        5,
        ...
        lrn_test_params{CASE_LRN_FP32_4,
                        2,
                        5,
                        lrn_norm_region_across_channel,
                        "lrn_gpu_across_channel_multiple_features"},
        lrn_test_params{CASE_LRN_FP32_5,
                        2,
                        5,
                        lrn_norm_region_across_channel,
                        "lrn_gpu_across_channel_multiple_features_fsv16"},

        // InputDataType = FP32   OutputDataType = FP16
        lrn_test_params{CASE_LRN_FP32_TO_FP16_1, 2, 5, lrn_norm_region_across_channel, "lrn_ref"},
        lrn_test_params{CASE_LRN_FP32_TO_FP16_1,
                        2,
                        5,
                        lrn_norm_region_across_channel,
                        "lrn_gpu_across_channel_multiple_features"},
        ...
        lrn_test_params{CASE_LRN_FP32_TO_FP16_3,
                        2,
                        5,
                        lrn_norm_region_across_channel,
                        "lrn_gpu_across_channel_yxfb_b8_opt"},
        lrn_test_params{CASE_LRN_FP32_TO_FP16_4,
                        2,
                        5,
                        lrn_norm_region_across_channel,
                        "lrn_gpu_across_channel_multiple_features"},
        lrn_test_params{CASE_LRN_FP32_TO_FP16_5,
                        2,
                        5,
                        lrn_norm_region_across_channel,
                        "lrn_gpu_across_channel_multiple_features_fsv16"},
...
INSTANTIATE_TEST_SUITE_P(
    fusings_gpu,
    lrn_fp32_quantize_u8_eltwise_activation_onednn,
    ::testing::ValuesIn(std::vector<lrn_test_params>{
        // InputDataType = FP32   OutputDataType = FP32
        lrn_test_params{CASE_LRN_FP32_1, 2, 5, lrn_norm_region_across_channel, "lrn_ref"},
        lrn_test_params{CASE_LRN_FP32_1, 2, 5, lrn_norm_region_within_channel, "lrn_gpu_within_channel_opt"},
...
INSTANTIATE_TEST_SUITE_P(
    fusings_gpu,
    lrn_fp32_quantize_i8_eltwise_activation,
    ::testing::ValuesIn(std::vector<lrn_test_params>{
        ...
        // primitive doesn't support input type FP16 while fusing (prepare_quantization.cpp :114 ->
        // prepare_primitive_fusing.cpp :474)
    }));
...
INSTANTIATE_TEST_SUITE_P(
    fusings_gpu,
    lrn_fp32_eltwise_activation_quantize_u8,
    ::testing::ValuesIn(std::vector<lrn_test_params>{
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::ValuesIn(std::vector<lrn_test_params>{
        ...
        lrn_test_params{CASE_LRN_FP16_1,
                        2,
                        4,
                        lrn_norm_region_across_channel,
                        "lrn_gpu_across_channel_multiple_features"},
        ...
        lrn_test_params{CASE_LRN_FP16_4,
                        2,
                        4,
                        lrn_norm_region_across_channel,
                        "lrn_gpu_across_channel_multiple_features"},
        // lrn_test_params{ CASE_LRN_FP16_5, 2, 4, lrn_norm_region_across_channel,
        // "lrn_gpu_across_channel_multiple_features_fsv16" },
    }));
