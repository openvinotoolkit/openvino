...
#define CASE_BATCH_TO_SPACE_F32_1                                                                        \
    {8, 1, 1, 1}, {2, 1, 2, 2}, data_types::f32, format::bfyx, {1, 1, 2, 2}, {0, 0, 0, 0}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_BATCH_TO_SPACE_F32_2                                                                                     \
    {64, 16, 2, 2}, {2, 112, 4, 4}, data_types::f32, format::b_fs_yx_fsv16, {1, 8, 2, 2}, {0, 8, 0, 0}, {0, 8, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_BATCH_TO_SPACE_F16_1                                                                          \
    {16, 4, 1, 2}, {2, 12, 1, 2}, data_types::f16, format::bfyx, {1, 4, 2, 1}, {0, 2, 1, 0}, {0, 2, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_BATCH_TO_SPACE_F16_2                                                                                      \
    {32, 16, 2, 1}, {1, 16, 32, 2}, data_types::f16, format::b_fs_yx_fsv16, {1, 1, 16, 2}, {0, 0, 0, 0}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_BATCH_TO_SPACE_U8_1                                                                           \
    {30, 12, 4, 6}, {1, 52, 8, 9}, data_types::u8, format::bfyx, {1, 5, 2, 3}, {0, 8, 0, 9}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_BATCH_TO_SPACE_U8_2                                                                                     \
    {24, 32, 4, 5}, {2, 64, 12, 8}, data_types::u8, format::b_fs_yx_fsv16, {1, 2, 3, 2}, {0, 0, 0, 2}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_BATCH_TO_SPACE_I8_1                                                                         \
    {32, 1, 3, 4}, {1, 8, 6, 8}, data_types::i8, format::bfyx, {1, 8, 2, 2}, {0, 0, 0, 0}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
#define CASE_BATCH_TO_SPACE_I8_2                                                                                    \
    {16, 16, 2, 1}, {2, 32, 4, 2}, data_types::i8, format::b_fs_yx_fsv16, {1, 2, 2, 2}, {0, 0, 0, 0}, {0, 0, 0, 0}, \
        data_types::f32, format::bfyx
...
TEST_P(batch_to_space_scale_act_eltwise_quantize_u8, basic) {
    ...
    create_topologies(
        ...
        eltwise("scale1",
                {input_info("batch_to_space"), input_info("scale1_data")},
                eltwise_mode::prod,
                p.default_type),
