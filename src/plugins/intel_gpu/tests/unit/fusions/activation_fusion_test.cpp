...
public:
    ...
    format get_input_format(activation_test_params& p) {
...
#define CASE_ACTIVATION_F32_8 \
    {1, 2, 3, 4, 5, 3, 2, 3}, data_types::f32, format::bfvuwzyx, data_types::f32, format::bfvuwzyx
...
#define CASE_ACTIVATION_3D_F32_2 \
    {1, 16, 7, 7, 7}, data_types::f32, format::b_fs_zyx_fsv16, data_types::f32, format::bfzyx
#define CASE_ACTIVATION_3D_F32_3 \
    {1, 17, 7, 7, 7}, data_types::f32, format::b_fs_zyx_fsv32, data_types::f32, format::bfzyx
#define CASE_ACTIVATION_3D_F32_4 \
    {1, 17, 7, 7, 7}, data_types::f32, format::bs_fs_yx_bsv16_fsv16, data_types::f32, format::bfzyx
#define CASE_ACTIVATION_3D_F32_5 \
    {1, 17, 7, 7, 7}, data_types::f32, format::fs_b_yx_fsv32, data_types::f32, format::bfzyx
...
#define CASE_ACTIVATION_3D_F16_2 \
    {1, 16, 7, 7, 7}, data_types::f16, format::b_fs_zyx_fsv16, data_types::f32, format::bfzyx
#define CASE_ACTIVATION_3D_F16_3 \
    {1, 17, 7, 7, 7}, data_types::f16, format::b_fs_zyx_fsv32, data_types::f32, format::bfzyx
#define CASE_ACTIVATION_3D_F16_4 \
    {1, 17, 7, 7, 7}, data_types::f16, format::bs_fs_yx_bsv16_fsv16, data_types::f32, format::bfzyx
#define CASE_ACTIVATION_3D_F16_5 \
    {1, 17, 7, 7, 7}, data_types::f16, format::fs_b_yx_fsv32, data_types::f32, format::bfzyx
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         activation_eltwise_activation_quantize_u8,
                         ::testing::ValuesIn(std::vector<activation_test_params>{
                             // InputDataType = FP32
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         activation_eltwise_activation_quantize_u8_onendnn,
                         ::testing::ValuesIn(std::vector<activation_test_params>{
                             // InputDataType = FP32
                             activation_test_params{CASE_ACTIVATION_F32_0, 3, 5, "activation_opt"},
                             activation_test_params{CASE_ACTIVATION_F32_1, 3, 5, "activation_opt"},
