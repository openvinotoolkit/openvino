...
namespace {
enum class broadcast_kinds { none, batch, feature };
...
public:
    void execute(gemm_test_params& p, bool is_dynamic, bool is_caching_test = false) {
        ...
        if (!p.kernel_name.empty()) {
            ...
            cfg_fused.set_property(
                ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"gemm_prim", gemm_target_impl}}));
            cfg_not_fused.set_property(
                ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"gemm_prim", gemm_ref_impl}}));
        }

        network::ptr network_not_fused =
            get_network(this->engine, this->topology_non_fused, cfg_not_fused, get_test_stream_ptr(), is_caching_test);
        network::ptr network_fused =
            get_network(this->engine, this->topology_fused, cfg_fused, get_test_stream_ptr(), is_caching_test);
...
#define CASE_GEMM_3IN_FP32_1                                                                                     \
    {{1, 1, 2, 2}, {1, 1, 2, 2}, {1, 1, 2, 2}}, {1, 1, 2, 2}, data_types::f32, data_types::f32, data_types::f32, \
        format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_3IN_FP32_2                                                                            \
    {{1, 1, 63, 63}, {1, 1, 63, 63}, {1, 1, 63, 63}}, {1, 1, 63, 63}, data_types::f32, data_types::f32, \
        data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_3IN_FP32_3                                                                                    \
    {{1, 1, 128, 128}, {1, 1, 128, 128}, {1, 1, 128, 128}}, {1, 1, 128, 128}, data_types::f32, data_types::f32, \
        data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_3IN_FP32_4                                                                                  \
    {{1, 2, 128, 64}, {1, 2, 64, 256}, {1, 2, 128, 256}}, {1, 2, 128, 256}, data_types::f32, data_types::f32, \
        data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_3IN_FP16_1                                                                                     \
    {{1, 1, 2, 2}, {1, 1, 2, 2}, {1, 1, 2, 2}}, {1, 1, 2, 2}, data_types::f16, data_types::f16, data_types::f16, \
        format::bfyx, data_types::f16, format::bfyx
#define CASE_GEMM_3IN_FP16_2                                                                            \
    {{1, 1, 31, 31}, {1, 1, 31, 31}, {1, 1, 31, 31}}, {1, 1, 31, 31}, data_types::f16, data_types::f16, \
        data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_GEMM_3IN_FP16_3                                                                            \
    {{1, 1, 64, 64}, {1, 1, 64, 64}, {1, 1, 64, 64}}, {1, 1, 64, 64}, data_types::f16, data_types::f16, \
        data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_GEMM_3IN_FP16_4                                                                                  \
    {{1, 2, 128, 64}, {1, 2, 64, 256}, {1, 2, 128, 256}}, {1, 2, 128, 256}, data_types::f16, data_types::f16, \
        data_types::f16, format::bfyx, data_types::f16, format::bfyx
#define CASE_GEMM_3IN_S8S8_1                                                                                  \
    {{1, 1, 2, 2}, {1, 1, 2, 2}, {1, 1, 2, 2}}, {1, 1, 2, 2}, data_types::i8, data_types::i8, data_types::i8, \
        format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_3IN_S8S8_2                                                                                \
    {{1, 2, 128, 64}, {1, 2, 64, 256}, {1, 2, 128, 256}}, {1, 2, 128, 256}, data_types::i8, data_types::i8, \
        data_types::i8, format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_3IN_S8S8_3                                                                                        \
    {{1, 1, 16, 8}, {1, 1, 8, 32}, {1, 1, 16, 32}}, {1, 1, 16, 32}, data_types::i8, data_types::i8, data_types::i8, \
        format::bfyx, data_types::f32, format::bfyx

#define CASE_GEMM_2IN_FP32_1                                                                                     \
    {{1, 1, 2, 2}, {1, 1, 2, 2}}, {1, 1, 2, 2}, data_types::f32, data_types::f32, data_types::f32, format::bfyx, \
        data_types::f32, format::bfyx
#define CASE_GEMM_2IN_FP32_2                                                                                           \
    {{1, 1, 63, 63}, {1, 1, 63, 63}}, {1, 1, 63, 63}, data_types::f32, data_types::f32, data_types::f32, format::bfyx, \
        data_types::f32, format::bfyx
#define CASE_GEMM_2IN_FP32_3                                                                                   \
    {{1, 1, 128, 128}, {1, 1, 128, 128}}, {1, 1, 128, 128}, data_types::f32, data_types::f32, data_types::f32, \
        format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_2IN_FP32_4                                                                                 \
    {{1, 2, 128, 64}, {1, 2, 64, 256}}, {1, 2, 128, 256}, data_types::f32, data_types::f32, data_types::f32, \
        format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_2IN_FP16_1                                                                                     \
    {{1, 1, 2, 2}, {1, 1, 2, 2}}, {1, 1, 2, 2}, data_types::f16, data_types::f16, data_types::f16, format::bfyx, \
        data_types::f16, format::bfyx
#define CASE_GEMM_2IN_FP16_2                                                                                           \
    {{1, 1, 31, 31}, {1, 1, 31, 31}}, {1, 1, 31, 31}, data_types::f16, data_types::f16, data_types::f16, format::bfyx, \
        data_types::f16, format::bfyx
#define CASE_GEMM_2IN_FP16_3                                                                                           \
    {{1, 1, 64, 64}, {1, 1, 64, 64}}, {1, 1, 64, 64}, data_types::f16, data_types::f16, data_types::f16, format::bfyx, \
        data_types::f16, format::bfyx
#define CASE_GEMM_2IN_FP16_4                                                                                 \
    {{1, 2, 128, 64}, {1, 2, 64, 256}}, {1, 2, 128, 256}, data_types::f16, data_types::f16, data_types::f16, \
        format::bfyx, data_types::f16, format::bfyx
#define CASE_GEMM_2IN_FP16_5                                                                                     \
    {{2, 3, 2, 2}, {2, 3, 2, 2}}, {2, 3, 2, 2}, data_types::f16, data_types::f16, data_types::f16, format::bfyx, \
        data_types::f16, format::bfyx
#define CASE_GEMM_2IN_FP16_3D_1                                                                            \
    {{16, 8, 64}, {16, 64, 8}, {16, 1, 8}}, {16, 8, 8}, data_types::f16, data_types::f16, data_types::f16, \
        format::bfyx, data_types::f16, format::bfyx
#define CASE_GEMM_2IN_FP16_5D_1                                                                             \
    {{2, 3, 5, 6, 4}, {2, 3, 5, 4, 6}}, {2, 3, 5, 6, 6}, data_types::f16, data_types::f16, data_types::f16, \
        format::bfzyx, data_types::f16, format::bfzyx
#define CASE_GEMM_2IN_FP16_6D_1                                                                                      \
    {{2, 3, 2, 3, 5, 7}, {2, 3, 2, 3, 7, 5}}, {2, 3, 2, 3, 5, 5}, data_types::f16, data_types::f16, data_types::f16, \
        format::bfwzyx, data_types::f16, format::bfwzyx

#define CASE_GEMM_2IN_U8U8_1                                                                                  \
    {{1, 1, 2, 2}, {1, 1, 2, 2}}, {1, 1, 2, 2}, data_types::u8, data_types::u8, data_types::u8, format::bfyx, \
        data_types::f32, format::bfyx
#define CASE_GEMM_2IN_U8U8_2                                                                              \
    {{1, 2, 128, 64}, {1, 2, 64, 256}}, {1, 2, 128, 256}, data_types::u8, data_types::u8, data_types::u8, \
        format::bfyx, data_types::f32, format::bfyx
#define CASE_GEMM_2IN_U8U8_3                                                                                        \
    {{1, 1, 16, 32}, {1, 1, 32, 16}}, {1, 1, 32, 32}, data_types::u8, data_types::u8, data_types::u8, format::bfyx, \
        data_types::f32, format::bfyx

#define CASE_GEMM_2IN_U8S8_1                                                                                  \
    {{1, 1, 2, 4}, {1, 1, 4, 8}}, {1, 1, 2, 8}, data_types::u8, data_types::i8, data_types::u8, format::bfyx, \
        data_types::f32, format::bfyx
#define CASE_GEMM_2IN_S8U8_1                                                                              \
    {{1, 2, 128, 64}, {1, 2, 64, 256}}, {1, 2, 128, 256}, data_types::i8, data_types::u8, data_types::u8, \
        format::bfyx, data_types::f32, format::bfyx

#define CASE_GEMM_ELTWISE_2IN_FP32_1                                                                             \
    {{1, 1, 4, 4}, {1, 1, 4, 4}}, {1, 1, 4, 4}, data_types::f32, data_types::f32, data_types::f32, format::bfyx, \
        data_types::f32, format::bfyx
#define CASE_GEMM_ELTWISE_2IN_FP16_1                                                                                   \
    {{1, 1, 32, 32}, {1, 1, 32, 32}}, {1, 1, 32, 32}, data_types::f16, data_types::f16, data_types::f16, format::bfyx, \
        data_types::f16, format::bfyx
#define CASE_GEMM_ELTWISE_2IN_FP16_2                                                                                 \
    {{1, 1, 1024, 1024}, {1, 1, 1024, 1024}}, {1, 1, 1024, 1024}, data_types::f16, data_types::f16, data_types::f16, \
        format::bfyx, data_types::f16, format::bfyx
#define CASE_GEMM_ELTWISE_2IN_U8S8_1                                                                          \
    {{1, 1, 4, 4}, {1, 1, 4, 4}}, {1, 1, 4, 4}, data_types::u8, data_types::i8, data_types::u8, format::bfyx, \
        data_types::f32, format::bfyx
#define CASE_GEMM_ELTWISE_2IN_S8U8_1                                                                                \
    {{1, 1, 32, 32}, {1, 1, 32, 32}}, {1, 1, 32, 32}, data_types::i8, data_types::u8, data_types::u8, format::bfyx, \
        data_types::f32, format::bfyx
#define CASE_GEMM_ELTWISE_2IN_U8S8_2                                                                              \
    {{1, 1, 1024, 1024}, {1, 1, 1024, 1024}}, {1, 1, 1024, 1024}, data_types::u8, data_types::i8, data_types::u8, \
        format::bfyx, data_types::f32, format::bfyx
...
TEST_P(gemm_2in_quantize_float_in, basic) {
    ...
    cfg_fused.set_property(
        ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"gemm_prim", gemm_impl}}));
...
TEST_P(gemm_2in_add, eltwise_postop_static) {
    ...
    if (engine.get_device_info().supports_immad) {
        ...
        cfg_fused.set_property(
            ov::intel_gpu::force_implementations(ov::intel_gpu::ImplForcingMap{{"gemm_prim", gemmv_impl}}));
    }
    ...
    create_topologies(
        ...
        data("add_data",
             get_mem(add_data_layout, 0.5f)),  // TODO: Meanless setting, iGPU failed in CASE_GEMM_2IN_FP16_5D_1 with
                                               // get_mem(add_data_layout, 0, 10)
        gemm("gemm_prim",
...
INSTANTIATE_TEST_SUITE_P(
    ...
    gemm_2in_add,
    ::testing::ValuesIn(std::vector<gemm_test_params>{
        // gemm_test_params{ CASE_GEMM_2IN_FP16_3, 3, 4, "", broadcast_kinds::none, eltwise_mode::sum },    // TODO:
        // check why failed in eltwise_postop_dynamic
...
TEST_P(gemm_2in_dynamic_add, add) {
    ...
    create_topologies(input_layout("input0", in_layout0),
                      input_layout("input1", in_layout1),
...
INSTANTIATE_TEST_SUITE_P(fusings_gpu,
                         gemm_2in_act_scale_quantize_eltwise_i8,
                         ::testing::ValuesIn(std::vector<gemm_test_params>{
