...
TEST_P(reshape_test_two_inputs, shape_infer) {
    ...
    auto reshape_prim = std::make_shared<reshape>("output",
                                                  input_info("input"),
                                                  input_info("pattern"),
                                                  p.special_zero,
                                                  p.output_partial_shape);
...
TEST_P(reshape_test_single_input, shape_infer) {
    ...
    program_wrapper::add_connection(prog, input_node, reshape_node);
    auto res =
        reshape_inst::calc_output_layouts<ov::PartialShape>(reshape_node, *reshape_node.get_kernel_impl_params());
...
TEST_P(squeeze_test, shape_infer) {
    ...
    auto squeeze_prim = std::make_shared<reshape>("output",
                                                  input_info("input"),
                                                  input_info("pattern"),
                                                  false,
                                                  p.output_partial_shape,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<squeeze_unsqueeze_test_params>{
        ...
        {
            layout{ov::PartialShape{1, 1, 10, 20, 30},
                   data_types::f32,
                   format::bfzyx,
                   get_pad(format::bfyx, {2, 3}, true)},
            layout{ov::PartialShape{1}, data_types::i64, format::bfyx},
            {1},
            ov::PartialShape::dynamic(4),
        ...
        {
            layout{ov::PartialShape{1, 1, 10, 1, 30},
                   data_types::f32,
                   format::bfzyx,
                   get_pad(format::bfyx, {2, 3}, true)},
            layout{ov::PartialShape{1}, data_types::i64, format::bfyx},
...
TEST_P(unsqueeze_test, shape_infer) {
    ...
    auto input_prim = std::make_shared<input_layout>("input", p.in_layout);
    auto indices_prim = std::make_shared<input_layout>("pattern", p.indices_layout);
    auto unsqueeze_prim = std::make_shared<reshape>("output",
                                                    input_info("input"),
                                                    input_info("pattern"),
                                                    false,
                                                    p.output_partial_shape,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<squeeze_unsqueeze_test_params>{
        ...
        {layout{ov::PartialShape{1, 10, 20, 30}, data_types::f32, format::bfyx, get_pad(format::bfyx, {2, 3}, true)},
         layout{ov::PartialShape{2}, data_types::i64, format::bfyx},
         {1, 4},
         ov::PartialShape::dynamic(6),
         layout{ov::PartialShape{1, 1, 10, 20, 1, 30},
                data_types::f32,
                format::bfwzyx,
                get_pad(format::bfyx, {2, 3}, true)}}}));
}  // namespace shape_infer_tests
