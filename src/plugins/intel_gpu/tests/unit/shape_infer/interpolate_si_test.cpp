...
struct InterpolateAttrs {
    ...
    InterpolateOp::CoordinateTransformMode coordinate_transformation_mode =
        InterpolateOp::CoordinateTransformMode::HALF_PIXEL;
...
TEST_P(interpolate_test_three_inputs, shape_infer) {
    ...
    auto resample_prim = std::make_shared<resample>("output",
                                                    input_info("input"),
                                                    input_info("sizes"),
                                                    input_info("scales"),
                                                    p.axes,
                                                    ...
                                                    p.attrs.cube_coeff,
                                                    p.attrs.mode,
                                                    p.attrs.shape_calc_mode,
                                                    p.attrs.coordinate_transformation_mode,
                                                    p.attrs.nearest_mode);
...
INSTANTIATE_TEST_SUITE_P(smoke,
                         ...
                         testing::ValuesIn(std::vector<interpolate_test_params>{
                             {layout{ov::PartialShape{1, 2, 48, 80}, data_types::f32, format::bfyx},
                              ...
                              {1.0f, 1.0f, 0.5f, 2.0f},
                              {0, 1, 2, 3},
                              InterpolateAttrs{InterpolateOp::ShapeCalcMode::SCALES},
