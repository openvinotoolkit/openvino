...
TEST_P(roi_align_test, shape_infer) {
    ...
    auto input1_layout_prim = std::make_shared<input_layout>(
        "input1",
        layout{ov::PartialShape{p.num_roi, 4}, p.input_layout.data_type, p.input_layout.format});
    auto input2_layout_prim = std::make_shared<input_layout>(
        "input2",
        layout{ov::PartialShape{p.num_roi}, p.input_layout.data_type, p.input_layout.format});
    auto inputs = std::vector<input_info>{input_info("input0"), input_info("input1"), input_info("input2")};
    auto roi_align_prim = std::make_shared<roi_align>("output",
                                                      inputs,
                                                      p.pooled_h,
                                                      p.pooled_w,
                                                      2,
                                                      ...
                                                      roi_align::AlignedMode::half_pixel_for_nn);
    ...
    auto res =
        roi_align_inst::calc_output_layouts<ov::PartialShape>(roi_align_node, *roi_align_node.get_kernel_impl_params());
...
INSTANTIATE_TEST_SUITE_P(smoke,
                         ...
                         testing::ValuesIn(std::vector<roi_align_test_params>{
                             {layout{ov::PartialShape{1, 2, 3, 4}, data_types::f16, format::bfyx},
                              ...
                              3,
                              3,
                              layout{ov::PartialShape{-1, 2, 3, 3}, data_types::f16, format::bfyx}},
                             {layout{ov::PartialShape{1, 2, 3, 4}, data_types::f32, format::bfyx},
                              10,
                              2,
                              2,
                              layout{ov::PartialShape{10, 2, 2, 2}, data_types::f32, format::bfyx}},
                             {layout{ov::PartialShape::dynamic(4), data_types::f16, format::bfyx},
                              10,
                              7,
                              7,
                              layout{ov::PartialShape{10, -1, 7, 7}, data_types::f16, format::bfyx}},
                             {layout{ov::PartialShape::dynamic(4), data_types::f32, format::bfyx},
                              -1,
                              2,
                              2,
                              layout{ov::PartialShape{-1, -1, 2, 2}, data_types::f32, format::bfyx}}}));
