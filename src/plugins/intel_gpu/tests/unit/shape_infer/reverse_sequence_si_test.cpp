...
TEST_P(reverse_sequence_test, shape_infer) {
    ...
    auto reverse_sequence_prim = std::make_shared<reverse_sequence>("output",
                                                                    input_info("input0"),
                                                                    input_info("input1"),
                                                                    p.seq_axis,
                                                                    p.batch_axis);
    ...
    auto res =
        reverse_sequence_inst::calc_output_layouts<ov::PartialShape>(reverse_sequence_node,
                                                                     *reverse_sequence_node.get_kernel_impl_params());
