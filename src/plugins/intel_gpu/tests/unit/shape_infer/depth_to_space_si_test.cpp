...
TEST_P(depth_to_space_test, shape_infer) {
    ...
    auto depth_to_space_prim = std::make_shared<depth_to_space>("depth_to_space",
                                                                input_info("input"),
                                                                p.block_size,
    ...
    auto res =
        depth_to_space_inst::calc_output_layouts<ov::PartialShape>(depth_to_space_node,
                                                                   *depth_to_space_node.get_kernel_impl_params());
