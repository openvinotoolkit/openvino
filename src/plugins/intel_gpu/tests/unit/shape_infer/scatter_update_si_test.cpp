...
TEST_P(scatter_update_test, shape_infer) {
    ...
    auto scatter_update_prim = std::make_shared<scatter_update>("output",
                                                                input_info("data"),
                                                                input_info("indices"),
                                                                input_info("updates"),
                                                                p.axis);
    ...
    auto res =
        scatter_update_inst::calc_output_layouts<ov::PartialShape>(scatter_update_node,
                                                                   *scatter_update_node.get_kernel_impl_params());
