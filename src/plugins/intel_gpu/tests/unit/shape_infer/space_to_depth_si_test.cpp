...
TEST_P(space_to_depth_si_test, shape_infer) {
    ...
    auto space_to_depth_prim = std::make_shared<space_to_depth>("space_to_depth",
                                                                input_info("input"),
    ...
    auto res =
        space_to_depth_inst::calc_output_layouts<ov::PartialShape>(space_to_depth_node,
                                                                   *space_to_depth_node.get_kernel_impl_params());
...
INSTANTIATE_TEST_SUITE_P(smoke,
                         space_to_depth_si_test,
                         testing::ValuesIn(std::vector<space_to_depth_test_params>{
                             {layout{ov::PartialShape{4, 2, 4, 8}, data_types::f16, format::bfyx},
                              4,
                              layout{ov::PartialShape{4, 32, 1, 2}, data_types::f16, format::bfyx}},
