...
TEST_P(one_hot_test, shape_infer) {
    ...
    auto res =
        one_hot_inst::calc_output_layouts<ov::PartialShape>(one_hot_node, *one_hot_node.get_kernel_impl_params());
...
INSTANTIATE_TEST_SUITE_P(smoke,
                         ...
                         testing::ValuesIn(std::vector<one_hot_test_params>{
                             {layout{ov::PartialShape{1, 2, 3}, data_types::f32, format::bfyx},
                              3,
                              5,
                              layout{ov::PartialShape{1, 2, 3, 5}, data_types::f32, format::bfyx}},
