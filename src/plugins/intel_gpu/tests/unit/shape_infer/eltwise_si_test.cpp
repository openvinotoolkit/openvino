...
TEST_P(eltwise_si_test, shape_infer) {
    ...
    auto eltwise_prim = std::make_shared<eltwise>("output",
                                                  input_info("input1"),
                                                  input_info("input2"),
                                                  p.stride,
                                                  p.mode,
                                                  p.auto_broadcast_spec);
    ...
    auto res =
        eltwise_inst::calc_output_layouts<ov::PartialShape>(eltwise_node, *eltwise_node.get_kernel_impl_params());
...
INSTANTIATE_TEST_SUITE_P(smoke,
                         ...
                         testing::ValuesIn(std::vector<eltwise_test_params>{
                             {{{2, 1, 5}, data_types::f32, format::bfyx},
                              {{2, 1, 5}, data_types::f32, format::bfyx},
                              eltwise_mode::sum,
                             ...
                             {{{2, 1, 5}, data_types::f32, format::bfyx},
                              ...
                              {{2, 4, 5}, data_types::f32, format::bfyx},
                              {}},
                             {{{1, 5, 1}, data_types::f32, format::bfyx},
                              {{5, 2, 1, 3}, data_types::f32, format::bfyx},
                              eltwise_mode::sum,
                              {AutoBroadcastType::NUMPY},
                              {{5, 2, 5, 3}, data_types::f32, format::bfyx},
                              {}},
                             {{{2, 3, 4, 5}, data_types::f32, format::bfyx},
                              {{4, 5}, data_types::f32, format::bfyx},
                              eltwise_mode::sum,
                              {AutoBroadcastType::PDPD, -1},
                              {{2, 3, 4, 5}, data_types::f32, format::bfyx},
                              {}},
                             {{{2, 3, 4, 5}, data_types::f32, format::bfyx},
                              {{2, 3}, data_types::f32, format::bfyx},
                              eltwise_mode::sum,
                              {AutoBroadcastType::PDPD, 0},
                              {{2, 3, 4, 5}, data_types::f32, format::bfyx},
                              {}},
                             {{{2, 3, 4, 5}, data_types::f32, format::bfyx},
                             ...
                             {{PartialShape::dynamic(3), data_types::f32, format::bfyx},
                              {{1, 4, 1}, data_types::f32, format::bfyx},
                              eltwise_mode::sum,
                              {AutoBroadcastType::PDPD},
                              {{-1, 4, -1}, data_types::f32, format::bfyx},
                              {}},
                             {{{-1, -1, 1024, 512}, data_types::f32, format::bfyx},
                              {{1, 1, 512}, data_types::f32, format::bfyx},
                              eltwise_mode::sum,
                              {AutoBroadcastType::NUMPY},
                              {{-1, -1, 1024, 512}, data_types::f32, format::bfyx},
                              {}},
                             {{{-1, -1, 768}, data_types::f32, format::bfyx},
                              {{768}, data_types::f32, format::bfyx},
                              eltwise_mode::sum,
                              {AutoBroadcastType::NUMPY},
                              {{-1, -1, 768}, data_types::f32, format::bfyx},
                              {}},
                             ...
                             {{{2, 3, 4, 5}, data_types::f32, format::bfyx},
                              ...
                              eltwise_mode::eq,
                              {AutoBroadcastType::NUMPY},
                              {{2, 3, 4, 5}, data_types::i8, format::bfyx},
                              {}},
                             {{{2, 3, 4, 5}, data_types::f16, format::bfyx},
                              {{5}, data_types::f16, format::bfyx},
                              eltwise_mode::ne,
                              {AutoBroadcastType::NUMPY},
                              {{2, 3, 4, 5}, data_types::i8, format::bfyx},
                              {}},
                             {{{2, 3, 4, 5}, data_types::f16, format::bfyx},
                              ...
                              {{2, 3, 4, 5}, data_types::i8, format::bfyx},
                              {}},
                             {{{2, 3, 4, 5}, data_types::i32, format::bfyx},
                              {{5}, data_types::i32, format::bfyx},
                              eltwise_mode::le,
                              {AutoBroadcastType::NUMPY},
                              {{2, 3, 4, 5}, data_types::i8, format::bfyx},
                              {}},
                             {{{2, 3, 4, 5}, data_types::i64, format::bfyx},
                              {{5}, data_types::i64, format::bfyx},
                              eltwise_mode::gt,
                              {AutoBroadcastType::NUMPY},
                              {{2, 3, 4, 5}, data_types::i8, format::bfyx},
                              {}},
                             {{{2, 3, 4, 5}, data_types::u8, format::bfyx},
                             ...
                             {{{2, 3, 4, 5}, data_types::f32, format::bfyx},
                              ...
                              {}},
                             // test stride
                             {{{5, 2, 1, 20}, data_types::f32, format::bfyx},
                              {{1, 40, 1}, data_types::f32, format::bfyx},
                              eltwise_mode::sum,
                              {AutoBroadcastType::NUMPY},
                              {{5, 2, 1, 5}, data_types::f32, format::bfyx},
                              {{1, 3, 4, 2}}},
                             {{{2, 3, 40, 50}, data_types::f32, format::bfyx},
