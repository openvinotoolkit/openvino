...
TEST_P(reorg_yolo_test, shape_infer) {
    ...
    auto reorg_yolo_prim = std::make_shared<reorg_yolo>("reorg_yolo", input_info("input"), p.stride);
    ...
    auto res = reorg_yolo_inst::calc_output_layouts<ov::PartialShape>(reorg_yolo_node,
                                                                      *reorg_yolo_node.get_kernel_impl_params());
