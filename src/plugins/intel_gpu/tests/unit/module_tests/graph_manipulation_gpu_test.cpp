...
TEST(add_intermediate_gpu, test1) {
    ...
    topology.add(data("weights2", weights2));
    topology.add(
        cldnn::convolution("conv1a", input_info("input"), "weights", "", 1, {1, 1}, {1, 1}, {0, 0}, {0, 0}, false));
    topology.add(
        cldnn::convolution("conv1b", input_info("input"), "weights", "", 1, {1, 1}, {1, 1}, {0, 0}, {0, 0}, false));
    topology.add(
        cldnn::convolution("conv2a", input_info("conv1a"), "weights2", "", 1, {1, 1}, {1, 1}, {0, 0}, {0, 0}, false));
    ...
    std::vector<float> expected_output_vec = {32.2f, 60.2f, 66.6f, 126.6f, 514.22f, 532.7f, 1075.26f, 1113.9f};
...
TEST(add_intermediate_gpu, test2) {
    ...
    topology.add(
        cldnn::convolution("conv2a", input_info("input"), "weights2", "", 1, {1, 1}, {1, 1}, {0, 0}, {0, 0}, false));
    topology.add(
        cldnn::convolution("conv2b", input_info("input"), "weights2", "", 1, {1, 1}, {1, 1}, {0, 0}, {0, 0}, false));

    auto new_conv = std::make_shared<convolution>("conv1a",
                                                  input_info("input"),
                                                  "weights",
                                                  "",
                                                  1,
    ...
    std::vector<float> expected_output_vec = {514.22f, 532.7f, 1075.26f, 1113.9f};
