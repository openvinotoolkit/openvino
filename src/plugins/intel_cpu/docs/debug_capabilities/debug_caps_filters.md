...
IR format filter is used to specify output IR formats, e.g. for [serialization](ir_serialization.md).
```sh
...
e.g. for [disabling](feature_disabling.md#graph-transformations) or [serialization](ir_serialization.md).
```sh
