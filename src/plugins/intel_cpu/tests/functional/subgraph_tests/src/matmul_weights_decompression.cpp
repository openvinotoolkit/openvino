...
protected:
    std::shared_ptr<ov::Node> initDecompressionWeights(const ov::Shape& weights_shape,
        ...
        auto weights = ov::test::utils::make_constant<int8_t>(weights_precision, transformed_weights_shape, {}, true, up_to);
        ...
        if (decompression_subtract_type != DecompressionSubtractType::empty) {
            ...
            auto shift_const = ov::test::utils::make_constant<uint8_t>(weights_precision, subtract_shape, {}, true, up_to);
        ...
        std::shared_ptr<ov::Node> scale_const = ov::test::utils::make_constant<float>(decompression_precision, scaleshift_const_shape, {}, true);
        if (reshape_on_decompression_constant) {
