...
class ReshapeChain : public SubgraphBaseTest {
    void SetUp() override {
        ...
        auto reshapeParam1 = ov::test::utils::make_constant<int>(secondInPrc, {3}, {0, 0, -1});
        auto reshape1 = std::make_shared<ov::op::v1::Reshape>(inputParams.front(), reshapeParam1, true);
        auto reshapeParam2 = ov::test::utils::make_constant<int>(secondInPrc, {2}, {0, -1});
        auto reshape2 = std::make_shared<ov::op::v1::Reshape>(reshape1, reshapeParam2, true);
        auto reshapeParam3 = ov::test::utils::make_constant<int>(secondInPrc, {1}, {-1});
        auto reshape3 = std::make_shared<ov::op::v1::Reshape>(reshape2, reshapeParam3, true);
        auto reshapeParam4 = ov::test::utils::make_constant<int>(secondInPrc, {2}, {4, -1});
