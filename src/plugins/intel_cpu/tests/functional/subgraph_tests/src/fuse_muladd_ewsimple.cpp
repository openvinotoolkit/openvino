...
void FuseMulAddAndEwSimpleTest1::CreateGraph() {
    ...
    mulSecondInput[0] = 1;
    auto params = ov::test::utils::builder::make_params(ngPrc, {inputShape, inputShape, mulSecondInput});
...
void FuseMulAddAndEwSimpleTest2::CreateGraph() {
    auto ngPrc = FuncTestUtils::PrecisionUtils::convertIE2nGraphPrc(inPrec);
    auto params = ov::test::utils::builder::make_params(ngPrc, {inputShape, inputShape, inputShape});
...
void FuseMulAddAndEwSimpleTest3::CreateGraph() {
    auto ngPrc = FuncTestUtils::PrecisionUtils::convertIE2nGraphPrc(inPrec);
    auto params = ov::test::utils::builder::make_params(ngPrc, {inputShape, inputShape, inputShape, inputShape, inputShape});
