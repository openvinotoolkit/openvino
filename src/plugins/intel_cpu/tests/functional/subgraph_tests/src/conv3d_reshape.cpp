    ...
    void SetUp() override {
        ...
        switch (convType) {
            case nodeType::convolution : {
                conv = ov::builder::makeConvolution(paramOuts[0], element::f32, kernelSize, strides,
                                                    padBegin, padEnd, dilation, paddingType, numOutChannels);
                break;
            }
            case nodeType::groupConvolution : {
                conv = ov::builder::makeGroupConvolution(paramOuts[0], element::f32, kernelSize, strides, padBegin,
