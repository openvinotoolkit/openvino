...
public:
    void SetUp() override {
        ...
        auto end = ov::test::utils::make_constant(element::i64, {1}, std::vector<int64_t>{2147483647});
        auto stride  = ov::test::utils::make_constant(element::i64, {1}, std::vector<int64_t>{1});
        auto indices = ov::test::utils::make_constant(element::i64, {1}, std::vector<int64_t>{1});
        auto axes = ov::test::utils::make_constant(element::i64, {1}, std::vector<int64_t>{0});
