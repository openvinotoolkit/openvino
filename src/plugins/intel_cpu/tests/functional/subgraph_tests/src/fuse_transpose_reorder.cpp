...
void FuseTransposeAndReorderTest::create_model() {
    ...
    auto constOrder = ov::test::utils::make_constant(ov::element::i64, {input_shape.size()}, order);
...
void FuseTransposeAndReorderTest1::create_model() {
    ...
    auto constOrder1 = ov::test::utils::make_constant(ov::element::i64, {input_shape.size()}, order);
    ...
    auto constOrder2 = ov::test::utils::make_constant(ov::element::i64, {input_shape.size()}, order);
    ...
    auto constOrder3 = ov::test::utils::make_constant(ov::element::i64, {input_shape.size()}, order);
    ...
    auto shape = ov::test::utils::make_constant(ov::element::i64, {input_shape.size()}, transpose3->get_output_shape(0));
...
void FuseTransposeAndReorderTest3::create_model() {
    ...
    auto constOrder = ov::test::utils::make_constant(ov::element::i64, {order.size()}, order);
