...
protected:
    void SetUp() override {
        ...
        const auto outputNodes = ov::helpers::convert2OutputVector(ov::helpers::castOps2Nodes<op::Parameter>(inputParams));
        const auto matMul = ov::builder::makeMatMul(outputNodes[0], outputNodes[1], false, false);
