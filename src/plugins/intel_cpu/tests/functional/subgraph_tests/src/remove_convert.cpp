...
public:
    ...
    void SetUp() override {
        ...
        auto begin = ov::test::utils::make_constant(element::i64, ov::Shape{4}, std::vector<int64_t>{0, 0, 0, 0});
        auto end = ov::test::utils::make_constant(element::i64, ov::Shape{4}, std::vector<int64_t>{0, 0, 16, 0});
        auto stride = ov::test::utils::make_constant(element::i64, ov::Shape{4}, std::vector<int64_t>{1, 1, 1, 1});
...
public:
    ...
    void SetUp() override {
        ...
        // zero output
        const auto split_axis = ov::test::utils::make_constant(element::i64, ov::Shape{}, std::vector<int64_t>{1});
        const auto split_lengths =
            ov::test::utils::make_constant(element::i64, ov::Shape{2}, std::vector<int64_t>{-1, 1});
