...
/*
  ...
  This test is needed to cover logic that allows to avoid computational error for subgraph: "[I32] -> Convert -> [F32] -> Range" due to precision lowering for floating point path inside "EnforceInferencePrecision" pass". Incorrect subgraph is generated by ONNX FE + ticket number.
*/
