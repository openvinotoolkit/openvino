...
protected:
    void SetUp() override {
        ...
        auto weights = ov::test::utils::builder::makeConstant(type, Shape{32, 32, 1, 1}, std::vector<float>{}, true);
        ...
        auto mul = std::make_shared<opset8::Multiply>(reshape_after, ov::test::utils::builder::makeConstant(type, Shape{32, 1, 1}, std::vector<float>{}, true));
        auto add = std::make_shared<opset8::Add>(mul, ov::test::utils::builder::makeConstant(type, Shape{32, 1, 1}, std::vector<float>{}, true));
