...
protected:
    void SetUp() override {
        ...
        auto constant =
            ov::test::utils::deprecated::make_constant(inType, std::vector<size_t>{1}, std::vector<float>{0.5});
...
protected:
    void SetUp() override {
        ...
        // Body
        auto constant =
            ov::test::utils::deprecated::make_constant(inType, std::vector<size_t>{1}, std::vector<float>{10});
