...
using RNNSequenceCpuSpecificParams =
...
protected:
    void SetUp() override {
        ...
        std::vector<ov::Shape> WRB = {{numDirections, hiddenSize, inputSize},
                                      {numDirections, hiddenSize, hiddenSize},
                                      {numDirections, hiddenSize},
                                      {batchSize}};
        auto rnn_sequence =
...
const std::vector<std::vector<InputShape>> staticShapes = {{{{}, {{10, 2, 10}}},  // Static shapes
                                                            {{}, {{10, 1, 1}}},
                                                            {{}, {{10}}}},
