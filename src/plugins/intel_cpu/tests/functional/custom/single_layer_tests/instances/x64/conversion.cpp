...
std::vector<CPUSpecificParams> memForm4D_dynamic = {CPUSpecificParams({nChw8c}, {nChw8c}, {}, "ref"),
                                                    CPUSpecificParams({nChw16c}, {nChw16c}, {}, "ref")};

INSTANTIATE_TEST_SUITE_P(smoke_ConvertCPULayerTest_blocked_Dynamic,
                         ConvertCPULayerTest,
...
std::vector<CPUSpecificParams> memForm4D_static_blocked = {CPUSpecificParams({nChw16c}, {nChw16c}, {}, {})};

const std::vector<ov::element::Type> precisions_floating_point = {ov::element::f32, ov::element::bf16};

INSTANTIATE_TEST_SUITE_P(smoke_ConvertCPULayerTest_Blocked,
                         ConvertCPULayerTest,
                         ::testing::Combine(::testing::ValuesIn(inShapes_4D_blocked),
                                            ::testing::ValuesIn(precisions()),
                                            ::testing::ValuesIn(precisions()),
...
INSTANTIATE_TEST_SUITE_P(smoke_ConvertCPULayerTest_BOOL_Dynamic,
                         ConvertToBooleanCPULayerTest,
                         ::testing::Combine(::testing::ValuesIn(inShapes_4D_dynamic()),
                                            ::testing::ValuesIn(precisions_floating_point),
                                            ::testing::Values(ov::element::boolean),
