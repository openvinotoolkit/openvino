...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Bitwise,
                         EltwiseLayerCPUTest,
                         params_4D_bitwise,
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Bitwise_i32,
                         EltwiseLayerCPUTest,
                         params_4D_bitwise_i32,
                         EltwiseLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Bitwise_NOT,
                         EltwiseLayerCPUTest,
                         params_4D_bitwise_NOT,
                         EltwiseLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Bitwise_NOT_i32,
                         EltwiseLayerCPUTest,
                         params_4D_bitwise_NOT_i32,
                         EltwiseLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_int_jit,
                         EltwiseLayerCPUTest,
                         params_4D_int_jit,
                         EltwiseLayerCPUTest::getTestCaseName);
