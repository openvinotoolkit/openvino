...
namespace test {
namespace Transpose {
std::vector<ov::AnyMap> additional_config = {{{ov::hint::inference_precision.name(), ov::element::f32.to_string()}},
...
const std::vector<ov::element::Type> netPrecisions = {ov::element::i8, ov::element::f32};
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes4DC16_Transpose,
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes4DC32_Transpose,
                         TransposeLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes4DC16_PermutePerChannels,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes4DC16()),
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes4DC32_PermutePerChannels,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes4DC32()),
                                            ::testing::ValuesIn(inputOrderPerChannels4D),
                                            ::testing::ValuesIn(netPrecisionsPerChannels()),
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamicShapes4D_PermutePerChannels,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes4D()),
                                            ::testing::ValuesIn(inputOrderPerChannels4D),
                                            ::testing::ValuesIn(netPrecisionsPerChannels()),
