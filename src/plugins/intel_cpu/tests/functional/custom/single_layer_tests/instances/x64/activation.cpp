...
const std::map<ActivationTypes, std::vector<std::vector<float>>>& activationTypesBlocked() {
    static const std::map<ActivationTypes, std::vector<std::vector<float>>> activationTypesBlocked{{Mish, {{}}},
                                                                                                   {SoftSign, {{}}}};
...
const auto blockedCases3D =
    ::testing::Combine(::testing::ValuesIn(static_shapes_to_test_representation(basic3D())),
...
INSTANTIATE_TEST_SUITE_P(smoke_Activation3D_Eltwise_CPU_Blocked,
...
INSTANTIATE_TEST_SUITE_P(smoke_Activation4D_Eltwise_CPU_Blocked,
                         ActivationLayerCPUTest,
                         basicCases4D,
                         ActivationLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Activation5D_Eltwise_CPU_Blocked,
                         ActivationLayerCPUTest,
                         basicCases5D,
                         ActivationLayerCPUTest::getTestCaseName);
