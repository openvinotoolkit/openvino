...
const std::vector<ov::element::Type> netPrecisions = {ov::element::i8, ov::element::bf16, ov::element::f32};
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes4DC16_TransposeBlocked,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes4DC16()),
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes4DC32_TransposeBlocked,
                         TransposeLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamicShapes4D_Transpose,
                         TransposeLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes5DC16_Transpose,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(staticInputShapes5DC16),
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes5DC32_Transpose,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(staticInputShapes5DC32),
                                            ::testing::ValuesIn(inputOrder5D),
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(ov::test::utils::DEVICE_CPU),
                                            ::testing::Values(additional_config),
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamicShapes5D_Transpose,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes5D),
                                            ::testing::ValuesIn(inputOrder5D),
                                            ::testing::Values(ov::element::bf16),
                                            ::testing::Values(ov::test::utils::DEVICE_CPU),
                                            ::testing::Values(additional_config),
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes5DC16_PermutePerChannels,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(staticInputShapes5DC16),
...
INSTANTIATE_TEST_SUITE_P(smoke_staticShapes5DC32_PermutePerChannels,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(staticInputShapes5DC32),
                                            ::testing::ValuesIn(inputOrderPerChannels5D),
                                            ::testing::ValuesIn(netPrecisionsPerChannels()),
...
INSTANTIATE_TEST_SUITE_P(smoke_dynamicShapes5D_PermutePerChannels,
                         TransposeLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(dynamicInputShapes5D),
                                            ::testing::ValuesIn(inputOrderPerChannels5D),
                                            ::testing::ValuesIn(netPrecisionsPerChannels()),
