...
std::vector<fusingSpecificParams> fusingParamsSet3D_MLAS_smoke{emptyFusingSpec, fusingBias, fusingMultiplyPerChannel};
...
INSTANTIATE_TEST_SUITE_P(smoke_FC_3D_MLAS,
                         MatMulLayerCPUTest,
                         testParams3D_MLAS_smoke,
                         MatMulLayerCPUTest::getTestCaseName);

std::vector<fusingSpecificParams> fusingParamsSet2D_MLAS_nightly{fusingScaleShift};
...
INSTANTIATE_TEST_SUITE_P(nightly_FC_2D_MLAS,
                         MatMulLayerCPUTest,
                         testParams2D_MLAS_nightly,
                         MatMulLayerCPUTest::getTestCaseName);

std::vector<fusingSpecificParams> fusingParamsSet2D_MLAS_smoke{emptyFusingSpec, fusingBias, fusingMultiplyPerChannel};
...
const auto testParams2D_MLAS_smoke =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(IS2D_smoke()),
                       ...
                       ::testing::ValuesIn(filterSpecificParams_MLAS()));
INSTANTIATE_TEST_SUITE_P(smoke_FC_2D_MLAS,
                         MatMulLayerCPUTest,
                         testParams2D_MLAS_smoke,
                         MatMulLayerCPUTest::getTestCaseName);
#endif
}  // namespace
}  // namespace MatMul
