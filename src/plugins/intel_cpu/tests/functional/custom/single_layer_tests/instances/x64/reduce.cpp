...
const auto params_NativeInt32 = testing::Combine(testing::Combine(testing::ValuesIn(axes()),
                                                                  testing::Values(ov::test::utils::OpType::VECTOR),
                                                                  testing::ValuesIn(keepDims()),
...
const auto params_NativeInt32Gather =
    testing::Combine(testing::Combine(testing::ValuesIn(axesGather),
                                      testing::Values(ov::test::utils::OpType::VECTOR),
                                      testing::ValuesIn(keepDims()),
                                      testing::ValuesIn(reductionTypesNativeInt32()),
                                      testing::Values(ElementType::i32),
...
const auto params_MultiAxis_3D_fusing =
    testing::Combine(testing::Combine(testing::Values(axes()[2]),
                                      testing::Values(ov::test::utils::OpType::VECTOR),
                                      testing::Values(true),
...
const auto params_DimZero_Arithmetic_fusing =
    testing::Combine(testing::Combine(testing::ValuesIn(axesZeroDimFusing),
                                      testing::Values(ov::test::utils::OpType::VECTOR),
                                      testing::Values(true),
...
const auto params_DimZero_Compare_fusing =
    testing::Combine(testing::Combine(testing::ValuesIn(axesZeroDimFusing),
                                      testing::Values(ov::test::utils::OpType::VECTOR),
                                      testing::Values(true),
