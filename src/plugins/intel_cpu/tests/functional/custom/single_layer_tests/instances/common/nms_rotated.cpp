...
static const std::vector<std::vector<InputShape>> input_shapes = {
    ...
    {{{}, {{5, 17, 5}}}, {{}, {{5, 7, 17}}}},
    {{{}, {{9, 75, 5}}}, {{}, {{9, 55, 75}}}},
    {{{-1, -1, 5}, {{5, 20, 5}, {3, 50, 5}, {2, 99, 5}}}, {{-1, -1, -1}, {{5, 30, 20}, {3, 100, 50}, {2, 133, 99}}}}};

static const std::vector<std::vector<InputShape>> input_shapes_nightly = {
    {{{}, {{3, 11, 5}}}, {{}, {{3, 15, 11}}}},
    {{{}, {{15, 29, 5}}}, {{}, {{15, 31, 29}}}},
    {{{}, {{21, 64, 5}}}, {{}, {{21, 32, 64}}}},
    {{{-1, -1, 5}, {{7, 35, 5}, {7, 35, 5}, {7, 35, 5}}}, {{-1, -1, -1}, {{7, 30, 35}, {7, 100, 35}, {7, 133, 35}}}}};

const ov::AnyMap empty_plugin_config{};

INSTANTIATE_TEST_SUITE_P(smoke_,
                         NmsRotatedOpTest,
                         ::testing::Combine(::testing::ValuesIn(input_shapes),    // Input shapes
...
INSTANTIATE_TEST_SUITE_P(nightly_,
                         NmsRotatedOpTest,
                         ::testing::Combine(::testing::ValuesIn(input_shapes_nightly),
