...
INSTANTIATE_TEST_SUITE_P(
    smoke_arm_Deconv_2D_Planar_FP16,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_arm_Deconv_2D_Planar_FP32,
    DeconvolutionLayerCPUTest,
    ::testing::Combine(convParams_ExplicitPadding_Planar_2D,
                       ::testing::ValuesIn(Planar_2D_inputs_smoke),
...
INSTANTIATE_TEST_SUITE_P(
    nightly_arm_Deconv_2D_Planar_FP16,
    DeconvolutionLayerCPUTest,
    ::testing::Combine(convParams_ExplicitPadding_Planar_2D,
...
INSTANTIATE_TEST_SUITE_P(
    nightly_arm_Deconv_2D_Planar_FP32,
    DeconvolutionLayerCPUTest,
    ::testing::Combine(convParams_ExplicitPadding_Planar_2D,
                       ::testing::ValuesIn(Planar_2D_inputs_nightly),
                       ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_arm_Deconv_2D_AutoPadding_FP16,
    DeconvolutionLayerCPUTest,
    ::testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(
    smoke_arm_Deconv_2D_AutoPadding_FP32,
    DeconvolutionLayerCPUTest,
    ::testing::Combine(
        deconvParams_AutoPadding_2D,
        ::testing::ValuesIn(inputs_2D_AutoPadding),
