...
const std::vector<ElementType>& netType() {
    static const std::vector<ElementType> netType = {ElementType::bf16};
    return netType;
}
...
const std::vector<InputShape>& inShapes_4D_dyn_param_fusing() {
    static const std::vector<InputShape> inShapes_4D_dyn_param_fusing = {
        ...
        {// dynamic
         {-1, 7, -1, -1},
         // target
         {{1, 7, 5, 1}, {3, 7, 1, 10}, {1, 7, 5, 1}, {3, 7, 4, 11}}}};
...
const std::vector<fusingSpecificParams> fusingParamsSet_x64{// eltwise
                                                            fusingSigmoid,
                                                            fusingPRelu1D,
                                                            // depthwise
...
const auto params_4D_Blocked_Blocked =
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_MemOrder_Blocked_Blocked,
                         EltwiseLayerCPUTest,
                         params_4D_Blocked_Blocked,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_4D_fusing = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(static_shapes_to_test_representation(inShapes_4D_fusing())),
                       ::testing::ValuesIn(eltwiseOpTypesBinInp()),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Fusing,
                         EltwiseLayerCPUTest,
                         params_4D_fusing,
                         EltwiseLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Fusing_Blocked_Blocked,
                         EltwiseLayerCPUTest,
                         params_4D_fusing_blocked_blocked,
                         EltwiseLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Blocked_Blocked_Fusing,
                         EltwiseLayerCPUTest,
                         params_4D_blocked_blocked_fusing,
                         EltwiseLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_emptyCPUSpec_x64,
                         EltwiseLayerCPUTest,
                         params_4D_emptyCPUSpec,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_5D_Blocked_Blocked =
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_MemOrder_Blocked_Blocked,
                         EltwiseLayerCPUTest,
                         params_5D_Blocked_Blocked,
                         EltwiseLayerCPUTest::getTestCaseName);

const std::vector<fusingSpecificParams> fusingParamsSet_I32{fusingMultiplyAddPerChannel};

const auto params_5D_emptyCPUSpec_I32 =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(static_shapes_to_test_representation(inShapes_5D())),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_I32,
                         EltwiseLayerCPUTest,
                         params_5D_emptyCPUSpec_I32,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_4D_Blocked_Planar = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(static_shapes_to_test_representation(inShapes_4D_Blocked_Planar())),
                       ::testing::ValuesIn(eltwiseOpTypesBinInp()),
...
const auto params_4D_Planar_Blocked = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(static_shapes_to_test_representation(inShapes_4D_Planar_Blocked())),
                       ::testing::ValuesIn(eltwiseOpTypesBinInp()),
                       ::testing::Values(ov::test::utils::InputLayerType::CONSTANT),
                       ::testing::ValuesIn(opTypes()),
                       ::testing::ValuesIn(netType()),
...
const auto params_5D_Blocked_Planar = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(static_shapes_to_test_representation(inShapes_5D_Blocked_Planar())),
                       ::testing::ValuesIn(eltwiseOpTypesBinInp()),
                       ::testing::Values(ov::test::utils::InputLayerType::CONSTANT),
                       ::testing::ValuesIn(opTypes()),
                       ::testing::ValuesIn(netType()),
...
const auto params_5D_Planar_Blocked = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(static_shapes_to_test_representation(inShapes_5D_Planar_Blocked())),
                       ::testing::ValuesIn(eltwiseOpTypesBinInp()),
                       ::testing::Values(ov::test::utils::InputLayerType::CONSTANT),
                       ::testing::ValuesIn(opTypes()),
                       ::testing::ValuesIn(netType()),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_Planar_Blocked_x64,
                         EltwiseLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_1D_Constant_x64,
                         EltwiseLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_1D_Constant_x64,
                         EltwiseLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_1D_Parameter_x64,
                         EltwiseLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_MemOrder_dyn_const_x64,
                         EltwiseLayerCPUTest,
                         params_4D_dyn_const,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_4D_blocked_blocked_dyn_const =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_4D_dyn_const()),
                                          ::testing::ValuesIn(eltwiseOpTypesBinInp()),
                                          ::testing::Values(ov::test::utils::InputLayerType::CONSTANT),
                                          ::testing::ValuesIn(opTypes()),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Blocked_Blocked_MemOrder_dyn_const_x64,
                         EltwiseLayerCPUTest,
                         params_4D_blocked_blocked_dyn_const,
                         EltwiseLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_MemOrder_dyn_param_x64,
                         EltwiseLayerCPUTest,
                         params_4D_dyn_param,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_4D_blocked_blocked_dyn_param =
    ::testing::Combine(::testing::Combine(::testing::Values(inShapes_4D_dyn_param()),
                                          ::testing::ValuesIn(eltwiseOpTypesBinDyn()),
                                          ::testing::Values(ov::test::utils::InputLayerType::PARAMETER),
                                          ::testing::ValuesIn(opTypes()),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Blocked_Blocked_MemOrder_dyn_param_x64,
                         EltwiseLayerCPUTest,
                         params_4D_blocked_blocked_dyn_param,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_4D_dyn_param_fusing =
    ::testing::Combine(::testing::Combine(::testing::Values(inShapes_4D_dyn_param_fusing()),
                                          ::testing::ValuesIn(eltwiseOpTypesBinDyn()),
                                          ::testing::Values(ov::test::utils::InputLayerType::PARAMETER),
                                          ::testing::ValuesIn(opTypes()),
                                          ::testing::Values(ElementType::f32),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_dyn_param_fusing,
                         EltwiseLayerCPUTest,
                         params_4D_dyn_param_fusing,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_4D_dyn_param_fusing_Blocked_Blocked =
    ::testing::Combine(::testing::Combine(::testing::Values(inShapes_4D_dyn_param_fusing()),
                                          ::testing::ValuesIn(eltwiseOpTypesBinDyn()),
                                          ::testing::Values(ov::test::utils::InputLayerType::PARAMETER),
                                          ::testing::ValuesIn(opTypes()),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_dyn_param_fusing_Blocked_Blocked,
                         EltwiseLayerCPUTest,
                         params_4D_dyn_param_fusing_Blocked_Blocked,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_4D_blocked_blocked_dyn_param_fusing =
    ::testing::Combine(::testing::Combine(::testing::Values(inShapes_4D_dyn_param_fusing()),
                                          ::testing::ValuesIn(eltwiseOpTypesBinDyn()),
                                          ::testing::Values(ov::test::utils::InputLayerType::PARAMETER),
                                          ::testing::ValuesIn(opTypes()),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_blocked_blocked_dyn_param_fusing,
                         EltwiseLayerCPUTest,
                         params_4D_blocked_blocked_dyn_param_fusing,
                         EltwiseLayerCPUTest::getTestCaseName);

//// ============================================ 5D ============================================

const auto params_5D_dyn_const_Blocked_Blocked =
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_MemOrder_dyn_const_Blocked_Blocked,
                         EltwiseLayerCPUTest,
                         params_5D_dyn_const_Blocked_Blocked,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_5D_dyn_param_Blocked_Blocked =
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_MemOrder_dyn_param_Blocked_Blocked,
                         EltwiseLayerCPUTest,
                         params_5D_dyn_param_Blocked_Blocked,
                         EltwiseLayerCPUTest::getTestCaseName);
...
const auto params_4D_bitwise = ::testing::Combine(
    ...
    ::testing::ValuesIn(
        {CPUSpecificParams({nhwc, nhwc}, {nhwc}, {}, {}), CPUSpecificParams({nchw, nchw}, {nchw}, {}, {})}),
    ::testing::Values(emptyFusingSpec),
...
const auto params_4D_bitwise_i32 = ::testing::Combine(
    ::testing::Combine(
        ...
        ::testing::Values(ov::AnyMap())),
    ::testing::ValuesIn(
        {CPUSpecificParams({nhwc, nhwc}, {nhwc}, {}, "*_I32"), CPUSpecificParams({nchw, nchw}, {nchw}, {}, "*_I32")}),
    ::testing::Values(emptyFusingSpec),
    ::testing::Values(false));
...
const auto params_4D_bitwise_NOT = ::testing::Combine(
    ::testing::Combine(
        ...
        ::testing::Values(ov::test::utils::DEVICE_CPU),
        ::testing::Values(ov::AnyMap())),
    ::testing::ValuesIn({CPUSpecificParams({nhwc}, {nhwc}, {}, {}), CPUSpecificParams({nchw}, {nchw}, {}, {})}),
    ::testing::Values(emptyFusingSpec),
    ::testing::Values(false));
...
const auto params_4D_bitwise_NOT_i32 =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(bitwise_in_shapes_4D),
                                          ...
                                          ::testing::Values(ov::test::utils::DEVICE_CPU),
                                          ::testing::Values(ov::AnyMap())),
                       ::testing::ValuesIn({CPUSpecificParams({nhwc}, {nhwc}, {}, "*_I32"),
