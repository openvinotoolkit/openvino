...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPoolV8_CPU_4D_ref,
                         MaxPoolingV8LayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(paramsMaxV84D_ref),
...
const std::vector<InputShape> inputShapes4D_int8 = {{{}, {{3, 4, 64, 64}}},
                                                    {{}, {{2, 8, 8, 12}}},
                                                    {{}, {{1, 16, 16, 12}}},
                                                    {{}, {{1, 21, 8, 4}}},
                                                    {{}, {{1, 32, 8, 8}}},
                                                    {// dynamic
                                                     {-1, 32, -1, -1},
                                                     // target
                                                     {{1, 32, 8, 8}, {1, 32, 8, 4}, {2, 32, 8, 12}, {1, 32, 8, 8}}},
                                                    {// dynamic
                                                     {{1, 5}, 16, {1, 64}, {1, 64}},
                                                     // target
                                                     {
...
const std::vector<InputShape> inputShapes5D_int8 = {
    ...
    {// dynamic
     {-1, 32, -1, -1, -1},
     // target
     {{2, 32, 8, 8, 8}, {1, 32, 16, 20, 8}, {1, 32, 16, 16, 16}, {2, 32, 8, 8, 8}}},
    {// dynamic
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPoolV8_CPU_3D,
                         MaxPoolingV8LayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(paramsMaxV83D()),
                                            ::testing::ValuesIn(inputShapes3D()),
                                            ::testing::ValuesIn((inpOutPrecision())),
                                            ::testing::ValuesIn(filterCPUInfoForDevice(vecCpuConfigsFusing_3D))),
                         MaxPoolingV8LayerCPUTest::getTestCaseName);
