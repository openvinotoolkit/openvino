...
std::vector<ov::bfloat16> input_2x2_bf16 = {ov::bfloat16(0.1f),
                                            ov::bfloat16(1.0f),
                                            ov::bfloat16(10.0f),
                                            ov::bfloat16(101.0f)};

const auto input = testing::Values(ov::Tensor(ov::element::f32, {4, 4}, input_4x4_f32.data()),
                                   ov::Tensor(ov::element::f16, {2, 3, 3}, input_2x3x3_f16.data()),
                                   ov::Tensor(ov::element::bf16, {2, 2}, input_2x2_bf16.data()));
...
const auto params_static = ::testing::Combine(test_type_static, input, adjoint, device_cpu);

const auto params_dynamic = ::testing::Combine(test_type_dynamic, input, adjoint, device_cpu);
