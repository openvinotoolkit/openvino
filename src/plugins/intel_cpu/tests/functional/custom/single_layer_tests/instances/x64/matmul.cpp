...
const auto testParams2DBF16_smoke =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(IS2D_smoke()),
                                          ::testing::ValuesIn(netPRCs()),
                                          ::testing::Values(ElementType::undefined),
                                          ::testing::Values(ElementType::undefined),
...
INSTANTIATE_TEST_SUITE_P(smoke_FC_2D_BF16,
                         MatMulLayerCPUTest,
                         testParams2DBF16_smoke,
                         MatMulLayerCPUTest::getTestCaseName);

const auto testParams2D_nightly =
...
std::vector<ov::AnyMap> filterAdditionalConfig_Brgemm() {
    ...
    std::vector<ov::AnyMap> additionalConfig = {ov::AnyMap{/* empty config */}};
#else
...
const std::vector<ShapeRelatedParams> IS2D_Brgemm_smoke = {
    ...
    {{{{-1, -1}, {{12, 16}, {25, 16}, {12, 16}, {25, 16}}}, {{16, 35}, {{16, 35}, {16, 35}, {16, 35}, {16, 35}}}},
     {false, false}},
    {{{{{0, 50}, {0, 50}}, {{17, 48}, {15, 48}}}, {{48, 15}, {{48, 15}, {48, 15}}}}, {true, true}},
};
...
const auto fullyConnectedParams2D_Brgemm_smoke =
    ::testing::Combine(::testing::ValuesIn(IS2D_Brgemm_smoke),
                       ::testing::Values(ElementType::f32),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(utils::InputLayerType::CONSTANT),
...
INSTANTIATE_TEST_SUITE_P(smoke_FC_2D_Brgemm,
                         MatMulLayerCPUTest,
                         testParams2D_Brgemm_smoke,
                         MatMulLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_MM_Brgemm_Static,
                         MatMulLayerCPUTest,
                         testBrgemmParams_smoke,
                         MatMulLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(nightly_MM_Brgemm_Static,
                         MatMulLayerCPUTest,
                         testBrgemmParams_nightly,
                         MatMulLayerCPUTest::getTestCaseName);

const std::vector<ShapeRelatedParams> IS_Brgemm_Dynamic = {
    {{{{-1, 256}, {{1, 256}}}, {{256, 384}, {{256, 384}}}}, {false, false}},
    {{{{-1, -1}, {{55, 12}, {33, 7}}}, {{-1, -1}, {{12, 55}, {7, 33}}}}, {false, false}},
    {{{{-1, -1, -1, -1}, {{1, 2, 32, 60}, {1, 2, 32, 30}}}, {{-1, -1}, {{60, 5}, {30, 5}}}}, {true, false}},
    {{{{-1, -1, -1}, {{7, 32, 60}, {7, 32, 30}}}, {{-1, -1, -1, -1}, {{3, 7, 60, 25}, {3, 7, 30, 25}}}}, {false, true}},
    {{{{-1, -1, -1}, {{10, 10, 10}, {5, 5, 5}}}, {{-1, -1, -1}, {{10, 10, 10}, {5, 5, 5}}}}, {false, false}},
    {{{{-1, -1, -1}, {{10, 10, 10}, {5, 5, 5}}}, {{-1, -1, -1}, {{10, 10, 10}, {5, 5, 5}}}}, {true, true}},
...
INSTANTIATE_TEST_SUITE_P(smoke_MM_Brgemm_Dynamic,
                         MatMulLayerCPUTest,
                         testBrgemmParamsDynamic,
                         MatMulLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_MM_Brgemm_Dynamic_Fusing,
                         MatMulLayerCPUTest,
                         testParamsBrgemmDynamicFusing,
                         MatMulLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_MM_Brgemm_Amx_Static,
                         MatMulLayerCPUTest,
                         testBrgemmAmxParams_smoke,
                         MatMulLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(nightly_MM_Brgemm_Amx_Static,
                         MatMulLayerCPUTest,
                         testBrgemmAmxParams_nightly,
                         MatMulLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_MM_Brgemm_Amx_Dynamic,
                         MatMulLayerCPUTest,
                         testBrgemmAmxParamsDynamic,
                         MatMulLayerCPUTest::getTestCaseName);
...
std::vector<CPUSpecificParams> filterSpecificParams_Brgconv1x1() {
    std::vector<CPUSpecificParams> specificParams;
    if (with_cpu_x86_avx512_core()) {
        specificParams.push_back(
            CPUSpecificParams{{}, {}, {/* brgconv_avx512_1x1 is not a part of fc impl list */}, "brgconv_avx512_1x1"});
    }

    return specificParams;
}

const auto fullyConnectedParams2D_Brgconv1x1_smoke =
    ::testing::Combine(::testing::ValuesIn(IS2D_Brgconv1x1_smoke),
                       ::testing::Values(ElementType::f32),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(utils::InputLayerType::CONSTANT),
...
INSTANTIATE_TEST_SUITE_P(smoke_FC_2D_Brgconv1x1,
                         MatMulLayerCPUTest,
                         testParams2D_Brgconv1x1_smoke,
                         MatMulLayerCPUTest::getTestCaseName);
...
const auto fullyConnectedParams3D_Brgconv1x1_smoke =
    ::testing::Combine(::testing::ValuesIn(IS3D_Brgconv1x1_smoke),
                       ::testing::Values(ElementType::f32),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(utils::InputLayerType::CONSTANT),
...
INSTANTIATE_TEST_SUITE_P(smoke_FC_3D_Brgconv1x1,
                         MatMulLayerCPUTest,
                         testParams3D_Brgconv1x1_smoke,
                         MatMulLayerCPUTest::getTestCaseName);

const auto fullyConnectedParams2D_Brgemm_Amx_smoke =
...
INSTANTIATE_TEST_SUITE_P(smoke_FC_2D_Brgemm_Amx,
                         MatMulLayerCPUTest,
                         testParams2D_Brgemm_Amx_smoke,
                         MatMulLayerCPUTest::getTestCaseName);
...
const std::vector<ShapeRelatedParams> IS2D_Brgemm_nightly = {
    ...
    {{{{-1, 128}, {{11, 128}, {20, 128}, {11, 128}, {15, 128}}},
     ...
     {true, false}},
    {{{{{0, 50}, 32}, {{50, 32}, {23, 32}}}, {{32, 21}, {{32, 21}, {32, 21}}}}, {false, true}},
};

const auto fullyConnectedParams2D_Brgemm_nightly =
    ::testing::Combine(::testing::ValuesIn(IS2D_Brgemm_nightly),
                       ::testing::Values(ElementType::f32),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(utils::InputLayerType::CONSTANT),
...
INSTANTIATE_TEST_SUITE_P(nightly_FC_2D_Brgemm,
                         MatMulLayerCPUTest,
                         testParams2D_Brgemm_nightly,
                         MatMulLayerCPUTest::getTestCaseName);

const auto fullyConnectedParams2D_Brgemm_Amx_nightly =
    ::testing::Combine(::testing::ValuesIn(IS2D_Brgemm_nightly),
                       ::testing::Values(ElementType::f32),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(ElementType::undefined),
...
INSTANTIATE_TEST_SUITE_P(nightly_FC_2D_Brgemm_Amx,
                         MatMulLayerCPUTest,
                         testParams2D_Brgemm_Amx_nightly,
                         MatMulLayerCPUTest::getTestCaseName);

const auto testParams2DBF16_nightly =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(IS2D_nightly()),
                                          ::testing::ValuesIn(netPRCs()),
                                          ::testing::Values(ElementType::undefined),
                                          ::testing::Values(ElementType::undefined),
...
INSTANTIATE_TEST_SUITE_P(nightly_FC_2D_BF16,
                         MatMulLayerCPUTest,
                         testParams2DBF16_nightly,
                         MatMulLayerCPUTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(nightly_FC_3D_BF16,
                         MatMulLayerCPUTest,
                         testParams3DBF16_nightly,
                         MatMulLayerCPUTest::getTestCaseName);
...
const fusingSpecificParams matmulFullDynInputsFusingParams[] = {fusingMultiplyPerChannel,
                                                                fusingMultiplyAddPerChannel,
                                                                fusingAddPerChannel};

const auto matMulParamsDynamicFusingFullUndefShapes =
    ::testing::Combine(::testing::ValuesIn(IS_Dynamic_Fusing),
                       ::testing::Values(ElementType::f32),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(ElementType::undefined),
                       ::testing::Values(utils::InputLayerType::PARAMETER),
...
const auto testParamsDynamicFusingFullUndefShapes =
    ::testing::Combine(matMulParamsDynamicFusingFullUndefShapes,
                       ::testing::Values(MatMulNodeType::MatMul),
                       ::testing::ValuesIn(matmulFullDynInputsFusingParams),
                       ::testing::ValuesIn(filterCPUInfo(filterSpecificParams())));

INSTANTIATE_TEST_SUITE_P(smoke_MM_Dynamic_Fusing_Full_Undef_Shapes,
