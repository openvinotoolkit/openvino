...
protected:
    void SetUp() override {
        ...
        auto priorBox = std::make_shared<ov::op::v0::PriorBox>(shape_of_1, shape_of_2, attributes);
...
namespace {
const std::vector<ov::test::ElementType> netPrecisions = {ov::test::ElementType::i32, ov::test::ElementType::u64};
