...
typedef std::tuple<convLayerTestParamsSet, CPUSpecificParams, fusingSpecificParams, ov::AnyMap>
...
using convParams_ExplicitPaddingType = decltype(::testing::Combine(::testing::ValuesIn(kernels2d()),
...
using convParams_ExplicitPaddingDilatedType =
    decltype(::testing::Combine(::testing::ValuesIn(kernels2d()),
                                ::testing::ValuesIn(strides2d()),
                                ::testing::ValuesIn(padBegins2d()),
                                ::testing::ValuesIn(padEnds2d()),
                                ...
                                ::testing::ValuesIn(numOutChannels_Gemm()),
                                ::testing::Values(ov::op::PadType::EXPLICIT)));
using convParams_ExplicitPadding_1x1_Type = decltype(::testing::Combine(::testing::Values(ov::Shape({1})),
