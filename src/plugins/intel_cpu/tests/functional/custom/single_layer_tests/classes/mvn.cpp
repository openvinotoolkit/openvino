...
const std::vector<InputShape>& inputShapes_1D() {
    static const std::vector<InputShape> inputShapes_1D = {{{}, {{5}}},
                                                           {{}, {{16}}},
                                                           {// dynamic
                                                            {-1},
                                                            // target
...
const std::vector<InputShape>& inputShapes_2D() {
    static const std::vector<InputShape> inputShapes_2D = {{{}, {{1, 32}}},
                                                           {{}, {{16, 64}}},
...
const std::vector<InputShape>& inputShapes_3D() {
    static const std::vector<InputShape> inputShapes_3D = {{{}, {{1, 32, 17}}},
                                                           {{}, {{1, 37, 9}}},
                                                           {{}, {{1, 16, 4}}},
                                                           {// dynamic
                                                            {-1, -1, -1},
                                                            // target
                                                            {{2, 16, 6}, {4, 16, 2}, {2, 16, 6}, {4, 16, 2}}},
                                                           {// dynamic
                                                            {{1, 5}, {1, 20}, {1, 7}},
                                                            // target
                                                            {{1, 1, 1}, {2, 16, 6}, {4, 16, 2}, {2, 16, 6}}}};
...
const std::vector<InputShape>& inputShapes_4D() {
    static const std::vector<InputShape> inputShapes_4D = {
        ...
        {// dynamic
         {-1, -1, -1, -1},
         // target
         {{2, 16, 10, 6}, {4, 16, 2, 2}, {2, 16, 10, 6}, {4, 16, 2, 2}}},
        {// dynamic
         {{1, 5}, {1, 20}, {1, 10}, {1, 7}},
         // target
         {{1, 1, 1, 1}, {2, 16, 10, 6}, {4, 16, 2, 2}, {2, 16, 10, 6}}}};
...
const std::vector<InputShape>& inputShapes_5D() {
    static const std::vector<InputShape> inputShapes_5D = {
        ...
        {// dynamic
         {-1, -1, -1, -1, -1},
         // target
         {{2, 16, 5, 10, 6}, {4, 16, 7, 2, 2}, {2, 16, 5, 10, 6}, {4, 16, 7, 2, 2}}},
        {// dynamic
         {{1, 5}, {1, 20}, {1, 7}, {1, 10}, {1, 7}},
         // target
         {{1, 1, 1, 1, 1}, {2, 16, 5, 10, 6}, {4, 16, 7, 2, 2}, {2, 16, 5, 10, 6}}}};
    return inputShapes_5D;
}

const std::vector<ov::Shape>& inputShapesStatic_2D() {
    static const std::vector<ov::Shape> inputShapesStatic_2D = {{1}, {16}, {4}};
    return inputShapesStatic_2D;
}

const std::vector<ov::Shape>& inputShapesStatic_3D() {
    static const std::vector<ov::Shape> inputShapesStatic_3D = {{2, 16, 6}, {4, 16, 2}, {1, 16, 4}};
    return inputShapesStatic_3D;
}

const std::vector<ov::Shape>& inputShapesStatic_4D() {
    static const std::vector<ov::Shape> inputShapesStatic_4D = {{1, 7, 3, 5},
                                                                {1, 15, 9, 5},
                                                                {4, 41, 6, 9},
...
const std::vector<ov::Shape>& inputShapesStatic_5D() {
    static const std::vector<ov::Shape> inputShapesStatic_5D = {{1, 32, 8, 1, 6},
                                                                {1, 9, 1, 15, 9},
                                                                {6, 64, 6, 1, 18},
...
const std::vector<bool>& acrossChannels() {
    static const std::vector<bool> acrossChannels = {true, false};
    return acrossChannels;
}

const std::vector<double>& epsilon() {
    static const std::vector<double> epsilon = {0.000000001};
    return epsilon;
}
