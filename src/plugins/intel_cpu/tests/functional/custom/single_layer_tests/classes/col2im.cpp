...
const std::vector<Col2ImSpecificParams> col2ImParamsVector = {
    Col2ImSpecificParams{InputShape{{}, {{1, 12, 9}}},
                         ...
                         ov::Shape{0, 0},
                         ov::Shape{0, 0}},
    Col2ImSpecificParams{InputShape{{}, {{3, 12, 81}}},
                         ...
                         ov::Shape{2, 2},
                         ov::Shape{2, 2}},
    Col2ImSpecificParams{InputShape{{}, {{12, 81}}},
                         std::vector<int64_t>{16, 16},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{2, 2},
                         ov::Strides{2, 2},
                         ov::Shape{2, 2},
                         ov::Shape{2, 2}},
    Col2ImSpecificParams{InputShape{{}, {{3, 12, 225}}},
                         std::vector<int64_t>{16, 16},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{1, 1},
                         ov::Strides{1, 1},
                         ov::Shape{0, 0},
                         ov::Shape{0, 0}},
    Col2ImSpecificParams{InputShape{{}, {{1, 27, 49}}},
                         std::vector<int64_t>{16, 16},
                         ...
                         ov::Shape{1, 1},
                         ov::Shape{1, 1}},
    Col2ImSpecificParams{InputShape{{}, {{1, 18, 104}}},
                         std::vector<int64_t>{16, 16},
                         ...
                         ov::Shape{1, 0},
                         ov::Shape{0, 1}},
    Col2ImSpecificParams{InputShape{{-1, -1, -1}, {{1, 12, 120}, {3, 12, 120}}},
                         std::vector<int64_t>{16, 16},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{2, 1},
                         ov::Strides{2, 2},
                         ov::Shape{1, 0},
                         ov::Shape{0, 1}},
    Col2ImSpecificParams{InputShape{{}, {{12, 12, 324}}},
                         ...
                         ov::Shape{3, 3},
                         ov::Shape{3, 3}},
    Col2ImSpecificParams{InputShape{{-1, 12, 324}, {{12, 12, 324}}},
                         std::vector<int64_t>{32, 32},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{2, 2},
                         ov::Strides{2, 2},
                         ov::Shape{3, 3},
                         ov::Shape{3, 3}},
    Col2ImSpecificParams{InputShape{{-1, -1, -1}, {{12, 12, 324}}},
                         std::vector<int64_t>{32, 32},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{2, 2},
                         ov::Strides{2, 2},
                         ov::Shape{3, 3},
                         ov::Shape{3, 3}},
    Col2ImSpecificParams{InputShape{{12, -1, -1}, {{12, 12, 324}}},
                         std::vector<int64_t>{32, 32},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{2, 2},
                         ov::Strides{2, 2},
                         ov::Shape{3, 3},
                         ov::Shape{3, 3}},
    Col2ImSpecificParams{InputShape{{12, 12, -1}, {{12, 12, 324}}},
                         std::vector<int64_t>{32, 32},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{2, 2},
                         ov::Strides{2, 2},
                         ov::Shape{3, 3},
                         ov::Shape{3, 3}},
    Col2ImSpecificParams{InputShape{{12, -1, 324}, {{12, 12, 324}}},
                         std::vector<int64_t>{32, 32},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{2, 2},
                         ov::Strides{2, 2},
                         ov::Shape{3, 3},
                         ov::Shape{3, 3}},
    Col2ImSpecificParams{InputShape{{-1, -1}, {{12, 324}}},
                         std::vector<int64_t>{32, 32},
                         std::vector<int64_t>{2, 2},
                         ov::Strides{2, 2},
                         ov::Strides{2, 2},
