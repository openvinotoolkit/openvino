...
using proposalSpecificParams = std::tuple<base_size_type,
...
protected:
    void SetUp() override {
        ...
        ov::ResultVector results{std::make_shared<ov::op::v0::Result>(proposal->output(0)),
...
std::vector<std::vector<ov::Shape>> staticInputShapesCase1 = {{{2, 30, 18, 22}, {2, 60, 18, 22}, {3}},
...
const auto proposalParamsCase1 = ::testing::Combine(::testing::ValuesIn(base_size_1),
...
INSTANTIATE_TEST_SUITE_P(smoke_Proposal_Dynamic_Test_Case1,
                         ProposalLayerCPUTest,
...
std::vector<std::vector<ov::Shape>> staticInputShapesCase2 = {{{1, 24, 24, 30}, {1, 48, 24, 30}, {3}},
...
const auto proposalParamsCase2 = ::testing::Combine(::testing::ValuesIn(base_size_2),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Proposal_Static_Test_Case2,
    ProposalLayerCPUTest,
