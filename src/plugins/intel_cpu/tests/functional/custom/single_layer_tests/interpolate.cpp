...
using InterpolateLayerCPUTestParamsSet = std::
    tuple<InterpolateSpecificParams, ShapeParams, ElementType, CPUSpecificParams, fusingSpecificParams, ov::AnyMap>;
...
protected:
    ...
    void SetUp() override {
        ...
        if (shapeCalcMode == ov::op::v11::Interpolate::ShapeCalcMode::SCALES) {
            ...
            if (shapeInputType == ov::test::utils::InputLayerType::PARAMETER) {
                auto paramNode =
                    std::make_shared<ov::op::v0::Parameter>(ElementType::i32, ov::Shape{sizes.front().size()});
                params.push_back(paramNode);
...
const std::vector<std::vector<int64_t>> defaultAxes3D = {{0, 1, 2}};

const std::vector<ShapeParams> shapeParams3D = {
    ShapeParams{ov::op::v11::Interpolate::ShapeCalcMode::SCALES,
...
const auto interpolateCasesNN_Smoke_3D =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::NEAREST),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateNN_Layout_Test_3D,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN_Smoke_3D,
...
const auto interpolateCasesNN_Full_3D =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::NEAREST),
                       ...
                       ::testing::ValuesIn(pads3D_full),
                       ::testing::ValuesIn(cubeCoefs));
INSTANTIATE_TEST_SUITE_P(InterpolateNN_Layout_Test_3D,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN_Full_3D,
                                            ::testing::ValuesIn(shapeParams3D),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice3D()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
const std::vector<ShapeParams> shapeParams3D_fixed_C = {ShapeParams{ov::op::v11::Interpolate::ShapeCalcMode::SCALES,
                                                                    InputShape{{}, {{1, 3, 4}}},
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateNN_Layout_PerChannelFuse3D_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN_Smoke_3D,
...
INSTANTIATE_TEST_SUITE_P(InterpolateNN_Layout_PerChannelFuse3D_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN_Full_3D,
                                            ::testing::ValuesIn(shapeParams3D_fixed_C),
                                            ::testing::Values(ElementType::f32),
...
const auto interpolateCasesLinear3D_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::LINEAR),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
...
const auto interpolateCasesLinear3D_Full =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::LINEAR),
                       ::testing::ValuesIn(coordinateTransformModes_Full),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateLinear_Layout3D_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesLinear3D_Smoke,
                                            ::testing::ValuesIn(shapeParams3D),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice3D()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
INSTANTIATE_TEST_SUITE_P(InterpolateLinear_Layout3D_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesLinear3D_Full,
                                            ::testing::ValuesIn(shapeParams3D),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice3D()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
const auto interpolateCasesCubic3D_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::CUBIC),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
                       ::testing::ValuesIn(pads3D_smoke),
...
const auto interpolateCasesCubic3D_Full =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::CUBIC),
                       ::testing::ValuesIn(coordinateTransformModes_Full),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateCubic_Layout3D_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesCubic3D_Smoke,
                                            ::testing::ValuesIn(shapeParams3D),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice3D()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
INSTANTIATE_TEST_SUITE_P(InterpolateCubic_Layout3D_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesCubic3D_Full,
                                            ::testing::ValuesIn(shapeParams3D),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice3D()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
const std::vector<std::vector<int64_t>> defaultAxes4D = {{0, 1, 2, 3}};
...
const auto interpolateCasesNN_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::NEAREST),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(nearestModes_Smoke),
                       ::testing::ValuesIn(antialias),
...
const auto interpolateCasesNN_Full =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::NEAREST),
                       ::testing::ValuesIn(coordinateTransformModes_Full),
                       ::testing::ValuesIn(nearestModes_Full),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateNN_Layout_Test,
                         InterpolateLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(InterpolateNN_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN_Full,
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateNN_Layout_PerChannelFuse_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN_Smoke,
...
INSTANTIATE_TEST_SUITE_P(InterpolateNN_Layout_PerChannelFuse_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN_Full,
                                            ::testing::ValuesIn(shapeParams4D_fixed_C),
                                            ::testing::Values(ElementType::f32),
...
const auto interpolateCasesLinearOnnx_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::LINEAR_ONNX),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
                       ::testing::ValuesIn(pads4D),
...
const auto interpolateCasesLinearOnnx_Full =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::LINEAR_ONNX),
                       ::testing::ValuesIn(coordinateTransformModes_Full),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateLinearOnnx_Layout_Test,
                         InterpolateLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(InterpolateLinearOnnx_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesLinearOnnx_Full,
                                            ::testing::ValuesIn(shapeParams4D_Full),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
const auto interpolateCasesLinear_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::LINEAR),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
const auto interpolateCasesLinear_Full =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::LINEAR),
                       ::testing::ValuesIn(coordinateTransformModes_Full),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateLinear_Layout_Test,
                         InterpolateLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(InterpolateLinear_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesLinear_Full,
                                            ::testing::ValuesIn(shapeParams4D_Full),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
const auto interpolateCasesCubic_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::CUBIC),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
const auto interpolateCasesCubic_Full =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::CUBIC),
                       ::testing::ValuesIn(coordinateTransformModes_Full),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateCubic_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesCubic_Smoke,
                                            ::testing::ValuesIn(shapeParams4D_Smoke),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
INSTANTIATE_TEST_SUITE_P(InterpolateCubic_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesCubic_Full,
                                            ::testing::ValuesIn(shapeParams4D_Full),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
const auto interpolateCasesLinearOnnx5D_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::LINEAR_ONNX),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
                       ...
                       ::testing::ValuesIn(pads5D),
                       ::testing::ValuesIn(cubeCoefs));
const auto interpolateCasesLinearOnnx5D_Full =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::LINEAR_ONNX),
                       ::testing::ValuesIn(coordinateTransformModes_Full),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateLinearOnnx5D_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesLinearOnnx5D_Smoke,
...
INSTANTIATE_TEST_SUITE_P(InterpolateLinearOnnx5D_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesLinearOnnx5D_Full,
...
const auto interpolateCasesNN5D_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::NEAREST),
                       ::testing::ValuesIn(coordinateTransformModes_Smoke),
                       ::testing::ValuesIn(nearestModes_Smoke),
                       ::testing::ValuesIn(antialias),
...
const auto interpolateCasesNN5D_Full =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::NEAREST),
                       ::testing::ValuesIn(coordinateTransformModes_Full),
                       ::testing::ValuesIn(nearestModes_Full),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateNN5D_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN5D_Smoke,
                                            ::testing::ValuesIn(shapeParams5D_Smoke),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice5D()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
INSTANTIATE_TEST_SUITE_P(InterpolateNN5D_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesNN5D_Full,
                                            ::testing::ValuesIn(shapeParams5D_Full),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice5D()),
                                            ::testing::ValuesIn(interpolateFusingParamsSet),
...
const auto interpolateCornerCases =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::NEAREST),
...
INSTANTIATE_TEST_SUITE_P(smoke_Interpolate_corner_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCornerCases,
...
const std::vector<fusingSpecificParams> interpolateFusingPillowParamsSet{emptyFusingSpec};

const std::vector<std::vector<int64_t>> defaultAxes4D_pillow = {{2, 3}};
...
const auto interpolateCasesBilinearPillow_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::BILINEAR_PILLOW),
...
const auto interpolateCasesBicubicPillow_Smoke =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::BICUBIC_PILLOW),
                       ::testing::ValuesIn(coordinateTransformModesPillow_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
                       ::testing::ValuesIn(pads4D),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateBilinearPillow_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesBilinearPillow_Smoke,
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateBicubicPillow_Layout_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesBicubicPillow_Smoke,
                                            ::testing::ValuesIn(shapeParams4D_Pillow_Smoke),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice_pillow()),
                                            ::testing::ValuesIn(interpolateFusingPillowParamsSet),
...
const std::vector<std::vector<int64_t>> defaultAxes4D_pillow_nchw_as_nhwc = {{1, 2}};
...
const std::vector<std::vector<size_t>> pads4D_nchw_as_nhwc = {{0, 0, 0, 0}};
...
const auto interpolateCasesBilinearPillow_Smoke_nchw_as_nhwc =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::BILINEAR_PILLOW),
                       ::testing::ValuesIn(coordinateTransformModesPillow_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateBilinearPillow_LayoutAlign_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesBilinearPillow_Smoke_nchw_as_nhwc,
...
const auto interpolateCasesBicubicPillow_Smoke_nchw_as_nhwc =
    ::testing::Combine(::testing::Values(ov::op::v11::Interpolate::InterpolateMode::BICUBIC_PILLOW),
                       ::testing::ValuesIn(coordinateTransformModesPillow_Smoke),
                       ::testing::ValuesIn(defNearestModes),
                       ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(smoke_InterpolateBicubicPillow_LayoutAlign_Test,
                         InterpolateLayerCPUTest,
                         ::testing::Combine(interpolateCasesBicubicPillow_Smoke_nchw_as_nhwc,
                                            ::testing::ValuesIn(shapeParams4D_Pillow_Smoke_nchw_as_nhwc),
                                            ::testing::Values(ElementType::f32),
                                            ::testing::ValuesIn(filterCPUInfoForDevice_pillow_nchw_as_nhwc()),
                                            ::testing::ValuesIn(interpolateFusingPillowParamsSet),
