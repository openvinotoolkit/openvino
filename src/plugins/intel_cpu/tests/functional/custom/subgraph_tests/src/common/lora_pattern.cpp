...
class LoraPatternMatmul : public LoraPattern {
public:
    void SetUp() override {
...
TEST_F(LoraPatternMatmul, smoke_empty_states) {
    run_test();
}

class LoraPatternConvolution : public LoraPattern {
public:
    void SetUp() override {
        targetDevice = utils::DEVICE_CPU;
...
TEST_F(LoraPatternConvolution, smoke_empty_states) {
    run_test();
}
} // namespace test
} // namespace ov
