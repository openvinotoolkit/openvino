...
#include "matmul_dynamic_quantization.hpp"
...
std::string MatmulDynamicQuantization::getTestCaseName(testing::TestParamInfo<MatmulDynamicQuantizationParams> obj) {
...
std::shared_ptr<ov::Model> MatmulDynamicQuantization::initSubgraph(const ov::PartialShape& data_shape,
    ...
    return makeNgraphFunction(data_precision, params, matMul, "MatmulDynamicQuantization");
}

void MatmulDynamicQuantization::SetUp() {
...
void MatmulDynamicQuantization::check_results() {
...
TEST_P(MatmulDynamicQuantization, CompareWithRefs) {
