...
#include "custom/subgraph_tests/src/classes/matmul_dynamic_quantization.hpp"
...
const std::vector<ov::test::ElementType> weights_precisions = {ov::element::i8,
                                                               /*ov::element::u4,
                                                               ov::element::i4,
                                                               ov::element::nf4*/};
...
INSTANTIATE_TEST_SUITE_P(smoke_MatMulDynamicQuantization_basic,
                         MatmulDynamicQuantization,
                         ::testing::Combine(::testing::ValuesIn(input_shapes_basic),
                                            ...
                                            ::testing::Values(true)),
                         MatmulDynamicQuantization::getTestCaseName);
