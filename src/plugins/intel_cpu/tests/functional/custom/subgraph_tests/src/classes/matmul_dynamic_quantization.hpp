...
typedef std::tuple<MatMulDecompressionShapeParams,
    ...
    MatmulDynamicQuantizationParams;

class MatmulDynamicQuantization : public testing::WithParamInterface<MatmulDynamicQuantizationParams>,
                                   virtual public SubgraphBaseTest,
                                   public CpuTestWithFusing {
public:
    static std::string getTestCaseName(testing::TestParamInfo<MatmulDynamicQuantizationParams> obj);
