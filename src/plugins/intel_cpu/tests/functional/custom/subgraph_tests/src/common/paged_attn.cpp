...
using PagedAttnTestParams = std::tuple<ElementType, InputShapeAndTransposeOrder>;
...
public:
    ...
    void generate(int idx, const bool isPagedAttn, const std::vector<ov::Shape>& targetInputStaticShapes) {
        inputs.clear();
...
class PagedAttnTest : public PagedAttnTestBase {
public:
...
TEST_P(PagedAttnTest, CompareWithRefs) {
...
INSTANTIATE_TEST_SUITE_P(smoke_PagedAttnTest,
                         PagedAttnTest,
