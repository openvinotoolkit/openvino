...
/*
The main purpose of the tests is to test cyclic inplace resolution in order to make sure that output edges are
...
public:
    void SetUp() override {
        ...
        auto rnnseq = std::make_shared<ov::op::v5::GRUSequence>(
            ...
            ov::op::v0::Constant::create(precision,
                                         {1, hidden_size * 3, 8},
                                         W),  // W [num_directions, 3 * hidden_size, input_size]
            ov::op::v0::Constant::create(precision,
                                         {1, hidden_size * 3, hidden_size},
                                         R),  // R [num_directions, 3 * hidden_size, hidden_size]
        ...
        auto reshape_1 = std::make_shared<ov::op::v0::Squeeze>(
            rnnseq->outputs()[0],
            reshape_param_1);  // Y [batch_size, num_directions, seq_len, hidden_size]
...
INSTANTIATE_TEST_SUITE_P(smoke_inplace_resolve_io,
                         RNNConcatSubgraphTest,
