...
elseif(RISCV64)
  ...
  foreach(TEST_CLASS_FILE ${LIST_OF_TEST_CLASSES})
    ...
    if(X86_64)
        file(GLOB LIST_OF_TEST_ARCH_INSTANCES ${TEST_DIR}/instances/x64/${TEST_CLASS_FILE_NAME})
    elseif(ARM OR AARCH64)
        file(GLOB LIST_OF_TEST_ARCH_INSTANCES ${TEST_DIR}/instances/arm/${TEST_CLASS_FILE_NAME})
    elseif(RISCV64)
        file(GLOB LIST_OF_TEST_ARCH_INSTANCES ${TEST_DIR}/instances/riscv64/${TEST_CLASS_FILE_NAME})
    endif()
    file(GLOB LIST_OF_TEST_COMMON_INSTANCES ${TEST_DIR}/instances/common/${TEST_CLASS_FILE_NAME})
