...
protected:
    void SetUp() override {
        ...
        if (maxOutBoxesType == ov::test::utils::InputLayerType::PARAMETER) {
            ...
            maxOutBoxesPerClassNode = ov::test::utils::make_constant(maxBoxPrec, ov::Shape{}, std::vector<int32_t>{maxOutBoxesPerClass});
        }
        ...
        auto softNmsSigmaNode = ov::test::utils::make_constant(thrPrec, ov::Shape{}, std::vector<float>{softNmsSigma})->output(0);
