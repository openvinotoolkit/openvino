...
protected:
    void SetUp() override {
        ...
        auto coords = ov::test::utils::builder::makeConstant<float>(ngraph::element::f32, proposalShape, proposal);
        auto params = ov::test::utils::builder::makeParams(ngraph::element::f32, {featureMapShape});
