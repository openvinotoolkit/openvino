...
protected:
    void SetUp() override {
        ...
        const auto paramsOut = ov::helpers::convert2OutputVector(ov::helpers::castOps2Nodes<ngraph::op::Parameter>(paramsIn));
        const auto roll = std::dynamic_pointer_cast<ngraph::op::v7::Roll>(ov::builder::makeRoll(paramsOut[0], shiftNode, axesNode));
