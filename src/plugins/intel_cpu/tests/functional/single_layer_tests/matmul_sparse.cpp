...
protected:
    ...
    std::shared_ptr<Node> makeMatMulRelaxed(const Output<Node>& A,
        ...
        auto matrixBFP32 = ov::builder::makeDynamicInputLayer(element::f32, ov::helpers::InputLayerType::CONSTANT, inShapeB);

        auto matMulRelaxed = std::make_shared<ov::op::TypeRelaxed<opset3::MatMul>>(
            *as_type_ptr<opset3::MatMul>(ov::builder::makeMatMul(inputParamsFP32, matrixBFP32, transpose_a, transpose_b)),
            element::f32);

        auto matrixB = ov::builder::makeConstant<int8_t>(weiType, inShapeB.get_shape(), weiData);
    ...
    void SetUp() override {
        abs_threshold = 0.5f;
        using ov::tests::pass::ConvertPrecision;
        ...
        auto matrixB = ov::builder::makeDynamicInputLayer(element::f32, ov::helpers::InputLayerType::CONSTANT, inShapeB);
        ...
        ov::tests::pass::ConvertPrecision<ngraph::element::Type_t::i8, ngraph::element::Type_t::f32>().run_on_model(functionRefs);
        ov::tests::pass::ConvertPrecision<ngraph::element::Type_t::u8, ngraph::element::Type_t::f32>().run_on_model(functionRefs);
