...
std::string NmsRotatedLayerTestCPU::getTestCaseName(const testing::TestParamInfo<NmsRotatedParams>& obj) {
...
void NmsRotatedLayerTestCPU::SetUp() {
...
void NmsRotatedLayerTestCPU::generate_inputs(const std::vector<ov::Shape>& targetInputStaticShapes) {
    inputs.clear();
