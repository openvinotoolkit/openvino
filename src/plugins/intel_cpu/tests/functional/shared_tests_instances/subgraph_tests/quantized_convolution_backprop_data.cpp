...
const auto quantConvBackpropData2DParams = ::testing::Combine(::testing::ValuesIn(kernels2D),
...
INSTANTIATE_TEST_SUITE_P(smoke_QuantConvBackpropData2D,
                         QuantConvBackpropDataLayerTest,
                         ::testing::Combine(quantConvBackpropData2DParams,
...
const auto quantConvBackpropData3DParams = ::testing::Combine(::testing::ValuesIn(kernels3D),
...
INSTANTIATE_TEST_SUITE_P(smoke_QuantConvBackpropData3D,
                         QuantConvBackpropDataLayerTest,
                         ::testing::Combine(quantConvBackpropData3DParams,
                                            ::testing::ValuesIn(element_types),
