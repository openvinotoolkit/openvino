...
const auto quantGroupConv2DParams = ::testing::Combine(::testing::ValuesIn(kernels2D),
...
INSTANTIATE_TEST_SUITE_P(smoke_QuantGroupConv2D,
                         QuantGroupConvLayerTest,
                         ::testing::Combine(quantGroupConv2DParams,
...
const auto quantGroupConv3DParams = ::testing::Combine(::testing::ValuesIn(kernels3D),
...
INSTANTIATE_TEST_SUITE_P(smoke_QuantGroupConv3D,
                         QuantGroupConvLayerTest,
                         ::testing::Combine(quantGroupConv3DParams,
                                            ::testing::ValuesIn(netPrecisions),
