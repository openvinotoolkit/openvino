...
const auto quantGroupConvBackpropData2DParams = ::testing::Combine(::testing::ValuesIn(kernels2D),
...
INSTANTIATE_TEST_SUITE_P(smoke_QuantGroupConvBackpropData2D,
                         QuantGroupConvBackpropDataLayerTest,
                         ::testing::Combine(quantGroupConvBackpropData2DParams,
...
const auto quantGroupConvBackpropData3DParams = ::testing::Combine(::testing::ValuesIn(kernels3D),
...
INSTANTIATE_TEST_SUITE_P(smoke_QuantGroupConvBackpropData3D,
                         QuantGroupConvBackpropDataLayerTest,
                         ::testing::Combine(quantGroupConvBackpropData3DParams,
                                            ::testing::ValuesIn(netPrecisions),
