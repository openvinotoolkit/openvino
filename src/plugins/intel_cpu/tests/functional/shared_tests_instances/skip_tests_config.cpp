...
std::vector<std::string> disabledTestPatterns() {
    std::vector<std::string> retVector{
        ...
        R"(.*smoke_MatmulAndGatherSharedWeightsDecompression.*weights_precision=i4.*)",
        ...
        // Issue: 124834
        R"(.*smoke_MatmulAndGatherSharedWeightsDecompression.*weights_precision=(u4|i4).*decompression_subtract=1.*)",
    };
