...
std::vector<std::string> disabledTestPatterns() {
    ...
    // retVector.emplace_back(R"(smoke_Snippets(?!_Eltwise|_Convert|_FQDecomposition_|_MatMul/|_MatMult/).*)");
    retVector.emplace_back(R"(smoke_Snippets(?!_Eltwise|_Convert|_FQDecomposition_|_MatMul1).*)");
