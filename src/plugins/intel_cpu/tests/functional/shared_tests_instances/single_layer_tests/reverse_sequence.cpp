...
const std::vector<ov::test::utils::InputLayerType> secondary_input_types = {ov::test::utils::InputLayerType::CONSTANT,
                                                                            ov::test::utils::InputLayerType::PARAMETER};

INSTANTIATE_TEST_SUITE_P(smoke_ReverseSequence,
                         ReverseSequenceLayerTest,
                         ::testing::Combine(::testing::ValuesIn(batch_axis_indices),
