...
const std::vector<std::vector<size_t>> in_shapes_caffe = {{1, 125, 13, 13}};

const std::vector<std::vector<size_t>> in_shapes_mxnet =
    {{1, 75, 52, 52}, {1, 75, 32, 32}, {1, 75, 26, 26}, {1, 75, 16, 16}, {1, 75, 13, 13}, {1, 75, 8, 8}};

const std::vector<std::vector<size_t>> in_shapes_v3 = {{1, 255, 52, 52}, {1, 255, 26, 26}, {1, 255, 13, 13}};
...
const auto test_case_yolov3 = ::testing::Combine(::testing::ValuesIn(in_shapes_v3),
...
const auto test_case_yolov3_mxnet = ::testing::Combine(::testing::ValuesIn(in_shapes_mxnet),
...
const auto test_case_yolov2_caffe = ::testing::Combine(::testing::ValuesIn(in_shapes_caffe),
                                                       ::testing::Values(classes[1]),
                                                       ::testing::Values(coords),
