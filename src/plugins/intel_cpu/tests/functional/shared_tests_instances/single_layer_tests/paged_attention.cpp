...
INSTANTIATE_TEST_SUITE_P(smoke_PagedAttention_basic_static, PagedAttentionLayerTest,
        ::testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(smoke_PagedAttention_static_rotation, PagedAttentionLayerTest,
                        ::testing::Combine(
                                ::testing::Values(ov::test::static_shapes_to_test_representation({
                                        {2, 8}, // InputShape query,
                                        {2, 8}, // InputShape key,
