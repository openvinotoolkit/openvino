...
const std::vector<ov::element::Type> model_types = {ov::element::f32, ov::element::f16, ov::element::i32};
...
const auto group_conv_1d_params_explicit_padding = ::testing::Combine(::testing::ValuesIn(kernels_1d),
...
const auto group_conv_1d_params_auto_pad_valid = ::testing::Combine(::testing::ValuesIn(kernels_1d),
                                                                    ::testing::ValuesIn(strides_1d),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(group_conv_1d_params_explicit_padding,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvolution1D_AutoPadValid,
    GroupConvolutionLayerTest,
    ::testing::Combine(group_conv_1d_params_auto_pad_valid,
                       ::testing::ValuesIn(model_types),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_1d)),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
    GroupConvolutionLayerTest::getTestCaseName);
...
const auto group_conv2DParams_explicit_padding = ::testing::Combine(::testing::ValuesIn(kernels_2d),
...
const auto group_conv2DParams_auto_pad_valid = ::testing::Combine(::testing::ValuesIn(kernels_2d),
                                                                  ::testing::ValuesIn(strides_2d),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    GroupConvolutionLayerTest,
    ::testing::Combine(group_conv2DParams_explicit_padding,
                       ::testing::ValuesIn(model_types),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvolution2D_AutoPadValid,
    GroupConvolutionLayerTest,
    ::testing::Combine(group_conv2DParams_auto_pad_valid,
                       ::testing::ValuesIn(model_types),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_2d)),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
    GroupConvolutionLayerTest::getTestCaseName);
...
const auto group_conv3DParams_explicit_padding = ::testing::Combine(::testing::ValuesIn(kernels_3d),
...
const auto group_conv3DParams_auto_pad_valid = ::testing::Combine(::testing::ValuesIn(kernels_3d),
                                                                  ::testing::ValuesIn(strides_3d),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    GroupConvolutionLayerTest,
    ::testing::Combine(group_conv3DParams_explicit_padding,
                       ::testing::ValuesIn(model_types),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvolution3D_AutoPadValid,
    GroupConvolutionLayerTest,
    ::testing::Combine(group_conv3DParams_auto_pad_valid,
                       ::testing::ValuesIn(model_types),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_3d)),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
    GroupConvolutionLayerTest::getTestCaseName);
