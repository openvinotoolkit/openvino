...
const auto test_case_caffe_yolov2 = ::testing::Combine(::testing::ValuesIn(in_shapes_caffe_yolov2),
                                                       ::testing::Values(strides[0]),
                                                       ::testing::Values(ov::element::f32),
                                                       ::testing::Values(ov::test::utils::DEVICE_CPU));

const auto test_case_smallest = ::testing::Combine(::testing::Values(in_shapes[0]),
                                                   ::testing::Values(strides[0]),
                                                   ::testing::Values(ov::element::f32),
                                                   ::testing::Values(ov::test::utils::DEVICE_CPU));

const auto test_case_stride_2 = ::testing::Combine(::testing::Values(in_shapes[1]),
                                                   ::testing::Values(strides[0]),
                                                   ::testing::Values(ov::element::f32),
                                                   ::testing::Values(ov::test::utils::DEVICE_CPU));

const auto test_case_stride_3 = ::testing::Combine(::testing::Values(in_shapes[2]),
                                                   ::testing::Values(strides[1]),
                                                   ::testing::Values(ov::element::f32),
                                                   ::testing::Values(ov::test::utils::DEVICE_CPU));

const auto test_case_smaller_h = ::testing::Combine(::testing::Values(in_shapes[4]),
                                                    ::testing::Values(strides[0]),
                                                    ::testing::Values(ov::element::f32),
                                                    ::testing::Values(ov::test::utils::DEVICE_CPU));

const auto test_case_batch_2 = ::testing::Combine(::testing::Values(in_shapes[3]),
                                                  ::testing::Values(strides[0]),
                                                  ::testing::Values(ov::element::f32),
                                                  ::testing::Values(ov::test::utils::DEVICE_CPU));
