...
const std::vector<std::vector<ov::Shape>> shapes_static = {{{1, 1}},
                                                           {{2, 6}},
                                                           {{1, 1, 1}},
                                                           {{2, 6, 13}},
                                                           {{1, 1, 1, 1}},
...
const auto fq_params = ::testing::Combine(::testing::ValuesIn(levels),
...
const auto none_broadcast_fq_params = ::testing::Combine(::testing::ValuesIn(levels),
                                                         ::testing::Values(single_shape),
                                                         ::testing::Values(fq_args),
                                                         ::testing::Values(none_broadcast));

INSTANTIATE_TEST_SUITE_P(
    smoke_FakeQuantizenone_broadcast,
    FakeQuantizeLayerTest,
    ::testing::Combine(none_broadcast_fq_params,
                       ::testing::ValuesIn(model_types),
...
const auto fq_params_per_channel_axis0 = ::testing::Combine(::testing::ValuesIn(levels),
                                                            ::testing::ValuesIn(const_shapes_per_channel_axis0),
                                                            ::testing::Values(fq_args),
                                                            ::testing::Values(numpy_broadcast));

const auto fq_params_per_channel_axis1 = ::testing::Combine(::testing::ValuesIn(levels),
                                                            ::testing::ValuesIn(const_shapes_per_channel_axis1),
                                                            ::testing::Values(fq_args),
                                                            ::testing::Values(numpy_broadcast));

INSTANTIATE_TEST_SUITE_P(
    smoke_FakeQuantizePerChannelAxis0,
    FakeQuantizeLayerTest,
    ::testing::Combine(fq_params_per_channel_axis0,
                       ::testing::ValuesIn(model_types),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_FakeQuantizePerChannelAxis1,
    FakeQuantizeLayerTest,
    ::testing::Combine(fq_params_per_channel_axis1,
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(shapes_static_per_channel)),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
    FakeQuantizeLayerTest::getTestCaseName);
...
const auto fq_params_const_shapes_per_channel_2d = ::testing::Combine(::testing::ValuesIn(levels),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    FakeQuantizeLayerTest,
    ::testing::Combine(fq_params_const_shapes_per_channel_2d,
                       ::testing::ValuesIn(model_types),
