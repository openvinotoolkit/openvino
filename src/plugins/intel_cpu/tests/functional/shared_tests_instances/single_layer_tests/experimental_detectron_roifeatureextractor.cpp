...
const std::vector<std::vector<InputShape>> staticInputShape = {
        ...
        static_shapes_to_test_representation({{1200, 4}, {1, 8, 200, 672}, {1, 8, 100, 336}, {1, 8, 50, 168}, {1, 8, 25, 84}})
};
        ...
        {
                {
                        ...
                        {{1, 8, -1, -1}, {{1, 8, 200, 336}, {1, 8, 200, 672}, {1, 8, 400, 672}}},
                        {{1, 8, -1, -1}, {{1, 8, 100, 168}, {1, 8, 100, 336}, {1, 8, 200, 336}}},
                        {{1, 8, -1, -1}, {{1, 8, 50, 84}, {1, 8, 50, 168}, {1, 8, 100, 168}}},
                        {{1, 8, -1, -1}, {{1, 8, 25, 42}, {1, 8, 25, 84}, {1, 8, 50, 84}}}
                }
        },
        {
                {
