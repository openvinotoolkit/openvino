...
INSTANTIATE_TEST_SUITE_P(DISABLED_smoke_RDFT_1d,
                         RDFTLayerTest,
                         ::testing::Combine(::testing::ValuesIn(shapes_forward_1d),
...
INSTANTIATE_TEST_SUITE_P(DISABLED_smoke_IRDFT_1d,
                         RDFTLayerTest,
                         ::testing::Combine(::testing::ValuesIn(shapes_inverse_1d),
                                            ::testing::ValuesIn(model_types),
                                            ::testing::Values(std::vector<int64_t>{0}),
                                            ::testing::ValuesIn(signal_sizes_1d),
...
INSTANTIATE_TEST_SUITE_P(smoke_RDFT_2d,
                         RDFTLayerTest,
                         ::testing::Combine(::testing::ValuesIn(shapes_forward_2d),
                                            ::testing::ValuesIn(model_types),
...
INSTANTIATE_TEST_SUITE_P(smoke_IRDFT_2d,
                         RDFTLayerTest,
                         ::testing::Combine(::testing::ValuesIn(shapes_inverse_2d),
                                            ::testing::ValuesIn(model_types),
                                            ::testing::ValuesIn(axes_2d),
                                            ::testing::ValuesIn(signal_sizes_2d),
                                            ::testing::Values(ov::test::utils::DFTOpType::INVERSE),
...
const std::vector<std::vector<int64_t>> axes_4d = {{0, 1, 2, 3}, {1, 0, -2, -1}};
...
INSTANTIATE_TEST_SUITE_P(smoke_RDFT_4d,
                         RDFTLayerTest,
                         ::testing::Combine(::testing::ValuesIn(shapes_forward_4d),
                                            ::testing::ValuesIn(model_types),
...
const std::vector<std::vector<int64_t>> axes_4d_2d = {{2, 3}, {1, -1}};

INSTANTIATE_TEST_SUITE_P(smoke_RDFT_4d_axes_2d,
                         RDFTLayerTest,
                         ::testing::Combine(::testing::ValuesIn(shapes_forward_4d),
                                            ::testing::ValuesIn(model_types),
...
INSTANTIATE_TEST_SUITE_P(smoke_IRDFT_4d,
                         RDFTLayerTest,
                         ::testing::Combine(::testing::ValuesIn(shapes_inverse_4d),
                                            ::testing::ValuesIn(model_types),
                                            ::testing::ValuesIn(axes_4d),
                                            ::testing::ValuesIn(signal_sizes_4d),
                                            ::testing::Values(ov::test::utils::DFTOpType::INVERSE),
...
INSTANTIATE_TEST_SUITE_P(smoke_IRDFT_4d_axes_2d,
                         RDFTLayerTest,
                         ::testing::Combine(::testing::ValuesIn(shapes_inverse_4d),
                                            ::testing::ValuesIn(model_types),
                                            ::testing::ValuesIn(axes_4d_2d),
