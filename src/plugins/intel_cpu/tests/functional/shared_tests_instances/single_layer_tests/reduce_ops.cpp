...
const auto params_one_axis = testing::Combine(testing::Values(std::vector<int>{0}),
...
const auto params_one_axis_logical = testing::Combine(testing::Values(std::vector<int>{0}),
                                                      testing::ValuesIn(op_types),
                                                      testing::ValuesIn(keep_dims),
...
const auto params_model_types = testing::Combine(testing::Values(std::vector<int>{1, 3}),
...
const auto params_model_types_ReduceL1 =
    testing::Combine(testing::Values(std::vector<int>{1, 3}),
                     testing::Values(op_types[1]),
                     testing::ValuesIn(keep_dims),
                     testing::Values(ov::test::utils::ReductionType::L1),
                     testing::Values(ov::element::f32, ov::element::f16, ov::element::i64, ov::element::i32),
                     testing::Values(std::vector<size_t>{2, 2, 2, 2}),
                     testing::Values(ov::test::utils::DEVICE_CPU));

const auto params_model_types_ReduceL2 = testing::Combine(testing::Values(std::vector<int>{1, 3}),
                                                          testing::Values(op_types[1]),
                                                          testing::ValuesIn(keep_dims),
...
const auto params_input_shapes = testing::Combine(testing::Values(std::vector<int>{0}),
                                                  testing::Values(op_types[1]),
                                                  testing::ValuesIn(keep_dims),
...
const auto params_reduction_types = testing::Combine(testing::Values(std::vector<int>{0, 1, 3}),
                                                     testing::Values(op_types[1]),
                                                     testing::ValuesIn(keep_dims),
                                                     testing::ValuesIn(reduction_types),
                                                     testing::Values(model_types[0]),
...
const auto params_reduction_types_logical = testing::Combine(testing::Values(std::vector<int>{0, 1, 3}),
                                                             testing::Values(op_types[1]),
                                                             testing::ValuesIn(keep_dims),
                                                             testing::ValuesIn(reduction_logical_types),
                                                             testing::Values(ov::element::boolean),
...
INSTANTIATE_TEST_SUITE_P(smoke_ReduceOneAxis, ReduceOpsLayerTest, params_one_axis, ReduceOpsLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Reduce,
                         ...
                         testing::Combine(testing::ValuesIn(decltype(axes){{0}, {1}}),
                                          ...
                                          testing::Values(true),
                                          testing::Values(ov::test::utils::ReductionType::Sum),
                                          testing::Values(ov::element::f32, ov::element::i32),
