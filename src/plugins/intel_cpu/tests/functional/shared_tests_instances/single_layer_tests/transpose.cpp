...
INSTANTIATE_TEST_SUITE_P(
    smoke_Transpose2D,
    TransposeLayerTest,
    ::testing::Combine(::testing::ValuesIn(order_2D),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Transpose4D,
    TransposeLayerTest,
    ::testing::Combine(::testing::ValuesIn(order_4D),
                       ::testing::ValuesIn(model_types),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Transpose5D,
    TransposeLayerTest,
    ::testing::Combine(::testing::ValuesIn(order_5D),
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shape_static_5D)),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
    TransposeLayerTest::getTestCaseName);

std::vector<std::vector<ov::Shape>> input_shape_static_6D = {{{2, 2, 2, 2, 2, 2}},
                                                             {{1, 10, 2, 3, 4, 5}},
                                                             {{2, 3, 4, 5, 6, 7}}};
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Transpose6D,
    TransposeLayerTest,
    ::testing::Combine(::testing::ValuesIn(order_6D),
                       ::testing::ValuesIn(model_types),
