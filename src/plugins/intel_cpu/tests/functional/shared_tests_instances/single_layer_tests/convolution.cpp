...
const std::vector<ov::element::Type> model_type = {ov::element::f32, ov::element::f16, ov::element::i32};
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Convolution1D_ExplicitPadding,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Convolution1D_AutoPadValid,
    ConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Convolution2D_SpecificWeightLayout,
    ConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Convolution3D_AutoPadValid,
    ConvolutionLayerTest,
