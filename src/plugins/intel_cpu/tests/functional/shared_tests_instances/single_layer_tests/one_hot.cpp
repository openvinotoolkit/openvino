...
const auto oneHotParams_ax =
    testing::Combine(testing::ValuesIn(arg_depth_type_ax),
...
const std::vector<ov::element::Type> arg_set_type_t = {ov::element::i8,
                                                       ov::element::u8,
                                                       ov::element::bf16,
                                                       ov::element::f32};
...
const auto oneHotParams_t =
    testing::Combine(testing::ValuesIn(arg_depth_type_t),
