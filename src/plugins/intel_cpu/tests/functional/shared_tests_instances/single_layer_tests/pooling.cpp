...
////* ========== Avg Pooling V16 ========== */
/* +========== Explicit Pad Ceil Rounding ========== */
const auto avgPooV16lExplicitPadCeilRoundingParams = ::testing::Combine(
        ::testing::ValuesIn(kernels),
        // TODO: Non 1 strides fails in reference implementation with error "The end corner is out of bounds at axis 3" thrown in the test body.
        ::testing::ValuesIn(strides),
        ::testing::ValuesIn(dilation),
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPoolV16_ExplicitPad_CeilRounding, AvgPoolingV16LayerTest,
                        ::testing::Combine(
                                avgPooV16lExplicitPadCeilRoundingParams,
                                ::testing::ValuesIn(model_types),
                                ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_static)),
                                ::testing::Values(ov::test::utils::DEVICE_CPU)),
                        AvgPoolingV16LayerTest::getTestCaseName);

std::vector<avgPoolV16LayerTestParams> psV16Params({avgPoolV16LayerTestParams({2, 2}, {2, 2}, {2, 2}, {0, 0}, {0, 0},
                        ov::op::RoundingType::CEIL, ov::op::PadType::EXPLICIT, false),
    avgPoolV16LayerTestParams({7, 7}, {1, 1}, {2, 2}, {0, 0}, {1, 1},
                        ov::op::RoundingType::CEIL, ov::op::PadType::EXPLICIT, false)});

INSTANTIATE_TEST_SUITE_P(smoke_AvgPoolV16_ExplicitPad_CeilRounding_corner, AvgPoolingV16LayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPoolV16_ExplicitPad_FloorRounding, AvgPoolingV16LayerTest,
                        ::testing::Combine(
                                avgPoolV16ExplicitPadFloorRoundingParams,
                                ::testing::ValuesIn(model_types),
                                ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_static)),
                                ::testing::Values(ov::test::utils::DEVICE_CPU)),
                        AvgPoolingV16LayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPoolV16_ExplicitPad_FloorRounding_5Dinput, AvgPoolingV16LayerTest,
                        ::testing::Combine(
                                avgPoolV16_ExplicitPad_FloorRounding_5Dinput_Params,
                                ::testing::ValuesIn(model_types),
                                ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_5d_2_static)),
                                ::testing::Values(ov::test::utils::DEVICE_CPU)),
                        AvgPoolingV16LayerTest::getTestCaseName);
...
/* ========== Same Upper Pad Floor Rounding 5D input========== */
const auto avgPoolV16_SameUpperPad_FloorRounding_5Dinput_Params = ::testing::Combine(
        ::testing::ValuesIn(kernel_3d),
        ::testing::ValuesIn(strides_3d),
        ::testing::ValuesIn(dilation_3d),
        ::testing::ValuesIn(pad_begins_3d),
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPoolV16_SameUpperPad_FloorRounding_5Dinput, AvgPoolingV16LayerTest,
                        ::testing::Combine(
                                avgPoolV16_SameUpperPad_FloorRounding_5Dinput_Params,
                                ::testing::ValuesIn(model_types),
                                ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_5d_2_static)),
                                ::testing::Values(ov::test::utils::DEVICE_CPU)),
                        AvgPoolingV16LayerTest::getTestCaseName);
...
/* ========== Same Lower Pad Ceil Rounding 5D input========== */
const auto avgPoolV16_SameLowerPad_CeilRounding_5Dinput_Params = ::testing::Combine(
        ::testing::ValuesIn(kernel_3d),
        ::testing::ValuesIn(strides_3d),
        ::testing::ValuesIn(dilation_3d),
        ::testing::ValuesIn(pad_begins_3d),
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPoolV16_SameLowerPad_CeilRounding_5Dinput, AvgPoolingV16LayerTest,
                        ::testing::Combine(
                                avgPoolV16_SameLowerPad_CeilRounding_5Dinput_Params,
                                ::testing::ValuesIn(model_types),
                                ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_5d_static)),
                                ::testing::Values(ov::test::utils::DEVICE_CPU)),
                        AvgPoolingV16LayerTest::getTestCaseName);
