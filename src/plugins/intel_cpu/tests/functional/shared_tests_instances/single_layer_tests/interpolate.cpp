...
const std::vector<ov::Shape> input_shapes_static = {{1, 4, 6, 6}};
...
const std::vector<std::vector<int64_t>> default_axes = {{0, 1, 2, 3}};

const std::vector<ov::Shape> target_shapes = {
    {1, 4, 8, 8},
};

const std::vector<std::vector<float>> default_scales = {{1.f, 1.f, 1.333333f, 1.333333f}};

std::map<std::string, std::string> additional_config = {};

const auto interpolateCasesWithoutNearest = ::testing::Combine(::testing::ValuesIn(modes_without_nearest),
...
const auto interpolateCases = ::testing::Combine(::testing::ValuesIn(nearest_mode),
                                                 ::testing::ValuesIn(shapeCalculationMode),
                                                 ::testing::ValuesIn(coordinateTransformModes),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Interpolate_Nearest,
    InterpolateLayerTest,
    ::testing::Combine(interpolateCases,
                       ::testing::ValuesIn(model_types),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_static)),
                       ::testing::ValuesIn(target_shapes),
                       ::testing::Values(ov::test::utils::DEVICE_CPU),
...
const std::vector<std::vector<float>> default_scalesTailTest = {{1.f, 1.f, 0.333333f, 1.833333f}};

const auto interpolateCasesWithoutNearestTail = ::testing::Combine(::testing::ValuesIn(modes_without_nearest),
                                                                   ::testing::ValuesIn(shapeCalculationMode),
                                                                   ::testing::ValuesIn(coordinateTransformModes),
                                                                   ::testing::ValuesIn(default_nearest_mode),
                                                                   ::testing::ValuesIn(antialias),
...
const auto interpolateCasesTail = ::testing::Combine(::testing::ValuesIn(nearest_mode),
                                                     ::testing::ValuesIn(shapeCalculationMode),
                                                     ::testing::ValuesIn(coordinateTransformModes),
                                                     ::testing::ValuesIn(nearest_modes),
                                                     ::testing::ValuesIn(antialias),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Interpolate_Basic_Down_Sample_Tail,
    InterpolateLayerTest,
    ::testing::Combine(interpolateCasesWithoutNearestTail,
                       ::testing::ValuesIn(model_types),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_static)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Interpolate_Nearest_Down_Sample_Tail,
    InterpolateLayerTest,
    ::testing::Combine(interpolateCasesTail,
                       ::testing::ValuesIn(model_types),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_static)),
                       ::testing::ValuesIn(target_shapes_tail_test),
                       ::testing::Values(ov::test::utils::DEVICE_CPU),
