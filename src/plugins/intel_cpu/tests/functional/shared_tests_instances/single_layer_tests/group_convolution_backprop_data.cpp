...
const auto groupConvBackpropData_1dParams_ExplicitPadding =
...
const auto groupConvBackpropData_1dParams_AutoPadValid = ::testing::Combine(::testing::ValuesIn(kernels_1d),
                                                                            ::testing::ValuesIn(strides_1d),
                                                                            ::testing::ValuesIn(pad_begins_1d),
                                                                            ::testing::ValuesIn(pad_ends_1d),
                                                                            ::testing::ValuesIn(dilations_1d),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_1d_ExplicitPadding,
    GroupConvBackpropLayerTest,
    ::testing::Combine(groupConvBackpropData_1dParams_ExplicitPadding,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_1d_AutoPadValid,
    GroupConvBackpropLayerTest,
    ::testing::Combine(groupConvBackpropData_1dParams_AutoPadValid,
                       ::testing::ValuesIn(model_types),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_1d)),
                       ::testing::ValuesIn(empty_output_shape),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
...
const std::vector<std::vector<ov::Shape>> input_shapes_2d = {{{1, 16, 10, 10}}, {{1, 32, 10, 10}}};
...
const auto groupConvBackpropData_2dParams_ExplicitPadding =
    ::testing::Combine(::testing::ValuesIn(kernels_2d),
                       ...
                       ::testing::Values(ov::op::PadType::EXPLICIT),
                       ::testing::ValuesIn(empty_output_padding));
const auto groupConvBackpropData_2dParams_AutoPadValid = ::testing::Combine(::testing::ValuesIn(kernels_2d),
                                                                            ::testing::ValuesIn(strides_2d),
                                                                            ::testing::ValuesIn(pad_begins_2d),
                                                                            ::testing::ValuesIn(pad_ends_2d),
                                                                            ::testing::ValuesIn(dilations_2d),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_2d_ExplicitPadding,
    GroupConvBackpropLayerTest,
    ::testing::Combine(groupConvBackpropData_2dParams_ExplicitPadding,
                       ::testing::ValuesIn(model_types),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_2d_AutoPadValid,
    GroupConvBackpropLayerTest,
    ::testing::Combine(groupConvBackpropData_2dParams_AutoPadValid,
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_2d)),
                       ::testing::ValuesIn(empty_output_shape),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_2d_OutputShapeDefined,
    GroupConvBackpropLayerTest,
    ::testing::Combine(groupConvBackpropData_2dParams_AutoPadValid,
                       ::testing::ValuesIn(model_types),
...
const auto conv_2dParams_ExplicitPadding_output_padding =
    ::testing::Combine(::testing::ValuesIn(kernels_2d),
...
const auto conv_2dParams_AutoPadValid_output_padding =
    ::testing::Combine(::testing::ValuesIn(kernels_2d),
                       ::testing::ValuesIn(test_strides_2d),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_2d_ExplicitPadding_output_paddingDefined,
    GroupConvBackpropLayerTest,
    ::testing::Combine(conv_2dParams_AutoPadValid_output_padding,
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_2d)),
                       ::testing::ValuesIn(empty_output_shape),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_2d_AutoPadding_output_paddingDefined,
    GroupConvBackpropLayerTest,
    ::testing::Combine(conv_2dParams_ExplicitPadding_output_padding,
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_2d)),
                       ::testing::ValuesIn(empty_output_shape),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
...
const std::vector<std::vector<ov::Shape>> input_shapes_3d = {{{1, 16, 5, 5, 5}}, {{1, 32, 5, 5, 5}}};
...
const auto groupConvBackpropData_3dParams_ExplicitPadding =
    ::testing::Combine(::testing::ValuesIn(kernels_3d),
                       ...
                       ::testing::Values(ov::op::PadType::EXPLICIT),
                       ::testing::ValuesIn(empty_output_padding));
const auto groupConvBackpropData_3dParams_AutoPadValid = ::testing::Combine(::testing::ValuesIn(kernels_3d),
                                                                            ::testing::ValuesIn(strides_3d),
                                                                            ::testing::ValuesIn(pad_begins_3d),
                                                                            ::testing::ValuesIn(pad_ends_3d),
                                                                            ::testing::ValuesIn(dilations_3d),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_3d_ExplicitPadding,
    GroupConvBackpropLayerTest,
    ::testing::Combine(groupConvBackpropData_3dParams_ExplicitPadding,
                       ::testing::ValuesIn(model_types),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_3d_AutoPadValid,
    GroupConvBackpropLayerTest,
    ::testing::Combine(groupConvBackpropData_3dParams_AutoPadValid,
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_3d)),
                       ::testing::ValuesIn(empty_output_shape),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_3d_OutputShapeDefined,
    GroupConvBackpropLayerTest,
    ::testing::Combine(groupConvBackpropData_3dParams_AutoPadValid,
                       ::testing::ValuesIn(model_types),
...
const auto conv_3dParams_ExplicitPadding_output_padding =
    ::testing::Combine(::testing::ValuesIn(kernels_3d),
...
const auto conv_3dParams_AutoPadValid_output_padding =
    ::testing::Combine(::testing::ValuesIn(kernels_3d),
                       ::testing::ValuesIn(test_strides_3d),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_3d_ExplicitPadding_output_paddingDefined,
    GroupConvBackpropLayerTest,
    ::testing::Combine(conv_3dParams_AutoPadValid_output_padding,
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_3d)),
                       ::testing::ValuesIn(empty_output_shape),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupConvBackpropData_3d_AutoPadding_output_paddingDefined,
    GroupConvBackpropLayerTest,
    ::testing::Combine(conv_3dParams_ExplicitPadding_output_padding,
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_3d)),
                       ::testing::ValuesIn(empty_output_shape),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
