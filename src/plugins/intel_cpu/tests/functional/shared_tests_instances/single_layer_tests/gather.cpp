...
const std::vector<ov::element::Type> model_types_tr_check = {ov::element::i64, ov::element::f16};
...
const auto gather7Params_1D =
    testing::Combine(testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_1d)),
...
const auto gather7Params_2D =
    testing::Combine(testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_2d)),
...
const auto gather7ParamsSubset_bd0 =
    testing::Combine(testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_4d)),
...
const auto gather7ParamsSubset_bd1 =
    testing::Combine(testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_4d)),
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather7_bd1,
                         Gather7LayerTest,
                         gather7ParamsSubset_bd1,
                         Gather7LayerTest::getTestCaseName);
...
const auto gather7ParamsSubset_bd2 =
    testing::Combine(testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_4d)),
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather7_bd2,
                         Gather7LayerTest,
                         gather7ParamsSubset_bd2,
                         Gather7LayerTest::getTestCaseName);
...
const auto gather7ParamsSubset_negative_bd =
    testing::Combine(testing::Values(ov::test::static_shapes_to_test_representation(input_shapes_4d)),
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather7_negative_bd,
                         Gather7LayerTest,
                         gather7ParamsSubset_negative_bd,
                         Gather7LayerTest::getTestCaseName);

///// GATHER-8 /////

const std::vector<std::vector<ov::Shape>> data_shapes_4d_gather8 =
    {{{10, 3, 1, 2}}, {{10, 3, 3, 1}}, {{10, 2, 2, 7}}, {{10, 2, 2, 2}}, {{10, 3, 4, 4}}, {{10, 2, 3, 17}}};
const std::vector<ov::Shape> idx_shapes_4d_gather8 = {{10, 1, 1},
                                                      {10, 1, 2},
                                                      {10, 1, 3},
                                                      {10, 2, 2},
                                                      {10, 1, 7},
...
const std::vector<std::vector<ov::Shape>> data_shapes_vec2_gather8 =
    {{{5, 4}}, {{11, 4}}, {{23, 4}}, {{35, 4}}, {{51, 4}}, {{71, 4}}};
const std::vector<ov::Shape> idx_shapes_vec2_gather8 = {{1}};

const std::vector<std::tuple<int, int>> axes_batches_vec2_gather8 = {{1, 0}};

const auto gatherParamsVec2 =
    testing::Combine(testing::ValuesIn(ov::test::static_shapes_to_test_representation(data_shapes_vec2_gather8)),
...
const auto gatherParamsVec3 =
    testing::Combine(testing::Values(ov::test::static_shapes_to_test_representation(data_shapes_vec3_gather8)),
