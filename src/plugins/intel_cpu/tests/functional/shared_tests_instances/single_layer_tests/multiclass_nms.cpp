...
const std::vector<std::vector<ov::Shape>> inStaticShapeParams1 = {{{3, 100, 4}, {3, 1, 100}},
                                                                  {{1, 10, 4}, {1, 100, 10}}};

const std::vector<std::vector<ov::test::InputShape>> inDynamicShapeParams1 = {
    // num_batches, num_boxes, 4
    {{{ov::Dimension::dynamic(), ov::Dimension::dynamic(), 4}, {{1, 10, 4}, {2, 100, 4}}},
     // num_batches, num_classes, num_boxes
     {{ov::Dimension::dynamic(), ov::Dimension::dynamic(), ov::Dimension::dynamic()}, {{1, 3, 10}, {2, 5, 100}}}},
    {{{ov::Dimension(1, 10), ov::Dimension(1, 100), 4}, {{1, 10, 4}, {2, 100, 4}}},
     {{{ov::Dimension(1, 10), ov::Dimension(1, 100), ov::Dimension(1, 100)}}, {{1, 3, 10}, {2, 5, 100}}}}};

/* input format #2 with 3 inputs: bboxes C, M, 4, scores C, M, roisnum N */
const std::vector<std::vector<ov::Shape>> inStaticShapeParams2 = {{{1, 10, 4}, {1, 10}, {1}},
                                                                  {{1, 10, 4}, {1, 10}, {10}},
                                                                  {{2, 100, 4}, {2, 100}, {1}},
                                                                  {{2, 100, 4}, {2, 100}, {10}}};
...
const std::vector<std::vector<ov::test::InputShape>> inDynamicShapeParams2 = {
    ...
    {{{ov::Dimension::dynamic(), ov::Dimension::dynamic(), 4}, {{1, 10, 4}, {2, 100, 4}}},
     // scores
     {{ov::Dimension::dynamic(), ov::Dimension::dynamic()}, {{1, 10}, {2, 100}}},
     // roisnum
     {{ov::Dimension::dynamic()}, {{1}, {10}}}},
    /*1*/
    {{{ov::Dimension(1, 10), ov::Dimension(1, 100), 4}, {{1, 10, 4}, {2, 100, 4}}},
     {{{ov::Dimension(1, 10), ov::Dimension(1, 100)}}, {{1, 10}, {2, 100}}},
     {{ov::Dimension::dynamic()}, {{1}, {10}}}},
    /*2*/
    {{{ov::Dimension(2), ov::Dimension(100), 4}, {{2, 100, 4}}},
     {{{ov::Dimension(2), ov::Dimension(100)}}, {{2, 100}}},
     {{ov::Dimension::dynamic()}, {{1}, {10}}}},
    /*3*/
    {{{ov::Dimension(3), ov::Dimension(2), 4}, {{3, 2, 4}}},
     {{{ov::Dimension(3), ov::Dimension(2)}}, {{3, 2}}},
     {{ov::Dimension::dynamic()}, {{1}, {10}}}}  // more images than num_boxes
};
...
const auto nmsParamsStatic_smoke1 =
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(inStaticShapeParams1)),
...
const auto nmsParamsDynamic_smoke1 =
    ::testing::Combine(::testing::ValuesIn(inDynamicShapeParams1),
                       ::testing::Combine(::testing::Values(ov::element::f32), ::testing::Values(ov::element::i32)),
                       ::testing::ValuesIn(nmsTopK),
                       ::testing::Combine(::testing::ValuesIn(iouThreshold),
                                          ::testing::ValuesIn(scoreThreshold),
...
INSTANTIATE_TEST_SUITE_P(smoke_MulticlassNmsLayerTest_dynamic1,
                         MulticlassNmsLayerTest,
                         nmsParamsDynamic_smoke1,
                         MulticlassNmsLayerTest::getTestCaseName);

const auto nmsParamsStatic_smoke2 =
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(inStaticShapeParams2)),
                       ::testing::Combine(::testing::Values(ov::element::f32), ::testing::Values(ov::element::i32)),
                       ::testing::ValuesIn(nmsTopK),
                       ::testing::Combine(::testing::ValuesIn(iouThreshold),
                                          ::testing::ValuesIn(scoreThreshold),
...
const auto nmsParamsDynamic_smoke2 =
    ::testing::Combine(::testing::ValuesIn(inDynamicShapeParams2),
                       ::testing::Combine(::testing::Values(ov::element::f32), ::testing::Values(ov::element::i32)),
                       ::testing::ValuesIn(nmsTopK),
                       ::testing::Combine(::testing::ValuesIn(iouThreshold),
                                          ::testing::ValuesIn(scoreThreshold),
...
INSTANTIATE_TEST_SUITE_P(smoke_MulticlassNmsLayerTest_static2,
                         ...
                         MulticlassNmsLayerTest::getTestCaseName);
INSTANTIATE_TEST_SUITE_P(smoke_MulticlassNmsLayerTest_dynamic2,
                         MulticlassNmsLayerTest,
                         nmsParamsDynamic_smoke2,
                         MulticlassNmsLayerTest::getTestCaseName);
}  // namespace