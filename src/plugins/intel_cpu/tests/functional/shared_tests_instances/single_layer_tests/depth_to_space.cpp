...
const std::vector<std::vector<ov::Shape>> input_shapes_bs2_static = {{{1, 4, 1, 1}},
                                                                     {{1, 4, 2, 2}},
                                                                     {{1, 4, 3, 3}},
                                                                     {{2, 32, 3, 3}},
                                                                     {{2, 16, 5, 4}},
...
const auto DepthToSpaceBS2 =
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_bs2_static)),
...
const std::vector<std::vector<ov::Shape>> input_shapes_bs3_static = {{{1, 9, 1, 1}},
                                                                     {{1, 9, 2, 2}},
                                                                     {{1, 9, 3, 3}},
                                                                     {{2, 36, 3, 3}},
                                                                     {{2, 27, 5, 4}},
...
const auto DepthToSpaceBS3 =
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_bs3_static)),
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(modes),
                       ::testing::Values(1, 3),
                       ::testing::Values(ov::test::utils::DEVICE_CPU));
