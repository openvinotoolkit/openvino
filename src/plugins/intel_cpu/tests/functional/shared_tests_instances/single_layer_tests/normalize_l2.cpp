...
const auto normL2params_1D =
    testing::Combine(testing::ValuesIn(axes_1d),
...
const auto normL2params_2D =
    testing::Combine(testing::ValuesIn(axes_2D),
                     testing::ValuesIn(eps),
                     testing::ValuesIn(eps_modes),
...
const auto normL2params_3D =
    testing::Combine(testing::ValuesIn(axes_3D),
                     testing::ValuesIn(eps),
                     testing::ValuesIn(eps_modes),
...
const auto normL2params_4D =
    testing::Combine(testing::ValuesIn(axes_4D),
                     testing::ValuesIn(eps),
                     testing::ValuesIn(eps_modes),
...
const auto normL2params_5D =
    testing::Combine(testing::ValuesIn(axes_5D),
                     testing::ValuesIn(eps),
                     testing::ValuesIn(eps_modes),
