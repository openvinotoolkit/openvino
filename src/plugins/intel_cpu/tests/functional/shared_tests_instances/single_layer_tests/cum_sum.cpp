...
const auto testCasesNegativeAxis =
    ::testing::Combine(::testing::Values(ov::test::static_shapes_to_test_representation({{4, 16, 3, 6, 5, 2}})),
...
const auto testCasesAxis_0 =
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(shapes_static)),
...
INSTANTIATE_TEST_SUITE_P(smoke_TestsCumSum_negative_axis,
                         CumSumLayerTest,
