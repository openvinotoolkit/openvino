...
const std::vector<std::vector<ov::Shape>> input_shapes_static = {{{8}},
                                                                 {{1, 16}},
                                                                 {{3, 19}},
                                                                 {{1, 32, 17}},
                                                                 {{1, 37, 9}},
...
const std::vector<bool> across_channels = {true, false};

const std::vector<bool> normalize_variance = {true, false};

const std::vector<double> epsilon = {0.000000001};

std::vector<ov::element::Type> model_types = {ov::element::f16, ov::element::f32};

const auto Mvnacross_channels =
...
const std::vector<std::vector<ov::Shape>> input_shapes_reduction_axes_static = {{{1, 10, 5, 17}}, {{1, 3, 8, 9}}};
...
INSTANTIATE_TEST_SUITE_P(smoke_TestsMVN_across_channels,
                         Mvn1LayerTest,
                         Mvnacross_channels,
...
std::vector<ov::element::Type> idx_types = {ov::element::i32, ov::element::i64};

const std::vector<std::string> epsMode = {"inside_sqrt", "outside_sqrt"};

const std::vector<float> epsilonF = {0.0001f};

const std::vector<std::vector<ov::Shape>> input_shapes_5d_static = {{{1, 10, 5, 7, 8}}, {{1, 3, 8, 9, 49}}};
...
const std::vector<std::vector<ov::Shape>> input_shapes_4d_static = {{{1, 10, 5, 17}}, {{1, 3, 8, 9}}};
...
const std::vector<std::vector<ov::Shape>> input_shapes_3d_static = {{{1, 32, 17}}, {{1, 37, 9}}};
...
const std::vector<std::vector<ov::Shape>> input_shapes_2d_static = {{{3, 5}}, {{2, 55}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_MVN_2D,
    Mvn6LayerTest,
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_2d_static)),
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(idx_types),
...
const std::vector<std::vector<ov::Shape>> input_shapes_1d_static = {{{3}}, {{9}}, {{55}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_MVN_1D,
    Mvn6LayerTest,
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(input_shapes_1d_static)),
                       ::testing::ValuesIn(model_types),
                       ::testing::ValuesIn(idx_types),
...
const std::vector<std::vector<ov::Shape>> input_shapes_decomposition_3d_static = {{{1, 32, 17}}, {{1, 37, 9}}};
...
INSTANTIATE_TEST_SUITE_P(smoke_Decomposition_3D,
                         ...
                         ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(
                                                input_shapes_decomposition_3d_static)),
                                            ::testing::ValuesIn(model_types),
                                            ::testing::ValuesIn(idx_types),
...
const std::vector<std::vector<ov::Shape>> input_shapes_decomposition_4d_static = {{{1, 16, 5, 8}}, {{2, 19, 5, 10}}};
