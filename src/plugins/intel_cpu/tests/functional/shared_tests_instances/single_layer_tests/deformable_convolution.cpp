...
const auto deformableConv2DParams_DeformableGroups_AutoPadExplicit =
    ::testing::Combine(::testing::ValuesIn(strides),
                       ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                       ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                       ::testing::ValuesIn(dilations),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_ExplicitPadding_NoModulation,
    DeformableConvolutionLayerTest,
    ::testing::Combine(deformableConv2DParams_ExplicitPadding,
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_ExplicitPadding_WithModulation,
    DeformableConvolutionLayerTest,
    ::testing::Combine(deformableConv2DParams_ExplicitPadding,
                       ::testing::Values(true),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_AutoPadValid_NoModulation,
    DeformableConvolutionLayerTest,
    ::testing::Combine(deformableConv2DParams_AutoPadValid,
                       ::testing::Values(false),
                       ::testing::ValuesIn(netPrecisions),
                       ::testing::Values(ov::test::static_shapes_to_test_representation(shapes_no_modulation)),
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_AutoPadValid_WithModulation,
    DeformableConvolutionLayerTest,
    ::testing::Combine(deformableConv2DParams_AutoPadValid,
                       ::testing::Values(true),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_DeformableGroups_ExplicitPadding_NoModulation,
                         DeformableConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_DeformableGroups_ExplicitPadding_WithModulation,
                         DeformableConvolutionLayerTest,
                         ::testing::Combine(deformableConv2DParams_DeformableGroups_AutoPadExplicit,
                                            ::testing::Values(true),
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(ov::test::static_shapes_to_test_representation(
                                                shapes_2d_deformable_groups_with_modulation)),
                                            ::testing::Values(ov::test::utils::DEVICE_CPU)),
                         DeformableConvolutionLayerTest::getTestCaseName);
...
const auto deformableConv2DParams_SingleTestCase =
    ::testing::Combine(::testing::ValuesIn(strides),
                       ::testing::ValuesIn(padBegins),
                       ::testing::ValuesIn(padEnds),
                       ::testing::ValuesIn(dilations),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_SingleTestCase_NoModulation,
    DeformableConvolutionLayerTest,
    ::testing::Combine(deformableConv2DParams_SingleTestCase,
                       ::testing::Values(false),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_DeformableConvolution2D_SingleTestCase_WithModulation,
    DeformableConvolutionLayerTest,
    ::testing::Combine(deformableConv2DParams_SingleTestCase,
                       ::testing::Values(true),
                       ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_MultipleGroups_NoModulation,
                         DeformableConvolutionLayerTest,
                         ::testing::Combine(::testing::Combine(::testing::ValuesIn(strides),
                                                               ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                                               ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                                               ::testing::ValuesIn(dilations),
                                            ...
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(ov::test::static_shapes_to_test_representation(
                                                shapes_multiple_groups_no_modulation)),
                                            ::testing::Values(ov::test::utils::DEVICE_CPU)),
                         DeformableConvolutionLayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_MultipleGroups_WithModulation,
                         DeformableConvolutionLayerTest,
                         ::testing::Combine(::testing::Combine(::testing::ValuesIn(strides),
                                                               ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                                               ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                            ...
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(ov::test::static_shapes_to_test_representation(
                                                shapes_multiple_groups_with_modulation)),
                                            ::testing::Values(ov::test::utils::DEVICE_CPU)),
                         DeformableConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_MultipleGroups_2_NoModulation,
                         DeformableConvolutionLayerTest,
                         ::testing::Combine(::testing::Combine(::testing::ValuesIn(strides),
                                                               ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                                               ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
...
INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_MultipleGroups_2_WithModulation,
                         DeformableConvolutionLayerTest,
                         ::testing::Combine(::testing::Combine(::testing::ValuesIn(strides),
                                                               ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                                               ::testing::Values(std::vector<ptrdiff_t>({0, 0})),
                                            ...
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(ov::test::static_shapes_to_test_representation(
                                                shapes_multiple_groups_2_with_modulation)),
                                            ::testing::Values(ov::test::utils::DEVICE_CPU)),
                         DeformableConvolutionLayerTest::getTestCaseName);
}  // namespace
