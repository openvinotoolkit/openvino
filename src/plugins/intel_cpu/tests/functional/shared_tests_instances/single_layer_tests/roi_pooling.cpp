...
const std::vector<ov::Shape> param_shapes = {{{1, 3, 8, 8}}, {{3, 4, 50, 50}}};

const std::vector<ov::Shape> coord_shapes = {{{1, 5}}, {{3, 5}}, {{5, 5}}};
...
const std::vector<ov::Shape> pooled_shapes_max = {{{1, 1}}, {{2, 2}}, {{3, 3}}, {{6, 6}}};

const std::vector<ov::Shape> pooled_shapes_bilinear = {{{1, 1}}, {{2, 2}}, {{3, 3}}, {{6, 6}}};
...
const auto test_ROIPooling_max = ::testing::Combine(::testing::ValuesIn(input_shapes),
...
INSTANTIATE_TEST_SUITE_P(smoke_TestsROIPooling_max,
                         ROIPoolingLayerTest,
                         test_ROIPooling_max,
                         ROIPoolingLayerTest::getTestCaseName);
INSTANTIATE_TEST_SUITE_P(smoke_TestsROIPooling_bilinear,
                         ROIPoolingLayerTest,
