...
const std::vector<std::vector<int64_t>> idx_value = {{0, 2, 4, 6, 1, 3, 5, 7}};

const auto scatter_update_case = ::testing::Combine(::testing::ValuesIn(combine_shapes(axes_shape_in_shape)),
