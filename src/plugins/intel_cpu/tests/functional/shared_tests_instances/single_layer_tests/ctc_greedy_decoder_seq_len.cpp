...
std::vector<std::vector<ov::Shape>> shapes1 = {{{1, 1, 1}}, {{1, 6, 10}}, {{3, 3, 16}}, {{5, 3, 55}}};
...
const auto basicCases =
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation({shapes1})),
                       ::testing::Values(10),
...
std::vector<std::vector<ov::Shape>> shapes2 = {{{2, 8, 11}}, {{4, 10, 55}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_set2,
    CTCGreedyDecoderSeqLenLayerTest,
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation({shapes2})),
