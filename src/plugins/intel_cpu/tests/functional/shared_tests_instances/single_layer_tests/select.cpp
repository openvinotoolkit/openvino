...
const std::vector<std::vector<ov::Shape>> none_shapes = {{{1}, {1}, {1}},
                                                         {{8}, {8}, {8}},
                                                         {{4, 5}, {4, 5}, {4, 5}},
                                                         {{3, 4, 5}, {3, 4, 5}, {3, 4, 5}},
...
const auto none_cases =
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(none_shapes)),
                       ::testing::ValuesIn(model_types),
                       ::testing::Values(ov::op::AutoBroadcastType::NONE),
                       ::testing::Values(ov::test::utils::DEVICE_CPU));

const std::vector<std::vector<ov::Shape>> numpy_shapes = {{{1}, {1}, {1}},
                                                          {{1}, {16}, {1}},
                                                          {{1}, {1}, {16}},
                                                          {{1}, {8}, {8}},
                                                          {{8}, {1}, {8}},
...
const auto numpy_cases =
    ::testing::Combine(::testing::ValuesIn(ov::test::static_shapes_to_test_representation(numpy_shapes)),
                       ::testing::ValuesIn(model_types),
