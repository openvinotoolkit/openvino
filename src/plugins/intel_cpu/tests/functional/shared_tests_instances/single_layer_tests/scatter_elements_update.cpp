...
const std::vector<std::vector<size_t>> idx_value = {{1, 0, 4, 6, 2, 3, 7, 5}};
...
const auto scatter_elt_update_cases = ::testing::Combine(::testing::ValuesIn(combine_shapes(axesShapeInShape)),
