...
const std::vector<ov::element::Type> model_types = {ov::element::u8, ov::element::u16, ov::element::f32};

const std::vector<int> axes = {-4, -3, -2, -1, 0, 1, 2, 3};
const std::vector<int> groups = {1, 2, 3, 6};

const auto shuffle_channels_params_4D = ::testing::Combine(::testing::ValuesIn(axes), ::testing::ValuesIn(groups));

INSTANTIATE_TEST_SUITE_P(
    smoke_ShuffleChannels4D,
    ShuffleChannelsLayerTest,
    ::testing::Combine(shuffle_channels_params_4D,
...
// ND support tests
INSTANTIATE_TEST_SUITE_P(
    smoke_ShuffleChannels6D,
    ShuffleChannelsLayerTest,
    ::testing::Combine(::testing::Values(std::tuple<int, int>(2, 3)),
                       ::testing::ValuesIn(model_types),
