...
static const std::vector<ov::element::Type> precisionsCPUInternal = {ov::element::f32};

static const std::vector<std::size_t> batchSizesCPUInternal = {1};
...
INSTANTIATE_TEST_SUITE_P(
    smoke_CachingSupportCase_CPU_Float,
    CompileModelCacheTestBase,
...
INSTANTIATE_TEST_SUITE_P(smoke_CachingSupportCase_CPU_Internal,
                         CompileModelCacheTestBase,
                         ::testing::Combine(::testing::ValuesIn(internal_functions_cpu()),
...
const std::vector<ov::AnyMap> autoConfigs = {{ov::device::priorities(ov::test::utils::DEVICE_CPU)}};
