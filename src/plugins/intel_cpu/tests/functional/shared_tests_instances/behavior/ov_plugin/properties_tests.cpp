...
INSTANTIATE_TEST_SUITE_P(smoke_BehaviorTests,
                         ...
                         ::testing::Values(CommonTestUtils::DEVICE_CPU, CommonTestUtils::DEVICE_AUTO));
...
const std::vector<ov::AnyMap> configsDevicePropertiesDouble = {
    {ov::device::properties("CPU", ov::num_streams(2)), ov::num_streams(4)},
    {ov::device::properties("CPU", ov::num_streams(2)),
     ov::device::properties(ov::AnyMap{{"CPU", ov::AnyMap{ov::num_streams(1)}}}),
     ov::num_streams(4)},
    {ov::device::properties("CPU", ov::num_streams(2)), ov::device::properties("CPU", ov::num_streams(1))},
