...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_MatMulFQ,
                         MatMulFQ,
                         ::testing::Combine(::testing::ValuesIn(input_shapes),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Snippets_MatMulBiasQuantized,
    MatMulBiasQuantized,
    ::testing::Combine(::testing::ValuesIn(std::vector<std::vector<ov::PartialShape>>{
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Snippets_MatMulQuantized,
    MatMulQuantized,
    ::testing::Combine(::testing::Values(std::vector<ov::PartialShape>{{1, 16, 128, 64}, {1, 16, 64, 128}, {128, 64}}),
                       ::testing::ValuesIn(quantized_precisions()),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Snippets_MatMulQuantizedSoftmax,
    MatMulQuantizedSoftmax,
    ::testing::Combine(::testing::Values(std::vector<ov::PartialShape>{{1, 16, 128, 64}, {1, 16, 64, 128}, {128, 64}}),
                       ::testing::ValuesIn(quantized_precisions()),
                       ::testing::Values(3),  // Subgraph + Reshape + Subgraph
                       ::testing::Values(2),  // Tokenized [MatMul+FQ+Matmul] and [FQ]
