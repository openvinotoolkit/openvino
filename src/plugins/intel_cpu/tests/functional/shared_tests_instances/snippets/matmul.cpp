...
std::vector<std::vector<ov::test::InputShape>> input_shapes{
    ...
    { {{}, {{1, 1, 128, 512}}},   {{}, {{1, 1, 512, 128}}} },
    { {{}, {{1, 1, 128, 1024}}},   {{}, {{1, 1, 1024, 128}}} },
    { {{}, {{1, 1, 128, 2500}}},   {{}, {{1, 1, 2500, 128}}} },
    { {{}, {{1, 1, 128, 2048}}},   {{}, {{1, 1, 2048, 128}}} },
    { {{}, {{1, 1, 128, 4096}}},   {{}, {{1, 1, 4096, 128}}} },
    { {{}, {{1, 1, 128, 4096 * 2}}},   {{}, {{1, 1, 4096 * 2, 128}}} },
    { {{}, {{1, 1, 128, 4096 * 4}}},   {{}, {{1, 1, 4096 * 4, 128}}} },
    { {{}, {{1, 1, 128, 4096 * 8}}},   {{}, {{1, 1, 4096 * 8, 128}}} },
