...
std::vector<ov::test::InputShape> inShapesStatic1{{{}, {{1, 16, 29, 1}}},
                                                  ...
                                                  {{}, {{1, 16, 29, 16}}},
                                                  {{}, {{1, 16, 29, 31}}}};
std::vector<ov::test::InputShape> inShapesStatic2{{{}, {{1, 16, 29, 1}}}, {{}, {{1, 16, 1, 1}}}, {{}, {{1, 1, 1, 1}}}};

INSTANTIATE_TEST_SUITE_P(
    smoke_Snippets_Eltwise,
    Add,
    ::testing::Combine(::testing::ValuesIn(inShapesStatic1),
...
std::vector<std::vector<InputShape>> inShapesAddPair{
    ...
    // DS
    {{{1, -1, {1, 10}, {1, 33}},
      {{1, 128, 1, 1}, {1, 128, 1, 9}, {1, 128, 1, 17}, {1, 128, 1, 29}, {1, 128, 9, 1}, {1, 128, 1, 1}}},
     {{{1, 1}, {128, 128}, {1, 10}, {1, 33}},
      {{1, 128, 1, 1}, {1, 128, 1, 9}, {1, 128, 1, 17}, {1, 128, 1, 29}, {1, 128, 1, 30}, {1, 128, 1, 1}}}},
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Snippets_Eltwise,
    AddPair,
    ::testing::Combine(::testing::ValuesIn(inShapesAddPair),
                       ::testing::Values(ov::element::f32),
                       ::testing::Values(1),
                       ::testing::Values(1),  // Subgraph is created, since the inputs are followed by converts
                       ::testing::Values(ov::test::utils::DEVICE_CPU)),
...
std::vector<ov::test::InputShape> inShapesAddConst{
    {{}, {{1, 2, 3, 32}}},
    {{}, {{1, 3, 17, 33}}},
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Snippets_Eltwise,
    AddConst,
    ::testing::Combine(::testing::ValuesIn(inShapesAddConst),
