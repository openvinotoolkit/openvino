...
std::vector<std::vector<InputShape>> inShapesAddPair {
        ...
        {{{1, -1, 1, {1, 32}}, {{1, 16, 1, 32}, {1, 16, 1, 32}, {1, 16, 1, 32}, {1, 16, 1, 32}, {1, 16, 1, 17}}},
         {{1, -1, 1, {1, 32}}, {{1, 16, 1, 32}, {1, 16, 1, 32}, {1, 16, 1, 1}, {1, 16, 1, 32}, {1, 16, 1, 1}}}},
        {{{2, 3, 3, -1, 10, -1, 10, -1}, {{2, 3, 3, 4, 10, 6, 10, 33}, {2, 3, 3, 2, 10, 1, 10, 33}, {2, 3, 3, 4, 10, 6, 10, 33}, {2, 3, 3, 3, 10, 2, 10, 15}}},
         {{2, 3, 3, -1, 10, -1, 10, -1}, {{2, 3, 3, 4, 10, 6, 10, 33}, {2, 3, 3, 2, 10, 1, 10, 1}, {2, 3, 3, 4, 10, 6, 10, 33}, {2, 3, 3, 3, 10, 2, 10, 1}}}},
        {{{-1}, {{128}, {32}, {32}, {128}, {30}, {130}}},
         {{-1}, {{128}, {1}, {32}, {128}, {1}, {130}}}},
};
