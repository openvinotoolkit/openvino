...
const std::vector<CheckBroadcastTestCaseParams> test_cases = {
    ...
    {{{{}, {{1, 3, 4, 4}}}, {{}, {{4, 4}}}}, ov::op::AutoBroadcastSpec(ov::op::AutoBroadcastType::PDPD, -1), 1, 0},
    {{{{}, {{1, 3, 4, 4}}}, {{}, {{4, 4}}}}, ov::op::AutoBroadcastSpec(ov::op::AutoBroadcastType::PDPD, 2), 1, 0},
    // DS
    ...
    {{{{}, {{1, 3, 4, 4}}}, {{}, {{1, 3, 4, 4}}}},
     ...
     1,
     1},
    {{{{}, {{1, 3, 4, 4}}}, {{}, {{1, 3, 4, 4}}}}, ov::op::AutoBroadcastSpec(ov::op::AutoBroadcastType::PDPD, 0), 1, 1},
    // DS
    {{{{1, 3, -1, {1, 4}}, {{1, 3, 4, 4}, {1, 3, 1, 3}, {1, 3, 4, 4}}},
      {{-1, 3, {1, 4}, {1, 4}}, {{1, 3, 4, 4}, {1, 3, 1, 3}, {1, 3, 4, 4}}}},
     ov::op::AutoBroadcastSpec(ov::op::AutoBroadcastType::PDPD, -1),
     1,
     1},
    {{{{1, 3, -1, {1, 4}}, {{1, 3, 4, 4}, {1, 3, 1, 3}, {1, 3, 4, 4}}},
    ...
    // any other PDPD
    {{{{}, {{1, 3, 4, 4}}}, {{}, {{4, 4}}}}, ov::op::AutoBroadcastSpec(ov::op::AutoBroadcastType::NUMPY, -1), 1, 1},
    {{{{}, {{1, 3, 4, 4}}}, {{}, {{4, 4}}}}, ov::op::AutoBroadcastSpec(ov::op::AutoBroadcastType::NUMPY, 0), 1, 1},
    {{{{}, {{1, 3, 4, 4}}}, {{}, {{4, 4}}}}, ov::op::AutoBroadcastSpec(ov::op::AutoBroadcastType::NUMPY, 2), 1, 1},
    // DS
    {{{{1, 3, -1, {1, 4}}, {{1, 3, 4, 4}, {1, 3, 1, 3}, {1, 3, 4, 4}}}, {{-1, {1, 4}}, {{4, 4}, {1, 3}, {4, 4}}}},
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_CheckBroadcast,
                         CheckBroadcast,
