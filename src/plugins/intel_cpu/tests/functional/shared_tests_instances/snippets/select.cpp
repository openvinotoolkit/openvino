...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_Select,
                         Select,
                         ::testing::Combine(::testing::ValuesIn(inShapes_a),
...
// DS
std::vector<ov::test::InputShape> inShapesDynamic_a{
    {{1, {1, 5}, -1, 35}, {{1, 5, 5, 35}, {1, 1, 1, 35}, {1, 5, 5, 35}}}};
std::vector<ov::test::InputShape> inShapesDynamic_b{{{-1}, {{1}, {1}, {1}}}};
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_Select_Dynamic,
                         Select,
                         ::testing::Combine(::testing::ValuesIn(inShapesDynamic_a),
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_BroadcastSelect,
                         BroadcastSelect,
                         ::testing::Combine(::testing::ValuesIn(inShapes0),
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_BroadcastSelect_Dynamic,
                         BroadcastSelect,
                         ::testing::Combine(::testing::ValuesIn(inShapes0_d),
