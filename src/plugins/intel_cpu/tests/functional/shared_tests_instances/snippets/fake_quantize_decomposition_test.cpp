...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_FQDecomposition_Scalars,
                         FakeQuantizeDecompositionTest,
                         ::testing::Combine(::testing::ValuesIn(testValuesDecompositionScalars),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    FakeQuantizeDecompositionTest,
    ::testing::Combine(::testing::Values(testValuesDecompositionPerChannel[0]),
                       ::testing::ValuesIn(operations),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    FakeQuantizeDecompositionTest,
    ::testing::Combine(::testing::Values(testValuesDecompositionPerChannel[1]),
                       ::testing::ValuesIn(operations),
...
const std::vector<TestValues> testValuesLegacyFuse = {
    {ov::element::f32, ov::Shape{1, 3, 16, 16}, ov::element::f32, 1.f, {{1, 3, 1, 1}, {1, 3, 1, 1}, {}, {}}},
    {ov::element::f32, ov::Shape{1, 3, 16, 16}, ov::element::f32, 1.f, {{}, {}, {1, 3, 1, 1}, {1, 3, 1, 1}}},
    {ov::element::f32, ov::Shape{1, 3, 16, 16}, ov::element::f32, 1.f, {{}, {}, {}, {}}},
    {ov::element::f32,
     ov::Shape{1, 3, 16, 16},
     ov::element::f32,
     1.f,
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets,
                         FakeQuantizeDecompositionTest,
                         ::testing::Combine(::testing::ValuesIn(testValuesLegacyFuse),
                                            ::testing::ValuesIn(operations),
                                            // reorder (nChw[16|8]c) + MaxPool + reorder(nhwc) + Convolution(with
                                            // internal weight reordering) + reorder(nchw)
