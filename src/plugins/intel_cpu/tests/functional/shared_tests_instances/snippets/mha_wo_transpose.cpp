...
std::vector<std::vector<ov::test::InputShape>> originalShape_4D_repack {
    { {{}, {{1, 1, 4096, 256}}}, {{}, {{1, 1, 256, 24576}}}, {{}, {{1, 1, 24576, 240}}} },
};
INSTANTIATE_TEST_SUITE_P(
    smoke_Snippets_MHAWOTransposeFP32_repack,
    MHAWOTranspose,
    ::testing::Combine(::testing::ValuesIn(originalShape_4D_repack),
                       ::testing::ValuesIn(precision_f32(3)),
                       ::testing::Values(ov::element::f32),
