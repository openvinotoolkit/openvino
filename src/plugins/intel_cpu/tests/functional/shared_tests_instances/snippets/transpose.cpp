...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_Transpose_3D,
                         Transpose,
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_Transpose_4D,
                         Transpose,
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_TransposeMul,
                         TransposeMul,
                         ::testing::Combine(::testing::Values(ov::PartialShape{2, 31, 3, 5}),
