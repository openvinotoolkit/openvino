...
std::vector<std::vector<InputShape>> transposedShape_4D(bool with_static = true, bool with_dynamic = true) {
    ...
    if (with_dynamic) {
        std::vector<std::vector<ov::test::InputShape>> dynamic_shapes = {
            ...
            {
                {PartialShape{-1, -1, -1, -1}, {{1, 128, 3, 64}, {2, 16, 2, 100}, {1, 1, 3, 64}, {1, 128, 3, 64}}},
                {PartialShape{-1, -1, -1, -1}, {{1, 128, 1, 64}, {2, 128, 2, 100}, {1, 128, 1, 64}, {1, 128, 1, 64}}},
                {PartialShape{-1, -1, -1, -1}, {{2, 1, 128, 128}, {2, 2, 16, 128}, {1, 1, 1, 128}, {2, 1, 128, 128}}},
                {PartialShape{-1, -1, -1, -1}, {{1, 128, 3, 64}, {2, 128, 2, 100}, {1, 128, 3, 64}, {1, 128, 3, 64}}},
            },
            {
