...
std::vector<std::vector<ov::test::InputShape>> inputShapes_4D_dynamic{
        ...
        },
        {
            ...
            {PartialShape{-1, -1, 12, 64}, {{1, 35, 12, 64}, {2, 10, 12, 64}, {2, 16, 12, 64}, {2, 10, 12, 64}, {1, 35, 12, 64}}},
            {PartialShape{-1, 12, -1, -1}, {{2, 12, 70, 35}, {1, 12, 20, 10}, {1, 12, 20, 16}, {1, 12, 20, 1},  {2, 12, 70, 35}}},
            {PartialShape{-1, -1, 12, 64}, {{1, 35, 12, 64}, {1, 10, 12, 64}, {1, 16, 12, 64}, {1, 10, 12, 64}, {1, 35, 12, 64}}},
        },
        {
            {PartialShape{-1, -1, 12, -1},  {{1, 197, 12, 197}, {1, 128, 12, 128}, {1, 12, 12, 128}}},
            {PartialShape{-1, 197, 12, -1}, {{1, 197, 12, 197}, {1, 197, 12, 128}, {1, 197, 12, 128}}},
            {PartialShape{-1, 12, -1, 197}, {{1, 12, 197, 197}, {1, 12, 128, 197}, {1, 12, 12, 197}}},
            {PartialShape{-1, 197, 12, -1}, {{1, 197, 12, 197}, {1, 197, 12, 128}, {1, 197, 12, 128}}},
        }
};
...
std::vector<std::vector<ov::test::InputShape>> inputShapes_4D_WithMul_dynamic{
        ...
        },
        {
            {PartialShape{-1, -1, 12, 64}, {{1, 70, 12, 64}, {1, 20, 12, 64}, {1, 20, 12, 64}, {1, 20, 12, 64}, {1, 70, 12, 64}}},
            {PartialShape{-1, -1, 12, 64}, {{1, 35, 12, 64}, {2, 10, 12, 64}, {2, 16, 12, 64},  {2, 10, 12, 64}, {1, 35, 12, 64}}},
            {PartialShape{-1, 12, 64, -1}, {{1, 12, 64, 35}, {1, 12, 64, 10}, {1, 12, 64, 16}, {1, 12, 64, 1},  {1, 12, 64, 35}}},
            {PartialShape{-1, 12, -1, -1}, {{2, 12, 70, 35}, {1, 12, 20, 10}, {1, 12, 20, 16}, {1, 12, 20, 1},  {2, 12, 70, 35}}},
            {PartialShape{-1, -1, 12, 64}, {{1, 35, 12, 64}, {1, 10, 12, 64}, {1, 16, 12, 64}, {1, 10, 12, 64}, {1, 35, 12, 64}}},
        }
};
