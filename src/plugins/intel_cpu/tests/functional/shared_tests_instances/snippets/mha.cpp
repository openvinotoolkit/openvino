...
//        {{1, 32, 12, 35}, {1, 128, 12, 35}, {1, 12, 32, 128}, {1, 128, 12, 60}},
//// Perf test 1
//     {{1, 128, 12, 64}, {1, 128, 12, 64}, {1, 1, 1, 128}, {1, 128, 12, 64}},
//// Perf test 2
//        {{1, 256, 12, 128}, {1, 256, 12, 128}, {1, 1, 1, 256}, {1, 256, 12, 128}},
//// Perf test 3
//        {{1, 256, 12, 128}, {1, 512, 12, 128}, {1, 1, 1, 512}, {1, 512, 12, 128}},
//// Perf test 4
       {{1, 512, 12, 256}, {1, 512, 12, 256}, {1, 1, 1, 512}, {1, 512, 12, 256}},
        // {{1, 12, 128, 64}, {1, 128, 12, 64}, {1, 128, , 128}, {1, 128, 12, 64}},
        // {{1, 32, 12, 35}, {1, 64, 12, 35}, {1, 12, 32, 64}, {1, 64, 12, 60}},
        //  {{1, 128, 12, 64}, {1, 128, 12, 64}, {1, 12, 128, 128}, {1, 128, 12, 64}},
        //  {{1, 128, 16, 64}, {1, 128, 16, 64}, {1, 16, 1, 1}, {1, 128, 16, 64}},
        //  {{1, 128, 16, 64}, {1, 128, 16, 64}, {1, 1, 16, 128}, {1, 128, 16, 64}},
