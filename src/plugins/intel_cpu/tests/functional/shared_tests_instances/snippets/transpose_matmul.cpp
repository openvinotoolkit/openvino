...
std::vector<std::vector<ov::test::InputShape>> transpose_input_shapes{
        {STATIC_SHAPE(1, 49, 2, 23), STATIC_SHAPE(2, 2, 23, 39)}
};
...
std::vector<std::vector<ov::test::InputShape>> transpose_input_shapes{
        {STATIC_SHAPE(2, 1, 49, 13), STATIC_SHAPE(1, 13, 3, 39)}
};
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_MatMult, TransposeMatMul,
                         ::testing::Combine(
                                 ::testing::ValuesIn(transpose_input_shapes),
...
std::vector<std::vector<ov::test::InputShape>> transpose_input_shapes{
        {STATIC_SHAPE(2, 1, 49, 13), STATIC_SHAPE(1, 2, 13, 39)}
};
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_MatMult, TransposeMatMul,
                         ::testing::Combine(
                                 ::testing::ValuesIn(transpose_input_shapes),
...
std::vector<std::vector<ov::test::InputShape>> explicit_transpose_input_shapes{
        {STATIC_SHAPE(1, 2, 69, 43), STATIC_SHAPE(2, 49, 2, 43)}
};
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_ExplicitTransposeMatMul, ExplicitTransposeMatMul,
                         ::testing::Combine(
                                 ::testing::ValuesIn(explicit_transpose_input_shapes),
...
std::vector<std::vector<ov::test::InputShape>> explicit_transpose_bias_input_shapes{
        {STATIC_SHAPE(1, 2, 69, 43), STATIC_SHAPE(2, 49, 2, 43), STATIC_SHAPE(1, 1, 69, 49)}
};
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_TransposeMatMulBias, ExplicitTransposeMatMulBias,
                         ::testing::Combine(
                                 ::testing::ValuesIn(explicit_transpose_bias_input_shapes),
                                 ::testing::Values(1), // Transpose on second input
                                 ::testing::ValuesIn(precisions()),
                                 ::testing::Values(1), // Subgraph;
                                 ::testing::Values(1), // Tokenized MatMul+Bias
