...
std::vector<std::vector<ov::PartialShape>> transpose_input_shapes{{{1, 49, 2, 23}, {2, 2, 23, 39}}};
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_MatMult,
                         TransposeMatMul,
                         ::testing::Combine(::testing::ValuesIn(transpose_input_shapes),
...
std::vector<std::vector<ov::PartialShape>> transpose_input_shapes{{{2, 1, 49, 13}, {1, 13, 3, 39}}};
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_MatMult,
                         TransposeMatMul,
                         ::testing::Combine(::testing::ValuesIn(transpose_input_shapes),
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_TransposeMatMulFQ,
                         TransposeMatMulFQ,
                         ::testing::Combine(::testing::ValuesIn(transpose_input_shapes),
                                            ::testing::Values(1),  // Transpose on 1st Matmul input
...
std::vector<std::vector<ov::PartialShape>> transpose_input_shapes{{{2, 1, 49, 13}, {1, 2, 13, 39}}};
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_MatMult,
                         TransposeMatMul,
                         ::testing::Combine(::testing::ValuesIn(transpose_input_shapes),
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_ExplicitTransposeMatMul,
                         ExplicitTransposeMatMul,
                         ::testing::Combine(::testing::Values(std::vector<ov::PartialShape>{{1, 2, 69, 43},
                                                                                            {2, 49, 2, 43}}),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_Snippets_TransposeMatMulBias,
    ExplicitTransposeMatMulBias,
    ::testing::Combine(::testing::Values(std::vector<ov::PartialShape>{{1, 2, 69, 43}, {2, 49, 2, 43}, {1, 1, 69, 49}}),
                       ::testing::Values(1),  // Transpose on second input
                       ::testing::ValuesIn(precisions()),
                       ::testing::Values(1),  // Subgraph;
                       ::testing::Values(1),  // Tokenized MatMul+Bias
