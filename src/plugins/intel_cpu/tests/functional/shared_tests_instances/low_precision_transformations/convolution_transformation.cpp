...
const std::vector<LayerTestsDefinitions::ConvolutionTransformationParam> params = {
    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, false, {}, false, "Convolution", "f32"},
    {{}, false, {255ul, ov::Shape{1, 1, 1, 1}, {0.f}, {254.f}, {-12.7f}, {12.7f}}, false, "Convolution", "f32"},
    ...
    {{256ul, ov::Shape{1}, {0.f}, {255.f}, {-18.7f}, {18.8f}},
     ...
     {255ul,
      ...
      {-0.6f},
      {0.6f},
      {-1.52806e-39f, -0.2f, -0.3f, -0.3f, -0.2f, -0.1f},
      {1.52806e-39f, 0.2f, 0.3f, 0.3f, 0.2f, 0.1f}},
     false,
     "Convolution",
     "u8"},
...
const std::vector<ov::Shape> shapes = {{1, 3, 16, 16}, {4, 3, 16, 16}};
...
const std::vector<ov::Shape> shapes = {{1, 3, 16}, {4, 3, 16}};
