...
const std::vector<bool> isConvertOnConstants = {false, true};
...
const std::vector<FakeQuantizeTransformationParam> fakeQuantizeOnDataValues = {
    ...
    {{256ul, {}, {0.f}, {0.f}, {0.f}, {0.f}}, "Pooling", "u8"},
    {{16ul, {}, {0.f}, {1.5f}, {0.f}, {1.5f}}, "Pooling", "u8"},
    {{16ul, {}, {-0.8f}, {0.7f}, {-0.8f}, {0.7f}}, "Pooling", "i8"},
    // INT16, INT32 FQ's are transformed, but updatePrecision = false for inference on CPU Plugin and inferred via FP32
    {{65536, {}, {0.f}, {65.535f}, {0.f}, {65.535f}}, "Pooling", "f32"},
    {{65536, {}, {-32.768f}, {32.767f}, {-32.768f}, {32.767f}}, "Pooling", "f32"},
    {{4294967296, {}, {0.f}, {4.294967295f}, {0.f}, {4.294967295f}}, "Pooling", "f32"},
    {{4294967296, {}, {-2.147483648f}, {2.147483647f}, {-2.147483648f}, {2.147483647f}}, "Pooling", "f32"},
    // nGraph: I8->FP32 Convert is not supported
