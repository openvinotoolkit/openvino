...
const std::vector<LayerTestsDefinitions::MoveFakeQuantizeTransformationParam> params = {
    ...
    // with ReLU operation
    {3, "relu", {256ul, {}, {-12.7f}, {12.7f}, {-12.7f}, {12.7f}}, {}, {}, "Concatenation", "u8", 1},
    // Q/DQ
    {3,
     "",
    ...
    {3,
     ...
     {
         {ov::element::f32},
         {{-127.f, -127.f / 2.f, -127.f / 3.f, -127.f / 4.f, -127.f / 5.f, -127.f / 6.f},
          ov::element::f32,
          {1, 6, 1, 1}},
         {0.01f},
     },
...
const std::vector<std::vector<ov::PartialShape>> shapes = {{{1, 1, 16, 16}, {1, 2, 16, 16}, {1, 3, 16, 16}},
...
const std::vector<LayerTestsDefinitions::MoveFakeQuantizeTransformationParam> params = {
    // negative axis
    {3, "", {256ul, {}, {-1.28f}, {1.27f}, {-1.28f}, {1.27f}}, {}, {}, "Concatenation", "i8", -1},
};
