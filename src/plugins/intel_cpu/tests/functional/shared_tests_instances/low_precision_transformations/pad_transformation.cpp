...
const std::vector<ov::PartialShape> inputShapes = {{1, 3, 16, 16}, {4, 3, 16, 16}};

const std::vector<ov::pass::low_precision::LayerTransformation::Params> trasformationParamValues = {
    LayerTestsUtils::LayerTransformationParamsNGraphFactory::createParamsU8I8()};

namespace commonTestCases {
const std::vector<ov::op::PadMode> padModes = {ov::op::PadMode::CONSTANT,
                                               ov::op::PadMode::EDGE,
...
const std::vector<LayerTestsDefinitions::PadTransformationParam> params = {
    // tensor quantization
    {{256ul, ov::Shape{1, 1, 1, 1}, {-2.f}, {10.5f}, {-2.f}, {10.5f}}, {0, 0, 1, 1}, {0, 0, 1, 1}, 0.f, "Pad", "f32"},
    {{256ul, ov::Shape{1, 1, 1, 1}, {-2.f}, {10.5f}, {-2.f}, {10.5f}}, {0, 0, -1, 1}, {0, 0, 1, -1}, 0.f, "Pad", "f32"},
    {{256ul, ov::Shape{1, 1, 1, 1}, {-2.f}, {10.5f}, {-2.f}, {10.5f}}, {0, 0, 0, 0}, {0, 0, -1, -1}, 0.f, "Pad", "u8"},
    // tensor quantization with subtract, non zero padValue and pad by unique dimension
    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {25.5f}, {0.f}, {12.8f}}, {0, 0, 2, 0}, {0, 0, 1, 0}, 2.f, "Pad", "u8"},

    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {25.5f}, {0.f}, {12.8f}}, {0, 0, 2, 0}, {0, 0, -1, 0}, 2.f, "Pad", "u8"},
    {{256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {25.5f}, {0.f}, {12.8f}}, {0, 0, -1, 0}, {0, 0, -1, 0}, 2.f, "Pad", "u8"},
    ...
    {{256ul, ov::Shape{1, 3, 1, 1}, {-2.f, -4.f, -6.f}, {10.5f, 8.5f, 6.5f}, {-2.f, -4.f, -6.f}, {10.5f, 8.5f, 6.5f}},
     {0, 0, 1, 1},
     {0, 0, 1, 1},
     0.f,
     "Pad",
...
const std::vector<ov::op::PadMode> modesWithoutConstant = {ov::op::PadMode::EDGE,
                                                           ov::op::PadMode::REFLECT,
                                                           ov::op::PadMode::SYMMETRIC};

const std::vector<LayerTestsDefinitions::PadTransformationParam> params = {
    // tensor quantization
    {{256ul, ov::Shape{1, 1, 1, 1}, {-2.f}, {10.5f}, {-2.f}, {10.5f}}, {0, 0, 1, 1}, {0, 0, 1, 1}, 0.f, "Pad", "u8"},
    // per-channel quantization with subtract
    {{256ul, ov::Shape{1, 3, 1, 1}, {-2.f, -4.f, -6.f}, {10.5f, 8.5f, 6.5f}, {-2.f, -4.f, -6.f}, {10.5f, 8.5f, 6.5f}},
     {0, 0, 1, 1},
     {0, 0, 1, 1},
