...
const std::vector<MatMulShapes> shapes = {
    {ov::PartialShape{1, 16}, ov::PartialShape{16, 8}, false, false},
    {ov::PartialShape{1, 16}, ov::PartialShape{8, 16}, false, true},
    {ov::PartialShape{16, 1}, ov::PartialShape{16, 8}, true, false},
};
