...
const std::vector<ReshapeTransformationParam> params = {
    // 3D -> 4D
    {{1, 3, 32}, {1, 3, 4, 8}, {256ul, ov::Shape{1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "u8"},
    // 3D -> 1D
    {{1, 3, 32}, {-1}, {256ul, ov::Shape{}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "u8"},
    // 4D -> 3D
    {{1, 3, 16, 16}, {1, 3, 256}, {256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "u8"},
    // 4D -> 3D
    {{1, 3, 16, 16},
     {0, 3, -1},
     ...
     "u8"},
    // 4D -> 2D
    {{1, 3, 4, 8}, {1, -1}, {256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "u8"},
    // 4D -> 6D
    {{1, 3, 4, 8}, {1, 3, 4, 8, 1, 1}, {256ul, ov::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "u8"},
    // 4D -> 2D
    {{1, 3, 4, 8},
     {1, -1},
     {
    ...
    {{1, 3, 16, 16},
     {1, 1, 48, 16},
     {256ul, ov::Shape{1, 3, 1, 1}, {0.f, 0.f, 0.f}, {255.f, 255.f, 255.f}, {0.f, 0.f, 0.f}, {255.f, 25.5f, 2.55f}},
     "Reshape",
     "f32"},
    // Channels count reducing, per-channel dequantizations 3d -> 4d
    {{1, 3, 16},
     {1, 1, 6, 8},
     {256ul, ov::Shape{1, 3, 1}, {0.f, 0.f, 0.f}, {255.f, 255.f, 255.f}, {0.f, 0.f, 0.f}, {255.f, 25.5f, 2.55f}},
     "Reshape",
     "f32"},
    ...
    {{1, 3, 2, 4, 2},
     {1, 1, 48},
     {256ul, ov::Shape{1, 3, 1, 1, 1}, {0.f, 0.f, 0.f}, {255.f, 255.f, 255.f}, {0.f, 0.f, 0.f}, {255.f, 25.5f, 2.55f}},
     "Reshape",
     "f32"},
