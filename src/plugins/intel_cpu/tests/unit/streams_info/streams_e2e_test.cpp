...
struct StreamGenerateionTestCase {
    ...
    ov::hint::LlmDistributionPolicy hint_llm_distribution_policy;
...
void make_config(StreamGenerateionTestCase& test_data, ov::intel_cpu::Config& config) {
    ...
    config.llmDistributionPolicy = test_data.hint_llm_distribution_policy;
...
StreamGenerateionTestCase generation_latency_1sockets_14cores_1_pinning = {
    ...
    ov::hint::LlmDistributionPolicy::SINGLE_DEVICE,  // param[in]: simulated setting for scope of candidate
