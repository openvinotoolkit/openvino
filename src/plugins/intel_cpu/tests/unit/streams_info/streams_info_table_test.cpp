...
StreamsCalculationTestCase _2sockets_104cores_latency_platform_1 = {
    ...
    0,                         // param[in]: the number of blocked cores
    {{1, ALL_PROC, 208, -1, -1},
...
StreamsCalculationTestCase _2sockets_104cores_latency_node_7 = {
    ...
    {{104, 104, 0, 0, -1, -1}, {26, 26, 0, 0, 0, 0}, {26, 26, 0, 0, 1, 0}, {26, 26, 0, 0, 2, 1}, {26, 26, 0, 0, 3, 1}},
    0,
    {{1, ALL_PROC, 52, -1, -1}, {0, MAIN_CORE_PROC, 26, 0, 0}, {0, MAIN_CORE_PROC, 26, 1, 0}},
};
...
StreamsCalculationTestCase _1sockets_14cores_latency_19 = {
    1,
    false,
    0,
    0,
