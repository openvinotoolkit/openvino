...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        make_tuple(unit_test::ShapeVector{{1, 2, 3, 1}, {2}}, std::vector<int64_t>{0, -1}, StaticShape({1, 6}), true),
        make_tuple(unit_test::ShapeVector{{1, 2, 3, 8}, {4}},
                   std::vector<int64_t>{1, 2, 3, 8},
                   StaticShape({1, 2, 3, 8}),
                   true),
        make_tuple(unit_test::ShapeVector{{1, 2, 3, 8}, {4}},
                   std::vector<int64_t>{0, 2, 0, 8},
                   StaticShape({1, 2, 3, 8}),
                   true),
        ...
        make_tuple(unit_test::ShapeVector{{3, 6, 5, 5}, {2}},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(
        make_tuple(unit_test::ShapeVector{{1, 2, 3, 1}, {3}}, std::vector<int64_t>{0, -1, -1}, StaticShape({}), true),
