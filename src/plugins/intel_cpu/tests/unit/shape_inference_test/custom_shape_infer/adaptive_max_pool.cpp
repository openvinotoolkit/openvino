...
TEST_F(AdaptiveMaxPoolV8CpuShapeInferenceTest, default_ctor) {
...
TEST_F(AdaptiveMaxPoolV8CpuShapeInferenceTest, out_spatial_dims_as_constant) {
...
TEST_F(AdaptiveMaxPoolV8CpuShapeInferenceTest, out_spatial_dims_in_const_map) {
...
TEST_F(AdaptiveMaxPoolV8CpuShapeInferenceTest, out_spatial_dims_in_const_map_has_wrong_length) {
    const auto data = std::make_shared<op::v0::Parameter>(element::f64, PartialShape::dynamic());
    const auto out_shape = std::make_shared<op::v0::Parameter>(element::i32, PartialShape::dynamic());
