...
TEST_P(StridedSliceCpuShapeInferenceTest, shape_inference_in_const_map) {
    ...
    const std::unordered_map<size_t, ov::Tensor> constant_data = {{1, begin_tensor},
                                                                  {2, end_tensor},
                                                                  {3, stride_tensor}};
    // implementation depends on some output information of the op
    op->set_output_type(0, element::i32, {-1, -1, -1});
...
INSTANTIATE_TEST_SUITE_P(
    ...
    Values(make_tuple(unit_test::ShapeVector{{3, 4, 5}, {3}, {3}, {3}},
                      std::vector<std::vector<int32_t>>{{100, 100, 100}, {-100, -100, -100}, {-1, -1, -1}},
                      std::vector<int64_t>(4, 0),
                      std::vector<int64_t>(4, 0),
                      StaticShape({3, 4, 5})),
           make_tuple(unit_test::ShapeVector{{3, 2, 3}, {3}, {3}, {3}},
                      std::vector<std::vector<int32_t>>{{1, 0, 0}, {2, 1, 3}, {1, 1, 1}},
                      std::vector<int64_t>(4, 0),
                      std::vector<int64_t>(4, 0),
                      StaticShape({1, 1, 3})),
           make_tuple(unit_test::ShapeVector{{3, 2, 3}, {3}, {3}, {3}},
                      std::vector<std::vector<int32_t>>{{1, 0, 0}, {2, 2, 3}, {1, 1, 1}},
                      std::vector<int64_t>(4, 0),
                      std::vector<int64_t>(4, 0),
                      StaticShape({1, 2, 3})),
           make_tuple(unit_test::ShapeVector{{3, 2, 3}, {3}, {3}, {3}},
                      std::vector<std::vector<int32_t>>{{2, 0, 0}, {3, 2, 3}, {1, 1, 2}},
                      std::vector<int64_t>(4, 0),
                      std::vector<int64_t>(4, 0),
                      StaticShape({1, 2, 2})),
           make_tuple(unit_test::ShapeVector{{3, 2, 3}, {3}, {3}, {3}},
                      std::vector<std::vector<int32_t>>{{1, 0, 0}, {0, 0, 0}, {1, 1, 1}},
                      std::vector<int64_t>{0, 1, 1},
                      std::vector<int64_t>(3, 1),
                      StaticShape({2, 2, 3})),
           make_tuple(unit_test::ShapeVector{{3, 2, 3}, {3}, {3}, {3}},
                      std::vector<std::vector<int32_t>>{{0, 1, 0}, {2, 0, 0}, {1, 1, 2}},
                      std::vector<int64_t>{1, 0, 1},
                      std::vector<int64_t>{0, 1, 1},
                      StaticShape({2, 1, 2})),
           make_tuple(unit_test::ShapeVector{{3, 2, 3}, {3}, {3}, {3}},
                      std::vector<std::vector<int32_t>>{{0, 0, 0}, {1, 0, 0}, {1, 1, -1}},
                      std::vector<int64_t>{0, 1, 1},
                      std::vector<int64_t>{0, 1, 1},
                      StaticShape({1, 2, 3}))),
