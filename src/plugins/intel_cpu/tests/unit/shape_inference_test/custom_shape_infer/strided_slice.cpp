...
TEST_F(StridedSliceCpuShapeInferenceTest , reverse_stride_begin_end_clip_to_dimension) {
...
TEST_F(StridedSliceCpuShapeInferenceTest , use_begin_end1) {
    const auto mask = std::vector<int64_t>(4, 0);
...
TEST_F(StridedSliceCpuShapeInferenceTest , use_begin_end2) {
    const auto mask = std::vector<int64_t>(4, 0);
...
TEST_F(StridedSliceCpuShapeInferenceTest , use_begin_end3) {
    const auto mask = std::vector<int64_t>(4, 0);
...
TEST_F(StridedSliceCpuShapeInferenceTest , ignore_begin_end) {
...
TEST_F(StridedSliceCpuShapeInferenceTest , ignore_begin_end_stride_by_two_last_dim) {
...
TEST_F(StridedSliceCpuShapeInferenceTest , use_reverse_stride_on_last_dimension) {
...
TEST_F(StridedSliceCpuShapeInferenceTest , default_stride) {
