...
TEST_F(ConvolutionBackpropDataV1StaticShapeInferenceTest, 2d_auto_pads_same_lower_inputs_dynamic_rank) {
...
TEST_F(ConvolutionBackpropDataV1StaticShapeInferenceTest, 3d_auto_pad_same_lower_inputs_out_spatial_as_const) {
...
TEST_F(ConvolutionBackpropDataV1StaticShapeInferenceTest, 3d_auto_pad_same_upper_inputs_out_spatial_in_map) {
    const auto strides = Strides{1, 1, 1};
    const auto dilations = Strides{1, 1, 1};
    const auto pads_begin = CoordinateDiff{0, 0, 0};
    const auto pads_end = CoordinateDiff{0, 0, 0};
