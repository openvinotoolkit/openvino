...
public:
    DummyPrecisionSelection(const std::set<std::vector<element::Type>>& precisions1,
...
public:
    ...
    public:
        Actual() = default;
        Actual(std::pair<element::Type, element::Type> convertion_before_op1,
    ...
    public:
        Expected() = default;
        Expected(std::pair<element::Type, element::Type> convertion_before_op1,
                 element::Type convertion_before_op2_1,
                 std::pair<element::Type, element::Type> convertion_before_op2_2,
                 element::Type convertion_after_op2,
    ...
    EnforcePrecisionParamsValues(std::vector<element::Type> input_types,
                                 element::Type source,
                                 element::Type target,
                                 Actual actual,
                                 Expected expected)
...
class EnforcePrecisionTest : public TransformationTestsF, public testing::WithParamInterface<EnforcePrecisionParams> {
public:
    static std::string getTestCaseName(testing::TestParamInfo<EnforcePrecisionParams> obj) {
        ...
        std::ostringstream result;
        result << "in0=" << shapes.first << "_" << test_values.input_types[0] << "_" << "in1=" << shapes.second << "_"
               << test_values.input_types[1] << "_" << "in2=" << test_values.input_types[2] << "_"
               ...
               << test_values.expected.convertion_before_op1.second << "_"
               << test_values.expected.convertion_before_op2_1 << "_"
               << test_values.expected.convertion_before_op2_2.first << "_"
               << test_values.expected.convertion_before_op2_2.second << "_"
...
TEST_P(EnforcePrecisionTest, CompareFunctions) {
    ...
    TwoBinaryOpsFunction function_stub(input_shapes,
    ...
    auto dummyPrecisionSelection =
        std::make_shared<DummyPrecisionSelection>(test_values.actual.precisions1, test_values.actual.precisions2);
    ...
    manager.register_pass<ov::intel_cpu::pass::EnforcePrecision>(test_values.source,
                                                                 test_values.target,
...
std::vector<std::pair<PartialShape, PartialShape>> shapes{{{1, 3, 16, 16}, {1, 3, 16, 16}}};
...
std::vector<EnforcePrecisionParamsValues> test_values{
    {{element::bf16, element::bf16, element::f32},
     ...
     {{}, {}, {element::f32, element::undefined}, {}, {element::bf16}}},
    ...
    {{element::bf16, element::bf16, element::f32},
     ...
     {{element::f32, element::f32},
      ...
      {{{element::bf16, element::bf16}}}},
     {{}, {}, {element::undefined, element::bf16}, {element::f32}, {element::bf16}}},
...
INSTANTIATE_TEST_SUITE_P(smoke_Snippets_EnforcePrecisionTest,
                         EnforcePrecisionTest,
                         ::testing::Combine(::testing::ValuesIn(shapes), ::testing::ValuesIn(test_values)),
