...
protected:
    std::shared_ptr<ov::Model> GetModel(const std::vector<ov::PartialShape>& shapes) const override {
        ...
        BrgemmConfig brgemm_config(dnnl::impl::cpu::x64::avx512_core, ov::element::f32);
...
protected:
    std::shared_ptr<ov::Model> GetModel(const std::vector<ov::PartialShape>& shapes) const override {
        ...
        BrgemmConfig brgemm_config(dnnl::impl::cpu::x64::avx512_core_amx, ov::element::bf16, true, false, true);
