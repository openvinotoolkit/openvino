...
TEST_F(PermuteSliceInterpolateTest, 3D) {
    const ov::Shape in_shape{1, 200, 4};
    {
        ...
        auto slice = std::make_shared<ov::op::v8::Slice>(input, slice_start, slice_stop, slice_step, slice_axes);
    ...
    }
    {
        ...
        auto slice = std::make_shared<ov::op::v8::Slice>(interpolate, slice_start, slice_stop, slice_step, slice_axes);
