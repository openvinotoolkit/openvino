...
void run_selective_ssm_differential_stress_typed(const element::Type& precision,
    ...
    const std::vector<StressCase> cases{
        {{0, 3, 2, 3, 1, 5}, 1, false},     {{2, 0, 4, 5, 2, 3}, 2, true},     {{1, 1, 1, 1, 1, 1}, 3, true},
        {{1, 1, 2, 5, 1, 17}, 3, false},    {{2, 2, 4, 3, 4, 5}, 1, false},    {{1, 5, 6, 7, 3, 9}, 2, true},
        {{2, 3, 8, 5, 4, 7}, 4, false},     {{1, 4, 3, 9, 1, 2}, 16, true},    {{1, 2, 2, 5, 1, 16}, 3, false},
        {{1, 2, 2, 5, 1, 17}, 4, true},     {{1, 2, 2, 5, 1, 128}, 5, false},  {{1, 2, 2, 5, 1, 129}, 3, true},
        {{1, 7, 2, 17, 1, 127}, 17, false}, {{1, 8, 2, 17, 1, 128}, 17, true}, {{2, 9, 4, 33, 2, 129}, 16, false},
        {{1, 17, 2, 32, 1, 128}, 32, true}, {{1, 8, 2, 33, 1, 1}, 33, false},  {{1, 9, 2, 65, 1, 3}, 65, true},
        {{2, 63, 4, 5, 2, 17}, 5, false},   {{1, 64, 4, 9, 2, 128}, 9, true},  {{2, 65, 4, 5, 2, 129}, 3, false},
    };
...
void run_paged_selective_ssm_differential_stress_typed(const element::Type& precision,
    ...
    std::vector<StressCase> cases{
        ...
        {4, 2, 5, 129, {63, 64, 65, 0}, {1, 0, 64, 0}, {3, 64, 65, 0}, 5, false},
        {4, 2, 9, 17, {65, 64}, {7, 3}, {0, -1}, 3, true},
    };
