...
elseif(NOT TARGET arm_compute::arm_compute)
    ...
    function(ov_arm_compute_configure_platform)
        ...
        if(ANDROID)
            ...
            set(ARM_COMPUTE_ANDROID_COMPILER_PREFIX "${android_compiler_prefix}" PARENT_SCOPE)
            set(cmake_build_env
                AR=${ARM_COMPUTE_AR}
    ...
    if(ANDROID)
        ...
        message(STATUS "  ARM_COMPUTE_ANDROID_COMPILER_PREFIX=${ARM_COMPUTE_ANDROID_COMPILER_PREFIX}")
