...
dnnl::algorithm DnnlExtensionUtils::convertToDnnlAlgorithm(Algorithm alg) {
    ...
    case Algorithm::EltwisePrelu:
        return dnnl::algorithm::binary_prelu;
    ...
    case Algorithm::FQCommon:
        return dnnl::algorithm::quantization_quantize_dequantize;
    case Algorithm::FQQuantization:
        return dnnl::algorithm::quantization_quantize;
    case Algorithm::FQBinarization:
        return dnnl::algorithm::binarization_depthwise;
    default:
