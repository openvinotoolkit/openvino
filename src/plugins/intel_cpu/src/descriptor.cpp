...
mkldnn::primitive_desc_iterator Descriptor::createPrimitiveDescriptorIterator(const mkldnn::engine &engine,
                                                                                    const mkldnn::primitive_attr &attr) const {
    return desc->createPrimitiveDescriptorIterator(attr, engine);
}

Descriptor::operator bool() {
    return desc != nullptr;
}

size_t Descriptor::inputNumbers() const {
    return 1;
}

size_t Descriptor::outputNumbers() const {
    return 1;
}

Descriptor::Descriptor(std::shared_ptr<mkldnn::convolution_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::convolution_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::convolution_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::deconvolution_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::deconvolution_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::deconvolution_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::convolution_backward_data::desc> desc,
...
Descriptor::operator std::shared_ptr<mkldnn::convolution_backward_data::desc>() {
...
Descriptor::operator std::shared_ptr<mkldnn::convolution_forward::primitive_desc>() {
    auto typeDesc = std::dynamic_pointer_cast<DescBwdImpl<mkldnn::convolution_backward_data::desc, mkldnn::convolution_forward::primitive_desc>>(desc);
    if (typeDesc == nullptr) {
        IE_THROW() << "Cannot cast descriptor!";
    }
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::inner_product_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::inner_product_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::inner_product_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::lrn_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::lrn_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::lrn_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::pooling_v2_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::pooling_v2_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::pooling_v2_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::softmax_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::softmax_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::softmax_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::vanilla_rnn_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::vanilla_rnn_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::vanilla_rnn_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::lstm_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::lstm_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::lstm_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::gru_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::gru_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::gru_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::lbr_gru_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::lbr_gru_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::lbr_gru_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::eltwise_forward::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::eltwise_forward::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::eltwise_forward::desc>() {
...
Descriptor::Descriptor(std::shared_ptr<mkldnn::matmul::desc> desc) {
    this->desc.reset(new DescFwdImpl<mkldnn::matmul::desc>(desc));
}

Descriptor::operator std::shared_ptr<mkldnn::matmul::desc>() {
