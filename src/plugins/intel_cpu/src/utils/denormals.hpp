...
inline bool flush_to_zero(bool on);
inline bool denormals_as_zero(bool on);
...
inline bool denormals_as_zero(bool on) {
    ...
    #else
        inline bool flush_to_zero(bool on) { return false; }
        inline bool denormals_as_zero(bool on) { return false; }
    #endif
