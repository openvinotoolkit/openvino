...
OV_CONFIG_RELEASE_INTERNAL_OPTION(ov::intel_cpu, cpu_runtime_cache_capacity, 0,
...
OV_CONFIG_RELEASE_INTERNAL_OPTION(ov::intel_cpu, snippets_mode, SnippetsMode::ENABLE,
