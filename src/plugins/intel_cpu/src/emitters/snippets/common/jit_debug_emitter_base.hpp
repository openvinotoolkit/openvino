...
template <typename JitEmitterT>
class jit_debug_emitter_riscv_base : public jit_debug_emitter_base_common<JitEmitterT> {
public:
    using base_t = jit_debug_emitter_base_common<JitEmitterT>;
    using EmissionLocation = typename base_t::EmissionLocation;
    using base_t::base_t;
...
template <typename JitEmitterT>
class jit_debug_emitter_aarch64_base : public jit_debug_emitter_base_common<JitEmitterT> {
public:
    using base_t = jit_debug_emitter_base_common<JitEmitterT>;
    using EmissionLocation = typename base_t::EmissionLocation;
    using base_t::base_t;
