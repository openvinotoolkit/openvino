...
intel_cpu::CPUTargetMachine::CPUTargetMachine(dnnl::impl::cpu::x64::cpu_isa_t host_isa,
    ...
    // data movement
    jitters[op::v0::Parameter::get_type_info_static()] = emitter_factory.snippets<intel_cpu::jit_nop_emitter>();
    jitters[op::v0::Result::get_type_info_static()] = emitter_factory.snippets<intel_cpu::jit_nop_emitter>();
    jitters[snippets::op::Buffer::get_type_info_static()] = emitter_factory.snippets<intel_cpu::jit_nop_emitter>();
    jitters[snippets::op::VectorBuffer::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_nop_emitter>();
    jitters[snippets::op::RankNormalization::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_nop_emitter>();
    jitters[snippets::op::Reshape::get_type_info_static()] = emitter_factory.snippets<intel_cpu::jit_nop_emitter>();
    jitters[snippets::op::Reorder::get_type_info_static()] = emitter_factory.snippets<intel_cpu::jit_nop_emitter>();

    jitters[snippets::op::Load::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_load_memory_emitter>();
    jitters[snippets::op::LoadReorder::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_load_memory_emitter>();
    jitters[snippets::op::BroadcastLoad::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_load_broadcast_emitter>();
    ...
    jitters[snippets::op::Store::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_store_memory_emitter>();
    ...
    jitters[snippets::op::Scalar::get_type_info_static()] = emitter_factory.snippets<intel_cpu::jit_scalar_emitter>();
    jitters[snippets::op::BroadcastMove::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_broadcast_move_emitter>();

    jitters[snippets::op::ConvertTruncation::get_type_info_static()] =
        emitter_factory.cpu<intel_cpu::jit_convert_truncation_emitter>();
    jitters[snippets::op::ConvertSaturation::get_type_info_static()] =
        emitter_factory.cpu<intel_cpu::jit_convert_saturation_emitter>();

    // ternary
    jitters[op::v1::Select::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_select_emitter>();
    jitters[intel_cpu::FusedMulAdd::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_mul_add_emitter>();

    // binary
    jitters[op::v1::Add::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_add_emitter>();
    jitters[op::v1::Divide::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_divide_emitter>();
    jitters[op::v1::Equal::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_equal_emitter>();
    jitters[op::v1::FloorMod::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_floor_mod_emitter>();
    jitters[op::v1::Greater::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_greater_emitter>();
    jitters[op::v1::GreaterEqual::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_greater_equal_emitter>();
    jitters[op::v1::Less::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_less_emitter>();
    jitters[op::v1::LessEqual::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_less_equal_emitter>();
    jitters[op::v1::LogicalAnd::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_logical_and_emitter>();
    jitters[op::v1::LogicalOr::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_logical_or_emitter>();
    jitters[op::v1::LogicalXor::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_logical_xor_emitter>();
    jitters[op::v1::Maximum::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_maximum_emitter>();
    jitters[op::v1::Minimum::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_minimum_emitter>();
    jitters[op::v1::Mod::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_mod_emitter>();
    jitters[op::v1::Multiply::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_multiply_emitter>();
    jitters[op::v1::NotEqual::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_not_equal_emitter>();
    jitters[snippets::op::PowerStatic::get_type_info_static()] =
        emitter_factory.cpu<intel_cpu::jit_power_static_emitter>();
    jitters[op::v1::Power::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_power_dynamic_emitter>();
    jitters[op::v0::PRelu::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_prelu_emitter>();
    jitters[op::v0::SquaredDifference::get_type_info_static()] =
        emitter_factory.cpu<intel_cpu::jit_squared_difference_emitter>();
    jitters[op::v1::Subtract::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_subtract_emitter>();
    jitters[op::v0::Xor::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_logical_xor_emitter>();

    // unary
    jitters[ov::op::v0::Abs::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_abs_emitter>();
    jitters[ov::op::v0::Ceiling::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_ceiling_emitter>();
    jitters[ov::op::v0::Clamp::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_clamp_emitter>();
    jitters[ov::op::v0::Elu::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_elu_emitter>();
    jitters[ov::op::v0::Erf::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_erf_emitter>();
    jitters[ov::op::v0::Exp::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_exp_emitter>();
    jitters[ov::op::v0::Floor::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_floor_emitter>();
    jitters[ov::op::v5::Round::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_round_emitter>();
    jitters[ov::op::v1::LogicalNot::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_logical_not_emitter>();
    jitters[ov::op::v0::Negative::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_negative_emitter>();
    jitters[ov::op::v0::Relu::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_relu_emitter>();
    jitters[ov::op::v0::Sigmoid::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_sigmoid_emitter>();
    jitters[ov::op::v0::Sqrt::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_sqrt_emitter>();
    jitters[ov::op::v0::Tanh::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_tanh_emitter>();

    jitters[ov::intel_cpu::SwishNode::get_type_info_static()] = emitter_factory.cpu<ov::intel_cpu::jit_swish_emitter>();
    jitters[ov::op::v4::HSwish::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_hswish_emitter>();
    jitters[ov::op::v0::Gelu::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_gelu_v0_emitter>();
    jitters[ov::op::v7::Gelu::get_type_info_static()] = emitter_factory.cpu<intel_cpu::jit_gelu_v7_emitter>();
    jitters[snippets::op::Fill::get_type_info_static()] = emitter_factory.snippets<intel_cpu::jit_fill_emitter>();

    jitters[snippets::op::HorizonMax::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_horizon_emitter>();
    ...
    jitters[intel_cpu::BrgemmCPU::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_brgemm_emitter>(std::cref(configurator->get_kernel_executor_table()),
                                                                compiled_kernel_cache);
    jitters[intel_cpu::BrgemmCopyB::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_brgemm_copy_b_emitter>(
            std::cref(configurator->get_kernel_executor_table()),
            compiled_kernel_cache);
    ...
    jitters[snippets::op::KernelStatic::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_kernel_static_emitter>();
    jitters[snippets::op::KernelDynamic::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_kernel_dynamic_emitter>();
    ...
    jitters[snippets::op::RegSpillBegin::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_reg_spill_begin_emitter>();
    jitters[snippets::op::RegSpillEnd::get_type_info_static()] =
        emitter_factory.snippets<intel_cpu::jit_reg_spill_end_emitter>();

#ifdef SNIPPETS_DEBUG_CAPS
    jitters[snippets::op::PerfCountBegin::get_type_info_static()] =
        emitter_factory.snippets<ov::intel_cpu::jit_perf_count_chrono_start_emitter>();
    jitters[snippets::op::PerfCountEnd::get_type_info_static()] =
        emitter_factory.snippets<ov::intel_cpu::jit_perf_count_chrono_end_emitter>();
    jitters[ov::intel_cpu::PerfCountRdtscBegin::get_type_info_static()] =
        emitter_factory.cpu<ov::intel_cpu::jit_perf_count_rdtsc_start_emitter>();
    jitters[ov::intel_cpu::PerfCountRdtscEnd::get_type_info_static()] =
        emitter_factory.cpu<ov::intel_cpu::jit_perf_count_rdtsc_end_emitter>();
#endif

#ifdef SNIPPETS_LIBXSMM_TPP
    jitters[intel_cpu::tpp::op::BrgemmTPP::get_type_info_static()] =
        emitter_factory.snippets<BrgemmTppEmitter>(std::cref(configurator->get_kernel_executor_table()),
                                                   compiled_kernel_cache);
#endif
}
