...
intel_cpu::CPUTargetMachine::CPUTargetMachine(dnnl::impl::cpu::x64::cpu_isa_t host_isa,
    ...
    jitters[snippets::op::IntermediateMemoryBuffer::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_nop_emitter);
    jitters[snippets::op::NewMemoryBuffer::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_nop_emitter);
    ...
    jitters[intel_cpu::LoadConvertSaturation::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_load_convert_emitter);
    ...
    jitters[intel_cpu::StoreConvertSaturation::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_store_convert_emitter);
    ...
    jitters[snippets::op::LoopBeginStatic::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_loop_begin_static_emitter);
    jitters[snippets::op::LoopBeginDynamic::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_loop_begin_dynamic_emitter);
    jitters[snippets::op::LoopEndStatic::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_loop_end_static_emitter);
    jitters[snippets::op::LoopEndDynamic::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_loop_end_dynamic_emitter);
    ...
    jitters[intel_cpu::BrgemmCPU::get_type_info_static()] =
        CREATE_SNIPPETS_EMITTER(intel_cpu::jit_brgemm_emitter, kernel_executor_table, compiled_kernel_cache);
