...
public:
    jit_loop_begin_static_emitter(dnnl::impl::cpu::x64::jit_generator* h,
                                  dnnl::impl::cpu::x64::cpu_isa_t isa,
                                  const ov::snippets::lowered::ExpressionPtr& expr);
...
public:
    jit_loop_begin_dynamic_emitter(dnnl::impl::cpu::x64::jit_generator* h,
                                   dnnl::impl::cpu::x64::cpu_isa_t isa,
                                   const ov::snippets::lowered::ExpressionPtr& expr);
...
public:
    jit_loop_end_static_emitter(dnnl::impl::cpu::x64::jit_generator* h,
                                dnnl::impl::cpu::x64::cpu_isa_t isa,
                                const ov::snippets::lowered::ExpressionPtr& expr);
...
public:
    jit_loop_end_dynamic_emitter(dnnl::impl::cpu::x64::jit_generator* h,
                                 dnnl::impl::cpu::x64::cpu_isa_t isa,
                                 const ov::snippets::lowered::ExpressionPtr& expr);
