...
BrgemmAMXBatchedKernelExecutor::BrgemmAMXBatchedKernelExecutor(ov::intel_cpu::MultiCacheWeakPtr kernel_cache,
    ...
    : CPUKernelExecutor<BrgemmAMXBatchedKernelConfig, BrgemmAMXBatchedCompiledKernel>(std::move(kernel_cache), std::move(config)) {}
...
std::shared_ptr<BrgemmAMXBatchedCompiledKernel> BrgemmAMXBatchedKernelExecutor::compile_kernel(
    ...
    std::shared_ptr<BrgemmAMXBatchedCompiledKernel> compiled_kernel = std::make_shared<BrgemmAMXBatchedCompiledKernel>();
