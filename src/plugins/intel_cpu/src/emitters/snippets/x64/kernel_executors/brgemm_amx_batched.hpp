...
struct BrgemmAMXBatchedKernelConfig : public BrgemmBaseKernelConfig {
public:
...
class BrgemmAMXBatchedKernelExecutor : public BrgemmBaseKernelExecutor,
...
protected:
    std::shared_ptr<BrgemmAMXBatchedCompiledKernel> compile_kernel(const BrgemmAMXBatchedKernelConfig& c) const override;
