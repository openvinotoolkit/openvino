...
public:
    jit_perf_count_chrono_start_emitter(dnnl::impl::cpu::aarch64::jit_generator_t* host,
...
public:
    jit_perf_count_chrono_end_emitter(dnnl::impl::cpu::aarch64::jit_generator_t* host,
                                      dnnl::impl::cpu::aarch64::cpu_isa_t host_isa,
                                      const ov::snippets::lowered::ExpressionPtr& expr);
