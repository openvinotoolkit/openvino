...
class jit_debug_emitter : public ov::intel_cpu::jit_debug_emitter_aarch64_base<jit_emitter> {
public:
    using base_t = ov::intel_cpu::jit_debug_emitter_aarch64_base<jit_emitter>;
