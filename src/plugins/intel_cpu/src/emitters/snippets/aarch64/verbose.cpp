...
void jit_emitter_info_t::init(const jit_emitter* emitter) {
    ...
    // For debugging, output the type of emitter we're processing
    std::cout << "emitter: " << emitter << std::endl;
    // std::string name = typeid(*emitter).name();
    // std::cout << "name: " << name << std::endl;
    // std::string emitter_type = get_emitter_type_name(emitter);
    // std::cout <<  "Processing emitter of type: " << emitter_type << std::endl;
    ...
    // } else {
        str_ = "todo";// init_info_jit_emitter_general(emitter);
    // }
