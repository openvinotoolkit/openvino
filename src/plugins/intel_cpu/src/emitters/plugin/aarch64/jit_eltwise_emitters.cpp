...
size_t jit_not_equal_emitter::get_inputs_count() const { return 2; }

size_t jit_not_equal_emitter::get_aux_vecs_count() const { return 1; }

size_t jit_not_equal_emitter::get_aux_gprs_count() const { return 1; }
