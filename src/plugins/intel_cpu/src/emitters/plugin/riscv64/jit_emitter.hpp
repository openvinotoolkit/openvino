...
protected:
    ...
    void load_table_val(const std::string& key, const Reg& aux, const VReg& target, const size_t key_off_val_shift = 0) const;
    ...
    void load(const VReg& rd, const float imm, const Reg& aux) const;
