...
public:
    jit_softsign_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                         ov::intel_cpu::riscv64::cpu_isa_t host_isa,
                         ov::element::Type exec_prc = ov::element::f32);
...
public:
    jit_greater_emitter(jit_generator_t* host, cpu_isa_t host_isa, element::Type exec_prc = element::f32);
...
private:
    std::unique_ptr<jit_erf_emitter> erf_emitter{nullptr};
...
public:
    jit_gelu_tanh_emitter(jit_generator_t* host, cpu_isa_t host_isa, element::Type exec_prc = element::f32);
    jit_gelu_tanh_emitter(jit_generator_t* host, cpu_isa_t host_isa, const std::shared_ptr<ov::Node>& node);
...
private:
    std::unique_ptr<jit_tanh_emitter> tanh_emitter{nullptr};
...
public:
    jit_is_finite_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                          ov::intel_cpu::riscv64::cpu_isa_t host_isa,
                          ov::element::Type exec_prc = ov::element::f32);
    jit_is_finite_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                          ov::intel_cpu::riscv64::cpu_isa_t host_isa,
...
public:
    jit_is_inf_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                       ov::intel_cpu::riscv64::cpu_isa_t host_isa,
...
public:
    jit_is_nan_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                       ov::intel_cpu::riscv64::cpu_isa_t host_isa,
                       ov::element::Type exec_prc = ov::element::f32);
    jit_is_nan_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                       ov::intel_cpu::riscv64::cpu_isa_t host_isa,
...
public:
    jit_power_dynamic_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                              ov::intel_cpu::riscv64::cpu_isa_t host_isa,
                              ov::element::Type exec_prc = ov::element::f32);
    jit_power_dynamic_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                              ov::intel_cpu::riscv64::cpu_isa_t host_isa,
...
public:
    jit_round_half_away_from_zero_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                                          ov::intel_cpu::riscv64::cpu_isa_t host_isa,
                                          ov::element::Type exec_prc = ov::element::f32);
    jit_round_half_away_from_zero_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                                          ov::intel_cpu::riscv64::cpu_isa_t host_isa,
...
public:
    jit_round_half_to_even_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                                   ov::intel_cpu::riscv64::cpu_isa_t host_isa,
                                   ov::element::Type exec_prc = ov::element::f32);
    jit_round_half_to_even_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                                   ov::intel_cpu::riscv64::cpu_isa_t host_isa,
...
public:
    jit_select_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                       ov::intel_cpu::riscv64::cpu_isa_t host_isa,
                       ov::element::Type exec_prc = ov::element::f32);
    jit_select_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                       ov::intel_cpu::riscv64::cpu_isa_t host_isa,
...
public:
    jit_squared_difference_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                                   ov::intel_cpu::riscv64::cpu_isa_t host_isa,
                                   const std::shared_ptr<ov::Node>& node);
    jit_squared_difference_emitter(ov::intel_cpu::riscv64::jit_generator_t* host,
                                   ov::intel_cpu::riscv64::cpu_isa_t host_isa,
...
public:
    jit_tanh_emitter(jit_generator_t* host, cpu_isa_t host_isa, element::Type exec_prc = element::f32);
    jit_tanh_emitter(jit_generator_t* host, cpu_isa_t host_isa, const std::shared_ptr<ov::Node>& node);
