...
namespace {
std::vector<size_t> get_caller_saved_gprs(const jit_generator_t* h,
...
std::vector<size_t> get_caller_saved_fp_gprs(const jit_generator_t* h,
...
std::vector<size_t> get_caller_saved_vec_gprs(const jit_generator_t* h,
