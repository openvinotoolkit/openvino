...
MemoryPtr DnnlPostOpsComposerLegacy::prepackDecompressionParams(const MemoryCPtr& params_ptr, bool needTranspose) {
...
void DnnlPostOpsComposerLegacy::appendDecompressionScales(const MemoryCPtr& scales_ptr, bool needTranspose) {
...
void DnnlPostOpsComposerLegacy::appendDecompressionZeroPoints(const MemoryCPtr& zero_points_ptr, bool needTranspose) {
