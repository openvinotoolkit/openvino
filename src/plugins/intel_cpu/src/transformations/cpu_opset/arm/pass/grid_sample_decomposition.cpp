...
static std::shared_ptr<Node> create_batch_indices(const Ctx& ctx) {
    ...
    auto n_dim_1d_bs = std::make_shared<v0::Unsqueeze>(ctx.n_dim, v0::Constant::create(element::i32, {}, {0}));
    auto batch_shape = std::make_shared<v0::Concat>(
    ...
    auto n_dim_1d = std::make_shared<v0::Unsqueeze>(ctx.n_dim, v0::Constant::create(element::i32, {}, {0}));
    auto h_out_1d = std::make_shared<v0::Unsqueeze>(ctx.h_out, v0::Constant::create(element::i32, {}, {0}));
    auto w_out_1d = std::make_shared<v0::Unsqueeze>(ctx.w_out, v0::Constant::create(element::i32, {}, {0}));
...
static std::shared_ptr<Node> gather_hw(const Ctx& ctx,
    ...
    auto x_i32 = std::make_shared<v0::Convert>(x_coord, element::i32);
    auto y_i32 = std::make_shared<v0::Convert>(y_coord, element::i32);
    auto bidx  = create_batch_indices(ctx);

    auto b_exp = std::make_shared<v0::Unsqueeze>(bidx, v0::Constant::create(element::i32, {}, {-1}));
    auto y_exp = std::make_shared<v0::Unsqueeze>(y_i32, v0::Constant::create(element::i32, {}, {-1}));
    auto x_exp = std::make_shared<v0::Unsqueeze>(x_i32, v0::Constant::create(element::i32, {}, {-1}));

    auto indices = std::make_shared<v0::Concat>(OutputVector{b_exp, y_exp, x_exp}, -1);
...
static std::shared_ptr<Node> reflect_coord(const Ctx& ctx,
    ...
    if (align_corners) {
        ...
        auto shifted  = std::make_shared<v1::Add>(coord, ctx.c0_5);
        auto mod      = std::make_shared<v1::FloorMod>(shifted, two_size);
        auto need_ref = std::make_shared<v1::Greater>(mod, size_f);
        auto ref_val  = std::make_shared<v1::Subtract>(two_size, mod);
        auto ref      = std::make_shared<v1::Select>(need_ref, ref_val, mod);
        auto res      = std::make_shared<v1::Subtract>(ref, ctx.c0_5);
...
static std::shared_ptr<Node> reflect_index(const Ctx& ctx,
    ...
    if (align_corners) {
        ...
        auto abs_i   = std::make_shared<v0::Abs>(idx);
        auto r       = std::make_shared<v1::FloorMod>(abs_i, two_sm1);
        auto flipped = std::make_shared<v1::Subtract>(two_sm1, r);
        auto cond    = std::make_shared<v1::GreaterEqual>(r, size_f);
        auto ref     = std::make_shared<v1::Select>(cond, flipped, r);
        return std::make_shared<v1::Select>(size_is_one, ctx.c0, ref);
    } else {
        auto two_s   = std::make_shared<v1::Multiply>(ctx.c2, size_f);
        auto per_m1  = std::make_shared<v1::Subtract>(two_s, ctx.c1);
        auto mod1    = std::make_shared<v1::FloorMod>(idx, two_s);
        auto mod2    = std::make_shared<v1::FloorMod>(std::make_shared<v1::Add>(mod1, two_s), two_s);
        auto need_rf = std::make_shared<v1::GreaterEqual>(mod2, size_f);
        auto ref_val = std::make_shared<v1::Subtract>(per_m1, mod2);
...
static bool decompose_impl(
    ...
    ctx.n_dim   = std::make_shared<v8::Gather>(dshape, v0::Constant::create(element::i32, {}, {0}),
                                               v0::Constant::create(element::i32, {}, {0}));
    ctx.c_dim   = std::make_shared<v8::Gather>(dshape, v0::Constant::create(element::i32, {}, {1}),
                                               v0::Constant::create(element::i32, {}, {0}));
    ctx.h_in    = std::make_shared<v8::Gather>(dshape, v0::Constant::create(element::i32, {}, {2}),
                                               v0::Constant::create(element::i32, {}, {0}));
    ctx.w_in    = std::make_shared<v8::Gather>(dshape, v0::Constant::create(element::i32, {}, {3}),
                                               v0::Constant::create(element::i32, {}, {0}));

    auto gshape = std::make_shared<v3::ShapeOf>(grid, element::i32);
    ctx.h_out   = std::make_shared<v8::Gather>(gshape, v0::Constant::create(element::i32, {}, {1}),
                                               v0::Constant::create(element::i32, {}, {0}));
    ctx.w_out   = std::make_shared<v8::Gather>(gshape, v0::Constant::create(element::i32, {}, {2}),
                                               v0::Constant::create(element::i32, {}, {0}));
    ...
    if (grid.get_element_type() != ctx.calc_type)
        grid_conv = std::make_shared<v0::Convert>(grid, ctx.calc_type);
    auto axis3 = v0::Constant::create(element::i32, {}, {3});
    auto x_grid = std::make_shared<v8::Gather>(grid_conv, v0::Constant::create(element::i32, {}, {0}), axis3);
    auto y_grid = std::make_shared<v8::Gather>(grid_conv, v0::Constant::create(element::i32, {}, {1}), axis3);
    ...
    if (gs->get_attributes().align_corners) {
        ...
        ctx.x = std::make_shared<v1::Multiply>(
                    std::make_shared<v1::Divide>(std::make_shared<v1::Add>(x_grid, ctx.c1), ctx.c2),
                    w_m1);
        ctx.y = std::make_shared<v1::Multiply>(
                    std::make_shared<v1::Divide>(std::make_shared<v1::Add>(y_grid, ctx.c1), ctx.c2),
                    h_m1);
    } else {
        ctx.x = std::make_shared<v1::Divide>(
                    std::make_shared<v1::Subtract>(
                        std::make_shared<v1::Multiply>(std::make_shared<v1::Add>(x_grid, ctx.c1), w_in_f),
                        ctx.c1),
                    ctx.c2);
        ctx.y = std::make_shared<v1::Divide>(
                    std::make_shared<v1::Subtract>(
                        std::make_shared<v1::Multiply>(std::make_shared<v1::Add>(y_grid, ctx.c1), h_in_f),
                        ctx.c1),
                    ctx.c2);
    }

    // NCHW -> NHWC
    auto to_nhwc = v0::Constant::create(element::i32, {4}, {0, 2, 3, 1});
    ctx.data_nhwc = std::make_shared<v1::Transpose>(data, to_nhwc);
    ...
    // NHWC -> NCHW
    auto to_nchw = v0::Constant::create(element::i32, {4}, {0, 3, 1, 2});
    auto result  = std::make_shared<v1::Transpose>(result_nhwc, to_nchw);
...
GridSampleDecompositionNearest::GridSampleDecompositionNearest() {
    auto pat = ov::pass::pattern::wrap_type<v9::GridSample>();
    matcher_pass_callback cb = [OV_CAPTURE_CPY_AND_THIS](ov::pass::pattern::Matcher& m) {
        auto gs = std::dynamic_pointer_cast<v9::GridSample>(m.get_match_root());
        if (!gs || transformation_callback(gs))
            return false;
        if (gs->get_attributes().mode != v9::GridSample::InterpolationMode::NEAREST)
            return false;

        return decompose_impl(gs, [&](const Ctx& ctx, const v9::GridSample::Attributes& attrs) -> std::shared_ptr<Node> {
            ...
            if (is_zeros) {
                ...
                result = std::make_shared<v1::Multiply>(result, mask_e);
            }
...
GridSampleDecompositionBilinear::GridSampleDecompositionBilinear() {
    ...
    matcher_pass_callback cb = [OV_CAPTURE_CPY_AND_THIS](ov::pass::pattern::Matcher& m) {
        ...
        if (!gs || transformation_callback(gs))
            return false;
        if (gs->get_attributes().mode != v9::GridSample::InterpolationMode::BILINEAR)
            return false;
        ...
        return decompose_impl(gs, [&](const Ctx& ctx, const v9::GridSample::Attributes& attrs) -> std::shared_ptr<Node> {
            ...
            auto dx = std::make_shared<v1::Subtract>(x_pad, x0);
            auto dy = std::make_shared<v1::Subtract>(y_pad, y0);
            ...
            std::vector<std::shared_ptr<Node>> weights{
                std::make_shared<v1::Multiply>(one_m_dx, one_m_dy), // w00
                std::make_shared<v1::Multiply>(dx,       one_m_dy), // w01
                std::make_shared<v1::Multiply>(one_m_dx, dy),       // w10
                std::make_shared<v1::Multiply>(dx,       dy)        // w11
            };
            ...
            for (size_t i = 0; i < 4; ++i) {
                ...
                if (is_zeros) {
                    auto x_ok = std::make_shared<v1::LogicalAnd>(
                        std::make_shared<v1::GreaterEqual>(x_coords[i], ctx.c0),
                        std::make_shared<v1::Less>(x_coords[i], w_in_f));
                    auto y_ok = std::make_shared<v1::LogicalAnd>(
                        std::make_shared<v1::GreaterEqual>(y_coords[i], ctx.c0),
                        std::make_shared<v1::Less>(y_coords[i], h_in_f));
                    auto ok   = std::make_shared<v1::LogicalAnd>(x_ok, y_ok);
                    auto mask = std::make_shared<v0::Convert>(ok, ctx.element_type);
                    auto mexp = std::make_shared<v0::Unsqueeze>(mask, v0::Constant::create(element::i32, {}, {-1}));
                    val = std::make_shared<v1::Multiply>(val, mexp);
                }

                values[i] = val;
            }

            std::shared_ptr<Node> res = std::make_shared<v1::Multiply>(
                values[0], std::make_shared<v0::Unsqueeze>(weights[0], v0::Constant::create(element::i32, {}, {-1})));
            for (size_t i = 1; i < 4; ++i) {
                auto wexp = std::make_shared<v0::Unsqueeze>(weights[i], v0::Constant::create(element::i32, {}, {-1}));
                res = std::make_shared<v1::Add>(res, std::make_shared<v1::Multiply>(values[i], wexp));
            }
            return res; // NHWC
        });
    };
...
GridSampleDecompositionBicubic::GridSampleDecompositionBicubic() {
    ...
    matcher_pass_callback cb = [OV_CAPTURE_CPY_AND_THIS](ov::pass::pattern::Matcher& m) {
        ...
        if (!gs || transformation_callback(gs))
            return false;
        if (gs->get_attributes().mode != v9::GridSample::InterpolationMode::BICUBIC)
            return false;
        ...
        return decompose_impl(gs, [&](const Ctx& ctx, const v9::GridSample::Attributes& attrs) -> std::shared_ptr<Node> {
            ...
            auto cubic_weight = [&](const std::shared_ptr<Node>& t) -> std::shared_ptr<Node> {
                auto t0  = std::make_shared<v1::Minimum>(std::make_shared<v1::Maximum>(t, ctx.c0), ctx.c2);
                auto t2  = std::make_shared<v1::Multiply>(t0, t0);
                auto t3  = std::make_shared<v1::Multiply>(t2, t0);
                auto ap2 = std::make_shared<v1::Add>(a, ctx.c2);
                auto ap3 = std::make_shared<v1::Add>(a, c3);

                auto f01_in = std::make_shared<v1::Subtract>(std::make_shared<v1::Multiply>(ap2, t0), ap3);
                auto f01    = std::make_shared<v1::Add>(std::make_shared<v1::Multiply>(f01_in, t2), ctx.c1);

                auto five_a  = std::make_shared<v1::Multiply>(c5, a);
                auto eight_a = std::make_shared<v1::Multiply>(c8, a);
                auto four_a  = std::make_shared<v1::Multiply>(c4, a);
                auto f12_in1 = std::make_shared<v1::Subtract>(std::make_shared<v1::Multiply>(a, t0), five_a);
                auto f12_in2 = std::make_shared<v1::Add>(std::make_shared<v1::Multiply>(f12_in1, t0), eight_a);
                auto f12     = std::make_shared<v1::Subtract>(std::make_shared<v1::Multiply>(f12_in2, t0), four_a);

                auto cond1 = std::make_shared<v1::LessEqual>(t0, ctx.c1);
                auto cond2 = std::make_shared<v1::Less>(t0, ctx.c2);
                return std::make_shared<v1::Select>(cond1, f01, std::make_shared<v1::Select>(cond2, f12, ctx.c0));
            };

            auto t_x0 = std::make_shared<v1::Add>(ctx.c1, dx);
            auto t_x1 = dx;
            auto t_x2 = std::make_shared<v1::Subtract>(ctx.c1, dx);
            auto t_x3 = std::make_shared<v1::Subtract>(ctx.c2, dx);
            ...
            auto t_y0 = std::make_shared<v1::Add>(ctx.c1, dy);
            auto t_y1 = dy;
            auto t_y2 = std::make_shared<v1::Subtract>(ctx.c1, dy);
            auto t_y3 = std::make_shared<v1::Subtract>(ctx.c2, dy);
            ...
            if (is_zeros) {
                for (int i = 0; i < 4; ++i) {
                    x_ok[i] = std::make_shared<v1::LogicalAnd>(
                        std::make_shared<v1::GreaterEqual>(x_idx[i], ctx.c0),
                        std::make_shared<v1::Less>(x_idx[i], w_in_f));
                    y_ok[i] = std::make_shared<v1::LogicalAnd>(
                        std::make_shared<v1::GreaterEqual>(y_idx[i], ctx.c0),
            ...
            if (is_reflection) {
                ...
                // when size==1 - to 0
                for (int i = 0; i < 4; ++i) {
                    x_idx[i] = std::make_shared<v1::Select>(w_is_one, ctx.c0, x_idx[i]);
                    y_idx[i] = std::make_shared<v1::Select>(h_is_one, ctx.c0, y_idx[i]);
                }
            }
            ...
            for (int iy = 0; iy < 4; ++iy) {
                ...
                for (int ix = 0; ix < 4; ++ix) {
                    ...
                    if (is_zeros) {
                        ...
                        auto m  = std::make_shared<v0::Convert>(ok, ctx.element_type);
                        wxy = std::make_shared<v1::Multiply>(wxy, m);
                    }

                    auto wexp = std::make_shared<v0::Unsqueeze>(wxy, v0::Constant::create(element::i32, {}, {-1}));
                    auto tap  = std::make_shared<v1::Multiply>(val, wexp);

                    row = row ? std::shared_ptr<Node>(std::make_shared<v1::Add>(row, tap)) : std::shared_ptr<Node>(tap);
                }
