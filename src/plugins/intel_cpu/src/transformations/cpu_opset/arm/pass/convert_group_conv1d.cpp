...
ov::matcher_pass_callback ov::intel_cpu::ConvertConv1DBase::convert_conv1d_to_conv2d() {
    return [&](ov::pass::pattern::Matcher& m) {
        ...
        auto w_shape = std::make_shared<ov::opset8::Constant>(ov::element::i64, ov::Shape{weights2d_shape.size()}, weights2d_shape);
...
ov::intel_cpu::ConvertConv1D::ConvertConv1D() {
    auto m = std::make_shared<ov::pass::pattern::Matcher>(
        ov::pass::pattern::wrap_type<ov::opset8::Convolution>({ov::pass::pattern::any_input(),
...
ov::intel_cpu::ConvertGroupConv1D::ConvertGroupConv1D() {
    auto m = std::make_shared<ov::pass::pattern::Matcher>(
            ov::pass::pattern::wrap_type<ov::opset8::GroupConvolution>({ov::pass::pattern::any_input(),
                                                                      ov::pass::pattern::any_input()}),
