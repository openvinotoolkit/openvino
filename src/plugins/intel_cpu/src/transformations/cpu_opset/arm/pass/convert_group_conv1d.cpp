...
ov::matcher_pass_callback ov::intel_cpu::ConvertConv1DBase::convert_conv1d_to_conv2d() {
    return [&](ov::pass::pattern::Matcher& m) {
        ...
        auto w_shape = std::make_shared<ov::op::v0::Constant>(ov::element::i64,
        ...
        auto getUnsqueeze = [&](const ov::Output<ov::Node>& node) {
            ...
            return std::make_shared<ov::op::v0::Unsqueeze>(
                node,
                ov::op::v0::Constant::create(ov::element::i64, ov::Shape{1}, {rank}));
        };
        ...
        auto reshape = std::make_shared<ov::op::v0::Squeeze>(
            conv2d,
            ov::op::v0::Constant::create(ov::element::i64, ov::Shape{1}, {input_shape.rank().get_length()}));
...
ov::intel_cpu::ConvertConv1D::ConvertConv1D() {
    auto m = std::make_shared<ov::pass::pattern::Matcher>(
        ov::pass::pattern::wrap_type<ov::op::v1::Convolution>(
            {ov::pass::pattern::any_input(), ov::pass::pattern::any_input()}),
        "ConvertConvolutionToArm");
    register_matcher(m, convert_conv1d_to_conv2d<ov::op::v1::Convolution>());
}

ov::intel_cpu::ConvertGroupConv1D::ConvertGroupConv1D() {
    auto m = std::make_shared<ov::pass::pattern::Matcher>(
        ov::pass::pattern::wrap_type<ov::op::v1::GroupConvolution>(
            {ov::pass::pattern::any_input(), ov::pass::pattern::any_input()}),
        "ConvertGroupConvolutionToArm");
    register_matcher(m, convert_conv1d_to_conv2d<ov::op::v1::GroupConvolution>());
}
