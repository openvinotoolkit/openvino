...
StatefulSDPAFusion::StatefulSDPAFusion() {
    ...
    ov::matcher_pass_callback callback = [=](Matcher& m) {
        ...
        opset6::Assign* assign_k_node = nullptr;
        opset6::Assign* assign_v_node = nullptr;
        opset1::Convert* assign_cvt_k_node = nullptr;
        opset1::Convert* assign_cvt_v_node = nullptr;
