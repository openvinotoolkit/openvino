...
/**
 * @brief Move ReadValue's inputs to new CPU ngraph node:ReadValueWithSubgraphNode inside.
 *     intput1
 *        |
 *     Some nodes(They have only one common successor[ReadValue])     input1
 *        |                                                             |
 *     ReadValue                                            ------->  ReadValueWithSubgraphNode(Subgraph is inside)
 *        |     \                                                       |          \
 *     Assign   others                                                Others      MemoryOutputStub
 */
