...
CausalMaskPreprocess::CausalMaskPreprocess() {
    ...
    auto slice_1 = makePattern<ov::opset1::StridedSlice>(
            ...
            {{"begin_mask", {1, 1, 1, 0}},
             ...
             {"shrink_axis_mask", {}},
             {"ellipsis_mask", {}}});
    auto slice_2 = makePattern<ov::opset8::Slice>(
            {SliceAssign_201_Reshape, {0, 0, 0, 0}, ScatterUpdate_93502, {1, 1, 1, 1}, {0, 1, 2, 3}});
    auto SliceAssign_201_Slice = slice_1 | slice_2; //  tensor_array<i32[?,1,8192,..8192]>
    ...
    auto slice_3 =
            makePattern<ov::opset1::StridedSlice>({mul_Multiply_1, {0, 0, 0, 0}, ScatterUpdate_93502, {1, 1, 1, 1}},
                                                  {{"begin_mask", {1, 1, 1, 0}},
                                                   ...
                                                   {"shrink_axis_mask", {}},
                                                   {"ellipsis_mask", {}}});
    auto slice_4 = makePattern<ov::opset8::Slice>({mul_Multiply_1, {0, 0, 0, 0}, ScatterUpdate_93502, {1, 1, 1, 1}, {0, 1, 2, 3}});
    auto causal_mask_boolean_1 = slice_3 | slice_4; //  tensor_array<f32[?,1,8192,..8192]>
    ...
    auto slice_5 = makePattern<ov::opset1::StridedSlice>(
            ...
            {{"begin_mask", {1, 1, 1, 0}},
             ...
             {"shrink_axis_mask", {}},
             {"ellipsis_mask", {}}});
    auto slice_6 = makePattern<ov::opset8::Slice>(
            {SliceAssign_201_Reshape_3, {0, 0, 0, 0}, ScatterUpdate_93554, {1, 1, 1, 1}, {0, 1, 2, 3}});
    auto slice_Slice_14 = slice_1 | slice_2; //  tensor_array<f32[?,1,8192,..8192]>
