...
CausalMaskPreprocess::CausalMaskPreprocess() {
    ...
    auto SliceAssign_201_Slice = GenSlice(SliceAssign_201_Reshape, {0, 0, 0, 0}, ScatterUpdate_93502, {1, 1, 1, 1}, 3); //  tensor_array<i32[?,1,8192,..8192]>
    ...
    auto causal_mask_boolean_1 = GenSlice(mul_Multiply_1, {0, 0, 0, 0}, ScatterUpdate_93502, {1, 1, 1, 1}, 3); //  tensor_array<f32[?,1,8192,..8192]>
    ...
    auto slice_Slice_14 = GenSlice(SliceAssign_201_Reshape_3, {0, 0, 0, 0}, ScatterUpdate_93554, {1, 1, 1, 1}, 3); //  tensor_array<f32[?,1,8192,..8192]>
