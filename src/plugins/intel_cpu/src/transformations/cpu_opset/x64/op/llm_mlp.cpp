...
void LLMMLPNode::validate_and_infer_types() {
    ...
    NODE_VALIDATION_CHECK(this, ishape.rank().is_static(), "feature shape rank must be static");
    NODE_VALIDATION_CHECK(this, ishape.rank() == 3, "feature shape rank must be 3");
