...
bool ConvertPrecisionI64ToI32::isNativelySupported(const ov::Node::type_info_t& type) const {
    static const std::unordered_set<ov::Node::type_info_t> i64Ops = {
        ...
        opset12::ReduceL1::get_type_info_static(),
        opset12::ReduceL2::get_type_info_static(),
        opset12::ReduceLogicalAnd::get_type_info_static(),
        opset12::ReduceLogicalOr::get_type_info_static(),
        opset12::ReduceMax::get_type_info_static(),
        opset12::ReduceMean::get_type_info_static(),
        opset12::ReduceMin::get_type_info_static(),
        opset12::ReduceProd::get_type_info_static(),
        opset12::ReduceSum::get_type_info_static(),
