...
void Transformations::MainSnippets(void) {
    ...
    const auto is_dynamic_subgraph_token_disabled = config.rtCacheCapacity == 0;
#if defined(OPENVINO_ARCH_ARM64)
    ...
    bool is_dynamic_mha_token_enabled = false && !is_dynamic_subgraph_token_disabled;
#else
    ...
    bool is_dynamic_mha_token_enabled = !is_dynamic_subgraph_token_disabled;
#endif
