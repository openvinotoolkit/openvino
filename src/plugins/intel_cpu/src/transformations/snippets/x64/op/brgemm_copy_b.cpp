...
ov::Shape intel_cpu::BrgemmCopyB::get_repacking_buffer_shape() const {
    ...
    // have enough memory allocated. For the details, please see 'copy_4x64' and 'copy_2x32' implementations and usage
    // in onednn/src/cpu/x64/matmul/brgemm_matmul_copy_utils.cpp
