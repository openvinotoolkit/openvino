...
LinearIR::constExprIt BrgemmCPUBlocking::move_new_memory_buffer(LinearIR& linear_ir,
    ...
    OPENVINO_ASSERT(wsp_buffer, "Scratchpad buffer for Brgemm AMX is required");
    OPENVINO_ASSERT(wsp_buffer->is_independent_memory(), "Incorrect Scratchpad buffer for Brgemm AMX");
