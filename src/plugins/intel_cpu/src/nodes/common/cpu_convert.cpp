...
template <>
[[maybe_unused]] void convert_vec<ov::float16, ov::float8_e4m3>(jit_generator& gen, const RegExp& src, const RegExp& dst) {
    const auto& f8vec = gen.xmm3;
...
template <>
[[maybe_unused]] void convert_vec<ov::float8_e4m3, ov::float16>(jit_generator& gen, const RegExp& src, const RegExp& dst) {
    const auto& f8vec = gen.xmm3;
    const auto& f16vec = gen.ymm4;
...
template <>
[[maybe_unused]] void convert_vec<ov::intel_cpu::bfloat16_t, ov::float8_e4m3>(jit_generator& gen, const RegExp& src, const RegExp& dst) {
    const auto& f8vec = gen.xmm3;
...
template <>
[[maybe_unused]] void convert_vec<ov::float8_e4m3, ov::intel_cpu::bfloat16_t>(jit_generator& gen, const RegExp& src, const RegExp& dst) {
    const auto& f8vec = gen.xmm3;
    const auto& f16vec = gen.ymm4;
    const auto& f32vec = gen.zmm4;
...
template <>
[[maybe_unused]] void convert_vec<ov::float16, ov::float8_e5m2>(jit_generator& gen, const RegExp& src, const RegExp& dst) {
    const auto& f8vec = gen.xmm3;
    const auto& f16vec = gen.ymm4;
...
template <>
[[maybe_unused]] void convert_vec<ov::float8_e5m2, ov::float16>(jit_generator& gen, const RegExp& src, const RegExp& dst) {
    const auto& f8vec = gen.xmm3;
    const auto& f16vec = gen.ymm4;
...
template <>
[[maybe_unused]] void convert_vec<ov::intel_cpu::bfloat16_t, ov::float8_e5m2>(jit_generator& gen, const RegExp& src, const RegExp& dst) {
    const auto& f8vec = gen.xmm3;
    const auto& f16vec = gen.zmm4;
...
template <>
[[maybe_unused]] void convert_vec<ov::float8_e5m2, ov::intel_cpu::bfloat16_t>(jit_generator& gen, const RegExp& src, const RegExp& dst) {
    const auto& f8vec = gen.xmm3;
    const auto& f16vec = gen.ymm4;
    const auto& f32vec = gen.zmm4;
