...
struct jit_uni_mvn_mean_variance_kernel_f32 : public jit_uni_mvn_mean_variance_kernel, public jit_generator_t {
    ...
    void create_ker() override {
        ...
        ker_ = reinterpret_cast<decltype(ker_)>(const_cast<Xbyak::uint8*>(jit_ker()));
    }
...
void MVNJitExecutorLegacy::exec(const uint8_t* src_data,
                                uint8_t* dst_data,
...
void MVNJitExecutorLegacy::mvn_pln(const uint8_t* src_data,
                                   uint8_t* dst_data,
                                   const void* post_ops_data_,
                                   const VectorDims& shape5d) {
...
void MVNJitExecutorLegacy::mvn_blk(const uint8_t* src_data,
                                   uint8_t* dst_data,
                                   const void* post_ops_data_,
                                   const VectorDims& shape5d) {
...
void MVNJitExecutorLegacy::mvn_nspc(const uint8_t* src_data,
                                    uint8_t* dst_data,
                                    const void* post_ops_data_,
                                    const VectorDims& shape5d) {
    size_t blk_size = 1;  // channel blk for memory layout
