...
void legacy::MVNJitExecutor::exec(const uint8_t* src_data,
                                  uint8_t* dst_data,
...
void legacy::MVNJitExecutor::mvn_pln(const uint8_t* src_data,
                                     uint8_t* dst_data,
                                     const void* post_ops_data_,
                                     const VectorDims& shape5d) {
...
void legacy::MVNJitExecutor::mvn_blk(const uint8_t* src_data,
                                     uint8_t* dst_data,
                                     const void* post_ops_data_,
                                     const VectorDims& shape5d) {
    size_t blk_size = 1;  // channel blk for memory layout
