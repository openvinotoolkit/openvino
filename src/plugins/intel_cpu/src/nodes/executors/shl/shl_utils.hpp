...
inline csinn_dtype_enum precisionToShlDataType(ov::element::Type precision) {
    ...
    case ov::element::u16:
        return CSINN_DTYPE_UINT16;
    case ov::element::i32:
        return CSINN_DTYPE_INT32;
    case ov::element::u32:
        return CSINN_DTYPE_UINT32;
    case ov::element::f16:
...
inline csinn_layout_enum getShlDataLayoutByMemoryDesc(const MemoryDescPtr& desc, bool is_weights = false) {
    if (desc->hasLayoutType(LayoutType::ncsp)) {
        ...
        case 1:
            return is_weights ? CSINN_LAYOUT_O : CSINN_LAYOUT_N;
        case 2:
            return is_weights ? CSINN_LAYOUT_OI : CSINN_LAYOUT_NC;
        case 3:
            return is_weights ? CSINN_LAYOUT_OIW : CSINN_LAYOUT_NCW;
        case 4:
        ...
        switch (desc->getShape().getRank()) {
        case 3:
            return is_weights ? CSINN_LAYOUT_OWI : CSINN_LAYOUT_NWC;
        case 4:
