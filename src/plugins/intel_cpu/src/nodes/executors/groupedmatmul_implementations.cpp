...
// GroupedMatMul always uses plain (ncsp) layout. GroupedMatMul-17 has no bias input, but the empty
// bias argument is kept in the notation so that the type mapping below stays a plain copy of the
// GatherMatmul one.
