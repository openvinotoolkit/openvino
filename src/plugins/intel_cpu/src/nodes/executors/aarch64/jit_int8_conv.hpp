...
private:
    ...
    std::shared_ptr<jit_int8_brgemm_kernel_2x8_dot_packed_strided> kernel_block2x8_dot_packed_s8_strided_;
    std::shared_ptr<jit_int8_brgemm_kernel_2x8_dot_packed_strided_interleaved4>
        kernel_block2x8_dot_packed_s8_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_2x16_dot_packed_strided_interleaved4>
        kernel_block2x16_dot_packed_s8_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_2x32_dot_packed_strided_interleaved4>
        kernel_block2x32_dot_packed_s8_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_4x16_dot_packed_strided_interleaved4>
        kernel_block4x16_dot_packed_s8_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_4x16_dot_packed_lhs_strided_interleaved4>
        kernel_block4x16_dot_packed_lhs_s8_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_2x8_udot_packed_strided> kernel_block2x8_udot_packed_strided_;
    std::shared_ptr<jit_int8_brgemm_kernel_2x8_udot_packed_strided_interleaved4>
        kernel_block2x8_udot_packed_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_2x16_udot_packed_strided_interleaved4>
        kernel_block2x16_udot_packed_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_2x32_udot_packed_strided_interleaved4>
        kernel_block2x32_udot_packed_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_4x16_udot_packed_strided_interleaved4>
        kernel_block4x16_udot_packed_strided_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_4x16_udot_packed_lhs_strided_interleaved4>
    ...
    std::shared_ptr<jit_int8_brgemm_kernel_4x4_smmla_packed> kernel_block4x4_mmla_packed_s8_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_4x8_smmla_packed> kernel_block4x8_mmla_packed_s8_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_8x8_smmla_packed> kernel_block8x8_mmla_packed_s8_;
    std::shared_ptr<jit_int8_brgemm_kernel_8x12_smmla_packed> kernel_block8x12_mmla_packed_s8_;
    std::shared_ptr<jit_int8_brgemm_kernel_4x16_smmla_packed> kernel_block4x16_mmla_packed_s8_interleaved_;
    ...
    std::shared_ptr<jit_int8_brgemm_kernel_4x4_usmmla_packed> kernel_block4x4_mmla_packed_u8_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_4x8_usmmla_packed> kernel_block4x8_mmla_packed_u8_interleaved_;
    std::shared_ptr<jit_int8_brgemm_kernel_8x8_usmmla_packed> kernel_block8x8_mmla_packed_u8_;
    std::shared_ptr<jit_int8_brgemm_kernel_8x12_usmmla_packed> kernel_block8x12_mmla_packed_u8_;
    std::shared_ptr<jit_int8_brgemm_kernel_4x16_usmmla_packed> kernel_block4x16_mmla_packed_u8_interleaved_;
    ...
    static constexpr size_t brgemm_1x1_m_blk_ = 8;
    ...
    std::vector<int8_t> packed_wei_1x1_dot8_interleaved_;
    std::vector<int8_t> packed_wei_1x1_dot16_interleaved_;
    std::vector<int8_t> packed_wei_1x1_dot32_interleaved_;
    std::vector<int8_t> packed_wei_1x1_mmla4_;
    std::vector<int8_t> packed_wei_1x1_mmla8_;
    std::vector<int8_t> packed_wei_1x1_mmla12_;
    std::vector<int8_t> packed_wei_1x1_mmla16_;
    size_t packed_wei_1x1_dot4_stride_ = 0;
    size_t packed_wei_1x1_dot8_stride_ = 0;
    size_t packed_wei_1x1_dot8_interleaved_stride_ = 0;
    size_t packed_wei_1x1_dot16_interleaved_stride_ = 0;
    size_t packed_wei_1x1_dot32_interleaved_stride_ = 0;
    size_t packed_wei_1x1_mmla4_stride_ = 0;
    size_t packed_wei_1x1_mmla8_stride_ = 0;
    size_t packed_wei_1x1_mmla12_stride_ = 0;
    size_t packed_wei_1x1_mmla16_stride_ = 0;
    std::vector<int32_t> wei_comp_1x1_;
    std::vector<int32_t> bias_comp_1x1_;
    ...
    std::vector<int8_t> packed_wei_brgemm_mmla12_fused_;
    size_t packed_wei_brgemm_mmla12_fused_stride_ = 0;
    ...
    bool logged_brgemm_1x1_path_ = false;
    bool logged_impl_path_ = false;
};
