...
void JitConv3DKernelF16::generate() {
...

    {
        ...
        ld1(VReg(2).h[1], ptr(reg_wei2)); add(reg_wei2, reg_wei2, reg_wei_stride);
        ld1(VReg(1).h[2], ptr(reg_wei)); add(reg_wei, reg_wei, reg_wei_stride);
        ld1(VReg(2).h[2], ptr(reg_wei2)); add(reg_wei2, reg_wei2, reg_wei_stride);
        ld1(VReg(1).h[3], ptr(reg_wei)); add(reg_wei, reg_wei, reg_wei_stride);
        ld1(VReg(2).h[3], ptr(reg_wei2)); add(reg_wei2, reg_wei2, reg_wei_stride);
        ld1(VReg(1).h[4], ptr(reg_wei)); add(reg_wei, reg_wei, reg_wei_stride);
        ld1(VReg(2).h[4], ptr(reg_wei2)); add(reg_wei2, reg_wei2, reg_wei_stride);
        ld1(VReg(1).h[5], ptr(reg_wei)); add(reg_wei, reg_wei, reg_wei_stride);
        ld1(VReg(2).h[5], ptr(reg_wei2)); add(reg_wei2, reg_wei2, reg_wei_stride);
        ...
        cmp(reg_tail, 0); b(LE, Ltail_done_d_kx);
    ...
    L(Lq_entry);
    {
        ...
        cmp(reg_tail, 0); b(LE, Lq_after_fill);
        ld1(VReg(0).h[0], ptr(reg_src)); ld1(VReg(1).h[0], ptr(reg_wei)); ld1(VReg(2).h[0], ptr(reg_wei2)); ld1(VReg(3).h[0], ptr(reg_wei3)); ld1(VReg(4).h[0], ptr(reg_wei4));
        ...
        cmp(reg_tail, 1); b(LE, Lq_after_fill);
        ...
        add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride); add(reg_wei2, reg_wei2, reg_wei_stride); add(reg_wei3, reg_wei3, reg_wei_stride); add(reg_wei4, reg_wei4, reg_wei_stride);
        cmp(reg_tail, 2); b(LE, Lq_after_fill);
        ...
        add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride); add(reg_wei2, reg_wei2, reg_wei_stride); add(reg_wei3, reg_wei3, reg_wei_stride); add(reg_wei4, reg_wei4, reg_wei_stride);
        cmp(reg_tail, 3); b(LE, Lq_after_fill);
        ...
        add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride); add(reg_wei2, reg_wei2, reg_wei_stride); add(reg_wei3, reg_wei3, reg_wei_stride); add(reg_wei4, reg_wei4, reg_wei_stride);
        cmp(reg_tail, 4); b(LE, Lq_after_fill);
        ...
        add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride); add(reg_wei2, reg_wei2, reg_wei_stride); add(reg_wei3, reg_wei3, reg_wei_stride); add(reg_wei4, reg_wei4, reg_wei_stride);
        cmp(reg_tail, 5); b(LE, Lq_after_fill);
        ...
        add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride); add(reg_wei2, reg_wei2, reg_wei_stride); add(reg_wei3, reg_wei3, reg_wei_stride); add(reg_wei4, reg_wei4, reg_wei_stride);
        cmp(reg_tail, 6); b(LE, Lq_after_fill);
        ...
        add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride); add(reg_wei2, reg_wei2, reg_wei_stride); add(reg_wei3, reg_wei3, reg_wei_stride); add(reg_wei4, reg_wei4, reg_wei_stride);
        cmp(reg_tail, 7); b(LE, Lq_after_fill);
        ...
        add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride); add(reg_wei2, reg_wei2, reg_wei_stride); add(reg_wei3, reg_wei3, reg_wei_stride); add(reg_wei4, reg_wei4, reg_wei_stride);
        ld1(VReg(0).h[7], ptr(reg_src)); ld1(VReg(1).h[7], ptr(reg_wei)); ld1(VReg(2).h[7], ptr(reg_wei2)); ld1(VReg(3).h[7], ptr(reg_wei3)); ld1(VReg(4).h[7], ptr(reg_wei4));
        fmlal(VReg4S(20), VReg4H(0), VReg4H(1)); fmlal2(VReg4S(20), VReg4H(0), VReg4H(1));
        fmlal(VReg4S(21), VReg4H(0), VReg4H(2)); fmlal2(VReg4S(21), VReg4H(0), VReg4H(2));
        fmlal(VReg4S(22), VReg4H(0), VReg4H(3)); fmlal2(VReg4S(22), VReg4H(0), VReg4H(3));
        fmlal(VReg4S(23), VReg4H(0), VReg4H(4)); fmlal2(VReg4S(23), VReg4H(0), VReg4H(4));
        // reduce/store
        faddp(VReg4S(20), VReg4S(20), VReg4S(20)); faddp(VReg2S(20), VReg2S(20), VReg2S(20));
        faddp(VReg4S(21), VReg4S(21), VReg4S(21)); faddp(VReg2S(21), VReg2S(21), VReg2S(21));
        faddp(VReg4S(22), VReg4S(22), VReg4S(22)); faddp(VReg2S(22), VReg2S(22), VReg2S(22));
    ...
    Label Lloop2, Lloop, Lafter_loop, Lafter_fill, Lnp1, Lend1, Lnp2, Lend2, Lnot_packed, Lkx_loop_s, Lafter_kx_s, Ls_loop, Ls_after_loop, Ls_after_fill;
    ...
    ld1(VReg(0).h[0], ptr(reg_src)); ld1(VReg(1).h[0], ptr(reg_wei)); add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride);
    ld1(VReg(0).h[1], ptr(reg_src)); ld1(VReg(1).h[1], ptr(reg_wei)); add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride);
    ld1(VReg(0).h[2], ptr(reg_src)); ld1(VReg(1).h[2], ptr(reg_wei)); add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride);
    ld1(VReg(0).h[3], ptr(reg_src)); ld1(VReg(1).h[3], ptr(reg_wei)); add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride);
    ld1(VReg(0).h[4], ptr(reg_src)); ld1(VReg(1).h[4], ptr(reg_wei)); add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride);
    ld1(VReg(0).h[5], ptr(reg_src)); ld1(VReg(1).h[5], ptr(reg_wei)); add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride);
    ld1(VReg(0).h[6], ptr(reg_src)); ld1(VReg(1).h[6], ptr(reg_wei)); add(reg_src, reg_src, reg_src_stride); add(reg_wei, reg_wei, reg_wei_stride);
    ld1(VReg(0).h[7], ptr(reg_src)); ld1(VReg(1).h[7], ptr(reg_wei));
    fmlal(VReg4S(20), VReg4H(0), VReg4H(1));
    fmlal2(VReg4S(20), VReg4H(0), VReg4H(1));
    add(reg_src, reg_src, reg_src_stride);
...
static inline uint16_t* ptr_f16(MemoryPtr& m) {
...
bool JitConv3DExecutor::supports(const ConvConfig& cfg) {
    ...
    if (!cfg.descs.count(ARG_SRC) || !cfg.descs.count(ARG_WEI) || !cfg.descs.count(ARG_DST)) return false;
    if (!cfg.descs.at(ARG_SRC) || !cfg.descs.at(ARG_WEI) || !cfg.descs.at(ARG_DST)) return false;
    ...
    if (s.getRank() != 5 || w.getRank() < 5 || d.getRank() != 5) return false;
    ...
    if (!(f16_ok || f32_ok)) return false;

    // group == 1: weights rank==5 (no groups)
    if (w.getRank() != 5) return false;
...
void JitConv3DExecutor::run_naive_fp16(const MemoryArgs& memory) {
    ...
    const uint16_t* wei_p = ptr_f16(wei);
    ...
    auto index_wei = [&](size_t oc, size_t c, size_t kz, size_t ky, size_t kx) -> size_t {
        ...
        for (size_t oh = 0; oh < OH; ++oh) {
            ...
            for (size_t ow = 0; ow < OW; ++ow) {
                const int64_t ix0 = static_cast<int64_t>(ow * SW) - static_cast<int64_t>(PW0);
                    ...
                    const size_t wei_c_stride_elems = KD * KH * KW;

                    if (SD == 1 && SH == 1 && SW == 1) {
                        const ptrdiff_t kz_lo = std::max<ptrdiff_t>(0, -iz0);
                        const ptrdiff_t kz_hi = std::min<ptrdiff_t>(static_cast<ptrdiff_t>(KD) - 1,
                                                                    static_cast<ptrdiff_t>(ID) - 1 - iz0);
                        const ptrdiff_t ky_lo = std::max<ptrdiff_t>(0, -iy0);
                        const ptrdiff_t ky_hi = std::min<ptrdiff_t>(static_cast<ptrdiff_t>(KH) - 1,
                                                                    static_cast<ptrdiff_t>(IH) - 1 - iy0);
                        const ptrdiff_t kx_lo = std::max<ptrdiff_t>(0, -ix0);
                        const ptrdiff_t kx_hi = std::min<ptrdiff_t>(static_cast<ptrdiff_t>(KW) - 1,
                                                                    static_cast<ptrdiff_t>(IW) - 1 - ix0);
                        if (kz_lo <= kz_hi && ky_lo <= ky_hi && kx_lo <= kx_hi) {
                            ...
                            for (ptrdiff_t kz = kz_lo; kz <= kz_hi; ++kz) {
                                ...
                                const size_t s_base0 = index_src(n, 0, iz, iy, ix);
                                ...
                                if (m_wei_packed_ready) {
                                    ...
                                    for (ptrdiff_t ky = ky_lo; ky <= ky_hi; ++ky) {
                                        ...
                                        const size_t pack_base0 = (((oc0 * KD + static_cast<size_t>(kz)) * KH + static_cast<size_t>(ky)) * KW + static_cast<size_t>(kx_lo)) * m_padded_C;
                                        a.wei = m_wei_packed.data() + pack_base0;
                                        if (has_oc1) {
                                            const size_t pack_base1 = (((oc1 * KD + static_cast<size_t>(kz)) * KH + static_cast<size_t>(ky)) * KW + static_cast<size_t>(kx_lo)) * m_padded_C;
                                        ...
                                        if (has_oc2) {
                                            ...
                                            a2.kw_cnt = a.kw_cnt;
                                            a2.src_dx = a.src_dx;
                                            const size_t pack_base2 = (((oc2 * KD + static_cast<size_t>(kz)) * KH + static_cast<size_t>(ky)) * KW + static_cast<size_t>(kx_lo)) * m_padded_C;
                                            a2.wei = m_wei_packed.data() + pack_base2;
                                            if (has_oc3) {
                                                const size_t pack_base3 = (((oc3 * KD + static_cast<size_t>(kz)) * KH + static_cast<size_t>(ky)) * KW + static_cast<size_t>(kx_lo)) * m_padded_C;
                                    ...
                                    // Non-packed: keep ky loop outside and issue dual calls
                                    for (ptrdiff_t ky = ky_lo; ky <= ky_hi; ++ky) {
                                        const size_t iy2 = static_cast<size_t>(iy0 + ky);
                                        const size_t ix2 = static_cast<size_t>(ix0 + kx_lo);
                                        const size_t s_base2 = index_src(n, 0, iz, iy2, ix2);
                                        const size_t w0_base = index_wei(oc0, 0, static_cast<size_t>(kz), static_cast<size_t>(ky), static_cast<size_t>(kx_lo));
                                        const size_t w1_base = has_oc1 ? index_wei(oc1, 0, static_cast<size_t>(kz), static_cast<size_t>(ky), static_cast<size_t>(kx_lo)) : 0;
                                        // pair 0
                                        {
                                            jit_conv3d_call_args a{};
                                            a.src = src_p + s_base2;
                                            ...
                                            a.src_dx = sizeof(uint16_t);
                                            a.wei = wei_p + w0_base;
                                            if (has_oc1) a.wei2 = wei_p + w1_base;
                                            a.wei_stride = wei_c_stride_elems * sizeof(uint16_t);
                                            a.wei_blk_stride = a.wei_stride * 8;
                                            a.wei_dx = sizeof(uint16_t);
                                            (*m_ip_kernel)(&a);
                                        }
                                        if (has_oc2) {
                                            const size_t w2_base = index_wei(oc2, 0, static_cast<size_t>(kz), static_cast<size_t>(ky), static_cast<size_t>(kx_lo));
                                            const size_t w3_base = has_oc3 ? index_wei(oc3, 0, static_cast<size_t>(kz), static_cast<size_t>(ky), static_cast<size_t>(kx_lo)) : 0;
                                            jit_conv3d_call_args a{};
                                            a.src = src_p + s_base2;
                                            a.src_stride = src_c_stride_elems * sizeof(uint16_t);
                                            a.src_blk_stride = a.src_stride * 8;
                                            ...
                                            a.src_dx = sizeof(uint16_t);
                                            a.wei = wei_p + w2_base;
                                            if (has_oc3) a.wei2 = wei_p + w3_base;
                                            a.wei_stride = wei_c_stride_elems * sizeof(uint16_t);
                                            a.wei_blk_stride = a.wei_stride * 8;
                                            a.wei_dx = sizeof(uint16_t);
                                            (*m_ip_kernel)(&a);
                        ...
                        if (iz < 0 || iz >= static_cast<int64_t>(ID)) continue;
                        for (size_t ky = 0; ky < KH; ++ky) {
                            const int64_t iy = iy0 + static_cast<int64_t>(ky);
                            if (iy < 0 || iy >= static_cast<int64_t>(IH)) continue;
                            for (size_t kx = 0; kx < KW; ++kx) {
                                const int64_t ix = ix0 + static_cast<int64_t>(kx);
                                if (ix < 0 || ix >= static_cast<int64_t>(IW)) continue;
                                const size_t s_base0 = index_src(n, 0, static_cast<size_t>(iz), static_cast<size_t>(iy), static_cast<size_t>(ix));
                                const size_t w0_base = index_wei(oc0, 0, kz, ky, kx);
                                const size_t w1_base = has_oc1 ? index_wei(oc1, 0, kz, ky, kx) : 0;
                                // pair 0
                                {
                                    jit_conv3d_call_args a{};
                                    a.src = src_p + s_base0;
                                    a.src_stride = src_c_stride_elems * sizeof(uint16_t);
                                    a.src_blk_stride = a.src_stride * 8; // used logically, kernel advances by stride once after 8 lanes
                                    a.acc = &acc0;
                                    a.acc2 = has_oc1 ? &acc1 : nullptr;
                                    ...
                                    if (m_wei_packed_ready) {
                                        ...
                                        if (has_oc1) {
                                            const size_t pack_base1 = (((oc1 * KD + kz) * KH + ky) * KW + kx) * m_padded_C;
                                            a.wei2 = m_wei_packed.data() + pack_base1;
                                        }
                                        (*m_ip_kernel)(&a);
                                    } else {
                                ...
                                // pair 1
                                if (has_oc2) {
                                    const size_t w2_base = index_wei(oc2, 0, kz, ky, kx);
                                    const size_t w3_base = has_oc3 ? index_wei(oc3, 0, kz, ky, kx) : 0;
                                    jit_conv3d_call_args a{};
                                    a.src = src_p + s_base0;
                                    a.src_stride = src_c_stride_elems * sizeof(uint16_t);
                                    a.src_blk_stride = a.src_stride * 8; // used logically, kernel advances by stride once after 8 lanes
                                    ...
                                    if (m_wei_packed_ready) {
                                        ...
                                        a.wei_blk_stride = a.wei_stride * 8; // logical
                                        if (has_oc3) {
                                            const size_t pack_base3 = (((oc3 * KD + kz) * KH + ky) * KW + kx) * m_padded_C;
                    ...
                    // Optional fused bias (disabled by default)
                    if (m_apply_post_ops && m_attrs.withBias && memory.count(ARG_BIAS) && memory.at(ARG_BIAS)) {
                    ...
                    // Optional fused PReLU (apply after bias) — disabled by default
                    if (m_apply_post_ops && m_has_prelu && !m_prelu_slopes.empty()) {
                        const auto slope_at = [&](size_t oc) -> float {
                            return m_prelu_slopes.size() == 1 ? m_prelu_slopes[0]
                                                              : m_prelu_slopes[std::min(oc, m_prelu_slopes.size() - 1)];
                        };
                        const float s0 = slope_at(oc0);
                        if (acc0 < 0.f) acc0 *= s0;
                        if (has_oc1) { const float s1 = slope_at(oc1); if (acc1 < 0.f) acc1 *= s1; }
                        if (has_oc2) { const float s2 = slope_at(oc2); if (acc2 < 0.f) acc2 *= s2; }
                        if (has_oc3) { const float s3 = slope_at(oc3); if (acc3 < 0.f) acc3 *= s3; }
                    }
...
void JitConv3DExecutor::execute(const MemoryArgs& memory) {
    if (m_is_fp32) run_naive_fp32(memory); else run_naive_fp16(memory);
}

void JitConv3DExecutor::ensure_weights_packed_f32(const MemoryArgs& memory) {
    if (m_wei_packed_ready_f32) return;
    auto src = memory.at(ARG_SRC);
    auto wei = memory.at(ARG_WEI);
    const auto& srcDims = src->getDescPtr()->getShape().getStaticDims();
    const auto& weiDims = wei->getDescPtr()->getShape().getStaticDims();
    if (srcDims.size() != 5 || weiDims.size() != 5) return;
    const size_t C = srcDims[1];
    const size_t OC = weiDims[0];
    const size_t KD = weiDims[2], KH = weiDims[3], KW = weiDims[4];
                            ...
                            for (ptrdiff_t kz = kz_lo; kz <= kz_hi; ++kz) {
                                ...
                                for (ptrdiff_t ky = ky_lo; ky <= ky_hi; ++ky) {
                                    ...
                                    if (m_wei_packed_ready_f32) {
                                        ...
                                        const size_t w0 = index_wei(oc0, 0, static_cast<size_t>(kz), static_cast<size_t>(ky), static_cast<size_t>(kx_lo));
                                        const size_t w1 = has_oc1 ? index_wei(oc1, 0, static_cast<size_t>(kz), static_cast<size_t>(ky), static_cast<size_t>(kx_lo)) : 0;
                                        jit_conv3d_f32_call_args a{};
                                        a.src = src_p + s_base;
                                        a.src_stride = src_c_stride_elems * sizeof(float);
                                        a.src_blk_stride = a.src_stride * 4;
