    ...
    static const std::map<const ov::DiscreteTypeInfo, Eltwise::Initializer> initializers{
        ...
        {PowerStaticNode::get_type_info_static(),
         [](const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.m_attrs.alpha = powerStatic->get_power();
             node.m_attrs.beta = powerStatic->get_scale();
             node.m_attrs.gamma = powerStatic->get_shift();
        ...
        {ov::op::v10::IsInf::get_type_info_static(),
         [](const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.m_attrs.alpha = static_cast<float>(attributes.detect_negative);
             node.m_attrs.beta = static_cast<float>(attributes.detect_positive);
         }},
        ...
        {ov::op::v0::Relu::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_relu;
         }},
        {LeakyReluNode::get_type_info_static(),
         [](const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.algorithm = Algorithm::EltwiseRelu;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_relu;
             node.m_attrs.alpha = leakyRelu->get_slope();
             node.m_attrs.beta = 0.0F;
         }},
        {ov::op::v0::Gelu::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             node.algorithm = Algorithm::EltwiseGeluErf;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_gelu_erf;
         }},
        {ov::op::v7::Gelu::get_type_info_static(),
         [](const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             if (approximationMode == ov::op::GeluApproximationMode::ERF) {
                 ...
                 node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_gelu_tanh;
             } else {
        ...
        {ov::op::v0::Elu::get_type_info_static(),
         [](const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.m_attrs.alpha = static_cast<float>(eluOp->get_alpha());
             node.algorithm = Algorithm::EltwiseElu;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_elu;
         }},
        {ov::op::v0::Tanh::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             node.algorithm = Algorithm::EltwiseTanh;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_tanh;
         }},
        {ov::op::v0::Sigmoid::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             node.algorithm = Algorithm::EltwiseSigmoid;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_logistic;
         }},
        {ov::op::v0::Abs::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             node.algorithm = Algorithm::EltwiseAbs;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_abs;
         }},
        {ov::op::v0::Sqrt::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             node.algorithm = Algorithm::EltwiseSqrt;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_sqrt;
         }},
        {ov::op::v0::Clamp::get_type_info_static(),
         [](const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.m_attrs.alpha = alpha_;
             node.m_attrs.beta = beta_;
             node.algorithm = Algorithm::EltwiseClamp;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_clip;
         }},
        ...
        {SwishNode::get_type_info_static(),
         [](const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_swish;
             node.m_attrs.alpha = swishOp->get_alpha();
         }},
        {ov::op::v4::HSwish::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.m_attrs.alpha = 1.F / 6.F;
             node.m_attrs.beta = 0.5F;
             node.algorithm = Algorithm::EltwiseHswish;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_hardswish;
         }},
        {ov::op::v4::Mish::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             node.algorithm = Algorithm::EltwiseMish;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_mish;
         }},
        {ov::op::v5::HSigmoid::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             node.algorithm = Algorithm::EltwiseHsigmoid;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_hsigmoid;
         }},
        {ov::op::v5::Round::get_type_info_static(),
         [](const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             case ov::op::v5::Round::RoundMode::HALF_TO_EVEN:
                 ...
                 node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_round_half_to_even;
                 break;
             case ov::op::v5::Round::RoundMode::HALF_AWAY_FROM_ZERO:
                 node.algorithm = Algorithm::EltwiseRoundHalfAwayFromZero;
                 node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_round_half_away_from_zero;
                 break;
             }
         }},
        ...
        {ov::op::v4::SoftPlus::get_type_info_static(),
         []([[maybe_unused]] const std::shared_ptr<ov::Node>& op, Eltwise& node) {
             ...
             node.m_attrs.alpha = 1.F;
             node.m_attrs.onednnAlgorithm = dnnl::algorithm::eltwise_soft_relu;
         }},
...
Eltwise::Eltwise(const std::shared_ptr<ov::Node>& op, const GraphContext::CPtr& context)
    ...
    m_attrs.algorithm = getAlgorithm();
}
...
void Eltwise::initSupportedPrimitiveDescriptors() {
    ...
    for (size_t i = 0; i < getParentEdges().size(); i++) {
        auto srcDesc =
            std::make_shared<CpuBlockedMemoryDesc>(getOriginalInputPrecisionAtPort(i), getInputShapeAtPort(i));
    ...
    auto dstDesc = std::make_shared<CpuBlockedMemoryDesc>(dstPrecision, getOutputShapeAtPort(0));
    ...
    for (const auto& nodeDescriptors : nodeDescriptorsList) {
        ...
        // std::cout << "after src descs: " << "\n";
        for (size_t i = 0; i < srcDescs.size(); i++) {
            const int isInPlace = i != 0 && isDynamicNode() && canBeInPlace() &&
                                          nodeConfig.inConfs[i].getMemDesc()->getPrecision() == outputPrecision
                                      ? 0
                                      : -1;
            if (auto it = nodeDescriptors.find(ARG_SRC + i); it != nodeDescriptors.end()) {
                nodeConfig.inConfs[i] = {it->second, BlockedMemoryDesc::EMPTY_MASK, isInPlace};
            } else {
                nodeConfig.inConfs[i] = {srcDescs[i], BlockedMemoryDesc::EMPTY_MASK, isInPlace};
            }

            // std::cout << *nodeConfig.inConfs[i].getMemDesc() << '\n';
        }

        nodeConfig.outConfs.emplace_back(outputDesc, BlockedMemoryDesc::EMPTY_MASK, -1);
...
bool Eltwise::canFuse(const NodePtr& node) const {
    ...
    if (!EltwiseJitExecutor::isSupportedConfiguration(m_attrs, inputShapes.front().getRank())) {
        return false;
    }
    ...
    if ((eltwise == nullptr) ||
        (!EltwiseJitExecutor::isSupportedConfiguration(m_attrs, inputShapes.front().getRank()))) {
        return false;
    }
#endif
...
void Eltwise::prepareParams() {
    // print_dnnl_memory(m_memory.at(ARG_SRC)->getPrimitive(), 10, ARG_SRC);
    // std::cout << getSrcMemoryAtPort(0)->getDesc() << "\n";
    // print_dnnl_memory(getSrcMemoryAtPort(1)->getPrimitive(), 10, ARG_SRC_1);
    // updateInputBlockDims();
...
void Eltwise::execute([[maybe_unused]] const dnnl::stream& strm) {
    // print_dnnl_memory(m_memory.at(ARG_SRC)->getPrimitive(), 10, ARG_SRC);
    // std::cout << getSrcMemoryAtPort(0)->getDesc() << "\n";
    // print_dnnl_memory(m_memory.at(ARG_SRC_1)->getPrimitive(), 10, ARG_SRC_1);
    assert(m_executor);
...
void Eltwise::fuseInto(NodePtr& parentNode) {
    ...
    m_attrs.specialConvolutionAddFusing =
        ...
        m_attrs.algorithm == Algorithm::EltwiseAdd &&
...
bool Eltwise::appendAttrPostOps(DnnlPostOpsComposerLegacy& dnnlpoc,
    ...
    if (getOneDnnAlgorithm() != dnnl::algorithm::undef) {
        ...
        case Algorithm::EltwisePowerStatic:
            if (m_attrs.beta != 1.0F && m_attrs.gamma != 0.0F) {
                return dnnlpoc.appendLinear(m_attrs.scales, m_attrs.shifts, isLastPostOp, allowBinary);
            } else if (m_attrs.beta != 1.0F) {  // Multiply if has m_attrs.scales
                return dnnlpoc.appendScale(m_attrs.scales, isLastPostOp, allowBinary);
            } else if (m_attrs.gamma != 0.0F) {  // Add only if has m_attrs.shifts
                return dnnlpoc.appendShift(m_attrs.shifts, allowBinary);
            }
            break;
        case Algorithm::EltwisePrelu:
...
bool Eltwise::canFuseParent(const NodePtr& parentNode) const {
    ...
    if (!EltwiseJitExecutor::isSupportedConfiguration(m_attrs, inputShapes.front().getRank(), input_precisions)) {
        return false;
    }
#else
...
bool Eltwise::canFuseConvert(const NodePtr& convertNode) {
    ...
    return EltwiseJitExecutor::isSupportedConfiguration(m_attrs,
