...
Pooling::Pooling(const std::shared_ptr<ov::Node>& op, const GraphContext::CPtr context)
    ...
    if (auto maxPoolOp_v8 = ov::as_type_ptr<const ov::op::v8::MaxPool>(op)) {
        ...
        poolingAttrs.auto_pad = (maxPoolOp_v8->get_auto_pad() == ov::op::PadType::SAME_LOWER ||
                                 maxPoolOp_v8->get_auto_pad() == ov::op::PadType::SAME_UPPER);
        ...
        poolingAttrs.auto_pad = (maxPoolOp_v1->get_auto_pad() == ov::op::PadType::SAME_LOWER ||
                                 maxPoolOp_v1->get_auto_pad() == ov::op::PadType::SAME_UPPER);
        ...
        poolingAttrs.auto_pad = (avgPoolOp->get_auto_pad() == ov::op::PadType::SAME_LOWER ||
                                 avgPoolOp->get_auto_pad() == ov::op::PadType::SAME_UPPER);
    }
