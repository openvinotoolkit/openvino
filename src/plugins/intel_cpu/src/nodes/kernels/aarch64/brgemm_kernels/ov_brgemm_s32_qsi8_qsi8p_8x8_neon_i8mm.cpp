...
jit_int8_brgemm_kernel_8x8_smmla_packed::jit_int8_brgemm_kernel_8x8_smmla_packed()
    : jit_generator() {}

void jit_int8_brgemm_kernel_8x8_smmla_packed::create_ker() {
    jit_generator::create_kernel();
    ker_ = ov::intel_cpu::jit_kernel_cast<ker_t>(jit_ker());
}

void jit_int8_brgemm_kernel_8x8_smmla_packed::generate() {
    preamble();
    ...
    auto compute8 = [&]() {
        ...
        emit_smmla(v_acc20.s, v_a45.b, v_w01.b);
        emit_smmla(v_acc21.s, v_a45.b, v_w23.b);
        emit_smmla(v_acc22.s, v_a45.b, v_w45.b);
        emit_smmla(v_acc23.s, v_a45.b, v_w67.b);
        emit_smmla(v_acc30.s, v_a67.b, v_w01.b);
        emit_smmla(v_acc31.s, v_a67.b, v_w23.b);
        emit_smmla(v_acc32.s, v_a67.b, v_w45.b);
        emit_smmla(v_acc33.s, v_a67.b, v_w67.b);
    ...
    L(store_accum);
    store_pair_acc(reg_c0, reg_c1, v_acc00, v_acc01, v_acc02, v_acc03);
    store_pair_acc(reg_c2, reg_c3, v_acc10, v_acc11, v_acc12, v_acc13);
    store_pair_acc(reg_c4, reg_c5, v_acc20, v_acc21, v_acc22, v_acc23);
    store_pair_acc(reg_c6, reg_c7, v_acc30, v_acc31, v_acc32, v_acc33);
    b(store_done);

    L(store_no_accum);
    store_pair_noacc(reg_c0, reg_c1, v_acc00, v_acc01, v_acc02, v_acc03);
    store_pair_noacc(reg_c2, reg_c3, v_acc10, v_acc11, v_acc12, v_acc13);
    store_pair_noacc(reg_c4, reg_c5, v_acc20, v_acc21, v_acc22, v_acc23);
    store_pair_noacc(reg_c6, reg_c7, v_acc30, v_acc31, v_acc32, v_acc33);
