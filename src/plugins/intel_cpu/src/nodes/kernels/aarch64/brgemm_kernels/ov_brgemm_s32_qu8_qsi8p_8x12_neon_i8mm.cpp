...
jit_int8_brgemm_kernel_8x12_usmmla_packed::jit_int8_brgemm_kernel_8x12_usmmla_packed()
    : jit_generator() {}

void jit_int8_brgemm_kernel_8x12_usmmla_packed::create_ker() {
    jit_generator::create_kernel();
    ker_ = ov::intel_cpu::jit_kernel_cast<ker_t>(jit_ker());
}

void jit_int8_brgemm_kernel_8x12_usmmla_packed::generate() {
    preamble();
    ...
    auto compute8 = [&]() {
        ...
        emit_usmmla(v_acc04.s, v_a01.b, v_w01.b);
        emit_usmmla(v_acc05.s, v_a01.b, v_w23.b);
        emit_usmmla(v_acc14.s, v_a23.b, v_w01.b);
        emit_usmmla(v_acc15.s, v_a23.b, v_w23.b);
        emit_usmmla(v_acc24.s, v_a45.b, v_w01.b);
        emit_usmmla(v_acc25.s, v_a45.b, v_w23.b);
        emit_usmmla(v_acc34.s, v_a67.b, v_w01.b);
        emit_usmmla(v_acc35.s, v_a67.b, v_w23.b);
    ...
    auto store_pair_acc = [&](const XReg& reg_lo,
        ...
        if (add_bias) {
            ...
            ldr(QReg(v_tmp0.getIdx()), ptr(reg_bias, 32));
            add(v_row0_2.s, v_row0_2.s, v_tmp0.s);
            add(v_row1_2.s, v_row1_2.s, v_tmp0.s);
        }
    ...
    L(store_accum);
    store_pair_acc(reg_c0, reg_c1, v_acc00, v_acc01, v_acc02, v_acc03, v_acc04, v_acc05, false);
    store_pair_acc(reg_c2, reg_c3, v_acc10, v_acc11, v_acc12, v_acc13, v_acc14, v_acc15, false);
    store_pair_acc(reg_c4, reg_c5, v_acc20, v_acc21, v_acc22, v_acc23, v_acc24, v_acc25, false);
    store_pair_acc(reg_c6, reg_c7, v_acc30, v_acc31, v_acc32, v_acc33, v_acc34, v_acc35, false);
    b(store_done);

    L(store_accum_bias);
    store_pair_acc(reg_c0, reg_c1, v_acc00, v_acc01, v_acc02, v_acc03, v_acc04, v_acc05, true);
    store_pair_acc(reg_c2, reg_c3, v_acc10, v_acc11, v_acc12, v_acc13, v_acc14, v_acc15, true);
    store_pair_acc(reg_c4, reg_c5, v_acc20, v_acc21, v_acc22, v_acc23, v_acc24, v_acc25, true);
    store_pair_acc(reg_c6, reg_c7, v_acc30, v_acc31, v_acc32, v_acc33, v_acc34, v_acc35, true);
    b(store_done);

    L(store_no_accum);
    cbnz(reg_bias, store_no_accum_bias);
    store_pair_noacc(reg_c0, reg_c1, v_acc00, v_acc01, v_acc02, v_acc03, v_acc04, v_acc05, false);
    store_pair_noacc(reg_c2, reg_c3, v_acc10, v_acc11, v_acc12, v_acc13, v_acc14, v_acc15, false);
    store_pair_noacc(reg_c4, reg_c5, v_acc20, v_acc21, v_acc22, v_acc23, v_acc24, v_acc25, false);
    store_pair_noacc(reg_c6, reg_c7, v_acc30, v_acc31, v_acc32, v_acc33, v_acc34, v_acc35, false);
    b(store_done);

    L(store_no_accum_bias);
    store_pair_noacc(reg_c0, reg_c1, v_acc00, v_acc01, v_acc02, v_acc03, v_acc04, v_acc05, true);
    store_pair_noacc(reg_c2, reg_c3, v_acc10, v_acc11, v_acc12, v_acc13, v_acc14, v_acc15, true);
    store_pair_noacc(reg_c4, reg_c5, v_acc20, v_acc21, v_acc22, v_acc23, v_acc24, v_acc25, true);
    store_pair_noacc(reg_c6, reg_c7, v_acc30, v_acc31, v_acc32, v_acc33, v_acc34, v_acc35, true);
