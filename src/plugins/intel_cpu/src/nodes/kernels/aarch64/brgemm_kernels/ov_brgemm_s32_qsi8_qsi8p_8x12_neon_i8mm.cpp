...
jit_int8_brgemm_kernel_8x12_smmla_packed::jit_int8_brgemm_kernel_8x12_smmla_packed()
    : jit_generator() {}

void jit_int8_brgemm_kernel_8x12_smmla_packed::create_ker() {
    jit_generator::create_kernel();
    ker_ = ov::intel_cpu::jit_kernel_cast<ker_t>(jit_ker());
}

void jit_int8_brgemm_kernel_8x12_smmla_packed::generate() {
    preamble();
    ...
    const VReg v_acc00 = VReg(8);
    const VReg v_acc01 = VReg(9);
    const VReg v_acc02 = VReg(10);
    const VReg v_acc03 = VReg(11);
    const VReg v_acc04 = VReg(12);
    const VReg v_acc05 = VReg(13);
    const VReg v_acc10 = VReg(14);
    const VReg v_acc11 = VReg(15);
    const VReg v_acc12 = VReg(16);
    const VReg v_acc13 = VReg(17);
    const VReg v_acc14 = VReg(18);
    const VReg v_acc15 = VReg(19);
    const VReg v_acc20 = VReg(20);
    const VReg v_acc21 = VReg(21);
    const VReg v_acc22 = VReg(22);
    const VReg v_acc23 = VReg(23);
    const VReg v_acc24 = VReg(24);
    const VReg v_acc25 = VReg(25);
    const VReg v_acc30 = VReg(26);
    const VReg v_acc31 = VReg(27);
    const VReg v_acc32 = VReg(28);
    const VReg v_acc33 = VReg(29);
    const VReg v_acc34 = VReg(30);
    const VReg v_acc35 = VReg(31);
    ...
    eor(v_acc24.b, v_acc24.b, v_acc24.b);
    eor(v_acc25.b, v_acc25.b, v_acc25.b);
    ...
    eor(v_acc34.b, v_acc34.b, v_acc34.b);
    eor(v_acc35.b, v_acc35.b, v_acc35.b);
    ...
    auto prefetch_next = [&]() {
        prfm(PLDL1KEEP, ptr(reg_wei, 384));
    ...
    auto compute8 = [&]() {
        ...
        ldp(QReg(v_w01.getIdx()), QReg(v_w23.getIdx()), ptr(reg_wei, 64));

        emit_smmla(v_acc04.s, v_a01.b, v_w01.b);
        emit_smmla(v_acc05.s, v_a01.b, v_w23.b);
        emit_smmla(v_acc14.s, v_a23.b, v_w01.b);
        emit_smmla(v_acc15.s, v_a23.b, v_w23.b);
        emit_smmla(v_acc24.s, v_a45.b, v_w01.b);
        emit_smmla(v_acc25.s, v_a45.b, v_w23.b);
        emit_smmla(v_acc34.s, v_a67.b, v_w01.b);
        emit_smmla(v_acc35.s, v_a67.b, v_w23.b);

        advance_src();
        add(reg_wei, reg_wei, 96);
    };
    ...
    const VReg v_row0_0 = VReg(0);
    const VReg v_row0_1 = VReg(1);
    const VReg v_row0_2 = VReg(2);
    const VReg v_row1_0 = VReg(3);
    const VReg v_row1_1 = VReg(4);
    const VReg v_row1_2 = VReg(5);
    const VReg v_tmp0 = VReg(6);
    const VReg v_tmp1 = VReg(7);
    ...
    auto store_pair_acc = [&](const XReg& reg_lo,
        ...
        zip1(v_row0_2.d, acc4.d, acc5.d);
        zip2(v_row1_0.d, acc0.d, acc1.d);
        zip2(v_row1_1.d, acc2.d, acc3.d);
        zip2(v_row1_2.d, acc4.d, acc5.d);
        ...
        ldr(QReg(v_tmp0.getIdx()), ptr(reg_lo, 32));
        add(v_tmp0.s, v_tmp0.s, v_row0_2.s);
        str(QReg(v_tmp0.getIdx()), ptr(reg_lo, 32));
        ...
        ldr(QReg(v_tmp0.getIdx()), ptr(reg_hi, 32));
        add(v_tmp0.s, v_tmp0.s, v_row1_2.s);
        str(QReg(v_tmp0.getIdx()), ptr(reg_hi, 32));
    };
    ...
    auto store_pair_noacc = [&](const XReg& reg_lo,
        ...
        str(QReg(v_row0_2.getIdx()), ptr(reg_lo, 32));
        stp(QReg(v_row1_0.getIdx()), QReg(v_row1_1.getIdx()), ptr(reg_hi));
        str(QReg(v_row1_2.getIdx()), ptr(reg_hi, 32));
    };

    cbz(reg_accum, store_no_accum);

    L(store_accum);
    store_pair_acc(reg_c0, reg_c1, v_acc00, v_acc01, v_acc02, v_acc03, v_acc04, v_acc05);
    store_pair_acc(reg_c2, reg_c3, v_acc10, v_acc11, v_acc12, v_acc13, v_acc14, v_acc15);
    store_pair_acc(reg_c4, reg_c5, v_acc20, v_acc21, v_acc22, v_acc23, v_acc24, v_acc25);
    store_pair_acc(reg_c6, reg_c7, v_acc30, v_acc31, v_acc32, v_acc33, v_acc34, v_acc35);
    b(store_done);

    L(store_no_accum);
    store_pair_noacc(reg_c0, reg_c1, v_acc00, v_acc01, v_acc02, v_acc03, v_acc04, v_acc05);
    store_pair_noacc(reg_c2, reg_c3, v_acc10, v_acc11, v_acc12, v_acc13, v_acc14, v_acc15);
    store_pair_noacc(reg_c4, reg_c5, v_acc20, v_acc21, v_acc22, v_acc23, v_acc24, v_acc25);
    store_pair_noacc(reg_c6, reg_c7, v_acc30, v_acc31, v_acc32, v_acc33, v_acc34, v_acc35);
