...
| `ov::device::id`/</br>`DEVICE_ID` | RW | The property for setting the required device to execute on. | Device ID starts from `0` for the first device, `1` for the second device, and so on | `0` |
