...
ov_dependent_option(ENABLE_ZEROAPI_BACKEND "Enable zero-api as a plugin backend" ON "NOT BUILD_COMPILER_FOR_DRIVER;ENABLE_NPU_RUNTIME_COMMON;ENABLE_NPU_PLUGIN_ENGINE" OFF)
...
if(NOT ENABLE_NPU_PLUGIN_ENGINE AND ENABLE_ZEROAPI_BACKEND)
    message(FATAL_ERROR "Zero backend depends on npu plugin engine!")
endif()
...
if(NOT ENABLE_NPU_RUNTIME_COMMON AND ENABLE_ZEROAPI_BACKEND)
    message(FATAL_ERROR "Zero backend depends on npu common libraries!")
endif()
