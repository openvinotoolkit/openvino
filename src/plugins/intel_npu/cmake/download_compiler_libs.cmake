...
function(extract_npu_plugin_compiler_libs
    ...
    if(EXISTS "${extracted_archive_dir}")
        message(STATUS "Prebuilt Plugin Compiler libraries already extracted ${extracted_archive_dir}, skip extraction")
...
if(ENABLE_INTEL_NPU_COMPILER)
    ...
    set(PLUGIN_COMPILER_WINDOWS_CHECKSUM_LATEST 631f435078de14938c9452cbae166d1a7b62ec5f16d4cd2a7d7b4bdf986959fa)
    ...
    set(PLUGIN_COMPILER_WINDOWS_CHECKSUM_FALLBACK 265bda74dfe07260e9b30ca02ec011653a57aa2900b40fd1f5291352922c363c)
    ...
    if(WIN32)
        ...
        set(OS_UPPERCASE "WINDOWS")

        set(PLUGIN_COMPILER_PACKAGE_PREFIX "npu_compiler_vcl_windows_2022")
