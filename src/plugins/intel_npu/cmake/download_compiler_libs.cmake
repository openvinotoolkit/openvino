...
if(ENABLE_INTEL_NPU_COMPILER)
    ...
    # Determine the base URL for downloading compiler libraries.
    # Support THIRDPARTY_SERVER_PATH to allow fetching from a local/private mirror,
    # consistent with the dependency resolution in cmake/dependencies.cmake.
    # Note: the internal mirror uses an extra npu_compiler/ subdirectory under
    # thirdparty/{platform}/, while the public storage does not.
    if(ENABLE_INTEL_NPU_COMPILER_EXPERIMENTAL AND DEFINED ENV{THIRDPARTY_SERVER_PATH})
        set(PLUGIN_COMPILER_BASE_URL "$ENV{THIRDPARTY_SERVER_PATH}")
        set(PLUGIN_COMPILER_WIN_RELATIVE_URL "thirdparty/windows/npu_compiler")
        set(PLUGIN_COMPILER_LIN_RELATIVE_URL "thirdparty/linux/npu_compiler")
    elseif(ENABLE_INTEL_NPU_COMPILER_EXPERIMENTAL AND DEFINED THIRDPARTY_SERVER_PATH)
        set(PLUGIN_COMPILER_BASE_URL "${THIRDPARTY_SERVER_PATH}")
        set(PLUGIN_COMPILER_WIN_RELATIVE_URL "thirdparty/windows/npu_compiler")
        set(PLUGIN_COMPILER_LIN_RELATIVE_URL "thirdparty/linux/npu_compiler")
    else()
        set(PLUGIN_COMPILER_BASE_URL "https://storage.openvinotoolkit.org/dependencies")
        set(PLUGIN_COMPILER_WIN_RELATIVE_URL "thirdparty/windows")
        set(PLUGIN_COMPILER_LIN_RELATIVE_URL "thirdparty/linux")
    endif()
    ...
    if(WIN32)
        ...
        set(PLUGIN_COMPILER_LIBS_URL "${PLUGIN_COMPILER_BASE_URL}/${PLUGIN_COMPILER_WIN_RELATIVE_URL}/npu_compiler_vcl_windows_2022-${PLUGIN_COMPILER_VERSION}-${PLUGIN_COMPILER_COMMIT_SHA}.zip")
        ...
        if(UNIX AND NOT APPLE)
            ...
            if(OS_NAME STREQUAL "Ubuntu")
                if(OS_VERSION STREQUAL "22.04")
                    ...
                    set(PLUGIN_COMPILER_LIBS_URL "${PLUGIN_COMPILER_BASE_URL}/${PLUGIN_COMPILER_LIN_RELATIVE_URL}/npu_compiler_vcl_ubuntu_22_04-${PLUGIN_COMPILER_VERSION}-${PLUGIN_COMPILER_COMMIT_SHA}.tar.gz")
                ...
                elseif(OS_VERSION STREQUAL "24.04")
                    ...
                    set(PLUGIN_COMPILER_LIBS_URL "${PLUGIN_COMPILER_BASE_URL}/${PLUGIN_COMPILER_LIN_RELATIVE_URL}/npu_compiler_vcl_ubuntu_24_04-${PLUGIN_COMPILER_VERSION}-${PLUGIN_COMPILER_COMMIT_SHA}.tar.gz")
