...
if(ENABLE_INTEL_NPU_COMPILER)
    ...
    install(FILES ${PLUGIN_COMPILER_LIB}
        DESTINATION ${OV_CPACK_RUNTIMEDIR} COMPONENT ${NPU_PLUGIN_COMPONENT})
    # Change lib to pass litian check to remove this
    list(APPEND CPACK_DEBIAN_EXCLUDE_FILES "${OV_CPACK_RUNTIMEDIR}/${PLUGIN_COMPILER_LIB}")
endif()
