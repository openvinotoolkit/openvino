...
public:
    ...
    ze_result_t ZE_APICALL pfnBuildLogGetString2(ze_graph_build_log_handle_t hGraphBuildLog,
                                                 uint32_t* pSize,
                                                 char* pBuildLog) {
        throwWhenUnsupported("ze_pfnGraphBuildLogGetString_ext_2_t", ZE_GRAPH_EXT_VERSION_1_12);
    ...
    ze_result_t ZE_APICALL pfnBuildLogDestroy(ze_graph_build_log_handle_t hGraphBuildLog) {
        throwWhenUnsupported("ze_pfnGraphBuildLogDestroy_ext_t", ZE_GRAPH_EXT_VERSION_1_12);
