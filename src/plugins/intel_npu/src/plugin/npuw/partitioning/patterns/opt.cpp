...
SliceLastMatmulMultiply2::SliceLastMatmulMultiply2() {
    auto matmul = opp::wrap_type<ov::op::v0::MatMul>({opp::any_input(), opp::any_input()});
    auto multiply1 = opp::wrap_type<ov::op::v1::Multiply>({matmul, opp::any_input()});
    auto tanh = opp::wrap_type<ov::op::v0::Tanh>({multiply1});
    auto multiply2 = opp::wrap_type<ov::op::v1::Multiply>({tanh, opp::any_input()});
    auto res = opp::wrap_type<ov::op::v0::Result>({multiply2});
    ...
    register_matcher(std::make_shared<opp::Matcher>(res, "SliceLastMatmulMultiply2"), std::move(callback));
}
