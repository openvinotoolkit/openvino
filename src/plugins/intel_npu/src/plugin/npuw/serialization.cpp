...
void ov::npuw::orc::serialize(Stream& stream, ov::npuw::compiled::HostFlashAttentionInfo::HFATileInputIndices& var) {
    stream & var.q & var.k & var.v & var.mask & var.acc & var.max & var.d & var.scale;
}
