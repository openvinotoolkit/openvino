...
void CompiledModelPropertyManager::registerProperties() {
    ...
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::compilation_mode_params, COMPILATION_MODE_PARAMS);
    ...
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::dynamic_shape_to_static, DYNAMIC_SHAPE_TO_STATIC);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::backend_compilation_params, BACKEND_COMPILATION_PARAMS);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::bypass_umd_caching, BYPASS_UMD_CACHING);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::defer_weights_load, DEFER_WEIGHTS_LOAD);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::compiler_dynamic_quantization, COMPILER_DYNAMIC_QUANTIZATION);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::qdq_optimization, QDQ_OPTIMIZATION);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::qdq_optimization_aggressive, QDQ_OPTIMIZATION_AGGRESSIVE);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::disable_version_check, DISABLE_VERSION_CHECK);
    ...
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::batch_compiler_mode_settings, BATCH_COMPILER_MODE_SETTINGS);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::run_inferences_sequentially, RUN_INFERENCES_SEQUENTIALLY);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::enable_weightless, ENABLE_WEIGHTLESS);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::separate_weights_version, SEPARATE_WEIGHTS_VERSION);
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(_config, _properties, ov::intel_npu::enable_strides_for, ENABLE_STRIDES_FOR);
    ...
    FORCE_REGISTER_CUSTOM_PROPERTY(_properties, ov::hint::model, MODEL_PTR, true, ov::PropertyMutability::RO, [](const Config&) {
    ...
    REGISTER_CUSTOM_METRIC(_properties, ov::optimal_number_of_infer_requests, true, [](const Config& config) {
        return ov::Any(static_cast<uint32_t>(getOptimalNumberOfInferRequestsInParallel(config)));
    });
