...
void Properties::registerPluginProperties() {
    ...
    TRY_REGISTER_SIMPLE_PROPERTY(ov::intel_npu::qdq_optimization_forced, QDQ_OPTIMIZATION_FORCED);
...
void Properties::registerCompiledModelProperties() {
    ...
    TRY_REGISTER_COMPILEDMODEL_PROPERTY_IFSET(ov::intel_npu::qdq_optimization_forced, QDQ_OPTIMIZATION_FORCED);
