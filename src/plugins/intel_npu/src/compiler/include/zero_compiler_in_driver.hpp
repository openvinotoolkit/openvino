...
private:
    ...
    void getMetadata(const std::unique_ptr<ze_graph_dditable_ext_decorator>& graphDdiTableExt,
...
private:
    ...
    const std::unique_ptr<ze_graph_dditable_ext_decorator>& _graphDdiTableExt = nullptr;
    Logger _logger;
};
