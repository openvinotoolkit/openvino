...
#define INTEL_NPU_NPUW_IF_GROUP_ROOT_ROOT(EMIT, ...) EMIT(__VA_ARGS__)
#define INTEL_NPU_NPUW_IF_GROUP_ROOT_LLM(EMIT, ...)
#define INTEL_NPU_NPUW_IF_GROUP_ROOT_KOKORO(EMIT, ...)
#define INTEL_NPU_NPUW_IF_GROUP_LLM_ROOT(EMIT, ...)
#define INTEL_NPU_NPUW_IF_GROUP_LLM_LLM(EMIT, ...) EMIT(__VA_ARGS__)
#define INTEL_NPU_NPUW_IF_GROUP_LLM_KOKORO(EMIT, ...)
#define INTEL_NPU_NPUW_IF_GROUP_KOKORO_ROOT(EMIT, ...)
#define INTEL_NPU_NPUW_IF_GROUP_KOKORO_LLM(EMIT, ...)
#define INTEL_NPU_NPUW_IF_GROUP_KOKORO_KOKORO(EMIT, ...) EMIT(__VA_ARGS__)

void intel_npu::registerNPUWOptions(OptionsDesc& desc) {
#define REGISTER_NPUW_OPTION(OPT_TYPE) desc.add<OPT_TYPE>();
#define INTEL_NPU_NPUW_SIMPLE_OPT(OPT, TYPE, DEFAULT, NS, VARNAME, KEY, GROUP, SURFACE, CACHING, BUILD) \
    INTEL_NPU_NPUW_IF_BUILD_##BUILD(INTEL_NPU_NPUW_IF_GROUP_ROOT_##GROUP, REGISTER_NPUW_OPTION, OPT)
...
#undef REGISTER_NPUW_OPTION
}

void intel_npu::registerNPUWLLMOptions(OptionsDesc& desc) {
#define REGISTER_NPUW_OPTION(OPT_TYPE) desc.add<OPT_TYPE>();
#define INTEL_NPU_NPUW_SIMPLE_OPT(OPT, TYPE, DEFAULT, NS, VARNAME, KEY, GROUP, SURFACE, CACHING, BUILD) \
    INTEL_NPU_NPUW_IF_BUILD_##BUILD(INTEL_NPU_NPUW_IF_GROUP_LLM_##GROUP, REGISTER_NPUW_OPTION, OPT)
#define INTEL_NPU_NPUW_STRING_ENUM_OPT(OPT, TYPE, TRAITS, NS, VARNAME, KEY, GROUP, SURFACE, CACHING, BUILD) \
    INTEL_NPU_NPUW_IF_BUILD_##BUILD(INTEL_NPU_NPUW_IF_GROUP_LLM_##GROUP, REGISTER_NPUW_OPTION, OPT)
#define INTEL_NPU_NPUW_ANYMAP_OPT(OPT, NS, VARNAME, KEY, GROUP, SURFACE, CACHING, BUILD) \
    INTEL_NPU_NPUW_IF_BUILD_##BUILD(INTEL_NPU_NPUW_IF_GROUP_LLM_##GROUP, REGISTER_NPUW_OPTION, OPT)
...
#define REGISTER_NPUW_OPTION(OPT_TYPE) desc.add<OPT_TYPE>();
#define INTEL_NPU_NPUW_SIMPLE_OPT(OPT, TYPE, DEFAULT, NS, VARNAME, KEY, GROUP, SURFACE, CACHING, BUILD) \
    INTEL_NPU_NPUW_IF_BUILD_##BUILD(INTEL_NPU_NPUW_IF_GROUP_KOKORO_##GROUP, REGISTER_NPUW_OPTION, OPT)
#define INTEL_NPU_NPUW_STRING_ENUM_OPT(OPT, TYPE, TRAITS, NS, VARNAME, KEY, GROUP, SURFACE, CACHING, BUILD) \
    INTEL_NPU_NPUW_IF_BUILD_##BUILD(INTEL_NPU_NPUW_IF_GROUP_KOKORO_##GROUP, REGISTER_NPUW_OPTION, OPT)
#define INTEL_NPU_NPUW_ANYMAP_OPT(OPT, NS, VARNAME, KEY, GROUP, SURFACE, CACHING, BUILD) \
    INTEL_NPU_NPUW_IF_BUILD_##BUILD(INTEL_NPU_NPUW_IF_GROUP_KOKORO_##GROUP, REGISTER_NPUW_OPTION, OPT)
