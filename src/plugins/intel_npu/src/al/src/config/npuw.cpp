...
#define REGISTER_NPUW_OPTION(OPT_TYPE) desc.add<OPT_TYPE>();
    INTEL_NPU_FOR_EACH_ROOT_NPUW_OPTION(REGISTER_NPUW_OPTION)
#undef REGISTER_NPUW_OPTION
}

void intel_npu::registerNPUWLLMOptions(OptionsDesc& desc) {
#define REGISTER_NPUW_OPTION(OPT_TYPE) desc.add<OPT_TYPE>();
    INTEL_NPU_FOR_EACH_LLM_NPUW_OPTION(REGISTER_NPUW_OPTION)
#undef REGISTER_NPUW_OPTION
}

void intel_npu::registerNPUWKokoroOptions(OptionsDesc& desc) {
#define REGISTER_NPUW_OPTION(OPT_TYPE) desc.add<OPT_TYPE>();
    INTEL_NPU_FOR_EACH_KOKORO_NPUW_OPTION(REGISTER_NPUW_OPTION)
#undef REGISTER_NPUW_OPTION
}
