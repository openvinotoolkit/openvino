...
DEFINE_OPT(NPUW_MOE_TOKEN_CHUNK_SIZE, uint64_t, 128, npuw::partitioning::moe_token_chunk_size, RunTime);
DEFINE_OPT(NPUW_MOE_PREFILL_ASYNC, bool, false, npuw::partitioning::moe_prefill_async, RunTime);
