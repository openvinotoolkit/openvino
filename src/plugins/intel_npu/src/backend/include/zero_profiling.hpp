...
struct ProfilingPool {
    ProfilingPool(ze_graph_handle_t graph_handle,
                  ...
                  const std::unique_ptr<ze_graph_profiling_ddi_table_ext_decorator>& graph_profiling_ddi_table_ext)
    ...
    const std::unique_ptr<ze_graph_profiling_ddi_table_ext_decorator>& _graph_profiling_ddi_table_ext;
};
