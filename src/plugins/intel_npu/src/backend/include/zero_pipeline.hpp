...
public:
    ...
    virtual void updateCommandList(uint32_t arg_index, const void* arg_data, size_t byte_size);
    virtual void updateCommandListIndex(uint32_t arg_index, const void* arg_data, size_t command_list_index);

    virtual void closeCommandList();
    virtual void closeCommandListIndex(size_t command_list_index);
