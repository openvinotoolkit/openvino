...
/**
 * @brief MLIR-level execute-parameter cache for a GraphArguments binding.
 *
...
/**
 * @brief Execute an MLIR graph directly, using the per-pipeline GraphArguments binding.
 *
 ...
 *
 * @param engine    MLIR runtime engine handle obtained via DynamicGraph::get_mlir_engine().
 ...
 */
void vm_execute_graph(npu_mlir_runtime_handle_t engine,
