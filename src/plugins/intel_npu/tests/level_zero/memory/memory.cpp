...
TEST_P(MemoryAllocator, AllocateTwice) {
    ...
    sharedAllocator = std::make_shared<zeroMemory::HostMemSharedAllocator>(ZeroInitStructsHolder::getInstance(), tensor, GetParam());
...
std::vector<int> allocatorFlags = {ZE_HOST_MEM_ALLOC_FLAG_BIAS_CACHED, ZE_HOST_MEM_ALLOC_FLAG_BIAS_UNCACHED, ZE_HOST_MEM_ALLOC_FLAG_BIAS_WRITE_COMBINED, ZE_HOST_MEM_ALLOC_FLAG_BIAS_INITIAL_PLACEMENT};

INSTANTIATE_TEST_SUITE_P(something, MemoryAllocator, 
