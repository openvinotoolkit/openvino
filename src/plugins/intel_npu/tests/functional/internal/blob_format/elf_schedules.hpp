...
public:
    ...
    void SetUp() override {
        ...
        reader->register_reader(KnownSectionType::ELF_MAIN_SCHEDULE, ELFMainScheduleSection::read);
        reader->register_reader(KnownSectionType::ELF_INIT_SCHEDULES, ELFInitSchedulesSection::read);
...
TEST_P(ELFSchedulesSections, MainScheduleSectionNonEmpty) {
    auto section = std::dynamic_pointer_cast<ELFMainScheduleSection>(
        reader->retrieve_first_section(KnownSectionType::ELF_MAIN_SCHEDULE));
...
TEST_P(ELFSchedulesWeightsSeparation, InitSchedulesSectionNonEmpty) {
    auto section = std::dynamic_pointer_cast<ELFInitSchedulesSection>(
        reader->retrieve_first_section(KnownSectionType::ELF_INIT_SCHEDULES));
    ASSERT_NE(section, nullptr);
...
TEST_P(ELFSchedulesNoInits, InitSchedulesSectionAbsent) {
    auto section = reader->retrieve_first_section(KnownSectionType::ELF_INIT_SCHEDULES);
