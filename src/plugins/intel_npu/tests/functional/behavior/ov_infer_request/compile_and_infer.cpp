...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(
        ...
        ::testing::Values(ov::test::utils::DEVICE_NPU),
        ::testing::ValuesIn(std::vector<ov::AnyMap>{
            {ov::intel_npu::model_serializer_algorithm(ov::intel_npu::ModelSerializerAlgorithm::COPY_WEIGHTS)},
            {ov::intel_npu::model_serializer_algorithm(ov::intel_npu::ModelSerializerAlgorithm::POINTERS_TO_ADDRESSES),
