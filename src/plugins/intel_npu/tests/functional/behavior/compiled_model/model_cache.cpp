...
std::vector<ov::AnyMap> config = {
    ...
    {ov::enable_weightless(true),
     ...
     ov::intel_npu::platform(ov::intel_npu::Platform::standardize(ov::test::utils::getTestsPlatformFromEnvironmentOr(
         ov::test::utils::DEVICE_NPU))),  // platform needed for NPU_COMPILER_TYPE_PLUGIN
