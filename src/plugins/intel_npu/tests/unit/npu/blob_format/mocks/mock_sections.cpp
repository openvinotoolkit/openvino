...
//     uint64_t size;
//     blob_reader.read_into_buffer(&size, sizeof(size));
...
// MockSectionWithTable::MockSectionWithTable(std::shared_ptr<MockSection_1> section_1,
//                                            std::unordered_map<SectionID, std::shared_ptr<ISection>>
//                                            parsed_reachables, Manifest embedded_table)
//     : ISection(MockTypes::MOCK_WITH_TABLE),
//       section_1(std::move(section_1)),
...
//     blob_reader.read_into_buffer(&table_location, sizeof(table_location));
