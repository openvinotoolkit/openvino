...
//     blobReader->register_reader(SectionTypeCode::BATCH_SIZE, BatchSizeSection::read);
//     blobReader->register_reader(SectionTypeCode::IO_LAYOUTS, IOLayoutsSection::read);
// }
...
//     reader.register_section_type_evaluator(
//         std::make_shared<SupportedSectionTypeEvaluator>(SectionTypeCode::BATCH_SIZE));
//     return stream.str();
// }
// }  // namespace
...
//     reader.register_reader(SectionTypeCode::BATCH_SIZE, BatchSizeSection::read);
...
//     reader_1->register_reader(SectionTypeCode::BATCH_SIZE, BatchSizeSection::read);
//     reader_1->register_reader(SectionTypeCode::IO_LAYOUTS, IOLayoutsSection::read);
...
//     reader_2->register_reader(SectionTypeCode::BATCH_SIZE, BatchSizeSection::read);
//     reader_2->register_reader(SectionTypeCode::IO_LAYOUTS, IOLayoutsSection::read);
...
//     auto sections = reader.retrieve_sections_same_type(SectionTypeCode::BATCH_SIZE);
...
//     BlobWriter writer;
//     writer.register_section(std::make_shared<IOLayoutsSection>(std::vector<ov::Layout>(),
//     std::vector<ov::Layout>())); std::stringstream stream; writer.write_to(stream);
...
//     auto section = reader.retrieve_section(SectionID(SectionTypeCode::BATCH_SIZE, 0));
//     ASSERT_NE(section, nullptr);
//     EXPECT_EQ(std::dynamic_pointer_cast<BatchSizeSection>(section)->get_batch_size(), BATCH);

//     // there is no second instance
//     EXPECT_EQ(reader.retrieve_section(SectionID(SectionTypeCode::BATCH_SIZE, 1)), nullptr);
// }
...
//     auto absent = reader.retrieve_sections_same_type(SectionTypeCode::IO_LAYOUTS);
...
//     section = reader.retrieve_section(SectionID(SectionTypeCode::BATCH_SIZE, 1));
//     ASSERT_NE(section, nullptr);
//     EXPECT_EQ(std::dynamic_pointer_cast<BatchSizeSection>(section)->get_batch_size(), BATCH_B);

//     section = reader.retrieve_section(SectionID(SectionTypeCode::BATCH_SIZE, 2));
//     ASSERT_NE(section, nullptr);
