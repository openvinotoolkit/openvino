...
//        *ELF*  *BT*
// */
// const std::vector<CREToken> expression_4 = {SectionTypeCode::ELF_MAIN_SCHEDULE, CRE::AND,
...
//     {SectionTypeCode::ELF_MAIN_SCHEDULE, CRE::AND, CRE::OPEN, SectionTypeCode::ELF_MAIN_SCHEDULE, CRE::OR,
//     CRE::CLOSE};

// // Missing only the second operand for the OR operator
// const std::vector<CREToken> invalid_expression_16 =
//     {SectionTypeCode::ELF_MAIN_SCHEDULE, CRE::AND, CRE::OPEN, CRE::OR, SectionTypeCode::ELF_MAIN_SCHEDULE,
//     CRE::CLOSE};
