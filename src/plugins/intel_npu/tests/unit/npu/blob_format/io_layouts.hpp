...
//     IOLayoutsSection real_section({ov::Layout("NCHW"), ov::Layout("NHWC")}, {ov::Layout("NCHW"),
//     ov::Layout("NHWC")}); std::stringstream stream; auto writer =
//     ov::unit_test::intel_npu::create_default_writer_interface(stream); real_section.write(writer); std::string buffer
//     = stream.str();
