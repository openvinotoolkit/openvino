...
TEST(CollapseUNQDQPassTest, RewritesPointwiseConvolutionToMatMulWithPostMatMulScale) {
...
TEST(CollapseUNQDQPassTest, KeepsConvolutionWhenScaleIsNotPerOutputChannel) {
...
TEST(CollapseUNQDQPassTest, RewritesDirectConvolutionToMatMulWithOutputTranspose) {
...
TEST(CollapseUNQDQPassTest, RewritesConvolutionWithScaleParameterReshapeChain) {
