...
void ov::intel_gna::ConvertMatrixFp32ToInt16(int16_t* ptr_dst,
                                             const float* ptr_src,
...
void ov::intel_gna::ConvertMatrixFp32ToInt8(int8_t* ptr_dst,
                                            const float* ptr_src,
                                            const uint32_t num_rows,
                                            const uint32_t num_columns,
                                            const float scale_factor,
...
void ov::intel_gna::ConvertMatrixInt32ToFp32Avx(float* ptr_dst,
...
void ov::intel_gna::ConvertMatrixInt16ToFp32Avx(float* ptr_dst,
...
void ov::intel_gna::ConvertMatrixInt8ToFp32Avx(float* ptr_dst,
