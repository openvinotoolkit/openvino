...
inline void writeNBytes(const void* ptr, size_t size, std::ostream& os) {
...
inline void readNBytes(void* ptr, size_t size, std::istream& is) {
...
header_latest::ModelHeader GNAModelSerial::ReadHeader(std::istream& is) {
    ...
    if (static_cast<size_t>(stream_len) > size_of_headers_header) {
