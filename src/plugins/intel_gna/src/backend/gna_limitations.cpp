...
bool Validator_30::ValidateCnn1DForCnn2GnaIface(const std::string& name, const uint32_t inHeight, const uint32_t inWidth,
...
bool Validator_30::IsCnn1DUsingCnn2DGnaIface() const {
    return false;
}
...
bool Validator_35::IsCnn1DUsingCnn2DGnaIface() const {
    return true;
}

bool Validator_35::ValidateCnn1DForCnn2GnaIface (const std::string& name, const uint32_t inHeight, const uint32_t inWidth,
    const uint32_t inChannels, const uint32_t kernelH, const uint32_t kernelW, const uint32_t kernelN,
    const uint32_t strideH, const uint32_t strideW, const uint32_t dilationH, const uint32_t dilationW,
    const OvGnaType inPrecision, const bool throwOnError) const {
