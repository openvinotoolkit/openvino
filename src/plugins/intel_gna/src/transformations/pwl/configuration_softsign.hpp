...
class ConfigurationSoftSign : public ActivationRepresentationConfigurationBase {
public:
    ConfigurationSoftSign(PWLApproximationMode mode, std::shared_ptr<BoundariesFQHandler> boundaries_handler);
...
private:
    class FunctionSoftSign : public Function {
