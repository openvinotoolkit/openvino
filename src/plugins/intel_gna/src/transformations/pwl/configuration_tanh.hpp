...
class ConfigurationTanh : public ActivationRepresentationConfigurationBase {
public:
    ConfigurationTanh(PWLApproximationMode mode, std::shared_ptr<BoundariesFQHandler> boundaries_handler);
...
private:
    ...
    static constexpr const double kLowerBound = -5;
    static constexpr const double kUpperBound = 5;
    static constexpr const double kMinValue = -1;
