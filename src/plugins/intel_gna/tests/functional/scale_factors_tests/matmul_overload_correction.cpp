...
protected:
    void SetUp() override {
        ...
        auto lowNodeIn1 = ov::test::utils::builder::makeConstant<float>(ngPrc, {1}, {-maxInputValue});
        auto highNodeIn1 = ov::test::utils::builder::makeConstant<float>(ngPrc, {1}, {maxInputValue});
        ...
        auto lowNodeIn2 = ov::test::utils::builder::makeConstant<float>(ngPrc, {1}, {-maxInputValue});
        auto highNodeIn2 = ov::test::utils::builder::makeConstant<float>(ngPrc, {1}, {maxInputValue});
        ...
        auto lowNodeOut =
            ov::test::utils::builder::makeConstant<float>(ngPrc,
                                                          {1},
                                                          {-maxInputValue * maxInputValue * inputShape[1] / 10});
        auto highNodeOut =
            ov::test::utils::builder::makeConstant<float>(ngPrc,
                                                          {1},
                                                          {maxInputValue * maxInputValue * inputShape[1] / 10});
