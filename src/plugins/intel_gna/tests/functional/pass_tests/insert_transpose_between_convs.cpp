...
protected:
    void SetUp() override {
        ...
        auto pattern1 =
            std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{4}, inputShape);
        ...
        auto pattern2 =
            std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{4}, pattern2_shape);
        auto reshape2 = std::make_shared<ov::opset1::Reshape>(conv1, pattern2, false);
        ...
        auto pattern3 =
            std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{2}, pattern3_shape);
        auto reshape3 = std::make_shared<ov::opset1::Reshape>(conv2, pattern3, false);
...
protected:
    void SetUp() override {
        ...
        auto pattern2 =
            std::make_shared<ov::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{4}, pattern2_shape);
        auto reshape2 = std::make_shared<ov::opset1::Reshape>(pool, pattern2, false);
...
const std::vector<std::vector<size_t>> inputShape = {{1, 1, 1, 32}, {1, 8, 1, 64}, {1, 4, 1, 128}};
