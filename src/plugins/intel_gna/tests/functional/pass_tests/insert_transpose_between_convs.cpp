...
protected:
    void SetUp() override {
        ...
        auto params = ov::test::utils::builder::make_params(ngPrc, {inputShape_2d});
        ...
        auto pattern2 =
            std::make_shared<ngraph::opset1::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{4}, pattern2_shape);
        ...
        auto pattern3 =
            std::make_shared<ngraph::opset1::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{2}, pattern3_shape);
