...
protected:
    ...
    void SetUp() override {
        ...
        size_t in_total_dims_size =
            std::accumulate(std::begin(inputShape), std::end(inputShape), 1, std::multiplies<double>());
        auto params = ov::test::utils::builder::make_params(ngPrc, {{1, 2 * in_total_dims_size}});
...
protected:
    ...
    void SetUp() override {
        ...
        size_t in_total_dims_size =
            std::accumulate(std::begin(inputShape), std::end(inputShape), 1, std::multiplies<double>());
        auto params = ov::test::utils::builder::make_params(ngPrc, {{1, splits_num * in_total_dims_size}});
