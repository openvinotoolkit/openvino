    ...
    switch (fun) {
        ...
        case kActFakeQuantize: {
            ...
            if (fun == kActFakeQuantize && fun.fqParams.set) {
                x_lower = static_cast<int32_t>(std::max(static_cast<int64_t>(*fun.fqParams.input_low * in_scale), static_cast<int64_t>(x_lower)));
                x_upper = static_cast<int32_t>(std::min(static_cast<int64_t>(*fun.fqParams.input_high * in_scale), static_cast<int64_t>(x_upper)));
                y_lower = static_cast<int16_t>(std::max(static_cast<int32_t>(*fun.fqParams.input_low * out_scale), static_cast<int32_t>(y_lower)));
                y_upper = static_cast<int16_t>(std::min(static_cast<int32_t>(*fun.fqParams.input_high * out_scale), static_cast<int32_t>(y_upper)));
            }
            auto n_segments = 2;
