...
inline v_float64x8 v_cvt_f64(const v_int64x8& v)
{
    ...
    __m512i v_lo         = _mm512_mask_blend_epi32 (0x55, magic_i_lo, v.val);
...
{
    return v_uint8x64(_mm512_unpacklo_epi8(a.val, b.val));
}

static inline v_uint8x64 v_interleave_high(const v_uint8x64& a, const v_uint8x64& b)
{
    return v_uint8x64(_mm512_unpackhi_epi8(a.val, b.val));
}

static inline v_int16x32 v_interleave_low(const v_int16x32& a, const v_int16x32& b)
{
    return v_int16x32(_mm512_unpacklo_epi16(a.val, b.val));
}

static inline v_int16x32 v_interleave_high(const v_int16x32& a, const v_int16x32& b)
{
    return v_int16x32(_mm512_unpackhi_epi16(a.val, b.val));
}

static inline v_uint8x64 v_saturate_u8(const v_int16x32& a)
{
    v_uint8x64 r;
    r.val = _mm512_packus_epi16(a.val, _mm512_setzero_si512());
    return r;
}

static inline v_int16x32 v_saturate_s16(const v_int32x16& a)
{
    v_int16x32 r;
    r.val = _mm512_packs_epi32(a.val, _mm512_setzero_si512());
    return r;
}

static inline v_int32x16 v_madd(const v_int16x32& a, const v_int16x32& b)
{
    v_int32x16 r;
    r.val = _mm512_madd_epi16(a.val, b.val);
    return r;
}
...
{
    v_int16x32 r;
    r.val = _mm512_mulhi_epi16(a.val, _mm512_set1_epi16(b));
    return r;
}

static inline v_uint16x32 v_mulhi(const v_uint16x32& a, v_uint16x32 b)
{
    v_uint16x32 r;
    r.val = _mm512_mulhi_epu16(a.val, b.val);
    return r;
}

static inline v_uint16x32 v_mulhi(const v_uint16x32& a, uint16_t b)
{
    v_uint16x32 r;
    r.val = _mm512_mulhi_epu16(a.val, _mm512_set1_epi16(b));
    return r;
}
...
static inline v_float32x16 v_fma(const v_float32x16& a, float b, const v_float32x16& c)
{
    return v_fma(a, v512_setall_f32(b), c);
}

static inline v_int16x32 operator+ (const v_int16x32& a, short b)
{
    return a + v512_setall_s16(b);
}

static inline v_int16x32 operator- (short a, const v_int16x32& b)
{
    return v512_setall_s16(a) - b;
}

static inline v_float32x16 operator- (float a, const v_float32x16& b)
{
    return v512_setall_f32(a) - b;
}

static inline v_float32x16 operator* (const v_float32x16& a, float b)
{
