...
public:
    static primitive_impl* create(const non_max_suppression_node& arg) {
        ...
        params.box_encoding = primitive->center_point_box ? kernel_selector::BoxEncodingType::BOX_ENCODING_CENTER : kernel_selector::BoxEncodingType::BOX_ENCODING_CORNER;
