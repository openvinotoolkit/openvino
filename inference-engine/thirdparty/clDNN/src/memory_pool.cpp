...
bool memory_pool::has_conflict(const memory_set& a,
    ...
    //CLDNN_TRACE_IR_METHOD_INTERNAL("memory_pool::has_conflict");
...
memory_impl::ptr memory_pool::get_from_non_padded_pool(const layout& layout,
                                                       ...
                                                       allocation_type type) {
    CLDNN_TRACE_IR_METHOD_INTERNAL("memory_pool::get_from_non_padded_pool");
...
memory_impl::ptr memory_pool::get_from_padded_pool(const layout& layout,
                                                   ...
                                                   const std::set<primitive_id>& restrictions,
                                                   allocation_type type) {
    CLDNN_TRACE_IR_METHOD_INTERNAL("memory_pool::get_from_padded_pool");
...
memory_impl::ptr memory_pool::get_from_across_networks_pool(const layout& layout,
                                                            ...
                                                            uint32_t network_id,
                                                            allocation_type type) {
    CLDNN_TRACE_IR_METHOD_INTERNAL("memory_pool::get_from_across_networks_pool");
...
void memory_pool::clear_pool() {
    CLDNN_TRACE_IR_METHOD_INTERNAL("memory_pool::clear_pool");
