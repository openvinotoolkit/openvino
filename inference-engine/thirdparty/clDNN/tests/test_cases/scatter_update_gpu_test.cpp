...
TEST(scatter_nd_update_gpu_fp16_kelvin, d2411_axisF) {
    //  Dictionary : 2x4x1x1
    //  Indexes : 2x2x1x1
    //  Updates : 2x2x1x1
    //  Axis : 1
    ...
    auto axis = cldnn::scatter_nd_update::scatter_nd_update_axis::along_f;
    ...
    topology.add(
        scatter_nd_update("scatter_nd_update", "InputData", "InputIndices", "InputUpdates", axis)
    );
