...
JitConstants fused_conv_eltwise_kernel_imad::GetJitConstants(const fused_conv_eltwise_params& params,
    ...
    mem_consts.Merge(MakeActivationJitConstants(params.conv.activations, "_CONV_TYPED", true));
    mem_consts.Merge(MakeActivationJitConstants(params.activations, "_ELTW_TYPED", true));
