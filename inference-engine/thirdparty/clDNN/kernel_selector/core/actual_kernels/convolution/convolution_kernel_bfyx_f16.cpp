...
ConvolutionKernel_bfyx_f16::ConvolutionKernel_bfyx_f16() : ConvolutionKernelBase("convolution_gpu_bfyx_f16") {
...
ConvolutionKernelBase::DispatchData ConvolutionKernel_bfyx_f16::SetDefault(const convolution_params& params,
                                                                           int autoTuneIndex) const {
...
bool ConvolutionKernel_bfyx_f16::Validate(const Params& p, const optional_params& o) const {
    ...
    if (params.groups != 1 || params.split != 1)
        return false;

    return true;
}

JitConstants ConvolutionKernel_bfyx_f16::GetJitConstants(const convolution_params& params,
    ...
    jit.AddConstant(MakeJitConstant("IC_BLOCKS", CeilDiv(input.Feature().v, feature_block_size)));
...
KernelsData ConvolutionKernel_bfyx_f16::GetTunedKernelsDataByIndex(const Params& params,
...
KernelsData ConvolutionKernel_bfyx_f16::GetKernelsData(const Params& params, const optional_params& options) const {
    return GetTunedKernelsDataByIndex(params, options);
}

KernelsData ConvolutionKernel_bfyx_f16::GetKernelsDataForAutoTune(const Params& params,
