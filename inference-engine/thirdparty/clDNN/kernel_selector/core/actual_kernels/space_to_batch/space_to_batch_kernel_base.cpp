...
JitConstants SpaceToBatchKernelBase::GetJitConstants(const space_to_batch_params& params) const {
    ...
    makeJitConstForParam(jit, "BLOCK_SHAPE", params.stb_params[0], 1);
    makeJitConstForParam(jit, "PADS_BEGIN", params.stb_params[1], 0);
    makeJitConstForParam(jit, "PADS_END", params.stb_params[2], 0);
