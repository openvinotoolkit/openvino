...
#if QUANTIZATION_TERM
    ACTIVATION_TYPE dequantized = TO_ACTIVATION_TYPE(dotProd) * quantizations[f] * I_QF;
#endif
...
#if QUANTIZATION_TERM
#   if CALIBRATION_TERM
    dequantized = dequantized * calibrations[f]);
...
#   endif // CALIBRATION_TERM
    ...
    output[out_index] = TO_OUTPUT_TYPE_SAT(dequantized);
}
