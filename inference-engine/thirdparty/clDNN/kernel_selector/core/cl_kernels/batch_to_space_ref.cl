...
KERNEL(batch_to_space_ref)(const __global UNIT_TYPE* input, __global UNIT_TYPE* output)
{
    ...
    const uint zyx = get_global_id(2) % (OUTPUT_SIZE_X * OUTPUT_SIZE_Y * OUTPUT_SIZE_Z);
    const uint w = get_global_id(2) / (OUTPUT_SIZE_X * OUTPUT_SIZE_Y * OUTPUT_SIZE_Z);
    ...
    const uint offset_batch = (offset_feature * BLOCK_SHAPE_W * BLOCK_SHAPE_Z * BLOCK_SHAPE_Y * BLOCK_SHAPE_X +
                            offset_w * BLOCK_SHAPE_Z * BLOCK_SHAPE_Y * BLOCK_SHAPE_X +
                            offset_z * BLOCK_SHAPE_Y * BLOCK_SHAPE_X +
