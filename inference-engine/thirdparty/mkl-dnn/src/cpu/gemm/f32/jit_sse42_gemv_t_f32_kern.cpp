...
#include "jit_sse42_gemv_t_f32_kern.hpp"
...
void jit_sse42_gemv_t_f32_kern::v_load(
...
void jit_sse42_gemv_t_f32_kern::v_store(
...
void jit_sse42_gemv_t_f32_kern::dot_product(
...
// Inner loop.
void jit_sse42_gemv_t_f32_kern::innerloop(int unroll_m, int unroll_n) {
...
// Outer loop.
void jit_sse42_gemv_t_f32_kern::outerloop(
...
void jit_sse42_gemv_t_f32_kern::generate() {
    // Prologue
    preamble();
...
jit_sse42_gemv_t_f32_kern::jit_sse42_gemv_t_f32_kern()
