...
INST_TEST_CASE(SimpleSmall_Depthwise_Blocked_Padded_Channels,
    ...
    PARAMS(FMT_DATA_BLOCKED, Goihw8g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 111, 111, 1, 2, 111, 1, 1, 3, 3, 1, 1, 1, 2),
    PARAMS(FMT_DATA_BLOCKED, Goihw8g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 29, 29, 16, 32, 29, 16, 18, 3, 3, 1, 2, 1, 2),
    PARAMS(FMT_DATA_BLOCKED, Goihw8g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 53, 53, 32, 16, 53, 16, 14, 3, 3, 1, 0, 2, 1),
    PARAMS(FMT_DATA_BLOCKED, Goihw8g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 13, 13, 32, 16, 13, 18, 16, 3, 3, 2, 1, 2, 1),
    PARAMS(FMT_DATA_BLOCKED, Goihw8g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 9, 9, 500, 500, 9, 698, 698, 3, 3, 100, 100, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, Goihw8g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 2, 2, 500, 500, 2, 698, 698, 3, 3, 100, 100, 1, 1)
);

INST_TEST_CASE(SimpleSmall_Blocked_Channels16,
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 1, 128, 10, 10, 96, 10, 10, 1, 1, 0, 0, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 1, 256, 15, 15, 128, 15, 15, 1, 1, 0, 0, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 1, 128, 10, 10, 96, 10, 10, 3, 3, 1, 1, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 1, 128, 10, 10, 96, 5, 5, 1, 1, 0, 0, 2, 2),
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 1, 128, 10, 10, 96, 5, 5, 3, 3, 1, 1, 2, 2),
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16_G, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 2, 128, 10, 10, 96, 10, 10, 1, 1, 0, 0, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16_G, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 2, 128, 10, 10, 96, 10, 10, 3, 3, 1, 1, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16_G, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 2, 128, 10, 10, 96, 5, 5, 1, 1, 0, 0, 2, 2),
    PARAMS(FMT_DATA_BLOCKED, FMT_WEIGHTS_BLOCKED16_G, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 2, 128, 10, 10, 96, 5, 5, 3, 3, 1, 1, 2, 2)
);

INST_TEST_CASE(SimpleSmall_Depthwise_Blocked_Channels16,
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        1, 16, 16, 10, 10, 16, 10, 10, 3, 3, 1, 1, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 64, 64, 9, 9, 64, 2, 2, 5, 5, 0, 0, 3, 3),
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 32, 32, 26, 26, 32, 26, 26, 4, 3, 1, 1, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 32, 32, 112, 112, 32, 112, 112, 1, 1, 0, 0, 1, 1),
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 112, 112, 1, 2, 112, 1, 1, 3, 3, 1, 1, 1, 2),
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 32, 32, 16, 32, 32, 16, 18, 3, 3, 1, 2, 1, 2),
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 48, 48, 32, 16, 48, 16, 14, 3, 3, 1, 0, 2, 1),
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 16, 16, 32, 16, 16, 18, 16, 3, 3, 2, 1, 2, 1),
    PARAMS(FMT_DATA_BLOCKED, Goihw16g, FMT_BIAS, FMT_DATA_BLOCKED,
        2, 16, 16, 500, 500, 16, 698, 698, 3, 3, 100, 100, 1, 1)
);
