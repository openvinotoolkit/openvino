...
using convolution_test = convolution_forward_test<uint8_t, int8_t, int32_t, int32_t>;
using convolution_test_s8 = convolution_forward_test<int8_t, int8_t, int32_t, int32_t>;
