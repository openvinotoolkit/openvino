...
function (CheckOrDownloadAndExtract component RELATIVE_URL archive_name unpacked_path result_path folder fattal result123 use_alternatives)
  ...
  if(DEFINED ENV{IE_PATH_TO_DEPS})
    ...
    if(DEFINED DEPENDENCIES_BASE_URL)
      set(URL "${DEPENDENCIES_BASE_URL}/${RELATIVE_URL}")
    else()
      set(URL "https://download.01.org/opencv/master/openvinotoolkit/2019_R4/inference_engine/${RELATIVE_URL}")
    endif()
  endif()
