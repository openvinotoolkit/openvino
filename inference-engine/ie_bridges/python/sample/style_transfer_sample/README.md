...
| Network Operations       | [IENetwork.input_info], [IENetwork.outputs], [InputInfoPtr.precision], [DataPtr.precision], [IENetwork.batch_size], [InputInfoPtr.input_data.shape] | Managing of network: configure input and output blobs |
