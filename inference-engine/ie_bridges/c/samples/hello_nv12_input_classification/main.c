 ...
 */
size_t read_image_from_file(const char *img_path, unsigned char *img_data,
                            size_t size) {
 ...
 */
bool is_supported_image_size(const char *size_str, size_t *width,
                             size_t *height) {
...
int main(int argc, char **argv) {
  ...
  status |= ie_blob_make_memory_from_preallocated(&y_tensor, img_data,
                                                  y_plane_size, &y_blob);
