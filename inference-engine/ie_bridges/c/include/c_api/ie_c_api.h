 ...
 * @return Status code of the operation: OK(0) for success.
 */
INFERENCE_ENGINE_C_API(IE_NODISCARD IEStatusCode) ie_core_read_network_from_memory(ie_core_t *core, const char *xml_content,
    ie_blob_t* weight_blob, ie_network_t **network);
