...
public:
     ...
     * @param resp Optional: pointer to an already allocated object to contain
     ...
     * @note Memory allocation does not happen
     * @param name Name of input or output blob.
     * @param data Reference to input or output blob. The type of Blob must match
     * the network input precision and size.
     * @param resp Optional: pointer to an already allocated object to contain
     * information in case of failure
     * @return Status code of the operation: InferenceEngine::OK (0) for success
     */
     ...
     *
     * @note blocks all methods of IInferRequest while request is ongoing (running
     * or waiting in queue)
     * @param resp Optional: pointer to an already allocated object to contain
     * information in case of failure
     * @return Status code of the operation: InferenceEngine::OK (0) for success
     ...
     * @param resp Optional: a pointer to an already allocated object to contain
     * extra information of a failure (if occurred)
     * @return Enumeration of the resulted action: InferenceEngine::OK (0) for
     * success
     */
    ...
    /**
     * @brief Gets arbitrary data for the request and stores a pointer to a
     * pointer to the obtained data
     *
     ...
     *
     * @param batch_size new batch size to be used by all the following inference
