...
NGRAPH_RTTI_DEFINITION(ov::pass::low_precision::AvgPoolTransformation, "AvgPoolTransformation", 0);
...
AvgPoolTransformation::AvgPoolTransformation(const Params& params) : LayerTransformation(params) {
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(matcher, "AvgPoolTransformation");
    this->register_matcher(m, callback);
}

bool AvgPoolTransformation::transform(TransformationContext& context, ov::pattern::Matcher &m) {
