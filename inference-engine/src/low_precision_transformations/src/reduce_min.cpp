...
NGRAPH_RTTI_DEFINITION(ov::pass::low_precision::ReduceMinTransformation, "ReduceMinTransformation", 0);
...
ReduceMinTransformation::ReduceMinTransformation(const Params& params) : ReduceBaseTransformation(params) {
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(matcher, "ReduceMinTransformation");
