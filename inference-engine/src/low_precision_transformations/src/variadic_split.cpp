...
NGRAPH_RTTI_DEFINITION(ov::pass::low_precision::VariadicSplitTransformation, "VariadicSplitTransformation", 0);
...
VariadicSplitTransformation::VariadicSplitTransformation(const Params& params) : SplitTransformation(params) {
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(matcher, "VariadicSplitTransformation");
