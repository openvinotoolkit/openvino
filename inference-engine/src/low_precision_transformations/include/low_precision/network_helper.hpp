...
public:
    ...
    static bool areQuantizeAndDequantizeSupportedForSubtract(const std::shared_ptr<Node>& node);

    static bool areQuantizeAndDequantizeSupportedForMultiply(const std::shared_ptr<Node>& node);
