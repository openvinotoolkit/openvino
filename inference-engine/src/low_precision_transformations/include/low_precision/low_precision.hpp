...
class LP_TRANSFORMATIONS_API ov::pass::low_precision::MarkupOptimizations : public ov::pass::FunctionPass {
public:
...
class LP_TRANSFORMATIONS_API ov::pass::low_precision::TypeRelaxedReplacer : public ov::pass::GraphRewrite {
public:
    NGRAPH_RTTI_DECLARATION;
    TypeRelaxedReplacer();
};

class LP_TRANSFORMATIONS_API ov::pass::low_precision::LowPrecision : public ov::pass::FunctionPass {
public:
    NGRAPH_RTTI_DECLARATION;
    LowPrecision(
        const std::vector<OperationPrecisionRestriction>& precisionRestrictions = {},
    ...
    static bool isFunctionQuantized(const std::shared_ptr<const ov::Function>& function);
