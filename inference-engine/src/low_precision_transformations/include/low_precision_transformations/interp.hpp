...
class INFERENCE_ENGINE_API_CLASS(InterpTransformation) : public LayerTransformation {
public:
    InterpTransformation(const Params& params) : LayerTransformation(params) {}
    ~InterpTransformation() override {}
