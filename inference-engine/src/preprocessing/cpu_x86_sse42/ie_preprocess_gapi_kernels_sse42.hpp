...
extern template void chanToPlaneRowImpl(sse42_tag, const uint8_t* in, int chan, int chs, uint8_t* out, int length);
extern template void chanToPlaneRowImpl(sse42_tag, const float*   in, int chan, int chs, float  * out, int length);
}  // namespace kernels
}  // namespace gapi
}  // namespace InferenceEngine
