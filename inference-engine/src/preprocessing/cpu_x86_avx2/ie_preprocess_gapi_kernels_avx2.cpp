...
void calcRowLinear8UC1Impl(avx2_tag,
    ...
    if (!xRatioEq && !yRatioEq) {
        if (4 == lpi) {
            // vertical pass
            verticalPass_lpi4_8U(src0, src1, tmp, beta, inSz.width);
            ...
            for (int l = 0; l < lpi; ++l) {
                ...
                // vertical pass
                verticalPass_anylpi_8U(src0, src1, tmp, beta0, l, inLength, inLength);
        ...
        for (int l = 0; l < lpi; ++l) {
            ...
            // vertical pass
            verticalPass_anylpi_8U(src0, src1, dst[l], beta0, l, inLength, outLength);
        }
