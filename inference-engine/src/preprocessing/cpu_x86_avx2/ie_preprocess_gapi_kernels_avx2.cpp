...
template void chanToPlaneRowImpl(avx2_tag, const uint8_t* in, int chan, int chs, uint8_t* out, int length);
template void chanToPlaneRowImpl(avx2_tag, const float*   in, int chan, int chs, float  * out, int length);
}  // namespace kernels
}  // namespace gapi
}  // namespace InferenceEngine
