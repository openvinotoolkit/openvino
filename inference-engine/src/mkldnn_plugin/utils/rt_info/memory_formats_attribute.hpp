...
public:
    ...
    std::string getMemoryFormats() const {
...
public:
    ...
    static std::string getMemoryFormats(const std::shared_ptr<ngraph::Node>& node) {
        ...
        if (!rtInfo.count(MemoryFormatsWrapper::type_info.name))
            return "";
    ...
    std::shared_ptr<ngraph::Variant> merge(const ngraph::NodeVector& nodes) override {
        ...
        if (unique_mem_format.size() > 1) {
            throw ngraph::ngraph_error(std::string(VariantWrapper<MemoryFormatsType>::type_info.name) +
...
template <>
class VariantWrapper<ngraph::MLKDNNInputMemoryFormats>
    : public MLKDNNMemoryFormatsHelper<ngraph::MLKDNNInputMemoryFormats> {
public:
    ...
    VariantWrapper(const ngraph::MLKDNNInputMemoryFormats& value)
        : MLKDNNMemoryFormatsHelper<ngraph::MLKDNNInputMemoryFormats>(value) {}
};

extern template class MLKDNNMemoryFormatsHelper<ngraph::MLKDNNOutputMemoryFormats>;

template <>
class VariantWrapper<ngraph::MLKDNNOutputMemoryFormats>
    : public MLKDNNMemoryFormatsHelper<ngraph::MLKDNNOutputMemoryFormats> {
public:
    ...
    VariantWrapper(const ngraph::MLKDNNOutputMemoryFormats& value)
        : MLKDNNMemoryFormatsHelper<ngraph::MLKDNNOutputMemoryFormats>(value) {}
};
