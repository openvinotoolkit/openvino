...
#define MKLDNN_CVT(ST, DT)                             \
    OV_CASE2(Precision::ST,                            \
             Precision::DT,                            \
             PrecisionInfo<Precision::ST>::value_type, \
             PrecisionInfo<Precision::DT>::value_type)
...
void cpu_convert(const void* srcPtr, void* dstPtr, Precision srcPrc, Precision dstPrc, const size_t size) {
    ...
    OV_SWITCH(MKLDNNPlugin,
              ...
              MKLDNN_CVT(FP32, U64),
              MKLDNN_CVT(FP32, I64),
              MKLDNN_CVT(FP32, BF16),
              MKLDNN_CVT(FP32, BOOL),
              MKLDNN_CVT(BF16, U8),
              MKLDNN_CVT(BF16, I8),
              MKLDNN_CVT(BF16, U16),
              MKLDNN_CVT(BF16, I16),
              ...
              MKLDNN_CVT(BF16, U64),
              MKLDNN_CVT(BF16, I64),
              MKLDNN_CVT(BF16, FP32),
              MKLDNN_CVT(BF16, BOOL),
              MKLDNN_CVT(BOOL, U8),
              MKLDNN_CVT(BOOL, I8),
              MKLDNN_CVT(BOOL, U16),
              MKLDNN_CVT(BOOL, I16),
              ...
              MKLDNN_CVT(BOOL, U64),
              MKLDNN_CVT(BOOL, I64),
              MKLDNN_CVT(BOOL, FP32),
              MKLDNN_CVT(BOOL, BF16));
