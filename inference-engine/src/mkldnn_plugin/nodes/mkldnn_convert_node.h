...
public:
    MKLDNNConvertNode(const std::shared_ptr<ngraph::Node>& op,
                      const mkldnn::engine& eng,
                      MKLDNNWeightsSharing::Ptr& cache);
    MKLDNNConvertNode(const InferenceEngine::SizeVector& dims,
    ...
    // this method. This is useful if the Convert node is added to the graph as an auxiliary operation at the
    // MKLDNNGraph initialization stage.
