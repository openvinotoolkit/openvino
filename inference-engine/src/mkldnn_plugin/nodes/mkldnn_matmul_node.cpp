...
bool MKLDNNMatMulNode::isSupportedOperation(const std::shared_ptr<const ngraph::Node>& op,
...
MKLDNNMatMulNode::MKLDNNMatMulNode(const std::shared_ptr<ngraph::Node>& op,
...
inline void process_gemm(char transa,
                         char transb,
                         int M,
                         int N,
                         int K,
