...
template<mkldnn::impl::cpu::cpu_isa_t T>
void MVNImpl<T>::mvn_pln(const float* src_data, float* dst_data, const SizeVector& dims) {
...
template<mkldnn::impl::cpu::cpu_isa_t T>
void MVNImpl<T>::mvn_blk(const float* src_data, float* dst_data, const SizeVector& dims) {
#if defined(HAVE_AVX512F)
    size_t blk_size = 16;
#else
    size_t blk_size = 8lu;
...
#if HAVE_AVX512F
REG_FACTORY_FOR_TYPE(avx512_common, ImplFactory<MVNImpl<mkldnn::impl::cpu::cpu_isa_t::avx512_common>>, MVN);
#elif HAVE_AVX2
REG_FACTORY_FOR_TYPE(avx2, ImplFactory<MVNImpl<mkldnn::impl::cpu::cpu_isa_t::avx2>>, MVN);
#elif HAVE_SSE
REG_FACTORY_FOR_TYPE(sse42, ImplFactory<MVNImpl<mkldnn::impl::cpu::cpu_isa_t::sse42>>, MVN);
#else
REG_FACTORY_FOR_TYPE(isa_any, ImplFactory<MVNImpl<mkldnn::impl::cpu::cpu_isa_t::isa_any>>, MVN);
#endif
