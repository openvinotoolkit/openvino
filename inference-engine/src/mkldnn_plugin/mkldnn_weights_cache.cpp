...
MKLDNNWeightsSharing::MKLDNNSharedMemory::MKLDNNSharedMemory(std::unique_lock<std::mutex>&& lock,
...
MKLDNNWeightsSharing::MKLDNNSharedMemory::Ptr
MKLDNNWeightsSharing::findOrCreate(const std::string& key, std::function<MKLDNNMemoryPtr(void)> create, bool valid) {
