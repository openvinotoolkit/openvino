        ...
        switch (store_num) {
            case 16:
                ...
                if (is_signed) {
                    ...
                    h->uni_vpmaxsd(vmm, vmm, Vmm(aux_vec_idxs[0]));
            ...
            case 8:
                if (mayiuse(cpu::x64::avx512_core)) {  // ymm block on avx512F + VL
                    if (is_signed) {
                        ...
                        h->uni_vpmaxsd(ymm, ymm, Vmm(aux_vec_idxs[0]));
            ...
            case 4:
                if (mayiuse(cpu::x64::avx512_core)) {  // xmm block on avx512F + VL
                    if (is_signed) {
                        ...
                        h->uni_vpmaxsd(xmm, xmm, Vmm(aux_vec_idxs[0]));
            ...
            switch (store_num) {
                case 16:
                    if (is_signed) {
                        ...
                        h->uni_vpmaxsd(vmm, Vmm(aux_vec_idxs[0]), vmm);        // if singed bit is 1, set value as 0.
                ...
                case 8:
                    if (mayiuse(cpu::x64::avx512_core)) {
                        if (is_signed) {
                            ...
                            h->uni_vpmaxsd(ymm, Vmm(aux_vec_idxs[0]), ymm);
                ...
                case 4:
                    if (mayiuse(cpu::x64::avx512_core)) {
                        if (is_signed) {
                            ...
                            h->uni_vpmaxsd(xmm, Vmm(aux_vec_idxs[0]), xmm);
                ...
                default:
                    if (is_zmm) {
                        ...
                        if (is_signed) {
                            ...
                            h->uni_vpmaxsd(vmm, Vmm(aux_vec_idxs[0]), vmm);
