...
op::RNNSequenceIE::RNNSequenceIE(const Output<Node>& X, const Output<Node>& H_t, const Output<Node>& sequence_lengths,
...
shared_ptr<Node> op::RNNSequenceIE::copy_with_new_args(const NodeVector& new_args) const {
