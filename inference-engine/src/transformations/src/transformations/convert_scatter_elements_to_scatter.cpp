...
void ngraph::pass::ConvertScatterElementsToScatter::convert_scatter_elements_to_scatter() {
    IETRANSFORM_SCOPE(ConvertScatterElementsToScatter,
        ...
        ngraph::graph_rewrite_callback callback = [](pattern::Matcher& m) {
            ...
            auto compare_shapes_ranges =
                [](const PartialShape & lhsShape, const PartialShape & rhsShape, const Range & lhsRange, const Range & rhsRange) -> bool {
