...
NGRAPH_RTTI_DEFINITION(ov::pass::BidirectionalSequenceDecomposition, "BidirectionalSequenceDecomposition", 0);
NGRAPH_RTTI_DEFINITION(ov::pass::BidirectionalLSTMSequenceDecomposition, "BidirectionalLSTMSequenceDecomposition", 0);
NGRAPH_RTTI_DEFINITION(ov::pass::BidirectionalGRUSequenceDecomposition, "BidirectionalGRUSequenceDecomposition", 0);
NGRAPH_RTTI_DEFINITION(ov::pass::BidirectionalRNNSequenceDecomposition, "BidirectionalRNNSequenceDecomposition", 0);
...
ov::pass::BidirectionalLSTMSequenceDecomposition::BidirectionalLSTMSequenceDecomposition() {
    ...
    ov::matcher_pass_callback callback = [this](pattern::Matcher &m) {
        ...
        auto lstm_sequence_forward = std::make_shared<ov::op::v5::LSTMSequence>(
        ...
        auto lstm_sequence_reverse = std::make_shared<ov::opset5::LSTMSequence>(
                lstm_sequence->input_value(0),
                H->output(1),
                C->output(1),
                lstm_sequence->input_value(3),
        ...
        ov::copy_runtime_info(lstm_sequence, {H, C, W, R, B, lstm_sequence_forward, lstm_sequence_reverse,
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(lstm_sequence_ngraph, matcher_name);
...
ov::pass::BidirectionalGRUSequenceDecomposition::BidirectionalGRUSequenceDecomposition() {
    ...
    ov::matcher_pass_callback callback = [this](pattern::Matcher &m) {
        ...
        auto gru_sequence_forward = std::make_shared<ov::op::v5::GRUSequence>(
        ...
        auto gru_sequence_reverse = std::make_shared<ov::opset5::GRUSequence>(
                gru_sequence->input_value(0),
                H->output(1),
                gru_sequence->input_value(2),
                W->output(1),
        ...
        ov::copy_runtime_info(gru_sequence, {H, W, R, B, gru_sequence_forward, gru_sequence_reverse,
                                                  concat_0, concat_1});
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(gru_sequence_ngraph, matcher_name);
    this->register_matcher(m, callback);
}
...
ov::pass::BidirectionalRNNSequenceDecomposition::BidirectionalRNNSequenceDecomposition() {
    ...
    ov::matcher_pass_callback callback = [this](pattern::Matcher &m) {
        ...
        auto rnn_sequence_forward = std::make_shared<ov::op::v5::RNNSequence>(
        ...
        auto rnn_sequence_reverse = std::make_shared<ov::opset5::RNNSequence>(
                rnn_sequence->input_value(0),
                H->output(1),
                rnn_sequence->input_value(2),
                W->output(1),
        ...
        ov::copy_runtime_info(rnn_sequence, {H, W, R, B, rnn_sequence_forward, rnn_sequence_reverse,
                                                 concat_0, concat_1});
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(rnn_sequence_ngraph, matcher_name);
    this->register_matcher(m, callback);
}
