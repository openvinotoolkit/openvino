...
NGRAPH_RTTI_DEFINITION(ov::pass::ConvertTopK3, "ConvertTopK3", 0);
...
ov::pass::ConvertTopK3::ConvertTopK3() {
    ...
    ov::matcher_pass_callback callback = [](pattern::Matcher& m) {
        ...
        auto new_topk = std::make_shared<ov::opset2::TopK>(topk->input_value(0), topk->input_value(1),
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(topk, matcher_name);
