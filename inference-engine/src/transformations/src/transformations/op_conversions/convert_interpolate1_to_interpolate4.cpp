...
NGRAPH_RTTI_DEFINITION(ov::pass::ConvertInterpolate1ToInterpolate4, "ConvertInterpolate1ToInterpolate4", 0);
...
ov::pass::ConvertInterpolate1ToInterpolate4::ConvertInterpolate1ToInterpolate4() {
    ...
    auto interpolate1 = ov::pattern::wrap_type<ov::opset1::Interpolate>({pattern::any_input(pattern::has_static_shape()), pattern::any_input()});
    ov::matcher_pass_callback callback = [this](pattern::Matcher& m) {
        ...
        auto scalesConstant = ov::op::Constant::create(ov::element::f32, {scales.size()}, scales);
        auto axisConstant = ov::op::Constant::create(ov::element::i64, {attrsV0.axes.size()},
        ...
        auto interpolateV4 = std::make_shared<ov::opset4::Interpolate>(interpolationV0->input_value(0), interpolationV0->input_value(1),
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(interpolate1, matcher_name);
