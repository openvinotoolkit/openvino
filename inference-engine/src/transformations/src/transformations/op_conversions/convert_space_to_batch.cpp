...
void ngraph::pass::ConvertSpaceToBatch::convert_space_to_batch() {
    ...
    ngraph::matcher_pass_callback callback = [](pattern::Matcher& m) {
        ...
        const auto pads_begin_const = std::dynamic_pointer_cast<opset3::Constant>(pads_begin.get_node()->shared_from_this());
        const auto pads_end_const = std::dynamic_pointer_cast<opset3::Constant>(pads_end.get_node()->shared_from_this());
...
void ngraph::pass::ConvertSpaceToBatch::convert_space_to_batch_by_elements() {
    ...
    ngraph::matcher_pass_callback callback = [this](pattern::Matcher& m) {
        ...
        const auto pads_begin_const = ov::as_type_ptr<opset3::Constant>(pads_begin.get_node()->shared_from_this());
        const auto pads_end_const = ov::as_type_ptr<opset3::Constant>(pads_end.get_node()->shared_from_this());
