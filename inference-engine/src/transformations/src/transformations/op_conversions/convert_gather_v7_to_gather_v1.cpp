...
ngraph::pass::ConvertGather7ToGather1::ConvertGather7ToGather1() {
    ...
    auto gather_v7 = pattern::wrap_type<ngraph::op::v7::Gather>();

    ngraph::matcher_pass_callback callback = [](pattern::Matcher& m) {
        auto gather_v7_node = std::dynamic_pointer_cast<ngraph::op::v7::Gather>(m.get_match_root());
        if (!gather_v7_node)
            return false;
        ...
        auto gather_v1  = std::make_shared<ngraph::op::v1::Gather>(data_input, indices_input, axis_input);
