...
NGRAPH_RTTI_DEFINITION(ov::pass::ConvertGELU, "ConvertGELU", 0);
...
ov::pass::ConvertGELU::ConvertGELU() {
    ...
    ov::matcher_pass_callback callback = [this](pattern::Matcher& m) {
        ...
        auto mul = std::make_shared<ov::opset1::Multiply>(input, ov::opset1::Constant::create(input_type, Shape{}, {0.5}));
