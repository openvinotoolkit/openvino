...
ngraph::pass::ConvertPriorBox8To0::ConvertPriorBox8To0() {
    ...
    ngraph::matcher_pass_callback callback = [=](pattern::Matcher& m) {
        ...
        auto output_size = prior_box_v8_node->input_value(0);
        auto image_size = prior_box_v8_node->input_value(1);
        auto prior_box_v0 = std::make_shared<ngraph::opset1::PriorBox>(output_size, image_size, attrs_v0);
