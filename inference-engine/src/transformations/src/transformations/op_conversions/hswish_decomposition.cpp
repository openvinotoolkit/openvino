...
NGRAPH_RTTI_DEFINITION(ov::pass::HSwishDecomposition, "HSwishDecomposition", 0);
...
ov::pass::HSwishDecomposition::HSwishDecomposition() {
    ...
    auto hswish = ov::pattern::wrap_type<opset4::HSwish>();
    ...
    ov::matcher_pass_callback callback = [=](ov::pattern::Matcher &m) {
        ...
        auto add_constant = ov::opset4::Constant::create(input_type, ov::Shape{}, {3.0});
        ...
        auto min_constant = ov::opset4::Constant::create(input_type, ov::Shape{}, {6.0});
        ...
        auto mul_constant = ov::opset4::Constant::create(input_type, ov::Shape{}, {(1.0/6.0)});  // const(1/6)
    ...
    auto m = std::make_shared<ov::pattern::Matcher>(hswish, matcher_name);
