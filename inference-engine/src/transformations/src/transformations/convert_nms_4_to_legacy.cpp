...
bool ngraph::pass::ConvertNMS4ToLegacy::run_on_function(std::shared_ptr<ngraph::Function> f) {
    ...
    for (auto &node : f->get_ops()) {
        ...
        const auto box_encoding = static_cast<const op::dynamic::v4::BoxEncodingType>(nms_4->get_box_encoding());
        ...
        const auto nms_legacy = std::make_shared<op::dynamic::NonMaxSuppression>(
                new_args.at(0),
                new_args.at(1),
                arg2,
                arg3,
        ...
        ngraph::copy_runtime_info(nms_4, nms_legacy);
