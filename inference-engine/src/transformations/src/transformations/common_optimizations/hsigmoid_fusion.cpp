...
ngraph::pass::HSigmoidFusionWithReluDiv::HSigmoidFusionWithReluDiv() {
    ...
    auto add = ngraph::pattern::wrap_type<ngraph::opset4::Add>({input, add_constant});
    auto relu = ngraph::pattern::wrap_type<ngraph::opset4::Relu>({add});
    auto min_constant = ngraph::pattern::wrap_type<ngraph::opset4::Constant>();
    auto min = ngraph::pattern::wrap_type<ngraph::opset4::Minimum>({relu, min_constant});
    auto div_constant = ngraph::pattern::wrap_type<ngraph::opset4::Constant>();
    auto div = ngraph::pattern::wrap_type<ngraph::opset4::Divide>({min, div_constant});
    ...
    ngraph::matcher_pass_callback callback = [=](ngraph::pattern::Matcher &m) {
        ...
        auto hsigmoid = register_new_node<ngraph::opset5::HSigmoid>(x_output);
...
ngraph::pass::HSigmoidFusionWithReluMul::HSigmoidFusionWithReluMul() {
    ...
    auto mul_second = ngraph::pattern::wrap_type<ngraph::opset4::Multiply>({min, mul_constant});
...
ngraph::pass::HSigmoidFusionWithoutRelu::HSigmoidFusionWithoutRelu() {
    ...
    auto max = ngraph::pattern::wrap_type<ngraph::opset4::Maximum>({add, max_constant});
    auto min_constant = ngraph::pattern::wrap_type<ngraph::opset4::Constant>();
    auto min = ngraph::pattern::wrap_type<ngraph::opset4::Minimum>({max, min_constant});
    auto div_constant = ngraph::pattern::wrap_type<ngraph::opset4::Constant>();
    auto div = ngraph::pattern::wrap_type<ngraph::opset4::Divide>({min, div_constant});
    auto mul = ngraph::pattern::wrap_type<ngraph::opset4::Multiply>({input, div});
...
ngraph::pass::HSigmoidFusionWithClampMul::HSigmoidFusionWithClampMul() {
    ...
    auto mul_constant = ngraph::pattern::wrap_type<ngraph::opset4::Constant>();
    auto mul_first = ngraph::pattern::wrap_type<ngraph::opset4::Multiply>({clamp, mul_constant});
    ...
    ngraph::matcher_pass_callback callback = [=](ngraph::pattern::Matcher &m) {
        ...
        auto clamp_node = std::dynamic_pointer_cast<ngraph::opset4::Clamp>(pattern_to_output.at(clamp).get_node_shared_ptr());
...
ngraph::pass::HSigmoidFusionWithClampDiv::HSigmoidFusionWithClampDiv() {
    ...
    auto clamp = ngraph::pattern::wrap_type<ngraph::op::v0::Clamp>({add});
    auto div_constant = ngraph::pattern::wrap_type<ngraph::opset4::Constant>();
    auto div = ngraph::pattern::wrap_type<ngraph::opset4::Divide>({clamp, div_constant});
