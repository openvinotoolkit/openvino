...
NGRAPH_RTTI_DEFINITION(pass::RemoveConcatZeroDimInput, "RemoveConcatZeroDimInput", 0);

pass::RemoveConcatZeroDimInput::RemoveConcatZeroDimInput() {
...
NGRAPH_RTTI_DEFINITION(ngraph::pass::RemoveMultiSubGraphOpDanglingParams, "RemoveMultiSubGraphOpDanglingParams", 0);

ngraph::pass::RemoveMultiSubGraphOpDanglingParams::RemoveMultiSubGraphOpDanglingParams() {
...
ngraph::pass::NopElimination::NopElimination(bool use_shape_for_elimination) {
    ...
    add_matcher<RemoveConcatZeroDimInput>();
    add_matcher<RemoveMultiSubGraphOpDanglingParams>();
