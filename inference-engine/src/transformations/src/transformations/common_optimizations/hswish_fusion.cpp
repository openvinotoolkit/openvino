...
NGRAPH_RTTI_DEFINITION(ov::pass::HSwishFusion, "HSwishFusion", 0);

NGRAPH_RTTI_DEFINITION(ov::pass::HSwishFusionWithReluDiv, "HSwishFusionWithReluDiv", 0);
...
ov::pass::HSwishFusionWithReluDiv::HSwishFusionWithReluDiv() {
    ...
    auto add = std::make_shared<ov::opset7::Add>(input, add_constant);
    auto relu = std::make_shared<ov::opset7::Relu>(add);
    auto min_constant = ov::pattern::wrap_type<ov::opset7::Constant>();
    auto min = std::make_shared<ov::opset7::Minimum>(relu, min_constant);
    auto mul = std::make_shared<ov::opset7::Multiply>(input, min);
    auto div_constant = ov::pattern::wrap_type<ov::opset7::Constant>();
    auto div = std::make_shared<ov::opset7::Divide>(mul, div_constant);
    ...
    ov::matcher_pass_callback callback = [=](ov::pattern::Matcher &m) {
        ...
        auto hswish = std::make_shared<ov::opset7::HSwish>(x_output);
...
NGRAPH_RTTI_DEFINITION(ov::pass::HSwishFusionWithReluMul, "HSwishFusionWithReluMul", 0);
...
ov::pass::HSwishFusionWithReluMul::HSwishFusionWithReluMul() {
    ...
    auto min_constant = ov::pattern::wrap_type<ov::opset7::Constant>();
    auto min = std::make_shared<ov::opset7::Minimum>(relu, min_constant);
    auto mul_first = std::make_shared<ov::opset7::Multiply>(input, min);
    auto mul_constant = ov::pattern::wrap_type<ov::opset7::Constant>();
    auto mul_second = std::make_shared<ov::opset7::Multiply>(mul_first, mul_constant);
...
NGRAPH_RTTI_DEFINITION(ov::pass::HSwishFusionWithHSigmoid, "HSwishFusionWithHSigmoid", 0);
...
ov::pass::HSwishFusionWithHSigmoid::HSwishFusionWithHSigmoid() {
    ...
    auto hsigmoid_pattern = pattern::wrap_type<ov::opset7::HSigmoid>({input}, pattern::consumers_count(1));
    auto mul_pattern = pattern::wrap_type<ov::opset7::Multiply>({input, hsigmoid_pattern});
    ...
    ov::matcher_pass_callback callback = [=](ov::pattern::Matcher &m) {
        ...
        auto hswish = std::make_shared<ov::opset7::HSwish>(pattern_to_output.at(input));
