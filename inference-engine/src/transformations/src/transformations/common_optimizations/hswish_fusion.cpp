...
ngraph::pass::HSwishFusionWithHSigmoid::HSwishFusionWithHSigmoid() {
    ...
    auto hsigmoid_pattern = pattern::wrap_type<ngraph::opset6::HSigmoid>({input}, pattern::consumers_count(1));
    auto mul_pattern = pattern::wrap_type<ngraph::opset6::Multiply>({input, hsigmoid_pattern});
