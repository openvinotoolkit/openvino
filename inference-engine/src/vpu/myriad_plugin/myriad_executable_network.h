...
public:
    ...
    InferenceEngine::InferRequestInternal::Ptr CreateInferRequestImpl(InferenceEngine::InputsDataMap networkInputs,
        ...
        return std::make_shared<MyriadInferRequest>(static_cast<Platform>(_device->_platform), _graphDesc, networkInputs, networkOutputs,
    ...
    void CreateInferRequest(InferenceEngine::IInferRequest::Ptr &asyncRequest) override {
        ...
        auto syncRequestImpl = std::make_shared<MyriadInferRequest>(static_cast<Platform>(_device->_platform), _graphDesc, _networkInputs, _networkOutputs,
                                                                    _inputInfo, _outputInfo,
