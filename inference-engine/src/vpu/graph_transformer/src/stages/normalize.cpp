...
private:
    ...
    void serializeDataImpl(BlobSerializer& serializer) const override {
        ...
        if (iDimsOrder == DimsOrder::NC || iDimsOrder == DimsOrder::C) {
            ...
            input->serializeOldBufferNC(this, serializer);
            output->serializeOldBufferNC(this, serializer);
            scales->serializeOldBufferNC(this, serializer);
        } else {
            input->serializeOldBuffer(this, serializer);
            output->serializeOldBuffer(this, serializer);
            scales->serializeOldBuffer(this, serializer);
        }
    }
};
