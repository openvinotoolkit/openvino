...
// build indices table
void MyriadInterpolate::buildIndexTableNN(SizeVector& srcDimPad, SizeVector& dstDim5d, std::vector<float>& scales) {
    
}

void MyriadInterpolate::buildIndexTableLinearOnnx(SizeVector& srcDimPad, SizeVector& dstDim, std::vector<float>& scales) {
    
}

void MyriadInterpolate::buidIndexTableLinear(SizeVector& srcDimPad, SizeVector& dstDim, std::vector<float>& scales, int kernel_width, bool antialias) {
    
}

void MyriadInterpolate::buidIndexTableCubic(SizeVector& srcDimPad, SizeVector& dstDim, std::vector<float>& scales, float cubicCoeff) {
