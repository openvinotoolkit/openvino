...
std::shared_ptr<ngraph::Node> V10Parser::createNode(const std::vector<ngraph::Output<ngraph::Node>>& inputs,
    ...
    static std::vector<std::shared_ptr<LayerBaseCreator>> creators = {
        ...
        std::make_shared<LayerCreator<ngraph::op::v1::LSTMCell>>("LSTMCell"),
...
// LSTMCell layer
template <>
std::shared_ptr<ngraph::Node> V10Parser::LayerCreator<ngraph::op::v1::LSTMCell>::createLayer(
    const ngraph::OutputVector& inputs, const pugi::xml_node& node, std::istream& binStream,
    const GenericLayerParams& layerParsePrms) {
    ...
    return std::make_shared<ngraph::op::v1::LSTMCell>(inputs[0], inputs[1], inputs[2], inputs[3], inputs[4], inputs[5],
                                                  GetUInt64Attr(dn, "hidden_size"), activations, activations_alpha,
                                                  activations_beta, clip);
}
