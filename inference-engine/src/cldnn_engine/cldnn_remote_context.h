...
public:
    ...
    explicit CLDNNExecutionContextImpl(std::shared_ptr<IInferencePluginInternal> plugin,
    ...
    const std::weak_ptr<IInferencePluginInternal> GetPlugin() const { return m_plugin; }
...
protected:
    ...
    ContextType m_type;
    std::weak_ptr<IInferencePluginInternal> m_plugin;
...
public:
    ...
    explicit typedCLDNNExecutionContext(std::shared_ptr<IInferencePluginInternal> plugin,
        const ParamMap& params,
        const Config& config = {})
