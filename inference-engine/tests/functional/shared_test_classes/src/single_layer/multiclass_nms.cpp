...
std::string MulticlassNmsLayerTest::getTestCaseName(testing::TestParamInfo<NmsParams> obj) {
    ...
    op::v8::MulticlassNms::BoxEncodingType boxEncoding;
    bool sortResDescend;
    ...
    result << "MulticlassNms/numBatches=" << numBatches << "_numBoxes=" << numBoxes << "_numClasses=" << numClasses << "_";
...
void MulticlassNmsLayerTest::SetUp() {
    ...
    auto nms = builder::makeMulticlassNms(paramOuts[0], paramOuts[1], convertIE2nGraphPrc(maxBoxPrec),
