...
std::string InterpolateLayerTestWithConfig::getTestCaseName(testing::TestParamInfo<InterpolateLayerTestParamsWithConfig> obj) {
    InterpolateSpecificParams interpolateParams;
    InferenceEngine::Precision netPrecision;
    InferenceEngine::Precision inPrc, outPrc;
    InferenceEngine::Layout inLayout, outLayout;
...
void InterpolateLayerTestWithConfig::SetUp() {
    InterpolateSpecificParams interpolateParams;
    std::vector<size_t> inputShape, targetShape;
    auto netPrecision = InferenceEngine::Precision::UNSPECIFIED;
    std::map<std::string, std::string> additional_config;
