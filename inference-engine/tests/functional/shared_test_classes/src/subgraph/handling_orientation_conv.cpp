...
namespace SubgraphTestsDefinitions {
    ...
    void HandlingOrientationClass::SetUp() {
        ...
        auto pattern2 = std::make_shared<ngraph::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 4 }, outFormShapes2);
        auto reshape2 = std::make_shared<ngraph::op::v1::Reshape>(params[1], pattern2, false);

        auto permute1 = std::make_shared<ngraph::op::v1::Transpose>(reshape1,
        ...
        auto permute2 = std::make_shared<ngraph::op::v1::Transpose>(conv1,
                                                                    ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{ 4 }, { 0, 2, 3, 1 }));
        ...
        auto pattern3 = std::make_shared<ngraph::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 2 }, outFormShapes3);
        auto pattern4 = std::make_shared<ngraph::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 2 }, outFormShapes4);
        auto reshape3 = std::make_shared<ngraph::op::v1::Reshape>(permute2, pattern3, false);
        auto reshape4 = std::make_shared<ngraph::op::v1::Reshape>(conv2, pattern4, false);
        ngraph::ResultVector results{ std::make_shared<ngraph::op::v0::Result>(reshape3),
                                      std::make_shared<ngraph::op::v0::Result>(reshape4)};
