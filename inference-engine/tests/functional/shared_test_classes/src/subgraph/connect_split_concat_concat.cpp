...
void SplitConcatConcatTest::SetUp() {
    ...
    auto relu_start = std::make_shared<ngraph::op::v0::Relu>(params[0]);
    ...
    auto concat = std::make_shared<ngraph::op::v0::Concat>(ngraph::OutputVector{split->output(0), const_concat}, 1);
    auto concat_2 = std::make_shared<ngraph::op::v0::Concat>(ngraph::OutputVector{concat, const_concat_2},
                                                             1);
    auto relu = std::make_shared<ngraph::op::v0::Relu>(concat_2);
    ngraph::ResultVector resultVector{
            std::make_shared<ngraph::op::v0::Result>(relu)
    };
