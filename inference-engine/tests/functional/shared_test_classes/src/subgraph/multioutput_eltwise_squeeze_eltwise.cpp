...
namespace SubgraphTestsDefinitions {
    ...
    void MultioutputEltwiseReshapeEltwise::SetUp() {
        ...
        auto eltwise = std::make_shared<ngraph::op::v1::Multiply>(input[0], eltwise_const);
        ...
        auto eltwise2 = std::make_shared<ngraph::op::v1::Multiply>(eltwise, eltwise_const2);
        auto eltwise3 = std::make_shared<ngraph::op::v1::Multiply>(unsqueeze, eltwise_const3);
        ngraph::ResultVector results{std::make_shared<ngraph::op::v0::Result>(eltwise2),
                                     std::make_shared<ngraph::op::v0::Result>(eltwise3)};
