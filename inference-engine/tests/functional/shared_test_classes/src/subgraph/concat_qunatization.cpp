...
void ConcatQuantization::SetUp() {
    ...
    auto tanh = std::make_shared<ngraph::op::v0::Tanh>(reshape1);
    ...
    auto reshape2 = std::make_shared<ngraph::op::v1::Reshape>(tanh, pattern2, false);
    ...
    auto scale_shift = std::make_shared<ngraph::op::v1::Multiply>(reshape2, scale);
    ...
    auto reshape3 = std::make_shared<ngraph::op::v1::Reshape>(scale_shift, pattern3, false);

    auto pattern4 = std::make_shared<ngraph::op::v0::Constant>(ngraph::element::Type_t::i64, ngraph::Shape{ 2 }, outFormShapes3);
    auto reshape4 = std::make_shared<ngraph::op::v1::Reshape>(tanh, pattern4, false);

    auto concat = std::make_shared<ngraph::op::v0::Concat>(ngraph::OutputVector{ reshape3, reshape4 }, 0);
