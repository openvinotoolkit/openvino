...
static std::vector<std::string> modelPaths = {
        ...
        std::string("faster_rcnn_inception_v2_coco/FP32/faster_rcnn_inception_v2_coco.xml"),
        std::string("faster_rcnn_inception_v2_coco/FP16/faster_rcnn_inception_v2_coco.xml"),
        std::string("faster_rcnn_resnet101_coco/FP32/faster_rcnn_resnet101_coco.xml"),
        std::string("faster_rcnn_resnet101_coco/FP16/faster_rcnn_resnet101_coco.xml"),
