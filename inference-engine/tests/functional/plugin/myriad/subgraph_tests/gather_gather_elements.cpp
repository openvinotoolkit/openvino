...
class Gather_GatherElements : public testing::WithParamInterface<std::string>,
    ...
    std::shared_ptr<ngraph::Node> createTestedOp() override {
        ...
        const auto imageGather = std::make_shared<ngraph::opset6::Gather>(
            imageParam,
            imageGatherIndices,
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{}, {2}));
        const auto squeeze = std::make_shared<ngraph::opset6::Squeeze>(
            imageGather,
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{1}, {0}));
        const auto transpose = std::make_shared<ngraph::op::v1::Transpose>(
                squeeze,
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{4}, {1, 0, 2, 3}));

        const auto shapeOf1 = std::make_shared<ngraph::op::v3::ShapeOf>(transpose, ngraph::element::i32);
        const auto shapeOf2 = std::make_shared<ngraph::op::v3::ShapeOf>(transpose, ngraph::element::i32);
        const auto shapeOf3 = std::make_shared<ngraph::op::v3::ShapeOf>(transpose, ngraph::element::i32);
        const auto shapeOf4 = std::make_shared<ngraph::op::v3::ShapeOf>(transpose, ngraph::element::i32);
        const auto shapeOf5 = std::make_shared<ngraph::op::v3::ShapeOf>(transpose, ngraph::element::i32);
        const auto shapeOf6 = std::make_shared<ngraph::op::v3::ShapeOf>(transpose, ngraph::element::i32);

        const auto gatherShape1 = std::make_shared<ngraph::opset6::Gather>(
            shapeOf1,
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{}, {0}),
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{}, {0}));
        const auto gatherShape2 = std::make_shared<ngraph::opset6::Gather>(
            shapeOf2,
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{}, {1}),
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{}, {0}));
        ...
        const auto concat1 = std::make_shared<ngraph::opset6::Concat>(
            ngraph::NodeVector{unsqueeze1, unsqueeze2, unsqueeze3, ngraph::op::v0::Constant::create(unsqueeze1->get_element_type(), ngraph::Shape{1}, {64})},
            0);
        const auto concat2 = std::make_shared<ngraph::opset6::Concat>(
            ngraph::NodeVector{unsqueeze4, unsqueeze5, unsqueeze6, ngraph::op::v0::Constant::create(unsqueeze1->get_element_type(), ngraph::Shape{1}, {64})},
            0);

        const auto reshape1 = std::make_shared<ngraph::op::v1::Reshape>(
            concat1,
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{1}, {-1}),
            false);
        const auto reshape2 = std::make_shared<ngraph::op::v1::Reshape>(
            concat2,
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{1}, {-1}),
            false);
        ...
        const auto equal1 = std::make_shared<ngraph::opset6::Equal>(
            reshape1,
            ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{4}, {-1, -1, -1, -1}));
        ...
        const auto gatherElements1 = std::make_shared<ngraph::op::v6::GatherElements>(transpose, broadcast1, 3);
        const auto gatherElements2 = std::make_shared<ngraph::op::v6::GatherElements>(transpose, broadcast2, 3);

        m_additionalResults.push_back(std::make_shared<ngraph::op::v0::Result>(gatherElements1));
