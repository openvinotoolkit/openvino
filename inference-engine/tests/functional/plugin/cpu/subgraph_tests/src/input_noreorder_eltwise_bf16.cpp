...
class InputNoReorderEltwiseBF16 : virtual public LayerTestsUtils::LayerTestsCommon, public CPUTestsBase {
protected:
    void SetUp() override {
        ...
        std::shared_ptr<ngraph::Node> secondaryInput =
            ngraph::builder::makeInputLayer(ngPrc, secondaryInputType, inputShape);
