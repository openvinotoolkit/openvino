...
typedef std::tuple<std::vector<std::vector<size_t>>,         // Input shapes
...
protected:
    void SetUp() override {
        ...
        for (int i = 1; i < inputPrecisions.size(); i++) {
            ...
            ngraphInputs.push_back(ngraph::builder::makeConstant(convertIE2nGraphPrc(inputPrecisions[i]),
                                                                 ngraph::Shape{inputShapes[i]},
                                                                 ngraphInput1Data,
                                                                 true));
        }
        ...
        if (withQuantization) {
            ...
            for (int i = 1; i < eltwiseOpTypes.size() - 1; i++) {
                eltwiseOps.push_back(ngraph::builder::makeEltwise(eltwiseOps[eltwiseOps.size() - 1],
                                                                  ngraphInputs[i],
                                                                  eltwiseOpTypes[i]));
            }
            ...
            eltwiseOps.push_back(ngraph::builder::makeEltwise(fq,
                                                              ngraphInputs[eltwiseOpTypes.size() - 1],
                                                              eltwiseOpTypes[eltwiseOpTypes.size() - 1]));
