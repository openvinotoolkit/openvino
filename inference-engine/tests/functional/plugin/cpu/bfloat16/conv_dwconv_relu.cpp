...
protected:
    std::shared_ptr<ngraph::Function> createGraph(InferenceEngine::Precision netPrecision) override {
        ...
        if (netPrecision == Precision::FP32) {
            ...
            weightsNode2 = std::make_shared<ngraph::op::v0::Constant>(ntype, convFilterShape2, weightValues2FP32);
        } else {
        ...
        std::shared_ptr<ngraph::Node> convNode2 = std::make_shared<ngraph::op::v1::GroupConvolution>(
        ...
        // ReLU
        auto reluNode2 =  std::make_shared<op::v0::Relu>(convNode2);
