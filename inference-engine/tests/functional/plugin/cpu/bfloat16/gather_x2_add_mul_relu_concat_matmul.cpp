...
//                           Matmul(BF16)
        ...
        auto gatherNode1 = std::make_shared<opset7::Gather>(matmulNode, indexesConst, axesConst);
        gatherNode1->set_friendly_name("Gather_1");

        auto gatherNode2 = std::make_shared<opset7::Gather>(matmulNode, indexesConst, axesConst);
