...
//            Conv(BF16)   Conv(BF16)  Conv(BF16)
        ...
        if (netPrecision == Precision::FP32) {
            ...
            weightsNode0_1 =
                std::make_shared<ngraph::opset1::Constant>(ntype, convFilterShape, weightValuesBF16.data());
            weightsNode0_2 =
                std::make_shared<ngraph::opset1::Constant>(ntype, convFilterShape, weightValuesBF16.data());
            weightsNode0_3 =
                std::make_shared<ngraph::opset1::Constant>(ntype, convFilterShape, weightValuesBF16.data());
        ...
        std::shared_ptr<ngraph::Node> convNode0_1 =
            std::make_shared<ngraph::opset1::Convolution>(addNode0,
                                                          weightsNode0_1,
        ...
        std::shared_ptr<ngraph::Node> convNode0_2 =
            std::make_shared<ngraph::opset1::Convolution>(addNode0,
                                                          weightsNode0_2,
                                                          ngraph::Strides({1, 1}),         // strides
                                                          ngraph::CoordinateDiff({1, 1}),  // pad begin
        ...
        std::shared_ptr<ngraph::Node> convNode0_3 =
            std::make_shared<ngraph::opset1::Convolution>(addNode0,
                                                          weightsNode0_3,
                                                          ngraph::Strides({1, 1}),         // strides
                                                          ngraph::CoordinateDiff({1, 1}),  // pad begin
        ...
        if (netPrecision == Precision::FP32) {
            ...
            maxConst = opset1::Constant::create(
                ntype,
                Shape{inputShapes},
                {bfloat16::from_bits(FuncTestUtils::Bf16TestUtils::reducePrecisionBitwiseS(2.0f))});
        }
        ...
        std::shared_ptr<ngraph::Node> convNode1 =
            std::make_shared<ngraph::opset1::Convolution>(eltMulNode,
                                                          weightsNode1,
                                                          ngraph::Strides({1, 1}),         // strides
                                                          ngraph::CoordinateDiff({1, 1}),  // pad begin
                                                          ngraph::CoordinateDiff({1, 1}),  // pad end
        ...
        std::shared_ptr<ngraph::Node> convNode2 =
            std::make_shared<ngraph::opset1::Convolution>(eltMaxNode,
                                                          weightsNode2,
                                                          ngraph::Strides({1, 1}),         // strides
                                                          ngraph::CoordinateDiff({1, 1}),  // pad begin
                                                          ngraph::CoordinateDiff({1, 1}),  // pad end
        ...
        std::shared_ptr<ngraph::Node> convNode3 =
            std::make_shared<ngraph::opset1::Convolution>(eltSumNode,
                                                          weightsNode3,
                                                          ngraph::Strides({1, 1}),         // strides
                                                          ngraph::CoordinateDiff({1, 1}),  // pad begin
                                                          ngraph::CoordinateDiff({1, 1}),  // pad end
    ...
    void SetUp() override {
        ...
        // STAGE3:
        // filling of expected precision of layer execution defined by precision of input tensor to the primitive and
