...
typedef std::tuple<InferenceEngine::Precision,  // netPrecision
...
const std::vector<SoftMaxConfig> optimizedConfigsFP32{
    {InferenceEngine::SizeVector{1, 100}, 1},        {InferenceEngine::SizeVector{10, 10}, 1},
    {InferenceEngine::SizeVector{100, 1}, 0},        {InferenceEngine::SizeVector{100, 1}, 1},
    {InferenceEngine::SizeVector{5, 5, 1}, 1},       {InferenceEngine::SizeVector{5, 5, 5}, 2},
    {InferenceEngine::SizeVector{5, 5, 5, 5}, 0},    {InferenceEngine::SizeVector{5, 5, 1, 1}, 1},
    {InferenceEngine::SizeVector{5, 5, 5, 5}, 1},    {InferenceEngine::SizeVector{5, 5, 5, 1}, 2},
    {InferenceEngine::SizeVector{5, 5, 5, 5}, 2},    {InferenceEngine::SizeVector{5, 5, 5, 5}, 3},
    {InferenceEngine::SizeVector{5, 5, 5, 5, 5}, 0}, {InferenceEngine::SizeVector{5, 5, 1, 1, 1}, 1},
    {InferenceEngine::SizeVector{5, 5, 5, 5, 5}, 1}, {InferenceEngine::SizeVector{5, 5, 5, 1, 1}, 2},
    {InferenceEngine::SizeVector{5, 5, 5, 5, 5}, 2}, {InferenceEngine::SizeVector{5, 5, 5, 1, 1}, 3},
    {InferenceEngine::SizeVector{5, 5, 5, 5, 5}, 3}, {InferenceEngine::SizeVector{5, 5, 5, 5, 1}, 4},
...
const auto OptimizedParams = testing::Combine(testing::Values(Precision::FP32, Precision::BF16),
...
const auto NotOptimizedParams = testing::Combine(testing::Values(Precision::FP32, Precision::BF16),
