...
protected:
    void SetUp() override {
        ...
        const auto inputOrderOp =
            std::make_shared<ngraph::opset3::Constant>(ngraph::element::i64, inOrderShape, inputOrder);
...
const std::vector<InferenceEngine::Precision> netPrecisions = {Precision::I8, Precision::BF16, Precision::FP32};

const std::vector<InferenceEngine::Precision> netPrecisionsPerChannels = {Precision::I8, Precision::FP32};

const std::vector<std::vector<size_t>> inputShapes4D = {{2, 32, 10, 20}};
...
const auto params4D = ::testing::Combine(::testing::ValuesIn(inputOrder4D),
...
INSTANTIATE_TEST_SUITE_P(smoke_Transpose4D_CPU,
                         TransposeLayerCPUTest,
                         params4D,
                         TransposeLayerCPUTest::getTestCaseName);

const auto paramsPerChannels4D = ::testing::Combine(::testing::ValuesIn(inputOrderPerChannels4D),
...
INSTANTIATE_TEST_SUITE_P(smoke_PermutePerChannels4D_CPU,
                         TransposeLayerCPUTest,
                         paramsPerChannels4D,
                         TransposeLayerCPUTest::getTestCaseName);

const std::vector<std::vector<size_t>> inputShapes5D = {{2, 32, 5, 10, 20}};
...
const auto params5D = ::testing::Combine(::testing::ValuesIn(inputOrder5D),
                                         ::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_SUITE_P(smoke_Transpose5D_CPU,
                         TransposeLayerCPUTest,
                         params5D,
                         TransposeLayerCPUTest::getTestCaseName);

const auto paramsPerChannels5D = ::testing::Combine(::testing::ValuesIn(inputOrderPerChannels5D),
                                                    ::testing::ValuesIn(netPrecisionsPerChannels),
                                                    ::testing::ValuesIn(inputShapes5D),
                                                    ::testing::Values(CommonTestUtils::DEVICE_CPU),
                                                    ::testing::Values(additional_config),
...
INSTANTIATE_TEST_SUITE_P(smoke_PermutePerChannels5D_CPU,
                         TransposeLayerCPUTest,
                         paramsPerChannels5D,
                         TransposeLayerCPUTest::getTestCaseName);
