...
typedef std::tuple<poolLayerTestParamsSet, CPUSpecificParams, fusingSpecificParams> poolLayerCpuTestParamsSet;
...
public:
    static std::string getTestCaseName(const testing::TestParamInfo<poolLayerCpuTestParamsSet>& obj) {
        ...
        result << PoolingLayerTest::getTestCaseName(testing::TestParamInfo<poolLayerTestParamsSet>(basicParamsSet, 0));
...
protected:
    void SetUp() override {
        ...
        std::tie(poolParams, netPrecision, inPrc, outPrc, inLayout, outLayout, inputShape, targetDevice) =
            basicParamsSet;
...
const std::vector<poolSpecificParams> paramsMax4D = {
    poolSpecificParams{ngraph::helpers::PoolingTypes::MAX,
                       {2, 2},
                       {2, 2},
                       {0, 0},
                       {0, 0},
...
INSTANTIATE_TEST_SUITE_P(
    smoke_MaxPool_CPU_4D,
    PoolingLayerCPUTest,
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(paramsMax4D),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_AvgPool_CPU_4D,
    PoolingLayerCPUTest,
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(paramsAvg4D),
                                          ::testing::Values(Precision::FP32),
                                          ::testing::ValuesIn(inpOutPrecision),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    PoolingLayerCPUTest,
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(paramsAvg4D_RefOnly),
                                          ::testing::Values(Precision::FP32),
                                          ::testing::ValuesIn(inpOutPrecision),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_MaxPool_CPU_5D,
    PoolingLayerCPUTest,
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(paramsMax5D),
                                          ::testing::Values(Precision::FP32),
                                          ::testing::ValuesIn(inpOutPrecision),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_AvgPool_CPU_5D,
    PoolingLayerCPUTest,
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(paramsAvg5D),
                                          ::testing::Values(Precision::FP32),
                                          ::testing::ValuesIn(inpOutPrecision),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_AvgPool_CPU_5D_NotOptimized,
    PoolingLayerCPUTest,
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(paramsAvg5D_RefOnly),
                                          ::testing::Values(Precision::FP32),
                                          ::testing::ValuesIn(inpOutPrecision),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_CPU_4D_I8,
                         PoolingLayerCPUTest,
                         ::testing::Combine(::testing::Combine(::testing::ValuesIn(paramsAvg4D),
                                                               ::testing::Values(Precision::FP32),
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_CPU_5D_I8,
                         PoolingLayerCPUTest,
                         ::testing::Combine(::testing::Combine(::testing::ValuesIn(paramsAvg5D),
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::I8),
