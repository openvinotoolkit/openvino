...
using LSTMCellCpuSpecificParams =
    typename std::tuple<LayerTestsDefinitions::LSTMCellParams, CPUSpecificParams, std::map<std::string, std::string>>;
...
public:
    static std::string getTestCaseName(const testing::TestParamInfo<LSTMCellCpuSpecificParams>& obj) {
        ...
        result << LayerTestsDefinitions::LSTMCellTest::getTestCaseName(
            testing::TestParamInfo<LayerTestsDefinitions::LSTMCellParams>(basicParamsSet, 0));
