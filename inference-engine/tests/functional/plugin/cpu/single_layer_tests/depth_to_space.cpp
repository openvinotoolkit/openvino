...
typedef std::tuple<LayerTestsDefinitions::depthToSpaceParamsTuple, CPUSpecificParams> DepthToSpaceLayerCPUTestParamSet;
...
const std::vector<DepthToSpace::DepthToSpaceMode> depthToSpaceModes = {DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
...
const std::vector<std::vector<size_t>> inputShapesBS3_4D = {{1, 27, 1, 1},
                                                            {1, 27, 2, 3},
                                                            {1, 18, 2, 3},
                                                            {3, 18, 1, 1},
                                                            {2, 18, 3, 1}};
...
const auto depthToSpaceBS2_4DParams = testing::Combine(testing::Combine(testing::ValuesIn(inputShapesBS2_4D),
...
const auto depthToSpaceBS3_4DParams = testing::Combine(testing::Combine(testing::ValuesIn(inputShapesBS3_4D),
                                                                        testing::ValuesIn(inputPrecisions),
                                                                        testing::ValuesIn(depthToSpaceModes),
                                                                        testing::Values(1, 3),
                                                                        testing::Values(CommonTestUtils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(smoke_CPUDepthToSpaceBS3_4D,
                         DepthToSpaceLayerCPUTest,
...
const std::vector<std::vector<size_t>> inputShapesBS3_5D = {{1, 54, 1, 1, 1},
                                                            {1, 54, 2, 1, 2},
                                                            {3, 54, 1, 1, 1},
                                                            {2, 54, 3, 1, 2},
                                                            {1, 54, 3, 2, 2}};
...
const auto depthToSpaceBS2_5DParams = testing::Combine(testing::Combine(testing::ValuesIn(inputShapesBS2_5D),
                                                                        testing::ValuesIn(inputPrecisions),
                                                                        testing::ValuesIn(depthToSpaceModes),
                                                                        testing::Values(1, 2),
                                                                        testing::Values(CommonTestUtils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(smoke_CPUDepthToSpaceBS2_5D,
                         DepthToSpaceLayerCPUTest,
...
const auto depthToSpaceBS3_5DParams = testing::Combine(testing::Combine(testing::ValuesIn(inputShapesBS3_5D),
                                                                        testing::ValuesIn(inputPrecisions),
                                                                        testing::ValuesIn(depthToSpaceModes),
                                                                        testing::Values(1, 3),
                                                                        testing::Values(CommonTestUtils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(smoke_CPUDepthToSpaceBS3_5D,
                         DepthToSpaceLayerCPUTest,
