...
const std::vector<InputShape> inputShapes4D = {
        ...
        {{-1, 32, -1 , -1},                                 // dynamic
         {{1, 32, 6, 12}, {2, 32, 24, 30}, {3, 32, 72, 144}}},  // target

        {{{2, 5}, {8, 50}, {1, 100}, {1, 100}},               // dynamic
         {{3, 11, 72, 36}, {2, 28, 6, 54}, {5, 12, 36, 42}}},   // target
};

const std::vector<InputShape> inputShapes5D = {
        {{-1, -1, -1, -1, -1},                                        // dynamic
         {{2, 2, 6, 84, 144}, {1, 4, 24, 60, 36}, {1, 10, 48, 54, 18}}},  // target

        {{{1, 3}, {5, 16}, {12, 288}, {12, 288}, {1, 288}},                // dynamic
         {{3, 5, 132, 120, 138}, {1, 16, 150, 156, 288}}},               // target
};

const std::vector<InputShape> inputShapesBlocked5D = {
        {{-1, 64, -1, -1, -1},                                          // dynamic
         {{1, 64, 4, 6, 10}, {1, 64, 12, 8, 2}, {3, 64, 16, 14, 24}}},     // target

        {{{1, 3}, 32, {1, 32}, {1, 32}, {1, 32}},                          // dynamic
         {{1, 32, 4, 6, 10}, {1, 32, 20, 22, 24}, {3, 32, 32, 28, 2}}},     // target
};
