...
typedef std::tuple<LayerTestsDefinitions::spaceToDepthParamsTuple, CPUSpecificParams> SpaceToDepthLayerCPUTestParamSet;
...
const std::vector<SpaceToDepth::SpaceToDepthMode> spaceToDepthModes = {SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST,
...
const std::vector<std::vector<size_t>> inputShapesBS3_4D = {{1, 2, 3, 3},
                                                            {1, 3, 3, 6},
                                                            {1, 5, 6, 3},
                                                            {2, 5, 9, 3},
                                                            {3, 5, 6, 6}};
...
const auto spaceToDepthBS2_4DParams = testing::Combine(testing::Combine(testing::ValuesIn(inputShapesBS2_4D),
...
const auto spaceToDepthBS3_4DParams = testing::Combine(testing::Combine(testing::ValuesIn(inputShapesBS3_4D),
                                                                        testing::ValuesIn(inputPrecisions),
                                                                        testing::ValuesIn(spaceToDepthModes),
                                                                        testing::Values(1, 3),
                                                                        testing::Values(CommonTestUtils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(smoke_CPUSpaceToDepthBS3_4D,
                         SpaceToDepthLayerCPUTest,
...
const std::vector<std::vector<size_t>> inputShapesBS3_5D = {{1, 2, 3, 3, 3},
                                                            {1, 2, 3, 6, 9},
                                                            {1, 5, 6, 3, 3},
                                                            {2, 5, 3, 9, 3},
                                                            {3, 5, 3, 3, 6}};
...
const auto spaceToDepthBS2_5DParams = testing::Combine(testing::Combine(testing::ValuesIn(inputShapesBS2_5D),
                                                                        testing::ValuesIn(inputPrecisions),
                                                                        testing::ValuesIn(spaceToDepthModes),
                                                                        testing::Values(1, 2),
                                                                        testing::Values(CommonTestUtils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(smoke_CPUSpaceToDepthBS2_5D,
                         SpaceToDepthLayerCPUTest,
...
const auto spaceToDepthBS3_5DParams = testing::Combine(testing::Combine(testing::ValuesIn(inputShapesBS3_5D),
                                                                        testing::ValuesIn(inputPrecisions),
                                                                        testing::ValuesIn(spaceToDepthModes),
                                                                        testing::Values(1, 3),
                                                                        testing::Values(CommonTestUtils::DEVICE_CPU)),
...
INSTANTIATE_TEST_SUITE_P(smoke_CPUSpaceToDepthBS3_5D,
                         SpaceToDepthLayerCPUTest,
