...
typedef std::tuple<LayerTestsDefinitions::shuffleChannelsLayerTestParamsSet, CPUSpecificParams>
    ShuffleChannelsLayerCPUTestParamsSet;
...
protected:
    void SetUp() override {
        ...
        std::tie(shuffleChannelsParams, netPrecision, inPrc, outPrc, inLayout, outLayout, inputShape, targetDevice) =
            basicParamsSet;
...
const auto shuffleChannelsParams4D = ::testing::Combine(::testing::ValuesIn(std::vector<int>{-4, -2, 0, 1, 2, 3}),
                                                        ::testing::ValuesIn(std::vector<int>{1, 2, 4, 8}));

const auto shuffleChannelsParams5D = ::testing::Combine(::testing::ValuesIn(std::vector<int>{-5, -1, 0, 1, 2, 3, 4}),
                                                        ::testing::ValuesIn(std::vector<int>{1, 2, 3, 6}));

INSTANTIATE_TEST_SUITE_P(
    smoke_ShuffleChannels4D,
    ShuffleChannelsLayerCPUTest,
    ::testing::Combine(::testing::Combine(shuffleChannelsParams4D,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ShuffleChannelsLayerCPUTest,
    ::testing::Combine(::testing::Combine(shuffleChannelsParams5D,
                                          ::testing::ValuesIn(netPrecisions),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_ShuffleChannels4DBlock,
    ShuffleChannelsLayerCPUTest,
    ::testing::Combine(::testing::Combine(shuffleChannelsParams4DBlock,
                                          ::testing::ValuesIn(netPrecisions),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
INSTANTIATE_TEST_SUITE_P(
    smoke_ShuffleChannels5DBlock,
    ShuffleChannelsLayerCPUTest,
    ::testing::Combine(::testing::Combine(shuffleChannelsParams5DBlock,
                                          ::testing::ValuesIn(netPrecisions),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
