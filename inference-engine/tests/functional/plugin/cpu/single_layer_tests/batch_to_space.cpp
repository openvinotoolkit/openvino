...
typedef std::tuple<LayerTestsDefinitions::batchToSpaceParamsTuple, CPUSpecificParams> BatchToSpaceLayerCPUTestParamSet;
...
const std::vector<CPUSpecificParams> cpuParams_4D = {CPUSpecificParams({nChw16c}, {nChw16c}, {}, {}),
                                                     CPUSpecificParams({nChw8c}, {nChw8c}, {}, {}),
                                                     CPUSpecificParams({nhwc}, {nhwc}, {}, {}),
                                                     CPUSpecificParams({nchw}, {nchw}, {}, {})};

const auto batchToSpaceParamsSet4D1 =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(std::vector<std::vector<int64_t>>({blockShape4D1})),
...
const auto batchToSpaceParamsSet4D2 =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(std::vector<std::vector<int64_t>>({blockShape4D2})),
...
INSTANTIATE_TEST_SUITE_P(smoke_BatchToSpaceCPULayerTestCase1_4D,
                         BatchToSpaceCPULayerTest,
                         batchToSpaceParamsSet4D1,
                         BatchToSpaceCPULayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_BatchToSpaceCPULayerTestCase2_4D,
                         BatchToSpaceCPULayerTest,
                         batchToSpaceParamsSet4D2,
                         BatchToSpaceCPULayerTest::getTestCaseName);
...
const std::vector<CPUSpecificParams> cpuParams_5D = {CPUSpecificParams({nCdhw16c}, {nCdhw16c}, {}, {}),
                                                     CPUSpecificParams({nCdhw8c}, {nCdhw8c}, {}, {}),
                                                     CPUSpecificParams({ndhwc}, {ndhwc}, {}, {}),
                                                     CPUSpecificParams({ncdhw}, {ncdhw}, {}, {})};

const auto batchToSpaceParamsSet5D1 =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(blockShape5D1),
...
const auto batchToSpaceParamsSet5D2 =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(blockShape5D2),
...
INSTANTIATE_TEST_SUITE_P(smoke_BatchToSpaceCPULayerTestCase1_5D,
                         BatchToSpaceCPULayerTest,
                         batchToSpaceParamsSet5D1,
                         BatchToSpaceCPULayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_BatchToSpaceCPULayerTestCase2_5D,
                         BatchToSpaceCPULayerTest,
                         batchToSpaceParamsSet5D2,
                         BatchToSpaceCPULayerTest::getTestCaseName);
