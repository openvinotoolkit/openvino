...
const std::vector<std::vector<int64_t>> blockShape4D = {{1, 2, 1, 2}, {1, 1, 2, 2}, {1, 2, 2, 1}, {1, 2, 2, 2}};
...
const std::vector<std::vector<size_t>> inputShapes4D = {{1, 16, 8, 8}, {1, 32, 8, 8}, {1, 16, 4, 4}, {2, 32, 16, 8}};
...
const std::vector<std::vector<size_t>> inputShapes5D = {{2, 16, 6, 6, 6}, {2, 16, 10, 9, 9}, {1, 32, 10, 6, 6}, {1, 32, 6, 9, 6}};
