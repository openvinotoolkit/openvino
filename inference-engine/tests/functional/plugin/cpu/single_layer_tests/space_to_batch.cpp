...
typedef std::tuple<LayerTestsDefinitions::spaceToBatchParamsTuple, CPUSpecificParams> SpaceToBatchLayerCPUTestParamSet;
...
const auto spaceToBatchParamsSet4D1 =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(blockShape4D1),
...
const auto spaceToBatchParamsSet4D2 =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(blockShape4D2),
...
INSTANTIATE_TEST_SUITE_P(smoke_SpaceToBatchCPULayerTestCase1_4D,
                         ...
                         spaceToBatchParamsSet4D1,
                         SpaceToBatchCPULayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_SpaceToBatchCPULayerTestCase2_4D,
                         SpaceToBatchCPULayerTest,
                         spaceToBatchParamsSet4D2,
                         SpaceToBatchCPULayerTest::getTestCaseName);
...
const auto spaceToBatchParamsSet5D =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(blockShape5D),
...
INSTANTIATE_TEST_SUITE_P(smoke_SpaceToBatchCPULayerTestCase_5D,
                         SpaceToBatchCPULayerTest,
                         spaceToBatchParamsSet5D,
                         SpaceToBatchCPULayerTest::getTestCaseName);
