...
public:
    static std::string getTestCaseName(testing::TestParamInfo<ReduceLayerCPUTestParamSet> obj) {
        ...
        result << LayerTestsDefinitions::ReduceOpsLayerTest::getTestCaseName(
            testing::TestParamInfo<reduceMeanParams>(basicParamsSet, 0));
...
const std::vector<ngraph::helpers::ReductionType> reductionLogicalTypes = {ngraph::helpers::ReductionType::LogicalOr,
...
std::vector<CPUSpecificParams> cpuParams_4D = {CPUSpecificParams({nChw16c}, {nChw16c}, {}, {}),
                                               CPUSpecificParams({nchw}, {nchw}, {}, {})};

std::vector<CPUSpecificParams> cpuParams_5D = {CPUSpecificParams({nCdhw16c}, {nCdhw16c}, {}, {}),
                                               CPUSpecificParams({ncdhw}, {ncdhw}, {}, {})};

const auto paramsOneAxis = ::testing::Combine(testing::Combine(testing::ValuesIn(axes),
...
const auto paramsOneAxisLogical =
    testing::Combine(testing::Combine(testing::ValuesIn(axes),
                                      testing::ValuesIn(opTypes),
                                      testing::ValuesIn(keepDims),
...
const auto params_MultiAxis =
    testing::Combine(testing::Combine(testing::ValuesIn(axesND),
...
const auto params_MultiAxis_4D =
    testing::Combine(testing::Combine(testing::ValuesIn(axesND),
                                      testing::Values(opTypes[1]),
                                      testing::Values(true),
                                      testing::ValuesIn(reductionTypes),
...
const auto params_MultiAxis_5D =
    testing::Combine(testing::Combine(testing::ValuesIn(axesND),
                                      testing::Values(opTypes[1]),
                                      testing::Values(true),
                                      testing::ValuesIn(reductionTypes),
...
const auto params_MultiAxisLogical =
    testing::Combine(testing::Combine(testing::ValuesIn(axesND),
                                      testing::Values(opTypes[1]),
                                      testing::Values(false),
                                      testing::ValuesIn(reductionLogicalTypes),
...
const auto params_MultiAxisLogical4D =
    testing::Combine(testing::Combine(testing::ValuesIn(axesND),
                                      testing::Values(opTypes[1]),
                                      testing::Values(true),
                                      testing::ValuesIn(reductionLogicalTypes),
...
const auto params_MultiAxisLogical5D =
    testing::Combine(testing::Combine(testing::ValuesIn(axesND),
                                      testing::Values(opTypes[1]),
                                      testing::Values(true),
                                      testing::ValuesIn(reductionLogicalTypes),
...
INSTANTIATE_TEST_SUITE_P(smoke_ReduceOneAxis_CPU,
                         ReduceCPULayerTest,
                         paramsOneAxis,
...
INSTANTIATE_TEST_SUITE_P(smoke_Reduce_ReductionTypes4D_CPU,
                         ReduceCPULayerTest,
                         params_MultiAxis_4D,
                         ReduceCPULayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_ReduceLogical_ReductionTypes_CPU,
                         ReduceCPULayerTest,
                         params_MultiAxisLogical,
                         ReduceCPULayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_ReduceLogical4D_ReductionTypes_CPU,
                         ReduceCPULayerTest,
