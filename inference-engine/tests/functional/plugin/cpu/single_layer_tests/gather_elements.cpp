...
typedef std::tuple<GatherElementsParams, CPUSpecificParams> GatherElementsCPUTestParamSet;
...
public:
    static std::string getTestCaseName(const testing::TestParamInfo<GatherElementsCPUTestParamSet>& obj) {
        ...
        result << GatherElementsLayerTest::getTestCaseName(
            testing::TestParamInfo<GatherElementsParams>(basicParamsSet, 0));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Combine(::testing::Values(std::vector<size_t>({2, 3, 5, 7})),  // Data shape
