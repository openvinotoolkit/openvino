...
public:
    static std::string getTestCaseName(const testing::TestParamInfo<oneHotCPUTestParams>& obj) {
        ...
        std::tie(inputShape, axis, depth, onValue, offValue, netPrecision, inPrc, outPrc, targetDevice, cpuParams) =
            obj.param;
...
protected:
    void SetUp() override {
        ...
        auto oneHot =
            std::make_shared<ngraph::opset5::OneHot>(inputParams.front(), depthConst, onConst, offConst, axis);
...
// 0d -> 1d, depth
const auto testCase_1d = ::testing::Combine(::testing::Values(std::vector<size_t>{}),
                                            ::testing::Values(-1, 0),
                                            ::testing::Values(3, 4),
                                            ::testing::Values(1.f),
                                            ::testing::Values(0.f),
...
// 1d -> 2d, axis default
const auto testCase_2d = ::testing::Combine(::testing::Values(std::vector<size_t>{3}),
...
const auto testCase_3d = ::testing::Combine(::testing::Values(std::vector<size_t>{3, 2}),
                                            ::testing::Values(-1, 0, 1),
                                            ::testing::Values(4),
                                            ::testing::Values(2.f),
                                            ::testing::Values(-1.f),
...
// 3d -> 4d
const auto testCase_4d = ::testing::Combine(::testing::Values(std::vector<size_t>{1, 3, 2}),
...
// 4d -> 5d
const auto testCase_5d = ::testing::Combine(::testing::Values(std::vector<size_t>{1, 3, 2, 3}),
