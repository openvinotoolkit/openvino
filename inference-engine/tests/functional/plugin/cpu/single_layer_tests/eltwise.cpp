...
typedef std::tuple<LayerTestsDefinitions::EltwiseTestParams, CPUSpecificParams> EltwiseLayerCPUTestParamsSet;
...
public:
    static std::string getTestCaseName(testing::TestParamInfo<EltwiseLayerCPUTestParamsSet> obj) {
        ...
        result << LayerTestsDefinitions::EltwiseLayerTest::getTestCaseName(
            testing::TestParamInfo<LayerTestsDefinitions::EltwiseTestParams>(basicParamsSet, 0));
...
protected:
    void SetUp() override {
        ...
        if (eltwiseType == ngraph::helpers::EltwiseTypes::DIVIDE || eltwiseType == ngraph::helpers::EltwiseTypes::MOD) {
            std::vector<float> data(ngraph::shape_size(shape_input_secondary));
            data = NGraphFunctions::Utils::generateVector<ngraph::element::Type_t::f32>(
                ngraph::shape_size(shape_input_secondary),
                10,
                2);
            ...
            negative_data =
                NGraphFunctions::Utils::generateVector<ngraph::element::Type_t::f32>(negative_data_size, -10, -2);
...
std::vector<ngraph::helpers::EltwiseTypes> eltwiseOpTypesDiffInp = {
    // Different number of input nodes depending on optimizations
...
std::vector<CPUSpecificParams> cpuParams_4D = {CPUSpecificParams({nChw16c, nChw16c}, {nChw16c}, {}, {}),
                                               CPUSpecificParams({nhwc, nhwc}, {nhwc}, {}, {}),
                                               CPUSpecificParams({nchw, nchw}, {nchw}, {}, {})};

const auto params_4D = ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_4D),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_MemOrder,
                         EltwiseLayerCPUTest,
                         params_4D,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_4D_emptyCPUSpec =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_4D),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_emptyCPUSpec,
                         EltwiseLayerCPUTest,
                         params_4D_emptyCPUSpec,
                         EltwiseLayerCPUTest::getTestCaseName);
...
std::vector<CPUSpecificParams> cpuParams_5D = {CPUSpecificParams({nCdhw16c, nCdhw16c}, {nCdhw16c}, {}, {}),
                                               CPUSpecificParams({ndhwc, ndhwc}, {ndhwc}, {}, {}),
                                               CPUSpecificParams({ncdhw, ncdhw}, {ncdhw}, {}, {})};

const auto params_5D = ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_5D),
                                                             ::testing::ValuesIn(eltwiseOpTypesBinInp),
                                                             ::testing::ValuesIn(secondaryInputTypes),
                                                             ::testing::ValuesIn(opTypes),
                                                             ::testing::ValuesIn(netPrc),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_MemOrder,
                         EltwiseLayerCPUTest,
                         params_5D,
                         EltwiseLayerCPUTest::getTestCaseName);

const auto params_5D_emptyCPUSpec =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_5D),
                                          ::testing::ValuesIn(eltwiseOpTypesDiffInp),
                                          ::testing::ValuesIn(secondaryInputTypes),
                                          ::testing::ValuesIn(opTypes),
                                          ::testing::ValuesIn(netPrc),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D,
                         EltwiseLayerCPUTest,
                         params_5D_emptyCPUSpec,
                         EltwiseLayerCPUTest::getTestCaseName);
...
const auto params_4D_Blocked_Planar =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_4D_Blocked_Planar),
                                          ::testing::ValuesIn(eltwiseOpTypesBinInp),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Blocked_Planar,
                         EltwiseLayerCPUTest,
                         params_4D_Blocked_Planar,
                         EltwiseLayerCPUTest::getTestCaseName);
...
const auto params_4D_Planar_Blocked =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_4D_Planar_Blocked),
                                          ::testing::ValuesIn(eltwiseOpTypesBinInp),
                                          ::testing::Values(ngraph::helpers::InputLayerType::CONSTANT),
                                          ::testing::ValuesIn(opTypes),
                                          ::testing::ValuesIn(netPrc),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_Planar_Blocked,
                         EltwiseLayerCPUTest,
                         params_4D_Planar_Blocked,
                         EltwiseLayerCPUTest::getTestCaseName);
...
const auto params_5D_Blocked_Planar =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_5D_Blocked_Planar),
                                          ::testing::ValuesIn(eltwiseOpTypesBinInp),
                                          ::testing::Values(ngraph::helpers::InputLayerType::CONSTANT),
                                          ::testing::ValuesIn(opTypes),
                                          ::testing::ValuesIn(netPrc),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_Blocked_Planar,
                         EltwiseLayerCPUTest,
                         params_5D_Blocked_Planar,
                         EltwiseLayerCPUTest::getTestCaseName);
...
const auto params_5D_Planar_Blocked =
    ::testing::Combine(::testing::Combine(::testing::ValuesIn(inShapes_5D_Planar_Blocked),
                                          ::testing::ValuesIn(eltwiseOpTypesBinInp),
                                          ::testing::Values(ngraph::helpers::InputLayerType::CONSTANT),
                                          ::testing::ValuesIn(opTypes),
                                          ::testing::ValuesIn(netPrc),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_Planar_Blocked,
                         EltwiseLayerCPUTest,
                         params_5D_Planar_Blocked,
                         EltwiseLayerCPUTest::getTestCaseName);
...
std::vector<CPUSpecificParams> cpuParams_4D_1D = {CPUSpecificParams({nChw16c, x}, {nChw16c}, {}, {}),
                                                  CPUSpecificParams({nhwc, x}, {nhwc}, {}, {}),
                                                  CPUSpecificParams({nchw, x}, {nchw}, {}, {})};

const auto params_4D_1D = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(inShapes_4D_1D),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_4D_1D,
                         EltwiseLayerCPUTest,
                         params_4D_1D,
                         EltwiseLayerCPUTest::getTestCaseName);
...
std::vector<CPUSpecificParams> cpuParams_5D_1D = {CPUSpecificParams({nCdhw16c, x}, {nCdhw16c}, {}, {}),
                                                  CPUSpecificParams({ndhwc, x}, {ndhwc}, {}, {}),
                                                  CPUSpecificParams({ncdhw, x}, {ncdhw}, {}, {})};

const auto params_5D_1D = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(inShapes_5D_1D),
                       ::testing::Values(ngraph::helpers::EltwiseTypes::ADD, ngraph::helpers::EltwiseTypes::MULTIPLY),
                       ::testing::ValuesIn(secondaryInputTypes),
                       ::testing::ValuesIn(opTypes),
                       ::testing::ValuesIn(netPrc),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_5D_1D,
                         EltwiseLayerCPUTest,
                         params_5D_1D,
                         EltwiseLayerCPUTest::getTestCaseName);
