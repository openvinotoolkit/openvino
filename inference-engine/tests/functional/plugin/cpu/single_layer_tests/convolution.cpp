...
typedef std::tuple<convLayerTestParamsSet, CPUSpecificParams, fusingSpecificParams, std::map<std::string, std::string>>
...
public:
    static std::string getTestCaseName(const testing::TestParamInfo<convLayerCPUTestParamsSet>& obj) {
        ...
        result << LayerTestsDefinitions::ConvolutionLayerTest::getTestCaseName(
            testing::TestParamInfo<convLayerTestParamsSet>(basicParamsSet, 0));
...
TEST_P(ConvolutionLayerCPUTest, CompareWithRefs) {
    ...
    if (!inFmts.empty() && (inFmts.front() == nhwc || inFmts.front() == ndhwc) &&
...
/* INSTANCES */
/* ============= Convolution (Gemm 2D) ============= */
const auto convParams_ExplicitPadding_GEMM_2D = ::testing::Combine(::testing::ValuesIn(kernels2d),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_GEMM_FP32,
...
/* ============= Convolution (GEMM 3D) ============= */
const auto convParams_ExplicitPadding_GEMM_3D = ::testing::Combine(::testing::ValuesIn(kernels3d),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_FP32,
                         ConvolutionLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_BF16,
                         ConvolutionLayerCPUTest,
                         ::testing::Combine(::testing::Combine(convParams_ExplicitPadding_2D,
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::BF16),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_PlainToBlocked_2D_FP32,
                         ConvolutionLayerCPUTest,
                         ::testing::Combine(::testing::Combine(convParams_ExplicitPadding_2D,
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::UNSPECIFIED),
...
/* ============= Convolution (3D) ============= */
const auto convParams_ExplicitPadding_3D = ::testing::Combine(::testing::ValuesIn(kernels3d),
                                                              ::testing::ValuesIn(strides3d),
                                                              ::testing::ValuesIn(padBegins3d),
                                                              ::testing::ValuesIn(padEnds3d),
                                                              ::testing::ValuesIn(dilations3d),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_FP32,
                         ConvolutionLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_3D_BF16,
                         ConvolutionLayerCPUTest,
                         ::testing::Combine(::testing::Combine(convParams_ExplicitPadding_3D,
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::BF16),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_PlainToBlocked_3D_FP32,
                         ConvolutionLayerCPUTest,
                         ::testing::Combine(::testing::Combine(convParams_ExplicitPadding_3D,
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::UNSPECIFIED),
...
const std::vector<CPUSpecificParams> CPUParams_1x1_2D = {conv_sse42_2D_1x1,
                                                         conv_avx2_2D_1x1,
                                                         conv_avx512_2D_1x1,
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_1x1_FP32,
                         ConvolutionLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_2D_1x1_BF16,
                         ConvolutionLayerCPUTest,
                         ::testing::Combine(::testing::Combine(convParams_ExplicitPadding_1x1_2D,
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::BF16),
...
const auto convParams_1D = ::testing::Combine(::testing::ValuesIn(kernels1d),
...
const std::vector<CPUSpecificParams> CPUParams_1D = {conv_sse42_1D, conv_avx2_1D, conv_avx512_1D};

INSTANTIATE_TEST_SUITE_P(smoke_Conv_1D,
                         ConvolutionLayerCPUTest,
                         ::testing::Combine(::testing::Combine(convParams_1D,
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::UNSPECIFIED),
                                                               ::testing::Values(Layout::ANY),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_Jit_Planar_2D_FP32,
                         ConvolutionLayerCPUTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_Jit_Planar_3D_FP32,
                         ConvolutionLayerCPUTest,
...
const auto convParams_2D = ::testing::Combine(::testing::ValuesIn(kernels2d),
                                              ::testing::ValuesIn(strides2d),
                                              ::testing::ValuesIn(padBegins2d),
                                              ::testing::ValuesIn(padEnds2d),
                                              ::testing::ValuesIn(dilations2d),
...
INSTANTIATE_TEST_SUITE_P(smoke_Conv_winograd,
                         ConvolutionLayerCPUTest,
                         ::testing::Combine(::testing::Combine(convParams_2D,
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::FP32),
                                                               ::testing::Values(Precision::UNSPECIFIED),
                                                               ::testing::Values(Layout::ANY),
                                                               ...
                                                               ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                                            ::testing::ValuesIn(filterCPUInfoForDevice(std::vector<CPUSpecificParams>{
                                                conv_winograd})),
                                            ::testing::ValuesIn(fusingParamsSet),
                                            ::testing::Values(cpuEmptyPluginConfig)),
                         ConvolutionLayerCPUTest::getTestCaseName);
