...
typedef std::tuple<groupConvLayerTestParamsSet, CPUSpecificParams, fusingSpecificParams> groupConvLayerCPUTestParamsSet;
...
public:
    static std::string getTestCaseName(testing::TestParamInfo<groupConvLayerCPUTestParamsSet> obj) {
        ...
        result << LayerTestsDefinitions::GroupConvolutionLayerTest::getTestCaseName(
            testing::TestParamInfo<groupConvLayerTestParamsSet>(basicParamsSet, 0));
...
protected:
    ...
    void SetUp() override {
        ...
        std::tie(groupConvParams, netPrecision, inPrc, outPrc, inLayout, outLayout, inputShape, targetDevice) =
            basicParamsSet;
        ...
        auto groupConv = std::dynamic_pointer_cast<ngraph::opset1::GroupConvolution>(
            ngraph::builder::makeGroupConvolution(paramOuts[0],
                                                  ngPrc,
                                                  kernel,
                                                  stride,
                                                  padBegin,
...
const auto groupConvParams_ExplicitPadding_Gemm_2D =
...
const VecPrcConnectedParams vecPrcConnectParamsFP32 = {
    PrcConnectedParams{Precision::FP32, Precision::FP32, fusingParamsSet}};
const VecPrcConnectedParams vecPrcConnectParams = {
    PrcConnectedParams{Precision::FP32, Precision::FP32, fusingParamsSet},
...
const VecPrcConnectedParams vecPrcConnectParamsFP32Default = {
    PrcConnectedParams{Precision::FP32, Precision::FP32, VecFusingParams{emptyFusingSpec}}};
const VecPrcConnectedParams vecPrcConnectParamsDefault = {
    PrcConnectedParams{Precision::FP32, Precision::FP32, VecFusingParams{emptyFusingSpec}},
...
const std::vector<groupConvLayerCPUTestParamsSet> JIT_SSE42_DW_GroupConvTestCases = generateSingleGroupConvCPUTestCases(
    ...
    //  ngraph::op::PadType::VALID, 17, 1, {5, 5}, 1, 1, conv_sse42_DW_2D, vecPrcConnectParamsFP32only), jcp.ow >
    //  jcp.ur_w (jcp.ow == 7)
    makeSingleGroupConvCPUTestCases({3, 3},
                                    {1, 1},
                                    {1, 1},
