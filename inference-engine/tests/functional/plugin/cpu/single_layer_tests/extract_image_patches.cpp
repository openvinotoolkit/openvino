...
typedef std::tuple<extractImagePatchesTuple, CPUSpecificParams> extractImagePatchesCPUTestParamsSet;
...
public:
    static std::string getTestCaseName(testing::TestParamInfo<extractImagePatchesCPUTestParamsSet> obj) {
        ...
        result << LayerTestsDefinitions::ExtractImagePatchesTest::getTestCaseName(
            testing::TestParamInfo<extractImagePatchesTuple>(basicParamsSet, 0));
...
protected:
    void SetUp() override {
        ...
        std::tie(inputShape, kernel, strides, rates, pad_type, netPrecision, inPrc, outPrc, inLayout, targetDevice) =
            basicParamsSet;
        ...
        auto extImgPatches = std::make_shared<ngraph::opset6::ExtractImagePatches>(inputNode,
                                                                                   ngraph::Shape(kernel),
...
const std::vector<ngraph::op::PadType> autoPads = {ngraph::op::PadType::VALID,
...
const auto Layer_params = ::testing::Combine(::testing::ValuesIn(inShapes),
