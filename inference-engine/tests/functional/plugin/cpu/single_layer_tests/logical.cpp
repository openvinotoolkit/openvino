...
typedef std::tuple<LayerTestsDefinitions::LogicalTestParams, CPUSpecificParams> LogicalLayerCPUTestParamSet;
...
public:
    static std::string getTestCaseName(testing::TestParamInfo<LogicalLayerCPUTestParamSet> obj) {
        ...
        result << LayerTestsDefinitions::LogicalLayerTest::getTestCaseName(
            testing::TestParamInfo<LayerTestsDefinitions::LogicalTestParams>(basicParamsSet, 0));
...
protected:
    void SetUp() override {
        ...
        auto ngInputsPrc = FuncTestUtils::PrecisionUtils::convertIE2nGraphPrc(
            Precision::BOOL);  // Because ngraph supports only boolean input for logical ops
...
const auto LogicalTestParams = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(LayerTestsDefinitions::LogicalLayerTest::combineShapes(inputShapes)),
...
const auto LogicalTestParamsNot = ::testing::Combine(
    ::testing::Combine(::testing::ValuesIn(LayerTestsDefinitions::LogicalLayerTest::combineShapes(inputShapesNot)),
