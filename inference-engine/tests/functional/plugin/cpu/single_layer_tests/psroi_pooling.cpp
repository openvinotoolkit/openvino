...
typedef std::tuple<std::vector<size_t>,  // feature map shape
...
typedef std::tuple<CPULayerTestsDefinitions::PSROIPoolingLayerTestParams, CPUSpecificParams>
    PSROIPoolingLayerCPUTestParamsSet;
...
protected:
    void SetUp() override {
        ...
        auto psroi = std::make_shared<ngraph::op::v0::PSROIPooling>(params[0],
                                                                    coords,
                                                                    outputDim,
                                                                    groupSize,
                                                                    spatialScale,
...
const std::vector<std::vector<size_t>> inputShapeVector = {SizeVector({2, 200, 20, 20}),
                                                           SizeVector({2, 200, 20, 16}),
                                                           SizeVector({2, 200, 16, 20}),
                                                           SizeVector({3, 200, 16, 16})};

const std::vector<std::vector<float>> averagePropVector = {{0, 0.9, 0.9, 18.9, 18.9, 1, 0.9, 0.9, 18.9, 18.9},
                                                           {1, 1, 1, 15, 15}};

const std::vector<std::vector<float>> bilinearPropVector = {{0, 0.1, 0.1, 0.9, 0.9, 1, 0.1, 0.1, 0.9, 0.9},
                                                            {1, 0.1, 0.1, 0.9, 0.9}};
...
const auto psroiPoolingBilinearParams = ::testing::Combine(::testing::Values(std::vector<size_t>{3, 32, 20, 20}),
