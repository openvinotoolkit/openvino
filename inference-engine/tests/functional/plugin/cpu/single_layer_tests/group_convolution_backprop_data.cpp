...
typedef std::tuple<groupConvBackpropDataLayerTestParamsSet,
    ...
    groupDeconvLayerCPUTestParamsSet;
...
public:
    static std::string getTestCaseName(testing::TestParamInfo<groupDeconvLayerCPUTestParamsSet> obj) {
        ...
        result << LayerTestsDefinitions::GroupConvBackpropLayerTest::getTestCaseName(
            testing::TestParamInfo<groupConvBackpropDataLayerTestParamsSet>(basicParamsSet, 0));
...
protected:
    void SetUp() override {
        ...
        std::tie(kernel, stride, padBegin, padEnd, dilation, convOutChannels, numGroups, padType, outputPadding) =
            groupConvParams;
        ...
        if (!outputShape.empty()) {
            ...
            groupConv = std::dynamic_pointer_cast<ngraph::opset1::GroupConvolutionBackpropData>(
                ngraph::builder::makeGroupConvolutionBackpropData(paramOuts[0],
                                                                  outShape,
                                                                  ngPrc,
                                                                  kernel,
                                                                  stride,
...
std::vector<groupDeconvLayerCPUTestParamsSet> filterParamsSetForDevice(
    std::vector<groupDeconvLayerCPUTestParamsSet> paramsSet) {
...
const auto groupConvParams_ExplicitPadding_Planar_2D =
...
INSTANTIATE_TEST_SUITE_P(
    smoke_GroupDeconv_2D_Planar_FP32,
    GroupDeconvolutionLayerCPUTest,
    ::testing::Combine(::testing::Combine(groupConvParams_ExplicitPadding_Planar_2D,
...
const auto groupConvParams_ExplicitPadding_Planar_3D =
...
INSTANTIATE_TEST_SUITE_P(
    ...
    GroupDeconvolutionLayerCPUTest,
    ::testing::Combine(::testing::Combine(groupConvParams_ExplicitPadding_Planar_3D,
                                          ::testing::Values(Precision::FP32),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
const auto groupConvParams_ExplicitPadding_Blocked_2D =
    ::testing::Combine(::testing::ValuesIn(kernels2d),
                       ::testing::ValuesIn(strides2d),
                       ::testing::ValuesIn(padBegins2d),
                       ::testing::ValuesIn(padEnds2d),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    GroupDeconvolutionLayerCPUTest,
    ::testing::Combine(::testing::Combine(groupConvParams_ExplicitPadding_Blocked_2D,
                                          ::testing::Values(Precision::FP32),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
...
const auto groupConvParams_ExplicitPadding_Blocked_3D =
    ::testing::Combine(::testing::ValuesIn(kernels3d),
                       ::testing::ValuesIn(strides3d),
                       ::testing::ValuesIn(padBegins3d),
                       ::testing::ValuesIn(padEnds3d),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    GroupDeconvolutionLayerCPUTest,
    ::testing::Combine(::testing::Combine(groupConvParams_ExplicitPadding_Blocked_3D,
                                          ::testing::Values(Precision::FP32),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                          ::testing::Values(InferenceEngine::Layout::ANY),
