...
namespace shape4d {
const std::vector<ngraph::PartialShape> inputShapes = {{1ul, 3ul, 16ul, 16ul}, {4ul, 3ul, 16ul, 16ul}};
...
namespace shape5d {
const std::vector<ngraph::PartialShape> inputShapes = {{1ul, 3ul, 16ul, 16ul, 16ul}, {4ul, 3ul, 16ul, 16ul, 16ul}};
