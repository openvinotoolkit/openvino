...
const std::vector<LayerTestsDefinitions::PadTransformationParam> params = {
    // tensor quantization
    {{256ul, ngraph::Shape{1, 1, 1, 1}, {0.f}, {25.5f}, {0.f}, {12.8f}}, {0, 0, 1, 1}, {0, 0, 1, 1}, 0.f, "Pad", "U8"},
...
INSTANTIATE_TEST_CASE_P(smoke_LPT,
                        PadTransformation,
...
const std::vector<LayerTestsDefinitions::PadTransformationParam> params = {
    ...
    {{256ul, ngraph::Shape{1, 1, 1, 1}, {0.f}, {25.5f}, {0.f}, {12.8f}}, {0, 0, 2, 0}, {0, 0, 1, 0}, 2.f, "Pad", "U8"},
...
const std::vector<ngraph::op::PadMode> modesWithoutConstant = {ngraph::op::PadMode::EDGE,
                                                               ngraph::op::PadMode::REFLECT,
                                                               ngraph::op::PadMode::SYMMETRIC};
