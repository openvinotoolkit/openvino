...
namespace {
const std::vector<ngraph::element::Type> netPrecisions = {ngraph::element::f32};
...
const std::vector<std::pair<ngraph::PartialShape, ngraph::Shape>> inputShapes = {{{1, 16}, {10, 16}},
                                                                                 {{1, 16}, {16, 10}}};

INSTANTIATE_TEST_SUITE_P(smoke_LPT,
                         MatMulWithOptimizedConstantFakeQuantizeTransformation,
