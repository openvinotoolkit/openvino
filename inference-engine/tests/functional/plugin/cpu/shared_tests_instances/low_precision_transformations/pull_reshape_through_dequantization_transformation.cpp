...
const std::vector<PullReshapeThroughDequantizationTestValues> params = {
    {ngraph::element::f32,
     ...
     {{ngraph::element::f32, false}, {}, {{0.03f}, ngraph::element::f32, {/* from parameter */}, false}},
     {{3, 3, 16, 1}},
...
const std::vector<ngraph::PartialShape> inputShapes = {{1, 16, 9, 9}, {4, 16, 9, 9}};

const std::vector<ngraph::Shape> dequantizationOnWeightElementwiseConstantShapes = {{ngraph::Shape({1, 16})}};
