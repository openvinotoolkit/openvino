...
const std::vector<ReshapeTransformationParam> params = {
    // 3D -> 4D
    {{1, 3, 32}, {1, 3, 4, 8}, {256ul, ngraph::Shape{1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "U8"},
    // 3D -> 1D
    {{1, 3, 32}, {-1}, {256ul, ngraph::Shape{}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "FP32"},
    // 4D -> 3D
    {{1, 3, 16, 16}, {1, 3, 256}, {256ul, ngraph::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "U8"},
    // 4D -> 3D
    {{1, 3, 16, 16},
     {0, 3, -1},
     ...
     "U8"},
    // 4D -> 2D
    {{1, 3, 4, 8}, {1, -1}, {256ul, ngraph::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}}, "Reshape", "U8"},
    // 4D -> 2D
    {{1, 3, 4, 8},
     {1, -1},
     {
