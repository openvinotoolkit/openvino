...
const std::vector<LayerTestsDefinitions::ConvolutionBackpropDataTransformationParam> params = {
    ...
    {{256ul, ngraph::Shape{1, 1, 1, 1}, {0.f}, {255.f}, {0.f}, {25.5f}},
     {{ngraph::element::f32},
      {},
      {{4.f, 2.f, 4.f, 2.f, 4.f, 2.f, 4.f, 2.f}, ngraph::element::f32, {8, 1, 1, 1}, false}},
     "",
     ""}};

const std::vector<std::pair<ngraph::PartialShape, bool>> inputShapes = {{{1, 8, 16, 16}, true}};

const std::vector<ngraph::Shape> outputShapes = {{16, 16}};
