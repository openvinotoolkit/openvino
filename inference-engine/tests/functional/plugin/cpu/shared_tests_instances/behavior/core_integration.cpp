...
INSTANTIATE_TEST_SUITE_P(smoke_IEClassCommon,
                         IEClassBasicTestP,
                         ::testing::Values(std::make_pair("MKLDNNPlugin", "CPU")));

INSTANTIATE_TEST_SUITE_P(smoke_IEClassNetworkTestP, IEClassNetworkTestP, ::testing::Values("CPU"));

INSTANTIATE_TEST_SUITE_P(smoke_IEClassImportExportTestP, IEClassImportExportTestP, ::testing::Values("HETERO:CPU"));
...
INSTANTIATE_TEST_SUITE_P(smoke_IEClassGetMetricTest, IEClassGetMetricTest_AVAILABLE_DEVICES, ::testing::Values("CPU"));
...
INSTANTIATE_TEST_SUITE_P(smoke_IEClassGetMetricTest, IEClassGetMetricTest_RANGE_FOR_STREAMS, ::testing::Values("CPU"));
...
INSTANTIATE_TEST_SUITE_P(smoke_IEClassGetAvailableDevices, IEClassGetAvailableDevices, ::testing::Values("CPU"));

//
// IE Class GetConfig
//

INSTANTIATE_TEST_SUITE_P(smoke_IEClassGetConfigTest, IEClassGetConfigTest, ::testing::Values("CPU"));
...
INSTANTIATE_TEST_SUITE_P(smoke_IEClassHeteroExecutableNetworkGetMetricTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_IEClassQueryNetworkTest, IEClassQueryNetworkTest, ::testing::Values("CPU"));

// IE Class Load network

INSTANTIATE_TEST_SUITE_P(smoke_IEClassLoadNetworkTest, IEClassLoadNetworkTest, ::testing::Values("CPU"));
}  // namespace