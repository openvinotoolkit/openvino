...
std::vector<std::string> disabledTestPatterns() {
    std::vector<std::string> retVector{
        ...
        retVector.insert(retVector.end(), {
              ...
              S\(1.1.1\)_PB\(0.0.0\)_PE\(0.0.0\)_D=\(1.1.1\)_O=6_G=3_AP=explicit_netPRC=FP32_inPRC=BF16_outPRC=BF16_
              inL=ANY_outL=ANY_trgDev=CPU_inFmts=ncdhw_outFmts=ncdhw_primitive=jit_gemm_PluginConf_ENFORCE_BF16=YES.*)",
              R"(.*GroupDeconv_3D_Planar_BF16.*IS=\(2.12.7.7.7\)_K\(3.3.3\)_
              S\(2.2.2\)_PB\(0.0.0\)_PE\(0.0.0\)_D=\(1.1.1\)_O=6_G=3_AP=explicit_netPRC=FP32_inPRC=BF16_outPRC=BF16_
              inL=ANY_outL=ANY_trgDev=CPU_inFmts=ncdhw_outFmts=ncdhw_primitive=jit_gemm_PluginConf_ENFORCE_BF16=YES.*)",
