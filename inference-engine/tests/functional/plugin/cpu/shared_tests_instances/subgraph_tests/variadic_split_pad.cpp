...
const std::vector<InferenceEngine::Precision> netPrecision = {InferenceEngine::Precision::FP32};
...
const std::vector<ngraph::helpers::PadMode> padMode = {ngraph::helpers::PadMode::CONSTANT,
