...
const auto AdaPool3DCases =
    ::testing::Combine(::testing::ValuesIn(std::vector<std::vector<size_t>>{{1, 2, 1}, {1, 1, 3}, {3, 17, 5}}),
...
const auto AdaPool4DCases =
    ::testing::Combine(::testing::ValuesIn(std::vector<std::vector<size_t>>{{1, 2, 1, 2}, {1, 1, 3, 2}, {3, 17, 5, 1}}),
...
const auto AdaPool5DCases = ::testing::Combine(
    ::testing::ValuesIn(std::vector<std::vector<size_t>>{{1, 2, 1, 2, 2}, {1, 1, 3, 2, 3}, {3, 17, 5, 1, 2}}),
