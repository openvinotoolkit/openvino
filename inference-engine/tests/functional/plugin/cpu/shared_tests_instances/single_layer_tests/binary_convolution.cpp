...
const auto binConv2DParams_ExplicitPadding = ::testing::Combine(::testing::ValuesIn(kernels),
...
const auto binConv2DParams_ValidPadding = ::testing::Combine(::testing::ValuesIn(kernels),
                                                             ::testing::ValuesIn(strides),
...
INSTANTIATE_TEST_SUITE_P(smoke_BinaryConvolution2D_ExplicitPadding,
                         BinaryConvolutionLayerTest,
                         ::testing::Combine(binConv2DParams_ExplicitPadding,
...
INSTANTIATE_TEST_SUITE_P(smoke_BinaryConvolution2D_AutoPadValid,
                         BinaryConvolutionLayerTest,
                         ::testing::Combine(binConv2DParams_ValidPadding,
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                            ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                            ::testing::Values(InferenceEngine::Layout::ANY),
