...
#include "single_layer_tests/multiclass_non_max_suppression.hpp"
...
// const std::vector<InputShapeParams> inShapeParams = {
//     InputShapeParams{2, 5, 3} // pass
//     // InputShapeParams{3, 100, 5} // some fail
//     // InputShapeParams{1, 10, 50} // some fail
//     // InputShapeParams{3, 100, 5} // some fail
//     // InputShapeParams{2, 50, 50}
// };
// const std::vector<InputShapeParams> inShapeParams = {InputShapeParams{1, 10, 50}};

// const std::vector<int32_t> nmsTopK = {-1};
const std::vector<int32_t> nmsTopK = {-1, 20};
const std::vector<float> iouThreshold = {0.7f};
const std::vector<float> scoreThreshold = {0.7f};
// const std::vector<int32_t> backgroundClass = {-1};
const std::vector<int32_t> backgroundClass = {-1, 0};
// const std::vector<int32_t> keepTopK = {-1};
const std::vector<int32_t> keepTopK = {-1, 30};
// const std::vector<element::Type> outType = {element::i32};
const std::vector<element::Type> outType = {element::i32, element::i64};

const std::vector<op::v8::MulticlassNms::SortResultType>
    sortResultType = {
...
//     sortResultType = {
//         op::v8::MulticlassNms::SortResultType::SCORE};
// const std::vector<bool> sortResDesc = {true};
// const std::vector<float> nmsEta = {1.0f};
// const std::vector<bool> normalized = {true};
