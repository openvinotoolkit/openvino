...
INSTANTIATE_TEST_SUITE_P(smoke_LogSoftmax2D, LogSoftmaxLayerTest, params2D, LogSoftmaxLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_LogSoftmax4D, LogSoftmaxLayerTest, params4D, LogSoftmaxLayerTest::getTestCaseName);
