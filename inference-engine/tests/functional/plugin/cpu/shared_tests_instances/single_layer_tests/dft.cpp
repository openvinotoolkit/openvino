...
const auto testCase1D = ::testing::Combine(::testing::ValuesIn(inputShapes),
...
const auto testCase2D = ::testing::Combine(::testing::ValuesIn(inputShapes),
                                           ::testing::ValuesIn(inputPrecision),
...
const auto testCase3D = ::testing::Combine(::testing::ValuesIn(inputShapes),
                                           ::testing::ValuesIn(inputPrecision),
...
const auto testCase4D = ::testing::Combine(::testing::ValuesIn(inputShapes),
                                           ::testing::ValuesIn(inputPrecision),
