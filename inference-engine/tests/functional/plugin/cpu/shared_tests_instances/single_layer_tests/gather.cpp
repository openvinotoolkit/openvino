...
const std::vector<InferenceEngine::Precision> netPrecisions = {InferenceEngine::Precision::I64,
...
const std::vector<std::tuple<int, int>> axes_batchdims_1D = {std::tuple<int, int>{0, 0}};

const auto gather7Params_1D = testing::Combine(testing::ValuesIn(inputShapes_1D),
...
const auto gather7Params_2D = testing::Combine(testing::ValuesIn(inputShapes_2D),
...
const auto gather7ParamsSubset_BD0 = testing::Combine(testing::ValuesIn(inputShapes4D),
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather7_BD0,
                         Gather7LayerTest,
                         gather7ParamsSubset_BD0,
...
const auto gather7ParamsSubset_BD1 = testing::Combine(testing::ValuesIn(inputShapes4D),
...
const std::vector<std::vector<size_t>> indicesShapes_BD2 = {std::vector<size_t>{4, 5, 4, 3},
...
const auto gather7ParamsSubset_BD2 = testing::Combine(testing::ValuesIn(inputShapes4D),
...
const std::vector<std::vector<size_t>> indicesShapes_NegativeBD = {std::vector<size_t>{4, 5, 4},
                                                                   std::vector<size_t>{4, 5, 3}};
...
const auto gather7ParamsSubset_NegativeBD = testing::Combine(testing::ValuesIn(inputShapes4D),
...
INSTANTIATE_TEST_SUITE_P(smoke_Gather7_NegativeBD,
                         Gather7LayerTest,
                         gather7ParamsSubset_NegativeBD,
                         Gather7LayerTest::getTestCaseName);
