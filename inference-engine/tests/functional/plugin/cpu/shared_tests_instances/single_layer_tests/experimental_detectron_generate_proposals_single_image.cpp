...
const std::vector<std::pair<std::string, std::vector<ov::runtime::Tensor>>> inputTensors = {
    {
        ...
        {
            // 3
            ExperimentalDetectronGenerateProposalsSingleImageLayerTest::createTensor<float>(ov::element::f32, ov::Shape{3}, {1.0f, 1.0f, 1.0f}),
            // 36 x 4 = 144
            ExperimentalDetectronGenerateProposalsSingleImageLayerTest::createTensor<float>(ov::element::f32, ov::Shape{36, 4}, {
                ...
                1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f}),
            // 12 x 2 x 6 = 144
            ExperimentalDetectronGenerateProposalsSingleImageLayerTest::createTensor<float>(ov::element::f32, ov::Shape{12, 2, 6}, {
                1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f,
                1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f,
                1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f,
                1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f,
                ...
                1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f}),
            // {3 x 2 x 6} = 36
            ExperimentalDetectronGenerateProposalsSingleImageLayerTest::createTensor<float>(ov::element::f32, ov::Shape{3, 2, 6}, {
    ...
    },
    {
        "filled",
        {
            ExperimentalDetectronGenerateProposalsSingleImageLayerTest::createTensor<float>(ov::element::f32, ov::Shape{3}, {150.0, 150.0, 1.0}),
            ExperimentalDetectronGenerateProposalsSingleImageLayerTest::createTensor<float>(ov::element::f32, ov::Shape{36, 4}, {
