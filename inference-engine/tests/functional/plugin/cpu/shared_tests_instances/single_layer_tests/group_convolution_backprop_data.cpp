...
const auto groupConvBackpropData1DParams_AutoPadValid =
    ::testing::Combine(::testing::ValuesIn(kernels1D),
                       ::testing::ValuesIn(strides1D),
                       ::testing::ValuesIn(padBegins1D),
                       ::testing::ValuesIn(padEnds1D),
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData1D_ExplicitPadding,
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData1D_AutoPadValid,
                        GroupConvBackpropLayerTest,
                        ::testing::Combine(groupConvBackpropData1DParams_AutoPadValid,
                                           ::testing::ValuesIn(netPrecisions),
                                           ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                           ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
                                           ::testing::Values(InferenceEngine::Layout::ANY),
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData2D_ExplicitPadding,
                        GroupConvBackpropLayerTest,
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData2D_AutoPadValid,
                        GroupConvBackpropLayerTest,
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData2D_OutputShapeDefined,
                        GroupConvBackpropLayerTest,
                        ::testing::Combine(groupConvBackpropData2DParams_AutoPadValid,
                                           ::testing::ValuesIn(netPrecisions),
                                           ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData2D_ExplicitPadding_OutputPaddingDefined,
                        GroupConvBackpropLayerTest,
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData2D_AutoPadding_OutputPaddingDefined,
                        GroupConvBackpropLayerTest,
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData3D_AutoPadValid,
                        GroupConvBackpropLayerTest,
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData3D_OutputShapeDefined,
                        GroupConvBackpropLayerTest,
                        ::testing::Combine(groupConvBackpropData3DParams_AutoPadValid,
                                           ::testing::ValuesIn(netPrecisions),
                                           ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData3D_ExplicitPadding_OutputPaddingDefined,
                        GroupConvBackpropLayerTest,
...
INSTANTIATE_TEST_CASE_P(smoke_GroupConvBackpropData3D_AutoPadding_OutputPaddingDefined,
                        GroupConvBackpropLayerTest,
