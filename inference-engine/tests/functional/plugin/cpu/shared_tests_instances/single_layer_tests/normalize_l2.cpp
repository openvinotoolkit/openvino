...
const std::vector<std::vector<int64_t>> axes_1D = {{}, {0}};

const auto normL2params_1D = testing::Combine(testing::ValuesIn(axes_1D),
...
INSTANTIATE_TEST_SUITE_P(smoke_NormalizeL2_1D,
...
const auto normL2params_2D = testing::Combine(testing::ValuesIn(axes_2D),
                                              testing::ValuesIn(eps),
                                              testing::ValuesIn(epsMode),
...
INSTANTIATE_TEST_SUITE_P(smoke_NormalizeL2_2D,
                         NormalizeL2LayerTest,
                         normL2params_2D,
                         NormalizeL2LayerTest::getTestCaseName);
...
const auto normL2params_3D = testing::Combine(testing::ValuesIn(axes_3D),
                                              testing::ValuesIn(eps),
                                              testing::ValuesIn(epsMode),
...
INSTANTIATE_TEST_SUITE_P(smoke_NormalizeL2_3D,
                         NormalizeL2LayerTest,
                         normL2params_3D,
                         NormalizeL2LayerTest::getTestCaseName);
...
const auto normL2params_4D = testing::Combine(testing::ValuesIn(axes_4D),
                                              testing::ValuesIn(eps),
                                              testing::ValuesIn(epsMode),
...
INSTANTIATE_TEST_SUITE_P(smoke_NormalizeL2_4D,
                         NormalizeL2LayerTest,
                         normL2params_4D,
                         NormalizeL2LayerTest::getTestCaseName);
...
const auto normL2params_5D = testing::Combine(testing::ValuesIn(axes_5D),
                                              testing::ValuesIn(eps),
                                              testing::ValuesIn(epsMode),
...
INSTANTIATE_TEST_SUITE_P(smoke_NormalizeL2_5D,
                         NormalizeL2LayerTest,
                         normL2params_5D,
                         NormalizeL2LayerTest::getTestCaseName);
}  // namespace
