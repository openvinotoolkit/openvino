...
const auto shuffleChannelsParams4D = ::testing::Combine(::testing::ValuesIn(axes), ::testing::ValuesIn(groups));

INSTANTIATE_TEST_SUITE_P(smoke_ShuffleChannels4D,
                         ShuffleChannelsLayerTest,
                         ::testing::Combine(shuffleChannelsParams4D,
...
// ND support tests
INSTANTIATE_TEST_SUITE_P(smoke_ShuffleChannels6D,
                         ShuffleChannelsLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_ShuffleChannels5D,
                         ShuffleChannelsLayerTest,
                         ::testing::Combine(::testing::Values(std::tuple<int, int>(2, 3)),
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
