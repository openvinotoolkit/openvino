...
const auto numpyBroadcastParams1 = ::testing::Combine(::testing::Values(targetShapesNumpy[0]),
...
INSTANTIATE_TEST_SUITE_P(smoke_TestNumpyBroadcast1,
                         BroadcastLayerTest,
                         numpyBroadcastParams1,
                         BroadcastLayerTest::getTestCaseName);

const auto numpyBroadcastParams2 = ::testing::Combine(::testing::Values(targetShapesNumpy[1]),
                                                      ::testing::Values(ngraph::AxisSet{}),  // not used in numpy mode
                                                      ::testing::Values(ngraph::op::BroadcastType::NUMPY),
...
INSTANTIATE_TEST_SUITE_P(smoke_TestNumpyBroadcast2,
                         BroadcastLayerTest,
...
const auto bidirectionalBroadcastParams1 =
    ::testing::Combine(::testing::Values(targetShapesBidi[0]),
...
INSTANTIATE_TEST_SUITE_P(smoke_TestBidirectionalBroadcast1,
                         BroadcastLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_TestBidirectionalBroadcast2,
                         BroadcastLayerTest,
...
const auto explicitBroadcastParams1 = ::testing::Combine(::testing::Values(targetShapesExplicit[0]),
...
INSTANTIATE_TEST_SUITE_P(smoke_TestExplicitBroadcast1,
                         BroadcastLayerTest,
                         explicitBroadcastParams1,
                         BroadcastLayerTest::getTestCaseName);

const auto explicitBroadcastParams2 = ::testing::Combine(::testing::Values(targetShapesExplicit[1]),
...
INSTANTIATE_TEST_SUITE_P(smoke_TestExplicitBroadcast2,
                         BroadcastLayerTest,
