...
const auto conv1DParams_ExplicitPadding = ::testing::Combine(::testing::ValuesIn(kernels1D),
...
INSTANTIATE_TEST_SUITE_P(smoke_Convolution1D_ExplicitPadding,
                         ConvolutionLayerTest,
                         ::testing::Combine(conv1DParams_ExplicitPadding,
...
INSTANTIATE_TEST_SUITE_P(smoke_Convolution1D_AutoPadValid,
                         ConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Convolution2D_ExplicitPadding,
                         ConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Convolution2D_SpecificWeightLayout,
                         ConvolutionLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Convolution3D_AutoPadValid,
                         ConvolutionLayerTest,
