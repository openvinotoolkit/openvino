...
const std::vector<InferenceEngine::Precision> probPrecisions = {InferenceEngine::Precision::FP32,
...
const auto basicCases = ::testing::Combine(::testing::ValuesIn(inputShape),
                                           ::testing::Values(10),
