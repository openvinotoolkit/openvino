...
const auto oneHotParams_IC = testing::Combine(testing::ValuesIn(argDepthType_IC),
...
INSTANTIATE_TEST_SUITE_P(smoke_OneHotIntConst, OneHotLayerTest, oneHotParams_IC, OneHotLayerTest::getTestCaseName);
...
const auto oneHotParams_Ax = testing::Combine(testing::ValuesIn(argDepthType_Ax),
...
INSTANTIATE_TEST_SUITE_P(smoke_OneHotAxrng, OneHotLayerTest, oneHotParams_Ax, OneHotLayerTest::getTestCaseName);
...
const std::vector<ngraph::element::Type> argSetType_T = {ngraph::element::i8,
                                                         ngraph::element::u8,
                                                         ngraph::element::bf16,
                                                         ngraph::element::f32};
...
const auto oneHotParams_T = testing::Combine(testing::ValuesIn(argDepthType_T),
...
INSTANTIATE_TEST_SUITE_P(smoke_OneHotArgType, OneHotLayerTest, oneHotParams_T, OneHotLayerTest::getTestCaseName);
}  // namespace
