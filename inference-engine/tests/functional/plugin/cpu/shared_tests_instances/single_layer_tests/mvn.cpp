...
INSTANTIATE_TEST_CASE_P(smoke_MVN_5D, Mvn6LayerTest,
                        ::testing::Combine(
                            ...
                            ::testing::ValuesIn(std::vector<std::vector<int>>{{1, 2, 3, 4}, {2, 3, 4}, {-3, -2, -1}, {-1, -2, -3, -4}}),
                            ::testing::ValuesIn(normalizeVariance),
...
INSTANTIATE_TEST_CASE_P(smoke_MVN_4D, Mvn6LayerTest,
                        ::testing::Combine(
                            ...
                            ::testing::ValuesIn(dataPrecisions),
                            ::testing::ValuesIn(idxPrecisions),
                            ::testing::ValuesIn(std::vector<std::vector<int>>{{1, 2, 3}, {2, 3}, {-2, -1}, {-1, -2, -3}}),
                            ::testing::ValuesIn(normalizeVariance),
                            ::testing::ValuesIn(epsilonF),
                            ::testing::ValuesIn(epsMode),
                            ::testing::Values(CommonTestUtils::DEVICE_CPU)),
...
INSTANTIATE_TEST_CASE_P(smoke_MVN_1D, Mvn6LayerTest,
                        ::testing::Combine(
...
INSTANTIATE_TEST_CASE_P(smoke_Decomposition_10D, Mvn6LayerTest,
                        ::testing::Combine(
