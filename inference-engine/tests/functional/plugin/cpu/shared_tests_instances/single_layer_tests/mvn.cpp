...
std::vector<InferenceEngine::Precision> dataPrecisions = {InferenceEngine::Precision::FP16,
                                                          InferenceEngine::Precision::FP32};

const auto MvnAcrossChannels = ::testing::Combine(::testing::ValuesIn(inputShapes),
...
INSTANTIATE_TEST_SUITE_P(smoke_MKLDNN_TestsMVN_AcrossChannels,
                         Mvn1LayerTest,
                         MvnAcrossChannels,
                         Mvn1LayerTest::getTestCaseName);

INSTANTIATE_TEST_SUITE_P(smoke_MKLDNN_TestsMVN_ReductionAxes,
                         Mvn1LayerTest,
                         MvnReductionAxes,
                         Mvn1LayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_MVN_2D,
                         Mvn6LayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_MVN_1D,
                         Mvn6LayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_Decomposition_3D,
                         Mvn6LayerTest,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(
        ...
        ::testing::ValuesIn(idxPrecisions),
        ::testing::ValuesIn(
            std::vector<std::vector<int>>{{0, 1, 5, 8, 9}, {0, 1, 2, 3}, {0, 1, 2}, {0, 3}, {0}, {3}, {5}, {9}}),
        ::testing::ValuesIn(normalizeVariance),
        ::testing::ValuesIn(epsilonF),
        ::testing::ValuesIn(epsMode),
        ::testing::Values(CommonTestUtils::DEVICE_CPU)),
