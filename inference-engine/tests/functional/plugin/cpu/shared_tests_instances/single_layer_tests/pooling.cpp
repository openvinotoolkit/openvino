...
const std::vector<std::vector<size_t>> strides = {{1, 1}, {1, 2}, {2, 1}, {2, 2}};
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_SameUpperPad_FloorRounding,
                         PoolingLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_SameLowerPad_FloorRounding,
                         PoolingLayerTest,
                         ::testing::Combine(maxPool_SameUpperPad_FloorRounding_Params,
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_ExplicitPad_FloorRounding_5Dinput,
                         PoolingLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_SameUpperPad_FloorRounding_5Dinput,
                         PoolingLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_MaxPool_SameLowerPad_CeilRounding_5Dinput,
                         PoolingLayerTest,
                         ::testing::Combine(maxPool_SameUpperPad_FloorRounding_5Dinput_Params,
                                            ::testing::ValuesIn(netPrecisions),
                                            ::testing::Values(InferenceEngine::Precision::UNSPECIFIED),
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_ExplicitPad_FloorRounding_5Dinput,
                         PoolingLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_SameUpperPad_FloorRounding_5Dinput,
                         PoolingLayerTest,
...
INSTANTIATE_TEST_SUITE_P(smoke_AvgPool_SameLowerPad_CeilRounding_5Dinput,
                         PoolingLayerTest,
