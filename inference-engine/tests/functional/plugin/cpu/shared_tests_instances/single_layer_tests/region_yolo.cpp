...
const auto testCase_yolov3 = ::testing::Combine(::testing::ValuesIn(inShapes_v3),
...
const auto testCase_yolov3_mxnet = ::testing::Combine(::testing::ValuesIn(inShapes_mxnet),
...
const auto testCase_yolov2_caffe = ::testing::Combine(::testing::ValuesIn(inShapes_caffe),
                                                      ::testing::Values(classes[1]),
                                                      ::testing::Values(coords),
