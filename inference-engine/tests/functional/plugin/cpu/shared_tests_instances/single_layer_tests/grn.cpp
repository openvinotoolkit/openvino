...
const auto basicCases = ::testing::Combine(::testing::ValuesIn(netPrecisions),
...
INSTANTIATE_TEST_CASE_P(smoke_GRN_Basic, GrnLayerTest, basicCases, GrnLayerTest::getTestCaseName);
}  // namespace
