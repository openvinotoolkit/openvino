...
TEST_P(TrivialLoopTest, PassThroughBody) {
    ...
    auto start = std::make_shared<ngraph::op::v0::Parameter>(prc, shape);
    auto count = std::make_shared<ngraph::op::v0::Constant>(ngraph::element::i64, scalarShape, 5);
    ...
    auto b_cond = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::boolean, scalarShape);
