...
std::string MatMulTransformation::getTestCaseName(testing::TestParamInfo<LayerTestsUtils::LayerTransformationParams> obj) {
...
void MatMulTransformation::SetUp() {
    ...
    function = ngraph::builder::subgraph::MatMulFunction::getOriginal(ngPrecision, inputShape);
