...
const std::map<std::string, std::string> config_i8_i8 = {
    {"GNA_DEVICE_MODE", "GNA_SW_EXACT"},
    {"GNA_SCALE_FACTOR_0", "1"},
    {"GNA_PRECISION", "I8"},
    {"GNA_INPUT_PRECISION", "I8"},
};
...
const std::vector<std::pair<std::string, std::map<std::string, std::string>>> configs = {
    ...
    {"sw_exact_i8_i8", config_i8_i8}
};

INSTANTIATE_TEST_CASE_P(smoke_LowPrecision, GnaLowPrecisionTest,
    ::testing::Combine(
