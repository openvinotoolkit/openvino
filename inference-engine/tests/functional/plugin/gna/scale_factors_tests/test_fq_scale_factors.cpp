...
protected:
    void SetUp() override {
        ...
        auto mul = std::make_shared<ngraph::opset7::Multiply>(fqIn, params[0]);
        ...
        auto fqOut = std::make_shared<ngraph::opset7::FakeQuantize>(mul, lowNodeOut, highNodeOut,
...
TEST_P(TestFQScaleFactorsTest, CompareWithRefImpl) {
    ...
    float abs_threshold = 2.5 * inputDataMax * inputDataMax / (levels - 1);
...
INSTANTIATE_TEST_CASE_P(smoke_base, TestFQScaleFactorsTest,
    ::testing::Combine(
