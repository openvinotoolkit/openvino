...
protected:
    void SetUp() override {
        ...
        auto fqIn = std::make_shared<ngraph::opset7::FakeQuantize>(params[0], lowNodeIn, highNodeIn,
        ...
        auto add = std::make_shared<ngraph::opset7::Add>(fqIn, constant);
        ...
        auto fq = std::make_shared<ngraph::opset7::FakeQuantize>(add, lowNode, highNode,
        ...
        auto fqOut = std::make_shared<ngraph::opset7::FakeQuantize>(tanh, lowNodeOut, highNodeOut,
            lowNodeOut, highNodeOut, levels16);

        ngraph::ResultVector results{std::make_shared<ngraph::opset7::Result>(fqOut)};
...
INSTANTIATE_TEST_CASE_P(smoke_base, EltwiseActFqTest,
    ::testing::Combine(
