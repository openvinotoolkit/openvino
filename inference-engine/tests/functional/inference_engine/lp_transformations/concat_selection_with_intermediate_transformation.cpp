...
const std::vector<TestValues> testValues = {
    // U8: MaxPool: precision before convolution is I8/U8: per tensor concatenation
    {
        Shape{ 1, 3, 9, 9 },
        ...
        },
        {
            ...
            { 256ul, ngraph::Shape({}), {0.f}, {2.55f / 2.f}, {0.f}, { 128 }, ngraph::element::u8 },
            { },
            { ngraph::element::f32, {}, {0.01f} }
        }
    },
    // U8: AvgPool: precision before convolution is FP32: multi-channel concatenation
    {
        Shape{ 1, 3, 9, 9 },
        LayerTransformation::createParamsU8I8(),
        false,
