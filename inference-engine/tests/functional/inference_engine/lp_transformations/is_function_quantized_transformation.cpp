...
public:
    void SetUp() override {
        ...
        const auto input = std::make_shared<ngraph::op::v0::Parameter>(testValues.precision, ngraph::Shape(testValues.shape));
        ...
        ngraph::ResultVector results{ std::make_shared<ngraph::op::v0::Result>(fakeQuantize) };
