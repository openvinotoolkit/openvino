...
class ReduceMeanTransformationTestValues {
public:
    class Actual {
    public:
...
typedef std::tuple <
    ngraph::Shape,
    ReduceMeanTransformationTestValues
> ReduceMeanTransformationParams;

class ReduceMeanTransformation : public LayerTransformation, public testing::WithParamInterface<ReduceMeanTransformationParams> {
public:
    void SetUp() override {
        const ngraph::Shape inputShape = std::get<0>(GetParam());
        const ReduceMeanTransformationTestValues& testValues = std::get<1>(GetParam());
    ...
    static std::string getTestCaseName(testing::TestParamInfo<ReduceMeanTransformationParams> obj) {
        ...
        const ReduceMeanTransformationTestValues testValues = std::get<1>(obj.param);
...
const std::vector<ReduceMeanTransformationTestValues> addTransformationTestValues = {
