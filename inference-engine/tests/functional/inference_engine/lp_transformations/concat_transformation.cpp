    ...
    public:
        void SetUp() override {
            ...
            actualFunction = ngraph::builder::subgraph::ConcatFunction::get(
                ...
                {},
                testValues.axis);
            ngraph::pass::VisualizeTree("c:\\Users\\ndemasho\\rep\\Visual\\test.actual").run_on_function(actualFunction);
            ...
            ngraph::pass::VisualizeTree("c:\\Users\\ndemasho\\rep\\Visual\\test.transform").run_on_function(actualFunction);
            ...
            referenceFunction = ngraph::builder::subgraph::ConcatFunction::get(
                ...
                testValues.axis);
            ngraph::pass::VisualizeTree("c:\\Users\\ndemasho\\rep\\Visual\\test.reference").run_on_function(referenceFunction);
        }
