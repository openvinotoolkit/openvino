...
class ReduceMaxTransformationTestValues {
public:
    class Actual {
    public:
...
typedef std::tuple <
    ngraph::Shape,
    ReduceMaxTransformationTestValues
> ReduceMaxTransformationParams;

class ReduceMaxTransformation : public LayerTransformation, public testing::WithParamInterface<ReduceMaxTransformationParams> {
public:
    void SetUp() override {
        const ngraph::Shape inputShape = std::get<0>(GetParam());
        const ReduceMaxTransformationTestValues testValues = std::get<1>(GetParam());
    ...
    static std::string getTestCaseName(testing::TestParamInfo<ReduceMaxTransformationParams> obj) {
        ...
        const ReduceMaxTransformationTestValues testValues = std::get<1>(obj.param);
...
const std::vector<ReduceMaxTransformationTestValues> addTransformationTestValues = {
