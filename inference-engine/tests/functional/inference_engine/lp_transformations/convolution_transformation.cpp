...
const std::vector<ConvolutionTransformationTestValues> testValues = {
    // with zero point
    {
        ...
        // ActualValues
        {
            ...
            {{ngraph::element::Type(ngraph::element::f32)}, { 128.f }, { 0.02f }},
            op::Constant::create(ngraph::element::Type(ngraph::element::f32), ngraph::Shape{}, std::vector<float>{ 2.f }),
            { 255ul, Shape({ 1, 1, 1, 1 }), { 0.f }, { 254.f }, { -1.27f }, { 1.27f } }
        },
        // ExpectedValues
        {
            ngraph::element::Type(ngraph::element::u8),
            {{}, { { 128.f }, ngraph::element::Type(ngraph::element::f32), { 1, 3, 1, 1 }, false }, {}},
            op::Constant::create(ngraph::element::Type(ngraph::element::i8), ngraph::Shape{}, std::vector<float>{ -125.f }),
            {},
            ngraph::element::Type(ngraph::element::f32),
            {{}, {}, {{ 0.0002f }, ngraph::element::Type(ngraph::element::f32), { 1, 1, 1 }}}
        }
    },
    // with zero point
    {
    ...
    // with zero point, not update precisions
    {
        ...
        // ExpectedValues
        {
            ngraph::element::Type(ngraph::element::f32),
            {{}, { { 128.f }, ngraph::element::Type(ngraph::element::f32), { 1, 3, 1, 1 }, false }, {}},
            op::Constant::create(ngraph::element::Type(ngraph::element::f32), ngraph::Shape{}, std::vector<float>{ -125.f }),
            {},
            ngraph::element::Type(ngraph::element::f32),
            {{}, {}, {{ 0.0002f }, ngraph::element::Type(ngraph::element::f32), { 1, 1, 1 }}}
        }
    ...
    // with zero point, per-channel quantization with the same values
    {
        ...
        {
            ngraph::element::Type(ngraph::element::u8),
            {{ngraph::element::Type(ngraph::element::f32)}, { { 128.f }, ngraph::element::Type(ngraph::element::f32), {1, 3, 1, 1} },
                { { 0.02f },  ngraph::element::Type(ngraph::element::f32), {1, 3, 1, 1} }},
            op::Constant::create(ngraph::element::Type(ngraph::element::f32), ngraph::Shape{}, std::vector<float>{ 2.f }),
            { 255ul, Shape({ 1, 1, 1, 1 }), { 0.f }, { 254.f }, { -1.27f }, { 1.27f } }
        },
        // ExpectedValues
    ...
    // with zero point, per-channel quantization with different values
    {
        ...
        // ActualValues
        {
            ...
            {
                {ngraph::element::Type(ngraph::element::f32)},
                {{ 128.f, 0.f, 128.f }, ngraph::element::Type(ngraph::element::f32), { 1, 3, 1, 1 }},
                {{ 0.02f, 0.01f, 0.03f }, ngraph::element::Type(ngraph::element::f32), {1, 3, 1, 1}}
            },
            op::Constant::create(ngraph::element::Type(ngraph::element::f32), ngraph::Shape{}, std::vector<float>{ 2.f }),
            { 255ul, Shape({ 1, 1, 1, 1 }), { 0.f }, { 254.f }, { -1.27f }, { 1.27f } }
        },
    ...
    // dequantization in second dimension
    {
        ...
        // ActualValues
        {
            ...
            {
                {ngraph::element::Type(ngraph::element::f32)},
                {{ 128.f }, ngraph::element::Type(ngraph::element::f32), { 1, 1, 1, 1 }},
                {{ 0.02f }, ngraph::element::Type(ngraph::element::f32), {1, 1, 1, 1}}
            },
            op::Constant::create(ngraph::element::Type(ngraph::element::f32), ngraph::Shape{}, std::vector<float>{ 2.f }),
            { 255ul, Shape({ 1, 1, 1, 1 }), { 0.f }, { 254.f }, { -1.27f }, { 1.27f } }
        },
