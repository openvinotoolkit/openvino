...
class MultiplyAddTransformation : public LayerTransformation, public testing::WithParamInterface<LayerTransformationParams> {
public:
    void SetUp() override {
...
TEST_P(MultiplyAddTransformation, CompareFunctions) {
