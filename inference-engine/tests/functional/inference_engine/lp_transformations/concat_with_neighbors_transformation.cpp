...
const std::vector<ConcatTransformationTestValues> testValues = {
    // U8: concat
    {
        ...
        },
        {
            ...
            { 256ul, ngraph::Shape({}), {0.f}, {2.55f}, {0.f}, {128.f}, ngraph::element::Type(ngraph::element::u8) },
            { 256ul, ngraph::Shape({}), {0.f}, {2.55f}, {0.f}, {85.f}, ngraph::element::Type(ngraph::element::u8) },
    ...
    // U8: concat multi channels
    {
        ...
        },
        {
            ...
            { ngraph::element::Type(ngraph::element::f32), {}, {{ 0.005f, 0.005f, 0.005f, 0.00333f, 0.00333f, 0.00333f }} }
        }
    },
    // U8: concat multi channels with subtract
    {
        ...
        },
        {
            ...
            { 256ul, ngraph::Shape({}), {1.275f}, {2.55f}, {0.f}, {255.f}, ngraph::element::Type(ngraph::element::u8) },
            { ngraph::element::Type(ngraph::element::f32), {{ 0.f, 0.f, 0.f, -255.f, -255.f, -255.f }}, {{ 0.01f, 0.01f, 0.01f, 0.005f, 0.005f, 0.005f }} },
    ...
    // I8: concat
    {
        ...
        },
        {
            ...
            { 256ul, ngraph::Shape({}), {-1.28f / 2.f}, {1.27f / 2.f}, {-64}, {64.f}, ngraph::element::Type(ngraph::element::i8) },
            { 256ul, ngraph::Shape({}), {-1.28f / 3.f}, {1.27f / 3.f}, {-43}, {42.f}, ngraph::element::Type(ngraph::element::i8) },
            { ngraph::element::Type(ngraph::element::f32), {}, { 0.01f } },
            { ngraph::element::Type(ngraph::element::f32), {}, { 0.01f } }
        }
    },
    // I8: concat multi channels
    {
        ...
        },
        {
            ...
            { 256ul, ngraph::Shape({}), {-1.28f / 3.f}, {1.27f / 3.f}, {-128.f}, {127.f}, ngraph::element::Type(ngraph::element::i8) },
            { ngraph::element::Type(ngraph::element::f32), {}, {{ 0.01f, 0.01f, 0.01f, 0.005f, 0.005f, 0.005f }} },
            { ngraph::element::Type(ngraph::element::f32), {}, {{ 0.005f, 0.005f, 0.005f, 0.00333f, 0.00333f, 0.00333f }} }
        }
    },
    // mixed: U8 + I8: concat multi channels
    {
        ...
        {
            { 256ul, ngraph::Shape({}), {0.f}, {2.55f}, {0.f}, {255.f}, ngraph::element::Type(ngraph::element::u8) },
            { 256ul, ngraph::Shape({}), {-1.28f}, {1.27f}, {0.f}, {255.f}, ngraph::element::Type(ngraph::element::u8) },
            { 256ul, ngraph::Shape({}), {-1.28f}, {1.27f}, {0.f}, {255.f}, ngraph::element::Type(ngraph::element::u8) },
            { ngraph::element::Type(ngraph::element::f32), {{ 0.f, 0.f, 0.f, 128.f, 128.f, 128.f }}, { 0.01f } },
            { ngraph::element::Type(ngraph::element::f32), { 128.f }, { 0.01f } }
        }
    },
};
