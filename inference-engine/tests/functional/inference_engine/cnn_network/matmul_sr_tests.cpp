...
public:
    void SetUp() override {
        ...
        const auto & out_shape = externalOutputsData.begin()->second->getDims();
        ASSERT_EQ(out_shape, test_case.ref_shape);
    }
};

class CNNNGraphImplSmartReshapeAnyInputTests : public CommonTestUtils::TestsCommon, public testing::WithParamInterface<std::tuple<ReshapeMatMulTestCase>> {
public:
    void SetUp() override {
        const auto& parameters = GetParam();
        const auto& test_case = std::get<0>(GetParam());
...
TEST_P(CNNNGraphImplSmartReshapeAnyInputTests, ReshapeMatMulAnyInput) {
}

INSTANTIATE_TEST_CASE_P(NGraph, SmartReshapeMatMulTests, testing::Values(
        ReshapeMatMulTestCase{true, {1, 20, 30}, {30, 40}, {20, -1}, false, false, {{"input_A", {2, 20, 30}}}, {40, 40}},
        ReshapeMatMulTestCase{true, {1, 20, 30}, {40, 30}, {20, -1}, false, true, {{"input_A", {2, 20, 30}}}, {40, 40}},
        ReshapeMatMulTestCase{true, {1, 30, 20}, {30, 20}, {-1, 20}, true, false, {{"input_A", {2, 30, 20}}}, {40, 20}},
        ReshapeMatMulTestCase{true, {1, 30, 20}, {40, 30}, {-1, 20}, true, true, {{"input_A", {2, 30, 20}}}, {40, 40}},
        ReshapeMatMulTestCase{false, {20, 30}, {1, 30, 40}, {-1, 40}, false, false, {{"input_B", {2, 30, 40}}}, {20, 80}},
        ReshapeMatMulTestCase{false, {20, 30}, {1, 40, 30}, {40, -1}, false, true, {{"input_B", {2, 40, 30}}}, {20, 80}},
        ReshapeMatMulTestCase{false, {30, 20}, {1, 30, 40}, {-1, 40}, true, false, {{"input_B", {2, 30, 40}}}, {20, 80}},
        ReshapeMatMulTestCase{false, {30, 20}, {1, 40, 30}, {40, -1}, true, true, {{"input_B", {2, 40, 30}}}, {20, 80}},
        ReshapeMatMulTestCase{true, {1, 2, 60, 20}, {1, 20, 30}, {2, 60, 20}, false, false, {{"input_A", {2, 2, 60, 20}}}, {4, 60, 30}},
        ReshapeMatMulTestCase{true, {1, 2, 60, 20}, {1, 30, 20}, {2, 60, 20}, false, true, {{"input_A", {2, 2, 60, 20}}}, {4, 60, 30}},
        ReshapeMatMulTestCase{true, {1, 2, 20, 60}, {1, 20, 30}, {2, 20, 60}, true, false, {{"input_A", {2, 2, 20, 60}}}, {4, 60, 30}},
        ReshapeMatMulTestCase{true, {1, 2, 20, 60}, {1, 30, 20}, {2, 20, 60}, true, true, {{"input_A", {2, 2, 20, 60}}}, {4, 60, 30}},
        ReshapeMatMulTestCase{false, {1, 30, 20}, {1, 2, 20, 60}, {2, 20, 60}, false, false, {{"input_B", {2, 2, 20, 60}}}, {4, 30, 60}},
        ReshapeMatMulTestCase{false, {1, 30, 20}, {1, 2, 60, 20}, {2, 60, 20}, false, true, {{"input_B", {2, 2, 60, 20}}}, {4, 30, 60}},
        ReshapeMatMulTestCase{false, {1, 20, 30}, {1, 2, 20, 60}, {2, 20, 60}, true, false, {{"input_B", {2, 2, 20, 60}}}, {4, 30, 60}},
        ReshapeMatMulTestCase{false, {1, 20, 30}, {1, 2, 60, 20}, {2, 60, 20}, true, true, {{"input_B", {2, 2, 60, 20}}}, {4, 30, 60}},
        ReshapeMatMulTestCase{true, {1, 5, 2, 60, 20}, {1, 2, 20, 30}, {5, 2, 60, 20}, false, false, {{"input_A", {2, 5, 2, 60, 20}}}, {10, 2, 60, 30}},
        ReshapeMatMulTestCase{true, {1, 5, 2, 60, 20}, {1, 2, 30, 20}, {5, 2, 60, 20}, false, true, {{"input_A", {2, 5, 2, 60, 20}}}, {10, 2, 60, 30}},
        ReshapeMatMulTestCase{true, {1, 5, 2, 20, 60}, {1, 2, 20, 30}, {5, 2, 20, 60}, true, false, {{"input_A", {2, 5, 2, 20, 60}}}, {10, 2, 60, 30}},
        ReshapeMatMulTestCase{true, {1, 5, 2, 20, 60}, {1, 2, 30, 20}, {5, 2, 20, 60}, true, true, {{"input_A", {2, 5, 2, 20, 60}}}, {10, 2, 60, 30}},
        ReshapeMatMulTestCase{false, {1, 2, 30, 20}, {1, 5, 2, 20, 60}, {5, 2, 20, 60}, false, false, {{"input_B", {2, 5, 2, 20, 60}}}, {10, 2, 30, 60}},
        ReshapeMatMulTestCase{false, {1, 2, 30, 20}, {1, 5, 2, 60, 20}, {5, 2, 60, 20}, false, true, {{"input_B", {2, 5, 2, 60, 20}}}, {10, 2, 30, 60}},
        ReshapeMatMulTestCase{false, {1, 2, 20, 30}, {1, 5, 2, 20, 60}, {5, 2, 20, 60}, true, false, {{"input_B", {2, 5, 2, 20, 60}}}, {10, 2, 30, 60}},
        ReshapeMatMulTestCase{false, {1, 2, 20, 30}, {1, 5, 2, 60, 20}, {5, 2, 60, 20}, true, true, {{"input_B", {2, 5, 2, 60, 20}}}, {10, 2, 30, 60}}));

INSTANTIATE_TEST_CASE_P(NGraph, CNNNGraphImplSmartReshapeAnyInputTests, testing::Values(
        ReshapeMatMulTestCase{true, {1, 20, 30}, {30, 40}, {20, -1}, false, false, {{"input_A", {2, 20, 30}}}, {40, 40}},
        ReshapeMatMulTestCase{true, {1, 20, 30}, {40, 30}, {20, -1}, false, true, {{"input_A", {2, 20, 30}}}, {40, 40}},
        ReshapeMatMulTestCase{true, {1, 30, 20}, {30, 20}, {-1, 20}, true, false, {{"input_A", {2, 30, 20}}}, {40, 20}},
        ReshapeMatMulTestCase{true, {1, 30, 20}, {40, 30}, {-1, 20}, true, true, {{"input_A", {2, 30, 20}}}, {40, 40}},
