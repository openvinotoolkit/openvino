...
INSTANTIATE_TEST_CASE_P(NGraph, CNNNGraphImplSmartReshapeTests, testing::Values(
        ...
        ReshapeMatMulTestCase{false, {1, 30, 20}, {1, 2, 20, 60}, {2, -1, 60}, false, false, {{"input_B", {2, 2, 20, 60}}}},
        ReshapeMatMulTestCase{false, {1, 30, 20}, {1, 2, 60, 20}, {2, 60, -1}, false, true, {{"input_B", {2, 2, 60, 20}}}},
        ReshapeMatMulTestCase{false, {1, 20, 30}, {1, 2, 20, 60}, {2, -1, 60}, true, false, {{"input_B", {2, 2, 20, 60}}}},
        ReshapeMatMulTestCase{false, {1, 20, 30}, {1, 2, 60, 20}, {2, 60, -1}, true, true, {{"input_B", {2, 2, 60, 20}}}},
        ...
        ReshapeMatMulTestCase{false, {1, 2, 30, 20}, {1, 5, 2, 20, 60}, {5, 2, -1, 60}, false, false, {{"input_B", {2, 5, 2, 20, 60}}}},
        ReshapeMatMulTestCase{false, {1, 2, 30, 20}, {1, 5, 2, 60, 20}, {5, 2, 60, -1}, false, true, {{"input_B", {2, 5, 2, 60, 20}}}},
        ReshapeMatMulTestCase{false, {1, 2, 20, 30}, {1, 5, 2, 20, 60}, {5, 2, -1, 60}, true, false, {{"input_B", {2, 5, 2, 20, 60}}}},
        ReshapeMatMulTestCase{false, {1, 2, 20, 30}, {1, 5, 2, 60, 20}, {5, 2, 60, -1}, true, true, {{"input_B", {2, 5, 2, 60, 20}}}}));
}  // namespace