...
TEST(TransformationTests, AssignRegisters) {
    ...
    {
        auto p0 = std::make_shared<op::v0::Parameter>(element::f32, Shape(1));
        auto p1 = std::make_shared<op::v0::Parameter>(element::f32, Shape(1));
        ...
        auto y02 = std::make_shared<op::v1::Multiply>(y00, y01); y02->set_friendly_name("y02");
...
TEST(TransformationTests, AssignRegisters2) {
    std::shared_ptr<Function> f(nullptr);
    {
        auto p0 = std::make_shared<op::v0::Parameter>(ngraph::element::f32, Shape());
        auto p1 = std::make_shared<op::v0::Parameter>(ngraph::element::f32, Shape());
        auto p2 = std::make_shared<op::v0::Parameter>(ngraph::element::f32, Shape());
        auto p3 = std::make_shared<op::v0::Parameter>(ngraph::element::f32, Shape());
        auto p4 = std::make_shared<op::v0::Parameter>(ngraph::element::f32, Shape());
        auto p5 = std::make_shared<op::v0::Parameter>(ngraph::element::f32, Shape());
        auto p6 = std::make_shared<op::v0::Parameter>(ngraph::element::f32, Shape());
        auto p7 = std::make_shared<op::v0::Parameter>(ngraph::element::f32, Shape());
        ...
        auto y02 = std::make_shared<op::v1::Multiply>(y00, c0); y02->set_friendly_name("r04");
        auto y03 = std::make_shared<op::v1::Multiply>(y01, c1); y03->set_friendly_name("r05");
        ...
        auto y06 = std::make_shared<op::v1::Add>(y02, y03); y06->set_friendly_name("r08");
        auto y07 = std::make_shared<op::v1::Multiply>(y04, c0); y07->set_friendly_name("r09");
        auto y08 = std::make_shared<op::v1::Multiply>(y05, c1); y08->set_friendly_name("r10");
        ...
        auto y11 = std::make_shared<op::v1::Add>(y07, y08); y11->set_friendly_name("r13");
        auto y12 = std::make_shared<op::v1::Multiply>(y09, c0); y12->set_friendly_name("r14");
        auto y13 = std::make_shared<op::v1::Multiply>(y10, c1); y13->set_friendly_name("r15");
        auto y14 = std::make_shared<snippets::isa::Load>(p6); y14->set_friendly_name("r16");
        auto y15 = std::make_shared<op::v1::Add>(y12, y13); y15->set_friendly_name("r17");
        auto y16 = std::make_shared<snippets::isa::Load>(p7); y16->set_friendly_name("r18");
        auto y17 = std::make_shared<op::v1::Multiply>(y14, c0); y17->set_friendly_name("r19");
        auto y18 = std::make_shared<op::v1::Multiply>(y16, c1); y18->set_friendly_name("r20");
        auto y19 = std::make_shared<op::v1::Add>(y06, y11); y19->set_friendly_name("r21");
        auto y20 = std::make_shared<op::v1::Add>(y17, y18); y20->set_friendly_name("r22");
        auto y21 = std::make_shared<op::v1::Add>(y15, y19); y21->set_friendly_name("r23");
        auto y22 = std::make_shared<op::v1::Add>(y20, y21); y22->set_friendly_name("r24");
