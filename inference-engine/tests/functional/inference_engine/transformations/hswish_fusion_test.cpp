...
TEST(TransformationTests, HSwishFusionWithReluDivF16) {
    ...
    {
        auto input = std::make_shared<ngraph::opset5::Parameter>(ngraph::element::f16, ngraph::PartialShape::dynamic(1));
        auto add_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {3.0});
        auto add = std::make_shared<ngraph::opset5::Add>(input, add_constant);
        auto relu = std::make_shared<ngraph::opset5::Relu>(add);
        auto min_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {6.0});
        ...
        auto div_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {6.0});
    ...
    {
        auto input = std::make_shared<ngraph::opset5::Parameter>(ngraph::element::f16, ngraph::PartialShape::dynamic(1));
        auto hswish = std::make_shared<ngraph::opset5::HSwish>(input);
...
TEST(TransformationTests, HSwishFusionWithReluDivF32) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        auto input = std::make_shared<ngraph::opset5::Parameter>(ngraph::element::f32, ngraph::Shape{});
        ...
        auto min = std::make_shared<ngraph::opset5::Minimum>(relu, min_constant);
        auto mul = std::make_shared<ngraph::opset5::Multiply>(input, min);
        auto div_constant = ngraph::opset5::Constant::create(ngraph::element::f32, ngraph::Shape{}, {6.0});
        auto div = std::make_shared<ngraph::opset5::Divide>(mul, div_constant);
...
TEST(TransformationTests, HSwishFusionWithReluMul) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto mul_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {0.1666666716});
...
TEST(TransformationTests, HSwishFusionWithoutRelu) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto add_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {3.0});
        auto add = std::make_shared<ngraph::opset5::Add>(input, add_constant);
        auto max_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {0.0});
...
TEST(TransformationTests, HSwishFusionWithClamp) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto mul_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {1.0 / 6.0});
...
TEST(TransformationTests, HSwishFusionWithReluMulWrongConstValue) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto min = std::make_shared<ngraph::opset5::Minimum>(relu, min_constant);
        auto mul_first = std::make_shared<ngraph::opset5::Multiply>(input, min);
        auto mul_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {0.167});
        auto mul_second = std::make_shared<ngraph::opset5::Multiply>(mul_first, mul_constant);
...
TEST(TransformationTests, HSwishFusionWithReluDivWrongConstValue) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        auto input = std::make_shared<ngraph::opset5::Parameter>(ngraph::element::f16, ngraph::Shape{});
        auto add_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {3.01});
        auto add = std::make_shared<ngraph::opset5::Add>(input, add_constant);
        auto relu = std::make_shared<ngraph::opset5::Relu>(add);
        auto min_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {6.002});
        auto min = std::make_shared<ngraph::opset5::Minimum>(relu, min_constant);
        auto mul = std::make_shared<ngraph::opset5::Multiply>(input, min);
        auto div_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {0.0});
        auto div = std::make_shared<ngraph::opset5::Divide>(mul, div_constant);
...
TEST(TransformationTests, HSwishFusionWithoutReluWrongConstValue) {
    ...
    {
        auto input = std::make_shared<ngraph::opset5::Parameter>(ngraph::element::f16, ngraph::PartialShape::dynamic(1));
        auto add_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {3.11});
        auto add = std::make_shared<ngraph::opset5::Add>(input, add_constant);
        auto max_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {0.22});
        auto max = std::make_shared<ngraph::opset5::Maximum>(add, max_constant);
        auto min_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {6.01});
        auto min = std::make_shared<ngraph::opset5::Minimum>(max, min_constant);
        auto div_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {6.002});
        auto div = std::make_shared<ngraph::opset5::Divide>(min, div_constant);
        auto mul = std::make_shared<ngraph::opset5::Multiply>(input, div);
...
TEST(TransformationTests, HSwishFusionWithClampWrongConstValue) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto mul_constant = ngraph::opset5::Constant::create(ngraph::element::f16, ngraph::Shape{}, {0.98 / 6.15});
        auto mul_first = std::make_shared<ngraph::opset5::Multiply>(clamp, mul_constant);
        auto mul_second = std::make_shared<ngraph::opset5::Multiply>(input, mul_first);
...
TEST(TransformationTests, HSwishFusionWithHSigmoidMul) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto mul = std::make_shared<ngraph::opset5::Multiply>(input, hsigmoid);
