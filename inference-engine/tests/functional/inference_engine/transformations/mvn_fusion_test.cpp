...
TEST(TransformationTests, MVNFusionTestOutside) {
    ...
    {
        auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f32, ngraph::Shape{ 1, 3, 224, 224 });
        auto mean1_axes = ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{ 3 }, { 1, 2, 3 });
        ...
        auto mean2_axes = ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{ 3 }, { 1, 2, 3 });
        ...
        auto const_2 = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { 2 });
        auto power_sqr = std::make_shared<ngraph::opset6::Power>(sub2, const_2);
        auto mean3_axes = ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{ 3 }, { 1, 2, 3 });
        auto mean3 = std::make_shared<ngraph::opset6::ReduceMean>(power_sqr, mean3_axes);
        auto const_0_5 = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { 0.5 });
        auto power_sqrt = std::make_shared<ngraph::opset6::Power>(mean3, const_0_5);
        auto eps = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { 1e-9 });
        auto add_eps = std::make_shared<ngraph::op::v1::Add>(power_sqrt, eps);
        auto const_neg_1 = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { -1 });
        auto power_div = std::make_shared<ngraph::opset6::Power>(add_eps, const_neg_1);
        auto div = std::make_shared<ngraph::op::v1::Multiply>(sub1, power_div);
    ...
    {
        auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f32, ngraph::Shape{ 1, 3, 224, 224 });
        auto axes = ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{ 3 }, { 1, 2, 3 });
        auto mvn = std::make_shared<ngraph::op::v6::MVN>(input, axes, true, 1e-9, ngraph::op::MVNEpsMode::OUTSIDE_SQRT);
...
TEST(TransformationTests, MVNFusionTestInsideSqrt) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto mean3 = std::make_shared<ngraph::opset6::ReduceMean>(power_sqr, mean3_axes);
        auto eps = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { 1e-9 });
        auto add_eps = std::make_shared<ngraph::op::v1::Add>(mean3, eps);
        auto const_0_5 = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { 0.5 });
...

    {
        auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f32, ngraph::Shape{ 1, 3, 224, 224 });
        auto axes = ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{ 3 }, { 1, 2, 3 });
        auto mvn = std::make_shared<ngraph::op::v6::MVN>(input, axes, true, 1e-9, ngraph::op::MVNEpsMode::INSIDE_SQRT);
...
TEST(TransformationTests, MVNFusionTestWithParametersInside) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f32, ngraph::Shape{ 1, 3, 224 });
        auto mean1_axes = ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{ 1 }, { 2 });
        ...
        auto mean2_axes = ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{ 1 }, { 2 });
        auto mean2 = std::make_shared<ngraph::opset6::ReduceMean>(squared_difference, mean2_axes, true);
        auto eps = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { 1e-9 });
        auto add_eps = std::make_shared<ngraph::op::v1::Add>(mean2, eps);
        auto const_0_5 = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { -0.5 });
        auto power_sqrt = std::make_shared<ngraph::opset6::Power>(add_eps, const_0_5);
        auto gamma = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { 1 });
        auto mul_gamma = std::make_shared<ngraph::op::v1::Multiply>(power_sqrt, gamma);
        auto mul1 = std::make_shared<ngraph::op::v1::Multiply>(input, mul_gamma);
        auto mul2 = std::make_shared<ngraph::op::v1::Multiply>(mul_gamma, mean1);
        auto beta = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { -1 });
        auto sub = std::make_shared<ngraph::opset6::Subtract>(beta, mul2);
        auto add = std::make_shared<ngraph::op::v1::Add>(mul1, sub);
    ...
    {
        auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f32, ngraph::Shape{ 1, 3, 224 });
        auto axes = ngraph::op::v0::Constant::create(ngraph::element::i32, ngraph::Shape{ 1 }, { 2 });
        auto mvn = std::make_shared<ngraph::op::v6::MVN>(input, axes, true, 1e-9, ngraph::op::MVNEpsMode::INSIDE_SQRT);
        auto gamma = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { 1 });
        auto mul_gamma = std::make_shared<ngraph::op::v1::Multiply>(mvn, gamma);
        auto beta = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, { -1 });
        auto add = std::make_shared<ngraph::op::v1::Add>(mul_gamma, beta);
