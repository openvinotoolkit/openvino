...
TEST(TransformationTests, HasConstantValueHelper) {
    auto float32_scalar = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, {1.234f});
    ...
    auto float32_1D = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {1.234f});
    ASSERT_TRUE(ngraph::op::util::has_constant_value<float>(float32_scalar, 1.234f));

    auto int64_scalar = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{}, {12});
    ASSERT_TRUE(ngraph::op::util::has_constant_value<int64_t>(int64_scalar, 12));

    auto bool_scalar = ngraph::op::v0::Constant::create(ngraph::element::boolean, ngraph::Shape{}, {true});
    ...
    auto float32_2D = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{2}, {1.2f, 3.4f});
    ASSERT_FALSE(ngraph::op::util::has_constant_value<float>(float32_2D, 1.2f));

    float32_scalar = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{}, {1.234f});
    ASSERT_FALSE(ngraph::op::util::has_constant_value<float>(float32_scalar, 1.235f));

    float32_1D = ngraph::op::v0::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {1.234f});
    ASSERT_FALSE(ngraph::op::util::has_constant_value<float>(float32_scalar, 1.235f));

    int64_scalar = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{}, {12});
