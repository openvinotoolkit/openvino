...
TEST(TransformationTests, ConvertNMS5ToNMSIEStaticSixInputs) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto soft_nms_sigma = ngraph::op::v0::Constant::create(element::f32, Shape{}, {0.25});
        auto nms = std::make_shared<op::v5::NonMaxSuppression>(boxes, scores, max_output_boxes_per_class, iou_threshold, score_threshold,
                                                               soft_nms_sigma, op::v5::NonMaxSuppression::BoxEncodingType::CORNER, true, element::i32);
...

    {
        ...
        auto new_max_per_class = std::make_shared<op::v1::Reshape>(max_output_boxes_per_class,
                                                                   op::v0::Constant::create(ngraph::element::i64, one_dim_shape,
                                                                                            one_dim_shape), true);
        auto new_iou_threshold = std::make_shared<op::v1::Reshape>(iou_threshold,
                                                                   op::v0::Constant::create(ngraph::element::i64, one_dim_shape,
                                                                                            one_dim_shape), true);
        auto new_score_threshold = std::make_shared<op::v1::Reshape>(score_threshold,
                                                                     op::v0::Constant::create(ngraph::element::i64, one_dim_shape,
                                                                                              one_dim_shape), true);
        auto new_soft_nms_sigma = std::make_shared<op::v1::Reshape>(soft_nms_sigma,
                                                                    op::v0::Constant::create(ngraph::element::i64, one_dim_shape,
                                                                                             one_dim_shape), true);
...
TEST(TransformationTests, ConvertNMS5ToNMSIEStaticFiveInputs) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto score_threshold = op::v0::Constant::create(element::f32, Shape{}, {0.7});
        auto nms = std::make_shared<op::v5::NonMaxSuppression>(boxes, scores, max_output_boxes_per_class, iou_threshold, score_threshold,
                                                               op::v5::NonMaxSuppression::BoxEncodingType::CORNER, true, element::i32);
...
TEST(TransformationTests, ConvertNMS5ToNMSIEStaticFourInputs) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto max_output_boxes_per_class = op::v0::Constant::create(element::i64, Shape{}, {10});
        auto iou_threshold = op::v0::Constant::create(element::f32, Shape{}, {0.75});
        auto nms = std::make_shared<op::v5::NonMaxSuppression>(boxes, scores, max_output_boxes_per_class, iou_threshold,
                                                               op::v5::NonMaxSuppression::BoxEncodingType::CORNER, true, element::i32);
...
TEST(TransformationTests, ConvertNMS5ToNMSIEStaticThreeInputs) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto scores = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 1, 1000});
        auto max_output_boxes_per_class = op::v0::Constant::create(element::i64, Shape{}, {10});
        auto nms = std::make_shared<op::v5::NonMaxSuppression>(boxes, scores, max_output_boxes_per_class,
                                                               op::v5::NonMaxSuppression::BoxEncodingType::CORNER, true, element::i32);
...
TEST(TransformationTests, ConvertNMS5ToNMSIEStaticTwoInputs) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        auto boxes = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 1000, 4});
        auto scores = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 1, 1000});
        auto nms = std::make_shared<op::v5::NonMaxSuppression>(boxes, scores,
                                                               op::v5::NonMaxSuppression::BoxEncodingType::CORNER, true, element::i32);
...

    {
        auto boxes = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 1000, 4});
        auto scores = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 1, 1000});
        auto max_output_boxes_per_class = op::v0::Constant::create(element::i32, Shape{}, {0});
        auto iou_threshold = op::v0::Constant::create(element::f32, Shape{}, {0.0f});
        auto score_threshold = op::v0::Constant::create(element::f32, Shape{}, {0.0f});
...
TEST(TransformationTests, ConvertNMS5ToNMSIEDynamic2TwoInputs) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto scores = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{DYN, 1, 1000});
        auto nms = std::make_shared<op::v5::NonMaxSuppression>(boxes, scores,
                                                               op::v5::NonMaxSuppression::BoxEncodingType::CORNER, true);
...

    {
        ...
        auto convert_0 = std::make_shared<op::v0::Convert>(nms->output(0), element::i64);
