...
TEST(TransformationTests, ConvertMulticlassNmsToMulticlassNmsIEInternal) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto nms = std::make_shared<opset7::MulticlassNms>(boxes, scores, max_output_boxes_per_class,
                iou_threshold, score_threshold, soft_nms_sigma, opset7::MulticlassNms::BoxEncodingType::CORNER, true, element::i32);
...

    {
        ...
        auto nms = std::make_shared<op::internal::MulticlassNmsIEInternal>(boxes, scores, max_output_boxes_per_class,
