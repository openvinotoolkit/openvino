...
struct AttentionBlockHorizontalFusingTestValues {
...
typedef std::tuple <
    AttentionBlockHorizontalFusingTestValues,
    bool, // add fq
    bool, // add reshape
    bool, // add transpose
    bool, // add sub
    bool  // add mul
> AttentionBlockHorizontalFusingParams;
...
class AttentionBlockHorizontalFusing : public ::testing::Test, public testing::WithParamInterface<AttentionBlockHorizontalFusingParams> {
public:
    void SetUp() override {
        ...
        manager.register_pass<pass::HorizontalFusings>();
    ...
    static std::string getTestCaseName(testing::TestParamInfo<AttentionBlockHorizontalFusingParams> obj) {
...
TEST_P(AttentionBlockHorizontalFusing, CompareFunctions) {
...
const std::vector<AttentionBlockHorizontalFusingTestValues> test_values {
    {
...
INSTANTIATE_TEST_SUITE_P(
    TransformationTests,
    AttentionBlockHorizontalFusing,
    ::testing::Combine(
        ...
        ::testing::Values(false),
        ::testing::Values(false)),
    AttentionBlockHorizontalFusing::getTestCaseName);
} // namespace positive_cases
