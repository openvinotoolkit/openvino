...
TEST(TransformationTests, RandomUniformMaxValFusing) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto min_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {0.0});
        auto max_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {1.0});
        ...
        auto mul_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {30.0});
...

    {
        ...
        auto ru =
            std::make_shared<ngraph::opset8::RandomUniform>(input, min_const, mul, ngraph::element::f32, 100, 200);
...
TEST(TransformationTests, RandomUniformMinValFusing) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        auto input = std::make_shared<ngraph::opset8::Parameter>(ngraph::element::i32, ngraph::Shape{3});
        auto min_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {0.0});
        auto max_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {30.0});
        auto ru = std::make_shared<ngraph::opset8::RandomUniform>(input,
                                                                  min_const,
                                                                  max_const,
                                                                  ngraph::element::f32,
        ...
        auto add_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {-10.0});
    ...
    {
        auto input = std::make_shared<ngraph::opset8::Parameter>(ngraph::element::i32, ngraph::Shape{3});
        auto ru_max_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {30.0});
        auto ru_min_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {0.0});
        auto add2_const = ngraph::opset8::Constant::create(ngraph::element::f32, ngraph::Shape{1}, {-10.0});
...
TEST(TransformationTests, RandomUniformWithConvertMaxValFusing) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto mul_const = ngraph::opset8::Constant::create(ngraph::element::f16, ngraph::Shape{1}, {30.0});
...
TEST(TransformationTests, RandomUniformWithConvertMinValFusing) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto add_const = ngraph::opset8::Constant::create(ngraph::element::f16, ngraph::Shape{1}, {-10.0});
