...
TEST(TransformationTests, LowLatency_v2LSTM) {
...
TEST(TransformationTests, LowLatency_v2GRU) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        auto X = std::make_shared<Parameter>(element::f32, Shape{1, 1, 16});
...
TEST(TransformationTests, LowLatency_v2RNN) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        auto X = std::make_shared<Parameter>(element::f32, Shape{1, 1, 16});
        auto Y = std::make_shared<Parameter>(element::f32, Shape{1, 128});
...
TEST(TransformationTests, LowLatency_v2LSTMReshape) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
...
TEST(TransformationTests, LowLatency_v2LSTM_Loop) {
    std::shared_ptr<Function> f(nullptr), f_ref(nullptr);
    {
        auto X = std::make_shared<Parameter>(element::f32, Shape{1, 1, 16});
        auto H_init = std::make_shared<Parameter>(element::f32, Shape{1, 128});
