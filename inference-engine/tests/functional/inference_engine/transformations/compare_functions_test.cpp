...
TEST(TransformationTests, CompareFunctoinsTIPositive) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        // Body
        auto reshape_pattern = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{2}, {1, 16});
        ...
        auto reshape_pattern_2 = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{3}, {1, 1, 128});
...
TEST(TransformationTests, ReorgYoloNegativeDifferentMax) {
    const auto createReorgYoloFunc = [](const Strides& stride) {
        ...
        return std::make_shared<ngraph::Function>(
            std::make_shared<ngraph::op::v0::Result>(reorg_yolo), ngraph::ParameterVector{param});
    };
