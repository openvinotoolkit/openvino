...
TEST(TransformationTests, ConvertPrecision_TopK) {
    std::shared_ptr<Function> f(nullptr);
    {
        auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f16, ngraph::Shape{15, 20, 3});
...
TEST(TransformationTests, ConvertPrecision_Bucketize) {
    std::shared_ptr<Function> f(nullptr);
    {
        auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f16, ngraph::Shape{20});
...
TEST(TransformationTests, ConvertPrecision_Roundings) {
    std::shared_ptr<Function> f(nullptr);
    {
        ...
        auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f16, ngraph::Shape{5, 5, 5, 5});
        auto begin = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4}, {0, 0, 0, 0});
        auto end = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4}, {max_int64, max_int64, max_int64, max_int64});
        ...
        auto ss = std::make_shared<ngraph::op::v1::StridedSlice>(input, begin, end, stride, begin_mask, end_mask);
        ...
        auto casted_end = std::dynamic_pointer_cast<op::v0::Constant>(ss->input_value(2).get_node_shared_ptr());
...
TEST(TransformationTests, ConvertPrecision_TIBody) {
    std::shared_ptr<ngraph::Function> f(nullptr), f_ref(nullptr);
    {
        ...
        auto W = ngraph::op::v0::Constant::create(ngraph::element::f16, ngraph::Shape{384, 16}, w_val);
        auto R = ngraph::op::v0::Constant::create(ngraph::element::f16, ngraph::Shape{384, 128}, r_val);
        auto B = ngraph::op::v0::Constant::create(ngraph::element::f16, ngraph::Shape{384}, b_val);
...
TEST(TransformationTests, ConvertPrecision_Equal) {
    std::shared_ptr<Function> f(nullptr);
    {
        auto input1 = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f16, ngraph::Shape{15, 20, 3});
        auto input2 = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f16, ngraph::Shape{15, 20, 3});
...
TEST(TransformationTests, ConvertPrecision_LogicalAnd) {
    std::shared_ptr<Function> f(nullptr);
    {
        auto input1 = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::boolean, ngraph::Shape{15, 20, 3});
        auto input2 = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::boolean, ngraph::Shape{15, 20, 3});
...
void constant_convert_test(element::Type type_from, element::Type type_to, const std::vector<From>& value, const std::vector<To>& expected) {
    ...
    auto c = std::dynamic_pointer_cast<op::v0::Constant>(ops[0]);
    ASSERT_NE(c, nullptr);
