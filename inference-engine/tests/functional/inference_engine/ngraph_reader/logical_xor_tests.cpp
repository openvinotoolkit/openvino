...
<net name="Network" version="10">
    <layers>
        ...
        <layer name="LogicalXor" id="2" type="LogicalXor" version="opset1">
            <input>
                <port id="0" precision="BOOL">
                    <dim>1</dim>
                    <dim>3</dim>
        ...
        <layer name="LogicalXor" type="Result" id="3" version="opset1">
            <input>
                <port id="0" precision="BOOL">
                    <dim>1</dim>
                    <dim>3</dim>
...
<net name="Network" version="5" precision="BOOL" batch="1">
    <layers>
        ...
        <layer id="1" name="data1" precision="BOOL" type="Const">
            <output>
                <port id="0">
                    <dim>1</dim>
                    <dim>3</dim>
            ...
            <blobs>
                <custom offset="0" size="1452"/>
            </blobs>
        </layer>
        <layer name="LogicalXor" id="2" precision="BOOL" type="Eltwise">
            <data operation="logical_xor"/>
            <input>
                <port id="0">
                    <dim>1</dim>
                    <dim>3</dim>
