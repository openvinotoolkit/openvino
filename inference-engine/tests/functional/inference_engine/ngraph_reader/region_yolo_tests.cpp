...
<net name="frozen_graph" version="10">
	<layers>
		...
		<layer id="1" name="yolo_out_postprocess/y/Output_0/Data_/copy_const" type="Const" version="opset1">
		...
		<layer id="2" name="yolo_out_postprocess" type="Multiply" version="opset1" precision="FP32">
		...
		<layer id="3" name="yolo_out_postprocess/YoloRegion" type="RegionYolo" version="opset1">
		...
		<layer id="4" name="364" type="Result" version="opset1">
			<input>
				<port id="0">
					<dim>1</dim>
					<dim>21125</dim>
...
<net name="frozen_graph" version="7">
	<layers>
		...
		<layer id="1" name="yolo_out_postprocess" type="Power" version="opset1">
			<data power="1" scale="0.0" shift="0"/>
			<input>
				<port id="0">
					<dim>1</dim>
					<dim>125</dim>
		...
		<layer id="2" name="yolo_out_postprocess/YoloRegion" type="RegionYolo" version="opset1">
