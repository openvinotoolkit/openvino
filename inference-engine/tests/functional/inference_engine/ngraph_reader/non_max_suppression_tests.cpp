...
// Because now call of ConvertNMS5ToLegacyMatcher was moved into MKLDNN and CLDNN, then
// CNNNetwork constructor doesn't perform this transformation, and we get CNNNetwork with
// NMS-5, not with NMSIE3, but NMS-5 has dynamic output shapes.
...
<net name="Network" version="10">
    ...
    constexpr size_t weightsSize = 20;
    ...
    auto soft_nms_sigma = opset5::Constant::create(element::f32, Shape{}, {0.0});
