...
<net name="yolov3-10" version="10">
	<layers>
		...
		<layer id="2" name="TFNodes/yolo_evaluation_layer_1/arange__271_cond/Output_0/Data__const" type="Const" version="opset1">
			<data element_type="boolean" offset="0" shape="" size="1"/>
			<output>
				<port id="1" precision="BOOL"/>
			</output>
		</layer>
		<layer id="3" name="TFNodes/yolo_evaluation_layer_1/arange_5/start:0/Output_0/Data__const" type="Const" version="opset1">
			<data element_type="i32" offset="1" shape="" size="4"/>
			<output>
				<port id="1" precision="I32"/>
			</output>
		</layer>
		<layer id="4" name="TFNodes/yolo_evaluation_layer_1/arange_5/delta:0/Output_0/Data__const" type="Const" version="opset1">
			...
			<body>
				<layers>
					...
					<layer id="3" name="11_input_port_1/value/Output_0/Data__const" type="Const" version="opset1">
						<data element_type="i64" offset="41" shape="1" size="8"/>
						<output>
							<port id="1" precision="I64">
								<dim>1</dim>
							</port>
		...
		<layer id="6" name="TFNodes/yolo_evaluation_layer_1/Reshape_13/Cast_11020_const" type="Const" version="opset1">
			<data element_type="i64" offset="9" shape="4" size="32"/>
			<output>
				<port id="1" precision="I64">
					<dim>4</dim>
				</port>
		...
		<layer id="7" name="TFNodes/yolo_evaluation_layer_1/Reshape_13" type="Reshape" version="opset1">
	...
	<edges>
		...
		<edge from-layer="5" from-port="4" to-layer="7" to-port="0"/>
