...
<net name="Network" version="10">
    <layers>
        ...
        <layer name="LogicalOr" id="2" type="LogicalOr" version="opset1">
            <input>
                <port id="0" precision="BOOL">
                    <dim>1</dim>
                    <dim>3</dim>
        ...
        <layer name="LogicalOr" type="Result" id="3" version="opset1">
            <input>
                <port id="0" precision="BOOL">
                    <dim>1</dim>
                    <dim>3</dim>
...
<net name="Network" version="5" precision="BOOL" batch="1">
    <layers>
        ...
        <layer name="LogicalOr" id="2" precision="BOOL" type="Eltwise">
            <data operation="logical_or"/>
            <input>
                <port id="0">
                    <dim>1</dim>
                    <dim>3</dim>
