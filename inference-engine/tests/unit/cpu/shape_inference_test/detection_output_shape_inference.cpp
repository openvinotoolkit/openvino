...
static std::shared_ptr<op::v0::DetectionOutput> create_detection_output(
    const PartialShape& box_logits_shape,
    ...
    const op::v0::DetectionOutput::Attributes& attrs,
    ...
    return std::make_shared<op::v0::DetectionOutput>(box_logits,
                                                     class_preds,
                                                     proposals,
                                                     aux_class_preds,
                                                     aux_box_preds,
...
TEST(StaticShapeInferenceTest, detection_output_top_k) {
    ...
    attrs.num_classes = 2;
    auto op = create_detection_output(PartialShape{4, 20},
                                      PartialShape{4, 10},
                                      PartialShape{4, 2, 20},
                                      PartialShape{4, 10},
                                      PartialShape{4, 20},
...
TEST(StaticShapeInferenceTest, detection_output_no_share_location) {
    ...
    auto op = create_detection_output(PartialShape{4, 40},
                                      PartialShape{4, 10},
                                      PartialShape{4, 2, 20},
                                      PartialShape{4, 10},
                                      PartialShape{4, 40},
