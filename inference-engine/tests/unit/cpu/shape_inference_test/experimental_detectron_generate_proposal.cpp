...
TEST(StaticShapeInferenceTest, ExperimentalProposalsTest) {
    ...
    auto im_info = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{3});
    auto anchors = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{201600, 4});
    auto deltas = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{12, 200, 336});
    auto scores = std::make_shared<op::v0::Parameter>(element::f32, PartialShape{3, 200, 336});
