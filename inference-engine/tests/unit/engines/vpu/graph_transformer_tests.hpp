...
public:
    TestModel() = default;
    TestModel(const Model::Ptr& model, const DataDesc& dataDesc);

    const Model::Ptr& getBaseModel() const { return _model; }
