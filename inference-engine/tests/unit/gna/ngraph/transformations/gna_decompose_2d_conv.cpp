...
struct GraphData {
    ...
    std::shared_ptr<ngraph::op::v0::FakeQuantize>fq_conv;
    std::shared_ptr<ngraph::opset7::Convolution> conv;
    std::shared_ptr<ngraph::op::v1::Add> bias;
    std::shared_ptr<ngraph::op::v0::FakeQuantize>fq_bias;
    std::shared_ptr<ngraph::opset7::MaxPool> max_pool;
    std::shared_ptr<ngraph::op::util::UnaryElementwiseArithmetic> af;
    std::shared_ptr<ngraph::op::v0::FakeQuantize>fq_af;
...
std::shared_ptr<ngraph::op::v0::FakeQuantize> createFQ(std::shared_ptr<ngraph::Node>& in_node) {
    auto input_low = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{1}, {1});
    auto input_high = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{1}, {5});
    auto output_low = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{1}, {0});
    auto output_high = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{1}, {10});
...
std::shared_ptr<ngraph::Node> createBiasFQ(const ngraph::Output<ngraph::Node>& in_node,
    std::shared_ptr<ngraph::op::v0::Constant>& bias_const, std::shared_ptr<ngraph::op::v1::Add>& bias, const bool& fq) {
    std::shared_ptr<ngraph::Node> node;
    bias = std::make_shared<ngraph::op::v1::Add>(in_node, bias_const);
    node = bias;
...
std::shared_ptr<ngraph::op::v0::Result> createFunction(const bool& fq,
    ...
    std::shared_ptr<ngraph::Node> fq_filters = std::make_shared<ngraph::op::v0::Constant>(ngraph::element::i64,
    ...
    std::shared_ptr<ngraph::op::v1::Add> bias = nullptr;
    ...
    std::shared_ptr<ngraph::Node> last_op = std::make_shared<ngraph::op::v1::Transpose>(conv, transpose_out_order);

    switch (model) {
    case modelType::TranspConvBcastAddTransp:
    {
        fq_bias = createBiasFQ(conv, bias_const, bias, fq);
        last_op = std::make_shared<ngraph::op::v1::Transpose>(fq_bias, transpose_out_order);
    }
    break;
    ...
    case modelType::TranspConvBcastAddMaxPoolTransp:
    {
        ...
        auto transpose = std::make_shared<ngraph::op::v1::Transpose>(max_pool, transpose_out_order);
    ...
    {
        fq_bias = createBiasFQ(conv, bias_const, bias, fq);
        activation = std::make_shared<ngraph::op::v0::Relu>(fq_bias);
    ...
    case modelType::TranspConvBcastAddMaxPoolActTransp:
    {
        ...
        max_pool = std::make_shared<ngraph::opset7::MaxPool>(fq_bias, maxpool_stride, ngraph::Shape{0, 0}, ngraph::Shape{0, 0}, maxpool_shape,
            ngraph::op::RoundingType::FLOOR, ngraph::op::PadType::VALID);
        activation = std::make_shared<ngraph::op::v0::Relu>(max_pool);
        if (fq) {
            fq_af = createFQ(activation);
        }
        last_op = std::make_shared<ngraph::op::v1::Transpose>(fq_af ? fq_af : activation, transpose_out_order);
    }
    break;
    ...
    case modelType::TranspConvTranspBcastAddAct:
    {
        ...
        last_op = std::make_shared<ngraph::op::v0::Relu>(fq_bias);
    }
    break;
    ...
    if (graph_data) {
        graph_data->fq_conv = fq ? std::dynamic_pointer_cast<ngraph::op::v0::FakeQuantize>(fq_filters) : nullptr;
        graph_data->conv = conv;
        graph_data->bias = bias;
        graph_data->fq_bias = fq ? std::dynamic_pointer_cast<ngraph::op::v0::FakeQuantize>(fq_bias) : nullptr;
        graph_data->af = std::dynamic_pointer_cast<ngraph::op::util::UnaryElementwiseArithmetic>(activation);
        graph_data->fq_af = fq ? std::dynamic_pointer_cast<ngraph::op::v0::FakeQuantize>(fq_af) : nullptr;
...
std::shared_ptr<ngraph::Node> ReshapeBiasConst(std::shared_ptr<ngraph::op::v1::Add> conv_bias, const ConvParams& conv_params) {
    auto add_const = std::dynamic_pointer_cast<ngraph::op::v0::Constant>(conv_bias->input_value(1).get_node_shared_ptr());

    IE_ASSERT(add_const);

    auto bias_size = shape_size(add_const->get_shape());
    return ngraph::op::util::make_try_fold<ngraph::op::v1::Reshape>(add_const,
        ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4}, ngraph::Shape{1, bias_size, 1, 1}), false);
}
...
std::shared_ptr<ngraph::opset7::StridedSlice> FlatCrop(ngraph::Output<ngraph::Node> input, size_t offset, size_t size) {
    ...
    return std::make_shared<ngraph::opset7::StridedSlice>(
        input,                                                                                                  // data
        ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{2}, {(size_t)0, offset}),          // begin slice index
...
static std::vector<std::shared_ptr<ngraph::Node>> Split2DConvFilters(std::shared_ptr<ngraph::op::v0::Constant>& filters,
    ...
    if (split_channels > 1) {
        const auto axis_node = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{}, {1});
        const auto split = std::make_shared<ngraph::op::v1::Split>(filters, axis_node, split_channels);
    ...
    if (horizontal_permute) {
        for (size_t split_index = 0; split_index < split_channels; split_index++) {
            ...
            result.push_back(std::make_shared<ngraph::op::v1::Transpose>(flat_filter,
                ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4}, ngraph::Shape{0, 1, 3, 2})));
        }
    }
    ...
    for (auto& new_filter : result)
        new_filter = ngraph::op::util::make_try_fold<ngraph::op::v1::Reshape>(new_filter,
            ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4}, reshape_shape), false);
...
ngraph::OutputVector SplitInput(const GraphData& graph_data, ConvParams& conv_params) {
    ...
    auto padded_input_plane = std::make_shared<ngraph::op::v1::Reshape>(graph_data.input_node,
    ...
    if (graph_data.conv_count > 1) {
        ...
        auto reshape_before_transpose = std::make_shared<ngraph::op::v1::Reshape>(padded_input_plane,
            ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{2},
                {shape_size(padded_input_plane->get_shape()) / graph_data.conv_count, graph_data.conv_count}), false);

        auto transpose_before_channel_wise_split = std::make_shared<ngraph::op::v1::Transpose>(reshape_before_transpose,
            ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{2}, {1, 0})->output(0));

        const auto axis_node = ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{}, {0});
        const auto split = std::make_shared<ngraph::op::v1::Split>(transpose_before_channel_wise_split, axis_node, graph_data.conv_count);
...
std::vector<std::shared_ptr<ngraph::Node>> SplitFilters(const GraphData& graph_data, ConvParams& conv_params) {
    ...
    auto filter_values = std::dynamic_pointer_cast<ngraph::op::v0::Constant>(graph_data.fq_conv == nullptr ?
...
void TransformInput(const GraphData& graph_data, const ConvParams& conv_params, ngraph::Output<ngraph::Node>& split_input_plane) {
    ...
    */
    ...
    if (conv_params.filter_stride_height > 1) {
        dilated_chunks_concat = std::make_shared<ngraph::op::v1::Reshape>(dilated_chunks_concat,
            ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{2},
                {conv_params.filter_height, conv_params.input_width * conv_params.input_channel_count * conv_params.output_height}), false);
    }

    auto transposed_dilated_chunks = std::make_shared<ngraph::op::v1::Transpose>(dilated_chunks_concat,
        ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{2}, {1, 0})->output(0));

    // Flattening of interleaved input planes
    auto flattened_dilated_transposed_input = std::make_shared<ngraph::op::v1::Reshape>(transposed_dilated_chunks,
        ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{2},
...
static void InsertFQLayer(const std::shared_ptr<ngraph::op::v0::FakeQuantize> fqLayer,
...
std::shared_ptr<ngraph::Node> Create1DConv(const GraphData& graph_data, const ConvParams& conv_params, const ngraph::Output<ngraph::Node>& input,
    std::shared_ptr<ngraph::Node> filters, const size_t conv_index, const size_t h_index) {
        // Transpose NHWC => NCHW
        std::shared_ptr<ngraph::Node> nchw_input = std::make_shared<ngraph::op::v1::Transpose>(input,
            ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4}, {0, 3, 1, 2})->output(0));
        ...
        if (graph_data.bias_const && conv_index == 0) {
            last_conv_block_op = std::make_shared<ngraph::op::v1::Add>(conv, graph_data.bias_const);
        ...
        // Transpose NCHW => NHWC
        auto nhwc_output = std::make_shared<ngraph::op::v1::Transpose>(last_conv_block_op,
            ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4}, {0, 2, 3, 1})->output(0));
        return nhwc_output;
}
...
std::shared_ptr<ngraph::Node> CreateDeomposedConv(const GraphData& graph_data, ConvParams& conv_params,
    ...
    for (size_t output_height = 0; output_height < conv_params.output_height; output_height++) {
        ...
        if (horizontal_permute) {
            ...
            auto flattened_dilated_conv_input = std::make_shared<ngraph::op::v1::Reshape>(transposed_dilated_chunks,
                ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4},
            ...
            nhwc_conv_y_input = std::make_shared<ngraph::op::v1::Reshape>(nhwc_conv_y_input,
                ngraph::op::v0::Constant::create(ngraph::element::i64, ngraph::Shape{4},
...
std::shared_ptr<ngraph::op::v0::Result> Decompose(const GraphData& graph_data, ConvParams& conv_params) {
    ...
    for (size_t i = 1; i < partial_conv_results.size(); i++) {
        auto add_result = std::make_shared<ngraph::op::v1::Add>(partial_conv_results[i], conv_result);
    ...
    return std::make_shared<ngraph::op::v0::Result>(conv_result);
}
...
std::shared_ptr<ngraph::Function> Decompose2DConvTestFixture::get_reference(const bool& fq,
    ...
    if (model != modelType::TranspConvTransp) {
        graph_data.bias_const = ReshapeBiasConst(std::dynamic_pointer_cast<ngraph::op::v1::Add>(graph_data.bias), conv_params);
    }
