...
<net name="Greater" version="10">
    <layers>
        ...
        <layer id="3" name="greater" type="Greater" version="opset1">
            <input>
                <port id="0" precision="FP32">
                    <dim>1</dim>
                    <dim>64</dim>
...
<net name="Greater" version="5" precision="FP32" batch="1">
    <layers>
        ...
        <layer id="3" name="greater" precision="BOOL" type="Eltwise">
...
<net name="Greater" version="10">
    <layers>
        ...
        <layer id="3" name="greater" type="GreaterEqual" version="opset1">
            <input>
                <port id="0" precision="FP32">
                    <dim>1</dim>
                    <dim>64</dim>
