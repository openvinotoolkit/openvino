...
<net name="Less" version="10">
    <layers>
        ...
        <layer id="3" name="Less" type="Less" version="opset1">
            <input>
                <port id="0" precision="FP32">
                    <dim>1</dim>
                    <dim>64</dim>
...
<net name="Greater" version="5" precision="FP32" batch="1">
    <layers>
        ...
        <layer id="3" name="Less" precision="BOOL" type="Eltwise">
            <data operation="less"/>
            <input>
                <port id="0">
                    <dim>1</dim>
...
<net name="LessEqual" version="10">
    <layers>
        ...
        <layer id="3" name="LessEqual" type="LessEqual" version="opset1">
            <input>
                <port id="0" precision="FP32">
                    <dim>1</dim>
                    <dim>64</dim>
...
<net name="Greater" version="5" precision="FP32" batch="1">
    <layers>
        ...
        <layer id="3" name="LessEqual" precision="BOOL" type="Eltwise">
            <data operation="less_equal"/>
            <input>
                <port id="0">
                    <dim>1</dim>
                    <dim>64</dim>
