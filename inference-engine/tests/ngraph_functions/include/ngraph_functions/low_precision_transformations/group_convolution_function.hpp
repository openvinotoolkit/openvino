...
inline std::ostream& operator<<(std::ostream& out, const GroupConvolutionFunction::ActualValues& values) {
...
inline std::ostream& operator<<(std::ostream& out, const GroupConvolutionFunction::ExpectedValues& values) {
