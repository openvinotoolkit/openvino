...
std::shared_ptr<ngraph::Function> DepthToSpaceFunction::getOriginal(
    ...
    const ngraph::op::v0::DepthToSpace::DepthToSpaceMode mode,
    ...
    auto d2s = std::make_shared<ngraph::op::v0::DepthToSpace>(fakeQuantize, mode, blockSize);
...
std::shared_ptr<ngraph::Function> DepthToSpaceFunction::getOriginal(
    ...
    auto d2s = std::make_shared<ngraph::op::v0::DepthToSpace>(dequantizationOp, mode, blockSize);
    d2s->set_friendly_name("output");
...
std::shared_ptr<ngraph::Function> DepthToSpaceFunction::getReference(
    ...
    auto d2s = std::make_shared<ngraph::op::v0::DepthToSpace>(dequantizationOpBefore, mode, blockSize);
