...
std::shared_ptr<ngraph::Function> FuseSubtractToFakeQuantizeFunction::get(
    ...
    const auto axis = std::make_shared<ngraph::op::v0::Constant>(element::i64, Shape{}, 1ul);
    const std::shared_ptr<Node> split = std::make_shared<ngraph::op::v1::Split>(input, axis, 2ul);
    ...
    ngraph::ResultVector results{
        std::make_shared<ngraph::op::v0::Result>(lastDequantization),
