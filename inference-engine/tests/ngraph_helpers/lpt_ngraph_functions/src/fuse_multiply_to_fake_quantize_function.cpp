...
std::shared_ptr<ngraph::Function> FuseMultiplyToFakeQuantizeFunction::get(
    ...
    const auto input = std::make_shared<ngraph::op::v0::Parameter>(ngraph::element::f32, inputShape);
    ...
    ngraph::ResultVector results{ std::make_shared<ngraph::op::v0::Result>(lastDequantization) };
