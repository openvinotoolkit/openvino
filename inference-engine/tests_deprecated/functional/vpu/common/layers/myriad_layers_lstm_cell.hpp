...
<net batch="1" name="ctpn" version="4">
  <layers>
    <layer id="0" name="previous_state_h/read/placeholder_port_0" precision="FP16" type="Input">
      <output>
        <port id="0">
          <dim>4</dim>
          <dim>128</dim>
    ...
    <layer id="1" name="previous_state_c/read/placeholder_port_0" precision="FP16" type="Input">
      <output>
        <port id="0">
          <dim>4</dim>
          <dim>128</dim>
    ...
    <layer id="2" name="previous_input/read/placeholder_port_0" precision="FP16" type="Input">
      <output>
        <port id="0">
          <dim>4</dim>
          <dim>2</dim>
    ...
    <layer id="38" name="lstm_fused_cell/BlockLSTM/TensorIterator" precision="FP16" type="TensorIterator">
      <input>
        <port id="0">
          <dim>4</dim>
          <dim>2</dim>
