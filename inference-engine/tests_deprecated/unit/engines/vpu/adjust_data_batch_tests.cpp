...
TEST_F(VPU_AdjustDataBatchTest, Case6_LinearWithBatchedInTheEnd) {
    //
...
TEST_F(VPU_AdjustDataBatchTest, Case7_BranchedWithBatchSplitItems) {
    //                                                                                      -> (Batched) -> [Output]
...
TEST_F(VPU_AdjustDataBatchTest, Case8_LinearWithBatchedInTheBeginning) {
    //
...
TEST_F(VPU_AdjustDataBatchTest, Case9_BranchedWithBatchItemsInTheEnd) {
    //                                                                                      -> (Batched) -> [Output]
