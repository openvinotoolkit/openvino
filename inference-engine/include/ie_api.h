...
# define _IE_SUPPRESS_DEPRECATED_START_GCC_4 IE_SUPPRESS_DEPRECATED_START
# define _IE_SUPPRESS_DEPRECATED_END_GCC_4 IE_SUPPRESS_DEPRECATED_END
#else
# define _IE_SUPPRESS_DEPRECATED_START_GCC_4
# define _IE_SUPPRESS_DEPRECATED_END_GCC_4
#endif
