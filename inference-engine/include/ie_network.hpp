 ...
 */
class INFERENCE_ENGINE_DEPRECATED INFERENCE_ENGINE_API_CLASS(PortInfo) {
public:
    /**
 ...
 */
class INFERENCE_ENGINE_DEPRECATED Connection {
public:
    IE_SUPPRESS_DEPRECATED_START
 ...
 */
class INFERENCE_ENGINE_DEPRECATED INFERENCE_ENGINE_API_CLASS(PortData) {
public:
    IE_SUPPRESS_DEPRECATED_START
 ...
 */
class INFERENCE_ENGINE_DEPRECATED INFERENCE_ENGINE_API_CLASS(Port) {
public:
    /**
 ...
 */
class INFERENCE_ENGINE_DEPRECATED ILayer {
public:
    IE_SUPPRESS_DEPRECATED_START
...
class INFERENCE_ENGINE_DEPRECATED INetworkIterator;
 ...
 * All methods here are constant and do not throw exceptions.
 */
class INFERENCE_ENGINE_DEPRECATED INetwork {
public:
    IE_SUPPRESS_DEPRECATED_START
