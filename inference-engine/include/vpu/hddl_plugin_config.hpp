...
/**
 * @deprecated Use InferenceEngine::MYRIAD_GRAPH_TAG instead
 ...
 */
INFERENCE_ENGINE_DEPRECATED("Use InferenceEngine::MYRIAD_GRAPH_TAG instead")
DECLARE_VPU_HDDL_CONFIG_KEY(GRAPH_TAG);

/**
 * @deprecated Use InferenceEngine::MYRIAD_STREAM_ID instead
 * @brief [Only for HDDLPlugin]
 * Type: Arbitrary non-empty string. If empty (""), equals no set, default: "";
 ...
 */
INFERENCE_ENGINE_DEPRECATED("Use InferenceEngine::MYRIAD_STREAM_ID instead")
DECLARE_VPU_HDDL_CONFIG_KEY(STREAM_ID);

/**
 * @deprecated Use InferenceEngine::MYRIAD_DEVICE_TAG instead
 * @brief [Only for HDDLPlugin]
 * Type: Arbitrary non-empty string. If empty (""), equals no set, default: "";
 ...
 */
INFERENCE_ENGINE_DEPRECATED("Use InferenceEngine::MYRIAD_DEVICE_TAG instead")
DECLARE_VPU_HDDL_CONFIG_KEY(DEVICE_TAG);

/**
 * @deprecated Use InferenceEngine::MYRIAD_BIND_DEVICE instead
 * @brief [Only for HDDLPlugin]
 ...
 */
INFERENCE_ENGINE_DEPRECATED("Use InferenceEngine::MYRIAD_BIND_DEVICE instead")
DECLARE_VPU_HDDL_CONFIG_KEY(BIND_DEVICE);

/**
 * @deprecated Use InferenceEngine::MYRIAD_RUNTIME_PRIORITY instead
 * @brief [Only for HDDLPlugin]
 ...
 */
INFERENCE_ENGINE_DEPRECATED("Use InferenceEngine::MYRIAD_RUNTIME_PRIORITY instead")
DECLARE_VPU_HDDL_CONFIG_KEY(RUNTIME_PRIORITY);

/**
 * @deprecated Use InferenceEngine::MYRIAD_USE_SGAD instead
 * @brief [Only for HDDLPlugin]
 * Type: "YES/NO", default is "NO".
 ...
 */
INFERENCE_ENGINE_DEPRECATED("Use InferenceEngine::MYRIAD_USE_SGAD instead")
DECLARE_VPU_HDDL_CONFIG_KEY(USE_SGAD);

/**
 * @deprecated Use InferenceEngine::MYRIAD_GROUP_DEVICE instead
 * @brief [Only for HDDLPlugin]
 * Type: A signed int wrapped in a string, default is "0".
 ...
 */
INFERENCE_ENGINE_DEPRECATED("Use InferenceEngine::MYRIAD_GROUP_DEVICE instead")
