...
public:
                                   ...
                                   InferenceEngine::ResponseDesc* /*resp*/) noexcept override
    {
        ...
        cfg.desc =
            InferenceEngine::TensorDesc(InferenceEngine::Precision::FP32, shape, {shape, order});
                                        ...
                                        InferenceEngine::ResponseDesc* /*resp*/) noexcept override
    {
        ...
        {
            InferenceEngine::MemoryBlob::CPtr minput =
                InferenceEngine::as<InferenceEngine::MemoryBlob>(inputs[i]);
            InferenceEngine::MemoryBlob::Ptr moutput =
                InferenceEngine::as<InferenceEngine::MemoryBlob>(outputs[i]);
            if (!moutput || !minput)
            {
...
public:
    ...
    bool visit_attributes(ngraph::AttributeVisitor& visitor) override { return true; }
};
