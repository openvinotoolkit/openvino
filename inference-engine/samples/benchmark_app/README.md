...
Options:
    ...
    -latency_percentile         Optional. Defines the percentile which will be reported in latency metric. The applicable values range is [0, 100]. The default value is 50.
