...
static const char infer_latency_percentile_message[] = "Optional. The percentile which will be reported in latency metric. The applicable values range is [1, 100]. The default value is 50.";
