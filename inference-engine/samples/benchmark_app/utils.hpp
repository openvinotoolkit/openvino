...
benchmark_app::InputsInfo getInputsInfo(const std::string& shape_string, const std::string& layout_string, const size_t batch_size,
                                        const std::string& blobs_shape_string, const std::map<std::string, T>& input_info, bool& reshape_required) {
...
template <typename T>
benchmark_app::InputsInfo getInputsInfo(const std::string& shape_string, const std::string& layout_string, const size_t batch_size,
                                        const std::string& blobs_shape_string, const std::map<std::string, T>& input_info) {
