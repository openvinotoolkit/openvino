...
#define OV_ITT_GLUE_2(PART1, PART2) PART1 ## PART2
#define OV_ITT_GLUE(PART1, PART2) OV_ITT_GLUE_2(PART1, PART2)
#define OV_ITT_GLUE_UNDERSCORE(PART1, PART2) OV_ITT_GLUE(OV_ITT_GLUE(PART1, _), PART2)