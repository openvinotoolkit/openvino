...
breathe_projects = {"openvino": "../xml/"}

myst_enable_extensions = ["colon_fence"]
myst_heading_anchors = 4
suppress_warnings = ["misc.highlighting_failure", "myst.xref_missing"]
...
def replace_design_tabs_script(app, exception):
    shutil.copy(
        "../../../docs/sphinx_setup/_static/design-tabs.js",
        "../_build/_static/design-tabs.js",
    )
