...
!function(e, t) {
  ...
  "use strict";
  var f = "undefined" != typeof self ? self
      : "undefined" != typeof window ? window
      : void 0 !== f                 ? f
                                     : {};
  var n = !f.document && !!f.postMessage,
      o = n && /blob:/i.test((f.location || {}).protocol), a = {}, h = 0, b = {
        parse : function(e, t) {
          ...
          if (t.dynamicTyping = r,
            ...
            var i = function() {
              ...
              var e =
                      (r = f.URL || f.webkitURL || null,
                       i = s.toString(),
                       b.BLOB_URL ||
                           (b.BLOB_URL = r.createObjectURL(new Blob(
                                [ "(", i, ")();" ],
            ...
            return i.userStep = t.step, i.userChunk = t.chunk,
                   i.userComplete = t.complete, i.userError = t.error,
                   t.step = q(t.step), t.chunk = q(t.chunk),
                   t.complete = q(t.complete), t.error = q(t.error),
                   delete t.worker,
                   void i.postMessage({input : e, config : t, workerId : i.id})
          }
          var n = null;
          b.NODE_STREAM_INPUT,
              "string" == typeof e ? n = t.download ? new l(t) : new p(t)
        ...
        unparse : function(e, t) {
          ...
          function y(e, t) {
            ...
            var r = "boolean" == typeof i && i || Array.isArray(i) && i[t] ||
                function(e, t) {
  ...
  if (b.RECORD_SEP = String.fromCharCode(30),
    ...
    d.fn.parse = function(o) {
      ...
      return this.each(function(e) {
        if (!("INPUT" === d(this).prop("tagName").toUpperCase() &&
              "file" === d(this).attr("type").toLowerCase() && f.FileReader) ||
      ...
      function e() {
        if (0 !== h.length) {
          ...
          if (q(o.before)) {
            ...
            if ("object" == typeof s) {
              if ("abort" === s.action)
                return e = "AbortError", t = n.file, r = n.inputElem,
                       i = s.reason,
  ...
  function u(e) {
    this._handle = null, this._finished = !1, this._completed = !1,
    this._halted = !1, this._input = null, this._baseIndex = 0,
    this._partialLine = "", this._rowCount = 0, this._start = 0,
    this._nextChunk = null, this.isFirstChunk = !0,
    this._completeResults = {data : [], errors : [], meta : {}}, function(e) {
      var t = w(e);
      ...
      if (!this._handle.paused() && !this._handle.aborted()) {
        ...
        return this._config.step || this._config.chunk ||
               ...
               this._completed || !a || !q(this._config.complete) ||
                   n && n.meta.aborted ||
      ...
      q(this._config.error) ? this._config.error(e)
  ...
  function l(e) {
    ...
    (e = e || {}).chunkSize || (e.chunkSize = b.RemoteChunkSize),
        u.call(this, e), this._nextChunk = n ? function() {
  ...
  function c(e) {
    ...
    this.stream = function(e) {
      this._input = e, n = e.slice || e.webkitSlice || e.mozSlice,
  ...
  function m(e) {
    ...
    this.pause = function() {
      ...
      this._input = e, this._input.on("data", this._streamData),
  ...
  function r(g) {
    ...
    function v(e) {
      return "greedy" === g.skipEmptyLines ? "" === e.join("").trim()
        ...
        function e(e, t) {
          ...
          for (r = 0; r < e.length; r++) {
            ...
            g.header && (n = r >= l.length ? "__parsed_extra" : l[r]),
                ...
                s = y(n, s),
                "__parsed_extra" === n ? (i[n] = i[n] || [], i[n].push(s))
                                       : i[n] = s
          }
          return g.header &&
                     (r > l.length ? k("FieldMismatch",
                                       "TooManyFields",
                                       "Too many fields: expected " + l.length +
                                           " fields but parsed " + r,
                                       f + t)
                                   : r < l.length &&
                              k("FieldMismatch",
                                "TooFewFields",
                                "Too few fields: expected " + l.length +
                                    " fields but parsed " + r,
                                f + t)),
                 i
        }
    ...
    function y(e, t) {
      return r = e,
             g.dynamicTypingFunction && void 0 === g.dynamicTyping[r] &&
    ...
    this.parse = function(e, t, r) {
      ...
      if (g.newline || (g.newline = function(e, t) {
            ...
            var r = new RegExp(U(t) + "([^]*?)" + U(t), "gm"),
                i = (e = e.replace(r, "")).split("\r"), n = e.split("\n"),
      ...
      t.streamer._halted ? (d = !1, t.streamer.parseChunk(a, !0))
                         : setTimeout(this.resume, 3)
    }, this.aborted = function() {
      return e
    }, this.abort = function() {
      e = !0, o.abort(), c.meta.aborted = !0, q(g.complete) && g.complete(c),
      a = ""
    }
  }
  function U(e) {
  ...
  function E(e) {
    var O, D = (e = e || {}).delimiter, I = e.newline, T = e.comments,
           A = e.step, L = e.preview, F = e.fastMode,
    ...
    this.parse = function(a, r, t) {
      ...
      var i = a.length, e = D.length, n = I.length, s = T.length, o = q(A),
          h = [], u = [], f = [], d = M = 0;
      if (!a)
        return R();
          ...
          if (T && 0 === f.length && a.substr(M, s) === T) {
            ...
            if (-1 !== p && (p < m || -1 === m)) {
              ...
              if (v && void 0 !== v.nextDelim) {
                p = v.nextDelim, g = v.quoteSearch, f.push(a.substring(M, p)),
                M = p + e, p = a.indexOf(D, M);
                continue
              }
            }
            if (-1 === m)
              ...
              if (O === z || 0 === g || a[g - 1] !== z) {
                ...
                if (a[g + 1 + y] === D) {
                  f.push(a.substring(M, g).replace(_, O)),
                      ...
                      p = a.indexOf(D, M), m = a.indexOf(I, M);
                  break
                }
                var k = E(m);
  ...
  function _(e) {
    ...
    if (t.error)
      ...
      if (q(r.userStep)) {
        for (var s = 0; s < t.results.data.length &&
             (r.userStep(
                  {
  ...
  return o &&
         ...
         (l.prototype = Object.create(u.prototype)).constructor = l,
                        (c.prototype = Object.create(u.prototype)).constructor =
                            c,
                        (p.prototype = Object.create(p.prototype)).constructor =
                            p,
                        (m.prototype = Object.create(u.prototype)).constructor =
                            m,
                        b
});