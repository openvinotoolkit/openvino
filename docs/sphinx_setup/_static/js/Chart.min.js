  ...
  "object" == typeof exports&& "undefined" != typeof module
        ...
        n = function(t, e) {
         ...
         a.rgb.hsv = function(t) {
           ...
           return i /= 100, r /= 108.883,
                  ...
                  [
                    116 *
                            (i = i > .008856 ? Math.pow(i, 1 / 3)
                                             : 7.787 * i + 16 / 116) -
                        16,
                    500 * (n - i),
                    200 *
                        (i -
                         (r = r > .008856 ? Math.pow(r, 1 / 3)
                                          : 7.787 * r + 16 / 116))
                  ]
           ...
           if (0 === (r = Math.round(r / 50)))
             return 30;
           var o = 30 +
               (Math.round(i / 255) << 2 | Math.round(n / 255) << 1 |
                Math.round(e / 255));
           return 2 === r && (o += 60), o
    ...
    var _, k = y, w = {
      ...
      inherits : function(t) {
        ...
        return i.prototype = e.prototype, n.prototype = new i,
               n.extend = w.inherits, t && w.extend(n.prototype, t),
               n.__super__ = e.prototype, n
      },
      _deprecated : function(t, e, n, i) {
        void 0 !== e &&
            console.warn(
                t + ': "' + n + '" is deprecated. Please use "' + i +
                '" instead')
      }
    },
           M = w;
    ...
    var S = {
      ...
      easeInOutBounce : function(t) {
        return t < .5 ? .5 * S.easeInBounce(2 * t)
                      : .5 * S.easeOutBounce(2 * t - 1) + .5
      }
    },
        C = {effects : S};
    M.easingEffects = S;
    var P = Math.PI, A = P / 180, D = 2 * P, T = P / 2, I = P / 4,
        F = 2 * P / 3, L = {
          clear : function(t) {
            ...
            if (r) {
              ...
              t.moveTo(e, l),
                  ...
                  : s < u        ? (t.moveTo(s, n),
                             t.arc(u, l, o, -T, T),
                             t.arc(s, l, o, T, P + T))
                  : l < d        ? (t.arc(s, l, o, -P, 0), t.arc(s, d, o, 0, P))
                                 : t.arc(s, l, o, -P, P),
          ...
          drawPoint : function(t, e, n, i, a, r) {
            ...
            if (e && "object" == typeof e &&
              ...
              return t.save(), t.translate(i, a), t.rotate(h),
                     t.drawImage(
                         e, -e.width / 2, -e.height / 2, e.width, e.height),
                     void t.restore();
            if (!(isNaN(n) || n <= 0)) {
              switch (t.beginPath(), e) {
                default:
                  ...
                  break;
                case "triangle":
                  t.moveTo(i + Math.sin(h) * n, a - Math.cos(h) * n), h += F,
                  ...
                  break;
                case "rectRounded":
                  u = n - (d = .516 * n), s = Math.cos(h + I) * u,
                  l = Math.sin(h + I) * u, t.arc(i - s, a - l, d, h - P, h - T),
                ...
                case "star":
                  s = Math.cos(h) * n, l = Math.sin(h) * n,
                  t.moveTo(i - s, a - l), t.lineTo(i + s, a + l),
                  t.moveTo(i + l, a - s), t.lineTo(i - l, a + s), h += I,
                  s = Math.cos(h) * n, l = Math.sin(h) * n,
                  t.moveTo(i - s, a - l), t.lineTo(i + s, a + l),
                  t.moveTo(i + l, a - s), t.lineTo(i - l, a + s);
                  break;
    ...
    var B = {
      ...
      _parseFont : function(t) {
        var e = z.global, n = N(t.fontSize, e.defaultFontSize), i = {
          ...
          lineHeight :
              M.options.toLineHeight(N(t.lineHeight, e.defaultLineHeight), n),
          size : n,
    ...
    var $ = {
      ...
      advance : function() {
        for (var t, e, n, i, a = this.animations, r = 0; r < a.length;)
          ...
          t.currentStep = Math.min(i, n), V.callback(t.render, [ e, t ], e),
    ...
    V.extend(et.prototype, {
      ...
      setHoverStyle : function(t) {
        var e = this.chart.data.datasets[t._datasetIndex], n = t._index,
            i = t.custom || {}, a = t._model, r = V.getHoverColor;
        t.$previousStyle = {
        ...
        a.backgroundColor = J(
            ...
            n),
        a.borderColor =
            J([ i.hoverBorderColor, e.hoverBorderColor, r(a.borderColor) ],
              void 0,
              n),
        a.borderWidth =
            J([ i.hoverBorderWidth, e.hoverBorderWidth, a.borderWidth ],
              void 0,
              n)
      },
      ...
      i ? (t.lineWidth = 2 * e.borderWidth, t.lineJoin = "round")
        : (t.lineWidth = e.borderWidth, t.lineJoin = "bevel"),
          ...
          function(t, e, n, i) {
            ...
            for (t.beginPath(),
                 t.arc(
                     n.x, n.y, e.outerRadius, n.startAngle, n.startAngle + it),
                 a = 0;
                 a < n.fullCircles;
                 ++a)
              t.stroke()
          }(t, e, n, i),
          i && at(t, n), t.beginPath(),
    ...
    var ot = X.extend({
      ...
      inRange : function(t, e) {
        var n = this._view;
        if (n) {
          for (var i = V.getAngleFromPoint(n, {x : t, y : e}),
                   a = i.angle,
                   r = i.distance,
                   o = n.startAngle,
                   s = n.endAngle;
    ...
    var ut = X.extend({
      ...
      draw : function() {
        var t, e, n, i = this, a = i._view, r = i._chart.ctx, o = a.spanGaps,
                     s = i._children.slice(), l = z.global, u = l.elements.line,
                     d = -1, h = i._loop;
        if (s.length) {
          if (i._loop) {
          ...
          for (r.save(),
               ...
               t < s.length;
               ++t)
            n = s[t]._view, e = -1 === d ? V.previousItem(s, t) : s[d],
            n.skip ||
    ...
    var ft = X.extend({
      ...
      draw : function(t) {
        var e = this._view, n = this._chart.ctx, i = e.pointStyle,
            a = e.rotation, r = e.radius, o = e.x, s = e.y, l = z.global,
            u = l.defaultColor;
        e.skip ||
    ...
    function bt(t, e, n) {
      var i, a, r, o, s = t.borderWidth, l = function(t) {
        ...
        return e ? (t.horizontal ? t.base > t.x && (e = vt(e, "left", "right"))
    ...
    var yt = X.extend({
      ...
      draw : function() {
        var t = this._chart.ctx, e = this._view, n = function(t) {
          var e = mt(t), n = e.right - e.left, i = e.bottom - e.top,
              a = bt(t, n / 2, i / 2);
          return {
      ...
      getCenterPoint : function() {
        ...
        return pt(n) ? (t = n.x, e = (n.y + n.base) / 2)
      ...
      getArea : function() {
        var t = this._view;
        return pt(t) ? t.width * Math.abs(t.y - t.base)
    ...
    var Dt = nt.extend({
      ...
      calculateBarIndexPixels : function(t, e, n, i) {
        var a="flex"===i.barThickness?function(t,e,n){var i,a=e.pixels,r=a[t],o=t>0?a[t-1]:null,s=t<a.length-1?a[t+1]:null,l=n.categoryPercentage;return null===o&&(o=r-(null===s?e.end-e.start:s-r)),null===s&&(s=r+r-o),i=r-(r-Math.min(o,s))/2*l,{chunk:Math.abs(s-o)/2*l/e.stackCount,ratio:n.barPercentage,start:i}}(e,n,i):At(e,n,i),r=this.getStackIndex(t,this.getMeta().stack),o=a.start+a.chunk*r+a.chunk/2,s=Math.min(Pt(i.maxBarThickness,1/0),a.chunk*a.ratio);
        return {
      ...
      _resolveDataElementOptions : function() {
        ...
        return e.barPercentage = Pt(n.barPercentage, e.barPercentage),
               ...
               e.categoryPercentage =
                   Pt(n.categoryPercentage, e.categoryPercentage),
                ...
                ? e.labels.map((function(n, i) {
                    ...
                    return {
                      text: n, fillStyle: r.backgroundColor,
                          strokeStyle: r.borderColor, lineWidth: r.borderWidth,
    ...
    function qt(t) {
      var e, n, i, a;
      return V.isObject(t) ? (e = t.top, n = t.right, i = t.bottom, a = t.left)
                           : e = n = i = a = t,
      {
    ...
    var Zt = nt.extend({
      ...
      _resolveDatasetElementOptions : function() {
        ...
        return i.spanGaps = Kt(e.spanGaps, n.spanGaps),
               i.tension = Kt(e.lineTension, n.elements.line.tension), i
      },
      updateBezierControlPoints : function() {
    ...
    function he(t, e, n) {
      ...
      for (i = 0, a = t.length; i < a; ++i)
        (o = (r = t[i]).box)
            .update(r.width || e.w, r.height || e.h, de(r.horizontal, e)),
    ...
    var fe,
          ...
          update : function(t, e, n) {
            if (t) {
              var i = t.options.layout || {},
                  a = V.options.toPadding(i.padding), r = e - a.width,
                  o = n - a.height,
                  s =
                      function(t) {
                    var e =
                      ...
                      return a
                        ...
                        n = se(oe(e, "left"), !0), i = se(oe(e, "right")),
                        a = se(oe(e, "top"), !0), r = se(oe(e, "bottom"));
                    return {
                      leftAndTop: n.concat(a), rightAndBottom: i.concat(r),
                          chartArea: oe(e, "chartArea"), vertical: n.concat(i),
              ...
              !function(t, e) {
                ...
                for (n = 0, i = t.length; n < i; ++n)
                  ...
                  ce(s.leftAndTop, h, d), h.x += h.w, h.y += h.h,
        ...
        pe =
            ...
            fe.default ||
        fe,
        me = "$chartjs", ve = "chartjs-size-monitor",
        be = "chartjs-render-monitor", xe = "chartjs-render-animation",
        ye = [ "animationstart", "webkitAnimationStart" ], _e = {
    ...
    function Ae(t, e, n) {
      var i, a, r, o,
          ...
          l = s.resizer =
            ...
            n.appendChild(Pe()), i.appendChild(Pe()), e.appendChild(n),
        ...
        Oe = {
          ...
          addScalesToLayout : function(t) {
            V.each(t.scales, (function(e) {
                     ...
                     e.weight = e.options.weight, ge.addBox(t, e)
                   }))
          }
        },
      ...
      tooltips : {
        ...
        callbacks : {
          ...
          label : function(t, e) {
            var n = e.datasets[t.datasetIndex].label || "";
            return n && (n += ": "),
                   V.isNullOrUndef(t.value) ? n += t.yLabel : n += t.value, n
          },
    ...
    var je = X.extend({
      ...
      update : function(t) {
        var e, n, i, a, r, o, s, l, u, d,
            h = this, c = h._options, f = h._model, g = h._model = We(c),
            ...
            return c.filter(t, m)
              ...
              x =
                ...
                return n.font = V.fontString(
                           u, e._titleFontStyle, e._titleFontFamily),
                       V.each(e.title, f),
                       n.font =
                           V.fontString(d, e._bodyFontStyle, e._bodyFontFamily),
                       V.each(e.beforeBody.concat(e.afterBody), f),
                       c = e.displayColors ? d + 2 : 0,
                       V.each(r, (function(t) {
                                V.each(t.before, f), V.each(t.lines, f),
                                    V.each(t.after, f)
                              })),
                       c = 0,
                       n.font = V.fontString(
      ...
      drawBody : function(t, e, n) {
        var i, a, r, o, s, l, u, d,
            ...
            p = e.displayColors, m = 0, v = p ? Ve(e, "left") : 0,
            b = ze(e.rtl, e.x, e.width), x = function(e) {
        ...
        for (n.textAlign = f,
          ...
          for (i = g[s],
            ...
            if (p) {
              ...
              n.fillRect(
                  b.leftForLtr(b.xPlus(_, 1), h - 2), t.y + 1, h - 2, h - 2),
              n.fillStyle = a
            }
            x(o[l])
          }
        ...
        merger : function(t, e, n, i) {
          if ("xAxes" === t || "yAxes" === t) {
            ...
            for (e[t] || (e[t] = []), a = 0; a < s; ++a)
              ...
              !e[t][a].type || o.type && o.type !== e[t][a].type ? V.merge(
                                                                       e[t][a],
                                                                       [
                                                                         Oe.getScaleDefaults(
                                                                             r),
    ...
    V.extend(Qe.prototype, {
      construct : function(t, e) {
        ...
        e = function(t) {
          ...
          return e.datasets = e.datasets || [], e.labels = e.labels || [],
                 t.options = Xe(z.global, z[t.type], t.options || {}), t
        }(e);
        var i = Fe.acquireContext(t, e), a = i && i.canvas, r = a && a.height,
            o = a && a.width;
        n.id = V.uid(), n.ctx = i, n.canvas = a, n.config = e, n.width = o,
        n.height = r, n.aspectRatio = r ? o / r : null, n.options = e.options,
        n._bufferedRender = !1, n._layers = [], n.chart = n, n.controller = n,
        Qe.instances[n.id] = n, Object.defineProperty(n, "data", {
          get : function() {
      ...
      initialize : function() {
        ...
        return Le.notify(t, "beforeInit"),
               V.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(),
      ...
      render : function(t) {
        ...
        var n = e.options.animation, i = Ye(t.duration, n && n.duration),
            a = t.lazy;
        if (!1 !== Le.notify(e, "beforeRender")) {
          ...
          if (n && i) {
            var o = new Z({
              ...
              render : function(t, e) {
                var n = V.easing.effects[e.easing], i = e.currentStep,
                    a = i / e.numSteps;
                t.draw(n(a), a, i)
              },
            ...
            e.draw(), r(new Z({numSteps : 0, chart : e}));
          return e
        }
      },
      draw : function(t) {
      ...
      destroy : function() {
        ...
        i &&
            (n.unbindEvents(),
             ...
             n.canvas = null,
             n.ctx = null),
            Le.notify(n, "destroy"), delete Qe.instances[n.id]
      },
      ...
      updateHoverStyle : function(t, e, n) {
        ...
        for (a = 0, r = t.length; a < r; ++a)
          (i = t[a]) &&
              this.getDatasetMeta(i._datasetIndex)
                  .controller[o + "HoverStyle"](i);
        "dataset" === e &&
            this.getDatasetMeta(t[0]._datasetIndex)
        ...
        return n.lastActive = n.lastActive || [],
               "mouseout" === t.type ? n.active = []
                                     : n.active = n.getElementsAtEventForMode(
                                           t, a.mode, a),
               V.callback(
                   i.onHover || i.hover.onHover, [ t.native, n.active ], n),
    ...
    function hn(t, e, n, i) {
      ...
      function _(t) {
        return {
          width: b[t] || 0, height: x[t] || 0, offset: y[t] || 0
        }
      }
      return function(t, e) {
        V.each(t, (function(t) {
      ...
      return V.extend(
          ...
          }),
          {
            color : V.options.resolve(
                [ e.fontColor, t.fontColor, z.global.defaultFontColor ])
          })
    }
    function pn(t) {
      var e = gn(t, t.minor);
      return {
        minor: e, major: t.major.enabled ? gn(t, t.major) : e
      }
    }
    function mn(t) {
      var e, n, i, a = [];
    ...
    function vn(t, e, n, i) {
      var a, r, o, s, l = ln(n, 0), u = Math.min(ln(i, t.length), t.length),
                      d = 0;
      ...
      for (r = Math.max(l, 0); r < u; r++)
        o = t[r],
        r === s ? (o._index = r, d++, s = Math.round(l + d * e))
                : delete o.label
    }
    z._set("scale", {
      display : !0,
    ...
    var bn = X.extend({
        ...
        !s._isVisible() || !u.display || h >= c || d <= 1 || !s.isHorizontal()
            ...
            : (e = (t = s._getLabelSizes()).widest.width,
               ...
               e + 6 > (a = l.offset ? s.maxWidth / d : i / (d - 1)) &&
                   (a = i / (d - (l.offset ? .5 : 1)),
                    r = s.maxHeight - cn(l.gridLines) - u.padding -
                        fn(l.scaleLabel),
                    o = Math.sqrt(e * e + n * n),
      ...
      fit : function() {
        ...
        if (u ? e.width = t.maxWidth : s && (e.width = cn(o) + fn(r)),
            ...
            a.display && s) {
          var d = pn(a), h = t._getLabelSizes(), c = h.first, f = h.last,
              g = h.widest, p = h.highest, m = .4 * d.minor.lineHeight,
              v = a.padding;
          if (u) {
            var b = 0 !== t.labelRotation, x = V.toRadians(t.labelRotation),
      ...
      _tickSize : function() {
        var t = this.options.ticks, e = V.toRadians(this.labelRotation),
      ...
      _computeGridLineItems : function(t) {
        var e, n, i, a, r, o, s, l, u, d, h, c, f, g, p, m, v,
            ...
            S = b._ticksToDraw, C = S.length + (w ? 1 : 0), P = cn(_), A = [],
            D = _.drawBorder ? un(_.lineWidth, 0, 0) : 0, T = D / 2,
      ...
      _computeLabelItems : function() {
        var t, e, n, i, a, r, o, s, l, u, d, h,
            ...
            v = c.isHorizontal(), b = c._ticksToDraw, x = pn(g), y = g.padding,
          ...
          for (r = 0, o = c.length; r < o; ++r)
            ...
            i && a &&
                (l.save(),
                 ...
                 l.restore());
          if (h) {
            var f, g, p, m, v = h, b = un(n.lineWidth, c.ticksLength - 1, 1),
                            x = c.borderValue;
            e.isHorizontal() ? (f = d(u, e.left, v) - v / 2,
                             ...
                             : (p = d(u, e.top, v) - v / 2,
                                ...
                                f = g = x),
                l.lineWidth = h, l.strokeStyle = un(n.color, 0), l.beginPath(),
      ...
      _drawTitle : function() {
        ...
        if (i.display) {
          var a, r, o = ln(i.fontColor, z.global.defaultFontColor),
                    ...
                    l = V.options.toPadding(i.padding), u = s.lineHeight / 2,
                    d = n.position, h = 0;
          if (t.isHorizontal())
            a = t.left + t.width / 2,
    ...
    var xn = bn, yn = V.isNullOrUndef, _n = xn.extend({
      ...
      _configure : function() {
        ...
        xn.prototype._configure.call(t),
            ...
            n &&
            (t._startValue = t.minIndex - (e ? .5 : 0),
          ...
          stepSize : V.valueOrDefault(e.fixedStepSize, e.stepSize)
            ...
            a = t.ticks = function(t, e) {
              ...
              (r = Math.ceil(g / p) - Math.floor(f / p)) > u &&
                  ...
                  s || Mn(c) ? n = Math.pow(10, V._decimalPlaces(p))
    ...
    function Pn(t, e, n, i) {
      ...
      for (a = 0; a < d; ++a)
        r = t._parseValue(i[a]),
        isNaN(r.min) || isNaN(r.max) || n.data[a].hidden ||
            (l[a] = l[a] || 0,
             u[a] = u[a] || 0,
    ...
    var Dn = Sn.extend({
      determineDataLimits : function() {
        ...
        V.each(u, (function(t) {
                 i = t.pos.concat(t.neg), a.min = Math.min(a.min, V.min(i)),
    ...
    var Rn = xn.extend({
      ...
      handleTickRangeOptions : function() {
        var t = this, e = t.options.ticks;
        t.min = On(e.min, t.min), t.max = On(e.max, t.max),
        t.min === t.max &&
            (0 !== t.min && null !== t.min
      ...
      _configure : function() {
        ...
        xn.prototype._configure.call(t),
            ...
            (e = t._getFirstTickValue(t.minNotZero),
             n = In(t.options.ticks.fontSize, z.global.defaultFontSize) /
                 t._length),
            t._startValue = Fn(e), t._valueOffset = n,
            t._valueRange = (Fn(t.max) - Fn(e)) / (1 - n)
      },
      getPixelForValue : function(t) {
        var e = this, n = 0;
        return (t = +e.getRightValue(t)) > e.min && t > 0 &&
                   (n = (Fn(t) - e._startValue) / e._valueRange +
                        e._valueOffset),
      ...
      getValueForPixel : function(t) {
        ...
        zn = Ln;
    Rn._defaults = zn;
    var Nn = V.valueOrDefault, Bn = V.valueAtIndexOrDefault,
        En = V.options.resolve, Wn = {
          display : !0,
          animate : !0,
          position : "chartArea",
          angleLines : {
    ...
    var Gn = Sn.extend({
      setDimensions : function() {
        ...
        t.paddingTop = Vn(t.options) / 2, t.xCenter = Math.floor(t.width / 2),
      ...
      fit : function() {
        ...
        t.display && t.pointLabels.display ? function(t) {
          ...
          for (e = 0; e < d; e++) {
            ...
            var h = t.getIndexAngle(e), c = V.toDegrees(h) % 360,
                f = Hn(c, i.x, n.w, 0, 180), g = Hn(c, i.y, n.h, 90, 270);
      ...
      _drawGrid : function() {
        var t, e, n, i = this, a = i.ctx, r = i.options, o = r.gridLines,
                     s = r.angleLines, l = Nn(s.lineWidth, o.lineWidth),
        ...
        if (r.pointLabels.display &&
                function(t) {
                  ...
                  for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                    ...
                    e.textAlign = jn(c), Un(c, t._pointLabelSizes[s], u),
          ...
          for (a.save(),
               ...
               a.setLineDash &&
                   (a.setLineDash(En([ s.borderDash, o.borderDash, [] ])),
                    a.lineDashOffset =
                        En([ s.borderDashOffset, o.borderDashOffset, 0 ])),
      ...
      _drawLabels : function() {
        ...
        if (n.display) {
          ...
          e.save(), e.font = o.string, e.translate(t.xCenter, t.yCenter),
                    e.rotate(r), e.textAlign = "center",
    ...
    var Kn = V._deprecated, Zn = V.options.resolve, $n = V.valueOrDefault,
        ...
        Qn = Number.MAX_SAFE_INTEGER || 9007199254740991, ti = {
    ...
    var di = xn.extend({
      ...
      getLabelForIndex : function(t, e) {
        ...
        return V.isObject(s) && (o = n.getRightValue(s)),
               r.tooltipFormat ? i.format(oi(n, o), r.tooltipFormat)
                   : "string" == typeof o
                   ? o
    ...
    an._date.override(
        "function" == typeof t ? {
          ...
          startOf : function(e, n, i) {
            return e = t(e),
                   "isoWeek" === n ? e.isoWeekday(i).valueOf()
                                   : e.startOf(n).valueOf()
          },
          endOf : function(e, n) {
    ...
    function _i(t, e, n, i, a, r) {
      ...
      for (t.beginPath(), o = 0, s = g; o < s; ++o)
        d = n(u = e[l = o % g]._view, l, i), h = xi(u), c = xi(d),
    ...
    var Pi = X.extend({
      initialize : function(t) {
        V.extend(this, t), this.legendHitBoxes = [], this._hoveredItem = null,
                           this.doughnutMode = !1
      },
      beforeUpdate : Mi,
      update : function(t, e, n) {
      ...
      fit : function() {
        var t = this, e = t.options, n = e.labels, i = e.display, a = t.ctx,
            r = V.options._parseFont(n), o = r.size, s = t.legendHitBoxes = [],
      ...
      draw : function() {
        var t = this, e = t.options, n = e.labels, i = z.global,
            a = i.defaultColor, r = i.elements.line, o = t.height,
            s = t.columnHeights, l = t.width, u = t.lineWidths;
        if (e.display) {
          var d, h = wi(e.rtl, t.left, t.minSize.width), c = t.ctx,
                ...
                !function(t, e, i) {
                  if (!(isNaN(m) || m <= 0)) {
                    ...
                    if (c.fillStyle = Si(i.fillStyle, a),
                        ...
                        c.lineDashOffset =
                            Si(i.lineDashOffset, r.borderDashOffset),
    ...
    var Ii = X.extend({
      ...
      fit : function() {
        var t, e = this, n = e.options, i = e.minSize = {},
               a = e.isHorizontal();
        n.display ? (t = (V.isArray(n.text) ? n.text.length : 1) *
      ...
      draw : function() {
        ...
        if (n.display) {
          var i, a, r, o = V.options._parseFont(n), s = o.lineHeight,
                       l = s / 2 + n.padding, u = 0, d = t.top, h = t.left,
                       c = t.bottom, f = t.right;
          e.fillStyle =
              V.valueOrDefault(n.fontColor, z.global.defaultFontColor),
          e.font = o.string,
          t.isHorizontal() ? (a = h + (f - h) / 2, r = d + l, i = f - h)
    ...
    for (var Ni in Li.filler = Oi,
                   ...
                   function() {
                     ...
                     function n(n, i, a) {
                       var r = document.defaultView, o = V._getParentNode(n),
                           s = r.getComputedStyle(n)[i],
                           l = r.getComputedStyle(o)[i], u = e(s), d = e(l),
                   ...
                   tn.helpers.each(ci, (function(t, e) {
                                     tn.scaleService.registerScaleType(
                                         e, t, t._defaults)
                                   })),
                   Li)
    ...
    return "undefined" != typeof window && (window.Chart = tn),
           tn.Chart = tn, tn.Legend = Li.legend._element,
           tn.Title = Li.title._element, tn.pluginService = tn.plugins,
           tn.PluginBase = tn.Element.extend({}),
           tn.canvasHelpers = tn.helpers.canvas, tn.layoutService = tn.layouts,
