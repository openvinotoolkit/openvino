...
.. image:: ../articles_en/assets/images/openvino-overview-diagram.jpg
   :align: center
...
.. grid:: 2 2 3 3
   ...
   .. grid-item-card:: Installation
      :img-top: ../articles_en/assets/images/home_begin_tile_01.png
   ...
   .. grid-item-card:: Framework Compatibility
      :img-top: ../articles_en/assets/images/home_begin_tile_03.png
      :class-card: homepage_begin_tile
      :shadow: none
   ...
   .. grid-item-card:: Easy Deployment
      :img-top: ../articles_en/assets/images/home_begin_tile_04.png
      :class-card: homepage_begin_tile
      :shadow: none
   ...
   .. grid-item-card:: Serving at scale
      :img-top: ../articles_en/assets/images/home_begin_tile_05.png
      :class-card: homepage_begin_tile
      :shadow: none
   ...
   .. grid-item-card:: Model Compression
      :img-top: ../articles_en/assets/images/home_begin_tile_06.png
      :class-card: homepage_begin_tile
      :shadow: none
...
.. grid:: 2 2 2 2
   ...
   .. grid-item-card:: Model Compression
      :img-top: ../articles_en/assets/images/home_key_feature_01.png
   ...
   .. grid-item-card:: Fast & Scalable Deployment
      :img-top: ../articles_en/assets/images/home_key_feature_02.png
      :class-card: homepage_begin_key
      :shadow: none
   ...
   .. grid-item-card:: Lighter Deployment
      :img-top: ../articles_en/assets/images/home_key_feature_03.png
      :class-card: homepage_begin_key
      :shadow: none
   ...
   .. grid-item-card:: Enhanced App Start-Up Time
      :img-top: ../articles_en/assets/images/home_key_feature_04.png
      :class-card: homepage_begin_key
      :shadow: none
