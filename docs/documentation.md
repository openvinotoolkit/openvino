...
## Media Processing
You can also add media processing capabilities to your application using third-party additional tools and libraries, which include [Intel® Deep Learning Streamer (Intel® DL Streamer)](https://dlstreamer.github.io), a utility that eases creation of media analytics pipelines via command line or API, and optimized versions of [OpenCV](https://opencv.org/).