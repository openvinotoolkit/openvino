...
The Image Classification Sample that was automatically compiled when you ran the Image Classification demo script. The binary file is in the `C:\Users\<USER_ID>\Documents\Intel\OpenVINO\inference_engine_cpp_samples_build\intel64\Release` directory.
...
> **NOTE**: To build the Security Barrier Camera Demo Application, see the instructions in the [Demo Applications Overview](@ref omz_demos) section.
