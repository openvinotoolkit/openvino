...
@snippet openvino/docs/examples/dldt_optimization_guide0.cpp part0
...
@snippet openvino/docs/examples/dldt_optimization_guide1.cpp part1
...
@snippet openvino/docs/examples/dldt_optimization_guide2.cpp part2
...
@snippet openvino/docs/examples/dldt_optimization_guide3.cpp part3
...
@snippet openvino/docs/examples/dldt_optimization_guide4.cpp part4
...
@snippet openvino/docs/examples/dldt_optimization_guide5.cpp part5
...
@snippet openvino/docs/examples/dldt_optimization_guide6.cpp part6
...
@snippet openvino/docs/examples/dldt_optimization_guide7.cpp part7
...
@snippet openvino/docs/examples/dldt_optimization_guide8.cpp part8
...
@snippet openvino/docs/examples/dldt_optimization_guide9.cpp part9
