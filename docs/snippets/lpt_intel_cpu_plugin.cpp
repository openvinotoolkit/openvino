...
const bool useLpt = ov::pass::low_precision::LowPrecision::isFunctionQuantized(ovLptFunc);
...
if (useLpt) {
    ...
    lptManager.run_passes(ovLptFunc);
}
//! [lpt_execution]
...
deviceSpecificManager.run_passes(ovLptFunc);
//! [lpt_device]
