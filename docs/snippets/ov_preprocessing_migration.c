...
ov_layout_create(layout_desc, &layout);
...
ov_layout_t* layout_nhwc = nullptr;
const char* input_layout_desc = "NHWC";
ov_layout_create(input_layout_desc, &layout_nhwc);
...
ov_preprocess_input_model_info_t* input_model = nullptr;
ov_preprocess_input_info_get_model_info(input_info, &input_model);
ov_layout_t* layout_nchw = nullptr;
const char* layout_desc = "NCHW";
ov_layout_create(layout_desc, &layout_nchw);
