...
int main() {
    ...
    ov::layout::batch_idx("NCDHW");    // returns 0 for batch
    ov::layout::channels_idx("NCDHW"); // returns 1 for channels
    ov::layout::depth_idx("NCDHW");    // returns 2 for depth
    ov::layout::height_idx("...HW");   // returns -2 for height
    ov::layout::width_idx("...HW");    // returns -1 for width
    //! [ov:layout:predefined]
