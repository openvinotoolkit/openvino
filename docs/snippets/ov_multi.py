...
def MULTI_0():
    ...
    core.set_property(device_name="MULTI", properties={device.priorities: "GPU,CPU"})
...
def MULTI_1():
    ...
    core.set_property(device_name="MULTI", properties={device.priorities: "CPU,GPU"})
    ...
    core.set_property(device_name="MULTI", properties={device.priorities: "GPU"})
...
def MULTI_4():
    ...
    compiled_model = core.compile_model(
        ...
        config={device.properties: {"CPU": cpu_config, "GPU": gpu_config}},
    )

    # Optionally, query the optimal number of requests:
    nireq = compiled_model.get_property(properties.optimal_number_of_infer_requests)
    #! [MULTI_4]
