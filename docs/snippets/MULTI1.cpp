...
// [ ERROR ] [NOT_FOUND] You can only change device priorities but not add new devices with the Network's
// SetConfig(MultiDeviceConfigParams::KEY_MULTI_DEVICE_PRIORITIES. CPU device was not in the original device list!
