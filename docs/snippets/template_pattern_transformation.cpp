...
ov::pass::DecomposeDivideMatcher::DecomposeDivideMatcher() {
    ...
    ov::matcher_pass_callback callback = [](pattern::Matcher& m) {
        auto div = std::dynamic_pointer_cast<ov::op::v1::Divide>(m.get_match_root());
        ...
        auto pow = std::make_shared<ov::op::v1::Power>(
            div->input_value(1),
            ov::op::v0::Constant::create(div->get_input_element_type(1), Shape{1}, {-1}));

        auto mul = std::make_shared<ov::op::v1::Multiply>(div->input_value(0), pow);
