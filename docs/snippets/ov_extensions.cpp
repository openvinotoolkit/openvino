...
int main() {
    ...
    }
    {
        ...
        core.add_extension(ov::frontend::ConversionExtension("Identity", [](const ov::frontend::NodeContext& context) {
    ...
    }
    {
        ...
        core.add_extension(
            ov::frontend::OpExtension<CustomOperation>(std::map<std::string, std::string>{{"attr1", "fw_attr1"}},
                                                       {{"attr2", 5}}));
        //! [frontend_extension_CustomOperation_rename_set]

        //! [frontend_extension_CustomOperation_rename_set_paddle]
        core.add_extension(
            ov::frontend::OpExtension<CustomOperation>({"A", "B", "C"},
                                                       {"X", "Y"},
        ...
        core.add_extension(
            ov::frontend::ConversionExtension("ThresholdedRelu", [](const ov::frontend::NodeContext& node) {
        ...
        core.add_extension(ov::frontend::ConversionExtension("TopKV2", [](const ov::frontend::NodeContext& node) {
            ...
            auto sort_type =
                sorted ? ov::opset11::TopK::SortType::SORT_VALUES : ov::opset11::TopK::SortType::SORT_INDICES;
            auto top_k =
                std::make_shared<ov::opset11::TopK>(input, k_input, -1, mode, sort_type, ov::element::i32, true);
