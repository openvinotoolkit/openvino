...
To get performance numbers, use the dedicated [Benchmark App](../../../samples/cpp/benchmark_app/README.md) sample as it is the best soultion to produce the performance reference.
