...
<<<<<<<< HEAD:docs/articles_en/documentation/openvino_legacy_features/mo_ovc_transition/legacy_conversion_api/convert_python_model_objects.md
@endsphinxdirective
========
>>>>>>>> e256250e4f (format rst files + add helper script):docs/MO_DG/prepare_model/MO_Python_API.rst
