...
python3 mo.py --input_model inception_v1.pb -b 1 --output_dir <A_WRITABLE_DIR>
```
...
python3 mo.py --input_model inception_v1.pb -b 1 --inputinput --output InceptionV1/Logits/Predictions/Reshape_1
```
