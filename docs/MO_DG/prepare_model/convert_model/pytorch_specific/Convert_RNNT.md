...
.. tab:: Package, Docker, open-source installation
   ...
   .. code-block:: sh
      ...
      python3 mo.py --input_model rnnt_encoder.onnx --input "input[157 1 240],feature_length->157"
      python3 mo.py --input_model rnnt_prediction.onnx --input "symbol[1 1],hidden_in_1[2 1 320],hidden_in_2[2 1 320]"
