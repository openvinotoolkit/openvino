# Supported ONNX Topologies {#openvino_docs_MO_DG_prepare_model_convert_model_onnx_specific_supported_topologies}
...
> **NOTE**: To convert these topologies one should first serialize the model by calling `paddle.fluid.io.save_inference_model` ([description](https://www.paddlepaddle.org.cn/documentation/docs/en/1.3/api/io.html#save-inference-model)) command and after that use [paddle2onnx](https://github.com/PaddlePaddle/paddle2onnx) converter.
