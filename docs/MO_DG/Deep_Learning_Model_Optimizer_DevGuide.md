...
> **NOTE**: PyTorch models must be exported to the ONNX format before conversion into IR. More information on this subject is provided in the [Converting a PyTorch Model guide](prepare_model/convert_model/Convert_Model_From_PyTorch.md).
