...
*  `OpenVINO Plugin API <https://docs.openvino.ai/2026/api/c_cpp_api/group__ov__dev__api.html>`__
*  `OpenVINO Transformation API <https://docs.openvino.ai/2026/api/c_cpp_api/group__ie__transformation__api.html>`__
