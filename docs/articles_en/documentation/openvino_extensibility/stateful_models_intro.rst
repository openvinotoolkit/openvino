...
## What is Stateful model?
 ...
 OpenVINO contains special API to simplify work with models with states. State is automatically saved between inferences,
...
![initializing_subgraph_example](./img/initializing_subgraph_example.png)
