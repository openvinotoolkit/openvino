...
Get started with simple :doc:`step-by-step procedures <openvino_docs_../../get-started_../../get-started_demos>` to learn how to build and run demo applications or discover the :doc:`full set of demos <omz_demos>` and adapt them for implementing specific deep learning scenarios in your applications.
