...
<<<<<<<< HEAD:docs/articles_en/documentation/openvino_ir/operation_sets/available_opsets/opset9.md
@endsphinxdirective
========

>>>>>>>> e256250e4f (format rst files + add helper script):docs/articles_en/documentation/openvino_ir/operation_sets/operations_specifications/opset9.rst
