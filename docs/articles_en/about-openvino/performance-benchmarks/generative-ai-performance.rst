...
The current data is as of OpenVINO 2026.1, 7 April 2026.
...
.. tab-set::
   ...
   .. tab-item:: 7-358H
      ...
      .. data-table::
         ...
         :header-rows: 1
         :file:  ../../_static/benchmarks_files/llm_models_7-358H.csv
         :data-column-hidden: [3,4,6]
         :data-order: [[ 0, "asc" ]]
...
.. grid:: 1 1 2 2
   ...
   .. grid-item::
      ...
      .. button-link:: ../../_static/benchmarks_files/llm_models_7-358H.csv 
         :color: primary
         :outline:
         :expand:

         :material-regular:`download;1.5em` Get the 7-358H table [CSV]
