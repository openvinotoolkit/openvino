...
If Your model requires conversion, check the `article <https://docs.openvino.ai/2024/openvino_docs_get_started_get_started_demos.html>`__ for information how to do it.
