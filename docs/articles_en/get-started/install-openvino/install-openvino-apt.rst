   ...
   .. tab-set::
      ...
      .. tab-item:: Ubuntu 26
         ...
         .. code-block:: sh
            ...
            echo "deb https://apt.repos.intel.com/openvino ubuntu26 main" | sudo tee /etc/apt/sources.list.d/intel-openvino.list
   ...
   .. tab-item:: A Specific Version
      ...
      #. Install a specific version of an OpenVINO package:
         ...
         .. code-block:: sh
            ...
            sudo apt install openvino-2026.4.0
...
.. tab-set::
   ...
   .. tab-item:: A Specific Version
      ...
      .. code-block:: sh
         ...
         sudo apt autoremove openvino-2026.4.0
