   ...
   .. tab-set::
      ...
      .. tab-item:: Ubuntu 26
         ...
         .. code-block:: sh
            ...
            echo "deb [signed-by=/etc/apt/keyrings/intel.gpg] https://apt.repos.intel.com/openvino ubuntu26 main" | sudo tee /etc/apt/sources.list.d/intel-openvino.list
...
.. tab-set::
   ...
   .. tab-item:: A Specific Version
      ...
      .. code-block:: sh
         ...
         sudo apt autoremove openvino-2026.3.1
