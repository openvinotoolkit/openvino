...
2. Download the `OpenVINO Runtime archive file for Windows <https://storage.openvinotoolkit.org/repositories/openvino/packages/2025.4/windows/>`__ to your local ``Downloads`` folder.
   ...
   .. note::
      ...
      ``CertUtil -hashfile openvino_2025.4.0.zip SHA256``. Compare the returned value in the
...
4. (Optional) Install *numpy* Python Library:
   ...
   You can use the ``requirements.txt`` file from the ``C:\Program Files (x86)\Intel\openvino_2025.4.0\python`` folder:
