...
.. note::
   ...
   * uses versioned WinGet package identifiers, for example ``Intel.OpenVINOToolkit.2026.3.0``;
...
3. Search for the OpenVINO package:
   ...
   .. code-block:: bat
      ...
      winget search --id Intel.OpenVINOToolkit.2026.3.0 -e --source winget
...
4. Install OpenVINO Runtime:
   ...
   .. code-block:: bat
      ...
      winget install --id Intel.OpenVINOToolkit.2026.3.0 -e --source winget

   To install an exact WinGet package version, add the ``--version`` option:

   .. code-block:: bat

      winget install --id Intel.OpenVINOToolkit.2026.3.0 --version 2026.3.0.0 -e --source winget
...
The WinGet package version may include an additional revision number, for example ``2026.3.0.0``. Use ``--version`` if you need to select the exact WinGet package version.
...
* ``Intel.OpenVINOToolkit.2026.3.0`` is the WinGet package identifier. Use this identifier with WinGet commands such as ``winget install``, ``winget list``, ``winget show``, and ``winget uninstall``.
* ``IntelCorporation.OpenVINOToolkit.2026.3.0`` is the MSIX package name used by Windows after installation. Use this name with PowerShell commands such as ``Get-AppxPackage``.
...
.. code-block:: bat
   ...
   winget list --id Intel.OpenVINOToolkit.2026.3.0 -e
...
.. code-block:: bat
   ...
   winget show --id Intel.OpenVINOToolkit.2026.3.0 -e --source winget
...
.. code-block:: powershell
   ...
   (Get-AppxPackage -Name "IntelCorporation.OpenVINOToolkit.2026.3.0").InstallLocation
...
.. code-block:: powershell
   ...
   $openvinoPackage = Get-AppxPackage -Name "IntelCorporation.OpenVINOToolkit.2026.3.0"
...
.. code-block:: bat
   ...
   winget uninstall --id Intel.OpenVINOToolkit.2026.3.0 -e --source winget
