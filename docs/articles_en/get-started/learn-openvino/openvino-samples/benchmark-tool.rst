         ...
         .. code-block:: sh
            ...
            Options:
              ...
              -api {sync,async}, --api_type {sync,async}
                                    Optional. Enable using sync/async API. Wnen hint is throughput, default value is async. When hint is latency, default value is sync.
      ...
      .. scrollbox::
         ...
         .. code-block:: sh
            ...
            Advanced options
                ...
                -api <sync/async>             Optional. Enable Sync/Async API. Wnen hint is throughput, default value is "async". When hint is latency, default value is "sync".
