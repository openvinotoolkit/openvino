...
the benchmark duration, iteration count, can run continuously until
...
.. tab-set::
   ...
   .. tab-item:: Python
      ...
      .. code-block:: console
         ...
         python throughput_benchmark.py <path_to_model> <device_name>(default: CPU) [--seconds-to-run SECONDS] [--niter NITER]
