...
.. tab-set::
   ...
   .. tab-item:: Linux
      ...
      .. code-block:: console
         ...
         pip install nncf==2.19.0 onnx==1.18.0 optimum-intel==2.1.0 transformers==5.0.0
         pip install openvino==2026.4.0 openvino-tokenizers==2026.4.0.0 openvino-genai==2026.4.0.0
...
.. note::
    ...
    With OpenVINO 2026.3, ``transformers==5.0.0`` is recommended for generating
    most models for Intel NPU.
