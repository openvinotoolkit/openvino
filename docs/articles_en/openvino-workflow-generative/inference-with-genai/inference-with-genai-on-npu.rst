...
.. tab-set::
   ...
   .. tab-item:: Linux
      ...
      .. code-block:: console
         ...
         pip install openvino==2026.2 openvino-tokenizers==2026.2 openvino-genai==2026.2
...
.. note::
    ...
    With OpenVINO 2026.2, it is highly recommended to use ``transformers==4.51.3`` to
