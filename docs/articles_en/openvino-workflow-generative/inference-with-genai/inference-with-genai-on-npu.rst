...
.. tab-set::
   ...
   .. tab-item:: Linux
      ...
      .. code-block:: console
         ...
         pip install openvino==2026.3.0 openvino-tokenizers==2026.3.0 openvino-genai==2026.3.0
...
.. note::
    ...
    With OpenVINO 2026.3, it is highly recommended to use ``transformers==4.51.3`` to
