...
* Ahead of time import in weightless mode has been optimized in terms of memory consumption.
  The consumption is lower than during the regular compilation and lower than using ``CACHE_DIR``.
