...
These entities work as a coherent mechanism and help to achieve the next goals:
...
1. Speed up execution of Model
    ...
    But often requesting data from State might reduce the expected performance gains and even lead to losses,
...
2. Simplify user code
    Typical scenarios as copying data from model's outputs to inputs in user code can be replaced with ReadValue/Assign operations.
    OpenVINO will manage this copying internally.
...
.. image:: _static/images/stateful_model_init_subgraph.png
   :align: center
...
You can find more details on these operations in [ReadValue specification](../ops/infrastructure/ReadValue_6.md) and
[Assign specification](../ops/infrastructure/Assign_6.md).
