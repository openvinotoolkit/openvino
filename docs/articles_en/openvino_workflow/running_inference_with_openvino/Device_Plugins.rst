...
========================================================================================= ============================ ========== ===========
 :doc:`Heterogeneous execution <openvino_docs_OV_UG_Hetero_execution>`                     Yes                         Yes
 :doc:`Multi-device execution <openvino_docs_OV_UG_Running_on_multiple_devices>`           Yes                         Yes
 :doc:`Automatic batching <openvino_docs_OV_UG_Automatic_Batching>`                        No                          Yes
 :doc:`Multi-stream execution <openvino_docs_deployment_optimization_guide_tput>`          Yes (Intel® x86-64 only)    Yes
 :doc:`Models caching <openvino_docs_OV_UG_Model_caching_overview>`                        Yes                         Partial
 :doc:`Dynamic shapes <openvino_docs_OV_UG_DynamicShapes>`                                 Yes                         Partial
 :doc:`Import/Export <openvino_ecosystem>`                                                 Yes                         No
 :doc:`Preprocessing acceleration <openvino_docs_OV_UG_Preprocessing_Overview>`            Yes                         Yes
 :doc:`Stateful models <openvino_docs_OV_UG_model_state_intro>`                            Yes                         No
 :doc:`Extensibility <openvino_docs_Extensibility_UG_Intro>`                               Yes                         Yes
========================================================================================= ============================ ========== ===========
