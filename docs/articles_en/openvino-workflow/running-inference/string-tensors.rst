...
`GenAI Samples <https://github.com/openvinotoolkit/openvino.genai/tree/releases/2024/6/samples/cpp/lora_greedy_causal_lm>`__.
...
* Check out `GenAI Samples <https://github.com/openvinotoolkit/openvino.genai/tree/releases/2024/6/samples/cpp/lora_greedy_causal_lm>`__ to see how string tensors are used in real-life applications.
