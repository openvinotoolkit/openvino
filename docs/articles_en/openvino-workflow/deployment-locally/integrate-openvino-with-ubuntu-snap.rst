...
`APT repository <https://docs.openvino.ai/2026/get-started/install-openvino/install-openvino-apt.html>`__,
...
1. Download the `GPG-PUB-KEY-INTEL-SW-PRODUCTS.PUB <https://docs.openvino.ai/2026/get-started/install-openvino/install-openvino-apt.html#:~:text=Install%20the%20GPG,SW%2DPRODUCTS.PUB>`__:
