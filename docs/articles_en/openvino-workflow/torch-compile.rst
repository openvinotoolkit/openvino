...
1. Neural Network Compression Framework (`NNCF <https://docs.openvino.ai/2026/openvino-workflow/model-optimization.html>`__). NNCF offers advanced algorithms for post-training quantization and weights compression in the OpenVINO toolkit.
...
The Neural Network Compression Framework (`NNCF <https://docs.openvino.ai/2026/openvino-workflow/model-optimization.html>`__) implements advanced quantization and weights compression algorithms, which can be applied to ``torch.fx.GraphModule`` to speed up inference
...
For further details, please see the `documentation <https://docs.openvino.ai/2026/openvino-workflow/model-optimization.html>`__
