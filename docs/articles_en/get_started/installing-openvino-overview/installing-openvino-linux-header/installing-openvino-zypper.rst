...
1. Create a ZYPPER repository file with the command below:
   ...
   .. code-block:: sh
      ...
      sudo zypper addrepo https://download.opensuse.org/repositories/home:cabelo:intel/15.5/home:cabelo:intel.repo
      sudo zypper 
...
.. tab-set::
   ...
   .. tab-item:: A Specific Version
      ...
      .. code-block:: sh
         ...
         sudo zypper remove *openvino-2023.3.0*
