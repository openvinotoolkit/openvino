...
To configure your Intel® Vision Accelerator Design With Intel® Movidius™ on supported operating systems, refer to the proper section in the [VPU Configuration Guide](configurations-for-ivad-vpu.md).
