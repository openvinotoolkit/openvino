...
| Plugin | Device types                                                                                                                                                |
|--------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
|[CPU](CPU.md)              |OpenVINO works with all Intel x86 and x64 processors. The newer 11th and 12th generation processors provide further performance boost, especially with INT8 models. For a full list of supported CPUs, see [Supported Devices](https://docs.openvino.ai/latest/openvino_docs_OV_UG_supported_plugins_Supported_Devices.html).|
|[GPU](GPU.md)            |Intel® Graphics, including Intel® HD Graphics, Intel® UHD Graphics, Intel® Iris® Graphics, Intel® Xe Graphics, and Intel® Xe MAX Graphics. Intel Iris, Xe, and Xe MAX Graphics provide further perfomance boost, especially with INT8 models. For a full list of supported GPUs, see [Supported Devices](https://docs.openvino.ai/latest/openvino_docs_OV_UG_supported_plugins_Supported_Devices.html). |
