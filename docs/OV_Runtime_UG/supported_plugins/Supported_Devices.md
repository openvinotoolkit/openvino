...
|[Heterogeneous plugin](../hetero.md) |Heterogeneous execution enables automatic inference splitting between several devices (for example if a device doesn't [support certain operation](#supported-layers)).                                                           |
...
For [Multi-Device](multi_device.md) and [Heterogeneous](../hetero.md) execution
