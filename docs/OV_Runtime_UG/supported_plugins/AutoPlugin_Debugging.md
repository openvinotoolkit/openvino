...
@sphinxdirective
.. image:: _static/IE_DG_supported_plugins_AUTO_debugging-img01-localhost.png
   :align: center
@endsphinxdirective
4. In the “what” pane, specify your target application/script on the local system.
@sphinxdirective
.. image:: _static/IE_DG_supported_plugins_AUTO_debugging-img02-launch.png
   :align: center
@endsphinxdirective
...
@sphinxdirective
.. image:: _static/IE_DG_supported_plugins_AUTO_debugging-img03-hotspots.png
   :align: center
@endsphinxdirective
...
@sphinxdirective
.. image:: _static/IE_DG_supported_plugins_AUTO_debugging-img04-vtunesummary.png
   :align: center
@endsphinxdirective
...
@sphinxdirective
.. image:: _static/IE_DG_supported_plugins_AUTO_debugging-img05-vtunebottomup.png
   :align: center
@endsphinxdirective
