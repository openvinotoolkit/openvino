...
| |                                | | executed.                                                          |
| |                                | | Examples of returning results could be ``CPU_HELP``(``CPU_HELP``   |
| |                                | | is a temporary device, indicating that CPU is used for             |
| |                                | | acceleration at the model compilation stage),                      |
| |                                | | ``CPU``, ``GPU``, ``CPU GPU``, ``GPU.0``, etc.                     |
+----------------------------------+----------------------------------------------------------------------+
