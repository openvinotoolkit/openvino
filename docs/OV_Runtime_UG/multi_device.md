...
- Use the :ref:`CUMULATIVE_THROUGHPUT performance option <cumulative throughput>` of the [Automatic Device Selection mode](@ref openvino_docs_OV_UG_supported_plugins_AUTO). This way, you can use all available devices in the system without the need to specify them. 
