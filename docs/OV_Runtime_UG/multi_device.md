...
You can use the [Properties API](supported_plugins/config_properties.md) API to query the optimal number of requests. Similarly, when using the Multi-Device you don't need to sum over included devices yourself, you can query property directly:
