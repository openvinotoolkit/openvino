...
.. tab-set::
   ...
   .. tab-item:: Windows OS
      ...
      |     CPU      |            -            |                          -                            |
      +--------------+-------------------------+-------------------------------------------------------+
      |     GPU      | | OpenCL.dll cache.json | | C:\Windows\System32\opencl.dll,                     |
      |              | | cache.json            | | ./runtime/bin/intel64/Release/cache.json,           |
      |              |                         | ./runtime/bin/intel64/Debug/cache.json                |
      +--------------+-------------------------+-------------------------------------------------------+
      |     GNA      |         gna.dll         | ./runtime/bin/intel64/Release/gna.dll,                |
