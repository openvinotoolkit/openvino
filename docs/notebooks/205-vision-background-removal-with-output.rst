...
-  `Preparation <#preparation>`__
   ...
   -  `Import the PyTorch Library and U2-Net <#import-the-pytorch-library-and-u-net>`__
   -  `Settings <#settings>`__
   -  `Load the U2-Net Model <#load-the-u-net-model>`__

-  `Convert PyTorch U2-Net model to OpenVINO
   IR <#convert-pytorch-u-net-model-to-openvino-ir>`__
...
.. parsed-literal::
   ...
   11%|█         | 524k/4.68M [00:00<00:01, 2.88MB/s]

.. parsed-literal::


   22%|██▏       | 1.05M/4.68M [00:00<00:01, 3.23MB/s]

.. parsed-literal::


   34%|███▎      | 1.57M/4.68M [00:00<00:00, 3.33MB/s]

.. parsed-literal::


   45%|████▍     | 2.10M/4.68M [00:00<00:00, 3.40MB/s]

.. parsed-literal::


   56%|█████▌    | 2.62M/4.68M [00:00<00:00, 3.39MB/s]

.. parsed-literal::


   67%|██████▋   | 3.15M/4.68M [00:00<00:00, 3.40MB/s]

.. parsed-literal::


   78%|███████▊  | 3.67M/4.68M [00:01<00:00, 3.41MB/s]

.. parsed-literal::


   90%|████████▉ | 4.19M/4.68M [00:01<00:00, 3.41MB/s]

.. parsed-literal::


   100%|██████████| 4.68M/4.68M [00:01<00:00, 3.43MB/s]

.. parsed-literal::


   100%|██████████| 4.68M/4.68M [00:01<00:00, 3.37MB/s]
...
.. parsed-literal::
    ...
    /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-593/.workspace/scm/ov-notebook/.venv/lib/python3.8/site-packages/torch/nn/functional.py:3769: UserWarning: nn.functional.upsample is deprecated. Use nn.functional.interpolate instead.
...
.. parsed-literal::
    ...
    Inference finished. Inference time: 0.112 seconds, FPS: 8.91.
