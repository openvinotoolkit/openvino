...
.. parsed-literal::
    ...
    [22:41:23.6016]I[plugin.cpp:538][AUTO] device:CPU, config:PERFORMANCE_HINT=LATENCY
    [22:41:23.6016]I[plugin.cpp:538][AUTO] device:CPU, config:PERFORMANCE_HINT_NUM_REQUESTS=0
    [22:41:23.6016]I[plugin.cpp:538][AUTO] device:CPU, config:PERF_COUNT=NO
    [22:41:23.6016]I[plugin.cpp:543][AUTO] device:CPU, priority:0
    [22:41:23.6018]I[schedule.cpp:17][AUTO] scheduler starting
    [22:41:23.6018]I[auto_schedule.cpp:131][AUTO] select device:CPU
    [22:41:23.7431]I[auto_schedule.cpp:109][AUTO] device:CPU compiling model finished
    [22:41:23.7433]I[plugin.cpp:573][AUTO] underlying hardware does not support hardware context
...
.. parsed-literal::
    ...
    [22:41:23.7556]I[schedule.cpp:303][AUTO] scheduler ending
...
.. parsed-literal::
    ...
    throughput:  182.98fps, latency:  31.12ms, time interval: 10.00s


.. parsed-literal::

    throughput:  182.22fps, latency:  32.10ms, time interval: 10.00s


.. parsed-literal::

    throughput:  183.02fps, latency:  31.92ms, time interval: 10.00s


.. parsed-literal::

    throughput:  182.93fps, latency:  31.99ms, time interval: 10.01s


.. parsed-literal::

    throughput:  181.64fps, latency:  32.23ms, time interval: 10.03s


.. parsed-literal::

    throughput:  182.52fps, latency:  32.05ms, time interval: 10.01s
...
.. parsed-literal::
    ...
    throughput:  139.05fps, latency:  6.63ms, time interval: 10.00s


.. parsed-literal::

    throughput:  141.59fps, latency:  6.62ms, time interval: 10.00s


.. parsed-literal::

    throughput:  141.09fps, latency:  6.64ms, time interval: 10.00s
...
.. parsed-literal::
    ...
    throughput:  141.36fps, latency:  6.64ms, time interval: 10.00s


.. parsed-literal::

    throughput:  141.34fps, latency:  6.64ms, time interval: 10.00s
