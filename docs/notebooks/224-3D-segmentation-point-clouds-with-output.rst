...
.. parsed-literal::
    ...
    /tmp/ipykernel_4051381/2347079344.py:12: UserWarning: No data for colormapping provided via 'c'. Parameters 'cmap' will be ignored
      ax.scatter3D(X, Y, Z, s=5, cmap="jet", marker="o", label='chair')
...
.. parsed-literal::
    ...
    /tmp/ipykernel_4051381/68687822.py:23: UserWarning: No data for colormapping provided via 'c'. Parameters 'cmap' will be ignored
      ax.scatter(XCur, YCur, ZCur, s=5, cmap="jet", marker="o", label=classes[i])
