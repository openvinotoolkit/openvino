...
Prepare Dataset `:math:`\Uparrow` <#Table-of-content:>`__
---------------------------------------------------------
...
Perform Quantization `:math:`\Uparrow` <#Table-of-content:>`__
--------------------------------------------------------------
...
Create Dataset for Validation `:math:`\Uparrow` <#Table-of-content:>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Run nncf.quantize for Getting an Optimized Model `:math:`\Uparrow` <#Table-of-content:>`__
------------------------------------------------------------------------------------------
...
Serialize an OpenVINO IR model `:math:`\Uparrow` <#Table-of-content:>`__
------------------------------------------------------------------------
...
Compare Accuracy of the Original and Quantized Models `:math:`\Uparrow` <#Table-of-content:>`__
-----------------------------------------------------------------------------------------------
...
Compare results on four pictures `:math:`\Uparrow` <#Table-of-content:>`__
--------------------------------------------------------------------------
