...
### Table of content: - `Prepare the Model <#1>`__ - `Prepare
Dataset <#2>`__ - `Perform Quantization <#3>`__ - `Create Dataset for
Validation <#4>`__ - `Run nncf.quantize for Getting an Optimized
Model <#5>`__ - `Serialize an OpenVINO IR model <#6>`__ - `Compare
Accuracy of the Original and Quantized Models <#7>`__ - `Select
inference device <#8>`__ - `Compare Performance of the Original and
Quantized Models <#9>`__ - `Compare results on four pictures <#10>`__
...
### Create Dataset for Validation `⇑ <#0>`__
...
## Run nncf.quantize for Getting an Optimized Model `⇑ <#0>`__
...
## Serialize an OpenVINO IR model `⇑ <#0>`__
...
## Compare results on four pictures `⇑ <#0>`__
