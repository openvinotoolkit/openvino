...
Additionally, you can also upload a video file.
   ...
   **NOTE**: To use a webcam, you must run this Jupyter notebook on a
   ...
   step. #### Table of contents: - `Imports <#Imports>`__ - `The
   model <#The-model>`__ - `Download the model <#Download-the-model>`__
   - `Load the model <#Load-the-model>`__ - `Processing <#Processing>`__
   - `OpenPose Decoder <#OpenPose-Decoder>`__ - `Process
   Results <#Process-Results>`__ - `Draw Pose
   Overlays <#Draw-Pose-Overlays>`__ - `Main Processing
   Function <#Main-Processing-Function>`__ - `Run <#Run>`__ - `Run Live
   Pose Estimation <#Run-Live-Pose-Estimation>`__
