...
.. parsed-literal::
    ...
    PosixPath('/opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-593/.workspace/scm/ov-notebook/notebooks/112-pytorch-post-training-quantization-nncf/model/resnet50_fp32.pth')
...
.. parsed-literal::
    ...
    Test: [ 0/79]	Time 0.268 (0.268)	Acc@1 81.25 (81.25)	Acc@5 92.19 (92.19)


.. parsed-literal::

    Test: [10/79]	Time 0.240 (0.240)	Acc@1 56.25 (66.97)	Acc@5 86.72 (87.50)
...
.. parsed-literal::
    ...
    Test: [30/79]	Time 0.238 (0.240)	Acc@1 53.12 (62.37)	Acc@5 77.34 (85.33)


.. parsed-literal::

    Test: [40/79]	Time 0.234 (0.240)	Acc@1 67.19 (60.86)	Acc@5 90.62 (84.51)
...
.. parsed-literal::
    ...
    Test: [60/79]	Time 0.234 (0.239)	Acc@1 66.41 (60.46)	Acc@5 86.72 (83.79)


.. parsed-literal::

    Test: [70/79]	Time 0.301 (0.242)	Acc@1 52.34 (60.21)	Acc@5 80.47 (83.33)


.. parsed-literal::

     * Acc@1 60.740 Acc@5 83.960 Total time: 19.023
...
.. parsed-literal::
    ...
    2024-01-18 22:57:52.457431: I tensorflow/core/util/port.cc:110] oneDNN custom operations are on. You may see slightly different numerical results due to floating-point round-off errors from different computation orders. To turn them off, set the environment variable `TF_ENABLE_ONEDNN_OPTS=0`.
    2024-01-18 22:57:52.488563: I tensorflow/core/platform/cpu_feature_guard.cc:182] This TensorFlow binary is optimized to use available CPU instructions in performance-critical operations.
    To enable the following instructions: AVX2 AVX512F AVX512_VNNI FMA, in other operations, rebuild TensorFlow with the appropriate compiler flags.


.. parsed-literal::

    2024-01-18 22:57:53.001208: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:38] TF-TRT Warning: Could not find TensorRT
...
.. parsed-literal::
    ...
    Test: [ 0/79]	Time 0.437 (0.437)	Acc@1 81.25 (81.25)	Acc@5 91.41 (91.41)


.. parsed-literal::

    Test: [10/79]	Time 0.378 (0.387)	Acc@1 54.69 (66.41)	Acc@5 85.94 (87.43)


.. parsed-literal::

    Test: [20/79]	Time 0.380 (0.384)	Acc@1 68.75 (64.17)	Acc@5 84.38 (87.02)


.. parsed-literal::

    Test: [30/79]	Time 0.380 (0.383)	Acc@1 52.34 (62.35)	Acc@5 77.34 (85.01)


.. parsed-literal::

    Test: [40/79]	Time 0.381 (0.383)	Acc@1 67.19 (60.75)	Acc@5 89.06 (84.26)


.. parsed-literal::

    Test: [50/79]	Time 0.380 (0.382)	Acc@1 60.16 (60.71)	Acc@5 88.28 (84.21)


.. parsed-literal::

    Test: [60/79]	Time 0.379 (0.382)	Acc@1 64.84 (60.35)	Acc@5 85.94 (83.63)


.. parsed-literal::

    Test: [70/79]	Time 0.378 (0.382)	Acc@1 52.34 (60.10)	Acc@5 79.69 (83.16)


.. parsed-literal::

     * Acc@1 60.600 Acc@5 83.820 Total time: 29.920
...
.. parsed-literal::
    ...
    /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-593/.workspace/scm/ov-notebook/.venv/lib/python3.8/site-packages/nncf/torch/quantization/layers.py:333: TracerWarning: Converting a tensor to a Python number might cause the trace to be incorrect. We can't record the data flow of Python values, so this value will be treated as a constant in the future. This means that the trace might not generalize to other inputs!
      return self._level_low.item()
    /opt/home/k8sworker/ci-ai/cibuilds/ov-notebook/OVNotebookOps-593/.workspace/scm/ov-notebook/.venv/lib/python3.8/site-packages/nncf/torch/quantization/layers.py:341: TracerWarning: Converting a tensor to a Python number might cause the trace to be incorrect. We can't record the data flow of Python values, so this value will be treated as a constant in the future. This means that the trace might not generalize to other inputs!
...
.. parsed-literal::
    ...
    Mismatched elements: 25585 / 25600 (99.9%)
    Greatest absolute difference: 0.45540666580200195 at index (120, 149) (up to 1e-05 allowed)
    Greatest relative difference: 42.557099376680775 at index (56, 158) (up to 1e-05 allowed)
      _check_trace(
...
.. parsed-literal::
    ...
    Test: [ 0/79]	Time 0.188 (0.188)	Acc@1 81.25 (81.25)	Acc@5 92.19 (92.19)


.. parsed-literal::

    Test: [10/79]	Time 0.137 (0.142)	Acc@1 56.25 (66.97)	Acc@5 86.72 (87.50)


.. parsed-literal::

    Test: [20/79]	Time 0.135 (0.140)	Acc@1 67.97 (64.29)	Acc@5 85.16 (87.35)


.. parsed-literal::

    Test: [30/79]	Time 0.135 (0.139)	Acc@1 53.12 (62.37)	Acc@5 77.34 (85.33)
...
.. parsed-literal::
    ...
    Test: [50/79]	Time 0.137 (0.139)	Acc@1 60.16 (60.80)	Acc@5 88.28 (84.42)
...
.. parsed-literal::
    ...
    Test: [70/79]	Time 0.137 (0.138)	Acc@1 52.34 (60.21)	Acc@5 80.47 (83.33)


.. parsed-literal::

     * Acc@1 60.740 Acc@5 83.960 Total time: 10.813
...
.. parsed-literal::
    ...
    Test: [ 0/79]	Time 0.140 (0.140)	Acc@1 82.03 (82.03)	Acc@5 92.19 (92.19)


.. parsed-literal::

    Test: [10/79]	Time 0.079 (0.083)	Acc@1 55.47 (66.62)	Acc@5 85.94 (87.64)


.. parsed-literal::

    Test: [20/79]	Time 0.078 (0.081)	Acc@1 67.97 (63.84)	Acc@5 84.38 (87.20)


.. parsed-literal::

    Test: [30/79]	Time 0.078 (0.080)	Acc@1 52.34 (62.22)	Acc@5 77.34 (85.18)


.. parsed-literal::

    Test: [40/79]	Time 0.078 (0.079)	Acc@1 67.19 (60.69)	Acc@5 89.84 (84.38)


.. parsed-literal::

    Test: [50/79]	Time 0.078 (0.079)	Acc@1 60.16 (60.71)	Acc@5 88.28 (84.30)


.. parsed-literal::

    Test: [60/79]	Time 0.075 (0.078)	Acc@1 66.41 (60.43)	Acc@5 87.50 (83.75)


.. parsed-literal::

    Test: [70/79]	Time 0.079 (0.078)	Acc@1 52.34 (60.11)	Acc@5 80.47 (83.27)


.. parsed-literal::

     * Acc@1 60.620 Acc@5 83.920 Total time: 6.129
