...
.. parsed-literal::
    ...
    <DisplayHandle display_id=705a85377b7503a50b2156a9cf5125ff>
...
.. parsed-literal::
    ...
    PyTorch model on CPU. First inference time: 0.0232 seconds
    PyTorch model on CPU: 0.0199 seconds per image (50.29 FPS)
...
.. parsed-literal::
    ...
    ONNX model on CPU. First inference time: 0.0168 seconds
    ONNX model on CPU: 0.0133 seconds per image (75.08 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on CPU: 0.0132 seconds per image (75.66 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model + more threads on CPU. First inference time: 0.0162 seconds
    OpenVINO model + more threads on CPU: 0.0132 seconds per image (75.85 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on AUTO: 0.0135 seconds per image (73.95 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model + shared memory on AUTO: 0.0053 seconds per image (188.35 FPS)
