...
.. parsed-literal::
    ...
    <DisplayHandle display_id=6784b15ecd1addfc90e5f95ba6c72a91>
...
.. parsed-literal::
    ...
    PyTorch model on CPU. First inference time: 0.0212 seconds


.. parsed-literal::

    PyTorch model on CPU: 0.0190 seconds per image (52.73 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on CPU: 0.0070 seconds per image (141.88 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model + bigger batch on CPU. First inference time: 0.0407 seconds


.. parsed-literal::

    OpenVINO model + bigger batch on CPU: 0.0069 seconds per image (144.13 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on CPU (THROUGHPUT). First inference time: 0.0202 seconds


.. parsed-literal::

    OpenVINO model on CPU (THROUGHPUT): 0.0040 seconds per image (249.63 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on AUTO (THROUGHPUT). First inference time: 0.0251 seconds


.. parsed-literal::

    OpenVINO model on AUTO (THROUGHPUT): 0.0040 seconds per image (250.70 FPS)
...
.. parsed-literal::
    ...
    OpenVINO model on AUTO (CUMULATIVE THROUGHPUT). First inference time: 0.0222 seconds


.. parsed-literal::

    OpenVINO model on AUTO (CUMULATIVE THROUGHPUT): 0.0040 seconds per image (250.59 FPS)
