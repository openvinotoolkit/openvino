...
.. parsed-literal::
    ...
    /home/ea/work/genai_env/lib/python3.8/site-packages/optimum/intel/openvino/modeling_diffusion.py:599: FutureWarning: `shared_memory` is deprecated and will be removed in 2024.0. Value of `shared_memory` is going to override `share_inputs` value. Please use only `share_inputs` explicitly.
      outputs = self.request(inputs, shared_memory=True)
    /home/ea/work/genai_env/lib/python3.8/site-packages/optimum/intel/openvino/modeling_diffusion.py:615: FutureWarning: `shared_memory` is deprecated and will be removed in 2024.0. Value of `shared_memory` is going to override `share_inputs` value. Please use only `share_inputs` explicitly.
      outputs = self.request(inputs, shared_memory=True)




.. image:: 248-segmind-vegart-with-output_files/248-segmind-vegart-with-output_12_3.png
...
.. parsed-literal::
    ...
    FP16 model size: 1455519.52 KB
    INT8 model size: 729448.03 KB
...
.. parsed-literal::
    ...
    FP16 pipeline latency: 9.751
    INT8 pipeline latency: 6.068
    Text-to-Image generation speed up: 1.607
