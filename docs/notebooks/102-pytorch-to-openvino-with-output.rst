...
weights. Typical steps for getting a pre-trained model: 1. Create an
instance of a model class 2. Load checkpoint state dict, which contains
pre-trained model weights 3. Turn the model to evaluation for switching
some operations to inference mode
...
.. parsed-literal::
    ...
    13.6 ms ± 5.91 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
parameters, such as: \* ``compress_to_fp16`` - flag to perform model
weights compression into FP16 data format. It may reduce the required
space for model storage on disk and give speedup for inference devices,
where FP16 calculation is supported. \* ``example_input`` - input data
sample which can be used for model tracing. \* ``input_shape`` - the
shape of input tensor for conversion
...
.. image:: 102-pytorch-to-openvino-with-output_files/102-pytorch-to-openvino-with-output_17_0.png
...
.. parsed-literal::
    ...
    3.1 ms ± 7.22 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. image:: 102-pytorch-to-openvino-with-output_files/102-pytorch-to-openvino-with-output_25_0.png
...
.. parsed-literal::
    ...
    2.78 ms ± 11.1 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. image:: 102-pytorch-to-openvino-with-output_files/102-pytorch-to-openvino-with-output_29_0.png
...
.. parsed-literal::
    ...
    12.5 ms ± 49.1 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
.. image:: 102-pytorch-to-openvino-with-output_files/102-pytorch-to-openvino-with-output_33_0.png
...
.. parsed-literal::
    ...
    3.04 ms ± 11.3 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. image:: 102-pytorch-to-openvino-with-output_files/102-pytorch-to-openvino-with-output_37_0.png
...
.. parsed-literal::
    ...
    12.7 ms ± 68.2 µs per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
.. image:: 102-pytorch-to-openvino-with-output_files/102-pytorch-to-openvino-with-output_41_0.png
...
.. parsed-literal::
    ...
    3.06 ms ± 9.13 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
