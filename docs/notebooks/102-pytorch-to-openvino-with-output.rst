...
`tutorial <notebooks/102-pytorch-to-openvino-with-output.html>`__.
...
.. parsed-literal::
    ...
    15.3 ms ± 19.4 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. parsed-literal::
    ...
    3.56 ms ± 5.15 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
`tutorial <notebooks/002-openvino-api-with-output.html>`__.
...
.. parsed-literal::
    ...
    2.89 ms ± 7.63 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. parsed-literal::
    ...
    13 ms ± 40.9 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. parsed-literal::
    ...
    3.62 ms ± 14.2 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. parsed-literal::
    ...
    14 ms ± 221 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. parsed-literal::
    ...
    3.58 ms ± 8.9 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
