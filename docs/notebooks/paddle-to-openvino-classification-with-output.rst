...
.. parsed-literal::
    ...
    --2024-07-02 01:07:43--  http://nz2.archive.ubuntu.com/ubuntu/pool/main/o/openssl/libssl1.1_1.1.1f-1ubuntu2.19_amd64.deb
    ...
    2024-07-02 01:07:43 ERROR 404: Not Found.
...
.. parsed-literal::
    ...
    2024-07-02 01:07:45 INFO: Loading faiss with AVX512 support.
    2024-07-02 01:07:45 INFO: Successfully loaded faiss with AVX512 support.
...
.. parsed-literal::
    ...
    [2024/07/02 01:08:12] ppcls WARNING: The current running environment does not support the use of GPU. CPU has been used instead.
...
.. parsed-literal::
    ...
    2024-07-02 01:08:13 WARNING: Clipping input data to the valid range for imshow with RGB data ([0..1] for floats or [0..255] for integers).
...
.. parsed-literal::
    ...
    <matplotlib.image.AxesImage at 0x7f33f85b7610>
...
.. parsed-literal::
    ...
    PaddlePaddle model on CPU: 0.0072 seconds per image, FPS: 139.22
...
.. parsed-literal::
    ...
    OpenVINO IR model in OpenVINO Runtime (AUTO): 0.0028 seconds per image, FPS: 361.41
