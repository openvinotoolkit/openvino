...
.. parsed-literal::
    ...
    --2024-01-18 22:35:48--  http://nz2.archive.ubuntu.com/ubuntu/pool/main/o/openssl/libssl1.1_1.1.1f-1ubuntu2.19_amd64.deb
...
.. parsed-literal::
    ...
    404 Not Found
    2024-01-18 22:35:48 ERROR 404: Not Found.
...
.. parsed-literal::
    ...
    2024-01-18 22:35:50 INFO: Loading faiss with AVX2 support.


.. parsed-literal::

    2024-01-18 22:35:50 INFO: Successfully loaded faiss with AVX2 support.
...
.. parsed-literal::
    ...
    [2024/01/18 22:36:11] ppcls WARNING: The current running environment does not support the use of GPU. CPU has been used instead.
...
.. parsed-literal::
    ...
    2024-01-18 22:36:11 WARNING: Clipping input data to the valid range for imshow with RGB data ([0..1] for floats or [0..255] for integers).
...
.. parsed-literal::
    ...
    <matplotlib.image.AxesImage at 0x7feb147b3790>
...
Notebook <notebooks/002-openvino-api-with-output.html>`__ for more
information.
...
.. parsed-literal::
    ...
    PaddlePaddle model on CPU: 0.0073 seconds per image, FPS: 137.62
...
.. parsed-literal::
    ...
    OpenVINO IR model in OpenVINO Runtime (AUTO): 0.0031 seconds per image, FPS: 327.67
