...
Table of content: - `Introduction <#1>`__ - `Install required
packages <#2>`__ - `Checking GPUs with Query Device <#3>`__ - `List GPUs
with core.available_devices <#4>`__ - `Check Properties with
core.get_property <#5>`__ - `Brief Descriptions of Key
Properties <#6>`__ - `Compiling a Model on GPU <#7>`__ - `Download and
Convert a Model <#8>`__ - `Download and unpack the Model <#9>`__ -
`Convert the Model to OpenVINO IR format <#10>`__ - `Compile with
Default Configuration <#11>`__ - `Reduce Compile Time through Model
Caching <#12>`__ - `Throughput and Latency Performance Hints <#13>`__ -
`Using Multiple GPUs with Multi-Device and Cumulative
Throughput <#14>`__ - `Performance Comparison with
benchmark_app <#15>`__ - `CPU vs GPU with Latency Hint <#16>`__ - `CPU
vs GPU with Throughput Hint <#17>`__ - `Single GPU vs Multiple
GPUs <#18>`__ - `Basic Application Using GPUs <#19>`__ - `Import
Necessary Packages <#20>`__ - `Compile the Model <#21>`__ - `Load and
Preprocess Video Frames <#22>`__ - `Define Model Output Classes <#23>`__
- `Set up Asynchronous Pipeline <#24>`__ - `Callback Definition <#25>`__
- `Create Async Pipeline <#26>`__ - `Perform Inference <#27>`__ -
`Process Results <#28>`__ - `Conclusion <#29>`__
...
### Install required packages `⇑ <#0>`__
...
## Checking GPUs with Query Device `⇑ <#0>`__
...
### List GPUs with core.available_devices `⇑ <#0>`__
...
### Check Properties with core.get_property `⇑ <#0>`__
...
### Brief Descriptions of Key Properties `⇑ <#0>`__
...
### Download and Convert a Model `⇑ <#0>`__
...
#### Download and unpack the Model `⇑ <#0>`__
...
### Compile with Default Configuration `⇑ <#0>`__
...
### Reduce Compile Time through Model Caching `⇑ <#0>`__
...
### Throughput and Latency Performance Hints `⇑ <#0>`__
...
## Performance Comparison with benchmark_app `⇑ <#0>`__
...
#### CPU vs GPU with Latency Hint `⇑ <#0>`__
...
#### CPU vs GPU with Throughput Hint `⇑ <#0>`__
...
#### Single GPU vs Multiple GPUs `⇑ <#0>`__
...
## Basic Application Using GPUs `⇑ <#0>`__
...
### Import Necessary Packages `⇑ <#0>`__
...
### Load and Preprocess Video Frames `⇑ <#0>`__
...
### Define Model Output Classes `⇑ <#0>`__
...
### Set up Asynchronous Pipeline `⇑ <#0>`__

#### Callback Definition `⇑ <#0>`__
