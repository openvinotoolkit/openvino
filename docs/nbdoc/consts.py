...
notebooks_binder = (
    "https://mybinder.org/v2/gh/openvinotoolkit/openvino_notebooks/HEAD?filepath="
)
notebooks_colab = "https://colab.research.google.com/github/openvinotoolkit/openvino_notebooks/blob/latest/"
file_with_binder_notebooks = Path(
    "../../docs/notebooks/notebooks_with_binder_buttons.txt"
).resolve(strict=True)
file_with_colab_notebooks = Path(
    "../../docs/notebooks/notebooks_with_colab_buttons.txt"
).resolve(strict=True)
openvino_notebooks_ipynb_list = Path(
    "../../docs/notebooks/all_notebooks_paths.txt"
).resolve(strict=True)
binder_image_source = Path(
    "../../docs/sphinx_setup/_static/images/launch_in_binder.svg"
).resolve(strict=True)
...
colab_image_source = Path(
    "../../docs/sphinx_setup/_static/images/open_in_colab.svg"
).resolve(strict=True)
...
github_image_source = Path(
    "../../docs/sphinx_setup/_static/images/view_on_github.svg"
).resolve(strict=True)
