...
We have two types of tests: nGraph reader tests located in `src/inference/tests/functional/inference_engine/ngraph_reader` and transformation tests located in `src/inference/tests/functional/inference_engine/transformations`
