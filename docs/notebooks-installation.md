...
+=====================================+================================+
| Ubuntu 18.04 LTS                    | 3.7, 3.8, 3.9                  |
+-------------------------------------+--------------------------------+
| Ubuntu 20.04 LTS                    | 3.7, 3.8, 3.9                  |
+-------------------------------------+--------------------------------+
| Red Hat Enterprise Linux 8          | 3.8, 3.9                       |
+-------------------------------------+--------------------------------+
| CentOS 7                            | 3.7, 3.8, 3.9                  |
+-------------------------------------+--------------------------------+
| macOS 10.15.x versions              | 3.7, 3.8, 3.9                  |
+-------------------------------------+--------------------------------+
| Windows 10 Pro, Enterprise          | 3.7, 3.8, 3.9                  |
...
.. tab:: WINDOWS
   ...
   1. **Install Python**
      ...
      Download 64 bit version of Python software (3.7, 3.8, 3.9) from  `python.org`_. 
