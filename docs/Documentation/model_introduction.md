...
:doc:`OpenVINO™ supports several model formats <Supported_Model_Formats>` and can read them without any prior conversion, therefore reducing application start time.
