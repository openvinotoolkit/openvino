...
**Short description**: *ReduceMax* operation performs reduction with finding the maximum value, on a given input `data`, along dimensions specified by `axes` input.

**Detailed Description**

*ReduceMax* operation performs reduction with finding the maximum value, on a given input `data`, along dimensions specified by `axes` input.
...
1. If `axes` is an empty list, then *ReduceMax* corresponds to identity operation. 
