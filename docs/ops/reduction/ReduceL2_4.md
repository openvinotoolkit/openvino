...
**Short description**: *ReduceL2* operation performs reduction with finding the L2 norm (square root of sum of squares), on a given input `data`, along dimensions specified by `axes` input.

**Detailed Description**

*ReduceL2* operation performs reduction with finding the L2 norm (square root of sum of squares), on a given input `data`, along dimensions specified by `axes` input.
...
1. If `axes` is an empty list, then *ReduceL2* corresponds to identity operation. 
