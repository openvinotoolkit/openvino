...
**Short description**: *ReduceProd* operation performs reduction with multiplication, on a given input `data`, along dimensions specified by `axes` input.

**Detailed Description**

*ReduceProd* operation performs reduction with multiplication, on a given input `data`, along dimensions specified by `axes` input.
...
1. If `axes` is an empty list, then *ReduceProd* corresponds to identity operation. 
