...
@snippet openvino/docs/examples/Bfloat16Inference0.cpp
...
@snippet openvino/docs/examples/Bfloat16Inference1.cpp
...
@snippet openvino/docs/examples/Bfloat16Inference2.cpp
