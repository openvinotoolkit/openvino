...
@snippet openvino/docs/examples/Bfloat16Inference0.cpp part0
...
@snippet openvino/docs/examples/Bfloat16Inference1.cpp part1
...
@snippet openvino/docs/examples/Bfloat16Inference2.cpp part2
