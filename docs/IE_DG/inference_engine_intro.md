...
| HETERO | `libhetero_plugin.so`        | Same as for selected plugins                                | `hetero_plugin.dll`       | Same as for selected plugins                                                                           | `libhetero_plugin.so`      |  Same as for selected plugins               |
