...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part0
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part3
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part4
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part5
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part6

5) **Create an infer request**:

@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part7
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part8
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part9
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part10
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part11
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part12

or by calling the `InferenceEngine::InferRequest::Infer` method for synchronous request:

@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part13
...
@snippet openvino/docs/examples/Integrate_with_customer_application_new_API.cpp part14
