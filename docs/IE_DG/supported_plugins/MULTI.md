...
@snippet openvino/docs/examples/MULTI2.cpp
...
@snippet openvino/docs/examples/MULTI3.cpp
...
@snippet openvino/docs/examples/MULTI4.cpp
...
@snippet openvino/docs/examples/MULTI5.cpp
