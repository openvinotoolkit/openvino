...
* All [12th Generation Intel® Core™ Processors (formerly codenamed Alder Lake)](https://ark.intel.com/content/www/us/en/ark/products/codename/147470/products-formerly-alder-lake.html).
...
<b>Table of Maximum Input Tensor Widths (W) vs. Rest of Parameters</b><br>
(Input and Kernel Precision: 2 bytes)<br>
...
<b>Table of Maximum Input Tensor Widths (W) vs. Rest of Parameters</b><br>
(Input and Kernel Precision: 1 bytes)<br>
...
#### Support for 2D Convolutions in GNA HW of previous generations
...
| :---------------------------------| :---------------------------------------------------------| :-----------| :------------------------------------------------------------------------|
| `KEY_GNA_EXEC_TARGET`             | `TARGET_2_0`/`TARGET_3_0`                                 | _see below_       | Defines the execution target.              |
| `KEY_GNA_COMPILE_TARGET`          | `TARGET_2_0`/`TARGET_3_0`                                 | The same as `KEY_GNA_EXEC_TARGET`       | Defines the compilation target.              |
...
| `KEY_GNA_DEVICE_MODE`             | `GNA_AUTO`/`GNA_HW`/<br/>`GNA_HW_WITH_SW_FBACK`/`GNA_SW_EXACT`/<br/>`GNA_SW_FP32` | `GNA_AUTO`  |  One of the modes described in <a href="#execution-modes">Execution Modes</a> |
