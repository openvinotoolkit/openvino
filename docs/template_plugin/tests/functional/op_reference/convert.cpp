...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        ConvertParams(ConversionTypes::CONVERT, ov::PartialShape {4}, ov::element::f32, ov::element::i16, std::vector<float> {-1, -2, 2, 3.8},
                      std::vector<int16_t> {-1, -2, 2, 3}),
        // destination i32
        ...
        ConvertParams(ConversionTypes::CONVERT, ov::PartialShape {4}, ov::element::f32, ov::element::i32, std::vector<float> {-1, -2, 2, 3.8},
                      std::vector<int32_t> {-1, -2, 2, 3}),
        // destination i64
        ...
        ConvertParams(ConversionTypes::CONVERT, ov::PartialShape {4}, ov::element::f32, ov::element::i64, std::vector<float> {-1, -2, 2, 3.8},
                      std::vector<int64_t> {-1, -2, 2, 3}),
        ...
        ConvertParams(ConversionTypes::CONVERT, ov::PartialShape {4}, ov::element::f32, ov::element::u16, std::vector<float> {1, 2, 2, 3.8},
                      std::vector<uint16_t> {1, 2, 2, 3}),
        ...
        ConvertParams(ConversionTypes::CONVERT, ov::PartialShape {4}, ov::element::f32, ov::element::u32, std::vector<float> {1, 2, 2, 3.8},
                      std::vector<uint32_t> {1, 2, 2, 3}),
        // destination u64
        ...
        ConvertParams(ConversionTypes::CONVERT, ov::PartialShape {4}, ov::element::f32, ov::element::u64, std::vector<float> {1, 2, 2, 3.8},
                      std::vector<uint64_t> {1, 2, 2, 3})),
