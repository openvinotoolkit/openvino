...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f16, ngraph::element::i8,
                      std::vector<ngraph::float16> {-1, -2, 0, 3.8}, std::vector<int8_t> {-1, -2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::bf16, ngraph::element::i8,
                      std::vector<ngraph::bfloat16> {-1, -2, 0, 3.8}, std::vector<int8_t> {-1, -2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f32, ngraph::element::i8, std::vector<float> {-1, -2, 2.2, 3.8},
                      std::vector<int8_t> {-1, -2, 2, 3}),
        // destination i16
        ...
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f16, ngraph::element::i16,
                      std::vector<ngraph::float16> {-1, -2, 0, 3.8}, std::vector<int16_t> {-1, -2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::bf16, ngraph::element::i16,
                      std::vector<ngraph::bfloat16> {-1, -2, 0, 3.8}, std::vector<int16_t> {-1, -2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f32, ngraph::element::i16, std::vector<float> {-1, -2, 2, 3.8},
                      std::vector<int16_t> {-1, -2, 2, 3}),
        // destination i32
        ...
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f16, ngraph::element::i32,
                      std::vector<ngraph::float16> {-1, -2, 0, 3.8}, std::vector<int32_t> {-1, -2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::bf16, ngraph::element::i32,
                      std::vector<ngraph::bfloat16> {-1, -2, 0, 3.8}, std::vector<int32_t> {-1, -2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f32, ngraph::element::i32, std::vector<float> {-1, -2, 2, 3.8},
                      std::vector<int32_t> {-1, -2, 2, 3}),
        // destination i64
        ...
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f16, ngraph::element::i64,
                      std::vector<ngraph::float16> {-1, -2, 0, 3.8}, std::vector<int64_t> {-1, -2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::bf16, ngraph::element::i64,
                      std::vector<ngraph::bfloat16> {-1, -2, 0, 3.8}, std::vector<int64_t> {-1, -2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f32, ngraph::element::i64, std::vector<float> {-1, -2, 2, 3.8},
                      std::vector<int64_t> {-1, -2, 2, 3}),
        ...
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::i64, ngraph::element::u8, std::vector<int64_t> {1, 2, 2, 3},
                      std::vector<uint8_t> {1, 2, 2, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f16, ngraph::element::u8,
                      std::vector<ngraph::float16> {1, 2, 0, 3.8}, std::vector<uint8_t> {1, 2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::bf16, ngraph::element::u8,
                      std::vector<ngraph::bfloat16> {1, 2, 0, 3.8}, std::vector<uint8_t> {1, 2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f32, ngraph::element::u8, std::vector<float> {1, 2, 2.2, 3.8},
                      std::vector<uint8_t> {1, 2, 2, 3}),
        ...
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::i64, ngraph::element::u16, std::vector<int64_t> {1, 2, 2, 3},
                      std::vector<uint16_t> {1, 2, 2, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f16, ngraph::element::u16,
                      std::vector<ngraph::float16> {1, 2, 0, 3.8}, std::vector<uint16_t> {1, 2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::bf16, ngraph::element::u16,
                      std::vector<ngraph::bfloat16> {1, 2, 0, 3.8}, std::vector<uint16_t> {1, 2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f32, ngraph::element::u16, std::vector<float> {1, 2, 2, 3.8},
                      std::vector<uint16_t> {1, 2, 2, 3}),
        ...
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::i64, ngraph::element::u32, std::vector<int64_t> {1, 2, 2, 3},
                      std::vector<uint32_t> {1, 2, 2, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f16, ngraph::element::u32,
                      std::vector<ngraph::float16> {1, 2, 0, 3.8}, std::vector<uint32_t> {1, 2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::bf16, ngraph::element::u32,
                      std::vector<ngraph::bfloat16> {1, 2, 0, 3.8}, std::vector<uint32_t> {1, 2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f32, ngraph::element::u32, std::vector<float> {1, 2, 2, 3.8},
                      std::vector<uint32_t> {1, 2, 2, 3}),
        // destination u64
        ...
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::i64, ngraph::element::u64, std::vector<int64_t> {1, 2, 2, 3},
                      std::vector<uint64_t> {1, 2, 2, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f16, ngraph::element::u64,
                      std::vector<ngraph::float16> {1, 2, 0, 3.8}, std::vector<uint64_t> {1, 2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::bf16, ngraph::element::u64,
                      std::vector<ngraph::bfloat16> {1, 2, 0, 3.8}, std::vector<uint64_t> {1, 2, 0, 3}),
        ConvertParams(ConversionTypes::CONVERT, ngraph::PartialShape {4}, ngraph::element::f32, ngraph::element::u64, std::vector<float> {1, 2, 2, 3.8},
                      std::vector<uint64_t> {1, 2, 2, 3})),
