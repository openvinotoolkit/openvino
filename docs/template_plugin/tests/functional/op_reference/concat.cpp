...
private:
    static std::shared_ptr<Function> CreateFunction(const ConcatParams& params) {
        ...
        auto f = std::make_shared<Function>(std::make_shared<op::v0::Concat>(NodeVector{A, B, C}, params.axis), ParameterVector{A, B, C});
        return f;
    }
};
...
public:
    void SetUp() override {
        ...
        function = std::make_shared<Function>(std::make_shared<op::v0::Concat>(inputs, 0), inputs_param);
...
private:
    static std::shared_ptr<Function> CreateFunction(const ConcatParamsInPlace2dTensor& params) {
        ...
        const auto f = std::make_shared<Function>(
            std::make_shared<op::v0::Concat>(NodeVector{add1, add2, subtract}, params.axis),
...
private:
    static std::shared_ptr<Function> CreateFunction(const ConcatParamsInPlacePropagate2dTensor& params) {
        ...
        const auto subtract = std::make_shared<op::v1::Subtract>(C, A);
        const auto f = std::make_shared<Function>(
            std::make_shared<op::v0::Concat>(NodeVector{concat1, subtract}, params.axis),
                                             ParameterVector{A, B, C, D});
        return f;
    }
};
...
private:
    static std::shared_ptr<Function> CreateFunction(const ConcatParamsInPlaceTree1& params) {
        ...
        const auto f = std::make_shared<Function>(std::make_shared<op::v1::Add>(concat, concat),
                                                  ParameterVector{A, B});
        return f;
    }
};
...
private:
    static std::shared_ptr<Function> CreateFunction(const ConcatParamsInPlaceTree2& params) {
        ...
        const auto f = std::make_shared<Function>(std::make_shared<op::v1::Add>(concat12, concat12),
                                                  ParameterVector{A, B});
        return f;
    }
};
...
private:
    static std::shared_ptr<Function> CreateFunction(const ConcatParamsInPlaceTree3& params) {
        ...
        const auto f = std::make_shared<Function>(std::make_shared<op::v1::Add>(concat14, concat14),
                                                  ParameterVector{A, B});
        return f;
    }
};
