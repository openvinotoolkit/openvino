...
struct LogSoftmaxParams {
    template <class IT>
    LogSoftmaxParams(const PartialShape& shape, const element::Type& iType, const std::vector<IT>& iValues, const std::vector<IT>& oValues,
                const int64_t axis)
        : axis(axis),
          pshape(shape),
          inType(iType),
...
private:
    static std::shared_ptr<Function> CreateFunction(const PartialShape& input_shape, const element::Type& input_type,
        ...
        return std::make_shared<Function>(NodeVector {LogSoftmax}, ParameterVector {in});
    }
};
...
std::vector<LogSoftmaxParams> generateLogSoftmaxFloatParams() {
    ...
    std::vector<LogSoftmaxParams> logSoftmaxParams {
        LogSoftmaxParams(ngraph::PartialShape {1},
                    IN_ET,
                    std::vector<T>{1},
                    std::vector<T>{0},
                    0),
        LogSoftmaxParams(ngraph::PartialShape {2, 4},
                    IN_ET,
        ...
        LogSoftmaxParams(ngraph::PartialShape {2, 4},
                    ...
                    std::vector<T>{-10000., -10000., -10000., -10000., 0., 0., 0., 0.},
                    -2),
        LogSoftmaxParams(ngraph::PartialShape {3, 2, 3},
                    IN_ET,
