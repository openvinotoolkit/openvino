...
INSTANTIATE_TEST_SUITE_P(Convolution2D_ExplicitPadding, ConvolutionLayerTest,
                        ::testing::Combine(
                                ...
                                ::testing::Values(InferenceEngine::Layout::ANY),
                                ::testing::Values(std::vector<std::vector<size_t >>({{1, 10}, {3, 30}, {30, 300}, {30, 300}})),
...
INSTANTIATE_TEST_SUITE_P(Convolution2D_AutoPadValid, ConvolutionLayerTest,
                        ::testing::Combine(
                                ...
                                ::testing::Values(InferenceEngine::Layout::ANY),
                                ::testing::Values(InferenceEngine::Layout::ANY),
                                ::testing::Values(std::vector<std::vector<size_t >>({{1, 1}, {3, 3}, {30, 30}, {30, 30}})),
                                ::testing::Values(std::vector<size_t >({1, 3, 30, 30})),
                                ::testing::Values(CommonTestUtils::DEVICE_TEMPLATE)),
                        ConvolutionLayerTest::getTestCaseName);
...
INSTANTIATE_TEST_SUITE_P(smoke_Convolution3D_ExplicitPadding, ConvolutionLayerTest,
                        ::testing::Combine(
                                ...
                                ::testing::Values(InferenceEngine::Layout::ANY),
                                ::testing::Values(InferenceEngine::Layout::ANY),
                                ::testing::Values(std::vector<std::vector<size_t >>({{1, 1}, {3, 3}, {10, 10}, {10, 10}, {10, 10}})),
