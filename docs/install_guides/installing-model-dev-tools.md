...
* To install OpenVINO Development Tools, you must have OpenVINO Runtime installed first. You can install OpenVINO Runtime through a docker ([Linux](installing-openvino-docker-linux.md), [Windows](installing-openvino-docker-windows.md)). 
