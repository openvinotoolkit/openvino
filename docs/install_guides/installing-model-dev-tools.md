...
* To install OpenVINO Development Tools, you must have OpenVINO Runtime installed first. You can install OpenVINO Runtime through archive files. See [Install OpenVINO on Linux from Archives](installing-openvino-from-archive-linux.md), [Install OpenVINO on Windows from Archives](installing-openvino-from-archive-windows.md), and [Install OpenVINO on macOS from Archives](installing-openvino-from-archive-macos.md) for more details. 
