...
> **NOTE**: These steps are only required for **IEI Mustang-V100-MX8-R10** card only. **IEI Mustang-V100-MX8-R11** card doesn't require any additional steps and it's completely configured using the [general guidance](https://docs.openvinotoolkit.org/2021.1/openvino_docs_install_guides_installing_openvino_linux_ivad_vpu.html).      
## See Also
