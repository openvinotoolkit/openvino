...
.. toctree::
   ...
   From Archives <openvino_docs_install_guides_installing_openvino_from_archive_macos>
...
* [Install OpenVINO Runtime from Archive Files](installing-openvino-from-archive-macos.md)
