...
To start with C++ samples, see <a href="openvino_docs_OV_UG_Samples_Overview.html#build_samples_macos">Build Sample Applications on macOS</a> first, and then you can try the following samples:
