...
**If you have already finished your model development and want to deploy your applications on various devices, [install OpenVINO Runtime](installing-openvino-runtime.md)**. It contains a set of libraries for easy inference integration with your products.
