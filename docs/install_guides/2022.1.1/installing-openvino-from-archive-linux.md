...
To start with C++ samples, see [Build Sample Applications on Linux](../../OV_Runtime_UG/Samples_Overview.mdS#build_samples_linux) first, and then you can try the following samples:
