# Install Intel® Distribution of OpenVINO™ toolkit for Windows and macOS Using Package Managers {#openvino_docs_install_guides_install_using_package_managers_win_mac}
