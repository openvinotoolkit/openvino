...
2. Download the `OpenVINO Runtime archive file for Windows <https://storage.openvinotoolkit.org/repositories/openvino/packages/2023.1.0/windows/>`__ to your local ``Downloads`` folder.
   ...
   .. code-block:: sh
      ...
      curl -L https://storage.openvinotoolkit.org/repositories/openvino/packages/2023.1.0/windows/w_openvino_toolkit_windows_2023.1.0.11005.fa1c41994f3_x86_64.zip --output openvino_2023.1.0.zip
