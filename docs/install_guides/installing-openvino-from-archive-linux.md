...
To start with C++ samples, see <a href="openvino_docs_OV_UG_Samples_Overview.html#build_samples_linux">Build Sample Applications on Linux</a> first, and then you can try the following samples:
