...
@snippet openvino/docs/examples/movidius-programming-guide.cpp part0

### Declare a Vector of Requests

@snippet openvino/docs/examples/movidius-programming-guide.cpp part1
...
@snippet openvino/docs/examples/movidius-programming-guide.cpp part2

@snippet openvino/docs/examples/movidius-programming-guide.cpp part3
...
@snippet openvino/docs/examples/movidius-programming-guide.cpp part4
