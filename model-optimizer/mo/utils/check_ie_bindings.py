...
def import_core_modules(silent: bool, path_to_module: str):
    ...
    try:
        ...
        from openvino.pyopenvino import PartialShape, Dimension  # pylint: disable=import-error,no-name-in-module
        ...
        print("\t- {}: \t{}".format("nGraph found in", os.path.dirname(openvino.__file__)))
