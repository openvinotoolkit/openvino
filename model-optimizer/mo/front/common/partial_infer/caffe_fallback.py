...
def caffe_native_node_infer(node: Node):
    ...
    """
    log.error("Caffe fallback is deprecated. It will be removed in future releases. Please use extensions for "
              "unsupported layers.\n See more information in the \"Custom Layers in the Model Optimizer\" chapter "
              "of the Model Optimizer Developer Guide",
