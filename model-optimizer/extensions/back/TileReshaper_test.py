...
nodes_attributes_ref = {
    ...
    'reshape_op_before': {'type': 'Reshape', 'kind': 'op'},
    'reshape_op_before_const': {'kind': 'op', 'type': 'Const', 'op': 'Const', 'value': int64_array([1, 1, 101, 1]), 'shape': [4]},
    'reshape_op_before_const_data': {'kind': 'data', 'value': int64_array([1, 1, 101, 1]), 'shape': [4]},
    ...
    'reshape_op_after': {'type': 'Reshape', 'kind': 'op'},
    'reshape_op_after_const': {'kind': 'op', 'type': 'Const', 'op': 'Const', 'value': int64_array([1, 16, 101]), 'shape': [3]},
    'reshape_op_after_const_data': {'kind': 'data', 'value': int64_array([1, 16, 101]), 'shape': [3]},
