...
"""
from extensions.ops.ReduceOps import ReduceProd, ReduceAnd, ReduceMax, ReduceMean, ReduceSum, AttributedReduceLp
...
class EuclideanNormFrontExtractor(FrontExtractorOp):
    ...
    @classmethod
    def extract(cls, node: Node):
        AttributedReduceLp.update_node_stat(node, {'keep_dims': node.pb.attr["keep_dims"].b, 'p': 2})
        return cls.enabled
