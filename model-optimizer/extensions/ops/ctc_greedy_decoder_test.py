...
class TestCTCGreedyDecoder(unittest.TestCase):
    def test_infer1(self):
        ...
        ref_output2_shape = int64_array([4])

        # get the result
        res_output1_shape = graph.node['output1']['shape']
        res_output2_shape = graph.node['output2']['shape']
        ...
        self.assertTrue(np.array_equal(ref_output2_shape, res_output2_shape),
                        'shapes do not match expected: {} and given: {}'.format(ref_output2_shape, res_output2_shape))
