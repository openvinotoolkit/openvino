...
from extensions.middle.ATenToEmbeddingBag import AtenToEmbeddingBag
from mo.front.common.partial_infer.utils import int64_array
from mo.utils.ir_engine.compare_graphs import compare_graphs
from mo.utils.unittest.graph import build_graph, const, regular_op_with_shaped_data, valued_const_with_data, result, \
    connect

nodes_attributes = {
    **const('weights_inp', np.random.randn(1000, 10)),
    'indices_inp': {'shape': None, 'type': 'Parameter', 'kind': 'op', 'op': 'Parameter'},
    'offsets_inp': {'shape': None, 'type': 'Parameter', 'kind': 'op', 'op': 'Parameter'},
    **const('per_sample_weights', np.random.randn(20)),
    ...
    def test(self):
        nodes = {
            ...
            **regular_op_with_shaped_data('aten', [10, 2],
                                          {'type': None, 'kind': 'op', 'op': 'ATen', 'mode': 0,
                                           'operator': 'embedding_bag', 'name': 'my_aten'}),
