...
class FusedBatchNormTrainingTest(unittest.TestCase):
    ...
    def test_transformation(self, op: str):
        ...
        graph.nodes['batchnorm_train']['op'] = op
        graph_ref = build_graph(nodes_attributes,
                                [('placeholder', 'placeholder_data', {}),
                                 ...
                                 ('scale_data', 'batchnorm_train', {'in': 1}),
                                 ('offset_data', 'batchnorm_train', {'in': 2}),
                                 ('bn_mean_data', 'batchnorm_train', {'in': 3}),
                                 ('bn_variance_data', 'batchnorm_train', {'in': 4}),
                                 ...
                                 ('reshape_to_orig_data', 'batchnorm_train', {'in': 0}),
        ...
        graph_ref.nodes['batchnorm_train']['op'] = op
    ...
    def test_non_training(self):
        graph = build_graph(nodes_attributes,
                            [('placeholder', 'placeholder_data', {}),
                             ...
                             ('mean_data', 'batchnorm_train', {'in': 3}),
                             ('variance_data', 'batchnorm_train', {'in': 4}),
                             ('batchnorm', 'batchnorm_train_data'),
