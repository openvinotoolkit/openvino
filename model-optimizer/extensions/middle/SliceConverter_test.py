...
nodes_attributes = {
    ...
    **valued_const_with_data('ss_begin_clamp_min', int64_array([np.iinfo(np.int32).min])),
    **valued_const_with_data('ss_begin_clamp_max', int64_array([np.iinfo(np.int32).max])),
    ...
    **valued_const_with_data('ss_end_clamp_min', int64_array([np.iinfo(np.int32).min])),
    **valued_const_with_data('ss_end_clamp_max', int64_array([np.iinfo(np.int32).max])),
...
pattern_ref_graph = [
    ...
    *connect('starts:0', '0:ss_begin_cast'),
    *connect('ss_begin_cast:0', '0:ss_begin_clamp'),
    *connect('ss_begin_clamp_min:0', '1:ss_begin_clamp'),
    *connect('ss_begin_clamp_max:0', '2:ss_begin_clamp'),
    *connect('ss_begin_concat:0', '1:ss'),
    *connect('ends:0', '0:ss_end_cast'),
    *connect('ss_end_cast:0', '0:ss_end_clamp'),
    ...
    def test_convert_slice_to_strided_slice_one_axis(self):
        ...
        ref_graph = build_graph(
            ...
            edges=pattern_ref_graph + [
                *connect('ss_begin_clamp:0', '0:ss_begin_gather_0'),
                ...
                *connect('ss_end_clamp:0', '0:ss_end_gather_0'),
    ...
    def test_convert_slice_to_strided_slice_two_axes(self):
        ...
        ref_graph = build_graph(
            ...
            edges=pattern_ref_graph + [
                *connect('ss_begin_clamp:0', '0:ss_begin_gather_0'),
                *connect('ss_begin_gather_0:0', '2:ss_begin_concat'),
                *connect_data('ss_begin_clamp:0', '0:ss_begin_gather_1'),
                ...
                *connect('ss_end_clamp:0', '0:ss_end_gather_0'),
                *connect('ss_end_gather_0:0', '2:ss_end_concat'),
                *connect_data('ss_end_clamp:0', '0:ss_end_gather_1'),
    ...
    def test_convert_slice_to_strided_slice_three_axes(self):
        ...
        ref_graph = build_graph(
            ...
            edges=pattern_ref_graph + [
                ...
                *connect_data('ss_begin_clamp:0', '0:ss_begin_gather_2'),
                ...
                *connect_data('ss_end_clamp:0', '0:ss_end_gather_2'),
    ...
    def test_convert_slice_to_strided_slice_not_sorted_axes(self):
        ...
        ref_graph = build_graph(
            ...
            edges=pattern_ref_graph + [
                ...
                *connect_data('ss_begin_clamp:0', '0:ss_begin_gather_2'),
                *connect('ss_begin_gather_2:0', '3:ss_begin_concat'),
                *connect_data('ss_begin_clamp:0', '0:ss_begin_gather_3'),
                ...
                *connect_data('ss_end_clamp:0', '0:ss_end_gather_2'),
                *connect('ss_end_gather_2:0', '3:ss_end_concat'),
                *connect_data('ss_end_clamp:0', '0:ss_end_gather_3'),
