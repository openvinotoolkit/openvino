...
ref_graph_node_attrs_with_4_inputs_interpolate = {
    ...
    'cast_mul_to_int': {'kind': 'op', 'op': 'Cast', 'type': 'Convert', 'dst_type': np.int64},
    'cast_mul_to_int_data': {'kind': 'data', 'shape': None},
    'scales': {
        'kind': 'op',
        'op': 'Const',
        'type': 'Const',
...
ref_graph_edges_attrs_with_4_inputs_interpolate = [
    ...
    ('mul_data', 'floor'),
    ('floor', 'floor_data'),
    ('floor_data', 'cast_mul_to_int'),
    ('cast_mul_to_int', 'cast_mul_to_int_data'),
    ('scales', 'scales_data'),
    ('axes', 'axes_data'),
    ('scales_data', 'interpolate', {'out': 0, 'in': 2}),
    ('cast_mul_to_int_data', 'interpolate', {'in': 1}),
