...
ref_nodes = {**regular_op_with_shaped_data('input', shape, {'type': 'Parameter', 'op': 'Parameter'}),
             ...
             **regular_op_with_shaped_data('shape2', int64_array([5]), {'op': 'ShapeOf'}),
             ...
             **regular_op_with_shaped_data('cast3', int64_array([5]), {'op': 'Cast'}),
             **regular_op_with_shaped_data('cast4', int64_array([1]), {'op': 'Cast'}),
             ...
             **regular_op_with_shaped_data('concat', int64_array([5]), {'op': 'Concat'}),
             **regular_op_with_shaped_data('reshape1', int64_array([1, 3, 1, 5, 2]), {'op': 'Reshape'}),
             ...
             **regular_op_with_shaped_data('mvn', int64_array([1, 3, 1, 5, 2]), {'op': 'MVN'}),
             ...
             **valued_const_with_data('range/start', int64_array(2)),
...
ref_edges = [*connect('input', '0:reshape1'),
             ...
             *connect('gather2', '0:concat'),
             *connect('cast4', '1:concat'),
             *connect('mul1', '2:concat'),
             *connect('cast2', '3:concat'),
