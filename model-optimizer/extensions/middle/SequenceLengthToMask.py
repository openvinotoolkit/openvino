...
class SequenceLengthToMask(MiddleReplacementPattern):
    ...
    def replace_pattern(self, graph: Graph, match: dict):
        ...
        for sample_ind in range(batch_size):
            sample_seq_length = sequence_length_value[sample_ind]
            sample_mask_value = np.zeros([time_size])
            sample_mask_value[0:sample_seq_length] = 1
            mask_value[sample_ind, :] = sample_mask_value
