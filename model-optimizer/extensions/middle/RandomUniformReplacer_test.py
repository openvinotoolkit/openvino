...
from extensions.middle.RandomUniformReplacer import RandomUniformReplacer, DropoutReplacer
...
nodes_attributes = {
    ...
    # additional nodes for DropoutReplacerTest
    'mul_data': {'kind': 'data'},
    'add': {'kind': 'op', 'op': 'Add'},
    'add_data': {'kind': 'data'},
...
class DropoutReplacerTest(unittest.TestCase):
    def test_1(self):
        graph = build_graph(nodes_attributes,
                            edges=[
                                ('shape', 'shape_data'),
        ...
        DropoutReplacer().find_and_replace_pattern(graph)
