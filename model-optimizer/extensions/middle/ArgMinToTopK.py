...
class ArgMaxToTopK(MiddleReplacementPattern):
    """
        The transformation replaces ArgMin with the TopK layer.
    """
    enabled = True
    force_clean_up = True
    ...
    def replace_pattern(self, graph: Graph, match: dict):
        ...
        topk_node = TopK(graph, {'axis': axis, 'mode': 'min', 'sort': 'index',
        ...
        if node.has_and_set('out_min_val'):
        ...
        topk_node.in_port(1).connect(Const(graph, {'name': node_name + '/TopK',
