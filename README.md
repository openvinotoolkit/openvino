...
- **Flexible Model Support**: Use models trained with popular frameworks such as PyTorch, TensorFlow, ONNX, Keras, and PaddlePaddle. Directly integrate models built with transformers and diffusers from the HuggingFace Hub using Optimum Intel. Convert and deploy models without original frameworks.
