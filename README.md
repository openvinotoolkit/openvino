...
-   [Keras 3](https://github.com/keras-team/keras) - Keras 3 is a multi-backend deep learning framework. User can switch on the OpenVINO backend for models inference using Keras API.
