...
Also OpenVINO™ Toolkit contains several plugins which should simplify loading model on several hardware devices:
<table>
    <thead>
        <tr>
            <th>Plugin</th>
...
[Developer documentation](./docs/dev/index.md) contains information about architectural decisions which are applied inside the OpenVINO components. This documentation provides all the necessary information you may need to contribute to OpenVINO.
...
* [DL Workbench](https://docs.openvino.ai/nightly/workbench_docs_Workbench_DG_Introduction.html) - an alternative, web-based version of OpenVINO designed to significantly facilitate production of pre-trained deep learning models.
