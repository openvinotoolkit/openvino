...
void regclass_graph_op_util_Variable(py::module m) {
    ...
    variable_info.def_readwrite("shape", &ov::op::util::VariableInfo::data_shape);
    variable_info.def_readwrite("type", &ov::op::util::VariableInfo::data_type);
    variable_info.def_readwrite("id", &ov::op::util::VariableInfo::variable_id);
