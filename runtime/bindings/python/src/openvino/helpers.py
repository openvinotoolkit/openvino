...
from openvino.impl import Function, PartialShape
from openvino import IENetwork, DataPtr, CDataPtr


def function_from_cnn(cnn_network: IENetwork) -> Function:
    """Get Graph function from Inference Engine CNN network."""
...
def function_to_cnn(ng_function: Function) -> Function:
    """Get Inference Engine CNN network from Graph function."""
...
def partial_shape_from_data(data: Union[DataPtr, CDataPtr]) -> PartialShape:
    """Get Graph PartialShape from Inference Engine Data."""
