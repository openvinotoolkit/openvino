...
def verify(sample_language, device, api=None, nireq=None, shape=None, data_shape=None, nstreams=None, layout=None, pin=None, cache=None, tmp_path=None, model='bvlcalexnet-12.onnx', inp='dog-224x224.bmp', batch='1', niter='10', tm=None, cpu_core_ids=None):
...
def test_cpu_core_ids(sample_language, device, cpu_core_ids, cache, tmp_path):
    verify(sample_language, device, nstreams='2', cache=cache, tmp_path=tmp_path, cpu_core_ids=cpu_core_ids)
