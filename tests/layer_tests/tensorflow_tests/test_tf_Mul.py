...
class TestMul(CommonTFLayerTest):
    ...
    @pytest.mark.nightly
    def test_mul_placeholder_const_1D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_mul_placeholder_const_net(**params),
            ie_device,
            precision,
            ir_version,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    def test_mul_placeholder_const_3D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_mul_placeholder_const_net(**params),
    ...
    @pytest.mark.nightly
    def test_mul_placeholder_const_4D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_mul_placeholder_const_net(**params),
    ...
    @pytest.mark.nightly
    def test_mul_placeholder_const_5D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_mul_placeholder_const_net(**params),
    ...
    test_data_broadcast_1D = [dict(x_shape=[3], y_shape=[1])]  # Power

    @pytest.mark.parametrize("params", test_data_broadcast_1D)
    @pytest.mark.nightly
    def test_mul_placeholder_const_broadcast_1D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_mul_placeholder_const_net(**params),
    ...
    @pytest.mark.nightly
    def test_mul_placeholder_const_broadcast_2D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_mul_placeholder_const_net(**params),
    ...
    test_data_broadcast_5D = [
        ...
        pytest.param(
            dict(x_shape=[1, 3, 1, 1, 1], y_shape=[3]), marks=pytest.mark.precommit
        ),
    ...
    @pytest.mark.nightly
    def test_mul_placeholder_const_broadcast_5D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_mul_placeholder_const_net(**params),
