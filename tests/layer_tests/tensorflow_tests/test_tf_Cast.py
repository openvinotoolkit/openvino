...
class TestCastOp(CommonTFLayerTest):
    ...
    def create_cast_op_placeholder_const_net(
        self,
        input_shape,
        input_type,
        output_type,
        ...
        with tf.compat.v1.Session() as sess:
            tf_input = tf.compat.v1.placeholder(
                tf_types[input_type], input_shape, "Input"
            )
    ...
    test_data = [
        pytest.param(
            dict(input_shape=[2, 3]), marks=pytest.mark.precommit  # Simple test
        ),
    ...
    @pytest.mark.nightly
    def test_cast_op_placeholder_const(
        self,
        params,
        input_type,
        output_type,
        ...
        self._test(
            *self.create_cast_op_placeholder_const_net(
                **params,
