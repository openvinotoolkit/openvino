...
class TestStringToHashBucketFast(CommonTFLayerTest):
    ...
    def create_string_to_hash_bucket_fast_net(
        self, input_shape, strings_dictionary, num_buckets
    ):
    ...
    def test_string_to_hash_bucket_fast(
        self,
        input_shape,
        num_buckets,
        strings_dictionary,
        ...
        self._test(
            *self.create_string_to_hash_bucket_fast_net(
