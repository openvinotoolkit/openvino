        ...
        with tf.compat.v1.Session() as sess:
            ...
            if pad_op == "Pad":
                ...
                tf.raw_ops.MirrorPad(
                    input=placeholder, paddings=paddings, mode=pad_mode, name="pad"
                )
...
class TestComplexPad(CommonTFLayerTest):
    ...
    def test_pad_complex(
        ...
        self._test(
            *self.create_pad_complex_net(**params),
            ie_device,
            precision,
            ir_version,
            temp_dir=temp_dir,
...
class TestComplexPadV2(CommonTFLayerTest):
    ...
    test_data_basic = [
        ...
        dict(
            input_shape=[2, 20, 10],
            pads_values=[[0, 1], [2, 3], [4, 0]],
            const_value=(0.0, 1.0),
        ),
        dict(
            input_shape=[1, 5, 10, 3],
            pads_values=[[1, 1], [0, 0], [4, 0], [1, 1]],
            const_value=(1.0, 2.0),
        ),
    ]
