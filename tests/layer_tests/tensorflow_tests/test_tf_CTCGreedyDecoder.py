...
class TestCTCGreedyDecoder(CommonTFLayerTest):
    ...
    def create_ctcgreedydecoder_placeholder_const_net(
        self, input_shape, merge_repeated, ir_version, use_legacy_frontend
    ):
        """
        ...
        with tf.compat.v1.Session() as sess:
            ...
            ctc_gd = tf.raw_ops.CTCGreedyDecoder(
                inputs=tf_inputs,
    ...
    @pytest.mark.nightly
    def test_ctcgreedydecoder_placeholder_const(
        self,
        params,
        merge_repeated,
        ie_device,
        ...
        if ie_device == "GPU":
            pytest.xfail("104860")
        self._test(
            *self.create_ctcgreedydecoder_placeholder_const_net(
                **params,
