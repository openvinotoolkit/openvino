...
class TestConv3D(CommonTFLayerTest):
    ...
    def create_conv3d_placeholder_const_net(
        self,
        input_shape,
        input_filter,
        input_strides,
        ...
        with tf.compat.v1.Session() as sess:
            ...
            tf_filter = tf.compat.v1.placeholder(
                tf.float32, input_filter, "InputFilter"
            )
    ...
    test_data = [
        dict(
            input_shape=[1, 10, 10, 10, 1],
            input_filter=[3, 3, 3, 1, 1],
            input_strides=[1, 1, 1, 1, 1],
            dilations=None,
        ),
        dict(
            input_shape=[1, 10, 10, 10, 2],
            input_filter=[3, 3, 3, 2, 2],
            input_strides=[1, 1, 1, 1, 1],
            dilations=None,
        ),
        dict(
            input_shape=[1, 10, 10, 10, 2],
            input_filter=[3, 3, 3, 2, 1],
            input_strides=[1, 1, 1, 1, 1],
            dilations=None,
        ),
        dict(
            input_shape=[1, 16, 16, 16, 3],
            input_filter=[4, 2, 4, 3, 3],
            input_strides=[1, 2, 2, 2, 1],
            dilations=None,
        ),
        dict(
            input_shape=[1, 10, 10, 20, 3],
            input_filter=[2, 4, 2, 3, 3],
            input_strides=[1, 2, 2, 2, 1],
            dilations=None,
        ),
        dict(
            input_shape=[1, 10, 10, 10, 4],
            input_filter=[3, 3, 3, 4, 2],
            input_strides=[1, 1, 1, 1, 1],
            dilations=None,
        ),
        dict(
    ...
    @pytest.mark.nightly
    def test_conv3d_placeholder_const(
        self,
        params,
        padding,
        ie_device,
        ...
        if ie_device == "GPU":
            pytest.skip(
                "Unable to convert data format b_fs_zyx_fsv16 to weights format issue on GPU"
            )
        self._test(
            *self.create_conv3d_placeholder_const_net(
                **params,
