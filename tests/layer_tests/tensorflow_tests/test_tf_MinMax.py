...
class TestMinMaxOps(CommonTFLayerTest):
    ...
    def create_minmax_ops_placeholder_const_net(
        self, input_shape, axis, op_type, keep_dims, ir_version, use_legacy_frontend
    ):
        """
    ...
    @pytest.mark.nightly
    def test_minmax_ops_placeholder_const(
        self,
        params,
        op_type,
        keep_dims,
        ...
        self._test(
            *self.create_minmax_ops_placeholder_const_net(
                **params,
                op_type=op_type,
