...
class TestConv2D(CommonTFLayerTest):
    ...
    def create_conv2d_placeholder_const_net(
        self,
        input_shape,
        input_filter,
        input_strides,
        ...
        with tf.compat.v1.Session() as sess:
            ...
            if input_padding != "EXPLICIT":
                ...
                tf.raw_ops.Conv2D(
                    ...
                    strides=input_strides,
                    padding=input_padding,
                    explicit_paddings=expl_paddings,
                    dilations=dilations,
                )
    ...
    test_data = [
        dict(
            ...
            input_filter=[3, 3, 1, 1],
            input_strides=[1, 1, 1, 1],
            dilations=None,
        ),
        dict(
            input_shape=[1, 10, 10, 2],
            input_filter=[3, 3, 2, 2],
            input_strides=[1, 1, 1, 1],
            dilations=None,
        ),
        dict(
            input_shape=[1, 10, 10, 2],
            input_filter=[3, 3, 2, 1],
            input_strides=[1, 1, 1, 1],
            dilations=None,
        ),
        dict(
        ...
        pytest.param(
            dict(
                input_shape=[2, 224, 224, 4],
                input_filter=[4, 4, 1, 12],
                input_strides=[1, 2, 2, 1],
                dilations=[1, 2, 2, 1],
            ),
            marks=pytest.mark.precommit,
    ...
    @pytest.mark.nightly
    def test_conv2d_placeholder_const(
        self,
        params,
        padding,
        ie_device,
        ...
        if ie_device == "GPU":
            pytest.xfail("104862")
        self._test(
            *self.create_conv2d_placeholder_const_net(
                **params,
