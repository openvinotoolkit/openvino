...
class TestStringSplitV2(CommonTFLayerTest):
    ...
    def create_string_split_v2_net(self, input_shape, sep, maxsplit):
        ...
        with tf.compat.v1.Session() as sess:
            ...
            string_split_v2 = tf.raw_ops.StringSplitV2(
                input=input, sep=sep, maxsplit=maxsplit
            )
    ...
    def test_string_split_v2(
        ...
        self._test(
            *self.create_string_split_v2_net(
                input_shape=input_shape, sep=sep, maxsplit=maxsplit
            ),
            ie_device,
            precision,
            ir_version,
