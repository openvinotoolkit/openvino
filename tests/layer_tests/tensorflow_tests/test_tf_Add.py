...
class TestAdd(CommonTFLayerTest):
    ...
    test_data_1D = [
        ...
        pytest.param(
            dict(x_shape=[3], y_shape=[3]), marks=pytest.mark.xfail(reason="*-19180")
        ),
    ]

    @pytest.mark.parametrize("params", test_data_1D)
    @pytest.mark.nightly
    def test_add_placeholder_const_1D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_add_placeholder_const_net(
                **params, use_legacy_frontend=use_legacy_frontend
            ),
            ie_device,
            precision,
            ir_version,
    ...
    @pytest.mark.nightly
    def test_add_placeholder_const_3D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_add_placeholder_const_net(
    ...
    @pytest.mark.nightly
    def test_add_placeholder_const_4D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_add_placeholder_const_net(
    ...
    @pytest.mark.nightly
    def test_add_placeholder_const_broadcast_1D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_add_placeholder_const_net(
    ...
    @pytest.mark.nightly
    def test_add_placeholder_const_broadcast_3D(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_add_placeholder_const_net(
    ...
    test_data_broadcast_4D = [
        ...
        dict(x_shape=[1, 1, 1, 3], y_shape=[3]),
        pytest.param(
            dict(x_shape=[1, 1, 3, 1], y_shape=[3, 1]), marks=pytest.mark.precommit
        ),
