...
class TestLogicalOps(CommonTFLayerTest):
    ...
    def create_logical_ops_placeholder_const_net(
        self, input_shape, axis, op_type, ir_version, use_legacy_frontend
    ):
        """
    ...
    @pytest.mark.nightly
    def test_logical_ops_placeholder_const(
        self,
        params,
        op_type,
        ie_device,
        ...
        self._test(
            *self.create_logical_ops_placeholder_const_net(
                **params,
                op_type=op_type,
