        ...
        test_data_5D.extend(
            [
                dict(
                    kernel_size=[1, 1, 1],
                    strides=[1, 1, 1],
                    pads=[[0, 0, 0], [0, 0, 0], "SAME"],
                    in_shape=[1, 3, 224, 224, 224],
                    out_shape=[1, 3, 224, 224, 224],
                    method=method,
                ),
                pytest.param(
                    dict(
                ...
                dict(
                    ...
                    pads=[[0, 0, 0], [0, 0, 0], "SAME"],
                    in_shape=[1, 3, 224, 224, 224],
                    out_shape=[1, 3, 56, 112, 112],
                    method=method,
                ),
                dict(
                    kernel_size=[2, 2, 3],
                    strides=[2, 2, 3],
                    pads=[[0, 0, 0], [0, 0, 1], "SAME"],
                    in_shape=[1, 3, 224, 224, 224],
                    out_shape=[1, 3, 112, 112, 75],
                    method=method,
                ),
                dict(
                    kernel_size=[3, 2, 2],
                    strides=[3, 2, 2],
                    pads=[[0, 0, 0], [1, 0, 0], "SAME"],
                    in_shape=[1, 3, 224, 224, 224],
                    out_shape=[1, 3, 75, 112, 112],
                    method=method,
                ),
                dict(
                    kernel_size=[3, 3, 3],
                    strides=[2, 2, 2],
                    pads=[[0, 0, 0], [1, 1, 1], "SAME"],
                    in_shape=[1, 3, 224, 224, 224],
                    out_shape=[1, 3, 112, 112, 112],
                    method=method,
                ),
