...
class TestConcat(CommonTFLayerTest):
    def create_concat_net(
        self, input_shapes, axis, is_v2, ir_version, use_legacy_frontend
    ):
    ...
    test_data_2D = [dict(input_shapes=[[1, 4], [1, 2]], axis=-1, is_v2=True)]
    ...
    test_data_4D = [
        dict(
            input_shapes=[[1, 3, 5, 7], [3, 3, 5, 7], [2, 3, 5, 7]], axis=0, is_v2=False
        ),
