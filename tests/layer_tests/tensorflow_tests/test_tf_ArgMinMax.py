...
OPS = {"tf.raw_ops.ArgMax": tf.raw_ops.ArgMax, "tf.raw_ops.ArgMin": tf.raw_ops.ArgMin}
...
class TestArgMinMax(CommonTFLayerTest):
    ...
    def create_argmin_max_net(
        self, input_shape, dimension, input_type, output_type, op_type
    ):
