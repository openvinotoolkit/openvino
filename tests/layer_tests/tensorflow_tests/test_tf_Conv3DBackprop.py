...
class TestConv3DBackprop(CommonTFLayerTest):
    ...
    def create_conv3dbackprop_placeholder_const_net(
        self,
        input_shape,
        input_filter,
        out_backprop,
        ...
        with tf.compat.v1.Session() as sess:
            ...
            tf_backprop = tf.compat.v1.placeholder(
                tf.float32, out_backprop, "InputBackprop"
            )
    ...
    test_data = [
        dict(
            input_shape=[1, 15, 15, 15, 1],
            input_filter=[1, 1, 1, 1, 1],
            out_backprop=[1, 15, 15, 15, 1],
            input_strides=[1, 1, 1, 1, 1],
            input_padding="SAME",
            dilations=None,
        ),
        dict(
            input_shape=[1, 15, 15, 15, 2],
            input_filter=[1, 1, 1, 2, 2],
            out_backprop=[1, 15, 15, 15, 2],
            input_strides=[1, 1, 1, 1, 1],
            input_padding="SAME",
            dilations=None,
        ),
        dict(
            ...
            input_filter=[2, 2, 2, 3, 3],
            out_backprop=[1, 8, 8, 8, 3],
        ...
        pytest.param(
            dict(
                input_shape=[1, 16, 20, 10, 3],
                input_filter=[3, 2, 4, 3, 3],
                out_backprop=[1, 8, 10, 5, 3],
                input_strides=[1, 2, 2, 2, 1],
                input_padding="SAME",
                dilations=None,
            ),
        ...
        pytest.param(
            dict(
                input_shape=[1, 16, 16, 16, 3],
                input_filter=[4, 2, 3, 3, 3],
                out_backprop=[1, 7, 8, 7, 3],
                input_strides=[1, 2, 2, 2, 1],
                input_padding="VALID",
                dilations=None,
            ),
    ...
    @pytest.mark.nightly
    def test_conv3dbackprop_placeholder_const(
        ...
        self._test(
            *self.create_conv3dbackprop_placeholder_const_net(
