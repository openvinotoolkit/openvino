...
class TestNot(OnnxRuntimeLayerTest):
    ...
    @pytest.mark.nightly
    def test_not(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(*self.create_net(**params, ir_version=ir_version), ie_device, precision,
                   ir_version,
                   temp_dir=temp_dir, use_new_frontend=use_new_frontend)
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_not_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
