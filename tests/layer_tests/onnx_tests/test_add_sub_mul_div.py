...
class TestOperations(OnnxRuntimeLayerTest):
    def create_net(self, shape1, shape2, op, precision, ir_version, opset=None):
        ...
        node_def = helper.make_node(op, inputs=["input", "const"], outputs=["output"])
    ...
    def create_net_const(self, shape1, shape2, op, precision, ir_version, opset=None):
        ...
        node_def = helper.make_node(
            op, inputs=["const1", "const2"], outputs=["node_out"]
        )
    ...
    def test_add(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_net(
                **params, op="Add", precision=precision, ir_version=ir_version
            ),
            ie_device,
            precision,
            ir_version,
    ...
    def test_sub(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_net(
                **params, op="Sub", precision=precision, ir_version=ir_version
            ),
            ie_device,
            precision,
            ir_version,
    ...
    def test_mul(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_net(
                **params, op="Mul", precision=precision, ir_version=ir_version
            ),
            ie_device,
            precision,
            ir_version,
    ...
    def test_div(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_net(
                **params, op="Div", precision=precision, ir_version=ir_version
            ),
            ie_device,
            precision,
            ir_version,
    ...
    def test_add_opset6(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_net(
                **params, op="Add", precision=precision, opset=6, ir_version=ir_version
            ),
            ie_device,
            precision,
            ir_version,
    ...
    def test_sub_opset6(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_net(
                **params, op="Sub", precision=precision, opset=6, ir_version=ir_version
            ),
            ie_device,
            precision,
            ir_version,
    ...
    def test_mul_opset6(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_net(
                **params, op="Mul", precision=precision, opset=6, ir_version=ir_version
            ),
            ie_device,
            precision,
            ir_version,
    ...
    def test_div_opset6(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_net(
                **params, op="Div", precision=precision, opset=6, ir_version=ir_version
            ),
            ie_device,
            precision,
            ir_version,
