...
class TestAbs(OnnxRuntimeLayerTest):
    def create_net(self, shape, ir_version):
        ...
        node_def = onnx.helper.make_node("Abs", inputs=["input"], outputs=["output"])
    ...
    def create_net_const(self, shape, precision, ir_version):
        ...
        node_def = onnx.helper.make_node("Abs", inputs=["const"], outputs=["abs"])

        node_concat_def = onnx.helper.make_node(
            "Concat", inputs=["input", "abs"], outputs=["output"], axis=concat_axis
        )
