...
class TestOr(OnnxRuntimeLayerTest):
    ...
    def create_net(self, shape1, shape2, ir_version):
        ...
        node_def = helper.make_node(
            "Or", inputs=["input1", "input2"], outputs=["output"]
        )
    ...
    def create_net_one_const(self, shape1, shape2, ir_version):
        ...
        node_def = helper.make_node("Or", inputs=["input", "const"], outputs=["output"])
    ...
    def create_net_const(self, shape1, shape2, ir_version):
        ...
        node_def = helper.make_node(
            "Or", inputs=["const1", "const2"], outputs=["node_out"]
        )
    ...
    test_data_precommit = [
        dict(shape1=[2, 3, 4], shape2=[2, 3, 4]),
