...
class TestSum(OnnxRuntimeLayerTest):
    ...
    @pytest.mark.nightly
    def test_sum_opset6(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_sum(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
    ...
    @pytest.mark.parametrize("params", const_test_data)
    @pytest.mark.nightly
    def test_sum_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(*self.create_const_net(**params, ir_version=ir_version), ie_device, precision,
                   ir_version,
                   temp_dir=temp_dir, use_new_frontend=use_new_frontend)
