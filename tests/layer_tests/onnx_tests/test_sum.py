...
class TestSum(OnnxRuntimeLayerTest):
    def create_net(self, dyn_shapes, const_shapes, precision, ir_version, opset=None):
        ...
        nodes.append(helper.make_node("Sum", inputs=input_names, outputs=["output"]))
    ...
    def create_const_net(self, const_shapes, ir_version, opset=None):
        ...
        nodes.append(helper.make_node("Sum", inputs=input_names, outputs=["sum"]))

        nodes.append(
            helper.make_node(
                "Concat", inputs=["input", "sum"], outputs=["output"], axis=concat_axis
            )
        )
    ...
    test_data_precommit = [
        dict(
            dyn_shapes=[[4, 6, 8], [4, 6, 8], [4, 6, 8]],
            const_shapes=[[4, 6, 8], [4, 6, 8], [4, 6, 8]],
        ),
        dict(
            dyn_shapes=[[4, 6, 8, 10, 12]],
            const_shapes=[[4, 6, 8, 10, 12], [4, 6, 8, 10, 12]],
        ),
        dict(
            dyn_shapes=[[4, 6, 8, 10, 12], [4, 6, 8, 10, 12], [4, 6, 8, 10, 12]],
    ...
    test_data = [
        ...
        dict(
            dyn_shapes=[[4, 6], [4, 6], [4, 6]], const_shapes=[[4, 6], [4, 6], [4, 6]]
        ),
        ...
        dict(
            dyn_shapes=[[4, 6, 8, 10], [4, 6, 8, 10], [4, 6, 8, 10]],
        ...
        dict(
            dyn_shapes=[[4, 6, 8, 10, 12], [4, 6, 8, 10, 12]],
    ...
    const_test_data_broadcasting_precommit = [
        ...
        dict(
            const_shapes=[[4, 6, 8, 10, 12], [4, 6, 8, 10, 12], [4, 6, 8, 10, 12], [12]]
        ),
    ]
    ...
    def test_sum_const_opset6(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(
            *self.create_const_net(**params, opset=6, ir_version=ir_version),
            ie_device,
            precision,
            ir_version,
            temp_dir=temp_dir
    ...
    @pytest.mark.precommit
    def test_sum_const_precommit(
        self, params, ie_device, precision, ir_version, temp_dir
    ):
        self._test(
            *self.create_const_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            ir_version,
            temp_dir=temp_dir
    ...
    @pytest.mark.precommit
    def test_sum_const_broadcasting_precommit(
        self, params, ie_device, precision, ir_version, temp_dir
    ):
        self._test(
            *self.create_const_net(**params, ir_version=ir_version),
    ...
    @pytest.mark.nightly
    def test_sum_const_broadcasting(
        self, params, ie_device, precision, ir_version, temp_dir
    ):
        self._test(
            *self.create_const_net(**params, ir_version=ir_version),
