...
class TestTrigonomery(OnnxRuntimeLayerTest):
    ...
    @pytest.mark.nightly
    def test_sin(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_sinh(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_asin(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_cos(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(*self.create_net(**params, ir_version=ir_version, op='Cos'), ie_device,
                   precision, ir_version,
                   temp_dir=temp_dir, use_new_frontend=use_new_frontend)
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_cosh(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_acos(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_tan(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_tanh(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_atan(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_sin_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_sinh_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_asin_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_cos_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
            *self.create_net_const(**params, ir_version=ir_version, precision=precision, op='Cos'),
            ie_device, precision, ir_version, temp_dir=temp_dir, use_new_frontend=use_new_frontend)
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_cosh_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_acos_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_tan_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_tanh_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_atan_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
        self._test(
