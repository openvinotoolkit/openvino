...
class TestRelu(Caffe2OnnxLayerTest):
    ...
    @pytest.mark.nightly
    def test_relu(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_relu_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
