...
class TestSqrt(OnnxRuntimeLayerTest):
    ...
    @pytest.mark.nightly
    def test_sqrt(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_sqrt_const(self, params, ie_device, precision, ir_version, temp_dir, use_new_frontend):
