...
from common.legacy.utils.common_utils import generate_ir
from common.legacy.utils.parsers import mapping_parser
...
class CommonLayerTest:
    ...
    def compare_ie_results_with_framework(self, infer_res, framework_res, mapping_dict, framework_eps):
        is_ok = True
        from common.legacy.utils.common_utils import allclose
