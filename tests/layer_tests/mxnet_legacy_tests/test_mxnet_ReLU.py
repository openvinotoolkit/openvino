...
def get_relu_params(ie_device=None, precision=None):
    """
...
class TestReLU(object):
    ...
    def test_relu_precommit(self, ie_device, precision):
        self.relu(ie_device, precision)

    @pytest.mark.nightly
    def test_relu_nightly(self, ie_device, precision):
        self.relu(ie_device, precision)

    def relu(self, ie_device, precision):
