...
def get_dropout_params(ie_device=None, precision=None):
    """
...
class TestDropout(object):
    ...
    def test_dropout_precommit(self, ie_device, precision):
        self.dropout(ie_device, precision)

    @pytest.mark.nightly
    def test_dropout_nightly(self, ie_device, precision):
        self.dropout(ie_device, precision)

    def dropout(self, ie_device, precision):
        ...
        dropout = network.add_layer(layer_type='Dropout',
                                    ...
                                    framework_representation_def=dropout_to_symbol)
