...
class TestKerasDepthwiseConv2D(CommonTF2LayerTest):
    ...
    def test_keras_dconv2D_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_dconv2D_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    @pytest.mark.precommit
    def test_keras_use_bias_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_dconv2D_net(**params, ir_version=ir_version),
    ...
    @pytest.mark.nightly
    @pytest.mark.precommit
    def test_keras_activations_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_dconv2D_net(**params, ir_version=ir_version),
