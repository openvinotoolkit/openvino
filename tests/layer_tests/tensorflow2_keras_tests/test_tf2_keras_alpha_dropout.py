...
class TestKerasAlphaDropout(CommonTF2LayerTest):
    def create_keras_alpha_dropout_net(self, rate, input_names, input_shapes, input_type, ir_version):
    ...
    test_data_float32 = [dict(rate=0.5, input_names=["x1"], input_shapes=[[5, 4, 3]], input_type=tf.float32)]

    @pytest.mark.parametrize("params", test_data_float32)
    @pytest.mark.nightly
    @pytest.mark.precommit
    def test_keras_keras_alpha_dropout_case1_float32(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_alpha_dropout_net(**params, ir_version=ir_version), ie_device, precision,
    ...
    @pytest.mark.nightly
    def test_keras_keras_alpha_dropout_case2_float32(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_alpha_dropout_net(**params, ir_version=ir_version), ie_device, precision,
                   temp_dir=temp_dir, ir_version=ir_version, **params)
