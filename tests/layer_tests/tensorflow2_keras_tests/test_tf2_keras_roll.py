...
class TestKerasRoll(CommonTF2LayerTest):
    def create_keras_roll_net(
        self, shift, axis, input_names, input_shapes, input_type, ir_version
    ):
    ...
    def test_keras_roll(
        ...
        self._test(
            *self.create_keras_roll_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
