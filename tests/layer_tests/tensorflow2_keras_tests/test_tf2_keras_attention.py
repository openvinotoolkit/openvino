...
class TestKerasAttention(CommonTF2LayerTest):
    def create_keras_attention_net(
        self,
        causal,
        dropout,
        use_scale,
    ...
    def test_keras_attention_float32_case1(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_attention_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    def test_keras_attention_float32_case2(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_attention_net(**params, ir_version=ir_version),
