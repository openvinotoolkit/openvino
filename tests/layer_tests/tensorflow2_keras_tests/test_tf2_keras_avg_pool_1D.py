...
class TestKerasAveragePooling1D(CommonTF2LayerTest):
    def create_keras_avg_pool_1D_net(
        self,
        pool_size,
        strides,
        padding,
    ...
    def test_keras_avg_pool_1D_case1_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_avg_pool_1D_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    def test_keras_avg_pool_1D_case2_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_avg_pool_1D_net(**params, ir_version=ir_version),
