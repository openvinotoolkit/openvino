...
class TestKerasGlobalMaxPool2D(CommonTF2LayerTest):
    def create_keras_global_maxpool2D_net(self, input_names, input_shapes, input_type, dataformat, ir_version):
        """
    ...
    def test_keras_global_max_pooling2D_float32(self, params, ie_device, precision, temp_dir, ir_version):
