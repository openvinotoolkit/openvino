...
class TestKerasSpatialDropout3D(CommonTF2LayerTest):
    def create_keras_spatialdropout3d_net(self, input_names, input_shapes, input_type, rate, data_format, ir_version):
    ...
    @pytest.mark.nightly
    def test_keras_spatialdropout3d_channels_first(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_spatialdropout3d_net(**params, ir_version=ir_version),
                   ie_device, precision, temp_dir=temp_dir, ir_version=ir_version, **params)
