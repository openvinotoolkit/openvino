...
class TestKerasBatchNormalization(CommonTF2LayerTest):
    def create_keras_batch_normalization_net(
        self,
        axis,
        momentum,
        epsilon,
    ...
    def test_keras_batch_normalization_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_batch_normalization_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.precommit
    @pytest.mark.nightly
    def test_keras_batch_normalization_extended_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_batch_normalization_net(**params, ir_version=ir_version),
