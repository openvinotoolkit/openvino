...
class TestKerasActivation(CommonTF2LayerTest):
    def create_keras_activation_net(
        self, activation_func, input_names, input_shapes, input_type, ir_version
    ):
    ...
    test_data_float32 = [
        ...
        pytest.param(
            ...
            marks=[
                pytest.mark.xfail(reason="49512"),
    ...
    def test_keras_activation_float32(
        ...
        self._test(
            *self.create_keras_activation_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
