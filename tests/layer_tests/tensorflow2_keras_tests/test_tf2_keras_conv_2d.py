...
class TestKerasConv2D(CommonTF2LayerTest):
    def create_keras_conv2d_net(self, conv_params, input_names, input_shapes, input_type, ir_version):
    ...
    test_data_float32 = [
        ...
        pytest.param(dict(conv_params=dict(filters=10, kernel_size=5, padding="same", strides=(3, 3),
    ...
    def test_keras_conv_2d_float32(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_conv2d_net(**params, ir_version=ir_version), ie_device, precision,
