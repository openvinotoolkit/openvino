...
class TestKerasDropout(CommonTF2LayerTest):
    def create_keras_dropout_net(self, input_names, input_shapes, input_type, rate, noise_shape, ir_version):
        """
    ...
    test_data_float32 = [
        dict(input_names=["x"], input_shapes=[[5, 2]], input_type=tf.float32, rate=0.1, noise_shape=(2,)),
        dict(input_names=["x"], input_shapes=[[5, 4, 4]], input_type=tf.float32, rate=0.9, noise_shape=(4,)),
        dict(input_names=["x"], input_shapes=[[5, 4, 4]], input_type=tf.float32, rate=0.4, noise_shape=(4, 4)),
        dict(input_names=["x"], input_shapes=[[5, 4, 4]], input_type=tf.float32, rate=0., noise_shape=(4, 4)),
        dict(input_names=["x"], input_shapes=[[5, 4, 4, 4]], input_type=tf.float32, rate=.999, noise_shape=(4, 4, 4)),
        dict(input_names=["x"], input_shapes=[[5, 4, 4, 12, 6]], input_type=tf.float32, rate=.5,
             noise_shape=(4, 4, 12, 6)),
    ]
