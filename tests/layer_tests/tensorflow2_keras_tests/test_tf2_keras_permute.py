...
class TestKerasPermute(CommonTF2LayerTest):
    ...
    test_data_float32 = [
        ...
        dict(input_names=["x1"], input_shapes=[[2, 3, 8, 2]], input_type=tf.float32, dims=(3, 2, 1)),
        dict(input_names=["x1"], input_shapes=[[1, 4, 1, 4, 2]], input_type=tf.float32, dims=(1, 2, 3, 4))]
