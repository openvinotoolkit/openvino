...
class TestKerasPReLU(CommonTF2LayerTest):
    def create_keras_prelu_net(
        self, input_names, input_shapes, input_type, shared_axes, ir_version
    ):
    ...
    def test_keras_prelu_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_prelu_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    def test_keras_prelu_float32_shared_axes(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_prelu_net(**params, ir_version=ir_version),
