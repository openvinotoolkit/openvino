...
class TestKerasSimpleRNN(CommonTF2LayerTest):
    def create_keras_simplernn_net(self, input_names, input_shapes, input_type,
                                   units, activation, use_bias, dropout, recurrent_dropout, return_sequences,
        ...
        y = tf.keras.layers.SimpleRNN(units=units, activation=activation, use_bias=use_bias, dropout=dropout,
    ...
    test_data_different_activations = [
        dict(input_names=["x1"], input_shapes=[[5, 4, 2]], input_type=tf.float32,
             units=3, activation='tanh', use_bias=True, dropout=0.0, recurrent_dropout=0.0, return_sequences=False,
             return_state=False, go_backwards=False, stateful=False, unroll=False),
        dict(input_names=["x1"], input_shapes=[[2, 3, 6]], input_type=tf.float32,
             units=3, activation='relu', use_bias=True, dropout=0.0, recurrent_dropout=0.0, return_sequences=False,
             return_state=False, go_backwards=False, stateful=False, unroll=False),
        dict(input_names=["x1"], input_shapes=[[3, 4, 1]], input_type=tf.float32,
             units=3, activation='elu', use_bias=True, dropout=0.0, recurrent_dropout=0.0, return_sequences=False,
             return_state=False, go_backwards=False, stateful=False, unroll=False),
        pytest.param(
    ...
    def test_keras_simplernn_different_activations(self, params, ie_device, precision, ir_version, temp_dir):
    ...
    test_data_dropout = [
        dict(input_names=["x1"], input_shapes=[[5, 4, 2]], input_type=tf.float32,
             units=3, activation='tanh', use_bias=True, dropout=0.8, recurrent_dropout=0.0, return_sequences=False,
             return_state=False, go_backwards=False, stateful=False, unroll=False),
        dict(input_names=["x1"], input_shapes=[[5, 4, 2]], input_type=tf.float32,
             units=3, activation='tanh', use_bias=True, dropout=0.8, recurrent_dropout=0.3, return_sequences=False,
             return_state=False, go_backwards=False, stateful=False, unroll=False),
    ]
    ...
    test_data_other = [
        dict(input_names=["x1"], input_shapes=[[5, 4, 2]], input_type=tf.float32,
             units=3, activation='tanh', use_bias=False, dropout=0.0, recurrent_dropout=0.0, return_sequences=False,
             return_state=False, go_backwards=False, stateful=False, unroll=False),
        dict(input_names=["x1"], input_shapes=[[5, 4, 2]], input_type=tf.float32,
             units=3, activation='tanh', use_bias=True, dropout=0.0, recurrent_dropout=0.0, return_sequences=False,
    ...
    @pytest.mark.nightly
    def test_keras_simplernn_test_data_multipleoutput(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_simplernn_net(**params, ir_version=ir_version),
                   ie_device, precision, temp_dir=temp_dir, ir_version=ir_version, **params)
