...
class TestKerasGlobalAvgPool1D(CommonTF2LayerTest):
    def create_keras_global_avg_pooling1D_net(self, input_names, input_shapes, input_type, dataformat, ir_version):
        """
    ...
    def test_keras_global_avg_pooling1D_float32(self, params, ie_device, precision, ir_version, temp_dir):
