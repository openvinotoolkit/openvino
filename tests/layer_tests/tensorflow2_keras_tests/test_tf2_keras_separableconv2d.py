...
class TestKerasSeparableConv2D(CommonTF2LayerTest):
    ...
    test_data = [
        ...
        pytest.param(
            dict(input_names=["x1"], input_shapes=[[1, 10, 16, 2]], input_type=tf.float32,
                 filters=4, kernel_size=(3, 2), strides=3, padding='valid', data_format='channels_last',
    ...
    test_data_different_activations = [
        ...
        dict(input_names=["x1"], input_shapes=[[1, 10, 16, 2]], input_type=tf.float32,
             filters=4, kernel_size=(3, 4), strides=(3, 3), padding='valid', data_format='channels_last',
        ...
        dict(input_names=["x1"], input_shapes=[[2, 22, 14, 6]], input_type=tf.float32,
             filters=3, kernel_size=(2, 3), strides=(1, 1), padding='valid', data_format='channels_last',
    ...
    @pytest.mark.nightly
    def test_keras_separableconv2d_different_activations(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_separableconv2d_net(**params, ir_version=ir_version),
                   ie_device, precision, temp_dir=temp_dir, ir_version=ir_version, **params)
    ...
    @pytest.mark.nightly
    def test_keras_separableconv2d_different_padding(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_separableconv2d_net(**params, ir_version=ir_version),
                   ie_device, precision, temp_dir=temp_dir, ir_version=ir_version, **params)
    ...
    @pytest.mark.nightly
    def test_keras_separableconv2d_different_bias(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_separableconv2d_net(**params, ir_version=ir_version),
                   ie_device, precision, temp_dir=temp_dir, ir_version=ir_version, **params)
