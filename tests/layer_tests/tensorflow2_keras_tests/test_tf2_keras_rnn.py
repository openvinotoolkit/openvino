...
class TestKerasRNN(CommonTF2LayerTest):
    ...
    def test_keras_rnn(
        ...
        self._test(
            *self.create_keras_rnn_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    def test_keras_rnn_multiple_outputs(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_rnn_net(**params, ir_version=ir_version),
