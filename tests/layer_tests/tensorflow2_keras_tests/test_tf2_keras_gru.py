...
class TestKerasGru(CommonTF2LayerTest):
    ...
    def test_keras_gru_with_bias_float32(
        self, params, ie_device, precision, temp_dir, ir_version, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_gru_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    @pytest.mark.precommit
    def test_keras_gru_without_bias_float32(
        self, params, ie_device, precision, temp_dir, ir_version, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_gru_net(**params, ir_version=ir_version),
    ...
    def test_keras_gru_flags_float32(
        self, params, ie_device, precision, temp_dir, ir_version, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_gru_net(**params, ir_version=ir_version),
    ...
    def test_keras_gru_flags_zero_recurrent_dropout_float32(
        self, params, ie_device, precision, temp_dir, ir_version, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_gru_net(**params, ir_version=ir_version),
