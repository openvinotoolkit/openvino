...
class TestKerasMasking(CommonTF2LayerTest):
    def create_keras_masking_net(self, input_names, input_shapes, input_type, mask_value, ir_version):
        """
    ...
    test_data_float32 = [
        ...
        dict(input_names=["x"], input_shapes=[[9, 4, 8, 47]], input_type=tf.float32, mask_value=0.3),
