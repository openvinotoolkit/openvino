...
class TestKerasActivityRegularization(CommonTF2LayerTest):
    def create_keras_activity_regularization_net(
        self, l1_param, l2_param, input_names, input_shapes, input_type, ir_version
    ):
    ...
    def test_keras_activity_regularization_case1_float32(
        ...
        self._test(
            *self.create_keras_activity_regularization_net(
    ...
    @pytest.mark.nightly
    def test_keras_activity_regularization_case_2_float32(
