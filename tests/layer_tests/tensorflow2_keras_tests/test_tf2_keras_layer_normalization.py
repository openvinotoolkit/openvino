...
class TestKerasLayerNormalization(CommonTF2LayerTest):
    def create_keras_lnorm_net(
        ...
        y = tf.keras.layers.LayerNormalization(
            axis=axis, epsilon=epsilon, center=center, scale=scale, trainable=False
        )(x1)
    ...
    def test_keras_dense_float32(
        self, params, ie_device, precision, temp_dir, ir_version, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_lnorm_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    def test_keras_dense_float32(
        self, params, ie_device, precision, temp_dir, ir_version
    ):
        self._test(
            *self.create_keras_lnorm_net(**params, ir_version=ir_version),
            ie_device,
