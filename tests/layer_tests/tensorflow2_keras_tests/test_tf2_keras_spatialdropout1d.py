...
class TestKerasSpatialDropout1D(CommonTF2LayerTest):
    def create_keras_spatialdropout1d_net(
        self, input_names, input_shapes, input_type, rate, ir_version
    ):
    ...
    def test_keras_spatialdropout1d(
        ...
        self._test(
            *self.create_keras_spatialdropout1d_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
