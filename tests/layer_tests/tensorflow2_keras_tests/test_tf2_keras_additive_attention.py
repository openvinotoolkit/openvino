...
class TestKerasAdditiveAttention(CommonTF2LayerTest):
    def create_keras_additive_attention_net(self, dropout, use_scale, input_names,
        ...
        y = tf.keras.layers.AdditiveAttention(dropout=dropout, use_scale=use_scale)(inputs, training=False)
    ...
    test_data_float32 = [
        dict(use_scale=True, dropout=0.0, input_names=["input1_query", "input2_value"],
