...
class TestKerasMinimum(CommonTF2LayerTest):
    ...
    def test_keras_minimum_float32(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_minimum_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.precommit
    def test_keras_minimum_float32_several_inputs(
