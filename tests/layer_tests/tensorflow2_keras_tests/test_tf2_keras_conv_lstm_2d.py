...
class TestKerasConvLSTM2D(CommonTF2LayerTest):
    ...
    test_data_float32 = [dict(params=dict(filters=16, kernel_size=(3, 3), padding='valid', return_sequences=False),
    ...
    def test_keras_conv_lstm_2d_float32(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_conv_lstm_2d_net(**params, ir_version=ir_version), ie_device, precision,
