...
class TestKerasSeparableConv1D(CommonTF2LayerTest):
    def create_keras_separableconv1d_net(
        self,
        input_names,
        input_shapes,
        input_type,
    ...
    def test_keras_separableconv1d(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_separableconv1d_net(**params, ir_version=ir_version),
            ie_device,
            precision,
            temp_dir=temp_dir,
    ...
    @pytest.mark.nightly
    def test_keras_separableconv1d_different_activations(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_separableconv1d_net(**params, ir_version=ir_version),
    ...
    @pytest.mark.nightly
    def test_keras_separableconv1d_different_padding(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_separableconv1d_net(**params, ir_version=ir_version),
    ...
    @pytest.mark.nightly
    def test_keras_separableconv1d_different_bias(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
        self._test(
            *self.create_keras_separableconv1d_net(**params, ir_version=ir_version),
