...
class TestKerasSeparableConv1D(CommonTF2LayerTest):
    ...
    @pytest.mark.nightly
    def test_keras_separableconv1d_different_activations(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_separableconv1d_net(**params, ir_version=ir_version),
                   ie_device, precision, temp_dir=temp_dir, ir_version=ir_version, **params)
    ...
    @pytest.mark.nightly
    def test_keras_separableconv1d_different_padding(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_separableconv1d_net(**params, ir_version=ir_version),
                   ie_device, precision, temp_dir=temp_dir, ir_version=ir_version, **params)
    ...
    @pytest.mark.nightly
    def test_keras_separableconv1d_different_bias(self, params, ie_device, precision, ir_version, temp_dir):
        self._test(*self.create_keras_separableconv1d_net(**params, ir_version=ir_version),
                   ie_device, precision, temp_dir=temp_dir, ir_version=ir_version, **params)
