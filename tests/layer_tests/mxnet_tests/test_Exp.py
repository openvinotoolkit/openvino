...
class TestExp(CommonMXNetLayerTest):
    def create_net(self, shape, output_shape, ir_version):
        """
            MXNet net                    IR net
        ...
        layer_name = 'exp'
        layer_ptr = mx.symbol.exp(data=data, name=layer_name)
    ...
    @pytest.mark.nightly
    def test_exp(self, params, ie_device, precision, ir_version, temp_dir):
