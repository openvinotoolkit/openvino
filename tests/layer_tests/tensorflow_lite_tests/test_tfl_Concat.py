...
test_params = [
    ...
    {
        "shapes": [[1, 3, 10, 17], [1, 3, 10, 1], [1, 3, 10, 5], [1, 3, 10, 3]],
        "axis": -1,
    },
    {"shapes": [[2, 7], [2, 8]], "axis": 1},
    {"shapes": [[1, 3, 10], [1, 2, 10], [1, 5, 10]], "axis": 1},
    {
        "shapes": [[1, 3, 10, 17], [1, 10, 10, 17], [1, 12, 10, 17], [1, 1, 10, 17]],
        "axis": 1,
    },
]
...
class TestTFLiteConcatTest(TFLiteLayerTest):
    ...
    def make_model(self, params):
        assert (
            len(set(params.keys()).intersection({"shapes", "axis"})) == 2
