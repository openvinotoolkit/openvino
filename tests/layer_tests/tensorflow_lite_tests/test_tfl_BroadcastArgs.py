...
test_params = [
    {'shape': [random.randint(1, 5) for _ in range(2)], 'broadcast_shape': [random.randint(1, 5) for _ in range(2)]},
    {'shape': [random.randint(1, 5) for _ in range(1)], 'broadcast_shape': [random.randint(1, 5) for _ in range(1)]}
]
