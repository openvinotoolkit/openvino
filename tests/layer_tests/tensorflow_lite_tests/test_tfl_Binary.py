...
test_ops = [
    ...
    {
        "op_name": "FLOOR_MOD",
        "op_func": tf.math.floormod,
        "kwargs_to_prepare_input": "positive",
    },
    {
        "op_name": "FLOOR_DIV",
        "op_func": tf.math.floordiv,
        "kwargs_to_prepare_input": "positive",
    },
    ...
    {
        "op_name": "LOGICAL_AND",
        "op_func": tf.math.logical_and,
        "kwargs_to_prepare_input": "boolean",
        "dtype": tf.bool,
    },
    {
        "op_name": "LOGICAL_OR",
        "op_func": tf.math.logical_or,
        "kwargs_to_prepare_input": "boolean",
        "dtype": tf.bool,
    },
...
class TestTFLiteBinaryLayerTest(TFLiteLayerTest):
    ...
    def make_model(self, params):
        ...
        with tf.compat.v1.Session() as sess:
            place_holder0 = tf.compat.v1.placeholder(
                params.get("dtype", tf.float32), params["shape"], name=self.inputs[0]
            )
            place_holder1 = tf.compat.v1.placeholder(
