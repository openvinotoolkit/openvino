...
test_params = [
    {'shapes': ((random.randint(1, 5) for _ in range(3)), (random.randint(1, 5) for _ in range(3)), (random.randint(1, 5) for _ in range(3)), (random.randint(1, 5) for _ in range(3))), 'adjoint_a': random.choice([True,False]), 'adjoint_b': random.choice([True,False])},
    {'shapes': ((random.randint(1, 5) for _ in range(4)), (random.randint(1, 5) for _ in range(3)), (random.randint(1, 5) for _ in range(4)), (random.randint(1, 5) for _ in range(3))), 'adjoint_a': random.choice([True,False]), 'adjoint_b': random.choice([True,False])},
    {'shapes': ((random.randint(1, 5) for _ in range(5)), (random.randint(1, 5) for _ in range(5)),
                (random.randint(1, 5) for _ in range(5)), (random.randint(1, 5) for _ in range(5))), 'adjoint_a': random.choice([True,False]), 'adjoint_b': random.choice([True, False])},
]
