        ...
        class aten_adaptive_avg_pool3d(torch.nn.Module):
            ...
            def forward(self, input_tensor):
                return torch.nn.functional.adaptive_avg_pool3d(
                    input_tensor, self.output_size
                )

        ref_net = None

        return (
            aten_adaptive_avg_pool3d(output_size),
            ref_net,
...
class TestAdaptiveAvgPool2D(PytorchLayerTest):
    ...
    def create_model(self, output_size):
        ...
        return (
            aten_adaptive_avg_pool2d(output_size),
            ref_net,
    ...
    def test_adaptive_avg_pool2d(
        self, ie_device, precision, ir_version, input_shape, output_size
    ):
...
class TestAdaptiveAvgPool1D(PytorchLayerTest):
    ...
    def create_model(self, output_size):
        ...
        return (
            aten_adaptive_avg_pool1d(output_size),
            ref_net,
