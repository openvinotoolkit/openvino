...
class TestQuantizedConv1D(PytorchLayerTest):
    ...
    def create_model(
        ...
        ref_net = None
        op_name = "quantized::conv1d_relu" if relu else "quantized::conv1d"
        return quantized_conv1d(), ref_net, op_name

    @pytest.mark.parametrize(
        "params",
        [
            {"weights_shape": [1, 3, 3], "strides": 1, "pads": 0, "dilations": 1, "groups": 1},
            {"weights_shape": [2, 3, 3], "strides": 1, "pads": 0, "dilations": 1, "groups": 1},
            {"weights_shape": [2, 3, 3], "strides": 2, "pads": 0, "dilations": 1, "groups": 1},
            {"weights_shape": [2, 3, 3], "strides": 1, "pads": 1, "dilations": 1, "groups": 1},
            {"weights_shape": [2, 3, 3], "strides": 1, "pads": 0, "dilations": 2, "groups": 1},
