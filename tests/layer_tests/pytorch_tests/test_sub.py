...
class TestSub(PytorchLayerTest):
    ...
    def test_sub(self, ie_device, precision, ir_version, input_data, use_ts_backend):
...
class TestSubTypes(PytorchLayerTest):
    ...
    @pytest.mark.nightly
    @pytest.mark.precommit
    def test_sub_types(self, ie_device, precision, ir_version, lhs_type, lhs_shape, rhs_type, rhs_shape, use_ts_backend):
        self.lhs_type = lhs_type
