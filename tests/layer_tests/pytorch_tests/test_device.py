...
class TestDevice(PytorchLayerTest):
    ...
    def test_device(self, device_string, ie_device, precision, ir_version, use_ts_backend):
        self._test(
    ...
    @pytest.mark.nightly
    @pytest.mark.precommit
    def test_device_type(self, device_string, ie_device, precision, ir_version, use_ts_backend):
        self._test(
