...
class TestArgSort(PytorchLayerTest):
    ...
    def create_model(self):
        class aten_argsort(torch.nn.Module):
            ...
            def forward(self, input_tensor):
                return torch.argsort(input_tensor, self.dim, self.descending, self.stable)
        ref_net = None

        return aten_argsort(), ref_net, "aten::argsort"
    ...
    def test_argsort(self, input_tensor, dim, descending, stable):
