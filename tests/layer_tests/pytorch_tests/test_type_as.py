...
class TestTypeAs(PytorchLayerTest):
    ...
    def test_type_as(self, input_dtype, cast_dtype, ie_device, precision, ir_version, use_ts_backend):
        self._test(*self.create_model(), ie_device, precision, ir_version,
                   kwargs_to_prepare_input={"input_dtype": input_dtype, "cast_dtype": cast_dtype}, use_ts_backend=use_ts_backend)
