...
class TestBucketize(PytorchLayerTest):
    ...
    def _prepare_input(
        self, input_shape, boundaries_range, input_dtype, boundaries_dtype
    ):
        return (
            ...
            def forward(self, input, boundaries):
                if self.is_out:
                    ...
                    return torch.bucketize(
                        input, boundaries, out_int32=self.out_int32, right=self.right
                    )
    ...
    def test_bucketize(
        ...
        self._test(
            *self.create_model(out_int32, right, is_out),
            ie_device,
            precision,
            ir_version,
            kwargs_to_prepare_input={
                ...
                "boundaries_range": boundaries_range,
                "boundaries_dtype": boundaries_dtype,
            }
        )
