...
class TestPixelShuffle(PytorchLayerTest):
    ...
    def test_pixel_shuffle(
        self, upscale_factor, shape, ie_device, precision, ir_version
    ):
        self.shape = shape
        self._test(*self.create_model(upscale_factor), ie_device, precision, ir_version)
...
class TestChannelShuffle(PytorchLayerTest):
    ...
    def test_channel_shuffle(self, groups, shape, ie_device, precision, ir_version):
        self.shape = shape
        self._test(*self.create_model(groups), ie_device, precision, ir_version)
