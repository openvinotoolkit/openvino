...
class TestCat(PytorchLayerTest):
    ...
    def test_append_cat(self, out, ie_device, precision, ir_version):
        ...
        self._test(
            model,
            None,
            ["aten::cat", "aten::append", "prim::ListConstruct"],
            ie_device,
            precision,
            ir_version,
            kwargs_to_prepare_input={"out": out, "num_repeats": 2},
    ...
    def test_loop_append_cat(self, out, ie_device, precision, ir_version):
        ...
        self._test(
            model,
            None,
            ["aten::cat", "aten::append", "prim::ListConstruct", "prim::Loop"],
            ie_device,
            precision,
            ir_version,
            freeze_model=False,
    ...
    def test_add_cat(self, out, ie_device, precision, ir_version):
        ...
        self._test(
            model,
            None,
            ["aten::cat", "aten::add", "prim::ListConstruct"],
            ie_device,
            precision,
            ir_version,
            freeze_model=False,
