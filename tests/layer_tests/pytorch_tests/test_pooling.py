...
class TestPooling(PytorchLayerTest):
    ...
    @pytest.mark.xfail(condition=platform.system() == 'Darwin' and platform.machine() == 'arm64',
                       reason='Ticket - 122715')
    def test_avg_pool2d(self, params, ceil_mode, count_include_pad, dtype, ie_device, precision, ir_version):
        self._test(*self.create_model("avg_pool2d", **params, ceil_mode=ceil_mode, count_include_pad=count_include_pad, dtype=dtype),
