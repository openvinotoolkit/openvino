...
class TestIm2Col(PytorchLayerTest):
    ...
    def test_exp(self, kernel_size, dilation, padding, stride, ie_device, precision, ir_version, use_ts_backend):
        self._test(*self.create_model(kernel_size, dilation, padding, stride), ie_device, precision, ir_version, use_ts_backend=use_ts_backend)
