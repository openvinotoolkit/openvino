...
class TestRoll(PytorchLayerTest):
    ...
    def test_roll(self, shifts, dim, ie_device, precision, ir_version, use_ts_backend):
        self._test(*self.create_model(shifts, dim), ie_device, precision, ir_version, use_ts_backend=use_ts_backend)
