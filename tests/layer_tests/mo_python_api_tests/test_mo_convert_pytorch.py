...
def create_pytorch_nn_module_layout_list(tmp_dir):
    ...
    return pt_model, ref_model, {
        ...
        "input": [InputCutInfo(None, None, "f32", None), InputCutInfo(None, None, "f32", None)]
        }
...
def create_pytorch_nn_module_mean_list_default_no_compression(tmp_dir):
    ...
    return pt_model, ref_model, {'input_shape': [shape, shape], 'mean_values': [[0, 0, 0], [0, 0, 0]], "input": [InputCutInfo(None, None, "f32", None), InputCutInfo(None, None, "f32", None)]}
...
def create_pytorch_nn_module_mean_list_compressin_enabled(tmp_dir):
    ...
    return pt_model, ref_model, {
        ...
        'compress_to_fp16': False, "input": [InputCutInfo(None, None, "f32", None), InputCutInfo(None, None, "f32", None)]}
...
def create_pytorch_nn_module_scale_list(tmp_dir):
    ...
    return pt_model, ref_model, {'input_shape': [shape, shape], 'scale_values': [[1, 1, 1], [1, 1, 1]], 'compress_to_fp16': False, "input": [InputCutInfo(None, None, "f32", None), InputCutInfo(None, None, "f32", None)]}
...
def create_pytorch_nn_module_shapes_list_static(tmp_dir):
    ...
    return pt_model, ref_model, {'input_shape': [[1, 3, 20, 20], [1, 3, 20, 20]], "input": [InputCutInfo(None, None, "f32", None), InputCutInfo(None, None, "f32", None)]}
...
def create_pytorch_nn_module_shapes_list_dynamic(tmp_dir):
    ...
    parameter_list = [param1, param2]
    ref_model = Model([sigm], parameter_list, "test")
    return pt_model, ref_model, {'input_shape': inp_shapes, "input": [InputCutInfo(None, None, "f32", None), InputCutInfo(None, None, "f32", None)]}
...
def create_pytorch_nn_module_shapes_list_dynamic_single_input(tmp_dir):
    ...
    return pt_model, ref_model, {'input_shape': inp_shapes, "input": InputCutInfo(None, None, "f32", None)}
...
def create_pytorch_nn_module_convert_pytorch_frontend1(tmp_dir):
    ...
    return pt_model, ref_model, {
        ...
        "input": [InputCutInfo(None, [-1, -1, -1, -1], "f32", None)]
    }
...
def create_pytorch_nn_module_convert_pytorch_frontend2(tmp_dir):
    ...
    return pt_model, ref_model, {
        ...
        "input": [InputCutInfo(None, [-1, -1, -1, -1], "i32", None)]
    }
...
def create_pytorch_nn_module_convert_pytorch_frontend3(tmp_dir):
    ...
    return pt_model, ref_model, {
        ...
        "input": [InputCutInfo(None, [-1, -1, -1, -1], "f32", None), InputCutInfo(None, [-1, -1, -1, -1], "f32", None)]
    }
...
def create_pytorch_jit_trace_module_convert_pytorch_frontend(tmp_dir):
    ...
    return scripted_model, ref_model,  {"example_input": example_input, "input": [
        InputCutInfo(None, [-1, -1, -1, -1], "f32", None), InputCutInfo(None, [-1, -1, -1, -1], "f32", None)]}
