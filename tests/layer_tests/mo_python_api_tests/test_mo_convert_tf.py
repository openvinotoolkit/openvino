...
def static_shape_true(temp_dir):
    ...
    return (
        keras_net,
        model_ref,
        {"use_convert_model_from_mo": True, "static_shape": True},
    )
...
def static_shape_false(temp_dir):
    ...
    return (
        keras_net,
        model_ref,
        {"use_convert_model_from_mo": True, "static_shape": False},
    )
...
class TestMoConvertTF(CommonMOConvertTest):
    ...
    def test_mo_import_from_memory_legacy_fe(
    ...
    def test_tensor_names(self, ie_device, precision, ir_version, temp_dir):
        ...
        class LayerModel(tf.Module):
            def __init__(self):
                ...
                self.var1 = tf.Variable([7.0, 5.0, 6.0], name="var1")
                self.var2 = tf.Variable([5.0, 7.0, 3.0], name="var2")
                self.var3 = tf.Variable([5.0, 7.0, 3.0], name="var2")
