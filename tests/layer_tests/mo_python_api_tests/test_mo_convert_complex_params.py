...
class TestComplexParams(CommonMOConvertTest):
    ...
    test_data = [
        ...
        },
        {
            ...
            "params_ref": {
                "input_shape": "[?,1..3,4..,..5],[?,1..3,4,..5],[?,3,4..,..5]",
                "input": "Input1,Input2,Relu3",
            },
        },
        {
            "params_test": {
                "input": [
                    InputCutInfo("Relu1", Shape([3, 2]), Type(np.int32)),
                    InputCutInfo(
                        "Relu2",
                        PartialShape([Dimension(3, 10), Dimension(2, -1)]),
                        np.int32,
                    ),
            ...
            "params_ref": {
                "input": "Relu1[3 2]{i32},Relu2[3..10 2..]{i32},Relu3[3 2]{i32}->[1 2 3 4 5 6]"
            },
        },
        {
            "params_test": {
                "input": [
                    ("Relu1", Shape([3, 2]), Type(np.int32)),
                    (
                        np.int32,
                        "Relu2",
                        PartialShape([Dimension(3, 10), Dimension(2, -1)]),
            ...
            "params_ref": {
                "input": "Relu1[3 2]{i32},Relu2[3..10 2..]{i32},Relu3[3 2]{i32}"
            },
        },
        {
        ...
        },
        {
            "params_test": {
                "mean_values": {
                    "Input1:0": [0.5, 1.3, 0.67],
                    "Input2:0": [4.2, 6.7, 3.15],
                    "Input3:0": [0.757, 4.6, 7.3],
                },
                "compress_to_fp16": True,
            },
            "params_ref": {
                "mean_values": "Input1:0[0.5,1.3,0.67],Input2:0[4.2,6.7,3.15],Input3:0[0.757,4.6,7.3]"
            },
        },
        {
            "params_test": {
        ...
        },
        {
            ...
            "params_ref": {
                "scale_values": "Input1:0[0.5,1.3,0.67],Input2:0[4.2,6.7,3.15],Input3:0[0.757,4.6,7.3]"
            },
        },
        {
            "params_test": {
        ...
        },
        {
            ...
            "params_ref": {
                "source_layout": "Input1:0(nchw),Input2:0(nchw),Input3:0(nc??)"
            },
        },
        {
            "params_test": {
                "target_layout": {
                    "Input1:0": Layout("nhwc"),
                    "Input2:0": "nhwc",
                    "Input3:0": "n??c",
                },
                "compress_to_fp16": True,
            ...
            "params_ref": {
                "target_layout": "Input1:0(nhwc),Input2:0(nhwc),Input3:0(n??c)"
            },
        },
        {
            "params_test": {
                "layout": {
                    "Input1:0": LayoutMap(
                        source_layout=Layout("nchw"), target_layout="nhwc"
                    ),
                    "Input2:0": LayoutMap(
                        source_layout="nc??", target_layout=Layout("n??c")
                    ),
                    "Input3:0": LayoutMap(source_layout="abcd", target_layout="acdb"),
                },
                "compress_to_fp16": True,
            },
            "params_ref": {
                "layout": "Input1:0(nchw->nhwc),Input2:0(nc??->n??c),Input3:0(abcd->acdb)"
            },
        },
        {
            "params_test": {
        ...
        },
        {
            "params_test": {
                "input": [
                    InputCutInfo(shape=[1], type=np.int32, value=[10]),
                    InputCutInfo(shape=[1], type=np.int32, value=[20]),
                    InputCutInfo(shape=[1], type=np.int32, value=[30]),
                ]
            },
            "params_ref": {
                "input": "Input1[1]{i32}->[10],Input2[1]{i32}->[20],Input3[1]{i32}->[30]"
            },
        },
    ]
    ...
    test_data = [
        {
            "params_test": {
                "input_shape": [[Dimension(1), 2, 3], [Dimension(1), 2, 3]],
                "freeze_placeholder_with_value": "Input3->[1]",
            },
            "params_ref": {
                "input_shape": "[1,2,3],[1,2,3]",
                "freeze_placeholder_with_value": "Input3->[1]",
            },
        },
        {
            "params_test": {
                "input": [PartialShape([Dimension(-1), 5, 6]), [-1, 5, 6]],
                "freeze_placeholder_with_value": "Input3->[1]",
            },
            "params_ref": {
                "input": "Input1:0[?,5,6],Input2:0[?,5,6]",
                "freeze_placeholder_with_value": "Input3->[1]",
            },
        },
        {
            "params_test": {
                "input": [np.float16, np.float16],
                "input_shape": [[10, 20], [10, 20]],
                "freeze_placeholder_with_value": "Input3->[1]",
            },
            "params_ref": {
                "input": "Input1:0{f16},Input2:0{f16}",
                "input_shape": "[10,20],[10,20]",
                "freeze_placeholder_with_value": "Input3->[1]",
            },
        },
    ...
    @pytest.mark.parametrize("params", test_data)
    @pytest.mark.nightly
    def test_mo_convert_tf_model_no_concat(
        self, params, ie_device, precision, ir_version, temp_dir, use_legacy_frontend
    ):
    ...
    test_data = [
        ...
        {
            "params_test": {
                "input_shape": PartialShape([2, 3, 4]),
                "compress_to_fp16": True,
            },
        ...
        # Check all args combinations.
        {
            "params_test": {
                "input": InputCutInfo(
                    "Relu", [3, 2], Type(np.int32), [1, 2, 3, 4, 5, 6]
                )
            },
        ...
        },
        {
            ...
            "params_ref": {
                "input": "Relu[3 2]{i32}->[1 2 3 4 5 6]",
                "compress_to_fp16": True,
            },
        },
        {
        ...
        {
            "params_test": {
                "input_shape": [Dimension(), Dimension(1, 3), 4, Dimension(-1, 5)],
                "compress_to_fp16": True,
            },
        ...
        {"params_test": {"input": ("Relu")}, "params_ref": {"input": "Relu"}},
        {
        ...
        {
            "params_test": {
                "layout": LayoutMap(source_layout=Layout("nchw"), target_layout="nhwc"),
                "compress_to_fp16": True,
            },
        ...
        {
            "params_test": {
                "input": InputCutInfo(shape=[1], type=np.int32, value=[10])
            },
        ...
        {
            "params_test": {
                "input_shape": [Dimension(3, 10), 10, -1],
                "compress_to_fp16": True,
            },
        ...
        {
            "params_test": {
                "input": PartialShape([1, 100, 100, 3]),
                "mean_values": [0.5, 1.3, 0.67],
                "compress_to_fp16": True,
            },
            "params_ref": {
                "input": "Input:0[1,100,100,3]",
                "mean_values": "[0.5,1.3,0.67]",
            },
        },
        {
    ...
    @pytest.mark.nightly
    @pytest.mark.precommit
    def test_mo_convert_clearing_transformation_registry(
        ...
        config_path = os.path.join(
            os.path.dirname(__file__), "test_transform_config/test_config.json"
        )
        test_config_based_transform = os.path.join(
            os.path.dirname(__file__), "test_legacy_exts/test_config_transform/"
        )

        # apply config based transformation on model
        _ = convert_model(
            input_model=tf_net_path,
            transformations_config=config_path,
        ...
        _ = convert_model(
            input_model=tf_net_path, extensions=test_config_based_transform
        )
