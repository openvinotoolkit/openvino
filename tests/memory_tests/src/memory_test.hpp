...
struct TestContext {
    ...
    void report() {
        ...
        for (auto &sample: samples) {
            std::cout << "{\"name\": \"" << sample.first << "\", "
            << "\"vmsize\": " << sample.second.virtual_size << ", "
            << "\"vmpeak\": " << sample.second.virtual_peak << ", "
            << "\"rssize\": " << sample.second.resident_size << ", "
            << "\"rspeak\": " << sample.second.resident_peak << ", "
            << "\"thr\": " << sample.second.thread_count << "}";
