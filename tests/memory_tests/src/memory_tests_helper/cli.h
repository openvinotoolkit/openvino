...
static const char reshape_shapes_message[] =
    ...
    "Example: 'input*1..2 3 100 100'. Use '&' delimiter for several inputs. "
    "Example: 'input1*1..2 100&input2*1..2 100' ";
...
static const char data_shapes_message[] =
    ...
    "Only static shapes for data. Example: 'input*1 3 100 100'. Use '&' delimiter for several inputs. Example: "
    "'input1*1 100&input2*1 100' ";
...
static void showUsage() {
  ...
  std::cout << "    -s \"<path>\"        " << statistics_path_message
            << std::endl;
  std::cout << "    -reshape_shapes      " << reshape_shapes_message
            << std::endl;
