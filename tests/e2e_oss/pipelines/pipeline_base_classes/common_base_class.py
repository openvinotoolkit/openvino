...
from utils.parsers import mapping_parser as mapping
from utils.e2e.common.e2e_utils import get_tensor_names_dict, collect_tensor_names
...
class CommonConfig:
    ...
    __pytest_marks__ = tuple([
        ...
        pytest.mark.components("openvino.test:e2e_oss"),
    ])
