...
"""
precommit_runtime_measure_duration = os.environ.get(
    "PRECOMMIT_RUNTIME_MEASURE_DURATION", "60"
)
nightly_runtime_measure_duration = os.environ.get(
    "NIGHTLY_RUNTIME_MEASURE_DURATION", "15"
)
"""
...
tf_hub_cache_dir = os.environ.get(
    "TFHUB_CACHE_DIR", os.path.join(tempfile.gettempdir(), "tfhub_modules")
)
hf_cache_dir = os.environ.get(
    "HF_HUB_CACHE", os.path.join(tempfile.gettempdir(), "hugging_face")
)
