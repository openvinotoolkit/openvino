...
class TestGFPGANConvertModel(TestTorchConvertModel):
    def setup_class(self):
        ...
        subprocess.check_call(
            ["git", "checkout", "bc5a5deb95a4a9653851177985d617af1b9bfa8b"],
    ...
    def compare_results(self, fw_outputs, ov_outputs):
        ...
        for i in range(len(ov_outputs)):
            ...
            try:
                np.testing.assert_allclose(cur_ov_res, cur_fw_res, fw_eps, fw_eps)
    ...
    @pytest.mark.skipif(
        version.parse(torchvision.__version__) >= version.parse("0.17"),
