...
from stress_tests.scripts.get_testdata import VirtualEnv, run_in_subprocess, abs_path
        ...
        if model_rec.attrib.get("source") == "omz" and "name" in model_rec.attrib:
            if model_rec.attrib["name"] not in models_to_run:
                ...
                model_rec.attrib["full_path"] = str(
                    args.omz_irs_out_dir / model_rec.attrib["subdirectory"] / PRECISION / (
