...
void test_cnnnetwork_reshape_batch_x2_full_pipeline(const std::string &model, const std::string &target_device, const int &n, const std::string &config_file = "");
...
void test_infer_request_inference_full_pipeline(const std::string &model, const std::string &target_device, const int &n, const std::string &config_file = "");
// tests_pipelines/tests_pipelines_full_pipeline.cpp
