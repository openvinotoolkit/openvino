    ...
    if(THREADING STREQUAL "TBB" OR THREADING STREQUAL "TBB_AUTO")
        ...
        if(enable_pkgconfig_tbb AND NOT ANDROID)
            ...
            if(NOT enable_system_tbb)
                set_and_check(_tbb_dir "D:/OPENVINO/openvino/temp/tbb/lib/cmake/TBB")
...
macro(_ov_find_intel_gpu_dependencies)
    ...
    if(_OV_ENABLE_ONEDNN_FOR_GPU AND NOT TARGET onednn_gpu_tgt)
        ...
        if(_ov_in_install_tree)
            ...
            set_and_check(onednn_gpu_lib_root "")
            if(WIN32)
            ...
            set_and_check(onednn_gpu_lib_path "D:/OPENVINO/openvino/src/plugins/intel_gpu/thirdparty/onednn_gpu_install/lib/openvino_onednn_gpu.lib")
        endif()
