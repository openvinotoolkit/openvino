...
if [ "$os" == "ubuntu18.04" ] ; then
    ...
    pkgs_dev=(cmake pkg-config libflags-dev zlib1g-dev nlohmann-json3-dev g++ gcc libc6-dev make curl sudo)
    ...
    pkgs_opencv_req=(libgtk-3-0 libgl1)
    pkgs_python=(python3 python3-dev python3-venv python3-setuptools python3-pip)
    pkgs_dev=(cmake pkg-config g++ gcc libc6-dev libflags-dev zlib1g-dev nlohmann-json3-dev make curl sudo)
    pkgs_myriad=(libusb-1.0-0)
    pkgs_cl_compiler=(libtinfo5)
    pkgs_opencv_opt=(
        gstreamer1.0-plugins-bad
    ...
    pkgs_dev=(gcc gcc-c++ make glibc libstdc++ libgcc cmake pkg-config libflags-dev zlib1g-dev nlohmann-json3-dev curl sudo)
    pkgs_myriad=()
    pkgs_opencv_opt=(
        gstreamer1
