...
function(ov_model_convert SRC DST OUT)
    set(onnx_gen_script ${OpenVINO_SOURCE_DIR}/runtime/core/core/test/models/onnx/onnx_prototxt_converter.py)
...
ov_model_convert("${CMAKE_CURRENT_SOURCE_DIR}/runtime/core/core/test"
...
if(ENABLE_TESTS)
    if(OV_ONNX_FRONTEND_ENABLE AND ENABLE_REQUIREMENTS_INSTALL)
        ...
        set(reqs "${OpenVINO_SOURCE_DIR}/runtime/core/core/test/requirements_test_onnx.txt")
