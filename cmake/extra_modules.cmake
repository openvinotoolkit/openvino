    ...
    foreach(module_path IN LISTS extra_modules)
        if(module_path)
            ...
            if(BUILD_${module_name})
                ...
                message(STATUS "extra modules compiler flags:" ${CMAKE_CXX_FLAGS})
                message(STATUS "extra modules exe linker flags:" ${CMAKE_EXE_LINKER_FLAGS})
                message(STATUS "extra modules module linker flags:" ${CMAKE_MODULE_LINKER_FLAGS})
                message(STATUS "extra modules shared linker flags:" ${CMAKE_SHARED_LINKER_FLAGS})
                message(STATUS "add_subdirectory before CMAKE_COMPILE_WARNING_AS_ERROR=" ${CMAKE_COMPILE_WARNING_AS_ERROR})
                set(CHANGE_FLAGS OFF)
                if ((${module_name} STREQUAL "nvidia_plugin" OR ${module_name} STREQUAL "npu") AND CMAKE_COMPILE_WARNING_AS_ERROR AND CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
                    string(REPLACE "/WX" "" CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
                    string(REPLACE "/WX" "" CMAKE_C_FLAGS "${CMAKE_C_FLAGS}")
                    string(REPLACE "/WX" "" CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS}")
                    # string(REPLACE "/WX" "" CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS}")
                    # string(REPLACE "/WX" "" CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS}")
                    set(CMAKE_COMPILE_WARNING_AS_ERROR OFF)
                    set(CHANGE_FLAGS ON)
                endif()

                message(STATUS "before add_subdirectory nvidia plugin compiler flags:" ${CMAKE_CXX_FLAGS})
                message(STATUS "before add_subdirectory nvidia plugin exe linker flags:" ${CMAKE_EXE_LINKER_FLAGS})
                message(STATUS "before add_subdirectory nvidia plugin module linker flags:" ${CMAKE_MODULE_LINKER_FLAGS})
                message(STATUS "before add_subdirectory nvidia plugin shared linker flags:" ${CMAKE_SHARED_LINKER_FLAGS})
                ...
                message(STATUS "add_subdirectory after CMAKE_COMPILE_WARNING_AS_ERROR=" ${CMAKE_COMPILE_WARNING_AS_ERROR})
                message(STATUS "extra modules compiler flags:" ${CMAKE_CXX_FLAGS})
                message(STATUS "extra modules exe linker flags:" ${CMAKE_EXE_LINKER_FLAGS})
                message(STATUS "extra modules module linker flags:" ${CMAKE_MODULE_LINKER_FLAGS})
                message(STATUS "extra modules shared linker flags:" ${CMAKE_SHARED_LINKER_FLAGS})
