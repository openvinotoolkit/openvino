        ...
        if(module_path)
            ...
            if(BUILD_${module_name})
                ...
                if (${module_name} STREQUAL "nvidia_plugin" AND CMAKE_COMPILE_WARNING_AS_ERROR AND CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
                    remove(CMAKE_SHARED_LINKER_FLAGS "/WX")
                    remove(CMAKE_MODULE_LINKER_FLAGS "/WX")
                    remove(CMAKE_EXE_LINKER_FLAGS "/WX")
                    remove(CMAKE_CXX_FLAGS "/WX")
                    remove(CMAKE_C_FLAGS "/WX")
                endif()
