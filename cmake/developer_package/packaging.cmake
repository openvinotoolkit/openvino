...
function(ie_cpack_set_library_dir)
    if(WIN32)
        set(IE_CPACK_LIBRARY_PATH runtime/${ARCH_FOLDER}/lib/$<CONFIG> PARENT_SCOPE)
        set(IE_CPACK_RUNTIME_PATH runtime/${ARCH_FOLDER}/bin/$<CONFIG> PARENT_SCOPE)
        set(IE_CPACK_ARCHIVE_PATH runtime/${ARCH_FOLDER}/lib/$<CONFIG> PARENT_SCOPE)
    else()
