...
function(add_clang_format_target TARGET_NAME)
    ...
    foreach(source_file IN LISTS CLANG_FORMAT_FOR_SOURCES)
        ...
        add_custom_command(
            ...
            -P "${OpenVINO_MAIN_SOURCE_DIR}/cmake/developer_package/clang_format/clang_format_check.cmake"
            DEPENDS
            "${source_file}"
            "${OpenVINO_MAIN_SOURCE_DIR}/cmake/developer_package/clang_format/clang_format_check.cmake"
            COMMENT
    ...
    add_custom_target(${TARGET_NAME}_fix
        ...
        -P "${OpenVINO_MAIN_SOURCE_DIR}/cmake/developer_package/clang_format/clang_format_fix.cmake"
        DEPENDS
        "${CLANG_FORMAT_FOR_SOURCES}"
        "${OpenVINO_MAIN_SOURCE_DIR}/cmake/developer_package/clang_format/clang_format_fix.cmake"
        COMMENT
