...
function(addIeTarget)
    ...
    if (${ARG_NAME} MATCHES ov_cpu_func_tests)
        list(FILTER includes INCLUDE REGEX ".+.hpp|.+.h")
        list(FILTER sources INCLUDE REGEX ".+.cpp")
        list(FILTER includes EXCLUDE REGEX ".+/single_layer_tests/.+|.+/subgraph_tests/.+|.+/low_precision_transformations/.+|.+/behavior/.+|.+/bfloat16/.+")
        list(FILTER sources EXCLUDE REGEX ".+/single_layer_tests/.+|.+/subgraph_tests/.+|.+/low_precision_transformations/.+|.+/behavior/.+|.+/bfloat16/.+")
#        list(APPEND sources /home/inovosel/openvino/snippets/src/plugins/intel_cpu/tests/functional/shared_tests_instances/snippets/add.cpp)
        message("\n\n#########################\n${ARG_NAME} statistics:")
        foreach(f ${includes})
