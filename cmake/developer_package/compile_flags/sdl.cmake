...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC" OR (OV_COMPILER_IS_INTEL_LLVM AND WIN32))
    ...
    set(OV_LINKER_FLAGS "${OV_LINKER_FLAGS} /guard:cf /CETCOMPAT")
endif()
...
if(ENABLE_INTEGRITYCHECK AND (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC" OR (OV_COMPILER_IS_INTEL_LLVM AND WIN32)))
    set(OV_LINKER_FLAGS "${OV_LINKER_FLAGS} /INTEGRITYCHECK")
endif()
