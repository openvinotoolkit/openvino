...
macro(ov_disable_deprecated_warnings)
    ...
    elseif(OV_COMPILER_IS_CLANG OR CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        set(ov_c_cxx_deprecated "-Wno-deprecated-declarations")
    else()
...
macro(ov_dev_package_no_errors)
    if(OV_COMPILER_IS_CLANG OR CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR (OV_COMPILER_IS_INTEL_LLVM AND UNIX))
...
macro(ov_avx512_optimization_flags flags)
    ...
    elseif(OV_COMPILER_IS_CLANG OR CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR (OV_COMPILER_IS_INTEL_LLVM AND UNIX))
...
function(ov_disable_all_warnings)
    foreach(target IN LISTS ARGN)
        ...
        elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR OV_COMPILER_IS_CLANG OR (OV_COMPILER_IS_INTEL_LLVM AND UNIX))
...
function(ov_abi_free_target target)
    ...
    if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND NOT MINGW64 AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS 13.0)
