...
macro(ie_parse_ci_build_number)
    ...
    macro(ie_get_hpp_version)
        ...
        set(ie_version_hpp "${OpenVINO_SOURCE_DIR}/runtime/core/runtime/include/ie/ie_version.hpp")
        if(NOT EXISTS ${ie_version_hpp})
            message(FATAL_ERROR "File ie_version.hpp with IE_VERSION definitions is not found")
        endif()

        set(ov_version_hpp "${OpenVINO_SOURCE_DIR}/runtime/core/core/include/openvino/core/version.hpp")
