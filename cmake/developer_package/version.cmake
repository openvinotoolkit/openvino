...
macro(ov_parse_ci_build_number)
    ...
    # TODO: prcoess alphas, beta, RCs etc.
    elseif(CI_BUILD_NUMBER MATCHES "^([0-9]+)\.([0-9]+)\.([0-9]+).*")
        set(OpenVINO_VERSION_MAJOR ${CMAKE_MATCH_1})
        set(OpenVINO_VERSION_MINOR ${CMAKE_MATCH_2})
        set(OpenVINO_VERSION_PATCH ${CMAKE_MATCH_3})
        set(OpenVINO_VERSION_BUILD "")
        set(the_whole_version_is_defined_by_ci ON)
...
#            message(STATUS "Variable name ${var}")
#            if (DEFINED ${var})
#                message(STATUS ".... Its value is |${${var}}|")
#            endif()
#            if (DEFINED ${var}_HPP)
#                message(STATUS ".... Its value in HPP is |${${var}_HPP}|")
#            endif()
#            if (NOT ${var} STREQUAL ${var}_HPP)
#                message(STATUS ".... Not equal")
#            endif()

            if(DEFINED ${var} AND NOT ${var} STREQUAL ${var}_HPP)
    ...
    set(version_add_info "")
    if(${OpenVINO_VERSION_BUILD} NOT STREQUAL "")
        set(version add_info "(Build ${OpenVINO_VERSION_BUILD})")
    endif()
    message(STATUS "OpenVINO version is ${OpenVINO_VERSION} ${version_add_info}")
