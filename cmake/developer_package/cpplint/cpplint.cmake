    ...
    foreach(source_file IN LISTS CPPLINT_FOR_SOURCES)
        ...
        add_custom_command(
            ...
            COMMAND
                ...
                -D "CPPLINT_SCRIPT=${OpenVINODevScripts_DIR}/cpplint/cpplint.py"
                ...
                -P "${OpenVINODevScripts_DIR}/cpplint/cpplint_run.cmake"
            DEPENDS
                "${source_file}"
                "${OpenVINODevScripts_DIR}/cpplint/cpplint.py"
                "${OpenVINODevScripts_DIR}/cpplint/cpplint_run.cmake"
            COMMENT
