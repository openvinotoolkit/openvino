...
function(add_cpplint_report_target)
    ...
    add_custom_command(
        ...
        COMMAND
            ...
            -P "${IEDevScripts_DIR}/cpplint/cpplint_merge.cmake"
        DEPENDS
            ${CPPLINT_ALL_OUTPUT_FILES}
            "${IEDevScripts_DIR}/cpplint/cpplint_merge.cmake"
        COMMENT
    ...
    add_custom_command(
        ...
        COMMAND
            ...
            -P "${IEDevScripts_DIR}/cpplint/cpplint_to_cppcheck_xml.cmake"
        DEPENDS
            "${cpplint_output_file}"
            "${OpenVINO_MAIN_SOURCE_DIR}/scripts/cpplint_to_cppcheckxml.py"
            "${IEDevScripts_DIR}/cpplint/cpplint_to_cppcheck_xml.cmake"
        COMMENT
    ...
    add_custom_command(
        ...
        COMMAND
            ...
            -P "${IEDevScripts_DIR}/cpplint/cpplint_html.cmake"
        DEPENDS
            "${cppcheck_output_file}"
            "${OpenVINO_MAIN_SOURCE_DIR}/scripts/cppcheck-htmlreport.py"
            "${IEDevScripts_DIR}/cpplint/cpplint_html.cmake"
        COMMENT
