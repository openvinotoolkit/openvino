...
macro(ov_register_in_plugins_xml)
    ...
    foreach(name IN LISTS PLUGIN_FILES)
        ...
        add_custom_command(TARGET ${OV_REGISTER_MAIN_TARGET} POST_BUILD
                  COMMAND
                    ...
                    -P "${OpenVINODevScripts_DIR}/plugins/unregister_plugin_cmake.cmake"
                  COMMENT
    ...
    foreach(name IN LISTS PLUGIN_FILES)
        ...
        add_custom_command(TARGET ${OV_REGISTER_MAIN_TARGET} POST_BUILD
           COMMAND
              ...
              -P "${OpenVINODevScripts_DIR}/plugins/create_plugin_file.cmake"
    ...
    add_custom_command(TARGET ${OV_REGISTER_MAIN_TARGET} POST_BUILD
                       COMMAND
                          ...
                          -D "OV_CONFIG_OUTPUT_FILE=${config_output_file}"
                          -D "OV_CONFIGS_DIR=${CMAKE_BINARY_DIR}/plugins"
                          -P "${OpenVINODevScripts_DIR}/plugins/register_plugin_cmake.cmake"
                        COMMENT
...
function(ov_generate_plugins_hpp)
    ...
    set(plugins_hpp_in "${OpenVINODevScripts_DIR}/plugins/plugins.hpp.in")
    ...
    add_custom_command(OUTPUT "${ov_plugins_hpp}"
                       COMMAND
                        ...
                        ${device_configs}
                        ${as_extension}
                        -P "${OpenVINODevScripts_DIR}/plugins/create_plugins_hpp.cmake"
                       DEPENDS
                         "${plugins_hpp_in}"
                         "${OpenVINODevScripts_DIR}/plugins/create_plugins_hpp.cmake"
                       COMMENT
