...
function(ov_add_plugin)
    ...
    if(NOT OV_PLUGIN_PSEUDO_PLUGIN_FOR)
        ...
        if(BUILD_SHARED_LIBS)
            target_compile_definitions(${OV_PLUGIN_NAME} PRIVATE OV_SHARED_LIBRARY_NAME=${OV_PLUGIN_NAME})
        endif()
...
function(ov_generate_plugins_hpp)
    ...
    foreach(name IN LISTS PLUGIN_FILES)
        ...
        if(BUILD_SHARED_LIBS)
            ...
            list(GET name 1 library_name_without_extension)
            list(APPEND device_mapping "${device_name}:${library_name}:${library_name_without_extension}")
        else()
