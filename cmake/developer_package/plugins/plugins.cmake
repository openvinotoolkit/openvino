...
function(ov_add_plugin)
    ...
    set(oneValueArgs NAME DEVICE_NAME VERSION_DEFINES_FOR PSEUDO_PLUGIN_FOR REAL_PLUGIN_NAME)
    ...
    if(NOT OV_PLUGIN_PSEUDO_PLUGIN_FOR)
        ...
        if(NOT OV_PLUGIN_REAL_PLUGIN_NAME)
            set(OV_PLUGIN_REAL_PLUGIN_NAME ${OV_PLUGIN_DEVICE_NAME})
        endif()
    ...
    if(NOT OV_PLUGIN_SKIP_REGISTRATION OR NOT BUILD_SHARED_LIBS)
        ...
        list(APPEND PLUGIN_FILES "${OV_PLUGIN_DEVICE_NAME}:${OV_PLUGIN_NAME}:${OV_PLUGIN_REAL_PLUGIN_NAME}")
...
function(ov_generate_plugins_hpp)
    ...
    foreach(name IN LISTS PLUGIN_FILES)
        ...
        if(BUILD_SHARED_LIBS)
            ...
            list(GET name 2 real_plugin_name)
            list(APPEND device_mapping "${device_name}:${library_name}:${real_plugin_name}")
        else()
