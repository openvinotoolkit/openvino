...
if(use_static_runtime)
    foreach(lang C CXX)
        foreach(build_type "" "_DEBUG" "_MINSIZEREL" "_RELEASE" "_RELWITHDEBINFO")
            ...
            set(link_flag_var "CMAKE_${type}_LINKER_FLAGS${build_type}_INIT")
            string(REPLACE "/MD" "/MT" ${flag_var} "${${flag_var}}")
            if (build_type STREQUAL "_DEBUG")
                set(${flag_var} "/MTd")
                string(APPEND ${link_flag_var} " /NODEFAULTLIB:libucrtd.lib /DEFAULTLIB:ucrtd.lib")
            else()
                set(${flag_var} "/MT")
                string(APPEND ${link_flag_var} " /NODEFAULTLIB:libucrt.lib /DEFAULTLIB:ucrt.lib")
            endif()
        endforeach()
    endforeach()
endif()
