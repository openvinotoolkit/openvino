...
if(BUILD_SHARED_LIBS AND (ENABLE_OV_TF_FRONTEND OR ENABLE_OV_ONNX_FRONTEND OR ENABLE_OV_PADDLE_FRONTEND))
    set(ENABLE_SHUTDOWN_PROTOBUF ON)
else()
    set(ENABLE_SHUTDOWN_PROTOBUF OFF)
endif()
