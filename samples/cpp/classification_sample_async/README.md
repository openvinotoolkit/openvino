...
When inference is done, the application outputs data to the standard output stream. Labels may be placed in the `.labels` file near the model to make an output look cleaner.
