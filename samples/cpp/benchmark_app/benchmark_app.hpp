...
/// @brief Define flag for loading property file <br>
DEFINE_string(load_property, "", load_property_message);

/// @brief Define flag for dumping property file <br>
DEFINE_string(dump_property, "", dump_property_message);
...
static void show_usage() {
    ...
    std::cout << "    -dump_property            " << dump_property_message << std::endl;
    std::cout << "    -load_property            " << load_property_message << std::endl;
}
