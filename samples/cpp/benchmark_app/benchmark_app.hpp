...
static const char report_type_message[] =
    ...
    "counters and latency for each executed infer request. \"sort_detailed_counters\" "
    "report sorted per-layer PM counters and latency for each executed infer request "
    "and calculate the percentage of per-layer PM counters.";
