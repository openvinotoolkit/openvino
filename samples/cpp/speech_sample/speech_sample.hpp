...
static const char memory_reuse_message[] = "Optional. Enables compact mode (memory_reuse).";
...
DEFINE_bool(memory_reuse, false, memory_reuse_message);
...
static void show_usage() {
    ...
    std::cout << "    -memory_reuse                " << memory_reuse_message << std::endl;
}
