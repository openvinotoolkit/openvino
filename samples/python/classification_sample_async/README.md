...
> **NOTES**:
>
> - By default, OpenVINO™ Toolkit Samples and Demos expect input with BGR channels order. In case you trained your model to work with RGB order, you need to manually rearrange the default channels order in the sample/demo application or reconvert your model using the Model Optimizer tool with specified argument `--reverse_input_channels`. You can learn about this argument in **When to Reverse Input Channels** section of [Embedding Preprocessing Computation](@ref openvino_docs_MO_DG_Additional_Optimization_Use_Cases).
>
