...
| ------------------| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| Basic Infer Flow  | [openvino.Core](https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.Core.html) ,                                                                                                                  |                                                                                                                 |
|                   | [openvino.Core.read_model](https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.Core.html#openvino.Core.read_model),                                                                       |                                                                                                                 |
|                   | [openvino.Core.compile_model](https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.Core.html#openvino.Core.compile_model)                                                                  | Common API to do inference                                                                                      |
| Synchronous Infer | [openvino.CompiledModel.infer_new_request](https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.CompiledModel.html#openvino.CompiledModel.infer_new_request),                              | Do synchronous inference                                                                                        |
| Model Operations  | [openvino.Model.inputs](https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.Model.html#openvino.Model.inputs),                                                                            | Managing of model                                                                                               |
|                   | [openvino.Model.outputs](https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.Model.html#openvino.Model.outputs),                                                                          |                                                                                                                 |
