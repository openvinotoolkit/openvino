...
const events = {
  onLibInitializing:
    setStatus('OpenVINO initializing...'),
  onModelLoaging:
    setStatus('OpenVINO successfully initialized. Model loading...'),
  onInferenceRunning:
    setStatus('Inference is in the progress, please wait...'),
...
makeInference(openvinojs, demoData.inferenceParametersMobilenetV3, events);
