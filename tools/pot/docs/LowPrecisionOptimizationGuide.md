...
please refer to the following [description](https://docs.openvino.ai/latest/_docs_ops_quantization_FakeQuantize_1.html).
...
[Inference Engine](https://docs.openvino.ai/latest/_docs_IE_DG_inference_engine_intro.html) in floating-point precision.
This process involves use of [Model Optimizer](https://docs.openvino.ai/latest/_docs_MO_DG_Deep_Learning_Model_Optimizer_DevGuide.html) tool to convert the model from the source framework 
