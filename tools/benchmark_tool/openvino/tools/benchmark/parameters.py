...
def parse_args():
    ...
    advs.add_argument('-shape', type=str, required=False, default='',
                      help='Optional. '
    ...
    advs.add_argument('-data_shape', type=str, required=False, default='',
                      help='Optional. '
    ...
    advs.add_argument('-layout', type=str, required=False, default='',
                      help='Optional. '
    ...
    advs.add_argument('-nthreads', '--number_threads', type=int, required=False, default=None,
                      help='Number of threads to use for inference on the CPU, GNA '
                           '(including HETERO and MULTI cases).')
    advs.add_argument('-pin', '--infer_threads_pinning', type=str, required=False,  choices=['YES', 'NO', 'NUMA', 'HYBRID_AWARE'],
    ...
    advs.add_argument('-pc', '--perf_counts', type=str2bool, required=False, default=False, nargs='?', const=True,
                      help='Optional. Report performance counters.', )
    advs.add_argument('-pcsort', '--perf_counts_sort', type=str, required=False, default="",
    ...
    advs.add_argument('-pcseq', '--pcseq', type=str2bool, required=False, default=False, nargs='?', const=True,
    ...
    advs.add_argument('-report_type', '--report_type', type=str, required=False,
    ...
    advs.add_argument('-report_folder', '--report_folder', type=str, required=False, default='',
                      help="Optional. Path to a folder where statistics report is stored.")
    advs.add_argument('-dump_config', type=str, required=False, default='',
                      help="Optional. Path to JSON file to dump OpenVINO parameters, which were set by application.")
    advs.add_argument('-load_config', type=str, required=False, default='',
