...
def get_convert_model_help_specifics():
    ...
    return {
        "input_model": {
            "description": "Input model file(s) from TensorFlow, ONNX, PaddlePaddle. "
        ...
        "input": {
            "description": "Information of model input required for model conversion. "
        ...
        "output": {
            "description": "One or more comma-separated model outputs to be preserved in the converted model. "
