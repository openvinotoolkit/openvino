...
from openvino._pyopenvino import get_version as get_ie_version  # pylint: disable=no-name-in-module,import-error
...
def get_simplified_ie_version(version=None):
    from openvino._pyopenvino import get_version  # pylint: disable=no-name-in-module,import-error
    if version is None:
        version = get_version()
