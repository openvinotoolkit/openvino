...
def get_convert_model_help_specifics():
    from openvino.runtime.ovc.cli_parser import CanonicalizeTransformationPathCheckExistenceAction, \
...
def get_to_string_methods_for_params():
    from openvino.runtime.ovc.cli_parser import path_to_str_or_object, str_list_to_str, \
