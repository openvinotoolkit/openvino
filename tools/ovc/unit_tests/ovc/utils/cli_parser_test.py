...
class TestShapesParsing(UnitTestWithMockedTelemetry):
    def test_get_shapes_several_inputs_several_shapes2(self):
        ...
        inputs_list, result, _ = get_placeholder_shapes(argv_input)
    ...
    def test_get_shapes_and_freezing_with_scalar_and_without_shapes_in_input(self):
        ...
        input_list, result_shapes, _ = get_placeholder_shapes(argv_input)
    ...
    def test_get_shapes_several_inputs_several_shapes3(self):
        ...
        input_list, result, _ = get_placeholder_shapes(argv_input)
    ...
    def test_get_shapes_no_input_no_shape(self):
        argv_input = ""
        _, result, _ = get_placeholder_shapes(argv_input)
        exp_res = None
...
class TestConvertModelParamsParsing(unittest.TestCase):
    def test_mo_convert_params_parsing(self):
        ref_params = {
            ...
            'Framework-agnostic parameters:': {'input_model',
                                               'input', 'output'
                                               'compress_to_fp16', 'transform', 'extensions',
                                               'silent', 'version',
                                               'example_input', 'share_weights'},
