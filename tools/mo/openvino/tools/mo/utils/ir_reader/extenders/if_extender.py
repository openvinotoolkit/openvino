...
class IfExtender(Extender):
    ...
    @staticmethod
    def set_input_output_id(
        subgraph, input_port_map, output_port_map, num_of_in_ports, num_of_out_ports
    ):
            ...
            for if_out_mapping_elem in output_port_map:
                if node_id == if_out_mapping_elem["internal_layer_id"]:
                    ...
                    if if_out_mapping_elem["external_port_id"] > num_of_out_ports:
                        node["output_id"] = (
                            if_out_mapping_elem["external_port_id"] - num_of_in_ports
                        )
    ...
    def extend(op: Node):
        ...
        IfExtender.set_input_output_id(
            op.then_graph,
            op.then_input_port_map,
