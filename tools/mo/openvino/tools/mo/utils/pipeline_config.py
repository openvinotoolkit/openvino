...
mapping_rules = [
    ...
    (
        ...
        "image_resizer/keep_aspect_ratio_resizer/pad_to_max_dimension",
        False,
    ),
    # anchor generator attributes
    (
        "anchor_generator_height",
        "first_stage_anchor_generator/grid_anchor_generator/height$",
        256,
    ),
    (
        "anchor_generator_width",
        "first_stage_anchor_generator/grid_anchor_generator/width$",
        256,
    ),
    (
        "anchor_generator_height_stride",
        "first_stage_anchor_generator/grid_anchor_generator/height_stride",
        16,
    ),
    (
        "anchor_generator_width_stride",
        "first_stage_anchor_generator/grid_anchor_generator/width_stride",
        16,
    ),
    (
        "anchor_generator_scales",
        "first_stage_anchor_generator/grid_anchor_generator/scales",
    ),
    (
        "anchor_generator_aspect_ratios",
        "first_stage_anchor_generator/grid_anchor_generator/aspect_ratios",
    ),
    (
        "multiscale_anchor_generator_min_level",
        "anchor_generator/multiscale_anchor_generator/min_level",
    ),
    (
        "multiscale_anchor_generator_max_level",
        "anchor_generator/multiscale_anchor_generator/max_level",
    ),
    (
        "multiscale_anchor_generator_anchor_scale",
        "anchor_generator/multiscale_anchor_generator/anchor_scale",
    ),
    (
        "multiscale_anchor_generator_aspect_ratios",
        "anchor_generator/multiscale_anchor_generator/aspect_ratios",
    ),
    (
        "multiscale_anchor_generator_scales_per_octave",
        "anchor_generator/multiscale_anchor_generator/scales_per_octave",
    ),
    # SSD anchor generator attributes
    (
        "ssd_anchor_generator_min_scale",
        "anchor_generator/ssd_anchor_generator/min_scale",
        0.2,
    ),
    (
        "ssd_anchor_generator_max_scale",
        "anchor_generator/ssd_anchor_generator/max_scale",
        0.95,
    ),
    (
        "ssd_anchor_generator_num_layers",
        "anchor_generator/ssd_anchor_generator/num_layers",
    ),
    (
        "ssd_anchor_generator_aspect_ratios",
        "anchor_generator/ssd_anchor_generator/aspect_ratios",
    ),
    ...
    (
        ...
        "anchor_generator/ssd_anchor_generator/interpolated_scale_aspect_ratio",
        1.0,
    ),
    (
        "ssd_anchor_generator_reduce_lowest",
        "anchor_generator/ssd_anchor_generator/reduce_boxes_in_lowest_layer",
    ),
    (
        "ssd_anchor_generator_base_anchor_height",
        "anchor_generator/ssd_anchor_generator/base_anchor_height",
        1.0,
    ),
    (
        "ssd_anchor_generator_base_anchor_width",
        "anchor_generator/ssd_anchor_generator/base_anchor_width",
        1.0,
    ),
    ...
    (
        "postprocessing_max_detections_per_class",
        ".*/batch_non_max_suppression/max_detections_per_class",
    ),
    (
        "postprocessing_max_total_detections",
        ".*/batch_non_max_suppression/max_total_detections",
    ),
    (
        "share_box_across_classes",
        "second_stage_box_predictor/.*/share_box_across_classes$",
        False,
    ),
...
class PipelineConfig:
    ...
    def _update_param_using_rule(self, params: dict, rule: [str, tuple]):
        if isinstance(rule, str):
            ...
            if value is not None:
                ...
                log.debug(
                    'There is no value path "{}". Set default value "{}"'.format(
                        value, rule[2]
                    )
                )
    ...
    def _initialize_model_params(self):
        ...
        if "model" not in self._raw_data_dict:
            raise Error(
                'The "model" key is not found in the configuration file. Looks like the parsed file is not '
