...
def get_convert_model_help_specifics():
    from openvino.tools.mo.utils.cli_parser import (
        ...
        CanonicalizePathCheckExistenceIfNeededAction,
        CanonicalizeTransformationPathCheckExistenceAction,
        check_positive,
        readable_dirs_or_files_or_empty,
        readable_file_or_dir,
    )
    from openvino.tools.mo.utils.version import VersionChecker

    return {
        "input_model": {
            "description": "Tensorflow*: a file with a pre-trained model "
        ...
        "input_shape": {
            "description": "Input shape(s) that should be fed to an input node(s) "
        ...
        "input": {
            "description": "Quoted list of comma-separated input nodes names with "
        ...
        "mean_values": {
            "description": "Mean values to be used for the input image per "
        ...
        "scale_values": {
            "description": "Scale values to be used for the input image per "
        ...
        "source_layout": {
            "description": "Layout of the input or output of the model in the "
        ...
        "transform": {
            "description": 'Apply additional transformations. Usage: "--transform '
        ...
        "extensions": {
            "description": "Paths or a comma-separated list of paths to libraries "
        ...
        "transformations_config": {
            "description": "Use the configuration file with transformations "
        ...
        "counts": {"action": CanonicalizePathCheckExistenceIfNeededAction},
        "version": {
            "action": "version",
            "version": "Version of Model Optimizer is: {}".format(
                VersionChecker().get_ie_version()
            ),
        },
        "scale": {"type": float, "aliases": {"-s"}},
        "batch": {"type": check_positive, "aliases": {"-b"}},
        "input_proto": {"aliases": {"-d"}},
        "log_level": {
            "choices": [
                "CRITICAL",
                "ERROR",
