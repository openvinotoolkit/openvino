...
from openvino.tools.mo.front.common.layout import get_height_dim, get_width_dim
...
class PriorBoxOp(Op):
    ...
    def priorbox_infer(node: Node):
        ...
        if node.has_and_set("V10_infer"):
            ...
            res_prod = (
                data_shape[get_height_dim(layout, 4)]
                * data_shape[get_width_dim(layout, 4)]
                * num_ratios
                * 4
            )
