...
class RollWithEmptyAxesReplacer(FrontReplacementPattern):
    ...
    def find_and_replace_pattern(self, graph: Graph):
        for roll_node in graph.get_op_nodes(op="Roll"):
            ...
            rename_nodes(
                [(roll_node, node_name + "/roll"), (reshape_to_orig_shape, node_name)]
            )
