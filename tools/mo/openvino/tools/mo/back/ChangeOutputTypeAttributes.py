...
def assert_that_is_castable_to_fp16(node: Node):
    ...
    original_output_len = original_output.shape if hasattr(original_output, 'shape') else None
    casted_output_len = casted_output.shape if hasattr(casted_output, 'shape') else None
