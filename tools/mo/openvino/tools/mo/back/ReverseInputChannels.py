...
class ReverseChannelsPropagationDown(BackReplacementPattern):
    ...
    propagation_rules = {
        ...
        'ConvertFP8': lambda node, rc: ReverseChannelsPropagationDown.pass_rc_through_eltwise(node, rc),
...
class ReverseChannelsPropagationUp(BackReplacementPattern):
    ...
    propagation_rules = {
        ...
        'ConvertFP8': lambda node, rc: ReverseChannelsPropagationUp.lift_up_through_eltwise(node, rc),
