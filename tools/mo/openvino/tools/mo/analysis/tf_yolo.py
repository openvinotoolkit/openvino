...
YOLO_CONFIGS = {
    "YOLOV2Full": [
        "openvino/tools/mo/front/tf/yolo_v2.json",
        "openvino/tools/mo/front/tf/yolo_v2_voc.json",
    ],
    "YOLOV3Full": [
        "openvino/tools/mo/front/tf/yolo_v3.json",
        "openvino/tools/mo/front/tf/yolo_v3_voc.json",
    ],
    "YOLOV2Tiny": [
        "openvino/tools/mo/front/tf/yolo_v2_tiny.json",
        "openvino/tools/mo/front/tf/yolo_v2_tiny_voc.json",
    ],
    "YOLOV3Tiny": [
        "openvino/tools/mo/front/tf/yolo_v3_tiny.json",
        "openvino/tools/mo/front/tf/yolo_v3_tiny_voc.json",
    ],
}
...
class TensorFlowYOLOV1V2Analysis(AnalyzeAction):
    ...
    def analyze(self, graph: Graph):
        ...
        if flavor is not None:
            message = (
                "Your model looks like YOLOv1 or YOLOv2 Model.\n"
...
class TensorFlowYOLOV3Analysis(AnalyzeAction):
    ...
    def analyze(self, graph: Graph):
        flavor = None
        if graph_contains_scope(graph, "detector/yolo-v3") and graph_contains_scope(
            graph, "detector/darknet-53"
        ):
            flavor = "YOLOV3Full"
        ...
        if flavor is not None:
            message = (
                "Your model looks like YOLOv3 Model.\n"
