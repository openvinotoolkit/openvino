...
from openvino.tools.mo.middle.InterpolateSequenceToInterpolate import (
...
graph_node_attrs_for_2d_case_1_opset4_case = {
    ...
    "size_1": {
        ...
        "op": "Const",
        "type": "Const",
        "value": int64_array([660]),
    },
    "size_1_data": {"value": int64_array([660]), "shape": [1], "kind": "data"},
    "scale_1": {"kind": "op", "op": "Const", "type": "Const", "value": np.array([3.0])},
    "scale_1_data": {"value": np.array([3.0]), "shape": [1], "kind": "data"},
    "axes_1": {"kind": "op", "op": "Const", "type": "Const", "value": int64_array([2])},
    ...
    "size_2": {
        ...
        "op": "Const",
        "type": "Const",
        "value": int64_array([700]),
    },
    "size_2_data": {"value": int64_array([700]), "shape": [1], "kind": "data"},
    "scale_2": {"kind": "op", "op": "Const", "type": "Const", "value": np.array([2.0])},
    "scale_2_data": {"value": np.array([2.0]), "shape": [1], "kind": "data"},
    "axes_2": {"kind": "op", "op": "Const", "type": "Const", "value": int64_array([3])},
    ...
    "size_3": {
        ...
        "op": "Const",
        "type": "Const",
        "value": int64_array([1320]),
    },
    "size_3_data": {"value": int64_array([1320]), "shape": [1], "kind": "data"},
    "scale_3": {"kind": "op", "op": "Const", "type": "Const", "value": np.array([2.0])},
    "scale_3_data": {"value": np.array([2.0]), "shape": [1], "kind": "data"},
    "axes_3": {"kind": "op", "op": "Const", "type": "Const", "value": int64_array([2])},
    ...
    "interpolate_3_data": {
        "value": None,
        "shape": int64_array([1, 4, 1320, 700]),
        "kind": "data",
    },
...
new_graph_node_attrs_for_2d_case_4_opset4_case = {
    ...
    "interpolate_1_data": {
        "value": None,
        "shape": int64_array([1, 4, 2200, 350]),
        "kind": "data",
    },
    "size_2": {
        "kind": "op",
    ...
    "interpolate_2_data": {
        "value": None,
        "shape": int64_array([1, 4, 2200, 700]),
        "kind": "data",
    },
    "abs": {"type": "Abs", "kind": "op", "op": "Abs"},
    "abs_data": {
...
new_ref_graph_node_attrs_for_3d_case_1_opset4_case = {
    ...
    "size_1": {
        ...
        "op": "Const",
        "type": "Const",
        "value": int64_array([4096, 1280, 2400]),
    },
    "size_1_data": {"value": None, "shape": None, "kind": "data"},
    "scale_1": {
        "kind": "op",
    ...
    "interpolate_1_data": {
        "value": None,
        "shape": int64_array([1, 5, 4096, 1280, 2400]),
        "kind": "data",
    },
    "size_3": {
        "kind": "op",
    ...
    "scale_3": {
        ...
        "op": "Const",
        "type": "Const",
        "value": np.array([512.0 / 2400.0]),
    },
    "scale_3_data": {"value": None, "shape": [1], "kind": "data"},
    "axes_3": {"kind": "op", "op": "Const", "type": "Const", "value": int64_array([4])},
    ...
    "interpolate_3_data": {
        "value": None,
        "shape": int64_array([1, 5, 4096, 1280, 512]),
        "kind": "data",
    },
    "abs": {"type": "Abs", "kind": "op", "op": "Abs"},
    "abs_data": {
...
new_graph_node_attrs_for_3d_case_1_opset4_case = {
    ...
    "interpolate_1_data": {
        "value": None,
        "shape": int64_array([1, 5, 4096, 256, 2400]),
        "kind": "data",
    },
    "size_2": {
        "kind": "op",
        "op": "Const",
        "type": "Const",
        "value": int64_array([1280]),
    },
    "size_2_data": {"value": int64_array([1280]), "shape": [1], "kind": "data"},
    "scale_2": {"kind": "op", "op": "Const", "type": "Const", "value": np.array([5.0])},
...
graph_node_attrs_for_3d_case_2 = {
    ...
    "interpolate_1_data": {
        "value": None,
        "shape": int64_array([1, 5, 4096, 1280, 800]),
        "kind": "data",
    },
    "abs": {"type": "Abs", "kind": "op", "op": "Abs"},
    "abs_data": {
...
graph_node_attrs_for_3d_case_3 = {
    ...
    "interpolate_1_data": {
        "value": None,
        "shape": int64_array([16, 44, 256, 87, 790]),
        "kind": "data",
    },
    "scale_2": {
        "kind": "op",
    ...
    "interpolate_2_data": {
        "value": None,
        "shape": int64_array([16, 44, 256, 87, 2370]),
        "kind": "data",
    },
    "scale_3": {
        "kind": "op",
    ...
    "interpolate_3_data": {
        "value": None,
        "shape": int64_array([16, 44, 256, 435, 2370]),
        "kind": "data",
    },
    "abs": {"type": "Abs", "kind": "op", "op": "Abs"},
    "abs_data": {
...
new_ref_graph_node_attrs_for_3d_case_4_opset4_case = {
    ...
    "size_1": {
        ...
        "op": "Const",
        "type": "Const",
        "value": int64_array([4599, 912, 133120]),
    },
    "size_1_data": {"value": None, "shape": None, "kind": "data"},
    "scale_1": {
        "kind": "op",
    ...
    "interpolate_1_data": {
        "value": None,
        "shape": int64_array([10, 64, 4599, 912, 133120]),
        "kind": "data",
    },
    "abs": {"type": "Abs", "kind": "op", "op": "Abs"},
    "abs_data": {
...
new_graph_node_attrs_for_3d_case_4_opset4_case = {
    ...
    "scale_1": {
        ...
        "op": "Const",
        "type": "Const",
        "value": np.array([4599.0 / 511.0, 133120.0 / 10240.0]),
    },
    "scale_1_data": {
        "value": np.array([4599.0 / 511.0, 133120.0 / 10240.0]),
        "shape": [2],
    ...
    "interpolate_1_data": {
        "value": None,
        "shape": int64_array([10, 64, 4599, 416, 133120]),
        "kind": "data",
    },
    "size_2": {
        "kind": "op",
...
class InterpolateSequenceToInterpolateTest(unittest.TestCase):
    def test_2d_interpolate_sequence_1(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_2d_case_1, edges=edges_for_2d_case_1
        )
    ...
    def test_2d_interpolate_sequence_2(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_2d_case_2, edges=edges_for_2d_case_2
        )
        ref_graph = build_graph(
            nodes_attrs=graph_node_attrs_for_2d_case_2, edges=edges_for_2d_case_2
        )
    ...
    def test_2d_interpolate_sequence_3(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_2d_case_3, edges=edges_for_2d_case_3
        )
    ...
    def test_2d_interpolate_sequence_4(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_2d_case_4, edges=edges_for_2d_case_4
        )
    ...
    def test_2d_interpolate_sequence_5_opset4_case(self):
        graph = build_graph(
            ...
            update_attributes={"interpolate_1": {"antialias": 0, "cube_coeff": -0.1}},
        )
    ...
    def test_2d_interpolate_sequence_6(self):
        ...
        ref_graph = build_graph(
            nodes_attrs=graph_node_attrs_for_2d_case_6, edges=edges_for_2d_case_6
        )
    ...
    def test_3d_interpolate_sequence_1(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_3d_case_1, edges=edges_for_3d_case_1
        )
    ...
    def test_3d_interpolate_sequence_3(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_3d_case_3, edges=edges_for_3d_case_3
        )
        ref_graph = build_graph(
            nodes_attrs=graph_node_attrs_for_3d_case_3, edges=edges_for_3d_case_3
        )
    ...
    def test_3d_interpolate_sequence_4(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_3d_case_4, edges=edges_for_3d_case_4
        )
