...
class InsertSelectTests(unittest.TestCase):
    ...
    def test_insert_select_0(self):
        graph = build_graph(
            ...
            [("input", "placeholder_data_1"), ("placeholder_data_1", "memory")],
    ...
    def test_insert_select_1(self):
        ...
        ref_graph = build_graph(
            ...
            [
                ...
                ("memory_in_data", "crop_in"),
                ("crop_in", "crop_in_data"),
                ("crop_in_data", "concat", {"in": 0}),
                ...
                ("crop_out_data", "equal", {"in": 1}),
                ("broadcast_data_mem_2", "equal", {"in": 0}),
                ("equal", "equal_data"),
                ("equal_data", "select", {"in": 0}),
                ("placeholder_data_2", "shape"),
                ("shape", "shape_data"),
                ...
                ("second_dim_data", "gather_shape", {"in": 1}),
                ...
                ("gather_shape_data", "broadcast", {"in": 1}),
