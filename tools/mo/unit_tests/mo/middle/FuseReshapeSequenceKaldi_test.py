...
class FuseReshapesKaldiTests(unittest.TestCase):
    ref_nodes = {
        ...
        **regular_op_with_shaped_data(
            "transpose_out", [1, 1, 9, 128], {"op": "Transpose", "type": "Transpose"}
        ),
        **valued_const_with_data("transpose_in_order", int64_array([0, 3, 1, 2])),
        **regular_op_with_shaped_data(
            "transpose_in", [1, 128, 1, 9], {"op": "Transpose", "type": "Transpose"}
        ),
        **regular_op_with_shaped_data(
            "pool",
            [1, 128, 1, 3],
    ...
    nodes = {
        **regular_op_with_shaped_data(
            "conv",
            [1, 128, 1, 9],
            {"kind": "op", "op": "Convolution", "kernel": [1, 1, 11, 5]},
        ),
        **valued_const_with_data("transpose_out_order", int64_array([0, 2, 3, 1])),
        **regular_op_with_shaped_data(
            "transpose_out", [1, 1, 9, 128], {"op": "Transpose", "type": "Transpose"}
        ...
        **regular_op_with_shaped_data(
            "reshape_out",
            [1, 1152],
            {"op": "Reshape", "type": "Reshape", "special_zero": True},
        ),
        **regular_op_with_shaped_data(
            "shapeof", [4], {"op": "ShapeOf", "type": "ShapeOf"}
        ),
        **valued_const_with_data("ind", int64_array([0])),
        **valued_const_with_data("axis", int64_array(0)),
        **regular_op_with_shaped_data(
            "gather_batch", [], {"op": "Gather", "type": "Gather"}
        ),
        ...
        **regular_op_with_shaped_data(
            "concat", [4], {"op": "Concat", "type": "Concat"}
        ),
        **regular_op_with_shaped_data(
            "reshape_in", [1, 1, 9, 128], {"op": "Reshape", "type": "Reshape"}
        ),
        **valued_const_with_data("transpose_in_order", int64_array([0, 3, 1, 2])),
        **regular_op_with_shaped_data(
            "transpose_in", [1, 128, 1, 9], {"op": "Transpose", "type": "Transpose"}
