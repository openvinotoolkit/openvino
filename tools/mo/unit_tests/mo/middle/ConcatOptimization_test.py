...
from openvino.tools.mo.middle.ConcatOptimization import (
    ConcatOdInputEraserAndPortsReconnect,
)
...
class ConcatOdInputEraserAndPortsReconnectTest(unittest.TestCase):
    ...
    def test_assertion_error(self):
        ...
        self.assertRaises(
            AssertionError,
            ConcatOdInputEraserAndPortsReconnect().find_and_replace_pattern,
            graph,
        )
