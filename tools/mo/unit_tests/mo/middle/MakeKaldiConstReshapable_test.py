...
nodes = {
    **regular_op_with_shaped_data(
        "placeholder_1", [1, 13], {"kind": "op", "op": "Parameter", "shape": [1, 13]}
    ),
    **regular_op_with_shaped_data(
        "splice_1",
        [1, 13],
        {"kind": "op", "op": "Splice", "context": np.array([-2, -1, 0, 1, 2])},
    ),
    **regular_op_with_shaped_data("placeholder_2", [1, 26], {"kind": "op", "op": None}),
    **regular_op_with_shaped_data(
        "memory_in",
        [1, 5],
        {"kind": "op", "op": "ReadValue", "shape": int64_array([1, 5])},
    ),
    **regular_op_with_shaped_data(
        "memory_out",
        [1, 5],
        {"kind": "op", "op": "Assign", "shape": int64_array([1, 5])},
    ),
    **result("result"),
    **regular_op_with_shaped_data(
        "crop_in",
        [1, 4],
        {"kind": "op", "op": "Crop", "axis": 1, "offset": 1, "dim": 4},
    ),
    **regular_op_with_shaped_data(
        "crop_out",
        [1, 1],
        {"kind": "op", "op": "Crop", "axis": 1, "offset": 0, "dim": 1},
    ),
    ...
    **regular_op_with_shaped_data(
        "crop_batch", None, {"kind": "op", "op": "Crop", "offset": int64_array([0])}
    ),
    **regular_op_with_shaped_data(
        "crop_batch_dim",
        None,
    ...
    **regular_op_with_shaped_data(
        "broadcast", [1, 5], {"kind": "op", "op": "Broadcast"}
    ),
    **regular_op_with_shaped_data(
        "fill_value_ones",
        [1, 26],
