...
class GatherNDDecompositionTest(unittest.TestCase):
    ...
    def test_GatherNDDecomposition_2by2indices_validinputs(self):
        ...
        graph = build_graph(
            ...
            update_attributes={
                "input_data": {
                    "shape": np.array([2, 1]),
                    "value": np.array([1, 2]).reshape([2, 1]),
                },
                "indices_input_data": {
                    "shape": np.array([2, 2]),
                    "value": np.array([1, 0, 0, 0]).reshape([2, 2]),
                },
    ...
    def test_GatherNDDecomposition_2by1indices_validinputs(self):
        ...
        graph = build_graph(
            ...
            update_attributes={
                ...
                "indices_input_data": {
                    "shape": np.array([2, 2]),
                    "value": np.array([1, 0]).reshape([2, 1]),
                },
                "gathernd": {"batch_dims": 0},
            },
            nodes_with_edges_only=True,
    ...
    def test_GatherNDDecomposition_2by0indices_invalidinputs(self):
        ...
        graph = build_graph(
            ...
            update_attributes={
                "input_data": {
                    "shape": np.array([1, 2]),
                    "value": np.array([1, 2]).reshape([1, 2]),
                },
                "indices_input_data": {
                    "shape": np.array([2]),
                    "value": np.array([1, 0]),
    ...
    def test_GatherNDDecomposition_1leadingdim(self):
        ...
        graph = build_graph(
            ...
            update_attributes={
                ...
                "indices_input_data": {
                    "shape": np.array([2, 1, 1]),
                    "value": np.array([1, 0]).reshape([2, 1, 1]),
                },
                "gathernd": {"batch_dims": 0},
            },
            nodes_with_edges_only=True,
    ...
    def test_GatherNDDecomposition_3leadingdims(self):
        ...
        graph = build_graph(
            ...
            update_attributes={
                ...
                "indices_input_data": {
                    "shape": np.array([2, 1, 1, 1, 1]),
                    "value": np.array([1, 0]).reshape([2, 1, 1, 1, 1]),
                },
                "gathernd": {"batch_dims": 0},
            },
            nodes_with_edges_only=True,
        ...
        graph_ref = build_graph(
            ...
            update_attributes={
                ...
                "indices": {
                    "shape": np.array([2, 1, 1, 1]),
                    "value": np.array([1, 0]).reshape([2, 1, 1, 1]),
                },
                "reshape_shape": {"shape": np.array([2]), "value": np.array([-1, 2])},
                "axis": {"shape": np.array([]), "value": 0},
            },
        ...
        graph = build_graph(
            ...
            update_attributes={
                "input_data": {
                    ...
                    "value": np.array([i for i in range(24)]).reshape([2, 3, 4]),
                },
                "indices_input_data": {
                    "shape": np.array([2, 1]),
                    "value": np.array([1, 0]).reshape([2, 1]),
    ...
    def test_GatherNDDecomposition_complexexample3(self):
        ...
        graph = build_graph(
            ...
            update_attributes={
                "input_data": {
                    "shape": np.array([1, 1, 5]),
                    "value": np.array([1, 2, 3, 4, 5]).reshape([1, 1, 5]),
                },
                "indices_input_data": {
                    "shape": np.array([2, 2, 3]),
                    "value": np.array([0, 0, 3, 0, 0, 1, 0, 0, 4, 0, 0, 2]).reshape(
                        [2, 2, 3]
                    ),
                },
                "gathernd": {"batch_dims": 0},
        ...
        graph_ref = build_graph(
            ...
            update_attributes={
                ...
                "indices": {
                    "shape": np.array([2, 2]),
                    "value": np.array([3, 1, 4, 2]).reshape([2, 2]),
                },
                "reshape_shape": {"shape": np.array([1]), "value": np.array([-1])},
                "axis": {"shape": np.array([]), "value": 0},
            },
    ...
    def test_GatherNDDecomposition_complexexample4(self):
        ...
        graph = build_graph(
            ...
            update_attributes={
                "input_data": {
                    "shape": np.array([1, 4, 1]),
                    "value": np.array([1, 2, 3, 4]).reshape([1, 4, 1]),
                },
                "indices_input_data": {
                    "shape": np.array([2, 2, 2]),
                    "value": np.array([0, 1, 0, 3, 0, 2, 0, 0]).reshape([2, 2, 2]),
                },
                "gathernd": {"batch_dims": 0},
            },
            nodes_with_edges_only=True,
        ...
        graph_ref = build_graph(
            ...
            update_attributes={
                ...
                "indices": {
                    "shape": np.array([2, 2]),
                    "value": np.array([1, 3, 2, 0]).reshape([2, 2]),
                },
