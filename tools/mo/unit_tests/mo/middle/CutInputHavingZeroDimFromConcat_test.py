...
from openvino.tools.mo.middle.CutInputHavingZeroDimFromConcat import (
    CutInputHavingZeroDimFromConcat,
)
...
class CutInputHavingZeroDimFromConcatTest(unittest.TestCase):
    ...
    def test_there_are_four_inputs_and_first_and_third_input_have_zero_in_their_shapes(
        self,
    ):
        graph = build_graph(
            nodes_attrs={
