        ...
        graph = build_graph(
            {
                "const_dense_shape": {
                    ...
                    "kind": "op",
                    "op": "Const",
                    "value": int64_array([4, 5]),
                    "shape": int64_array([2]),
                },
                "const_dense_shape_data": {
                    "kind": "data",
                    "value": int64_array([4, 5]),
                    "shape": int64_array([2]),
                },
                "const_new_dense_shape": {
                    "type": "Const",
                    "kind": "op",
                    "op": "Const",
                    "value": int64_array([4, -1]),
                    "shape": int64_array([2]),
                },
                "const_new_dense_shape_data": {
                    "kind": "data",
                    "value": int64_array([4, -1]),
                    "shape": int64_array([2]),
                },
                ...
                "input_params_table": {
                    "value": None,
                    "shape": int64_array([100, 4, 3]),
                    "type": "Parameter",
                    "kind": "op",
                    "op": "Parameter",
                },
                "input_params_table_data": {
                    "shape": int64_array([10, 4, 3]),
                    "value": None,
                    "kind": "data",
                },
