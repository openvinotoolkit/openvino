    ...
    def test_1(self):
        ...
        ref_graph = build_graph(
            nodes_attrs={
                ...
                **shaped_const_with_data("gamma", None),
                **regular_op_with_empty_data(
                    "gamma_unsqueeze", {"op": "Unsqueeze", "type": "Unsqueeze"}
                ),
                **shaped_const_with_data("gamma_unsqueeze_const", None),
                **regular_op_with_empty_data(
                    "beta_unsqueeze", {"op": "Unsqueeze", "type": "Unsqueeze"}
                ),
            ...
            update_attributes={
                ...
                "gamma_unsqueeze_const": {
                    "value": int64_array([0, 1, 2]),
                    "shape": int64_array([3]),
                },
                "beta_unsqueeze_const": {
                    "value": int64_array([0, 1, 2]),
                    "shape": int64_array([3]),
                },
            },
