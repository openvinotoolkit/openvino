...
class TensorIteratorConditionTests(unittest.TestCase):
    def test_not_dynamic_1(self):
        ...
        graph = build_graph_with_attrs(
            ...
            new_edges_with_attrs=[("Identity_1_data", "TensorIteratorInput")],
        ...
        nodes_attributes = {
            **regular_op_with_empty_data(
                "StridedSlice", {"op": "StridedSlice", "type": None}
            ),
        ...
        (flag, resp) = compare_graphs(
            graph, graph_ref, "loop_cond_data", check_op_attrs=True
        )
    ...
    def test_not_dynamic_2(self):
        ...
        nodes_attributes = {
            **regular_op_with_empty_data(
                "loop_cond", {"op": "TensorIteratorCondition", "type": None}
            ),
            **regular_op_with_empty_data(
                "StridedSlice", {"op": "StridedSlice", "type": None}
            ),
