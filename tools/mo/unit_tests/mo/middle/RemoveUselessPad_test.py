...
class RemoveUselessPadTests(unittest.TestCase):
    def test_useless_pad_constant_input(self):
        nodes = {
            **regular_op_with_shaped_data(
                "placeholder", [1, 10, 20, 3], {"type": "Parameter"}
            ),
            **regular_op_with_shaped_data(
                "pad", [1, 10, 20, 3], {"type": "Pad", "op": "Pad"}
            ),
