...
from openvino.tools.mo.middle.ReverseTransposeNormalization import (
    ReverseTransposeNormalization,
)
...
class ReverseTransposeNormalizationTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.ref_nodes_attributes = {
            ...
            **regular_op_with_shaped_data(
                "transpose", [3, 20, 10, 1], {"type": "Transpose", "op": "Transpose"}
            ),
