...
nodes = {
    **regular_op_with_shaped_data(
        "input", shape, {"type": "Parameter", "op": "Parameter"}
    ),
    ...
    **regular_op_with_shaped_data(
        "space_to_batch",
        int64_array([1024, 14, 18, 24]),
        {"op": "SpaceToBatch", "name": "stb"},
    ),
    **regular_op_with_shaped_data(
        "conv",
        int64_array([1024, 12, 16, 24]),
        {
            "op": "Conv2D",
            "name": "conv",
    ...
    **regular_op_with_shaped_data(
        "batch_to_space", shape, {"op": "BatchToSpace", "name": "bts"}
    ),
    **result("result"),
}

edges = [
    *connect("input", "0:space_to_batch"),
...
ref_nodes = {
    ...
    **regular_op_with_shaped_data(
        ...
        shape,
        {
            ...
            "name": "conv",
            "spatial_dims": int64_array([1, 2]),
            "dilation": int64_array([1, 32, 32, 1]),
            "auto_pad": None,
...
ref_edges = [*connect("input", "0:conv"), *connect("conv", "result")]
