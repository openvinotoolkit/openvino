...
class TestQuantizeWithAxis(unittest.TestCase):
    def test_quantize_with_axis(self):
        ...
        for idx, (input_shape, scale_param_value, zero_param_value,
                                target_shape, in_low, in_high, out_low, out_high, axis) in enumerate(test_cases):
            with self.subTest(test_cases=idx):
                graph = build_graph(nodes1_attributes,
                                    ...
                                    ],
                                    {
                                        ...
                                        'scale_param_q_data': {'shape': scale_param_value.shape,
                                                               'value': scale_param_value},
                                        'zerop_param_q': {'shape': zero_param_value.shape, 'value': zero_param_value},
                                        'zerop_param_q_data': {'shape': zero_param_value.shape,
