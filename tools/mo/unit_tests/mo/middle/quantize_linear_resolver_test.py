...
class TestQuantizeWithAxis:
    @pytest.mark.parametrize(
        "input_shape, scale_param_value, zero_param_value,target_shape, in_low, in_high, out_low, out_high, axis",
        [
            (
                int64_array([1, 3, 4, 4]),
                ...
                np.array([253.0, 252.0, 251.0, 250.0]),
                0,
                255,
                2,
            ),
            ...
            (
                ...
                np.array([125.0, 124.0, 123.0, 122.0]),
                -128.0,
                127.0,
                2,
            ),
