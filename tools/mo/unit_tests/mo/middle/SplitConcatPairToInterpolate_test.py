...
from openvino.tools.mo.middle.SplitConcatPairToInterpolate import (
...
graph_node_attrs_for_2d_spatial_case = {
    ...
    "split_data_0": {
        "value": None,
        "shape": int64_array([1, 100, 120, 50]),
        "kind": "data",
    },
    "split_data_1": {
        "value": None,
    ...
    "concat_data": {
        "value": None,
        "shape": int64_array([1, 100, 120, 300]),
        "kind": "data",
    },
...
graph_node_attrs_for_3d_spatial_case = {
    ...
    "split_data_0": {
        "value": None,
        "shape": int64_array([1, 3, 100, 120, 50]),
        "kind": "data",
    },
    "split_data_1": {
        "value": None,
    ...
    "concat_data": {
        "value": None,
        "shape": int64_array([1, 3, 100, 120, 300]),
        "kind": "data",
    },
    "abs": {"type": "Abs", "kind": "op", "op": "Abs"},
    "abs_data": {
...
ref_graph_node_attrs_for_3d_spatial_case_2 = {
    ...
    "interpolate_data": {
        "value": None,
        "shape": int64_array([1, 3, 100, 240, 150]),
        "kind": "data",
    },
    "abs": {"type": "Abs", "kind": "op", "op": "Abs"},
    "abs_data": {
...
class SplitConcatPairToInterpolateTest(unittest.TestCase):
    def test_spatial_2d_split_concat_1(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_2d_spatial_case, edges=graph_edges
        )
    ...
    def test_spatial_3d_split_concat_1(self):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_for_3d_spatial_case, edges=graph_edges
        )
        ref_graph = build_graph(
    ...
    def test_spatial_3d_split_concat_2(self):
        graph = build_graph(
            ...
            update_attributes={
                ...
                "split_data_0": {
                    "value": None,
                    "shape": int64_array([1, 3, 100, 40, 150]),
                    "kind": "data",
                },
                "split_data_1": {
                    "value": None,
