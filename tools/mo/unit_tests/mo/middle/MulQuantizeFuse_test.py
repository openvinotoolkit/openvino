...
class MulQuantizeFuseTest(unittest.TestCase):
    def test_1(self):
        graph = build_graph(
            ...
            edges,
            {
                ...
                "mul_const_data": {
                    ...
                    "value": np.broadcast_to(np.array([1]), (3, 1, 1)),
                },
                ...
                "ma_o_data": {
                    ...
                    "value": np.broadcast_to(np.array([1]), (1, 3, 1, 1)),
                },
            },
        ...
        graph_ref = build_graph(
            ...
            edges_ref,
            {
                ...
                "mi_i_data": {
                    "shape": np.array([3, 1, 1]),
                    "value": np.broadcast_to(np.array([-10]), (3, 1, 1)),
                },
                "ma_i_data": {
                    "shape": np.array([3, 1, 1]),
                    "value": np.broadcast_to(np.array([10]), (3, 1, 1)),
    ...
    def test_negative_2(self):
        graph = build_graph(
            nodes, edges, {"mul": {"can_be_fused": False}}, nodes_with_edges_only=True
        )
        graph.stage = "middle"
        graph_ref = build_graph(
            nodes, edges, {"mul": {"can_be_fused": False}}, nodes_with_edges_only=True
