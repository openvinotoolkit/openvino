...
class SliceLikeToStridedSliceTest(unittest.TestCase):
    ...
    def test_1(self):
        ...
        ref_graph = build_graph(
            nodes_attributes, same_input_shapes_dims_edges, nodes_with_edges_only=True
        )
    ...
    def test_2(self):
        ...
        SliceLikeToStridedSlice().find_and_replace_pattern(graph)
        ref_graph = build_graph(
            nodes_attributes, last_axis_index, nodes_with_edges_only=True
        )
    ...
    def test_3(self):
        ...
        SliceLikeToStridedSlice().find_and_replace_pattern(graph)
        ref_graph = build_graph(
            nodes_attributes, input_part_shape_edges, nodes_with_edges_only=True
        )
        flag, resp = compare_graphs(graph, ref_graph, "result")
        self.assertTrue(flag, resp)
