...
class TestUpsampleToResampleTest:
    @pytest.mark.parametrize(
        "input_shape, scales, axes",
        [
            ([2, 10, 20, 30], [1, 1, 5, 5], [2, 3]),
    ...
    def test_conversion(self, input_shape, scales, axes):
        ...
        graph = build_graph(
            ...
            graph_edges,
            {
                ...
                "upsample_data": {
                    "shape": ((input_shape_as_array + 1.0e-5) * scales_as_array).astype(
                        np.int64
                    )
                },
            },
        ...
        ref_graph = build_graph(
            ...
            new_ref_graph_edges,
            {
                ...
                "interpolate_data": {
                    "shape": (input_shape_as_array * scales_as_array + 1e-5).astype(
                        np.int64
                    )
                },
            },
