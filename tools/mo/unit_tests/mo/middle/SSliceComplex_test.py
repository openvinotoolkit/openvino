...
graph_node_attrs = {
    **regular_op_with_shaped_data(
        "placeholder",
        int64_array([3, 100, 100, 2]),
        {"type": "Parameter", "op": "Parameter"},
    ),
    **regular_op_with_shaped_data(
        "strided_slice_real",
        int64_array([3, 100, 100]),
        {
            "type": "StridedSlice",
            "op": "StridedSlice",
            "begin_mask": int64_array([1]),
            "end_mask": int64_array([1]),
            "ellipsis_mask": int64_array([1]),
    ...
    **regular_op_with_shaped_data(
        "complex", int64_array([3, 100, 100, 2]), {"op": "Complex"}
    ),
    ...
    **regular_op_with_shaped_data(
        "abs", int64_array([3, 100, 100, 2]), {"type": "Abs", "op": "Abs"}
    ),
    **result("output"),
}
...
graph_node_attrs_2 = {
    **regular_op_with_shaped_data(
        "placeholder",
        int64_array([3, 100, 2, 66, 34]),
        {"type": "Parameter", "op": "Parameter"},
    ),
    **regular_op_with_shaped_data(
        "strided_slice_real",
        int64_array([3, 100, 66, 34]),
        {
            "type": "StridedSlice",
            "op": "StridedSlice",
    ...
    **regular_op_with_shaped_data(
        "complex", int64_array([3, 100, 66, 34, 2]), {"op": "Complex"}
    ),
    ...
    **regular_op_with_shaped_data(
        "abs", int64_array([3, 100, 66, 34, 2]), {"type": "Abs", "op": "Abs"}
    ),
    **result("output"),
}
...
graph_node_attrs_3 = {
    ...
    **regular_op_with_shaped_data(
        "roll", int64_array([3, 100, 66, 34, 2]), {"type": "Roll", "op": "Roll"}
    ),
    **valued_const_with_data("real_begin", int64_array([0, 0, 0, 0, 0])),
    **valued_const_with_data("imag_begin", int64_array([0, 0, 1, 0, 0])),
    **valued_const_with_data("real_end", int64_array([0, 0, 1, 0, 0])),
...
class SSliceComplexMiddleStageTest(unittest.TestCase):
    ...
    def test_replacement_with_update_roll_axes(self):
        ...
        graph.clean_up()
        ref_graph = build_graph(
            nodes_attrs=ref_graph_node_attrs_3, edges=ref_graph_edges_3
        )
        (flag, resp) = compare_graphs(graph, ref_graph, "output", check_op_attrs=True)
        self.assertTrue(flag, resp)
