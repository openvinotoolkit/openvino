...
class TestStridedSliceNormalizer(unittest.TestCase):
    ...
    def test_strided_slice_extend_inputs(self):
        ...
        nodes = {
            **valued_const_with_data(
                "input", np.arange(np.product(input_shape)).reshape(*input_shape)
            ),
            **regular_op_with_empty_data(
                "strided_slice",
                {
        ...
        graph_ref = build_graph(
            nodes, edges_ref_extended_inputs, nodes_with_edges_only=True
        )
        graph.stage = "middle"
        ...
        self.assertTrue(
            flag,
            "Graphs after StridedSliceNormalizer do not match to reference: {}".format(
                resp
            ),
        )
    ...
    def test_strided_slice_unrooll_ellipsis(self):
        ...
        nodes = {
            ...
            **valued_const_with_data(
                "splits_lengths_begin", int64_array([ellipsis_start, -1])
            ),
            **regular_op_with_empty_data(
                "split_for_begin", {"op": "VariadicSplit", "infer": VariadicSplit.infer}
            ),
            ...
            **valued_const_with_data(
                "splits_lengths_end", int64_array([ellipsis_start, -1])
            ),
            **regular_op_with_empty_data(
                "split_for_end", {"op": "VariadicSplit", "infer": VariadicSplit.infer}
            ),
            ...
            **valued_const_with_data(
                "splits_lengths_strides", int64_array([ellipsis_start, -1])
            ),
            **regular_op_with_empty_data(
                "split_for_strides",
                {"op": "VariadicSplit", "infer": VariadicSplit.infer},
            ),
        ...
        graph = build_graph(nodes, edges, nodes_with_edges_only=True)
        graph_ref = build_graph(
            nodes, edges_ref_ellipsis_unrolled, nodes_with_edges_only=True
        )
        graph.stage = "middle"
        graph_ref.stage = "middle"
        graph = partial_infer(graph)
...
class TestStridedSliceShapeInferAfterNormalizer(unittest.TestCase):
    ...
    def test_strided_slice_infer_after_normalizer_11(
        ...
        strides=(1, 1, 1, 1, 1),
        begin_mask=(1, 0, 1, 1, 1),
        end_mask=(1, 0, 1, 1, 1),
        shrink_axis_mask=(1,),
        new_axis_mask=(0, 0, 0, 0, 1),
        ellipsis_mask=(0,),
    ):
        self.run_infer_test(
            inp,
    ...
    def test_normalizer_auto_infer_strided_slice_3d_over_4d_0(self):
        ...
        self.run_infer_test(
            ...
            end_mask=(0, 0, 0, 0),
            shrink_axis_mask=(0, 0, 1, 0),
            new_axis_mask=(1, 0, 0, 0),
            ellipsis_mask=(0, 1, 0, 0),
        )
    ...
    def test_normalizer_auto_infer_strided_slice_3d_over_4d_1(self):
        ...
        self.run_infer_test(
            ...
            end_mask=(0, 0, 0, 0),
            shrink_axis_mask=(0, 0, 1, 0),
            new_axis_mask=(0, 1, 0, 0),
            ellipsis_mask=(1, 0, 0, 0),
        )
    ...
    def test_normalizer_auto_infer_strided_slice_3d_over_5d_0(self):
        ...
        self.run_infer_test(
            inp=(1, 100, 200, 10, 3),
            ref_res=(1, 1, 100, 10, 3),
            begin=(0, 0, 0, 0, 0),
            end=(0, 0, 0, 0, 0),
            strides=(1, 1, 1, 1, 1),
            begin_mask=(0, 0, 0, 0, 0),
            end_mask=(0, 0, 0, 0, 0),
            shrink_axis_mask=(0, 0, 1, 0, 0),
            new_axis_mask=(1, 0, 0, 0, 0),
            ellipsis_mask=(0, 1, 0, 0, 0),
        )
    ...
    def test_normalizer_auto_infer_strided_slice_3d_over_5d_2(self):
        ...
        self.run_infer_test(
            inp=(1, 100, 200, 10, 3),
            ref_res=(1, 100, 200, 10, 3),
            begin=(0, 0, 0, 0, 0),
            end=(0, 0, 0, 0, 0),
            strides=(1, 1, 1, 1, 1),
            begin_mask=(0, 0, 0, 0, 0),
            end_mask=(0, 0, 0, 0, 0),
            shrink_axis_mask=(1, 0, 0, 0, 0),
            new_axis_mask=(0, 1, 0, 0, 0),
            ellipsis_mask=(0, 0, 1, 0, 0),
        )
...
class TestStridedSlicePermute(unittest.TestCase):
    def run_permute_test(
        ...
        from openvino.tools.mo.middle.MergeNodesPermutations import (
            MergeNodesPermutations,
        )
        ...
        nodes = {
            ...
            **regular_op_with_empty_data(
                ...
                {
                    "op": "StridedSlice",
                    "type": "StridedSlice",  # need for permute
                    "begin_mask": begin_mask,
                    "end_mask": end_mask,
                    "shrink_axis_mask": shrink_axis_mask,
                    "new_axis_mask": new_axis_mask,
...
class TestStridedSliceMaskAlignment(unittest.TestCase):
        ...
        nodes_ref.update(
            {
                **regular_op_with_empty_data(
                    "strided_slice",
                    {
                        "op": "StridedSlice",
                        "type": "StridedSlice",  # need for permute
                        "begin_mask": begin_mask_ref,
                        "end_mask": end_mask_ref,
    ...
    def test_mask_align_compare_graphs_1(self):
        self.run_align_test(
            ...
            begin_mask_ref=(0, 0),
            end_mask_ref=(0, 0),
            shrink_axis_mask_ref=(1, 1),
            new_axis_mask_ref=(0, 0),
            ellipsis_mask_ref=(0, 0),
        )
