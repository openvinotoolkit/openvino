...
nodes_attributes = {
    **regular_op_with_shaped_data(
        "input", [2, 3, 300, 300], {"type": "Parameter", "op": "Parameter"}
    ),
    ...
    **regular_op_with_empty_data(
        "ss_begin_cast", {"op": "Cast", "type": "Convert", "dst_type": np.int64}
    ),
    **regular_op_with_empty_data("ss_begin_clamp", {"op": "Clamp", "type": None}),
    **regular_op_with_empty_data(
        "ss_begin_clamp_min",
        {"value": np.iinfo(np.int32).min, "op": "Const", "type": "Const"},
    ),
    **regular_op_with_empty_data(
        "ss_begin_clamp_max",
        {"value": np.iinfo(np.int32).max, "op": "Const", "type": "Const"},
    ),
    **regular_op_with_empty_data(
        "ss_begin_gather_0", {"op": "Gather", "type": "Gather"}
    ),
    **valued_const_with_data("ss_begin_gather_0_idx", int64_array([0])),
    **regular_op_with_shaped_data(
        "ss_begin_gather_0_axis", [], {"op": "Const", "type": "Const", "value": [0]}
    ),
    **regular_op_with_empty_data(
        "ss_begin_gather_1", {"op": "Gather", "type": "Gather"}
    ),
    **valued_const_with_data("ss_begin_gather_1_idx", int64_array([1])),
    **regular_op_with_shaped_data(
        "ss_begin_gather_1_axis", [], {"op": "Const", "type": "Const", "value": [0]}
    ),
    **regular_op_with_empty_data(
        "ss_begin_gather_2", {"op": "Gather", "type": "Gather"}
    ),
    **valued_const_with_data("ss_begin_gather_2_idx", int64_array([2])),
    **regular_op_with_shaped_data(
        "ss_begin_gather_2_axis", [], {"op": "Const", "type": "Const", "value": [0]}
    ),
    **regular_op_with_empty_data(
        "ss_begin_gather_3", {"op": "Gather", "type": "Gather"}
    ),
    **valued_const_with_data("ss_begin_gather_3_idx", int64_array([3])),
    **regular_op_with_shaped_data(
        "ss_begin_gather_3_axis", [], {"op": "Const", "type": "Const", "value": [0]}
    ),
    **regular_op_with_empty_data(
        "ss_begin_const_0", {"op": "Const", "type": "Const", "value": int64_array([0])}
    ),
    **regular_op_with_empty_data(
        "ss_begin_const_1", {"op": "Const", "type": "Const", "value": int64_array([0])}
    ),
    **regular_op_with_empty_data(
        "ss_begin_const_2", {"op": "Const", "type": "Const", "value": int64_array([0])}
    ),
    **regular_op_with_empty_data(
        "ss_begin_const_3", {"op": "Const", "type": "Const", "value": int64_array([0])}
    ),
    **regular_op_with_empty_data("ss_begin_concat", {"op": "Concat", "type": "Concat"}),
    **regular_op_with_empty_data(
        "ss_end_cast", {"op": "Cast", "type": "Convert", "dst_type": np.int64}
    ),
    ...
    **regular_op_with_shaped_data(
        "ss_end_gather_0_axis", [], {"op": "Const", "type": "Const", "value": [0]}
    ),
    **regular_op_with_empty_data("ss_end_gather_1", {"op": "Gather", "type": "Gather"}),
    **valued_const_with_data("ss_end_gather_1_idx", int64_array([1])),
    **regular_op_with_shaped_data(
        "ss_end_gather_1_axis", [], {"op": "Const", "type": "Const", "value": [0]}
    ),
    **regular_op_with_empty_data("ss_end_gather_2", {"op": "Gather", "type": "Gather"}),
    **valued_const_with_data("ss_end_gather_2_idx", int64_array([2])),
    **regular_op_with_shaped_data(
        "ss_end_gather_2_axis", [], {"op": "Const", "type": "Const", "value": [0]}
    ),
    **regular_op_with_empty_data("ss_end_gather_3", {"op": "Gather", "type": "Gather"}),
    **valued_const_with_data("ss_end_gather_3_idx", int64_array([3])),
    **regular_op_with_shaped_data(
        "ss_end_gather_3_axis", [], {"op": "Const", "type": "Const", "value": [0]}
    ),
    **regular_op_with_empty_data(
        "ss_end_const_0", {"op": "Const", "type": "Const", "value": int64_array([0])}
    ),
    **regular_op_with_empty_data(
        "ss_end_const_1", {"op": "Const", "type": "Const", "value": int64_array([0])}
    ),
    **regular_op_with_empty_data(
        "ss_end_const_2", {"op": "Const", "type": "Const", "value": int64_array([0])}
    ),
    **regular_op_with_empty_data(
        "ss_end_const_3", {"op": "Const", "type": "Const", "value": int64_array([0])}
    ),
    ...
    def test_convert_slice_to_strided_slice_one_axis(self):
        ...
        ref_graph = build_graph(
            ...
            update_attributes={
                ...
                "ss": {
                    "begin_mask": int64_array([1, 0, 0, 0]),
                    "end_mask": int64_array([1, 0, 0, 0]),
                },
            },
        )
    ...
    def test_convert_slice_to_strided_slice_one_axis_steps_is_2(self):
        ...
        ref_graph = build_graph(
            ...
            update_attributes={
                ...
                "ss": {
                    "begin_mask": int64_array([0, 0, 1, 0]),
                    "end_mask": int64_array([0, 0, 1, 0]),
                },
            },
        )
        ConvertSlice().find_and_replace_pattern(graph)
    ...
    def test_convert_slice_to_strided_slice_two_axes(self):
        ...
        ref_graph = build_graph(
            ...
            update_attributes={
                ...
                "ss_strides": {"value": int64_array([1, 1, 1, 1]), "shape": [4]},
                "ss": {
                    "begin_mask": int64_array([0, 0, 1, 1]),
                    "end_mask": int64_array([0, 0, 1, 1]),
                },
            },
        )
        ConvertSlice().find_and_replace_pattern(graph)
    ...
    def test_convert_slice_to_strided_slice_three_axes(self):
        ...
        ref_graph = build_graph(
            ...
            update_attributes={
                ...
                "ss_strides": {"value": int64_array([1, 1, 1, 1]), "shape": [4]},
                "ss": {
                    "begin_mask": int64_array([0, 1, 1, 1]),
                    "end_mask": int64_array([0, 1, 1, 1]),
                },
            },
        )
        ConvertSlice().find_and_replace_pattern(graph)
