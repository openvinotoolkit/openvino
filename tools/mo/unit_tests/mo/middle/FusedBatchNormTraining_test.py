...
nodes_attributes = {
    ...
    "scale": {
        "value": np.array([2, 3.5, 4.5, 5.1, 2.6], dtype=np.float32),
        "shape": int64_array([5]),
        "kind": "op",
        "op": "Const",
    },
    ...
    "offset": {
        "value": np.array([1, 2.5, 3.5, 4.1, 5.6], dtype=np.float32),
        "shape": int64_array([5]),
        "kind": "op",
        "op": "Const",
    },
