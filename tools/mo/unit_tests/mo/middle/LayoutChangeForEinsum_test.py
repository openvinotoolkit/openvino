...
nodes_attributes = {
    # Parameter layers
    **regular_op_with_shaped_data(
        "placeholder_1", None, {"type": "Parameter", "op": "Parameter"}
    ),
    **regular_op_with_shaped_data(
        "placeholder_2", None, {"type": "Parameter", "op": "Parameter"}
    ),
    **regular_op_with_shaped_data(
        "placeholder_3", None, {"type": "Parameter", "op": "Parameter"}
    ),
    # Einsum layer
