...
from openvino.tools.mo.middle.FakeSplitOutputs import (
    AddFakeOutputsToSplit,
    AddFakeOutputsToVariadicSplit,
)
...
nodes_attributes = {
    ...
    "variadic_split_data_1": {
        "kind": "data",
        "value": None,
        "shape": np.array([1, 2, 227, 3]),
    },
    "split_data_1": {
        "kind": "data",
        "value": None,
        "shape": np.array([1, 227, 227, 1]),
    },
...
class SplitSaveEmptyBranchesTest(unittest.TestCase):
    def test_variadic_split_non_zero(self):
        graph = build_graph(
            nodes_attributes,
            [
                ("placeholder_1", "placeholder_data"),
                ("placeholder_data", "variadic_split"),
                ("variadic_split", "variadic_split_data_1"),
                ("variadic_split_data_1", "last"),
                ("last", "last_data"),
                ("last_data", "res"),
