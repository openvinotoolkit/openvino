...
from openvino.tools.mo.middle.passes.fusing.fuse_linear_ops import (
    _fuse_mul,
    fuse_linear_ops,
)
...
class FuseMulTests(unittest.TestCase):
    ...
    def test_fuse_mul_to_conv_3(self):
        ...
        graph = build_graph(
            ...
            ],
            {
                ...
                "const_mul_1_w": {
                    "shape": np.array([96]),
                    "value": np.array([x for x in range(96)]),
                },
                "mul_1_w": {
                    "shape": np.array([96]),
                    "value": np.array([x for x in range(96)]),
        ...
        ref_weights = np.ones((11, 11, 3, 96)) * np.reshape(
            np.array([x for x in range(96)]), 96
        )
        ...
        (flag, resp) = compare_graphs(
            graph, graph_ref, "placeholder_1", "placeholder_1"
        )
        self.assertTrue(flag, resp)
    ...
    def test_fuse_mul_to_convolutions_1(self):
        ...
        _fuse_mul(
            graph,
            Node(graph, "mul_1"),
            [Node(graph, "conv_1"), Node(graph, "conv_2")],
            backward=False,
        )
        graph.clean_up()
    ...
    def test_fuse_mul_to_fc_1(self):
        ...
        graph = build_graph(
            ...
            ],
            {
                ...
                "const_mul_1_w": {
                    "shape": np.array([2048]),
                    "value": np.array([x for x in range(2048)]),
                },
                "mul_1_w": {
                    "shape": np.array([2048]),
                    "value": np.array([x for x in range(2048)]),
                ...
                "const_fc_1_w": {
                    "shape": np.array([10260, 2048]),
                    "value": np.ones((10260, 2048)),
                },
                "fc_1_w": {
                    "shape": np.array([10260, 2048]),
                    "value": np.ones((10260, 2048)),
    ...
    def test_fuse_mul_to_dwconv_1(self):
        ...
        graph = build_graph(
            ...
            ],
            {
                ...
                "const_conv_1_w": {
                    "shape": np.array([3, 3, 6, 1]),
                    "value": np.ones((3, 3, 6, 1)),
                },
                "conv_1_w": {
                    "shape": np.array([3, 3, 6, 1]),
                    "value": np.ones((3, 3, 6, 1)),
                    "output_channel_dim": 2,
                    "input_channel_dim": 2,
                    "dims_number": 4,
                },
                "conv_1_data": {},
        ...
        ref_weights = np.ones((3, 3, 6, 1)) * np.reshape(
    ...
    def test_fuse_lin_op_1(self):
        graph = build_graph(
            ...
            ],
            {
                "placeholder_1_data": {"shape": np.array([1, 227, 227, 3])},
                "const_conv_1_w": {
                    "shape": np.array([1, 1, 3, 3]),
                    "value": np.zeros((1, 1, 3, 3)),
                },
                "conv_1_w": {
                    "shape": np.array([1, 1, 3, 3]),
                    "value": np.zeros((1, 1, 3, 3)),
