...
class MarkFusedNodes(unittest.TestCase):
    def test_mark_unfused_nodes_1(self):
        ...
        self.assertFalse(
            graph.node["mul_1"]["can_be_fused"], "can_be_fused should be False"
        )
        self.assertFalse(
            graph.node["mul_2"]["can_be_fused"], "can_be_fused should be False"
        )
        self.assertTrue(
            graph.node["add_1"]["can_be_fused"], "can_be_fused should be True"
        )
    ...
    def test_mark_unfused_nodes_2(self):
        ...
        self.assertFalse(
            graph.node["add_1"]["can_be_fused"], "can_be_fused should be False"
        )
        self.assertFalse(
            graph.node["placeholder_1"]["can_be_fused"], "can_be_fused should be False"
        )
        self.assertFalse(
            graph.node["concat_1"]["can_be_fused"], "can_be_fused should be False"
        )
    ...
    def test_mark_unfused_nodes_3(self):
        ...
        self.assertTrue(
            graph.node["mul_2"]["can_be_fused"], "can_be_fused should be True"
        )
    ...
    def test_mark_unfused_nodes_4(self):
        ...
        self.assertTrue(
            graph.node["mul_1"]["can_be_fused"], "can_be_fused should be True"
        )
        self.assertTrue(
            graph.node["add_1"]["can_be_fused"], "can_be_fused should be True"
        )
