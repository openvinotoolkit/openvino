    ...
    def test(self):
        ...
        graph = build_graph_with_attrs(
            ...
            new_edges_with_attrs=[
                ("index", "TensorArrayWrite", {"in": 1}),
                ("value", "TensorArrayWrite", {"in": 2}),
                ("ta_size", "TensorArray"),
            ],
            update_nodes_attributes=[
                ("WriteEnter_data", {"value": np.array([1, 1])}),
        ...
        graph_ref = build_graph_with_attrs(
            ...
            edges_with_attrs=[
                ("ta_size", "TensorIteratorOutput", {"in": 0}),
        ...
        (flag, resp) = compare_graphs(
            graph, graph_ref, "TensorArrayGather_data", check_op_attrs=True
        )
