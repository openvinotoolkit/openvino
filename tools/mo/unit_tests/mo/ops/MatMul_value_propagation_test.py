...
class TestMatMulValuePropagation:
    @pytest.mark.parametrize(
        ...
        [
            (
                [16, 3],
                np.arange(-5, -5 + 16 * 3).reshape((16, 3)),
                [3, 5],
                np.arange(0, 3 * 5).reshape((3, 5)),
                False,
                False,
            ),
            (
                [3, 16],
                np.arange(-5, -5 + 16 * 3).reshape((3, 16)),
                [3, 5],
                np.arange(0, 3 * 5).reshape((3, 5)),
                True,
                False,
            ...
            (
                [5, 8],
                np.arange(-1, -1 + 5 * 8).reshape((5, 8)),
                [4, 8],
                np.arange(-2, -2 + 4 * 8).reshape((4, 8)),
                False,
                True,
            ),
            (
                [8, 8],
                np.arange(1, 1 + 8 * 8).reshape((8, 8)),
                [4, 8],
                np.arange(-2, -2 + 4 * 8).reshape((4, 8)),
                True,
                True,
            ...
            (
                [7, 16, 3],
                np.arange(0, 0 + 16 * 3 * 7).reshape((7, 16, 3)),
                [3, 5],
                np.arange(0, 3 * 5).reshape((3, 5)),
                False,
                False,
            ...
            (
                [1, 3, 16],
                np.arange(-5, -5 + 16 * 3).reshape((1, 3, 16)),
                [3, 5],
                np.arange(0, 3 * 5).reshape((3, 5)),
                True,
                False,
            ...
            (
                [11, 5, 8],
                np.arange(-1, -1 + 5 * 8 * 11).reshape((11, 5, 8)),
                [11, 4, 8],
                np.arange(-2, -2 + 4 * 8 * 11).reshape((11, 4, 8)),
                False,
                True,
            ),
            (
                [1, 3, 5, 8, 8],
                np.arange(1, 1 + 8 * 8 * 3 * 5).reshape((1, 3, 5, 8, 8)),
                [4, 8],
                np.arange(-2, -2 + 4 * 8).reshape((4, 8)),
                True,
                True,
    ...
    def test_value_propagation(
        self, a_shape, a_value, b_shape, b_value, transpose_a, transpose_b
    ):
        graph = build_graph(
