...
class TestSqueezeInfer:
    @pytest.mark.parametrize(
        "input_value, input_shape, squeeze_dims, ref_value, ref_shape",
        [
            (None, shape_array([1, 2, 1, 4]), shape_array([2]), None, [1, 2, 4]),
            # allow squeezing dynamic dimensions
            (
                None,
                shape_array([1, 2, dynamic_dimension_value, 4]),
                shape_array([2]),
                None,
                [1, 2, 4],
            ),
            ...
            (
                None,
                shape_array([1, dynamic_dimension_value, 1, 4]),
                shape_array([]),
                None,
    ...
    def test_squeeze_squeeze_dims(
        self, input_value, input_shape, squeeze_dims, ref_value, ref_shape
    ):
        graph = build_graph(
            nodes_attributes,
            [
