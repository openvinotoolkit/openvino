...
class TestInterpolateOp:
    @pytest.mark.parametrize(
        "pads_begin, pads_end, input_shape, output_shape, sizes, scales, axes",
        [
            (
                [0],
                [0],
    ...
    def test_interpolate4_using_sizes(
        self, pads_begin, pads_end, input_shape, output_shape, sizes, scales, axes
    ):
        graph = build_graph(
            ...
            update_attributes={
                ...
                "sizes": {
                    "shape": int64_array(sizes).shape,
                    "value": int64_array(sizes),
                },
                "sizes_data": {
                    "shape": int64_array(sizes).shape,
                    "value": int64_array(sizes),
                ...
                "scales_data": {
                    "shape": np.array(scales).shape,
                    "value": np.array(scales),
                },
                ...
                "interpolate": {
                    "pads_begin": int64_array(pads_begin),
        ...
        msg = (
            "Interpolate-4 infer failed for case: sizes={}, scales={}, pads_begin={}, pads_end={}, axes={},"
            " expected_shape={}, actual_shape={}"
        )

        assert np.array_equal(
            graph.node["interpolate_data"]["shape"], int64_array(output_shape)
        ), msg.format(
            sizes,
            scales,
            pads_begin,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [4, 3, 11, 22, 5, 0, 0],
                [1, 3, 4, 8, 5, 0, 0],
                [1, 16, 85, 470, 690, 349, 3],
                [60, 22, 430, 500, 345, 349, 1],
                [60, 430, 345, 1],
                [10.0, 4.3, 345.0 / 700.0, 1 / 3],
                [0, 2, 4, 6],
            ),
            (
                [4, 3, 11, 22, 5, 0, 0],
                ...
                [60, 22, 430, 500, 345, 349, 1],
                [60, 430, 345, 1],
                [10.0, 4.3, 345.0 / 700.0, 0.3333333],
                [0, 2, 4, 6],
            ),
        ],
    )
    def test_interpolate4_using_scales(
        self, pads_begin, pads_end, input_shape, output_shape, sizes, scales, axes
    ):
        graph = build_graph(
            nodes_attrs=graph_nodes_attrs,
    ...
    @pytest.mark.parametrize(
        "pads_begin, pads_end, input_shape, output_shape, sizes, scales",
        [
            (
                [0],
                [0],
            ...
            (
                ...
                [20, 16, 40, 470, 1380],
                [20, 16, 40, 470, 1380],
                [20.0, 1.0, 40.0 / 85.0, 1.0, 1380.0 / 690.0],
            ),
            (
                [4, 3, 11, 22, 5],
                [1, 3, 4, 8, 5],
            ...
            (
                ...
                [60, 22, 430, 500, 345, 349],
                [60, 22, 430, 500, 345, 349],
                [10.0, 1.0, 4.3, 1.0, 345.0 / 700.0, 1.0],
            ),
            (
                [4, 3, 11, 22, 5, 0, 0],
                [1, 3, 4, 8, 5, 0, 0],
                ...
                [60, 22, 430, 500, 345, 349, 1],
                [60, 22, 430, 500, 345, 349, 1],
                [10.0, 1.0, 4.3, 1.0, 345.0 / 700.0, 1.0, 1 / 3],
            ),
        ],
    )
    def test_interpolate4_using_sizes_without_axes(
        self, pads_begin, pads_end, input_shape, output_shape, sizes, scales
    ):
        graph = build_graph(
            nodes_attrs=graph_node_attrs_without_axes,
        ...
        msg = (
            "Interpolate-4 infer failed for case: sizes={}, scales={}, pads_begin={}, pads_end={},"
            " expected_shape={}, actual_shape={}"
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                [60, 22, 430, 500, 345, 349, 1],
                [60, 22, 430, 500, 345, 349, 1],
                [10.0, 1.0, 4.3, 1.0, 345.0 / 700.0, 1.0, 0.3333333],
            ),
        ],
    )
