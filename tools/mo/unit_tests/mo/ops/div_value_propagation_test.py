...
class TestDivValuePropagation:
    @pytest.mark.parametrize(
        "a_shape, a_value, b_shape, b_value, elem_type",
        [
            (
                [2, 3],
                np.array([[1, 4, -6], [0, -16, 45]], dtype=np.int64),
                [2, 3],
                np.array([[1, 2, -4], [1, -8, -5]], dtype=np.int64),
                np.int64,
            ),
            (
                [2, 3],
            ...
            (
                [3, 3],
                np.array([[15, 2, 11], [14, 7, 8], [24, 12, 0]], dtype=np.int64),
                [3, 3],
                np.array([[-5, 4, 2], [7, 2, 4], [6, 24, 1]], dtype=np.int64),
                np.int64,
            ),
            (
                [3, 3],
