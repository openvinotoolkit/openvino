...
inputs3 = {
    "data_data": {"shape": int64_array([1, 64, 64, 320]), "value": None},
    "indices_data": {"shape": int64_array([1, 64, 64, 1, 1]), "value": None},
}

# test data for constant folding: gather elements, batch_dims = 0
inputs4 = {
    "data_data": {"shape": int64_array([2, 2]), "value": int64_array([[1, 2], [3, 4]])},
    "indices_data": {
        "shape": int64_array([2, 2]),
        "value": int64_array([[0, 0], [1, 0]]),
    },
}
...
inputs5 = {
    ...
    "indices_data": {
        "shape": int64_array([3, 2]),
        "value": int64_array([[0, 1], [1, 0], [1, 2]]),
    },
}
output5 = int64_array([[5, 6, 7, 8], [13, 14, 15, 16], [21, 22, 23, 24]])
...
inputs6 = {
    ...
    "indices_data": {"shape": int64_array([2, 1]), "value": int64_array([[1], [0]])},
}
output6 = int64_array([[5, 6, 7, 8], [13, 14, 15, 16]])
...
inputs7 = {
    ...
    "indices_data": {
        "shape": int64_array([2, 3, 1, 1]),
        "value": int64_array([[[[1]], [[0]], [[2]]], [[[0]], [[2]], [[2]]]]),
    },
}
...
inputs9 = {
    "data_data": {
        "shape": shape_array([dynamic_dimension_value, 40, 4, 9]),
        "value": None,
    },
    "indices_data": {
        "shape": shape_array([dynamic_dimension_value, 40, 3, 5, 1]),
        "value": None,
    },
}
...
inputs10 = {
    "data_data": {
        "shape": shape_array([40, dynamic_dimension_value, 4, 9]),
        "value": None,
    },
    "indices_data": {
        "shape": shape_array([40, dynamic_dimension_value, 3, 5, 1]),
        "value": None,
    },
}
...
class TestGatherND_5(unittest.TestCase):
    ...
    def test_infer4(self):
        ...
        self.assertTrue(
            np.array_equal(output4, res_output_value),
            "values do not match expected: {} and given: {}".format(
                output4, res_output_value
            ),
        )
    ...
    def test_infer6(self):
        ...
        self.assertTrue(
            np.array_equal(output6, res_output_value),
            "values do not match expected: {} and given: {}".format(
                output6, res_output_value
            ),
        )
