...
def create_einsum_graph(input_shapes: list, equation: str) -> Graph:
    ...
    for input_ind in range(num_inputs):
        ...
        parameter_op = regular_op_with_shaped_data(
            input_name,
    ...
    einsum_op = regular_op_with_shaped_data(
        "einsum_node", None, {"op": "Einsum", "type": "Einsum", "equation": equation}
    )
...
class TestEinsum:
    @pytest.mark.parametrize(
        "input_shapes, equation, ref_output_shape",
        [
            # dot product
            ([int64_array([10]), int64_array([10])], "i,i->", int64_array([])),
            # matrix multiplication
            (
                [int64_array([2, 3]), int64_array([3, 4])],
                "ab,bc->ac",
                int64_array([2, 4]),
            ),
            # trace per batch
            ...
            (
                [int64_array([2, 5]), int64_array([5, 3, 6]), int64_array([5, 3])],
                "ab,bcd,bc->ca",
                int64_array([3, 2]),
            ),
            ...
            (
                [int64_array([3, 5]), int64_array([1])],
                "a...,...->a...",
                int64_array([3, 5]),
            ),
            # ellipsis with broadcasting
            (
                [int64_array([9, 1, 4, 3]), int64_array([3, 11, 7, 1])],
                "a...b,b...->a...",
                int64_array([9, 11, 7, 4]),
            ),
            # mixed case letters in equation
            ([int64_array([1, 3, 5])], "AbC", int64_array([1, 5, 3])),
            # mixed case letters and equation in implicit mode
            (
                [int64_array([3, 11, 1, 5]), int64_array([1, 3, 1, 7])],
                "a...b,B...",
                int64_array([3, 11, 7, 1, 3, 5]),
            ),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [int64_array([11, 1, 4, 3]), int64_array([3, 11, 7, 5])],
                "a...b,b...->a...",
                None,
            ),
            # missed ellipsis
            (
                [int64_array([11, 1, 4, 3]), int64_array([3, 11, 7, 4])],
                "a...b,b...->a",
                None,
            ),
        ],
