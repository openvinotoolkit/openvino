...
nodes_attributes = {
    "deconv_input": {"value": None, "kind": "data"},
...
class TestConvolutionPartialInfer(unittest.TestCase):
    def test_deconv_infer_one_group(self):
        graph = create_deconv_graph(
            int64_array([1, 21, 18, 18]),
        ...
        self.assertTrue(
            ...
            "group number values do not match expected: {} and computed: {}".format(
                exp_group, res_group
            ),
        )
