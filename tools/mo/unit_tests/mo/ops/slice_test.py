...
from openvino.tools.mo.ops.slice import OvSlice, Slice


class TestSliceOp:
    @pytest.mark.parametrize(
        "inp_value, inp_shape, starts, ends, axes, steps, expected_value, expected_shape",
        [
            # standard case
            (
                [[4, 5, 6, 7], [2, 3, 5, 6], [5, 6, 8, 9], [5, 6, 8, 9]],
                [4, 4],
                [0, 1],
                [3, 2],
                [0, 1],
