...
class TestReshapeShapeInfer:
    @pytest.mark.parametrize(
        "input_value, input_shape, output_shape, ref_value, ref_shape",
        [
            ...
            (
                None,
                shape_array([5, dynamic_dimension_value, 4]),
                shape_array([4, -1, 5]),
                None,
            ...
            (
                None,
                shape_array([dynamic_dimension_value, 4, 5]),
                shape_array([0, -1]),
                None,
            ...
            (
                None,
                shape_array([dynamic_dimension_value, 4, 5]),
                shape_array([5, -1, dynamic_dimension_value]),
                None,
                shape_array([5, dynamic_dimension_value, dynamic_dimension_value]),
            ),
            (
                None,
                shape_array([dynamic_dimension_value, 1, 546]),
                shape_array([dynamic_dimension_value, -1, 91]),
                None,
                shape_array([dynamic_dimension_value, dynamic_dimension_value, 91]),
            ),
            (
                None,
                shape_array([5, dynamic_dimension_value, 8]),
                shape_array([4, -1]),
                None,
            ...
            (
                None,
                shape_array([3, 14, 5]),
                shape_array([dynamic_dimension_value, 2, 0]),
                None,
                shape_array([21, 2, 5]),
            ),
            (
                shape_array([1, 2, dynamic_dimension_value, 4, 5, 6]),
                shape_array([6]),
                shape_array([-1, 2]),
                shape_array([1, 2, dynamic_dimension_value, 4, 5, 6]).reshape((3, 2)),
                shape_array([3, 2]),
            ),
        ],
    )
    def test_reshape_infer(
        self, input_value, input_shape, output_shape, ref_value, ref_shape
    ):
        graph = build_graph(
            nodes_attributes,
            [
