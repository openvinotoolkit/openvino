...
from openvino.tools.mo.middle.passes.convert_data_type import packed_I4, packed_U4
...
nodes = lambda value, dst_type: {
    ...
    **regular_op_with_empty_data(
        "convert", {"dst_type": dst_type, "infer": Cast.infer}
    ),
    **result(),
}
