...
class ReduceLpTest(unittest.TestCase):
    def test_reduce_lp(self):
        ...
        for idx, (shape, axes, keepdims, p) in enumerate(test_cases):
    ...
    def test_reduce_dynamic(self):
        ...
        for idx, (shape, axes, keepdims, p) in enumerate(test_cases):
            with self.subTest(test_cases=idx):
                ...
                # create an array of all masked elements which is the expected result of
                # the reduce of the tensor with dynamic values
