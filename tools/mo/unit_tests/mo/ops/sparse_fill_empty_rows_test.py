...
# graph 1
edges1 = [
    ("input_indices", "sparse_fill_empty_rows_node", {"in": 0}),
...
inputs1 = {
    "input_indices": {"shape": int64_array([20, 2]), "value": None},
...
class TestSparseFillEmptyRows(unittest.TestCase):
    ...
    def test_incorrect_shape_of_default_value(self):
        ...
        sparse_fill_empty_rows_node = Node(graph, "sparse_fill_empty_rows_node")
        self.assertRaises(
            AssertionError, SparseFillEmptyRows.infer, sparse_fill_empty_rows_node
        )
