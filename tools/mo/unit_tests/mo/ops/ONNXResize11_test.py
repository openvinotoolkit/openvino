...
class TestONNXResize11Op(unittest.TestCase):
    def test_onnx_resize11_using_sizes(self):
        test_cases=[([1, 260, 100, 150], [1, 260, 200, 350], [1, 260, 200, 350], [1.0, 1.0, 1.0, 1.0]),
        ...
        for idx, (input_shape, output_shape, sizes, scales) in enumerate(test_cases):
    ...
    def test_onnx_resize_using_scales(self):
        test_cases=[([1, 260, 100, 150], [1, 260, 200, 350], [1.0, 1.0, 2.0, 350 / 150]),
        ...
        for idx, (input_shape, output_shape, scales) in enumerate(test_cases):
            with self.subTest(test_cases=idx):
                np_scales = np.array(scales)
    ...
    def test_onnx_resize11_using_sizes_without_roi_input(self):
        test_cases=[([1, 260, 100, 150], [1, 260, 200, 350], [1, 260, 200, 350], [1.0, 1.0, 1.0, 1.0]),
                ([1, 260, 100, 150], [1, 260, 200, 350], [1, 1, 200, 350], [1.0, 1.0, 1.0, 1.0]),
                ([5, 14, 300, 40], [5, 14, 140, 280], [1, 1, 140, 280], [1.0, 1.0, 1.0, 1.0]),
                ([5, 14, 300, 40], [5, 14, 140, 280], [5, 14, 140, 280], [1.0, 1.0, 1.0, 1.0]),
    ...
    def test_onnx_resize_using_scales_without_roi(self):
        test_cases=[([1, 260, 100, 150], [1, 260, 200, 350], [1.0, 1.0, 2.0, 350 / 150]),
                ([1, 3, 100, 200], [1, 3, 350, 150], [1.0, 1.0, 3.5, 150 / 200]),
                ([5, 14, 300, 40], [5, 14, 140, 280], [1.0, 1.0, 140 / 300, 7.0]),
                ([5, 14, 300, 40], [5, 14, 140, 560], [1.0, 1.0, 140 / 300, 14.0]),
