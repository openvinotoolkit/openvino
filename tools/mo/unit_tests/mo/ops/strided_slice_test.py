...
class TestStridedSliceInfer(unittest.TestCase):
    ...
    def run_test(
        ...
        res = (
            ...
            if is_shape
            else node.out_port(0).data.get_value()
        )
    ...
    def test_slice_infer_value_2(
        self,  # inp[1:3:1] = [34, 34]
        inp=(1, 34, 34, 62),
        ref_res=(34, 34),
        is_shape=False,
        begin=(1,),
    ...
    def test_slice_infer_value_3(
        self,  # inp[np.newaxis, :4:1] = [[1, 34, 34, 62]]
        inp=(1, 34, 34, 62),
        ref_res=((1, 34, 34, 62),),
        is_shape=False,
        begin=(
    ...
    def test_slice_infer_value_5(
        self,  # inp[::-1] = [62, 34, 34, 1]
        inp=(1, 34, 34, 62),
        ref_res=(62, 34, 34, 1),
        is_shape=False,
        begin=(0,),
    ...
    def test_slice_infer_value_7(
        self,  # inp[:-1:1] = [1, 34, 34], since begin_mask is [0], begin can be of any value
        inp=(1, 34, 34, 62),
        ref_res=(1, 34, 34),
        is_shape=False,
        begin=(0,),
    ...
    def test_slice_infer_dynamic_shape_1(
        self,  # inp[0:3, 0:1, 0:5]
        inp=(dynamic_dimension_value, 10, 10, 10),
        ref_res=(dynamic_dimension_value, 1, 5, 10),
        is_shape=True,
        begin=(0, 0, 0),
        end=(3, 1, 5),
        strides=(1, 1, 1),
    ...
    def test_slice_infer_dynamic_shape_2(
        ...
        is_shape=True,
        begin=(0, 0, 0),
        end=(dynamic_dimension_value, 1, 5),
        strides=(1, 1, 1),
        begin_mask=(1, 1, 1),
        end_mask=(1, 1, 1),
        shrink_axis_mask=(0,),
    ...
    def test_slice_infer_dynamic_shape_3(
        self,  # inp[1:34, 0, :, :d]
        inp=(1, 35, 35, 3),
        ref_res=(1, 35, dynamic_dimension_value),
        is_shape=True,
        begin=(0, 0, 0, 0),
        end=(1, 34, 0, dynamic_dimension_value),
        strides=(1, 1, 1, 1),
        begin_mask=(1, 1, 0, 0),
        end_mask=(1, 0, 0, 1),
        shrink_axis_mask=(0, 1, 0, 0),
