...
nodes_attributes = {
    "input_tensor": {"shape": None, "value": None, "kind": "data"},
...
# graph 1
edges1 = [
    ("input_tensor", "bucketize_node", {"in": 0}),
...
inputs1 = {
    "input_tensor": {
        "shape": int64_array([4]),
        "value": np.array([0.2, 6.4, 3.0, 1.6]),
    },
    "input_buckets": {
        "shape": int64_array([5]),
        "value": np.array([0.0, 1.0, 2.5, 4.0, 10.0]),
    },
}
...
inputs3 = {
    "input_tensor": {"shape": int64_array([10, 40]), "value": None},
