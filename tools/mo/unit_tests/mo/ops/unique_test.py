...
class TestUnique(unittest.TestCase):
    ...
    def test_constant_input(self):
        ...
        inputs_ = {
            "input": {
                ...
                "value": np.array(
                    [8.0, 1.0, 2.0, 1.0, 8.0, 5.0, 1.0, 5.0, 0.0, 0.0], dtype=float
                ),
            },
            "unique_node": {
                "sorted": "false",
        ...
        ref_output_indices_value = np.array(
            [0.0, 1.0, 2.0, 1.0, 0.0, 3.0, 1.0, 3.0, 4.0, 4.0], dtype=float
        )
        ...
        self.assertTrue(
            np.array_equal(ref_output_uniques_value, res_output_uniques_value),
            "values do not match expected: {} and given: {}".format(
                ref_output_uniques_value, res_output_uniques_value
            ),
        )
        self.assertTrue(
            np.array_equal(ref_output_indices_shape, res_output_indices_shape),
        ...
        self.assertTrue(
            np.array_equal(ref_output_indices_value, res_output_indices_value),
            "values do not match expected: {} and given: {}".format(
                ref_output_indices_value, res_output_indices_value
            ),
        )
        self.assertTrue(
            np.array_equal(ref_output_counts_shape, res_output_counts_shape),
        ...
        self.assertTrue(
            np.array_equal(ref_output_counts_value, res_output_counts_value),
            "values do not match expected: {} and given: {}".format(
                ref_output_counts_value, res_output_counts_value
            ),
        )
    ...
    def test_constant_input(self):
        ...
        ref_output_indices_shape = int64_array([10])
        ref_output_indices_value = np.array(
            [4.0, 1.0, 2.0, 1.0, 4.0, 3.0, 1.0, 3.0, 0.0, 0.0], dtype=float
        )
        ref_output_counts_shape = int64_array([5])
        ref_output_counts_value = np.array([2.0, 3.0, 1.0, 2.0, 2.0], dtype=float)
