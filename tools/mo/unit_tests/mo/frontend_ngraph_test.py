...
class TestNoInferenceEngine(unittest.TestCase):
    ...
    def test_no_ie_ngraph(self, mock_find):
        ...
        with pytest.raises(SystemExit) as e, self.assertLogs(
            log.getLogger(), level="ERROR"
        ) as cm:
            subprocess_main()
        ...
        res = [
            i
            for i in cm.output
            if "Consider building the OpenVINO and Python APIs from sources" in i
        ]
        assert res
...
def test_frontends():
    ...
    args = [
        ...
        "-m",
        "pytest",
        os.path.join(os.path.dirname(__file__), "frontend_ngraph_test_actual.py"),
        "-s",
    ]
...
def test_moc_extractor():
    ...
    args = [
        ...
        "pytest",
        os.path.join(
            os.path.dirname(__file__), "moc_frontend/moc_extractor_test_actual.py"
        ),
        "-s",
    ]
...
def test_moc_preprocessing():
    ...
    args = [
        ...
        "pytest",
        os.path.join(
            os.path.dirname(__file__), "back/moc_preprocessing_test_actual.py"
        ),
        "-s",
    ]
...
def test_main_test():
    ...
    args = [
        ...
        "-m",
        "pytest",
        os.path.join(os.path.dirname(__file__), "main_test_actual.py"),
        "-s",
    ]
...
def test_rt_info():
    ...
    args = [
        ...
        "-m",
        "pytest",
        os.path.join(os.path.dirname(__file__), "convert/meta_data_test_actual.py"),
        "-s",
    ]
...
def test_mo_extensions_test():
    ...
    args = [
        ...
        "-m",
        "pytest",
        os.path.join(os.path.dirname(__file__), "extensions_test_actual.py"),
        "-s",
    ]
...
def test_mo_fallback_test():
    ...
    args = [
        ...
        "-m",
        "pytest",
        os.path.join(os.path.dirname(__file__), "utils/mo_fallback_test_actual.py"),
        "-s",
    ]
...
def test_mo_model_analysis():
    ...
    args = [
        ...
        "pytest",
        os.path.join(
            os.path.dirname(__file__), "utils/test_mo_model_analysis_actual.py"
        ),
        "-s",
    ]
...
def test_convert_impl_tmp_irs_cleanup():
    ...
    args = [
        ...
        os.path.join(
            ...
            "utils",
            "convert_impl_tmp_irs_cleanup_test_actual.py",
        ),
    ]
