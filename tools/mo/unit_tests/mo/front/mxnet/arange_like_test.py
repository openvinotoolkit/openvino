...
class ArangeLikeReplacerTest(unittest.TestCase):
    def test_axis_not_none_start_0(self):
        graph = build_graph(
            ...
            edges=[*connect("input", "arange_like"), *connect("arange_like", "result")],
        )
        ref_graph = build_graph(
            nodes_attrs={
                **shaped_parameter("input", int64_array([1, 3, 5, 5])),
                **regular_op_with_empty_data(
                    "shape_of", {"op": "ShapeOf", "type": "ShapeOf"}
                ),
                ...
                **regular_op_with_empty_data(
                    "squeeze", {"op": "Squeeze", "type": "Squeeze"}
                ),
    ...
    def test_axis_none_start_0(self):
        ...
        ref_graph = build_graph(
            nodes_attrs={
                ...
                **regular_op_with_empty_data(
                    "reduce_prod", {"op": "ReduceProd", "type": "ReduceProd"}
                ),
                ...
                **regular_op_with_empty_data("range", {"op": "Range", "type": "Range"}),
                **regular_op_with_empty_data(
                    "reshape_backward", {"op": "Reshape", "type": "Reshape"}
                ),
                **result("result"),
            },
            edges=[
