...
from openvino.tools.mo.front.mxnet.add_input_data_to_prior_boxes import (
    AddInputDataToPriorBoxes,
)
...
class TestMxnetPipeline(unittest.TestCase):
        ...
        graph = build_graph(
            {
                ...
                "node_multi_box": {
                    "type": "_contrib_MultiBoxPrior",
                    "kind": "op",
                    "op": "_contrib_MultiBoxPrior",
                },
            },
            [("data", "node_2"), ("node_2", "node_multi_box")],
            {
    ...
    def test_mxnet_pipeline_2(self):
        graph = build_graph(
            ...
            [("node_1", "node_2"), ("node_2", "node_multi_box")],
            {
