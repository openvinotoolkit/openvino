...
class TestMXReshapeReverseTest(unittest.TestCase):
    nodes_attributes = {
        ...
        "forward_reverse_unsqueeze_dims_node": {
            "kind": "op",
            "op": "Const",
            "type": "Const",
            "value": int64_array([0]),
        ...
        "forward_reverse_unsqueeze_node": {
            "kind": "op",
            "op": "Unsqueeze",
            "type": "Unsqueeze",
        },
        "forward_reverse_node": {"kind": "op", "op": "Reverse", "type": "Reverse"},
        "forward_reverse_squeeze_dims_node": {
            "kind": "op",
            "op": "Const",
            "type": "Const",
            "value": int64_array([0]),
        ...
        "backward_reverse_unsqueeze_node": {
            "kind": "op",
            "op": "Unsqueeze",
            "type": "Unsqueeze",
        },
        "backward_reverse_node": {"kind": "op", "op": "Reverse", "type": "Reverse"},
        "backward_reverse_squeeze_dims_node": {
            "kind": "op",
            "op": "Const",
            "type": "Const",
            "value": int64_array([0]),
