...
nodes_attributes = {
    ...
    "model_reshape0_const": {
        "kind": "op",
        "op": "Const",
        "value": int64_array([1, -1, 4]),
    },
    "model_reshape1": {"kind": "op", "op": "Reshape"},
    "model_reshape1_const": {
        "kind": "op",
        "op": "Const",
        "value": int64_array([1, -1, 4]),
    },
    "model_reshape2": {"kind": "op", "op": "Reshape"},
    "model_reshape2_const": {
        "kind": "op",
        "op": "Const",
...
class SsdAnchorsReplacerTest(unittest.TestCase):
    ...
    def test_replacer(self):
        ...
        ref_graph = build_graph(
            ...
            update_attributes={"concat": {"axis": 1}},
            nodes_with_edges_only=True,
        )
        graph.stage = "front"
        ...
        flag, resp = compare_graphs(
            graph, ref_graph, "detection_output", check_op_attrs=True
        )
