...
nodes = {
    ...
    **regular_op(
        "pooling", {"type": "Pooling", "global_pool": True, "pool_method": "avg"}
    ),
    **result("result"),
...
edges = [
    ("input", "relu", {"in": 0, "out": 0}),
    ("relu", "pooling", {"in": 0, "out": 0}),
    ("pooling", "result", {"in": 0, "out": 0}),
]
ref_edges = [
    ("input", "relu", {"in": 0, "out": 0}),
    ("relu", "rank", {"in": 0, "out": 0}),
    ("rank", "range", {"in": 1, "out": 0}),
    ("relu", "reduce_mean", {"in": 0, "out": 0}),
    ("const_1", "range", {"in": 0, "out": 0}),
    ("const_2", "range", {"in": 2, "out": 0}),
