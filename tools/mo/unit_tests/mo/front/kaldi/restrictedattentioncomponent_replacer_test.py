...
from openvino.tools.mo.front.kaldi.restrictedattentioncomponent_replacer import (
    RestrictedAttentionComponentReplacer,
)
...
class RestrictedAttentionComponentReplacerTest(unittest.TestCase):
    nodes = {
        ...
        **regular_op("memoryoffset_1_0", {"type": None, "t": -2, "has_default": False}),
        **regular_op("memoryoffset_1_1", {"type": None, "t": 2, "has_default": False}),
        ...
        **regular_op("memoryoffset_2_0", {"type": None, "t": -2, "has_default": False}),
        **regular_op("memoryoffset_2_1", {"type": None, "t": 2, "has_default": False}),
