...
import numpy as np
from unit_tests.utils.graph import build_graph, connect_front, const, regular_op

from openvino.tools.mo.front.common.partial_infer.utils import int64_array
from openvino.tools.mo.front.kaldi.replace_timeheightconvolution import (
    ReplaceTimeHeightConvolutionPattern,
)
...
class TimeheightconvolutionReplacerTest(unittest.TestCase):
    nodes = {
        ...
        **regular_op(
            "memoryoffset_0",
            {"type": None, "op": "MemoryOffset", "t": -1, "has_default": False},
        ),
        **regular_op(
            "memoryoffset_1",
            {"type": None, "op": "MemoryOffset", "t": 0, "has_default": False},
        ),
        **regular_op(
            "memoryoffset_2",
            {"type": None, "op": "MemoryOffset", "t": 1, "has_default": True},
        ),
        **regular_op(
            "conv",
            {"op": "Convolution", "type": "Convolution", "output": 12, "height_in": 80},
        ),
    }
    ...
    def test_timeheightconvolution_1offset(self):
        ...
        (flag, resp) = compare_graphs(
            graph, ref_graph, "placeholder_out", check_op_attrs=True
        )
