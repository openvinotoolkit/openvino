...
from openvino.tools.mo.front.kaldi.extractors.max_pooling_ext import (
    MaxPoolingComponentFrontExtractor,
)
...
class MaxPoolingComponentFrontExtractorTest(KaldiFrontExtractorTest):
    ...
    def test_assertion(self):
        self.assertRaises(
            AttributeError, MaxPoolingComponentFrontExtractor.extract, None
        )
