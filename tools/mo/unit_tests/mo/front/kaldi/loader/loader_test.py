...
from openvino.tools.mo.front.kaldi.loader.loader import (
    load_components,
    load_topology_map,
)
...
class TestKaldiModelsLoading(unittest.TestCase):
    ...
    def test_component_map_loading_sequence(self):
        ...
        ref_graph = build_graph(
            {
                "input": {"shape": np.array([1, 16]), "kind": "op", "op": "Parameter"},
                "lda": {"kind": "op"},
        ...
        ref_graph = build_graph(
            {
                ...
                "tdnn1.affine": {
                    ...
                    "parameters": "<MaxChange>  @?<LearningRate> ·С8<LinearParams> ",
                },
                "tdnn1.relu": {
                    "kind": "op",
                    "op": "rectifiedlinearcomponent",
                    "parameters": "<Dim>   <ValueAvg> FV ",
                },
            },
            [
                ("input", "lda"),
