...
import numpy as np
from unit_tests.utils.extractors import PB, FakeMultiParam, FakeParam

from openvino.tools.mo.front.caffe.conv_ext import (
    ConvFrontExtractor,
    DeconvFrontExtractor,
    conv_create_attrs,
    conv_set_params,
)
...
class TestConvShapesParsing(unittest.TestCase):
    ...
    def test_params_creation(self):
        ...
        res = conv_set_params(
            FakeConvProtoLayer(FakeMultiParam(params)).convolution_param, "Conv2D"
        )
