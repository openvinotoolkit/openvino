...
from openvino.tools.mo.front.ThresholdedReluDecomposition import (
    ThresholdedReluDecomposition,
)
...
class ThresholdedReluDecompositionTest(unittest.TestCase):
    def test_trelu(self):
        ...
        self.assertTrue(
            len(graph.get_op_nodes(name="my_trelu")) == 1
            and graph.get_op_nodes(name="my_trelu")[0].op == "Mul"
        )
