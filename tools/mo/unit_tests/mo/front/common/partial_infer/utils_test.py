...
class TestIsFullyDefinedTest:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                np.array([2, dynamic_dimension_value]),
                True,
            ),  # array with dynamic dimension value is fully defined!
            (
                shape_array([2, dynamic_dimension_value, 5]),
                False,
            ),  # masked array with at least one masked element
            (
                shape_array([2, 4, 5]),
                True,
            ),  # masked array with no masked elements is fully defined
            ...
            (
                ...
                True,
            ),  # list with dynamic dimension values is
            # fully defined
            (
                (dynamic_dimension, 1),
                False,
            ),  # tuple with dynamic dimension is not fully defined
            (
                [dynamic_dimension, 1],
                False,
            ),  # list with dynamic dimension is not fully defined
        ],
    )
...
class TestCompareShapesTest:
    @pytest.mark.parametrize(
        ...
        [
            (gen_masked_array([1, 2, 3], []), gen_masked_array([1, 2, 3], []), True),
            ...
            (
                gen_masked_array([1, 2, 3], [1]),
                gen_masked_array([1, 5, 3], [1]),
                True,
            ),  # [1, d, 3] vs [1, d, 3]
            (
                gen_masked_array([1, 2, 3], [2]),
                gen_masked_array([1, 5, 3], [1]),
                True,
            ),  # [1, 2, d] vs [1, d, 3]
            (
            ...
            (
                gen_masked_array([1, 2, 3], [0]),
                gen_masked_array([1, 5, 3], []),
                False,
            ),  # [d, 2, 3] vs [1, 5, 3]
            (
                np.array([1, 2, 3]),
...
class TestShapeDeleteTest:
    @pytest.mark.parametrize(
        "shape, indices, result",
        [
            (gen_masked_array([1, 2, 3], []), [], gen_masked_array([1, 2, 3], [])),
            ...
            (
                gen_masked_array([1, 2, 3, 4], [1]),
                [0, 2],
                gen_masked_array([2, 4], [0]),
            ),  # [1, d, 3, 4] -> [d, 4]
            (
                gen_masked_array([1, 2, 3], [1]),
                [0, 2, 1],
            ...
            (
                gen_masked_array([1, 2, 3], [1]),
                [0, 2],
                gen_masked_array([2], [0]),
            ),  # [1, d, 3] -> [d]
            # [1, d, d, 4] -> [d, d]
            (
                gen_masked_array([1, 2, 3, 4], [1, 2]),
                [3, 0],
                gen_masked_array([2, 3], [0, 1]),
            ),
            (
                gen_masked_array([1, 2, 3, 4], [2]),
                3,
                gen_masked_array([1, 2, 3], [2]),
            ),  # [1, 2, d, 4] -> [1, 2, d]
            (
                ...
                [1],
                [1, 3, 4],
            ),  # [1, 2, 3, 4] -> [1, 3, 4]. Input is a regular lists
            (
                np.array([1, 2, 3, 4]),
                [1],
                [1, 3, 4],
            ),  # [1, 2, 3, 4] -> [1, 3, 4]. Input is a regular arrays
            (
                np.array([1, 2, 3, 4]),
                [-1, -3],
                [1, 3],
            ),  # [1, 2, 3, 4] -> [1, 3]. Negative indices
            (
                np.array([1, 2, 3, 4]),
                -2,
                [1, 2, 4],
            ),  # [1, 2, 3, 4] -> [1, 2, 4]. Negative index
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                1,
                [5],
                gen_masked_array([1, 5, 2, 3], [2]),
            ),
            (
                gen_masked_array([1, 2, 3], [1]),
                1,
                [dynamic_dimension],
                gen_masked_array([1, 5, 2, 3], [1, 2]),
            ),
            (
                gen_masked_array([1, 2, 3], [1]),
                0,
            ...
            (
                gen_masked_array([1], [0]),
                0,
                [7, dynamic_dimension],
                gen_masked_array([7, 5, 2], [1, 2]),
            ),
        ],
    )
...
class Testmo_array_test:
    @pytest.mark.parametrize(
        "data, result",
        [
            (mo_array([2, 3, 5, 7]), np.array([2, 3, 5, 7])),
            (
                mo_array([2.0, 3.0, 5.0, 7.0], dtype=np.float64),
                np.array([2.0, 3.0, 5.0, 7.0]),
            ),
            (
                mo_array([2.0, 3.0, 5.0, 7.0]),
    ...
    @pytest.mark.parametrize(
        "data, result",
        [
            (mo_array([2.0, 3.0, 5.0, 7.0]), np.array([2.0, 3.0, 5.0, 7.0])),
        ],
    )
