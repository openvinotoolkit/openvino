...
from openvino.tools.mo.front.tf.NonConstBeginStridedSliceReplacement import (
    NonConstBeginStridedSliceReplacement,
)
...
class NonConstBeginStridedSliceReplacementTests(unittest.TestCase):
    def test1(self):
        ...
        self.assertTrue(
            graph.node[graph.get_nodes_with_attributes(op="Squeeze")[0]]["name"]
