...
from openvino.tools.mo.front.tf.CTCGreedyDecoderReplacement import (
...
class CTCGreedyDecoderReplacementTests(unittest.TestCase):
    ...
    def test_CTCGreedyDecoderWithSparseToDenseShape(self):
        ...
        graph.stage = "front"
        CTCGreedyDecoderWithSparseToDenseShapeReplacement().find_and_replace_pattern(
            graph
        )
    ...
    def test_CTCGreedyDecoderSingle_negative(self):
        ...
        graph = build_graph(self.nodes_attributes, edges, nodes_with_edges_only=True)
        graph.stage = "front"
        CTCGreedyDecoderSingleReplacement().find_and_replace_pattern(graph)

        graph_ref = build_graph(
            self.nodes_attributes, edges, nodes_with_edges_only=True
        )
