...
class TestTFFFTToDFTTest:
    @pytest.mark.parametrize(
        "num_of_dimensions, dft_type, fft_axes",
        [
            (2, "DFT", int64_array([-2, -1])),
    ...
    def test_replacement(self, num_of_dimensions, dft_type, fft_axes):
        graph = build_graph(
            nodes_attrs=dft_graph_node_attrs,
        ...
        ref_graph = build_graph(
            nodes_attrs=ref_dft_graph_node_attrs,
    ...
    def test_replacement_for_signal_size(
        self, num_of_dims, fft_kind, fft_axes, input_shape, signal_size
    ):
        graph = build_graph(
            nodes_attrs=dft_graph_with_signal_size_node_attrs,
            edges=dft_graph_with_signal_size_edges,
            update_attributes={
                "placeholder": {"shape": input_shape},
                "signal_size": {"shape": signal_size.shape, "value": signal_size},
        ...
        TFFFTToDFT().find_and_replace_pattern(graph)
        ref_graph = build_graph(
            nodes_attrs=ref_dft_graph_with_signal_size_node_attrs,
