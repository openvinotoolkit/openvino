...
nodes = {
    **regular_op_with_shaped_data(
        "placeholder", [1, 3, 30, 40], {"type": "Parameter", "op": "Parameter"}
    ),
    ...
    **regular_op_with_shaped_data(
        "identity_00", [1, 3, 60, 160], {"identity": True, "op": "Identity"}
    ),
    **regular_op_with_shaped_data(
        "identity_01", [1, 3, 60, 160], {"identity": True, "op": "Identity"}
    ),
    ...
    **regular_op_with_shaped_data(
        "placeholder_1", [1, 3, 60, 160], {"type": "Parameter", "op": "Parameter"}
    ),
    **regular_op_with_shaped_data(
        "identity_10", [1, 3, 60, 160], {"identity": True, "op": "Identity"}
    ),
    **regular_op_with_shaped_data(
        "identity_11", [1, 3, 60, 160], {"identity": True, "op": "Identity"}
    ),
    **regular_op_with_shaped_data(
        "concat", [1, 7, 60, 160], {"type": "Concat", "axis": 1, "op": "Concat"}
    ),
