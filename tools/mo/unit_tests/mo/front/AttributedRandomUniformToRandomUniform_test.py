...
from openvino.tools.mo.front.AttributedRandomUniformToRandomUniform import (
    AttributedRandomUniformToRandomUniform,
)
    ...
    def test_min_max(self):
        graph = build_graph(
            ...
            [
                ...
                ("attr_random_uniform", "result", {"in": 0, "out": 0}),
            ],
            {},
        ...
        self.assertTrue(
            graph.node[graph.get_nodes_with_attributes(op="RandomUniform")[0]]["name"]
            == "attr_random_uniform"
        )
