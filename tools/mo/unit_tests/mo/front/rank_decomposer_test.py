...
nodes = lambda output_type: {
    ...
    **regular_op_with_empty_data(
        "rank",
        {"op": "Rank", "type": None, "output_type": output_type, "name": "my_rank"},
    ),
    **result(),
    **regular_op_with_empty_data(
        "shape", {"type": "ShapeOf", "output_type": output_type}
    ),
    **regular_op_with_empty_data(
        "rank_1D", {"type": "ShapeOf", "output_type": output_type}
    ),
