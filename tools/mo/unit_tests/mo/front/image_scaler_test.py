...
class ImageScalerTest(unittest.TestCase):
    ...
    def test_image_scaler_test_4(self):
        ...
        graph_ref = build_graph(
            nodes_attributes,
            [("placeholder_1", "placeholder_1_data"), ("placeholder_1_data", "last")],
            {
                "placeholder_1_data": {"shape": np.array([1, 227, 227, 3])},
            },
            nodes_with_edges_only=True,
    ...
    def test_image_scaler_test_6(self):
        ...
        graph_ref = build_graph(
            nodes_attributes,
            [("placeholder_1", "add_1"), ("const_add_1_w", "add_1"), ("add_1", "last")],
            {
                "placeholder_1": {"shape": np.array([1, 227, 227, 3])},
                "const_add_1_w": {
                    "shape": np.array([3, 1, 1]),
    ...
    def test_image_scaler_test_7(self):
        ...
        graph_ref = build_graph(
            nodes_attributes,
            [("placeholder_1", "mul_1"), ("const_mul_1_w", "mul_1"), ("mul_1", "last")],
            {
                "placeholder_1": {"shape": np.array([1, 227, 227, 3])},
                "const_mul_1_w": {"shape": np.array(2.0).shape, "value": np.array(2.0)},
            },
