    ...
    def test_remove_memory(self):
        ...
        graph = build_graph(
            ...
            edges=[
                ...
                ("const_0_data", "memory_in"),
                ("memory_in", "data_mem"),
                ("data_in", "concat", {"in": 0}),
                ("data_mem", "concat", {"in": 1}),
                ("concat", "concat_data"),
                ("concat_data", "some_op"),
        ...
        graph_ref = build_graph(
            ...
            edges=[
                ("input", "data_in"),
                ("new_input", "new_in_data"),
                ("data_in", "concat", {"in": 0}),
                ("new_in_data", "concat", {"in": 1}),
                ("concat", "concat_data"),
                ("concat_data", "some_op"),
                ("some_op", "some_op_data"),
                ("some_op_data", "crop"),
                ("crop", "crop_data"),
                ("crop_data", "mem_out_result"),
            ],
        )
        ...
        (flag, resp) = compare_graphs(
            graph, graph_ref, last_node="mem_out_result", check_op_attrs=True
        )
