...
from openvino.tools.mo.back.insert_compatibility_l2normalization import (
...
class CompatibilityL2NormalizationPatternTest(unittest.TestCase):
    ...
    def test_insert_data(self):
        graph = build_graph(
            self.nodes,
            [("input_node", "l2norm_node"), ("l2norm_node", "output_node")],
            {
        ...
        self.assertEqual(
            graph.node["l2norm_node_weights"]["name"], "l2norm_node_weights"
        )
