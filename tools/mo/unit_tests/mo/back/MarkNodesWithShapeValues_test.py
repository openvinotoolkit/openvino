...
class TestMarkDataTypeInShapeOfSubgraphs(unittest.TestCase):
    ...
    def test_run_with_shape_subgraph_input(self):
        ...
        nodes = {
            ...
            **regular_op_with_empty_data(
                "cast_to_float", {"type": "Cast", "dst_type": dst_type}
            ),
            **regular_op("mul_const", {"op": "Const"}),
            **{
                "mul_const_d": {
                    "kind": "data",
                    "value": float32_array([1.0, 1.0, 1.0, 100.0]),
                }
            },
            **regular_op_with_empty_data("mul", {"type": "Mul"}),
            **regular_op_with_empty_data(
                "cast_to_int", {"type": "Cast", "dst_type": np.int64}
            ),
            **regular_op_with_empty_data(
                "interpolate",
                {"type": "Interpolate", "shape_calculation_model": "scales"},
            ),
            **result("res"),
        }
        ...
        nodes_ref = {
            ...
            **regular_op_with_empty_data(
                "cast_to_float",
                {"type": "Cast", "dst_type": dst_type, "returns_shape_value": True},
            ),
            **regular_op_with_empty_data(
                "mul", {"type": "Mul", "returns_shape_value": True}
            ),
            ...
            **regular_op_with_empty_data(
                "cast_to_int",
                {"type": "Cast", "dst_type": np.int64, "returns_shape_value": True},
            ),
            **regular_op_with_empty_data(
                "interpolate",
                {"type": "Interpolate", "shape_calculation_model": "scales"},
    ...
    def test_run_with_solitary_shapeof_in_shape_value_subgraph(self):
        ...
        inp_shape_2 = int64_array(
            (1, 3, 100, 50)
        )  # inp_2 and const will be concatenated to (1, 3, 200, 50)
        const_shape = int64_array((1, 3, 100, 50))

        nodes = {
            **regular_op_with_shaped_data(
                "input_1", inp_shape_1, {"op": "Parameter", "type": "Parameter"}
            ),
            **regular_op_with_shaped_data(
                "input_2",
                inp_shape_2,
                {"op": "Parameter", "type": "Parameter", "returns_shape_value": False},
            ),
            ...
            **regular_op_with_empty_data(
                "shapeof", {"op": "ShapeOf", "type": "ShapeOf"}
            ),
            **regular_op_with_empty_data(
                "reshape", {"op": "Reshape", "type": "Reshape"}
            ),
            **result("res"),
        }
        ...
        self.assertTrue(
            flag,
            "'returns_shape_value' should be False or unset for ShapeOf input nodes"
            + ": "
            + str(resp),
        )
