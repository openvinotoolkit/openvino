...
from openvino.tools.mo.back.remove_last_softmax_pattern import (
    RemoveLastLogSoftMaxPattern,
    RemoveLastSoftMaxPattern,
)
...
class KaldiRemoveLastSoftMaxTest(unittest.TestCase):
    nodes = {
        ...
        "softmax_node": {"op": "SoftMax", "kind": "op"},
        "output_node": {"kind": "data"},
        "op_output": {"kind": "op", "op": "Result"},
        "log_node": {"op": "Log", "kind": "op"},
        "log_data": {"kind": "data"},
    }
    ...
    def test_remove_last_LogSoftMax(self):
        graph = build_graph(
            nodes_attrs=self.nodes_for_logsoftmax, edges=self.edges_for_logsoftmax
        )
    ...
    def test_do_not_remove_not_last_SoftMax(self):
        graph = build_graph(
            self.nodes,
            [("input_node", "softmax_node"), ("softmax_node", "output_node")],
        )
        RemoveLastSoftMaxPattern().find_and_replace_pattern(graph)
