...
class TestTopologicalSort(unittest.TestCase):
    def test_determined_topological_sort_1(self):
        edges = [('A', 'Ad', {'out': 0}),
                 ('Ad', 'B', {'in': 0}),
                 ('B', 'Bd', {'out': 0}),
                 ('Bd', 'C', {'in': 0}),
        ...
        expected_op_order = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K']
        expected_data_order = ['Ad', 'Bd', 'Cd', 'Dd', 'Ed', 'Fd', 'Gd', 'Hd', 'Id', 'Jd', 'Kd']
        self.assertListEqual(op_order, expected_op_order)
        self.assertListEqual(data_order, expected_data_order)

    def test_determined_topological_sort_2(self):
        edges = [('A', 'Ad', {'out': 0}),
                 ('Ad', 'B', {'in': 0}),
                 ('B', 'Bd', {'out': 0}),
                 ('Bd', 'C', {'in': 0}),
    ...
    def test_determined_topological_sort_3(self):
        edges = [('A', 'Ad', {'out': 0}),
                 ('Ad', 'B', {'in': 0}),
                 ('B', 'Bd', {'out': 0}),
                 ('Bd', 'C', {'in': 0}),
