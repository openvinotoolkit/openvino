...
class TestingBroadcasting:
    ...
    def test_uni_directional_broadcasting(
        self, input_shape, target_shape, expected_shape
    ):
        ...
        if expected_shape is not None:
            ...
            with pytest.raises(
                Exception, match=".*cannot be uni-directionally broadcasted.*"
            ):
                uni_directional_broadcasting(input_value, int64_array(target_shape))
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                shape_array([10, dynamic_dimension_value]),
                shape_array([dynamic_dimension_value, 3, 10, 2]),
                shape_array([dynamic_dimension_value, 3, 10, 2]),
            ),
            (
    ...
    def test_uni_directional_shape_broadcasting(
        self, input_shape, target_shape, expected_shape
    ):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [10, 2],
                shape_array([dynamic_dimension_value, 3, 1, 2]),
                shape_array([dynamic_dimension_value, 3, 10, 2]),
            ),
            (
                shape_array([10, dynamic_dimension_value]),
            ...
            (
                shape_array([dynamic_dimension_value, 2]),
                shape_array([dynamic_dimension_value, 3, 10, 1]),
                shape_array([dynamic_dimension_value, 3, 10, 2]),
            ),
            (
                shape_array([dynamic_dimension_value]),
    ...
    def test_bi_directional_shape_broadcasting(
        self, input_shape, target_shape, expected_shape
    ):
