...
class TestingBroadcasting(unittest.TestCase):
    def test_uni_directional_broadcasting(self):
        test_cases = [
            ([], [20, 30, 10], [20, 30, 10]),
            ([1], [20, 30, 10], [20, 30, 10]),
    ...
    def test_uni_directional_shape_broadcasting(self):
        test_cases=[([], [20, 30, 10], [20, 30, 10]),
                ([1], [20, 30, 10], [20, 30, 10]),
                ([1, 1, 10], [20, 30, 10], [20, 30, 10]),
                ([20, 1, 10], [20, 30, 10], [20, 30, 10]),
                ([20, 30, 10], [20, 30, 10], [20, 30, 10]),
    ...
    def test_bi_directional_shape_broadcasting(self):
        test_cases=[([], [20, 30, 10], [20, 30, 10]),
                ([1], [20, 30, 10], [20, 30, 10]),
                ([1, 1, 10], [20, 30, 10], [20, 30, 10]),
                ([20, 1, 10], [20, 30, 10], [20, 30, 10]),
