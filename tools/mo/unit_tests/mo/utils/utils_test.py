...
class TestMatchShapes(unittest.TestCase):
    ...
    def test_positive(self):
        ...
        self.assertTrue(
            self.run_match_shapes([dynamic_dimension_value, 2, 3], [1, 2, 3])
        )
        self.assertTrue(
            self.run_match_shapes([1, dynamic_dimension_value, 3], [1, 2, 3])
        )
        self.assertTrue(
            self.run_match_shapes(
                [
                    dynamic_dimension_value,
                    dynamic_dimension_value,
                    dynamic_dimension_value,
    ...
    def test_negative(self):
        ...
        self.assertFalse(
            self.run_match_shapes([dynamic_dimension_value, 2, 3], [1, 3, 3])
        )
