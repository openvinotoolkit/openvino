...
class TestMoFallback:
    def setup_method(self):
        ...
        if paddle_imported:
            ...
            save_paddle_model(
                "relu", exe, feedkeys=["x"], fetchlist=[out], target_dir=self.paddle_dir
            )
    ...
    @pytest.mark.parametrize(
        "extension, use_legacy, use_new_fe, conversion_method, fallback_reason",
        [
    ...
    def test_fallback_if_extension_specified(
        self, extension, use_legacy, use_new_fe, conversion_method, fallback_reason
    ):
        with patch(
    ...
    @pytest.mark.parametrize(
        "use_legacy, use_new_fe, conversion_method",
        [
    ...
    def test_fallback_if_new_extension_specified(
        self, use_legacy, use_new_fe, conversion_method
    ):
        with patch(
            "openvino.tools.mo.convert_impl.get_default_frontends"
        ) as default_fe:
    ...
    def test_fallback_if_two_new_extension_specified(
        self, use_legacy, use_new_fe, conversion_method
    ):
        with patch(
            "openvino.tools.mo.convert_impl.get_default_frontends"
    ...
    @pytest.mark.parametrize(
        "trans_config, use_legacy, use_new_fe, expected_path, fallback_reason",
        [
            (
                "fake_config.json",
                None,
    ...
    def test_fallback_if_tranformations_config_specified(
        self, trans_config, use_legacy, use_new_fe, expected_path, fallback_reason
    ):
        with patch(
            "openvino.tools.mo.convert_impl.get_default_frontends"
        ) as default_fe:
            ...
            tm.Telemetry.send_event.assert_any_call(
                "mo", "conversion_method", expected_path
            )
            if fallback_reason:
                tm.Telemetry.send_event.assert_any_call(
                    "mo", "fallback_reason", fallback_reason
    ...
    @pytest.mark.parametrize(
        "extension, trans_config, use_new_fe, expected_path, fallback_reason",
        [
            (
                ["dir_to_extension"],
                "fake_config.json",
                None,
                "mo_legacy",
                "extensions, transformations_config",
            ),  # fallback
            (
                None,
                "fake_config.json",
    ...
    def test_fallback_if_both_extension_and_trans_config_specified(
        self, extension, trans_config, use_new_fe, expected_path, fallback_reason
    ):
        with patch(
            "openvino.tools.mo.convert_impl.get_default_frontends"
        ) as default_fe:
    ...
    @pytest.mark.parametrize(
        "trans_config, use_legacy, use_new_fe, expected_path",
        [
    ...
    def test_fallback_if_legacy_set_as_default(
        self, trans_config, use_legacy, use_new_fe, expected_path
    ):
        with patch(
            "openvino.tools.mo.convert_impl.get_default_frontends"
        ) as default_fe:
    ...
    @pytest.mark.parametrize(
        "use_new_fe, use_legacy, extension, expected_path",
        [(True, None, None, "paddle_frontend"), (None, None, None, "paddle_frontend")],
    )
    def test_no_fallback_if_pdpd(
        self, use_new_fe, use_legacy, extension, expected_path
    ):
        args = base_args_config(use_legacy, use_new_fe)
