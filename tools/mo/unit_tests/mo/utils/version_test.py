...
class TestingVersion(unittest.TestCase):
    ...
    @mock.patch(
        ...
        create=True,
        read_data="2021.1.0-1028-55e4d5673a8",
    )
    ...
    @mock.patch(
        ...
        new_callable=mock_open,
        create=True,
        read_data="custom_releases/2021/1_55e4d5673a8",
    )
    ...
    @mock.patch(
        ...
        new_callable=mock_open,
        create=True,
        read_data="custom_my_branch/fix_55e4d5673a8",
    )
    ...
    def test_simplify_ie_version_release_legacy(self):
        self.assertEqual(
            get_simplified_ie_version(version="2.1.custom_releases/2021/3_4c8eae"),
            "2021.3",
        )

    def test_simplify_ie_version_release(self):
        self.assertEqual(
            get_simplified_ie_version(version="custom_releases/2021/3_4c8eae"), "2021.3"
        )

    def test_simplify_ie_version_custom_legacy(self):
        self.assertEqual(
            get_simplified_ie_version(version="2.1.custom_my/branch/3_4c8eae"), "custom"
        )

    def test_simplify_ie_version_custom(self):
        self.assertEqual(
            get_simplified_ie_version(version="custom_my/branch/3_4c8eae"), "custom"
        )
    ...
    def test_extracting_version_hash_full_with_build_number_dirty(self):
        self.assertEqual(
            extract_hash_from_version(full_version="2021.1.0-1028-55e4d5673a8-dirty"),
            "55e4d5673a8",
        )

    def test_extracting_version_hash_full_with_build_number_private(self):
        self.assertEqual(
            extract_hash_from_version(full_version="2021.1.0-1028-55e4d5673a8-private"),
            "55e4d5673a8",
        )
    ...
    def test_extracting_version_hash_custom_master(self):
        self.assertEqual(
            extract_hash_from_version(
                full_version="custom_master_55e4d5673a833abab638ee9837bc87a0b7c3a043"
            ),
    ...
    def test_extracting_version_hash_mo_format(self):
        self.assertEqual(
            extract_hash_from_version(
                full_version="2022.1.custom_master_55e4d5673a833abab638ee9837bc87a0b7c3a043"
            ),
            "55e4d5673a833abab638ee9837bc87a0b7c3a043",
        )
    ...
    def test_negative_extracting_version_hash(self):
        self.assertEqual(
            extract_hash_from_version(full_version="2022.1.custom_master"), None
        )
    ...
    def test_version_checker(self):
        ...
        args = [
            ...
            os.path.join(
                ...
                "convert/version_checker_test_actual.py",
            ),
            "-s",
        ]
