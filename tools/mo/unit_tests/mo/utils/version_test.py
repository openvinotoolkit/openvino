...
from openvino.tools.mo.utils.version import extract_release_version, extract_hash_from_version, VersionChecker
...
class TestingVersion(unittest.TestCase):
    ...
    def test_get_version(self, mock_open, mock_isfile):
        ...
        self.assertEqual(VersionChecker._get_version(), '2021.1.0-1028-55e4d5673a8')
    ...
    def test_release_version_extractor(self, mock_open, mock_isfile):
        mock_isfile.return_value = True
        mock_open.return_value.__enter__ = mock_open
        self.assertEqual(extract_release_version(VersionChecker._get_version()), ('2021', '1'))
    ...
    def test_release_version_extractor_neg(self, mock_open, mock_isfile):
        mock_isfile.return_value = True
        mock_open.return_value.__enter__ = mock_open
        self.assertEqual(extract_release_version(VersionChecker._get_version()), (None, None))
    ...
    def test_simplify_mo_version_release(self, mock_open, mock_isfile):
        mock_isfile.return_value = True
        mock_open.return_value.__enter__ = mock_open
        self.assertEqual(VersionChecker._simplify_version(VersionChecker._get_version()), "2021.1")
    ...
    def test_simplify_mo_version_custom(self, mock_open, mock_isfile):
        mock_isfile.return_value = True
        mock_open.return_value.__enter__ = mock_open
        self.assertEqual(VersionChecker._simplify_version(VersionChecker._get_version()), "custom")

    def test_simplify_ie_version_release_legacy(self):
        self.assertEqual(VersionChecker._get_simplified_ie_version(version="2.1.custom_releases/2021/3_4c8eae"), "2021.3")

    def test_simplify_ie_version_release(self):
        self.assertEqual(VersionChecker._get_simplified_ie_version(version="custom_releases/2021/3_4c8eae"), "2021.3")

    def test_simplify_ie_version_custom_legacy(self):
        self.assertEqual(VersionChecker._get_simplified_ie_version(version="2.1.custom_my/branch/3_4c8eae"), "custom")

    def test_simplify_ie_version_custom(self):
        self.assertEqual(VersionChecker._get_simplified_ie_version(version="custom_my/branch/3_4c8eae"), "custom")
