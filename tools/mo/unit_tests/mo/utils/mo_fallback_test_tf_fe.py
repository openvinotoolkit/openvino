...
class TestMoFallback(unittest.TestCase):
    ...
    def test_transform_config_fallback_tf_fe_pb(
        self, use_legacy_frontend, use_new_frontend, expected_frontend, fallback_reason
    ):
        import tempfile
        ...
        with tempfile.TemporaryDirectory(dir=self.test_directory) as tmp_dir:
            ...
            tm.Telemetry.send_event.assert_any_call(
                "mo", "conversion_method", expected_frontend
            )
            if fallback_reason:
                tm.Telemetry.send_event.assert_any_call(
    ...
    def test_transform_config_fallback_tf_fe_saved_model(
        self, use_legacy_frontend, use_new_frontend, expected_frontend, fallback_reason
    ):
        import tempfile
