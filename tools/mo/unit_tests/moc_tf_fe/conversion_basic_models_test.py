...
class TestMoFreezePlaceholderTFFE(unittest.TestCase):
    ...
    def test_fp32(self, input_freezing_value, inputs, expected, dtype):
    ...
    def test_int32(self, input_freezing_value, inputs, expected, dtype=None):
    ...
    def test_bool(self, input_freezing_value, inputs, expected, dtype=None):
    ...
    @generate(
        *[
            (
                "add:0[3],z:0",
                {
                    "add:0": np.array([4, 5, 6], dtype=np.float32),
                    "z:0": np.array([1, 2, 3], dtype=np.float32),
                },
            ...
            (
                "add:0{i32}[3],z:0{i32}",
                {
                    "add:0": np.array([4, 5, 6], dtype=np.int32),
                    "z:0": np.array([1, 2, 3], dtype=np.int32),
                },
    ...
    @generate(
        *[
            (
                "x[1,4],y[4]",
                {
                    "x": np.array([[3, 2, 1, 5]], dtype=np.int32),
                    "y": np.array([0, -1, -7, 8], dtype=np.int32),
                },
            ...
            (
                "x,y",
                {
                    ...
                    "y": np.array([[10, -11, -17]], dtype=np.int32),
                },
    ...
    def test_freeze_placeholder_with_unknown_rank(
        self,
        inputs,
        inputs_data,
        expected,
