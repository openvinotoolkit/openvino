...
####### The input file was OpenVINODeveloperPackageConfig.cmake.in                            ########
...
set_and_check(OpenVINO_SOURCE_DIR "D:/OPENVINO/openvino")
...
if(ENABLE_SAMPLES)
    if("")
        set_and_check(gflags_DIR "")
    else()
        set_and_check(gflags_DIR "D:/OPENVINO/openvino/thirdparty/gflags/gflags")
    endif()
endif()
