...
|---|---|
| [`skills/conversion-issues/pytorch.md`](skills/conversion-issues/pytorch.md) | Conversion failures, existing op bugs, accuracy issues, shape/type mismatches, normalize-step failures, tracing mode issues |
| [`skills/add-fe-op/pytorch.md`](skills/add-fe-op/pytorch.md) | Implementing a new op translator (`"No translator found for"`, `PtFrameworkNode` remains after conversion) |
