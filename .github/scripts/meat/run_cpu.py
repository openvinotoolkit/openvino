#!/usr/bin/env python3
"""Run the CPU plugin agent.

Implements an ISA-aware CPU kernel for a new OpenVINO operator:
node registration, JIT executor (AVX2/AVX-512/AMX), oneDNN-backed paths,
and functional tests. Runs in parallel with the Transformation and GPU
agents after Core OpSpec publishes the op spec.

Usage:
    python .github/scripts/meat/run_cpu.py <context-file>
...
Output goes to agent-results/cpu/.
...
AGENT_FILE = ".github/agents/cpu.agent.md"
