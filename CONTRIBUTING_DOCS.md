...
* **Annotate screenshots with numbers** instead of writing on them or leaving them blank.
  ...
  * If you describe many elements of the same or two similar screens, put multiple
  ...
  ![](docs/sphinx_setup/_static/images/bad-annotated-screenshot-1.png)

  ![](docs/sphinx_setup/_static/images/bad-annotated-screenshot-2.png)
  ...
  ![](docs/sphinx_setup/_static/images/good-annotated-screenshot.png)
