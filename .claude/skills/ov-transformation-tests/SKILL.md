...
1. Read [src/common/transformations/docs/writing_tests.md](../../../src/common/transformations/docs/writing_tests.md) — it covers test location, build target, fixture setup, FunctionsComparator flags, node builders, model builder helpers, parametrized and negative test patterns, and what NOT to do.
