...
NGRAPH_OP(BatchNormInference, ov::op::v5)
...
NGRAPH_OP(Proposal, ov::op::v4)
NGRAPH_OP(Range, ov::op::v4)
...
NGRAPH_OP(ReorgYolo, ov::op::v0)
NGRAPH_OP(Reshape, ov::op::v1)
NGRAPH_OP(Result, ov::op::v0)
NGRAPH_OP(ReverseSequence, ov::op::v0)
NGRAPH_OP(ROIPooling, ov::op::v0)
NGRAPH_OP(ScatterNDUpdate, ov::op::v3)
...
NGRAPH_OP(Acosh, ov::op::v3)
NGRAPH_OP(Asinh, ov::op::v3)
NGRAPH_OP(Atanh, ov::op::v3)
NGRAPH_OP(CTCLoss, ov::op::v4)
NGRAPH_OP(HSwish, ov::op::v4)
NGRAPH_OP(Interpolate, ov::op::v4)
NGRAPH_OP(Mish, ov::op::v4)
NGRAPH_OP(ReduceL1, ov::op::v4)
NGRAPH_OP(ReduceL2, ov::op::v4)
NGRAPH_OP(SoftPlus, ov::op::v4)
NGRAPH_OP(Swish, ov::op::v4)

// New operations added in opset5
NGRAPH_OP(GatherND, ov::op::v5)
NGRAPH_OP(GRUSequence, ov::op::v5)
NGRAPH_OP(HSigmoid, ov::op::v5)
NGRAPH_OP(LogSoftmax, ov::op::v5)
NGRAPH_OP(Loop, ov::op::v5)
NGRAPH_OP(LSTMSequence, ov::op::v5)
NGRAPH_OP(NonMaxSuppression, ov::op::v5)
NGRAPH_OP(RNNSequence, ov::op::v5)
NGRAPH_OP(Round, ov::op::v5)

// New operations added in opset6
NGRAPH_OP(CTCGreedyDecoderSeqLen, ov::op::v6)
NGRAPH_OP(ExperimentalDetectronDetectionOutput, ov::op::v6)
NGRAPH_OP(ExperimentalDetectronGenerateProposalsSingleImage, ov::op::v6)
NGRAPH_OP(ExperimentalDetectronPriorGridGenerator, ov::op::v6)
NGRAPH_OP(ExperimentalDetectronROIFeatureExtractor, ov::op::v6)
NGRAPH_OP(ExperimentalDetectronTopKROIs, ov::op::v6)
NGRAPH_OP(GatherElements, ov::op::v6)
NGRAPH_OP(MVN, ov::op::v6)
NGRAPH_OP(Assign, ov::op::v6)    // new version
NGRAPH_OP(ReadValue, ov::op::v6) // new version

// New operations added in opset7
NGRAPH_OP(DFT, ov::op::v7)
NGRAPH_OP(Einsum, ov::op::v7)
NGRAPH_OP(Gelu, ov::op::v7)
NGRAPH_OP(IDFT, ov::op::v7)
NGRAPH_OP(Roll, ov::op::v7)

// New operations added in opset8
NGRAPH_OP(Gather, ov::op::v8)
NGRAPH_OP(AdaptiveAvgPool, ov::op::v8)
NGRAPH_OP(AdaptiveMaxPool, ov::op::v8)
NGRAPH_OP(DeformableConvolution, ov::op::v8)
NGRAPH_OP(MatrixNms, ov::op::v8)
NGRAPH_OP(MaxPool, ov::op::v8)
NGRAPH_OP(MulticlassNms, ov::op::v8)
NGRAPH_OP(RandomUniform, ov::op::v8)
