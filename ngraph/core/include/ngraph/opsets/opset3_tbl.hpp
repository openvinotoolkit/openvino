...
NGRAPH_OP(Broadcast, ov::op::v3)
NGRAPH_OP(Bucketize, ov::op::v3)
...
NGRAPH_OP(ExtractImagePatches, ov::op::v3)
...
NGRAPH_OP(MVN, ov::op::v0) // Missing in opset1

NGRAPH_OP(Negative, ov::op::v0)
NGRAPH_OP(NonMaxSuppression, ov::op::v3)
...
NGRAPH_OP(ReorgYolo, ov::op::v0) // Missing in opset1
...
NGRAPH_OP(ROIPooling, ov::op::v0) // Missing in opset1
...
NGRAPH_OP(Gelu, ov::op::v0)
NGRAPH_OP(BatchToSpace, ov::op::v1)
NGRAPH_OP(SpaceToBatch, ov::op::v1)

// New operations added in opset3
NGRAPH_OP(EmbeddingBagPackedSum, ov::op::v3)
NGRAPH_OP(EmbeddingSegmentsSum, ov::op::v3)
NGRAPH_OP(EmbeddingBagOffsetsSum, ov::op::v3)
NGRAPH_OP(GRUCell, ov::op::v3)
NGRAPH_OP(NonZero, ov::op::v3)
NGRAPH_OP(RNNCell, ov::op::v0)
NGRAPH_OP(ROIAlign, ov::op::v3)
NGRAPH_OP(ScatterElementsUpdate, ov::op::v3)
NGRAPH_OP(ScatterUpdate, ov::op::v3)
NGRAPH_OP(ShuffleChannels, ov::op::v0)
NGRAPH_OP(ShapeOf, ov::op::v3)
NGRAPH_OP(Assign, ov::op::v3)
NGRAPH_OP(ReadValue, ov::op::v3)
NGRAPH_OP(TopK, ov::op::v3)
