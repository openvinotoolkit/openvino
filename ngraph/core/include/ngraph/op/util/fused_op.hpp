...
///        ngraph ops
///
class NGRAPH_DEPRECATED("FusedOp approach was deprecated! "
                        "Please use inheritance from usual Op instead of FusedOp") NGRAPH_API FusedOp : public Op {
public:
    NGRAPH_RTTI_DECLARATION;

    // Fused op decomposition can be performed in the presence of
    // partial shapes
    virtual bool can_decompose_with_partial_shapes() {
        return false;
    }
