...
namespace ngraph
{
    namespace op
    {
        namespace v0
        {
            ...
            // clang-format off
            class NGRAPH_DEPRECATED("This operation is deprecated and will be removed soon. Use v1::ReduceSum instead of it.") NGRAPH_API Sum : public util::ArithmeticReduction
            {
            public:
