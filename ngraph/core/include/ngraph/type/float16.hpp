...
namespace std
{
    bool NGRAPH_API isnan(ov::float16 x);
    ...
    public:
        ...
        static constexpr ov::float16 min() noexcept { return ov::float16::from_bits(0x0200); }
        static constexpr ov::float16 max() noexcept { return ov::float16::from_bits(0x7BFF); }
        static constexpr ov::float16 lowest() noexcept { return ov::float16::from_bits(0xFBFF); }
        ...
        static constexpr ov::float16 epsilon() noexcept { return ov::float16::from_bits(0x1200); }
        ...
        static constexpr ov::float16 infinity() noexcept { return ov::float16::from_bits(0x7C00); }
        static constexpr ov::float16 quiet_NaN() noexcept { return ov::float16::from_bits(0x7FFF); }
        static constexpr ov::float16 signaling_NaN() noexcept
        {
            return ov::float16::from_bits(0x7DFF);
        }
        static constexpr ov::float16 denorm_min() noexcept { return ov::float16::from_bits(0); }
