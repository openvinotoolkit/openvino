...
public:
    ...
    template <typename T>
    Constant(const element::Type& type, const ngraph::Shape& shape, const std::vector<T>& values)
        : Constant(type, shape) {
    ...
    Constant(const element::Type& type, const ngraph::Shape& shape);
    ...
    Constant(const element::Type& type, const ngraph::Shape& shape, T value) : Constant(type, shape) {
...
#    pragma GCC diagnostic pop
    ...
    Constant(const element::Type& type, const ngraph::Shape& shape, const std::vector<std::string>& values);
    ...
    Constant(const element::Type& type, const ngraph::Shape& shape, const void* data);
    ...
    Constant(const Constant& other, const ngraph::Shape& new_shape);
    ...
    ngraph::Shape get_shape_val() const;
    ...
    void set_data_shape(const ngraph::Shape& shape);
    ...
    static std::shared_ptr<Constant> create(const element::Type& type, const ngraph::Shape& shape, const void* memory) {
