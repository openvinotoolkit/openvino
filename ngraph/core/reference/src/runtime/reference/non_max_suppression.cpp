...
namespace
{
    ...
    void eval(const float* boxes_data,
        ...
        namespace reference
        {
                                     ...
                                     const std::vector<std::shared_ptr<HostTensor>>& inputs)
            {
                ...
                auto selected_indices_shape =
                    infer_selected_indices_shape(inputs, max_output_boxes_per_class);
                ...
                auto boxes_data =
                    prepare_boxes_data(inputs[boxes_port], boxes_shape, nms5->get_box_encoding());
