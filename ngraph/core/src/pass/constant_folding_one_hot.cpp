...
{
    NGRAPH_PASS_SCOPE(ConstantFolding_ConstantOneHot,
        auto indices_label =
        ...
        auto one_hot_matcher =
            make_shared<pattern::Matcher>(ont_hot_pattern, matcher_name);
