                                                                ...
                                                                shared_ptr<Node> reduction_node)
{
    ...
    else if (auto reduce_and = as_type_ptr<::ngraph::op::v1::ReduceLogicalAnd>(reduction_node))
    {
        ...
        runtime::reference::reduce_logical_and(arg, data_ptr, input_shape, reduction_axes, reduce_and->get_keep_dims());
    }
    else if (auto reduce_or = as_type_ptr<::ngraph::op::v1::ReduceLogicalOr>(reduction_node))
    {
        ...
        runtime::reference::reduce_logical_or(arg, data_ptr, input_shape, reduction_axes, reduce_or->get_keep_dims());
    }
    else
    {
        NGRAPH_CHECK(false,
