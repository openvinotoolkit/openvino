...
{
    NGRAPH_PASS_SCOPE(ConvertFP32ToFP16_convert_constants_precision,
        auto constant =
        ...
        auto m = std::make_shared<ngraph::pattern::Matcher>(constant, matcher_name);
...
{
    NGRAPH_PASS_SCOPE(ConvertFP32ToFP16_convert_parameters_precision,
