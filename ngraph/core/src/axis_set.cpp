...
ngraph::AxisSet::AxisSet(const std::initializer_list<size_t>& axes) : std::set<size_t>(axes) {}

ngraph::AxisSet::AxisSet(const std::set<size_t>& axes) : std::set<size_t>(axes) {}

ngraph::AxisSet::AxisSet(const std::vector<size_t>& axes) : std::set<size_t>(axes.begin(), axes.end()) {}

ngraph::AxisSet::AxisSet(const AxisSet& axes) : std::set<size_t>(axes) {}
