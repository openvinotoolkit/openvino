...
OPENVINO_RTTI_DEFINITION(op::v6::ExperimentalDetectronDetectionOutput,
...
void op::v6::ExperimentalDetectronDetectionOutput::validate_and_infer_types() {
    ...
    set_output_type(1, element::Type_t::i32, ov::StaticShape{rois_num});
    set_output_type(2, input_et, ov::StaticShape{rois_num});
