...
OPENVINO_RTTI_DEFINITION(op::v1::LogicalXor, "LogicalXor", "opset2", util::BinaryElementwiseLogical, 1);
...
OPENVINO_RTTI_DEFINITION(op::v0::Xor, "Xor", "opset1", util::BinaryElementwiseLogical);
