...
{
    NGRAPH_OP_SCOPE(DetectionOutput_validate_and_infer_types)
    {
            ...
            if (class_preds_pshape[1].is_static())
            {
                ...
                else
                {
                    ...
                    NODE_VALIDATION_CHECK(
                        this,
                        class_preds_pshape[1].get_length() ==
                            num_prior_boxes_val * m_attrs.num_classes,
...
{
    NGRAPH_OP_SCOPE(DetectionOutput_clone_with_new_inputs)
    {
...
{
    NGRAPH_OP_SCOPE(DetectionOutput_visit_attributes)
    {
