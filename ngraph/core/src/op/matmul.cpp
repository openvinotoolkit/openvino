...
OPENVINO_RTTI_DEFINITION(op::v0::MatMul, "MatMul", "opset1");
...
namespace matmul {
ov::Shape validate_matmul_output_shape(const ov::Shape& arg0_shape,
                                       const ov::Shape& arg1_shape,
                                       bool transpose_a,
                                       bool transpose_b) {
...
bool evaluate(const HostTensorPtr& arg0,
    ...
    ov::Shape output_partial_shape =
        validate_matmul_output_shape(ov::Shape(arg0_shape), ov::Shape(arg1_shape), transpose_a, transpose_b);
...
void ngraph::op::v0::MatMul::validate_and_infer_types() {
    ...
    if (A_partial_shape.rank().is_static() && B_partial_shape.rank().is_static()) {
        ...
        set_output_type(0, result_et, ov::Shape::dynamic());
    }
}
