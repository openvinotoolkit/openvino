...
OPENVINO_RTTI_DEFINITION(op::v3::ScatterElementsUpdate, "ScatterElementsUpdate", "opset3", op::Op, 3);
...
void op::v3::ScatterElementsUpdate::validate_and_infer_types() {
    ...
    NODE_VALIDATION_CHECK(this,
                          axis_shape.compatible(ov::Shape{}) || axis_shape.compatible(ov::Shape{1}),
