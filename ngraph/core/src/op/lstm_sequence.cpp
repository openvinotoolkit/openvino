...
OPENVINO_RTTI_DEFINITION(op::v0::LSTMSequence, "LSTMSequence", "opset1");
OPENVINO_RTTI_DEFINITION(op::v5::LSTMSequence, "LSTMSequence", "opset5", util::RNNCellBase, 5);
...
op::v0::LSTMSequence::LSTMSequence(const Output<Node>& X,
    ...
    : op::v0::LSTMSequence(
          ...
          Constant::create(element::f32,
                           StaticShape{(lstm_direction == LSTMSequence::direction::BIDIRECTIONAL ? 2UL : 1UL),
