...
int64_t op::v8::MulticlassNms::max_boxes_output_from_input() const
{
...
float op::v8::MulticlassNms::iou_threshold_from_input() const
{
...
float op::v8::MulticlassNms::score_threshold_from_input() const
{
...
float op::v8::MulticlassNms::soft_nms_sigma_from_input() const
{
...
bool op::v8::MulticlassNms::is_soft_nms_sigma_constant_and_default() const
{
...
{
    NGRAPH_OP_SCOPE(v8_MulticlassNms_validate_and_infer_types);
    const auto boxes_ps = get_input_partial_shape(0);
    const auto scores_ps = get_input_partial_shape(1);

    // MulticlassNms produces triplets
...
{
    template <>
    EnumNames<op::v8::MulticlassNms::BoxEncodingType>&
        EnumNames<op::v8::MulticlassNms::BoxEncodingType>::get()
    {
        static auto enum_names = EnumNames<op::v8::MulticlassNms::BoxEncodingType>(
            "op::v8::MulticlassNms::BoxEncodingType",
            {{"corner", op::v8::MulticlassNms::BoxEncodingType::CORNER},
             {"center", op::v8::MulticlassNms::BoxEncodingType::CENTER}});
        return enum_names;
    }
