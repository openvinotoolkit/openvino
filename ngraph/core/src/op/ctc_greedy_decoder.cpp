...
{
    NGRAPH_OP_SCOPE(CTCGreedyDecoder_validate_and_infer_types)
    {
...
{
    NGRAPH_OP_SCOPE(CTCGreedyDecoder_visit_attributes)
    {
...
{
    NGRAPH_OP_SCOPE(CTCGreedyDecoder_clone_with_new_inputs)
    {
