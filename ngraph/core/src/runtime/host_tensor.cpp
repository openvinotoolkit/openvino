...
runtime::HostTensor::HostTensor(const ov::element::Type& element_type,
                                const Shape& shape,
                                void* memory_pointer)
    : runtime::Tensor(std::make_shared<ov::descriptor::Tensor>(element_type, shape, ""))
...
runtime::HostTensor::HostTensor(const element::Type& element_type,
    ...
    : runtime::Tensor(std::make_shared<ov::descriptor::Tensor>(element_type, partial_shape, ""))
    , m_buffer_size(0)
{
