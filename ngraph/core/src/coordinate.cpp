...
ngraph::Coordinate::Coordinate(const std::initializer_list<size_t>& axes) : std::vector<size_t>(axes) {}

ngraph::Coordinate::Coordinate(const Shape& shape)
    : std::vector<size_t>(static_cast<const std::vector<size_t>&>(shape)) {}

ngraph::Coordinate::Coordinate(const std::vector<size_t>& axes) : std::vector<size_t>(axes) {}

ngraph::Coordinate::Coordinate(const Coordinate& axes) : std::vector<size_t>(axes) {}

ngraph::Coordinate::Coordinate(size_t n, size_t initial_value) : std::vector<size_t>(n, initial_value) {}
