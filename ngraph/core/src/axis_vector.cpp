...
ngraph::AxisVector::AxisVector(const std::initializer_list<size_t>& axes) : std::vector<size_t>(axes) {}

ngraph::AxisVector::AxisVector(const std::vector<size_t>& axes) : std::vector<size_t>(axes) {}

ngraph::AxisVector::AxisVector(const AxisVector& axes) : std::vector<size_t>(axes) {}

ngraph::AxisVector::AxisVector(size_t n) : std::vector<size_t>(n) {}
