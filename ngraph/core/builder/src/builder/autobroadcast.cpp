...
namespace ngraph
{
    namespace builder
    {
                                                     ...
                                                     const Shape& source_shape)
        {
            ...
            {
                auto shape_const =
                    op::Constant::create(element::Type_t::u64, Shape{output_shape.size()}, output_shape);
                                                       ...
                                                       size_t start_match_axis)
        {
            ...
            return op::Constant::create(element::Type_t::i64, Shape{axes_mapping.size()}, axes_mapping);
        }
        ...
        namespace opset1
        {
                                        ...
                                        const AxisSet& broadcast_axes)
            {
                return make_shared<op::v1::Broadcast>(
                    node,
                    op::Constant::create(element::Type_t::i64, Shape{target_shape.size()}, target_shape),
