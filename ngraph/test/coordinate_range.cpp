...
TEST(coordinate_range, slice_range_shape0d)
{
    ...
    EXPECT_EQ(it->coodinate(), Coordinate({}));
...
TEST(coordinate_range, slice_range_shape1d)
{
    ...
    {
        EXPECT_EQ(it->index(), c.first);
        EXPECT_EQ(it->coodinate(), c.second);
        ++it;
    }
...
TEST(coordinate_range, slice_range_shape3d)
{
    ...
    const ExpectedOutput expected{
        {0, {0, 0, 0}},  {1, {0, 0, 1}},  {2, {0, 0, 2}},  {3, {0, 0, 3}},  {4, {0, 1, 0}},
        {5, {0, 1, 1}},  {6, {0, 1, 2}},  {7, {0, 1, 3}},  {8, {0, 2, 0}},  {9, {0, 2, 1}},
        {10, {0, 2, 2}}, {11, {0, 2, 3}}, {12, {1, 0, 0}}, {13, {1, 0, 1}}, {14, {1, 0, 2}},
        {15, {1, 0, 3}}, {16, {1, 1, 0}}, {17, {1, 1, 1}}, {18, {1, 1, 2}}, {19, {1, 1, 3}},
...
TEST(coordinate_range, slice_range_corner)
{
    ...
    const ExpectedOutput expected{{33, {3, 3}},
                                  ...
                                  {54, {5, 4}},
                                  {55, {5, 5}}};
    EXPECT_EQ(expected.size(), shape_size(sliced_shape(source_start_corner, source_end_corner)))
        << "check epxected data";

    auto slice_range = slice(s, source_start_corner, source_end_corner);
    auto it = slice_range.begin();
...
TEST(coordinate_range, slice_range_strides)
{
    ...
    const ExpectedOutput expected{{0, {0, 0}},  {3, {0, 3}},  {6, {0, 6}},  {9, {0, 9}},
                                  {20, {2, 0}}, {23, {2, 3}}, {26, {2, 6}}, {29, {2, 9}},
                                  {40, {4, 0}}, {43, {4, 3}}, {46, {4, 6}}, {49, {4, 9}},
                                  {60, {6, 0}}, {63, {6, 3}}, {66, {6, 6}}, {69, {6, 9}},
                                  {80, {8, 0}}, {83, {8, 3}}, {86, {8, 6}}, {89, {8, 9}}};

    auto slice_range = slice(s, source_start_corner, source_end_corner, source_strides);
    auto it = slice_range.begin();
...
TEST(coordinate_range, reverse_range_2d)
{
    ...
    const ExpectedOutput expected{
        ...
        {3, {0, 3}},  {2, {0, 2}},  {1, {0, 1}},  {0, {0, 0}},  {19, {1, 9}}, {18, {1, 8}},
        {17, {1, 7}}, {16, {1, 6}}, {15, {1, 5}}, {14, {1, 4}}, {13, {1, 3}}, {12, {1, 2}},
        {11, {1, 1}}, {10, {1, 0}}, {29, {2, 9}}, {28, {2, 8}}, {27, {2, 7}}, {26, {2, 6}},
        {25, {2, 5}}, {24, {2, 4}}, {23, {2, 3}}, {22, {2, 2}}, {21, {2, 1}}, {20, {2, 0}}};
...
TEST(coordinate_range, reverse_range_3d)
{
    const Shape s{3, 3, 3};
    const AxisSet reverset_axis{1};

    const ExpectedOutput expected{
        {6, {0, 2, 0}},  {7, {0, 2, 1}},  {8, {0, 2, 2}},  {3, {0, 1, 0}},  {4, {0, 1, 1}},
        {5, {0, 1, 2}},  {0, {0, 0, 0}},  {1, {0, 0, 1}},  {2, {0, 0, 2}},  {15, {1, 2, 0}},
        {16, {1, 2, 1}}, {17, {1, 2, 2}}, {12, {1, 1, 0}}, {13, {1, 1, 1}}, {14, {1, 1, 2}},
        {9, {1, 0, 0}},  {10, {1, 0, 1}}, {11, {1, 0, 2}}, {24, {2, 2, 0}}, {25, {2, 2, 1}},
        {26, {2, 2, 2}}, {21, {2, 1, 0}}, {22, {2, 1, 1}}, {23, {2, 1, 2}}, {18, {2, 0, 0}},
        {19, {2, 0, 1}}, {20, {2, 0, 2}}};
