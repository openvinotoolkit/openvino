...
TEST(attributes, proposal_op)
{
    ...
    const auto class_probs = make_shared<op::Parameter>(element::i64, Shape{1024, 2, 128, 128});
    const auto class_logits = make_shared<op::Parameter>(element::i64, Shape{1024, 4, 128, 128});
