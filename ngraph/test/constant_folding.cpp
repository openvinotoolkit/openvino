...
static std::vector<T> get_result_constant(std::shared_ptr<Function> f, size_t pos) {
    auto new_const = ov::as_type_ptr<op::Constant>(f->get_results().at(pos)->input_value(0).get_node()->shared_from_this());
...
TEST(constant_folding, acosh) {
    ...
    auto new_const = ov::as_type_ptr<op::Constant>(f->get_results()[0]->input_value(0).get_node()->shared_from_this());
...
TEST(constant_folding, constant_squeeze) {
    ...
    auto new_const = ov::as_type_ptr<op::Constant>(f->get_results().at(0)->input_value(0).get_node()->shared_from_this());
...
TEST(constant_folding, const_reduce_logical_and__no_keepdims) {
    ...
    const auto new_const = ov::as_type_ptr<op::Constant>(f->get_results().at(0)->input_value(0).get_node()->shared_from_this());
    ASSERT_TRUE(new_const);
    ASSERT_EQ(new_const->get_friendly_name(), "test");
...
TEST(constant_folding, const_reshape_no_data_copy) {
    ...
    auto const1 = std::dynamic_pointer_cast<op::Constant>(consumer1->input_value(0).get_node()->shared_from_this());
    auto const2 = std::dynamic_pointer_cast<op::Constant>(consumer2->input_value(0).get_node()->shared_from_this());
...
TEST(constant_folding, constant_v1_split) {
    ...
    auto res1 = ov::as_type_ptr<op::Constant>(f->get_results().at(0)->input_value(0).get_node()->shared_from_this());
    auto res2 = ov::as_type_ptr<op::Constant>(f->get_results().at(1)->input_value(0).get_node()->shared_from_this());
    auto res3 = ov::as_type_ptr<op::Constant>(f->get_results().at(2)->input_value(0).get_node()->shared_from_this());
    ASSERT_TRUE(res1);
    ASSERT_TRUE(res2);
    ASSERT_TRUE(res3);
...
TEST(constant_folding, constant_v1_split_axis_1_4_splits) {
    ...
    auto res2 = ov::as_type_ptr<op::Constant>(f->get_results().at(1)->input_value(0).get_node()->shared_from_this());
    auto res3 = ov::as_type_ptr<op::Constant>(f->get_results().at(2)->input_value(0).get_node()->shared_from_this());
    auto res4 = ov::as_type_ptr<op::Constant>(f->get_results().at(3)->input_value(0).get_node()->shared_from_this());
    ASSERT_TRUE(res1);
...
TEST(constant_folding, constant_v1_one_hot) {
    ...
    auto res = ov::as_type_ptr<op::Constant>(f->get_results().at(0)->input_value(0).get_node()->shared_from_this());
    ASSERT_TRUE(res);
...
TEST(constant_folding, constant_scatter_elements_update_basic) {
    ...
    auto result_node = ov::as_type_ptr<op::Constant>(f->get_results().at(0)->input_value(0).get_node()->shared_from_this());
...
TEST(constant_folding, constant_loop) {
    ...
    auto result_node_0 = ov::as_type_ptr<op::Constant>(f->get_results().at(0)->input_value(0).get_node()->shared_from_this());
    auto result_node_1 = ov::as_type_ptr<op::Constant>(f->get_results().at(1)->input_value(0).get_node()->shared_from_this());
