                            ...
                            const Shape& expected_shape)
{
    ...
    auto test_case = test::TestCase<ov::test::INTERPRETER_Engine>(fun);
...
TEST(op_eval, einsum_ellipsis_complex_mul)
{
    ...
    std::vector<float> expected_result{27., 85., 37., 66., 30., 58., 50., 8.,  37., 123., 55.,
                                       83., 16., 48., 24., 30., 29., 83., 43., 52., 20.,  92.,
                                       44., 24., 24., 96., 48., 30., 13., 67., 31., 15.};
...
TEST(op_eval, einsum_diagonal_with_matmul)
{
    ...
    std::vector<float> input1{
        4.0, 2.0, 5.0, 4.0, 5.0, 5.0, 1.0, 1.0, 3.0, 3.0, 1.0, 1.0, 2.0, 2.0, 4.0, 1.0, 3.0, 4.0,
