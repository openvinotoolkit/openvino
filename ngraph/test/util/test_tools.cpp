...
shared_ptr<Function> make_test_graph()
{
    ...
    auto t0 = make_shared<op::v0::Add>(arg_0, arg_1);
    auto t1 = make_shared<op::v0::Dot>(t0, arg_2);
    auto t2 = make_shared<op::v0::Multiply>(t0, arg_3);

    auto t3 = make_shared<op::v0::Add>(t1, arg_4);
    auto t4 = make_shared<op::v0::Add>(t2, arg_5);

    auto r0 = make_shared<op::v0::Add>(t3, t4);
