...
namespace
{
    ...
    {
        op::Abs node;
        EXPECT_TRUE(op::util::is_unary_elementwise_arithmetic(&node));
        EXPECT_FALSE(op::util::is_binary_elementwise_arithmetic(&node));
        EXPECT_FALSE(op::util::is_binary_elementwise_comparison(&node));
        EXPECT_FALSE(op::util::is_binary_elementwise_logical(&node));
    }
    ...
    {
        op::Add node;
        EXPECT_FALSE(op::util::is_unary_elementwise_arithmetic(&node));
        EXPECT_TRUE(op::util::is_binary_elementwise_arithmetic(&node));
        EXPECT_FALSE(op::util::is_binary_elementwise_comparison(&node));
        EXPECT_FALSE(op::util::is_binary_elementwise_logical(&node));
    }
    ...
    void op_is_Equal()
    {
        ...
        EXPECT_FALSE(op::util::is_unary_elementwise_arithmetic(&node));
        EXPECT_FALSE(op::util::is_binary_elementwise_arithmetic(&node));
        EXPECT_TRUE(op::util::is_binary_elementwise_comparison(&node));
        EXPECT_FALSE(op::util::is_binary_elementwise_logical(&node));
    }
    ...
    void op_is_Or()
    {
        ...
        EXPECT_FALSE(op::util::is_binary_elementwise_arithmetic(&node));
        EXPECT_FALSE(op::util::is_binary_elementwise_comparison(&node));
        EXPECT_TRUE(op::util::is_binary_elementwise_logical(&node));
    }
