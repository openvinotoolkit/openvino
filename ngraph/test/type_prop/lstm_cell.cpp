...
TEST(type_prop, lstm_cell)
{
    ...
    const auto W =
        make_shared<opset4::Parameter>(element::Type_t::f32, Shape{gates_count * hidden_size, input_size});
    const auto R =
        make_shared<opset4::Parameter>(element::Type_t::f32, Shape{gates_count * hidden_size, hidden_size});
    const auto H_t = make_shared<opset4::Parameter>(element::Type_t::f32, Shape{batch_size, hidden_size});
    const auto C_t = make_shared<opset4::Parameter>(element::Type_t::f32, Shape{batch_size, hidden_size});
...
TEST(type_prop, lstm_cell_invalid_input)
{
    ...
    auto W = make_shared<opset4::Parameter>(element::Type_t::f32, Shape{1 * hidden_size, input_size});
    try
    {
        const auto lstm_cell = make_shared<opset4::LSTMCell>(X, H_t, C_t, W, R, hidden_size);
    ...
    W = make_shared<opset4::Parameter>(element::Type_t::f32, Shape{gates_count * hidden_size, input_size});
    ...
    R = make_shared<opset4::Parameter>(element::Type_t::f32, Shape{gates_count * hidden_size, hidden_size});
    ...
    auto B = make_shared<opset4::Parameter>(element::Type_t::f32, Shape{2 * gates_count * hidden_size});
...
TEST(type_prop, lstm_cell_invalid_input_rank0)
{
    ...
    auto X = make_shared<opset4::Parameter>(element::Type_t::f32, PartialShape{batch_size, input_size});
    ...
    auto H_t = make_shared<opset4::Parameter>(element::Type_t::f32, PartialShape{batch_size, hidden_size});
    auto C_t = make_shared<opset4::Parameter>(element::Type_t::f32, PartialShape{batch_size, hidden_size});
    ...
    H_t = make_shared<opset4::Parameter>(element::Type_t::f32, PartialShape{batch_size, hidden_size});
    ...
    C_t = make_shared<opset4::Parameter>(element::Type_t::f32, PartialShape{batch_size, hidden_size});
...
TEST(type_prop, lstm_cell_invalid_input_dynamic_rank)
{
    ...
    W = make_shared<opset4::Parameter>(element::Type_t::f32, PartialShape::dynamic(Rank::dynamic()));
    ...
    H_t = make_shared<opset4::Parameter>(element::Type_t::f32, PartialShape{batch_size, hidden_size});
    C_t = make_shared<opset4::Parameter>(element::Type_t::f32, PartialShape::dynamic(Rank::dynamic()));
    lstm = make_shared<opset4::LSTMCell>(X, H_t, C_t, W, R, hidden_size);
    EXPECT_EQ(check_dynamic_lstm(lstm), true);
