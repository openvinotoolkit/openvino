...
TEST(type_prop, rnn_sequence_dynamic_invalid_input_rank0) {
    ...
    ASSERT_THROW(make_shared<op::v5::RNNSequence>(X, H_t, sequence_lengths, W, R, B, hidden_size, direction),
                 ngraph::CheckFailure)
...
TEST(type_prop, rnn_sequence_dynamic_invalid_input_dynamic_rank) {
    ...
    auto rnn_x = make_shared<op::v5::RNNSequence>(X, H_t, sequence_lengths, W, R, B, hidden_size, direction);
    ...
    auto rnn_h = make_shared<op::v5::RNNSequence>(X, H_t, sequence_lengths, W, R, B, hidden_size, direction);
    ...
    auto rnn_w = make_shared<op::v5::RNNSequence>(X, H_t, sequence_lengths, W, R, B, hidden_size, direction);
    ...
    auto rnn_r = make_shared<op::v5::RNNSequence>(X, H_t, sequence_lengths, W, R, B, hidden_size, direction);
    ...
    auto rnn_b = make_shared<op::v5::RNNSequence>(X, H_t, sequence_lengths, W, R, B, hidden_size, direction);
