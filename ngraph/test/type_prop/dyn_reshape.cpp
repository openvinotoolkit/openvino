...
{
    auto arg = make_shared<op::v0::Parameter>(element::f32, Shape{2, 0, 2, 8});
    auto pattern = op::v0::Constant::create(element::i64, Shape{4}, {1, 2, 0, 32});
    ...
    auto dynamic_arg = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    ...
    try
    {
        auto static_shape_parameter =
            make_shared<op::v0::Parameter>(element::f32, Shape{1, 2, 3, 4});
        auto reshape_output_pattern =
            op::v0::Constant::create(element::i64, Shape{4}, {2, 2, 3, 4});
        auto reshape =
