...
class BasicParamInference: public testing::WithParamInterface<UnaryParams>,
                           public testing::Test {
public:
...
class IncompatibleInputType: public testing::WithParamInterface<UnaryParams>,
                             public testing::Test {
public:
    InputType input_type;
    Shape input_shape;
...
INSTANTIATE_TEST_CASE_P(type_prop, BasicParamInference,
        testing::Values(std::make_tuple(InputType{element::f32}, Shape{2, 2}),
                        ...
                        std::make_tuple(InputType{element::f16}, Shape{2, 20, 5, 5})),
                        BasicParamInference::getTestCaseName);

INSTANTIATE_TEST_CASE_P(type_prop, IncompatibleInputType,
...
INSTANTIATE_TEST_CASE_P(type_prop, DynamicRankInputShape,
