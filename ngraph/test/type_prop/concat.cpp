...
{
    // Deduce type
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 4});
    auto param1 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 7, 4});
    auto param2 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2, 4});
...
TEST(type_prop, concat_deduce_wrong_shape)
{
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 4});
    auto param1 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 7, 4});
    auto param2 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2, 5});
    try
    {
        auto c = make_shared<op::Concat>(NodeVector{param0, param1, param2}, 1);
        // Should have thrown, so fail if it didn't
...
TEST(type_prop, concat_deduce_axis_barely_in_bounds)
{
    // Deduce type
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 4});
    auto param1 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 8});
    auto param2 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 12});
...
{
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 4});
    auto param1 = make_shared<op::Parameter>(element::Type_t::i32, Shape{2, 7, 4});
    auto param2 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2, 4});
    try
    {
        auto c = make_shared<op::Concat>(NodeVector{param0, param1, param2}, 1);
...
{
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 4});
    auto param1 = make_shared<op::Parameter>(element::Type_t::dynamic, Shape{2, 7, 4});
    auto param2 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2, 4});
    auto c = make_shared<op::Concat>(NodeVector{param0, param1, param2}, 1);
...
TEST(type_prop, concat_partial_et_inconsistent)
{
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 4});
    auto param1 = make_shared<op::Parameter>(element::Type_t::dynamic, Shape{2, 7, 4});
    auto param2 = make_shared<op::Parameter>(element::Type_t::i32, Shape{2, 2, 4});
    try
    {
        auto c = make_shared<op::Concat>(NodeVector{param0, param1, param2}, 1);
        // Should have thrown, so fail if it didn't
...
{
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
...
TEST(type_prop, concat_partial_some_rank_dynamic_others_rank_static_dynamic_dims_inconsistent)
{
    ...
    auto param1 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
    auto param2 =
        make_shared<op::Parameter>(element::Type_t::f32, PartialShape{3, 3, Dimension::dynamic()});
    try
    {
        auto c = make_shared<op::Concat>(NodeVector{param0, param1, param2}, 1);
        // Should have thrown, so fail if it didn't
     ...
     concat_partial_some_rank_dynamic_others_rank_static_dynamic_dims_intransitively_inconsistent)
{
    ...
    auto param2 = make_shared<op::Parameter>(
        element::Type_t::f32, PartialShape{Dimension::dynamic(), 3, Dimension::dynamic()});
    auto param3 =
        make_shared<op::Parameter>(element::Type_t::f32, PartialShape{3, 3, Dimension::dynamic()});
    try
    {
...
{
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{2, 2, 3});
    auto param1 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
    auto param2 =
        make_shared<op::Parameter>(element::Type_t::f32, PartialShape{2, 3, Dimension::dynamic()});
    auto c = make_shared<op::Concat>(NodeVector{param0, param1, param2}, 1);
...
TEST(type_prop, concat_partial_all_static_with_concat_axis_static_compatible_result_static)
{
    auto param0 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{2, 2, 3});
    auto param1 =
        make_shared<op::Parameter>(element::Type_t::f32, PartialShape{Dimension::dynamic(), 4, 3});
    auto param2 =
        make_shared<op::Parameter>(element::Type_t::f32, PartialShape{2, 3, Dimension::dynamic()});
    auto c = make_shared<op::Concat>(NodeVector{param0, param1, param2}, 1);
...
{
    auto param0 =
        make_shared<op::Parameter>(element::Type_t::f32, PartialShape{2, 2, Dimension::dynamic()});
    auto param1 = make_shared<op::Parameter>(
        element::Type_t::f32, PartialShape{Dimension::dynamic(), 4, Dimension::dynamic()});
    auto param2 =
        make_shared<op::Parameter>(element::Type_t::f32, PartialShape{2, 3, Dimension::dynamic()});
    auto c = make_shared<op::Concat>(NodeVector{param0, param1, param2}, 1);
