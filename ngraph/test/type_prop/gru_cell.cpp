...
TEST(type_prop, gru_cell_dynamic_hidden_size) {
    ...
    const auto gru_cell = make_shared<op::v3::GRUCell>(X, H_t, W, R, 3);
    EXPECT_EQ(gru_cell->get_output_element_type(0), element::f32);
    EXPECT_EQ(gru_cell->get_output_partial_shape(0), (PartialShape{batch_size, hidden_size}));
}
...
TEST(type_prop, gru_cell_dynamic_inputs) {
    ...
    const auto gru_cell = make_shared<op::v3::GRUCell>(X, H_t, W, R, 2);
...
TEST(type_prop, gru_cell_invalid_input_rank0) {
    ...
    ASSERT_THROW(make_shared<op::v3::GRUCell>(X, H_t, W, R, hidden_size), ngraph::NodeValidationFailure)
    ...
    ASSERT_THROW(make_shared<op::v3::GRUCell>(X, H_t, W, R, B, hidden_size), ngraph::NodeValidationFailure)
        << "GRUCell node was created with invalid data.";
}
...
TEST(type_prop, gru_cell_invalid_input_dynamic_rank) {
    ...
    auto check_dynamic_gru = [](const shared_ptr<op::v3::GRUCell>& gru) -> bool {
    ...
    auto gru_w = make_shared<op::v3::GRUCell>(X, H_t, W, R, hidden_size);
    ...
    auto gru_x = make_shared<op::v3::GRUCell>(X, H_t, W, R, hidden_size);
    ...
    auto gru_h = make_shared<op::v3::GRUCell>(X, H_t, W, R, hidden_size);
    ...
    auto gru_r = make_shared<op::v3::GRUCell>(X, H_t, W, R, hidden_size);
    ...
    auto gru_b = make_shared<op::v3::GRUCell>(X, H_t, W, R, B, hidden_size);
