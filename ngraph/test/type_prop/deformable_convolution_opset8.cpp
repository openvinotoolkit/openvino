...
TEST(type_prop,
     deformable_convolution_opset8_partial_auto_padding_same_lower_data_batch_nc_dims_dynamic)
{
...
TEST(type_prop, deformable_convolution_opset8_invalid_et_inputs)
{
    ...
    try
    {
        ...
        auto deformable_conv = make_shared<DeformableConvolution>(
...
TEST(type_prop, deformable_convolution_opset8_invalid_mask_batch_dim)
{
    ...
    {
        EXPECT_HAS_SUBSTRING(error.what(),
                             "Data batch and mask batch dimension must be same value");
    }
    catch (...)
    {
