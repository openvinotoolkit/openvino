...
{
    auto data = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 128});
    auto block_shape =
...
{
    auto data = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 64, 64, 3});
    auto block_shape =
...
{
    auto data = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 32, 64, 128, 256});
    auto block_shape =
...
{
    auto data = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 100, 1024, 3});
    auto block_shape =
