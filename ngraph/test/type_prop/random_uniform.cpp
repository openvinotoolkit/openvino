...
TEST(type_prop, random_uniform_type_shape) {
    auto out_shape = op::Constant::create(element::i64, Shape{4}, {2, 3, 4, 5});
    auto min_val = make_shared<op::Constant>(element::f32, Shape{}, 0.f);
    auto max_val = make_shared<op::Constant>(element::f32, Shape{}, 1.f);
...
TEST(type_prop, random_uniform_dynamic_shape) {
    auto out_shape = make_shared<op::Parameter>(element::i32, PartialShape{Dimension::dynamic()});
    auto min_val = make_shared<op::Constant>(element::i64, Shape{}, 5);
    auto max_val = make_shared<op::Constant>(element::i64, Shape{}, 10);
...
TEST(type_prop, random_uniform_dynamic_rank) {
    auto out_shape = make_shared<op::Parameter>(element::i32, PartialShape::dynamic());
    auto min_val = make_shared<op::Constant>(element::f64, Shape{}, 5);
    auto max_val = make_shared<op::Constant>(element::f64, Shape{}, 10);
...
TEST(type_prop, random_uniform_invalid_out_shape_type) {
    auto out_shape = op::Constant::create(element::f64, Shape{4}, {2, 3, 4, 5});
    auto min_val = make_shared<op::Constant>(element::f32, Shape{}, 0.f);
    auto max_val = make_shared<op::Constant>(element::f32, Shape{}, 1.f);
...
TEST(type_prop, random_uniform_invalid_out_shape_rank) {
    auto out_shape = make_shared<op::Parameter>(element::i32, Shape{3, 2});
    auto min_val = make_shared<op::Constant>(element::f32, Shape{}, 0.f);
    auto max_val = make_shared<op::Constant>(element::f32, Shape{}, 1.f);
    try {
        auto r = make_shared<op::v8::RandomUniform>(out_shape, min_val, max_val, element::f32, 120, 100);
...
TEST(type_prop, random_uniform_invalid_min_val) {
    auto out_shape = op::Constant::create(element::i32, Shape{4}, {2, 3, 4, 5});
    auto min_val = op::Constant::create(element::f32, Shape{2}, {2, 3});
    auto max_val = make_shared<op::Constant>(element::f32, Shape{}, 1.f);
...
TEST(type_prop, random_uniform_invalid_max_val) {
    auto out_shape = op::Constant::create(element::i32, Shape{4}, {2, 3, 4, 5});
    auto min_val = make_shared<op::Constant>(element::f32, Shape{}, 0.f);
    auto max_val = op::Constant::create(element::f32, Shape{3}, {2, 3, 5});
...
TEST(type_prop, random_uniform_invalid_min_max_val_type_case1) {
    auto out_shape = op::Constant::create(element::i64, Shape{4}, {2, 3, 4, 5});
    auto min_val = make_shared<op::Constant>(element::f32, Shape{}, 0.f);
    auto max_val = make_shared<op::Constant>(element::i32, Shape{}, 100);
...
TEST(type_prop, random_uniform_invalid_min_max_val_type_case2) {
    ...
    try {
        auto r = make_shared<op::v8::RandomUniform>(out_shape, min_val, max_val, element::i32, 120, 100);
        // Should have thrown, so fail if it didn't
...
TEST(type_prop, random_uniform_invalid_min_max_values_case1) {
    auto out_shape = op::Constant::create(element::i64, Shape{4}, {2, 3, 4, 5});
    auto min_val = make_shared<op::Constant>(element::f32, Shape{}, 1.f);
    auto max_val = make_shared<op::Constant>(element::f32, Shape{}, 0.f);
...
TEST(type_prop, random_uniform_invalid_min_max_values_case2) {
    auto out_shape = op::Constant::create(element::i64, Shape{4}, {2, 3, 4, 5});
    auto min_val = make_shared<op::Constant>(element::i32, Shape{}, 100);
    auto max_val = make_shared<op::Constant>(element::i32, Shape{}, 100);
...
TEST(type_prop, random_uniform_min_max_1d_tensors) {
    auto out_shape = op::Constant::create(element::i64, Shape{4}, {2, 3, 4, 5});
    auto min_val = op::Constant::create(element::f32, Shape{1}, {-1.0});
    auto max_val = op::Constant::create(element::f32, Shape{1}, {2.0});
