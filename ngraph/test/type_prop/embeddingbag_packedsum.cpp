...
TEST(type_prop, ebps)
{
    ...
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{3, 4});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{3, 4});
...
TEST(type_prop, ebps_dynamic_indices)
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices =
        make_shared<op::v0::Parameter>(element::i64, PartialShape{Dimension::dynamic(), 4});
    auto per_sample_weights =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic(), 4});
...
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices = make_shared<op::v0::Parameter>(element::f32, Shape{3, 4});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{3, 4});
...
TEST(type_prop, ebps_fail_mismatch_element_type)
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{3, 4});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::i64, Shape{3, 4});
...
TEST(type_prop, ebps_fail_mismatch_shape)
{
    auto emb_table = make_shared<op::v0::Parameter>(element::f32, Shape{5, 2});
    auto indices = make_shared<op::v0::Parameter>(element::i64, Shape{3, 4});
    auto per_sample_weights = make_shared<op::v0::Parameter>(element::f32, Shape{4, 3});
