...
TEST(type_prop, dot_deduce_scalar_2d)
{
    ...
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{4, 5});
    auto bc = make_shared<op::v0::Dot>(param1, param2);
...
TEST(type_prop, dot_deduce_2d_scalar)
{
    ...
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{4, 5});
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{});
    auto bc = make_shared<op::v0::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
    ASSERT_EQ(bc->get_shape(), (Shape{4, 5}));
}
...
TEST(type_prop, dot_deduce_scalar_1d)
{
    ...
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{});
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{6});
    auto bc = make_shared<op::v0::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
...
TEST(type_prop, dot_deduce_1d)
{
    ...
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{4});
    auto bc = make_shared<op::v0::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
    ASSERT_EQ(bc->get_shape(), (Shape{}));
}
...
TEST(type_prop, dot_deduce_2d)
{
    ...
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{4, 2});
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 3});
    auto bc = make_shared<op::v0::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
...
TEST(type_prop, dot_deduce_different_rank)
{
    ...
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 8, 4, 2});
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{2, 1, 3});
    auto bc = make_shared<op::v0::Dot>(param1, param2);
    ASSERT_EQ(bc->get_element_type(), element::f32);
...
TEST(type_prop, dot_deduce_element_type_mismatch)
{
    ...
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{4, 2});
    auto param2 = make_shared<op::v0::Parameter>(element::i32, Shape{2, 5});
    try
    {
        auto bc = make_shared<op::v0::Dot>(param1, param2);
...
TEST(type_prop, dot_deduce_reduction_axes_size_mismatch)
{
    ...
    auto param1 = make_shared<op::v0::Parameter>(element::f32, Shape{4, 2});
    auto param2 = make_shared<op::v0::Parameter>(element::f32, Shape{3, 5});
    try
    {
        auto bc = make_shared<op::v0::Dot>(param1, param2);
        // Should have thrown, so fail if it didn't
...
TEST(type_prop, dot_partial_both_rank_dynamic_axis_count_implicit)
{
    ...
    auto d = make_shared<op::v0::Dot>(param0, param1);
...
TEST(type_prop, dot_partial_both_rank_dynamic_axis_count_explicit)
{
    auto param0 = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    auto param1 = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    auto d = make_shared<op::v0::Dot>(param0, param1, /*reduction axis count=*/1234);
...
TEST(type_prop, dot_partial_left_rank_dynamic_right_rank_static_dynamic_axis_count_explicit_ok)
{
    ...
    auto param1 =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic(), 2, 3});
    auto d = make_shared<op::v0::Dot>(param0, param1, /* reduction axis count=*/3);
     ...
     dot_partial_left_rank_dynamic_right_rank_static_dynamic_axis_count_explicit_too_many)
{
    ...
    try
    {
        auto d = make_shared<op::v0::Dot>(param0, param1, /* reduction axis count=*/4);
        FAIL()
...
{
    auto param0 =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic(), 2, 2});
...
{
    auto param0 = make_shared<op::v0::Parameter>(element::f32, PartialShape{});
    auto param1 = make_shared<op::v0::Parameter>(
        element::f32, PartialShape{2, Dimension::dynamic(), 4, Dimension::dynamic(), 5});
    auto d = make_shared<op::v0::Dot>(param0, param1);
    ...
    dot_partial_left_rank_static_dynamic_right_rank_static_dynamic_axis_count_explicit_too_many_for_left)
{
    auto param0 =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic(), 2, 3});
    auto param1 = make_shared<op::v0::Parameter>(element::f32,
                                                 PartialShape{Dimension::dynamic(), 2, 3, 5, 6});
    try
    {
        auto d = make_shared<op::v0::Dot>(param0, param1, /* reduction axis count=*/4);
...
{
    auto param0 = make_shared<op::v0::Parameter>(element::f32,
                                                 PartialShape{Dimension::dynamic(), 2, 3, 5, 6});
    auto param1 =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic(), 2, 3});
    try
