...
TEST(type_prop, add_bad_arguments)
{
    test_binary("Add",
                [](const shared_ptr<Node>& x, const shared_ptr<Node>& y) -> shared_ptr<Node> {
                    return make_shared<op::v0::Add>(x, y);
                });
}
...
TEST(type_prop, divide_bad_arguments)
{
    test_binary("Divide",
                [](const shared_ptr<Node>& x, const shared_ptr<Node>& y) -> shared_ptr<Node> {
                    return make_shared<op::v0::Divide>(x, y);
                });
}
...
TEST(type_prop, multiply_bad_arguments)
{
    test_binary("Multiply",
                [](const shared_ptr<Node>& x, const shared_ptr<Node>& y) -> shared_ptr<Node> {
                    return make_shared<op::v0::Multiply>(x, y);
                });
}
...
TEST(type_prop, subtract_bad_arguments)
{
    test_binary("Subtract",
                [](const shared_ptr<Node>& x, const shared_ptr<Node>& y) -> shared_ptr<Node> {
                    return make_shared<op::v0::Subtract>(x, y);
                });
}
...
TEST(type_prop, or_bad_arguments)
{
    test_binary_logical(
        "Or", [](const shared_ptr<Node>& x, const shared_ptr<Node>& y) -> shared_ptr<Node> {
            return make_shared<op::v0::Or>(x, y);
        });
}
...
TEST(type_prop, xor_bad_arguments)
{
    test_binary_logical(
        "Xor", [](const shared_ptr<Node>& x, const shared_ptr<Node>& y) -> shared_ptr<Node> {
            return make_shared<op::v0::Xor>(x, y);
        });
}
...
TEST(type_prop, eltwise_auto_bcast)
{
    ...
    test_binary_eltwise_numpy<op::v0::Divide>(element::f32, op::AutoBroadcastType::NUMPY);
    ...
    test_binary_eltwise_numpy<op::v0::Multiply>(element::f32, op::AutoBroadcastType::NUMPY);
    test_binary_eltwise_numpy<op::v0::NotEqual>(element::f32, op::AutoBroadcastType::NUMPY);
    test_binary_eltwise_numpy<op::v0::Or>(element::boolean, op::AutoBroadcastType::NUMPY);
    test_binary_eltwise_numpy<op::v0::Power>(element::f32, op::AutoBroadcastType::NUMPY);
    test_binary_eltwise_numpy<op::v0::Subtract>(element::f32, op::AutoBroadcastType::NUMPY);
    test_binary_eltwise_numpy<op::v0::Xor>(element::boolean, op::AutoBroadcastType::NUMPY);
}
...
TEST(type_prop, binary_arithmetic_bad_argument_element_types)
{
    ...
    try
    {
        auto bc = make_shared<op::v0::Add>(tv0_2_4_param_0, tv0_2_4_param_1);
        // Should have thrown, so fail if it didn't
...
TEST(type_prop, binary_elementwise_arithmetic_both_dynamic)
{
    ...
    auto add = make_shared<op::v0::Add>(a, b);
...
TEST(type_prop, logic_arith_compare_partial_et)
{
    auto test_arith = [](element::Type et0, element::Type et1) -> std::shared_ptr<Node> {
        ...
        return std::make_shared<op::v0::Add>(param0, param1);
    };
    ...
    auto test_not = [](element::Type et) -> std::shared_ptr<Node> {
        ...
        return std::make_shared<op::v0::Not>(param);
    };
