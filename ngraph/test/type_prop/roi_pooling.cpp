...
TEST(type_prop, roi_pooling_dynamic_channels_dim)
{
    const auto feat_maps =
        make_shared<op::Parameter>(element::Type_t::f32, PartialShape{1, Dimension(), 6, 6});
    const auto rois = make_shared<op::Parameter>(element::Type_t::f32, Shape{4, 5});
...
{
    const auto feat_maps = make_shared<op::Parameter>(element::Type_t::f32, Shape{1, 3, 6, 6});
    const auto rois = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
    const auto op = make_shared<op::v0::ROIPooling>(feat_maps, rois, Shape{2, 2}, 0.625f);
    ASSERT_TRUE(op->get_output_partial_shape(0).same_scheme(PartialShape{Dimension(), 3, 2, 2}));
}
...
{
    const auto feat_maps = make_shared<op::Parameter>(element::Type_t::f32, Shape{1, 3, 2, 6, 6});
    const auto rois = make_shared<op::Parameter>(element::Type_t::f32, Shape{3, 5});
...
TEST(type_prop, roi_pooling_incompatible_pooling_shape)
{
    ...
    const auto feat_maps = make_shared<op::Parameter>(element::Type_t::f32, Shape{3, 2, 6, 6});
    const auto rois = make_shared<op::Parameter>(element::Type_t::f32, Shape{3, 5});
...
{
    const auto feat_maps = make_shared<op::Parameter>(element::Type_t::f32, Shape{3, 2, 6, 6});
    const auto rois = make_shared<op::Parameter>(element::Type_t::f32, Shape{3, 4});
...
{
    const auto feat_maps = make_shared<op::Parameter>(element::Type_t::i32, Shape{3, 2, 6, 6});
    const auto rois = make_shared<op::Parameter>(element::Type_t::f32, Shape{3, 5});
...
{
    const auto feat_maps = make_shared<op::Parameter>(element::Type_t::f32, Shape{3, 2, 6, 6});
    const auto rois = make_shared<op::Parameter>(element::Type_t::f16, Shape{3, 5});
