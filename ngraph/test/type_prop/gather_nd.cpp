...
TEST(type_prop, gather_nd_slices_from_4d_batch_dims0)
{
    ...
    auto P = make_shared<op::Parameter>(element::Type_t::f32, params_shape);
    auto I = make_shared<op::Parameter>(element::Type_t::i32, indices_shape);
    auto G5 = make_shared<op::v5::GatherND>(P, I, 0);
    ASSERT_EQ(G5->get_element_type(), element::Type_t::f32);
...
TEST(type_prop, gather_nd_fail_indices_element_type)
{
    ...
    Shape out_shape{2, 1, 2, 2};
    auto P = make_shared<op::Parameter>(element::Type_t::f32, params_shape);
    auto I = make_shared<op::Parameter>(element::Type_t::f32, indices_shape);
