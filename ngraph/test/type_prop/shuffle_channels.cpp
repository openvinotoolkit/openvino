...
TEST(type_prop, shuffle_channels_axis_validation)
{
    try
    {
        const auto data = make_shared<op::v0::Parameter>(element::f64, Shape{1, 2, 3, 4});
...
TEST(type_prop, shuffle_channels_invalid_input_shape)
{
    try
    {
        const auto data = make_shared<op::v0::Parameter>(element::f64, Shape{});
...
TEST(type_prop, shuffle_channels_invalid_groups_value)
{
    try
    {
        const auto data = make_shared<op::v0::Parameter>(element::f64, Shape{1, 2, 3, 15});
