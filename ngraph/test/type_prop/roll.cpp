...
TEST(type_prop, roll_dynamic_shape) {
    auto arg = make_shared<op::Parameter>(element::f32, PartialShape{Dimension::dynamic(), Dimension::dynamic()});
...
TEST(type_prop, roll_dynamic_ranks) {
    ...
    auto shift = make_shared<op::Parameter>(element::i64, PartialShape::dynamic());
    auto axes = make_shared<op::Parameter>(element::i32, PartialShape::dynamic());
...
TEST(type_prop, roll_dynamic_axes_static_shift) {
    auto arg = make_shared<op::Parameter>(element::i32, Shape{3, 3, 4, 2});
    auto shift = op::Constant::create(element::i64, Shape{}, {5});
    auto axes = make_shared<op::Parameter>(element::i32, PartialShape{Dimension::dynamic()});
...
TEST(type_prop, roll_scatic_axes_dynamic_shift) {
    auto arg = make_shared<op::Parameter>(element::i32, Shape{1, 2, 4});
    auto shift = make_shared<op::Parameter>(element::i64, PartialShape{Dimension::dynamic()});
    auto axes = make_shared<op::Parameter>(element::i32, Shape{3});
