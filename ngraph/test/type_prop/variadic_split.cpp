...
TEST(type_prop, variadic_split)
{
    ...
    const auto axis = op::v0::Constant::create<int64_t>(element::i64, Shape{}, {1});
    const auto splits = op::v0::Constant::create<int64_t>(element::i64, Shape{2}, {2, 4});
    ...
    EXPECT_EQ(make_shared<op::v1::VariadicSplit>(
                  make_shared<op::v0::Parameter>(element::i32, Shape{12, 6}),
                  op::v0::Constant::create<int64_t>(element::i64, Shape{}, {-2}),
                  op::v0::Constant::create<int64_t>(element::i64, Shape{3}, {7, -1, 2}))
                  ->output(1)
                  .get_shape(),
              (Shape{3, 6}));
    ...
    EXPECT_EQ(make_shared<op::v1::VariadicSplit>(
                  make_shared<op::v0::Parameter>(element::i32, Shape{12, 6}),
                  op::v0::Constant::create<int64_t>(element::i64, Shape{}, {-2}),
                  op::v0::Constant::create<int64_t>(element::i64, Shape{3}, {-1, 7, 2}))
                  ->output(0)
                  .get_shape(),
              (Shape{3, 6}));

    EXPECT_EQ(make_shared<op::v1::VariadicSplit>(
                  make_shared<op::v0::Parameter>(element::i32, Shape{12, 1, 6}),
                  op::v0::Constant::create<int64_t>(element::i64, Shape{1}, {2}),
                  op::v0::Constant::create<int64_t>(element::i64, Shape{3}, {3, 1, 2}))
                  ->output(2)
                  .get_shape(),
              (Shape{12, 1, 2}));
    ...
    EXPECT_EQ(make_shared<op::v1::VariadicSplit>(
                  make_shared<op::v0::Parameter>(element::i32, Shape{12, 6}),
                  op::v0::Constant::create<int64_t>(element::i64, Shape{1}, {1}),
                  op::v0::Constant::create<int64_t>(element::i64, Shape{2}, {6, 0}))
                  ->output(1)
                  .get_shape(),
              (Shape{12, 0}));
}
...
TEST(type_prop, variadic_split_splits_rank)
{
    ...
    {
        const auto axis = op::v0::Constant::create<int64_t>(element::i64, Shape{}, {1});
        const auto splits = op::v0::Constant::create<int64_t>(element::i64, Shape{1, 2}, {2, 4});
        const auto split = make_shared<op::v1::VariadicSplit>(data, axis, splits);
...
TEST(type_prop, variadic_split_incorrect_sum)
{
    ...
    {
        const auto axis = op::v0::Constant::create<int64_t>(element::i64, Shape{}, {1});
        const auto splits = op::v0::Constant::create<int64_t>(element::i64, Shape{2}, {1, 6});
        const auto split = make_shared<op::v1::VariadicSplit>(data, axis, splits);
        FAIL() << "Split node was created with incorrect data.";
    }
    catch (const NodeValidationFailure& error)
...
TEST(type_prop, variadic_split_incorrect_axis)
{
    ...
    try
    {
        const auto axis = op::v0::Constant::create<int64_t>(element::i64, Shape{}, {-5});
        const auto splits = op::v0::Constant::create<int64_t>(element::i64, Shape{2}, {2, 4});
        const auto split = make_shared<op::v1::VariadicSplit>(data, axis, splits);
        FAIL() << "Split node was created with incorrect data.";
    }
...
TEST(type_prop, variadic_split_splits_multiple_negatives)
{
    ...
    {
        const auto axis = op::v0::Constant::create<int64_t>(element::i64, Shape{}, {1});
        const auto splits = op::v0::Constant::create<int64_t>(element::i64, Shape{3}, {-1, -1, 3});
        const auto split = make_shared<op::v1::VariadicSplit>(data, axis, splits);
        FAIL() << "Split node was created with incorrect data.";
    }
    catch (const NodeValidationFailure& error)
...
TEST(type_prop, variadic_split_shape_partially_dynamic)
{
    ...
    auto var_split1 = make_shared<op::v1::VariadicSplit>(
        make_shared<op::v0::Parameter>(element::i32, PartialShape{12, Dimension()}),
        op::v0::Constant::create<int64_t>(element::i64, Shape{}, {-2}),
        op::v0::Constant::create<int64_t>(element::i64, Shape{3}, {7, -1, 2}));
    ...
    auto var_split2 = make_shared<op::v1::VariadicSplit>(
        make_shared<op::v0::Parameter>(element::i32, PartialShape{Dimension(), Dimension(), 6}),
        op::v0::Constant::create<int64_t>(element::i64, Shape{}, {2}),
        op::v0::Constant::create<int64_t>(element::i64, Shape{3}, {3, 1, 2}));
    ...
    auto var_split3 = make_shared<op::v1::VariadicSplit>(
        make_shared<op::v0::Parameter>(element::i32, PartialShape{Dimension(), 6}),
        op::v0::Constant::create<int64_t>(element::i64, Shape{}, {1}),
        op::v0::Constant::create<int64_t>(element::i64, Shape{2}, {6, 0}));
