...
namespace
{
                        ...
                        const Shape& shape2 = {1, 3, 6})
    {
        ...
        try
        {
            auto logical_or = make_shared<op::v1::LogicalOr>(input1, input2);
        }
...
TEST(type_prop, logical_or_incorrect_type_f32)
{
    incorrect_init(
        element::f32,
...
TEST(type_prop, logical_or_incorrect_type_f64)
{
    incorrect_init(
        element::f64,
...
TEST(type_prop, logical_or_incorrect_type_i32)
{
    incorrect_init(
        element::i32,
...
TEST(type_prop, logical_or_incorrect_type_i64)
{
    incorrect_init(
        element::i64,
...
TEST(type_prop, logical_or_incorrect_type_u32)
{
    incorrect_init(
        element::u32,
...
TEST(type_prop, logical_or_incorrect_type_u64)
{
    incorrect_init(
        element::u64,
...
TEST(type_prop, logical_or_incorrect_shape)
{
    incorrect_init(
        element::boolean, "Argument shapes are inconsistent", Shape{1, 3, 6}, Shape{1, 2, 3});
}

TEST(type_prop, logical_or_broadcast)
{
    ...
    auto logical_and = make_shared<op::v1::LogicalOr>(input1, input2);
