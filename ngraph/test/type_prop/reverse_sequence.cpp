...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, Shape{4, 3, 2});
    auto seq_lenghts = make_shared<op::v0::Parameter>(element::f32, Shape{4, 4});
    try
    {
        size_t batch_axis = 0;
        size_t seq_axis = 1;
        auto bc = make_shared<op::v0::ReverseSequence>(data, seq_lenghts, batch_axis, seq_axis);
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, Shape{4, 3, 2});
    auto seq_lenghts = make_shared<op::v0::Parameter>(element::f32, Shape{3});
    try
    {
        size_t batch_axis = 3;
        size_t seq_axis = 1;
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, Shape{4, 3, 2});
    auto seq_lengths = make_shared<op::v0::Parameter>(element::f32, Shape{3});
    try
    {
        size_t batch_axis = 1;
        size_t seq_axis = 3;
        auto bc = make_shared<op::v0::ReverseSequence>(data, seq_lengths, batch_axis, seq_axis);
...
TEST(type_prop, reverse_sequence_partial_both_rank_dynamic)
{
    ...
    auto seq_lengths = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    // Unrealistic values, but they don't matter here.
    size_t batch_axis = 202;
    size_t seq_axis = 909;
    auto rs = make_shared<op::v0::ReverseSequence>(data, seq_lengths, batch_axis, seq_axis);
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    auto seq_lengths = make_shared<op::v0::Parameter>(element::f32, PartialShape{3});
    // Unrealistic values, but they don't matter here.
    size_t batch_axis = 202;
    size_t seq_axis = 909;
    auto rs = make_shared<op::v0::ReverseSequence>(data, seq_lengths, batch_axis, seq_axis);
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{2, 4, 6, 8});
    auto seq_lengths = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    size_t batch_axis = 0;
    size_t seq_axis = 1;
    auto rs = make_shared<op::v0::ReverseSequence>(data, seq_lengths, batch_axis, seq_axis);
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32,
...
TEST(type_prop, reverse_sequence_partial_both_rank_static_dynamic_batch_axis_oob)
{
    auto data = make_shared<op::v0::Parameter>(element::f32,
                                               PartialShape{Dimension::dynamic(),
                                                            ...
                                                            Dimension::dynamic()});
    auto seq_lengths =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic()});
    size_t batch_axis = 4;
    size_t seq_axis = 1;
    try
    {
...
{
    auto data = make_shared<op::v0::Parameter>(
        element::f32,
        PartialShape{Dimension::dynamic(), Dimension::dynamic(), 3, Dimension::dynamic()});
    auto seq_lengths =
        make_shared<op::v0::Parameter>(element::f32, PartialShape{Dimension::dynamic()});
    ...
    reverse_sequence_partial_left_rank_static_dynamic_right_static_left_seq_length_static_inconsistent)
{
    auto data = make_shared<op::v0::Parameter>(
        element::f32,
        PartialShape{Dimension::dynamic(), Dimension::dynamic(), 3, Dimension::dynamic()});
    auto seq_lengths = make_shared<op::v0::Parameter>(element::f32, PartialShape{4});
    size_t batch_axis = 2;
    size_t seq_axis = 1;
    try
    {
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
    auto seq_lengths = make_shared<op::v0::Parameter>(element::f32, PartialShape{1});
...
{
    auto data = make_shared<op::v0::Parameter>(element::f32, PartialShape{1, 2, 3, 4, 5});
    auto seq_lengths = make_shared<op::v0::Parameter>(element::f32, PartialShape{3});
