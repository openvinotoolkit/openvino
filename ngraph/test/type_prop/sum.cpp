...
TEST(type_prop, sum_axis_oob)
{
    ...
    try
    {
        auto r = make_shared<op::v0::Sum>(param_0, AxisSet{0, 2, 1});
...
TEST(type_prop, sum_dynamic_axes)
{
    ...
    auto summation_axes = make_shared<op::v0::Parameter>(element::i64, Shape{2});
    auto sum = make_shared<op::v0::Sum>(param, summation_axes);
...
{
    auto param = make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic());
...
{
    auto param = make_shared<op::v0::Parameter>(element::f32,
...
TEST(type_prop, sum_partial_negative_axes)
{
    auto param = make_shared<op::v0::Parameter>(element::f32,
                                                PartialShape{1, 2, Dimension::dynamic(), 4, 5});
    auto summation_axes = op::v0::Constant::create(element::i64, Shape{2}, {-3, -2});
    auto sum = make_shared<op::v0::Sum>(param, summation_axes);
