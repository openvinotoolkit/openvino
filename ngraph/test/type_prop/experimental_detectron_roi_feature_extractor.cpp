...
TEST(type_prop, detectron_roi_feature_extractor_intervals_1)
{
    ...
    for (const auto& s : shapes)
    {
        ...
        auto layer0_shape = PartialShape{first_dims[0], layer0_channels, 200, 336};
        auto layer1_shape = PartialShape{first_dims[1], layer1_channels, 100, 168};
        auto layer2_shape = PartialShape{first_dims[2], layer2_channels, 50, 84};
        auto layer3_shape = PartialShape{first_dims[3], layer3_channels, 25, 42};
