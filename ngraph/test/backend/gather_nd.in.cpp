...
//-----v8-----
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_single_indices) {
    Shape params_shape{3, 3};
    Shape indices_shape{2};
    Shape out_shape{};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
    auto I = make_shared<op::Parameter>(element::i32, indices_shape);
    auto G = make_shared<op::v8::GatherND>(P, I);
    auto f = make_shared<Function>(G, ParameterVector{P, I});
    ...
    auto G5 = make_shared<op::v8::GatherND>(P, I);
    auto f5 = make_shared<Function>(G5, ParameterVector{P, I});
    auto c5 = backend->compile(f5);
    c5->call_with_validate({result}, {p, i});
    EXPECT_TRUE(test::all_close_f((vector<float>{1.5f}), read_vector<float>(result), MIN_FLOAT_TOLERANCE_BITS));
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_scalar_from_2d) {
    Shape params_shape{2, 2};
    Shape indices_shape{2, 2};
    Shape out_shape{2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_1d_from_2d) {
    Shape params_shape{2, 2};
    Shape indices_shape{2, 1};
    Shape out_shape{2, 2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_scalar_from_3d) {
    Shape params_shape{2, 2, 2};
    Shape indices_shape{2, 3};
    Shape out_shape{2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_1d_from_3d) {
    Shape params_shape{2, 2, 2};
    Shape indices_shape{2, 2};
    Shape out_shape{2, 2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_2d_from_3d) {
    Shape params_shape{2, 2, 2};
    Shape indices_shape{1, 1};
    Shape out_shape{1, 2, 2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_scalar_from_2d) {
    Shape params_shape{2, 2};
    Shape indices_shape{2, 1, 2};
    Shape out_shape{2, 1};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_1d_from_2d) {
    Shape params_shape{2, 2};
    Shape indices_shape{2, 1, 1};
    Shape out_shape{2, 1, 2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_scalar_from_3d) {
    Shape params_shape{2, 2, 2};
    Shape indices_shape{2, 2, 3};
    Shape out_shape{2, 2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_1d_from_3d) {
    Shape params_shape{2, 2, 2};
    Shape indices_shape{2, 2, 2};
    Shape out_shape{2, 2, 2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_1d_from_3d_negative) {
    Shape params_shape{2, 2, 2};
    Shape indices_shape{2, 2, 2};
    Shape out_shape{2, 2, 2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_2d_from_3d) {
    Shape params_shape{2, 2, 2};
    Shape indices_shape{2, 1, 1};
    Shape out_shape{2, 1, 2, 2};
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_dims1) {
    Shape params_shape{2, 3, 4};
    Shape indices_shape{2, 1};
    Shape out_shape{2, 4};
    int batch_dims = 1;
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_dims2) {
    Shape params_shape{2, 3, 4, 2};
    Shape indices_shape{2, 3, 3, 2};
...
NGRAPH_TEST(${BACKEND_NAME}, gather_nd_v8_batch_dims2_lead_dims) {
    Shape params_shape{2, 3, 4};
    Shape indices_shape{2, 3, 1, 1};
    Shape out_shape{2, 3, 1};
    int batch_dims = 2;
    auto P = make_shared<op::Parameter>(element::f32, params_shape);
    auto I = make_shared<op::Parameter>(element::i32, indices_shape);
    auto G = make_shared<op::v8::GatherND>(P, I, batch_dims);
