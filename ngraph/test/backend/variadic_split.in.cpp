...
NGRAPH_TEST(${BACKEND_NAME}, variadic_split_2d_axis_0)
{
...
NGRAPH_TEST(${BACKEND_NAME}, variadic_split_2d_axis_1)
{
...
NGRAPH_TEST(${BACKEND_NAME}, variadic_split_4d_axis_0)
{
...
NGRAPH_TEST(${BACKEND_NAME}, variadic_split_4d_axis_1)
{
...
NGRAPH_TEST(${BACKEND_NAME}, variadic_split_4d_axis_2)
{
...
NGRAPH_TEST(${BACKEND_NAME}, variadic_split_4d_axis_3)
{
