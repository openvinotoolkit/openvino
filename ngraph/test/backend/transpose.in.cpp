...
NGRAPH_TEST(${BACKEND_NAME}, transpose_axes_constant)
{
    ...
    auto function =
        make_shared<ngraph::Function>(NodeVector{transpose}, ParameterVector{data_param});
...
NGRAPH_TEST(${BACKEND_NAME}, transpose_axes_parameter_static_shapes)
{
    ...
    auto function = make_shared<ngraph::Function>(NodeVector{transpose},
                                                  ParameterVector{data_param, axes_param});
