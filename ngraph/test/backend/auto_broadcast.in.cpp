...
NGRAPH_TEST(${BACKEND_NAME}, auto_bcast_binary_elementwise_pdpd_dynamic)
{
    ...
    auto f = make_shared<Function>(make_shared<op::v0::Add>(a, b, autob), ParameterVector{a, b});
    ...
    f = make_shared<Function>(make_shared<op::v0::Add>(a, b, autob), ParameterVector{a, b});
