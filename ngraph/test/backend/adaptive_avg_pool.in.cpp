...
NGRAPH_TEST(${BACKEND_NAME}, adaptive_avg_pool_2d) {
    ...
    std::vector<float> expected_result{-1.08333337, -0.25000000, -0.91666669, -0.08333334, -0.66666669,
...
NGRAPH_TEST(${BACKEND_NAME}, adaptive_avg_pool_3d) {
    ...
    std::vector<float> expected_result{-0.750, -0.250, -1.375, -1.125, -1.125, -0.500, -0.875, -1.250,
