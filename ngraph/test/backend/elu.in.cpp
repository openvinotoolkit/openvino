...
{
    auto t = test::make_unary_test<TestEngine, op::Elu, element::f32>(Shape{3, 2}, 0.5f);

    t.test({-2.f, 3.f, -2.f, 1.f, -1.f, 0.f},
           {-0.432332358f, 3.f, -0.432332358f, 1.f, -0.316060279f, 0.f});
}

NGRAPH_TEST(${BACKEND_NAME}, elu_negative_alpha)
{
    auto t = test::make_unary_test<TestEngine, op::Elu, element::f32>(Shape{3, 2}, -1.f);
