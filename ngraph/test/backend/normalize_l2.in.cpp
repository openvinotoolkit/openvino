...
NGRAPH_TEST(${BACKEND_NAME}, normalize_l2_across_123_4d_add)
{
    ...
    auto eps_mode = ngraph::op::EpsMode::ADD;
    std::vector<float> expected_output{
        0.01428571f, 0.02857143f, 0.04285714f, 0.05714286f, 0.07142857f, 0.08571429f,
...
NGRAPH_TEST(${BACKEND_NAME}, normalize_l2_across_1_4d_add)
{
    ...
    auto eps_mode = ngraph::op::EpsMode::ADD;
    std::vector<float> expected_output{
        0.0766965f,  0.14142136f, 0.19611613f, 0.24253564f, 0.28216633f, 0.31622776f,
...
NGRAPH_TEST(${BACKEND_NAME}, normalize_l2_across_123_5d_add)
{
    ...
    float eps = 1e-6f;
    auto eps_mode = ngraph::op::EpsMode::ADD;
    std::vector<float> expected_output{0.026389, 0.0495682, 0.070014, 0.105556, 0.12392,  0.140028,
                                       0.184723, 0.198273,  0.210042, 0.26389,  0.272625, 0.280056,
                                       0.343057, 0.346977,  0.35007,  0.422224, 0.421329, 0.420084,
                                       0.501391, 0.495682,  0.490098, 0.580558, 0.570034, 0.560112};
...
NGRAPH_TEST(${BACKEND_NAME}, normalize_l2_across_123_4d_max_test)
{
    ...
    auto eps_mode = ngraph::op::EpsMode::MAX;
    std::vector<float> expected_output{
        0.0142857, 0.0285714, 0.0428571, 0.0571429, 0.0714286, 0.0857143, 0.1,      0.114286,
        0.128571,  0.142857,  0.157143,  0.171429,  0.185714,  0.2,       0.214286, 0.228571,
        0.242857,  0.257143,  0.271429,  0.285714,  0.3,       0.314286,  0.328571, 0.342857};
...
NGRAPH_TEST(${BACKEND_NAME}, normalize_l2_across_1_4d_max_test)
{
    ...
    auto eps_mode = ngraph::op::EpsMode::MAX;
    std::vector<float> expected_output{
        0.0766965, 0.141421, 0.196116, 0.242536, 0.282166, 0.316228, 0.345705, 0.371391,
        0.393919,  0.413803, 0.431455, 0.447214, 0.997055, 0.98995,  0.980581, 0.970143,
