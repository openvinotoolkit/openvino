...
{
    HostTensor c(element::Type_t::f32, Shape{});
...
TEST(eval, max_eval_reduce_min)
{
    auto concat = make_shared<op::v0::Convert>(
        make_shared<op::v0::Concat>(
            OutputVector{make_shared<op::v0::Parameter>(element::Type_t::i64, Shape{4}),
                         make_shared<op::v0::Constant>(element::Type_t::i64, Shape{4}, 37)},
            0),
        element::Type_t::i32);
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{-1, -1});
...
{
    auto p_start = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{});
    auto p_stop = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{});
    auto p_step = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{});
    auto p1 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{});
    ...
    EXPECT_EQ(result_tensor->get_element_type(), element::Type_t::f32);
...
TEST(eval, interpret_dynamic_range_sum)
{
    ...
    auto p_start_val = backend->create_tensor(element::Type_t::f32, Shape{});
    copy_data(p_start_val, vector<float>{1.0f});
    auto p_stop_val = backend->create_tensor(element::Type_t::f32, Shape{});
    copy_data(p_stop_val, vector<float>{10.0f});
    auto p_step_val = backend->create_tensor(element::Type_t::f32, Shape{});
    copy_data(p_step_val, vector<float>{3.0f});
    auto p1_val = backend->create_tensor(element::Type_t::f32, Shape{});
...
TEST(eval, evaluate_broadcast_v3_bidirectional)
{
    ...
    auto target_shape = op::Constant::create<int32_t>(element::Type_t::i32, Shape{3}, {2, 1, 4});
    auto bcast_v3 =
...
TEST(eval, evaluate_broadcast_v3_bidirectional_target_rank_smaller_than_input)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape_a);
    auto target_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{4}, {1, 3, 1, 1});
    auto bcast_v3 =
        make_shared<op::v3::Broadcast>(A, target_shape, op::BroadcastType::BIDIRECTIONAL);
    auto fun = make_shared<Function>(OutputVector{bcast_v3}, ParameterVector{A});
...
TEST(eval, evaluate_broadcast_v3_bidirectional_target_rank_smaller_than_input_2)
{
    Shape shape_a{1, 3, 1};
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape_a);
    auto target_shape = op::Constant::create<int32_t>(element::Type_t::i32, Shape{2}, {3, 1});
    auto bcast_v3 =
        make_shared<op::v3::Broadcast>(A, target_shape, op::BroadcastType::BIDIRECTIONAL);
    auto fun = make_shared<Function>(OutputVector{bcast_v3}, ParameterVector{A});
...
TEST(eval, evaluate_broadcast_v3_bidirectional_dyn)
{
    ...
    auto target_shape = make_shared<op::Parameter>(element::Type_t::i32, Shape{3});
    auto bcast_v3 =
        make_shared<op::v3::Broadcast>(A, target_shape, op::BroadcastType::BIDIRECTIONAL);
...
TEST(eval, evaluate_broadcast_v3_numpy)
{
    Shape shape_a{3, 1};
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape_a);
    auto target_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{3}, {2, 3, 6});
...
TEST(eval, evaluate_broadcast_v3_numpy_vs_bidi)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, in_shape);
    auto target_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{3}, {1, 4, 4});
    ...
    auto target_shape2 = op::Constant::create<int64_t>(element::Type_t::i64, Shape{2}, {1, 4});
    auto bcast_v3 =
    ...
    EXPECT_EQ(result2->get_element_type(), element::Type_t::f32);
...
TEST(eval, evaluate_broadcast_v3_bidi_3d)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, in_shape);
    auto target_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{3}, {1, 1, 3});
    auto bcast_v3_num =
        make_shared<op::v3::Broadcast>(A, target_shape, op::BroadcastType::BIDIRECTIONAL);
    auto fun_num = make_shared<Function>(OutputVector{bcast_v3_num}, ParameterVector{A});
...
TEST(eval, evaluate_broadcast_v3_bidi_4d)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, in_shape);
    auto target_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{4}, {1, 1, 2, 2});
    auto bcast_v3 =
        make_shared<op::v3::Broadcast>(A, target_shape, op::BroadcastType::BIDIRECTIONAL);
    auto fun = make_shared<Function>(OutputVector{bcast_v3}, ParameterVector{A});
...
TEST(eval, evaluate_broadcast_v1_numpy_dyn)
{
    Shape shape_a{3, 1};
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape_a);
    auto target_shape = make_shared<op::Parameter>(element::Type_t::i64, Shape{3});
    auto bcast_v3 = make_shared<op::v1::Broadcast>(A, target_shape);
    auto fun = make_shared<Function>(OutputVector{bcast_v3}, ParameterVector{A, target_shape});
...
TEST(eval, evaluate_broadcast_v1_explicit)
{
    Shape shape_a{3, 1};
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape_a);
    auto target_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{3}, {2, 3, 1});
    auto axes_mapping = op::Constant::create<int32_t>(element::Type_t::i32, Shape{2}, {1, 2});
    auto bcast_v3 = make_shared<op::v1::Broadcast>(
...
TEST(eval, evaluate_broadcast_v1_explicit_dyn)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape_a);
    auto target_shape = make_shared<op::Parameter>(element::Type_t::i64, Shape{3});
    auto axes_mapping = make_shared<op::Parameter>(element::Type_t::i32, Shape{2});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{2, 3});
    auto p2 = make_shared<op::Parameter>(element::Type_t::f64, PartialShape{2, 2});
    ...
    EXPECT_EQ(result2->get_element_type(), element::Type_t::f64);
...
{
    auto data = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 5});
    auto pattern = make_shared<op::Parameter>(element::Type_t::i64, Shape{2});
...
{
    auto data = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2, 2, 2});
    auto pattern = make_shared<op::Parameter>(element::Type_t::i64, Shape{6});
...
{
    auto data = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2, 2, 2});
    auto pattern = make_shared<op::Parameter>(element::Type_t::i16, Shape{6});
    auto dyn_reshape = make_shared<op::v1::Reshape>(data, pattern, true);
    auto func = make_shared<Function>(OutputVector{dyn_reshape}, ParameterVector{data, pattern});
    auto result_tensor = make_shared<HostTensor>();
    ASSERT_TRUE(
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, PartialShape{-1, -1});
    auto convert = make_shared<op::v0::Convert>(p, element::Type_t::i64);
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::i32, Shape{2, 2});
    auto floor = make_shared<op::Floor>(p);
    auto fun = make_shared<Function>(OutputVector{floor}, ParameterVector{p});
    auto result = make_shared<HostTensor>();
    ASSERT_TRUE(fun->evaluate({result},
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2, 2});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 5});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::i32, Shape{2, 5});
    auto negate = make_shared<op::Negative>(p);
    auto fun = make_shared<Function>(OutputVector{negate}, ParameterVector{p});
    auto result = make_shared<HostTensor>();
    ASSERT_TRUE(fun->evaluate({result},
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{5});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{3, 5});
    auto round = make_shared<op::v5::Round>(p, op::v5::Round::RoundMode::HALF_TO_EVEN);
    auto fun = make_shared<Function>(OutputVector{round}, ParameterVector{p});
    auto result = make_shared<HostTensor>();
    ASSERT_TRUE(fun->evaluate({result},
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{1, 1, 2, 2});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{11});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::f32, Shape{6});
...
{
    auto p = make_shared<op::Parameter>(element::Type_t::boolean, Shape{2, 2});
    ...
    EXPECT_EQ(result->get_element_type(), element::Type_t::boolean);
...
TEST(eval, evaluate_dynamic_gather)
{
    ...
    auto arg2 = make_shared<op::Parameter>(element::Type_t::i32, PartialShape::dynamic());
    auto arg3 = make_shared<op::Parameter>(element::Type_t::i32, PartialShape::dynamic());
...
TEST(eval, evaluate_dynamic_axis_gather)
{
    auto arg1 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
    auto arg2 = make_shared<op::Parameter>(element::Type_t::i32, PartialShape::dynamic());
    auto arg3 = make_shared<op::Parameter>(element::Type_t::i64, PartialShape::dynamic());
    auto gather = make_shared<op::v1::Gather>(arg1, arg2, arg3);
    auto fun = make_shared<Function>(OutputVector{gather}, ParameterVector{arg1, arg2, arg3});
    auto result_tensor = make_shared<HostTensor>();
    ASSERT_TRUE(fun->evaluate({result_tensor},
...
{
    auto arg1 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
    auto arg2 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
...
TEST(eval, evaluate_static_scatter_elements_update_basic)
{
    ...
    auto arg1 = make_shared<op::Parameter>(element::Type_t::f32, data_shape);
    auto arg2 = make_shared<op::Parameter>(element::Type_t::i32, indices_shape);
    auto arg3 = make_shared<op::Parameter>(element::Type_t::f32, indices_shape);
    auto arg4 = make_shared<op::Parameter>(element::Type_t::i64, Shape{});
...
TEST(eval, evaluate_dynamic_scatter_elements_update_basic)
{
    ...
    auto arg1 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
    auto arg2 = make_shared<op::Parameter>(element::Type_t::i32, PartialShape::dynamic());
    auto arg3 = make_shared<op::Parameter>(element::Type_t::f32, PartialShape::dynamic());
    auto arg4 = make_shared<op::Parameter>(element::Type_t::i64, PartialShape::dynamic());
...
TEST(eval, DISABLED_evaluate_dynamic_scatter_elements_update_3d_i16)
{
    ...
    auto arg1 = make_shared<op::Parameter>(element::Type_t::i16, PartialShape::dynamic());
    auto arg2 = make_shared<op::Parameter>(element::Type_t::i16, PartialShape::dynamic());
    auto arg3 = make_shared<op::Parameter>(element::Type_t::i16, PartialShape::dynamic());
    auto arg4 = make_shared<op::Parameter>(element::Type_t::i64, PartialShape::dynamic());
    ...
    EXPECT_EQ(result_tensor->get_element_type(), element::Type_t::i16);
...
TEST(eval, evaluate_dynamic_scatter_elements_update_one_elem_i32)
{
    ...
    EXPECT_EQ(result_tensor->get_element_type(), element::Type_t::i32);
    EXPECT_EQ(result_tensor->get_partial_shape(), (PartialShape{3, 3, 3}));
...
TEST(eval, topk_v1)
{
    ...
    const auto k = op::Constant::create(element::Type_t::i32, Shape{}, {2});
    auto B = make_shared<op::v1::TopK>(A, k, 1, "max", "index", element::Type_t::i32);
    ...
    EXPECT_EQ(result0->get_element_type(), element::Type_t::f32);
    EXPECT_EQ(result0->get_partial_shape(), (PartialShape{2, 2, 2}));
    EXPECT_EQ(result1->get_element_type(), element::Type_t::i32);
...
TEST(eval, topk_v1_dyn)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape);
    auto k = make_shared<op::Parameter>(element::Type_t::u32, Shape{});
    auto B = make_shared<op::v1::TopK>(A, k, 1, "max", "index", element::Type_t::i32);
...
TEST(eval, topk_v3_dyn)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape);
    auto k = make_shared<op::Parameter>(element::Type_t::u32, Shape{});
    auto B = make_shared<op::v3::TopK>(A, k, 1, "max", "index", element::Type_t::i32);
...
TEST(eval, topk_v3_dyn_values)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape);
    auto k = make_shared<op::Parameter>(element::Type_t::u32, Shape{});
    auto B = make_shared<op::v3::TopK>(A, k, 1, "max", "value", element::Type_t::i32);
...
TEST(eval, topk_v1_dyn_k0)
{
    ...
    auto A = make_shared<op::Parameter>(element::Type_t::f32, shape);
    auto k = make_shared<op::Parameter>(element::Type_t::i64, Shape{});

    element::Type result_et{element::Type_t::i32};
...
{
    const auto data = make_shared<op::Parameter>(element::Type_t::boolean, Shape{2, 2, 2});
    const auto axes = make_shared<op::Parameter>(element::Type_t::i64, Shape{});
...
TEST(eval, evaluate_static_scatter_update_basic_axes_indices_i32)
{
    ...
    auto arg1 = make_shared<op::Parameter>(element::Type_t::f32, data_shape);
    auto arg2 = make_shared<op::Parameter>(element::Type_t::i32, indices_shape);
    auto arg3 = make_shared<op::Parameter>(element::Type_t::f32, updates_shape);
    auto arg4 = make_shared<op::Parameter>(element::Type_t::i32, Shape{});
...
TEST(eval, evaluate_static_scatter_update_basic_axes_indices_i64)
{
    ...
    auto arg1 = make_shared<op::Parameter>(element::Type_t::f32, data_shape);
    auto arg2 = make_shared<op::Parameter>(element::Type_t::i64, indices_shape);
    auto arg3 = make_shared<op::Parameter>(element::Type_t::f32, updates_shape);
    auto arg4 = make_shared<op::Parameter>(element::Type_t::i64, Shape{});
    auto scatter_update = make_shared<op::v3::ScatterUpdate>(arg1, arg2, arg3, arg4);
    auto fun = make_shared<Function>(OutputVector{scatter_update},
