...
TEST(attributes, scatter_elements_update) {
    ...
    auto indices = std::make_shared<op::Parameter>(element::i16, {2, 2, 2, 2});
    auto updates = std::make_shared<op::Parameter>(element::f32, {2, 2, 2, 2});
    auto axis = std::make_shared<op::Parameter>(element::i16, {});
