...
TEST(attributes, random_uniform_op)
{
    ...
    const auto random_uniform = make_shared<opset8::RandomUniform>(out_shape, min_val, max_val, element::Type_t::f32, element::Type_t::f32, 150, 10);
    ...
    EXPECT_EQ(g_random_uniform->get_initial_type(), random_uniform->get_initial_type());
