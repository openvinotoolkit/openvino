...
TEST(attributes, group_conv_op) {
    NodeBuilder::get_ops().register_factory<op::v1::GroupConvolution>();
    ...
    auto g_group_conv = as_type_ptr<op::v1::GroupConvolution>(builder.create());
...
TEST(attributes, group_conv_backprop_data_op) {
    ...
    const auto g_gcbd = as_type_ptr<op::v1::GroupConvolutionBackpropData>(builder.create());
