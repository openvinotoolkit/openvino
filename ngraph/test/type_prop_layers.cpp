...
{
    auto input = make_shared<op::Parameter>(element::Type_t::f32, Shape{88, 2, 48});
    auto seq_len = make_shared<op::Parameter>(element::Type_t::f32, Shape{88, 2});
...
{
    auto box_logits = make_shared<op::Parameter>(element::Type_t::f32, Shape{4, 1, 5, 5});
    auto class_preds = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 1, 4, 5});
    auto proposals = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 1, 4, 5});
    auto aux_class_preds = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 1, 4, 5});
    auto aux_box_preds = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 1, 4, 5});
...
{
    auto image = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 2, 33, 65});
    auto dyn_output_shape = make_shared<op::Parameter>(element::Type_t::i64, Shape{2});
    auto output_shape = op::v0::Constant::create<int64_t>(element::Type_t::i64, Shape{2}, {15, 30});
...
TEST(type_prop_layers, prior_box1)
{
    ...
    auto layer_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{2}, {32, 32});
    auto image_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{2}, {300, 300});
...
TEST(type_prop_layers, prior_box3)
{
    ...
    auto layer_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{2}, {1, 1});
    auto image_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{2}, {300, 300});
    auto pb = make_shared<op::PriorBox>(layer_shape, image_shape, attrs);
...
TEST(type_prop_layers, prior_box_clustered)
{
    ...
    auto layer_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{2}, {19, 19});
    auto image_shape = op::Constant::create<int64_t>(element::Type_t::i64, Shape{2}, {300, 300});
...
{
    auto inputs = make_shared<op::Parameter>(element::Type_t::f32, Shape{1, 125, 13, 13});
...
{
    auto inputs = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 24, 34, 62});
...
{
    auto inputs = make_shared<op::Parameter>(element::Type_t::f32, Shape{1, 3, 4, 5});
    auto coords = make_shared<op::Parameter>(element::Type_t::f32, Shape{150, 5});
...
{
    auto inputs = make_shared<op::Parameter>(element::Type_t::f32, Shape{2, 3, 4, 5});
    auto coords = make_shared<op::Parameter>(element::Type_t::f32, Shape{150, 5});
