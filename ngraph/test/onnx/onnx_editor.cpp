...
NGRAPH_TEST(onnx_editor, types__missing_type_in_input_descriptor) {
    ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/invalid_input_no_type.onnx")};
...
NGRAPH_TEST(onnx_editor, types__missing_tensor_type_in_input_descriptor) {
    ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/invalid_input_no_tensor_type.onnx")};
...
NGRAPH_TEST(onnx_editor, types__elem_type_missing_in_input) {
    // the original model contains 2 inputs with i64 data type and one f32 input
    ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/elem_type_missing_in_input.onnx")};
...
NGRAPH_TEST(onnx_editor, shapes__modify_single_input) {
    ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/shapes__add_two_inputs.onnx")};
...
NGRAPH_TEST(onnx_editor, subgraph__linear_model_head_cut) {
    ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/subgraph__inception_head.onnx")};

    editor.cut_graph_fragment({{InputEdge(1, 0)}}, {});

    const auto ref_model =
        ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/reference/subgraph__linear_model_head_cut.onnx");
...
NGRAPH_TEST(onnx_editor, subgraph__linear_model_deeper_head_cut) {
    ...
    const auto ref_model =
        ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/reference/subgraph__linear_model_deeper_head_cut.onnx");
...
NGRAPH_TEST(onnx_editor, subgraph__linear_model_tail_cut) {
    ...
    const auto ref_model =
        ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/reference/subgraph__linear_model_tail_cut.onnx");
...
NGRAPH_TEST(onnx_editor, subgraph__linear_model_with_initializer_tail_cut) {
    ONNXModelEditor editor{
        ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/subgraph__inception_head_with_initializer.onnx")};
...
NGRAPH_TEST(onnx_editor, subgraph__initializer_without_matching_input_tail_cut) {
    ONNXModelEditor editor{
        ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/subgraph__initializer_without_matching_input.onnx")};
...
NGRAPH_TEST(onnx_editor, subgraph__linear_model_deeper_tail_cut) {
    ...
    const auto ref_model =
        ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/reference/subgraph__linear_model_deeper_tail_cut.onnx");
...
NGRAPH_TEST(onnx_editor, subgraph__no_input_params) {
    const auto model_path = ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/subgraph__inception_head.onnx");
...
NGRAPH_TEST(onnx_editor, subgraph__multiout_op_output_edge) {
    ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/subgraph_extraction_tests.onnx")};

    editor.cut_graph_fragment({}, {{OutputEdge{5, 1}}});

    const auto ref_model =
        ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/reference/subgraph__multiout_op_output_edge.onnx");
...
NGRAPH_TEST(onnx_editor, subgraph__multiple_consumers_of_graph_input_relu2) {
    ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/subgraph_extraction_tests_2.onnx")};
...
NGRAPH_TEST(onnx_editor, values__append_two_initializers_to_invalid) {
    onnx_editor::ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/add_1D_invalid.onnx")};
    std::map<std::string, std::shared_ptr<ngraph::op::Constant>> in_vals;
...
NGRAPH_TEST(onnx_editor, read_model_from_stream) {
    ...
    auto test_case = ngraph::test::TestCase<TestEngine>(editor.get_function());
...
NGRAPH_TEST(onnx_editor, cut_operator_with_no_schema) {
    ONNXModelEditor editor{ngraph::file_util::path_join(SERIALIZED_ZOO, "onnx/model_editor/unknown_input_value_info.onnx")};
