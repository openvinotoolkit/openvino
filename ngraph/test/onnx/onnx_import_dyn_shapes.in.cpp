...
{
    const auto instance_norm_fn = onnx_import::import_onnx_model(file_util::path_join(
    ...
    auto test_case =
        test::NgraphTestCase(instance_norm_fn, "${BACKEND_NAME}", test::BackendMode::DYNAMIC);
