...
public:
    TestMatcherPass()
    {
        auto m_relu1 = ov::pattern::wrap_type<ov::opset3::Relu>(pattern::consumers_count(1));
        auto m_relu2 = ov::pattern::wrap_type<ov::opset3::Relu>({m_relu1});
        ...
        ov::graph_rewrite_callback callback = [=](pattern::Matcher& m) {
            ...
            auto new_relu = register_new_node<ov::opset3::Relu>(
        ...
        auto m = std::make_shared<ov::pattern::Matcher>(m_relu2, "ReluReluFusion");
        // Register Matcher
...
{
    {
        ...
        auto f = std::make_shared<Function>(ov::NodeVector{c}, ParameterVector{a});
...

    {
        ...
        auto b = make_shared<opset3::Relu>(a);
        auto c = make_shared<opset3::Relu>(b);
        auto f = std::make_shared<Function>(ov::NodeVector{b, c}, ParameterVector{a});
...

    {
        std::shared_ptr<Function> f;
        {
            ...
            f = std::make_shared<Function>(ov::NodeVector{d}, ParameterVector{a});
        }
