...
static const std::vector<std::string> models{std::string("argmax"),
                                             ...
                                             std::string("rnn_lstm_layer_1_bidirectional_seq_len_False"),
                                             std::string("rnn_lstm_layer_1_forward_seq_len_False"),
                                             std::string("rnn_lstm_layer_2_bidirectional_seq_len_False"),
                                             std::string("rnn_lstm_layer_2_forward_seq_len_False"),
                                             std::string("rnn_lstm_layer_1_forward_seq_len_True"),
                                             std::string("rnn_lstm_layer_2_bidirectional_seq_len_True"),
