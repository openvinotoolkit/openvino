...
{
    Shape shape{4};
    op::Constant c(element::Type_t::boolean, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::boolean, shape, vector<string>{"1"});
    auto v = c.get_vector<char>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::boolean, shape, vector<char>{1, 0, 1, 0});
    auto v = c.get_vector<char>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::boolean, shape, vector<char>{1});
    auto v = c.get_vector<char>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f32, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f32, shape, vector<string>{"1"});
    auto v = c.get_vector<float>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f32, shape, vector<float>{1, 0, 1, 0});
    auto v = c.get_vector<float>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f32, shape, vector<float>{1});
    auto v = c.get_vector<float>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f64, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f64, shape, vector<string>{"1"});
    auto v = c.get_vector<double>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f64, shape, vector<double>{1, 0, 1, 0});
    auto v = c.get_vector<double>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f64, shape, vector<double>{1});
    auto v = c.get_vector<double>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i8, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i8, shape, vector<string>{"1"});
    auto v = c.get_vector<int8_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i8, shape, vector<int8_t>{1, 0, 1, 0});
    auto v = c.get_vector<int8_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i8, shape, vector<int8_t>{1});
    auto v = c.get_vector<int8_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i16, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i16, shape, vector<string>{"1"});
    auto v = c.get_vector<int16_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i16, shape, vector<int16_t>{1, 0, 1, 0});
    auto v = c.get_vector<int16_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i16, shape, vector<int16_t>{1});
    auto v = c.get_vector<int16_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i32, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i32, shape, vector<string>{"1"});
    auto v = c.get_vector<int32_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i32, shape, vector<int32_t>{1, 0, 1, 0});
    auto v = c.get_vector<int32_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i32, shape, vector<int32_t>{1});
    auto v = c.get_vector<int32_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i64, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i64, shape, vector<string>{"1"});
    auto v = c.get_vector<int64_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i64, shape, vector<int64_t>{1, 0, 1, 0});
    auto v = c.get_vector<int64_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::i64, shape, vector<int64_t>{1});
    auto v = c.get_vector<int64_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u8, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u8, shape, vector<string>{"1"});
    auto v = c.get_vector<uint8_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u8, shape, vector<uint8_t>{1, 0, 1, 0});
    auto v = c.get_vector<uint8_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u8, shape, vector<uint8_t>{1});
    auto v = c.get_vector<uint8_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u16, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u16, shape, vector<string>{"1"});
    auto v = c.get_vector<uint16_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u16, shape, vector<uint16_t>{1, 0, 1, 0});
    auto v = c.get_vector<uint16_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u16, shape, vector<uint16_t>{1});
    auto v = c.get_vector<uint16_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u32, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u32, shape, vector<string>{"1"});
    auto v = c.get_vector<uint32_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u32, shape, vector<uint32_t>{1, 0, 1, 0});
    auto v = c.get_vector<uint32_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u32, shape, vector<uint32_t>{1});
    auto v = c.get_vector<uint32_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u64, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u64, shape, vector<string>{"1"});
    auto v = c.get_vector<uint64_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u64, shape, vector<uint64_t>{1, 0, 1, 0});
    auto v = c.get_vector<uint64_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 0);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::u64, shape, vector<uint64_t>{1});
    auto v = c.get_vector<uint64_t>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], 1);
    EXPECT_EQ(v[1], 1);
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::bf16, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::bf16, shape, vector<string>{"1"});
    auto v = c.get_vector<bfloat16>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], bfloat16(1));
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::bf16, shape, vector<bfloat16>{1, 0, 1, 0});
    auto v = c.get_vector<bfloat16>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], bfloat16(1));
    EXPECT_EQ(v[1], bfloat16(0));
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::bf16, shape, vector<bfloat16>{1});
    auto v = c.get_vector<bfloat16>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], bfloat16(1));
    EXPECT_EQ(v[1], bfloat16(1));
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f16, shape, vector<string>{"1", "0", "1", "0"});
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f16, shape, vector<string>{"1"});
    auto v = c.get_vector<float16>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], float16(1));
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f16, shape, vector<float16>{1, 0, 1, 0});
    auto v = c.get_vector<float16>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], float16(1));
    EXPECT_EQ(v[1], float16(0));
...
{
    Shape shape{4};
    op::Constant c(element::Type_t::f16, shape, vector<float16>{1});
    auto v = c.get_vector<float16>();
    ASSERT_EQ(v.size(), shape_size(shape));
    EXPECT_EQ(v[0], float16(1));
    EXPECT_EQ(v[1], float16(1));
...
{
    Shape shape{100, 200};
    auto c1 = make_shared<op::Constant>(element::Type_t::f16, shape, vector<float16>{123});
...
{
    op::Constant c(element::Type_t::f32, Shape{}, vector<float>{1.0});
