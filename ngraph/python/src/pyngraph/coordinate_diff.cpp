...
#include "ngraph/coordinate_diff.hpp" // ov::CoordinateDiff
...
{
    py::class_<ov::CoordinateDiff, std::shared_ptr<ov::CoordinateDiff>> coordinate_diff(
        m, "CoordinateDiff");
    coordinate_diff.doc() = "ngraph.impl.CoordinateDiff wraps ov::CoordinateDiff";
