...
#include "ngraph/shape.hpp"         // ov::Shape
...
void regclass_pyngraph_PartialShape(py::module m)
{
    ...
    shape.def(
        "get_dimension",
        [](const ov::PartialShape& self, size_t index) -> ov::Dimension { return self[index]; },
        py::arg("index"),
        R"(
    ...
    shape.def(
        "__eq__",
        [](const ov::PartialShape& a, const ov::PartialShape& b) { return a == b; },
        py::is_operator());
    shape.def(
        "__eq__",
        [](const ov::PartialShape& a, const ov::Shape& b) { return a == b; },
        py::is_operator());
