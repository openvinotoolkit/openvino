...
#include "ngraph/op/parameter.hpp" // ov::op::Parameter
...
{
    py::class_<ov::Function, std::shared_ptr<ov::Function>> function(m, "Function");
    ...
    function.def(py::init<const std::vector<std::shared_ptr<ov::Node>>&,
                          const std::vector<std::shared_ptr<ov::op::Parameter>>&,
                          const std::string&>(),
                 py::arg("results"),
                 py::arg("parameters"),
                 py::arg("name"),
    ...
    function.def_property(
        "friendly_name", &ov::Function::get_friendly_name, &ov::Function::set_friendly_name);
}
