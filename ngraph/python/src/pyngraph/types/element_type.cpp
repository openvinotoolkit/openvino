...
void regclass_pyngraph_Type(py::module m)
{
    ...
    type.attr("boolean") = ngraph::element::Type_t::boolean;
    type.attr("f16") = ngraph::element::Type_t::f16;
    type.attr("f32") = ngraph::element::Type_t::f32;
    type.attr("f64") = ngraph::element::Type_t::f64;
    type.attr("i8") = ngraph::element::Type_t::i8;
    type.attr("i16") = ngraph::element::Type_t::i16;
    type.attr("i32") = ngraph::element::Type_t::i32;
    type.attr("i64") = ngraph::element::Type_t::i64;
    type.attr("u1") = ngraph::element::Type_t::u1;
    type.attr("u8") = ngraph::element::Type_t::u8;
    type.attr("u16") = ngraph::element::Type_t::u16;
    type.attr("u32") = ngraph::element::Type_t::u32;
    type.attr("u64") = ngraph::element::Type_t::u64;
