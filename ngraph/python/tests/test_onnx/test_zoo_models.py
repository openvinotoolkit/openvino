...
if len(zoo_models) > 0:
    ...
    if tests.MODEL_ZOO_XFAIL:
        import_xfail_list = [
            ...
            # Model MSFT
            (xfail_issue_2, "test_20191107_opset10_mlperf_ssd_mobilenet_300_ssd_mobilenet_v1_coco_2018_01_28_cpu"),
            (xfail_issue_2, "test_20191107_opset10_mlperf_ssd_resnet34_1200_ssd_resnet34_mAP_20.2_cpu"),
            (xfail_issue_2, "test_20191107_opset10_yolov3_yolov3_cpu"),
            (xfail_issue_2, "test_20191107_opset11_tinyyolov3_yolov3_tiny_cpu"),
            (xfail_issue_2, "test_20191107_opset10_mlperf_ssd_resnet34_1200_ssd_resnet34_mAP_20.2_cpu"),
            (xfail_issue_7, "test_20191107_opset10_mask_rcnn_keras_mask_rcnn_keras_cpu"),
            (xfail_issue_36535, "test_20191107_opset9_LSTM_Seq_lens_unpacked_model_cpu"),
    ...
    if tests.MODEL_ZOO_XFAIL:
        execution_xfail_list = [
            ...
            # Model MSFT
            (xfail_issue_36533, "test_20191107_opset10_tf_inception_v2_model_cpu"),
            (xfail_issue_36533, "test_20191107_opset8_test_tiny_yolov2_model_cpu"),
            (xfail_issue_36533, "test_20191107_opset9_tf_inception_v2_model_cpu"),
            (xfail_issue_36533, "test_20191107_opset8_tf_inception_v2_model_cpu"),
            (xfail_issue_36533, "test_20191107_opset8_mxnet_arcface_model_cpu"),
            (xfail_issue_36533, "test_20191107_opset7_test_resnet152v2_resnet152v2_cpu"),
            (xfail_issue_36533, "test_20191107_opset7_test_tiny_yolov2_model_cpu"),
            (xfail_issue_36533, "test_20191107_opset7_tf_inception_v2_model_cpu"),
            (xfail_issue_36533, "test_20191107_opset11_tf_inception_v2_model_cpu"),
            (xfail_issue_36533, "test_20191107_opset7_test_mobilenetv2_1.0_mobilenetv2_1.0_cpu"),

            (xfail_issue_38090, "test_20191107_opset7_fp16_tiny_yolov2_onnxzoo_winmlperf_tiny_yolov2_cpu"),
            (xfail_issue_38090, "test_20191107_opset8_fp16_inception_v1_onnxzoo_lotus_inception_v1_cpu"),
            (xfail_issue_38090, "test_20191107_opset8_fp16_tiny_yolov2_onnxzoo_winmlperf_tiny_yolov2_cpu"),
            (xfail_issue_38090, "test_20191107_opset8_fp16_shufflenet_onnxzoo_lotus_shufflenet_cpu"),
            (xfail_issue_38090, "test_20191107_opset7_fp16_inception_v1_onnxzoo_lotus_inception_v1_cpu"),
            (xfail_issue_38090, "test_20191107_opset10_mlperf_resnet_resnet50_v1_cpu"),
            (xfail_issue_38090, "test_20191107_opset7_fp16_shufflenet_onnxzoo_lotus_shufflenet_cpu"),

            (xfail_issue_38084, "test_20191107_opset10_mask_rcnn_mask_rcnn_R_50_FPN_1x_cpu"),
            (xfail_issue_38084, "test_20191107_opset10_faster_rcnn_faster_rcnn_R_50_FPN_1x_cpu"),

            (xfail_issue_8, "test_20191107_opset9_cgan_cgan_cpu"),
            (xfail_issue_35926, "test_20191107_opset10_BERT_Squad_bertsquad10_cpu"),
        ]
