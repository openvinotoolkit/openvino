...
if len(zoo_models) > 0:
    ...
    if tests.MODEL_ZOO_XFAIL:
        import_xfail_list = [
            ...
            (xfail_issue_12345, "test_onnx_model_zoo_vision_object_detection_segmentation_ssd_mobilenetv1_model_ssd_mobilenet_v1_10_ssd_mobilenet_v1_ssd_mobilenet_v1_cpu"),
            ...
            (xfail_issue_12346, "test_onnx_model_zoo_vision_object_detection_segmentation_tiny_yolov3_model_tiny_yolov3_11_yolov3_tiny_cpu"),

            # Model MSFT
            (xfail_issue_12345, "test_MSFT_opset10_mlperf_ssd_mobilenet_300_ssd_mobilenet_v1_coco_2018_01_28_cpu"),
            (xfail_issue_12347, "test_MSFT_opset10_mlperf_ssd_resnet34_1200_ssd_resnet34_mAP_20.2_cpu"),
    ...
    if tests.MODEL_ZOO_XFAIL:
        execution_xfail_list = [
            ...
            (xfail_issue_12346, "test_MSFT_opset11_tinyyolov3_yolov3_tiny_cpu"),
            (xfail_issue_12346, "test_onnx_model_zoo_vision_object_detection_segmentation_yolov3_model_yolov3_10_yolov3_yolov3_cpu"),
            (xfail_issue_12346, "test_MSFT_opset10_yolov3_yolov3_cpu")
        ]
