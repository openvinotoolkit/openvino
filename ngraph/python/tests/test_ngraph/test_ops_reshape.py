...
from tests import xfail_issue_42944, xfail_issue_35929
...
@pytest.mark.parametrize(
    "val_type, value",
    [
        pytest.param(np.float32, np.float32(0.1234), marks=xfail_issue_42944),
        pytest.param(np.float64, np.float64(0.1234), marks=xfail_issue_35929),
        pytest.param(np.int8, np.int8(-63), marks=xfail_issue_42944),
        pytest.param(np.int16, np.int16(-12345), marks=xfail_issue_42944),
        pytest.param(np.int32, np.int32(-123456), marks=xfail_issue_42944),
        pytest.param(np.int64, np.int64(-1234567), marks=xfail_issue_42944),
        pytest.param(np.uint8, np.uint8(63), marks=xfail_issue_42944),
        pytest.param(np.uint16, np.uint16(12345), marks=xfail_issue_42944),
        pytest.param(np.uint32, np.uint32(123456), marks=xfail_issue_42944),
        pytest.param(np.uint64, np.uint64(1234567), marks=xfail_issue_42944),
    ],
)
