...
namespace ngraph
{
    namespace frontend
    {
        class PlaceTensorflow : public IPlace
        {
        public:
        ...
        class NGRAPH_API InputModelTensorflow : public IInputModel
        {
        public:
            ...
            void setPartialShape (IPlace::Ptr place, const ngraph::PartialShape& pshape) override;
        };

        class NGRAPH_API FrontEndTensorflow : public IFrontEnd
        {
        public:
