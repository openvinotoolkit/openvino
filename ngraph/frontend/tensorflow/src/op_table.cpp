...
#define OP_T_CONVERTER(op) template <class T> NamedOutputs op(const NodeContext& node)
#define OP_UINT_CONVERTER(op) template <unsigned int T> NamedOutputs op(const NodeContext& node)
