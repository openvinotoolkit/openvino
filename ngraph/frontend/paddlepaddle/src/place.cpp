...
const std::map<std::string, std::vector<std::shared_ptr<InPortPlacePDPD>>>& OpPlacePDPD::get_input_ports() const {
...
void OpPlacePDPD::add_out_port(const std::shared_ptr<OutPortPlacePDPD>& output, const std::string& name) {
    m_output_ports[name].push_back(output);
}

void OpPlacePDPD::add_in_port(const std::shared_ptr<InPortPlacePDPD>& input, const std::string& name) {
...
std::vector<Place::Ptr> OpPlacePDPD::get_consuming_operations(const std::string& outputPortName) const {
...
Place::Ptr OpPlacePDPD::get_producing_operation(const std::string& inputName, int inputPortIndex) const {
