...
namespace pdpd
{
    namespace op
    {
        NamedOutputs multiclass_nms(const NodeContext& node)
        {
            ...
            auto node_max_output_boxes_per_class =
                opset6::Constant::create<int>(element::i32, Shape{1}, {max_output_boxes_per_class});
            ...
            return node.default_single_output_mapping(
                {std::make_shared<opset6::NonMaxSuppression>(bboxes,
                                                             scores,
