            ...
            namespace op
            {
                                                     ...
                                                     std::shared_ptr<Node> array_node)
                {
                    ...
                    if (idx > 0)
                    {
                        ...
                        auto stridesNode = ov::opset6::Constant::create(element::i32, {1}, {1});
                        auto head =
                            std::make_shared<ov::opset6::StridedSlice>(array_node,
                                                                       startsNode,
                                                                       endsNode,
                                                                       stridesNode,
                                                                       std::vector<int64_t>(1, 0),
                ...
                static Output<Node> get_seed_node(const NodeContext& node)
                {
                    ...
                    {
                    case element::i32:
                        val_node = ov::opset6::Constant::create(dtype, {1}, {std::stoi(str_value)});
                        break;
                    case element::i64:
                        val_node =
                            ov::opset6::Constant::create(dtype, {1}, {std::stoll(str_value)});
                        break;
                    case element::f32:
                        val_node = ov::opset6::Constant::create(dtype, {1}, {std::stof(str_value)});
                        break;
                    case element::f64:
                        val_node = ov::opset6::Constant::create(dtype, {1}, {std::stod(str_value)});
                        break;
                    default:
                ...
                NamedOutputs fill_constant_batch_size_like(const NodeContext& node)
                {
                    ...
                    auto shapes_node =
                        ov::opset6::Constant::create(ov::element::i32, {shapes.size()}, shapes);
                    ...
                    return node.default_single_output_mapping(
                        {std::make_shared<ov::opset6::Broadcast>(val_node, shape_node)}, {"Out"});
                }
