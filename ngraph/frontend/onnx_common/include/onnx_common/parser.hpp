...
namespace ngraph
{
    namespace onnx_common
    {
        ...
        ONNX_IMPORTER_API ONNX_NAMESPACE::ModelProto parse_from_file(const std::string& file_path);
        ...
        ///
        /// \return  The parsed in-memory representation of the ONNX model
        ONNX_IMPORTER_API ONNX_NAMESPACE::ModelProto parse_from_istream(std::istream& model_stream);
    } // namespace onnx_common
