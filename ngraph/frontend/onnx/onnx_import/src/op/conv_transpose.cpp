    ...
    namespace onnx_import
    {
        namespace op
        {
            namespace set_1
            {
                ...
                {
                    Output<ov::Node>
                        make_group_conv_backprop(const Output<ov::Node>& data,
                    ...
                    Output<ov::Node>
                        make_conv_backprop(const Output<ov::Node>& data,
                                           const Output<ov::Node>& filters,
                                           const Strides& strides,
                                           const Strides& dilations,
                                           const CoordinateDiff& pads_begin,
                    ...
                    Output<ov::Node> get_prepared_bias(const Output<ov::Node>& bias,
                                                       const Output<ov::Node>& conv)
                    {
