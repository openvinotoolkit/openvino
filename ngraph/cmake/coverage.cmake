...
set(NGRAPH_COVERAGE_GCDA_DATA_DIRECTORY "${CMAKE_BINARY_DIR}/ngraph")
set(NGRAPH_COVERAGE_BASE_DIRECTORY "${OpenVINO_MAIN_SOURCE_DIR}/ngraph")

ie_coverage_clean(REPOSITORY "nGraph"
                  DIRECTORY "${NGRAPH_COVERAGE_GCDA_DATA_DIRECTORY}")
...
ie_coverage_extract(INPUT "nGraph" OUTPUT "ngraph"
                    PATTERNS "${NGRAPH_COVERAGE_BASE_DIRECTORY}/core/*")
...
if (NGRAPH_ONNX_IMPORT_ENABLE)
    ie_coverage_extract(INPUT "nGraph" OUTPUT "onnx_importer"
        PATTERNS "${NGRAPH_COVERAGE_BASE_DIRECTORY}/frontend/onnx_common*"
        "${NGRAPH_COVERAGE_BASE_DIRECTORY}/frontend/onnx_import*")
    ie_coverage_genhtml(INFO_FILE "onnx_importer"
        PREFIX "${NGRAPH_COVERAGE_BASE_DIRECTORY}")

    ie_coverage_extract(INPUT "nGraph" OUTPUT "onnx_editor"
        PATTERNS 
        "${NGRAPH_COVERAGE_BASE_DIRECTORY}/frontend/onnx_editor*")
