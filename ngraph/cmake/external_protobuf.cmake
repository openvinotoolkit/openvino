...
if(CMAKE_CROSSCOMPILING)
    ...
    if(SYSTEM_PROTOC)
        ...
        if(${PROTOC_VERSION} VERSION_EQUAL "3.15.0")
            message(WARNING "Protobuf 3.0.0 detected switching to 3.15.0 due to bug in gmock url")
...
if(PROTOC_VERSION VERSION_LESS "3.15.0" AND NGRAPH_USE_PROTOBUF_LITE)
    message(FATAL_ERROR "Minimum supported version of protobuf-lite library is 3.15.0")
else()
