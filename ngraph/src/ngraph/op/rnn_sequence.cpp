...
#include "ngraph_ops/rnn_sequence.hpp"
...
constexpr NodeTypeInfo op::RNNSequence::type_info;

op::RNNSequence::RNNSequence(const Output<Node>& X, const Output<Node>& H_t, const Output<Node>& sequence_lengths,
