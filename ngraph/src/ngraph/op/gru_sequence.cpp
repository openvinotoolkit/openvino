...
constexpr NodeTypeInfo op::GRUSequence::type_info;

op::GRUSequence::GRUSequence(const Output<Node>& X, const Output<Node>& H_t, const Output<Node>& sequence_lengths,
...
void op::GRUSequence::validate_and_infer_types() {
...
shared_ptr<Node> op::GRUSequence::copy_with_new_args(const NodeVector& new_args) const {
    check_new_args_count(this, new_args);
    return make_shared<op::GRUSequence>(new_args.at(0), new_args.at(1), new_args.at(2), new_args.at(3),
