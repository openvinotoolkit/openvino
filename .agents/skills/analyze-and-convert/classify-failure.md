...
def extract_signals(attempts, profile, dominant_class):
    ...
    routing = {
        ...
        "missing_conversion_rule": "openvino-orchestrator",
        "frontend_error": "openvino-orchestrator",
        "ir_validation_error": "openvino-orchestrator",
        "inference_runtime_error": "openvino-orchestrator",
